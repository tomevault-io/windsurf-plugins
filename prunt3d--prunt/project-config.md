---
trigger: always_on
description: Run focused tests using `PRUNT_SKIP_VALIDATION=true PRUNT_XCOV_DUMP=false PRUNT_SKIP_INTEGRATION=true ./run_tests.sh <filter>`. The final optional argument filters both unit tests and integration scenarios by substring, (`thermistors` to run `*thermistors*` for example).
---
...
---
> Source: [Prunt3D/prunt](https://github.com/Prunt3D/prunt) — distributed by [TomeVault](https://tomevault.io).
