---
trigger: always_on
description: - `src/index.ts` — MCP server entry (stdio transport, tool dispatch, 25s keepalive)
---
...
---
> Source: [x51xxx/codex-mcp-tool](https://github.com/x51xxx/codex-mcp-tool) — distributed by [TomeVault](https://tomevault.io).
