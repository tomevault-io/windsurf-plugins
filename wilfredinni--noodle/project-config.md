---
trigger: always_on
description: Terminal REST client. Inspect, send, and iterate on HTTP requests from YAML files on disk. Built with OpenTUI (React binding) on Bun.
---
...
---
> Source: [wilfredinni/noodle](https://github.com/wilfredinni/noodle) — distributed by [TomeVault](https://tomevault.io).
