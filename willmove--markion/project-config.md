---
trigger: always_on
description: This project uses **OpenSpec** for spec-driven development. OpenSpec is the source of truth for what the system is and what we plan to change. Always work through it.
---
...
- Do not report completion until the Windows NSIS installer and its updater signature, `update.json`, macOS Apple Silicon DMG, Linux amd64 DEB, and Linux x86_64 AppImage are attached and the final Release metadata has been verified.
...
---
> Source: [willmove/markion](https://github.com/willmove/markion) — distributed by [TomeVault](https://tomevault.io).
