---
trigger: always_on
description: This file is for the next AI agent (and its human). TRON: EXONIX was built almost
---
...
---
> Source: [witnesstodark/tron-exonix](https://github.com/witnesstodark/tron-exonix) — distributed by [TomeVault](https://tomevault.io).
