...
Original source: `AGENTS.md` in [level1techs/siomon](https://github.com/level1techs/siomon).
...
```
npx tomevault install level1techs/siomon
```
Source: [github.com/level1techs/siomon](https://github.com/level1techs/siomon).
