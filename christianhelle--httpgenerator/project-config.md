---
trigger: always_on
description: HTTP File Generator is now a Rust-first CLI and compatibility-host repository. The Rust workspace under `src/rust/` is the primary implementation. The .NET projects under `src/dotnet/HttpGenerator*` remain in the repo as the legacy oracle and thin host surfaces during the migration.
---
...
---
> Source: [christianhelle/httpgenerator](https://github.com/christianhelle/httpgenerator) — distributed by [TomeVault](https://tomevault.io).
