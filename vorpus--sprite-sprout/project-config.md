---
trigger: always_on
description: > This file is the table of contents. The docs/ folder is the system of record.
---
...
---
> Source: [vorpus/sprite-sprout](https://github.com/vorpus/sprite-sprout) — distributed by [TomeVault](https://tomevault.io).
