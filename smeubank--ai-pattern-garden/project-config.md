---
trigger: always_on
description: This guide defines writing standards for `.cursor/rules/*.mdc` files in the project template. These files serve as both AI assistant instructions and developer documentation.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/smeubank)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/smeubank)
