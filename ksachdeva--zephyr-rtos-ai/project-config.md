---
trigger: always_on
description: This document provides context for AI coding assistants (Open Code, Claude Code, Gemini CLI, GitHub Copilot, etc.) to understand the `zephyr-rtos-ai` project and assist with development of features.
---
