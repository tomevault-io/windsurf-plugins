---
trigger: always_on
description: This package houses the canonical web component implementation of the design
---
...
For `packages/ibm-products-web-components/src/components/`:
...
---
> Source: [carbon-design-system/ibm-products](https://github.com/carbon-design-system/ibm-products) — distributed by [TomeVault](https://tomevault.io).
