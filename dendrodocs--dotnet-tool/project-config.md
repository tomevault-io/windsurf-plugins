---
trigger: always_on
description: DendroDocs.Tool is a .NET command-line tool that analyzes .NET projects and solutions, producing JSON output conforming to the DendroDocs Schema. It's the successor to the Living Documentation Analyzer and uses shared code from the DendroDocs.Shared library.
---
...
---
> Source: [dendrodocs/dotnet-tool](https://github.com/dendrodocs/dotnet-tool) — distributed by [TomeVault](https://tomevault.io).
