---
trigger: always_on
description: Fix for GitHub issue #57: GSM extension characters (`|`, `^`, `{`, `}`, etc.) were double-counted when a message was forced into UCS-2 encoding by a non-GSM character.
---
...
---
> Source: [TwilioDevEd/message-segment-calculator](https://github.com/TwilioDevEd/message-segment-calculator) — distributed by [TomeVault](https://tomevault.io).
