---
trigger: always_on
description: - Code is formatted with Prettier.
---
...
---
> Source: [coliff/bootstrap-show-password-toggle](https://github.com/coliff/bootstrap-show-password-toggle) — distributed by [TomeVault](https://tomevault.io).
