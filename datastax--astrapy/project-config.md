---
trigger: always_on
description: **Copyright notice MANDATORY:** All Python files, including empty ones (`__init__.py`), must start with the same copyright notice (as can be seen by reading any of them).
---
...
---
> Source: [datastax/astrapy](https://github.com/datastax/astrapy) — distributed by [TomeVault](https://tomevault.io).
