---
trigger: always_on
description: - Use `///` for public API documentation
---
...
---
> Source: [consensus-shipyard/ipc](https://github.com/consensus-shipyard/ipc) — distributed by [TomeVault](https://tomevault.io).
