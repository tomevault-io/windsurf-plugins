---
trigger: always_on
description: Use available agent skills proactively whenever a request matches their purpose; the user does not need to name a skill explicitly. Briefly state which skill you are using and why. Do not use Superpowers unless the user explicitly requests it.
---
...
---
> Source: [michaelmjhhhh/pi-atelier](https://github.com/michaelmjhhhh/pi-atelier) — distributed by [TomeVault](https://tomevault.io).
