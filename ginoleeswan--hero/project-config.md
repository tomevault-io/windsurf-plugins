---
trigger: always_on
description: Mythique is a superhero/villain encyclopedia. Its components are **React Native** components compiled for the web via **react-native-web**, exposed on `window.Mythique`. They render real RN primitives in the browser — there is **no CSS class system**.
---
...
---
> Source: [ginoleeswan/hero](https://github.com/ginoleeswan/hero) — distributed by [TomeVault](https://tomevault.io).
