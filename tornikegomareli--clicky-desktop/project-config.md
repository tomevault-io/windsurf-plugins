---
trigger: always_on
description: This file is the persistent Codex context for `clicky-desktop`. Keep it focused on stable architecture, conventions, and workflow notes that are useful every turn.
---
