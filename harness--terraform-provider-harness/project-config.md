---
trigger: always_on
description: This package implements the Terraform resource and data source for Harness DBDevOps Instance. A database instance represents a specific database that is managed by a parent database schema. It connects a database (via a connector) to a schema definition.
---
...
---
> Source: [harness/terraform-provider-harness](https://github.com/harness/terraform-provider-harness) — distributed by [TomeVault](https://tomevault.io).
