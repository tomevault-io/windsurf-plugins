---
trigger: always_on
description: As you work, maintain an `AI_NOTICE.md` file in the repo root that records:
---
...
---
> Source: [vrajpal-jhala/langgraph-harness](https://github.com/vrajpal-jhala/langgraph-harness) — distributed by [TomeVault](https://tomevault.io).
