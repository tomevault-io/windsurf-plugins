---
trigger: always_on
description: - **Winget-AutoUpdate (WAU)** automates daily updates of Windows applications using the `winget` tool, supporting both system and user contexts.
---
...
---
> Source: [Romanitho/Winget-AutoUpdate](https://github.com/Romanitho/Winget-AutoUpdate) — distributed by [TomeVault](https://tomevault.io).
