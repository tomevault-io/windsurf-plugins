---
trigger: always_on
description: The `perl` cookbook installs Perl from operating system package repositories on Linux and uses
---
...
---
> Source: [sous-chefs/perl](https://github.com/sous-chefs/perl) — distributed by [TomeVault](https://tomevault.io).
