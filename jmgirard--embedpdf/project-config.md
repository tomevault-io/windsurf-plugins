---
trigger: always_on
description: A Quarto HTML extension. The `{{< pdf file.pdf >}}` shortcode embeds a PDF using
---
...
---
> Source: [jmgirard/embedpdf](https://github.com/jmgirard/embedpdf) — distributed by [TomeVault](https://tomevault.io).
