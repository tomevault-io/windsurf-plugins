---
trigger: always_on
description: Instructions for AI coding agents when working on this project.
---
...
---
> Source: [weppos/publicsuffix-ruby](https://github.com/weppos/publicsuffix-ruby) — distributed by [TomeVault](https://tomevault.io).
