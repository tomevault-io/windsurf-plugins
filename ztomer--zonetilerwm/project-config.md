---
trigger: always_on
description: **📚 Note:** For complete AI copilot instructions, see [docs/GEMINI.md](../docs/GEMINI.md). This file provides a quick reference.
---
...
---
> Source: [ztomer/ZoneTilerWM](https://github.com/ztomer/ZoneTilerWM) — distributed by [TomeVault](https://tomevault.io).
