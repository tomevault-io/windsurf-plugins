---
trigger: always_on
description: cargo clippy --all-targets --all-features -- -D warnings
---
...
---
> Source: [jac3km4/vakfu](https://github.com/jac3km4/vakfu) — distributed by [TomeVault](https://tomevault.io).
