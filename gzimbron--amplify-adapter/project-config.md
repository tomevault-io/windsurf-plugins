---
trigger: always_on
description: `amplify-adapter` is a [SvelteKit adapter](https://kit.svelte.dev/docs/adapters) that packages SvelteKit apps for deployment on AWS Amplify Hosting with SSR (Server-Side Rendering) support via CI/CD.
---
...
---
> Source: [gzimbron/amplify-adapter](https://github.com/gzimbron/amplify-adapter) — distributed by [TomeVault](https://tomevault.io).
