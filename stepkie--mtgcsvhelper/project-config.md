---
trigger: always_on
description: Tool for converting Magic: The Gathering card collection CSV files between formats (Moxfield, DragonShield, Manabox, Topdecked, Deckbox, MtgGoldfish, CardKingdom).
---
