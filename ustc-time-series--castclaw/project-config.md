---
trigger: always_on
description: The `tmpdir` function in `fixture/fixture.ts` creates temporary directories for tests with automatic cleanup.
---
...
- `config?: Partial<Config.Info>` - Write an `castclaw.json` config file
...
- Directories are created in the system temp folder with prefix `castclaw-test-`
...
---
> Source: [ustc-time-series/CastClaw](https://github.com/ustc-time-series/CastClaw) — distributed by [TomeVault](https://tomevault.io).
