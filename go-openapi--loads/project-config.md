---
trigger: always_on
description: `github.com/go-openapi/loads` loads, parses, and analyzes Swagger/OpenAPI v2.0 specifications from local files or remote URLs in JSON and YAML formats. It is part of the `go-openapi` ecosystem.
---
...
---
> Source: [go-openapi/loads](https://github.com/go-openapi/loads) — distributed by [TomeVault](https://tomevault.io).
