---
trigger: always_on
description: This is a **multi-agent swarm** for Kubernetes/OpenShift platform operations. Seven agents work together, each with a defined domain and personality.
---
...
---
> Source: [kcns008/cluster-agent-swarm-skills](https://github.com/kcns008/cluster-agent-swarm-skills) — distributed by [TomeVault](https://tomevault.io).
