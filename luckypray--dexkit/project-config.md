---
trigger: always_on
description: - For significant features, refactors, or cross-module fixes, sketch a short plan first and keep it updated while you work.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/LuckyPray)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/LuckyPray)
