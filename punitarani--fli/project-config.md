---
trigger: always_on
description: Fli is a Python library providing programmatic access to Google Flights data via reverse-engineered API. It offers a CLI (`fli`), MCP server (`fli-mcp` / `fli-mcp-http`), and Python API. No external services (databases, caches, etc.) are required.
---
...
---
> Source: [punitarani/fli](https://github.com/punitarani/fli) — distributed by [TomeVault](https://tomevault.io).
