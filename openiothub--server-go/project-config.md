---
trigger: always_on
description: **kcp-go** is a production-grade, reliable UDP library for Go. It implements the KCP protocol, providing a stream-based interface (like TCP) over UDP with low latency, high throughput, and packet-level control. It is widely used in gaming, streaming, and network acceleration (e.g., kcptun).
---
...
---
> Source: [OpenIoTHub/server-go](https://github.com/OpenIoTHub/server-go) — distributed by [TomeVault](https://tomevault.io).
