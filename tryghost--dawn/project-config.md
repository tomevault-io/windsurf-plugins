---
trigger: always_on
description: This package is the Dawn Ghost theme. In the standalone mirror repository, this tree is pushed from `TryGhost/Themes/packages/dawn` by subtree sync; make durable theme-content changes in `TryGhost/Themes` unless the task is explicitly repo-level metadata or GitHub settings.
---
...
---
> Source: [TryGhost/Dawn](https://github.com/TryGhost/Dawn) — distributed by [TomeVault](https://tomevault.io).
