---
trigger: always_on
description: This document provides comprehensive instructions for GitHub Copilot coding agents working on the [meshery-extensions-packages](https://github.com/layer5labs/meshery-extensions-packages) repository.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/layer5labs)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/layer5labs)
