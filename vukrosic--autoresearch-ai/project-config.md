---
trigger: always_on
description: You are working in the AutoResearch-AI repository. This file is the entry point for any AI coding agent (Codex, Claude Code, Cursor, Hermes, others) sent to make changes here.
---
...
---
> Source: [vukrosic/autoresearch-ai](https://github.com/vukrosic/autoresearch-ai) — distributed by [TomeVault](https://tomevault.io).
