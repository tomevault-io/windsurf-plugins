...
Original source: `CLAUDE.md` in [Vexa-ai/vexa](https://github.com/Vexa-ai/vexa).
...
```
npx tomevault install Vexa-ai/vexa
```
Source: [github.com/Vexa-ai/vexa](https://github.com/Vexa-ai/vexa).
