---
trigger: always_on
description: Codex App Manager:官方 OpenAI Codex 桌面应用的安装/更新/卸载管理器(Tauri v2)。
---
...
---
> Source: [Wangnov/Codex-App-Manager](https://github.com/Wangnov/Codex-App-Manager) — distributed by [TomeVault](https://tomevault.io).
