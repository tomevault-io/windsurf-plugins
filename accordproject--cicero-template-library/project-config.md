---
trigger: always_on
description: - `src/<template-name>/` — each template is an npm workspace
---
...
---
> Source: [accordproject/cicero-template-library](https://github.com/accordproject/cicero-template-library) — distributed by [TomeVault](https://tomevault.io).
