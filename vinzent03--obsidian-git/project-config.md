---
trigger: always_on
description: This repository contains the `obsidian-git` Obsidian community plugin. It
---
...
---
> Source: [Vinzent03/obsidian-git](https://github.com/Vinzent03/obsidian-git) — distributed by [TomeVault](https://tomevault.io).
