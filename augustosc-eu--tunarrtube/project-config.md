---
trigger: always_on
description: If the task already names the files/symbols to touch, SKIP vexp. Otherwise one
---
...
---
> Source: [augustosc-eu/TunarrTube](https://github.com/augustosc-eu/TunarrTube) — distributed by [TomeVault](https://tomevault.io).
