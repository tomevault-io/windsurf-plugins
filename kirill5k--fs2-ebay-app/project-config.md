---
trigger: always_on
description: `fs2-ebay-app` is a deal-finding and stock monitoring application for multiple retailers (eBay, Argos, JD Sports, Nvidia, etc.). It consists of three Scala backend services and a Next.js frontend, all built as a multi-module project.
---
