---
trigger: always_on
description: Authoritative document for every agent action in this repository.
---
...
---
> Source: [Gixsy95/abap_wiki](https://github.com/Gixsy95/abap_wiki) — distributed by [TomeVault](https://tomevault.io).
