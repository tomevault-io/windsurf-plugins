---
trigger: always_on
description: **Pyre** is Meta's performant type checker for Python (PEP 484 compliant).
---
...
---
> Source: [facebook/pyre-check](https://github.com/facebook/pyre-check) — distributed by [TomeVault](https://tomevault.io).
