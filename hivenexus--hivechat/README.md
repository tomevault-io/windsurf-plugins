...
Original source: `CLAUDE.md` in [HiveNexus/HiveChat](https://github.com/HiveNexus/HiveChat).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/HiveNexus/HiveChat](https://github.com/HiveNexus/HiveChat)
