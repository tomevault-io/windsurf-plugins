---
trigger: always_on
description: Use the project specification and guidelines to build the app.
---
...
---
> Source: [mckaywrigley/slack-customer-service-ai-agent](https://github.com/mckaywrigley/slack-customer-service-ai-agent) — distributed by [TomeVault](https://tomevault.io).
