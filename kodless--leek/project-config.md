---
trigger: always_on
description: Leek agent is a simple python client that connects to brokers and fanout events to Leek API. the communication between
---
...
---
> Source: [kodless/leek](https://github.com/kodless/leek) — distributed by [TomeVault](https://tomevault.io).
