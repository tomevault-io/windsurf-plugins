---
trigger: always_on
description: TinyTuya is a Python library to control Tuya-based WiFi smart devices over the local network, plus a Tuya Cloud client, network scanner, setup wizard, and CLI. Read [DESIGN.md](DESIGN.md) for the architecture before changing core code, and [PROTOCOL.md](PROTOCOL.md) before touching anything on the wire path.
---
...
---
> Source: [jasonacox/tinytuya](https://github.com/jasonacox/tinytuya) — distributed by [TomeVault](https://tomevault.io).
