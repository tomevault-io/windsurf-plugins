---
trigger: always_on
description: 过程中请使用中文和我沟通，但 console 里请优先使用英文。
---
...
---
> Source: [zj1123581321/VideoTranscriptAPI](https://github.com/zj1123581321/VideoTranscriptAPI) — distributed by [TomeVault](https://tomevault.io).
