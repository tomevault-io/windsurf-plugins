---
trigger: always_on
description: > 本文件由 Codex / Cursor / 任何 AI Coding Agent 在每次会话开始自动读取。
---
...
- `core/` 改动必须 pytest 通过
- web 改动必须浏览器实测一次
- 页面设计与改动先读 [AI Design 执行规范](./docs/AI_DESIGN.md)，提交页面合同和状态矩阵；规范目标不等于全站已实现。
...
---
> Source: [wanghui2323/learnbuddy](https://github.com/wanghui2323/learnbuddy) — distributed by [TomeVault](https://tomevault.io).
