---
trigger: always_on
description: Ethnicolr provides name-pattern estimates from published lookup tables and
---
...
---
> Source: [appeler/ethnicolr](https://github.com/appeler/ethnicolr) — distributed by [TomeVault](https://tomevault.io).
