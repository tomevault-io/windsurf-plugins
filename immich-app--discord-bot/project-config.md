---
trigger: always_on
description: Immich Discord bot built with NestJS, discordx, and PostgreSQL (Kysely ORM).
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/immich-app)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/immich-app)
