---
trigger: always_on
description: After the project is cloned, you must fetch external packages.
---
...
---
> Source: [fvutils/pyhdl-if](https://github.com/fvutils/pyhdl-if) — distributed by [TomeVault](https://tomevault.io).
