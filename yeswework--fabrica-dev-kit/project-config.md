---
trigger: always_on
description: **This repo is FDK itself, not a project that uses it.** Editing here changes the toolkit for every project on the machine, so a change is not proven until it has been run against a real FDK project.
---
...
---
> Source: [yeswework/fabrica-dev-kit](https://github.com/yeswework/fabrica-dev-kit) — distributed by [TomeVault](https://tomevault.io).
