---
trigger: always_on
description: HumanString is a Swift Package Manager library that provides human-friendly string indexing. Instead of using complex String.Index types, it allows using integers for string subscripting, supporting both positive indices (from start) and negative indices (from end).
---
...
---
> Source: [zonble/HumanString](https://github.com/zonble/HumanString) — distributed by [TomeVault](https://tomevault.io).
