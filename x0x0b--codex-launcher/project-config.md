---
trigger: always_on
description: - `src/main/kotlin/com/github/x0x0b/codexlauncher/` — plugin actions (`*Action`), terminal service, CLI arg builder, settings UI/options.
---
...
---
> Source: [x0x0b/codex-launcher](https://github.com/x0x0b/codex-launcher) — distributed by [TomeVault](https://tomevault.io).
