---
trigger: always_on
description: Do not mention Claude, Codex, Copilot, or any other coding agent in commit messages. No `Co-Authored-By` trailers for AI assistants, no "Generated with…" footers, no tool branding of any kind. Write commit messages as if a human authored them.
---
...
---
> Source: [yap-tools/yap-core](https://github.com/yap-tools/yap-core) — distributed by [TomeVault](https://tomevault.io).
