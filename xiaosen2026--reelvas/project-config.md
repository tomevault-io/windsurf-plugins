---
trigger: always_on
description: 本项目为 Next.js `output: 'export'`。**免费 TTS 落盘**依赖 Node 侧 `POST /api/free-tts` 或 Electron IPC `tts:free`。
---
...
---
> Source: [xiaosen2026/Reelvas](https://github.com/xiaosen2026/Reelvas) — distributed by [TomeVault](https://tomevault.io).
