---
trigger: always_on
description: This guide provides instructions for AI agents working on the StackRox UI codebase.
---
...
---
> Source: [stackrox/stackrox](https://github.com/stackrox/stackrox) — distributed by [TomeVault](https://tomevault.io).
