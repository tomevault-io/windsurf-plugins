---
trigger: always_on
description: Guidance for coding agents working in this repo. Keep it short; add a rule only
---
...
---
> Source: [jjolano/HookKit](https://github.com/jjolano/HookKit) — distributed by [TomeVault](https://tomevault.io).
