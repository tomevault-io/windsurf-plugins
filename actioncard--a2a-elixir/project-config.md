---
trigger: always_on
description: - All modules live under the `A2A.*` namespace
---
...
---
> Source: [actioncard/a2a-elixir](https://github.com/actioncard/a2a-elixir) — distributed by [TomeVault](https://tomevault.io).
