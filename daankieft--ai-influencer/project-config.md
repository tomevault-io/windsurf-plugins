---
trigger: always_on
description: This file gives a new Claude Code session enough context to be useful
---
...
---
> Source: [DaanKieft/ai-influencer](https://github.com/DaanKieft/ai-influencer) — distributed by [TomeVault](https://tomevault.io).
