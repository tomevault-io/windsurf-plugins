---
trigger: always_on
description: RTL (Ride The Lightning) is a device-agnostic web UI for Lightning node operations:
---
...
---
> Source: [Ride-The-Lightning/RTL](https://github.com/Ride-The-Lightning/RTL) — distributed by [TomeVault](https://tomevault.io).
