---
trigger: always_on
description: Project-wide preferences and conventions for agents working in this repository.
---
...
---
> Source: [zekzekus/stube](https://github.com/zekzekus/stube) — distributed by [TomeVault](https://tomevault.io).
