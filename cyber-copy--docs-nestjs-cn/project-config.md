---
trigger: always_on
description: * 对于内部内容跳转，请将"docs.nestjs.com" 和 "docs.nestjs.cn" 改为使用相对路径，并需要并修正该真实路径，   例如 `./guide/introduction`。
---
...
---
> Source: [cyber-copy/docs.nestjs.cn](https://github.com/cyber-copy/docs.nestjs.cn) — distributed by [TomeVault](https://tomevault.io).
