---
trigger: always_on
description: - **Salesforce Operations:** ALWAYS use the `mcp__sfMcp` server tools for ALL Salesforce related work, including:
---
...
---
> Source: [codefriar/ApexKit](https://github.com/codefriar/ApexKit) — distributed by [TomeVault](https://tomevault.io).
