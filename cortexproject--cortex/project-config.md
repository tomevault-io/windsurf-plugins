---
trigger: always_on
description: franz-go is a pure Go Kafka client library. The `kgo` package is the main client package.
---
...
---
> Source: [cortexproject/cortex](https://github.com/cortexproject/cortex) — distributed by [TomeVault](https://tomevault.io).
