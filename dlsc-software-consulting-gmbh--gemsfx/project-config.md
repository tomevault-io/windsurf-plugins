---
trigger: always_on
description: GemsFX is a JavaFX custom controls library. The `gemsfx` module targets Java 11 and JavaFX 17, while `gemsfx-demo` uses
---
...
---
> Source: [dlsc-software-consulting-gmbh/GemsFX](https://github.com/dlsc-software-consulting-gmbh/GemsFX) — distributed by [TomeVault](https://tomevault.io).
