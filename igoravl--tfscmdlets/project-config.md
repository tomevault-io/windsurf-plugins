---
trigger: always_on
description: TfsCmdlets is a PowerShell module providing cmdlets for automating Azure DevOps (Services and Server) and legacy Team Foundation Server (TFS 2010–2018). The core logic is written in C# with Roslyn source generators that produce cmdlet and controller boilerplate. The compiled DLL is loaded as a binary PowerShell module.
---
...
---
> Source: [igoravl/TfsCmdlets](https://github.com/igoravl/TfsCmdlets) — distributed by [TomeVault](https://tomevault.io).
