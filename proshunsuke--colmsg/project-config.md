---
trigger: always_on
description: このファイルは、このリポジトリでコードを扱う際のClaude Code (claude.ai/code) への指針を提供します。
---
...
---
> Source: [proshunsuke/colmsg](https://github.com/proshunsuke/colmsg) — distributed by [TomeVault](https://tomevault.io).
