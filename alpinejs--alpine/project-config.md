---
trigger: always_on
description: When evaluating pull requests for Alpine.js, assess the following:
---
...
---
> Source: [alpinejs/alpine](https://github.com/alpinejs/alpine) — distributed by [TomeVault](https://tomevault.io).
