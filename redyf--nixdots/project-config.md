---
trigger: always_on
description: - NixOS flake for personal hosts `desktop` and `selene`, plus a safe public `example` host.
---
...
---
> Source: [redyf/nixdots](https://github.com/redyf/nixdots) — distributed by [TomeVault](https://tomevault.io).
