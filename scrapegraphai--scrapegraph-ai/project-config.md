---
trigger: always_on
description: Instructions for AI coding agents (Claude Code, Codex, Cursor, Copilot agents, …)
---
...
---
> Source: [ScrapeGraphAI/Scrapegraph-ai](https://github.com/ScrapeGraphAI/Scrapegraph-ai) — distributed by [TomeVault](https://tomevault.io).
