---
trigger: always_on
description: 3X-UI is a web-based control panel for managing Xray-core servers. It's a Go application using Gin web framework with embedded static assets and SQLite database. The panel manages VPN/proxy inbounds, monitors traffic, and provides Telegram bot integration.
---
...
---
> Source: [Copperchaleu/3x-ui-cluster](https://github.com/Copperchaleu/3x-ui-cluster) — distributed by [TomeVault](https://tomevault.io).
