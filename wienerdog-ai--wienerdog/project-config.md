---
trigger: always_on
description: <!-- GENERATED from CLAUDE.md — do not hand-edit. Regenerate with: npm run gen:agents. -->
---
...
---
> Source: [wienerdog-ai/wienerdog](https://github.com/wienerdog-ai/wienerdog) — distributed by [TomeVault](https://tomevault.io).
