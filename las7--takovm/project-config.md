---
trigger: always_on
description: Secure Python code execution in isolated Docker containers. Lets AI agents and platforms run untrusted code safely by sandboxing it behind a gVisor-backed container boundary. REST API for sync/async job execution, plus a Python SDK for library-mode usage.
---
...
---
> Source: [las7/TakoVM](https://github.com/las7/TakoVM) — distributed by [TomeVault](https://tomevault.io).
