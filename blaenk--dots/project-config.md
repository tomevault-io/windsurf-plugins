---
trigger: always_on
description: Store worktrees in ~/code/worktrees/<repo-name>/<worktree-name>
---
...
---
> Source: [blaenk/dots](https://github.com/blaenk/dots) — distributed by [TomeVault](https://tomevault.io).
