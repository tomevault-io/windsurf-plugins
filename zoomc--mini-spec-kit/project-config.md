---
trigger: always_on
description: This project uses `.mini-spec-kit/` for spec-driven development. Before modifying code:
---
...
---
> Source: [zoomc/mini-spec-kit](https://github.com/zoomc/mini-spec-kit) — distributed by [TomeVault](https://tomevault.io).
