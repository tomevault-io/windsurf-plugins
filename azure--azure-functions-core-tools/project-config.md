---
trigger: always_on
description: - Ensure Core Tools version bumps follow [SemVer](https://semver.org/) consistently.
---
...
---
> Source: [Azure/azure-functions-core-tools](https://github.com/Azure/azure-functions-core-tools) — distributed by [TomeVault](https://tomevault.io).
