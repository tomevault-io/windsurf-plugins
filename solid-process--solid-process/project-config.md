---
trigger: always_on
description: Ruby gem for encapsulating business logic into processes, with Rails integration, input validation, dependency injection, and observability.
---
...
---
> Source: [solid-process/solid-process](https://github.com/solid-process/solid-process) — distributed by [TomeVault](https://tomevault.io).
