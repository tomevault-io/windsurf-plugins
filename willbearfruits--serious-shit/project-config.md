---
trigger: always_on
description: This is the static website for **Serious S.H.I.T.** (Super Hyper Incredible Things), an experimental music, circuit-bending, and electronics brand by Yaniv Schonfeld. The site serves as a hub for workshops, gear modification services, and selling unique noise devices.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/willbearfruits)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/willbearfruits)
