---
trigger: always_on
description: Code must be [PEP8](https://www.python.org/dev/peps/pep-0008/) compliant with the exception of allowing for line lengths up to 110 characters.
---
...
---
> Source: [bcgov/wps](https://github.com/bcgov/wps) — distributed by [TomeVault](https://tomevault.io).
