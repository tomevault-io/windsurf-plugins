---
trigger: always_on
description: Format: `<type>(<scope>): <description>` (lowercase, imperative mood)
---
...
---
> Source: [jdx/fnox](https://github.com/jdx/fnox) — distributed by [TomeVault](https://tomevault.io).
