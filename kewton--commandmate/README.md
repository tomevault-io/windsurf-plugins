...
Original source: `AGENTS.md` in [Kewton/CommandMate](https://github.com/Kewton/CommandMate).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/Kewton/CommandMate](https://github.com/Kewton/CommandMate)
