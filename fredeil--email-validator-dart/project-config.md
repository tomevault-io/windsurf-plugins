---
trigger: always_on
description: dart pub get          # install dependencies
---
...
---
> Source: [fredeil/email-validator.dart](https://github.com/fredeil/email-validator.dart) — distributed by [TomeVault](https://tomevault.io).
