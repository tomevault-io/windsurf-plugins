...
Pomodoro timer with a cat companion :)
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/builder-group/focuscat](https://github.com/builder-group/focuscat)
