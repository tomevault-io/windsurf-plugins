---
trigger: always_on
description: This repo provides the **four-meme-integration** skill for AI agents: create and trade meme tokens on **four.meme (BSC only)** using the official API and on-chain contracts (**TokenManager2**, **TokenManagerHelper3**). TokenManager V1 is **not** supported by this skill.
---
...
---
> Source: [four-meme-community/four-meme-ai](https://github.com/four-meme-community/four-meme-ai) — distributed by [TomeVault](https://tomevault.io).
