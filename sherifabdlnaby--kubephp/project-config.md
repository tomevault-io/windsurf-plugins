---
trigger: always_on
description: Guidance for AI agents working in this repo. KubePHP is a **template Docker image** (Nginx + PHP-FPM) for Cloud-Native PHP apps; the repo itself ships no application code (the `app/` dir is a mounted demo).
---
...
---
> Source: [sherifabdlnaby/kubephp](https://github.com/sherifabdlnaby/kubephp) — distributed by [TomeVault](https://tomevault.io).
