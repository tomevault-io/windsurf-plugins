---
trigger: always_on
description: Guidance for coding agents working on CourseTable. For human setup, see [CONTRIBUTING.md](CONTRIBUTING.md) and [README.md](README.md).
---
...
---
> Source: [coursetable/coursetable](https://github.com/coursetable/coursetable) — distributed by [TomeVault](https://tomevault.io).
