---
trigger: always_on
description: Miruri generates target software artifact sets from existing C/C++ projects. It must remain extensible to GUI, graphics, shaders, audio, input, games, plugins and packaging.
---
...
---
> Source: [yuna-r/miruri](https://github.com/yuna-r/miruri) — distributed by [TomeVault](https://tomevault.io).
