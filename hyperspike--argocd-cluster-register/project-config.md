---
trigger: always_on
description: **ArgoCD-Cluster-Register** is a Kubernetes operator (controller) built with Go and Kubebuilder. Its primary purpose is to automate the registration of [Cluster-API (CAPI)](https://cluster-api.sigs.k8s.io/) clusters with [ArgoCD](https://argo-cd.readthedocs.io/).
---
...
---
> Source: [hyperspike/argocd-cluster-register](https://github.com/hyperspike/argocd-cluster-register) — distributed by [TomeVault](https://tomevault.io).
