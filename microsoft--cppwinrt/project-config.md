---
trigger: always_on
description: - `cppwinrt/` — The cppwinrt.exe code generator (C++ source)
---
...
---
> Source: [microsoft/cppwinrt](https://github.com/microsoft/cppwinrt) — distributed by [TomeVault](https://tomevault.io).
