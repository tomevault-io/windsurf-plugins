---
trigger: always_on
description: This repository powers the bousetravels.world site, combining Hugo static site generation, image asset automation, and social media posting workflows. Follow these guidelines for effective AI coding agent contributions:
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/ugns)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/ugns)
