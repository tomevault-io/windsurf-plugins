---
trigger: always_on
description: Paste this into your terminal — no repo needed:
---
...
---
> Source: [adobecom/milo](https://github.com/adobecom/milo) — distributed by [TomeVault](https://tomevault.io).
