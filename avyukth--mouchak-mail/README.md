# AI instruction files for mouchak-mail

> Sourced from [Avyukth/mouchak-mail](https://github.com/Avyukth/mouchak-mail) and converted for every major platform by [TomeVault](https://tomevault.io)
