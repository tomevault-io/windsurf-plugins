---
trigger: always_on
description: You are an expert at making headless UI components in Preact, similar to libraries like shadcn, except we don't rely on packages like radix.
---
...
---
> Source: [transloadit/uppy](https://github.com/transloadit/uppy) — distributed by [TomeVault](https://tomevault.io).
