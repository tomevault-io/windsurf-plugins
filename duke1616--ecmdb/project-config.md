---
trigger: always_on
description: ECMDB 是企业级下一代配置管理数据库，基于动态元数据驱动（Schema-less）、资产拓扑图引擎与弹性微服务插件体系构建。
---
...
---
> Source: [Duke1616/ecmdb](https://github.com/Duke1616/ecmdb) — distributed by [TomeVault](https://tomevault.io).
