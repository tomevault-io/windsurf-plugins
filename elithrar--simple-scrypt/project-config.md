---
trigger: always_on
description: Guidelines for AI agents operating in the `simple-scrypt` repository.
---
...
---
> Source: [elithrar/simple-scrypt](https://github.com/elithrar/simple-scrypt) — distributed by [TomeVault](https://tomevault.io).
