---
trigger: always_on
description: - The **server** owns the persisted state under `DATA_DIR` (defaults to `<repo>/data`).
---
...
---
> Source: [bmesuere/optivolt](https://github.com/bmesuere/optivolt) — distributed by [TomeVault](https://tomevault.io).
