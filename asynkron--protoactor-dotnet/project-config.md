---
trigger: always_on
description: - Verify that .NET 8 is installed by running `dotnet --version`.
---
...
---
> Source: [asynkron/protoactor-dotnet](https://github.com/asynkron/protoactor-dotnet) — distributed by [TomeVault](https://tomevault.io).
