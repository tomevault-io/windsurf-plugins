---
trigger: always_on
description: - Nx workspace keeps both apps and libs under `projects/`. The shipping Angular library lives in `projects/ng-draw-flow`
---
...
---
> Source: [taiga-family/ng-draw-flow](https://github.com/taiga-family/ng-draw-flow) — distributed by [TomeVault](https://tomevault.io).
