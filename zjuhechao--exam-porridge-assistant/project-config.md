---
trigger: always_on
description: AI 驱动的学习助手，支持知识库管理、智能出题、错题本、复习纲要和学习笔记生成。
---
...
---
> Source: [zjuhechao/exam-porridge-assistant](https://github.com/zjuhechao/exam-porridge-assistant) — distributed by [TomeVault](https://tomevault.io).
