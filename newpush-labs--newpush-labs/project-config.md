---
trigger: always_on
description: Welcome to the `newpush-labs` repository. This project provisions and manages containerized, self-hosted lab environments for students and professionals using a combination of Ansible, Terraform, Packer, and Docker Compose.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/newpush-labs)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/newpush-labs)
