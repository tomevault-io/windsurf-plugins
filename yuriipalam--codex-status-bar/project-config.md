---
trigger: always_on
description: Read `README.md` before making changes. Follow the product behavior, privacy boundaries, build commands, distribution notes, and local-state assumptions documented there.
---
...
---
> Source: [yuriipalam/codex-status-bar](https://github.com/yuriipalam/codex-status-bar) — distributed by [TomeVault](https://tomevault.io).
