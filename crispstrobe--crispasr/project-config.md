---
trigger: always_on
description: CCACHE_DIR=/mnt/volume1/.ccache cmake -G Ninja -B build \
---
...
---
> Source: [CrispStrobe/CrispASR](https://github.com/CrispStrobe/CrispASR) — distributed by [TomeVault](https://tomevault.io).
