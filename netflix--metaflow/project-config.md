---
trigger: always_on
description: > `CLAUDE.md` is a symlink to this file. Edit `AGENTS.md`; both Codex/Claude
---
...
---
> Source: [Netflix/metaflow](https://github.com/Netflix/metaflow) — distributed by [TomeVault](https://tomevault.io).
