---
trigger: always_on
description: - Real Gradle project is single-module `:app` (`settings.gradle.kts`); `app-compose/` exists in repo but is not included in the build.
---
...
---
> Source: [AniTrend/anitrend-app](https://github.com/AniTrend/anitrend-app) — distributed by [TomeVault](https://tomevault.io).
