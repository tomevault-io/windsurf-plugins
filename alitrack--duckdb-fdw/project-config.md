---
trigger: always_on
description: `duckdb_fdw` is a PostgreSQL extension that allows PostgreSQL to interface natively with DuckDB. It enables PostgreSQL users to query DuckDB databases, Parquet files, and Iceberg tables directly as foreign tables.
---
...
---
> Source: [alitrack/duckdb_fdw](https://github.com/alitrack/duckdb_fdw) — distributed by [TomeVault](https://tomevault.io).
