---
trigger: always_on
description: - **Build the Atomic package**: `pnpm turbo build --filter=@coveo/atomic`
---
...
---
> Source: [coveo/ui-kit](https://github.com/coveo/ui-kit) — distributed by [TomeVault](https://tomevault.io).
