---
trigger: always_on
description: Use the vault MCP tools when the user needs:
---
...
---
> Source: [x746b/command-vault](https://github.com/x746b/command-vault) — distributed by [TomeVault](https://tomevault.io).
