---
trigger: always_on
description: Requirements Rubric for Web Application Specification Documents
---
...
Is it Unique and Identifiable (e.g., a clear identifier is present)? (Yes/No)
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/lizTheDeveloper)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/lizTheDeveloper)
