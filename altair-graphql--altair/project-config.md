---
trigger: always_on
description: - Components are in `packages/altair-app/src/app/modules/altair/components/`
---
...
---
> Source: [altair-graphql/altair](https://github.com/altair-graphql/altair) — distributed by [TomeVault](https://tomevault.io).
