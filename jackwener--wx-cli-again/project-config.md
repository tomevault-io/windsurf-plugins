---
trigger: always_on
description: 1. **`cargo check`** — 改任何 `.rs` 文件后立刻运行，不通过不提交
---
...
---
> Source: [jackwener/wx-cli-again](https://github.com/jackwener/wx-cli-again) — distributed by [TomeVault](https://tomevault.io).
