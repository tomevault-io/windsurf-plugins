---
trigger: always_on
description: This repository is a Swift wrapper around `libwebp` for encoding, decoding, and inspecting WebP data.
---
...
---
> Source: [ainame/Swift-WebP](https://github.com/ainame/Swift-WebP) — distributed by [TomeVault](https://tomevault.io).
