---
trigger: always_on
description: - Use functional components with `"use client"` if needed.
---
...
- Prefer `gpt-5` model with high reasoning effort for all AI calls.
...
---
> Source: [PioneerSquareLabs/idea-roulette](https://github.com/PioneerSquareLabs/idea-roulette) — distributed by [TomeVault](https://tomevault.io).
