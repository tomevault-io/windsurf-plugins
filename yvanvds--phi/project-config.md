---
trigger: always_on
description: Workflow rules for Claude Code sessions on the Phi project. Read at session
---
...
---
> Source: [yvanvds/phi](https://github.com/yvanvds/phi) — distributed by [TomeVault](https://tomevault.io).
