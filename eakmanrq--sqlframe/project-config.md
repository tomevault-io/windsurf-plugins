---
trigger: always_on
description: make install-dev       # Install all deps (uv sync --all-extras)
---
...
---
> Source: [eakmanrq/sqlframe](https://github.com/eakmanrq/sqlframe) — distributed by [TomeVault](https://tomevault.io).
