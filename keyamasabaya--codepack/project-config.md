---
trigger: always_on
description: **Codepack** is a CLI tool that extracts folder structure and file contents into a single text file, optimized for AI processing (ChatGPT, Claude, etc.).
---
