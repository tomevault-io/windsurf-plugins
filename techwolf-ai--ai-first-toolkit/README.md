...
Original source: `CLAUDE.md` in [techwolf-ai/ai-first-toolkit](https://github.com/techwolf-ai/ai-first-toolkit).
...
```
npx tomevault install techwolf-ai/ai-first-toolkit
```
Source: [github.com/techwolf-ai/ai-first-toolkit](https://github.com/techwolf-ai/ai-first-toolkit).
