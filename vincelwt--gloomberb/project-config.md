---
trigger: always_on
description: - Be selective: add or keep a test only when it protects behavior that is easy to break and hard to catch in review.
---
...
---
> Source: [vincelwt/gloomberb](https://github.com/vincelwt/gloomberb) — distributed by [TomeVault](https://tomevault.io).
