...
Original source: `AGENTS.md` in [vitorfdl/narratrix](https://github.com/vitorfdl/narratrix).
...
From [vitorfdl/narratrix](https://github.com/vitorfdl/narratrix) — a repo with 83+ stars on GitHub.
