---
trigger: always_on
description: Models are the application API. Controllers access them directly—no service layers, interactors, or repositories between them. Business logic lives in models, not procedural wrappers.
---
...
---
> Source: [jargon-io/jargon-v1](https://github.com/jargon-io/jargon-v1) — distributed by [TomeVault](https://tomevault.io).
