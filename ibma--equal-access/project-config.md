---
trigger: always_on
description: This file lists agent-readable documentation for the equal-access codebase. Each entry describes the area covered and links to the full reference document.
---
...
---
> Source: [IBMa/equal-access](https://github.com/IBMa/equal-access) — distributed by [TomeVault](https://tomevault.io).
