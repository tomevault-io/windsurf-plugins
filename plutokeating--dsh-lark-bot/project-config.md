---
trigger: always_on
description: 给专业 Agent 的开发规范。本文件约束所有由 AI Agent 执行的项目开发、整理、修复、文档和交付工作。
---
...
---
> Source: [PlutoKeating/dsh-lark-bot](https://github.com/PlutoKeating/dsh-lark-bot) — distributed by [TomeVault](https://tomevault.io).
