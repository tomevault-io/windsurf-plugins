---
trigger: always_on
description: `typed-factorio` publishes TypeScript type definitions for the Factorio modding
---
...
---
> Source: [GlassBricks/typed-factorio](https://github.com/GlassBricks/typed-factorio) — distributed by [TomeVault](https://tomevault.io).
