---
trigger: always_on
description: スキル名は原則として `service-target-action` の順で付けます。
---
...
---
> Source: [u7chan/old-agent-skills](https://github.com/u7chan/old-agent-skills) — distributed by [TomeVault](https://tomevault.io).
