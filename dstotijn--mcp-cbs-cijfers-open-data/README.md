...
Original source: `.cursor/rules/*.mdc` in [dstotijn/mcp-cbs-cijfers-open-data](https://github.com/dstotijn/mcp-cbs-cijfers-open-data).
...
```
npx tomevault install dstotijn/mcp-cbs-cijfers-open-data
```
Source: [github.com/dstotijn/mcp-cbs-cijfers-open-data](https://github.com/dstotijn/mcp-cbs-cijfers-open-data).
