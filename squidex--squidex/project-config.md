---
trigger: always_on
description: Headless CMS. Angular frontend in `frontend/`, ASP.NET Core backend in `backend/`.
---
...
---
> Source: [Squidex/squidex](https://github.com/Squidex/squidex) — distributed by [TomeVault](https://tomevault.io).
