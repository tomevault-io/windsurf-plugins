---
trigger: always_on
description: This document outlines the conventions and best practices for Gemini CLI when interacting with Markdown (`.md`) files within this project. Adhering to these guidelines ensures consistency, clarity, and maintainability of documentation.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/wilson323)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/wilson323)
