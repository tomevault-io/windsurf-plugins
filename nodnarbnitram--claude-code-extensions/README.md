# AI instruction files for claude-code-extensions

> Sourced from [nodnarbnitram/claude-code-extensions](https://github.com/nodnarbnitram/claude-code-extensions) and converted for every major platform by [TomeVault](https://tomevault.io)
...
- [ha-addon](https://github.com/nodnarbnitram/claude-code-extensions/tree/main/.claude/skills/ha-addon)
- [esphome-box3-builder](https://github.com/nodnarbnitram/claude-code-extensions/tree/main/.claude/skills/esphome-box3-builder)
- [grafana-plugin-scaffolding](https://github.com/nodnarbnitram/claude-code-extensions/tree/main/.claude/skills/grafana-plugin-scaffolding)
