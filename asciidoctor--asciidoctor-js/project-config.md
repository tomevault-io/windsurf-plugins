---
trigger: always_on
description: This package is a **native JavaScript implementation of Asciidoctor**, converted from the original [Ruby source](https://github.com/asciidoctor/asciidoctor) by Claude. It is a pure ESM library targeting Node.js ≥ 20 with no Opal/Ruby compilation step.
---
...
---
> Source: [asciidoctor/asciidoctor.js](https://github.com/asciidoctor/asciidoctor.js) — distributed by [TomeVault](https://tomevault.io).
