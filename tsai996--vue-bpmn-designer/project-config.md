---
trigger: always_on
description: Vue3(SFC `<script setup lang="ts">`), Vite6, TS, Pinia, Vue Router, Element Plus, bpmn-js(含diagram-js等), SCSS.
---
...
---
> Source: [tsai996/vue-bpmn-designer](https://github.com/tsai996/vue-bpmn-designer) — distributed by [TomeVault](https://tomevault.io).
