---
trigger: always_on
description: - The human-facing policy and disclosure obligations are in [AI-POLICY.md](AI-POLICY.md); read it too.
---
...
---
> Source: [leanprover-community/physlib](https://github.com/leanprover-community/physlib) — distributed by [TomeVault](https://tomevault.io).
