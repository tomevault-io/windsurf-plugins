---
trigger: always_on
description: This is a public repo for the Vercidium Audio Unreal Engine plugin, which is a wrapper around the vaudionative.dll file, which is the Vercidium Audio (vaudio) C SDK.
---
...
---
> Source: [vercidium-audio/vaudio-unreal](https://github.com/vercidium-audio/vaudio-unreal) — distributed by [TomeVault](https://tomevault.io).
