---
trigger: always_on
description: PHP 支付 SDK，支持支付宝、微信、银联、抖音、江苏银行、PayPal、Stripe。基于插件管道架构，关注支付流程、回调验签和 Provider 扩展一致性。
---
...
---
> Source: [yansongda/pay](https://github.com/yansongda/pay) — distributed by [TomeVault](https://tomevault.io).
