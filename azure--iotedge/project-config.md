---
trigger: always_on
description: Azure IoT Edge is a dual-language (C# and Rust) system with three main components:
---
...
---
> Source: [Azure/iotedge](https://github.com/Azure/iotedge) — distributed by [TomeVault](https://tomevault.io).
