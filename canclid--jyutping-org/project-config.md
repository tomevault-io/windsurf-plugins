---
trigger: always_on
description: - Don't repeat yourself. Avoid copy-and-paste. Constantly move code and extract to constants/functions.
---
...
---
> Source: [CanCLID/jyutping.org](https://github.com/CanCLID/jyutping.org) — distributed by [TomeVault](https://tomevault.io).
