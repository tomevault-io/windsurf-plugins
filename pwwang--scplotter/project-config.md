---
trigger: always_on
description: `scplotter` is an R package for publication-quality visualizations of single-cell sequencing data. It's built as a **wrapper layer** around [`plotthis`](https://github.com/pwwang/plotthis), extracting data from Seurat/Giotto objects and .h5ad files to pass to plotthis functions.
---
...
---
> Source: [pwwang/scplotter](https://github.com/pwwang/scplotter) — distributed by [TomeVault](https://tomevault.io).
