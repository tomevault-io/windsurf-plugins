---
trigger: always_on
description: - Read `design.md` completely before proposing or making changes to public
---
...
---
> Source: [lukewilliamboswell/roc-ray](https://github.com/lukewilliamboswell/roc-ray) — distributed by [TomeVault](https://tomevault.io).
