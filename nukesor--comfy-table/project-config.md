---
trigger: always_on
description: This project does not approve of large-scale work done by LLMs.
---
...
---
> Source: [Nukesor/comfy-table](https://github.com/Nukesor/comfy-table) — distributed by [TomeVault](https://tomevault.io).
