---
trigger: always_on
description: Probabilistic data structures for C#. Managed IL throughout — no `unsafe`, no pointers,
---
...
---
> Source: [mattlorimor/ProbabilisticDataStructures](https://github.com/mattlorimor/ProbabilisticDataStructures) — distributed by [TomeVault](https://tomevault.io).
