---
trigger: always_on
description: Guidance for Claude Code when working in this repository. Behaviour that consumers need to know is
---
...
---
> Source: [kibertoad/layered-loader](https://github.com/kibertoad/layered-loader) — distributed by [TomeVault](https://tomevault.io).
