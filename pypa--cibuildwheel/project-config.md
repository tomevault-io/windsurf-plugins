---
trigger: always_on
description: - `prek -a` should be run after changes to reformat, lint, and type check
---
...
---
> Source: [pypa/cibuildwheel](https://github.com/pypa/cibuildwheel) — distributed by [TomeVault](https://tomevault.io).
