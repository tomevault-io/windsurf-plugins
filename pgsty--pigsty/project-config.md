---
trigger: always_on
description: `{{ inventory_hostname }}` | [Docs](https://pigsty.io/docs) | [中文](https://pigsty.io/docs)
---
...
PG {{ pg_version | default(18) }} with [555 extensions](https://pigsty.io/ext). Cluster: `{{ pg_cluster | default('pg-meta') }}`
...
---
> Source: [pgsty/pigsty](https://github.com/pgsty/pigsty) — distributed by [TomeVault](https://tomevault.io).
