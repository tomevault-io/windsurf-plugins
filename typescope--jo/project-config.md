...
- [Syntax Summary](docs/language/syntax/syntax-summary.md) - Formal grammar
...
Warning: Never re-build the whole project during development. Use the following scripts instead:
