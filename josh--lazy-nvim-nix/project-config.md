---
trigger: always_on
description: If `nix` is not installed, use the Determinate Systems installer:
---
...
---
> Source: [josh/lazy-nvim-nix](https://github.com/josh/lazy-nvim-nix) — distributed by [TomeVault](https://tomevault.io).
