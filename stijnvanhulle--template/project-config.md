---
trigger: always_on
description: A modern TypeScript monorepo template (pnpm workspaces, Turborepo, oxlint, oxfmt, tsdown, Vitest, and Changesets).
---
...
---
> Source: [stijnvanhulle/template](https://github.com/stijnvanhulle/template) — distributed by [TomeVault](https://tomevault.io).
