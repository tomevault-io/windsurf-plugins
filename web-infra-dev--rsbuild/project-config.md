---
trigger: always_on
description: - Use repo Node.js/pnpm versions (`package.json`, `.node-version`)
---
...
---
> Source: [web-infra-dev/rsbuild](https://github.com/web-infra-dev/rsbuild) — distributed by [TomeVault](https://tomevault.io).
