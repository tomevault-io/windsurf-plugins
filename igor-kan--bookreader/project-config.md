---
trigger: always_on
description: A modern book reading application with support for EPUB and PDF formats, featuring an intuitive interface for an enhanced reading experience.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/igor-kan)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/igor-kan)
