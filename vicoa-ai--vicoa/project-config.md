---
trigger: always_on
description: Guidance for Claude Code, Codex, and other coding agents working in this
---
...
---
> Source: [vicoa-ai/vicoa](https://github.com/vicoa-ai/vicoa) — distributed by [TomeVault](https://tomevault.io).
