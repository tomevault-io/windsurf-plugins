---
trigger: always_on
description: This repository uses a single source of truth for AI agent rules and skills located in
---
...
---
> Source: [cloudfoundry/uaa](https://github.com/cloudfoundry/uaa) — distributed by [TomeVault](https://tomevault.io).
