---
trigger: always_on
description: This file is guidance for AI/code agents working in this repository.
---
...
---
> Source: [Devolutions/multi-pwsh](https://github.com/Devolutions/multi-pwsh) — distributed by [TomeVault](https://tomevault.io).
