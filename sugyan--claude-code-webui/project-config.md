---
trigger: always_on
description: A web-based interface for the `claude` command line tool that provides streaming responses in a chat interface.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/sugyan)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/sugyan)
