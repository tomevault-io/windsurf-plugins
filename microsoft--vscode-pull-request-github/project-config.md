---
trigger: always_on
description: - **Follow the existing code style**: Use single quotes, semicolons, and 2-space indentation. See `.eslintrc.base.json` for detailed linting rules.
---
...
---
> Source: [microsoft/vscode-pull-request-github](https://github.com/microsoft/vscode-pull-request-github) — distributed by [TomeVault](https://tomevault.io).
