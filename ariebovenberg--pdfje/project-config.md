---
trigger: always_on
description: A declarative, pure-Python PDF writer library. Users describe documents with immutable data structures; pdfje handles layout, typesetting, and PDF generation. No mutation-based APIs — everything is built from frozen dataclasses.
---
...
---
> Source: [ariebovenberg/pdfje](https://github.com/ariebovenberg/pdfje) — distributed by [TomeVault](https://tomevault.io).
