---
trigger: always_on
description: A monorepo of **independently versioned** community-maintained OpenTelemetry
---
...
---
> Source: [open-telemetry/opentelemetry-dotnet-contrib](https://github.com/open-telemetry/opentelemetry-dotnet-contrib) — distributed by [TomeVault](https://tomevault.io).
