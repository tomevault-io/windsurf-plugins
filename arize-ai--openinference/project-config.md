---
trigger: always_on
description: pip install tox-uv==1.11.2
---
...
---
> Source: [Arize-ai/openinference](https://github.com/Arize-ai/openinference) — distributed by [TomeVault](https://tomevault.io).
