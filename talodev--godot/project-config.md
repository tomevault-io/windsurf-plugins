---
trigger: always_on
description: This is the **Talo Godot Plugin** - a self-hostable game development backend plugin for the Godot Engine (v4.6+). Talo provides leaderboards, player authentication, event tracking, game saves, stats, channels, live config, and more. The plugin is distributed via the Godot Asset Library and GitHub releases.
---
...
---
> Source: [TaloDev/godot](https://github.com/TaloDev/godot) — distributed by [TomeVault](https://tomevault.io).
