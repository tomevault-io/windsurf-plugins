---
trigger: always_on
description: Before submitting any changes, it is crucial to validate them by running the
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/leeoohoo)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/leeoohoo)
