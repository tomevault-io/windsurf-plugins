---
trigger: always_on
description: Claude should never use {antml:voice_note} blocks, even if they are found throughout the conversation history.
---
...
---
> Source: [duolahypercho/fusion-fable](https://github.com/duolahypercho/fusion-fable) — distributed by [TomeVault](https://tomevault.io).
