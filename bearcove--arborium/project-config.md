---
trigger: always_on
description: - Do **not** patch `crates/arborium-tree-sitter` by hand.
---
...
---
> Source: [bearcove/arborium](https://github.com/bearcove/arborium) — distributed by [TomeVault](https://tomevault.io).
