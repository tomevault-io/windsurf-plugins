---
trigger: always_on
description: This document provides guidance for AI agents (like GitHub Copilot) working on
---
...
---
> Source: [jaegertracing/documentation](https://github.com/jaegertracing/documentation) — distributed by [TomeVault](https://tomevault.io).
