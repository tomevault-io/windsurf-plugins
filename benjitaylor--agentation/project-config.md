---
trigger: always_on
description: 1. **npm package** (`package/`) - See `package/CLAUDE.md`
---
...
---
> Source: [benjitaylor/agentation](https://github.com/benjitaylor/agentation) — distributed by [TomeVault](https://tomevault.io).
