---
trigger: always_on
description: Project policy: `docs/ai-contributions.md`. For **this** repo, when work was
---
...
---
> Source: [highlightjs/highlight.js](https://github.com/highlightjs/highlight.js) — distributed by [TomeVault](https://tomevault.io).
