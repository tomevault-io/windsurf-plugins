---
trigger: always_on
description: RankHub is a cross-platform Flutter app for managing rhythm game data (舞萌 DX, 中二节奏, etc.) across multiple platforms. Architecture follows a **Platform-Game two-level abstraction** with plugin-style extensibility.
---
...
---
> Source: [Project-Fukakai/RankHub](https://github.com/Project-Fukakai/RankHub) — distributed by [TomeVault](https://tomevault.io).
