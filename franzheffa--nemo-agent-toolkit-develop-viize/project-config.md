---
trigger: always_on
description: Follow these rules when working with any documentation in the AIQ Toolkit project.
---

# General Documentation Rules

Follow these rules when working with any documentation in the AIQ Toolkit project.
...
- **Subsequent references**: "Agent toolkit" 
- Examples:
  - "In the Agent toolkit, you can…"
  - "Change directory to the Agent toolkit repo root…"
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/franzheffa) — claim your Tome and manage your conversions.
