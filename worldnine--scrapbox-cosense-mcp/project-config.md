---
trigger: always_on
description: MCP server for Cosense (Scrapbox). Also works as a CLI.
---
...
---
> Source: [worldnine/scrapbox-cosense-mcp](https://github.com/worldnine/scrapbox-cosense-mcp) — distributed by [TomeVault](https://tomevault.io).
