---
trigger: always_on
description: A Kubernetes operator that configures existing Keycloak instances.
---
...
---
> Source: [epam/edp-keycloak-operator](https://github.com/epam/edp-keycloak-operator) — distributed by [TomeVault](https://tomevault.io).
