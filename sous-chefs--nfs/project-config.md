---
trigger: always_on
description: NFS client and server utilities are provided by operating system package repositories. This cookbook does not configure an upstream NFS vendor repository.
---
...
---
> Source: [sous-chefs/nfs](https://github.com/sous-chefs/nfs) — distributed by [TomeVault](https://tomevault.io).
