---
trigger: always_on
description: - `./gradlew build` - Build the entire project
---
...
---
> Source: [didalgolab/ai-intellij-plugin](https://github.com/didalgolab/ai-intellij-plugin) — distributed by [TomeVault](https://tomevault.io).
