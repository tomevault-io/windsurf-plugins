---
trigger: always_on
description: This file provides instructions for AI agents working on the Apache HTTP Server documentation.
---
...
---
> Source: [apache/httpd](https://github.com/apache/httpd) — distributed by [TomeVault](https://tomevault.io).
