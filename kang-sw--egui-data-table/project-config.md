---
trigger: always_on
description: Read at every session start, before other action:
---
...
---
> Source: [kang-sw/egui-data-table](https://github.com/kang-sw/egui-data-table) — distributed by [TomeVault](https://tomevault.io).
