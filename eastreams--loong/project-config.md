---
trigger: always_on
description: This document is intentionally mirrored in `CLAUDE.md` and `AGENTS.md`.
---
...
---
> Source: [eastreams/loong](https://github.com/eastreams/loong) — distributed by [TomeVault](https://tomevault.io).
