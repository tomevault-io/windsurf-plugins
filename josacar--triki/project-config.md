---
trigger: always_on
description: **Triki** is a Crystal library for selectively rewriting (obfuscating/anonymizing) SQL dumps to protect user privacy. It parses dumps from MySQL, PostgreSQL, and SQL Server and rewrites sensitive columns with fake data.
---
...
---
> Source: [josacar/triki](https://github.com/josacar/triki) — distributed by [TomeVault](https://tomevault.io).
