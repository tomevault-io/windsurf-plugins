---
trigger: always_on
description: Restates the review-relevant subset of AGENTS.md on purpose: Copilot code
---
...
---
> Source: [GridTools/gt4py](https://github.com/GridTools/gt4py) — distributed by [TomeVault](https://tomevault.io).
