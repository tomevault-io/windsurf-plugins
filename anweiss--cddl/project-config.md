---
trigger: always_on
description: Before completing any task that modifies code, you MUST verify that all CI checks pass:
---
...
---
> Source: [anweiss/cddl](https://github.com/anweiss/cddl) — distributed by [TomeVault](https://tomevault.io).
