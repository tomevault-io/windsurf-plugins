---
trigger: always_on
description: This project is a Flutter application called "PetJournal". This app allows users to store and manage important information about their pets. It currently stores data in a local sqlite database using Drift.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/zjcz)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/zjcz)
