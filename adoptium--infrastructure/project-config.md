---
trigger: always_on
description: Always reference these instructions first and fallback to search or bash commands only when you encounter unexpected information that does not match the information here.
---
...
---
> Source: [adoptium/infrastructure](https://github.com/adoptium/infrastructure) — distributed by [TomeVault](https://tomevault.io).
