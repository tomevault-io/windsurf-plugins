# AI instruction files for vibe-coding-template
...
Original source: `.cursor/rules/*.mdc` in [humanstack/vibe-coding-template](https://github.com/humanstack/vibe-coding-template).
