---
trigger: always_on
description: Work In Progress by Watikita, V1.1
---
...
---
> Source: [Bannerlord-Modding/Documentation](https://github.com/Bannerlord-Modding/Documentation) — distributed by [TomeVault](https://tomevault.io).
