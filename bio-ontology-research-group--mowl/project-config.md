---
trigger: always_on
description: mOWL (Machine Learning with Ontologies) is a Python library for building ML models that operate on biomedical ontologies. It wraps the OWL API (Java) via JPype and exposes ontology projectors, corpus generators, and embedding models (ELEmbeddings, ELBoxEmbeddings, etc.) through a unified Python interface.
---
...
---
> Source: [bio-ontology-research-group/mowl](https://github.com/bio-ontology-research-group/mowl) — distributed by [TomeVault](https://tomevault.io).
