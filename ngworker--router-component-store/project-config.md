---
trigger: always_on
description: You are in an nx workspace using yarn as the package manager.
---
...
---
> Source: [ngworker/router-component-store](https://github.com/ngworker/router-component-store) — distributed by [TomeVault](https://tomevault.io).
