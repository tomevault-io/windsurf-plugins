---
trigger: always_on
description: Gitify is a multi-forge notification client — an Electron desktop app that surfaces GitHub, Gitea, and Bitbucket Cloud notifications in the system tray. Built with React, TypeScript, Vite, and pnpm.
---
...
---
> Source: [gitify-app/gitify](https://github.com/gitify-app/gitify) — distributed by [TomeVault](https://tomevault.io).
