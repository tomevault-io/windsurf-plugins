---
trigger: always_on
description: Use the `wq-forum-rag` MCP server as the source of truth for local WorldQuant forum knowledge.
---
...
---
> Source: [BeastOrange/wq-forum](https://github.com/BeastOrange/wq-forum) — distributed by [TomeVault](https://tomevault.io).
