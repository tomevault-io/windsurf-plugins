---
trigger: always_on
description: Python bindings for the [wood](https://github.com/petrasvestartas/wood) C++ library using [nanobind](https://github.com/wjakob/nanobind).
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/petrasvestartas)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/petrasvestartas)
