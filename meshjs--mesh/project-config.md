---
trigger: always_on
description: Mesh is an all-in-one TypeScript SDK for building UTXO-based blockchain applications, specifically targeting the Cardano ecosystem. The project follows a monorepo structure using Turborepo, with distinct packages providing specialized functionality.
---
...
---
> Source: [MeshJS/mesh](https://github.com/MeshJS/mesh) — distributed by [TomeVault](https://tomevault.io).
