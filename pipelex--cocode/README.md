...
> Tome by [Pipelex](https://github.com/Pipelex/cocode) — distributed by [TomeVault](https://tomevault.io)
...
Original source: `.cursor/rules/*.mdc` in [Pipelex/cocode](https://github.com/Pipelex/cocode).
...
From [Pipelex/cocode](https://github.com/Pipelex/cocode) — a repo with 17+ stars on GitHub.
