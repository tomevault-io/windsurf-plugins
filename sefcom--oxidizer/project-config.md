---
trigger: always_on
description: Oxidizer is a Rust decompiler built on top of angr. It generates concise, high-fidelity Rust pseudocode from stripped Rust binaries by recovering high-level Rust abstractions (enums, pattern matching, `?` operator, macros). Published at IEEE S&P 2026 by SEFCOM at Arizona State University.
---
...
---
> Source: [sefcom/oxidizer](https://github.com/sefcom/oxidizer) — distributed by [TomeVault](https://tomevault.io).
