---
trigger: always_on
description: このリポジトリは、[Typst](https://typst.app/)の公式ドキュメントを日本語に翻訳するプロジェクトにおける、コーディングエージェント用の初期セットアップガイドです。エージェントは作業を開始する前に必ずこのファイルを参照し、記載された手順や制約に従ってください。
---
...
---
> Source: [typst-jp/docs](https://github.com/typst-jp/docs) — distributed by [TomeVault](https://tomevault.io).
