---
trigger: always_on
description: - `cmd/agent`：Agent 入口；`cmd/dashboard`：Dashboard 入口。
---
...
---
> Source: [ruanun/simple-server-status](https://github.com/ruanun/simple-server-status) — distributed by [TomeVault](https://tomevault.io).
