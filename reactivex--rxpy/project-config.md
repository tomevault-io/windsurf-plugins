---
trigger: always_on
description: This file provides guidance for AI agents (Repo Assist, Copilot, etc.) working in this repository.
---
...
---
> Source: [ReactiveX/RxPY](https://github.com/ReactiveX/RxPY) — distributed by [TomeVault](https://tomevault.io).
