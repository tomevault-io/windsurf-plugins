---
trigger: always_on
description: - 任何实现都必须走 TDD 流程：先补会失败的测试，再改实现，最后补齐回归验证。
---
...
---
> Source: [xiankq/cesium-mvt](https://github.com/xiankq/cesium-mvt) — distributed by [TomeVault](https://tomevault.io).
