---
trigger: always_on
description: The project uses Nix for reproducible development environments. To get started:
---
...
---
> Source: [apossiblespace/parts](https://github.com/apossiblespace/parts) — distributed by [TomeVault](https://tomevault.io).
