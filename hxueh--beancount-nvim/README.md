...
Original source: `CLAUDE.md` in [hxueh/beancount.nvim](https://github.com/hxueh/beancount.nvim).
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/hxueh/beancount.nvim](https://github.com/hxueh/beancount.nvim)
