---
trigger: always_on
description: This is the **Symfony Plugin** for IntelliJ IDEA/PhpStorm - a sophisticated IDE plugin that provides intelligent code assistance for Symfony PHP framework development. The plugin supports Symfony 2, 3, 4, and later versions.
---
...
---
> Source: [Haehnchen/idea-php-symfony2-plugin](https://github.com/Haehnchen/idea-php-symfony2-plugin) — distributed by [TomeVault](https://tomevault.io).
