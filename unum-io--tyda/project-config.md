---
trigger: always_on
description: Project names are camelCased. The camelCased name is derived from the directory
---
...
---
> Source: [unum-io/tyda](https://github.com/unum-io/tyda) — distributed by [TomeVault](https://tomevault.io).
