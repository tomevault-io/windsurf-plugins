---
trigger: always_on
description: **NEVER perform `git push` or `git commit` without explicit permission from the user.**
---
...
---
> Source: [quatrope/scikit-criteria](https://github.com/quatrope/scikit-criteria) — distributed by [TomeVault](https://tomevault.io).
