---
trigger: always_on
description: DocuThinker is a FERN-Stack AI-powered document analysis app with a Python AI/ML layer (`ai_ml/`) and a Node.js orchestrator (`orchestrator/`).
---
...
---
> Source: [hoangsonww/DocuThinker-AI-App](https://github.com/hoangsonww/DocuThinker-AI-App) — distributed by [TomeVault](https://tomevault.io).
