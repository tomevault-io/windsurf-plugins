---
trigger: always_on
description: Use this guide to review all PRs across the library (PdfRendererCore, PdfRendererView, PdfViewAdapter, PdfDownloader, PinchZoomRecyclerView, PdfViewerActivity, Compose interop).
---
...
---
> Source: [afreakyelf/Pdf-Viewer](https://github.com/afreakyelf/Pdf-Viewer) — distributed by [TomeVault](https://tomevault.io).
