---
trigger: always_on
description: - Use `bun` only. Do not use `npm` or `pnpm`.
---
...
---
> Source: [yusufipk/OpenFrame](https://github.com/yusufipk/OpenFrame) — distributed by [TomeVault](https://tomevault.io).
