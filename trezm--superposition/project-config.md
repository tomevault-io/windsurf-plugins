---
trigger: always_on
description: AI coding session manager — bare-clones repos, creates isolated git worktrees, and spawns CLI processes (Claude Code, Codex, Gemini) with PTY streams to the browser.
---
...
---
> Source: [trezm/superposition](https://github.com/trezm/superposition) — distributed by [TomeVault](https://tomevault.io).
