---
trigger: always_on
description: Unformat is a single-file, header-only C++11 library (`unformat.h`) for parsing and extracting data from brace-style `{}` formatted strings. Public domain.
---
...
---
> Source: [adamyaxley/Unformat](https://github.com/adamyaxley/Unformat) — distributed by [TomeVault](https://tomevault.io).
