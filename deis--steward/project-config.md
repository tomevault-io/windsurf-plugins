---
trigger: always_on
description: We use Git for our version control system. The `master` branch is the home of the current development candidate. Releases are tagged.
---
...
---
> Source: [deis/steward](https://github.com/deis/steward) — distributed by [TomeVault](https://tomevault.io).
