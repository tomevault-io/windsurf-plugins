---
trigger: always_on
description: JavaScript input-mask library. Source in `lib/` (plain JS, ES modules). TypeScript declarations are **generated** from JS via `tsc --emitDeclarationOnly` — never hand-edit `dist/types/`.
---
...
---
> Source: [RobinHerbots/Inputmask](https://github.com/RobinHerbots/Inputmask) — distributed by [TomeVault](https://tomevault.io).
