---
trigger: always_on
description: FSWatcherEngineEvent is a PowerShell module that provides file system change notifications as PowerShell engine events. It wraps .NET's `FileSystemWatcher` class and exposes cmdlets for creating, managing, and monitoring file system watchers.
---
...
---
> Source: [wgross/fswatcher-engine-event](https://github.com/wgross/fswatcher-engine-event) — distributed by [TomeVault](https://tomevault.io).
