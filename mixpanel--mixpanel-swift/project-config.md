---
trigger: always_on
description: This repository contains the **Mixpanel Swift SDK** - an analytics tracking library for Apple platforms. It enables iOS, tvOS, macOS, and watchOS applications to send event and user data to Mixpanel. The SDK supports Swift Package Manager, CocoaPods, and Carthage for installation.
---
...
---
> Source: [mixpanel/mixpanel-swift](https://github.com/mixpanel/mixpanel-swift) — distributed by [TomeVault](https://tomevault.io).
