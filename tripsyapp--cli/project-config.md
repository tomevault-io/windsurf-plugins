---
trigger: always_on
description: Use this file when an agent is creating or maintaining Tripsy itinerary data through the local `tripsy` CLI or `tripsy-mcp` server.
---
...
---
> Source: [tripsyapp/cli](https://github.com/tripsyapp/cli) — distributed by [TomeVault](https://tomevault.io).
