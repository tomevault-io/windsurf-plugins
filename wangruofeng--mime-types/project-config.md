---
trigger: always_on
description: 纯前端、单文件的 MIME 类型速查工具。面向人类的说明见 `README.md`；本文件记录**改代码时必须知道的红线与约定**。项目与同级目录 `../json-viewer`、`../xml-viewer` 保持同一套设计与代码风格。
---
...
---
> Source: [wangruofeng/mime-types](https://github.com/wangruofeng/mime-types) — distributed by [TomeVault](https://tomevault.io).
