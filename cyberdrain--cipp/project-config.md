---
trigger: always_on
description: Generate all commit messages in **Conventional Commits** format:
---
...
---
> Source: [CyberDrain/CIPP](https://github.com/CyberDrain/CIPP) — distributed by [TomeVault](https://tomevault.io).
