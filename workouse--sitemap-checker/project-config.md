---
trigger: always_on
description: This document provides essential guidelines and instructions for working in the `sitemap-checker` repository. This guide is intended for agents contributing to the repository to ensure consistency in development practices, testing, and coding standards.
---
...
---
> Source: [workouse/sitemap-checker](https://github.com/workouse/sitemap-checker) — distributed by [TomeVault](https://tomevault.io).
