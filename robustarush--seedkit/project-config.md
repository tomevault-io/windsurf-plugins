---
trigger: always_on
description: Claude Code skill for bootstrapping Django projects + the testcase harness that exercises it.
---
...
---
> Source: [RobustaRush/seedkit](https://github.com/RobustaRush/seedkit) — distributed by [TomeVault](https://tomevault.io).
