---
trigger: always_on
description: PTSD (iron law) > User (context provider) > Assistant (executor)
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/veschin) — claim your Tome and manage your conversions.
