---
trigger: always_on
description: > RED — Roughly Enough Data. A fast, simple, native database explorer in pure
---
...
---
> Source: [vojir-mikulas/red](https://github.com/vojir-mikulas/red) — distributed by [TomeVault](https://tomevault.io).
