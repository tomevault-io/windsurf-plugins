---
trigger: always_on
description: Open-source Craft CMS plugin. Lets editors build CP documentation ("User Manual" /
---
...
---
> Source: [RobErskine/Craft-User-Manual](https://github.com/RobErskine/Craft-User-Manual) — distributed by [TomeVault](https://tomevault.io).
