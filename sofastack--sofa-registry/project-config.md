---
trigger: always_on
description: > This file provides context for AI coding assistants (Claude Code, GitHub Copilot, Cursor, Cline, Aider, etc.)
---
...
---
> Source: [sofastack/sofa-registry](https://github.com/sofastack/sofa-registry) — distributed by [TomeVault](https://tomevault.io).
