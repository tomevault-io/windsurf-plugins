---
trigger: always_on
description: generates a context-rich prompt (impacted components,
---
...
---
> Source: [InsertKoinIO/koin-getting-started](https://github.com/InsertKoinIO/koin-getting-started) — distributed by [TomeVault](https://tomevault.io).
