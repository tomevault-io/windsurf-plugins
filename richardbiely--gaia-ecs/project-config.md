---
trigger: always_on
description: This repository is Gaia-ECS. All changes, examples, benchmarks, tests, documentation, and explanations must stay grounded in Gaia-ECS itself. Do not drift into generic ECS patterns or assumptions.
---
...
---
> Source: [richardbiely/gaia-ecs](https://github.com/richardbiely/gaia-ecs) — distributed by [TomeVault](https://tomevault.io).
