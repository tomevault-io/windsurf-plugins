---
trigger: always_on
description: - This is a public alpha SDK for user-directed workflows in visible ChatGPT web
---
...
---
> Source: [adamallcock/codex-chatgpt-control](https://github.com/adamallcock/codex-chatgpt-control) — distributed by [TomeVault](https://tomevault.io).
