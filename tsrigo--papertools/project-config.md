---
trigger: always_on
description: PaperTools 是一个学术论文自动化处理流水线，使用 LLM API 进行智能论文筛选和总结。
---
...
---
> Source: [tsrigo/PaperTools](https://github.com/tsrigo/PaperTools) — distributed by [TomeVault](https://tomevault.io).
