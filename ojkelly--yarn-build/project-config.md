---
trigger: always_on
description: Yarn 4 plugin providing dependency-aware `build` and `test` commands
---
...
---
> Source: [ojkelly/yarn.build](https://github.com/ojkelly/yarn.build) — distributed by [TomeVault](https://tomevault.io).
