---
trigger: always_on
description: > 本项目是 **DSH 外部插件**（profile bundle）。开发、实装、验证全部遵循官方文档；
---
...
---
> Source: [yjh051108/dsh-engram-relay](https://github.com/yjh051108/dsh-engram-relay) — distributed by [TomeVault](https://tomevault.io).
