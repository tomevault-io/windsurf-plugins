...
Original source: `CLAUDE.md` in [Hankanman/Area-Occupancy-Detection](https://github.com/Hankanman/Area-Occupancy-Detection).
...
From [Hankanman/Area-Occupancy-Detection](https://github.com/Hankanman/Area-Occupancy-Detection) — a repo with 290+ stars on GitHub.
