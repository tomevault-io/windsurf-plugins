---
trigger: always_on
description: The Interceptor is a Bun-managed TypeScript browser extension. Main extension source lives in `app/ts`, injected inpage-provider source lives in `app/inpage/ts`, tests live in `test`, build tooling lives in `build` and `scripts`, and extension pages/assets live under `app`.
---
...
---
> Source: [DarkFlorist/TheInterceptor](https://github.com/DarkFlorist/TheInterceptor) — distributed by [TomeVault](https://tomevault.io).
