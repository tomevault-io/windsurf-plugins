---
trigger: always_on
description: This file contains specific instructions for the Nano Banana 2 (gemini-3.1-flash-image-preview) model when working with the Nano Banana extension for image generation, editing, and restoration.
---
