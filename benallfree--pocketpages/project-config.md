---
trigger: always_on
description: This project uses the PocketBase JSVM. In code samples, nothing is awaitable and we do not use the PocketBase JS SDK at all. All demo code should use the PocketBase JSVM API.
---
...
---
> Source: [benallfree/pocketpages](https://github.com/benallfree/pocketpages) — distributed by [TomeVault](https://tomevault.io).
