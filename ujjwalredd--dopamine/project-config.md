---
trigger: always_on
description: <!-- Generated by scripts/generate_integrations.py; edit skills/dopamine/SKILL.md instead. -->
---

<!-- Generated by scripts/generate_integrations.py; edit skills/dopamine/SKILL.md instead. -->
...
Choose the smallest decisive executable check appropriate to the artifact. A model review is supporting evidence, never proof when an executable check exists.
...
---
> Source: [ujjwalredd/Dopamine](https://github.com/ujjwalredd/Dopamine) — distributed by [TomeVault](https://tomevault.io).
