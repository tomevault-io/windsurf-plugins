---
trigger: always_on
description: This is an Elixir umbrella app with multiple sub-apps under `apps/`.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/hexlet-codebattle)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/hexlet-codebattle)
