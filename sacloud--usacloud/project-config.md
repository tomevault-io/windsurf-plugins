---
trigger: always_on
description: `usacloud` はさくらのクラウド公式 CLI です。`main.go` は `pkg.Run()` に処理を委譲し、そこで Cobra コマンドを登録してルートコマンドを実行します。
---
...
---
> Source: [sacloud/usacloud](https://github.com/sacloud/usacloud) — distributed by [TomeVault](https://tomevault.io).
