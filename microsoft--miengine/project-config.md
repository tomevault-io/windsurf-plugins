---
trigger: always_on
description: - Apply the code-formatting style defined in `.editorconfig`.
---
...
---
> Source: [microsoft/MIEngine](https://github.com/microsoft/MIEngine) — distributed by [TomeVault](https://tomevault.io).
