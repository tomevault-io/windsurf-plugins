---
trigger: always_on
description: フェッチ済みの git リポジトリをユーザー環境の任意パスへ symlink / copy で配置する Nix ライブラリ・モジュール群。設定生成は行わない。
---
...
---
> Source: [yasunori0418/nput](https://github.com/yasunori0418/nput) — distributed by [TomeVault](https://tomevault.io).
