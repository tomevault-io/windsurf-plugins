---
trigger: always_on
description: - CLI owns the end-user command surface, output formatting, and exit-code behavior.
---
...
---
> Source: [towardsthecloud/cloudburn](https://github.com/towardsthecloud/cloudburn) — distributed by [TomeVault](https://tomevault.io).
