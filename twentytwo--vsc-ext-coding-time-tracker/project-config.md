---
trigger: always_on
description: VS Code extension that tracks coding time with visualization, health reminders, and git branch/language detection. Version 0.6.7, published to VS Code Marketplace and Open VSX.
---
...
---
> Source: [twentyTwo/vsc-ext-coding-time-tracker](https://github.com/twentyTwo/vsc-ext-coding-time-tracker) — distributed by [TomeVault](https://tomevault.io).
