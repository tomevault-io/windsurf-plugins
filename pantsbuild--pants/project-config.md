---
trigger: always_on
description: This is the Pants build system repo -- a self-hosting build system where `pants` runs Pants from source. Follow the conventions, architecture, and workflows specific to this codebase.
---
...
---
> Source: [pantsbuild/pants](https://github.com/pantsbuild/pants) — distributed by [TomeVault](https://tomevault.io).
