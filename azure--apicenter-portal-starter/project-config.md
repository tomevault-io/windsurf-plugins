---
trigger: always_on
description: For any request about architecture, system design, component boundaries, data flow, routing, services, state management, authentication, deployment, or folder organization, start with [.wiki/index.md](../.wiki/index.md).
---
...
---
> Source: [Azure/APICenter-Portal-Starter](https://github.com/Azure/APICenter-Portal-Starter) — distributed by [TomeVault](https://tomevault.io).
