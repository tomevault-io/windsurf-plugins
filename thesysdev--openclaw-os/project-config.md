---
trigger: always_on
description: OpenClaw types come from the `openclaw` npm package via subpath exports:
---
...
---
> Source: [thesysdev/openclaw-os](https://github.com/thesysdev/openclaw-os) — distributed by [TomeVault](https://tomevault.io).
