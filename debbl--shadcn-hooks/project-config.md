---
trigger: always_on
description: - TypeScript strict; avoid `any` (use precise types). Comments in English. Keep solutions simple and maintainable.
---
...
---
> Source: [Debbl/shadcn-hooks](https://github.com/Debbl/shadcn-hooks) — distributed by [TomeVault](https://tomevault.io).
