...
Original source: `AGENTS.md` in [XenoAtom/XenoAtom.Logging](https://github.com/XenoAtom/XenoAtom.Logging).
...
From [XenoAtom/XenoAtom.Logging](https://github.com/XenoAtom/XenoAtom.Logging) — a repo with 55+ stars on GitHub.
