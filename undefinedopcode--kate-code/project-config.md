---
trigger: always_on
description: A Kate text editor plugin that wraps Claude Code using claude-code-acp.
---
...
---
> Source: [undefinedopcode/kate-code](https://github.com/undefinedopcode/kate-code) — distributed by [TomeVault](https://tomevault.io).
