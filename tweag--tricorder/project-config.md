---
trigger: always_on
description: The tricorder plugin provides a skill for checking build status from within Claude Code sessions.
---
...
---
> Source: [tweag/tricorder](https://github.com/tweag/tricorder) — distributed by [TomeVault](https://tomevault.io).
