---
trigger: always_on
description: This repository implements a Home Assistant Lovelace "strategy" that generates a colorful dashboard using the `BonbonStrategy` class. Use these focused notes to make productive code changes quickly.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/trashbytes)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/trashbytes)
