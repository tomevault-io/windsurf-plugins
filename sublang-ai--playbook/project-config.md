...
- Keep specs lawful per @specs/meta.md — the law itself, not this summary: complete and exact (meta-34), minimal (meta-23), one cohesive concern per item (meta-29), cohesive packages for a shared intent (meta-13), sections per meta-30, relationships and test evidence only as inline citations (meta-14, meta-16, meta-20), integration/system tests only (meta-21, meta-32).
...
---
> Source: [sublang-ai/playbook](https://github.com/sublang-ai/playbook) — distributed by [TomeVault](https://tomevault.io).
