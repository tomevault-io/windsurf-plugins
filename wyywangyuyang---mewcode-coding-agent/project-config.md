---
trigger: always_on
description: 我正在构建一个终端 AI 编程助手（类似 Claude Code），项目名叫 MewCode，使用的编程语言是[python]。
---
...
---
> Source: [wyywangyuyang/-MewCode-Coding-Agent](https://github.com/wyywangyuyang/-MewCode-Coding-Agent) — distributed by [TomeVault](https://tomevault.io).
