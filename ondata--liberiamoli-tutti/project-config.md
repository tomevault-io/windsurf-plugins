---
trigger: always_on
description: Questo documento fornisce le linee guida essenziali per interagire con questo repository. La tua aderenza a queste regole è fondamentale per mantenere la coerenza e la qualità del progetto.
---
