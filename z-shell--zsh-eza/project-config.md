---
trigger: always_on
description: This is a Zsh plugin that replaces GNU `ls` aliases with [`eza`](https://github.com/eza-community/eza).
---
...
---
> Source: [z-shell/zsh-eza](https://github.com/z-shell/zsh-eza) — distributed by [TomeVault](https://tomevault.io).
