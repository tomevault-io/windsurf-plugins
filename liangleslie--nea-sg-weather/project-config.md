---
trigger: always_on
description: Home Assistant custom integration providing real-time weather data for Singapore via the NEA / data.gov.sg API.
---
...
---
> Source: [liangleslie/nea_sg_weather](https://github.com/liangleslie/nea_sg_weather) — distributed by [TomeVault](https://tomevault.io).
