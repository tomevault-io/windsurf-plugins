---
trigger: always_on
description: These rules apply to all Node.js code in the repository and aim to prevent common security risks through disciplined use of input validation, output encoding, and safe APIs.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/Scrollico) — claim your Tome and manage your conversions.
