---
trigger: always_on
description: This is a Rust web application built with the Rapina framework.
---
...
---
> Source: [rapina-rs/rapina](https://github.com/rapina-rs/rapina) — distributed by [TomeVault](https://tomevault.io).
