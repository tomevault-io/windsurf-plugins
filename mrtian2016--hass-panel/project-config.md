---
trigger: always_on
description: 本文件为 Claude Code (claude.ai/code) 提供在此代码仓库中工作时的指导。
---
...
---
> Source: [mrtian2016/hass-panel](https://github.com/mrtian2016/hass-panel) — distributed by [TomeVault](https://tomevault.io).
