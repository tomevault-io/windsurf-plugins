---
trigger: always_on
description: - `init.lua`: Entry point; sets globals and loads `config.lazy` (bootstraps lazy.nvim).
---
...
---
> Source: [SamSaffron/dotfiles](https://github.com/SamSaffron/dotfiles) — distributed by [TomeVault](https://tomevault.io).
