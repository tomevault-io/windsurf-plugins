---
trigger: always_on
description: 11tybundle.dev is an Eleventy-based static site aggregating 1500+ blog posts from 350+ authors about Eleventy, organized into categories, author pages, and a searchable "firehose". Data is fetched from a GitHub-hosted JSON file and heavily processed at build time.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/bobmonsour)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/bobmonsour)
