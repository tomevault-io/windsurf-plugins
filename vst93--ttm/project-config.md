---
trigger: always_on
description: Operational guide for autonomous coding agents working in this repository.
---
...
---
> Source: [vst93/ttm](https://github.com/vst93/ttm) — distributed by [TomeVault](https://tomevault.io).
