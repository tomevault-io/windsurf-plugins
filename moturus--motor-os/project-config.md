---
trigger: always_on
description: These instructions apply below `src/bin/lorry` and refine the repository-root
---
...
---
> Source: [moturus/motor-os](https://github.com/moturus/motor-os) — distributed by [TomeVault](https://tomevault.io).
