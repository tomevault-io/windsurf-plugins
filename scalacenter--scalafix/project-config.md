---
trigger: always_on
description: Scalafix is a refactoring and linting tool for Scala. It enables syntactic and semantic source code transformations through a rule-based system. The project targets multiple Scala versions (2.12, 2.13, 3.3-3.8) and is built using a complex sbt-projectmatrix setup.
---
...
---
> Source: [scalacenter/scalafix](https://github.com/scalacenter/scalafix) — distributed by [TomeVault](https://tomevault.io).
