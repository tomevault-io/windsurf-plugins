---
trigger: always_on
description: - The root README and package READMEs are user-facing. They explain what the current package does, how to install it, and how to use its public API.
---
...
---
> Source: [EvotecIT/OfficeIMO](https://github.com/EvotecIT/OfficeIMO) — distributed by [TomeVault](https://tomevault.io).
