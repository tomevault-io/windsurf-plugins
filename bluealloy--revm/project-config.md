---
trigger: always_on
description: REVM is a highly efficient Rust implementation of the Ethereum Virtual Machine (EVM). It serves both as:
---
...
---
> Source: [bluealloy/revm](https://github.com/bluealloy/revm) — distributed by [TomeVault](https://tomevault.io).
