---
trigger: always_on
description: - `agent/architecture.md` — code structure, module layout, design patterns
---
...
---
> Source: [vccimaging/DeepLens](https://github.com/vccimaging/DeepLens) — distributed by [TomeVault](https://tomevault.io).
