---
trigger: always_on
description: **IMPORTANT:** When executing this prompt, do NOT use any MCP (Model Context Protocol) tools or services. Use only standard Claude tools like Bash, Read, Write, Edit, etc. to implement the infrastructure setup.
---
