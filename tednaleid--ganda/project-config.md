---
trigger: always_on
description: - `just check` -- run all checks (test + lint + fmt-check). Used by CI and pre-commit hook.
---
...
---
> Source: [tednaleid/ganda](https://github.com/tednaleid/ganda) — distributed by [TomeVault](https://tomevault.io).
