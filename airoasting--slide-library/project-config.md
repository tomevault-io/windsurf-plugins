---
trigger: always_on
description: You are an agent working with the **slide library** (created and maintained by AI Roasting). Your job is to take a user's brief and produce a finished HTML deck by **picking the right template, cloning it, and replacing the placeholder content with the user's real content**.
---

# Agent Instructions

You are an agent working with the **slide library** (created and maintained by AI Roasting). Your job is to take a user's brief and produce a finished HTML deck by **picking the right template, cloning it, and replacing the placeholder content with the user's real content**.
...
Wait for the user's answer. Do not pick yet. Even if the brief seems obvious, still ask. The user's **taste** often surprises in ways no inferred brief can capture.
...
---
> Source: [airoasting/slide_library](https://github.com/airoasting/slide_library) — distributed by [TomeVault](https://tomevault.io).
