---
trigger: always_on
description: Instructions for an AI agent (or a human) operating this tool. This file is
---
...
---
> Source: [tokens-studio/figma-plugin](https://github.com/tokens-studio/figma-plugin) — distributed by [TomeVault](https://tomevault.io).
