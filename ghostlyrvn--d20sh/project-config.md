---
trigger: always_on
description: A D&D-inspired terminal enhancement that gamifies command execution. Your terminal character has ability scores that affect command success rates through d20 rolls.
---
...
---
> Source: [ghostlyRvn/d20sh](https://github.com/ghostlyRvn/d20sh) — distributed by [TomeVault](https://tomevault.io).
