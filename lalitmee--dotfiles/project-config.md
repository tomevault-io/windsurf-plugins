---
trigger: always_on
description: 1.  **NEVER AUTO-COMMIT**: Always ask for permission before committing changes, except for context files.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/lalitmee)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/lalitmee)
