---
trigger: always_on
description: - Always use `git mv` when moving or renaming files in a git repo — plain `mv` loses history when files have been edited
---
...
---
> Source: [kshenoy/dotfiles](https://github.com/kshenoy/dotfiles) — distributed by [TomeVault](https://tomevault.io).
