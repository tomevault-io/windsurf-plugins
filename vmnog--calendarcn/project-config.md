---
trigger: always_on
description: CalendarCN is an open-source React calendar component inspired by Notion Calendar. It provides a weekly view with drag/resize interactions, multi-day events, dark mode, and keyboard shortcuts. Built with Next.js 16, React 19, Tailwind CSS 4, and shadcn/ui.
---
...
---
> Source: [vmnog/calendarcn](https://github.com/vmnog/calendarcn) — distributed by [TomeVault](https://tomevault.io).
