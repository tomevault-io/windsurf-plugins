---
trigger: always_on
description: - 后端: NestJS + Prisma + MySQL + Redis (TS 严格模式)
---
...
---
> Source: [weips001/nest-vue-admin](https://github.com/weips001/nest-vue-admin) — distributed by [TomeVault](https://tomevault.io).
