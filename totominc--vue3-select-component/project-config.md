---
trigger: always_on
description: - Playground demos should be separate Vue components per test case so manual regression testing stays easy when changing the select.
---
...
---
> Source: [TotomInc/vue3-select-component](https://github.com/TotomInc/vue3-select-component) — distributed by [TomeVault](https://tomevault.io).
