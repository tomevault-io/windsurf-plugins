---
trigger: always_on
description: - CB-Spider: Cloud-Barista sub-framework, unified API for multiple CSPs.
---
...
---
> Source: [cloud-barista/cb-spider](https://github.com/cloud-barista/cb-spider) — distributed by [TomeVault](https://tomevault.io).
