---
trigger: always_on
description: This is the ZeroDev SDK v5, a comprehensive SDK for building ERC-4337 (Account Abstraction) applications on Ethereum. The SDK provides utilities for working with smart contract wallets, bundlers, paymasters, and various validation plugins.
---
...
---
> Source: [zerodevapp/sdk](https://github.com/zerodevapp/sdk) — distributed by [TomeVault](https://tomevault.io).
