---
trigger: always_on
description: > Repo guide for AI coding agents working **in this codebase** (Cursor, Cline, Codex CLI, Claude Code, Windsurf, Aider, etc.).
---
...
---
> Source: [vitalio-sh/thunderbird-cli](https://github.com/vitalio-sh/thunderbird-cli) — distributed by [TomeVault](https://tomevault.io).
