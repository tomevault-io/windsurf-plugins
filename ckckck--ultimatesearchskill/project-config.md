---
trigger: always_on
description: - `OPENAI_COMPATIBLE_BASE_URL` / `OPENAI_COMPATIBLE_API_KEY` / `OPENAI_COMPATIBLE_MODEL`：统一兼容后端配置，优先级高于 legacy `GROK_*`。
---
...
---
> Source: [ckckck/UltimateSearchSkill](https://github.com/ckckck/UltimateSearchSkill) — distributed by [TomeVault](https://tomevault.io).
