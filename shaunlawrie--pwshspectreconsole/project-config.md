...
- You will run tests when iterating on code fixes by executing `pwsh -Command ./build.ps1` in the terminal.
...
---
> Source: [ShaunLawrie/PwshSpectreConsole](https://github.com/ShaunLawrie/PwshSpectreConsole) — distributed by [TomeVault](https://tomevault.io).
