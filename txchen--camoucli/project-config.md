---
trigger: always_on
description: - Purpose: Camoucli is a Node.js-first ESM CLI plus local daemon for driving Camoufox through Playwright, without depending on the Camoufox Python SDK.
---
...
---
> Source: [txchen/camoucli](https://github.com/txchen/camoucli) — distributed by [TomeVault](https://tomevault.io).
