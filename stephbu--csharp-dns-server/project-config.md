---
trigger: always_on
description: > Scope: assistants may edit **code, tests, and documentation** in this repository. Infrastructure/deployment assets remain off-limits unless explicitly approved.
---
...
---
> Source: [stephbu/csharp-dns-server](https://github.com/stephbu/csharp-dns-server) — distributed by [TomeVault](https://tomevault.io).
