---
trigger: always_on
description: Use [CLAUDE.md](./CLAUDE.md) as the single source of truth for this repository's project guidance, architecture notes, release workflow, and conventions.
---
...
---
> Source: [xiufengsun/TokenTracker](https://github.com/xiufengsun/TokenTracker) — distributed by [TomeVault](https://tomevault.io).
