---
trigger: always_on
description: - Commit messages and PR names should follow Conventional Commits specification (https://www.conventionalcommits.org/en/v1.0.0/)
---
...
---
> Source: [scikit-hep/mplhep](https://github.com/scikit-hep/mplhep) — distributed by [TomeVault](https://tomevault.io).
