---
trigger: always_on
description: Agent-oriented reference for the XMLUI monorepo. Read this first for any task.
---
...
---
> Source: [xmlui-org/xmlui](https://github.com/xmlui-org/xmlui) — distributed by [TomeVault](https://tomevault.io).
