---
trigger: always_on
description: Claude Code plugin for spec-driven, git-centered development. Distributed as a GitHub-native marketplace: the repo root is a marketplace (`.claude-plugin/marketplace.json`) that contains one plugin, `up`, under `plugins/up/`.
---
...
---
> Source: [btseytlin/ultrapack](https://github.com/btseytlin/ultrapack) — distributed by [TomeVault](https://tomevault.io).
