---
trigger: always_on
description: Follow these mandatory guidelines when contributing code, documentation, and translations to this repository. All contributions will be reviewed for compliance.
---
...
---
> Source: [nelmio/NelmioApiDocBundle](https://github.com/nelmio/NelmioApiDocBundle) — distributed by [TomeVault](https://tomevault.io).
