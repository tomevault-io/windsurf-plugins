---
trigger: always_on
description: npm install            # install dev deps (peer deps only — no runtime bundled)
---
...
---
> Source: [wilfredinni/pi-openplan](https://github.com/wilfredinni/pi-openplan) — distributed by [TomeVault](https://tomevault.io).
