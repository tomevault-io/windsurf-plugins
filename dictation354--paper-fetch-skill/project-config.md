---
trigger: always_on
description: - 当存在已有的包或者代码块（包括本地的和网络上成熟的包）时，必须使用或者复用，禁止自己用其他方式写代码实现功能。
---
...
---
> Source: [Dictation354/paper-fetch-skill](https://github.com/Dictation354/paper-fetch-skill) — distributed by [TomeVault](https://tomevault.io).
