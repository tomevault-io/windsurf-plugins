---
trigger: always_on
description: GraphQL+ is a successor to GraphQL, implementing a parser, merging verifier, and modeller in C# .NET. The project provides tools for parsing, verifying, and modeling GraphQL+ schemas and queries.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/NeonGraal)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/NeonGraal)
