---
trigger: always_on
description: You are an AI/LLM about to work on **Vanchor-NG**. Before editing anything:
---
...
---
> Source: [AlexAsplund/Vanchor](https://github.com/AlexAsplund/Vanchor) — distributed by [TomeVault](https://tomevault.io).
