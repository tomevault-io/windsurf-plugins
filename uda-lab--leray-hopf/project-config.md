---
trigger: always_on
description: Operating rules for the **AI agent team** working in this repository (roster:
---
...
---
> Source: [uda-lab/leray-hopf](https://github.com/uda-lab/leray-hopf) — distributed by [TomeVault](https://tomevault.io).
