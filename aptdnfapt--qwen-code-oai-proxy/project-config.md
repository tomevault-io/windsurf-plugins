---
trigger: always_on
description: must first read the ./docs/README.md To undertsadn the goal of the porject . the qwen-code cli dir is ./qwen-code . its being added to git ignore to not push in github.
---
...
---
> Source: [aptdnfapt/qwen-code-oai-proxy](https://github.com/aptdnfapt/qwen-code-oai-proxy) — distributed by [TomeVault](https://tomevault.io).
