---
trigger: always_on
description: Glu is a modern systems programming language compiler built with LLVM.
---
...
---
> Source: [glu-lang/glu](https://github.com/glu-lang/glu) — distributed by [TomeVault](https://tomevault.io).
