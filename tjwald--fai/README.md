...
Original source: `AGENTS.md` in [tjwald/FAI](https://github.com/tjwald/FAI).
...
```
npx tomevault install tjwald/FAI
```
Source: [github.com/tjwald/FAI](https://github.com/tjwald/FAI).
