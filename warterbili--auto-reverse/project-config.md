---
trigger: always_on
description: Read this first. It's the map and the operating rules — the things you **can't cheaply
---
...
---
> Source: [warterbili/AUTO_REVERSE](https://github.com/warterbili/AUTO_REVERSE) — distributed by [TomeVault](https://tomevault.io).
