---
trigger: always_on
description: This file defines stable repository-wide instructions for coding agents and human contributors. Product targets and provider experiments belong in `docs/product-decisions.md`; visual context belongs in `.impeccable.md`.
---
...
---
> Source: [zhangzhangjingjing0408-coder/echoscene](https://github.com/zhangzhangjingjing0408-coder/echoscene) — distributed by [TomeVault](https://tomevault.io).
