---
trigger: always_on
description: Ruby client for the Crowdin API v2 and Crowdin Enterprise API v2 (gem: `crowdin-api`, namespace `Crowdin`).
---
...
---
> Source: [crowdin/crowdin-api-client-ruby](https://github.com/crowdin/crowdin-api-client-ruby) — distributed by [TomeVault](https://tomevault.io).
