---
trigger: always_on
description: Guidance for AI coding agents (Claude Code, Cursor, Codex, etc.) working in this repository. `CLAUDE.md` is a symlink to this file.
---
...
---
> Source: [zama-ai/sdk](https://github.com/zama-ai/sdk) — distributed by [TomeVault](https://tomevault.io).
