---
trigger: always_on
description: An `IntelliTect Coalesce`–based project. Projects:
---
...
---
> Source: [IntelliTect/Coalesce](https://github.com/IntelliTect/Coalesce) — distributed by [TomeVault](https://tomevault.io).
