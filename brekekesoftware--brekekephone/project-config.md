---
trigger: always_on
description: - Always write code and comments in English. You can response in chat using user prompt language.
---

# Coding Conventions

- Always write code and comments in English. You can response in chat using user prompt language.
...
---
> Source: [brekekesoftware/brekekephone](https://github.com/brekekesoftware/brekekephone) — distributed by [TomeVault](https://tomevault.io).
