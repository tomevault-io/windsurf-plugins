---
trigger: always_on
description: This repository hosts a Unity plugin that brings the [rlottie](https://github.com/Samsung/rlottie) animation library to the Unity ecosystem. The project builds native binaries for multiple platforms using CMake and provides C# scripts to integrate Lottie animations inside Unity games or applications.
---
...
---
> Source: [gindemit/unity-rlottie](https://github.com/gindemit/unity-rlottie) — distributed by [TomeVault](https://tomevault.io).
