---
trigger: always_on
description: Guidance for depositors on how to record something the schema can hold in more than one
---
...
---
> Source: [open-reaction-database/ord-schema](https://github.com/open-reaction-database/ord-schema) — distributed by [TomeVault](https://tomevault.io).
