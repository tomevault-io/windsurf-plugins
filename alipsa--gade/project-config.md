---
trigger: always_on
description: - The Gradle build expects JVM sources in `src/main/java` and supporting Groovy/utility scripts in `src/main/scripts` and `src/bin`.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/Alipsa)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/Alipsa)
