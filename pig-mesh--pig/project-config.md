---
trigger: always_on
description: `pig` aggregates the open-source Spring Cloud services through the root `pom.xml`. Runtime services sit under dedicated
---
...
---
> Source: [pig-mesh/pig](https://github.com/pig-mesh/pig) — distributed by [TomeVault](https://tomevault.io).
