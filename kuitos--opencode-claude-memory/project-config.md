---
trigger: always_on
description: OpenCode plugin that replicates Claude Code's persistent memory system. TypeScript on Bun, consumed as raw `.ts` by OpenCode (no build step). Published to npm via semantic-release.
---
