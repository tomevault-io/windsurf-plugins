---
trigger: always_on
description: Read the latest handoff in docs/summaries/ if one exists. Load only the files that handoff references — not all summaries. If no handoff exists, ask: what is the project, what type of work, what is the target deliverable.
---
...
- docs/context/ — reusable domain knowledge, loaded only when relevant to the current task
  ...
  <!-- Add your own domain context files here. Examples:
       - client-briefs/[client].md — per-client context
...
---
> Source: [Arkya-AI/claude-context-os](https://github.com/Arkya-AI/claude-context-os) — distributed by [TomeVault](https://tomevault.io).
