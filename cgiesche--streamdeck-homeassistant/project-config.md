---
trigger: always_on
description: enableServiceIndicator, iconSettings, // 'PREFER_PLUGIN' | 'PREFER_HA' | 'HIDE'
---
...
---
> Source: [cgiesche/streamdeck-homeassistant](https://github.com/cgiesche/streamdeck-homeassistant) — distributed by [TomeVault](https://tomevault.io).
