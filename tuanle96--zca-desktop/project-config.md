---
trigger: always_on
description: Cross-platform **Zalo desktop client** (personal-use, unofficial). Rust **Tauri v2**
---
...
---
> Source: [tuanle96/zca-desktop](https://github.com/tuanle96/zca-desktop) — distributed by [TomeVault](https://tomevault.io).
