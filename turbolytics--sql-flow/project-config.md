---
trigger: always_on
description: All prose — commit messages, PR descriptions, code comments, docs, README,
---
...
---
> Source: [turbolytics/sql-flow](https://github.com/turbolytics/sql-flow) — distributed by [TomeVault](https://tomevault.io).
