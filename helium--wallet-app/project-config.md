---
trigger: always_on
description: React Native Solana wallet with extensive Helium ecosystem integration.
---
...
---
> Source: [helium/wallet-app](https://github.com/helium/wallet-app) — distributed by [TomeVault](https://tomevault.io).
