---
trigger: always_on
description: - When writing Julia code, use _4 whitespaces_ for indentation and try to keep
---
...
---
> Source: [aviatesk/JETLS.jl](https://github.com/aviatesk/JETLS.jl) — distributed by [TomeVault](https://tomevault.io).
