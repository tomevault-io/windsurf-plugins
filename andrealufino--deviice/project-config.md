---
trigger: always_on
description: Swift Package (iOS 15+, zero dependencies) that identifies iOS devices at runtime. Maps hardware identifiers (e.g. `iPhone17,2`) to structured device info via a bundled JSON database.
---
...
---
> Source: [andrealufino/Deviice](https://github.com/andrealufino/Deviice) — distributed by [TomeVault](https://tomevault.io).
