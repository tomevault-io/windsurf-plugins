---
trigger: always_on
description: These instructions apply to human contributors and coding agents working anywhere in this
---
...
---
> Source: [yxflc11/openbot](https://github.com/yxflc11/openbot) — distributed by [TomeVault](https://tomevault.io).
