---
trigger: always_on
description: - `cmd/` holds CLI and MCP entry points; `main.go` wires shared packages.
---
...
---
> Source: [yaleh/meta-cc](https://github.com/yaleh/meta-cc) — distributed by [TomeVault](https://tomevault.io).
