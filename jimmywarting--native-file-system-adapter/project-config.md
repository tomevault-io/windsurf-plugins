---
trigger: always_on
description: This is a WHATWG File System Access API polyfill. It provides browser-compatible `FileSystemHandle`, `FileSystemDirectoryHandle`, and `FileSystemFileHandle` interfaces backed by various storage backends (memory, Node.js fs, Deno fs, IndexedDB, Cache API, jsDelivr CDN).
---
