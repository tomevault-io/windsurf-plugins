---
trigger: always_on
description: This is a Python package backed by a Rust PyO3 extension. Rust implementations and the extension exports are in `src/`. The public Python wrapper is in `python/wirio_settings/`, and Python tests are in `tests/`.
---
...
---
> Source: [wirio-org/wirio-settings](https://github.com/wirio-org/wirio-settings) — distributed by [TomeVault](https://tomevault.io).
