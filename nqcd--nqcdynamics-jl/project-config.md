---
trigger: always_on
description: Really these should just be called developer documentation, but hey ho, AI and all that.
---
...
---
> Source: [NQCD/NQCDynamics.jl](https://github.com/NQCD/NQCDynamics.jl) — distributed by [TomeVault](https://tomevault.io).
