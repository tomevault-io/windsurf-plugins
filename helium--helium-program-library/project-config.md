---
trigger: always_on
description: When initializing new Anchor accounts in instruction handlers, always use the `set_inner()` syntax instead of setting fields individually.
---
...
---
> Source: [helium/helium-program-library](https://github.com/helium/helium-program-library) — distributed by [TomeVault](https://tomevault.io).
