---
trigger: always_on
description: flake.nix                 ← Entry point (flake-parts based)
---
...
---
> Source: [y3owk1n/nix-system-config-v2](https://github.com/y3owk1n/nix-system-config-v2) — distributed by [TomeVault](https://tomevault.io).
