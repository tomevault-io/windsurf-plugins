---
trigger: always_on
description: This file captures durable repo context for future agent sessions.
---
...
---
> Source: [ophal/core](https://github.com/ophal/core) — distributed by [TomeVault](https://tomevault.io).
