---
trigger: always_on
description: - Root: `Cargo.toml` (package and bins), `build.rs` (build metadata via shadow-rs), `docs/` (mdBook).
---
...
---
> Source: [wp-labs/warp-parse](https://github.com/wp-labs/warp-parse) — distributed by [TomeVault](https://tomevault.io).
