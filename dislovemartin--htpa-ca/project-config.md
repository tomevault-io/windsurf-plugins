---
trigger: always_on
description: Agile Workflow and core memory procedure RULES that MUST be followed EXACTLY
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/dislovemartin)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/dislovemartin)
