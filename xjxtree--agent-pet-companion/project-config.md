---
trigger: always_on
description: Agent Pet Companion is a native macOS desktop pet app with an AI pet studio, local pet library, desktop overlay, and Agent session responses.
---
...
---
> Source: [xjxtree/agent-pet-companion](https://github.com/xjxtree/agent-pet-companion) — distributed by [TomeVault](https://tomevault.io).
