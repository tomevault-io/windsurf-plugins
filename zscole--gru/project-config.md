---
trigger: always_on
description: Gru is not a single assistant. It's an orchestrator that spawns specialized agents to handle complex tasks in parallel.
---
...
---
> Source: [zscole/gru](https://github.com/zscole/gru) — distributed by [TomeVault](https://tomevault.io).
