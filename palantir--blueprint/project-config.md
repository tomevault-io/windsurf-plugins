---
trigger: always_on
description: - **Build**: `pnpm compile` (all packages), `pnpm nx compile @blueprintjs/core` (single package)
---
...
---
> Source: [palantir/blueprint](https://github.com/palantir/blueprint) — distributed by [TomeVault](https://tomevault.io).
