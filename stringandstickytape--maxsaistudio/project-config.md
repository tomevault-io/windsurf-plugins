---
trigger: always_on
description: This project is a sophisticated, multi-faceted C# .NET application named "Max's AI Studio". It functions as both a standalone Windows Presentation Foundation (WPF) desktop application and a Visual Studio (VSIX) extension.
---
...
---
> Source: [stringandstickytape/MaxsAiStudio](https://github.com/stringandstickytape/MaxsAiStudio) — distributed by [TomeVault](https://tomevault.io).
