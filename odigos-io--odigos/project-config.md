---
trigger: always_on
description: - Keep changes minimal and scoped to the task.
---
...
---
> Source: [odigos-io/odigos](https://github.com/odigos-io/odigos) — distributed by [TomeVault](https://tomevault.io).
