---
trigger: always_on
description: This is a project that uses [Stagehand](https://github.com/browserbase/stagehand), which amplifies Playwright with AI-powered `act`, `extract`, and `observe` methods added to the Page class.
---
...
---
> Source: [pkiv/forkable](https://github.com/pkiv/forkable) — distributed by [TomeVault](https://tomevault.io).
