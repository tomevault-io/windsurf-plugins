---
trigger: always_on
description: - Do not add Go tests (`_test.go`) unless explicitly asked.
---
...
---
> Source: [casdoor/casdoor](https://github.com/casdoor/casdoor) — distributed by [TomeVault](https://tomevault.io).
