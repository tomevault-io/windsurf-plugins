---
trigger: always_on
description: UXsim is a pure Python macroscopic and mesoscopic network traffic flow simulator for large-scale (city-scale) traffic phenomena simulation. It is designed for scientific and educational purposes with simple, lightweight, and customizable features.
---
...
---
> Source: [toruseo/UXsim](https://github.com/toruseo/UXsim) — distributed by [TomeVault](https://tomevault.io).
