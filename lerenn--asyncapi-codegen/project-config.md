---
trigger: always_on
description: When asked to "ship" the code or when shipping is mentioned, systematically execute these commands in order:
---
...
---
> Source: [lerenn/asyncapi-codegen](https://github.com/lerenn/asyncapi-codegen) — distributed by [TomeVault](https://tomevault.io).
