---
trigger: always_on
description: Provides a typed `Quantity` system (`Watt`, `KiloWattHour`, etc.) for stronger unit safety. Distinct from the `lt.Units` enum used in I/O declarations.
---
...
---
> Source: [FZJ-IEK3-VSA/HiSim](https://github.com/FZJ-IEK3-VSA/HiSim) — distributed by [TomeVault](https://tomevault.io).
