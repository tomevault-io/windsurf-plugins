---
trigger: always_on
description: - Rust workspace (`Cargo.toml`) with crates: `lexer/`, `parser/`, `object/`, `interpreter/`, `compiler/`, `wasm/`.
---
...
---
> Source: [gengjiawen/monkey-rust](https://github.com/gengjiawen/monkey-rust) — distributed by [TomeVault](https://tomevault.io).
