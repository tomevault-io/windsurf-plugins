---
trigger: always_on
description: This project uses bkit with automatic level detection.
---
...
---
> Source: [popup-studio-ai/bkit-codex](https://github.com/popup-studio-ai/bkit-codex) — distributed by [TomeVault](https://tomevault.io).
