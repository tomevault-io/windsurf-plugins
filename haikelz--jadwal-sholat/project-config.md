---
trigger: always_on
description: - `apps/jadwal-sholat` is the Next.js App Router application.
---
...
---
> Source: [haikelz/jadwal-sholat](https://github.com/haikelz/jadwal-sholat) — distributed by [TomeVault](https://tomevault.io).
