---
trigger: always_on
description: Here’s the updated AGENTS.md with a Doc Sync note so contributors know to check all public-facing docs together when changes happen:
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/djav1985)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/djav1985)
