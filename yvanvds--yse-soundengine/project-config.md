---
trigger: always_on
description: Workflow rules for Claude Code sessions on the YSE Sound Engine. Read at
---
...
---
> Source: [yvanvds/yse-soundengine](https://github.com/yvanvds/yse-soundengine) — distributed by [TomeVault](https://tomevault.io).
