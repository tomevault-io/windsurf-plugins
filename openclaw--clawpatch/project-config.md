---
trigger: always_on
description: `clawpatch` is a TypeScript CLI. Source lives in `src/`, with the CLI entry in
---
...
---
> Source: [openclaw/clawpatch](https://github.com/openclaw/clawpatch) — distributed by [TomeVault](https://tomevault.io).
