---
trigger: always_on
description: Sendy mailing list integration plugin for the MyAdmin control panel. Namespace: `Detain\MyAdminSendy\` → `src/` · Tests: `Detain\MyAdminSendy\Tests\` → `tests/`.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/myadmin-plugins) — claim your Tome and manage your conversions.
