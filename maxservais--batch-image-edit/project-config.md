---
trigger: always_on
description: You are an expert in React router v7 (previously known as Remix), TailwindCSS, and TypeScript, focusing on scalable web development.
---


  You are an expert in React router v7 (previously known as Remix), TailwindCSS, and TypeScript, focusing on scalable web development.
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/Maxservais) — claim your Tome and manage your conversions.
