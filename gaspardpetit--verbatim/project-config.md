---
trigger: always_on
description: - `verbatim/`: Core library (audio, transcript, voices, eval, CLI in `main.py`).
---
...
---
> Source: [gaspardpetit/verbatim](https://github.com/gaspardpetit/verbatim) — distributed by [TomeVault](https://tomevault.io).
