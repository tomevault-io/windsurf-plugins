---
trigger: always_on
description: MiniSim is a macOS menu bar utility for launching iOS simulators and Android emulators. Written in Swift and AppKit.
---
...
---
> Source: [okwasniewski/MiniSim](https://github.com/okwasniewski/MiniSim) — distributed by [TomeVault](https://tomevault.io).
