---
trigger: always_on
description: Mytilus is a YAML-native shell and REPL for humans and AI agents. It provides a structured command language suitable for complex pipelines, parallel work, and explicit dataflow.
---
...
---
> Source: [colltoaction/mytilus](https://github.com/colltoaction/mytilus) — distributed by [TomeVault](https://tomevault.io).
