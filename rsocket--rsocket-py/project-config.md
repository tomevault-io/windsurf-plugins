---
trigger: always_on
description: RSocket-py is a Python implementation of the [RSocket](http://rsocket.io) protocol, which is a binary protocol for use on byte stream transports such as TCP, WebSockets, and Aeron. The project provides a comprehensive implementation of the RSocket protocol with support for various transports, extensions, and integrations.
---
...
---
> Source: [rsocket/rsocket-py](https://github.com/rsocket/rsocket-py) — distributed by [TomeVault](https://tomevault.io).
