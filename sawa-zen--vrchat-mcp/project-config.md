---
trigger: always_on
description: This project is developing a Model Context Protocol (MCP) server that can retrieve information from the VRChat API.
---
...
---
> Source: [sawa-zen/vrchat-mcp](https://github.com/sawa-zen/vrchat-mcp) — distributed by [TomeVault](https://tomevault.io).
