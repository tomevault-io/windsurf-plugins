---
trigger: always_on
description: neat-python is a pure-Python implementation of NEAT (NeuroEvolution of Augmenting Topologies),
---
...
---
> Source: [CodeReclaimers/neat-python](https://github.com/CodeReclaimers/neat-python) — distributed by [TomeVault](https://tomevault.io).
