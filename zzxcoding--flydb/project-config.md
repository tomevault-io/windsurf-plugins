---
trigger: always_on
description: 本文件适用于整个 Flydb 仓库，记录所有开发 Agent 都必须遵守的稳定约束。
---
...
---
> Source: [zzxCoding/Flydb](https://github.com/zzxCoding/Flydb) — distributed by [TomeVault](https://tomevault.io).
