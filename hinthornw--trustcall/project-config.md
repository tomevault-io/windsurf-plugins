---
trigger: always_on
description: - Always run `make lint` before committing to ensure code passes ruff and mypy checks
---
...
---
> Source: [hinthornw/trustcall](https://github.com/hinthornw/trustcall) — distributed by [TomeVault](https://tomevault.io).
