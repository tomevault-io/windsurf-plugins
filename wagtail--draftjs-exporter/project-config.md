---
trigger: always_on
description: > For the human-readable contributor guide, see [docs/CONTRIBUTING.md](docs/CONTRIBUTING.md). This file is a concise quick-reference for the AI assistant.
---
...
---
> Source: [wagtail/draftjs_exporter](https://github.com/wagtail/draftjs_exporter) — distributed by [TomeVault](https://tomevault.io).
