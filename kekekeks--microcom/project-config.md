---
trigger: always_on
description: This project is about generating C++ header and C# interop for COM interfaces.
---
...
---
> Source: [kekekeks/MicroCom](https://github.com/kekekeks/MicroCom) — distributed by [TomeVault](https://tomevault.io).
