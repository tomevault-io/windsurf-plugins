---
trigger: always_on
description: 这个文件给后续接手本仓库的 Codex / 自动化维护者看。范围是整个仓库。
---
...
- 修改会影响 `评估/项目仪表盘.md` 统计来源的配置、预览图、评分记录或生成逻辑。
...
3. 检查 `生成提示词/README.md`、`生成提示词/覆盖矩阵.md`、`生成提示词/标签索引.md`、`生成提示词/标签覆盖矩阵.md`、JSON bundle、API 请求 JSONL/schema 和 CSV 索引是否符合预期。
...
---
> Source: [yujianwudi/ai-image-prompts](https://github.com/yujianwudi/ai-image-prompts) — distributed by [TomeVault](https://tomevault.io).
