---
trigger: always_on
description: SolrNet does not attempt to abstract much over Solr, it's assumed that you know what Solr is and how to use it, just as you need to know relational databases before using an ORM.
---
...
---
> Source: [SolrNet/SolrNet](https://github.com/SolrNet/SolrNet) — distributed by [TomeVault](https://tomevault.io).
