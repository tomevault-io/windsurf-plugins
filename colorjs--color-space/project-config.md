---
trigger: always_on
description: The web catalog (`web/index.html` + `web/js/*`, built by `npm run landing` → `_site/`) is a
---
...
---
> Source: [colorjs/color-space](https://github.com/colorjs/color-space) — distributed by [TomeVault](https://tomevault.io).
