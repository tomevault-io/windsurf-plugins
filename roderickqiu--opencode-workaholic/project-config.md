---
trigger: always_on
description: - **Build**: `mise run build` or `bun build ./src/index.ts --outdir dist --target bun`
---
...
---
> Source: [RoderickQiu/opencode-workaholic](https://github.com/RoderickQiu/opencode-workaholic) — distributed by [TomeVault](https://tomevault.io).
