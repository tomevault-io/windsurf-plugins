---
trigger: always_on
description: Umbrella Helm chart repository that bundles all components of the FIWARE Data
---
...
---
> Source: [FIWARE/data-space-connector](https://github.com/FIWARE/data-space-connector) — distributed by [TomeVault](https://tomevault.io).
