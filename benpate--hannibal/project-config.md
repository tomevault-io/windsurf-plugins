---
trigger: always_on
description: Notes for anyone (human or agent) changing this package. Read [README.md](README.md) first for what it does; this file is about the traps.
---
...
---
> Source: [benpate/hannibal](https://github.com/benpate/hannibal) — distributed by [TomeVault](https://tomevault.io).
