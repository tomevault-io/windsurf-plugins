---
trigger: always_on
description: RFC 3986 compliant URI parsing library replacing Python's `urllib.parse`. Requires Python >= 3.10, zero runtime dependencies.
---
...
---
> Source: [tkem/uritools](https://github.com/tkem/uritools) — distributed by [TomeVault](https://tomevault.io).
