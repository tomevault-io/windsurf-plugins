---
trigger: always_on
description: When passing a Kotlin/Java List or ArrayList to a Python function via Chaquopy, you **must** convert it to a Python list first. Otherwise you'll get `'ArrayList' object is not iterable`.
---
...
---
> Source: [torlando-tech/columba](https://github.com/torlando-tech/columba) — distributed by [TomeVault](https://tomevault.io).
