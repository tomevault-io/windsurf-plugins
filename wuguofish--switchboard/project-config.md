---
trigger: always_on
description: 本地 MCP Server，讓多個 Claude Code session 互傳訊息。對應的 design spec 在 `docs/superpowers/specs/2026-04-15-switchboard-mcp-design.md`。
---
...
---
> Source: [wuguofish/Switchboard](https://github.com/wuguofish/Switchboard) — distributed by [TomeVault](https://tomevault.io).
