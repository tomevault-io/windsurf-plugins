---
trigger: always_on
description: This repository provides editor tooling for Unity's [SerializeReference], including `SubclassSelector`
---
...
---
> Source: [mackysoft/Unity-SerializeReferenceExtensions](https://github.com/mackysoft/Unity-SerializeReferenceExtensions) — distributed by [TomeVault](https://tomevault.io).
