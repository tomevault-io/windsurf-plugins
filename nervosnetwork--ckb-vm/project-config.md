---
trigger: always_on
description: - This repository is the virtual machine implementation for Nervos CKB.
---
...
---
> Source: [nervosnetwork/ckb-vm](https://github.com/nervosnetwork/ckb-vm) — distributed by [TomeVault](https://tomevault.io).
