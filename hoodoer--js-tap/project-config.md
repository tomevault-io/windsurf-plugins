---
trigger: always_on
description: Before creating or modifying ANY UI elements, read @STYLE_GUIDE.md.
---
...
---
> Source: [hoodoer/JS-Tap](https://github.com/hoodoer/JS-Tap) — distributed by [TomeVault](https://tomevault.io).
