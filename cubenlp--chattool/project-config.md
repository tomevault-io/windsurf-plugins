---
trigger: always_on
description: - CLI 入口：`chattool`、`chatenv`、`chatskill`
---
...
├── tools/      # 工具箱（lark、image、nginx 等；成熟能力如 dns/network 已拆到独立包）
...
---
> Source: [cubenlp/ChatTool](https://github.com/cubenlp/ChatTool) — distributed by [TomeVault](https://tomevault.io).
