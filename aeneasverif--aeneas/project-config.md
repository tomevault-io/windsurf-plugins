---
trigger: always_on
description: Aeneas translates Rust programs to pure Lean code for formal verification.
---
...
---
> Source: [AeneasVerif/aeneas](https://github.com/AeneasVerif/aeneas) — distributed by [TomeVault](https://tomevault.io).
