---
trigger: always_on
description: Este repositório é um espelho público e sanitizado de uma configuração Orquestrador/Codex. Ele deve continuar instalável, revisável e seguro para publicação.
---
...
---
> Source: [FernandoBolzan/Orquestrador-Maestro](https://github.com/FernandoBolzan/Orquestrador-Maestro) — distributed by [TomeVault](https://tomevault.io).
