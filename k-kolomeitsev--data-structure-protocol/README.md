...
Original source: `AGENTS.md` in [k-kolomeitsev/data-structure-protocol](https://github.com/k-kolomeitsev/data-structure-protocol).
...
```
npx tomevault install k-kolomeitsev/data-structure-protocol
```
Source: [github.com/k-kolomeitsev/data-structure-protocol](https://github.com/k-kolomeitsev/data-structure-protocol).
