---
trigger: always_on
description: - **Server Features**: The `ServerSettingsView.tsx` now includes a `FeaturesTab` supporting Text-to-Speech (TTS) and VoiceWake toggles, pulling data through the `openclaw/features.ts` API wrappers (`getTtsStatus`, `setTtsEnable`, etc.).
---
