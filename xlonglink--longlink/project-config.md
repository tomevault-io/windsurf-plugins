---
trigger: always_on
description: - When listing improvement suggestions, use numbered lists.
---
...
---
> Source: [xLongLink/longlink](https://github.com/xLongLink/longlink) — distributed by [TomeVault](https://tomevault.io).
