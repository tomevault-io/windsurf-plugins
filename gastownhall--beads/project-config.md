---
trigger: always_on
description: **beads** (command: `bd`) is a Dolt-powered issue tracker designed for AI-supervised coding workflows. Git integration is optional. We dogfood our own tool for all task tracking.
---
...
---
> Source: [gastownhall/beads](https://github.com/gastownhall/beads) — distributed by [TomeVault](https://tomevault.io).
