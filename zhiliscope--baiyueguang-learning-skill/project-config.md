---
trigger: always_on
description: Claude 支持将一个包含 `SKILL.md` 的文件夹打包成 `.zip` 后上传为 Skill。
---
...
---
> Source: [zhiliscope/baiyueguang-learning-skill](https://github.com/zhiliscope/baiyueguang-learning-skill) — distributed by [TomeVault](https://tomevault.io).
