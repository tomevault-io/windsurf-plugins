---
trigger: always_on
description: You are working in a repo that uses the agentic development framework (folder: .agentic/).
---
...
Subagent context: Run `bash .agentic/tools/context-for-role.sh <role> <feature-id>` to assemble minimal context per subagent. Subagents do NOT inherit instruction files.

Workflows, delegation, gates, checklists: run `ag` commands or see `.agentic/agents/shared/auto_orchestration.md`

---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/tomgun) — claim your Tome and manage your conversions.
