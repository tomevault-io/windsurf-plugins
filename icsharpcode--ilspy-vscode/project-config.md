---
trigger: always_on
description: Applies to files under `backend/ILSpyX.Backend.LSP/`.
---
...
---
> Source: [icsharpcode/ilspy-vscode](https://github.com/icsharpcode/ilspy-vscode) — distributed by [TomeVault](https://tomevault.io).
