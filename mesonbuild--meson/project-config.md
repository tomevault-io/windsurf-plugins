---
trigger: always_on
description: Meson is a cross-platform build system. Due to the complexity of the domain and
---
...
---
> Source: [mesonbuild/meson](https://github.com/mesonbuild/meson) — distributed by [TomeVault](https://tomevault.io).
