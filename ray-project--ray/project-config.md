---
trigger: always_on
description: > These instructions apply to **all** AI-assisted contributions to `ray-project/ray`.
---
...
---
> Source: [ray-project/ray](https://github.com/ray-project/ray) — distributed by [TomeVault](https://tomevault.io).
