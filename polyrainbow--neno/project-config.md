---
trigger: always_on
description: Privacy-first note-taking app built on the Subtext markup language.
---
...
---
> Source: [polyrainbow/neno](https://github.com/polyrainbow/neno) — distributed by [TomeVault](https://tomevault.io).
