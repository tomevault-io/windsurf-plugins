---
trigger: always_on
description: `*warn-on-reflection*` is enabled project-wide (`:global-vars` in
---
...
---
> Source: [manetu/temporal-clojure-sdk](https://github.com/manetu/temporal-clojure-sdk) — distributed by [TomeVault](https://tomevault.io).
