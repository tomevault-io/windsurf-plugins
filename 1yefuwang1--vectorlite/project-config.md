---
trigger: always_on
description: Vectorlite is a SQLite extension for fast vector search using the HNSW algorithm. Written in C++17 with SIMD acceleration via Google Highway. Distributed as Python wheels and npm packages.
---
...
---
> Source: [1yefuwang1/vectorlite](https://github.com/1yefuwang1/vectorlite) — distributed by [TomeVault](https://tomevault.io).
