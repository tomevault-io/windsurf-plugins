---
trigger: always_on
description: Druid is Alibaba's open-source high-performance JDBC connection pool and SQL parser for Java. Version: 1.2.29-SNAPSHOT.
---
...
---
> Source: [alibaba/druid](https://github.com/alibaba/druid) — distributed by [TomeVault](https://tomevault.io).
