---
trigger: always_on
description: Mandatory rules for the UltraViolet repository.
---
...
---
> Source: [yakushstanislav/UltraViolet](https://github.com/yakushstanislav/UltraViolet) — distributed by [TomeVault](https://tomevault.io).
