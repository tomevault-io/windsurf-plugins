---
trigger: always_on
description: This is a Java 17 multi-module Maven project for Opensabre framework starters. The root `pom.xml` aggregates modules and controls the shared `${revision}` version. Dependency versions live in `opensabre-base-dependencies`.
---
...
---
> Source: [opensabre/opensabre-framework](https://github.com/opensabre/opensabre-framework) — distributed by [TomeVault](https://tomevault.io).
