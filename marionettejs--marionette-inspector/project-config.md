---
trigger: always_on
description: The Agent is the script that is injected into the application window. The agent is responsible for spying on the the Application and communicating with the Inspector.
---
...
---
> Source: [marionettejs/marionette.inspector](https://github.com/marionettejs/marionette.inspector) — distributed by [TomeVault](https://tomevault.io).
