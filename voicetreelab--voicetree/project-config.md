---
trigger: always_on
description: If ~/brain/SKILL.md exists, read it before starting work — it is the Brainforest agent operating system (lifecycle, recall, calibration, gardening).
---
...
---
> Source: [voicetreelab/voicetree](https://github.com/voicetreelab/voicetree) — distributed by [TomeVault](https://tomevault.io).
