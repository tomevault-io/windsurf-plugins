---
trigger: always_on
description: Create semver Git tags and GitHub releases from actual repository changes, including release-note generation, annotated tags, and GitHub release publishing.
---


# Release Publisher

Use this rule when preparing, tagging, or publishing a semantic-versioned GitHub release.
