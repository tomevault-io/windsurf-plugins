---
trigger: always_on
description: This file applies to `.github/` and inherits the repository-wide rules in `/AGENTS.md`.
---
...
---
> Source: [lidge-jun/opencodex](https://github.com/lidge-jun/opencodex) — distributed by [TomeVault](https://tomevault.io).
