---
trigger: always_on
description: Follow [the shared automation policy](docs/AUTOMATION_POLICY.md) for all new
---
...
---
> Source: [ventianima-lab/codex-web-gpt-automation](https://github.com/ventianima-lab/codex-web-gpt-automation) — distributed by [TomeVault](https://tomevault.io).
