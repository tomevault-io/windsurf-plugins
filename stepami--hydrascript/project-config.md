---
trigger: always_on
description: HydraScript is a statically typed scripting-language interpreter in C#. Keep this file short; load the follow-ups needed for the task.
---
...
---
> Source: [Stepami/hydrascript](https://github.com/Stepami/hydrascript) — distributed by [TomeVault](https://tomevault.io).
