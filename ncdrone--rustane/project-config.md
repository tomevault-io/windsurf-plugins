---
trigger: always_on
description: **Read `dev/CURRENT.md` first** — it has the live project state, recent fixes, active experiments, and what to do next.
---
...
---
> Source: [ncdrone/rustane](https://github.com/ncdrone/rustane) — distributed by [TomeVault](https://tomevault.io).
