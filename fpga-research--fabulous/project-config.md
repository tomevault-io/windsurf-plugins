---
trigger: always_on
description: FABulous is a parametric FPGA fabric generator. It takes a fabric definition (CSV or YAML), builds an in-memory fabric model, and emits the HDL, nextpnr chip database, synthesis scripts, geometry, and bitstream needed to target that fabric.
---
...
---
> Source: [FPGA-Research/FABulous](https://github.com/FPGA-Research/FABulous) — distributed by [TomeVault](https://tomevault.io).
