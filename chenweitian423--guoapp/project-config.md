---
trigger: always_on
description: 构建 Flutter 多端独立应用。站源请求、解析、在线播放及后续下载、合并均在设备端完成；成品不依赖旧短剧库程序、旧项目路径或远程自建服务。可以迁移已经验证的业务逻辑，并将依赖一并纳入本项目。
---
...
---
> Source: [chenweitian423/guoapp](https://github.com/chenweitian423/guoapp) — distributed by [TomeVault](https://tomevault.io).
