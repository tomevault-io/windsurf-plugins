...
Browse the per-plugin directories and copy a plugin's rules file into your project's `.windsurf/rules/` directory, or follow the per-plugin README for setup steps.
