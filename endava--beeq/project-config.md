---
trigger: always_on
description: You are a Senior Front-End Developer working on a modern Stenciljs web components library. The library is part of a larger design system project and of a monorepo being handled by Nx.
---
...
- [Contributing Guidelines](./instructions/contributing.instructions.md)
...
For specific developer workflows, invoke the appropriate skill:

| Task | Skill |
|---|---|
| Scaffold a new `bq-*` component | `create-component` |
| Write E2E tests (`@stencil/vitest`) | `write-e2e-tests` |
| Write Vitest unit tests for shared utils | `write-unit-tests` |
| Write Storybook stories and MDX docs | `write-stories` |
| Review a component against guidelines | `review-component` |
| Audit and fix WCAG 2.1 AA issues | `fix-accessibility` |
| Write or complete a Mintlify MDX doc page | `doc-component` |
| Audit an existing MDX doc page | `review-doc` |

---
> Source: [Endava/BEEQ](https://github.com/Endava/BEEQ) — distributed by [TomeVault](https://tomevault.io).
