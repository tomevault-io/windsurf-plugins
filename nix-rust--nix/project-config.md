---
trigger: always_on
description: In order to achieve our goal of wrapping [libc][libc] code in idiomatic rust
---
...
---
> Source: [nix-rust/nix](https://github.com/nix-rust/nix) — distributed by [TomeVault](https://tomevault.io).
