---
trigger: always_on
description: The repository builds with the standard .NET SDK CLI; the SDK version is pinned in `global.json`.
---
...
---
> Source: [elastic/elasticsearch-net](https://github.com/elastic/elasticsearch-net) — distributed by [TomeVault](https://tomevault.io).
