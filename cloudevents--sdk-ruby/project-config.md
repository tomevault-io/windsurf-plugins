---
trigger: always_on
description: Handles encoding/decoding CloudEvents to/from HTTP (Rack env hashes). Supports:
---
...
---
> Source: [cloudevents/sdk-ruby](https://github.com/cloudevents/sdk-ruby) — distributed by [TomeVault](https://tomevault.io).
