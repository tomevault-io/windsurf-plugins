---
trigger: always_on
description: Polyflow Taskpool is a modular library for building process platforms with task and business-data pools. It provides core domain capabilities, integrations, and
---
...
---
> Source: [holunda-io/camunda-bpm-taskpool](https://github.com/holunda-io/camunda-bpm-taskpool) — distributed by [TomeVault](https://tomevault.io).
