---
trigger: always_on
description: CodexLoom is a local-first, single-owner application. Unless a task explicitly
---
...
---
> Source: [yan5xu/codexloom](https://github.com/yan5xu/codexloom) — distributed by [TomeVault](https://tomevault.io).
