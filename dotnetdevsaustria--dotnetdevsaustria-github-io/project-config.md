---
trigger: always_on
description: Jekyll website for DotNetDevs.at (Minimal Mistakes theme), hosted on GitHub Pages.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/dotnetdevsaustria)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/dotnetdevsaustria)
