---
trigger: always_on
description: cd webapp && npm run dev          # starts on port 3010
---
...
---
> Source: [aws-samples/serverless-full-stack-webapp-starter-kit](https://github.com/aws-samples/serverless-full-stack-webapp-starter-kit) — distributed by [TomeVault](https://tomevault.io).
