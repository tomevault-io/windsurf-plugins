---
trigger: always_on
description: Use this as the fast path for future work in this repository. The codebase now has characterization tests; do not treat builds alone as enough for non-trivial changes.
---
...
---
> Source: [bjin/hprox](https://github.com/bjin/hprox) — distributed by [TomeVault](https://tomevault.io).
