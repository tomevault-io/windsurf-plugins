---
trigger: always_on
description: This is the standard library for [MoonBit](docs.moonbitlang.com).
---
...
---
> Source: [moonbitlang/core](https://github.com/moonbitlang/core) — distributed by [TomeVault](https://tomevault.io).
