---
trigger: always_on
description: Make merkle-json compatible with Node 24.x to support OIDC npm publishing in dependent projects.
---
...
---
> Source: [oyamist/merkle-json](https://github.com/oyamist/merkle-json) — distributed by [TomeVault](https://tomevault.io).
