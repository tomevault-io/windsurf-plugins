---
trigger: always_on
description: - TorchFont is a beta Python + Rust library for font-focused PyTorch workflows; prefer better architecture over backward compatibility.
---
...
---
> Source: [torchfont/torchfont](https://github.com/torchfont/torchfont) — distributed by [TomeVault](https://tomevault.io).
