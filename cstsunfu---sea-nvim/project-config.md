---
trigger: always_on
description: This repository is a personal Neovim configuration.
---
...
---
> Source: [cstsunfu/.sea.nvim](https://github.com/cstsunfu/.sea.nvim) — distributed by [TomeVault](https://tomevault.io).
