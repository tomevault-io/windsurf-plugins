---
trigger: always_on
description: - **`engine/`** — Core server: API (`engine/api/`), CDN, VCS, hooks, hatchery manager, repositories, authentication, and more.
---
...
---
> Source: [ovh/cds](https://github.com/ovh/cds) — distributed by [TomeVault](https://tomevault.io).
