---
trigger: always_on
description: To generate java tests for the given code, please follow these steps:
---
...
---
> Source: [Angular2Guy/MovieManager](https://github.com/Angular2Guy/MovieManager) — distributed by [TomeVault](https://tomevault.io).
