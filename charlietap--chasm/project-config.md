---
trigger: always_on
description: - **Fast dev loop:** run `./gradlew test`. This executes the runtime unit
---
...
---
> Source: [CharlieTap/chasm](https://github.com/CharlieTap/chasm) — distributed by [TomeVault](https://tomevault.io).
