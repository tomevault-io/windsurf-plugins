---
trigger: always_on
description: JasperFx is the foundational framework for the "Critter Stack" (.NET tools including Marten and Wolverine). It provides core utilities, a CLI framework (formerly Oakton), Roslyn-based runtime code generation, event sourcing abstractions with an async daemon, and multi-tenancy support.
---
...
---
> Source: [JasperFx/jasperfx](https://github.com/JasperFx/jasperfx) — distributed by [TomeVault](https://tomevault.io).
