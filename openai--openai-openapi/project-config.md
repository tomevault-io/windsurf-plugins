---
trigger: always_on
description: Read the [contribution workflow](README.md#contributing) before making changes.
---
...
---
> Source: [openai/openai-openapi](https://github.com/openai/openai-openapi) — distributed by [TomeVault](https://tomevault.io).
