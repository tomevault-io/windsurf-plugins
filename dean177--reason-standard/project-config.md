---
trigger: always_on
description: In Reason / OCaml it is a convention for the primary type of a module to be named `t`.
---
...
---
> Source: [Dean177/reason-standard](https://github.com/Dean177/reason-standard) — distributed by [TomeVault](https://tomevault.io).
