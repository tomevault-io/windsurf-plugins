---
trigger: always_on
description: Browser extension (Chrome/Edge/Firefox) that lets users change the appearance of any website via a visual CSS editor. Vue 2 + TypeScript, built with webpack.
---
...
---
> Source: [ankit/stylebot](https://github.com/ankit/stylebot) — distributed by [TomeVault](https://tomevault.io).
