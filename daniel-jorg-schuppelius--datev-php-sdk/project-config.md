---
trigger: always_on
description: This is a **DATEV Desktop API SDK** for PHP that provides programmatic access to German accounting/payroll software. It follows a **domain-driven design** with strict separation between API clients, endpoints, entities, and contracts.
---
...
---
> Source: [Daniel-Jorg-Schuppelius/datev-php-sdk](https://github.com/Daniel-Jorg-Schuppelius/datev-php-sdk) — distributed by [TomeVault](https://tomevault.io).
