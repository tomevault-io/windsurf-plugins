---
trigger: always_on
description: Android app for scanning and storing barcodes and Apple Wallet passes (.pkpass files).
---
...
---
> Source: [LateNightProductions/CardKeeper](https://github.com/LateNightProductions/CardKeeper) — distributed by [TomeVault](https://tomevault.io).
