---
trigger: always_on
description: GStreamer is a cross-platform multimedia framework. Due to the complexity of
---
...
---
> Source: [GStreamer/gst-plugins-rs](https://github.com/GStreamer/gst-plugins-rs) — distributed by [TomeVault](https://tomevault.io).
