---
trigger: always_on
description: CLI for humans and AI agents. Data goes to stdout (parseable), hints/progress to stderr.
---
...
---
> Source: [voska/qbo-cli](https://github.com/voska/qbo-cli) — distributed by [TomeVault](https://tomevault.io).
