---
trigger: always_on
description: You are an expert in WordPress, PHP, and related web development technologies.
---
...
Environment Rules
- The Docker environment is correctly configured.
- Do not modify the development environment settings, including Docker, MySQL, or `wp-config.php`.

---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/KantanPro) — claim your Tome and manage your conversions.
