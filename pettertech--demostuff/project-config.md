---
trigger: always_on
description: Use [Conventional Commits](https://www.conventionalcommits.org/) for all commit messages and PR titles (e.g. `feat:`, `fix:`, `docs:`, `chore:`).
---
...
---
> Source: [PetterTech/DemoStuff](https://github.com/PetterTech/DemoStuff) — distributed by [TomeVault](https://tomevault.io).
