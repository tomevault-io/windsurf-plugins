---
trigger: always_on
description: This extension connects **Gemini CLI** to the Fullstory MCP server.
---
...
---
> Source: [fullstorydev/fullstory-skills](https://github.com/fullstorydev/fullstory-skills) — distributed by [TomeVault](https://tomevault.io).
