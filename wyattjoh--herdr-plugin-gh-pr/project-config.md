---
trigger: always_on
description: A herdr plugin (v0.7.4+) that labels the focused **agent** pane's sidebar row with the GitHub PR status of that pane's current git branch, via a named `pr` token.
---
...
---
> Source: [wyattjoh/herdr-plugin-gh-pr](https://github.com/wyattjoh/herdr-plugin-gh-pr) — distributed by [TomeVault](https://tomevault.io).
