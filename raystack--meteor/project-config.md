---
trigger: always_on
description: Meteor is a plugin-driven metadata collection agent. It extracts metadata from data stores/services via **extractors**, transforms it via **processors**, and pushes it to catalog services via **sinks**.
---
...
---
> Source: [raystack/meteor](https://github.com/raystack/meteor) — distributed by [TomeVault](https://tomevault.io).
