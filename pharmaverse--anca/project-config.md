---
trigger: always_on
description: R package for automated Non-Compartmental Analysis (NCA) with a Shiny app interface.
---
...
---
> Source: [pharmaverse/aNCA](https://github.com/pharmaverse/aNCA) — distributed by [TomeVault](https://tomevault.io).
