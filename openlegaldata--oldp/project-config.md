---
trigger: always_on
description: OLDP is a Web application based on the Django framework for making legal documents (laws and court decision) accessible as open data.
---
...
---
> Source: [openlegaldata/oldp](https://github.com/openlegaldata/oldp) — distributed by [TomeVault](https://tomevault.io).
