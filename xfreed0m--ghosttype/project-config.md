---
trigger: always_on
description: Context for AI coding assistants (Claude Code, Cursor, Copilot, etc.) working on ghosttype.
---
...
---
> Source: [xFreed0m/ghosttype](https://github.com/xFreed0m/ghosttype) — distributed by [TomeVault](https://tomevault.io).
