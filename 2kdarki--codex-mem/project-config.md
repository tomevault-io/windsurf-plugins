---
trigger: always_on
description: Codex-mem is a Codex plugin providing persistent memory across sessions. It captures tool usage, compresses observations using the Codex Agent SDK, and injects relevant context into future sessions.
---
...
---
> Source: [2kDarki/codex-mem](https://github.com/2kDarki/codex-mem) — distributed by [TomeVault](https://tomevault.io).
