---
trigger: always_on
description: IntelliJ IDEA 插件项目（thief-book-idea，IDE 内"摸鱼"小说阅读器）。Java 编写，面向 IntelliJ Platform。
---
...
---
> Source: [yisier/thief-book-idea](https://github.com/yisier/thief-book-idea) — distributed by [TomeVault](https://tomevault.io).
