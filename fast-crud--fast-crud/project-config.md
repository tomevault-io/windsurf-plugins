---
trigger: always_on
description: 本文件是给 AI 开发代理使用的项目级规范。修改本仓库时，以本文件为优先上下文；若子目录以后出现更近的 `AGENTS.md`，以更近文件为准。
---
...
---
> Source: [fast-crud/fast-crud](https://github.com/fast-crud/fast-crud) — distributed by [TomeVault](https://tomevault.io).
