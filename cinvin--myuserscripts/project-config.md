---
trigger: always_on
description: 本文件定义在 `ncmExtend` 子项目内进行自动化或半自动化改动时的最小协作规范。
---
...
---
> Source: [Cinvin/myuserscripts](https://github.com/Cinvin/myuserscripts) — distributed by [TomeVault](https://tomevault.io).
