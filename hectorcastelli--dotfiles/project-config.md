---
trigger: always_on
description: This repo is a minimal, hackable dotfiles manager implemented as a set of shell scripts and a collection of "profiles". The guidance below helps an AI coding agent make focused, correct edits that follow the project's conventions.
---
...
---
> Source: [HectorCastelli/dotfiles](https://github.com/HectorCastelli/dotfiles) — distributed by [TomeVault](https://tomevault.io).
