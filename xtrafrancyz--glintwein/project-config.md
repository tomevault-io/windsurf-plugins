---
trigger: always_on
description: - `glintwein` is a client-side Minecraft UI framework/mod, split by concern: shared engine in `common/`, Minecraft-version shims in `version/<mc-version>/`, and loader entrypoints in `mod/<version-loader>/`.
---
...
---
> Source: [xtrafrancyz/glintwein](https://github.com/xtrafrancyz/glintwein) — distributed by [TomeVault](https://tomevault.io).
