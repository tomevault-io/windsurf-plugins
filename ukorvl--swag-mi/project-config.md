---
trigger: always_on
description: This repository is a pnpm monorepo template for shipping a TypeScript library from `lib/`, with `docs/` and `example/` workspaces.
---
...
---
> Source: [ukorvl/swag-mi](https://github.com/ukorvl/swag-mi) — distributed by [TomeVault](https://tomevault.io).
