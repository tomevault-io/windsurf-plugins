---
trigger: always_on
description: next-roots is a TypeScript library that generates internationalized (i18n) routes for Next.js applications using the APP directory. It provides an alternative to dynamic `[lang]` segments by pre-generating all localized file-routes.
---
...
---
> Source: [svobik7/next-roots](https://github.com/svobik7/next-roots) — distributed by [TomeVault](https://tomevault.io).
