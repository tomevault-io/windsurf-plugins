---
trigger: always_on
description: Before committing, use ``cd src && make format`` to run clang-format on all .cpp and .hpp files in the src directory. This will ensure consistent code style across the codebase.
---
