---
trigger: always_on
description: Python PDDL parser + object model + reference planning layer (ANTLR4-based).
---
...
---
> Source: [hfoffani/pddl-lib](https://github.com/hfoffani/pddl-lib) — distributed by [TomeVault](https://tomevault.io).
