---
trigger: always_on
description: Do NOT run `npm publish` directly. The release is automated via GitHub.
---
...
---
> Source: [withoneai/cli](https://github.com/withoneai/cli) — distributed by [TomeVault](https://tomevault.io).
