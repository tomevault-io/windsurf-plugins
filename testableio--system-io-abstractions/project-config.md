---
trigger: always_on
description: System.IO.Abstractions is a .NET library that provides testable abstractions for System.IO operations, enabling developers to write unit tests that don't rely on the actual file system.
---
...
---
> Source: [TestableIO/System.IO.Abstractions](https://github.com/TestableIO/System.IO.Abstractions) — distributed by [TomeVault](https://tomevault.io).
