---
trigger: always_on
description: Follow the **[AGENTS.md format](https://agents.md)**. Keep this file short (~50-80 lines); load detailed context from `.agents/` only when task triggers match.
---
