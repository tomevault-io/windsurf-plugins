---
trigger: always_on
description: Ginger is a comprehensive automation IDE supporting multiple platforms (Web, Mobile, APIs, Java, Windows, PowerBuilder, Linux/Unix, Mainframe). It uses a drag-and-drop approach enabling users with or without coding skills to create automation flows.
---
...
---
> Source: [Ginger-Automation/Ginger](https://github.com/Ginger-Automation/Ginger) — distributed by [TomeVault](https://tomevault.io).
