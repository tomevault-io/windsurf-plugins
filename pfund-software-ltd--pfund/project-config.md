---
trigger: always_on
description: There are some conventions used throughout `pfund` for convenience.
---
...
---
> Source: [PFund-Software-Ltd/pfund](https://github.com/PFund-Software-Ltd/pfund) — distributed by [TomeVault](https://tomevault.io).
