---
trigger: always_on
description: RedMatic packages Node-RED as an addon for the Homematic CCU3 / OpenCCU (formerly RaspberryMatic)
---
...
---
> Source: [rdmtc/RedMatic](https://github.com/rdmtc/RedMatic) — distributed by [TomeVault](https://tomevault.io).
