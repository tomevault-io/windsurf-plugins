---
trigger: always_on
description: 编写一份边缘侧大语言模型和VLM推理加速从software到算法教程markdown，要包含大量的实例（能直接数学算就数学算，或者文字说明，不写代码,但会大量讨论软件包如 vllm，sglang）
---
...
---
> Source: [zsc/llm_edge_inference](https://github.com/zsc/llm_edge_inference) — distributed by [TomeVault](https://tomevault.io).
