---
trigger: always_on
description: This guide is intended for AI agents (Codex, bots, contributors) working on the `atosl-rs` repository. It provides an overview of the project structure, development workflows, and coding standards.
---
