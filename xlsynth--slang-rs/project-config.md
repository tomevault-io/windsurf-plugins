---
trigger: always_on
description: Keep every third-party input used by this repository reproducible and tied to
---
...
---
> Source: [xlsynth/slang-rs](https://github.com/xlsynth/slang-rs) — distributed by [TomeVault](https://tomevault.io).
