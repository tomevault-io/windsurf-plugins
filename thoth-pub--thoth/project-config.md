---
trigger: always_on
description: This file extends the repository-root `AGENTS.md`.
---
...
---
> Source: [thoth-pub/thoth](https://github.com/thoth-pub/thoth) — distributed by [TomeVault](https://tomevault.io).
