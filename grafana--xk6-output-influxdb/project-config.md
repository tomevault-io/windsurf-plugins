---
trigger: always_on
description: k6 output extension that ships test metrics to InfluxDB v2. Exists as a separate extension because the v2 API has breaking changes that cannot coexist with the v1 output bundled in k6 core.
---
...
---
> Source: [grafana/xk6-output-influxdb](https://github.com/grafana/xk6-output-influxdb) — distributed by [TomeVault](https://tomevault.io).
