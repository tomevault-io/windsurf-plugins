---
trigger: always_on
description: Fork of microsoft/mimalloc adding pprof-compatible sampled heap profiling (Windows-first)
---
...
---
> Source: [zackees/mimalloc-pprof](https://github.com/zackees/mimalloc-pprof) — distributed by [TomeVault](https://tomevault.io).
