---
trigger: always_on
description: KubeArchive archives Kubernetes resources to a JSON-capable relational database (PostgreSQL, MariaDB, or MySQL), allowing cluster cleanup without data loss.
---
...
---
> Source: [kubearchive/kubearchive](https://github.com/kubearchive/kubearchive) — distributed by [TomeVault](https://tomevault.io).
