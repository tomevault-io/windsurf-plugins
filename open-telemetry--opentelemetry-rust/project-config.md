---
trigger: always_on
description: Guidance for AI coding agents (GitHub Copilot, Claude, Codex, Cursor, etc.) working in
---
...
---
> Source: [open-telemetry/opentelemetry-rust](https://github.com/open-telemetry/opentelemetry-rust) — distributed by [TomeVault](https://tomevault.io).
