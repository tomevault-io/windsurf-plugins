---
trigger: always_on
description: Refactored single-file installer for 3x-ui VPN panel (based on x-ui-pro).
---
...
---
> Source: [mozaroc/3x-ui-pro](https://github.com/mozaroc/3x-ui-pro) — distributed by [TomeVault](https://tomevault.io).
