---
trigger: always_on
description: <!-- description: Declare API versions in ASP.NET Core with conventions instead of attributes, including external assemblies. -->
---
...
---
> Source: [dotnet/aspnet-api-versioning](https://github.com/dotnet/aspnet-api-versioning) — distributed by [TomeVault](https://tomevault.io).
