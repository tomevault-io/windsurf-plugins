---
trigger: always_on
description: `optd` is a Rust 2024 workspace for relational query IR and query-optimizer experiments.
---
...
---
> Source: [cmu-db/optd](https://github.com/cmu-db/optd) — distributed by [TomeVault](https://tomevault.io).
