---
trigger: always_on
description: Lightweight standalone service that receives anonymous telemetry snapshots from GrtBlog instances, stores them in PostgreSQL, and exposes data via Grafana and admin API.
---
...
---
> Source: [grtsinry43/grtblog](https://github.com/grtsinry43/grtblog) — distributed by [TomeVault](https://tomevault.io).
