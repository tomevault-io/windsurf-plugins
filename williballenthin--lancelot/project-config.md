---
trigger: always_on
description: Use the version bump script to ensure all locations are updated:
---
...
---
> Source: [williballenthin/lancelot](https://github.com/williballenthin/lancelot) — distributed by [TomeVault](https://tomevault.io).
