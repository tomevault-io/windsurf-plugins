---
trigger: always_on
description: YouTube 视频中文配音 + 多平台自动发布。后端 Python/FastAPI + 前端 Vue 3/TypeScript。端到端管线：下载→STT→翻译→TTS→合成→发布。
---
...
---
> Source: [yaoyue123/VidDub](https://github.com/yaoyue123/VidDub) — distributed by [TomeVault](https://tomevault.io).
