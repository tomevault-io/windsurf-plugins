---
trigger: always_on
description: Are you building multiple applications or packages and do you want to make sure the same rules are validated on all those repositories?
---
...
---
> Source: [phpro/grumphp](https://github.com/phpro/grumphp) — distributed by [TomeVault](https://tomevault.io).
