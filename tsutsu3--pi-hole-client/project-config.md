---
trigger: always_on
description: Use Conventional Commits format for pull request titles.
---
...
---
> Source: [tsutsu3/pi-hole-client](https://github.com/tsutsu3/pi-hole-client) — distributed by [TomeVault](https://tomevault.io).
