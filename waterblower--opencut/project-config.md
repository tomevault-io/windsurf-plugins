---
trigger: always_on
description: - Do not extract a separate function when it has only one caller and its body is
---
...
---
> Source: [waterblower/opencut](https://github.com/waterblower/opencut) — distributed by [TomeVault](https://tomevault.io).
