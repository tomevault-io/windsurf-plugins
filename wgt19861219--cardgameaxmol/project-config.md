---
trigger: always_on
description: 卡牌手游项目，**用 Godot 4.5 重写为单机版**。原项目为 cocos2d-x 2.x 客户端 + PHP 服务端架构。
---
...
---
> Source: [wgt19861219/CardGameAxmol](https://github.com/wgt19861219/CardGameAxmol) — distributed by [TomeVault](https://tomevault.io).
