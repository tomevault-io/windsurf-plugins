---
trigger: always_on
description: LinkML Map is a framework for specifying and executing mappings between data models.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/linkml)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/linkml)
