---
trigger: always_on
description: A DeepSeek Harness (DSH) plugin **package** (not a single-file plugin): the
---
...
---
> Source: [welsione/dsh-mmx-bridge](https://github.com/welsione/dsh-mmx-bridge) — distributed by [TomeVault](https://tomevault.io).
