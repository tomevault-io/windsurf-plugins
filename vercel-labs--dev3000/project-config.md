---
trigger: always_on
description: This file is the source of truth for agent guidance in this repo. `CLAUDE.md` is symlinked here.
---
...
---
> Source: [vercel-labs/dev3000](https://github.com/vercel-labs/dev3000) — distributed by [TomeVault](https://tomevault.io).
