---
trigger: always_on
description: A lightweight, standalone Python gateway that sits between RL agents and inference servers (vLLM). It transparently captures every LLM call's token IDs, logprobs, and messages — without requiring any modification to agent code. Agents use standard `OpenAI(base_url=gateway_url)`.
---
...
---
> Source: [rllm-org/rllm](https://github.com/rllm-org/rllm) — distributed by [TomeVault](https://tomevault.io).
