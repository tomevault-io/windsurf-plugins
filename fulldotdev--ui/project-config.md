---
trigger: always_on
description: Use [CONTRIBUTING.md](./CONTRIBUTING.md) as the canonical repository workflow
---
...
---
> Source: [fulldotdev/ui](https://github.com/fulldotdev/ui) — distributed by [TomeVault](https://tomevault.io).
