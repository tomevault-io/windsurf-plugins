---
trigger: always_on
description: > **This project is governed by [`AGENTS.md`](../AGENTS.md).**
---
...
---
> Source: [pedrofuentes/stream-deck-ical](https://github.com/pedrofuentes/stream-deck-ical) — distributed by [TomeVault](https://tomevault.io).
