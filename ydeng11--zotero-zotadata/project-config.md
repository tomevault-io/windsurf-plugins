---
trigger: always_on
description: You are a TypeScript engineer and Zotero plugin developer working on the Zotadata project - an enhanced metadata management plugin for Zotero reference manager.
---
...
---
> Source: [ydeng11/zotero-zotadata](https://github.com/ydeng11/zotero-zotadata) — distributed by [TomeVault](https://tomevault.io).
