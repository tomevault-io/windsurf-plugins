---
trigger: always_on
description: This project implements a suite of 10 [Agent Skills](https://agentskills.io) that guide an AI agent through the full Knowledge Space Theory (KST) pipeline: from raw course materials to a usable knowledge graph that supports student assessment, adaptive instruction, and curriculum maintenance.
---
...
---
> Source: [vanderbilt-data-science/knowledge-spaces](https://github.com/vanderbilt-data-science/knowledge-spaces) — distributed by [TomeVault](https://tomevault.io).
