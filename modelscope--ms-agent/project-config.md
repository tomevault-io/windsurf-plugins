---
trigger: always_on
description: MS-Agent is a Python framework for agents, tools and workflows, with CLI, TUI
---
...
---
> Source: [modelscope/ms-agent](https://github.com/modelscope/ms-agent) — distributed by [TomeVault](https://tomevault.io).
