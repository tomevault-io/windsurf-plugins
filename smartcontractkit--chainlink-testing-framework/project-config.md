---
trigger: always_on
description: Every environment generated by `ctf gen env` ships an `AGENTS.md` file at its root that teaches
---
...
---
> Source: [smartcontractkit/chainlink-testing-framework](https://github.com/smartcontractkit/chainlink-testing-framework) — distributed by [TomeVault](https://tomevault.io).
