---
trigger: always_on
description: **n.codes MUST NOT use pre-defined templates or component types.** Agentic UI means the AI generates the complete UI (HTML/CSS/JS) from scratch based on the user's prompt. We cannot predict what the user will ask for, so the system must be capable of generating any UI on the fly.
---
...
---
> Source: [yungookim/n.codes](https://github.com/yungookim/n.codes) — distributed by [TomeVault](https://tomevault.io).
