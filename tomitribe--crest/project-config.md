---
trigger: always_on
description: Annotation-driven CLI framework (`org.tomitribe.crest`).
---
...
---
> Source: [tomitribe/crest](https://github.com/tomitribe/crest) — distributed by [TomeVault](https://tomevault.io).
