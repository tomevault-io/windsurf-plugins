---
trigger: always_on
description: This is **Mastering GitHub Copilot for Paired Programming**, an open-source educational repository maintained by Microsoft. It is a multi-module, 10-hour course that teaches developers how to use GitHub Copilot as an AI coding partner — from beginner to advanced topics including Agent Mode.
---
...
---
> Source: [microsoft/Mastering-GitHub-Copilot-for-Paired-Programming](https://github.com/microsoft/Mastering-GitHub-Copilot-for-Paired-Programming) — distributed by [TomeVault](https://tomevault.io).
