---
trigger: always_on
description: **What this is.** QORM (Query · Observe · Render · Mutate) is a pure-Go,
---
...
---
> Source: [qorm/platform](https://github.com/qorm/platform) — distributed by [TomeVault](https://tomevault.io).
