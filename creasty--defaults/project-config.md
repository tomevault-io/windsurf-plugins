---
trigger: always_on
description: A reflection-based library that fills struct fields from `default:"..."` tags. Narrow scope by
---
...
---
> Source: [creasty/defaults](https://github.com/creasty/defaults) — distributed by [TomeVault](https://tomevault.io).
