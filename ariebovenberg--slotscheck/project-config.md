---
trigger: always_on
description: Guide for AI agents working on the `slotscheck` codebase.
---
...
---
> Source: [ariebovenberg/slotscheck](https://github.com/ariebovenberg/slotscheck) — distributed by [TomeVault](https://tomevault.io).
