---
trigger: always_on
description: This is a Photo Gallery & Portfolio application built with Next.js 15, TypeScript, and Tailwind CSS. The application follows a component-driven architecture with:
---
...
---
> Source: [ps-copilot-sandbox/copilot-intermediate-gallery-repo](https://github.com/ps-copilot-sandbox/copilot-intermediate-gallery-repo) — distributed by [TomeVault](https://tomevault.io).
