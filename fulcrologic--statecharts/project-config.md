---
trigger: always_on
description: Connects statecharts to Fulcro UI framework. This is the most complex subsystem with **10-20% test coverage — critical gap**.
---
...
---
> Source: [fulcrologic/statecharts](https://github.com/fulcrologic/statecharts) — distributed by [TomeVault](https://tomevault.io).
