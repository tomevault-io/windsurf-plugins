---
trigger: always_on
description: d2-checklist is the Angular front end for [d2checklist.com](https://www.d2checklist.com), a Destiny 2 companion app. It uses Angular 19, Angular Material, and the Bungie API.
---
...
---
> Source: [dcaslin/d2-checklist](https://github.com/dcaslin/d2-checklist) — distributed by [TomeVault](https://tomevault.io).
