---
trigger: always_on
description: This module generates compile-time serializers and deserializers. Generated serde code is runtime hot-path code and should be treated like hand-written performance-sensitive code.
---
