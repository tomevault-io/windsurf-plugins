---
trigger: always_on
description: - Runtime: Node.js 24+, TypeScript, ESM modules
---
...
---
> Source: [TimIsOverpowered/archive](https://github.com/TimIsOverpowered/archive) — distributed by [TomeVault](https://tomevault.io).
