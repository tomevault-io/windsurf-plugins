---
trigger: always_on
description: This file gives coding agents the repository-specific rules for Base. It is a
---
...
---
> Source: [codeforester/base](https://github.com/codeforester/base) — distributed by [TomeVault](https://tomevault.io).
