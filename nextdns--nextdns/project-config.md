---
trigger: always_on
description: - Project: NextDNS CLI (`github.com/nextdns/nextdns`)
---
...
---
> Source: [nextdns/nextdns](https://github.com/nextdns/nextdns) — distributed by [TomeVault](https://tomevault.io).
