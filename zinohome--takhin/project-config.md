---
trigger: always_on
description: Takhin is a Kafka-compatible streaming platform rewritten in Go, consisting of two main components:
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/zinohome)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/zinohome)
