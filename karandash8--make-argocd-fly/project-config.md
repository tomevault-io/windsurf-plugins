---
trigger: always_on
description: - Target runtime is Python `>=3.11`; install both pinned files: `pip install -r requirements.txt` and `pip install -r requirements.dev.txt`.
---
...
---
> Source: [Karandash8/make-argocd-fly](https://github.com/Karandash8/make-argocd-fly) — distributed by [TomeVault](https://tomevault.io).
