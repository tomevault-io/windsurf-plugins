---
trigger: always_on
description: When working on schema definitions, build/flatten functions, proxy layers, or any code that interacts with the Genesys Cloud SDK, always read the corresponding SDK model types from:
---
...
---
> Source: [MyPureCloud/terraform-provider-genesyscloud](https://github.com/MyPureCloud/terraform-provider-genesyscloud) — distributed by [TomeVault](https://tomevault.io).
