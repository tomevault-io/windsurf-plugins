---
trigger: always_on
description: 1. **NEVER run neuroimaging tools or downloads of data directly.** ALWAYS write a bash script that uses `module load <tool>/<version>` with an explicit version pinned. Or use osf/datalad inside a script to fetch data!
---
...
---
> Source: [neurodesk/neurocontainers](https://github.com/neurodesk/neurocontainers) — distributed by [TomeVault](https://tomevault.io).
