---
trigger: always_on
description: 本仓库是 Web/H5 逆向工程 SKILLS 总库，active skill inventory 以根目录 `skills-manifest.json` 为单一来源；数量用 `python3 tools/skills_manifest.py summary` 校验。本文件是 OpenAI Codex CLI 的入口约定。
---
...
---
> Source: [zy950618/oh_my_reverse_skill](https://github.com/zy950618/oh_my_reverse_skill) — distributed by [TomeVault](https://tomevault.io).
