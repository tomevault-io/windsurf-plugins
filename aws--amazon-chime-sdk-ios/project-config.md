---
trigger: always_on
description: Tests use handwritten spies and the verification helpers in `common/CommonTestCase.swift`. Do not add Cuckoo, generated mocks, or method-specific verifier proxies without explicit approval.
---
...
---
> Source: [aws/amazon-chime-sdk-ios](https://github.com/aws/amazon-chime-sdk-ios) — distributed by [TomeVault](https://tomevault.io).
