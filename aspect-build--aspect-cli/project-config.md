---
trigger: always_on
description: **Prefer typed constructions.** Use `record(f = field(Type, default = ...))`
---
...
---
> Source: [aspect-build/aspect-cli](https://github.com/aspect-build/aspect-cli) — distributed by [TomeVault](https://tomevault.io).
