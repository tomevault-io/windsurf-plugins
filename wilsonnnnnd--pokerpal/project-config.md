---
trigger: always_on
description: The PokerPal codebase (Expo + React Native + Firebase + local sqlite) — quick guide for AI coding agents
---
...
---
> Source: [wilsonnnnnd/pokerpal](https://github.com/wilsonnnnnd/pokerpal) — distributed by [TomeVault](https://tomevault.io).
