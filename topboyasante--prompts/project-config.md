---
trigger: always_on
description: This project has a living `docs/` folder with architecture, implementation, patterns, decisions, and changelog files.
---
...
---
> Source: [topboyasante/prompts](https://github.com/topboyasante/prompts) — distributed by [TomeVault](https://tomevault.io).
