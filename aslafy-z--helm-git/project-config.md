---
trigger: always_on
description: helm-git is a Helm downloader plugin that enables fetching charts directly from Git repositories. The plugin is written primarily in shell script with npm-based development tooling.
---
...
---
> Source: [aslafy-z/helm-git](https://github.com/aslafy-z/helm-git) — distributed by [TomeVault](https://tomevault.io).
