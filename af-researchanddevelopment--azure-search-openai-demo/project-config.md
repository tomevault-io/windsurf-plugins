---
trigger: always_on
description: This file contains instructions for developers working on the Azure Search and OpenAI demo application. It covers the overall code layout, how to add new data, how to add new azd environment variables, how to add new developer settings, and how to add tests for new features.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/AF-ResearchAndDevelopment)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/AF-ResearchAndDevelopment)
