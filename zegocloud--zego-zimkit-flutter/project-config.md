---
trigger: always_on
description: > **Note**: This library is part of the `zego_uikits` monorepo. See the root [CLAUDE.md](https://github.com/your-org/zego_uikits/blob/main/CLAUDE.md) for cross-library dependencies and architecture overview.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/ZEGOCLOUD) — claim your Tome and manage your conversions.
