---
trigger: always_on
description: Prefer bun over node for running scripts.
---
...
---
> Source: [TeselaGen/tg-oss](https://github.com/TeselaGen/tg-oss) — distributed by [TomeVault](https://tomevault.io).
