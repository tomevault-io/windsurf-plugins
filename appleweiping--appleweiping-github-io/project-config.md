---
trigger: always_on
description: `al-folio` is a **thin starter** for the pluginized architecture.
---
...
---
> Source: [appleweiping/appleweiping.github.io](https://github.com/appleweiping/appleweiping.github.io) — distributed by [TomeVault](https://tomevault.io).
