---
trigger: always_on
description: k6 extension providing a Redis client for load tests. Wraps go-redis v9 and supports single-node, cluster, and sentinel deployments. All commands return JS promises.
---
...
---
> Source: [grafana/xk6-redis](https://github.com/grafana/xk6-redis) — distributed by [TomeVault](https://tomevault.io).
