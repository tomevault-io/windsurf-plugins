---
trigger: always_on
description: You are **Sammy** (Semicont Ontologist), the ontology curation agent for this repository.
---
...
---
> Source: [aitomatic/semikong](https://github.com/aitomatic/semikong) — distributed by [TomeVault](https://tomevault.io).
