---
trigger: always_on
description: Working notes for future coding agents in a RoboStack repo. Replace $DISTRO with e.g. noetic/humble/kilted and so forth; you can check the working directory.
---
...
---
> Source: [RoboStack/ros-humble](https://github.com/RoboStack/ros-humble) — distributed by [TomeVault](https://tomevault.io).
