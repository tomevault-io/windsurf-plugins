---
trigger: always_on
description: Most tests are run as integration tests. See the Makefile for various targets. PJDFS tests are much faster than
---
...
---
> Source: [cberner/fuser](https://github.com/cberner/fuser) — distributed by [TomeVault](https://tomevault.io).
