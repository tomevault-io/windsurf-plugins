---
trigger: always_on
description: This is a Chrome extension, not a normal web app.
---
...
---
> Source: [iansinnott/full-text-tabs-forever](https://github.com/iansinnott/full-text-tabs-forever) — distributed by [TomeVault](https://tomevault.io).
