---
trigger: always_on
description: Wraps `html-react-parser` with `isomorphic-dompurify` to sanitize HTML before parsing into React elements. Works in both SSR (Node) and browser environments.
---
...
---
> Source: [NaverPayDev/pie](https://github.com/NaverPayDev/pie) — distributed by [TomeVault](https://tomevault.io).
