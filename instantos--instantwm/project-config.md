---
trigger: always_on
description: This is a Rust rewrite of a C dwm fork. It has since deviated a lot from dwm,
---
...
---
> Source: [instantOS/instantWM](https://github.com/instantOS/instantWM) — distributed by [TomeVault](https://tomevault.io).
