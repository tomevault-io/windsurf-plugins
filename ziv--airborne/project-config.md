---
trigger: always_on
description: A modern remake of F-15 Strike Eagle II — not a full simulator, not an arcade, but something in between. Built from scratch with raylib (no game engine). The codebase uses C++23 modules and an ECS architecture (EnTT).
---
...
---
> Source: [ziv/airborne](https://github.com/ziv/airborne) — distributed by [TomeVault](https://tomevault.io).
