---
trigger: always_on
description: 为 AI 协作者（以及新接手的开发者）梳理本项目的关键约定。本文件描述架构、目录职责，以及修改各类功能时必须遵守的模式。与代码不一致时，以代码为准。
---
...
---
> Source: [wly5556/S1-Orange](https://github.com/wly5556/S1-Orange) — distributed by [TomeVault](https://tomevault.io).
