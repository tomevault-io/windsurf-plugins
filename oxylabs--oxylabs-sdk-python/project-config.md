---
trigger: always_on
description: Python SDK for Oxylabs Web Scraper APIs. Provides sync (`RealtimeClient`) and async (`AsyncClient`) wrappers for 50+ scraping sources.
---
...
---
> Source: [oxylabs/oxylabs-sdk-python](https://github.com/oxylabs/oxylabs-sdk-python) — distributed by [TomeVault](https://tomevault.io).
