---
trigger: always_on
description: This project contains TypeScript jscodeshift codemod examples.
---
...
---
> Source: [chimurai/jscodeshift-typescript-example](https://github.com/chimurai/jscodeshift-typescript-example) — distributed by [TomeVault](https://tomevault.io).
