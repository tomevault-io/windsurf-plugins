---
trigger: always_on
description: **wlpinyin** - 实验性 Wayland 中文输入法，使用 Rime 引擎。
---
...
**依赖:** wayland-client, wayland-protocols, rime, xkbcommon, glib-2.0  
...
---
> Source: [xhebox/wlpinyin](https://github.com/xhebox/wlpinyin) — distributed by [TomeVault](https://tomevault.io).
