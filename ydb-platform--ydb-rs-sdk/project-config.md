---
trigger: always_on
description: Canonical agent entry point. Tool configs (`CLAUDE.md`, Cursor rules) start here and route to [`.agents/`](.agents/).
---
...
---
> Source: [ydb-platform/ydb-rs-sdk](https://github.com/ydb-platform/ydb-rs-sdk) — distributed by [TomeVault](https://tomevault.io).
