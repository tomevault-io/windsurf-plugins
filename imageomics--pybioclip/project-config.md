---
trigger: always_on
description: pybioclip is a Python package and CLI tool that simplifies using BioCLIP for taxonomic image classification, custom label prediction, and embedding generation. This tool requires network connectivity to HuggingFace Hub for downloading pre-trained models.
---
...
---
> Source: [Imageomics/pybioclip](https://github.com/Imageomics/pybioclip) — distributed by [TomeVault](https://tomevault.io).
