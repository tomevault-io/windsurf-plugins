---
trigger: always_on
description: Tool-agnostic entry point for AI coding agents (Codex, Cursor, Aider, Claude Code, etc.).
---
...
---
> Source: [MakazhanAlpamys/Soup](https://github.com/MakazhanAlpamys/Soup) — distributed by [TomeVault](https://tomevault.io).
