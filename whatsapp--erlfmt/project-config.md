---
trigger: always_on
description: Opinionated Erlang code formatter. Built with rebar3, runs on OTP 24+.
---
...
---
> Source: [WhatsApp/erlfmt](https://github.com/WhatsApp/erlfmt) — distributed by [TomeVault](https://tomevault.io).
