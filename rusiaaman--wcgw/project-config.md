---
trigger: always_on
description: - Make sure mypy --strict passes for these two folders `uv run mypy --strict src/wcgw src/wcgw_cli`.
---
...
---
> Source: [rusiaaman/wcgw](https://github.com/rusiaaman/wcgw) — distributed by [TomeVault](https://tomevault.io).
