---
trigger: always_on
description: > **Note**: This file follows the [AGENTS.md standard](https://agents.md/) for cross-tool compatibility with Cursor, GitHub Copilot, and other AI coding assistants. A Claude Code-specific version is maintained in `CLAUDE.md`.
---
...
---
> Source: [ansari-project/ansari-skill](https://github.com/ansari-project/ansari-skill) — distributed by [TomeVault](https://tomevault.io).
