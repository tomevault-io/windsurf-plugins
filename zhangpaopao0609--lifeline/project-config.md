---
trigger: always_on
description: Project context for AI agents working in this repo. Tool-agnostic. `CLAUDE.md` is a symlink to this file — **edit this file only**.
---
...
---
> Source: [zhangpaopao0609/lifeline](https://github.com/zhangpaopao0609/lifeline) — distributed by [TomeVault](https://tomevault.io).
