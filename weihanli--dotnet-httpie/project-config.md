---
trigger: always_on
description: A command-line HTTP client for .NET, providing a user-friendly alternative to curl for API testing and debugging. This tool can be installed as a global .NET tool or run as a Docker container.
---
...
---
> Source: [WeihanLi/dotnet-httpie](https://github.com/WeihanLi/dotnet-httpie) — distributed by [TomeVault](https://tomevault.io).
