---
trigger: always_on
description: - **Build**: `npm run build` or `pnpm build` (builds with Vite and copies assets to dist/)
---
...
---
> Source: [vipzhicheng/logseq-plugin-vim-shortcuts](https://github.com/vipzhicheng/logseq-plugin-vim-shortcuts) — distributed by [TomeVault](https://tomevault.io).
