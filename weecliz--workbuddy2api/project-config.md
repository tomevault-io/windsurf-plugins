---
trigger: always_on
description: Gemini CLI 默认只读取 GEMINI.md（默认上下文文件名），不读 AGENTS.md。
---
...
---
> Source: [weecliz/workbuddy2api](https://github.com/weecliz/workbuddy2api) — distributed by [TomeVault](https://tomevault.io).
