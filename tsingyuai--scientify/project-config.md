---
trigger: always_on
description: 本文档指导 Claude 进行 Scientify 插件的版本更新和发布工作。
---
...
---
> Source: [tsingyuai/scientify](https://github.com/tsingyuai/scientify) — distributed by [TomeVault](https://tomevault.io).
