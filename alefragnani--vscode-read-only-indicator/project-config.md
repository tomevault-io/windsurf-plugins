...
# Read-Only Indicator Agents Instructions
...
---
> Source: [alefragnani/vscode-read-only-indicator](https://github.com/alefragnani/vscode-read-only-indicator) — distributed by [TomeVault](https://tomevault.io).
