---
trigger: always_on
description: - This is a Chrome Extension (Manifest V3) for sending links, images, or selected text to user-configurable webhooks.
---
...
---
> Source: [ejfn/send-to-webhook](https://github.com/ejfn/send-to-webhook) — distributed by [TomeVault](https://tomevault.io).
