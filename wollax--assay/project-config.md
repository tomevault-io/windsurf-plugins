---
trigger: always_on
description: You are working within the Assay monorepo, an agentic development kit built in Rust. The repo contains two projects: **assay** (spec-driven dev kit) and **smelt** (infrastructure layer for container-based job execution).
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/wollax)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/wollax)
