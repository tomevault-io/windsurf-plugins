---
trigger: always_on
description: This file is your operating manual. Read it at the start of every session. It defines the wiki structure, entity types, workflows, and conventions you must follow.
---
...
---
> Source: [balukosuri/llm-wiki-karpathy](https://github.com/balukosuri/llm-wiki-karpathy) — distributed by [TomeVault](https://tomevault.io).
