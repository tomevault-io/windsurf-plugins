---
trigger: always_on
description: These are repository-wide guidelines. Path‑scoped files in `.github/instructions/*.instructions.md` provide focused guidance for specific areas (frontend, API, database).
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/githubschool)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/githubschool)
