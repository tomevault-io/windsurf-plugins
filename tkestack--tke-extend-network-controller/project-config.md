---
trigger: always_on
description: TKE Extend Network Controller 是一个 TKE (腾讯云 Kubernetes) 集群的网络控制器，主要用于游戏房间、会议等房间类场景，为每个 Pod/Node 分配独立的公网地址映射（通过 CLB 端口池实现）。
---
...
---
> Source: [tkestack/tke-extend-network-controller](https://github.com/tkestack/tke-extend-network-controller) — distributed by [TomeVault](https://tomevault.io).
