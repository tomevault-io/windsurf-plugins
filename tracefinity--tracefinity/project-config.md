---
trigger: always_on
description: Tool tracing app that generates 3D-printable gridfinity bins from photos. Backend is Python/FastAPI with OpenCV and manifold3d; frontend is Next.js 16/React 19/TypeScript with react-three-fiber for 3D preview.
---
...
---
> Source: [tracefinity/tracefinity](https://github.com/tracefinity/tracefinity) — distributed by [TomeVault](https://tomevault.io).
