---
trigger: always_on
description: This file provides guidance to coding agents (Claude Code, Codex, Cursor, Aider, and similar) working in the public Campos repository.
---
...
---
> Source: [withqwerty/campos](https://github.com/withqwerty/campos) — distributed by [TomeVault](https://tomevault.io).
