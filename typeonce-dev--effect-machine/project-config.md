---
trigger: always_on
description: Effect Machine is intended to become part of the core `effect` library. Treat that as an architectural requirement: public APIs, failures, module boundaries, ownership, and implementation patterns must meet Effect's standards and fit its general API shape.
---
...
---
> Source: [typeonce-dev/effect-machine](https://github.com/typeonce-dev/effect-machine) — distributed by [TomeVault](https://tomevault.io).
