---
trigger: always_on
description: - `using namespace testing;` is not allowed; use fully qualified names instead.
---
...
---
> Source: [philips-software/amp-embedded-infra-lib](https://github.com/philips-software/amp-embedded-infra-lib) — distributed by [TomeVault](https://tomevault.io).
