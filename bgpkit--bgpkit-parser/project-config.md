---
trigger: always_on
description: `bgpkit-parser` is a Rust library for parsing MRT/BGP/BMP data. It provides both a library API and a CLI (`bgpkit-parser` binary).
---
...
---
> Source: [bgpkit/bgpkit-parser](https://github.com/bgpkit/bgpkit-parser) — distributed by [TomeVault](https://tomevault.io).
