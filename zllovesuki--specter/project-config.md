---
trigger: always_on
description: - `main.go` launches the `specter` CLI; `cmd/specter` wires top-level commands, and `cmd/{server,client,dns,...}` holds command entrypoints/helpers.
---
...
---
> Source: [zllovesuki/specter](https://github.com/zllovesuki/specter) — distributed by [TomeVault](https://tomevault.io).
