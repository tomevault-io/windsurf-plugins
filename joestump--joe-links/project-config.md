---
trigger: always_on
description: A self-hosted "go links" service — short memorable slugs that redirect to long URLs.
---
...
---
> Source: [joestump/joe-links](https://github.com/joestump/joe-links) — distributed by [TomeVault](https://tomevault.io).
