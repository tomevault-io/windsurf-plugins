---
trigger: always_on
description: This repository contains the **BMAD Skills** package for Claude Code - a suite of skills implementing the BMAD Method (Breakthrough Method for Agile AI-Driven Development).
---
...
---
> Source: [aj-geddes/claude-code-bmad-skills](https://github.com/aj-geddes/claude-code-bmad-skills) — distributed by [TomeVault](https://tomevault.io).
