---
trigger: always_on
description: GitOps monorepo deploying 50+ Kubernetes components across multiple clusters via Kustomize and ArgoCD ApplicationSets.
---
...
---
> Source: [redhat-appstudio/infra-deployments](https://github.com/redhat-appstudio/infra-deployments) — distributed by [TomeVault](https://tomevault.io).
