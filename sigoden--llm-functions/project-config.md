---
trigger: always_on
description: The agent follows a specific organizational structure to ensure streamlined functionality and easy access to essential files:
---
...
---
> Source: [sigoden/llm-functions](https://github.com/sigoden/llm-functions) — distributed by [TomeVault](https://tomevault.io).
