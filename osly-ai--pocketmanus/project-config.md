---
trigger: always_on
description: An agent is a powerful design pattern in which a node can take dynamic actions based on the context it receives. To express an agent, create a Node with a prompt template like:
---
...
---
> Source: [Osly-AI/PocketManus](https://github.com/Osly-AI/PocketManus) — distributed by [TomeVault](https://tomevault.io).
