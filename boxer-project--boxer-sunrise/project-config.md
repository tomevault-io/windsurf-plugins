---
trigger: always_on
description: Each commit message should ideally begin with one of the following prefixes:
---
...
---
> Source: [boxer-project/boxer-sunrise](https://github.com/boxer-project/boxer-sunrise) — distributed by [TomeVault](https://tomevault.io).
