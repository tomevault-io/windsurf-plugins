---
trigger: always_on
description: 本文档为 Claude Code (claude.ai/code) 在本代码库中工作提供指导。
---
...
---
> Source: [go-water/water](https://github.com/go-water/water) — distributed by [TomeVault](https://tomevault.io).
