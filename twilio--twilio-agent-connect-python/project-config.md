---
trigger: always_on
description: Twilio Agent Connect (TAC) is a Python SDK — middleware (not an agent runtime) that enables LLM applications (OpenAI Agents SDK, Bedrock, LangChain, etc.) to use Twilio primitives: Conversation Memory for memory, Conversation Orchestrator for conversations, ConversationRelay for voice.
---
...
---
> Source: [twilio/twilio-agent-connect-python](https://github.com/twilio/twilio-agent-connect-python) — distributed by [TomeVault](https://tomevault.io).
