---
trigger: always_on
description: This document outlines the coding standards, guidelines, and best practices for contributing to the bUnit project.
---
...
---
> Source: [bUnit-dev/bUnit](https://github.com/bUnit-dev/bUnit) — distributed by [TomeVault](https://tomevault.io).
