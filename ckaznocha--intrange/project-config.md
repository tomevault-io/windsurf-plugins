---
trigger: always_on
description: The primary way this project gets used is as a library. The main entry point is
---
...
---
> Source: [ckaznocha/intrange](https://github.com/ckaznocha/intrange) — distributed by [TomeVault](https://tomevault.io).
