---
trigger: always_on
description: 这个仓库当前主线研究 high_speed_train / motorBike 上的 OpenFOAM-style finite-volume physics loss。请优先保持仓库结构整洁。
---
...
---
> Source: [zoujunhong/UniField](https://github.com/zoujunhong/UniField) — distributed by [TomeVault](https://tomevault.io).
