---
trigger: always_on
description: SVGPathCommander v2.2.0 — TypeScript library for manipulating SVG `<path>` `d` attributes. Works in browser and Node.js.
---
...
---
> Source: [thednp/svg-path-commander](https://github.com/thednp/svg-path-commander) — distributed by [TomeVault](https://tomevault.io).
