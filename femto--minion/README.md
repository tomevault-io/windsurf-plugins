...
Original source: `CLAUDE.md` in [femto/minion](https://github.com/femto/minion).
...
From [femto/minion](https://github.com/femto/minion) — a repo with 141+ stars on GitHub.
