---
trigger: always_on
description: When writing tests for vcspull, leverage libvcs's pytest plugin to efficiently create and manage VCS repositories during testing.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/vcs-python)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/vcs-python)
