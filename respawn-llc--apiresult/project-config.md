---
trigger: always_on
description: - `core/` is the Kotlin Multiplatform library. Shared code lives in `core/src/commonMain/kotlin/pro/respawn/apiresult/`.
---
...
---
> Source: [respawn-llc/ApiResult](https://github.com/respawn-llc/ApiResult) — distributed by [TomeVault](https://tomevault.io).
