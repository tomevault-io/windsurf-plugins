---
trigger: always_on
description: Purpose: quick orientation for an automated coding agent (or reviewer) to be productive in this Windows AutoHotkey v2 project.
---
...
---
> Source: [ecornell/ai-tools-ahk](https://github.com/ecornell/ai-tools-ahk) — distributed by [TomeVault](https://tomevault.io).
