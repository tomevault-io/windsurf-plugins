---
trigger: always_on
description: Welcome, AI Agent! This document provides context, architectural guidelines, and coding standards for interacting with the **Resaca** repository. Please read and adhere to these instructions when generating code, writing tests, or proposing architectural changes.
---
...
---
> Source: [sebaslogen/resaca](https://github.com/sebaslogen/resaca) — distributed by [TomeVault](https://tomevault.io).
