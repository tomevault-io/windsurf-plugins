---
trigger: always_on
description: Topos is a layer for AI agents to share **behaviors** within a team or organization. A behavior (a
---
...
---
> Source: [topos-sh/topos](https://github.com/topos-sh/topos) — distributed by [TomeVault](https://tomevault.io).
