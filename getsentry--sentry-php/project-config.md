---
trigger: always_on
description: - `sentry/sentry` is the core PHP SDK, not an application or framework bundle.
---
...
---
> Source: [getsentry/sentry-php](https://github.com/getsentry/sentry-php) — distributed by [TomeVault](https://tomevault.io).
