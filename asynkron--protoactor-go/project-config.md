---
trigger: always_on
description: - Lint the code, there is a script for this, "make lint", then fix some of the reported issues
---
...
---
> Source: [asynkron/protoactor-go](https://github.com/asynkron/protoactor-go) — distributed by [TomeVault](https://tomevault.io).
