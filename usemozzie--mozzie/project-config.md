---
trigger: always_on
description: You are building **Mozzie**, a Tauri 2.0 desktop app for AI agent orchestration. The full spec is in `docs/mozzie-phase1-spec.docx`. Read it before doing anything.
---
...
---
> Source: [usemozzie/mozzie](https://github.com/usemozzie/mozzie) — distributed by [TomeVault](https://tomevault.io).
