---
trigger: always_on
description: TypeScript project using npm for dependency management.
---
...
---
> Source: [victronenergy/venus-html5-app](https://github.com/victronenergy/venus-html5-app) — distributed by [TomeVault](https://tomevault.io).
