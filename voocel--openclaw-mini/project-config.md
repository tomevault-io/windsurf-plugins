---
trigger: always_on
description: 如果存在 `BOOTSTRAP.md`，它就是你的“出生说明”。先完成它，再删除。之后就不再需要它。
---
...
---
> Source: [voocel/openclaw-mini](https://github.com/voocel/openclaw-mini) — distributed by [TomeVault](https://tomevault.io).
