---
trigger: always_on
description: Thundernetes makes it easy to run game servers on Kubernetes. It originates from the Azure PlayFab Multiplayer Servers team and enables running both Windows and Linux game servers on Kubernetes clusters. Key capabilities include:
---
...
---
> Source: [PlayFab/thundernetes](https://github.com/PlayFab/thundernetes) — distributed by [TomeVault](https://tomevault.io).
