---
trigger: always_on
description: Official University of Illinois mobile app (Rokwire Platform). No automated
---
...
---
> Source: [rokwire/illinois-app](https://github.com/rokwire/illinois-app) — distributed by [TomeVault](https://tomevault.io).
