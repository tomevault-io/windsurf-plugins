---
trigger: always_on
description: <!-- jankurai generated adapter -->
---
...
---
> Source: [jeppsontaylor/Jankurai](https://github.com/jeppsontaylor/Jankurai) — distributed by [TomeVault](https://tomevault.io).
