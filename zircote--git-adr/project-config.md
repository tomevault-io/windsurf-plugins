---
trigger: always_on
description: git-adr is a Rust CLI tool for managing Architecture Decision Records (ADRs) stored in **git notes** (not files), making ADRs non-intrusive and portable with git history.
---
