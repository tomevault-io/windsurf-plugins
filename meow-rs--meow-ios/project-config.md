---
trigger: always_on
description: To save GitHub Actions minutes and keep the red-main failure mode from coming back, always run lint and the full relevant test suite locally before pushing to the remote.
---
...
---
> Source: [meow-rs/meow-ios](https://github.com/meow-rs/meow-ios) — distributed by [TomeVault](https://tomevault.io).
