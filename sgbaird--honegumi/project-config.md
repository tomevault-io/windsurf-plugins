---
trigger: always_on
description: - Look up honegumi github repo using your context7 mcp tool
---
...
---
> Source: [sgbaird/honegumi](https://github.com/sgbaird/honegumi) — distributed by [TomeVault](https://tomevault.io).
