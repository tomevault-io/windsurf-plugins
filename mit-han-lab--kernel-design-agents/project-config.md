---
trigger: always_on
description: This repository is the Kernel Design Agents prompt and workflow release artifact for MLSys 2026 FlashInfer NVIDIA track kernel submissions.
---

# Agent Instructions

This repository is the Kernel Design Agents prompt and workflow release artifact for MLSys 2026 FlashInfer NVIDIA track kernel submissions.

## Repository Rules

- Use English for all repository-facing files, comments, documentation, prompts, and commit messages.
- Released final-result snapshots live in `git@github.com:DongyunZou/HANLab-Kernel-Mafia-MLSys2026-Submissions.git` for provenance only.
...
---
> Source: [mit-han-lab/kernel-design-agents](https://github.com/mit-han-lab/kernel-design-agents) — distributed by [TomeVault](https://tomevault.io).
