---
trigger: always_on
description: Writing this file is not a statement for or against using AI coding agents.
---
...
---
> Source: [uutils/coreutils](https://github.com/uutils/coreutils) — distributed by [TomeVault](https://tomevault.io).
