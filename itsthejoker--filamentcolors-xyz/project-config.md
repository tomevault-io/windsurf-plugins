---
trigger: always_on
description: This document captures practical guidelines derived from the current codebase. It should help you write code that fits the repository and run tests confidently.
---
...
---
> Source: [itsthejoker/filamentcolors.xyz](https://github.com/itsthejoker/filamentcolors.xyz) — distributed by [TomeVault](https://tomevault.io).
