---
trigger: always_on
description: [page.tsx](mdc:apps/lasereyes-docs/app/page.tsx) [page.tsx](mdc:apps/lasereyes-docs/app/docs/page.tsx)
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/omnisat)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/omnisat)
