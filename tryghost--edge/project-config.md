---
trigger: always_on
description: This package is the Edge Ghost theme. In the standalone mirror repository, this tree is pushed from `TryGhost/Themes/packages/edge` by subtree sync; make durable theme-content changes in `TryGhost/Themes` unless the task is explicitly repo-level metadata or GitHub settings.
---
...
---
> Source: [TryGhost/Edge](https://github.com/TryGhost/Edge) — distributed by [TomeVault](https://tomevault.io).
