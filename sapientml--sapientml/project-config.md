---
trigger: always_on
description: - **Purpose**: AutoML library that generates scikit-learn pipelines from tabular data
---
...
---
> Source: [sapientml/sapientml](https://github.com/sapientml/sapientml) — distributed by [TomeVault](https://tomevault.io).
