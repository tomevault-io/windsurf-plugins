---
trigger: always_on
description: **IMPORTANT**: Before making any changes or attempting to interact with the game system, read the Game Flow documentation (see Resources below) to understand the game mechanics and how to navigate the application.
---
...
---
> Source: [TNG/elevation-of-privilege](https://github.com/TNG/elevation-of-privilege) — distributed by [TomeVault](https://tomevault.io).
