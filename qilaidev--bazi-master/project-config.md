---
trigger: always_on
description: 仓库根有一个面向 Agent 调用的程序化 CLI。环境准备、起停本地栈、数据库迁移、测试、端到端校验
---
...
---
> Source: [qilaidev/bazi-master](https://github.com/qilaidev/bazi-master) — distributed by [TomeVault](https://tomevault.io).
