---
trigger: always_on
description: The codebase follows a domain-based architecture:
---
...
---
> Source: [MRVDH/picnic-api](https://github.com/MRVDH/picnic-api) — distributed by [TomeVault](https://tomevault.io).
