---
trigger: always_on
description: Documentation for Dify, built with Mintlify. English is the source language; Chinese and Japanese translations are generated automatically. Exception: `en/self-host/configuration/environments.mdx` is excluded from the translation pipeline and must be translated manually.
---
...
---
> Source: [langgenius/dify-docs](https://github.com/langgenius/dify-docs) — distributed by [TomeVault](https://tomevault.io).
