---
trigger: always_on
description: A simple, expressive, extensible Liquid template engine for JavaScript — Shopify, Jekyll and GitHub Pages compatible, for Node.js, browsers, and the CLI, with TypeScript support. TypeScript in `src/`, bundles in `dist/`. Docs site in `docs/` (Hexo, `navy` theme).
---
...
---
> Source: [harttle/liquidjs](https://github.com/harttle/liquidjs) — distributed by [TomeVault](https://tomevault.io).
