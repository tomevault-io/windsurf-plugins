---
trigger: always_on
description: Node.js API compatibility layer for Hermes. Ports Node's native bindings to Node-API; reuses Node's `lib/*.js` files.
---
...
---
> Source: [tmikov/hermes-node](https://github.com/tmikov/hermes-node) — distributed by [TomeVault](https://tomevault.io).
