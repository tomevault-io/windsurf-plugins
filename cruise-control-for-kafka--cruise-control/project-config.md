---
trigger: always_on
description: All pull requests **must** use the PR template located at `.github/pull_request_template.md`.
---
...
Every PR **must** be linked to an existing issue(if there's pre-existing one). Replace the issue placeholder
template:
...
If no issue exists, please remove the issue placeholder.
...
---
> Source: [cruise-control-for-kafka/cruise-control](https://github.com/cruise-control-for-kafka/cruise-control) — distributed by [TomeVault](https://tomevault.io).
