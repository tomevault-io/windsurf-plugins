---
trigger: always_on
description: `gitbackup` is a command-line tool written in Go that backs up Git repositories from GitHub, GitLab, and Bitbucket. It supports two operation modes:
---
...
---
> Source: [amitsaha/gitbackup](https://github.com/amitsaha/gitbackup) — distributed by [TomeVault](https://tomevault.io).
