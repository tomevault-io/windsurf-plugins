---
trigger: always_on
description: Module-specific guidance for AI agents. Root `../AGENTS.md` still applies; this file only adds rules that matter inside `hugegraph-llm`.
---
...
---
> Source: [apache/hugegraph-ai](https://github.com/apache/hugegraph-ai) — distributed by [TomeVault](https://tomevault.io).
