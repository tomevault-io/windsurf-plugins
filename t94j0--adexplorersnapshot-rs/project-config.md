---
trigger: always_on
description: cargo run -- ./data/snapshot.bak -o /tmp/output.tar.gz
---
...
---
> Source: [t94j0/adexplorersnapshot-rs](https://github.com/t94j0/adexplorersnapshot-rs) — distributed by [TomeVault](https://tomevault.io).
