---
trigger: always_on
description: - **pb/** — PocketBase backend (Go binary + JS hooks). Owns the SQLite DB, auth, file storage, and custom API routes.
---
...
---
> Source: [spinspire/pocketbase-sveltekit-starter](https://github.com/spinspire/pocketbase-sveltekit-starter) — distributed by [TomeVault](https://tomevault.io).
