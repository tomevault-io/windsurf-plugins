---
trigger: always_on
description: You might be in a sandbox. Check out [safehouse.sb](docs/internal/ai/safehouse.sb).
---
...
---
> Source: [plasmicapp/plasmic](https://github.com/plasmicapp/plasmic) — distributed by [TomeVault](https://tomevault.io).
