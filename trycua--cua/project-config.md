---
trigger: always_on
description: Preserve contributor credit when external code or design ships in Cua.
---
...
---
> Source: [trycua/cua](https://github.com/trycua/cua) — distributed by [TomeVault](https://tomevault.io).
