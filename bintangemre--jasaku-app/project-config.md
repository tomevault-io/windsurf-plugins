---
trigger: always_on
description: Jasaku is a home-service marketplace with two packages in this monorepo.
---
...
---
> Source: [bintangemre/Jasaku-App](https://github.com/bintangemre/Jasaku-App) — distributed by [TomeVault](https://tomevault.io).
