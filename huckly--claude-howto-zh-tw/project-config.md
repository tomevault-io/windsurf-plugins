---
trigger: always_on
description: Tutorial repo. Output is markdown in numbered modules `01-` through `10-`, not an app. Scripts in `scripts/` exist only to validate docs and build the EPUB.
---
...
---
> Source: [huckly/claude-howto-zh-tw](https://github.com/huckly/claude-howto-zh-tw) — distributed by [TomeVault](https://tomevault.io).
