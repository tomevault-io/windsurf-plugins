---
trigger: always_on
description: - This is the source code of daisyUI. The source styles will be compiled into daisyUI plugin for Tailwind CSS. daisyUI adds component classes to Tailwind CSS development faster, cleaner, easier.
---
...
---
> Source: [saadeghi/daisyui](https://github.com/saadeghi/daisyui) — distributed by [TomeVault](https://tomevault.io).
