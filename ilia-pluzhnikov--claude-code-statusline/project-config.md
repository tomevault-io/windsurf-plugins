---
trigger: always_on
description: > **Sync:** Any changes to this file must also be applied to `CLAUDE.md` and `AGENTS.md`.
---

# claude-code-statusline

> **Sync:** Any changes to this file must also be applied to `CLAUDE.md` and `AGENTS.md`.
