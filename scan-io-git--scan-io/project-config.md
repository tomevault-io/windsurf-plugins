---
trigger: always_on
description: - When implementing new features or making changes to the codebase, always check the `docs/engineering/` directory first for established patterns and guidelines:
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/scan-io-git) — claim your Tome and manage your conversions.
