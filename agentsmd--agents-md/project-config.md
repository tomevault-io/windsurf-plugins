---
trigger: always_on
description: This repository contains a Next.js application located in the root of this repository. When
---
...
---
> Source: [agentsmd/agents.md](https://github.com/agentsmd/agents.md) — distributed by [TomeVault](https://tomevault.io).
