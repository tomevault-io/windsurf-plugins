---
trigger: always_on
description: This is the Kubernetes Cloud Controller Manager for Linode infrastructure. It integrates Kubernetes clusters with Linode's cloud services, managing load balancers (NodeBalancers), firewalls (Cloud Firewalls),  nodes, networking routes, and IP allocation.
---
...
---
> Source: [linode/linode-cloud-controller-manager](https://github.com/linode/linode-cloud-controller-manager) — distributed by [TomeVault](https://tomevault.io).
