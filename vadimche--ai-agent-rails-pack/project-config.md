---
trigger: always_on
description: Follow these rules when working in this repository.
---
...
---
> Source: [vadimche/ai-agent-rails-pack](https://github.com/vadimche/ai-agent-rails-pack) — distributed by [TomeVault](https://tomevault.io).
