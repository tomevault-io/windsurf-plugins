---
trigger: always_on
description: This file is the canonical instruction entrypoint for local agent tooling in this repo.
---
...
---
> Source: [shapeshift/web](https://github.com/shapeshift/web) — distributed by [TomeVault](https://tomevault.io).
