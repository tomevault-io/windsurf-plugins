---
trigger: always_on
description: copy_with_context.nvim is a Neovim plugin that simplifies sharing code snippets by automatically copying selected lines along with their file path and line number metadata. This eliminates the manual process of adding context information when sharing code, making collaboration and code review more efficient.
---
...
---
> Source: [zhisme/copy_with_context.nvim](https://github.com/zhisme/copy_with_context.nvim) — distributed by [TomeVault](https://tomevault.io).
