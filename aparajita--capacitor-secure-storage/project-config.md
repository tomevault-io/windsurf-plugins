---
trigger: always_on
description: - `pnpm build` - Clean build with linting, type checking, and compilation
---
...
---
> Source: [aparajita/capacitor-secure-storage](https://github.com/aparajita/capacitor-secure-storage) — distributed by [TomeVault](https://tomevault.io).
