---
trigger: always_on
description: **Path**: `{OUTPUT_DIR}/conventions.md`
---
...
---
> Source: [aws-samples/sample-aidlc-decisions-driven-skill](https://github.com/aws-samples/sample-aidlc-decisions-driven-skill) — distributed by [TomeVault](https://tomevault.io).
