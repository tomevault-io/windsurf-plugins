---
trigger: always_on
description: To build the project (for most code changes):
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/vgteam)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/vgteam)
