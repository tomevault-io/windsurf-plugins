---
trigger: always_on
description: StoryCore-Engine is a multimodal AI pipeline for video production, transforming scripts into coherent videos. Core deterministic flow: Script → Text Engine → Configurable Grid (3x3 default) → Promotion Engine → QA Validation → AI Generation (HunyuanVideo/Wan/Qwen) → Export.
---
...
---
> Source: [zedarvates/StoryCore-Engine](https://github.com/zedarvates/StoryCore-Engine) — distributed by [TomeVault](https://tomevault.io).
