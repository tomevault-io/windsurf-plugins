---
trigger: always_on
description: This project provides a C++ header-only JSON Schema validator that can be used with various different JSON parsers. It supports draft 7 of the JSON Schema specification.
---
...
---
> Source: [tristanpenman/valijson](https://github.com/tristanpenman/valijson) — distributed by [TomeVault](https://tomevault.io).
