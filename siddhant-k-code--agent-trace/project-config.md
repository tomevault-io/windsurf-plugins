---
trigger: always_on
description: This file tells AI coding agents how to work with the agent-strace repository.
---
...
---
> Source: [Siddhant-K-code/agent-trace](https://github.com/Siddhant-K-code/agent-trace) — distributed by [TomeVault](https://tomevault.io).
