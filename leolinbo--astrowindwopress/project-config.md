---
trigger: always_on
description: AstroWind is a free, open-source website template built with **Astro v6** and **Tailwind CSS v4**. It generates a fully static site optimized for performance, SEO, and accessibility.
---
...
---
> Source: [leolinbo/astrowindwopress](https://github.com/leolinbo/astrowindwopress) — distributed by [TomeVault](https://tomevault.io).
