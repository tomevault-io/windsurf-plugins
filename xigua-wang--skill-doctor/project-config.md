---
trigger: always_on
description: `skill-doctor` is a local-first inspector with a typed scanner core and a local React app:
---
...
---
> Source: [xigua-wang/skill-doctor](https://github.com/xigua-wang/skill-doctor) — distributed by [TomeVault](https://tomevault.io).
