---
trigger: always_on
description: - Use ZethCode Compose skills when available, otherwise use superpowers skill if installed.
---

- Use ZethCode Compose skills when available, otherwise use superpowers skill if installed.
...
---
> Source: [ZethRise/ZethCode](https://github.com/ZethRise/ZethCode) — distributed by [TomeVault](https://tomevault.io).
