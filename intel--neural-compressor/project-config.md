---
trigger: always_on
description: This file configures GitHub Copilot (code suggestions and PR reviews) to follow the coding
---
...
---
> Source: [intel/neural-compressor](https://github.com/intel/neural-compressor) — distributed by [TomeVault](https://tomevault.io).
