---
trigger: always_on
description: This PCF component uses the [`react-big-schedule`](https://www.npmjs.com/package/react-big-schedule) React library for rendering a calendar-style scheduling interface. GitHub Copilot should follow these implementation rules when generating code for this control.
---
...
---
> Source: [rwilson504/PCFControls](https://github.com/rwilson504/PCFControls) — distributed by [TomeVault](https://tomevault.io).
