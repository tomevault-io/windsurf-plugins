---
trigger: always_on
description: Merkur is a tiny, extensible JavaScript library for building **micro frontends**
---
...
---
> Source: [mjancarik/merkur](https://github.com/mjancarik/merkur) — distributed by [TomeVault](https://tomevault.io).
