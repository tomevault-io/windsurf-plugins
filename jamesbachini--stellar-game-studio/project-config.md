---
trigger: always_on
description: This repo is the Stellar Game Studio. Use this guide when building or updating games so AI tools can navigate the repo and follow the expected Soroban + frontend patterns.
---
...
---
> Source: [jamesbachini/Stellar-Game-Studio](https://github.com/jamesbachini/Stellar-Game-Studio) — distributed by [TomeVault](https://tomevault.io).
