---
trigger: always_on
description: This file is intentionally thin. The canonical, repo-wide agent guidance lives in
---
...
---
> Source: [dotnet/roslyn](https://github.com/dotnet/roslyn) — distributed by [TomeVault](https://tomevault.io).
