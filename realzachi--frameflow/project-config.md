---
trigger: always_on
description: Frameflow is a React 19, TypeScript, and Vite editor. Treat maintainability, user data, export accuracy, and secret handling as product behavior.
---
...
---
> Source: [realZachi/frameflow](https://github.com/realZachi/frameflow) — distributed by [TomeVault](https://tomevault.io).
