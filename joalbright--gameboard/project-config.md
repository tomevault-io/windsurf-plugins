---
trigger: always_on
description: Apply these layout rules to every Swift source file in this repository tree.
---
...
---
> Source: [joalbright/Gameboard](https://github.com/joalbright/Gameboard) — distributed by [TomeVault](https://tomevault.io).
