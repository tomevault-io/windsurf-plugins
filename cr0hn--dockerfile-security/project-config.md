---
trigger: always_on
description: Herramienta CLI que analiza Dockerfiles en busca de vulnerabilidades de seguridad y credenciales expuestas, usando reglas regex definidas en YAML.
---
