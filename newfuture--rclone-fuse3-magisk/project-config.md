---
trigger: always_on
description: This repository builds a Magisk module that integrates Rclone with FUSE 3.17.x support into Android. The module enables automatic mounting of remote storage as local directories during system boot and runtime.
---
...
---
> Source: [NewFuture/rclone-fuse3-magisk](https://github.com/NewFuture/rclone-fuse3-magisk) — distributed by [TomeVault](https://tomevault.io).
