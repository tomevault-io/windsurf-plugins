---
trigger: always_on
description: This project is a monorepo with core (web library), desktop-app (electron app), and website packages.
---
...
---
> Source: [1j01/tracky-mouse](https://github.com/1j01/tracky-mouse) — distributed by [TomeVault](https://tomevault.io).
