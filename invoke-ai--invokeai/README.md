...
Original source: `CLAUDE.md` in [invoke-ai/InvokeAI](https://github.com/invoke-ai/InvokeAI).
...
From [invoke-ai/InvokeAI](https://github.com/invoke-ai/InvokeAI) — a repo with 27651+ stars on GitHub.
