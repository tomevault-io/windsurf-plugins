---
trigger: always_on
description: provides both a web-based console and a CLI. When the agent is running, `zrok2 share` and `zrok2 access` commands
---
...
---
> Source: [openziti/zrok](https://github.com/openziti/zrok) — distributed by [TomeVault](https://tomevault.io).
