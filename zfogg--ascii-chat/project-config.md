---
trigger: always_on
description: **discovery.ascii-chat.com** is the official public key distribution website for ACDS (ASCII-Chat Discovery Service). It serves Ed25519 public keys over HTTPS that clients use to establish trusted connections to the ACDS server at `discovery-service.ascii-chat.com:27225`.
---
...
---
> Source: [zfogg/ascii-chat](https://github.com/zfogg/ascii-chat) — distributed by [TomeVault](https://tomevault.io).
