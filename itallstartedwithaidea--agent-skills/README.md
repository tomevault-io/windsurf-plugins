...
Original source: `CLAUDE.md` in [itallstartedwithaidea/agent-skills](https://github.com/itallstartedwithaidea/agent-skills).
...
From [itallstartedwithaidea/agent-skills](https://github.com/itallstartedwithaidea/agent-skills) — a repo with 9+ stars on GitHub.
