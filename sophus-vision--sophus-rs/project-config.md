---
trigger: always_on
description: > **Maintenance:** Keep this file up to date. Each commit that adds crates, changes APIs,
---
...
---
> Source: [sophus-vision/sophus-rs](https://github.com/sophus-vision/sophus-rs) — distributed by [TomeVault](https://tomevault.io).
