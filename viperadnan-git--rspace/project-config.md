---
trigger: always_on
description: - Use Conventional Commits (`type(scope): subject`).
---
...
---
> Source: [viperadnan-git/rspace](https://github.com/viperadnan-git/rspace) — distributed by [TomeVault](https://tomevault.io).
