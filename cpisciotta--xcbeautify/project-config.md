---
trigger: always_on
description: - `xcbeautify` is a Swift CLI that formats `xcodebuild` and `swift` output.
---
...
---
> Source: [cpisciotta/xcbeautify](https://github.com/cpisciotta/xcbeautify) — distributed by [TomeVault](https://tomevault.io).
