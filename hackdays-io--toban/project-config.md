---
trigger: always_on
description: Toban is a role-based rewards distribution system built on blockchain technology. It simplifies contribution tracking and reward distribution for collaborative projects using Hats Protocol, Splits, and custom smart contracts.
---
...
---
> Source: [hackdays-io/toban](https://github.com/hackdays-io/toban) — distributed by [TomeVault](https://tomevault.io).
