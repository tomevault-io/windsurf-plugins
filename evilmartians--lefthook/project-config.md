---
trigger: always_on
description: See [AGENTS.md](AGENTS.md) for build commands, directory map, and contribution rules.
---
...
---
> Source: [evilmartians/lefthook](https://github.com/evilmartians/lefthook) — distributed by [TomeVault](https://tomevault.io).
