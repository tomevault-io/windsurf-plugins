...
Original source: `CLAUDE.md` in [duanebester/gooey](https://github.com/duanebester/gooey).
...
From [duanebester/gooey](https://github.com/duanebester/gooey) — a repo with 85+ stars on GitHub.
