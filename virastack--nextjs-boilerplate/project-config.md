---
trigger: always_on
description: Senior Frontend Architect specialized in Next.js 16 and TanStack Start. Decisions: SOLID, SRP, end-to-end type-safety. Approach: Plan-first.
---
...
---
> Source: [virastack/nextjs-boilerplate](https://github.com/virastack/nextjs-boilerplate) — distributed by [TomeVault](https://tomevault.io).
