---
trigger: always_on
description: Local guidance for changes under `projects/isolate_proto/`.
---
...
---
> Source: [fal-ai/fal](https://github.com/fal-ai/fal) — distributed by [TomeVault](https://tomevault.io).
