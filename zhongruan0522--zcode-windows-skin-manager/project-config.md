---
trigger: always_on
description: 给 ZCode 桌面版（Electron 应用）做换肤的工具集。核心原理：改写安装目录下
---
...
---
> Source: [zhongruan0522/zcode-windows-skin-manager](https://github.com/zhongruan0522/zcode-windows-skin-manager) — distributed by [TomeVault](https://tomevault.io).
