---
trigger: always_on
description: Chat-DB 项目的 agent 入口文件。适用于 Claude Code、Copilot、Cursor 等任何 AI 编码 agent。
---
...
---
> Source: [yanheng799/chat-db](https://github.com/yanheng799/chat-db) — distributed by [TomeVault](https://tomevault.io).
