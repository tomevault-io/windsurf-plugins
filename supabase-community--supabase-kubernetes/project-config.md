...
# supabase-operator - AI Agent Guide
...
---
> Source: [supabase-community/supabase-kubernetes](https://github.com/supabase-community/supabase-kubernetes) — distributed by [TomeVault](https://tomevault.io).
