---
trigger: always_on
description: Clepsydre is a single-purpose product repo: a **context-window status line for Claude
---
...
---
> Source: [tpierrain/clepsydre](https://github.com/tpierrain/clepsydre) — distributed by [TomeVault](https://tomevault.io).
