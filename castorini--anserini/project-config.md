---
trigger: always_on
description: - This repository is **Anserini** (`io.anserini:anserini`), a Java toolkit for reproducible IR research built on Apache Lucene.
---
...
---
> Source: [castorini/anserini](https://github.com/castorini/anserini) — distributed by [TomeVault](https://tomevault.io).
