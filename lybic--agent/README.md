...
Original source: `CLAUDE.md` in [lybic/agent](https://github.com/lybic/agent).
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/lybic/agent](https://github.com/lybic/agent)
