---
trigger: always_on
description: - In this program, a dataset with nodes and edges is visualized in different graphs and lists. These view modes are selectable in tabs.
---
...
---
> Source: [algorithmicsuperintelligence/openevolve](https://github.com/algorithmicsuperintelligence/openevolve) — distributed by [TomeVault](https://tomevault.io).
