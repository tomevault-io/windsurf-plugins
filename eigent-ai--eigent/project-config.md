---
trigger: always_on
description: Before planning, generating, reviewing, or modifying any user-facing UI, read
---
...
---
> Source: [eigent-ai/eigent](https://github.com/eigent-ai/eigent) — distributed by [TomeVault](https://tomevault.io).
