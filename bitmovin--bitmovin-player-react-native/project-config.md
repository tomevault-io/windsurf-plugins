---
trigger: always_on
description: - `src/`: TypeScript API surface and React components (library code).
---
...
---
> Source: [bitmovin/bitmovin-player-react-native](https://github.com/bitmovin/bitmovin-player-react-native) — distributed by [TomeVault](https://tomevault.io).
