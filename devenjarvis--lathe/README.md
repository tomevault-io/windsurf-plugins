...
Original source: `CLAUDE.md` in [devenjarvis/lathe](https://github.com/devenjarvis/lathe).
...
From [devenjarvis/lathe](https://github.com/devenjarvis/lathe) — a repo with 1561+ stars on GitHub.
