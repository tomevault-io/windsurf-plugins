---
trigger: always_on
description: - Full Java test suite: `mvn -f reference-implementations/java/pom.xml test`
---
...
---
> Source: [brunoborges/toml-schema](https://github.com/brunoborges/toml-schema) — distributed by [TomeVault](https://tomevault.io).
