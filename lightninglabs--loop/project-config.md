---
trigger: always_on
description: - Use the local CLI binary: `/home/user/bin/loop`.
---
...
---
> Source: [lightninglabs/loop](https://github.com/lightninglabs/loop) — distributed by [TomeVault](https://tomevault.io).
