---
trigger: always_on
description: - `just check` - Fast syntax/type checking (prefer over full build)
---
...
---
> Source: [trailofbits/muton](https://github.com/trailofbits/muton) — distributed by [TomeVault](https://tomevault.io).
