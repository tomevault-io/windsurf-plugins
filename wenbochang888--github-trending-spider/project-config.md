---
trigger: always_on
description: 本文件为本仓库的 AI 协作约定。所有自动化助手在读取、修改或评审本项目时必须遵守。
---
...
---
> Source: [wenbochang888/github-trending-spider](https://github.com/wenbochang888/github-trending-spider) — distributed by [TomeVault](https://tomevault.io).
