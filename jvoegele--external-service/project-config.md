---
trigger: always_on
description: - `external_service` is an Elixir library that provides retry logic, circuit breaker behavior, and optional rate limiting for external API/service calls.
---
