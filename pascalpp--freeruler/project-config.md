---
trigger: always_on
description: Guidance for Codex and other coding agents working on Free Ruler.
---
...
---
> Source: [pascalpp/FreeRuler](https://github.com/pascalpp/FreeRuler) — distributed by [TomeVault](https://tomevault.io).
