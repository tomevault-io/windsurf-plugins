---
trigger: always_on
description: Java client for the Crowdin API v2 and Crowdin Enterprise API v2, distributed via JitPack (`com.github.crowdin:crowdin-api-client-java`).
---
...
---
> Source: [crowdin/crowdin-api-client-java](https://github.com/crowdin/crowdin-api-client-java) — distributed by [TomeVault](https://tomevault.io).
