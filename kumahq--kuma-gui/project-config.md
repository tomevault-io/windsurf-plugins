---
trigger: always_on
description: We use `make` for development. Running `make help` will provide you with the
---
...
---
> Source: [kumahq/kuma-gui](https://github.com/kumahq/kuma-gui) — distributed by [TomeVault](https://tomevault.io).
