---
trigger: always_on
description: This is the official Snowflake Snowpark Python library repository (snowflakedb/snowpark-python).
---
...
---
> Source: [snowflakedb/snowpark-python](https://github.com/snowflakedb/snowpark-python) — distributed by [TomeVault](https://tomevault.io).
