---
trigger: always_on
description: always use kebab case for new filenames. never use uppercase letters in filenames
---
...
---
> Source: [remorses/safe-mdx](https://github.com/remorses/safe-mdx) — distributed by [TomeVault](https://tomevault.io).
