---
trigger: always_on
description: These instructions guide code and test authoring. Keep changes aligned with the detailed rules in .claude to avoid drift.
---
...
---
> Source: [DoubleML/doubleml-for-py](https://github.com/DoubleML/doubleml-for-py) — distributed by [TomeVault](https://tomevault.io).
