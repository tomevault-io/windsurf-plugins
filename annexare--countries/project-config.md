---
trigger: always_on
description: - Build: `bun run build` (builds all workspace packages)
---
...
---
> Source: [annexare/Countries](https://github.com/annexare/Countries) — distributed by [TomeVault](https://tomevault.io).
