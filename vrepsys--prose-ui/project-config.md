---
trigger: always_on
description: Prose UI is a library of components, remark plugins, and CSS styles to add typography, code blocks, math, callouts, and other MDX-ready UI out of the box.
---
...
---
> Source: [vrepsys/prose-ui](https://github.com/vrepsys/prose-ui) — distributed by [TomeVault](https://tomevault.io).
