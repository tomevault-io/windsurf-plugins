---
trigger: always_on
description: AL-Go for GitHub is a set of GitHub Actions and Templates for building, testing, and deploying Business Central extensions using GitHub workflows. It consists of PowerShell actions, reusable YAML workflows, and Pester-based unit tests.
---
...
---
> Source: [microsoft/AL-Go](https://github.com/microsoft/AL-Go) — distributed by [TomeVault](https://tomevault.io).
