---
trigger: always_on
description: This repository contains tools and utilities for analyzing and visualizing call graphs in Windows batch files (.cmd, .bat) and command scripts.
---
...
---
> Source: [microsoft/cmd-call-graph](https://github.com/microsoft/cmd-call-graph) — distributed by [TomeVault](https://tomevault.io).
