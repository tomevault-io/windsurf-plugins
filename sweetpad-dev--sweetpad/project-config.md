---
trigger: always_on
description: A Rust workspace (`sweetpad-lib`, `sweetpad-core`, `sweetpad-cli`,
---
...
---
> Source: [sweetpad-dev/sweetpad](https://github.com/sweetpad-dev/sweetpad) — distributed by [TomeVault](https://tomevault.io).
