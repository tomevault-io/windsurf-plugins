---
trigger: always_on
description: This project uses [Ebean ORM](https://ebean.io).
---
...
---
> Source: [ebean-orm/ebean](https://github.com/ebean-orm/ebean) — distributed by [TomeVault](https://tomevault.io).
