---
trigger: always_on
description: Public generator APIs live in root-level `.go` files. Query expressions are under `field/`, clause helpers under `helper/`, and implementation details under `internal/` (`generate`, `parser`, `template`, `model`, and `diagnostic`). Unit tests sit beside their packages.
---
...
---
> Source: [go-gorm/gen](https://github.com/go-gorm/gen) — distributed by [TomeVault](https://tomevault.io).
