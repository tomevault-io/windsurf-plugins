---
trigger: always_on
description: - When running xcodebuild, prefer using `/Applications/Xcode.app/Contents/Developer` as the developer directory (via `DEVELOPER_DIR` env var or `xcode-select`), falling back to `/Applications/Xcode-16.4.0.app/Contents/Developer`.
---
