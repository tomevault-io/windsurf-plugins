---
trigger: always_on
description: - Run all tests: `make test` or `python3 -m unittest test`
---
...
- CI tests against Python 3.8–3.14

---
> Source: [tkrajina/gpxpy](https://github.com/tkrajina/gpxpy) — distributed by [TomeVault](https://tomevault.io).
