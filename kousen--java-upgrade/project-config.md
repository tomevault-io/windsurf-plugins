---
trigger: always_on
description: This is a comprehensive Java training project focused on functional programming features in modern Java (Java 8+). The project provides hands-on exercises for students to learn functional programming concepts through practical examples.
---
...
---
> Source: [kousen/java_upgrade](https://github.com/kousen/java_upgrade) — distributed by [TomeVault](https://tomevault.io).
