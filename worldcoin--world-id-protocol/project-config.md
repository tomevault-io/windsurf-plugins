---
trigger: always_on
description: - Rust workspace + Solidity contracts + Circom circuits + deployable services.
---
...
---
> Source: [worldcoin/world-id-protocol](https://github.com/worldcoin/world-id-protocol) — distributed by [TomeVault](https://tomevault.io).
