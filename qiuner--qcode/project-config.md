...
- 已有中英文对应的文档，涉及行为、命令、版本和限制的修改须同步更新两种语言，沿用现有文件配对，不要求为所有文档新建译本。
...
---
> Source: [Qiuner/QCode](https://github.com/Qiuner/QCode) — distributed by [TomeVault](https://tomevault.io).
