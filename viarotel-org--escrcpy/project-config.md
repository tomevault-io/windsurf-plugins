---
trigger: always_on
description: Escrcpy is a pnpm + Turborepo monorepo for an Electron GUI around Android mirroring/control with scrcpy. Keep this file focused on agent-critical facts; link existing docs instead of copying them. For the broader overview, start with [develop.md](../develop.md).
---
...
---
> Source: [viarotel-org/escrcpy](https://github.com/viarotel-org/escrcpy) — distributed by [TomeVault](https://tomevault.io).
