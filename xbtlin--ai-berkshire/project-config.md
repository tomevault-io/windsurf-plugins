---
trigger: always_on
description: 基于 Claude Code 的价值投资研究 Skill 合集。四大师框架：巴菲特、芒格、段永平、李录。
---
...
---
> Source: [xbtlin/ai-berkshire](https://github.com/xbtlin/ai-berkshire) — distributed by [TomeVault](https://tomevault.io).
