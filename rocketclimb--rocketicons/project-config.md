---
trigger: always_on
description: Create branches as `<type>/<short-kebab-case-description>`, using one of these prefixes:
---
...
---
> Source: [rocketclimb/rocketicons](https://github.com/rocketclimb/rocketicons) — distributed by [TomeVault](https://tomevault.io).
