---
trigger: always_on
description: **The full agent guide for this repository is [`CLAUDE.md`](./CLAUDE.md) — read it first.**
---
...
---
> Source: [xiaoleiy/podpull](https://github.com/xiaoleiy/podpull) — distributed by [TomeVault](https://tomevault.io).
