---
trigger: always_on
description: Guidance for AI agents in `use-mask-input`. Only non-obvious stuff lives here; scripts, deps, and file layout are discoverable from `package.json` and the tree.
---
