---
trigger: always_on
description: This repository is being refactored from a Pelican blog into an **Astro 6** static site under `web/`.
---
...
---
> Source: [CloudBytes-Academy/CloudBytes.dev](https://github.com/CloudBytes-Academy/CloudBytes.dev) — distributed by [TomeVault](https://tomevault.io).
