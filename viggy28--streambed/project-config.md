---
trigger: always_on
description: Postgres-to-Iceberg CDC engine. Streams WAL changes via logical replication, writes Parquet data files to S3, commits Iceberg metadata, and exposes tables through a Postgres-compatible query server (DuckDB + psql-wire).
---
...
---
> Source: [viggy28/streambed](https://github.com/viggy28/streambed) — distributed by [TomeVault](https://tomevault.io).
