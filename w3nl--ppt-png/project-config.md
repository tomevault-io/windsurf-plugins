---
trigger: always_on
description: - **Pure Functions**: Favor pure functions (no side effects, no mutation, deterministic) as advocated by Eric Elliott.
---
...
---
> Source: [w3nl/ppt-png](https://github.com/w3nl/ppt-png) — distributed by [TomeVault](https://tomevault.io).
