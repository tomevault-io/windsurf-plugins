---
trigger: always_on
description: This document provides guidance for AI agents working in the Strands Agents monorepo. For human contributor guidelines, see [CONTRIBUTING.md](CONTRIBUTING.md).
---
...
---
> Source: [strands-agents/harness-sdk](https://github.com/strands-agents/harness-sdk) — distributed by [TomeVault](https://tomevault.io).
