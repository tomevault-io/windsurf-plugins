---
trigger: always_on
description: This file adds package-local guidance. Global rules are defined in the repository root `AGENTS.md` and still apply.
---
...
---
> Source: [sonofmagic/monorepo-template](https://github.com/sonofmagic/monorepo-template) — distributed by [TomeVault](https://tomevault.io).
