---
trigger: always_on
description: - 这是一个示例型仓库，优先保证示例清晰、可运行、便于教学，不要为了“工程化完美”随意重构现有写法。
---
...
---
> Source: [javastacks/spring-boot-best-practice](https://github.com/javastacks/spring-boot-best-practice) — distributed by [TomeVault](https://tomevault.io).
