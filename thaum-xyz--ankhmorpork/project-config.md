---
trigger: always_on
description: Flux-managed k3s homelab. `core/` bootstraps the cluster, `base/` is infrastructure,
---
...
---
> Source: [thaum-xyz/ankhmorpork](https://github.com/thaum-xyz/ankhmorpork) — distributed by [TomeVault](https://tomevault.io).
