---
trigger: always_on
description: A GitHub Action (TypeScript) that automates versioning, releases, and documentation for Terraform modules in monorepos.
---
...
- **Node.js 25+** local dev (`.node-version`); compiles to Node.js 24+ for GitHub Actions runtime (`action.yml` →
  `node24`)
