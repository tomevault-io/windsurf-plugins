---
trigger: always_on
description: The documentation is organized into five tabs:
---
...
---
> Source: [meilisearch/documentation](https://github.com/meilisearch/documentation) — distributed by [TomeVault](https://tomevault.io).
