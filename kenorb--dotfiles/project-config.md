---
trigger: always_on
description: Persistent single-source truth for autonomous agent behavior in this repository.
---
...
---
> Source: [kenorb/dotfiles](https://github.com/kenorb/dotfiles) — distributed by [TomeVault](https://tomevault.io).
