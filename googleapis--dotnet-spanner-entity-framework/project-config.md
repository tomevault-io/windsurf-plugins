---
trigger: always_on
description: This developer guide provides an overview of the project structure and testing guidelines for the Cloud Spanner ADO.NET Data Provider (`Google.Cloud.Spanner.Data`).
---
...
---
> Source: [googleapis/dotnet-spanner-entity-framework](https://github.com/googleapis/dotnet-spanner-entity-framework) — distributed by [TomeVault](https://tomevault.io).
