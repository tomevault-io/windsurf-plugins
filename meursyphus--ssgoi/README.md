...
> Source: [meursyphus/ssgoi](https://github.com/meursyphus/ssgoi). Graded, signed and kept current as the models change by [TomeVault](https://tomevault.io)

## Windsurf Config

The `project-config.md` file in this directory is the project config converted for Windsurf.
Original source: `AGENTS.md` in [meursyphus/ssgoi](https://github.com/meursyphus/ssgoi).
