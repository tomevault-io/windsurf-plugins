---
trigger: always_on
description: - Core loader logic and headers live in `src/`.
---
...
---
> Source: [decompals/wibo](https://github.com/decompals/wibo) — distributed by [TomeVault](https://tomevault.io).
