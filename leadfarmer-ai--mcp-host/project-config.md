---
trigger: always_on
description: How to develop MCP Model Context Protocol Hosts & Servers
---
...
---
> Source: [LeadFarmer-ai/mcp-host](https://github.com/LeadFarmer-ai/mcp-host) — distributed by [TomeVault](https://tomevault.io).
