---
trigger: always_on
description: Before concluding any task that modifies code, run a full build:
---
...
---
> Source: [martinpaljak/apdu4j](https://github.com/martinpaljak/apdu4j) — distributed by [TomeVault](https://tomevault.io).
