---
trigger: always_on
description: Fluent Operator is a Kubernetes operator (written in Go) that manages Fluent Bit and Fluentd deployments via Custom Resource Definitions (CRDs). It is built with **kubebuilder v3** and **controller-runtime**. The Go module path is `github.com/fluent/fluent-operator/v3`.
---
...
---
> Source: [fluent/fluent-operator](https://github.com/fluent/fluent-operator) — distributed by [TomeVault](https://tomevault.io).
