---
trigger: always_on
description: - Work on a descriptive feature branch. Do not make changes or commits directly on `master`.
---
...
---
> Source: [vtjeng/MIPVerify.jl](https://github.com/vtjeng/MIPVerify.jl) — distributed by [TomeVault](https://tomevault.io).
