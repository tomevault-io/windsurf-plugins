---
trigger: always_on
description: FreeFlow is a native macOS menu-bar dictation app built directly with `swiftc`
---
...
---
> Source: [zachlatta/freeflow](https://github.com/zachlatta/freeflow) — distributed by [TomeVault](https://tomevault.io).
