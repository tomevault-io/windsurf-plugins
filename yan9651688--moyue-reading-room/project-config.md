---
trigger: always_on
description: - `assets/app/server.py` implements the local HTTP server, Markdown indexing, search, and path-safety checks.
---
...
The first command starts the Web reader on `127.0.0.1:4173`. The PowerShell command creates NSIS and portable Windows artifacts under `dist/windows/`; the shell script creates ad-hoc-signed macOS DMG and app ZIP artifacts under `dist/macos/`.
...
---
> Source: [yan9651688/moyue-reading-room](https://github.com/yan9651688/moyue-reading-room) — distributed by [TomeVault](https://tomevault.io).
