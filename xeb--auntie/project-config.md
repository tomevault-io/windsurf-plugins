---
trigger: always_on
description: auntie is a Chrome browser automation CLI using the DevTools Protocol. It communicates with Chrome via WebSocket to control navigation, DOM interaction, screenshots, and more.
---
