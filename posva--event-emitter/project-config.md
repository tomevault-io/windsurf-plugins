---
trigger: always_on
description: Small, type-safe event emitter library using the oxc ecosystem.
---
...
---
> Source: [posva/event-emitter](https://github.com/posva/event-emitter) — distributed by [TomeVault](https://tomevault.io).
