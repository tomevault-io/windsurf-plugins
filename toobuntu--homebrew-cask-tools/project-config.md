---
trigger: always_on
description: Generates Bash, ZSH, and Fish completion files for all commands in `cmd/` and `dev-cmd/`, Ronn man
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/toobuntu)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/toobuntu)
