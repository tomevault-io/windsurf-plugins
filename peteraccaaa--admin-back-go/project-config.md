---
trigger: always_on
description: 这是 `E:\admin_go` 的 Go 主后端。
---
...
---
> Source: [PeterACCaaa/admin_back_go](https://github.com/PeterACCaaa/admin_back_go) — distributed by [TomeVault](https://tomevault.io).
