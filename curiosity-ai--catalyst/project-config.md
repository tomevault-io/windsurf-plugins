---
trigger: always_on
description: C# natural language processing library (tokenization, tagging, entity recognition, embeddings).
---
...
---
> Source: [curiosity-ai/catalyst](https://github.com/curiosity-ai/catalyst) — distributed by [TomeVault](https://tomevault.io).
