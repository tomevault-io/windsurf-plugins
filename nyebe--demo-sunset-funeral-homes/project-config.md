---
trigger: always_on
description: - ✅ Always follow [Core Engineering Principles](../docs/core-engineering-principles.md).
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/nyebe)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/nyebe)
