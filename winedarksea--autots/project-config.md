---
trigger: always_on
description: - **Aim to keep files < 500 lines.** Large files are difficult to reason about and cause merge conflicts.
---
...
---
> Source: [winedarksea/AutoTS](https://github.com/winedarksea/AutoTS) — distributed by [TomeVault](https://tomevault.io).
