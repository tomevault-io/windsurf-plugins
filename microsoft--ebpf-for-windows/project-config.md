---
trigger: always_on
description: This project brings eBPF (extended Berkeley Packet Filter) to Windows, enabling programmable OS kernel extensions for use cases like network filtering and observability.
---
...
---
> Source: [microsoft/ebpf-for-windows](https://github.com/microsoft/ebpf-for-windows) — distributed by [TomeVault](https://tomevault.io).
