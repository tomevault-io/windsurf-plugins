---
trigger: always_on
description: Osmia is a Kubernetes-native AI coding agent harness that orchestrates autonomous developer agents (Claude Code, OpenAI Codex, Aider) to perform maintenance and development tasks on codebases at scale. It is Apache 2.0 licensed, enterprise-grade, and security-first.
---
...
---
> Source: [unitaryai/osmia](https://github.com/unitaryai/osmia) — distributed by [TomeVault](https://tomevault.io).
