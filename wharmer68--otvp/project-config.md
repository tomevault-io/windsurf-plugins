---
trigger: always_on
description: The **Open Transparency Verification Platform specification** — this defines the OTVP standard itself. It is not code. It is the authoritative document that describes how trust envelopes work, what controls are verified, how agents should behave, and how results are structured.
---
...
---
> Source: [wharmer68/otvp](https://github.com/wharmer68/otvp) — distributed by [TomeVault](https://tomevault.io).
