---
trigger: always_on
description: 1. **Read these first:** `docs/ai/workflows.md`, `docs/ai/testing.md`, `docs/ai/mechanical_overrides.md`
---
...
---
> Source: [owen2345/camaleon-cms](https://github.com/owen2345/camaleon-cms) — distributed by [TomeVault](https://tomevault.io).
