---
trigger: always_on
description: This file is the single source of truth for AI coding agents (Claude Code, Codex, Hermes, …) working on this repo. Read it before making changes.
---
...
---
> Source: [wassermanproductions/motion-previs-studio](https://github.com/wassermanproductions/motion-previs-studio) — distributed by [TomeVault](https://tomevault.io).
