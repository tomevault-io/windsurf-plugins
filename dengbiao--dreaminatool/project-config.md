...
# 新增规则
    ...
    - 所有TypeScript文件和 css 文件都要用 kebab-case 命名。
...
---
> Source: [dengbiao/DreaminaTool](https://github.com/dengbiao/DreaminaTool) — distributed by [TomeVault](https://tomevault.io).
