---
trigger: always_on
description: This skill provides guidance for generating Answer Engine Optimization (AEO) content - optimizing websites for AI-powered answer engines (ChatGPT, Claude, Gemini, AI Overviews).
---
...
---
> Source: [bencium/bencium-marketplace](https://github.com/bencium/bencium-marketplace) — distributed by [TomeVault](https://tomevault.io).
