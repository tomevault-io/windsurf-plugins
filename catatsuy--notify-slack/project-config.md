---
trigger: always_on
description: - `cmd/notify_slack`: primary CLI entry point for sending messages.
---
...
---
> Source: [catatsuy/notify_slack](https://github.com/catatsuy/notify_slack) — distributed by [TomeVault](https://tomevault.io).
