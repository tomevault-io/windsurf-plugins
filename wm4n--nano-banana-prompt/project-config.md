---
trigger: always_on
description: A **Hugo-based static gallery website** displaying 115+ AI image generation prompts for the Nano Banana ChatGPT integration. The site is published to GitHub Pages and automatically rebuilt on push to `main`.
---
...
---
> Source: [wm4n/nano-banana-prompt](https://github.com/wm4n/nano-banana-prompt) — distributed by [TomeVault](https://tomevault.io).
