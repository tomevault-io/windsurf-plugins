---
trigger: always_on
description: Ad Fontes Manager is a Vue 3 + Express + Electron app for generating, reviewing, improving, and exporting multilingual etymology-based word entries.
---
...
---
> Source: [yelanyanyu/ad-fontes-manager](https://github.com/yelanyanyu/ad-fontes-manager) — distributed by [TomeVault](https://tomevault.io).
