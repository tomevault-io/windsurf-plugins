---
trigger: always_on
description: MCP resources expose read-only data that AI clients can request. Unlike tools, resources are static data endpoints identified by URIs.
---
...
---
> Source: [shopware/core](https://github.com/shopware/core) — distributed by [TomeVault](https://tomevault.io).
