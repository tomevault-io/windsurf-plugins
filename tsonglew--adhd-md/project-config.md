---
trigger: always_on
description: 本仓库提供一个跨 agent 通用的 skill：把 Markdown 改造成 ADHD 友好、可扫读的版本。
---
...
---
> Source: [tsonglew/adhd-md](https://github.com/tsonglew/adhd-md) — distributed by [TomeVault](https://tomevault.io).
