---
trigger: always_on
description: This file defines the default working protocol for coding agents for this project.
---
...
---
> Source: [rsms/rsm](https://github.com/rsms/rsm) — distributed by [TomeVault](https://tomevault.io).
