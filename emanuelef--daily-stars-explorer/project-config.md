---
trigger: always_on
description: Daily Stars Explorer — full-stack app (Go + React) that visualizes GitHub repository star history with daily/hourly granularity, correlated activity data, and social media mentions.
---
...
---
> Source: [emanuelef/daily-stars-explorer](https://github.com/emanuelef/daily-stars-explorer) — distributed by [TomeVault](https://tomevault.io).
