---
trigger: always_on
description: The preprocessing module prepares meshes for slicing. Located in `src/slicer/preprocessing/`.
---
...
---
> Source: [jgphilpott/polyslice](https://github.com/jgphilpott/polyslice) — distributed by [TomeVault](https://tomevault.io).
