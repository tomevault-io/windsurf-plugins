---
trigger: always_on
description: Canonical playbook for all coding agents working in the Catnip repo. Model-specific quirks live alongside this file (for example `CLAUDE.md`). Always start here, then consult your agent supplement if one exists.
---
...
---
> Source: [wandb/catnip](https://github.com/wandb/catnip) — distributed by [TomeVault](https://tomevault.io).
