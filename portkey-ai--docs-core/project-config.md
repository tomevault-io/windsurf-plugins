---
trigger: always_on
description: This repository contains the documentation for [Portkey AI](https://portkey.ai), hosted at https://portkey.ai/docs. Built using [Mintlify](https://mintlify.com).
---
...
---
> Source: [Portkey-AI/docs-core](https://github.com/Portkey-AI/docs-core) — distributed by [TomeVault](https://tomevault.io).
