...
Original source: `CLAUDE.md` in [tradeblocks-org/tradeblocks](https://github.com/tradeblocks-org/tradeblocks).
...
```
npx tomevault install tradeblocks-org/tradeblocks
```
Source: [github.com/tradeblocks-org/tradeblocks](https://github.com/tradeblocks-org/tradeblocks).
