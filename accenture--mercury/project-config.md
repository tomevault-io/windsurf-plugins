---
trigger: always_on
description: > **First-run init — do this before anything else (incl. before summarizing).** A fresh clone has the
---
...
---
> Source: [Accenture/mercury](https://github.com/Accenture/mercury) — distributed by [TomeVault](https://tomevault.io).
