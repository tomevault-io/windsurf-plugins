---
trigger: always_on
description: 1. The user interface accepts a text string known as mapText. This mapText is a specific DSL format for onlinewardleymaps.
---
...
---
> Source: [damonsk/onlinewardleymaps](https://github.com/damonsk/onlinewardleymaps) — distributed by [TomeVault](https://tomevault.io).
