...
Original source: `AGENTS.md` in [netresearch/jira-skill](https://github.com/netresearch/jira-skill).
...
From [netresearch/jira-skill](https://github.com/netresearch/jira-skill) — a repo with 48+ stars on GitHub.
