...
Original source: `CLAUDE.md` in [makr-code/ThemisDB](https://github.com/makr-code/ThemisDB).
...
From [makr-code/ThemisDB](https://github.com/makr-code/ThemisDB) — a repo with 8+ stars on GitHub.
