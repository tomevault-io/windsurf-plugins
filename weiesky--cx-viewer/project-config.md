---
trigger: always_on
description: the agent stops at the first rung that holds:
---
...
---
> Source: [weiesky/cx-viewer](https://github.com/weiesky/cx-viewer) — distributed by [TomeVault](https://tomevault.io).
