---
trigger: always_on
description: This file defines the repository-wide execution rules for coding agents. Human Git workflow remains documented in `WORKFLOW.md`.
---
...
---
> Source: [wjllance/StandX-CLI](https://github.com/wjllance/StandX-CLI) — distributed by [TomeVault](https://tomevault.io).
