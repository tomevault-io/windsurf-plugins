---
trigger: always_on
description: Note: If @AGENTS.override.md exists,treat it as the ultimate source of truth for AGENTS.md and read it right now.
---
...
---
> Source: [worldcoin/orb-software](https://github.com/worldcoin/orb-software) — distributed by [TomeVault](https://tomevault.io).
