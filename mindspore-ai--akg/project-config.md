---
trigger: always_on
description: > 本目录是 AKG Agents 的**使用态工作空间**（`akg_agents/workspace/`）。
---
...
---
> Source: [mindspore-ai/akg](https://github.com/mindspore-ai/akg) — distributed by [TomeVault](https://tomevault.io).
