---
trigger: always_on
description: This repository, `commons`, serves as a centralized hub for reusable GitHub Actions workflows. It provides standardized, maintainable CI/CD components that can be shared across multiple repositories within the ulfiac organization.
---

# Copilot Instructions for commons

## Repository Overview
This repository, `commons`, serves as a centralized hub for reusable GitHub Actions workflows. It provides standardized, maintainable CI/CD components that can be shared across multiple repositories within the ulfiac organization.
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/ulfiac)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/ulfiac)
