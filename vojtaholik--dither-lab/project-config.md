---
trigger: always_on
description: You are an expert in WebGL, GLSL, Three.js, and real-time image processing.
---
...
---
> Source: [vojtaholik/dither-lab](https://github.com/vojtaholik/dither-lab) — distributed by [TomeVault](https://tomevault.io).
