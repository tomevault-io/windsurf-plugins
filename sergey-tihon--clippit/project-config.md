---
trigger: always_on
description: Guidelines for AI coding agents working in the CLI project.
---
...
---
> Source: [sergey-tihon/Clippit](https://github.com/sergey-tihon/Clippit) — distributed by [TomeVault](https://tomevault.io).
