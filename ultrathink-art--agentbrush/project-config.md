---
trigger: always_on
description: - **BG removal demos: ALWAYS use WHITE background** — white has zero color overlap with any colorful illustration. Black bg is risky: dark feather/fur/shadow details near edges are close to black threshold, flood fill nibbles them. Three iterations proved this. Current showcase: colorful owl on white bg.
---
...
---
> Source: [ultrathink-art/agentbrush](https://github.com/ultrathink-art/agentbrush) — distributed by [TomeVault](https://tomevault.io).
