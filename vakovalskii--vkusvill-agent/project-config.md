---
trigger: always_on
description: - use MinGW terminal for work
---
...
---
> Source: [vakovalskii/vkusvill-agent](https://github.com/vakovalskii/vkusvill-agent) — distributed by [TomeVault](https://tomevault.io).
