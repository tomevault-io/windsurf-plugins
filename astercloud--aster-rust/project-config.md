...
- Core crates: `aster` (agent logic), `aster-cli` (CLI), `aster-server` (backend), `aster-mcp` (MCP servers)
...
- Naming convention: In `documentation/docs` and `documentation/blog`, always refer to the project as "aster" (lowercase), never "Aster" (even at the start of sentences)
...
---
> Source: [astercloud/aster-rust](https://github.com/astercloud/aster-rust) — distributed by [TomeVault](https://tomevault.io).
