---
trigger: always_on
description: US street address parser gem (`StreetAddress`). Parses address strings into normalized `StreetAddress::US::Address` objects. Port of Perl's `Geo::StreetAddress::US`. Single-file library at `lib/street_address.rb`.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/street-address-rb)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/street-address-rb)
