---
trigger: always_on
description: - 个人 C++ 引擎项目，默认渲染器为 Vulkan，主要生产环境为 Windows。
---
...
---
> Source: [tangziwen/CubeMiniGame](https://github.com/tangziwen/CubeMiniGame) — distributed by [TomeVault](https://tomevault.io).
