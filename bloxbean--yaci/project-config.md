---
trigger: always_on
description: Each agent in Yaci Core implements a specific mini protocol. An agent is a low level component which understands how to
---
...
---
> Source: [bloxbean/yaci](https://github.com/bloxbean/yaci) — distributed by [TomeVault](https://tomevault.io).
