---
trigger: always_on
description: This copilot-instructions.md file provides guidance for code agents working with this codebase.
---
...
---
> Source: [huggingface/new-model-addition-cwm](https://github.com/huggingface/new-model-addition-cwm) — distributed by [TomeVault](https://tomevault.io).
