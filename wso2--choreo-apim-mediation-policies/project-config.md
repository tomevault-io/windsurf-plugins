---
trigger: always_on
description: A collection of out-of-the-box mediation and guardrail policies for WSO2 Choreo APIM, written in Ballerina. Each policy is an independent Ballerina package under a top-level directory (e.g., `mediation-add-header/`, `guardrail-regex-guardrail/`).
---
...
---
> Source: [wso2/choreo-apim-mediation-policies](https://github.com/wso2/choreo-apim-mediation-policies) — distributed by [TomeVault](https://tomevault.io).
