---
trigger: always_on
description: This project is an F# LSP server (`csharp-ls`). Agents and humans share the same docs —
---
...
---
> Source: [razzmatazz/csharp-language-server](https://github.com/razzmatazz/csharp-language-server) — distributed by [TomeVault](https://tomevault.io).
