---
trigger: always_on
description: - Run autoformatters and linters via `tox`. Never invoke `flake8`, `isort`,
---
...
---
> Source: [VirtusLab/git-machete](https://github.com/VirtusLab/git-machete) — distributed by [TomeVault](https://tomevault.io).
