---
trigger: always_on
description: 本文件为 AI 助手（Claude Code / 类 IDE 编码代理）在本仓库工作时提供项目级上下文。**项目结构或规范变化时，必须同步更新本文件**（见文末「同步维护」）。
---
...
---
> Source: [umlink/python-ai-agent](https://github.com/umlink/python-ai-agent) — distributed by [TomeVault](https://tomevault.io).
