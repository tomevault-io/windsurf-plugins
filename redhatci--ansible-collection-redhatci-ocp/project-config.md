---
trigger: always_on
description: `ansible-lint` only checks that module references use fully qualified
---
...
---
> Source: [redhatci/ansible-collection-redhatci-ocp](https://github.com/redhatci/ansible-collection-redhatci-ocp) — distributed by [TomeVault](https://tomevault.io).
