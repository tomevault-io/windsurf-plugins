---
trigger: always_on
description: Fine-tuning framework for LLMs. Config-driven: every training run is defined by a single YAML file.
---
...
---
> Source: [axolotl-ai-cloud/axolotl](https://github.com/axolotl-ai-cloud/axolotl) — distributed by [TomeVault](https://tomevault.io).
