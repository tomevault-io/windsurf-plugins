---
trigger: always_on
description: CLI tool that generates Markdown documentation from Azure Bicep template files. It invokes the Azure CLI to compile Bicep to ARM JSON, parses the compiled template, and writes structured Markdown output.
---
...
---
> Source: [christosgalano/bicep-docs](https://github.com/christosgalano/bicep-docs) — distributed by [TomeVault](https://tomevault.io).
