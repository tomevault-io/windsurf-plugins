---
trigger: always_on
description: Canonical agent file: [`AGENTS.md`](../AGENTS.md). Summary below.
---
...
---
> Source: [willy92wins/DayZ-Modding-Knowledge-Pack](https://github.com/willy92wins/DayZ-Modding-Knowledge-Pack) — distributed by [TomeVault](https://tomevault.io).
