---
trigger: always_on
description: Erlang/OTP library for intercluster RPC **without** the Erlang distribution
---
...
---
> Source: [g-andrade/backwater](https://github.com/g-andrade/backwater) — distributed by [TomeVault](https://tomevault.io).
