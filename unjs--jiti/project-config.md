---
trigger: always_on
description: **jiti** (`unjs/jiti`) — Runtime TypeScript and ESM support for Node.js.
---
...
---
> Source: [unjs/jiti](https://github.com/unjs/jiti) — distributed by [TomeVault](https://tomevault.io).
