---
trigger: always_on
description: Devolutions Gateway is a relay server.
---
...
---
> Source: [Devolutions/devolutions-gateway](https://github.com/Devolutions/devolutions-gateway) — distributed by [TomeVault](https://tomevault.io).
