---
trigger: always_on
description: - Do rely on `package.json` for scripts and dependencies and stick with `npm`; avoid swapping in other package managers.
---
...
---
> Source: [thlorenz/doctoc](https://github.com/thlorenz/doctoc) — distributed by [TomeVault](https://tomevault.io).
