---
trigger: always_on
description: This file contains agent-specific guidance only.
---
...
---
> Source: [osmlab/name-suggestion-index](https://github.com/osmlab/name-suggestion-index) — distributed by [TomeVault](https://tomevault.io).
