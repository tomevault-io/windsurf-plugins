---
trigger: always_on
description: Before adding or modifying any plugin in this directory, read [AGENTS.md](AGENTS.md)
---
...
---
> Source: [chidiwilliams/buzz](https://github.com/chidiwilliams/buzz) — distributed by [TomeVault](https://tomevault.io).
