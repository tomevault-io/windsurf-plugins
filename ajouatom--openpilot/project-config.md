---
trigger: always_on
description: - Navigation deceleration behavior for the `origin/thftgr/navi-stream` branch is documented in
---
...
---
> Source: [ajouatom/openpilot](https://github.com/ajouatom/openpilot) — distributed by [TomeVault](https://tomevault.io).
