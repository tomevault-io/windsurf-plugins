---
trigger: always_on
description: `src/main.ts`, `src/rasterize.worker.ts`, and `src/pdfBuild.worker.ts` import from
---
...
---
> Source: [philips/supernote-obsidian-plugin](https://github.com/philips/supernote-obsidian-plugin) — distributed by [TomeVault](https://tomevault.io).
