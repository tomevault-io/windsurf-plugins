---
trigger: always_on
description: **Global instructions for AI agents, LLMs, and developers contributing to or using webXOS.**
---
...
---
> Source: [webxos/webXOS](https://github.com/webxos/webXOS) — distributed by [TomeVault](https://tomevault.io).
