---
trigger: always_on
description: Instructions for AI coding agents working in the Popochiu repository. This file is the single source of truth across harnesses (GitHub Copilot, Cursor, Claude Code, OpenAI Codex, OpenCode).
---
...
---
> Source: [carenalgas/popochiu](https://github.com/carenalgas/popochiu) — distributed by [TomeVault](https://tomevault.io).
