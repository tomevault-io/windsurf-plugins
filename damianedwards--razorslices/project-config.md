---
trigger: always_on
description: **RazorSlices** is a lightweight Razor-based template library for ASP.NET Core without MVC, Razor Pages, or Blazor. It's optimized for high-performance, unbuffered rendering with low allocations and is compatible with trimming and native AOT.
---
...
---
> Source: [DamianEdwards/RazorSlices](https://github.com/DamianEdwards/RazorSlices) — distributed by [TomeVault](https://tomevault.io).
