---
trigger: always_on
description: Follow **`GROK.md`** for all work in this repository (canonical process).
---
...
---
> Source: [trey-copeland/uavsim](https://github.com/trey-copeland/uavsim) — distributed by [TomeVault](https://tomevault.io).
