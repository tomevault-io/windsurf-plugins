...
Original source: `AGENTS.md` in [ClipboardHealth/groundcrew](https://github.com/ClipboardHealth/groundcrew).
...
```
npx tomevault install ClipboardHealth/groundcrew
```
Source: [github.com/ClipboardHealth/groundcrew](https://github.com/ClipboardHealth/groundcrew).
