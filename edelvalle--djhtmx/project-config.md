---
trigger: always_on
description: When writing functions, classes, constants, etc., put public, high-level entry points first, followed by lower-level helpers and private utilities. This lets developers read files like prose, moving from general concepts to
---
...
---
> Source: [edelvalle/djhtmx](https://github.com/edelvalle/djhtmx) — distributed by [TomeVault](https://tomevault.io).
