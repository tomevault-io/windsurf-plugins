---
trigger: always_on
description: - **Docs**: Consult @docs/index.md before working on any topic it covers.
---
...
---
> Source: [churnish/resize-mobile-split-view](https://github.com/churnish/resize-mobile-split-view) — distributed by [TomeVault](https://tomevault.io).
