---
trigger: always_on
description: `scholarly` is a Python module for retrieving author and publication data from Google Scholar programmatically. It parses HTML responses from Google Scholar and returns structured data.
---
...
---
> Source: [scholarly-python-package/scholarly](https://github.com/scholarly-python-package/scholarly) — distributed by [TomeVault](https://tomevault.io).
