---
trigger: always_on
description: <!-- https://github.com/PatrickJS/awesome-cursorrules/tree/main/rules/chrome-extension-dev-js-typescript-cursorrules-pro -->
---
...
---
> Source: [Trifall/chat-export](https://github.com/Trifall/chat-export) — distributed by [TomeVault](https://tomevault.io).
