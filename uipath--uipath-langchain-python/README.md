...
Original source: `copilot-instructions.md` in [UiPath/uipath-langchain-python](https://github.com/UiPath/uipath-langchain-python).
...
From [UiPath/uipath-langchain-python](https://github.com/UiPath/uipath-langchain-python) — a repo with 71+ stars on GitHub.
