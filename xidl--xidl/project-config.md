---
trigger: always_on
description: - This file MUST govern handwritten source files under `xidl-build/src/`,
---
...
---
> Source: [xidl/xidl](https://github.com/xidl/xidl) — distributed by [TomeVault](https://tomevault.io).
