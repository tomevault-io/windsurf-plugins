---
trigger: always_on
description: This repository contains a small library of prompts intended to work with NotebookLM. The assumed context is single source analysis: the user is using NotebookLM to "dive deep" into a single report - assumed to be a lengthy report. README.md shares details on the envisioned use-case.
---
