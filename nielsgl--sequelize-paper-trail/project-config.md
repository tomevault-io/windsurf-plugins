---
trigger: always_on
description: - `lib/` holds the source code (`index.js`, `helpers.js`). Build output goes to `dist/` via Babel.
---
...
---
> Source: [nielsgl/sequelize-paper-trail](https://github.com/nielsgl/sequelize-paper-trail) — distributed by [TomeVault](https://tomevault.io).
