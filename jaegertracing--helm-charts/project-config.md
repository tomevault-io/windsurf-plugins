---
trigger: always_on
description: Follow these steps whenever you modify the charts. Keep answers concise and actionable.
---
...
---
> Source: [jaegertracing/helm-charts](https://github.com/jaegertracing/helm-charts) — distributed by [TomeVault](https://tomevault.io).
