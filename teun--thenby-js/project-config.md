---
trigger: always_on
description: Single-file JavaScript micro-library (`thenBy.js`). No monorepo, no workspaces.
---
...
---
> Source: [Teun/thenBy.js](https://github.com/Teun/thenBy.js) — distributed by [TomeVault](https://tomevault.io).
