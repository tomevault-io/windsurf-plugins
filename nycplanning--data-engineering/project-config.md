---
trigger: always_on
description: Single `main` branch. All work happens on feature branches and merges to `main` via pull request.
---
...
---
> Source: [NYCPlanning/data-engineering](https://github.com/NYCPlanning/data-engineering) — distributed by [TomeVault](https://tomevault.io).
