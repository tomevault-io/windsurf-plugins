---
trigger: always_on
description: LSDJ (Latent Space DJ) is a generative DJ instrument: two locally-running model decks
---
...
---
> Source: [protocol-works/lsdj](https://github.com/protocol-works/lsdj) — distributed by [TomeVault](https://tomevault.io).
