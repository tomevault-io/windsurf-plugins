---
trigger: always_on
description: This is a starter kit for developing Google Apps Script projects with modern web development tools. It allows developers to use next-generation JavaScript (ES6+) and provides a local development environment with features like code bundling, linting, and testing.
---
...
---
> Source: [labnol/apps-script-starter](https://github.com/labnol/apps-script-starter) — distributed by [TomeVault](https://tomevault.io).
