---
trigger: always_on
description: Netstamp is a pnpm workspace with a Go backend and React/Vite frontend. Use this root guide for repository-wide orientation only. Before making task-specific changes, read the closest area guide:
---
...
---
> Source: [yorukot/Netstamp](https://github.com/yorukot/Netstamp) — distributed by [TomeVault](https://tomevault.io).
