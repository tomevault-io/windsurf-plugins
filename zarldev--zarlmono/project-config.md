---
trigger: always_on
description: Essential, high-signal context for agents working in this repo. If it doesn't help an agent avoid a mistake or ramp up, it doesn't belong here.
---
...
---
> Source: [zarldev/zarlmono](https://github.com/zarldev/zarlmono) — distributed by [TomeVault](https://tomevault.io).
