---
trigger: always_on
description: This file guides AI coding agents working in the flow-emulator repository.
---
...
---
> Source: [onflow/flow-emulator](https://github.com/onflow/flow-emulator) — distributed by [TomeVault](https://tomevault.io).
