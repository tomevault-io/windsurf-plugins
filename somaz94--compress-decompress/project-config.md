---
trigger: always_on
description: GitHub Action to compress or decompress files using various formats (zip, tar, tgz, tbz2, txz).
---
...
---
> Source: [somaz94/compress-decompress](https://github.com/somaz94/compress-decompress) — distributed by [TomeVault](https://tomevault.io).
