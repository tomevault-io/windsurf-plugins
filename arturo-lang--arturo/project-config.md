---
trigger: always_on
description: - Source: `src/` (VM in `src/vm/`, standard library in `src/library/`, helpers in `src/helpers/`).
---
...
---
> Source: [arturo-lang/arturo](https://github.com/arturo-lang/arturo) — distributed by [TomeVault](https://tomevault.io).
