---
trigger: always_on
description: This workspace is designed for AI agents to work efficiently within a project-aware environment with organized file management and clear separation between static project information and dynamic work outputs.
---
...
---
> Source: [NASA-AMMOS/slim](https://github.com/NASA-AMMOS/slim) — distributed by [TomeVault](https://tomevault.io).
