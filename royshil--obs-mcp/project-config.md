---
trigger: always_on
description: - Build: `npm run build` - Compiles TypeScript and sets executable permissions
---
...
---
> Source: [royshil/obs-mcp](https://github.com/royshil/obs-mcp) — distributed by [TomeVault](https://tomevault.io).
