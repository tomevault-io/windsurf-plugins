---
trigger: always_on
description: - Use Go idiomatically. Let the problem and data drive the design.
---
...
---
> Source: [SAP/go-hdb](https://github.com/SAP/go-hdb) — distributed by [TomeVault](https://tomevault.io).
