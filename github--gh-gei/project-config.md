---
trigger: always_on
description: This is a C# based repository that produces several CLIs that are used by customers to interact with the GitHub migration APIs. Please follow these guidelines when contributing:
---
...
---
> Source: [github/gh-gei](https://github.com/github/gh-gei) — distributed by [TomeVault](https://tomevault.io).
