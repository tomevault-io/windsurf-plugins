---
trigger: always_on
description: 1.	Install the latest stable (.NET SDK)[https://dotnet.microsoft.com/en-us/download].
---
...
---
> Source: [yurkinh/Plugin.Maui.Calendar](https://github.com/yurkinh/Plugin.Maui.Calendar) — distributed by [TomeVault](https://tomevault.io).
