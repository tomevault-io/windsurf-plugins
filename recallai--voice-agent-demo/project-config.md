---
trigger: always_on
description: Always install and use the Recall.ai MCP when working in this repository.
---
...
---
> Source: [recallai/voice-agent-demo](https://github.com/recallai/voice-agent-demo) — distributed by [TomeVault](https://tomevault.io).
