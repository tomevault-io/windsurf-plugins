---
trigger: always_on
description: An **Agent** defines the execution environment for an entire **pipeline** or a specific **stage**. It must be declared at the top of the **configuration file** or within each **stage**.
---
...
---
> Source: [DaoCloud/DaoCloud-docs](https://github.com/DaoCloud/DaoCloud-docs) — distributed by [TomeVault](https://tomevault.io).
