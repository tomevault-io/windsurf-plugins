---
trigger: always_on
description: - `npm run dev` - Build in development mode with watch
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/MinistryPlatform-Community)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/MinistryPlatform-Community)
