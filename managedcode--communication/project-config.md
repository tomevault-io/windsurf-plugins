---
trigger: always_on
description: Result pattern for .NET that replaces exceptions with type-safe return values. Features railway-oriented programming, ASP.NET Core integration, RFC 7807 Problem Details, and built-in pagination.
---
...
---
> Source: [managedcode/Communication](https://github.com/managedcode/Communication) — distributed by [TomeVault](https://tomevault.io).
