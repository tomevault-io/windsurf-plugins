---
trigger: always_on
description: **@gfazioli/mantine-split-pane** — A Mantine 9 React component library providing resizable split pane layouts with 7 resizer variants, context-based prop inheritance, responsive orientation, and dynamic pane generation.
---
...
---
> Source: [gfazioli/mantine-split-pane](https://github.com/gfazioli/mantine-split-pane) — distributed by [TomeVault](https://tomevault.io).
