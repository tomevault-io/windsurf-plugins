---
trigger: always_on
description: AWS OFI NCCL is a plugin that enables NVIDIA NCCL, AMD RCCL, and AWS Neuron
---
...
---
> Source: [aws/aws-ofi-nccl](https://github.com/aws/aws-ofi-nccl) — distributed by [TomeVault](https://tomevault.io).
