---
trigger: always_on
description: This repository uses a highly modular, `flake-parts` and `import-tree` driven NixOS configuration designed for a distributed cluster. To save time exploring the codebase, understand the following data flows and auto-wiring mechanics:
---
...
---
> Source: [oluceps/nixos-config](https://github.com/oluceps/nixos-config) — distributed by [TomeVault](https://tomevault.io).
