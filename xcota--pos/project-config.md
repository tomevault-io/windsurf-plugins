---
trigger: always_on
description: Memory + execution + mirror — this folder is where you keep the person you work with.
---
...
---
> Source: [xcota/pos](https://github.com/xcota/pos) — distributed by [TomeVault](https://tomevault.io).
