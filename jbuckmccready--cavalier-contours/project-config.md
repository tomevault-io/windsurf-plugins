---
trigger: always_on
description: - **Format:** `cargo fmt --all`
---
...
---
> Source: [jbuckmccready/cavalier_contours](https://github.com/jbuckmccready/cavalier_contours) — distributed by [TomeVault](https://tomevault.io).
