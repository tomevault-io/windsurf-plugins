---
trigger: always_on
description: 这是一个局域网文件共享项目，包含两个使用面和一个内嵌服务：
---
...
- 发布新版本时，changelog/release notes 必须基于“上一个发布版本 tag 到当前发布 tag”的完整变更来整理，列出面向用户的重要功能更新和体验改进；不要只写本次最后一个提交，也不需要罗列实现细节或内部修改细节。

---
> Source: [tri5m/file-share](https://github.com/tri5m/file-share) — distributed by [TomeVault](https://tomevault.io).
