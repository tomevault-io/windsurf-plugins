---
trigger: always_on
description: - Workspace root (`Cargo.toml`) aggregates all crates; shared config lives beside it
---
...
---
> Source: [ratatui/tui-widgets](https://github.com/ratatui/tui-widgets) — distributed by [TomeVault](https://tomevault.io).
