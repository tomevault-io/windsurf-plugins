---
trigger: always_on
description: Run the following commands from the workspace root:
---
...
---
> Source: [longbridge/openapi](https://github.com/longbridge/openapi) — distributed by [TomeVault](https://tomevault.io).
