---
trigger: always_on
description: - `cmd/insights-bot/` contains the main entrypoint for the bot binary.
---
...
---
> Source: [nekomeowww/insights-bot](https://github.com/nekomeowww/insights-bot) — distributed by [TomeVault](https://tomevault.io).
