# AI instruction files for augmentedcode-configuration
...
Original source: `AGENTS.md` in [eferro/augmentedcode-configuration](https://github.com/eferro/augmentedcode-configuration).
