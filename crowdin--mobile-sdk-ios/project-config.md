---
trigger: always_on
description: This is an iOS/macOS/tvOS/watchOS SDK for delivering Over-The-Air (OTA) localization updates from Crowdin. The SDK swizzles Bundle methods to intercept localization lookups and provide translations from remote storage.
---
...
---
> Source: [crowdin/mobile-sdk-ios](https://github.com/crowdin/mobile-sdk-ios) — distributed by [TomeVault](https://tomevault.io).
