---
trigger: always_on
description: - **Build**: `dotnet build`
---
...
---
> Source: [getsentry/symbol-collector](https://github.com/getsentry/symbol-collector) — distributed by [TomeVault](https://tomevault.io).
