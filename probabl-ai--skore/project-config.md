---
trigger: always_on
description: - Read the closest `AGENTS.md` for the area you touch.
---
...
---
> Source: [probabl-ai/skore](https://github.com/probabl-ai/skore) — distributed by [TomeVault](https://tomevault.io).
