---
trigger: always_on
description: <!-- Short, focused Copilot instructions for working in the Cloudrave repo -->
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/uditplayz)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/uditplayz)
