---
trigger: always_on
description: - `index.js` is the public entry point; `index.d.ts` provides TypeScript typings.
---
...
---
> Source: [scravy/node-macaddress](https://github.com/scravy/node-macaddress) — distributed by [TomeVault](https://tomevault.io).
