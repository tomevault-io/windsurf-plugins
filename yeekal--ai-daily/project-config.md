---
trigger: always_on
description: AI 驱动的 RSS 新闻聚合与推送系统，支持 400+ 信息源，使用 LLM 智能评分筛选，定时推送到 Discord/企业微信。
---
...
---
> Source: [YeeKal/ai-daily](https://github.com/YeeKal/ai-daily) — distributed by [TomeVault](https://tomevault.io).
