---
trigger: always_on
description: **HAML All-in-One** is a VS Code extension providing comprehensive HAML development tools including syntax highlighting, linting, formatting, Rails integration (partials, routes, I18n), and HTML/ERB conversion.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/wilfison)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/wilfison)
