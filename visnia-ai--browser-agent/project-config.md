---
trigger: always_on
description: - Keep reusable `src/core/` APIs configurable through explicit typed inputs and dependency injection. Do not make core entrypoints depend on YAML files, CLI arguments, or implicit environment configuration.
---
...
---
> Source: [visnia-ai/browser-agent](https://github.com/visnia-ai/browser-agent) — distributed by [TomeVault](https://tomevault.io).
