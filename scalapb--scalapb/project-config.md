---
trigger: always_on
description: ScalaPB is a protoc plugin that generates Scala case classes from `.proto` files.
---
...
---
> Source: [scalapb/ScalaPB](https://github.com/scalapb/ScalaPB) — distributed by [TomeVault](https://tomevault.io).
