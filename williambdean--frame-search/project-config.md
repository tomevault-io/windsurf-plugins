---
trigger: always_on
description: Frame Search is a Python library that adds a GitHub search inspired interface to DataFrames. It provides a `.search()` method that works with both pandas and polars DataFrames using GitHub-style query syntax.
---
...
---
> Source: [williambdean/frame-search](https://github.com/williambdean/frame-search) — distributed by [TomeVault](https://tomevault.io).
