---
trigger: always_on
description: Open Deep Research is a configurable, fully open-source deep research agent that works across multiple model providers, search tools, and MCP (Model Context Protocol) servers. It enables automated research with parallel processing and comprehensive report generation.
---
...
---
> Source: [larrymargerum01/Multi-Agent-Research-Assistant](https://github.com/larrymargerum01/Multi-Agent-Research-Assistant) — distributed by [TomeVault](https://tomevault.io).
