---
trigger: always_on
description: SwifQL is a strongly typed, declarative, composable Swift SQL-building library. It builds SQL; database execution belongs to database drivers or wrappers outside this repository.
---
...
---
> Source: [SwifQL/SwifQL](https://github.com/SwifQL/SwifQL) — distributed by [TomeVault](https://tomevault.io).
