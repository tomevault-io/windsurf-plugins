---
trigger: always_on
description: This is the main repo of Parlant (https://parlant.io).
---
...
---
> Source: [emcie-co/parlant](https://github.com/emcie-co/parlant) — distributed by [TomeVault](https://tomevault.io).
