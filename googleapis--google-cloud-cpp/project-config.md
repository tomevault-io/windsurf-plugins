---
trigger: always_on
description: - Use `EXPECT_THAT` / `ASSERT_THAT` with gtest/gmock matchers (e.g.,
---
...
---
> Source: [googleapis/google-cloud-cpp](https://github.com/googleapis/google-cloud-cpp) — distributed by [TomeVault](https://tomevault.io).
