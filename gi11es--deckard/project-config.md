---
trigger: always_on
description: xcodebuild -project Deckard.xcodeproj -scheme Deckard -configuration Debug build
---
...
---
> Source: [gi11es/deckard](https://github.com/gi11es/deckard) — distributed by [TomeVault](https://tomevault.io).
