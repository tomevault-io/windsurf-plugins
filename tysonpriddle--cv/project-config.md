---
trigger: always_on
description: A single-file personal web CV hosted on GitHub Pages at `cv.tysonpriddle.com`.
---
...
---
> Source: [tysonpriddle/cv](https://github.com/tysonpriddle/cv) — distributed by [TomeVault](https://tomevault.io).
