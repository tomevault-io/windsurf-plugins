---
trigger: always_on
description: Welcome! This file keeps lightweight coordination notes for anyone (human or AI) hacking on `connect-mongo`.
---
...
---
> Source: [jdesboeufs/connect-mongo](https://github.com/jdesboeufs/connect-mongo) — distributed by [TomeVault](https://tomevault.io).
