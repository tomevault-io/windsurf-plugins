---
trigger: always_on
description: The following slash commands are available for common development tasks. Run them with `/skill-name <module-name>`:
---
...
---
> Source: [makeup/makeup-js](https://github.com/makeup/makeup-js) — distributed by [TomeVault](https://tomevault.io).
