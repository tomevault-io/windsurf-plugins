---
trigger: always_on
description: 面向 AI 编码代理（codex/claude 等）的项目上下文基线。先读本文，再读 README.md。
---
...
---
> Source: [web-casa/DeepSeek-Harness-Desktop](https://github.com/web-casa/DeepSeek-Harness-Desktop) — distributed by [TomeVault](https://tomevault.io).
