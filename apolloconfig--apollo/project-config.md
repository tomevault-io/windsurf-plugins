---
trigger: always_on
description: - Multi-module Maven repo with root `pom.xml` and service modules like `apollo-configservice`, `apollo-adminservice`, and `apollo-portal`, shared libs in `apollo-common`, and packaging in `apollo-assembly`.
---
...
---
> Source: [apolloconfig/apollo](https://github.com/apolloconfig/apollo) — distributed by [TomeVault](https://tomevault.io).
