---
trigger: always_on
description: Wakaru is a JavaScript decompiler that transforms minified/bundled code back into readable, modern ESNext. It unpacks bundles (webpack4, webpack5, esbuild, browserify), restores transpiler helpers (Babel, TypeScript), and applies ~60 rewrite rules to recover idiomatic source.
---
...
---
> Source: [pionxzh/wakaru](https://github.com/pionxzh/wakaru) — distributed by [TomeVault](https://tomevault.io).
