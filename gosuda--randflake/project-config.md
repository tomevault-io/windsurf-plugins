---
trigger: always_on
description: TypeScript implementation of the Randflake ID generator using BigInt for 64-bit safety.
---
...
---
> Source: [gosuda/randflake](https://github.com/gosuda/randflake) — distributed by [TomeVault](https://tomevault.io).
