---
trigger: always_on
description: - Application code lives in `src/sqlite3_to_mysql`; `cli.py` exposes the `sqlite3mysql` entry point, while
---
...
---
> Source: [techouse/sqlite3-to-mysql](https://github.com/techouse/sqlite3-to-mysql) — distributed by [TomeVault](https://tomevault.io).
