---
trigger: always_on
description: This project is indexed with SocratiCode. Always use its MCP tools to explore the codebase
---
...
---
> Source: [giancarloerra/SocratiCode](https://github.com/giancarloerra/SocratiCode) — distributed by [TomeVault](https://tomevault.io).
