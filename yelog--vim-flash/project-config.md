---
trigger: always_on
description: This file provides instructional context for Gemini CLI when working in the `vim-flash` repository.
---
...
---
> Source: [yelog/vim-flash](https://github.com/yelog/vim-flash) — distributed by [TomeVault](https://tomevault.io).
