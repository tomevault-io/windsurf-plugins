---
trigger: always_on
description: This project requires [RTK](https://github.com/rtk-ai/rtk) for agent shell commands.
---
...
---
> Source: [zhouhanker/versatile-computer-use](https://github.com/zhouhanker/versatile-computer-use) — distributed by [TomeVault](https://tomevault.io).
