---
trigger: always_on
description: <!-- AUTO-GENERATED from rundeck-plugins/.github/templates/copilot-instructions.shared.md -- DO NOT EDIT. Run scripts/sync-copilot-instructions.sh to update. -->
---
...
---
> Source: [rundeck-plugins/ansible-plugin](https://github.com/rundeck-plugins/ansible-plugin) — distributed by [TomeVault](https://tomevault.io).
