---
trigger: always_on
description: - **Always use `logger` instead of `console` for logging** in both main and renderer processes
---
...
---
> Source: [hydralauncher/hydra](https://github.com/hydralauncher/hydra) — distributed by [TomeVault](https://tomevault.io).
