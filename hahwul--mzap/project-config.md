---
trigger: always_on
description: `mzap` is a Crystal CLI (v2.0.0) for multi-target ZAP scanning. Dispatches targets across ZAP API hosts via round-robin, supports wait/poll mode, and exports reports.
---
...
---
> Source: [hahwul/mzap](https://github.com/hahwul/mzap) — distributed by [TomeVault](https://tomevault.io).
