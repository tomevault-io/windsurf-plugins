---
trigger: always_on
description: 本仓库是用于开发 Tampermonkey 用户脚本的 pnpm 工作区。主要脚本包位于 `packages/*`，共享运行时代码位于 `shared`，构建相关的包位于 `tools/*`。
---
...
---
> Source: [sakura-flutter/tampermonkey-scripts](https://github.com/sakura-flutter/tampermonkey-scripts) — distributed by [TomeVault](https://tomevault.io).
