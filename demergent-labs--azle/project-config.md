---
trigger: always_on
description: Azle is a TypeScript/JavaScript environment for the Internet Computer Protocol.
---
...
---
> Source: [demergent-labs/azle](https://github.com/demergent-labs/azle) — distributed by [TomeVault](https://tomevault.io).
