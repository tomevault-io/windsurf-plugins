---
trigger: always_on
description: > **Note:** This document provides high-level guidance for AI agents working with Lit components. Detailed rules with code examples are in the `rules/` directory.
---
