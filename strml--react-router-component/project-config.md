---
trigger: always_on
description: Declarative router component for React. Allows routes to be defined directly as part of the component hierarchy.
---
...
---
> Source: [STRML/react-router-component](https://github.com/STRML/react-router-component) — distributed by [TomeVault](https://tomevault.io).
