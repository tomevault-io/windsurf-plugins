---
trigger: always_on
description: Instructions for coding agents — and useful to humans. **reconverge** is static reconvergence analysis for Rust GPU kernels: it catches divergent barriers and non-convergent warp collectives at compile time, and shows you why, lane by lane, in your terminal.
---
...
---
> Source: [vyncint/reconverge](https://github.com/vyncint/reconverge) — distributed by [TomeVault](https://tomevault.io).
