---
trigger: always_on
description: This file defines repository-wide defaults for Copilot behavior. It is always applied.
---
...
---
> Source: [microsoft/kiota](https://github.com/microsoft/kiota) — distributed by [TomeVault](https://tomevault.io).
