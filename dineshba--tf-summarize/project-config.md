---
trigger: always_on
description: `tf-summarize` is a Go CLI tool that summarizes Terraform plan output into human-readable formats: table, tree, JSON, HTML, and separate-tree views. It reads plans from stdin or file (JSON or binary tfplan), parses them using `hashicorp/terraform-json`, and writes formatted summaries.
---
...
---
> Source: [dineshba/tf-summarize](https://github.com/dineshba/tf-summarize) — distributed by [TomeVault](https://tomevault.io).
