---
trigger: always_on
description: - `lib/protox/**`: Core library (encoding/decoding, generation, parsing). Mix tasks in `lib/mix/tasks/protox/*`.
---
...
---
> Source: [ahamez/protox](https://github.com/ahamez/protox) — distributed by [TomeVault](https://tomevault.io).
