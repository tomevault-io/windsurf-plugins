---
trigger: always_on
description: - Add concise, meaningful docstrings to all functions when creating or modifying CLI code.
---
...
---
> Source: [vsjha18/tickertrail](https://github.com/vsjha18/tickertrail) — distributed by [TomeVault](https://tomevault.io).
