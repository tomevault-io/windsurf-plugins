---
trigger: always_on
description: Obsidian vault 기반 개발 노트 모음. `obsidian-site-action/`의 빌드 도구로 정적 웹사이트를 생성한다.
---
...
---
> Source: [benelog/devnote](https://github.com/benelog/devnote) — distributed by [TomeVault](https://tomevault.io).
