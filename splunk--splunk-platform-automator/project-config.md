---
trigger: always_on
description: Splunk Platform Automator (SPA) provisions and deploys Splunk Enterprise on **AWS Linux** using Ansible + Terraform. Configuration is driven by `config/splunk_config.yml`.
---
...
---
> Source: [splunk/splunk-platform-automator](https://github.com/splunk/splunk-platform-automator) — distributed by [TomeVault](https://tomevault.io).
