---
trigger: always_on
description: - **Git Workflow:** Never use `git commit --amend`. Always create a new commit and push to the same branch to update an existing Pull Request.
---
...
---
> Source: [GoogleCloudPlatform/terraform-python-testing-helper](https://github.com/GoogleCloudPlatform/terraform-python-testing-helper) — distributed by [TomeVault](https://tomevault.io).
