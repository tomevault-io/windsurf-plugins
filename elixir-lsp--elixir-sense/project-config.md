---
trigger: always_on
description: - lib/: Elixir source (primary namespace: ElixirSense.*). Keep providers/utilities under lib/elixir_sense/providers/** and lib/elixir_sense/providers/utils/**.
---
...
---
> Source: [elixir-lsp/elixir_sense](https://github.com/elixir-lsp/elixir_sense) — distributed by [TomeVault](https://tomevault.io).
