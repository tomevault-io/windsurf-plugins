---
trigger: always_on
description: NLWeb is a natural language search system that provides intelligent query processing, multi-source retrieval, and AI-powered response generation.
---
...
**Backend**: Python-based aiohttp server in `AskAgent/python/` with main entry at `webserver/aiohttp_server.py`
...
---
> Source: [nlweb-ai/NLWeb](https://github.com/nlweb-ai/NLWeb) — distributed by [TomeVault](https://tomevault.io).
