---
trigger: always_on
description: 1. **ドキュメント作成**: 永続ドキュメント(`docs/`)で「何を作るか」を定義
---
...
---
> Source: [GenerativeAgents/claude-code-book-chapter8](https://github.com/GenerativeAgents/claude-code-book-chapter8) — distributed by [TomeVault](https://tomevault.io).
