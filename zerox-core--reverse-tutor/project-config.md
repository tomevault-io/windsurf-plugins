---
trigger: always_on
description: > 本文件被 Codex CLI 每次会话自动读取。**这里是不可违反的硬规则**；完整背景、技术细节与测试方向见 `docs/CODEX_HANDOFF.md`。
---
...
---
> Source: [zerox-core/Reverse-Tutor](https://github.com/zerox-core/Reverse-Tutor) — distributed by [TomeVault](https://tomevault.io).
