---
trigger: always_on
description: `@pulumi/cdk` is a TypeScript SDK that lets Pulumi programs use AWS CDK constructs.
---
...
---
> Source: [pulumi/pulumi-cdk](https://github.com/pulumi/pulumi-cdk) — distributed by [TomeVault](https://tomevault.io).
