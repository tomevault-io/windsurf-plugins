---
trigger: always_on
description: RNS agent is an executable which is deployed on an asset for the purpose of carrying out tasks sent to it from the base (C2).
---
...
---
> Source: [dsnezhkov/racketeer](https://github.com/dsnezhkov/racketeer) — distributed by [TomeVault](https://tomevault.io).
