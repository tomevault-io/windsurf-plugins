---
trigger: always_on
description: Read `state/task_spec.md`, `state/progress.json`, and `state/STATE.json` before work.
---
...
---
> Source: [vukrosic/cancer-research](https://github.com/vukrosic/cancer-research) — distributed by [TomeVault](https://tomevault.io).
