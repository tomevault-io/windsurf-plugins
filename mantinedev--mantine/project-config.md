---
trigger: always_on
description: Choose these commands to run after finalizing your work:
---
...
---
> Source: [mantinedev/mantine](https://github.com/mantinedev/mantine) — distributed by [TomeVault](https://tomevault.io).
