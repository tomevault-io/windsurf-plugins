---
trigger: always_on
description: - Assume “happy path” only—omit error handling, logging, or CLI arg
---
...
---
> Source: [seanchatmangpt/dslmodel](https://github.com/seanchatmangpt/dslmodel) — distributed by [TomeVault](https://tomevault.io).
