---
trigger: always_on
description: MonkeyLang.jl is a Julia implementation of the Monkey programming language, based on Thorsten Ball's "Writing An Interpreter In Go" and "Writing A Compiler In Go".
---
...
---
> Source: [lucifer1004/MonkeyLang.jl](https://github.com/lucifer1004/MonkeyLang.jl) — distributed by [TomeVault](https://tomevault.io).
