---
trigger: always_on
description: RMM (RAPIDS Memory Manager) is a CUDA memory management library providing C++ and Python APIs.
---
...
---
> Source: [rapidsai/rmm](https://github.com/rapidsai/rmm) — distributed by [TomeVault](https://tomevault.io).
