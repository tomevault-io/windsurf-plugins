---
trigger: always_on
description: This is an ESPHome YAML library for building LVGL touchscreen UIs on ESP32 devices. Not Python or JavaScript — pure ESPHome YAML with inline C++ lambdas.
---

# Cline Rules — esphome-modular-lvgl-buttons
