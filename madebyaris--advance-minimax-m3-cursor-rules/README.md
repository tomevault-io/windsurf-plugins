...
Original source: `.cursor/rules/*.mdc` in [madebyaris/advance-minimax-m3-cursor-rules](https://github.com/madebyaris/advance-minimax-m3-cursor-rules).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/madebyaris/advance-minimax-m3-cursor-rules](https://github.com/madebyaris/advance-minimax-m3-cursor-rules)
