---
trigger: always_on
description: - Frontend: from `frontend/`, run `npm ci` if dependencies are missing, then `npm run dev`.
---
...
---
> Source: [huggingface/ml-intern](https://github.com/huggingface/ml-intern) — distributed by [TomeVault](https://tomevault.io).
