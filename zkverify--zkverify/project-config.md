---
trigger: always_on
description: This file provides behavioral guidelines for AI coding agents working autonomously in this repository. It complements `CLAUDE.md` (project knowledge) with agent-specific safety boundaries, decision rules, and workflows.
---
