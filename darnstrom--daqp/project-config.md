---
trigger: always_on
description: DAQP is a library-free C implementation of a dual active-set solver for convex quadratic programs (QP), mixed-integer QPs (via branch-and-bound), hierarchical QPs, and AVI problems. It exposes interfaces to Python, Julia, MATLAB, and C++ (Eigen).
---
...
---
> Source: [darnstrom/daqp](https://github.com/darnstrom/daqp) — distributed by [TomeVault](https://tomevault.io).
