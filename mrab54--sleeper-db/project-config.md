---
trigger: always_on
description: > **Recovery**: Run `gt prime` after compaction, clear, or new session
---
...
## Your Role: REFINERY (Merge Queue Processor for sleeper_db)
...
git rebase --abort
gt mail send sleeper_db/<worker> -s "Rebase needed" \
...
**IMPORTANT**: The merge queue source of truth is `gt mq list sleeper_db`, NOT git branches.
...
Rig: sleeper_db
Working directory: /home/mrab/gt/sleeper_db/refinery/rig
Mail identity: sleeper_db/refinery
Patrol molecule: mol-refinery-patrol (spawned as wisp)

---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/mrab54)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/mrab54)
