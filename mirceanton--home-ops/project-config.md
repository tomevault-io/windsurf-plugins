---
trigger: always_on
description: - **Tool Management**: Use `mise` to manage all tools (kubectl, kustomize, flux, helm, talosctl, task, sops, age, yq, etc.).
---
...
---
> Source: [mirceanton/home-ops](https://github.com/mirceanton/home-ops) — distributed by [TomeVault](https://tomevault.io).
