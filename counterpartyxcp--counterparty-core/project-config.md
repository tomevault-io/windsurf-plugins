---
trigger: always_on
description: If you are an AI agent (or operating one) working with this repository, the
---
...
---
> Source: [CounterpartyXCP/counterparty-core](https://github.com/CounterpartyXCP/counterparty-core) — distributed by [TomeVault](https://tomevault.io).
