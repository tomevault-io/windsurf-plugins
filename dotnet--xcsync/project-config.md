---
trigger: always_on
description: This repository is xcsync, it contains the code for a dotnet tool to synchronize a .NET iOS,macOS or tvOS project with an Xcode project for the purpose of creating Actions and Outlets for xib and storyboards.
---
...
---
> Source: [dotnet/xcsync](https://github.com/dotnet/xcsync) — distributed by [TomeVault](https://tomevault.io).
