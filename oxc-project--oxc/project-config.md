---
trigger: always_on
description: Prettier compatible JSON/JSONC/JSON5/JSON.stringify formatter (`oxfmt`'s Tier 1 backend), using the `oxc_formatter_core` APIs.
---
...
---
> Source: [oxc-project/oxc](https://github.com/oxc-project/oxc) — distributed by [TomeVault](https://tomevault.io).
