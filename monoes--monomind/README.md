...
Original source: `CLAUDE.md` in [monoes/monomind](https://github.com/monoes/monomind).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/monoes/monomind](https://github.com/monoes/monomind)
