---
trigger: always_on
description: This file is for AI coding agents working in this repository. Human contributors should read [CONTRIBUTING.md](CONTRIBUTING.md) instead.
---
...
---
> Source: [argoproj/argo-helm](https://github.com/argoproj/argo-helm) — distributed by [TomeVault](https://tomevault.io).
