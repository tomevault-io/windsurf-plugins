---
trigger: always_on
description: - **Type**: .NET 10 WinForms Desktop Application
---
...
---
> Source: [spektor56/OpenpilotToolkit](https://github.com/spektor56/OpenpilotToolkit) — distributed by [TomeVault](https://tomevault.io).
