---
trigger: always_on
description: Go server providing document synchronization via CRDTs with MongoDB or
---
...
---
> Source: [yorkie-team/yorkie](https://github.com/yorkie-team/yorkie) — distributed by [TomeVault](https://tomevault.io).
