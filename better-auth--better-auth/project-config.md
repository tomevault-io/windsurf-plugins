---
trigger: always_on
description: This is the Better Auth repository - a comprehensive authentication framework for TypeScript, designed to be runtime and framework-agnostic.
---
...
---
> Source: [better-auth/better-auth](https://github.com/better-auth/better-auth) — distributed by [TomeVault](https://tomevault.io).
