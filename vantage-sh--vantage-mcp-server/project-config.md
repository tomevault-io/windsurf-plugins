---
trigger: always_on
description: - `npm run dev` - Start development server with Wrangler DEV config
---
...
---
> Source: [vantage-sh/vantage-mcp-server](https://github.com/vantage-sh/vantage-mcp-server) — distributed by [TomeVault](https://tomevault.io).
