---
trigger: always_on
description: - Before every commit: `nu -c "use toolkit.nu; toolkit fmt"` and `nu -c "use toolkit.nu; toolkit clippy"`. This is pretty fast so you can run it frequently.
---
...
---
> Source: [nushell/nushell](https://github.com/nushell/nushell) — distributed by [TomeVault](https://tomevault.io).
