---
trigger: always_on
description: PR body format for AI agents. A human filling this in by hand wants the
---
...
---
> Source: [uwuclxdy/clauth](https://github.com/uwuclxdy/clauth) — distributed by [TomeVault](https://tomevault.io).
