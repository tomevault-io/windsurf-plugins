---
trigger: always_on
description: AsciiDoc source for SUSE product release notes, built with [doc-kit](https://github.com/openSUSE/doc-kit) via `daps`. No traditional test/lint/typecheck — `make validate` is the closest.
---
...
---
> Source: [SUSE/release-notes](https://github.com/SUSE/release-notes) — distributed by [TomeVault](https://tomevault.io).
