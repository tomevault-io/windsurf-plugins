---
trigger: always_on
description: PHP client library for the [Bunny.net](https://bunny.net) API. Each API endpoint is a **model class** under `src/Model/Api/{ApiGroup}/{Category}/` — most are **auto-generated** from OpenAPI specs via `generator/`. The library is PSR-18 based; users supply their own HTTP client.
---
...
---
> Source: [ToshY/BunnyNet-PHP](https://github.com/ToshY/BunnyNet-PHP) — distributed by [TomeVault](https://tomevault.io).
