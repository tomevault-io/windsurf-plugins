---
trigger: always_on
description: We use a **MediaQuery scale factor** approach — no `flutter_screenutil`. The design width is **393px**. Sizes stay unchanged on 393px+ screens and smoothly shrink down to 85% on smaller screens.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/ved1nsh) — claim your Tome and manage your conversions.
