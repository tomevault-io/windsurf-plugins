---
trigger: always_on
description: - `src/MoYuCode/`: ASP.NET Core Web API (`net10.0`) with EF Core (SQLite).
---
...
---
> Source: [AIDotNet/MoYuCode](https://github.com/AIDotNet/MoYuCode) — distributed by [TomeVault](https://tomevault.io).
