---
trigger: always_on
description: Behavioral guidelines for LLM coding assistants working on **sveltekit-i18n**
---
...
---
> Source: [sveltekit-i18n/lib](https://github.com/sveltekit-i18n/lib) — distributed by [TomeVault](https://tomevault.io).
