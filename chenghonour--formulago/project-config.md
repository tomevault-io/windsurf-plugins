---
trigger: always_on
description: biz/handler/  →  biz/logic/  →  biz/domain/  →  data/
---
...
---
> Source: [chenghonour/formulago](https://github.com/chenghonour/formulago) — distributed by [TomeVault](https://tomevault.io).
