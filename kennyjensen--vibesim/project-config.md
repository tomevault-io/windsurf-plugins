---
trigger: always_on
description: - Root files: `index.html`, `style.css`, `app.js`.
---
...
---
> Source: [kennyjensen/vibesim](https://github.com/kennyjensen/vibesim) — distributed by [TomeVault](https://tomevault.io).
