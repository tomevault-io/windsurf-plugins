---
trigger: always_on
description: When the user asks to "run a test", "run tests", "test this file", or similar test-related requests, automatically execute the following command:
---
...
---
> Source: [schedule-x/schedule-x](https://github.com/schedule-x/schedule-x) — distributed by [TomeVault](https://tomevault.io).
