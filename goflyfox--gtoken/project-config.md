---
trigger: always_on
description: 基于 GoFrame v2.x 的 Token 认证库，提供服务端 Token 管理，支持 gcache、gredis 和文件存储。
---
...
---
> Source: [goflyfox/gtoken](https://github.com/goflyfox/gtoken) — distributed by [TomeVault](https://tomevault.io).
