---
trigger: always_on
description: IRC WebSocket client for Twitch chat - parsing IRCv3 tags, auto-reconnect (5s), PONG handling, discriminated unions.
---
...
---
> Source: [julez-dev/chatuino](https://github.com/julez-dev/chatuino) — distributed by [TomeVault](https://tomevault.io).
