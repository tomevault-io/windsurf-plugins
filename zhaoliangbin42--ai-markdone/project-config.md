---
trigger: always_on
description: Chrome Extension (Manifest V3) that enhances ChatGPT/Gemini with robust Markdown export. Extracts LaTeX from KaTeX, handles rendering failures, converts tables/code to Markdown, and provides click-to-copy math formulas.
---
