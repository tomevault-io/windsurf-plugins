---
trigger: always_on
description: logq is a Rust CLI tool implementing PartiQL to query server log files (ELB, ALB, S3, Squid, JSONL). The goal is full PartiQL spec compliance (with pragmatic exclusions) using a bottom-up phased approach.
---
...
---
> Source: [MnO2/logq](https://github.com/MnO2/logq) — distributed by [TomeVault](https://tomevault.io).
