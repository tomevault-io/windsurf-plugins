---
trigger: always_on
description: Cube Worlds is a Telegram Mini App game built around NFTs on the TON blockchain. It consists of three main parts: a Telegram bot (Grammy), a backend API (Fastify), and a Vue 3 frontend (Vite). Data is stored in MongoDB via Typegoose.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/cube-worlds) — claim your Tome and manage your conversions.
