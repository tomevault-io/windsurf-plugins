---
trigger: always_on
description: - `source/`: D sources. Entry point `app.d`; primary modules under `nijigenerate/*` (core, io, panels, windows, widgets).
---
...
---
> Source: [nijigenerate/nijigenerate](https://github.com/nijigenerate/nijigenerate) — distributed by [TomeVault](https://tomevault.io).
