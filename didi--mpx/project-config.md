---
trigger: always_on
description: 本仓库是 Mpx 的核心仓库，Mpx 是一款在微信原生小程序语法基础上进行了类 Vue 增强的跨端开发框架，能够以类似 Vue 的开发体验开发小程序及跨端应用，支持输出到多小程序平台、Web 和 React Native 环境中。
---
...
---
> Source: [didi/mpx](https://github.com/didi/mpx) — distributed by [TomeVault](https://tomevault.io).
