---
trigger: always_on
description: > 本文件面向 AI Agent。当你需要**创建、修改或维护** helper 时，阅读此文件即可完成任务。
---
...
---
> Source: [WecomTeam/wecom-cli](https://github.com/WecomTeam/wecom-cli) — distributed by [TomeVault](https://tomevault.io).
