---
trigger: always_on
description: This repository (`1inch/1inch-audits`) is a **static document archive**, not a software application.
---
...
---
> Source: [1inch/1inch-audits](https://github.com/1inch/1inch-audits) — distributed by [TomeVault](https://tomevault.io).
