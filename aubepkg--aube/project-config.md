...
mbx:
  policy: mise install installs mbx 1.4; mise run activates the project wrapper, and standalone cargo commands require an activated mise shell
  ...
  agent_boundary: do not permanently disable the wrapper and do not post externally without user authorization
...
---
> Source: [aubepkg/aube](https://github.com/aubepkg/aube) — distributed by [TomeVault](https://tomevault.io).
