---
trigger: always_on
description: This is a personal Home Assistant configuration repository for a heavily customized smart home setup. It is not an application codebase — there is no build step, no tests to run, and no deployment pipeline. Changes are applied by validating via the HA UI config check, then restarting Home Assistant.
---
...
---
> Source: [theglus/Home-Assistant-Config](https://github.com/theglus/Home-Assistant-Config) — distributed by [TomeVault](https://tomevault.io).
