---
trigger: always_on
description: Gõkey is a Vietnamese input method editor (IME) for macOS, written in Rust. It
---
...
---
> Source: [huytd/goxkey](https://github.com/huytd/goxkey) — distributed by [TomeVault](https://tomevault.io).
