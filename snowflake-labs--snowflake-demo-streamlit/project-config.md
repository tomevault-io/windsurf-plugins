---
trigger: always_on
description: This repository contains a collection of Streamlit in Snowflake demos and tutorials. Each directory is an independent app with its own code, setup scripts, and sample data.
---
...
---
> Source: [Snowflake-Labs/snowflake-demo-streamlit](https://github.com/Snowflake-Labs/snowflake-demo-streamlit) — distributed by [TomeVault](https://tomevault.io).
