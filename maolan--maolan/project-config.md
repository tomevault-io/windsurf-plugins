---
trigger: always_on
description: After every code change in this directory, run these commands in order:
---
...
---
> Source: [maolan/maolan](https://github.com/maolan/maolan) — distributed by [TomeVault](https://tomevault.io).
