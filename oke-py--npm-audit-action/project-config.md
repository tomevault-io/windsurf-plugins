---
trigger: always_on
description: This repository is a GitHub Action that runs `npm audit` and reports findings by commenting on PRs or creating issues. The action executes from `dist/index.js` and is built from TypeScript sources in `src/`.
---
