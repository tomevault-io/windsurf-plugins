---
trigger: always_on
description: coc.nvim is a language client framework for Vim and Neovim.
---
...
---
> Source: [neoclide/coc.nvim](https://github.com/neoclide/coc.nvim) — distributed by [TomeVault](https://tomevault.io).
