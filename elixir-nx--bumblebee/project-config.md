---
trigger: always_on
description: For reference, you can look at an example complete PR adding SmolLM3 LLM [here](https://github.com/elixir-nx/bumblebee/pull/422/files), and another one adding Swin image classification model [here](https://github.com/elixir-nx/bumblebee/pull/394/files).
---
...
---
> Source: [elixir-nx/bumblebee](https://github.com/elixir-nx/bumblebee) — distributed by [TomeVault](https://tomevault.io).
