---
trigger: always_on
description: Keep this file, `AGENTS.md`, up to date when the repo's release workflow or contributor guidance changes.
---
...
---
> Source: [storybookjs/addon-designs](https://github.com/storybookjs/addon-designs) — distributed by [TomeVault](https://tomevault.io).
