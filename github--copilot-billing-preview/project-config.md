---
trigger: always_on
description: - Never add real customer data to tests, fixtures, snapshots, examples, or documentation committed to this repository.
---
...
---
> Source: [github/copilot-billing-preview](https://github.com/github/copilot-billing-preview) — distributed by [TomeVault](https://tomevault.io).
