---
trigger: always_on
description: Swift 4.2 big number library (`BInt`, `BDouble`) with no external dependencies.
---
...
---
> Source: [mkrd/Swift-BigInt](https://github.com/mkrd/Swift-BigInt) — distributed by [TomeVault](https://tomevault.io).
