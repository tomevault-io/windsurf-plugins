---
trigger: always_on
description: - `podlove.php` and `plugin.php` are the plugin entry points.
---
...
---
> Source: [podlove/podlove-publisher](https://github.com/podlove/podlove-publisher) — distributed by [TomeVault](https://tomevault.io).
