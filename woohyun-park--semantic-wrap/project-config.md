---
trigger: always_on
description: - Core owns synchronous layout logic and stays independent of React, DOM measurement, and language presets. React owns DOM measurement and wrapper-free `<br>` rendering; English and Korean models stay in their own packages.
---
...
---
> Source: [woohyun-park/semantic-wrap](https://github.com/woohyun-park/semantic-wrap) — distributed by [TomeVault](https://tomevault.io).
