---
trigger: always_on
description: Before running ANY skill, always execute:
---
...
---
> Source: [moorcheh-ai/memanto](https://github.com/moorcheh-ai/memanto) — distributed by [TomeVault](https://tomevault.io).
