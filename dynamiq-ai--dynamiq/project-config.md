---
trigger: always_on
description: An agent that has access to the E2B Code Interpreter and is capable of solving complex coding tasks.
---
...
---
> Source: [dynamiq-ai/dynamiq](https://github.com/dynamiq-ai/dynamiq) — distributed by [TomeVault](https://tomevault.io).
