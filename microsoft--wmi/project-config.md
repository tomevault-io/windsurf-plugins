---
trigger: always_on
description: When creating or working on a pull request, **DO NOT** mark the PR as ready for review until all of the following conditions are met:
---
...
---
> Source: [microsoft/wmi](https://github.com/microsoft/wmi) — distributed by [TomeVault](https://tomevault.io).
