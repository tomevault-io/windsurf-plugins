---
trigger: always_on
description: **ALWAYS follow these instructions completely before using any search commands or bash exploration.** Only use additional search and context gathering if the information in these instructions is incomplete or found to be in error.
---
...
---
> Source: [JonasJurczok/factorio-todo-list](https://github.com/JonasJurczok/factorio-todo-list) — distributed by [TomeVault](https://tomevault.io).
