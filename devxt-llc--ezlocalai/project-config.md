---
trigger: always_on
description: - ezLocalai is designed to run inside of a docker container.
---
...
---
> Source: [DevXT-LLC/ezlocalai](https://github.com/DevXT-LLC/ezlocalai) — distributed by [TomeVault](https://tomevault.io).
