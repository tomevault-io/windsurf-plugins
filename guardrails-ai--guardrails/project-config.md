---
trigger: always_on
description: This repo separates **compatibility** (what users are allowed to install) from
---
...
---
> Source: [guardrails-ai/guardrails](https://github.com/guardrails-ai/guardrails) — distributed by [TomeVault](https://tomevault.io).
