---
trigger: always_on
description: - Always scan `README.md` first for the project overview + architecture constraints.
---
...
---
> Source: [Squalr/Squalr](https://github.com/Squalr/Squalr) — distributed by [TomeVault](https://tomevault.io).
