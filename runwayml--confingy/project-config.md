---
trigger: always_on
description: An implicit configuration system for Python. Tracks constructor arguments, supports lazy instantiation, and serializes/deserializes configurations to JSON ("fingys").
---
...
---
> Source: [runwayml/confingy](https://github.com/runwayml/confingy) — distributed by [TomeVault](https://tomevault.io).
