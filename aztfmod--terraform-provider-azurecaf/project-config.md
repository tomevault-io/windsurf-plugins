---
trigger: always_on
description: - Update ./CHANGELOG.md with the changes you do and assess the impact of the changes.
---
...
---
> Source: [aztfmod/terraform-provider-azurecaf](https://github.com/aztfmod/terraform-provider-azurecaf) — distributed by [TomeVault](https://tomevault.io).
