---
trigger: always_on
description: - Monorepo (pnpm workspaces). Key paths:
---
...
---
> Source: [zekenewsom/hyperlocal](https://github.com/zekenewsom/hyperlocal) — distributed by [TomeVault](https://tomevault.io).
