---
trigger: always_on
description: This repository contains agent-agnostic `SKILL.md` skills. Use this file when your agent does not have native skills support, or when it needs explicit rules for discovering and applying the skills in `skills/`.
---
...
---
> Source: [dongshuyan/compass-skills](https://github.com/dongshuyan/compass-skills) — distributed by [TomeVault](https://tomevault.io).
