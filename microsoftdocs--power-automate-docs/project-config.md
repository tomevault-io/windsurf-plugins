---
trigger: always_on
description: This repository contains the technical documentation for Microsoft Power Automate, published at https://learn.microsoft.com/power-automate. The content is primarily Markdown files under the `articles/` directory, with supporting assets in subfolders.
---
...
---
> Source: [MicrosoftDocs/power-automate-docs](https://github.com/MicrosoftDocs/power-automate-docs) — distributed by [TomeVault](https://tomevault.io).
