---
trigger: always_on
description: Project-wide guidelines for the CodeLearn Platform LMS. Covers project structure, tech stack, commands, hexagonal architecture, and key documentation references.
---
