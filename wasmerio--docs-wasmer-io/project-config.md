---
trigger: always_on
description: This is the repository for the documentation of Wasmer.
---
...
---
> Source: [wasmerio/docs.wasmer.io](https://github.com/wasmerio/docs.wasmer.io) — distributed by [TomeVault](https://tomevault.io).
