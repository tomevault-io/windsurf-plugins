---
trigger: always_on
description: - Root `pom.xml` 聚合 `sdk`、`service`；指令從根目錄執行。
---
...
---
> Source: [vincentf13/open.vincentf13](https://github.com/vincentf13/open.vincentf13) — distributed by [TomeVault](https://tomevault.io).
