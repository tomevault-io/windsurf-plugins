---
trigger: always_on
description: 本流程用于在仓库根目录 `C:\Users\Felix\CLionProjects\KSword` 生成包含完整 `Release\` 目录的 7z 发行包。默认参考旧包布局：`C:\Users\Felix\Downloads\KswordARK评估版本-260427-未签名R0-进程内存监控增强.7z`。
---
...
---
> Source: [WangWei-CM/KSword](https://github.com/WangWei-CM/KSword) — distributed by [TomeVault](https://tomevault.io).
