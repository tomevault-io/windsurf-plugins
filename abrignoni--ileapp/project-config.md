---
trigger: always_on
description: iOS, iPadOS and watchOS logs, events and protobuf parser. The largest of the five LEAPP
---
...
---
> Source: [abrignoni/iLEAPP](https://github.com/abrignoni/iLEAPP) — distributed by [TomeVault](https://tomevault.io).
