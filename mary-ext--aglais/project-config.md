---
trigger: always_on
description: aglais is a web client for the Bluesky social network, built with Solid.js and Vite.
---
...
---
> Source: [mary-ext/aglais](https://github.com/mary-ext/aglais) — distributed by [TomeVault](https://tomevault.io).
