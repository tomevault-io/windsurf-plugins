---
trigger: always_on
description: Read `AGENTS.md` for the full project guide. Use the rules below as the highest-priority summary for Copilot surfaces that truncate long instruction files.
---
...
---
> Source: [finos/git-proxy](https://github.com/finos/git-proxy) — distributed by [TomeVault](https://tomevault.io).
