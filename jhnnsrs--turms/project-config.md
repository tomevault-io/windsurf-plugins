---
trigger: always_on
description: **turms** is a `graphql-codegen`-inspired Python code generator that produces typed, serializable Pydantic models and operation functions from GraphQL schemas and documents. It supports both client-side (operations/fragments) and server-side (Strawberry schema types) generation.
---
...
---
> Source: [jhnnsrs/turms](https://github.com/jhnnsrs/turms) — distributed by [TomeVault](https://tomevault.io).
