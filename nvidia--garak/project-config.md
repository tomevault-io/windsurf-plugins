---
trigger: always_on
description: > These instructions apply to **all** AI-assisted contributions to `nvidia/garak`.
---
...
---
> Source: [NVIDIA/garak](https://github.com/NVIDIA/garak) — distributed by [TomeVault](https://tomevault.io).
