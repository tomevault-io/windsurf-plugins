---
trigger: always_on
description: This file describes how to build, test, format, and contribute to FSharpx.Collections.
---
...
---
> Source: [fsprojects/FSharpx.Collections](https://github.com/fsprojects/FSharpx.Collections) — distributed by [TomeVault](https://tomevault.io).
