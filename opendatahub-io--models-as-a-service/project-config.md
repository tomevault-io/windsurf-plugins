---
trigger: always_on
description: Kubernetes-native platform for managing inference model endpoints, built with Go, controller-runtime, and Gateway API.
---
...
---
> Source: [opendatahub-io/models-as-a-service](https://github.com/opendatahub-io/models-as-a-service) — distributed by [TomeVault](https://tomevault.io).
