---
trigger: always_on
description: Cast is a self-hosted harness for multi-user Claude Code agents that run as isolated container processes. See [README.md](README.md) for the project overview, philosophy, and setup.
---
...
---
> Source: [yaodub/cast](https://github.com/yaodub/cast) — distributed by [TomeVault](https://tomevault.io).
