---
trigger: always_on
description: For any Markdown files generated by AI, always disclose that they were created with the assistance of AI. Add the following frontmatter key/value pair:
---
...
---
> Source: [NuGet/docs.microsoft.com-nuget](https://github.com/NuGet/docs.microsoft.com-nuget) — distributed by [TomeVault](https://tomevault.io).
