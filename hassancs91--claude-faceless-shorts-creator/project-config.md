---
trigger: always_on
description: A **faceless-shorts factory** driven by Claude Code. Three production tracks, one repo — the
---
...
---
> Source: [hassancs91/claude-faceless-shorts-creator](https://github.com/hassancs91/claude-faceless-shorts-creator) — distributed by [TomeVault](https://tomevault.io).
