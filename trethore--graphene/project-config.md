---
trigger: always_on
description: Graphene is a modern, client-side, Chromium-based UI library for Minecraft 1.21.11 that runs on the Fabric mod loader.
---
...
---
> Source: [trethore/graphene](https://github.com/trethore/graphene) — distributed by [TomeVault](https://tomevault.io).
