---
trigger: always_on
description: 如果你想把 MMYOLO 修改为自己的项目，请遵循下面的约定。
---
...
---
> Source: [VinAIResearch/Open3DIS](https://github.com/VinAIResearch/Open3DIS) — distributed by [TomeVault](https://tomevault.io).
