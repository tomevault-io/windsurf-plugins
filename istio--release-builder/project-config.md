---
trigger: always_on
description: This repository defines the release process for Istio. AI agents working on this project should understand the build/publish workflow and release management processes.
---
...
---
> Source: [istio/release-builder](https://github.com/istio/release-builder) — distributed by [TomeVault](https://tomevault.io).
