---
trigger: always_on
description: Never break these three main instructions:
---
...
---
> Source: [tuomashatakka/aueio-player-desktop](https://github.com/tuomashatakka/aueio-player-desktop) — distributed by [TomeVault](https://tomevault.io).
