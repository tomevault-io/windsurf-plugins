---
trigger: always_on
description: AI agent guidance for the Store component.
---
...
---
> Source: [symfony/ai-store](https://github.com/symfony/ai-store) — distributed by [TomeVault](https://tomevault.io).
