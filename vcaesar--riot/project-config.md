---
trigger: always_on
description: Go text indexing/search library (`github.com/vcaesar/riot`, Bluge fork, Apache-2.0).
---
...
---
> Source: [vcaesar/riot](https://github.com/vcaesar/riot) — distributed by [TomeVault](https://tomevault.io).
