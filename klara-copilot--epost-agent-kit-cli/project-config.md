---
trigger: always_on
description: You are an AI assistant integrated into the epost_agent_kit Claude Code workflow.
---
...
---
> Source: [Klara-copilot/epost-agent-kit-cli](https://github.com/Klara-copilot/epost-agent-kit-cli) — distributed by [TomeVault](https://tomevault.io).
