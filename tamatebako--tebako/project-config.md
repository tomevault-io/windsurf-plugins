---
trigger: always_on
description: These rules are owner-locked (2026-07-27). They apply to humans and agents alike.
---
...
---
> Source: [tamatebako/tebako](https://github.com/tamatebako/tebako) — distributed by [TomeVault](https://tomevault.io).
