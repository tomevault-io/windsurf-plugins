---
trigger: always_on
description: Lost Cities is a Minecraft Forge 1.20.1 mod built with Java 17 and Gradle. Most behavior is split between Java world-generation code and data-driven JSON assets that describe buildings, city styles, palettes, parts, and related content.
---
...
---
> Source: [McJtyMods/LostCities](https://github.com/McJtyMods/LostCities) — distributed by [TomeVault](https://tomevault.io).
