---
trigger: always_on
description: Java indent is 2 spaces (not the typical 4).
---
...
---
> Source: [aparajita/capacitor-biometric-auth](https://github.com/aparajita/capacitor-biometric-auth) — distributed by [TomeVault](https://tomevault.io).
