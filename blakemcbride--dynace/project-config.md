---
trigger: always_on
description: Portable, open-source object-oriented extension to C. Adds classes, instances, methods, generic functions, multiple inheritance, and garbage collection to standard C via a metaclass-based system (similar to CLOS/Smalltalk). Written entirely in C — no new syntax beyond what the `dpp` preprocessor handles.
---
...
---
> Source: [blakemcbride/Dynace](https://github.com/blakemcbride/Dynace) — distributed by [TomeVault](https://tomevault.io).
