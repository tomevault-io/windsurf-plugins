---
trigger: always_on
description: The root `pom.xml` aggregates the main modules: `common/` shared utilities,
---
...
---
> Source: [helidon-io/helidon-build-tools](https://github.com/helidon-io/helidon-build-tools) — distributed by [TomeVault](https://tomevault.io).
