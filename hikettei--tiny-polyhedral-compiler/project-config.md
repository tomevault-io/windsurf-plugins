---
trigger: always_on
description: - Target abstraction: provide a high-level ISL wrapper exposed as `import caten.isl as I` per README examples; prioritize architecture over ad-hoc code, mirroring the Common Lisp reference in `caten_isl_ref/*.lisp` when designing Python layers.
---
