---
trigger: always_on
description: Before creating a new branch, always sync and clean up:
---
...
---
> Source: [dblock/slack-gamebot](https://github.com/dblock/slack-gamebot) — distributed by [TomeVault](https://tomevault.io).
