---
trigger: always_on
description: The Python package remains `self_improve` and the CLI remains `selfimprove`.
---
...
---
> Source: [tonygwu/recursive-self-improve](https://github.com/tonygwu/recursive-self-improve) — distributed by [TomeVault](https://tomevault.io).
