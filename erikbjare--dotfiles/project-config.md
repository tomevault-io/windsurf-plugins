---
trigger: always_on
description: - **PR merge strategy**: Always use `--squash` by default. Only use `--rebase` for exceptionally clean/separated commits. Never use `--merge`.
---
...
---
> Source: [ErikBjare/dotfiles](https://github.com/ErikBjare/dotfiles) — distributed by [TomeVault](https://tomevault.io).
