---
trigger: always_on
description: KptnCook is a Python command-line client for downloading recipes from the KptnCook cooking app. It can fetch daily recipes, backup favorites, and sync with Mealie (a self-hosted recipe manager) or export to Paprika.
---
...
---
> Source: [ephes/kptncook](https://github.com/ephes/kptncook) — distributed by [TomeVault](https://tomevault.io).
