...
Original source: `.cursor/rules/*.mdc` in [vparla/mcp-cpp](https://github.com/vparla/mcp-cpp).
...
From [vparla/mcp-cpp](https://github.com/vparla/mcp-cpp) — a repo with 9+ stars on GitHub.
