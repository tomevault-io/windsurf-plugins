---
trigger: always_on
description: This file is a concise entry point for coding agents. It does not replace the repository's contributor policies. Before substantive work, read and follow:
---
...
---
> Source: [QMCSoftware/QMCSoftware](https://github.com/QMCSoftware/QMCSoftware) — distributed by [TomeVault](https://tomevault.io).
