---
trigger: always_on
description: This repository contains a TYPO3 extension for multi-channel contexts that show/hide content based on configurable rules (screen size, location, browser, GET parameters, etc.).
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/netresearch)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/netresearch)
