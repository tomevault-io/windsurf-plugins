---
trigger: always_on
description: Rimu is a friendly template language for structured data and functional expressions.
---
...
---
> Source: [ahdinosaur/rimu](https://github.com/ahdinosaur/rimu) — distributed by [TomeVault](https://tomevault.io).
