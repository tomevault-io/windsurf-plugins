---
trigger: always_on
description: There are two main workflows with Byterover tools and recommended tool call strategies that you **MUST** follow precisely.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/PedroHSGuimaraes)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/PedroHSGuimaraes)
