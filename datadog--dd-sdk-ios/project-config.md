---
trigger: always_on
description: > This file is a **map**, not an encyclopedia. It provides the entry point and pointers to deeper documentation. Start here, then follow the links relevant to your task.
---
...
---
> Source: [DataDog/dd-sdk-ios](https://github.com/DataDog/dd-sdk-ios) — distributed by [TomeVault](https://tomevault.io).
