---
trigger: always_on
description: This package is the Headline Ghost theme. In the standalone mirror repository, this tree is pushed from `TryGhost/Themes/packages/headline` by subtree sync; make durable theme-content changes in `TryGhost/Themes` unless the task is explicitly repo-level metadata or GitHub settings.
---
...
---
> Source: [TryGhost/Headline](https://github.com/TryGhost/Headline) — distributed by [TomeVault](https://tomevault.io).
