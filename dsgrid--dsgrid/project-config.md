---
trigger: always_on
description: This document defines the coding conventions for the Python client codebase. These rules should be followed for all new code and when modifying existing code.
---
...
---
> Source: [dsgrid/dsgrid](https://github.com/dsgrid/dsgrid) — distributed by [TomeVault](https://tomevault.io).
