---
trigger: always_on
description: These instructions are for GitHub Copilot, Claude Code, and similar coding assistants.
---
...
---
> Source: [desihub/desispec](https://github.com/desihub/desispec) — distributed by [TomeVault](https://tomevault.io).
