---
trigger: always_on
description: `repo-to-text` is a command-line tool that converts a directory's structure and contents into a single text file.
---
...
---
> Source: [kirill-markin/repo-to-text](https://github.com/kirill-markin/repo-to-text) — distributed by [TomeVault](https://tomevault.io).
