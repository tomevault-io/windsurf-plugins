---
trigger: always_on
description: > The canonical agent instructions live in [AGENTS.md](./AGENTS.md). This file provides the essential summary for GitHub Copilot; read `AGENTS.md` for the complete project map, working rules, and validation steps.
---
...
---
> Source: [crazywhalecc/static-php-cli](https://github.com/crazywhalecc/static-php-cli) — distributed by [TomeVault](https://tomevault.io).
