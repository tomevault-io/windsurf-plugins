---
trigger: always_on
description: Putting together an agent in LlamaIndex can be done by defining a set of tools and providing them to our ReActAgent or FunctionAgent implementation. We're using it here with OpenAI, but it can be used with any sufficiently capable LLM.
---
...
---
> Source: [run-llama/llama_index](https://github.com/run-llama/llama_index) — distributed by [TomeVault](https://tomevault.io).
