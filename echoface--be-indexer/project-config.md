---
trigger: always_on
description: go test -run TestBEIndex_Retrieve ./...
---
...
---
> Source: [echoface/be_indexer](https://github.com/echoface/be_indexer) — distributed by [TomeVault](https://tomevault.io).
