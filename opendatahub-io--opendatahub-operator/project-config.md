---
trigger: always_on
description: Kubernetes operator deploying AI/ML platform on OpenShift. Manages 16 components via DataScienceCluster (DSC) and DSCInitialization (DSCI) CRs with dedicated per-component controllers.
---
...
---
> Source: [opendatahub-io/opendatahub-operator](https://github.com/opendatahub-io/opendatahub-operator) — distributed by [TomeVault](https://tomevault.io).
