---
trigger: always_on
description: NestJS 11 project. Express adapter.
---
...
---
> Source: [jsmastery-pro/Hackathon-backend](https://github.com/jsmastery-pro/Hackathon-backend) — distributed by [TomeVault](https://tomevault.io).
