---
trigger: always_on
description: - All commit messages and PR titles MUST follow Conventional Commits.
---
...
---
> Source: [opista/svn-blamer](https://github.com/opista/svn-blamer) — distributed by [TomeVault](https://tomevault.io).
