---
trigger: always_on
description: This is a **Claude Code plugin marketplace** hosted at `github.com/Ovid/paad`. It distributes the `paad` plugin, which provides skills for architecture analysis, code quality, and development workflows.
---
...
---
> Source: [Ovid/paad](https://github.com/Ovid/paad) — distributed by [TomeVault](https://tomevault.io).
