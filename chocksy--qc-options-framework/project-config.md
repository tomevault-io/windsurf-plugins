---
trigger: always_on
description: RIPER-5 MODE: STRICT OPERATIONAL PROTOCOL
---
...
---
> Source: [Chocksy/qc-options-framework](https://github.com/Chocksy/qc-options-framework) — distributed by [TomeVault](https://tomevault.io).
