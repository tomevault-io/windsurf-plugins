---
trigger: always_on
description: Use Zero-API-Key Web Search when Gemini needs live search results, source-backed verification, or page-level reading.
---
...
---
> Source: [wd041216-bit/zero-api-key-web-search](https://github.com/wd041216-bit/zero-api-key-web-search) — distributed by [TomeVault](https://tomevault.io).
