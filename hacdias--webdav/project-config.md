---
trigger: always_on
description: Guidance for Claude when working in this repository (`hacdias/webdav`).
---
...
---
> Source: [hacdias/webdav](https://github.com/hacdias/webdav) — distributed by [TomeVault](https://tomevault.io).
