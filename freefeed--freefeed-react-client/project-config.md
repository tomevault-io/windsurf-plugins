---
trigger: always_on
description: This is the React-based frontend client for [FreeFeed](https://freefeed.net) — an open-source social network. The app is a single-page application built with React 19, Redux, and Vite.
---
...
---
> Source: [FreeFeed/freefeed-react-client](https://github.com/FreeFeed/freefeed-react-client) — distributed by [TomeVault](https://tomevault.io).
