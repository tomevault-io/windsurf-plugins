---
trigger: always_on
description: - All code must be written in TypeScript, with a focus on DOM, CSS, and testing using Vitest and testing-library.
---
...
---
> Source: [goblindegook/littlefoot](https://github.com/goblindegook/littlefoot) — distributed by [TomeVault](https://tomevault.io).
