---
trigger: always_on
description: > Self-hosted admin UI for Actual Budget. Backend: `actual-http-api`.
---
...
---
> Source: [x-rous/actual-bench](https://github.com/x-rous/actual-bench) — distributed by [TomeVault](https://tomevault.io).
