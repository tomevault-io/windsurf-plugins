---
trigger: always_on
description: This package is the Wave Ghost theme. In the standalone mirror repository, this tree is pushed from `TryGhost/Themes/packages/wave` by subtree sync; make durable theme-content changes in `TryGhost/Themes` unless the task is explicitly repo-level metadata or GitHub settings.
---
...
---
> Source: [TryGhost/Wave](https://github.com/TryGhost/Wave) — distributed by [TomeVault](https://tomevault.io).
