---
trigger: always_on
description: Kotoba is a language-learning Anki deck generator. Any agent host that loads
---
...
---
> Source: [yufengliu15/kotoba](https://github.com/yufengliu15/kotoba) — distributed by [TomeVault](https://tomevault.io).
