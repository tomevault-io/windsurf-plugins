---
trigger: always_on
description: This file provides guidance to Claude Code when maintaining this repository.
---
...
---
> Source: [Xnhyacinth/Awesome-LLM-Long-Context-Modeling](https://github.com/Xnhyacinth/Awesome-LLM-Long-Context-Modeling) — distributed by [TomeVault](https://tomevault.io).
