---
trigger: always_on
description: This is a **Nuxt 4** API service that aggregates JW.org data from multiple sources (Mediator API, WOL, Pub Media, Bible Data). It provides both RESTful endpoints (`/api/v1/*`) and an **MCP (Model Context Protocol) server** (`/mcp`) for AI agent integration.
---
