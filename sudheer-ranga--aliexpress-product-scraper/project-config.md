---
trigger: always_on
description: - Always create a new branch per task; never commit directly to `master`.
---
...
---
> Source: [sudheer-ranga/aliexpress-product-scraper](https://github.com/sudheer-ranga/aliexpress-product-scraper) — distributed by [TomeVault](https://tomevault.io).
