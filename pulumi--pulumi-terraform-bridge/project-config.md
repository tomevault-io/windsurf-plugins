---
trigger: always_on
description: This repo is the Pulumi Terraform Bridge. Keep changes small, focused, and consistent with the architecture below.
---
...
---
> Source: [pulumi/pulumi-terraform-bridge](https://github.com/pulumi/pulumi-terraform-bridge) — distributed by [TomeVault](https://tomevault.io).
