---
trigger: always_on
description: Bundlers follow every statically-resolvable import — including lazy `import('./relative/path')` — and fail browser builds on `node:` builtins in the resulting chunks.
---
...
---
> Source: [anthropics/anthropic-sdk-typescript](https://github.com/anthropics/anthropic-sdk-typescript) — distributed by [TomeVault](https://tomevault.io).
