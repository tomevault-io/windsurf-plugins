---
trigger: always_on
description: MiniScaffold is a .NET 8.0 F# template project that generates scaffolding for F# libraries and console applications. It uses FAKE (F# Make) for build automation and includes comprehensive tooling for testing, documentation, and release management.
---
...
---
> Source: [TheAngryByrd/MiniScaffold](https://github.com/TheAngryByrd/MiniScaffold) — distributed by [TomeVault](https://tomevault.io).
