---
trigger: always_on
description: Edge Delivery Services. Read a block first. Omissions are in the repo or known.
---
...
- A PR without a `{branch}--kp-ue-demo--buzzer89.aem.page/{path}` link is rejected.
...
---
> Source: [buzzer89/kp-ue-demo](https://github.com/buzzer89/kp-ue-demo) — distributed by [TomeVault](https://tomevault.io).
