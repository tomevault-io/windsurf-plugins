---
trigger: always_on
description: You MUST maintain a file called `summary.md` in the workspace root. Update it **after every training attempt and every submission**, not just at the end.
---
...
---
> Source: [microsoft/RD-Agent](https://github.com/microsoft/RD-Agent) — distributed by [TomeVault](https://tomevault.io).
