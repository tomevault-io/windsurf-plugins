...
mcp-server/     # MCP server (28 tools) — shares the app's vault layout
...
---
> Source: [cmblir/Myco](https://github.com/cmblir/Myco) — distributed by [TomeVault](https://tomevault.io).
