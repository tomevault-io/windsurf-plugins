---
trigger: always_on
description: - `apps/backend/app` contains the FastAPI stack: `agent/` for wrappers, `services/` for orchestration (see `score_improvement_service.py`), `prompt/` for LLM prompts, and `schemas/` for JSON/Pydantic contracts.
---
...
---
> Source: [negimox/skillsense](https://github.com/negimox/skillsense) — distributed by [TomeVault](https://tomevault.io).
