---
trigger: always_on
description: Standalone caching utilities extracted from [nitro](https://github.com/nitrojs/nitro). Zero framework dependencies — works with any runtime that has standard `Request`/`Response`.
---
...
---
> Source: [unjs/ocache](https://github.com/unjs/ocache) — distributed by [TomeVault](https://tomevault.io).
