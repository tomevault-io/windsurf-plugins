---
trigger: always_on
description: This is the Adyen Ruby API Library, providing Ruby developers with an easy way to interact with the Adyen API. The library is a wrapper around the Adyen API, with services generated from OpenAPI specifications.
---
...
---
> Source: [Adyen/adyen-ruby-api-library](https://github.com/Adyen/adyen-ruby-api-library) — distributed by [TomeVault](https://tomevault.io).
