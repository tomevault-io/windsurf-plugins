---
trigger: always_on
description: Satori is a local-first macOS learning workspace. Its primary job is to help a learner understand PDF-based material. It is not a note-taking product first.
---
...
---
> Source: [yuxino/satori](https://github.com/yuxino/satori) — distributed by [TomeVault](https://tomevault.io).
