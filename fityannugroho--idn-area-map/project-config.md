---
trigger: always_on
description: Single-page Next.js (App Router) application for visualizing Indonesian administrative areas and islands. Primary features: interactive map dashboard, area boundaries, and island markers visualization page.
---
