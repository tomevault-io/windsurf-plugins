...
---
> Source: [Azure/terraform-azurerm-avm-res-containerservice-managedcluster](https://github.com/Azure/terraform-azurerm-avm-res-containerservice-managedcluster) — distributed by [TomeVault](https://tomevault.io).
