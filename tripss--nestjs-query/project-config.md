---
trigger: always_on
description: `nestjs-query` is a TypeScript monorepo for NestJS query libraries. It uses Yarn 4 workspaces and Nx. Reusable libraries live in `packages/`; runnable and end-to-end examples live in `examples/`; the Mintlify documentation site lives in `docs/`.
---
...
---
> Source: [TriPSs/nestjs-query](https://github.com/TriPSs/nestjs-query) — distributed by [TomeVault](https://tomevault.io).
