---
trigger: always_on
description: PipeCD is a GitOps-style continuous delivery platform. It has two main runtime components: **Control Plane** (`cmd/pipecd`) and **Piped agent** (`cmd/piped`/`cmd/pipedv1`), plus a CLI (`cmd/pipectl`) and a React web frontend (`web/`).
---
...
---
> Source: [pipe-cd/pipecd](https://github.com/pipe-cd/pipecd) — distributed by [TomeVault](https://tomevault.io).
