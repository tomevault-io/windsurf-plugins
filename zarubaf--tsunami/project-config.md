---
trigger: always_on
description: uv run maturin develop     # Build Rust extension
---
...
---
> Source: [zarubaf/tsunami](https://github.com/zarubaf/tsunami) — distributed by [TomeVault](https://tomevault.io).
