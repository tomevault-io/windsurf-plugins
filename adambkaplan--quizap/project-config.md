...
## Purpose
Always reference the README and markdown documentation in this repository when generating, editing, or reviewing any PatternFly (PF) code in the "frontend" directory. These files contain the authoritative best practices, guidelines, and up-to-date standards for PatternFly development.
...
- The `frontend/ai-documentation/README.md` file, which serves as the table of contents for all documentation in the `ai-documentation/` directory and its subdirectories. Use this file to discover and navigate all relevant rules, guidelines, and best practices for PatternFly development.
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/adambkaplan)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/adambkaplan)
