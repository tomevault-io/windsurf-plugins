---
trigger: always_on
description: **MANDATORY: use vexp MCP tools for ALL file analysis.**
---

## vexp context tools <!-- vexp v1.2.9 -->
...
---
> Source: [Feramance/Torrentarr](https://github.com/Feramance/Torrentarr) — distributed by [TomeVault](https://tomevault.io).
