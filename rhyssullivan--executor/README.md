...
Original source: `CLAUDE.md` in [RhysSullivan/executor](https://github.com/RhysSullivan/executor).
...
From [RhysSullivan/executor](https://github.com/RhysSullivan/executor) — a repo with 1154+ stars on GitHub.
