---
trigger: always_on
description: This is the Dhara monorepo. It contains the protocol specification (`spec/`) and the reference TypeScript implementation (`src/`).
---
...
---
> Source: [zosmaai/dhara](https://github.com/zosmaai/dhara) — distributed by [TomeVault](https://tomevault.io).
