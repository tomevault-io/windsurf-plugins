---
trigger: always_on
description: When creating or modifying scripts in the `gh-cli` and `scripts` directories:
---
...
---
> Source: [joshjohanning/github-misc-scripts](https://github.com/joshjohanning/github-misc-scripts) — distributed by [TomeVault](https://tomevault.io).
