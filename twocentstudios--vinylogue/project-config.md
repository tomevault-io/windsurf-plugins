---
trigger: always_on
description: - `OnboardingStore/View.swift` - First-time user setup with username validation
---
...
---
> Source: [twocentstudios/vinylogue](https://github.com/twocentstudios/vinylogue) — distributed by [TomeVault](https://tomevault.io).
