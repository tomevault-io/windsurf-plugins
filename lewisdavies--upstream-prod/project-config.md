---
trigger: always_on
description: A dbt package that overrides `ref()` to resolve references against production data in development environments.
---
...
---
> Source: [LewisDavies/upstream-prod](https://github.com/LewisDavies/upstream-prod) — distributed by [TomeVault](https://tomevault.io).
