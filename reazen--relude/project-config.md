---
trigger: always_on
description: This page will attempt to outline common usage patterns for using Relude.  You will likely find your own patterns, but these are some ideas that have worked well for us so far.
---
...
---
> Source: [reazen/relude](https://github.com/reazen/relude) — distributed by [TomeVault](https://tomevault.io).
