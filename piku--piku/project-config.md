---
trigger: always_on
description: The tiniest PaaS you've ever seen. `git push` deployments to your own servers.
---
...
---
> Source: [piku/piku](https://github.com/piku/piku) — distributed by [TomeVault](https://tomevault.io).
