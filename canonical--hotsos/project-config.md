---
trigger: always_on
description: **Hotsos** is a software analysis toolkit developed by Canonical. It performs repeatable, automated analysis of common cloud applications and subsystems (e.g., OpenStack, Kubernetes, Juju, Ceph, OVS/OVN, kernel). Analysis can run against a **live host** or a **sosreport**.
---
...
---
> Source: [canonical/hotsos](https://github.com/canonical/hotsos) — distributed by [TomeVault](https://tomevault.io).
