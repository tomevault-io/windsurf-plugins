---
trigger: always_on
description: 本倉庫提供完整的學術研究 Skill 套件，涵蓋從論文閱讀到撰寫、審稿的完整研究流程。
---
...
---
> Source: [voidful/academic-skills](https://github.com/voidful/academic-skills) — distributed by [TomeVault](https://tomevault.io).
