---
trigger: always_on
description: Documentation for AI agents (and anyone else) reading this repo.
---
...
---
> Source: [walkindude/cli-bridge](https://github.com/walkindude/cli-bridge) — distributed by [TomeVault](https://tomevault.io).
