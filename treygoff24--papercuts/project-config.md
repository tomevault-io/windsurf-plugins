---
trigger: always_on
description: Machine-facing contract for agents working in this repo.
---
...
---
> Source: [treygoff24/papercuts](https://github.com/treygoff24/papercuts) — distributed by [TomeVault](https://tomevault.io).
