---
trigger: always_on
description: zvec-go is a Go SDK for the [zvec](https://github.com/alibaba/zvec) vector database. It wraps the zvec C-API via cgo to provide idiomatic Go access to all zvec functionality.
---
...
---
> Source: [zvec-ai/zvec-go](https://github.com/zvec-ai/zvec-go) — distributed by [TomeVault](https://tomevault.io).
