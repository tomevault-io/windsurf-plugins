---
trigger: always_on
description: UniEmployee 数字员工平台（deepagents 0.7.5 / LangGraph 1.2.9 / FastAPI / Vue 3）。中文交流。
---
...
---
> Source: [zj-unicom-ai/UniEmployee](https://github.com/zj-unicom-ai/UniEmployee) — distributed by [TomeVault](https://tomevault.io).
