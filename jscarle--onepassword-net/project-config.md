---
trigger: always_on
description: This repository contains `OnePassword.NET`, a .NET wrapper for the 1Password CLI.
---
...
---
> Source: [jscarle/OnePassword.NET](https://github.com/jscarle/OnePassword.NET) — distributed by [TomeVault](https://tomevault.io).
