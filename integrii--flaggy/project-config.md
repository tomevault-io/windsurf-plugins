---
trigger: always_on
description: This repository provides a zero-dependency command-line parsing library that must always rely exclusively on the Go standard library for runtime and test code. The core principles that follow preserve the project's lightweight nature and its focus on easily understandable, flat code.
---
...
---
> Source: [integrii/flaggy](https://github.com/integrii/flaggy) — distributed by [TomeVault](https://tomevault.io).
