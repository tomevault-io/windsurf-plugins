---
trigger: always_on
description: - 현재 프로젝트는 Android 네이티브 앱 개발 중심으로, Jetpack Compose와 MVI(Model-View-Intent) 패턴을 핵심 아키텍처로 채택하고 있다.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/woosang1) — claim your Tome and manage your conversions.
