---
trigger: always_on
description: `vals` is a Go-based CLI tool for managing configuration values and secrets from various sources including AWS, GCP, Azure, Vault, Kubernetes, and many others.
---
...
---
> Source: [helmfile/vals](https://github.com/helmfile/vals) — distributed by [TomeVault](https://tomevault.io).
