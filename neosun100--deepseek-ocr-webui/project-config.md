---
trigger: always_on
description: This file contains the shared rules and context for all AI Agents working on this project.
---

# Project: Browser-only Image/PDF OCR & Converter - General Agent Rules
...
---
> Source: [neosun100/DeepSeek-OCR-WebUI](https://github.com/neosun100/DeepSeek-OCR-WebUI) — distributed by [TomeVault](https://tomevault.io).
