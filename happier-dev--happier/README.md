...
Original source: `.cursor/rules/*.mdc` in [happier-dev/happier](https://github.com/happier-dev/happier).
...
```
npx tomevault install happier-dev/happier
```
Source: [github.com/happier-dev/happier](https://github.com/happier-dev/happier).
