---
trigger: always_on
description: This file helps AI coding agents (Claude Code, Copilot, Cursor, Cody,
---
...
---
> Source: [deftio/fr_math](https://github.com/deftio/fr_math) — distributed by [TomeVault](https://tomevault.io).
