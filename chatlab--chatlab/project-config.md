---
trigger: always_on
description: - 文档：开始开发前，请先查看 `./.docs/README.md`，并阅读与当前需求相关的文档
---
...
---
> Source: [ChatLab/ChatLab](https://github.com/ChatLab/ChatLab) — distributed by [TomeVault](https://tomevault.io).
