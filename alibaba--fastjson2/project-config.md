---
trigger: always_on
description: High-performance Java JSON library (fastjson v2). Multi-module Maven project, JDK 8+.
---
...
---
> Source: [alibaba/fastjson2](https://github.com/alibaba/fastjson2) — distributed by [TomeVault](https://tomevault.io).
