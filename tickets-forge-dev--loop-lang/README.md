...
> Source: [tickets-forge-dev/loop-lang](https://github.com/tickets-forge-dev/loop-lang). Graded, signed and kept current as the models change by [TomeVault](https://tomevault.io)
...
From [tickets-forge-dev/loop-lang](https://github.com/tickets-forge-dev/loop-lang) — a repo with 11+ stars on GitHub.
