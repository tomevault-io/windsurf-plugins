---
trigger: always_on
description: This repo owns the `vclaw` CLI. Read `README.md`, `bin/vclaw.mjs`, and the command implementation under `src/commands/` before changing setup behavior.
---
...
---
> Source: [vercel-labs/vclaw-archived](https://github.com/vercel-labs/vclaw-archived) — distributed by [TomeVault](https://tomevault.io).
