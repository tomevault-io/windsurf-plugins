---
trigger: always_on
description: This file is the primary playbook for agentic coding tools working in this repository.
---
...
---
> Source: [ktorio/ktor](https://github.com/ktorio/ktor) — distributed by [TomeVault](https://tomevault.io).
