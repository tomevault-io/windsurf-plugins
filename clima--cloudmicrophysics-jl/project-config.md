---
trigger: always_on
description: Read this file first. It is the agent entry point for the shared engineering guidelines. Each guide applies across the CliMA ecosystem unless stated otherwise.
---
...
---
> Source: [CliMA/CloudMicrophysics.jl](https://github.com/CliMA/CloudMicrophysics.jl) — distributed by [TomeVault](https://tomevault.io).
