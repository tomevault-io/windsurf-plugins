---
trigger: always_on
description: This repository contains a Home Assistant integration for the Zaptec Electric Vehicle Chargers (EVC).
---
...
---
> Source: [custom-components/zaptec](https://github.com/custom-components/zaptec) — distributed by [TomeVault](https://tomevault.io).
