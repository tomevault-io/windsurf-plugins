---
trigger: always_on
description: Lifelog is a privacy-first CLI productivity tracker for neurodivergent users with multi-device sync capabilities. Built with Python/Typer for CLI, Rich for UI, SQLite for storage, and Flask for API sync.
---
...
---
> Source: [zach-mckinnon/lifelog](https://github.com/zach-mckinnon/lifelog) — distributed by [TomeVault](https://tomevault.io).
