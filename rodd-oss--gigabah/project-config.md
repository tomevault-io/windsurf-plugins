---
trigger: always_on
description: - Use strict typing in GDScript for better error detection and IDE support
---

# Godot 4.5 Game Development .cursorrules
...
---
> Source: [rodd-oss/gigabah](https://github.com/rodd-oss/gigabah) — distributed by [TomeVault](https://tomevault.io).
