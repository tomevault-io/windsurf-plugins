---
trigger: always_on
description: > Claude Code 에이전트 기반 유니티 프로젝트 템플릿. 포크해서 본인 게임 이름으로 바꿔 쓰세요.
---
...
---
> Source: [zaffre001/unity-claude-template](https://github.com/zaffre001/unity-claude-template) — distributed by [TomeVault](https://tomevault.io).
