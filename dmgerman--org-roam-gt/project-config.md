---
trigger: always_on
description: `org-roam-gt` is a minor mode that extends org-roam via Emacs advice.
---
...
---
> Source: [dmgerman/org-roam-gt](https://github.com/dmgerman/org-roam-gt) — distributed by [TomeVault](https://tomevault.io).
