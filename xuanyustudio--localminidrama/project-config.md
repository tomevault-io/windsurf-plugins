---
trigger: always_on
description: LocalMiniDrama (本地短剧助手) — an AI-powered local short drama creation tool. Single product, three sub-projects sharing one repo (no monorepo tooling).
---
...
---
> Source: [xuanyustudio/LocalMiniDrama](https://github.com/xuanyustudio/LocalMiniDrama) — distributed by [TomeVault](https://tomevault.io).
