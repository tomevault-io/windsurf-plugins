---
trigger: always_on
description: Command: `/version-update` or simply ask Claude to "update versions"
---
...
---
> Source: [IITC-CE/ingress-intel-total-conversion](https://github.com/IITC-CE/ingress-intel-total-conversion) — distributed by [TomeVault](https://tomevault.io).
