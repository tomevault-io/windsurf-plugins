---
trigger: always_on
description: `coding-agent-runner` is a Node.js package for running local coding-agent CLIs from application code.
---
...
---
> Source: [yinguangyao/coding-agent-runner](https://github.com/yinguangyao/coding-agent-runner) — distributed by [TomeVault](https://tomevault.io).
