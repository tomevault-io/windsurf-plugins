---
trigger: always_on
description: - Main documentation is in `/packages/app-web-docs/src/docs/user/README.md`
---
...
---
> Source: [cursorless-dev/cursorless](https://github.com/cursorless-dev/cursorless) — distributed by [TomeVault](https://tomevault.io).
