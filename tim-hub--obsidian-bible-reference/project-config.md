---
trigger: always_on
description: Plugin to help users access and reference Bible verses in Obsidian. All decisions should serve this purpose.
---
...
---
> Source: [tim-hub/obsidian-bible-reference](https://github.com/tim-hub/obsidian-bible-reference) — distributed by [TomeVault](https://tomevault.io).
