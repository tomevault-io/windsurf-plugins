---
trigger: always_on
description: - The project uses the latest version of the `three` npm package.
---
...
---
> Source: [NewKrok/three-particles](https://github.com/NewKrok/three-particles) — distributed by [TomeVault](https://tomevault.io).
