---
trigger: always_on
description: Python library for caching and distributed locking. Backend-agnostic with out-of-the box support for in-memory, Redis, and DragonflyDB.
---
...
---
> Source: [EzyGang/py-cachify](https://github.com/EzyGang/py-cachify) — distributed by [TomeVault](https://tomevault.io).
