---
trigger: always_on
description: This repository uses a CLI tool (`cli-update-asset.js`) to manage contract metadata and icons following the CAIP-19 standard.
---
...
---
> Source: [MetaMask/contract-metadata](https://github.com/MetaMask/contract-metadata) — distributed by [TomeVault](https://tomevault.io).
