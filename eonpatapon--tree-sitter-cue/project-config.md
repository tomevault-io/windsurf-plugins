---
trigger: always_on
description: Tree-sitter grammar for the [CUE language](https://cuelang.org/).
---
...
---
> Source: [eonpatapon/tree-sitter-cue](https://github.com/eonpatapon/tree-sitter-cue) — distributed by [TomeVault](https://tomevault.io).
