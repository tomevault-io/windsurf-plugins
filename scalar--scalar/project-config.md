---
trigger: always_on
description: `@scalar/api-reference` renders beautiful API documentation from OpenAPI descriptions. It is the primary visual surface for themes, sidebar navigation, search, code highlighting, and the embedded API client modal.
---
