---
trigger: always_on
description: This repository contains the official Go SDK for the Model Context Protocol (MCP).
---
...
---
> Source: [modelcontextprotocol/go-sdk](https://github.com/modelcontextprotocol/go-sdk) — distributed by [TomeVault](https://tomevault.io).
