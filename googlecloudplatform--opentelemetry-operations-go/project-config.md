---
trigger: always_on
description: This repository is a multi-module Go project containing OpenTelemetry exporters for Google Cloud. To work effectively here, please follow these guidelines.
---
...
---
> Source: [GoogleCloudPlatform/opentelemetry-operations-go](https://github.com/GoogleCloudPlatform/opentelemetry-operations-go) — distributed by [TomeVault](https://tomevault.io).
