---
trigger: always_on
description: Jedis is a synchronous Java client for Redis, shipped as a library on Maven Central as `redis.clients:jedis`.
---
...
---
> Source: [redis/jedis](https://github.com/redis/jedis) — distributed by [TomeVault](https://tomevault.io).
