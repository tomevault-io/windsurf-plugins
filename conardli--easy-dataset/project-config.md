---
trigger: always_on
description: Easy Dataset 是一个专为大型语言模型（LLM）微调数据集创建而设计的应用程序。它提供完整的workflow，从文档处理到数据集导出，支持多种文件格式和AI模型。
---
...
---
> Source: [ConardLi/easy-dataset](https://github.com/ConardLi/easy-dataset) — distributed by [TomeVault](https://tomevault.io).
