---
trigger: always_on
description: This repository contains Groovy device drivers, libraries, and helper scripts for the Hubitat Elevation platform that support Shelly devices. Primary language: Groovy. Primary purpose: device drivers and components for Hubitat users. Developer docs: https://docs2.hubitat.com/en/developer
---
