---
trigger: always_on
description: This project uses **Opensquad**, a multi-agent orchestration framework.
---
...
---
> Source: [renatoasse/opensquad](https://github.com/renatoasse/opensquad) — distributed by [TomeVault](https://tomevault.io).
