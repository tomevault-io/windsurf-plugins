---
trigger: always_on
description: `docs/website/` 아래에서 작업할 때 따르는 규칙입니다.
---
...
---
> Source: [woowabros/critical-script](https://github.com/woowabros/critical-script) — distributed by [TomeVault](https://tomevault.io).
