---
trigger: always_on
description: - Run all tests: `just test` (auto-installs correct .NET version)
---
...
---
> Source: [stripe/stripe-dotnet](https://github.com/stripe/stripe-dotnet) — distributed by [TomeVault](https://tomevault.io).
