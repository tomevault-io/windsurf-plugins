---
trigger: always_on
description: Nano favors static, event-driven Java code with zero reflection and minimal dependencies. Treat this guide as the fastest path to productive contributions without violating the framework’s immutability and functional constraints.
---
...
---
> Source: [NanoNative/nano](https://github.com/NanoNative/nano) — distributed by [TomeVault](https://tomevault.io).
