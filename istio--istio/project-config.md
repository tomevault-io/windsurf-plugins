---
trigger: always_on
description: This file provides repository-specific instructions for GitHub Copilot, summarizing key conventions, practices, and context from the Istio project. These guidelines are distilled from all README.md files and important documentation in the .wiki directory.
---
...
---
> Source: [istio/istio](https://github.com/istio/istio) — distributed by [TomeVault](https://tomevault.io).
