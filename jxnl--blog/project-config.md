---
trigger: always_on
description: All blog posts in [docs/writing/posts/](mdc:docs/writing/posts/) must follow the standard front matter structure to ensure consistency and proper functionality with the MkDocs Material theme.
---
