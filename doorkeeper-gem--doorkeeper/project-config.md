---
trigger: always_on
description: Doorkeeper is a Ruby gem and Rails engine that implements an OAuth 2 provider for Rails and Grape applications.
---
...
---
> Source: [doorkeeper-gem/doorkeeper](https://github.com/doorkeeper-gem/doorkeeper) — distributed by [TomeVault](https://tomevault.io).
