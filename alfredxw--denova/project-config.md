---
trigger: always_on
description: 一个面向创作者的终极 AI 创作工具，支持完整创作流程，游戏交互
---
...
- 共通能力要同时检查写作和游戏模式；涉及布局、导航、会话、设置、版本管理时尤其如此。
...
---
> Source: [alfredxw/denova](https://github.com/alfredxw/denova) — distributed by [TomeVault](https://tomevault.io).
