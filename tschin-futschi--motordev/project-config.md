---
trigger: always_on
description: > 本文件主要供 Claude Code 读取，作为本项目的技术负责人工作准则；Codex / ChatGPT 可将其作为协作约束参考。所有开发决策以本文件为准。
---
...
---
> Source: [tschin-futschi/MotorDev](https://github.com/tschin-futschi/MotorDev) — distributed by [TomeVault](https://tomevault.io).
