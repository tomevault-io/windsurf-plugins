---
trigger: always_on
description: These conventions are enforced if contributing code for the core distribution.
---
...
---
> Source: [fanx-dev/fanx](https://github.com/fanx-dev/fanx) — distributed by [TomeVault](https://tomevault.io).
