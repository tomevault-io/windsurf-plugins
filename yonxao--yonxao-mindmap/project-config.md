---
trigger: always_on
description: 先读 `docs/DEVELOPMENT_CONTEXT.zh-CN.md` 的"0. 快速接手摘要"。
---
...
---
> Source: [yonxao/yonxao-mindmap](https://github.com/yonxao/yonxao-mindmap) — distributed by [TomeVault](https://tomevault.io).
