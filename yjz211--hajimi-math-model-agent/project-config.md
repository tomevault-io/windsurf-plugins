---
trigger: always_on
description: npm run dev          # Web dev server (port 30141)
---
...
---
> Source: [yjz211/HaJiMi-Math-Model-Agent](https://github.com/yjz211/HaJiMi-Math-Model-Agent) — distributed by [TomeVault](https://tomevault.io).
