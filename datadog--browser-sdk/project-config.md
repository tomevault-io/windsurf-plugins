---
trigger: always_on
description: Browser SDK for collecting Real User Monitoring (RUM) and logging data from web applications.
---
...
---
> Source: [DataDog/browser-sdk](https://github.com/DataDog/browser-sdk) — distributed by [TomeVault](https://tomevault.io).
