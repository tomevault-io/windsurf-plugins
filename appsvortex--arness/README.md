...
Original source: `CLAUDE.md` in [AppsVortex/arness](https://github.com/AppsVortex/arness).
...
From [AppsVortex/arness](https://github.com/AppsVortex/arness) — a repo with 20+ stars on GitHub.
