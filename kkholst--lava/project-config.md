---
trigger: always_on
description: Agent orientation for the `lava` R package (Structural Equation Models).
---
...
---
> Source: [kkholst/lava](https://github.com/kkholst/lava) — distributed by [TomeVault](https://tomevault.io).
