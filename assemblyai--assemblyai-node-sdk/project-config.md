---
trigger: always_on
description: Speech-to-text and audio intelligence SDK for Node.js, Deno, and Bun. Supports pre-recorded transcription, real-time streaming, and audio analysis features.
---
...
---
> Source: [AssemblyAI/assemblyai-node-sdk](https://github.com/AssemblyAI/assemblyai-node-sdk) — distributed by [TomeVault](https://tomevault.io).
