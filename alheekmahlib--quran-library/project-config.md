---
trigger: always_on
description: هذه التعليمات موجّهة إلى Copilot لكي يلتزم بها تلقائيًا داخل هذا المستودع. الهدف: مخرجات عربية موجزة، كود Flutter/Dart نظيف متوافق مع أدوات المشروع، مع مراعاة الأداء، الأمان، والاختبارات.
---
...
---
> Source: [alheekmahlib/quran_library](https://github.com/alheekmahlib/quran_library) — distributed by [TomeVault](https://tomevault.io).
