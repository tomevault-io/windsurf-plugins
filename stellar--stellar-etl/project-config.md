---
trigger: always_on
description: Stellar-ETL is a Go CLI that extracts data from the Stellar blockchain and exports it as newline-delimited JSON or Parquet files for ingestion into BigQuery. Reads from a GCS-hosted datastore of `LedgerCloseMetaBatch` XDR binary files.
---
...
---
> Source: [stellar/stellar-etl](https://github.com/stellar/stellar-etl) — distributed by [TomeVault](https://tomevault.io).
