---
trigger: always_on
description: > 企业微信在 17 年 11 月对 API 进行了大量的改动，应用管理部分已经没啥用了
---
...
---
> Source: [likeadmin-likeshop/likeadmin_php_saas](https://github.com/likeadmin-likeshop/likeadmin_php_saas) — distributed by [TomeVault](https://tomevault.io).
