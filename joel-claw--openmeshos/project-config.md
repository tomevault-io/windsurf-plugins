---
trigger: always_on
description: OpenMeshOS is open-source firmware for the LilyGo T-Deck and T-Deck Plus (ESP32-S3, LoRa mesh). It uses MeshCore as a git submodule and LVGL 9 for the UI.
---
