---
trigger: always_on
description: Microsoft Agent Framework - a multi-language framework for building, orchestrating, and deploying AI agents.
---
...
---
> Source: [microsoft/agent-framework](https://github.com/microsoft/agent-framework) — distributed by [TomeVault](https://tomevault.io).
