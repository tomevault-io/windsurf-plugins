---
trigger: always_on
description: jup discovers, verifies, caches and runs the tools in its built-in table.
---
...
---
> Source: [unjs/jup](https://github.com/unjs/jup) — distributed by [TomeVault](https://tomevault.io).
