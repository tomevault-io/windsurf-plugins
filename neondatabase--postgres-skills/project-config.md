...
- **Skill directory**: kebab-case, must match `name` in frontmatter (e.g., `postgres-best-practices`)
...
---
> Source: [neondatabase/postgres-skills](https://github.com/neondatabase/postgres-skills) — distributed by [TomeVault](https://tomevault.io).
