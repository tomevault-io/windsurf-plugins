---
trigger: always_on
description: This file provides guidance to AI coding assistants (Claude Code, Cursor, and others) when working with code in this repository.
---
...
---
> Source: [ethersphere/beekeeper](https://github.com/ethersphere/beekeeper) — distributed by [TomeVault](https://tomevault.io).
