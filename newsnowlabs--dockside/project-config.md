---
trigger: always_on
description: - `./test.sh` runs the full static suite (Perl compile, Vue build, ESLint, StyleLint,
---
...
---
> Source: [newsnowlabs/dockside](https://github.com/newsnowlabs/dockside) — distributed by [TomeVault](https://tomevault.io).
