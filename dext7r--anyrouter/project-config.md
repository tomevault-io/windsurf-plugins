---
trigger: always_on
description: AnyRouter 是一个运行在 Cloudflare Workers 上的通用 API 代理服务，支持 OpenAI、Anthropic、Google、Azure、Groq 等任意 HTTP API 的统一转发。
---
...
---
> Source: [dext7r/anyrouter](https://github.com/dext7r/anyrouter) — distributed by [TomeVault](https://tomevault.io).
