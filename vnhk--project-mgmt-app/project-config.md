---
trigger: always_on
description: > **IMPORTANT**: Keep this file updated when making significant changes to the codebase. This file serves as persistent memory between Claude Code sessions.
---
...
---
> Source: [vnhk/project-mgmt-app](https://github.com/vnhk/project-mgmt-app) — distributed by [TomeVault](https://tomevault.io).
