---
trigger: always_on
description: This repository contains the GLEE framework for evaluating LLMs in economic games (Bargaining, Negotiation, Persuasion).
---
...
---
> Source: [eilamshapira/GLEE](https://github.com/eilamshapira/GLEE) — distributed by [TomeVault](https://tomevault.io).
