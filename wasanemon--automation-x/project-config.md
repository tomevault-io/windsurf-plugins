---
trigger: always_on
description: - Do not put secrets in code, tests, fixtures, docs examples, or logs.
---
...
---
> Source: [wasanemon/automation_x](https://github.com/wasanemon/automation_x) — distributed by [TomeVault](https://tomevault.io).
