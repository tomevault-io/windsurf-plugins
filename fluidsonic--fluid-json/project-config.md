---
trigger: always_on
description: Kotlin multiplatform JSON library with codec system, annotation processor, and Ktor integration.
---
...
---
> Source: [fluidsonic/fluid-json](https://github.com/fluidsonic/fluid-json) — distributed by [TomeVault](https://tomevault.io).
