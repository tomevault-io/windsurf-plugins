---
trigger: always_on
description: > 本文件为所有 AI agent 与贡献者的强制约束。与 [CLAUDE.MD](CLAUDE.MD) 互补：
---
...
---
> Source: [yijuichen/ale-quant](https://github.com/yijuichen/ale-quant) — distributed by [TomeVault](https://tomevault.io).
