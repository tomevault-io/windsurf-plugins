---
trigger: always_on
description: Guidance for AI agents (and humans) **editing this repository**. If you
---
...
---
> Source: [modelstudioai/skills](https://github.com/modelstudioai/skills) — distributed by [TomeVault](https://tomevault.io).
