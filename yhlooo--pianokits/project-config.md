---
trigger: always_on
description: TypeScript 纯 Web 应用，基于 **Vite + TypeScript** 构建。
---
...
---
> Source: [yhlooo/pianokits](https://github.com/yhlooo/pianokits) — distributed by [TomeVault](https://tomevault.io).
