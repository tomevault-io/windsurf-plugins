---
trigger: always_on
description: Read [CONTRIBUTING.md](CONTRIBUTING.md) before changing anything. It covers setup, tests, code rules and pull request expectations. The points below are the ones agents get wrong most often.
---
...
---
> Source: [yagizdo/standlock](https://github.com/yagizdo/standlock) — distributed by [TomeVault](https://tomevault.io).
