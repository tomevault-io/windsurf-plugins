...
Original source: `CLAUDE.md` in [joshuaswarren/remnic](https://github.com/joshuaswarren/remnic).
...
```
npx tomevault install joshuaswarren/remnic
```
Source: [github.com/joshuaswarren/remnic](https://github.com/joshuaswarren/remnic).
