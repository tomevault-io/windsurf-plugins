---
trigger: always_on
description: The **`tailwind-animations` skill is for package consumers** (people using the npm package in their apps), not for contributing to this monorepo.
---
...
---
> Source: [midudev/tailwind-animations](https://github.com/midudev/tailwind-animations) — distributed by [TomeVault](https://tomevault.io).
