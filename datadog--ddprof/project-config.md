---
trigger: always_on
description: `ddprof` is the Datadog native profiler for Linux. It profiles CPU time and
---
...
---
> Source: [DataDog/ddprof](https://github.com/DataDog/ddprof) — distributed by [TomeVault](https://tomevault.io).
