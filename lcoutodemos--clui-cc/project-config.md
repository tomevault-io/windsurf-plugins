---
trigger: always_on
description: > This file is optimized for AI coding agents (Claude Code, Cursor, Copilot, etc.).
---
...
---
> Source: [lcoutodemos/clui-cc](https://github.com/lcoutodemos/clui-cc) — distributed by [TomeVault](https://tomevault.io).
