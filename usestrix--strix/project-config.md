---
trigger: always_on
description: Strix is an open-source autonomous AI pentesting tool. This file is for AI coding agents that want to **use** Strix (run security scans) or **contribute** to it.
---
...
---
> Source: [usestrix/strix](https://github.com/usestrix/strix) — distributed by [TomeVault](https://tomevault.io).
