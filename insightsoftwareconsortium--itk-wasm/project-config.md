---
trigger: always_on
description: ITK-Wasm compiles [ITK](https://itk.org/) C++ image processing to WebAssembly for browser, Node.js, and Python execution. The architecture spans:
---
...
---
> Source: [InsightSoftwareConsortium/ITK-Wasm](https://github.com/InsightSoftwareConsortium/ITK-Wasm) — distributed by [TomeVault](https://tomevault.io).
