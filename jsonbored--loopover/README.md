...
> Source: [JSONbored/loopover](https://github.com/JSONbored/loopover). Graded, signed and kept current as the models change by [TomeVault](https://tomevault.io)
...
Graded against the Tome Standard, TomeVault's public ruleset for whether AI instructions load, read clearly and stay safe. Source: [github.com/JSONbored/loopover](https://github.com/JSONbored/loopover)
