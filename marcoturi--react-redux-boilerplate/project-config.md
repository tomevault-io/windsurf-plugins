---
trigger: always_on
description: Production-ready React 19 boilerplate using vertical slice architecture. The stack is React 19 + Redux Toolkit 2 + Vite 7 + TypeScript 5.9 + Tailwind CSS 4 + Biome.
---
...
---
> Source: [marcoturi/react-redux-boilerplate](https://github.com/marcoturi/react-redux-boilerplate) — distributed by [TomeVault](https://tomevault.io).
