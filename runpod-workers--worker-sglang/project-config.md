---
trigger: always_on
description: - ❌ **NEVER** commit automatically
---
...
---
> Source: [runpod-workers/worker-sglang](https://github.com/runpod-workers/worker-sglang) — distributed by [TomeVault](https://tomevault.io).
