---
trigger: always_on
description: This project implements a RFC7033-compliant WebFinger server in Go, providing user discovery via `acct:` URIs with both API endpoints and an HTML frontend for manual lookups.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/0dayfall)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/0dayfall)
