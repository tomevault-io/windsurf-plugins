---
trigger: always_on
description: This document provides essential information for AI coding agents working on the `git-diff-view` codebase.
---
...
---
> Source: [MrWangJustToDo/git-diff-view](https://github.com/MrWangJustToDo/git-diff-view) — distributed by [TomeVault](https://tomevault.io).
