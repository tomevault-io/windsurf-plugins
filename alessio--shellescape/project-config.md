---
trigger: always_on
description: Welcome to `shellescape` (`al.essio.dev/pkg/shellescape`). This repository provides a high-reliability, zero-dependency Go library and a CLI tool (`escargs`) to safely escape arbitrary strings for POSIX shell command-line execution and protect systems against shell injection vulnerabilities.
---
...
---
> Source: [alessio/shellescape](https://github.com/alessio/shellescape) — distributed by [TomeVault](https://tomevault.io).
