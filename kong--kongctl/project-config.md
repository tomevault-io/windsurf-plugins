---
trigger: always_on
description: **For comprehensive repository guidelines, see [AGENTS.md](/AGENTS.md)** in the root directory.
---
...
---
> Source: [Kong/kongctl](https://github.com/Kong/kongctl) — distributed by [TomeVault](https://tomevault.io).
