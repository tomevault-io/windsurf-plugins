---
trigger: always_on
description: PyEMD is a pure Python library for computing the Earth Mover's Distance using POT (Python Optimal Transport). Exposes three functions: `emd()`, `emd_with_flow()`, `emd_samples()`.
---
...
---
> Source: [wmayner/pyemd](https://github.com/wmayner/pyemd) — distributed by [TomeVault](https://tomevault.io).
