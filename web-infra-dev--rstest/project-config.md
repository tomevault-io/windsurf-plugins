---
trigger: always_on
description: Rstest is an Rsbuild-based testing framework for JavaScript/TypeScript projects.
---
...
---
> Source: [web-infra-dev/rstest](https://github.com/web-infra-dev/rstest) — distributed by [TomeVault](https://tomevault.io).
