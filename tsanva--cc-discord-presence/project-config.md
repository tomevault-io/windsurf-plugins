---
trigger: always_on
description: **cc-discord-presence** is a Discord Rich Presence plugin for Claude Code. It displays real-time session information on Discord, including project name, git branch, model, session duration, token usage, and cost.
---
...
---
> Source: [tsanva/cc-discord-presence](https://github.com/tsanva/cc-discord-presence) — distributed by [TomeVault](https://tomevault.io).
