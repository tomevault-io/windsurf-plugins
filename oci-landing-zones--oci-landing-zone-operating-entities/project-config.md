---
trigger: always_on
description: Scope: this file covers `gen/workload-extensions/exacs/**` and published ExaCS snapshots/docs under `workload-extensions/exacs/**`. Root `AGENTS.md` owns customer safety, base landing-zone discovery, and deployment defaults; this file owns ExaDB-D / ExaCS extension semantics.
---
...
---
> Source: [oci-landing-zones/oci-landing-zone-operating-entities](https://github.com/oci-landing-zones/oci-landing-zone-operating-entities) — distributed by [TomeVault](https://tomevault.io).
