---
trigger: always_on
description: - Crates: `reductstore/` (server/CLI; proto in `reductstore/src/proto`), `reduct_base/` (models, logging, JSON
---
...
---
> Source: [reductstore/reductstore](https://github.com/reductstore/reductstore) — distributed by [TomeVault](https://tomevault.io).
