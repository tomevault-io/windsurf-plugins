---
trigger: always_on
description: - Core TypeScript sources sit in `src/`, covering motion primitives and platform helpers (`linear-gradient*.ts`, `svg.ts`); colocate tests under `src/__tests__/`.
---
...
---
> Source: [LegendApp/legend-motion](https://github.com/LegendApp/legend-motion) — distributed by [TomeVault](https://tomevault.io).
