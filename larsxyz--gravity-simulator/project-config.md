---
trigger: always_on
description: - Do NOT use subagents (Agent tool) — they are too slow. Use direct tool calls (Read, Grep, Glob, Bash) instead.
---
...
---
> Source: [larsXYZ/Gravity-Simulator](https://github.com/larsXYZ/Gravity-Simulator) — distributed by [TomeVault](https://tomevault.io).
