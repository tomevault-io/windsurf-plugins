---
trigger: always_on
description: Local search server + browser extension that appends hits from your
---
...
---
> Source: [Endle/fireSeqSearch](https://github.com/Endle/fireSeqSearch) — distributed by [TomeVault](https://tomevault.io).
