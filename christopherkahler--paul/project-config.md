---
trigger: always_on
description: Template for `.paul/codebase/CONVENTIONS.md` - captures coding style and patterns.
---
...
---
> Source: [ChristopherKahler/paul](https://github.com/ChristopherKahler/paul) — distributed by [TomeVault](https://tomevault.io).
