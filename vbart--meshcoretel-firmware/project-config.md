---
trigger: always_on
description: MeshCoreTel-firmware layer on top of upstream MeshCore.
---
...
---
> Source: [VBart/MeshCoreTel-firmware](https://github.com/VBart/MeshCoreTel-firmware) — distributed by [TomeVault](https://tomevault.io).
