---
trigger: always_on
description: - Read-only actions don't need prior approval — status, log, branch listing, file reads, drafting.
---
...
---
> Source: [EAPD-DRB/OG-PHL](https://github.com/EAPD-DRB/OG-PHL) — distributed by [TomeVault](https://tomevault.io).
