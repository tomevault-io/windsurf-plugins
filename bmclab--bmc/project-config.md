---
trigger: always_on
description: This repository is a **Jupyter Book** of biomechanics and motor-control tutorials — mostly pure
---
...
---
> Source: [BMClab/BMC](https://github.com/BMClab/BMC) — distributed by [TomeVault](https://tomevault.io).
