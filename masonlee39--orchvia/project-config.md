---
trigger: always_on
description: Orchvia uses one Node.js engine for scheduling and SQLite persistence; Python connects to that host rather than implementing another engine.
---
...
---
> Source: [masonlee39/orchvia](https://github.com/masonlee39/orchvia) — distributed by [TomeVault](https://tomevault.io).
