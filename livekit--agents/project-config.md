---
trigger: always_on
description: This project uses **uv** as the package manager. All commands run from the repository root.
---
...
---
> Source: [livekit/agents](https://github.com/livekit/agents) — distributed by [TomeVault](https://tomevault.io).
