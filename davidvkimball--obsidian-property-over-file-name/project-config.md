---
trigger: always_on
description: This project uses the OpenSkills system for AI agent guidance. General development skills are provided by the [obsidian-dev-skills](https://github.com/davidvkimball/obsidian-dev-skills) repository.
---
...
---
> Source: [davidvkimball/obsidian-property-over-file-name](https://github.com/davidvkimball/obsidian-property-over-file-name) — distributed by [TomeVault](https://tomevault.io).
