---
trigger: always_on
description: Notes for automated agents and contributors working in this repository.
---
...
---
> Source: [cpmech/russell](https://github.com/cpmech/russell) — distributed by [TomeVault](https://tomevault.io).
