---
trigger: always_on
description: sumy uses [uv](https://docs.astral.sh/uv/). Install the development environment with the language
---
...
---
> Source: [miso-belica/sumy](https://github.com/miso-belica/sumy) — distributed by [TomeVault](https://tomevault.io).
