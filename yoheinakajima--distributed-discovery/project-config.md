---
trigger: always_on
description: This repository develops **Distributed Discovery**: how organizations and multi-agent systems convert dispersed evidence into portfolios of search actions. The repository is public by explicit project-owner decision; the canonical paper and site remain read-only upstream at `yoheinakajima/shared-discovery-paradox`.
---
...
---
> Source: [yoheinakajima/distributed-discovery](https://github.com/yoheinakajima/distributed-discovery) — distributed by [TomeVault](https://tomevault.io).
