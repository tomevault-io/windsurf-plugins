---
trigger: always_on
description: This is a community n8n node package providing EspoCRM REST API integration through three main node types:
---
...
---
> Source: [traien/n8n-nodes-espocrm](https://github.com/traien/n8n-nodes-espocrm) — distributed by [TomeVault](https://tomevault.io).
