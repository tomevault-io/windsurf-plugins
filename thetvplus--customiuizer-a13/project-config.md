---
trigger: always_on
description: 共同工程规则，适用于 ChatGPT、Cursor、Devin、Codex 和其它 Agent。
---
...
---
> Source: [thetvplus/customiuizer-a13](https://github.com/thetvplus/customiuizer-a13) — distributed by [TomeVault](https://tomevault.io).
