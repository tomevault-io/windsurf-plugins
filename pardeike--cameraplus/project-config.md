---
trigger: always_on
description: CameraPlus is a C# RimWorld mod that changes camera zoom/panning and replaces some vanilla pawn-label rendering with configurable map and edge markers. It is a Harmony-heavy runtime mod, so most behavior is driven by patches rather than by new RimWorld defs.
---
...
---
> Source: [pardeike/CameraPlus](https://github.com/pardeike/CameraPlus) — distributed by [TomeVault](https://tomevault.io).
