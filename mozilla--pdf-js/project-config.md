---
trigger: always_on
description: PDF.js is a Portable Document Format (PDF) viewer built with JavaScript, HTML5 Canvas, and CSS. It's a Mozilla project that provides a general-purpose, web standards-based platform for parsing and rendering PDFs without requiring native code or plugins.
---
...
---
> Source: [mozilla/pdf.js](https://github.com/mozilla/pdf.js) — distributed by [TomeVault](https://tomevault.io).
