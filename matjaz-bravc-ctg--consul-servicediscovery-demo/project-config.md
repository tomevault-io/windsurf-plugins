---
trigger: always_on
description: This rule defines the best practices and tools to use for writing unit and integration tests in the backend project.
---
...
---
> Source: [matjaz-bravc-ctg/Consul.ServiceDiscovery.Demo](https://github.com/matjaz-bravc-ctg/Consul.ServiceDiscovery.Demo) — distributed by [TomeVault](https://tomevault.io).
