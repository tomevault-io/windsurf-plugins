---
trigger: always_on
description: Provides a layered terminal UI framework with an Elm/Bubbletea-style runtime, deterministic buffer-diff rendering, RAII terminal lifecycle management, and a broad widget library. Supports both inline (scrollback-preserving) and alt-screen modes.
---
