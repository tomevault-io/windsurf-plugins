---
trigger: always_on
description: - Python imports a single C++17 pybind11 module: `pdaggerq/__init__.py` re-exports `._pdaggerq`. Core algebra is in `pdaggerq/*.cc`; graph optimization and code generation are in `pq_graph/src/` and `pq_graph/include/`.
---
...
---
> Source: [edeprince3/pdaggerq](https://github.com/edeprince3/pdaggerq) — distributed by [TomeVault](https://tomevault.io).
