---
trigger: always_on
description: If you're building AI agents (like Claude Code) that need to generate speech, the [SKILL.md](SKILL.md) file provides agent-optimized documentation.
---
...
---
> Source: [EmZod/speak](https://github.com/EmZod/speak) — distributed by [TomeVault](https://tomevault.io).
