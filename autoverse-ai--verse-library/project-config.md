---
trigger: always_on
description: As mentioned in {doc}`creating scenario in Verse<creating_scenario_in_verse>`, a scenario in Verse is composed by multiple agents. Agents in Verse can be instantiated by a `simulator` and a `decisionLogic`. An example for instantiating a car agent for Verse is shown below.
---
...
---
> Source: [AutoVerse-ai/Verse-library](https://github.com/AutoVerse-ai/Verse-library) — distributed by [TomeVault](https://tomevault.io).
