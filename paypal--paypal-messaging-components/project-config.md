---
trigger: always_on
description: This document provides essential information for Claude to understand and work with the PayPal Messaging Components repository.
---
...
---
> Source: [paypal/paypal-messaging-components](https://github.com/paypal/paypal-messaging-components) — distributed by [TomeVault](https://tomevault.io).
