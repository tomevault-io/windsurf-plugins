---
trigger: always_on
description: - Read `SPEC.md` to understand the product specification and intended behavior.
---

# Before starting work

- Read `SPEC.md` to understand the product specification and intended behavior.
- Read `FSKIT.md` when implementing any functionality that uses the FSKit framework. It contains API reference, protocol signatures, and implementation patterns.
...
---
> Source: [indragiek/GHFS](https://github.com/indragiek/GHFS) — distributed by [TomeVault](https://tomevault.io).
