---
trigger: always_on
description: - After editing code, run `cargo clippy --all-targets -- -D warnings`.
---
...
---
> Source: [gluesql/gluesql](https://github.com/gluesql/gluesql) — distributed by [TomeVault](https://tomevault.io).
