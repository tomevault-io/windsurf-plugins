---
trigger: always_on
description: Before declaring a task complete, run all three suites:
---
...
---
> Source: [ktrysmt/go-bitbucket](https://github.com/ktrysmt/go-bitbucket) — distributed by [TomeVault](https://tomevault.io).
