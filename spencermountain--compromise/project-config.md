---
trigger: always_on
description: Guidance for AI coding agents (and humans) writing code with **compromise**, a rule-based English
---
...
---
> Source: [spencermountain/compromise](https://github.com/spencermountain/compromise) — distributed by [TomeVault](https://tomevault.io).
