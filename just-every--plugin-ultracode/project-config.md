---
trigger: always_on
description: - NEVER write mock code or fallbacks to solve product issues. Mock data is allowed in test suites only.
---
...
---
> Source: [just-every/plugin-ultracode](https://github.com/just-every/plugin-ultracode) — distributed by [TomeVault](https://tomevault.io).
