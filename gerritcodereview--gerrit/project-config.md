---
trigger: always_on
description: Gerrit is a web-based code review system for Git. Backend is Java 21, frontend is TypeScript/Lit components, built with Bazel.
---
...
---
> Source: [GerritCodeReview/gerrit](https://github.com/GerritCodeReview/gerrit) — distributed by [TomeVault](https://tomevault.io).
