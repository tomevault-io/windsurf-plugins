---
trigger: always_on
description: **UK Government API Aggregator** — A platform that aggregates, indexes, and provides unified access to UK Government APIs from across departments and public sector organisations.
---
