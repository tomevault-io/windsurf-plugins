---
trigger: always_on
description: This repository is an API client library for [Bluesky](https://bsky.app/) (Kotlin Multiplatform compatible). It is implemented based on the AT Protocol (atproto).
---
...
---
> Source: [uakihir0/kbsky](https://github.com/uakihir0/kbsky) — distributed by [TomeVault](https://tomevault.io).
