---
trigger: always_on
description: This is a .NET MAUI plugin that provides cross-platform audio playback and recording. It targets Android, iOS, macOS (Catalyst), and Windows.
---
...
---
> Source: [jfversluis/Plugin.Maui.Audio](https://github.com/jfversluis/Plugin.Maui.Audio) — distributed by [TomeVault](https://tomevault.io).
