---
trigger: always_on
description: JamfUploader is a collection of AutoPkg processors for uploading and managing objects in Jamf Pro. The processors can be used in AutoPkg recipes or standalone via the `jamf-upload.sh` wrapper script.
---
...
---
> Source: [grahampugh/jamf-upload](https://github.com/grahampugh/jamf-upload) — distributed by [TomeVault](https://tomevault.io).
