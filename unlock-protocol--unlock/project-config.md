---
trigger: always_on
description: Unlock is a decentralized membership/subscription protocol on EVM blockchains. NFT-based access control: **Locks** are smart contracts, **Keys** are NFTs granting membership.
---
...
---
> Source: [unlock-protocol/unlock](https://github.com/unlock-protocol/unlock) — distributed by [TomeVault](https://tomevault.io).
