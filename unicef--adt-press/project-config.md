---
trigger: always_on
description: ADT Press converts PDF files into Accessible Digital Textbooks (ADTs) using AI/LLM processing. It extracts content from PDFs, processes them through generative AI models (typically from OpenAI), and generates interactive HTML textbooks with text-to-speech, translations, and educational activities.
---
