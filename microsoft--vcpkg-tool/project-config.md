---
trigger: always_on
description: - Configure: `cmake --preset windows-ci` (or `linux-ci`, `linux-arm64-ci`, `macos-ci`)
---
...
---
> Source: [microsoft/vcpkg-tool](https://github.com/microsoft/vcpkg-tool) — distributed by [TomeVault](https://tomevault.io).
