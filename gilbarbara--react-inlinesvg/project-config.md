---
trigger: always_on
description: React component library (`react-inlinesvg`) that loads inline, local, or remote SVGs into React components. Supports data URIs, base64, URL-encoded, inline strings, and remote URLs with automatic caching.
---
...
---
> Source: [gilbarbara/react-inlinesvg](https://github.com/gilbarbara/react-inlinesvg) — distributed by [TomeVault](https://tomevault.io).
