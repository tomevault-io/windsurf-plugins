---
trigger: always_on
description: Each skill is a folder directly under `skills/`, holding a `SKILL.md`. A skill can also carry an `agents/openai.yaml` (Codex metadata) and a `references/` folder for material the `SKILL.md` points to.
---
...
---
> Source: [will-ness-ai/skills](https://github.com/will-ness-ai/skills) — distributed by [TomeVault](https://tomevault.io).
