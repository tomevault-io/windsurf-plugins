---
trigger: always_on
description: This package is the VS Code extension for Kaoto: a visual low-code editor for Apache Camel integrations. It integrates the Kaoto UI into VS Code and provides tooling for creating, editing, and managing Camel routes, pipes, and kamelets.
---
...
---
> Source: [KaotoIO/kaoto](https://github.com/KaotoIO/kaoto) — distributed by [TomeVault](https://tomevault.io).
