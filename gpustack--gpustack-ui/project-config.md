---
trigger: always_on
description: This is the **open source UI** (`gpustack-ui`). Common `components`, `hooks`, and `utils` are published as `@gpustack/core-ui` and consumed throughout `src`.
---
...
---
> Source: [gpustack/gpustack-ui](https://github.com/gpustack/gpustack-ui) — distributed by [TomeVault](https://tomevault.io).
