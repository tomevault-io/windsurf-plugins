---
trigger: always_on
description: - システムコンテキストの日付から曜日を判断しない。`date +%A` で確認すること
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/tsu-nera) — claim your Tome and manage your conversions.
