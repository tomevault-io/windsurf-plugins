---
trigger: always_on
description: Visionmate is a multi-modal assistant that continuously captures UVC video, screen content, or audio, streaming them to a VLM (Vision Language Model) to fuse visual and spoken context for near real-time conversational understanding.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/yuyash) — claim your Tome and manage your conversions.
