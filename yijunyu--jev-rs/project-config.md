---
trigger: always_on
description: - Every commit's **author and committer** must be the human maintainer.
---
...
---
> Source: [yijunyu/jev-rs](https://github.com/yijunyu/jev-rs) — distributed by [TomeVault](https://tomevault.io).
