---
trigger: always_on
description: JSONoid is a JSON Schema discovery tool written in Scala 2.
---
...
---
> Source: [dataunitylab/jsonoid-discovery](https://github.com/dataunitylab/jsonoid-discovery) — distributed by [TomeVault](https://tomevault.io).
