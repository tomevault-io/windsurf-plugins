---
trigger: always_on
description: - Start a fresh `release-notes.md` for every minor or major release; do not inherit or carry forward the previous release's changelog.
---
...
---
> Source: [tzubertowski/TreeFrogUI](https://github.com/tzubertowski/TreeFrogUI) — distributed by [TomeVault](https://tomevault.io).
