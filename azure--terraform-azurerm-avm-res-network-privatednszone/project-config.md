...
---
> Source: [Azure/terraform-azurerm-avm-res-network-privatednszone](https://github.com/Azure/terraform-azurerm-avm-res-network-privatednszone) — distributed by [TomeVault](https://tomevault.io).
