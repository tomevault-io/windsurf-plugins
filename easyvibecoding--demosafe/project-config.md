---
trigger: always_on
description: Demo-safe API Key Manager — macOS system-level tool that masks API keys during demos, livestreams, and tutorials. Three-layer architecture: Swift Core Engine + VS Code Extension + Chrome Extension.
---
