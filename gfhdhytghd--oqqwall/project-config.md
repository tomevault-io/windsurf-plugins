---
trigger: always_on
description: This document orients contributors and agents working in this repo. Keep changes small, focused, and consistent with the existing scripts and layout.
---
...
---
> Source: [gfhdhytghd/OQQWall](https://github.com/gfhdhytghd/OQQWall) — distributed by [TomeVault](https://tomevault.io).
