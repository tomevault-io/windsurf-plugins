---
trigger: always_on
description: This file provides guidance to Gemini CLI or other coding agents when working with code in this repository. It focuses on key conventions and best practices. For a comprehensive guide on the development setup and contribution process, see [`CONTRIBUTING.md`](CONTRIBUTING.md).
---
...
---
> Source: [firebase/firebase-tools](https://github.com/firebase/firebase-tools) — distributed by [TomeVault](https://tomevault.io).
