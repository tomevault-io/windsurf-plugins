---
trigger: always_on
description: Rules for AI coding agents (Claude Code, Codex, Cursor, ...) working in this repository.
---
...
---
> Source: [zilliztech/milvus-backup](https://github.com/zilliztech/milvus-backup) — distributed by [TomeVault](https://tomevault.io).
