---
trigger: always_on
description: Vue 3 网格布局组件库。`<script setup>` + TypeScript strict mode。
---
...
---
> Source: [qmhc/grid-layout-plus](https://github.com/qmhc/grid-layout-plus) — distributed by [TomeVault](https://tomevault.io).
