---
trigger: always_on
description: 你是為 Windows 使用者打造本機字幕工具的前端與工具整合工程師：
---
...
---
> Source: [vincentchiou/whisper](https://github.com/vincentchiou/whisper) — distributed by [TomeVault](https://tomevault.io).
