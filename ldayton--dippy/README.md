...
Original source: `CLAUDE.md` in [ldayton/Dippy](https://github.com/ldayton/Dippy).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/ldayton/Dippy](https://github.com/ldayton/Dippy)
