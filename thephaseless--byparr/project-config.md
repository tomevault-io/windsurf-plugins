---
trigger: always_on
description: - FastAPI service that mimics FlareSolverr-style API for bypassing anti-bot pages using Camoufox + Playwright captcha solver.
---
...
---
> Source: [ThePhaseless/Byparr](https://github.com/ThePhaseless/Byparr) — distributed by [TomeVault](https://tomevault.io).
