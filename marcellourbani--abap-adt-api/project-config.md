---
trigger: always_on
description: TypeScript client library for SAP's ABAP Developer Tools (ADT) REST API. Primary consumer is the [vscode_abap_remote_fs](https://github.com/marcellourbani/vscode_abap_remote_fs) extension.
---
...
---
> Source: [marcellourbani/abap-adt-api](https://github.com/marcellourbani/abap-adt-api) — distributed by [TomeVault](https://tomevault.io).
