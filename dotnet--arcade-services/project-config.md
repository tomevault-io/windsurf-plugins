---
trigger: always_on
description: Scope: `src/ProductConstructionService/`. Extends the root AGENTS.md. See `src/AGENTS.md` for the project map.
---
...
---
> Source: [dotnet/arcade-services](https://github.com/dotnet/arcade-services) — distributed by [TomeVault](https://tomevault.io).
