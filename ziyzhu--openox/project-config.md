---
trigger: always_on
description: 1. The app must remain neutral to LLM provider.
---
...
---
> Source: [ziyzhu/openox](https://github.com/ziyzhu/openox) — distributed by [TomeVault](https://tomevault.io).
