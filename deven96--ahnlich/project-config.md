---
trigger: always_on
description: When reviewing pull requests for Ahnlich, follow these guidelines:
---
...
---
> Source: [deven96/ahnlich](https://github.com/deven96/ahnlich) — distributed by [TomeVault](https://tomevault.io).
