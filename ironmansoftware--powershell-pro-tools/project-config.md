---
trigger: always_on
description: This repository contains PowerShell Pro Tools: Visual Studio extensions, a VS Code extension, PowerShell cmdlets/modules, packaging/MSBuild helpers, host services, and Windows Forms designer components.
---
...
---
> Source: [ironmansoftware/powershell-pro-tools](https://github.com/ironmansoftware/powershell-pro-tools) — distributed by [TomeVault](https://tomevault.io).
