---
trigger: always_on
description: Guidance for coding agents working in **flowgraph**.
---
...
---
> Source: [vectaport/flowgraph](https://github.com/vectaport/flowgraph) — distributed by [TomeVault](https://tomevault.io).
