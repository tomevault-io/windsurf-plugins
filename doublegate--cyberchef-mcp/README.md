...
Original source: `copilot-instructions.md` in [doublegate/CyberChef-MCP](https://github.com/doublegate/CyberChef-MCP).
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/doublegate/CyberChef-MCP](https://github.com/doublegate/CyberChef-MCP)
