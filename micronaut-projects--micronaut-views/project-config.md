---
trigger: always_on
description: This file applies to the whole `micronaut-views` repository. Keep changes
---
...
---
> Source: [micronaut-projects/micronaut-views](https://github.com/micronaut-projects/micronaut-views) — distributed by [TomeVault](https://tomevault.io).
