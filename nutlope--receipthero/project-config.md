---
trigger: always_on
description: - `npm run dev` or `next dev` - **NEVER USE**
---
...
---
> Source: [Nutlope/receipthero](https://github.com/Nutlope/receipthero) — distributed by [TomeVault](https://tomevault.io).
