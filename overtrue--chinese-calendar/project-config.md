---
trigger: always_on
description: 给 AI 代理与自动化工具的项目须知（人类贡献者同样适用）。
---
...
---
> Source: [overtrue/chinese-calendar](https://github.com/overtrue/chinese-calendar) — distributed by [TomeVault](https://tomevault.io).
