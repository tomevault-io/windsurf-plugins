---
trigger: always_on
description: 本书在议题的讨论中，将在文档引用、示例代码、日志输出、源码版本、源码省略等方面做出约定。
---
...
---
> Source: [mercyblitz/mercyblitz.github.io](https://github.com/mercyblitz/mercyblitz.github.io) — distributed by [TomeVault](https://tomevault.io).
