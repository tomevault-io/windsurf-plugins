---
trigger: always_on
description: DSH plugin: MCP server manager for DeepSeek Harness (web profile). Settings → MCP page for HTTP (OAuth PKCE + RFC 7591 dynamic client registration, or static Bearer token) and local stdio MCP servers, whose tools are registered as `mcp__<name>__<rawName>` native tools.
---
...
---
> Source: [hyqhyq3/dsh-mcp-manager](https://github.com/hyqhyq3/dsh-mcp-manager) — distributed by [TomeVault](https://tomevault.io).
