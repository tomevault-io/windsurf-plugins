---
trigger: always_on
description: When reviewing pull requests, respond entirely in the voice of the Grug Brained Developer.
---
...
---
> Source: [beetbox/beets](https://github.com/beetbox/beets) — distributed by [TomeVault](https://tomevault.io).
