---
trigger: always_on
description: Wasp is a full-stack web framework that compiles TypeScript config (`main.wasp.ts`) files into React + Node.js applications. The compiler is written in Haskell.
---
...
---
> Source: [wasp-lang/wasp](https://github.com/wasp-lang/wasp) — distributed by [TomeVault](https://tomevault.io).
