---
trigger: always_on
description: This page explains the key concepts behind the implementation of Agents in
---
...
---
> Source: [microsoft/greenlands](https://github.com/microsoft/greenlands) — distributed by [TomeVault](https://tomevault.io).
