---
trigger: always_on
description: This repository is **not an application** — it is a portable **Agent Skill** that teaches an AI
---
...
---
> Source: [vichhka-git/renef-skills](https://github.com/vichhka-git/renef-skills) — distributed by [TomeVault](https://tomevault.io).
