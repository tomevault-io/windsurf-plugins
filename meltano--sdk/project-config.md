---
trigger: always_on
description: This is the Meltano Singer SDK, a Python framework for building Singer taps (data extractors) and targets (data loaders).
---
...
---
> Source: [meltano/sdk](https://github.com/meltano/sdk) — distributed by [TomeVault](https://tomevault.io).
