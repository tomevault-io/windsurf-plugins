---
trigger: always_on
description: Start by running `./sync.sh` to fill the monorepo directory with the right stuff.
---
...
---
> Source: [pathoplexus/pathoplexus](https://github.com/pathoplexus/pathoplexus) — distributed by [TomeVault](https://tomevault.io).
