---
trigger: always_on
description: 此文件为 Codex (Codex.ai/code) 在处理此代码库时提供指导。
---
...
---
> Source: [Juncai22/spring-ai-agent-learning](https://github.com/Juncai22/spring-ai-agent-learning) — distributed by [TomeVault](https://tomevault.io).
