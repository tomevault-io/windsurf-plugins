---
trigger: always_on
description: Tauri 2 + Vue 3 + TypeScript app for launching Doom source ports (UZDoom/GZDoom) with community WADs.
---
...
---
> Source: [stared/rusted-doom-launcher](https://github.com/stared/rusted-doom-launcher) — distributed by [TomeVault](https://tomevault.io).
