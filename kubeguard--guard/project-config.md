---
trigger: always_on
description: Kubernetes Webhook Authentication/Authorization server.
---
...
---
> Source: [kubeguard/guard](https://github.com/kubeguard/guard) — distributed by [TomeVault](https://tomevault.io).
