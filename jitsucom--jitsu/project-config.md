---
trigger: always_on
description: Jitsu is an open-source data pipeline platform (self-hosted Segment alternative). It
---
...
---
> Source: [jitsucom/jitsu](https://github.com/jitsucom/jitsu) — distributed by [TomeVault](https://tomevault.io).
