---
trigger: always_on
description: In Rescript, OCaml and F#, it is a convention for the primary type of a module to be named `t`.
---
...
---
> Source: [darklang/tablecloth](https://github.com/darklang/tablecloth) — distributed by [TomeVault](https://tomevault.io).
