---
trigger: always_on
description: **The Oracle** is a terminal-native multimodal AI agent that combines Valyu's real-time DeepSearch API with vision-capable LLMs to deliver fully-cited answers enriched with image insight. Runs entirely in the CLI and shows pixel-art previews of every image it analyses.
---
...
---
> Source: [yorkeccak/the-oracle](https://github.com/yorkeccak/the-oracle) — distributed by [TomeVault](https://tomevault.io).
