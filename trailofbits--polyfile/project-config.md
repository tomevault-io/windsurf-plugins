---
trigger: always_on
description: PolyFile is a file analysis utility that identifies and maps the semantic and syntactic structure of files—including polyglots, chimeras, and "schizophrenic" files that are validly multiple types simultaneously.
---
...
---
> Source: [trailofbits/polyfile](https://github.com/trailofbits/polyfile) — distributed by [TomeVault](https://tomevault.io).
