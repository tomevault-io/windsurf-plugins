---
trigger: always_on
description: Message Header Analyzer (MHA) - Outlook add-in for analyzing email headers. See README.md for full feature list and usage.
---
...
---
> Source: [microsoft/MHA](https://github.com/microsoft/MHA) — distributed by [TomeVault](https://tomevault.io).
