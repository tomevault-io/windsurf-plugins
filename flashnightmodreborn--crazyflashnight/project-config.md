---
trigger: always_on
description: 闪客快打7佣兵帝国（CF7:ME）单机 MOD。游戏核心仍在 **AS2 / Flash CS6**，但当前工程已经是多栈本地系统：**C# Guardian Launcher + WebView2 / Web + TypeScript / V8 + Rust `sol_parser` + PowerShell / CLI 自动化** 都是现役组成部分。
---
...
## Context Packs（按任务最小加载，最后核对 commit `d063d53c2`）
...
---
> Source: [FlashNightModReborn/CrazyFlashNight](https://github.com/FlashNightModReborn/CrazyFlashNight) — distributed by [TomeVault](https://tomevault.io).
