---
trigger: always_on
description: SDS is a **Material UI v5 + Emotion** component library. It has **no utility-class system** — you
---
...
---
> Source: [chanzuckerberg/sci-components](https://github.com/chanzuckerberg/sci-components) — distributed by [TomeVault](https://tomevault.io).
