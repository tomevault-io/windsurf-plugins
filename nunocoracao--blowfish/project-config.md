---
trigger: always_on
description: Hugo theme built with Tailwind CSS. Templates in `layouts/`, Tailwind source in `assets/css/main.css` compiled to `assets/css/compiled/main.css` (committed), demo/testbed in `exampleSite/`, localization in `i18n/`.
---
...
---
> Source: [nunocoracao/blowfish](https://github.com/nunocoracao/blowfish) — distributed by [TomeVault](https://tomevault.io).
