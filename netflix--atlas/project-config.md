---
trigger: always_on
description: Netflix Atlas is a metrics platform for managing dimensional time series data. It uses a
---
...
---
> Source: [Netflix/atlas](https://github.com/Netflix/atlas) — distributed by [TomeVault](https://tomevault.io).
