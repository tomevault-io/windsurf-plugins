---
trigger: always_on
description: - Never write comments in code - code should be self-documenting
---
...
---
> Source: [vm/nila-code](https://github.com/vm/nila-code) — distributed by [TomeVault](https://tomevault.io).
