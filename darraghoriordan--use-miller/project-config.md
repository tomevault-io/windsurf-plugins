---
trigger: always_on
description: Instructions for AI coding agents working in this pnpm monorepo.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/darraghoriordan)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/darraghoriordan)
