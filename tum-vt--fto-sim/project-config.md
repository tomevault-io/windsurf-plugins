---
trigger: always_on
description: Help contributors and AI agents become productive quickly in FTO-Sim by describing the architecture, entry points, important conventions, and common run/debug workflows.
---
...
---
> Source: [TUM-VT/FTO-Sim](https://github.com/TUM-VT/FTO-Sim) — distributed by [TomeVault](https://tomevault.io).
