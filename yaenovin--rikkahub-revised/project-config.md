---
trigger: always_on
description: RikkaHub is a native Android LLM chat client that supports switching between different AI providers
---
...
- **Assistant**: An assistant configuration with system prompts, model parameters, and conversation isolation. Each
  assistant maintains its own settings including temperature, rolling-summary settings, custom headers, tools, memory options, regex
...
---
> Source: [YaeNovin/Rikkahub-Revised](https://github.com/YaeNovin/Rikkahub-Revised) — distributed by [TomeVault](https://tomevault.io).
