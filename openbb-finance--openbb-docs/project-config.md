---
trigger: always_on
description: - Start dev server: `npm run dev`
---
...
---
> Source: [OpenBB-finance/openbb-docs](https://github.com/OpenBB-finance/openbb-docs) — distributed by [TomeVault](https://tomevault.io).
