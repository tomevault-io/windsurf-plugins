---
trigger: always_on
description: - IMPORTANT: Do not use emoji, special symbols (like ->), or Unicode characters in comments or code.
---
...
---
> Source: [zeroasiccorp/logikbench](https://github.com/zeroasiccorp/logikbench) — distributed by [TomeVault](https://tomevault.io).
