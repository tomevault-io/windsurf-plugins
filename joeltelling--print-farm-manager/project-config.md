---
trigger: always_on
description: - On every new session, read `docs/README.md` first to understand the project structure and existing documentation.
---
...
---
> Source: [joeltelling/print-farm-manager](https://github.com/joeltelling/print-farm-manager) — distributed by [TomeVault](https://tomevault.io).
