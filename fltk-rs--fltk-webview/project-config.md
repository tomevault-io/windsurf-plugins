---
trigger: always_on
description: - Root crate: `Cargo.toml`, library entry at `src/lib.rs` (public `Webview` API).
---
...
---
> Source: [fltk-rs/fltk-webview](https://github.com/fltk-rs/fltk-webview) — distributed by [TomeVault](https://tomevault.io).
