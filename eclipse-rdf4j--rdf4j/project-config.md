---
trigger: always_on
description: Before taking any action (either tool calls *or* responses to the user), you must proactively, methodically, and independently plan and reason about:
---
...
---
> Source: [eclipse-rdf4j/rdf4j](https://github.com/eclipse-rdf4j/rdf4j) — distributed by [TomeVault](https://tomevault.io).
