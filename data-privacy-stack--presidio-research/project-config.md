---
trigger: always_on
description: - Python managed with `uv` — always use `uv run` for Python, never bare `python` or `pip`
---
...
---
> Source: [data-privacy-stack/presidio-research](https://github.com/data-privacy-stack/presidio-research) — distributed by [TomeVault](https://tomevault.io).
