---
trigger: always_on
description: Libretto is an open-source toolkit for building robust web integrations. It gives coding agents a live browser and a token-efficient CLI to inspect pages, capture network traffic, record user actions, and replay them as automation scripts.
---
...
---
> Source: [saffron-health/libretto](https://github.com/saffron-health/libretto) — distributed by [TomeVault](https://tomevault.io).
