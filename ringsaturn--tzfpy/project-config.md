---
trigger: always_on
description: - `src/lib.rs` contains the PyO3 extension module and the exported Python-callable functions.
---
...
---
> Source: [ringsaturn/tzfpy](https://github.com/ringsaturn/tzfpy) — distributed by [TomeVault](https://tomevault.io).
