---
trigger: always_on
description: Name test files and classes after the **capability or use case** under test (e.g.
---
...
---
> Source: [Handlebars-Net/Handlebars.Net](https://github.com/Handlebars-Net/Handlebars.Net) — distributed by [TomeVault](https://tomevault.io).
