---
trigger: always_on
description: **IMPORTANT:** **Do not** read, list, or use the following paths or files for analysis or suggestions. These files are machine-generated and very numerous; accessing them causes performance issues and is irrelevant to most tasks:
---
...
---
> Source: [typisttech/wpsecadv](https://github.com/typisttech/wpsecadv) — distributed by [TomeVault](https://tomevault.io).
