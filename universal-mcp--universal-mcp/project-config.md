---
trigger: always_on
description: - This repository uses Python managed by uv for dependency resolution, virtual environments, locking, and execution. Always prefer uv subcommands (add/remove/run/sync/export) over raw pip/venv commands.
---
...
---
> Source: [universal-mcp/universal-mcp](https://github.com/universal-mcp/universal-mcp) — distributed by [TomeVault](https://tomevault.io).
