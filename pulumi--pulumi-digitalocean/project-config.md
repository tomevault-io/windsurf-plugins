---
trigger: always_on
description: The Pulumi digitalocean provider is a Go-based Pulumi resource provider that bridges the Terraform provider to Pulumi. It generates SDKs for TypeScript/JavaScript, Python, .NET, Go, and Java. The provider uses the Terraform provider as an upstream source via git submodules.
---

# Pulumi digitalocean Provider

The Pulumi digitalocean provider is a Go-based Pulumi resource provider that bridges the Terraform provider to Pulumi. It generates SDKs for TypeScript/JavaScript, Python, .NET, Go, and Java. The provider uses the Terraform provider as an upstream source via git submodules.
...
---
> Source: [pulumi/pulumi-digitalocean](https://github.com/pulumi/pulumi-digitalocean) — distributed by [TomeVault](https://tomevault.io).
