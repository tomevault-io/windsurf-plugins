---
trigger: always_on
description: - **第一性原理思考**：从原始需求和问题出发。若动机或目标不清晰，先讨论；若路径不是最优，直接指出并建议更好的做法
---
...
---
> Source: [wzj998/ChatCCC](https://github.com/wzj998/ChatCCC) — distributed by [TomeVault](https://tomevault.io).
