---
trigger: always_on
description: Project conventions and architecture for AI-assisted development.
---
...
---
> Source: [ltwlf/json-diff-ts](https://github.com/ltwlf/json-diff-ts) — distributed by [TomeVault](https://tomevault.io).
