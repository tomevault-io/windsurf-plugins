---
trigger: always_on
description: ClawSec combines a Vite + React frontend with security skill packages and release tooling.
---
...
---
> Source: [prompt-security/clawsec](https://github.com/prompt-security/clawsec) — distributed by [TomeVault](https://tomevault.io).
