---
trigger: always_on
description: Semantic version control CLI. Entity-level diffs for Git (functions, classes, methods instead of lines).
---
...
---
> Source: [Ataraxy-Labs/sem](https://github.com/Ataraxy-Labs/sem) — distributed by [TomeVault](https://tomevault.io).
