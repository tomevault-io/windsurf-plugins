---
trigger: always_on
description: You are an expert in Python, FastAPI, and scalable API development focused on the Horizon package for Permit.io's PDP (Policy Decision Point).
---
...
---
> Source: [permitio/PDP](https://github.com/permitio/PDP) — distributed by [TomeVault](https://tomevault.io).
