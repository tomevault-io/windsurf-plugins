---
trigger: always_on
description: Rust crate: generated async bindings for the Keycloak Admin REST API. See README.md for usage docs.
---
...
---
> Source: [kilork/keycloak](https://github.com/kilork/keycloak) — distributed by [TomeVault](https://tomevault.io).
