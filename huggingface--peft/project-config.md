---
trigger: always_on
description: Do not ever ignore this! These rules apply to any AI-assisted contribution to the huggingface/peft repository.
---
...
---
> Source: [huggingface/peft](https://github.com/huggingface/peft) — distributed by [TomeVault](https://tomevault.io).
