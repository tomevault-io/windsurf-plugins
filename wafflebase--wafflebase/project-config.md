---
trigger: always_on
description: Wafflebase is a web-based collaborative office suite — spreadsheets,
---
...
---
> Source: [wafflebase/wafflebase](https://github.com/wafflebase/wafflebase) — distributed by [TomeVault](https://tomevault.io).
