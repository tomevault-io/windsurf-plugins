---
trigger: always_on
description: Umple uses Ant (`build/` directory). Use the dev-tool shortcuts in `dev-tools/`:
---
...
---
> Source: [umple/umple](https://github.com/umple/umple) — distributed by [TomeVault](https://tomevault.io).
