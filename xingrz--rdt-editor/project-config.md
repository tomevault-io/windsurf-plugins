---
trigger: always_on
description: A web-based visual editor for Wikipedia [Route Diagram Template (RDT)](https://en.wikipedia.org/wiki/WP:RDT). It provides a split-view interface with a text editor on the left and a live-rendered route diagram preview on the right.
---
...
---
> Source: [xingrz/rdt-editor](https://github.com/xingrz/rdt-editor) — distributed by [TomeVault](https://tomevault.io).
