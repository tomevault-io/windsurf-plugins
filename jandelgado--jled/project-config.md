---
trigger: always_on
description: JLed is an embedded C++ library for non-blocking, time-driven LED control (blink, breathe, fade, etc.). LEDs can be grouped and controlled in parallel or sequentially.
---
...
---
> Source: [jandelgado/jled](https://github.com/jandelgado/jled) — distributed by [TomeVault](https://tomevault.io).
