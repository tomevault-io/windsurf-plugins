---
trigger: always_on
description: When reviewing pull requests, check if changes warrant a version bump:
---
...
---
> Source: [bazel-contrib/rules_perl](https://github.com/bazel-contrib/rules_perl) — distributed by [TomeVault](https://tomevault.io).
