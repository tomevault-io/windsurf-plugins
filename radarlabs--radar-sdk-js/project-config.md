---
trigger: always_on
description: npm run build                          # core SDK → dist/ (ESM) + cdn/ (IIFE)
---
...
---
> Source: [radarlabs/radar-sdk-js](https://github.com/radarlabs/radar-sdk-js) — distributed by [TomeVault](https://tomevault.io).
