---
trigger: always_on
description: The Stacks Explorer is a Next.js (App Router) application used to monitor the Stacks blockchain. It relies heavily on React, Chakra UI, Redux Toolkit and various Stacks packages. Development uses TypeScript throughout and is managed with PNPM.
---
...
---
> Source: [stx-labs/explorer](https://github.com/stx-labs/explorer) — distributed by [TomeVault](https://tomevault.io).
