---
trigger: always_on
description: backend/       Python 3.12 / FastAPI app (package name: nuros)
---
...
---
> Source: [ulanpy/nuspace](https://github.com/ulanpy/nuspace) — distributed by [TomeVault](https://tomevault.io).
