---
trigger: always_on
description: 欢迎参与 **Libgdx-Backend-TextureView-Android** 的开发！本文件定义了在该项目内协作的 AI Agent 角色、职责及开发指导方针，旨在提升代码质量和渲染性能。
---
...
---
> Source: [tpnet/Libgdx-Backend-TextureView-Android](https://github.com/tpnet/Libgdx-Backend-TextureView-Android) — distributed by [TomeVault](https://tomevault.io).
