---
trigger: always_on
description: Guidelines for developing and maintaining FlowOS documentation using Docusaurus, including content structure, style, and deployment processes.
---
...
## Purpose
Guidelines for developing and maintaining FlowOS documentation using Docusaurus, including content structure, style, and deployment processes.
...
│   ├── tutorials/           # FlowOS tutorials
│   ├── components/          # Component documentation
│   ├── flows/               # Guides to build, run, and test flows
│   ├── deployment/          # Guides for deploying and hosting a FlowOS server
│   ├── develop/             # Guides for developing apps with FlowOS
...
### Images and Assets
```
![Descriptive alt text](/img/some-image.png)
```
...
### API examples
```bash
make api_examples_local          # Run API sample files against a local FlowOS server
...
### Terminology
- **FlowOS:** Always capitalize
- **Component:** Capitalize when referring to FlowOS components
- **Flow:** Capitalize when referring to FlowOS flows
...
---
> Source: [dspraneeth07/Flow_OS](https://github.com/dspraneeth07/Flow_OS) — distributed by [TomeVault](https://tomevault.io).
