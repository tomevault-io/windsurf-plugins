...
- Canonical requirements are coded here: [validate-plugin-entry.yml](https://github.com/obsidianmd/obsidian-releases/blob/master/.github/workflows/validate-plugin-entry.yml)
...
---
> Source: [dragonish/obsidian-abbreviations](https://github.com/dragonish/obsidian-abbreviations) — distributed by [TomeVault](https://tomevault.io).
