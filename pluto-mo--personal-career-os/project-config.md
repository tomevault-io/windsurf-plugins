---
trigger: always_on
description: 本仓库只包含一个纯 Agent Skill。运行入口和行为真源是根目录 `SKILL.md`。
---
...
---
> Source: [Pluto-Mo/personal-career-os](https://github.com/Pluto-Mo/personal-career-os) — distributed by [TomeVault](https://tomevault.io).
