---
trigger: always_on
description: Instructions for Codex and other coding agents working in this repository.
---
...
---
> Source: [vsamarth/drift](https://github.com/vsamarth/drift) — distributed by [TomeVault](https://tomevault.io).
