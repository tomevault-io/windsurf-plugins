---
trigger: always_on
description: - Run tox via uv: `uv run tox -e <env>`
---
...
---
> Source: [getsentry/sentry-python](https://github.com/getsentry/sentry-python) — distributed by [TomeVault](https://tomevault.io).
