---
trigger: always_on
description: Wasm3 is a WebAssembly interpreter written in C99, plus a CLI, a set of embedded ports,
---
...
---
> Source: [wasm3/wasm3](https://github.com/wasm3/wasm3) — distributed by [TomeVault](https://tomevault.io).
