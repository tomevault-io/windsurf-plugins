---
trigger: always_on
description: - `cmd/wacli/`: CLI command wiring (auth, sync, messages, send, media, contacts, chats, groups, history, presence, doctor).
---
...
---
> Source: [openclaw/wacli](https://github.com/openclaw/wacli) — distributed by [TomeVault](https://tomevault.io).
