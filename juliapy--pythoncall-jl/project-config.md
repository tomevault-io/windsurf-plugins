---
trigger: always_on
description: - **Julia tests**: Run from the project root with `julia --project -e 'using Pkg; Pkg.test()'`. Expect a warning about the General registry being unreachable in locked-down environments; the suite still finishes (PyCall tests are marked broken/Skipped).
---
...
---
> Source: [JuliaPy/PythonCall.jl](https://github.com/JuliaPy/PythonCall.jl) — distributed by [TomeVault](https://tomevault.io).
