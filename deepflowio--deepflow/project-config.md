---
trigger: always_on
description: - Always refer to files by repo-root relative path. Prefer `@path/to/file` notation when it improves clarity.
---
...
---
> Source: [deepflowio/deepflow](https://github.com/deepflowio/deepflow) — distributed by [TomeVault](https://tomevault.io).
