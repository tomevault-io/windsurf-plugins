---
trigger: always_on
description: This file provides instructions for AI coding agents (GitHub Copilot, Claude Code, OpenAI Codex, etc.) working in this repository.
---
...
---
> Source: [feast-dev/feast](https://github.com/feast-dev/feast) — distributed by [TomeVault](https://tomevault.io).
