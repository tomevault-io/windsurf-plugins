---
trigger: always_on
description: This is a documentation website for [RabbitMQ](https://rabbitmq.com/docs). It has multiple
---
 ...
 * 4.4 (in development): its Markdown source files can be found under `./docs`
 * 4.3 with source files under `./versioned_docs/version-4.3`
...
---
> Source: [rabbitmq/rabbitmq-website](https://github.com/rabbitmq/rabbitmq-website) — distributed by [TomeVault](https://tomevault.io).
