---
trigger: always_on
description: **DEVELOPER NOTE:** After every development session, you MUST update the `Development Log` section at the bottom of this file with a new entry for the current date. The entry should be a bulleted list summarizing all changes, new features, and bug fixes.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/visheshnarayan)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/visheshnarayan)
