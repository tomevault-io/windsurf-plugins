---
trigger: always_on
description: This file provides context for AI coding agents (Claude Code, GitHub Copilot, Cursor, etc.) working in this repository.
---
...
---
> Source: [owncloud/davclient.js](https://github.com/owncloud/davclient.js) — distributed by [TomeVault](https://tomevault.io).
