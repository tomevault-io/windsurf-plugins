---
trigger: always_on
description: When working in this repository, prefer the project skills under `.github/skills/` for repeatable workflows.
---
...
---
> Source: [sandrohanea/whisper.net](https://github.com/sandrohanea/whisper.net) — distributed by [TomeVault](https://tomevault.io).
