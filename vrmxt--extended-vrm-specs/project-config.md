...
| `examples/**` | Technical docs / examples — loaded file, captions, clipped JSON |
| `implementations/**` | Technical docs — host seams, versions, ModHost |
| `tutorials/**` | Tutorial / how-to — second person, click path, what you should see |
