---
trigger: always_on
description: Skill Engineering is the standalone source of truth for Agent Skill creation, Doctor, behavior evaluation, continuous maintenance, self-evolution, and release safety.
---
...
---
> Source: [wukongai/skill-engineering](https://github.com/wukongai/skill-engineering) — distributed by [TomeVault](https://tomevault.io).
