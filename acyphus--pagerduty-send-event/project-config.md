---
trigger: always_on
description: This repository contains a GitHub Action for sending events to PagerDuty to
---
...
---
> Source: [ACyphus/pagerduty-send-event](https://github.com/ACyphus/pagerduty-send-event) — distributed by [TomeVault](https://tomevault.io).
