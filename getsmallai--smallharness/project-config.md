---
trigger: always_on
description: - After finishing code or documentation updates, give the user a git commit message.
---
...
---
> Source: [GetSmallAI/SmallHarness](https://github.com/GetSmallAI/SmallHarness) — distributed by [TomeVault](https://tomevault.io).
