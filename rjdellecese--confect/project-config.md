---
trigger: always_on
description: Confect is a library that integrates Effect with the Convex backend platform. It is a pnpm monorepo (requires Node >= 22, pnpm >= 10).
---
...
---
> Source: [rjdellecese/confect](https://github.com/rjdellecese/confect) — distributed by [TomeVault](https://tomevault.io).
