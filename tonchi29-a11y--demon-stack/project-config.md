---
trigger: always_on
description: DEMON_STACK is a mono-repo of small, reusable AutoHotkey v2 libraries (each in its own `Demon*/` folder) plus reference “Gold” stacks in `stacks/GOLD_*`.
---
...
---
> Source: [tonchi29-a11y/DEMON_STACK](https://github.com/tonchi29-a11y/DEMON_STACK) — distributed by [TomeVault](https://tomevault.io).
