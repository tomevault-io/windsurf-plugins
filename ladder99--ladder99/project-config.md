---
trigger: always_on
description: The **MTConnect Agent** receives data from one or more device Adapters and writes the data to an XML tree. This XML can be consumed by other applications, or displayed in a browser as an HTML webpage.
---
...
---
> Source: [Ladder99/ladder99](https://github.com/Ladder99/ladder99) — distributed by [TomeVault](https://tomevault.io).
