---
trigger: always_on
description: This repo is Java-first (JDK 21) with Maven as the primary build/test tool.
---
...
---
> Source: [Comcast/Oscar](https://github.com/Comcast/Oscar) — distributed by [TomeVault](https://tomevault.io).
