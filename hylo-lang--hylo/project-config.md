---
trigger: always_on
description: This document describes some of the conventions and used in this project.
---
...
---
> Source: [hylo-lang/hylo](https://github.com/hylo-lang/hylo) — distributed by [TomeVault](https://tomevault.io).
