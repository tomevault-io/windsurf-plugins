---
trigger: always_on
description: This file is for humans and coding agents working in this repository. Keep it generic so it can be copied into other repos.
---
...
---
> Source: [CederGroupHub/alabos](https://github.com/CederGroupHub/alabos) — distributed by [TomeVault](https://tomevault.io).
