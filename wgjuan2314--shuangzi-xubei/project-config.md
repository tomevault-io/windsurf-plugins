---
trigger: always_on
description: - **每完成执行清单中一项，必须同步更新 `PROJECT.md` 与 `PROGRESS.md`**（任务状态 + 当日进展），保持文档与代码一致
---
...
---
> Source: [wgjuan2314/shuangzi-xubei](https://github.com/wgjuan2314/shuangzi-xubei) — distributed by [TomeVault](https://tomevault.io).
