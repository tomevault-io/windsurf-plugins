---
trigger: always_on
description: - `Unbreak-classical.yaml` and `proxy-classical.yaml` are Clash rule lists in YAML format. Each file contains a single `payload:` list with one rule per line.
---
...
---
> Source: [qoli/SyncnextClash](https://github.com/qoli/SyncnextClash) — distributed by [TomeVault](https://tomevault.io).
