---
trigger: always_on
description: SharpSource is a collection of C# Roslyn analyzers designed to detect code patterns that have concrete potential to become defects. The project focuses on runtime exceptions, performance issues, and unintended behavior rather than code style or formatting.
---
...
---
> Source: [Vannevelj/SharpSource](https://github.com/Vannevelj/SharpSource) — distributed by [TomeVault](https://tomevault.io).
