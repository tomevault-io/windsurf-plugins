---
trigger: always_on
description: > 本文档供 AI Coding Agent 阅读，用于快速理解项目架构和开发规范。
---
...
---
> Source: [yifeianyi/BsimpleHires](https://github.com/yifeianyi/BsimpleHires) — distributed by [TomeVault](https://tomevault.io).
