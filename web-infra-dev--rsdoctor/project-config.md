---
trigger: always_on
description: - Node.js `22+`, package manager **pnpm `10.17+`** (enable via `corepack enable`)
---
...
---
> Source: [web-infra-dev/rsdoctor](https://github.com/web-infra-dev/rsdoctor) — distributed by [TomeVault](https://tomevault.io).
