---
trigger: always_on
description: A free, open-source DNS-based domain redirect service. Users create CNAME records pointing to `redirect.center` and the service parses the DNS record to perform HTTP redirects. No server, no hosting, no code needed by the end user.
---
...
---
> Source: [udleinati/redirect.center](https://github.com/udleinati/redirect.center) — distributed by [TomeVault](https://tomevault.io).
