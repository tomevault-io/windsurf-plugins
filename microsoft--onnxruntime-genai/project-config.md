---
trigger: always_on
description: When generating or reviewing code in the Python Model Builder (`src/python/py/models/`), evaluate all changes against the criteria defined in the following files:
---
...
---
> Source: [microsoft/onnxruntime-genai](https://github.com/microsoft/onnxruntime-genai) — distributed by [TomeVault](https://tomevault.io).
