---
trigger: always_on
description: SiEval is a **model delivery quality verification system**: eval-side knowledge constraining and verifying the entire model delivery pipeline (training → conversion → infer → evaluation).
---
...
---
> Source: [scitix/sieval](https://github.com/scitix/sieval) — distributed by [TomeVault](https://tomevault.io).
