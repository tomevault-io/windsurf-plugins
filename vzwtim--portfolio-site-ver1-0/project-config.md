---
trigger: always_on
description: この仕様書は、Geminiがあなたのポートフォリオサイトを効率的かつ正確に作成するために必要な情報と指示をまとめたものです。ご提示いただいた`https://lusion.co/projects/porsche_dream_machine`のデザイン・UI/UXを参考に、洗練された没入感のある体験を目指します。
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/vzwtim)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/vzwtim)
