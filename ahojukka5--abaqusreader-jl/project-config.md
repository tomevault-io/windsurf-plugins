---
trigger: always_on
description: AbaqusReader.jl is designed around **two distinct use cases** that should never be conflated:
---
...
---
> Source: [ahojukka5/AbaqusReader.jl](https://github.com/ahojukka5/AbaqusReader.jl) — distributed by [TomeVault](https://tomevault.io).
