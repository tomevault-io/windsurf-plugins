---
trigger: always_on
description: [directorystructure.md](mdc:directorystructure.md) を参照。
---
...
[directorystructure.md](mdc:directorystructure.md) を参照。
...
- `lib/api`ディレクトリ内に API エンドポイント用のディレクトリを作成
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/hum2)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/hum2)
