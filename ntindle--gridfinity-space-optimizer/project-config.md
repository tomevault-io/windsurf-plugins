---
trigger: always_on
description: **ALWAYS follow these instructions first and only fallback to additional search and context gathering if the information in the instructions is incomplete or found to be in error.**
---
...
---
> Source: [ntindle/gridfinity-space-optimizer](https://github.com/ntindle/gridfinity-space-optimizer) — distributed by [TomeVault](https://tomevault.io).
