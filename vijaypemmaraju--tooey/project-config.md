---
trigger: always_on
description: project guide for @tooey/ui - token-efficient ui library for llm output
---
...
---
> Source: [vijaypemmaraju/tooey](https://github.com/vijaypemmaraju/tooey) — distributed by [TomeVault](https://tomevault.io).
