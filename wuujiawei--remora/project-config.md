---
trigger: always_on
description: Remora 是一个原生 macOS SSH/SFTP 客户端，使用 Swift 6 + SwiftUI 构建，最低支持 macOS 14+。项目采用 Swift Package Manager 管理。
---
...
---
> Source: [wuuJiawei/Remora](https://github.com/wuuJiawei/Remora) — distributed by [TomeVault](https://tomevault.io).
