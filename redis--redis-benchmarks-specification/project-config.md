---
trigger: always_on
description: Instructions for AI coding agents (Claude Code, Copilot, Cursor, etc.) working in this repo.
---
...
---
> Source: [redis/redis-benchmarks-specification](https://github.com/redis/redis-benchmarks-specification) — distributed by [TomeVault](https://tomevault.io).
