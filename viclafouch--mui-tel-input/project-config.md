---
trigger: always_on
description: Phone number input component for MUI (Material UI), published on NPM as `mui-tel-input`.
---
...
---
> Source: [viclafouch/mui-tel-input](https://github.com/viclafouch/mui-tel-input) — distributed by [TomeVault](https://tomevault.io).
