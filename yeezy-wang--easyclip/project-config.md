---
trigger: always_on
description: macOS 原生菜单栏剪贴板历史管理工具。自动记录文字和图片复制内容，支持搜索、置顶、保留策略、Quick Look 预览和重新粘贴。
---
...
---
> Source: [yeezy-wang/EasyClip](https://github.com/yeezy-wang/EasyClip) — distributed by [TomeVault](https://tomevault.io).
