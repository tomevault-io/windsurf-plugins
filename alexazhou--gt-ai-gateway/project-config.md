---
trigger: always_on
description: | **GEMINI.md** | 本文档，编程规范和工作技巧 |
---
...
---
> Source: [alexazhou/gt_ai_gateway](https://github.com/alexazhou/gt_ai_gateway) — distributed by [TomeVault](https://tomevault.io).
