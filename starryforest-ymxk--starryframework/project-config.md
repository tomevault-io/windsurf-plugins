---
trigger: always_on
description: 1. All assets must be placed in the corresponding directories:
---
...
---
> Source: [starryforest-ymxk/StarryFramework](https://github.com/starryforest-ymxk/StarryFramework) — distributed by [TomeVault](https://tomevault.io).
