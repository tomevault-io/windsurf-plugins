---
trigger: always_on
description: - `main.go` coordinates CLI flags, configuration loading, and the scanning pipeline entrypoint.
---
...
---
> Source: [dsecuredcom/dynamic-file-searcher](https://github.com/dsecuredcom/dynamic-file-searcher) — distributed by [TomeVault](https://tomevault.io).
