...
- `feat/externalize-hermes-adapter` → core has **no** `hermes-galyarder-adapter` dependency and **no** built-in `hermes_local` registration. Install Hermes via the Adapter Plugin manager (`@henkey/hermes-galyarder-adapter` or a `file:` path).

<!-- Content truncated to meet Windsurf 6KB limit -->

---
> Source: [galyarderlabs/galyarder-hq](https://github.com/galyarderlabs/galyarder-hq) — distributed by [TomeVault](https://tomevault.io).
