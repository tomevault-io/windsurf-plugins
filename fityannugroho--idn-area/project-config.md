---
trigger: always_on
description: Indonesian Area API - NestJS REST API providing comprehensive Indonesian administrative area data (provinces, regencies, districts, villages, islands) with multi-database support via Prisma.
---
...
---
> Source: [fityannugroho/idn-area](https://github.com/fityannugroho/idn-area) — distributed by [TomeVault](https://tomevault.io).
