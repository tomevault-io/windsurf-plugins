---
trigger: always_on
description: `@mcp-ts/sdk` is a TypeScript SDK for building Model Context Protocol (MCP) applications with support for streamed HTTP RPC, OAuth 2.1, multiple storage backends, MCP Apps, and production-ready integrations.
---
...
---
> Source: [zonlabs/mcp-ts](https://github.com/zonlabs/mcp-ts) — distributed by [TomeVault](https://tomevault.io).
