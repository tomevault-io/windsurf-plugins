...
1. **Source of truth** — Clone/checkout `AceDataCloud/Docs` and read `openapi/seedance.json` (the OpenAPI spec).
...
---
> Source: [AceDataCloud/SeedanceMCP](https://github.com/AceDataCloud/SeedanceMCP) — distributed by [TomeVault](https://tomevault.io).
