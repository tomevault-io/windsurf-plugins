---
trigger: always_on
description: - Vite + React 19 app with TanStack Router. Entry is src/main.tsx; routing is defined in src/router.tsx and mounted in components/layout/RootLayout.tsx.
---
...
---
> Source: [wilfredinni/javascript-cheatsheet](https://github.com/wilfredinni/javascript-cheatsheet) — distributed by [TomeVault](https://tomevault.io).
