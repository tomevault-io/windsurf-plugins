---
trigger: always_on
description: - Read [ARCHITECTURE.md](ARCHITECTURE.md) before changing Rust actors, async manager methods, worker tasks, Rust closure-based orchestration, reconciliation, shared state, locks, dispatch, or UniFFI manager boundaries
---
...
---
> Source: [bitcoinppl/cove](https://github.com/bitcoinppl/cove) — distributed by [TomeVault](https://tomevault.io).
