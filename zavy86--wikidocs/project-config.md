---
trigger: always_on
description: These guidelines apply **only** to `frontend/`.
---
...
---
> Source: [Zavy86/WikiDocs](https://github.com/Zavy86/WikiDocs) — distributed by [TomeVault](https://tomevault.io).
