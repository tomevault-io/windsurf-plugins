---
trigger: always_on
description: このファイルは、このリポジトリを編集する際のルールとガイドラインを定めたものです。主に OpenCode（さくらのAIエンジン経由の Kimi など）およびその他のAIアシスタント向けに作成しています。
---
...
---
> Source: [llm-jp/awesome-japanese-llm](https://github.com/llm-jp/awesome-japanese-llm) — distributed by [TomeVault](https://tomevault.io).
