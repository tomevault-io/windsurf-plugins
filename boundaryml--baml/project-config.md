---
trigger: always_on
description: NOTE: The baml_vis children collapse config will effect these tests and can prevent them from passing
---
...
---
> Source: [BoundaryML/baml](https://github.com/BoundaryML/baml) — distributed by [TomeVault](https://tomevault.io).
