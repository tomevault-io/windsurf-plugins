---
trigger: always_on
description: Love2Droid 是单 `app` 模块 Android 应用，包名为 `top.wsdx233.love2droid`。应用把 LÖVE/SDL native runtime、项目文件管理和 Sora Editor 集成在同一个 APK 中。最低 API 23，Java/Kotlin 目标版本为 17。
---
...
---
> Source: [wsdx233/Love2Droid](https://github.com/wsdx233/Love2Droid) — distributed by [TomeVault](https://tomevault.io).
