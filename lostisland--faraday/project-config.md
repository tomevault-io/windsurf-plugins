---
trigger: always_on
description: **Before making any code suggestions**, consult `.ai/guidelines.md` for comprehensive Faraday-specific conventions and patterns.
---
...
---
> Source: [lostisland/faraday](https://github.com/lostisland/faraday) — distributed by [TomeVault](https://tomevault.io).
