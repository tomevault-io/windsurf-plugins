---
trigger: always_on
description: This document gives automation agents the minimum context needed to work effectively on the tabSidian browser extension codebase. Use it alongside `README.md`, `TODO.md`, and inline comments for deeper detail.
---
...
---
> Source: [cgranier/tabSidian](https://github.com/cgranier/tabSidian) — distributed by [TomeVault](https://tomevault.io).
