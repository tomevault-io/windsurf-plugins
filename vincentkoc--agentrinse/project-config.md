---
trigger: always_on
description: AgentRinse is a safety-critical local cleanup planner. Unknown state is
---
...
---
> Source: [vincentkoc/agentrinse](https://github.com/vincentkoc/agentrinse) — distributed by [TomeVault](https://tomevault.io).
