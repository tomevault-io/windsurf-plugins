---
trigger: always_on
description: HPRO (Hamiltonian Projection and Reconstruction to atomic Orbitals) is a Python package for converting plane-wave DFT results to atomic orbital basis.
---
...
---
> Source: [Xiaoxun-Gong/HPRO](https://github.com/Xiaoxun-Gong/HPRO) — distributed by [TomeVault](https://tomevault.io).
