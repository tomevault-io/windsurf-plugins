---
trigger: always_on
description: The `data_loading` code location wraps the standalone **`ol_dlt`** dlt project
---
...
---
> Source: [mitodl/ol-data-platform](https://github.com/mitodl/ol-data-platform) — distributed by [TomeVault](https://tomevault.io).
