...
Original source: `AGENTS.md` in [synatrahq/synatra](https://github.com/synatrahq/synatra).
...
```
npx tomevault install synatrahq/synatra
```
Source: [github.com/synatrahq/synatra](https://github.com/synatrahq/synatra).
