---
trigger: always_on
description: Settings UI (group 134) changes often — tab indices, `param0` values, and widget types all shift across game updates. Never hardcode; always verify at runtime.
---
...
---
> Source: [chsami/Microbot](https://github.com/chsami/Microbot) — distributed by [TomeVault](https://tomevault.io).
