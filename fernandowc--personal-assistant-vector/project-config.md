---
trigger: always_on
description: XiaoZhi is an ESP-IDF C/C++ voice-assistant firmware supporting many chips, boards, displays, audio devices, and network transports. A build selects exactly one board implementation.
---
...
---
> Source: [fernandowc/personal-assistant-vector](https://github.com/fernandowc/personal-assistant-vector) — distributed by [TomeVault](https://tomevault.io).
