---
trigger: always_on
description: - 每个模型类型必须配对特定的 Formatter（见 [`mori.py:_create_model()`](../../mori/mori.py:127)）
---
...
---
> Source: [acgurl/mori](https://github.com/acgurl/mori) — distributed by [TomeVault](https://tomevault.io).
