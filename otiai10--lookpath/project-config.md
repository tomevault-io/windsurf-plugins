---
trigger: always_on
description: Zero-dependency TypeScript library for finding executables in PATH (npm equivalent of Go's `exec.LookPath`). The entire implementation is ~89 lines in `src/index.ts`.
---
...
---
> Source: [otiai10/lookpath](https://github.com/otiai10/lookpath) — distributed by [TomeVault](https://tomevault.io).
