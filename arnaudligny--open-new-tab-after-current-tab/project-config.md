---
trigger: always_on
description: **Open New Tab After Current Tab** is a Chromium browser extension (Manifest V3) for Google Chrome and Microsoft Edge. It intercepts new tab creation and moves the new tab to the position immediately after the currently active tab, instead of the browser default of opening it at the end of the tab strip.
---
...
---
> Source: [ArnaudLigny/Open-New-Tab-After-Current-Tab](https://github.com/ArnaudLigny/Open-New-Tab-After-Current-Tab) — distributed by [TomeVault](https://tomevault.io).
