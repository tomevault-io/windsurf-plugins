---
trigger: always_on
description: **This file provides project-specific context for Claude Code and its agents.**
---
...
---
> Source: [senaiverse/claude-code-reactnative-expo-agent-system](https://github.com/senaiverse/claude-code-reactnative-expo-agent-system) — distributed by [TomeVault](https://tomevault.io).
