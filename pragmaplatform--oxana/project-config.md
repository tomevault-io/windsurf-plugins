---
trigger: always_on
description: This file provides guidance to any coding agent (Claude, ChatGPT, etc.) when working with code in this repository.
---
...
---
> Source: [pragmaplatform/oxana](https://github.com/pragmaplatform/oxana) — distributed by [TomeVault](https://tomevault.io).
