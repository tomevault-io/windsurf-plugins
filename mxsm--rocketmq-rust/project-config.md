---
trigger: always_on
description: This is the standalone Rust backend for the Tauri app.
---
...
---
> Source: [mxsm/rocketmq-rust](https://github.com/mxsm/rocketmq-rust) — distributed by [TomeVault](https://tomevault.io).
