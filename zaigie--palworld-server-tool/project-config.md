---
trigger: always_on
description: 除非维护者明确要求采用其他方式，否则发布正式版本时遵循以下流程。
---
...
---
> Source: [zaigie/palworld-server-tool](https://github.com/zaigie/palworld-server-tool) — distributed by [TomeVault](https://tomevault.io).
