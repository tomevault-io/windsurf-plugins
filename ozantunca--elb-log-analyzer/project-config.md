---
trigger: always_on
description: **elb-log-analyzer** is a Node.js CLI tool and library for analyzing AWS ELB/ALB access log files. It is a single-package TypeScript project (not a monorepo) with no external service dependencies.
---
...
---
> Source: [ozantunca/elb-log-analyzer](https://github.com/ozantunca/elb-log-analyzer) — distributed by [TomeVault](https://tomevault.io).
