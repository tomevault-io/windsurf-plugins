---
trigger: always_on
description: These rules apply to work inside `dcapal-frontend/`. Read the repository root `AGENTS.md`, `CONTEXT-MAP.md`, this app's `CONTEXT.md`, and any relevant ADRs before changing behavior.
---
...
---
> Source: [dcapal/dcapal](https://github.com/dcapal/dcapal) — distributed by [TomeVault](https://tomevault.io).
