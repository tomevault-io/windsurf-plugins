---
trigger: always_on
description: The canonical contributor guide for this repo is [`AGENTS.md`](../AGENTS.md). It covers setup, commands, package shape, architecture boundaries, naming, error handling, interceptor order, the request lifecycle, cancellation, common pitfalls, tests, and security-sensitive code.
---
...
---
> Source: [axios/axios](https://github.com/axios/axios) — distributed by [TomeVault](https://tomevault.io).
