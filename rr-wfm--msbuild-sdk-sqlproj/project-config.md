---
trigger: always_on
description: - This repository ships an MSBuild SDK that builds SQL projects into `.dacpac` artifacts.
---
...
---
> Source: [rr-wfm/MSBuild.Sdk.SqlProj](https://github.com/rr-wfm/MSBuild.Sdk.SqlProj) — distributed by [TomeVault](https://tomevault.io).
