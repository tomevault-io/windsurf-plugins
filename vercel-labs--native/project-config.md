---
trigger: always_on
description: Guidance for agents (and humans) working on this repository.
---
...
---
> Source: [vercel-labs/native](https://github.com/vercel-labs/native) — distributed by [TomeVault](https://tomevault.io).
