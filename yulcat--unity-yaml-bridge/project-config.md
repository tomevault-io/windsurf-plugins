---
trigger: always_on
description: Bidirectional parser between Unity YAML (.prefab/.scene/.asset) and an AI-friendly compact format.
---
...
---
> Source: [yulcat/unity-yaml-bridge](https://github.com/yulcat/unity-yaml-bridge) — distributed by [TomeVault](https://tomevault.io).
