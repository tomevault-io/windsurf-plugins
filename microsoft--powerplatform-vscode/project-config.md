---
trigger: always_on
description: - The Power Platform VS Code extension desktop code is under `src/client/`.
---
...
---
> Source: [microsoft/powerplatform-vscode](https://github.com/microsoft/powerplatform-vscode) — distributed by [TomeVault](https://tomevault.io).
