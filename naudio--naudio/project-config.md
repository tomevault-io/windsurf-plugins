---
trigger: always_on
description: This file gives AI agents (Claude, etc.) the conventions for contributing to NAudio. Humans should read [README.md](README.md) and [Docs/Architecture/](Docs/Architecture/) instead.
---
...
---
> Source: [naudio/NAudio](https://github.com/naudio/NAudio) — distributed by [TomeVault](https://tomevault.io).
