---
trigger: always_on
description: ClangSharp provides Clang bindings in C#. It is **self-hosted**: the hand-written generator parses the
---
...
---
> Source: [dotnet/ClangSharp](https://github.com/dotnet/ClangSharp) — distributed by [TomeVault](https://tomevault.io).
