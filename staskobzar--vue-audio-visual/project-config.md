---
trigger: always_on
description: Purpose: short reference for Copilot sessions to quickly understand how to build, test, lint, and navigate this repository.
---
...
---
> Source: [staskobzar/vue-audio-visual](https://github.com/staskobzar/vue-audio-visual) — distributed by [TomeVault](https://tomevault.io).
