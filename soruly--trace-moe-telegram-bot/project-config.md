---
trigger: always_on
description: **trace.moe-telegram-bot** is the official Telegram Bot for [trace.moe](https://trace.moe) (anime scene search engine). It allows users and groups to identify anime, episodes, and timestamps by sending images, GIFs, or videos, and provides animated video previews.
---
...
---
> Source: [soruly/trace.moe-telegram-bot](https://github.com/soruly/trace.moe-telegram-bot) — distributed by [TomeVault](https://tomevault.io).
