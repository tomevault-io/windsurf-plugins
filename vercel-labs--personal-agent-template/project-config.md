---
trigger: always_on
description: Durable personal AI assistant built with Eve and Nuxt 4.
---
...
---
> Source: [vercel-labs/personal-agent-template](https://github.com/vercel-labs/personal-agent-template) — distributed by [TomeVault](https://tomevault.io).
