---
trigger: always_on
description: umBRELA is a Python package for LLM-based relevance assessment of query-passage pairs, reproducing the Bing RELevance Assessor. It assigns 4-class relevance labels (0-3) to query-document pairs using various LLMs.
---
...
---
> Source: [castorini/umbrela](https://github.com/castorini/umbrela) — distributed by [TomeVault](https://tomevault.io).
