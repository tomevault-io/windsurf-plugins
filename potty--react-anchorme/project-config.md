---
trigger: always_on
description: React component library (v5.0.0) that uses [anchorme.js](https://github.com/alexcorvi/anchorme.js) to detect URLs, emails, and IP addresses in text and convert them into clickable links. Published as dual CJS/ESM via Rollup.
---
...
---
> Source: [potty/react-anchorme](https://github.com/potty/react-anchorme) — distributed by [TomeVault](https://tomevault.io).
