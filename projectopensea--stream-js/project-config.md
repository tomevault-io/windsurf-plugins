---
trigger: always_on
description: WebSocket client for real-time OpenSea marketplace event streaming via the Stream API (Phoenix Channels).
---
...
---
> Source: [ProjectOpenSea/stream-js](https://github.com/ProjectOpenSea/stream-js) — distributed by [TomeVault](https://tomevault.io).
