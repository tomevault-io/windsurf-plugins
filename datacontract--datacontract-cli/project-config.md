---
trigger: always_on
description: python3.11 -m venv venv
---
...
---
> Source: [datacontract/datacontract-cli](https://github.com/datacontract/datacontract-cli) — distributed by [TomeVault](https://tomevault.io).
