---
trigger: always_on
description: - This file defines mandatory rules for AI agents and humans using AI while
---
...
---
> Source: [grycap/oscar](https://github.com/grycap/oscar) — distributed by [TomeVault](https://tomevault.io).
