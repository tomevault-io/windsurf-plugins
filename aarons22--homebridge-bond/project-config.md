---
trigger: always_on
description: This repository contains a Homebridge plugin for Bond devices. For comprehensive coding instructions, architecture details, and development workflows, please refer to:
---
