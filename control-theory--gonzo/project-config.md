---
trigger: always_on
description: This repo includes a Claude Code plugin with a guided log-analysis skill at `skills/gonzo/`.
---
...
---
> Source: [control-theory/gonzo](https://github.com/control-theory/gonzo) — distributed by [TomeVault](https://tomevault.io).
