---
trigger: always_on
description: This repository is the TypeScript source for the `agy-hud` Antigravity CLI status-line plugin.
---
...
---
> Source: [franksde/agy-hud](https://github.com/franksde/agy-hud) — distributed by [TomeVault](https://tomevault.io).
