---
trigger: always_on
description: - `make`, `make all`, or `make build`: Build the `openshift-router` executable.
---
...
---
> Source: [openshift/router](https://github.com/openshift/router) — distributed by [TomeVault](https://tomevault.io).
