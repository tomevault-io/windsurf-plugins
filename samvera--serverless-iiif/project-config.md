---
trigger: always_on
description: - `src/`: TypeScript Lambda handler and helpers (`index.ts`, `helpers.ts`, `resolvers.ts`, `error.ts`, `streamify.ts`).
---
...
---
> Source: [samvera/serverless-iiif](https://github.com/samvera/serverless-iiif) — distributed by [TomeVault](https://tomevault.io).
