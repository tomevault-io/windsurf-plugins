---
trigger: always_on
description: Converts Pulumi Package Schema (JSON) into typed Java SDK source files (resources, args, outputs, enums, build files).
---
...
---
> Source: [pulumi/pulumi-java](https://github.com/pulumi/pulumi-java) — distributed by [TomeVault](https://tomevault.io).
