---
trigger: always_on
description: This is a **meta-repository** for Claude Code. It serves as a unified workspace with shared skills, commands, and hooks — so every team member gets consistent, high-quality AI assistance from day one.
---
...
---
> Source: [Benkapner/claude-code-basecamp](https://github.com/Benkapner/claude-code-basecamp) — distributed by [TomeVault](https://tomevault.io).
