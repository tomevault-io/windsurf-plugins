---
trigger: always_on
description: This document provides instructions for agentic coding agents (like GitHub
---
...
---
> Source: [yamlresume/yamlresume](https://github.com/yamlresume/yamlresume) — distributed by [TomeVault](https://tomevault.io).
