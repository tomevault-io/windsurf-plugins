...
Original source: `AGENTS.md` in [KaminDeng/dp_sdk_core](https://github.com/KaminDeng/dp_sdk_core).
...
```
npx tomevault install KaminDeng/dp_sdk_core
```
Source: [github.com/KaminDeng/dp_sdk_core](https://github.com/KaminDeng/dp_sdk_core).
