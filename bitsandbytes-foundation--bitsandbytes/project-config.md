---
trigger: always_on
description: NEVER work on a fix or feature branch inside the main `~/git/bitsandbytes` checkout. Always create a worktree first:
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/bitsandbytes-foundation)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/bitsandbytes-foundation)
