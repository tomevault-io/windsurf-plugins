---
trigger: always_on
description: > Java 扩展点框架,以 SDK 方式发布到 Maven Central。本文档是 `.claude/` 体系的入口索引,详细规则在 `.claude/rules/` 下。
---
...
---
> Source: [xiaoshicae/easy-extension](https://github.com/xiaoshicae/easy-extension) — distributed by [TomeVault](https://tomevault.io).
