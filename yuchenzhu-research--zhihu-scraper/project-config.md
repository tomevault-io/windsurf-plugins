---
trigger: always_on
description: 后续任何代码代理或自动化协作者进入仓库后，都应优先阅读本文件，再执行具体任务。
---
...
---
> Source: [yuchenzhu-research/zhihu-scraper](https://github.com/yuchenzhu-research/zhihu-scraper) — distributed by [TomeVault](https://tomevault.io).
