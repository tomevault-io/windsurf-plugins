---
trigger: always_on
description: Welcome, AI Assistant! This repository is the central hub for **Reconmap**, an open-source pentesting management and automation platform.
---
...
---
> Source: [reconmap/reconmap](https://github.com/reconmap/reconmap) — distributed by [TomeVault](https://tomevault.io).
