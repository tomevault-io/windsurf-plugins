---
trigger: always_on
description: Queryx is a schema-first, type-safe ORM for Go and TypeScript. It parses HCL schema files, generates type-safe ORM code, and manages database migrations using Atlas. Supports PostgreSQL, MySQL, and SQLite.
---
...
---
> Source: [swiftcarrot/queryx](https://github.com/swiftcarrot/queryx) — distributed by [TomeVault](https://tomevault.io).
