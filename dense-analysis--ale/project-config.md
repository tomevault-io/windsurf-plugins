---
trigger: always_on
description: Read documentation from @doc/ale-development.txt to understand how to be an
---
...
---
> Source: [dense-analysis/ale](https://github.com/dense-analysis/ale) — distributed by [TomeVault](https://tomevault.io).
