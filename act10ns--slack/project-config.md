---
trigger: always_on
description: GitHub Action that sends Slack notifications for GitHub Actions workflows, jobs, and steps. Used by 3000+ public repos. Published to the GitHub Marketplace as [act10ns/slack](https://github.com/marketplace/actions/slack-action-status).
---
...
---
> Source: [act10ns/slack](https://github.com/act10ns/slack) — distributed by [TomeVault](https://tomevault.io).
