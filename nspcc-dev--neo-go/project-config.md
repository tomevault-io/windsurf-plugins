---
trigger: always_on
description: This document will list conventions that this repo should follow. These are
---
...
---
> Source: [nspcc-dev/neo-go](https://github.com/nspcc-dev/neo-go) — distributed by [TomeVault](https://tomevault.io).
