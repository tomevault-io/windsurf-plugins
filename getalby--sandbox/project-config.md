---
trigger: always_on
description: Educational Lightning Network payment demo application. Allows users to try scenarios that simulate
---
...
---
> Source: [getAlby/sandbox](https://github.com/getAlby/sandbox) — distributed by [TomeVault](https://tomevault.io).
