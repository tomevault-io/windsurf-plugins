---
trigger: always_on
description: Erlang/OTP library for IP geolocation using MaxMind GeoIP2/GeoLite2 databases (MMDB format). Supports loading from HTTP(S) URLs, MaxMind's API, local filesystem, or custom fetchers. Also works with IPinfo and DB-IP. Includes a CLI tool (`locus check`) for database validation.
---
...
---
> Source: [g-andrade/locus](https://github.com/g-andrade/locus) — distributed by [TomeVault](https://tomevault.io).
