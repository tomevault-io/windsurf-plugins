---
trigger: always_on
description: As it is just a `String[]`, you can interpret the arguments passed to your
---
...
---
> Source: [bowbahdoe/ModernJava](https://github.com/bowbahdoe/ModernJava) — distributed by [TomeVault](https://tomevault.io).
