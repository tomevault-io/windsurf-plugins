---
trigger: always_on
description: - Start from the root `Justfile` unless you have a clear reason to drop into a subproject.
---
...
---
> Source: [grimmory-tools/grimmory](https://github.com/grimmory-tools/grimmory) — distributed by [TomeVault](https://tomevault.io).
