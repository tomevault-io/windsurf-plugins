---
trigger: always_on
description: - Keep workflow YAML minimal, readable, and scoped to the repository behavior it automates.
---
...
---
> Source: [PromptPasture/llama.ui](https://github.com/PromptPasture/llama.ui) — distributed by [TomeVault](https://tomevault.io).
