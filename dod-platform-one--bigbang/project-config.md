---
trigger: always_on
description: <!-- big-bang-agents-standard: 1 -->
---
...
---
> Source: [DoD-Platform-One/bigbang](https://github.com/DoD-Platform-One/bigbang) — distributed by [TomeVault](https://tomevault.io).
