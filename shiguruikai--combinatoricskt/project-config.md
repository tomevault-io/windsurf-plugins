---
trigger: always_on
description: This document provides essential context and guidelines for AI agents working on the `combinatoricskt` library.
---
...
---
> Source: [shiguruikai/combinatoricskt](https://github.com/shiguruikai/combinatoricskt) — distributed by [TomeVault](https://tomevault.io).
