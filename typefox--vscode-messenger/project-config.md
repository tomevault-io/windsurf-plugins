---
trigger: always_on
description: Typed RPC library for message-passing between a VS Code extension host and its webviews. TypeScript monorepo managed with npm workspaces (npm ^10.8.0, Node 18+ — CI pins Node 18).
---
