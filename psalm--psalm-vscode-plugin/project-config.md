---
trigger: always_on
description: PSalm VS Code plugin that integrates [Psalm](https://psalm.dev) PHP static analysis into VS Code via the Language Server Protocol. Provides inline diagnostics, type-aware autocompletion, and hover definitions for PHP projects.
---
...
---
> Source: [psalm/psalm-vscode-plugin](https://github.com/psalm/psalm-vscode-plugin) — distributed by [TomeVault](https://tomevault.io).
