---
trigger: always_on
description: **CRITICAL:** All repository artifacts must be written in English.
---
...
---
> Source: [javierbrea/cypress-fail-fast](https://github.com/javierbrea/cypress-fail-fast) — distributed by [TomeVault](https://tomevault.io).
