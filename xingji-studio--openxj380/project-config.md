---
trigger: always_on
description: Kernel/user boundary implementation. This subtree wires syscall entry, dispatch, xapi bridges, user memory copying, signals, and large user-facing syscall handlers.
---
...
---
> Source: [xingji-studio/OpenXJ380](https://github.com/xingji-studio/OpenXJ380) — distributed by [TomeVault](https://tomevault.io).
