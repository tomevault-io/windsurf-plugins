---
trigger: always_on
description: Vertz is a full-stack TypeScript framework. It includes:
---
...
---
> Source: [vertz-dev/vertz](https://github.com/vertz-dev/vertz) — distributed by [TomeVault](https://tomevault.io).
