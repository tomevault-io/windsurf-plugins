---
trigger: always_on
description: This file describes repository-wide guidance for the `flutter-plugins` monorepo. Package-specific guidance may exist deeper in the tree and should be treated as higher-priority context for that subtree.
---
...
---
> Source: [MixinNetwork/flutter-plugins](https://github.com/MixinNetwork/flutter-plugins) — distributed by [TomeVault](https://tomevault.io).
