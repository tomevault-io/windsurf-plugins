---
trigger: always_on
description: Valkyrie converts SVG/XML icons to Compose `ImageVector` Kotlin code. It ships as four tools sharing the same core
---
...
---
> Source: [ComposeGears/Valkyrie](https://github.com/ComposeGears/Valkyrie) — distributed by [TomeVault](https://tomevault.io).
