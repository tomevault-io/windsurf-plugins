---
trigger: always_on
description: * prefer `function` over `const` for components
---
...
---
> Source: [veloplanner/map-matrix](https://github.com/veloplanner/map-matrix) — distributed by [TomeVault](https://tomevault.io).
