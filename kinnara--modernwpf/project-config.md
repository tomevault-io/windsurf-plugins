---
trigger: always_on
description: This file applies to the entire repository unless a more specific `AGENTS.md`
---
...
---
> Source: [Kinnara/ModernWpf](https://github.com/Kinnara/ModernWpf) — distributed by [TomeVault](https://tomevault.io).
