---
trigger: always_on
description: When working on anything Next.js-related in this repo (routing, data fetching, caching, config, deployment, errors):
---
...
---
> Source: [yaGeey/osu-find-songs](https://github.com/yaGeey/osu-find-songs) — distributed by [TomeVault](https://tomevault.io).
