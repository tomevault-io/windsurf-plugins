---
trigger: always_on
description: This file applies to the entire repository. Keep it short: it defines durable
---
...
---
> Source: [appautomaton/mlx-h3](https://github.com/appautomaton/mlx-h3) — distributed by [TomeVault](https://tomevault.io).
