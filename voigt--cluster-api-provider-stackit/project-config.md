---
trigger: always_on
description: This guide is the primary instruction file for AI coding agents working in this repository.
---
...
---
> Source: [voigt/cluster-api-provider-stackit](https://github.com/voigt/cluster-api-provider-stackit) — distributed by [TomeVault](https://tomevault.io).
