---
trigger: always_on
description: Read root `AGENTS.md` first. This file covers `singer-connectors/`; use scoped E2E, implementation, test, and docs guidance when those areas are involved.
---
