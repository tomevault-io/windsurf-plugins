---
trigger: always_on
description: Instructions for AI coding agents working on this Erlang DNS server project.
---
...
---
> Source: [dnsimple/erldns](https://github.com/dnsimple/erldns) — distributed by [TomeVault](https://tomevault.io).
