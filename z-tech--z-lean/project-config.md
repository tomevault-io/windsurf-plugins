---
trigger: always_on
description: Guidance for both human contributors and AI assistants (Claude Code,
---
...
---
> Source: [z-tech/z-lean](https://github.com/z-tech/z-lean) — distributed by [TomeVault](https://tomevault.io).
