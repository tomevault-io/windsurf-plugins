---
trigger: always_on
description: Hify 是一个简版的 AI Agent 开发平台（参考 Dify），可本地部署，面向团队内部小规模使用（20-50 人同时在线）。
---
...
---
> Source: [socutes/hify](https://github.com/socutes/hify) — distributed by [TomeVault](https://tomevault.io).
