---
trigger: always_on
description: This file provides guidance when working on this repository.
---
...
---
> Source: [hakanensari/structure](https://github.com/hakanensari/structure) — distributed by [TomeVault](https://tomevault.io).
