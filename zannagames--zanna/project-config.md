---
trigger: always_on
description: This file is the tool-agnostic operating guide for AI coding agents (Codex,
---
...
---
> Source: [zannagames/zanna](https://github.com/zannagames/zanna) — distributed by [TomeVault](https://tomevault.io).
