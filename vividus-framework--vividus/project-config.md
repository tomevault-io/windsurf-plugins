---
trigger: always_on
description: Before committing any Java changes, run the full quality suite for every affected module
---
...
---
> Source: [vividus-framework/vividus](https://github.com/vividus-framework/vividus) — distributed by [TomeVault](https://tomevault.io).
