---
trigger: always_on
description: Doubean is an unofficial Android app for [Douban](https://www.douban.com/) (Groups, Books, Movies, TVs), built with
---
...
- **UI**: Compose only. Use `DoubeanTheme`. We use a slightly refined Material 3 style (crisper, less
  bubbly).
...
---
> Source: [Bumblebee202111/doubean-public](https://github.com/Bumblebee202111/doubean-public) — distributed by [TomeVault](https://tomevault.io).
