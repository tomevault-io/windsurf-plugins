---
trigger: always_on
description: Files_MacOS is a C#/.NET 10 desktop file manager for macOS. It uses Uno Platform for the UI and a native Objective-C/AppKit bridge for macOS integration.
---
...
---
> Source: [zixing131/Files_MacOS](https://github.com/zixing131/Files_MacOS) — distributed by [TomeVault](https://tomevault.io).
