---
trigger: always_on
description: EpiModel-Gallery is a collection of template examples for extending the EpiModel R package to model infectious disease dynamics over networks. Examples focus on stochastic network models using ERGMs (exponential random graph models). EpiModel itself is documented at https://github.com/statnet/EpiModel.
---
...
---
> Source: [EpiModel/EpiModel-Gallery](https://github.com/EpiModel/EpiModel-Gallery) — distributed by [TomeVault](https://tomevault.io).
