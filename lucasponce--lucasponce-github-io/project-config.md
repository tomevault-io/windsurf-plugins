---
trigger: always_on
description: This project is a static web application that displays an interactive map of archaeological sites from the Roman and Visigothic periods in Spain using Google Maps.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/lucasponce)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/lucasponce)
