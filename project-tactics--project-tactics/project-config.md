---
trigger: always_on
description: Do not change code, resources, build files, scripts, or project metadata unless the user explicitly grants permission for
---
...
---
> Source: [Project-Tactics/Project-Tactics](https://github.com/Project-Tactics/Project-Tactics) — distributed by [TomeVault](https://tomevault.io).
