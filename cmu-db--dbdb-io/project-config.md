---
trigger: always_on
description: This repository is a Django-based "Database of Databases" web app (Django 6.0). Use this file as a compact, actionable guide so code changes are small, safe, and aligned with existing conventions.
---
...
---
> Source: [cmu-db/dbdb.io](https://github.com/cmu-db/dbdb.io) — distributed by [TomeVault](https://tomevault.io).
