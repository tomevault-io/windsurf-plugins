---
trigger: always_on
description: - `pygase/connection.py`: protocol and transport core. Defines package/header serialization, sequence/ack tracking, connection status, and client/server connection classes that send and receive UDP datagrams.
---
...
---
> Source: [sbischoff-ai/pygase](https://github.com/sbischoff-ai/pygase) — distributed by [TomeVault](https://tomevault.io).
