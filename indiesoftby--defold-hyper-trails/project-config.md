---
trigger: always_on
description: It's a library made for the Defold game engine. The Defold engine is a 2D game engine, but it can also be used to make 3D games. It uses Lua 5.1 as its scripting language with "bit" module for bitwise operations. Developers write Lua code in the files with ".lua", ".script", ".gui_script", ".render_script", ".editor_script" extensions. Source code is formatted with tabs (4 spaces width) for indentation. "snake_case" is used for variable, function, file, folder names. It uses LDoc for documentati
---
...
---
> Source: [indiesoftby/defold-hyper-trails](https://github.com/indiesoftby/defold-hyper-trails) — distributed by [TomeVault](https://tomevault.io).
