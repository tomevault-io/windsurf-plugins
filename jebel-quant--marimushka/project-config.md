---
trigger: always_on
description: You are working in a project that utilises the `rhiza` framework. Rhiza is a collection of reusable
---
...
---
> Source: [Jebel-Quant/marimushka](https://github.com/Jebel-Quant/marimushka) — distributed by [TomeVault](https://tomevault.io).
