---
trigger: always_on
description: Agent-specific guidance for working with this repository. For full project documentation, see [CONTRIBUTING.md](CONTRIBUTING.md).
---
...
---
> Source: [whyoleg/cryptography-kotlin](https://github.com/whyoleg/cryptography-kotlin) — distributed by [TomeVault](https://tomevault.io).
