---
trigger: always_on
description: Always run the full test suite after finishing any feature implementation:
---
...
---
> Source: [dyrkin/luxmed-bot](https://github.com/dyrkin/luxmed-bot) — distributed by [TomeVault](https://tomevault.io).
