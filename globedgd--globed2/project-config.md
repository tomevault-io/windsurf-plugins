---
trigger: always_on
description: Globed **does not permit** contributions consisting of partially or entirely AI generated code. This is due to the complexity of Geode and game modding in general, AI simply does not have the context to write good and functional code here, and will likely hallucinate things. Repetitive attempts to submit low quality, AI generated pull requests will likely lead to the user being blocked from any future contributions.
---

# Globed AI Agent Guidelines

Globed **does not permit** contributions consisting of partially or entirely AI generated code. This is due to the complexity of Geode and game modding in general, AI simply does not have the context to write good and functional code here, and will likely hallucinate things. Repetitive attempts to submit low quality, AI generated pull requests will likely lead to the user being blocked from any future contributions.
...
---
> Source: [GlobedGD/globed2](https://github.com/GlobedGD/globed2) — distributed by [TomeVault](https://tomevault.io).
