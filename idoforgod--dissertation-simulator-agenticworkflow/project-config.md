---
trigger: always_on
description: AgenticWorkflow 방법론 — 이 프로젝트의 모든 작업에 적용
---
...
**반드시 `AGENTS.md`를 읽고 해당 규칙을 따라야 한다.**
...
### English-First 강제 (MANDATORY)

> 워크플로우 전체 진행·에이전트 작업·최종 결과물은 **영어** (강제). 영어 원본 완성 → `@translator`로 한국어 번역 (순서 역전 불가). 절대 기준 1(품질)의 직접적 구현. 상세: AGENTS.md §5.2

- **프레임워크 문서·사용자 대화**: 한국어 (허용) / **기술 용어**: 영어 유지 / **시각화**: Mermaid 선호

---
> Source: [idoforgod/Dissertation-Simulator-AgenticWorkflow](https://github.com/idoforgod/Dissertation-Simulator-AgenticWorkflow) — distributed by [TomeVault](https://tomevault.io).
