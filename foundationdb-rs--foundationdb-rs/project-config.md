---
trigger: always_on
description: This file provides guidance to coding agents (Claude Code, etc.) when working with code in
---
...
---
> Source: [foundationdb-rs/foundationdb-rs](https://github.com/foundationdb-rs/foundationdb-rs) — distributed by [TomeVault](https://tomevault.io).
