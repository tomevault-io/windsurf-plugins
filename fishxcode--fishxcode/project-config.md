---
trigger: always_on
description: FishXCode 是一个 **AI Coding 中转站**，支持 Claude、Codex 等主流 AI 模型在多种平台使用。本仓库包含两个核心部分：
---
...
---
> Source: [fishxcode/fishxcode](https://github.com/fishxcode/fishxcode) — distributed by [TomeVault](https://tomevault.io).
