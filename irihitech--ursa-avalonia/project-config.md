---
trigger: always_on
description: Ursa.Avalonia is an enterprise-level UI library for building cross-platform applications with Avalonia UI. This is a .NET 8.0 library that provides advanced UI controls and themes for Avalonia applications.
---
...
---
> Source: [irihitech/Ursa.Avalonia](https://github.com/irihitech/Ursa.Avalonia) — distributed by [TomeVault](https://tomevault.io).
