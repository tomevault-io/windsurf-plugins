---
trigger: always_on
description: <!-- BEGIN:dry-run-worktree-rules -->
---
...
---
> Source: [vercel-labs/ds-skill-extraction-workshop](https://github.com/vercel-labs/ds-skill-extraction-workshop) — distributed by [TomeVault](https://tomevault.io).
