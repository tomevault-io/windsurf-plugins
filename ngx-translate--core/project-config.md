---
trigger: always_on
description: - This monorepo contains the main `@ngx-translate/core` library (Angular i18n), the `@ngx-translate/http-loader` for loading translations via HTTP, and related test/demo apps.
---
...
---
> Source: [ngx-translate/core](https://github.com/ngx-translate/core) — distributed by [TomeVault](https://tomevault.io).
