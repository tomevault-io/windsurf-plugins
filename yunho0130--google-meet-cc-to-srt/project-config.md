---
trigger: always_on
description: - `manifest.json` defines the Chrome Extension (MV3) entry points and permissions.
---
...
---
> Source: [yunho0130/google-meet-cc-to-srt](https://github.com/yunho0130/google-meet-cc-to-srt) — distributed by [TomeVault](https://tomevault.io).
