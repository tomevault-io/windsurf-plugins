---
trigger: always_on
description: This is a ClojureScript (re-frame) music editor for Indian classical music bandishes.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/Studio-kalavati)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/Studio-kalavati)
