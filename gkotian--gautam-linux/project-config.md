---
trigger: always_on
description: When formatting code to stay under 80 characters, use a compact style:
---
...
---
> Source: [gkotian/gautam_linux](https://github.com/gkotian/gautam_linux) — distributed by [TomeVault](https://tomevault.io).
