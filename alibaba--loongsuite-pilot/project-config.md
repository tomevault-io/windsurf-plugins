---
trigger: always_on
description: > 多 AI Agent 轻量数据采集平台 — 自动发现、多种采集方式、多目标数据输出
---
...
---
> Source: [alibaba/loongsuite-pilot](https://github.com/alibaba/loongsuite-pilot) — distributed by [TomeVault](https://tomevault.io).
