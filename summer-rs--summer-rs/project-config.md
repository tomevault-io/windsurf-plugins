---
trigger: always_on
description: 本文档面向在本仓库中协助开发或审查代码的自动化代理（AI Agent）与人类贡献者，说明项目结构、常用命令与约定。
---
...
---
> Source: [summer-rs/summer-rs](https://github.com/summer-rs/summer-rs) — distributed by [TomeVault](https://tomevault.io).
