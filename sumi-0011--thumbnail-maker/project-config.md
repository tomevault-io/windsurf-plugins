---
trigger: always_on
description: 썸네일 제작 도구 - React + TypeScript + Vite 기반
---
...
---
> Source: [sumi-0011/Thumbnail-Maker](https://github.com/sumi-0011/Thumbnail-Maker) — distributed by [TomeVault](https://tomevault.io).
