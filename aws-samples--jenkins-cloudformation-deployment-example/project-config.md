---
trigger: always_on
description: Setup a Kubernetes YAML template after you've built the agent image. In this example, we will be using the [k8sPodTemplate.yaml](https://github.com/aws-samples/jenkins-cloudformation-deployment-example/blob/main/k8s/k8sPodTemplate.yaml) file stored in the `k8s/` folder.
---
...
---
> Source: [aws-samples/jenkins-cloudformation-deployment-example](https://github.com/aws-samples/jenkins-cloudformation-deployment-example) — distributed by [TomeVault](https://tomevault.io).
