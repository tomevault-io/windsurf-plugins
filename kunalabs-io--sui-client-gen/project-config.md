---
trigger: always_on
description: handles packages that `move_package_alt` identifies as `"unnamed_legacy_package"`
---
...
---
> Source: [kunalabs-io/sui-client-gen](https://github.com/kunalabs-io/sui-client-gen) — distributed by [TomeVault](https://tomevault.io).
