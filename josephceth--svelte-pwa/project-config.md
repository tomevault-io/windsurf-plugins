...
These new runes do not have to be imported they are native to all svelte files
...
the $state, $props, and $derrived runes do not have to be imported.
```html
<script>
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/josephceth) — claim your Tome and manage your conversions.
