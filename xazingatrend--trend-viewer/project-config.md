---
trigger: always_on
description: > Daily trend viewer port. Upstream: single-file Python stdlib server (`_upstream/`). Target: feature-based modular Python (stdlib-only, no external deps).
---
...
---
> Source: [xazingatrend/trend-viewer](https://github.com/xazingatrend/trend-viewer) — distributed by [TomeVault](https://tomevault.io).
