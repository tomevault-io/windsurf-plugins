---
trigger: always_on
description: `make format` to format, `make lint` to check. Rebuild formatter image after editing `Dockerfile.formatter` with `make build-formatter-image`.
---
...
---
> Source: [DataDog/nginx-datadog](https://github.com/DataDog/nginx-datadog) — distributed by [TomeVault](https://tomevault.io).
