---
trigger: always_on
description: This repo contains the MEGA-Code plugin surfaces:
---
...
---
> Source: [wisdomgraph/mega-code](https://github.com/wisdomgraph/mega-code) — distributed by [TomeVault](https://tomevault.io).
