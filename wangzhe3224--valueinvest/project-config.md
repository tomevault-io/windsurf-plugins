---
trigger: always_on
description: 本文档为 AI Agent 提供库的快速参考和常用模式。
---
...
---
> Source: [wangzhe3224/valueinvest](https://github.com/wangzhe3224/valueinvest) — distributed by [TomeVault](https://tomevault.io).
