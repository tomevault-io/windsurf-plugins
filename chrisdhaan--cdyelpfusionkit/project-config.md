---
trigger: always_on
description: CDYelpFusionKit is a Swift framework that wraps the Yelp Fusion REST API. It provides typed request/response models and a dependency-free URLSession-backed HTTP client.
---
...
---
> Source: [chrisdhaan/CDYelpFusionKit](https://github.com/chrisdhaan/CDYelpFusionKit) — distributed by [TomeVault](https://tomevault.io).
