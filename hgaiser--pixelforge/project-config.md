---
trigger: always_on
description: Pixelforge is a Rust library for video encoding using Vulkan Video.
---
...
---
> Source: [hgaiser/pixelforge](https://github.com/hgaiser/pixelforge) — distributed by [TomeVault](https://tomevault.io).
