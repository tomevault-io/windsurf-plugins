---
trigger: always_on
description: This repository contains two book projects: `book1-claude-code/` and `book2-comparing/`. Each book keeps its manuscript in root-level Markdown files such as `README.md`, `SUMMARY.md`, `preface.md`, and `chapter-*.md`.
---
...
---
> Source: [wquguru/harness-books](https://github.com/wquguru/harness-books) — distributed by [TomeVault](https://tomevault.io).
