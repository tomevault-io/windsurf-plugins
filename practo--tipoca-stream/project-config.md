---
trigger: always_on
description: House style observed across the codebase. Follow these when adding code.
---
...
---
> Source: [practo/tipoca-stream](https://github.com/practo/tipoca-stream) — distributed by [TomeVault](https://tomevault.io).
