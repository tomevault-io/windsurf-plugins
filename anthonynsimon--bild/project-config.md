---
trigger: always_on
description: Pure Go image processing library (`github.com/anthonynsimon/bild`) with a built-in CLI. Minimal dependencies — just cobra for CLI and `golang.org/x/image` for BMP support.
---
...
---
> Source: [anthonynsimon/bild](https://github.com/anthonynsimon/bild) — distributed by [TomeVault](https://tomevault.io).
