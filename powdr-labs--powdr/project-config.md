---
trigger: always_on
description: Single-page web app for visualizing Automatic Precompile (APC) candidate effectiveness in zkVM systems. Port of `plot_effectiveness.py` from powdr.
---
...
---
> Source: [powdr-labs/powdr](https://github.com/powdr-labs/powdr) — distributed by [TomeVault](https://tomevault.io).
