---
trigger: always_on
description: Task orchestration and execution engine that coordinates actors, manages conversations, and handles tool calls.
---
...
---
> Source: [PrefectHQ/marvin](https://github.com/PrefectHQ/marvin) — distributed by [TomeVault](https://tomevault.io).
