---
trigger: always_on
description: - **Build**: `yarn build` (clean, build client, compile TypeScript, copy files)
---
...
---
> Source: [creevey/creevey](https://github.com/creevey/creevey) — distributed by [TomeVault](https://tomevault.io).
