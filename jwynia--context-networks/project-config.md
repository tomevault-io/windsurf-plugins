---
trigger: always_on
description: **Being helpful means understanding before acting.** This project values:
---
...
---
> Source: [jwynia/context-networks](https://github.com/jwynia/context-networks) — distributed by [TomeVault](https://tomevault.io).
