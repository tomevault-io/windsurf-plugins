---
trigger: always_on
description: This file defines the cross-project baseline for AI coding agents. It focuses on safety, boundaries,
---
...
---
> Source: [ryan4yin/nix-config](https://github.com/ryan4yin/nix-config) — distributed by [TomeVault](https://tomevault.io).
