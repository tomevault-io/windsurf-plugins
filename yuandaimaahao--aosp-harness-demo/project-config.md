---
trigger: always_on
description: <!-- DEMO —— 这是《AOSP 整机源码 Harness 工程探索》的示例文件，非真实约束。
---
...
---
> Source: [yuandaimaahao/aosp-harness-demo](https://github.com/yuandaimaahao/aosp-harness-demo) — distributed by [TomeVault](https://tomevault.io).
