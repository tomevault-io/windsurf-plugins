---
trigger: always_on
description: Bootstrap 4 template tags and filters for Django, by [Zostera](https://github.com/zostera).
---

# django-bootstrap4 — Agent Guide

Bootstrap 4 template tags and filters for Django, by [Zostera](https://github.com/zostera).
...
- `https://github.com/zostera/django-bootstrap4` — Bootstrap 4 for Django (this package)
...
src/bootstrap4/
    ...
    templatetags/
        bootstrap4.py   all template tags and filters
...
---
> Source: [zostera/django-bootstrap4](https://github.com/zostera/django-bootstrap4) — distributed by [TomeVault](https://tomevault.io).
