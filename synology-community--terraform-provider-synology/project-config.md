---
trigger: always_on
description: - All new packages and most new significant functionality must come with unit tests.
---
...
---
> Source: [synology-community/terraform-provider-synology](https://github.com/synology-community/terraform-provider-synology) — distributed by [TomeVault](https://tomevault.io).
