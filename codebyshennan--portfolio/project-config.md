---
trigger: always_on
description: Provide concise, actionable guidance for AI coding agents working on this Next.js portfolio repo so they can be productive immediately.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/codebyshennan)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/codebyshennan)
