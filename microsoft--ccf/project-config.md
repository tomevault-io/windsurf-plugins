---
trigger: always_on
description: When reviewing changes to `CHANGELOG.md`, always verify that every new or modified entry includes a reference to the pull request that introduced the change, in the form `(#1234)` at the end of the entry (matching the existing convention).
---
...
---
> Source: [microsoft/CCF](https://github.com/microsoft/CCF) — distributed by [TomeVault](https://tomevault.io).
