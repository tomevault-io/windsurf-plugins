---
trigger: always_on
description: - When changing homepage or shared theme text, update every file in `_data/locales/` so non-English locale files do not keep English fallback strings.
---
