---
trigger: always_on
description: When modifying any of these template source files, you **MUST** also update the migration skill documentation:
---
...
---
> Source: [Axect/pytorch_template](https://github.com/Axect/pytorch_template) — distributed by [TomeVault](https://tomevault.io).
