---
trigger: always_on
description: Agents working in this repository must read [VISION.md](VISION.md) before making product, architecture, scope, or backlog-disposition decisions.
---
...
---
> Source: [nicobailon/pi-subagents](https://github.com/nicobailon/pi-subagents) — distributed by [TomeVault](https://tomevault.io).
