---
trigger: always_on
description: This is the Adyen Node.js API Library, providing Node.js developers with an easy way to interact with the Adyen API. The library is a wrapper around the Adyen API, generated from OpenAPI specifications.
---
...
---
> Source: [Adyen/adyen-node-api-library](https://github.com/Adyen/adyen-node-api-library) — distributed by [TomeVault](https://tomevault.io).
