---
trigger: always_on
description: > Part of the `HFTFramework` repository. See the root [`AGENTS.md`](../AGENTS.md) for the global
---
...
---
> Source: [javifalces/HFTFramework](https://github.com/javifalces/HFTFramework) — distributed by [TomeVault](https://tomevault.io).
