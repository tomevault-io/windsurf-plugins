---
trigger: always_on
description: > **For AI coding agents only.** Keep this file machine-readable and concise. Human-facing docs live in README.md.
---
...
---
> Source: [BlockedPath/pi-xai-oauth](https://github.com/BlockedPath/pi-xai-oauth) — distributed by [TomeVault](https://tomevault.io).
