...
- `deps/` — explain what lives here and when agents should edit it.
- `dev.ps1/` — explain what lives here and when agents should edit it.
- `docs/` — explain what lives here and when agents should edit it.
- `frontend/` — explain what lives here and when agents should edit it.
- `go.mod/` — explain what lives here and when agents should edit it.
- `go.sum/` — explain what lives here and when agents should edit it.
- `internal/` — explain what lives here and when agents should edit it.
...
---
> Source: [jvkabum/Lumaestro](https://github.com/jvkabum/Lumaestro) — distributed by [TomeVault](https://tomevault.io).
