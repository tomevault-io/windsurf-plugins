---
trigger: always_on
description: The Simperium client library for Apple platforms, written in Objective-C.
---
...
---
> Source: [Simperium/simperium-ios](https://github.com/Simperium/simperium-ios) — distributed by [TomeVault](https://tomevault.io).
