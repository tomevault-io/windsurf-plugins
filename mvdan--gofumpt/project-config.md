---
trigger: always_on
description: This file provides guidance to coding agents such as Claude Code (claude.ai/code)
---
...
---
> Source: [mvdan/gofumpt](https://github.com/mvdan/gofumpt) — distributed by [TomeVault](https://tomevault.io).
