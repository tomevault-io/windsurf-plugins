---
trigger: always_on
description: 这是一个精简的 WooCommerce 易支付网关插件。保持代码小而清晰，不引入码支付、QQ 支付或空 `type` 的聚合收银台。
---
...
---
> Source: [wxcydzcc/epay](https://github.com/wxcydzcc/epay) — distributed by [TomeVault](https://tomevault.io).
