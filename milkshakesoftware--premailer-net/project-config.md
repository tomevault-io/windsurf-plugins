---
trigger: always_on
description: The .sln and all projects live in the nested `PreMailer.Net/` folder, not the repo root. **Run all `dotnet` commands from `./PreMailer.Net/`** (matches `working-directory` in `.github/workflows/dotnetcore.yml`).
---
...
---
> Source: [milkshakesoftware/PreMailer.Net](https://github.com/milkshakesoftware/PreMailer.Net) — distributed by [TomeVault](https://tomevault.io).
