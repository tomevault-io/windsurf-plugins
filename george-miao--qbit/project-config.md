---
trigger: always_on
description: `qbit-rs` is a Rust 2024 client for qBittorrent's Web API. It supports the
---
...
---
> Source: [George-Miao/qbit](https://github.com/George-Miao/qbit) — distributed by [TomeVault](https://tomevault.io).
