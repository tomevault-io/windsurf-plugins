---
trigger: always_on
description: - Add a concise JSDoc comment at the top of every file in src/ you create describing the purpose of the file.
---
...
---
> Source: [vitalets/request-mocking-protocol](https://github.com/vitalets/request-mocking-protocol) — distributed by [TomeVault](https://tomevault.io).
