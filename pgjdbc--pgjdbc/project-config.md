---
trigger: always_on
description: Use the right-hand column below in Javadoc, inline comments, error and log messages, `CHANGELOG.md`, `docs/`,
---
...
---
> Source: [pgjdbc/pgjdbc](https://github.com/pgjdbc/pgjdbc) — distributed by [TomeVault](https://tomevault.io).
