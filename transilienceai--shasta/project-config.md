---
trigger: always_on
description: Shasta is a Claude Code-native SOC 2 and ISO 27001 compliance platform. It scans AWS and Azure environments, maps findings to compliance controls, generates remediation guidance (with Terraform), and produces compliance policies and reports.
---
...
---
> Source: [transilienceai/shasta](https://github.com/transilienceai/shasta) — distributed by [TomeVault](https://tomevault.io).
