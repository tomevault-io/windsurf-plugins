---
trigger: always_on
description: pstack is a collection of SKILL.md files that give AI agents structured roles for
---

# pstack — AI Engineering Workflow

pstack is a collection of SKILL.md files that give AI agents structured roles for
...
| `/pstack-upgrade` | Update pstack to the latest version. |
...
---
> Source: [no-session/pstack](https://github.com/no-session/pstack) — distributed by [TomeVault](https://tomevault.io).
