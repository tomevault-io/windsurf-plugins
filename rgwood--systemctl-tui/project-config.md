---
trigger: always_on
description: When testing systemctl-tui, run it in debug mode (i.e. do not specify `--release`).
---
...
- `crates/systemctl-ui-core` — shared systemd/journald/SSH plumbing, no UI dependencies
...
---
> Source: [rgwood/systemctl-tui](https://github.com/rgwood/systemctl-tui) — distributed by [TomeVault](https://tomevault.io).
