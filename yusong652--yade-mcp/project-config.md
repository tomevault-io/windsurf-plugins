---
trigger: always_on
description: yade-mcp is an MCP server that connects AI agents to YADE (open-source DEM engine). Two packages live in this monorepo:
---
...
---
> Source: [yusong652/yade-mcp](https://github.com/yusong652/yade-mcp) — distributed by [TomeVault](https://tomevault.io).
