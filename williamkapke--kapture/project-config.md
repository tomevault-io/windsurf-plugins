---
trigger: always_on
description: This document provides a high-level overview of the Kapture project, intended to be used as a reference for the Gemini AI assistant.
---
...
---
> Source: [williamkapke/kapture](https://github.com/williamkapke/kapture) — distributed by [TomeVault](https://tomevault.io).
