...
# AI Agent Reference for ha-openwrt
...
| Area | Path |
|---|---|
| Integration Entry | `custom_components/openwrt/__init__.py` |
| Coordinator | `custom_components/openwrt/coordinator.py` |
| Options Flow | `custom_components/openwrt/config_flow.py` |
| Tests | `tests/` |
...
---
> Source: [FaserF/ha-openwrt](https://github.com/FaserF/ha-openwrt) — distributed by [TomeVault](https://tomevault.io).
