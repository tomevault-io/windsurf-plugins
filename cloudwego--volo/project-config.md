---
trigger: always_on
description: `volo-macros` is a **reserved placeholder** crate for future procedural macros. It contains no active functionality.
---
...
---
> Source: [cloudwego/volo](https://github.com/cloudwego/volo) — distributed by [TomeVault](https://tomevault.io).
