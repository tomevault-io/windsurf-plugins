---
trigger: always_on
description: Squix is a CLI tool for managing and executing SQL queries across multiple
---
...
---
> Source: [eduardofuncao/squix](https://github.com/eduardofuncao/squix) — distributed by [TomeVault](https://tomevault.io).
