---
trigger: always_on
description: This repository is a monorepo that uses Lit for building web components and no other frontend frameworks unless otherwise specified.
---
...
---
> Source: [lit/lit](https://github.com/lit/lit) — distributed by [TomeVault](https://tomevault.io).
