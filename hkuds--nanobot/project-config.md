---
trigger: always_on
description: Use this file for project-specific preferences, recurring workflow conventions, and instructions you want the agent to remember for this workspace. Keep durable facts about the user in `USER.md`, personality/style guidance in `SOUL.md`, and long-term memory in `memory/MEMORY.md`.
---
...
---
> Source: [HKUDS/nanobot](https://github.com/HKUDS/nanobot) — distributed by [TomeVault](https://tomevault.io).
