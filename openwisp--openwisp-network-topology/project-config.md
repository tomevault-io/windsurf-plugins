---
trigger: always_on
description: `openwisp-network-topology` is the OpenWISP Django app for collecting, storing, visualizing, and comparing network topology data.
---
...
---
> Source: [openwisp/openwisp-network-topology](https://github.com/openwisp/openwisp-network-topology) — distributed by [TomeVault](https://tomevault.io).
