---
trigger: always_on
description: Minimal cross-platform mobile UI framework for .NET (iOS + Android). **No** `Microsoft.Maui.Controls`, XAML, DI, MVVM, data-binding, or `System.Reflection`. Views are POCOs mapping to native controls. Uses only `Microsoft.Maui.Graphics` (`Color`) and MAUI's SingleProject + Resizetizer.
---
...
---
> Source: [jonathanpeppers/spice](https://github.com/jonathanpeppers/spice) — distributed by [TomeVault](https://tomevault.io).
