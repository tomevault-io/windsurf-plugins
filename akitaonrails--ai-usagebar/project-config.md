---
trigger: always_on
description: Notes for Claude Code (and humans) about working in this repo. Keep tight:
---
...
2. Update the matching `types.rs` in `src/{anthropic,openai,zai,openrouter}/`.
...
---
> Source: [akitaonrails/ai-usagebar](https://github.com/akitaonrails/ai-usagebar) — distributed by [TomeVault](https://tomevault.io).
