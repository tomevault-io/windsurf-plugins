---
trigger: always_on
description: - Test runner is **mocha** (not jest): `BABEL_ENV=test npx mocha --require babel-core/register tests/unit/flags.js`
---
...
---
> Source: [mixpanel/mixpanel-js](https://github.com/mixpanel/mixpanel-js) — distributed by [TomeVault](https://tomevault.io).
