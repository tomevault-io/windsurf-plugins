---
trigger: always_on
description: - **Build**: `pnpm run build` (TypeScript compilation)
---
...
---
> Source: [causalens/dara](https://github.com/causalens/dara) — distributed by [TomeVault](https://tomevault.io).
