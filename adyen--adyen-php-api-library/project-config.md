---
trigger: always_on
description: This is the Adyen PHP API Library, providing PHP developers with an easy way to interact with the Adyen API. The library is a wrapper around the Adyen API, with services and models generated from OpenAPI specifications.
---
...
---
> Source: [Adyen/adyen-php-api-library](https://github.com/Adyen/adyen-php-api-library) — distributed by [TomeVault](https://tomevault.io).
