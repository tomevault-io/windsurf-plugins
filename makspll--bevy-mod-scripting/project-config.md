---
trigger: always_on
description: The `/docs` folder contain documentation for the project as well as release notes.
---
...
---
> Source: [makspll/bevy_mod_scripting](https://github.com/makspll/bevy_mod_scripting) — distributed by [TomeVault](https://tomevault.io).
