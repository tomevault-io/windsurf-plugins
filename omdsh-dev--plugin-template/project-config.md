---
trigger: always_on
description: This repository is a standalone DeepSeek Harness plugin template.
---
...
---
> Source: [omdsh-dev/plugin-template](https://github.com/omdsh-dev/plugin-template) — distributed by [TomeVault](https://tomevault.io).
