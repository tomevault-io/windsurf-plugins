---
trigger: always_on
description: Always use `make` targets for checking and linting:
---
...
---
> Source: [databendlabs/openraft](https://github.com/databendlabs/openraft) — distributed by [TomeVault](https://tomevault.io).
