---
trigger: always_on
description: TypeScript library for Cashu ecash wallets and mint interaction.
---
...
---
> Source: [cashubtc/cashu-ts](https://github.com/cashubtc/cashu-ts) — distributed by [TomeVault](https://tomevault.io).
