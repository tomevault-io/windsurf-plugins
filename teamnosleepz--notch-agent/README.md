...
Original source: `CLAUDE.md` in [TeamNoSleepz/notch-agent](https://github.com/TeamNoSleepz/notch-agent).
...
From [TeamNoSleepz/notch-agent](https://github.com/TeamNoSleepz/notch-agent) — a repo with 15+ stars on GitHub.
