---
trigger: always_on
description: - This repository is Ruby-first. Prefer Ruby naming and control flow over Python- or Java-style ceremony.
---
...
---
> Source: [YusukeIwaki/capybara-playwright-driver](https://github.com/YusukeIwaki/capybara-playwright-driver) — distributed by [TomeVault](https://tomevault.io).
