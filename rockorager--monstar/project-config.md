---
trigger: always_on
description: If `hostname` is `e2b.local` or `/proc/1/mountinfo` contains `/e2b/`, you are
---
...
---
> Source: [rockorager/monstar](https://github.com/rockorager/monstar) — distributed by [TomeVault](https://tomevault.io).
