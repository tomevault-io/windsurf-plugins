---
trigger: always_on
description: This document summarizes how to work on rslint effectively and consistently.
---
...
---
> Source: [web-infra-dev/rslint](https://github.com/web-infra-dev/rslint) — distributed by [TomeVault](https://tomevault.io).
