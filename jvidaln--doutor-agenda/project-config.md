...
- Sempre use React Hook Form para criação e validação de formulários. Use o componente [form.tsx](mdc:src/components/ui/form.tsx) para criar esses formulários. Exemplo: [upsert-doctor-form.tsx](mdc:src/app/(protected).
...
- Ao criar páginas, use os componentes dentro de [page-container.tsx](mdc:src/components/ui/page-container.tsx) para manter os padrões de margin, padding e spacing nas páginas. Exemplo: [page.tsx](mdc:src/app/(protected).
- Sempre use a biblioteca "react-number-format" ao criar máscaras para inputs.

---
> Source: [JVidalN/doutor-agenda](https://github.com/JVidalN/doutor-agenda) — distributed by [TomeVault](https://tomevault.io).
