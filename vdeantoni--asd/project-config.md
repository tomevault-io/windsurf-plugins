---
trigger: always_on
description: `asd` is a terminal-based diff viewer built in Rust. It reads unified diff from stdin and displays it in a full-screen TUI with split panes, syntax highlighting, and word-level change detection.
---
...
---
> Source: [vdeantoni/asd](https://github.com/vdeantoni/asd) — distributed by [TomeVault](https://tomevault.io).
