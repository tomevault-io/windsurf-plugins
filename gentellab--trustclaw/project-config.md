---
trigger: always_on
description: OpenClaw runs a single embedded agent runtime derived from **p-mono**.
---
...
---
> Source: [GenTelLab/trustclaw](https://github.com/GenTelLab/trustclaw) — distributed by [TomeVault](https://tomevault.io).
