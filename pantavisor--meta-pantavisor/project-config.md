---
trigger: always_on
description: Yocto/OpenEmbedded layer for building Pantavisor, a container-based embedded Linux system runtime. It provides recipes, classes, and configurations for building complete BSP images with container support.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/pantavisor)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/pantavisor)
