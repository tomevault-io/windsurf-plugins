---
trigger: always_on
description: - `make all` — check style, run tests, and build the plugin bundle
---
...
---
> Source: [mattermost/mattermost-plugin-playbooks](https://github.com/mattermost/mattermost-plugin-playbooks) — distributed by [TomeVault](https://tomevault.io).
