---
trigger: always_on
description: - `Package.swift` defines the Swift Package Manager app target and the `swift-markdown` dependency.
---
...
---
> Source: [frankdilo/MarkdownViewer](https://github.com/frankdilo/MarkdownViewer) — distributed by [TomeVault](https://tomevault.io).
