---
trigger: always_on
description: Use this prompt to update `tests/BUILD.bazel` after adding, removing, or
---
...
---
> Source: [aya-rs/bpf-linker](https://github.com/aya-rs/bpf-linker) — distributed by [TomeVault](https://tomevault.io).
