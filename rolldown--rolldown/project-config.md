---
trigger: always_on
description: Rolldown is a JavaScript/TypeScript bundler written in Rust and TypeScript, designed to be the future bundler for Vite.
---
...
---
> Source: [rolldown/rolldown](https://github.com/rolldown/rolldown) — distributed by [TomeVault](https://tomevault.io).
