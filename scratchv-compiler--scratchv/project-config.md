---
trigger: always_on
description: LLVM 是 baseline，ScratchV 编译优化**超越 LLVM**。当前差距: 动态指令数 4.2x (18.5亿 vs 77.7亿)。
---
...
| 分析 | 分析实验数据、研究优化方向、找差距根因 | benchmark 结果后 |
| 实现 | 具体修改、代码落地 | 方案确定后 |
| 验证 | 测试、检查、回归 | 每次修改后 |
...
---
> Source: [ScratchV-Compiler/ScratchV](https://github.com/ScratchV-Compiler/ScratchV) — distributed by [TomeVault](https://tomevault.io).
