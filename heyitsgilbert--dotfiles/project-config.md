---
trigger: always_on
description: > The global `~/.claude/CLAUDE.md` (applies to all projects) is generated by `dot_claude/CLAUDE.md`. This file is scoped to this repo only.
---
...
---
> Source: [HeyItsGilbert/dotfiles](https://github.com/HeyItsGilbert/dotfiles) — distributed by [TomeVault](https://tomevault.io).
