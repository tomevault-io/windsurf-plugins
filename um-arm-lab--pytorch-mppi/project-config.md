---
trigger: always_on
description: Model Predictive Path Integral (MPPI) control library using approximate dynamics in PyTorch.
---
...
---
> Source: [UM-ARM-Lab/pytorch_mppi](https://github.com/UM-ARM-Lab/pytorch_mppi) — distributed by [TomeVault](https://tomevault.io).
