---
trigger: always_on
description: **dt-sql-parser** 是一个基于 [ANTLR4](https://github.com/antlr/antlr4) 构建的 SQL 解析器库，面向 **大数据** 领域。它提供以下功能：
---
...
---
> Source: [DTStack/dt-sql-parser](https://github.com/DTStack/dt-sql-parser) — distributed by [TomeVault](https://tomevault.io).
