---
trigger: always_on
description: This repository contains a **Home Assistant custom integration** for Smart #1 and #3 vehicles. It connects to the Smart vehicle cloud API to retrieve vehicle status, location, charging information, and other telemetry data for use in Home Assistant.
---
...
---
> Source: [DasBasti/SmartHashtag](https://github.com/DasBasti/SmartHashtag) — distributed by [TomeVault](https://tomevault.io).
