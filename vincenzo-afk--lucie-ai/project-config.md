---
trigger: always_on
description: Guidelines for any AI (or human) making further changes to this project.
---
...
---
> Source: [vincenzo-afk/Lucie-AI](https://github.com/vincenzo-afk/Lucie-AI) — distributed by [TomeVault](https://tomevault.io).
