---
trigger: always_on
description: You're working on the source code for `miniwdl`, the Workflow Description Language (WDL) runner and developer toolkit.
---
...
- EXCLUDING TESTS, Python code should be linted with `mypy`, `ruff check --fix`, and `ruff format`.
- Testing guidelines:
...
---
> Source: [chanzuckerberg/miniwdl](https://github.com/chanzuckerberg/miniwdl) — distributed by [TomeVault](https://tomevault.io).
