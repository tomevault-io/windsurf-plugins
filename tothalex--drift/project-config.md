---
trigger: always_on
description: drift is a Rust terminal UI for reviewing working changes like a pull
---
...
---
> Source: [tothalex/drift](https://github.com/tothalex/drift) — distributed by [TomeVault](https://tomevault.io).
