---
trigger: always_on
description: Claude Code plugin development repository. Contains plugins that extend Claude Code with domain-specific skills, output
---
...
---
> Source: [xobotyi/cc-foundry](https://github.com/xobotyi/cc-foundry) — distributed by [TomeVault](https://tomevault.io).
