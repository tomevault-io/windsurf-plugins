---
trigger: always_on
description: These rules apply to AI coding agents working in this repository.
---
...
---
> Source: [yhw2003/claude-openai-bridge](https://github.com/yhw2003/claude-openai-bridge) — distributed by [TomeVault](https://tomevault.io).
