---
trigger: always_on
description: This project, named "selfie," is an educational platform for teaching the design and implementation of programming languages and runtime systems. It is a self-contained C implementation of a compiler, an emulator, and a hypervisor.
---
...
---
> Source: [cksystemsteaching/selfie](https://github.com/cksystemsteaching/selfie) — distributed by [TomeVault](https://tomevault.io).
