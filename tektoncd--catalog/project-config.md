---
trigger: always_on
description: Curated collection of reusable Tekton Task, StepAction, and Pipeline YAML
---
...
---
> Source: [tektoncd/catalog](https://github.com/tektoncd/catalog) — distributed by [TomeVault](https://tomevault.io).
