---
trigger: always_on
description: PDF auto-renamer using AI + OCR. Extracts company name, date, and document type from PDFs, renames to `YYYYMMDD COMPANY DOCTYPE.pdf`.
---
...
---
> Source: [ptmrio/autorename-pdf](https://github.com/ptmrio/autorename-pdf) — distributed by [TomeVault](https://tomevault.io).
