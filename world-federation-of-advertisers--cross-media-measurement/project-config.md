---
trigger: always_on
description: Privacy-preserving system for cross-publisher, cross-media reach and frequency measurement through secure multiparty computation. Kotlin primary, C++ for crypto, Protocol Buffers for APIs, Bazel build, gRPC services, Kubernetes deployments, Spanner database, Confidential Spaces for TEE workloads.
---
...
---
> Source: [world-federation-of-advertisers/cross-media-measurement](https://github.com/world-federation-of-advertisers/cross-media-measurement) — distributed by [TomeVault](https://tomevault.io).
