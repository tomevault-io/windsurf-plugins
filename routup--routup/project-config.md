---
trigger: always_on
description: The shipped routup plugins follow a small set of conventions. Adopting them in your plugin makes it feel native, integrates cleanly with `decorators` parameter extractors, and gives users predictable mental models across the ecosystem.
---
...
---
> Source: [routup/routup](https://github.com/routup/routup) — distributed by [TomeVault](https://tomevault.io).
