---
trigger: always_on
description: This file provides guidance to AI coding agents such as Claude Code (claude.ai/code) and Gemini Code Assist when working
---

# AGENTS.md

This file provides guidance to AI coding agents such as Claude Code (claude.ai/code) and Gemini Code Assist when working
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/si618)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/si618)
