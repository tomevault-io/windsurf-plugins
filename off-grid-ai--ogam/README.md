...
> Tome by [off-grid-ai](https://github.com/off-grid-ai/OGAM), graded and kept true across every major AI platform by [TomeVault](https://tomevault.io)
...
Graded against the Tome Standard, TomeVault's public ruleset for whether AI instructions load, read clearly and stay safe. Source: [github.com/off-grid-ai/OGAM](https://github.com/off-grid-ai/OGAM)
