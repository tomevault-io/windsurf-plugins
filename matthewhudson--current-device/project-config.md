---
trigger: always_on
description: Browser device detection library (OS, type, orientation) — ~25k downloads/week on npm.
---
...
---
> Source: [matthewhudson/current-device](https://github.com/matthewhudson/current-device) — distributed by [TomeVault](https://tomevault.io).
