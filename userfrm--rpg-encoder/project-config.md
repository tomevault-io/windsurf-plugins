---
trigger: always_on
description: Rust workspace for building Repository Planning Graphs (RPGs) — semantic code understanding via MCP.
---
...
---
> Source: [userFRM/rpg-encoder](https://github.com/userFRM/rpg-encoder) — distributed by [TomeVault](https://tomevault.io).
