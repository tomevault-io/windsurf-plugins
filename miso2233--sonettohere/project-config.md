---
trigger: always_on
description: 每次合并 PR 或发布版本后，Claude Code 应根据以下规则评估是否添加系统更新动态：
---
...
---
> Source: [Miso2233/SonettoHere](https://github.com/Miso2233/SonettoHere) — distributed by [TomeVault](https://tomevault.io).
