---
trigger: always_on
description: This file provides context for AI coding agents working on the swup codebase.
---
...
---
> Source: [swup/swup](https://github.com/swup/swup) — distributed by [TomeVault](https://tomevault.io).
