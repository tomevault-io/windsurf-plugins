---
trigger: always_on
description: Provide an OpenClaw skill that wraps GitHub Copilot CLI (copilot) commands so agents can run Copilot CLI features (suggest, chat, autopilot, agents) programmatically and receive structured results.
---
...
---
> Source: [windy629/copilot-cli-skill](https://github.com/windy629/copilot-cli-skill) — distributed by [TomeVault](https://tomevault.io).
