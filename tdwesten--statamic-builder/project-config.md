---
trigger: always_on
description: The Statamic Builder speeds up building Statamic sites by providing a fluent, PHP-based API to define sites, blueprints, fieldsets, collections, navigations, and taxonomies. This approach enhances code readability and maintainability by replacing traditional YAML configuration with PHP classes.
---
...
---
> Source: [tdwesten/statamic-builder](https://github.com/tdwesten/statamic-builder) — distributed by [TomeVault](https://tomevault.io).
