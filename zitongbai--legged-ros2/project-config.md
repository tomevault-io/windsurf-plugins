---
trigger: always_on
description: - `legged_rl_controller/`: RL controller plugin and supporting C++ headers/sources.
---
...
---
> Source: [zitongbai/legged_ros2](https://github.com/zitongbai/legged_ros2) — distributed by [TomeVault](https://tomevault.io).
