---
trigger: always_on
description: - this project uses Bazel build system for TypeScript and some Java code.
---
...
- **No AI attribution:** Do not add AI agent attribution or signatures to commit messages (e.g., "By: Claude", "Generated by AI", etc.).
...
---
> Source: [AnySoftKeyboard/AnySoftKeyboard](https://github.com/AnySoftKeyboard/AnySoftKeyboard) — distributed by [TomeVault](https://tomevault.io).
