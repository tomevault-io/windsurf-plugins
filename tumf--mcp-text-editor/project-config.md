---
trigger: always_on
description: This document provides guidance for AI coding agents working on this codebase.
---
...
---
> Source: [tumf/mcp-text-editor](https://github.com/tumf/mcp-text-editor) — distributed by [TomeVault](https://tomevault.io).
