---
trigger: always_on
description: Public reference repo for OpenClaw configuration patterns.
---
...
---
> Source: [unisone/openclaw-config](https://github.com/unisone/openclaw-config) — distributed by [TomeVault](https://tomevault.io).
