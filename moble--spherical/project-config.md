---
trigger: always_on
description: Defined exclusively in terms of quaternions, the Wigner $\mathfrak{D}$
---
...
---
> Source: [moble/spherical](https://github.com/moble/spherical) — distributed by [TomeVault](https://tomevault.io).
