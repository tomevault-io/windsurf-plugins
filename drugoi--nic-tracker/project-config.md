---
trigger: always_on
description: - Server deploy should stay a simple `git pull` → `npm ci` → PM2 flow without a separate manual compile step in the deploy script (build runs via `postinstall`).
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/drugoi)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/drugoi)
