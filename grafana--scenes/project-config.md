---
trigger: always_on
description: This file provides guidance to AI agents when working with code in the scenes repository.
---
...
---
> Source: [grafana/scenes](https://github.com/grafana/scenes) — distributed by [TomeVault](https://tomevault.io).
