---
trigger: always_on
description: - Use **uv** for everything; pip is only a documented fallback.
---
...
---
> Source: [krichelj/PyDiffGame](https://github.com/krichelj/PyDiffGame) — distributed by [TomeVault](https://tomevault.io).
