---
trigger: always_on
description: This repo builds `claude-plugin-codex`, a Codex plugin that lets Codex consult
---
...
---
> Source: [yanchuk/claude-plugin-codex](https://github.com/yanchuk/claude-plugin-codex) — distributed by [TomeVault](https://tomevault.io).
