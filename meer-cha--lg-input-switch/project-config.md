---
trigger: always_on
description: `lg-input-switch` is a single-file Python CLI (`lg_switch.py`) that switches the active input on an **LG 45GX950A-B** monitor on Windows with an NVIDIA GPU.
---
...
---
> Source: [meer-cha/lg-input-switch](https://github.com/meer-cha/lg-input-switch) — distributed by [TomeVault](https://tomevault.io).
