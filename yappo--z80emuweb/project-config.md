---
trigger: always_on
description: 1. 優先順位は「AIが必要タスクを整理し順番に処理」が基本です。**ユーザから緊急依頼が来た場合は割り込みを最優先**し、元タスクは一時停止として扱います。
---
...
---
> Source: [yappo/z80emuweb](https://github.com/yappo/z80emuweb) — distributed by [TomeVault](https://tomevault.io).
