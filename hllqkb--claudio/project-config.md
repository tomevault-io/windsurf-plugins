---
trigger: always_on
description: - pnpm monorepo: apps/server (Fastify + TypeScript) + apps/web (React 19 + Vite + PWA)
---
...
---
> Source: [hllqkb/Claudio](https://github.com/hllqkb/Claudio) — distributed by [TomeVault](https://tomevault.io).
