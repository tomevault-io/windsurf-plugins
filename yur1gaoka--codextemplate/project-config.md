---
trigger: always_on
description: すべての作業は本ファイルおよび docs 配下の内容に従うこと。
---
...
---
> Source: [yur1gaoka/codexTemplate](https://github.com/yur1gaoka/codexTemplate) — distributed by [TomeVault](https://tomevault.io).
