---
trigger: always_on
description: The jsdom project has several relevant test suites. They largely divide into testing the jsdom API, versus the web platform implementation. Most of the test suites are slow, so we need to be deliberate about how and when we run them to avoid wasting time and context window space.
---
...
---
> Source: [jsdom/jsdom](https://github.com/jsdom/jsdom) — distributed by [TomeVault](https://tomevault.io).
