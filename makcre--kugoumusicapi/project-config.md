---
trigger: always_on
description: > KuGouMusicApi 项目指南 — 酷狗音乐 NodeJS 版 API
---
...
---
> Source: [MakcRe/KuGouMusicApi](https://github.com/MakcRe/KuGouMusicApi) — distributed by [TomeVault](https://tomevault.io).
