---
trigger: always_on
description: Rust ports of Windows driver samples from the official [Windows Driver Samples](https://github.com/microsoft/Windows-driver-samples), using crates from [windows-drivers-rs](https://github.com/microsoft/windows-drivers-rs). All driver crates target `#![no_std]` and compile as `cdylib` for the Windows kernel.
---
...
---
> Source: [microsoft/Windows-rust-driver-samples](https://github.com/microsoft/Windows-rust-driver-samples) — distributed by [TomeVault](https://tomevault.io).
