---
trigger: always_on
description: `AGENTS.md` is the canonical shared AI router. `CONTEXT-POLICY.md` is the retrieval and privacy authority.
---
...
---
> Source: [kravetech/kos-starter-kit](https://github.com/kravetech/kos-starter-kit) — distributed by [TomeVault](https://tomevault.io).
