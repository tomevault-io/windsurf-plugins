---
trigger: always_on
description: Guidance for AI agents (and humans) contributing to FreiFahren.
---
...
---
> Source: [FreiFahren/FreiFahren](https://github.com/FreiFahren/FreiFahren) — distributed by [TomeVault](https://tomevault.io).
