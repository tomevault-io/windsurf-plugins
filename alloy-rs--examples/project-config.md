---
trigger: always_on
description: Use `examples-index.json` as the first lookup surface. It lists every Cargo example target with its
---
...
---
> Source: [alloy-rs/examples](https://github.com/alloy-rs/examples) — distributed by [TomeVault](https://tomevault.io).
