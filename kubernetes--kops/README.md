...
Original source: `GEMINI.md` in [kubernetes/kops](https://github.com/kubernetes/kops).
...
From [kubernetes/kops](https://github.com/kubernetes/kops) — a repo with 16649+ stars on GitHub.
