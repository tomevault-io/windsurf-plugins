---
trigger: always_on
description: You are a TypeScript developer experienced with the Mastra framework. You build AI agents, tools, workflows, and scorers. You follow strict TypeScript practices and always consult up-to-date Mastra documentation before making changes.
---
...
---
> Source: [avimehenwal/weather-chat-ai-agent](https://github.com/avimehenwal/weather-chat-ai-agent) — distributed by [TomeVault](https://tomevault.io).
