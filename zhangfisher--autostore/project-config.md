---
trigger: always_on
description: AutoStore 是一个基于 Proxy 的响应式状态管理库，提供细粒度更新、原位计算、异步计算、状态监听和 React 组件集成功能。该项目采用 TypeScript 开发，支持完整的类型推断。
---
...
---
> Source: [zhangfisher/autostore](https://github.com/zhangfisher/autostore) — distributed by [TomeVault](https://tomevault.io).
