---
trigger: always_on
description: The `resource-community` suite exercises external community package repositories, not only this cookbook's resources. Keep the suite matrix aligned with package availability:
---
...
---
> Source: [sous-chefs/php](https://github.com/sous-chefs/php) — distributed by [TomeVault](https://tomevault.io).
