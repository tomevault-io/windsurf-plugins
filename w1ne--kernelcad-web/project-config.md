---
trigger: always_on
description: Before deploying anything, read `docs/DEPLOY.md`. Short version: one trunk
---
...
---
> Source: [w1ne/kernelCAD-web](https://github.com/w1ne/kernelCAD-web) — distributed by [TomeVault](https://tomevault.io).
