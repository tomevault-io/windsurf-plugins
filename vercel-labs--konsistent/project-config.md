---
trigger: always_on
description: `konsistent` is a CLI tool that enforces structural conventions in TypeScript codebases via `konsistent.json` config files.
---
...
---
> Source: [vercel-labs/konsistent](https://github.com/vercel-labs/konsistent) — distributed by [TomeVault](https://tomevault.io).
