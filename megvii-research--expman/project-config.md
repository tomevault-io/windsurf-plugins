---
trigger: always_on
description: ExpMan is a zsh-based experiment management tool that leverages git-worktree to enable working on multiple git branches simultaneously. It's particularly useful for machine learning and experimental sciences where engineers need to run multiple experiments in parallel.
---
...
---
> Source: [megvii-research/expman](https://github.com/megvii-research/expman) — distributed by [TomeVault](https://tomevault.io).
