---
trigger: always_on
description: This file is the entry point for any AI coding agent — Claude Code, Codex CLI, Cursor, Gemini CLI, OpenCode, Aider, or anything else — that has been pointed at this repository. It is deliberately short. The goal is to tell an agent what this repo is, how to verify changes, and what tone to use when contributing.
---
