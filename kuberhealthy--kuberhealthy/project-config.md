---
trigger: always_on
description: - It is desired for you to make liberal use of MCP servers, or chains of MCP tools, whenever it appears to be useful.
---
...
---
> Source: [kuberhealthy/kuberhealthy](https://github.com/kuberhealthy/kuberhealthy) — distributed by [TomeVault](https://tomevault.io).
