# AI instruction files for taotao-cloud-project

> Sourced from [shuigedeng/taotao-cloud-project](https://github.com/shuigedeng/taotao-cloud-project) and converted for every major platform by [TomeVault](https://tomevault.io)
