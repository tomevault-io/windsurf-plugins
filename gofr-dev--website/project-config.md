---
trigger: always_on
description: For Claude Code, Cursor, Aider, Codex, etc. Hand
---
...
---
> Source: [gofr-dev/website](https://github.com/gofr-dev/website) — distributed by [TomeVault](https://tomevault.io).
