---
trigger: always_on
description: - Inherit the repo-root `AGENTS.md`; this file only adds `packages/firefox-extension` specifics.
---
...
---
> Source: [zhensherlock/vue-devtools-unlocker](https://github.com/zhensherlock/vue-devtools-unlocker) — distributed by [TomeVault](https://tomevault.io).
