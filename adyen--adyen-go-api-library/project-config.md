---
trigger: always_on
description: This is the Adyen Go API Library, providing Go developers with an easy way to interact with the Adyen API. The library is a wrapper around the Adyen API, with services and models generated from OpenAPI specifications.
---
...
---
> Source: [Adyen/adyen-go-api-library](https://github.com/Adyen/adyen-go-api-library) — distributed by [TomeVault](https://tomevault.io).
