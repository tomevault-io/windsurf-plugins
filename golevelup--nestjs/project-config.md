---
trigger: always_on
description: This is a **pnpm monorepo** containing a collection of NestJS modules and utilities. Each package lives under `packages/` and is published independently to npm under the `@golevelup` scope.
---
...
---
> Source: [golevelup/nestjs](https://github.com/golevelup/nestjs) — distributed by [TomeVault](https://tomevault.io).
