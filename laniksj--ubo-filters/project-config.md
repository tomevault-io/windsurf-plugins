---
trigger: always_on
description: ubo-filters contains uBlock Origin filter lists for blocking ads and tracking.
---
...
---
> Source: [LanikSJ/ubo-filters](https://github.com/LanikSJ/ubo-filters) — distributed by [TomeVault](https://tomevault.io).
