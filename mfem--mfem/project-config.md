---
trigger: always_on
description: Review MFEM PRs for correctness, maintainability, performance, portability, test coverage, and MFEM consistency. Use the diff and PR context; reference source files, tests, and CI results when available. Follow `CONTRIBUTING.md`, especially Developer Guidelines, PR rules, checklist, and testing.
---
...
---
> Source: [mfem/mfem](https://github.com/mfem/mfem) — distributed by [TomeVault](https://tomevault.io).
