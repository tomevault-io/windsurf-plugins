---
trigger: always_on
description: - `v1alpha1` is the stable production API — name is historical
---
...
---
> Source: [openshift/lvm-operator](https://github.com/openshift/lvm-operator) — distributed by [TomeVault](https://tomevault.io).
