---
trigger: always_on
description: Each non-local session requires installing dependancies via `npm i --silent`. Check the working directory: if it contains Users, it's local; if it contains /home/runner/ or /github/, it's a GitHub Actions runner.
---
...
---
> Source: [Infinite-Chess/infinitechess.org](https://github.com/Infinite-Chess/infinitechess.org) — distributed by [TomeVault](https://tomevault.io).
