---
trigger: always_on
description: Public MIT package (`malzariey/filament-daterangepicker-filter`), branch `x5`. Treat `src/` as public API: a behaviour change to a documented method needs a major bump, not a patch. Follow `CONTRIBUTING.md`. `~/.claude/house-standard.md` governs the apps, not this repo — do not apply app conventions here.
---
...
---
> Source: [malzariey/filament-daterangepicker-filter](https://github.com/malzariey/filament-daterangepicker-filter) — distributed by [TomeVault](https://tomevault.io).
