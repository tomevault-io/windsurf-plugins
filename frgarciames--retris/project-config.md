---
trigger: always_on
description: This app was scaffolded with `remix new`. Use these conventions when continuing to build it out.
---
...
---
> Source: [frgarciames/retris](https://github.com/frgarciames/retris) — distributed by [TomeVault](https://tomevault.io).
