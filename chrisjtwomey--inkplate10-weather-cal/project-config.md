---
trigger: always_on
description: **Read [CONTRIBUTING.md](CONTRIBUTING.md) first.** It covers the repository layout, how to run the tests, and how to build and run things locally.
---
...
---
> Source: [chrisjtwomey/inkplate10-weather-cal](https://github.com/chrisjtwomey/inkplate10-weather-cal) — distributed by [TomeVault](https://tomevault.io).
