---
trigger: always_on
description: Read `README.md` before preparing variants or interpreting a report. It defines the exact revision model, profile
---
...
---
> Source: [aurelia/aurelia](https://github.com/aurelia/aurelia) — distributed by [TomeVault](https://tomevault.io).
