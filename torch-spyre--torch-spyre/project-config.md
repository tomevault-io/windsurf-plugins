---
trigger: always_on
description: torch-spyre is an **out-of-tree PyTorch backend** that registers the
---
...
---
> Source: [torch-spyre/torch-spyre](https://github.com/torch-spyre/torch-spyre) — distributed by [TomeVault](https://tomevault.io).
