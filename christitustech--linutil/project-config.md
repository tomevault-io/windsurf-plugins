---
trigger: always_on
description: Linutil is a universal Linux utility with a Rust-based terminal user interface
---
...
---
> Source: [ChrisTitusTech/linutil](https://github.com/ChrisTitusTech/linutil) — distributed by [TomeVault](https://tomevault.io).
