---
trigger: always_on
description: When generating code for this project, please ensure compliance with the following standards:
---
...
---
> Source: [rameshsunkara/go-rest-api-example](https://github.com/rameshsunkara/go-rest-api-example) — distributed by [TomeVault](https://tomevault.io).
