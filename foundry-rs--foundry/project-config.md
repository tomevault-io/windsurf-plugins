---
trigger: always_on
description: Guidance for AI coding agents working in `crates/evm/symbolic`.
---
...
---
> Source: [foundry-rs/foundry](https://github.com/foundry-rs/foundry) — distributed by [TomeVault](https://tomevault.io).
