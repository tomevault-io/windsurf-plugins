---
trigger: always_on
description: * Setup `uv -q sync --extra dev --extra torch-cpu --extra doc` to install development dependencies.
---
...
* MUST add `Assisted-by: AGENT_NAME:MODEL_VERSION [TOOL1] [TOOL2] ...` to the end of
...
---
> Source: [adaptive-machine-learning/CapyMOA](https://github.com/adaptive-machine-learning/CapyMOA) — distributed by [TomeVault](https://tomevault.io).
