---
trigger: always_on
description: Ops is the official Python framework for developing Kubernetes and machine charms within the Juju ecosystem. It provides an event-driven abstraction layer for charm developers.
---
...
---
> Source: [canonical/operator](https://github.com/canonical/operator) — distributed by [TomeVault](https://tomevault.io).
