---
trigger: always_on
description: 组织级约定和跨仓边界以 [组织 AGENTS.md](https://github.com/metasequoiaime/.github/blob/main/AGENTS.md) 为准。本文件补充本仓的实现、数据和验证规则。
---
...
- `helpcodes/`——五套辅助码方案，本仓 `assets/tables` 只有其中一套，从同一个 Engine gitlink 的 `helpcode/helpcodes` 取全
...
---
> Source: [metasequoiaime/MSIME-Windows-Server](https://github.com/metasequoiaime/MSIME-Windows-Server) — distributed by [TomeVault](https://tomevault.io).
