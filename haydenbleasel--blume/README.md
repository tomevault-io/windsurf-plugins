# AI instruction files for blume
...
Original source: `CLAUDE.md` in [haydenbleasel/blume](https://github.com/haydenbleasel/blume).
...
```
npx tomevault install haydenbleasel/blume
```
Source: [github.com/haydenbleasel/blume](https://github.com/haydenbleasel/blume).
