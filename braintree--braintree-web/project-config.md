---
trigger: always_on
description: <!-- ES6 language features here. We can't use this yet, so I am commenting them out so the AI doesn't use 'em.
---
...
---
> Source: [braintree/braintree-web](https://github.com/braintree/braintree-web) — distributed by [TomeVault](https://tomevault.io).
