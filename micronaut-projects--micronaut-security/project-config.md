---
trigger: always_on
description: This file applies to the whole `micronaut-security` repository. Keep changes
---
...
---
> Source: [micronaut-projects/micronaut-security](https://github.com/micronaut-projects/micronaut-security) — distributed by [TomeVault](https://tomevault.io).
