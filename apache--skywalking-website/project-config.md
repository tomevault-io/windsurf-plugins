---
trigger: always_on
description: - Do NOT add `Co-Authored-By` with Claude or any AI assistant in commit messages.
---
...
---
> Source: [apache/skywalking-website](https://github.com/apache/skywalking-website) — distributed by [TomeVault](https://tomevault.io).
