---
trigger: always_on
description: When creating or updating .rendered files, **intelligently choose dimensions** that demonstrate the component properly **without wasting space**.
---
...
---
> Source: [fastn-stack/fastn](https://github.com/fastn-stack/fastn) — distributed by [TomeVault](https://tomevault.io).
