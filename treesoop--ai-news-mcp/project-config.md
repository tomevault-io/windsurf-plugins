---
trigger: always_on
description: 실시간 AI/기술 뉴스를 수집·캐싱해서 누구나 HTTP로 호출할 수 있는 공개 API.
---
...
---
> Source: [treesoop/ai-news-mcp](https://github.com/treesoop/ai-news-mcp) — distributed by [TomeVault](https://tomevault.io).
