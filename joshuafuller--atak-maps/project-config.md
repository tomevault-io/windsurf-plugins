---
trigger: always_on
description: Collection of MOBAC-format XML map source files for [ATAK](https://tak.gov). Each XML file points to an online tile server so ATAK can display and cache map imagery.
---
...
---
> Source: [joshuafuller/ATAK-Maps](https://github.com/joshuafuller/ATAK-Maps) — distributed by [TomeVault](https://tomevault.io).
