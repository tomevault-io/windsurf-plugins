---
trigger: always_on
description: This repo is the Terraform provider for Elastic Stack, written in Go.
---
...
---
> Source: [elastic/terraform-provider-elasticstack](https://github.com/elastic/terraform-provider-elasticstack) — distributed by [TomeVault](https://tomevault.io).
