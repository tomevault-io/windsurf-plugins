---
trigger: always_on
description: Studio Admin is a responsive admin dashboard built with Next.js 16, React 19, TypeScript, Tailwind CSS v4, shadcn/ui, and React Aria.
---
...
- Screen-specific data and schemas: `src/app/(main)/dashboard/<screen>/_data/`
...
---
> Source: [arhamkhnz/next-shadcn-admin-dashboard-aria](https://github.com/arhamkhnz/next-shadcn-admin-dashboard-aria) — distributed by [TomeVault](https://tomevault.io).
