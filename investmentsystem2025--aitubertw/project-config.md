---
trigger: always_on
description: このファイルは、Claude Code (claude.ai/code) がこのリポジトリのコードを扱う際のガイダンスを提供します。
---
...
---
> Source: [InvestmentSystem2025/AituberTW](https://github.com/InvestmentSystem2025/AituberTW) — distributed by [TomeVault](https://tomevault.io).
