---
trigger: always_on
description: DelegateDecompiler is a .NET library that decompiles delegates and method bodies to their lambda representation. It enables computed properties in LINQ queries by translating `[Computed]` attributes into executable expressions that can be processed by Entity Framework and other ORMs.
---
...
---
> Source: [hazzik/DelegateDecompiler](https://github.com/hazzik/DelegateDecompiler) — distributed by [TomeVault](https://tomevault.io).
