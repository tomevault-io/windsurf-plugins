---
trigger: always_on
description: All agent definitions, skills, and project rules live under **`.claude/`**. Use that tree whether you
---
...
---
> Source: [Tatsh/youtube-unofficial](https://github.com/Tatsh/youtube-unofficial) — distributed by [TomeVault](https://tomevault.io).
