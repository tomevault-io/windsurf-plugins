---
trigger: always_on
description: Electron hub app: web LLM tabs + shared workspace folder + docked CLI-agent terminals.
---
...
---
> Source: [yusufkaraaslan/tote](https://github.com/yusufkaraaslan/tote) — distributed by [TomeVault](https://tomevault.io).
