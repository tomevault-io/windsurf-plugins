---
trigger: always_on
description: 1. No unnecessary helper functions. If a function is only used once, it should be inlined.
---
...
---
> Source: [nico-bohlinger/RL-X](https://github.com/nico-bohlinger/RL-X) — distributed by [TomeVault](https://tomevault.io).
