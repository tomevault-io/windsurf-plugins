---
trigger: always_on
description: XPolicyLab wraps each robot policy as a self-contained adapter under `policy/<POLICY>/`. The policy
---
...
---
> Source: [XPolicyLab/XPolicyLab](https://github.com/XPolicyLab/XPolicyLab) — distributed by [TomeVault](https://tomevault.io).
