---
trigger: always_on
description: This file provides guidance to AI coding agents (Claude Code, Cursor, etc.) when
---
...
---
> Source: [w4ysonch/embedmq](https://github.com/w4ysonch/embedmq) — distributed by [TomeVault](https://tomevault.io).
