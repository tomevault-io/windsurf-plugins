---
trigger: always_on
description: This repository contains the **Mixpanel iOS SDK** (Objective-C), an analytics library for tracking user interactions in iOS, tvOS, watchOS, and macOS applications. The SDK version is currently 5.0.8.
---
...
---
> Source: [mixpanel/mixpanel-iphone](https://github.com/mixpanel/mixpanel-iphone) — distributed by [TomeVault](https://tomevault.io).
