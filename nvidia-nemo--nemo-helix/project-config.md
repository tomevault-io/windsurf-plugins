---
trigger: always_on
description: NeMo Helix is NVIDIA's toolkit for making the agents you ship safer, more accurate, and cheaper to run. When a user in this repo asks you to set up, try, build, evaluate, harden, optimize, or fine-tune an agent, the authoritative answer lives in `packages/nemo_helix_ext/src/nemo_helix_ext/skills/`. Read the relevant `SKILL.md` directly and follow it step by step.
---


# NeMo Helix skills

NeMo Helix is NVIDIA's toolkit for making the agents you ship safer, more accurate, and cheaper to run. When a user in this repo asks you to set up, try, build, evaluate, harden, optimize, or fine-tune an agent, the authoritative answer lives in `packages/nemo_helix_ext/src/nemo_helix_ext/skills/`. Read the relevant `SKILL.md` directly and follow it step by step.
...
- Read `packages/nemo_helix_ext/src/nemo_helix_ext/skills/<skill-name>/SKILL.md` as a file and follow its instructions in order.
...
- Do not write Pydantic AI, LangChain, CrewAI, AutoGen, or any agent framework code from scratch. NeMo Helix optimizes LangGraph agents wrapped in NVIDIA NeMo Agent Toolkit (NAT). The skills wire your agent correctly.
...
---
> Source: [NVIDIA-NeMo/nemo-helix](https://github.com/NVIDIA-NeMo/nemo-helix) — distributed by [TomeVault](https://tomevault.io).
