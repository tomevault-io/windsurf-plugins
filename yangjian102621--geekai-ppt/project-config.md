---
trigger: always_on
description: - `backend/`: FastAPI 后端；核心入口在 `backend/main.py`，数据与会话逻辑集中在 `backend/repository.py`、`backend/database.py`。
---
...
---
> Source: [yangjian102621/geekai-ppt](https://github.com/yangjian102621/geekai-ppt) — distributed by [TomeVault](https://tomevault.io).
