---
trigger: always_on
description: ecsta is a CLI tool for operating Amazon ECS (Elastic Container Service) tasks. It supports a wide range of operations including listing tasks, viewing details, executing commands, displaying logs, port forwarding, and file transfers.
---
