---
trigger: always_on
description: All development work must target the `development` branch. PRs should use `development` as their base branch. The `main` branch is updated by merging `development` into it for releases.
---
