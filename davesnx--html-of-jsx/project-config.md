---
trigger: always_on
description: - OCaml keyword conflicts in polyvariants: append underscore (`done_`, `lazy_`)
---
...
---
> Source: [davesnx/html_of_jsx](https://github.com/davesnx/html_of_jsx) — distributed by [TomeVault](https://tomevault.io).
