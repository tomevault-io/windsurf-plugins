---
trigger: always_on
description: > AI coding agents（Claude Code / Codex / Cursor / Gemini CLI 等）共通の作業指示 SSOT。
---
...
- **Layer 2: 仕様** — `design/contracts/` に 33 contract（web 28 + app 先行 5）+ 99 禁止ルール + 99 トークンの JSON 仕様。これが SSOT
