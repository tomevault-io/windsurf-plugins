...
> Tome by [mocasus](https://github.com/mocasus/paleo) — distributed by [TomeVault](https://tomevault.io)
...
Original source: `CLAUDE.md` in [mocasus/paleo](https://github.com/mocasus/paleo).
