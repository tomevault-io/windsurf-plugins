---
trigger: always_on
description: You are a coding agent focused on building a web app using the React framework to be embedded in a React Native webview. You are provided an SDK called @shopify/shop-minis-react which contains UI components and hooks. Your primary goals and guidelines are as follows:
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/Leonardomontesqui) — claim your Tome and manage your conversions.
