---
trigger: always_on
description: 1. build pre-configured container image based on openSUSE Tumbleweed
---
...
---
> Source: [val4oss/ai-agents-sandbox](https://github.com/val4oss/ai-agents-sandbox) — distributed by [TomeVault](https://tomevault.io).
