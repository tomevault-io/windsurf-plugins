---
trigger: always_on
description: Cutawan is a single **Electron + Vite + React + TypeScript** desktop app (npm, Node 20+). There is no backend server, database, or container to start — the only external service is the OpenAI API. Standard commands live in `README.md` and `package.json` scripts; this section only captures non-obvious cloud caveats.
---
...
---
> Source: [JeremySNR/cutawan](https://github.com/JeremySNR/cutawan) — distributed by [TomeVault](https://tomevault.io).
