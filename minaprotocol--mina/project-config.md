---
trigger: always_on
description: Minimal interface providing `run_in_thread` (run blocking OCaml code in a
---
...
---
> Source: [MinaProtocol/mina](https://github.com/MinaProtocol/mina) — distributed by [TomeVault](https://tomevault.io).
