---
trigger: always_on
description: - Purpose: provide rules for automated code-editing agents working in this repository.
---
...
---
> Source: [xkjq/yoto-up](https://github.com/xkjq/yoto-up) — distributed by [TomeVault](https://tomevault.io).
