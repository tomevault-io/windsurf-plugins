---
trigger: always_on
description: Use `pnpm` for all package management commands (not npm or yarn).
---
...
---
> Source: [vercel-labs/emulate](https://github.com/vercel-labs/emulate) — distributed by [TomeVault](https://tomevault.io).
