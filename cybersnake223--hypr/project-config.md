---
trigger: always_on
description: Quickshell overlay menus (app launcher, wifi, bluetooth, power, emoji, screenshot, edit config/script, watch-video) for Hyprland. No git repo, no tests, no linters. QML only.
---
...
---
> Source: [Cybersnake223/Hypr](https://github.com/Cybersnake223/Hypr) — distributed by [TomeVault](https://tomevault.io).
