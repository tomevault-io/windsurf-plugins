---
trigger: always_on
description: These are common instructions for narze's agents across all scenarios.
---
...
---
> Source: [narze/dotfiles](https://github.com/narze/dotfiles) — distributed by [TomeVault](https://tomevault.io).
