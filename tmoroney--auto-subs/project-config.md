---
trigger: always_on
description: > **Note:** This document is primarily intended for AI agents working on the AutoSubs codebase. For general documentation, see the [main README](README.md), [Contributing Guide](CONTRIBUTING.md), or [AutoSubs-App README](AutoSubs-App/README.md).
---
...
---
> Source: [tmoroney/auto-subs](https://github.com/tmoroney/auto-subs) — distributed by [TomeVault](https://tomevault.io).
