---
trigger: always_on
description: > AGENTS.md is a tool-agnostic pointer for non-Claude-Code AI agents (Codex CLI, Cursor, Continue.dev, Aider, Goose, …). Setup is the only thing that differs per tool; the workflow, rules, and worked examples are canonical in [SKILL.md](./SKILL.md).
---
...
---
> Source: [AlexanderAbramovPav/youtube-advisor](https://github.com/AlexanderAbramovPav/youtube-advisor) — distributed by [TomeVault](https://tomevault.io).
