---
trigger: always_on
description: StepCounter is an Android step tracking app that uses accelerometer sensor data to detect steps and calculate distance walked. The app runs as a foreground service for background tracking.
---
