---
trigger: always_on
description: This project uses the eve framework: an agent is a directory of files under `agent/`, and eve compiles and runs it.
---
...
---
> Source: [lemonkingy4-design/alexa-agent](https://github.com/lemonkingy4-design/alexa-agent) — distributed by [TomeVault](https://tomevault.io).
