---
trigger: always_on
description: Tymly is a backend workflow system for data collection and manipulation. It works by pooling together blueprints, plugins, packages and other directories to build project workflows for end users.
---
...
---
> Source: [wmfs/tymly](https://github.com/wmfs/tymly) — distributed by [TomeVault](https://tomevault.io).
