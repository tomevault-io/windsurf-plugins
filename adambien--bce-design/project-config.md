---
trigger: always_on
description: This file provides guidance to AI coding agents (Claude Code, Codex, Gemini CLI, ...) when working with code in this repository.
---
...
---
> Source: [AdamBien/bce.design](https://github.com/AdamBien/bce.design) — distributed by [TomeVault](https://tomevault.io).
