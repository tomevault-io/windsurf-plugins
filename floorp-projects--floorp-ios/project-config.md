---
trigger: always_on
description: - When refactoring existing code, check relevant files for existing tests and update them if necessary.
---
...
---
> Source: [Floorp-Projects/floorp-ios](https://github.com/Floorp-Projects/floorp-ios) — distributed by [TomeVault](https://tomevault.io).
