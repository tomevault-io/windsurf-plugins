---
trigger: always_on
description: This is the **Talo Unity Package**, a self-hostable game development SDK providing leaderboards, player authentication, event tracking, game saves, stats, live config, channels, and more. The package is distributed via Unity Asset Store, GitHub releases, and itch.io.
---
...
---
> Source: [TaloDev/unity](https://github.com/TaloDev/unity) — distributed by [TomeVault](https://tomevault.io).
