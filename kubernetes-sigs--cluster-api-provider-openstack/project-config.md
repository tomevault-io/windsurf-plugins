---
trigger: always_on
description: This document provides guidelines and useful commands for AI agents contributing to the Cluster API Provider OpenStack (CAPO) repository.
---
...
---
> Source: [kubernetes-sigs/cluster-api-provider-openstack](https://github.com/kubernetes-sigs/cluster-api-provider-openstack) — distributed by [TomeVault](https://tomevault.io).
