---
trigger: always_on
description: Shorebird's updater library — a Rust core that gets linked into Flutter Engine (`libflutter.so`) as a static C library to enable over-the-air code push for Flutter apps. The Dart package (`shorebird_code_push`) calls into it via FFI.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/shorebirdtech) — claim your Tome and manage your conversions.
