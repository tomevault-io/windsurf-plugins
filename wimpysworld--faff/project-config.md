---
trigger: always_on
description: CLI tool that generates Conventional Commits messages from git diffs using local LLMs via Ollama. Single-file bash script, privacy-first (no cloud APIs).
---
