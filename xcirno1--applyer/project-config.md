---
trigger: always_on
description: - Always use production style and compatible code.
---
...
---
> Source: [xCirno1/applyer](https://github.com/xCirno1/applyer) — distributed by [TomeVault](https://tomevault.io).
