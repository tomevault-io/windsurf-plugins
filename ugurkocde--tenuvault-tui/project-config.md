---
trigger: always_on
description: TenuVault TUI is a single Go binary (module `github.com/ugurkocde/TenuVault-TUI`)
---
...
---
> Source: [ugurkocde/TenuVault-TUI](https://github.com/ugurkocde/TenuVault-TUI) — distributed by [TomeVault](https://tomevault.io).
