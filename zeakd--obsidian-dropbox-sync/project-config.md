---
trigger: always_on
description: Obsidian vault를 Dropbox로 동기화하는 플러그인.
---
...
---
> Source: [zeakd/obsidian-dropbox-sync](https://github.com/zeakd/obsidian-dropbox-sync) — distributed by [TomeVault](https://tomevault.io).
