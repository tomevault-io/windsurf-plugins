---
trigger: always_on
description: This is a UV workspace monorepo that publishes **two PyPI packages**:
---
...
---
> Source: [linkml/linkml](https://github.com/linkml/linkml) — distributed by [TomeVault](https://tomevault.io).
