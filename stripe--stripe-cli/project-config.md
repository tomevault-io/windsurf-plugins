---
trigger: always_on
description: make build              # Build binary (runs go generate first)
---
...
---
> Source: [stripe/stripe-cli](https://github.com/stripe/stripe-cli) — distributed by [TomeVault](https://tomevault.io).
