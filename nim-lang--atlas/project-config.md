---
trigger: always_on
description: - `src/`: Main Nim sources. Entry point: `src/atlas.nim`. Core modules live under `src/basic/` (parsing, versions, git ops) and helpers like `pkgsearch.nim`, `confighandler.nim`.
---
...
---
> Source: [nim-lang/atlas](https://github.com/nim-lang/atlas) — distributed by [TomeVault](https://tomevault.io).
