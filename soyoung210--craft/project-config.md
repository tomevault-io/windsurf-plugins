---
trigger: always_on
description: 1. **ALWAYS use `pnpm` as the package manager.** Never use npm or yarn.
---
...
---
> Source: [SoYoung210/craft](https://github.com/SoYoung210/craft) — distributed by [TomeVault](https://tomevault.io).
