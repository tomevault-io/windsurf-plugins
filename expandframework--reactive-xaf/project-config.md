---
trigger: always_on
description: Project-specific knowledge distilled from the lab-build workflow session (2026-08-24). Applies on top of the global system.md rules.
---
...
---
> Source: [eXpandFramework/Reactive.XAF](https://github.com/eXpandFramework/Reactive.XAF) — distributed by [TomeVault](https://tomevault.io).
