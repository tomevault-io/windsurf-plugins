---
trigger: always_on
description: Sutra is an Elixir-based offchain transaction builder framework for Cardano. It leverages Rust (via Rustler) for UPLC evaluation and provides a high-level API for constructing, signing, and submitting transactions.
---
...
---
> Source: [txbody-org/sutra-cardano](https://github.com/txbody-org/sutra-cardano) — distributed by [TomeVault](https://tomevault.io).
