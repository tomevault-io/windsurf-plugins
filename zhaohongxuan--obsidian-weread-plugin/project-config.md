---
trigger: always_on
description: - This is an Obsidian community plugin for syncing WeRead (微信读书) book metadata, highlights, notes, and reviews into Markdown files in an Obsidian vault.
---
...
---
> Source: [zhaohongxuan/obsidian-weread-plugin](https://github.com/zhaohongxuan/obsidian-weread-plugin) — distributed by [TomeVault](https://tomevault.io).
