---
trigger: always_on
description: This section defines the core rules for an agent's behavior within this project.
---
...
---
> Source: [node-libraries/wasm-image-optimization](https://github.com/node-libraries/wasm-image-optimization) — distributed by [TomeVault](https://tomevault.io).
