---
trigger: always_on
description: This is a personal portfolio website built with Next.js 16 using the App Router, configured for static export and GitHub Pages deployment. The site features MDX-based articles, dark/light theme support, and a clean, professional design built with Tailwind CSS.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/tpkreepur) — claim your Tome and manage your conversions.
