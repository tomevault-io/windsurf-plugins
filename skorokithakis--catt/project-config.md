---
trigger: always_on
description: Guide for AI agents (and new human contributors) working in this repo.
---
...
---
> Source: [skorokithakis/catt](https://github.com/skorokithakis/catt) — distributed by [TomeVault](https://tomevault.io).
