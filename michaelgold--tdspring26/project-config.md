---
trigger: always_on
description: This is a Blender Technical Direction course repository. Scripts automate Blender scene setup, rendering, cameras, lighting, and pipeline tasks using the `bpy` Python API.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/michaelgold) — claim your Tome and manage your conversions.
