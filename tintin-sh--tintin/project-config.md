---
trigger: always_on
description: - Chat entrypoint for Codex / Claude Code via Telegram or Slack; can drive Playwright MCP / Browserbase / Hyperbrowser.
---
...
---
> Source: [tintin-sh/tintin](https://github.com/tintin-sh/tintin) — distributed by [TomeVault](https://tomevault.io).
