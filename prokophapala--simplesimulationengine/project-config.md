---
trigger: always_on
description: We develop rigorous scientific software where debuggability, physical consistency, numerical correctness and stability, as well as performance and simplicity are paramount. Follow these principles:
---
...
---
> Source: [ProkopHapala/SimpleSimulationEngine](https://github.com/ProkopHapala/SimpleSimulationEngine) — distributed by [TomeVault](https://tomevault.io).
