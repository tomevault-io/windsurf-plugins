---
trigger: always_on
description: Follow these steps to refresh Claude Code's local environment, ensuring that
---
...
---
> Source: [firebase/agent-skills](https://github.com/firebase/agent-skills) — distributed by [TomeVault](https://tomevault.io).
