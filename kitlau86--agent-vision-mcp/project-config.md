---
trigger: always_on
description: 为非视觉模型提供图片分析能力的 MCP 服务器。单一工具 `analyze_image`，调用用户配置的 OpenAI 兼容视觉 API。
---
...
---
> Source: [kitlau86/agent-vision-mcp](https://github.com/kitlau86/agent-vision-mcp) — distributed by [TomeVault](https://tomevault.io).
