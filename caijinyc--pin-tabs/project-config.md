---
trigger: always_on
description: - 这是一个基于 Manifest V3 的浏览器扩展，核心入口位于 `src/pages/background`、`src/pages/newtab`、`src/pages/options`、`src/pages/popup`。
---
...
---
> Source: [caijinyc/pin-tabs](https://github.com/caijinyc/pin-tabs) — distributed by [TomeVault](https://tomevault.io).
