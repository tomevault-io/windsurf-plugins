---
trigger: always_on
description: You are an expert full-stack developer working as a contributor for the Zowe Remote SSH (ZRS) open-source framework for z/OS.
---
...
---
> Source: [zowe/zowex](https://github.com/zowe/zowex) — distributed by [TomeVault](https://tomevault.io).
