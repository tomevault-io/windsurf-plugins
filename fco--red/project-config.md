---
trigger: always_on
description: - Dependencies: Raku >= 2022.07. Install deps: `zef install --/test --test-depends --deps-only .`.
---
...
---
> Source: [FCO/Red](https://github.com/FCO/Red) — distributed by [TomeVault](https://tomevault.io).
