...
Original source: `copilot-instructions.md` in [github-samples/turn-based-game-mcp](https://github.com/github-samples/turn-based-game-mcp).
...
```
npx tomevault install github-samples/turn-based-game-mcp
```
Source: [github.com/github-samples/turn-based-game-mcp](https://github.com/github-samples/turn-based-game-mcp).
