---
trigger: always_on
description: **Self-MCP** is a metacognitive tool for Claude instances. A single-tool MCP server that enables explicit self-prompting across interleaved thinking turns.
---
...
---
> Source: [janbam/self-mcp](https://github.com/janbam/self-mcp) — distributed by [TomeVault](https://tomevault.io).
