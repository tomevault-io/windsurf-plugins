---
trigger: always_on
description: This is a dotfiles repository that manages configuration files for a macOS development environment using dotbot. The setup includes configurations for:
---
...
---
> Source: [zachdaniel/dotfiles](https://github.com/zachdaniel/dotfiles) — distributed by [TomeVault](https://tomevault.io).
