---
trigger: always_on
description: A Go CLI tool for Kubernetes development — syncs local code changes to remote clusters in real time.
---
...
- Use the strategy pattern for feature flags; choose the default that preserves current behavior — see [context/feature-flags.md](.claude/context/feature-flags.md)
...
---
> Source: [okteto/okteto](https://github.com/okteto/okteto) — distributed by [TomeVault](https://tomevault.io).
