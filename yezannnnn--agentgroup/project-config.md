---
trigger: always_on
description: This is the MCP (Model Context Protocol) server implementation for Simone. This is a complete rewrite of the legacy directory-based command system.
---
...
---
> Source: [yezannnnn/agentGroup](https://github.com/yezannnnn/agentGroup) — distributed by [TomeVault](https://tomevault.io).
