---
trigger: always_on
description: 本文件是给 Codex 和其他编码代理看的项目说明。优先遵守离当前工作目录最近的 `AGENTS.md`；如果没有更近的说明，就遵守本文件。
---
...
---
> Source: [kuizuo/blog](https://github.com/kuizuo/blog) — distributed by [TomeVault](https://tomevault.io).
