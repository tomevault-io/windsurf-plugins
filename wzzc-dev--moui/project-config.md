---
trigger: always_on
description: Short map only. Deep rules live in `docs/`; do not treat this file as an encyclopedia.
---
...
---
> Source: [wzzc-dev/MoUI](https://github.com/wzzc-dev/MoUI) — distributed by [TomeVault](https://tomevault.io).
