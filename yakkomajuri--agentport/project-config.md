---
trigger: always_on
description: A universal tool gateway for AI agents. One place to manage every external capability an agent can call — remote MCP servers or plain REST APIs.
---
...
---
> Source: [yakkomajuri/agentport](https://github.com/yakkomajuri/agentport) — distributed by [TomeVault](https://tomevault.io).
