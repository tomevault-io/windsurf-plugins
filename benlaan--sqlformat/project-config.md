---
trigger: always_on
description: This is a VS Code extension called "laan.sqlformat" that formats SQL code using an external `sqlformat` command-line tool.
---
...
---
> Source: [benlaan/sqlformat](https://github.com/benlaan/sqlformat) — distributed by [TomeVault](https://tomevault.io).
