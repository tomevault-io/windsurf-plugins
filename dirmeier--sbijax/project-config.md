---
trigger: always_on
description: Operational guide for an agent editing **sbijax** — a JAX library of
---
...
---
> Source: [dirmeier/sbijax](https://github.com/dirmeier/sbijax) — distributed by [TomeVault](https://tomevault.io).
