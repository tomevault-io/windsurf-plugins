---
trigger: always_on
description: AssistAI is an Eclipse IDE plugin that integrates LLM assistants (OpenAI, Anthropic, Gemini, Grok, DeepSeek, Groq) into the development environment. It also functions as an MCP Server, exposing Eclipse IDE tools via HTTP for external clients like Claude Code and Claude Desktop.
---
...
---
> Source: [gradusnikov/eclipse-chatgpt-plugin](https://github.com/gradusnikov/eclipse-chatgpt-plugin) — distributed by [TomeVault](https://tomevault.io).
