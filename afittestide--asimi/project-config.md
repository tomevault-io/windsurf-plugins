---
trigger: always_on
description: **Write idiomatic Go** - Keep it simple, flat, and direct.
---
...
---
> Source: [afittestide/asimi](https://github.com/afittestide/asimi) — distributed by [TomeVault](https://tomevault.io).
