---
trigger: always_on
description: - `goldboot/src/builder/os/` — one module per supported OS
---
...
---
> Source: [fossable/goldboot](https://github.com/fossable/goldboot) — distributed by [TomeVault](https://tomevault.io).
