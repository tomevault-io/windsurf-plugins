---
trigger: always_on
description: This repository ships an [Agent Skill](https://agentskills.io) for hylite at:
---
...
---
> Source: [hifexplo/hylite](https://github.com/hifexplo/hylite) — distributed by [TomeVault](https://tomevault.io).
