---
trigger: always_on
description: 1. **`page.getByRole(role, { name })`** - Interactive elements, headings (reflects user perception)
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/redhat-developer)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/redhat-developer)
