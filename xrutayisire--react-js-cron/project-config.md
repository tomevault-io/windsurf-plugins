---
trigger: always_on
description: A React cron editor component built with Ant Design (antd). Allows users to build cron expressions via a UI.
---
...
---
> Source: [xrutayisire/react-js-cron](https://github.com/xrutayisire/react-js-cron) — distributed by [TomeVault](https://tomevault.io).
