---
trigger: always_on
description: `qref` defines the Quantum Resource Estimation Format and provides validation, schema tooling, docs, and rendering utilities.
---
...
---
> Source: [PsiQ/qref](https://github.com/PsiQ/qref) — distributed by [TomeVault](https://tomevault.io).
