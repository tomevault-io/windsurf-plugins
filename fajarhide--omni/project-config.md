---
trigger: always_on
description: This file is for AI assistants (Claude, Codex, etc.) and human contributors working on OMNI.
---
...
---
> Source: [fajarhide/omni](https://github.com/fajarhide/omni) — distributed by [TomeVault](https://tomevault.io).
