---
trigger: always_on
description: The **simplicio-tasks** skill is runtime-agnostic. Gemini, Codex, Copilot, Grok, or
---
...
---
> Source: [wesleysimplicio/simplicio-loop](https://github.com/wesleysimplicio/simplicio-loop) — distributed by [TomeVault](https://tomevault.io).
