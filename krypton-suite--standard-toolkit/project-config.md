---
trigger: always_on
description: - Shell: Use Command Prompt (`cmd.exe`) only; avoid Bash/Unix commands
---
...
---
> Source: [Krypton-Suite/Standard-Toolkit](https://github.com/Krypton-Suite/Standard-Toolkit) — distributed by [TomeVault](https://tomevault.io).
