---
trigger: always_on
description: npm run tauri:dev      # Tauri dev mode
---
...
---
> Source: [zarguell/phishmonger](https://github.com/zarguell/phishmonger) — distributed by [TomeVault](https://tomevault.io).
