---
trigger: always_on
description: 本文档为运行在本代码库的AI编码/翻译智能体提供操作规范。
---
...
---
> Source: [xindoo/agentic-design-patterns](https://github.com/xindoo/agentic-design-patterns) — distributed by [TomeVault](https://tomevault.io).
