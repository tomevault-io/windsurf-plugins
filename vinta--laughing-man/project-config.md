---
trigger: always_on
description: laughing-man is a CLI tool that turns a folder of Markdown files into a newsletter: a static archive site on Cloudflare Pages and email delivery via Resend Broadcasts. Built with Bun + TypeScript.
---
...
### Cloudflare Skills (`.Codex/skills/`)
...
---
> Source: [vinta/laughing-man](https://github.com/vinta/laughing-man) — distributed by [TomeVault](https://tomevault.io).
