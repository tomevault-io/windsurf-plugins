---
trigger: always_on
description: - Build the solution from the repo root: `dotnet build src/Generator.sln`
---
...
---
> Source: [dotMorten/DotNetOMDGenerator](https://github.com/dotMorten/DotNetOMDGenerator) — distributed by [TomeVault](https://tomevault.io).
