---
trigger: always_on
description: Vesta is a native macOS terminal built on **libghostty** (linked as
---
...
---
> Source: [vestaterm/Vesta](https://github.com/vestaterm/Vesta) — distributed by [TomeVault](https://tomevault.io).
