---
trigger: always_on
description: ISPC (Intel SPMD Program Compiler) is a performance-oriented compiler for
---
...
---
> Source: [ispc/ispc](https://github.com/ispc/ispc) — distributed by [TomeVault](https://tomevault.io).
