---
trigger: always_on
description: xd is a crossword puzzle processing pipeline. It defines the `.xd` plain-text format and provides tools to convert from other formats (puz, ipuz, XML, JSON) into `.xd`.
---
...
---
> Source: [century-arcade/xd](https://github.com/century-arcade/xd) — distributed by [TomeVault](https://tomevault.io).
