---
trigger: always_on
description: 1. **`version/version.go`**: Update `fdwVersion` to the new version (e.g., `"2.2.0"`).
---
...
---
> Source: [turbot/steampipe-postgres-fdw](https://github.com/turbot/steampipe-postgres-fdw) — distributed by [TomeVault](https://tomevault.io).
