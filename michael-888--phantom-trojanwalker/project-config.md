---
trigger: always_on
description: - Ghidra 引擎服务（:8000）：[module/ghidra_pipe/main.py](../module/ghidra_pipe/main.py) 维护"当前打开的二进制"全局状态；提供 `/upload`→`/analyze`→`/metadata`/`/functions`/`/strings`/`/callgraph`/`/decompile_batch`。
---
...
---
> Source: [MICHAEL-888/Phantom_TrojanWalker](https://github.com/MICHAEL-888/Phantom_TrojanWalker) — distributed by [TomeVault](https://tomevault.io).
