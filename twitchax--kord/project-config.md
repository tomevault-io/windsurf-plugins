---
trigger: always_on
description: - Heavy use of `#[cfg(feature = "…")]` across crates; follow existing feature gating patterns (base → specific).
---
...
---
> Source: [twitchax/kord](https://github.com/twitchax/kord) — distributed by [TomeVault](https://tomevault.io).
