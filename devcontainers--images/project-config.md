---
trigger: always_on
description: - Every image change must bump the version in the image's `manifest.json` using semantic versioning.
---
...
---
> Source: [devcontainers/images](https://github.com/devcontainers/images) — distributed by [TomeVault](https://tomevault.io).
