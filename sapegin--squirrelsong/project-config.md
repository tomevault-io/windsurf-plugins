---
trigger: always_on
description: Monorepo of UX/color themes for various apps. One folder per extension under `themes/<app>/`.
---
...
---
> Source: [sapegin/squirrelsong](https://github.com/sapegin/squirrelsong) — distributed by [TomeVault](https://tomevault.io).
