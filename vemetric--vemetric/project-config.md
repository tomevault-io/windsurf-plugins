---
trigger: always_on
description: - `apps/` contains runnable services: `app` (Vite SPA + Hono API), `hub` (event ingestion), `worker` (jobs), `bullboard` (queue UI), `health-check`, and `e2e` (Playwright tests).
---
...
---
> Source: [vemetric/vemetric](https://github.com/vemetric/vemetric) — distributed by [TomeVault](https://tomevault.io).
