---
trigger: always_on
description: - Ignore files that match the glob patterns specificed by `package.exclude` glob patterns in file `Cargo.toml`.
---
...
---
> Source: [jtmoon79/super-speedy-syslog-searcher](https://github.com/jtmoon79/super-speedy-syslog-searcher) — distributed by [TomeVault](https://tomevault.io).
