---
trigger: always_on
description: Lightweight, type-safe, zero-dependency awaitable hook system.
---
...
---
> Source: [unjs/hookable](https://github.com/unjs/hookable) — distributed by [TomeVault](https://tomevault.io).
