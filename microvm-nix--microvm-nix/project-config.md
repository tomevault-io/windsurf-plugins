---
trigger: always_on
description: This section describes the interface that is used to run MicroVM
---
...
---
> Source: [microvm-nix/microvm.nix](https://github.com/microvm-nix/microvm.nix) — distributed by [TomeVault](https://tomevault.io).
