---
trigger: always_on
description: The following text has been compressed by you (Claude 3.5 sonnet) to save space. Decode the text to reconstruct and understand the original context. The decoded text contains compressed information about Convex, React, and web development practices:
---
...
---
> Source: [tomredman/add-convex-to-cursor](https://github.com/tomredman/add-convex-to-cursor) — distributed by [TomeVault](https://tomevault.io).
