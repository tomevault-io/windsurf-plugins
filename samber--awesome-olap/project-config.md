---
trigger: always_on
description: **`README.md` is the only content file.** The website (`samber.github.io/awesome-olap`) is generated from it at build time. Never duplicate content between the README and the site.
---
...
---
> Source: [samber/awesome-olap](https://github.com/samber/awesome-olap) — distributed by [TomeVault](https://tomevault.io).
