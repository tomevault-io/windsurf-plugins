---
trigger: always_on
description: - **Platform-specific code** → `platform/<platform-name>/`
---
...
---
> Source: [hyperledger-labs/fabric-smart-client](https://github.com/hyperledger-labs/fabric-smart-client) — distributed by [TomeVault](https://tomevault.io).
