...
Original source: `copilot-instructions.md` in [macalbert/envilder](https://github.com/macalbert/envilder).
...
From [macalbert/envilder](https://github.com/macalbert/envilder) — a repo with 136+ stars on GitHub.
