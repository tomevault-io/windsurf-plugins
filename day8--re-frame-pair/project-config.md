---
trigger: always_on
description: **Canonical instructions are in [`CLAUDE.md`](CLAUDE.md).** Read that file for build/test commands, fixture integration testing, beads workflow, session-completion rules, and shell-command non-interactivity tips.
---
...
---
> Source: [day8/re-frame-pair](https://github.com/day8/re-frame-pair) — distributed by [TomeVault](https://tomevault.io).
