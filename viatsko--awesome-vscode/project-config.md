---
trigger: always_on
description: An [Awesome List](https://github.com/sindresorhus/awesome) of Visual Studio Code
---
...
---
> Source: [viatsko/awesome-vscode](https://github.com/viatsko/awesome-vscode) — distributed by [TomeVault](https://tomevault.io).
