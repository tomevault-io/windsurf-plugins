---
trigger: always_on
description: Below is an implementation of a service that can retrieve the latest version from maven central. You can curl yourself the latest versions by running an equivalent command from the CLI.
---
...
---
> Source: [theapache64/compose-chrome-extension-template](https://github.com/theapache64/compose-chrome-extension-template) — distributed by [TomeVault](https://tomevault.io).
