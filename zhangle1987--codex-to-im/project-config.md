---
trigger: always_on
description: 本仓库是 `codex-to-im`，一个本地 npm 包，用来把 Codex 接入飞书、微信等 IM 通道。维护目标不是只让单个接口跑通，而是保证 CLI、Web UI、bridge 守护进程、Codex SDK、Codex Desktop thread、IM 通道和本地持久化状态之间长期一致。
---
...
---
> Source: [zhangle1987/codex-to-im](https://github.com/zhangle1987/codex-to-im) — distributed by [TomeVault](https://tomevault.io).
