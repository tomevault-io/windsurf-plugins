...
- Use Simplified Chinese for all code and documentation（Except for special cases, such as proper nouns, variable names, etc.）.
...
---
> Source: [anjiemo/Downloader](https://github.com/anjiemo/Downloader) — distributed by [TomeVault](https://tomevault.io).
