---
trigger: always_on
description: Python benchmark framework for browser agents and provider integrations.
---
...
---
> Source: [lexmount/browseruse-agent-bench](https://github.com/lexmount/browseruse-agent-bench) — distributed by [TomeVault](https://tomevault.io).
