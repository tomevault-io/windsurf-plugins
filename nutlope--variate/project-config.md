---
trigger: always_on
description: variate puts four design variations of one of the user's files on their own
---
...
---
> Source: [Nutlope/variate](https://github.com/Nutlope/variate) — distributed by [TomeVault](https://tomevault.io).
