---
trigger: always_on
description: - Run all tests: `python -m unittest discover -s tests`
---
...
---
> Source: [rawveg/trader-magic](https://github.com/rawveg/trader-magic) — distributed by [TomeVault](https://tomevault.io).
