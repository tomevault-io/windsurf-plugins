---
trigger: always_on
description: Strictly adhere to these coding preferences while writing code when asked:
---
...
---
> Source: [yyovil/tandem](https://github.com/yyovil/tandem) — distributed by [TomeVault](https://tomevault.io).
