---
trigger: always_on
description: Freyja 是一个使用 Vue SSR + NestJS 的博客系统，采用 npm workspaces 的 monorepo 结构：
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/bangbang93)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/bangbang93)
