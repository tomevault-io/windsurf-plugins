---
trigger: always_on
description: Client/server network interface: request packing/unpacking, server dispatch table, method/xs callback glue, and client-side histogram collection.
---
...
---
> Source: [CUBRID/cubrid](https://github.com/CUBRID/cubrid) — distributed by [TomeVault](https://tomevault.io).
