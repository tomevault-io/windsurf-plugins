---
trigger: always_on
description: CIM (Cross-platform Instant Messaging) is a Java-based instant messaging framework.
---
...
---
> Source: [crossoverJie/cim](https://github.com/crossoverJie/cim) — distributed by [TomeVault](https://tomevault.io).
