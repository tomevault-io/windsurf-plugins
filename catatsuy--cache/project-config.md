---
trigger: always_on
description: This repository implements Go caching primitives, singleflight variants, and supporting tooling. Follow these practices to keep contributions fast and reliable.
---
...
---
> Source: [catatsuy/cache](https://github.com/catatsuy/cache) — distributed by [TomeVault](https://tomevault.io).
