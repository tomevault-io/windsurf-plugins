---
trigger: always_on
description: This document provides context and guidelines for AI agents working on the `compose_edge_to_edge_preview` project.
---
...
---
> Source: [timo-drick/compose_edge_to_edge_preview](https://github.com/timo-drick/compose_edge_to_edge_preview) — distributed by [TomeVault](https://tomevault.io).
