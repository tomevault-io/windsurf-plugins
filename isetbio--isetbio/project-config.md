---
trigger: always_on
description: Use this file as the shared startup guidance for AI coding assistants working
---
...
---
> Source: [isetbio/isetbio](https://github.com/isetbio/isetbio) — distributed by [TomeVault](https://tomevault.io).
