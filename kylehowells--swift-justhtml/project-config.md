---
trigger: always_on
description: A dependency-free Swift implementation of an HTML5 parser following the WHATWG HTML parsing specification. This is a Swift port of [justhtml](https://github.com/EmilStenstrom/justhtml) (Python) and [justjshtml](https://github.com/simonw/justjshtml) (JavaScript).
---
...
---
> Source: [kylehowells/swift-justhtml](https://github.com/kylehowells/swift-justhtml) — distributed by [TomeVault](https://tomevault.io).
