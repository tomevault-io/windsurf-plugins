---
trigger: always_on
description: Repo-specific guidance for automated contributors.
---
...
---
> Source: [alanrsoares/prelude-js](https://github.com/alanrsoares/prelude-js) — distributed by [TomeVault](https://tomevault.io).
