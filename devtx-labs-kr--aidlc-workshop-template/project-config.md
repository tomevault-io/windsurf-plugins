---
trigger: always_on
description: AIDLC (AI-Driven Development Life Cycle) workshop project. Provides structured software development workflow with Inception, Construction, and Operations phases.
---
...
---
> Source: [devtx-labs-kr/aidlc-workshop-template](https://github.com/devtx-labs-kr/aidlc-workshop-template) — distributed by [TomeVault](https://tomevault.io).
