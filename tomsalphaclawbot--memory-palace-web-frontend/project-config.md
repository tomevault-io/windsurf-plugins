---
trigger: always_on
description: Project-level instructions for AI/code agents working in this repository.
---
...
---
> Source: [tomsalphaclawbot/memory-palace-web-frontend](https://github.com/tomsalphaclawbot/memory-palace-web-frontend) — distributed by [TomeVault](https://tomevault.io).
