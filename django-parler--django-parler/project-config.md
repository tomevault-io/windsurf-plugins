---
trigger: always_on
description: Reusable Django library that adds model-level translation support via a separate `*Translation` table per model. No runnable server — this is a Django app package.
---
...
---
> Source: [django-parler/django-parler](https://github.com/django-parler/django-parler) — distributed by [TomeVault](https://tomevault.io).
