---
trigger: always_on
description: - `devbox run -- uv run -- pytest` – run all tests
---
...
---
> Source: [copier-org/copier](https://github.com/copier-org/copier) — distributed by [TomeVault](https://tomevault.io).
