---
trigger: always_on
description: - IntelliJ plugin: `./build.sh <version_number>` (creates JAR file)
---
...
---
> Source: [gaplo917/GapStyle](https://github.com/gaplo917/GapStyle) — distributed by [TomeVault](https://tomevault.io).
