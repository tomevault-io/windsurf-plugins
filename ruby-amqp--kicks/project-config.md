---
trigger: always_on
description: Kicks is a fast background processing framework for Ruby and RabbitMQ.
---
...
---
> Source: [ruby-amqp/kicks](https://github.com/ruby-amqp/kicks) — distributed by [TomeVault](https://tomevault.io).
