---
trigger: always_on
description: OpenQuota tracks Claude subscription limits and local Claude usage history.
---
...
---
> Source: [deviffyy/OpenQuota](https://github.com/deviffyy/OpenQuota) — distributed by [TomeVault](https://tomevault.io).
