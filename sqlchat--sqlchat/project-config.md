---
trigger: always_on
description: - Development: `pnpm dev` (or `pnpm nodb` without DB, `pnpm usedb` with DB)
---
...
---
> Source: [sqlchat/sqlchat](https://github.com/sqlchat/sqlchat) — distributed by [TomeVault](https://tomevault.io).
