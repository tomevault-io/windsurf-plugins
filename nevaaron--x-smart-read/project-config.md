---
trigger: always_on
description: This file is for AI agents (Claude Code, OpenClaw, Cursor, Copilot, etc.). For human docs, see [README.md](README.md). For setup instructions, see [SETUP.md](SETUP.md).
---
...
---
> Source: [nevaaron/x-smart-read](https://github.com/nevaaron/x-smart-read) — distributed by [TomeVault](https://tomevault.io).
