---
trigger: always_on
description: open-xquant is an Agent First quantitative trading framework. See `README.md` for motivation and `docs/architecture.md` for full design.
---
...
---
> Source: [xingwudao/open-xquant](https://github.com/xingwudao/open-xquant) — distributed by [TomeVault](https://tomevault.io).
