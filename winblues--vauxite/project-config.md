---
trigger: always_on
description: A **BlueBuild** project that produces signed OCI container images for a Fedora Atomic Xfce desktop (`ghcr.io/winblues/vauxite`). There is no application code — the "source" is YAML recipe files, build-time shell scripts, and a filesystem overlay. End users install/update via `bootc` or `rpm-ostree rebase`.
---
...
---
> Source: [winblues/vauxite](https://github.com/winblues/vauxite) — distributed by [TomeVault](https://tomevault.io).
