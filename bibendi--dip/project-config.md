---
trigger: always_on
description: dip is a Ruby CLI gem (Thor-based) for Dockerized development. It wraps docker-compose and kubectl commands via a `dip.yml` config.
---
...
---
> Source: [bibendi/dip](https://github.com/bibendi/dip) — distributed by [TomeVault](https://tomevault.io).
