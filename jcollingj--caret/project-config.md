---
trigger: always_on
description: bun run dev  # shorthand for: node esbuild.config.mjs
---
...
---
> Source: [jcollingj/caret](https://github.com/jcollingj/caret) — distributed by [TomeVault](https://tomevault.io).
