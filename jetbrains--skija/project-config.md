---
trigger: always_on
description: - As close to Skia API as possible. Exceptions:
---
...
---
> Source: [JetBrains/skija](https://github.com/JetBrains/skija) — distributed by [TomeVault](https://tomevault.io).
