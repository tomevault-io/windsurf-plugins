---
trigger: always_on
description: Mineradio 是 Windows Electron 桌面音乐播放器，核心体验包括搜索、播放、歌单、歌词、3D 歌单架、粒子视觉预设、DIY 视觉控制台和 GitHub 自动更新。
---
...
---
> Source: [haoj322-ops/https-github.com-XxHuberrr-Mineradio](https://github.com/haoj322-ops/https-github.com-XxHuberrr-Mineradio) — distributed by [TomeVault](https://tomevault.io).
