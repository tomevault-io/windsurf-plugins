---
trigger: always_on
description: **Listr** is a Nostr-based list management application built with SvelteKit. It allows users to create, manage, and discover various types of Nostr lists (Contact lists, Mute lists, Bookmarks, Communities, etc.).
---
...
---
> Source: [erskingardner/listr](https://github.com/erskingardner/listr) — distributed by [TomeVault](https://tomevault.io).
