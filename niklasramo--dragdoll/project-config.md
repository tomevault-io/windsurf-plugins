---
trigger: always_on
description: Vanilla TypeScript drag and drop library with a modular architecture (sensors, draggables, droppables). Framework integration packages provide hooks wrapping the core library:
---
