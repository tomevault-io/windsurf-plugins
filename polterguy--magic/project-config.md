---
trigger: always_on
description: React + Vite + TypeScript single-page app — the Magic dashboard.
---
...
---
> Source: [polterguy/magic](https://github.com/polterguy/magic) — distributed by [TomeVault](https://tomevault.io).
