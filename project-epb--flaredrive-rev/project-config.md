---
trigger: always_on
description: 一个基于 Cloudflare Workers 的云原生 S3-compatible 存储桶管理工具，支持多存储后端（R2、AWS S3、MinIO 等），提供用户注册/登录、桶配置与管理功能。
---
...
---
> Source: [project-epb/flaredrive-rev](https://github.com/project-epb/flaredrive-rev) — distributed by [TomeVault](https://tomevault.io).
