---
trigger: always_on
description: Project guidance for Claude Code sessions. Keep this file tight: skim it first, then dive in.
---
...
---
> Source: [unredacted/packetframe](https://github.com/unredacted/packetframe) — distributed by [TomeVault](https://tomevault.io).
