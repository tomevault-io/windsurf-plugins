---
trigger: always_on
description: Deeper instructions for specific kinds of work live in `agents/skills/`. Read the
---
...
---
> Source: [omacom/omarchy](https://github.com/omacom/omarchy) — distributed by [TomeVault](https://tomevault.io).
