---
trigger: always_on
description: Guidance for coding agents working in the current OpenRange repo.
---
...
---
> Source: [open-cybernauts/open-range](https://github.com/open-cybernauts/open-range) — distributed by [TomeVault](https://tomevault.io).
