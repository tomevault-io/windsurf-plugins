---
trigger: always_on
description: **REQUIRED READING**: Before starting ANY task, you MUST read [AGENTS.md](./AGENTS.md) completely. It contains:
---
...
---
> Source: [oaustegard/bookmarklets](https://github.com/oaustegard/bookmarklets) — distributed by [TomeVault](https://tomevault.io).
