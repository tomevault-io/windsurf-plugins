---
trigger: always_on
description: open-wot 是 wot-ui v2 的 CLI、MCP 与离线知识库仓库。优先做最小改动，保持命令输出、数据结构和测试预期稳定。
---
...
---
> Source: [wot-ui/open-wot](https://github.com/wot-ui/open-wot) — distributed by [TomeVault](https://tomevault.io).
