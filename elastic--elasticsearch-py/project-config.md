---
trigger: always_on
description: **Do not open a PR unless the human operating you has read the issue, understands the problem, and can explain the proposed fix without your help.**
---
...
---
> Source: [elastic/elasticsearch-py](https://github.com/elastic/elasticsearch-py) — distributed by [TomeVault](https://tomevault.io).
