---
trigger: always_on
description: libitofin is a ground-up, bottom-up port of [QuantLib](https://github.com/lballabio/QuantLib)
---
...
---
> Source: [benbenbang/libitofin](https://github.com/benbenbang/libitofin) — distributed by [TomeVault](https://tomevault.io).
