---
trigger: always_on
description: - This repo is a Markdown proposal archive, not a codebase. Proposal files live at the root as `NNN-title.md`; proposal assets live under `images/`.
---
...
---
> Source: [strimzi/proposals](https://github.com/strimzi/proposals) — distributed by [TomeVault](https://tomevault.io).
