---
trigger: always_on
description: **Read the workspace AGENTS.md at `../AGENTS.md` first.** This file extends it with repo-specific detail for `engram`. Platform-wide rules (engram protocol, licensing, build conventions, commit format) are defined there and apply here without exception.
---
