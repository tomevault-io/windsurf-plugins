---
trigger: always_on
description: Operating instructions for coding agents (Hermes, Codex, Claude Code, Cursor, …).
---
...
---
> Source: [tony-simons-aiowa/hermes-newswire](https://github.com/tony-simons-aiowa/hermes-newswire) — distributed by [TomeVault](https://tomevault.io).
