---
trigger: always_on
description: This is a Pulumi provider for [DataRobot](https://www.datarobot.com/), automatically bridged from the [terraform-provider-datarobot](https://github.com/datarobot-community/terraform-provider-datarobot) using [pulumi-terraform-bridge](https://github.com/pulumi/pulumi-terraform-bridge).
---
...
---
> Source: [datarobot-community/pulumi-datarobot](https://github.com/datarobot-community/pulumi-datarobot) — distributed by [TomeVault](https://tomevault.io).
