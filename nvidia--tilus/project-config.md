---
trigger: always_on
description: Tilus caches generated kernels. During development, set the cache directory via `tilus.option.cache_dir("some-cache-dir")` to inspect the generated `source.cu` files.
---
