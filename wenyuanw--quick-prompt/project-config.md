---
trigger: always_on
description: - Source: `entrypoints/` (web extension entrypoints)
---
...
---
> Source: [wenyuanw/quick-prompt](https://github.com/wenyuanw/quick-prompt) — distributed by [TomeVault](https://tomevault.io).
