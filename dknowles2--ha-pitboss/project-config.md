---
trigger: always_on
description: `ha-pitboss` is a HACS custom component for Home Assistant that talks to
---
...
---
> Source: [dknowles2/ha-pitboss](https://github.com/dknowles2/ha-pitboss) — distributed by [TomeVault](https://tomevault.io).
