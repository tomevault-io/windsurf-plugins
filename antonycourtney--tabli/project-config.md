---
trigger: always_on
description: - Build: `npm run build-dev` (development) or `npm run build-prod` (production)
---
...
---
> Source: [antonycourtney/tabli](https://github.com/antonycourtney/tabli) — distributed by [TomeVault](https://tomevault.io).
