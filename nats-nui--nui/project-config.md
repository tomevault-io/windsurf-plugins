---
trigger: always_on
description: This is a **React** frontend application built with **Vite**, designed to run as both a **Web** application and a **Desktop** application (via **Wails**). It interacts with NATS servers.
---
...
---
> Source: [nats-nui/nui](https://github.com/nats-nui/nui) — distributed by [TomeVault](https://tomevault.io).
