---
trigger: always_on
description: This is a multi-cluster Kubernetes homelab managed through GitOps using ArgoCD, with a unique KCL-based configuration system replacing traditional YAML/Helm patterns.
---
...
---
> Source: [MacroPower/homelab](https://github.com/MacroPower/homelab) — distributed by [TomeVault](https://tomevault.io).
