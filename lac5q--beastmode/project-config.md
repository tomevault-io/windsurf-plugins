...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/beastmode/context` | Codebase overview, check index freshness |
| `gitnexus://repo/beastmode/clusters` | All functional areas |
| `gitnexus://repo/beastmode/processes` | All execution flows |
| `gitnexus://repo/beastmode/process/{name}` | Step-by-step execution trace |
...
---
> Source: [lac5q/beastmode](https://github.com/lac5q/beastmode) — distributed by [TomeVault](https://tomevault.io).
