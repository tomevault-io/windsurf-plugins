---
trigger: always_on
description: Roster is a **human-in-the-loop, hierarchical multi-agent framework** for software-engineering and
---
...
---
> Source: [zhiming-dev/Roster](https://github.com/zhiming-dev/Roster) — distributed by [TomeVault](https://tomevault.io).
