---
trigger: always_on
description: <!-- Above imports universal agent instructions. Claude-specific extensions below. -->
---
...
---
> Source: [DataRecce/recce](https://github.com/DataRecce/recce) — distributed by [TomeVault](https://tomevault.io).
