---
trigger: always_on
description: - Before running any tests, run `make` in the triton directory to rebuild triton.
---
...
---
> Source: [triton-lang/Triton-to-tile-IR](https://github.com/triton-lang/Triton-to-tile-IR) — distributed by [TomeVault](https://tomevault.io).
