---
trigger: always_on
description: For changes to files in the `frontend/` directory.
---
...
- Use only test-level mocks, avoid module-level mocks.
...
---
> Source: [FarmBot/Farmbot-Web-App](https://github.com/FarmBot/Farmbot-Web-App) — distributed by [TomeVault](https://tomevault.io).
