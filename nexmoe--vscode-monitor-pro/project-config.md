---
trigger: always_on
description: To ensure high-quality code evolution and system stability, you must strictly adhere to the following protocols:
---
...
---
> Source: [nexmoe/vscode-monitor-pro](https://github.com/nexmoe/vscode-monitor-pro) — distributed by [TomeVault](https://tomevault.io).
