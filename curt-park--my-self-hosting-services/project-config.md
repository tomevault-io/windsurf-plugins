---
trigger: always_on
description: Docker-based homelab infrastructure for self-hosting services. Each service is a Docker Compose stack deployed via Portainer from a forked Git repository. All persistent data lives under `$HOME/docker_volumes/`.
---
...
---
> Source: [Curt-Park/my-self-hosting-services](https://github.com/Curt-Park/my-self-hosting-services) — distributed by [TomeVault](https://tomevault.io).
