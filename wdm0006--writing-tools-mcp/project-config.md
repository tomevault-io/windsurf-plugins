---
trigger: always_on
description: This file defines a FastMCP server ([server.py](mdc:server.py)) that provides various tools for text analysis. It uses libraries like `spacy`, `textstat`, `pyspellchecker`, and `markdown-it-py`.
---
...
---
> Source: [wdm0006/writing-tools-mcp](https://github.com/wdm0006/writing-tools-mcp) — distributed by [TomeVault](https://tomevault.io).
