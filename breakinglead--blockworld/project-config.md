---
trigger: always_on
description: Rust Cargo workspace (resolver = "2") with 3 crates, dependency order:
---
...
---
> Source: [BreakingLead/blockworld](https://github.com/BreakingLead/blockworld) — distributed by [TomeVault](https://tomevault.io).
