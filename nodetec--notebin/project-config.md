---
trigger: always_on
description: - **Notebin**: A decentralized code snippet sharing platform using Nostr protocol (NIP-C0 implementation)
---
...
---
> Source: [nodetec/notebin](https://github.com/nodetec/notebin) — distributed by [TomeVault](https://tomevault.io).
