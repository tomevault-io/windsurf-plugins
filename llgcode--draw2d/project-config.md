---
trigger: always_on
description: draw2d is a Go 2D vector graphics library with multiple backends:
---
...
---
> Source: [llgcode/draw2d](https://github.com/llgcode/draw2d) — distributed by [TomeVault](https://tomevault.io).
