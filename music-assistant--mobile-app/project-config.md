---
trigger: always_on
description: When generating code, finding bugs, or optimizing SwiftUI projects, follow these guidelines:
---
...
---
> Source: [music-assistant/mobile-app](https://github.com/music-assistant/mobile-app) — distributed by [TomeVault](https://tomevault.io).
