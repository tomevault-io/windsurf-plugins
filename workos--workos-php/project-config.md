...
| [workos/oagen-emitters](https://github.com/workos/oagen-emitters) | The per-language emitters, including the PHP emitter that produces this repo's code |

Regeneration runs from a checkout of `openapi-spec`, never from this repo:

```bash
npm run sdk:generate -- --lang php --output workos-php
```
...
| Generated PHP code is broken or un-idiomatic | [workos/oagen-emitters](https://github.com/workos/oagen-emitters) |
...
---
> Source: [workos/workos-php](https://github.com/workos/workos-php) — distributed by [TomeVault](https://tomevault.io).
