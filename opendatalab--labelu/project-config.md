---
trigger: always_on
description: LabelU is a multimodal data annotation platform (image/video/audio) built with FastAPI + SQLAlchemy. It provides task management, file attachment handling, sample annotation, and real-time collaboration via WebSocket.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/opendatalab)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/opendatalab)
