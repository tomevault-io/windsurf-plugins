---
trigger: always_on
description: Installs and manages Tekton components (Pipeline, Triggers, Chains, Dashboard,
---
...
---
> Source: [tektoncd/operator](https://github.com/tektoncd/operator) — distributed by [TomeVault](https://tomevault.io).
