---
trigger: always_on
description: This project provides a clean, efficient, and header-only C++ implementation of the A* (A-Star) pathfinding algorithm. It is designed for high-performance applications like video games and includes an optional fixed-size memory allocator (`fsa.h`) to minimize memory fragmentation and allocation overhead.
---
...
---
> Source: [justinhj/astar-algorithm-cpp](https://github.com/justinhj/astar-algorithm-cpp) — distributed by [TomeVault](https://tomevault.io).
