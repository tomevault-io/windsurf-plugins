---
trigger: always_on
description: This `GEMINI.md` file serves as a comprehensive guide for AI agents interacting with the CShade project. It outlines the project's purpose, how to use its components, and established development conventions.
---
...
---
> Source: [papadanku/CShade](https://github.com/papadanku/CShade) — distributed by [TomeVault](https://tomevault.io).
