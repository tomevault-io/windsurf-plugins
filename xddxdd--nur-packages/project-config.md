---
trigger: always_on
description: - **持续更新文档**：每次根据用户建议修改包后，应将可推广的经验教训更新到本文档（AGENTS.md）中
---
...
---
> Source: [xddxdd/nur-packages](https://github.com/xddxdd/nur-packages) — distributed by [TomeVault](https://tomevault.io).
