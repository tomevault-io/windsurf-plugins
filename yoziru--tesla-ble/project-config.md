---
trigger: always_on
description: cmake -B build -DCMAKE_MESSAGE_LOG_LEVEL=ERROR && cmake --build build -j 2>&1 | grep -E "error:|Error:|Built target|failed" | head -20 || true
---
...
---
> Source: [yoziru/tesla-ble](https://github.com/yoziru/tesla-ble) — distributed by [TomeVault](https://tomevault.io).
