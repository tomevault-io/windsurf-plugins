---
trigger: always_on
description: - Stack: Svelte (v5) + TypeScript + Vite. Nostr integration is via @nostr-dev-kit/ndk and @nostr-dev-kit/ndk-wallet.
---
...
---
> Source: [vivganes/kanbanstr](https://github.com/vivganes/kanbanstr) — distributed by [TomeVault](https://tomevault.io).
