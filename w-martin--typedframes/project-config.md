---
trigger: always_on
description: - `typedframes`: Python schemas, columns, frames + Rust checker (built with maturin)
---
...
---
> Source: [w-martin/typedframes](https://github.com/w-martin/typedframes) — distributed by [TomeVault](https://tomevault.io).
