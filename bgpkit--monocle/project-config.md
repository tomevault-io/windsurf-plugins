---
trigger: always_on
description: This document provides guidelines for AI coding agents working on the monocle codebase.
---
...
---
> Source: [bgpkit/monocle](https://github.com/bgpkit/monocle) — distributed by [TomeVault](https://tomevault.io).
