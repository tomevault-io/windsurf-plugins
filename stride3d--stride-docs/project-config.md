---
trigger: always_on
description: These repository instructions guide GitHub Copilot (and similar AI assistants) when updating the Stride game engine documentation.
---
...
---
> Source: [stride3d/stride-docs](https://github.com/stride3d/stride-docs) — distributed by [TomeVault](https://tomevault.io).
