---
trigger: always_on
description: The Bessemer **vertical agent-class library**: reliable, bounded-autonomy AI agents for real roles in small organizations. The third layer of the Bessemer stack — **research** (methodology) → **icm-kit** (tooling) → **agent-classes** (product).
---
...
---
> Source: [usebessemer/agent-classes](https://github.com/usebessemer/agent-classes) — distributed by [TomeVault](https://tomevault.io).
