---
trigger: always_on
description: - uv-managed; Python 3.11+. Install dev deps: `uv sync --all-extras --group linting`
---
...
---
> Source: [SoulMelody/LibreSVIP](https://github.com/SoulMelody/LibreSVIP) — distributed by [TomeVault](https://tomevault.io).
