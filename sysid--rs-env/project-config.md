---
trigger: always_on
description: Rust CLI that unifies hierarchical env-var management, file guarding (symlink-to-vault), and file swap-in/out around a per-project "vault" stored outside the repo.
---
...
---
> Source: [sysid/rs-env](https://github.com/sysid/rs-env) — distributed by [TomeVault](https://tomevault.io).
