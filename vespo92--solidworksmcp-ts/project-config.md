---
trigger: always_on
description: npm run build        # TypeScript compile (tsc)
---
...
---
> Source: [vespo92/SolidworksMCP-TS](https://github.com/vespo92/SolidworksMCP-TS) — distributed by [TomeVault](https://tomevault.io).
