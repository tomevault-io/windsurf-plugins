---
trigger: always_on
description: `geoparquet-overviews` is a proposal for the GeoParquet community. It defines one
---
...
---
> Source: [yharby/geoparquet-overviews](https://github.com/yharby/geoparquet-overviews) — distributed by [TomeVault](https://tomevault.io).
