---
trigger: always_on
description: Инструкции для Gemini при работе с TaskMate — системой управления задачами для автосалонов.
---

# GEMINI.md

Инструкции для Gemini при работе с TaskMate — системой управления задачами для автосалонов.
...
Детальные инструкции по структуре, конвенциям и запретам — в `GEMINI.md` каждого модуля:
- `TaskMateServer/GEMINI.md` — controller→service→model, eager loading, Form Requests, TimeHelper
- `TaskMateClient/GEMINI.md` — Zustand vs TanStack Query, usePermissions, API модули, dateTime
- `TaskMateTelegramBot/GEMINI.md` — async/await, FSM, RabbitMQ consumer, API communication

---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/xierongchuan)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/xierongchuan)
