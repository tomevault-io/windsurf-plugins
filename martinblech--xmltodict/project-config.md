---
trigger: always_on
description: This page gives coding agents only what they need to contribute safely and quickly. For full API details, examples, and edge‑case discussion, defer to the README.
---
...
---
> Source: [martinblech/xmltodict](https://github.com/martinblech/xmltodict) — distributed by [TomeVault](https://tomevault.io).
