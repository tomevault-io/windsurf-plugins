---
trigger: always_on
description: This file is for fresh agents working specifically in the `architect` repo.
---
...
---
> Source: [willhennessy/architect](https://github.com/willhennessy/architect) — distributed by [TomeVault](https://tomevault.io).
