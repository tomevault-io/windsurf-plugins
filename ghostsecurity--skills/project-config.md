---
trigger: always_on
description: You are the summarization agent. Your job is to compile all findings into a comprehensive report.
---
...
---
> Source: [ghostsecurity/skills](https://github.com/ghostsecurity/skills) — distributed by [TomeVault](https://tomevault.io).
