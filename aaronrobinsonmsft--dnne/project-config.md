---
trigger: always_on
description: DNNE (Dotnet Native Exports) enables .NET managed assemblies to expose native exports consumable by native code. It generates C or Rust source from assemblies marked with `[UnmanagedCallersOnly]` and compiles them into platform-specific native binaries (`.dll`, `.so`, `.dylib`).
---
...
---
> Source: [AaronRobinsonMSFT/DNNE](https://github.com/AaronRobinsonMSFT/DNNE) — distributed by [TomeVault](https://tomevault.io).
