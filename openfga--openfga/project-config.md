---
trigger: always_on
description: When reviewing changes to `Dockerfile`, check whether the `ghcr.io/grpc-ecosystem/grpc-health-probe` image reference (version tag and/or digest) was modified.
---
...
---
> Source: [openfga/openfga](https://github.com/openfga/openfga) — distributed by [TomeVault](https://tomevault.io).
