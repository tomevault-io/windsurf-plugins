...
Original source: `.cursor/rules/*.mdc` in [azutoolkit/cql](https://github.com/azutoolkit/cql).
...
From [azutoolkit/cql](https://github.com/azutoolkit/cql) — a repo with 23+ stars on GitHub.
