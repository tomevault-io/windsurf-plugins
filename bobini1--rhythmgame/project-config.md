---
trigger: always_on
description: This file applies to the entire repository. A more deeply nested `AGENTS.md` or
---
...
---
> Source: [Bobini1/RhythmGame](https://github.com/Bobini1/RhythmGame) — distributed by [TomeVault](https://tomevault.io).
