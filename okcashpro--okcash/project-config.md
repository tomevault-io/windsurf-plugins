---
trigger: always_on
description: The Agent Package (`@okai/agent`) provides the high-level orchestration layer for OKai, managing agent lifecycles, character loading, client initialization, and runtime coordination.
---
...
---
> Source: [okcashpro/okcash](https://github.com/okcashpro/okcash) — distributed by [TomeVault](https://tomevault.io).
