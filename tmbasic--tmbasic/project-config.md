---
trigger: always_on
description: Follow these steps to add a new BASIC function or subroutine called "Foo" to our standard library.
---
...
---
> Source: [tmbasic/tmbasic](https://github.com/tmbasic/tmbasic) — distributed by [TomeVault](https://tomevault.io).
