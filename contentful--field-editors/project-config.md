---
trigger: always_on
description: Agent-first routing table for `field-editors`, Contentful's monorepo of built-in entry-field editor React components (`@contentful/field-editor-*`).
---
...
---
> Source: [contentful/field-editors](https://github.com/contentful/field-editors) — distributed by [TomeVault](https://tomevault.io).
