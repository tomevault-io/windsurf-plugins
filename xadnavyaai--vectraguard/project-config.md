---
trigger: always_on
description: - Run shell commands via `vectra-guard exec -- <command>` when changes are involved.
---
...
---
> Source: [xadnavyaai/vectraguard](https://github.com/xadnavyaai/vectraguard) — distributed by [TomeVault](https://tomevault.io).
