---
trigger: always_on
description: - Prefer **immutability** and use the `final` keyword for fields, parameters, and local variables when appropriate.
---
...
---
> Source: [schemacrawler/SchemaCrawler-AI](https://github.com/schemacrawler/SchemaCrawler-AI) — distributed by [TomeVault](https://tomevault.io).
