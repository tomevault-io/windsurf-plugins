---
trigger: always_on
description: Agent framework where agents are directories compiled into deployable server artifacts.
---
...
---
> Source: [withastro/flue](https://github.com/withastro/flue) — distributed by [TomeVault](https://tomevault.io).
