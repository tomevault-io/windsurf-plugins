---
trigger: always_on
description: 本文档为 AI 编码助手（如 Cursor、Copilot、OpenCode 等）提供项目规范和开发指南。
---
...
---
> Source: [ochelp/iori-nav](https://github.com/ochelp/iori-nav) — distributed by [TomeVault](https://tomevault.io).
