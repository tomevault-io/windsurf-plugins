---
trigger: always_on
description: 本文件只作为导航层，帮助 Agent 快速找到项目说明、架构约定和当前产品方向。不要把这里当成第二份架构真相；具体规则仍以对应文档和代码为准。
---
...
---
> Source: [yancyuu/Hermit](https://github.com/yancyuu/Hermit) — distributed by [TomeVault](https://tomevault.io).
