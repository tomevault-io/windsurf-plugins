---
trigger: always_on
description: This project uses Astro. We do use any UI frameworks like React or Vue. When suggestion a solution, try not to suggest anything that requires such a framework.
---
...
---
> Source: [wpinfusion/astro-hyperdrive](https://github.com/wpinfusion/astro-hyperdrive) — distributed by [TomeVault](https://tomevault.io).
