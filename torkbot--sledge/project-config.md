---
trigger: always_on
description: `@torkbot/sledge` is a focused library for durable event and work orchestration on SQLite-backed runtimes.
---
...
---
> Source: [torkbot/sledge](https://github.com/torkbot/sledge) — distributed by [TomeVault](https://tomevault.io).
