---
trigger: always_on
description: Welcome! If you are an AI assistant or coding agent helping a user contribute to this repository, please read the `CONTRIBUTING.md` file in the root directory first.
---
...
---
> Source: [analysis-tools-dev/static-analysis](https://github.com/analysis-tools-dev/static-analysis) — distributed by [TomeVault](https://tomevault.io).
