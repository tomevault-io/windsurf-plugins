---
trigger: always_on
description: Front door for work on the rendering pipeline. Backlog lives in
---
...
---
> Source: [GMOD/jbrowse-components](https://github.com/GMOD/jbrowse-components) — distributed by [TomeVault](https://tomevault.io).
