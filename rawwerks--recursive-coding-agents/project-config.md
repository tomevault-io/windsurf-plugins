---
trigger: always_on
description: Audience: coding agents maintaining this repo.
---
...
---
> Source: [rawwerks/recursive-coding-agents](https://github.com/rawwerks/recursive-coding-agents) — distributed by [TomeVault](https://tomevault.io).
