---
trigger: always_on
description: <!-- Generated from kubebuilder template: https://github.com/kubernetes-sigs/kubebuilder/blob/v4.11.1/pkg/plugins/golang/v4/scaffolds/internal/templates/agents.go -->
---
...
---
> Source: [kubernetes-sigs/mcp-lifecycle-operator](https://github.com/kubernetes-sigs/mcp-lifecycle-operator) — distributed by [TomeVault](https://tomevault.io).
