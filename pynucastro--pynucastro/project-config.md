---
trigger: always_on
description: generates `docs/source/changelog.md` from `CHANGES.md`; these are generated
---
...
---
> Source: [pynucastro/pynucastro](https://github.com/pynucastro/pynucastro) — distributed by [TomeVault](https://tomevault.io).
