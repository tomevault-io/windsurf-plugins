---
trigger: always_on
description: VS Code extension that surfaces the Hermes AI agent as a sidebar chat panel, communicating via ACP (JSON-RPC 2.0 over stdio subprocess).
---
...
---
> Source: [joaompfp/hermes-vscode](https://github.com/joaompfp/hermes-vscode) — distributed by [TomeVault](https://tomevault.io).
