---
trigger: always_on
description: 本目录是 **meta2d.js**  monorepo 中的核心包 `@meta2d/core`（路径 `packages/core`）。meta2d.js 是一个基于 Web Canvas 的实时数据交互 2D 引擎，可用于构建 Web SCADA、物联网（IoT）、数字孪生、电力/组态图等应用。上游仓库：<https://github.com/le5le-com/meta2d.js>，License 为 MIT。
---
...
---
> Source: [le5le-com/meta2d.js](https://github.com/le5le-com/meta2d.js) — distributed by [TomeVault](https://tomevault.io).
