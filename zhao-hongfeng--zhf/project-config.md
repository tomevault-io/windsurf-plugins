---
trigger: always_on
description: 个人网址收藏网站:点击卡片在新标签页跳转,数据存 txt,无数据库、无前端构建工具。
---
...
---
> Source: [zhao-hongfeng/zhf](https://github.com/zhao-hongfeng/zhf) — distributed by [TomeVault](https://tomevault.io).
