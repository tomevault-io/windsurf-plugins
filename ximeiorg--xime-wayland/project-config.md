---
trigger: always_on
description: 一个用纯 Rust 实现一个 Linux 五笔输入法，直接对接 Wayland 和 librime，自绘 UI。
---
...
---
> Source: [ximeiorg/xime-wayland](https://github.com/ximeiorg/xime-wayland) — distributed by [TomeVault](https://tomevault.io).
