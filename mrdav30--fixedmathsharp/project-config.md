---
trigger: always_on
description: - This repository is a deterministic fixed-point math library centered on `Fixed64` (`src/FixedMathSharp/Numerics/Fixed64.cs`) with Q32.32 representation (`SHIFT_AMOUNT_I = 32` in `src/FixedMathSharp/Core/FixedMath.cs`).
---
...
---
> Source: [mrdav30/FixedMathSharp](https://github.com/mrdav30/FixedMathSharp) — distributed by [TomeVault](https://tomevault.io).
