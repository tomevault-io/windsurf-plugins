---
trigger: always_on
description: This is a VS Code extension. Read `.clinerules/general.md` for tribal knowledge and nuanced patterns.
---
...
---
> Source: [vvcode-top/vv-code](https://github.com/vvcode-top/vv-code) — distributed by [TomeVault](https://tomevault.io).
