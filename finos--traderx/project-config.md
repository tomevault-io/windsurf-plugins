---
trigger: always_on
description: This repository follows a SpecKit-first, multi-state architecture. Agents should use this file as the primary operating contract.
---
...
---
> Source: [finos/traderX](https://github.com/finos/traderX) — distributed by [TomeVault](https://tomevault.io).
