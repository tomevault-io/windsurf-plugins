---
trigger: always_on
description: * Before creating commit, always run `cargo fmt`
---
...
---
> Source: [josh-project/josh](https://github.com/josh-project/josh) — distributed by [TomeVault](https://tomevault.io).
