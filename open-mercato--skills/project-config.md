---
trigger: always_on
description: This is an isolated static UI fixture for browser-provider verification.
---
...
---
> Source: [open-mercato/skills](https://github.com/open-mercato/skills) — distributed by [TomeVault](https://tomevault.io).
