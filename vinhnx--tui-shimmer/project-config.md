---
trigger: always_on
description: Guidance for AI agents working on or integrating `tui-shimmer`.
---
...
---
> Source: [vinhnx/tui-shimmer](https://github.com/vinhnx/tui-shimmer) — distributed by [TomeVault](https://tomevault.io).
