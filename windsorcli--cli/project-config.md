---
trigger: always_on
description: Skills are defined in `.agent/skills/` and are discovered automatically by Claude Code, Cursor, and other adopting tools.
---
...
---
> Source: [windsorcli/cli](https://github.com/windsorcli/cli) — distributed by [TomeVault](https://tomevault.io).
