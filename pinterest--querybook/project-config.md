---
trigger: always_on
description: Querybook is Pinterest's open-source Big Data IDE for discovering, creating, and sharing data analyses. It combines a rich-text editor, SQL query engine, charting, scheduling, and table documentation in a single web app.
---
...
---
> Source: [pinterest/querybook](https://github.com/pinterest/querybook) — distributed by [TomeVault](https://tomevault.io).
