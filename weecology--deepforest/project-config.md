---
trigger: always_on
description: - When proposing code changes that require new tests:
---
...
---
> Source: [weecology/DeepForest](https://github.com/weecology/DeepForest) — distributed by [TomeVault](https://tomevault.io).
