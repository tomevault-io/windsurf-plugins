---
trigger: always_on
description: - nixai is a modular, console-based Linux application for solving NixOS configuration problems and assisting with NixOS setup and troubleshooting from the command line.
---
...
---
> Source: [olafkfreund/nix-ai-help](https://github.com/olafkfreund/nix-ai-help) — distributed by [TomeVault](https://tomevault.io).
