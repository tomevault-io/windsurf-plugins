---
trigger: always_on
description: **Go from the most general to the most specific, and write down every step.**
---
...
---
> Source: [ugarchance/codex-plus-plus](https://github.com/ugarchance/codex-plus-plus) — distributed by [TomeVault](https://tomevault.io).
