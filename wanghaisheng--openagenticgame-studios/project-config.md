---
trigger: always_on
description: This repository is Codex-native. Use this file as the primary project instruction source and use `.codex/` as the active execution layer.
---
...
---
> Source: [wanghaisheng/OpenAgenticGame-Studios](https://github.com/wanghaisheng/OpenAgenticGame-Studios) — distributed by [TomeVault](https://tomevault.io).
