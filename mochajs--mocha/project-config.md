---
trigger: always_on
description: For this repository, follow `AGENTS.md` in the repo root as the primary onboarding source.
---
...
---
> Source: [mochajs/mocha](https://github.com/mochajs/mocha) — distributed by [TomeVault](https://tomevault.io).
