---
trigger: always_on
description: This file provides guidance for AI coding assistants working with the Craft codebase.
---
...
---
> Source: [getsentry/craft](https://github.com/getsentry/craft) — distributed by [TomeVault](https://tomevault.io).
