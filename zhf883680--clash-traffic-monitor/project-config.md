---
trigger: always_on
description: These instructions apply to the entire repository. If a deeper directory later gets its own `AGENTS.md` or `AGENTS.override.md`, that file should narrow or override these rules for work in that subtree.
---
...
---
> Source: [zhf883680/clash-traffic-monitor](https://github.com/zhf883680/clash-traffic-monitor) — distributed by [TomeVault](https://tomevault.io).
