---
trigger: always_on
description: * **Always** use `null|` in favor of `?` for nullable types (e.g. `?string` instead of `string|null`).
---
...
---
> Source: [dcarbone/php-consul-api](https://github.com/dcarbone/php-consul-api) — distributed by [TomeVault](https://tomevault.io).
