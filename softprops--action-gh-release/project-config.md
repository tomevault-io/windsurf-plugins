---
trigger: always_on
description: This repository is maintained as a small, user-facing GitHub Action with a relatively wide compatibility surface.
---
...
---
> Source: [softprops/action-gh-release](https://github.com/softprops/action-gh-release) — distributed by [TomeVault](https://tomevault.io).
