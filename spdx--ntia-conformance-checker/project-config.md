---
trigger: always_on
description: - Follow existing code style and repository conventions.
---
...
---
> Source: [spdx/ntia-conformance-checker](https://github.com/spdx/ntia-conformance-checker) — distributed by [TomeVault](https://tomevault.io).
