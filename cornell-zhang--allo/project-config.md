---
trigger: always_on
description: - Always run `conda activate allo` before building or running tests
---
...
---
> Source: [cornell-zhang/allo](https://github.com/cornell-zhang/allo) — distributed by [TomeVault](https://tomevault.io).
