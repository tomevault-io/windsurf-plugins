---
trigger: always_on
description: To compile this project, please use the provided `build.sh` script in the root directory.
---
...
---
> Source: [alibaba/MNN](https://github.com/alibaba/MNN) — distributed by [TomeVault](https://tomevault.io).
