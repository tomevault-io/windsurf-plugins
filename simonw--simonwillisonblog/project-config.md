---
trigger: always_on
description: Django 6.0 web application for https://simonwillison.net/
---
...
---
> Source: [simonw/simonwillisonblog](https://github.com/simonw/simonwillisonblog) — distributed by [TomeVault](https://tomevault.io).
