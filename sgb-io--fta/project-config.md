---
trigger: always_on
description: This document provides guidelines for AI agents (like GitHub Copilot) working on the FTA (Fast TypeScript Analyzer) codebase.
---
...
---
> Source: [sgb-io/fta](https://github.com/sgb-io/fta) — distributed by [TomeVault](https://tomevault.io).
