---
trigger: always_on
description: - `anti_slop/` is the canonical implementation; `tests/` mirrors it one test file per rule.
---
...
---
> Source: [zaterka/anti-slop-python](https://github.com/zaterka/anti-slop-python) — distributed by [TomeVault](https://tomevault.io).
