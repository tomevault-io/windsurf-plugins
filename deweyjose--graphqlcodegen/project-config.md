---
trigger: always_on
description: Guidance for AI agents editing the example harness. Read the repo-root `AGENTS.md` first for
---
...
---
> Source: [deweyjose/graphqlcodegen](https://github.com/deweyjose/graphqlcodegen) — distributed by [TomeVault](https://tomevault.io).
