---
trigger: always_on
description: This package provides encryption middleware for the Inngest Python SDK. It enables automatic encryption and decryption of sensitive data in Inngest functions and events.
---
...
---
> Source: [inngest/inngest-py](https://github.com/inngest/inngest-py) — distributed by [TomeVault](https://tomevault.io).
