---
trigger: always_on
description: - Use British English spelling and grammar (e.g., "behaviour", "colour", "organise", "analyse", "favour", "innitialise", etc.)
---
...
---
> Source: [xpack/doxygen2docusaurus-cli-ts](https://github.com/xpack/doxygen2docusaurus-cli-ts) — distributed by [TomeVault](https://tomevault.io).
