---
trigger: always_on
description: See [AGENTS.md](./AGENTS.md) for the repository instructions. They apply in full to Claude Code.
---

# CLAUDE.md

See [AGENTS.md](./AGENTS.md) for the repository instructions. They apply in full to Claude Code.
