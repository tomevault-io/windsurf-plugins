---
trigger: always_on
description: This project is a SAM application with a CDK-defined CI/CD pipeline. Keep changes scoped to the package or stack being modified.
---
...
---
> Source: [aws-samples/aws-serverless-books-api-sample](https://github.com/aws-samples/aws-serverless-books-api-sample) — distributed by [TomeVault](https://tomevault.io).
