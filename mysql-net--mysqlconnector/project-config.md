---
trigger: always_on
description: MySqlConnector is a high-performance ADO.NET Data Provider for MySQL.
---
...
---
> Source: [mysql-net/MySqlConnector](https://github.com/mysql-net/MySqlConnector) — distributed by [TomeVault](https://tomevault.io).
