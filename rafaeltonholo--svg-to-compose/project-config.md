---
trigger: always_on
description: CRITICAL: MUST read and follow `.ai/guidelines.md` at all times. It contains
---
...
---
> Source: [rafaeltonholo/svg-to-compose](https://github.com/rafaeltonholo/svg-to-compose) — distributed by [TomeVault](https://tomevault.io).
