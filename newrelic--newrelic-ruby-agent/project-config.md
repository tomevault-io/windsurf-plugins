---
trigger: always_on
description: The `newrelic_rpm` gem: instruments customer Ruby apps and reports performance data to New Relic.
---
...
---
> Source: [newrelic/newrelic-ruby-agent](https://github.com/newrelic/newrelic-ruby-agent) — distributed by [TomeVault](https://tomevault.io).
