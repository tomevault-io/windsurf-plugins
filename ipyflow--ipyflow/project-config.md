---
trigger: always_on
description: Use `./scripts/runtests.sh` which sets up the proper environment (initializes `IPyflowInteractiveShell` before pytest).
---
...
---
> Source: [ipyflow/ipyflow](https://github.com/ipyflow/ipyflow) — distributed by [TomeVault](https://tomevault.io).
