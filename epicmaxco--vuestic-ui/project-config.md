---
trigger: always_on
description: * `color` prop should be used for `background-color`
---
...
---
> Source: [epicmaxco/vuestic-ui](https://github.com/epicmaxco/vuestic-ui) — distributed by [TomeVault](https://tomevault.io).
