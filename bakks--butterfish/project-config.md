---
trigger: always_on
description: - Butterfish shell performance is sensitive to terminal I/O behavior.
---
...
---
> Source: [bakks/butterfish](https://github.com/bakks/butterfish) — distributed by [TomeVault](https://tomevault.io).
