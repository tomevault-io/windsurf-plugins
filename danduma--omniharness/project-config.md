---
trigger: always_on
description: - NEVER EVER EVER create a branch!!! branches are FORBIDDEN!!!
---
...
---
> Source: [danduma/omniharness](https://github.com/danduma/omniharness) — distributed by [TomeVault](https://tomevault.io).
