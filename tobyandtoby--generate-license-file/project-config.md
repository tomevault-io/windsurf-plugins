---
trigger: always_on
description: CLI and library tool that aggregates third-party production dependency licenses into a single output file. Supports npm and pnpm workspaces, a webpack plugin, and a programmatic API.
---
...
---
> Source: [TobyAndToby/generate-license-file](https://github.com/TobyAndToby/generate-license-file) — distributed by [TomeVault](https://tomevault.io).
