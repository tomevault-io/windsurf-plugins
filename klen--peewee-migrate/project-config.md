---
trigger: always_on
description: Repository guidance for coding agents working in `peewee-migrate`.
---
...
---
> Source: [klen/peewee_migrate](https://github.com/klen/peewee_migrate) — distributed by [TomeVault](https://tomevault.io).
