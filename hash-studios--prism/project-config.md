---
trigger: always_on
description: Prism is a Flutter mobile wallpaper app (Android/iOS). The main development loop uses FVM + Makefile targets. See `README.md` for full docs.
---
...
---
> Source: [Hash-Studios/Prism](https://github.com/Hash-Studios/Prism) — distributed by [TomeVault](https://tomevault.io).
