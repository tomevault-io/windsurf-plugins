---
trigger: always_on
description: - `cmd/`: Cobra CLI entry (`root.go`), flag parsing and command execution.
---
...
---
> Source: [uzumaki-inc/stay_or_go](https://github.com/uzumaki-inc/stay_or_go) — distributed by [TomeVault](https://tomevault.io).
