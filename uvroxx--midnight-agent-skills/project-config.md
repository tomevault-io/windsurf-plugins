---
trigger: always_on
description: This file provides guidance to Claude and other AI coding agents when working with code in this repository.
---
...
---
> Source: [UvRoxx/midnight-agent-skills](https://github.com/UvRoxx/midnight-agent-skills) — distributed by [TomeVault](https://tomevault.io).
