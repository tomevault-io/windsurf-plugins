---
trigger: always_on
description: **Mark** is a CLI tool that processes markdown files, extracts images and links, sends them to LLMs, and appends responses back to the markdown file.
---
...
---
> Source: [relston/mark](https://github.com/relston/mark) — distributed by [TomeVault](https://tomevault.io).
