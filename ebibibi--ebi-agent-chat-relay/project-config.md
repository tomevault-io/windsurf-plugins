---
trigger: always_on
description: Discord frontend for Claude Code CLI. Python 3.12+ with discord.py v2.
---
...
---
> Source: [ebibibi/ebi-agent-chat-relay](https://github.com/ebibibi/ebi-agent-chat-relay) — distributed by [TomeVault](https://tomevault.io).
