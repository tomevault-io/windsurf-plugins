---
trigger: always_on
description: 本指南帮助贡献者与自动化代理在 GameGrid（Next.js）项目中保持一致协作。
---
...
---
> Source: [SomiaWhiteRing/game-grid](https://github.com/SomiaWhiteRing/game-grid) — distributed by [TomeVault](https://tomevault.io).
