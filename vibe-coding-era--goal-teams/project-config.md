---
trigger: always_on
description: 本仓库是 Codex Skill 包，不是业务应用。修改时优先保持规则一致、安装可用、示例可复盘。
---
...
---
> Source: [vibe-coding-era/goal-teams](https://github.com/vibe-coding-era/goal-teams) — distributed by [TomeVault](https://tomevault.io).
