---
trigger: always_on
description: - This repository is now a Python-only package. Do not reintroduce TypeScript, Node.js runtime code, npm metadata, or shell-outs to FontTools CLIs.
---
...
---
> Source: [VdustR/font-splitter](https://github.com/VdustR/font-splitter) — distributed by [TomeVault](https://tomevault.io).
