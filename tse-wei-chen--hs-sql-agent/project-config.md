---
trigger: always_on
description: - **Backend**: ASP.NET Core (net10.0) in `backend/src/`. Main entrypoint: `ToolBox/ToolBox.csproj`.
---
...
---
> Source: [tse-wei-chen/hs-sql-agent](https://github.com/tse-wei-chen/hs-sql-agent) — distributed by [TomeVault](https://tomevault.io).
