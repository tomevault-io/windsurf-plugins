...
Original source: `CLAUDE.md` in [LianjiaTech/bella-openapi](https://github.com/LianjiaTech/bella-openapi).
...
```
npx tomevault install LianjiaTech/bella-openapi
```
Source: [github.com/LianjiaTech/bella-openapi](https://github.com/LianjiaTech/bella-openapi).
