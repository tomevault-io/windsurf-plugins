---
trigger: always_on
description: - Core library lives in `ITMO_FS/` with subpackages for `filters`, `wrappers`, `embedded`, `ensembles`, `hybrid`, shared `base`, and `utils`.
---
...
---
> Source: [ctlab/ITMO_FS](https://github.com/ctlab/ITMO_FS) — distributed by [TomeVault](https://tomevault.io).
