---
trigger: always_on
description: CLI, MCP server, and API-compatible interface for Perplexity AI's web interface.
---
...
---
> Source: [devdotbo/perplexity-web-mcp](https://github.com/devdotbo/perplexity-web-mcp) — distributed by [TomeVault](https://tomevault.io).
