---
trigger: always_on
description: - Preserve the credential boundary: never read Codex auth files or add direct OAuth fallback.
---
...
---
> Source: [valentine-89/codex-quota-guard-mcp](https://github.com/valentine-89/codex-quota-guard-mcp) — distributed by [TomeVault](https://tomevault.io).
