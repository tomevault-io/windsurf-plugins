---
trigger: always_on
description: Colin (**Co**ntext **Lin**eage) is a context engine for the AI era. It takes interconnected source documents, resolves dependencies, applies transformations (including LLM calls), and produces outputs your agents can use.
---
...
---
> Source: [PrefectHQ/colin](https://github.com/PrefectHQ/colin) — distributed by [TomeVault](https://tomevault.io).
