---
trigger: always_on
description: The `tools/` directory holds the CLI tools that drive Nevermore's development workflow. Everything here is TypeScript (ESM, Node 18+) built with pnpm workspaces.
---
...
---
> Source: [Quenty/NevermoreEngine](https://github.com/Quenty/NevermoreEngine) — distributed by [TomeVault](https://tomevault.io).
