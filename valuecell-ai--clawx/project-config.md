---
trigger: always_on
description: ClawX is a cross-platform **Electron desktop app** (React 19 + Vite + TypeScript) providing a GUI for the OpenClaw AI agent runtime. It uses pnpm as its package manager (pinned version in `package.json`'s `packageManager` field).
---
...
---
> Source: [ValueCell-ai/ClawX](https://github.com/ValueCell-ai/ClawX) — distributed by [TomeVault](https://tomevault.io).
