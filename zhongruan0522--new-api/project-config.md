---
trigger: always_on
description: 本文件是仓库级统一入口。按 https://agents.md/ 的约定，子目录中更近的
---
...
---
> Source: [zhongruan0522/new-api](https://github.com/zhongruan0522/new-api) — distributed by [TomeVault](https://tomevault.io).
