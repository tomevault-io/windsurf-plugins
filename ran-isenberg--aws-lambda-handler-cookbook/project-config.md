---
trigger: always_on
description: Guidance for Claude Code in this repository. Topic rules live in [.claude/rules/](.claude/rules/)
---
...
---
> Source: [ran-isenberg/aws-lambda-handler-cookbook](https://github.com/ran-isenberg/aws-lambda-handler-cookbook) — distributed by [TomeVault](https://tomevault.io).
