---
trigger: always_on
description: - Nkululeko runs ML experiments end-to-end from INI configs: dataset loading → feature extraction → model training → reporting. Orchestration is centered in nkululeko/experiment.py and invoked by CLI modules in nkululeko/*.py.
---
...
---
> Source: [felixbur/nkululeko](https://github.com/felixbur/nkululeko) — distributed by [TomeVault](https://tomevault.io).
