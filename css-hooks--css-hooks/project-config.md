---
trigger: always_on
description: generates a static stylesheet once, then uses CSS variable toggling to apply
---
...
---
> Source: [css-hooks/css-hooks](https://github.com/css-hooks/css-hooks) — distributed by [TomeVault](https://tomevault.io).
