---
trigger: always_on
description: **LƯU Ý QUAN TRỌNG:** Đọc file [TestDevKitTs/AIContext.md](../TestDevKitTs/AIContext.md) để hiểu đầy đủ context của dự án này.
---
...
---
> Source: [phuocle/Dynamics-Crm-DevKit](https://github.com/phuocle/Dynamics-Crm-DevKit) — distributed by [TomeVault](https://tomevault.io).
