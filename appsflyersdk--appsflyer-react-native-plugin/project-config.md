---
trigger: always_on
description: React Native bridge plugin wrapping the AppsFlyer iOS and Android native SDKs via `NativeModules`.
---
...
---
> Source: [AppsFlyerSDK/appsflyer-react-native-plugin](https://github.com/AppsFlyerSDK/appsflyer-react-native-plugin) — distributed by [TomeVault](https://tomevault.io).
