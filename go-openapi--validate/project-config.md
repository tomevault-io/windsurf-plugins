---
trigger: always_on
description: Go library for validating OpenAPI v2 (Swagger) specifications and JSON Schema draft 4 data.
---
...
---
> Source: [go-openapi/validate](https://github.com/go-openapi/validate) — distributed by [TomeVault](https://tomevault.io).
