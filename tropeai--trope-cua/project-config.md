---
trigger: always_on
description: This repo is Trope CUA: native MCP/server drivers for background-safe UI automation, target-window capture, and the visual agent cursor overlay on Windows and macOS.
---
...
---
> Source: [tropeai/trope-cua](https://github.com/tropeai/trope-cua) — distributed by [TomeVault](https://tomevault.io).
