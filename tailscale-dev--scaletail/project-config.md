---
trigger: always_on
description: Follow [CONTRIBUTING.md](CONTRIBUTING.md) and the current service template.
---
...
---
> Source: [tailscale-dev/ScaleTail](https://github.com/tailscale-dev/ScaleTail) — distributed by [TomeVault](https://tomevault.io).
