---
trigger: always_on
description: **pymtml** is Python bindings for the Moore Threads Management Library (MTML) - a C-based API for monitoring and managing Moore Threads GPU devices. It provides:
---
...
---
> Source: [MooreThreads/mthreads-ml-py](https://github.com/MooreThreads/mthreads-ml-py) — distributed by [TomeVault](https://tomevault.io).
