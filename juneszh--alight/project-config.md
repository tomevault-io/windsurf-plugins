---
trigger: always_on
description: This repository contains the Alight framework. Changes here affect every
---
...
---
> Source: [juneszh/alight](https://github.com/juneszh/alight) — distributed by [TomeVault](https://tomevault.io).
