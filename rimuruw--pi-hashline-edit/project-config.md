---
trigger: always_on
description: - `index.ts` is the extension entrypoint; it registers the custom `read`/`edit` tools and optional compatibility notifications.
---
...
---
> Source: [RimuruW/pi-hashline-edit](https://github.com/RimuruW/pi-hashline-edit) — distributed by [TomeVault](https://tomevault.io).
