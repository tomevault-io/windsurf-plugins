---
trigger: always_on
description: - `src/` holds all TypeScript sources; UI lives in `src/components/`, domain logic in `src/services/`, shared hooks in `src/hooks/`, and utilities/constants in their respective folders.
---
...
---
> Source: [wsw669/cclens](https://github.com/wsw669/cclens) — distributed by [TomeVault](https://tomevault.io).
