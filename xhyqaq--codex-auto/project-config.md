---
trigger: always_on
description: - 任何会影响交互式终端行为的改动，在宣称完成前都必须同时通过自动化测试和真实终端回归。
---
...
---
> Source: [xhyqaq/codex-auto](https://github.com/xhyqaq/codex-auto) — distributed by [TomeVault](https://tomevault.io).
