---
trigger: always_on
description: sp.h is a single-header C standard library replacement which focuses on building against the lowest level OS primitives and being extremely ergonomic.
---
...
---
> Source: [tspader/sp](https://github.com/tspader/sp) — distributed by [TomeVault](https://tomevault.io).
