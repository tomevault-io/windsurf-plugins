---
trigger: always_on
description: ModelCraft is a local-first SwiftUI personal AI assistant for macOS with multimodal chat, local inference, projects and retrieval, media generation, and agent tools.
---
...
---
> Source: [zhang-hongshen/ModelCraft](https://github.com/zhang-hongshen/ModelCraft) — distributed by [TomeVault](https://tomevault.io).
