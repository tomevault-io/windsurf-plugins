---
trigger: always_on
description: This document provides context and guidance for AI assistants (like Claude) working on the Sveltepress codebase.
---
...
---
> Source: [SveltePress/sveltepress](https://github.com/SveltePress/sveltepress) — distributed by [TomeVault](https://tomevault.io).
