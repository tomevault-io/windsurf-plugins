---
trigger: always_on
description: 1. **Never alter unrelated code** - Touch only code directly related to the requested change
---
...
---
> Source: [yafitzdev/fitz-sage](https://github.com/yafitzdev/fitz-sage) — distributed by [TomeVault](https://tomevault.io).
