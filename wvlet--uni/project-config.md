---
trigger: always_on
description: **Uni** is an essential Scala utilities, refined for Scala 3 with minimal dependencies.
---
...
---
> Source: [wvlet/uni](https://github.com/wvlet/uni) — distributed by [TomeVault](https://tomevault.io).
