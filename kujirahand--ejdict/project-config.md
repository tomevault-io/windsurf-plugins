---
trigger: always_on
description: このドキュメントは、英和辞書データ『ejdict-hand』プロジェクトのフォルダ構造、データ形式、および `tools/` ディレクトリに配置されている各種開発ツールについて解説します。
---
...
---
> Source: [kujirahand/EJDict](https://github.com/kujirahand/EJDict) — distributed by [TomeVault](https://tomevault.io).
