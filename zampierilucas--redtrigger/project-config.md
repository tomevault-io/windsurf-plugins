---
trigger: always_on
description: Android app for Nubia Red Magic phones that enables shoulder triggers (SAR capacitive sensors) system-wide without activating full Game Space. The Nubia game framework resets trigger settings on every activity change; RedTrigger watches for those resets and re-applies them instantly via a foreground service.
---
...
---
> Source: [zampierilucas/RedTrigger](https://github.com/zampierilucas/RedTrigger) — distributed by [TomeVault](https://tomevault.io).
