---
trigger: always_on
description: nvm use                        # Use correct Node version (see .nvmrc)
---
...
---
> Source: [foundry-rs/foundry-toolchain](https://github.com/foundry-rs/foundry-toolchain) — distributed by [TomeVault](https://tomevault.io).
