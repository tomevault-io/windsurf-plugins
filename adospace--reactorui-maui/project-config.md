---
trigger: always_on
description: MauiReactor is a library built on top of .NET MAUI. MauiReactor applications are .NET MAUI written in C# using a custom version of the MVU (Model View Update) approach.
---
...
---
> Source: [adospace/reactorui-maui](https://github.com/adospace/reactorui-maui) — distributed by [TomeVault](https://tomevault.io).
