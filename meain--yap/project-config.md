---
trigger: always_on
description: `yap` is an Emacs package for interacting with LLMs via predefined templates. It supports OpenAI, Anthropic, Ollama, Groq, OpenRouter, and GitHub Models. Uses the `ahyatt/llm` library for provider abstraction and `plz` for HTTP requests.
---
...
---
> Source: [meain/yap](https://github.com/meain/yap) — distributed by [TomeVault](https://tomevault.io).
