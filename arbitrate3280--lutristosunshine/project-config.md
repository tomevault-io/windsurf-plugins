---
trigger: always_on
description: - `lutristosunshine.py`: CLI entrypoint that orchestrates launcher discovery, Sunshine checks, user prompts, and game import.
---
...
---
> Source: [Arbitrate3280/LutrisToSunshine](https://github.com/Arbitrate3280/LutrisToSunshine) — distributed by [TomeVault](https://tomevault.io).
