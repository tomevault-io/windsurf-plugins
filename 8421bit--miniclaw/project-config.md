---
trigger: always_on
description: MiniClaw is a minimalist, open-source "micro-kernel agent" designed as a Model Context Protocol (MCP) server for clients like Claude CoWork, Qoderwork, and WorkBuddy. It acts as a "Digital Life Embryo" or an AI Copilot for IDEs, providing advanced features such as:
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/8421bit)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/8421bit)
