---
trigger: always_on
description: Each channel in `scripts/configure.js` maps `CHANNEL_*` env vars → `channels.<name>.*` in `openclaw.json`.
---
...
---
> Source: [coollabsio/openclaw](https://github.com/coollabsio/openclaw) — distributed by [TomeVault](https://tomevault.io).
