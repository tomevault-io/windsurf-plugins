---
trigger: always_on
description: - `src/worker/` contains the Mega downloader worker code.
---
...
---
> Source: [chanderlud/giga-grabber](https://github.com/chanderlud/giga-grabber) — distributed by [TomeVault](https://tomevault.io).
