---
trigger: always_on
description: WikiRace is a desktop Wikipedia navigation game built with PyQt6 and Python 3.13. Features both solo and real-time multiplayer functionality using a FastAPI + Socket.IO server architecture.
---
...
- ✅ Solo gameplay fully functional and polished
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/ianwagers)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/ianwagers)
