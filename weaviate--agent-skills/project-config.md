---
trigger: always_on
description: This document provides setup instructions for AI agents using the Weaviate skill and plugin.
---
...
---
> Source: [weaviate/agent-skills](https://github.com/weaviate/agent-skills) — distributed by [TomeVault](https://tomevault.io).
