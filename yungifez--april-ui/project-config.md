---
trigger: always_on
description: - Use the default `{{$slot}}` when the content is the main part of a component and the component accepts one item. For example, a button's label belongs in `<april:button>Inside</april:button>`.
---
...
---
> Source: [yungifez/april-ui](https://github.com/yungifez/april-ui) — distributed by [TomeVault](https://tomevault.io).
