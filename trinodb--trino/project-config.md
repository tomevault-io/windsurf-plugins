---
trigger: always_on
description: **Before writing Java code, you must first read [`.github/DEVELOPMENT.md`](.github/DEVELOPMENT.md)
---
...
---
> Source: [trinodb/trino](https://github.com/trinodb/trino) — distributed by [TomeVault](https://tomevault.io).
