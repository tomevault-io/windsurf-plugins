---
trigger: always_on
description: **DANGER**: You must follow the rules in `Style and Prose`, and `Format and Output` when doing the following:
---
...
- Utilize the the full capabilities of Github Flavor markdown. Examples of capabilities you should use:
  ...
  - Collapsed details block (`<details>`) are perfect for long lists. Example: `<details><summary>Click to expand</summary></details>`
...
Adhering to these standards and guidelines (`Style and Prose`, and `Format and Output`) will ensure the best experience for readers and the user.
