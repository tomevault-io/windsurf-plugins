---
trigger: always_on
description: Always use conventional commits format when creating commits. Follow this structure:
---
...
---
> Source: [microsoft/OpenAPI.NET](https://github.com/microsoft/OpenAPI.NET) — distributed by [TomeVault](https://tomevault.io).
