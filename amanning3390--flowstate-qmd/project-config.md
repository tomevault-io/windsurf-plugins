---
trigger: always_on
description: Use Bun instead of Node.js (`bun` not `node`, `bun install` not `npm install`).
---
...
---
> Source: [amanning3390/flowstate-qmd](https://github.com/amanning3390/flowstate-qmd) — distributed by [TomeVault](https://tomevault.io).
