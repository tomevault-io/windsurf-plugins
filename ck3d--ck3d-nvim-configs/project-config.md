---
trigger: always_on
description: This directory contains a Neovim configuration managed by Nix and the `nix2nvimrc` flake. It provides a modular and reproducible way to set up the editor with different sets of plugins and language support.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/ck3d)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/ck3d)
