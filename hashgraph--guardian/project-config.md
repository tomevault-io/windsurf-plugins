---
trigger: always_on
description: FastAPI service providing unified carbon credit registry data (Verra VCS + Gold Standard). Async throughout — asyncpg for PostgreSQL, SQLModel/SQLAlchemy ORM. The API serves the Market Explorer frontend at `/market`.
---
...
---
> Source: [hashgraph/guardian](https://github.com/hashgraph/guardian) — distributed by [TomeVault](https://tomevault.io).
