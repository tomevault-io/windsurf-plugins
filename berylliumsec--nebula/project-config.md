---
trigger: always_on
description: For every operator-visible interface, mobile, LAN, chat/session lifecycle,
---
...
---
> Source: [berylliumsec/nebula](https://github.com/berylliumsec/nebula) — distributed by [TomeVault](https://tomevault.io).
