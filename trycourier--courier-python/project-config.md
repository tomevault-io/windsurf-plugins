---
trigger: always_on
description: Courier is a notifications API for sending messages across email, SMS, push, in-app inbox, Slack, and WhatsApp from a single API call.
---
...
---
> Source: [trycourier/courier-python](https://github.com/trycourier/courier-python) — distributed by [TomeVault](https://tomevault.io).
