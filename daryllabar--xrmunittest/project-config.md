---
trigger: always_on
description: Unit testing framework for Microsoft Dynamics CRM/XRM and Dataverse with in-memory fake CRM server. ~324 MB, ~3,262 C# files, 14 projects. Multi-targeting: .NET Framework 4.6.2/4.7.2/4.8, .NET 6.0/8.0. Uses MSTest, dotnet CLI, AppVeyor CI.
---
...
---
> Source: [daryllabar/XrmUnitTest](https://github.com/daryllabar/XrmUnitTest) — distributed by [TomeVault](https://tomevault.io).
