---
trigger: always_on
description: `clickhouse-java` is a multi-module Maven repository for ClickHouse Java clients and drivers.
---
...
---
> Source: [ClickHouse/clickhouse-java](https://github.com/ClickHouse/clickhouse-java) — distributed by [TomeVault](https://tomevault.io).
