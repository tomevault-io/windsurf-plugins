---
trigger: always_on
description: `bun run build` (uses tsup)
---
...
---
> Source: [imbuxiangnan-cyber/copilot-api-plus](https://github.com/imbuxiangnan-cyber/copilot-api-plus) — distributed by [TomeVault](https://tomevault.io).
