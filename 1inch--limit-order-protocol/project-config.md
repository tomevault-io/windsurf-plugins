---
trigger: always_on
description: This repo is the **1inch Limit Order Protocol** — EVM Solidity smart contracts built with
---
...
---
> Source: [1inch/limit-order-protocol](https://github.com/1inch/limit-order-protocol) — distributed by [TomeVault](https://tomevault.io).
