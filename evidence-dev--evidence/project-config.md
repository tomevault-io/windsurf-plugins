---
trigger: always_on
description: Evidence is an agent-ready tool for creating reports from your data — markdown with inline SQL, rendered as interactive reports.
---
...
---
> Source: [evidence-dev/evidence](https://github.com/evidence-dev/evidence) — distributed by [TomeVault](https://tomevault.io).
