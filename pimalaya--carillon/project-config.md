...
For how this crate is built, where changes belong, and the Pimalaya standards it follows, read `CONTRIBUTING.md` and the `src/main.rs` header (the crate's architecture document).

---
> Source: [pimalaya/carillon](https://github.com/pimalaya/carillon) — distributed by [TomeVault](https://tomevault.io).
