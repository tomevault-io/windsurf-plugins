---
trigger: always_on
description: BAML (Basically, A Made-Up Language) is a domain-specific language for building LLM prompts as functions.
---
...
---
> Source: [beam-cloud/lovable-clone](https://github.com/beam-cloud/lovable-clone) — distributed by [TomeVault](https://tomevault.io).
