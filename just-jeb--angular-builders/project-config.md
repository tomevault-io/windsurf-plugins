---
trigger: always_on
description: > GitHub Actions workflows and PR/issue templates for the angular-builders monorepo.
---
...
---
> Source: [just-jeb/angular-builders](https://github.com/just-jeb/angular-builders) — distributed by [TomeVault](https://tomevault.io).
