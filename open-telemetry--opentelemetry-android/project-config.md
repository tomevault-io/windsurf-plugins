---
trigger: always_on
description: This repository provides OpenTelemetry instrumentation for Android applications (the Android RUM SDK).
---
...
---
> Source: [open-telemetry/opentelemetry-android](https://github.com/open-telemetry/opentelemetry-android) — distributed by [TomeVault](https://tomevault.io).
