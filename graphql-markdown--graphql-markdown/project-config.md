---
trigger: always_on
description: GraphQL-Markdown is a flexible tool for generating Markdown documentation from GraphQL schemas, designed for static site generators like Docusaurus.
---
...
---
> Source: [graphql-markdown/graphql-markdown](https://github.com/graphql-markdown/graphql-markdown) — distributed by [TomeVault](https://tomevault.io).
