---
trigger: always_on
description: This repository is intentionally easy for coding agents to extend.
---
...
---
> Source: [virpo/pegboard](https://github.com/virpo/pegboard) — distributed by [TomeVault](https://tomevault.io).
