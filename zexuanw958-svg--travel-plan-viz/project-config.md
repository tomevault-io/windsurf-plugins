---
trigger: always_on
description: 给在本仓库**开发/维护这个 skill** 的 AI。终端用户怎么用 skill 见 `README.md`，skill 运行逻辑见 `travel-plan-viz/SKILL.md`。
---
...
> **命名分层（别去"统一"）**：README 门面品牌名是 **Migo · 旅行领航**（Migo = 候鸟领航员吉祥物），但技术 id、SKILL.md `name`、触发词、GitHub 仓库名一律保持 `travel-plan-viz` 不变——这是有意为之（保留搜索/SEO 与安装路径稳定）。看到 README 与 SKILL.md 名称"不一致"是正常的，不要改触发词或仓库名去对齐。
...
---
> Source: [zexuanw958-svg/travel-plan-viz](https://github.com/zexuanw958-svg/travel-plan-viz) — distributed by [TomeVault](https://tomevault.io).
