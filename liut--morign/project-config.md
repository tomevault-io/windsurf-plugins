---
trigger: always_on
description: Morign 是一个 AI 聊天后端，集知识库问答、MCP 工具与 OAuth 认证于一体。
---
...
---
> Source: [liut/morign](https://github.com/liut/morign) — distributed by [TomeVault](https://tomevault.io).
