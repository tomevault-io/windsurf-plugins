---
trigger: always_on
description: VLBI and radio astronomy has many non-standard conventions when coming from physics. Additionally, these conventions change from telescope to telescope, often making it difficult
---
...
---
> Source: [ptiede/Comrade.jl](https://github.com/ptiede/Comrade.jl) — distributed by [TomeVault](https://tomevault.io).
