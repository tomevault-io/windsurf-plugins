---
trigger: always_on
description: 本文件面向在此仓库内工作的 AI 编程助手，说明项目结构、运行方式与开发约束，帮助你快速上手并正确修改代码。
---
...
---
> Source: [tycoding/grok-ball](https://github.com/tycoding/grok-ball) — distributed by [TomeVault](https://tomevault.io).
