---
trigger: always_on
description: PypeIt is a pure Python package for processing raw spectroscopic data from
---
...
---
> Source: [pypeit/PypeIt](https://github.com/pypeit/PypeIt) — distributed by [TomeVault](https://tomevault.io).
