---
trigger: always_on
description: Claude Code Schedule is a Rust CLI tool created by Ian Macalinao that runs Claude Code at a specific scheduled time. The tool runs persistently in your terminal and executes the command when the scheduled time is reached.
---
...
---
> Source: [macalinao/claude-code-schedule](https://github.com/macalinao/claude-code-schedule) — distributed by [TomeVault](https://tomevault.io).
