---
trigger: always_on
description: - Use `pnpm` (not npm/yarn) for package management.
---
...
---
> Source: [scttcper/plex](https://github.com/scttcper/plex) — distributed by [TomeVault](https://tomevault.io).
