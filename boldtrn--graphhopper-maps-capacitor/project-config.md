---
trigger: always_on
description: Capacitor-based Android app wrapping **GraphHopper Maps** (React/OpenLayers web app) with a native **turn-by-turn navigation** screen built on MapLibre GL and the MapLibre Navigation SDK.
---
...
---
> Source: [boldtrn/graphhopper-maps-capacitor](https://github.com/boldtrn/graphhopper-maps-capacitor) — distributed by [TomeVault](https://tomevault.io).
