---
trigger: always_on
description: This document contains a list of conventions that `bevy_lint`'s code follows to ensure consistency across the project. Beyond this document, the project uses [Clippy], [`rustfmt`], and [`typos`] in CI, and it follows the majority of the [Rust API Guidelines].
---
...
---
> Source: [TheBevyFlock/bevy_cli](https://github.com/TheBevyFlock/bevy_cli) — distributed by [TomeVault](https://tomevault.io).
