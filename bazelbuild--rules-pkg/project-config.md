---
trigger: always_on
description: rules_pkg is a set of Bazel rules for building distribution packages (tar, zip, deb, rpm, …).
---
...
---
> Source: [bazelbuild/rules_pkg](https://github.com/bazelbuild/rules_pkg) — distributed by [TomeVault](https://tomevault.io).
