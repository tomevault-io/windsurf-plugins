---
trigger: always_on
description: DevSkim is a framework of IDE extensions and language analyzers that provide inline security analysis in the dev environment as the developer writes code. The repository contains:
---
...
---
> Source: [microsoft/DevSkim](https://github.com/microsoft/DevSkim) — distributed by [TomeVault](https://tomevault.io).
