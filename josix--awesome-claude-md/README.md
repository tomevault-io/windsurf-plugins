# AI instruction files for awesome-claude-md

> Sourced from [josix/awesome-claude-md](https://github.com/josix/awesome-claude-md) and converted for every major platform by [TomeVault](https://tomevault.io)
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/josix/awesome-claude-md](https://github.com/josix/awesome-claude-md)
