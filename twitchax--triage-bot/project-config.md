---
trigger: always_on
description: This repository is configured to work seamlessly with GitHub Copilot. This document provides guidance on how to use the provided tools and configurations.
---
...
---
> Source: [twitchax/triage-bot](https://github.com/twitchax/triage-bot) — distributed by [TomeVault](https://tomevault.io).
