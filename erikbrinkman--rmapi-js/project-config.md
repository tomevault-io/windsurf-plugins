---
trigger: always_on
description: - The types in this library are reverse-engineered from the reMarkable cloud
---
...
---
> Source: [erikbrinkman/rmapi-js](https://github.com/erikbrinkman/rmapi-js) — distributed by [TomeVault](https://tomevault.io).
