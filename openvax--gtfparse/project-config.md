---
trigger: always_on
description: 1. **Never commit to `master`.** Always `git checkout -b <feature-branch>` before editing. Land via PR.
---
...
---
> Source: [openvax/gtfparse](https://github.com/openvax/gtfparse) — distributed by [TomeVault](https://tomevault.io).
