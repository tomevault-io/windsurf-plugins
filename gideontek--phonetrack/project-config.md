---
trigger: always_on
description: PhoneTrack is an open source Android app that focuses on location sharing over SMS messages without using data. It has a simple interface and defaults to common use cases but provides overrides when needed.
---
...
---
> Source: [gideontek/phonetrack](https://github.com/gideontek/phonetrack) — distributed by [TomeVault](https://tomevault.io).
