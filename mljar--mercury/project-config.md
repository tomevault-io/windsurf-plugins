---
trigger: always_on
description: Guidance for AI coding agents (Claude Code, Cursor, Codex, Copilot) working in this
---
...
---
> Source: [mljar/mercury](https://github.com/mljar/mercury) — distributed by [TomeVault](https://tomevault.io).
