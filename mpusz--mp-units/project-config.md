---
trigger: always_on
description: Claude Code loads this file automatically. The shared, vendor-neutral guidance for this
---
...
---
> Source: [mpusz/mp-units](https://github.com/mpusz/mp-units) — distributed by [TomeVault](https://tomevault.io).
