---
trigger: always_on
description: - `server/` – MCP server implementation. Main entry: `server/zenml_server.py`; analytics: `server/zenml_mcp_analytics.py`; treat `server/lib/` as vendored support code (avoid edits unless necessary).
---
...
---
> Source: [zenml-io/mcp-zenml](https://github.com/zenml-io/mcp-zenml) — distributed by [TomeVault](https://tomevault.io).
