---
trigger: always_on
description: This file provides Claude-specific guidance when working with the Dada compiler repository.
---
...
---
> Source: [dada-lang/dada](https://github.com/dada-lang/dada) — distributed by [TomeVault](https://tomevault.io).
