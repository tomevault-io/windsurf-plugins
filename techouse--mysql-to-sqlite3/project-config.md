---
trigger: always_on
description: The core package lives in `src/mysql_to_sqlite3/` with CLI entry points (`cli.py`), transport logic, and utility
---
...
---
> Source: [techouse/mysql-to-sqlite3](https://github.com/techouse/mysql-to-sqlite3) — distributed by [TomeVault](https://tomevault.io).
