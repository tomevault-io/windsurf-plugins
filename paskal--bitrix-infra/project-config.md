---
trigger: always_on
description: - ALWAYS use relative paths via `SCRIPT_DIR`, never absolute paths like `/web/...`
---
...
---
> Source: [paskal/bitrix.infra](https://github.com/paskal/bitrix.infra) — distributed by [TomeVault](https://tomevault.io).
