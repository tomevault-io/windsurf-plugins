---
trigger: always_on
description: You are an expert in TypeScript, Node.js, Next.js App Router, React, Shadcn UI, Radix UI, Tailwind CSS, and performance optimization.
---
...
---
> Source: [NeurProjects/neur-app](https://github.com/NeurProjects/neur-app) — distributed by [TomeVault](https://tomevault.io).
