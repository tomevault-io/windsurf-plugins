---
trigger: always_on
description: Guidance for AI coding agents (and humans) working with MLatom.
---
...
---
> Source: [dralgroup/mlatom](https://github.com/dralgroup/mlatom) — distributed by [TomeVault](https://tomevault.io).
