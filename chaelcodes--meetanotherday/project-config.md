---
trigger: always_on
description: Meet Another Day is a Ruby on Rails 7.1 web application that helps you meet up with your friends at conferences. One week before an event, you'll receive an email with a list of friends attending. Built with Ruby 3.2.2, PostgreSQL 13, and uses Bulma CSS framework with Material Icons.
---
...
---
> Source: [ChaelCodes/MeetAnotherDay](https://github.com/ChaelCodes/MeetAnotherDay) — distributed by [TomeVault](https://tomevault.io).
