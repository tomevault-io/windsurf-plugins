---
trigger: always_on
description: This file provides guidelines for AI-assisted contributions to
---
...
---
> Source: [open-telemetry/opentelemetry-go-compile-instrumentation](https://github.com/open-telemetry/opentelemetry-go-compile-instrumentation) — distributed by [TomeVault](https://tomevault.io).
