---
trigger: always_on
description: Every commit must have a descriptive title and a substantive body. Title-only
---
...
---
> Source: [rust-lang/flate2-rs](https://github.com/rust-lang/flate2-rs) — distributed by [TomeVault](https://tomevault.io).
