---
trigger: always_on
description: - Scan and understand the entire project before starting.
---
...
---
> Source: [pestphp/pest-plugin-browser](https://github.com/pestphp/pest-plugin-browser) — distributed by [TomeVault](https://tomevault.io).
