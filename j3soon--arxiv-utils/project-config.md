---
trigger: always_on
description: - Add every navigation testcase to the shared `navigation` list in `tests/testcases/testcases.yaml`. The Jest test must always run the complete list; do not filter or comment out cases for Jest.
---
...
---
> Source: [j3soon/arxiv-utils](https://github.com/j3soon/arxiv-utils) — distributed by [TomeVault](https://tomevault.io).
