---
trigger: always_on
description: This file provides instructions for AI coding agents working on the `ebarooni/capacitor-calendar` codebase.
---
...
---
> Source: [ebarooni/capacitor-calendar](https://github.com/ebarooni/capacitor-calendar) — distributed by [TomeVault](https://tomevault.io).
