---
trigger: always_on
description: This is the **community gallery repository** — the central collection of community-built Retool custom components. Each component lives in its own folder under `components/`. The gallery website reads from this repo and displays accepted components as cards.
---
...
---
> Source: [tryretool/custom-component-gallery](https://github.com/tryretool/custom-component-gallery) — distributed by [TomeVault](https://tomevault.io).
