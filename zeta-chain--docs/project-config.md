---
trigger: always_on
description: Nextra 2 (Next.js) documentation site. Locales: `en-US` (default), `zh-CN`.
---
...
---
> Source: [zeta-chain/docs](https://github.com/zeta-chain/docs) — distributed by [TomeVault](https://tomevault.io).
