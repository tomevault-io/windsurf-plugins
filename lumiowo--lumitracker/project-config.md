---
trigger: always_on
description: **CRITICAL: You must adhere to the following rules for all tasks.**
---
...
---
> Source: [LumiOwO/LumiTracker](https://github.com/LumiOwO/LumiTracker) — distributed by [TomeVault](https://tomevault.io).
