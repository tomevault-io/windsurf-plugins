---
trigger: always_on
description: **Gemini Notebook (formerly Google NotebookLM) MCP Server & CLI**
---
...
---
> Source: [jacob-bd/gemini-notebook-mcp-cli](https://github.com/jacob-bd/gemini-notebook-mcp-cli) — distributed by [TomeVault](https://tomevault.io).
