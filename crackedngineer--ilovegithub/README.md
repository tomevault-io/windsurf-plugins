# AI instruction files for iLoveGithub

> Sourced from [crackedngineer/iLoveGithub](https://github.com/crackedngineer/iLoveGithub), graded against the public Tome Standard and kept consistent across every major platform by [TomeVault](https://tomevault.io)

A curated collection of magical tools built around GitHub
