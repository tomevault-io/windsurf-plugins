---
trigger: always_on
description: 本文件是后续 AI agent 进入 `halo-theme-hydro-minim` 时的第一入口。更完整的开发说明见 [docs/ai-development-guide.md](docs/ai-development-guide.md)。
---
...
---
> Source: [liuyiwuqing/halo-theme-hydro-minim](https://github.com/liuyiwuqing/halo-theme-hydro-minim) — distributed by [TomeVault](https://tomevault.io).
