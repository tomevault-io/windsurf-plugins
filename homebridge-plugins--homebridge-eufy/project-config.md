---
trigger: always_on
description: **IMPORTANT: Create the branch BEFORE editing any files.**
---
...
---
> Source: [homebridge-plugins/homebridge-eufy](https://github.com/homebridge-plugins/homebridge-eufy) — distributed by [TomeVault](https://tomevault.io).
