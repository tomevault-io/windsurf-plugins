---
trigger: always_on
description: This file sets repository-wide rules for coding agents in WeClaws.
---
...
---
> Source: [baseclaw/weclaws](https://github.com/baseclaw/weclaws) — distributed by [TomeVault](https://tomevault.io).
