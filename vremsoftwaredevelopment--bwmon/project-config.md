---
trigger: always_on
description: > Universal instructions for AI coding agents (Copilot, Claude, Cursor, Codex, etc.)
---
...
---
> Source: [VREMSoftwareDevelopment/bwmon](https://github.com/VREMSoftwareDevelopment/bwmon) — distributed by [TomeVault](https://tomevault.io).
