---
trigger: always_on
description: go-p2ptunnel 是一个基于 libp2p 的 P2P TCP 隧道工具（Go 语言），支持 QUIC/TCP/WebSocket/WebTransport 传输协议，使用 Noise 协议加密，内置 NAT 穿越、SOCKS5 代理和 HTTP/HTTPS 代理功能。
---
...
---
> Source: [chenjia404/go-p2ptunnel](https://github.com/chenjia404/go-p2ptunnel) — distributed by [TomeVault](https://tomevault.io).
