---
trigger: always_on
description: pnpm check # full product gate. Run before every commit.
---
...
---
> Source: [zkortam/wingman](https://github.com/zkortam/wingman) — distributed by [TomeVault](https://tomevault.io).
