---
trigger: always_on
description: 本仓库是「轻影 / Watermark」项目的多端代码集合，核心功能是水印模板设计、图片 EXIF 信息读取和批量生成带模板效果的新图片。
---
...
---
> Source: [3egirlsdream/Watermark.Win](https://github.com/3egirlsdream/Watermark.Win) — distributed by [TomeVault](https://tomevault.io).
