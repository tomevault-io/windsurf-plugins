---
trigger: always_on
description: This file is a discoverability shortcut for AI coding agents (Claude Code, Cursor, Codex, Aider, …). The canonical guide lives in the docs:
---
...
---
> Source: [zubzet/framework](https://github.com/zubzet/framework) — distributed by [TomeVault](https://tomevault.io).
