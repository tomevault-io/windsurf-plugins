---
trigger: always_on
description: This file is the local operating guide for agents working in this repository.
---
...
---
> Source: [monkey/monkey](https://github.com/monkey/monkey) — distributed by [TomeVault](https://tomevault.io).
