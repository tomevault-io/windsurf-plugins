---
trigger: always_on
description: - Monorepo layout: `packages/*` for libraries, `apps/*` for apps.
---
...
---
> Source: [JoaoPauloCMarra/react-native-nitro-markdown](https://github.com/JoaoPauloCMarra/react-native-nitro-markdown) — distributed by [TomeVault](https://tomevault.io).
