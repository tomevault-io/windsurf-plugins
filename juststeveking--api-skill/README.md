...
Original source: `` in [JustSteveKing/api-skill](https://github.com/JustSteveKing/api-skill).
...
```
npx tomevault install JustSteveKing/api-skill
```
Source: [github.com/JustSteveKing/api-skill](https://github.com/JustSteveKing/api-skill).
