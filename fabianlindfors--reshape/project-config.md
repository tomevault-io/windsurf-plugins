---
trigger: always_on
description: Reshape is a zero-downtime schema migration tool for PostgreSQL (12+). It works by creating views that encapsulate tables, with triggers to translate between old and new schemas during migrations. This allows gradual application rollouts without downtime.
---
...
---
> Source: [fabianlindfors/reshape](https://github.com/fabianlindfors/reshape) — distributed by [TomeVault](https://tomevault.io).
