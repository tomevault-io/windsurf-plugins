---
trigger: always_on
description: このファイルは、Claude Code がこのリポジトリで作業する際のガイダンスを提供します。
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/ebal5) — claim your Tome and manage your conversions.
