---
trigger: always_on
description: Follow [Contributing.md](Contributing.md) and [SECURITY.md](SECURITY.md), including
---
...
---
> Source: [verybadcat/CSharpMath](https://github.com/verybadcat/CSharpMath) — distributed by [TomeVault](https://tomevault.io).
