---
trigger: always_on
description: - `src/FluentHub.App`: WinUI 3 application layer (views, view models, app services, app lifecycle).
---
...
---
> Source: [0x5bfa/FluentHub](https://github.com/0x5bfa/FluentHub) — distributed by [TomeVault](https://tomevault.io).
