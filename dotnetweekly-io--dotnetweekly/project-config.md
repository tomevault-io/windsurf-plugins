---
trigger: always_on
description: You are the GitHub Copilot agent for this repository. When you're assigned to an issue, you will perform the following tasks:
---
...
---
> Source: [DotNETWeekly-io/DotNetWeekly](https://github.com/DotNETWeekly-io/DotNetWeekly) — distributed by [TomeVault](https://tomevault.io).
