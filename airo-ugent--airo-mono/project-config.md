---
trigger: always_on
description: Python monorepo for robot manipulation tooling from the [AIRO lab](https://airo.ugent.be/) at Ghent University.
---
...
---
> Source: [airo-ugent/airo-mono](https://github.com/airo-ugent/airo-mono) — distributed by [TomeVault](https://tomevault.io).
