---
trigger: always_on
description: - Use **PascalCase** for class names, method names, and properties.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/DroneDB)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/DroneDB)
