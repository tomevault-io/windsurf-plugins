---
trigger: always_on
description: This project contains nearly identical implementations of Conway's Game of Life in multiple programming languages to showcase core language constructs for comparison purposes.
---
