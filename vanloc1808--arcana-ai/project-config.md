---
trigger: always_on
description: For all newly created Postgres tables, enable Row Level Security (RLS) by default in the same migration that creates the table.
---
...
---
> Source: [vanloc1808/arcana-ai](https://github.com/vanloc1808/arcana-ai) — distributed by [TomeVault](https://tomevault.io).
