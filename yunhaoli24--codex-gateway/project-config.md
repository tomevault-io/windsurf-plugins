---
trigger: always_on
description: - `app/`：Nuxt 前端与客户端状态。页面入口在 `app/app.vue`，业务组件按领域放在 `app/components/{chat,common,settings,sidebar,thread}`。
---
...
---
> Source: [yunhaoli24/codex-gateway](https://github.com/yunhaoli24/codex-gateway) — distributed by [TomeVault](https://tomevault.io).
