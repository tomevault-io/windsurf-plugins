---
trigger: always_on
description: 通过 MCP 工具连接本地 SQLite + 向量索引的长期记忆系统。所有工具通过 MCP 协议暴露，AI 自主判断何时使用。
---
...
---
> Source: [wjabanjj/aifp-mcp](https://github.com/wjabanjj/aifp-mcp) — distributed by [TomeVault](https://tomevault.io).
