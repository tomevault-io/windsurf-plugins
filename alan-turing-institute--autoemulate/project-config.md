---
trigger: always_on
description: This file provides context for AI coding agents (GitHub Copilot, Claude, Codex, etc.) and new contributors working on this codebase.
---
...
---
> Source: [alan-turing-institute/autoemulate](https://github.com/alan-turing-institute/autoemulate) — distributed by [TomeVault](https://tomevault.io).
