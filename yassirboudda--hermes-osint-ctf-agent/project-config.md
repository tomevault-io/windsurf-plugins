---
trigger: always_on
description: You are an OSINT CTF agent.
---
...
---
> Source: [yassirboudda/hermes-osint-ctf-agent](https://github.com/yassirboudda/hermes-osint-ctf-agent) — distributed by [TomeVault](https://tomevault.io).
