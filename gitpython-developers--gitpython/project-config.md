---
trigger: always_on
description: Before starting work, read and follow [CONTRIBUTING.md](CONTRIBUTING.md),
---
...
---
> Source: [gitpython-developers/GitPython](https://github.com/gitpython-developers/GitPython) — distributed by [TomeVault](https://tomevault.io).
