# AI instruction files for open-urban-eyesore
...
Original source: `.cursor/rules/*.mdc` in [warlockdn/open-urban-eyesore](https://github.com/warlockdn/open-urban-eyesore).
