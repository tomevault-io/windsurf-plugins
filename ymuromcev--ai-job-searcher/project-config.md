---
trigger: always_on
description: Project-level instructions for Claude Code (or any AI agent) working in
---
...
---
> Source: [ymuromcev/ai-job-searcher](https://github.com/ymuromcev/ai-job-searcher) — distributed by [TomeVault](https://tomevault.io).
