---
trigger: always_on
description: make test CONFIG=minimal   # Build, start, and test a specific config
---
...
---
> Source: [digitalocean-labs/openclaw-appplatform](https://github.com/digitalocean-labs/openclaw-appplatform) — distributed by [TomeVault](https://tomevault.io).
