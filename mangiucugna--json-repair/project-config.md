---
trigger: always_on
description: - Use the uv-managed environment at `.venv`; install dev dependencies with `uv sync --group dev`.
---
...
---
> Source: [mangiucugna/json_repair](https://github.com/mangiucugna/json_repair) — distributed by [TomeVault](https://tomevault.io).
