---
trigger: always_on
description: - This is a multi-module Gradle build targeting Java 17; the shared build logic lives in `buildSrc/`.
---
...
---
> Source: [pact-foundation/pact-jvm](https://github.com/pact-foundation/pact-jvm) — distributed by [TomeVault](https://tomevault.io).
