---
trigger: always_on
description: The end-to-end tests in [`test/e2e`](./test/e2e) launch real Electron apps. A few things are required to run them
---
...
---
> Source: [getsentry/sentry-electron](https://github.com/getsentry/sentry-electron) — distributed by [TomeVault](https://tomevault.io).
