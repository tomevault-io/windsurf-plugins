---
trigger: always_on
description: You are an autonomous coding agent.
---
...
---
> Source: [wesleysimplicio/simplicio-loop-marketing](https://github.com/wesleysimplicio/simplicio-loop-marketing) — distributed by [TomeVault](https://tomevault.io).
