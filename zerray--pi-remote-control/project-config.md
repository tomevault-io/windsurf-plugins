---
trigger: always_on
description: - This directory is an independent Git repository distributed as the `pi-remote-control` Pi package.
---
...
---
> Source: [zerray/pi-remote-control](https://github.com/zerray/pi-remote-control) — distributed by [TomeVault](https://tomevault.io).
