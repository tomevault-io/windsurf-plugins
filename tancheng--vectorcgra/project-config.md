---
trigger: always_on
description: This file provides guidance to AI coding agents (Claude Code, Codex, and
---
...
---
> Source: [tancheng/VectorCGRA](https://github.com/tancheng/VectorCGRA) — distributed by [TomeVault](https://tomevault.io).
