---
trigger: always_on
description: `crates/stypes` is the source of truth for Rust data structures shared by the native app, core runtime crates, CLI, and plugin-facing flows.
---
...
---
> Source: [esrlabs/chipmunk](https://github.com/esrlabs/chipmunk) — distributed by [TomeVault](https://tomevault.io).
