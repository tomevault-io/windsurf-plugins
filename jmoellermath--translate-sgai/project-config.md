---
trigger: always_on
description: - If you are uncertain about any specific word or phrase in your translation then you can wrap it in the `\unsure{}` command to highlight it, and add an optional margin note with `\unsure[lorem ipsum]{}`; if there is a whole bit that you want to skip for the moment you can use `\completelyunsure`, which is just `\unsure{[\ldots]}`.
---
...
---
> Source: [jmoellermath/translate-SGAI](https://github.com/jmoellermath/translate-SGAI) — distributed by [TomeVault](https://tomevault.io).
