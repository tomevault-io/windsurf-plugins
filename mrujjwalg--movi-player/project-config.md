...
`custom-elements.json` (repo root) describes the element itself — every
attribute and event, as data. See [4.0](#40-read-the-manifest-first).
...
---
> Source: [MrUjjwalG/movi-player](https://github.com/MrUjjwalG/movi-player) — distributed by [TomeVault](https://tomevault.io).
