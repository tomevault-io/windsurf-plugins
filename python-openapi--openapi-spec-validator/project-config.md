---
trigger: always_on
description: Guidance for coding agents working in `openapi-spec-validator`.
---
...
---
> Source: [python-openapi/openapi-spec-validator](https://github.com/python-openapi/openapi-spec-validator) — distributed by [TomeVault](https://tomevault.io).
