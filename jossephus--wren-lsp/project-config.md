---
trigger: always_on
description: **Never commit or push unless explicitly told to do so.** Always verify with the user before making commits.
---
...
---
> Source: [jossephus/wren-lsp](https://github.com/jossephus/wren-lsp) — distributed by [TomeVault](https://tomevault.io).
