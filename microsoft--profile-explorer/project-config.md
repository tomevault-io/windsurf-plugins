---
trigger: always_on
description: **NEVER commit or git add without explicit user permission.** When asked for a commit message, provide the message text only - do not execute `git commit` or `git add`.
---
...
---
> Source: [microsoft/profile-explorer](https://github.com/microsoft/profile-explorer) — distributed by [TomeVault](https://tomevault.io).
