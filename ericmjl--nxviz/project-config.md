---
trigger: always_on
description: nxviz is a Python library for rational network visualizations built on a grammar of graphics. It provides six plot types (circos, arc, hive, matrix, parallel, geo) through a functional API, with matplotlib as the default backend and optional interactive backends (plotly).
---
...
---
> Source: [ericmjl/nxviz](https://github.com/ericmjl/nxviz) — distributed by [TomeVault](https://tomevault.io).
