---
trigger: always_on
description: - See the overview of the project in `.kilocode/rules/overview.md`
---
...
---
> Source: [mits-pl/wove](https://github.com/mits-pl/wove) — distributed by [TomeVault](https://tomevault.io).
