---
trigger: always_on
description: You are an expert technical writer tasked with creating "How To" documentation for software features to help non-technical users understand how to use them.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/TOSS-Platform)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/TOSS-Platform)
