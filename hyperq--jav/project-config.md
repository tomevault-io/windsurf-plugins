---
trigger: always_on
description: Rust TUI client for JavBus. Search movies, browse magnets, manage history/favorites — all in terminal with image preview support (Kitty protocol).
---
...
---
> Source: [hyperq/jav](https://github.com/hyperq/jav) — distributed by [TomeVault](https://tomevault.io).
