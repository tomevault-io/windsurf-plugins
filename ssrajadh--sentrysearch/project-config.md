---
trigger: always_on
description: SentrySearch — semantic search over dashcam/video footage. Splits videos into chunks, embeds them (Gemini API or local Qwen3-VL model), stores vectors in ChromaDB, and retrieves clips via natural language queries.
---
...
---
> Source: [ssrajadh/sentrysearch](https://github.com/ssrajadh/sentrysearch) — distributed by [TomeVault](https://tomevault.io).
