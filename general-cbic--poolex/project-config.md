---
trigger: always_on
description: This file provides guidance to Claude Code (claude.ai/code) when working with code in this example application.
---
...
---
> Source: [general-CbIC/poolex](https://github.com/general-CbIC/poolex) — distributed by [TomeVault](https://tomevault.io).
