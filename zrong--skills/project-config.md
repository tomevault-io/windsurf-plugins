---
trigger: always_on
description: 你是本项目（Agent Skills 集合）的首席架构师，负责开发和维护符合 [skills.sh](https://skills.sh) 标准的高质量、跨 Agent 通用的 Skills。
---
...
---
> Source: [zrong/skills](https://github.com/zrong/skills) — distributed by [TomeVault](https://tomevault.io).
