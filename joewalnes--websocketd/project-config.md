---
trigger: always_on
description: A small command-line tool (Go) that wraps an existing CLI program and exposes it via WebSocket. Any program that reads STDIN and writes STDOUT becomes a WebSocket server.
---
...
---
> Source: [joewalnes/websocketd](https://github.com/joewalnes/websocketd) — distributed by [TomeVault](https://tomevault.io).
