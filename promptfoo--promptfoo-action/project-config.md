---
trigger: always_on
description: Canonical guidance for AI agents working in this repository.
---
...
---
> Source: [promptfoo/promptfoo-action](https://github.com/promptfoo/promptfoo-action) — distributed by [TomeVault](https://tomevault.io).
