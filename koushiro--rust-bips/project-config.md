---
trigger: always_on
description: - `src/lib.rs` is the public entry point; core logic lives in `src/mnemonic/` and `src/language/`.
---
...
---
> Source: [koushiro/rust-bips](https://github.com/koushiro/rust-bips) — distributed by [TomeVault](https://tomevault.io).
