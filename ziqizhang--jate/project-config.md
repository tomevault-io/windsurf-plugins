---
trigger: always_on
description: Python library for automatic term extraction (ATE). 14 classical scoring algorithms, corpus-level statistics, evaluation, CLI, and REST API. Built on spaCy.
---
...
---
> Source: [ziqizhang/jate](https://github.com/ziqizhang/jate) — distributed by [TomeVault](https://tomevault.io).
