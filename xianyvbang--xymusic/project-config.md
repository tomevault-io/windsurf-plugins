---
trigger: always_on
description: - 对总结、Plan、Task、以及长内容的输出，优先进行逻辑整理后使用美观的Table格式整齐输出;普通内容正常输出
---
...
---
> Source: [xianyvbang/XyMusic](https://github.com/xianyvbang/XyMusic) — distributed by [TomeVault](https://tomevault.io).
