---
trigger: always_on
description: Always follow the [Contributing Guide](../docs/CONTRIBUTING.md).
---
...
---
> Source: [DestinyItemManager/DIM](https://github.com/DestinyItemManager/DIM) — distributed by [TomeVault](https://tomevault.io).
