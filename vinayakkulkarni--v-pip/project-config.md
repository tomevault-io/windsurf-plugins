---
trigger: always_on
description: > **For AI Coding Assistants (Claude Code, Cursor, Copilot, etc.)**
---
...
**v-pip** (`v-pip`) -- Vue wrapper for native picture-in-picture (PiP).
...
---
> Source: [vinayakkulkarni/v-pip](https://github.com/vinayakkulkarni/v-pip) — distributed by [TomeVault](https://tomevault.io).
