---
trigger: always_on
description: Read and follow [`../AGENTS.md`](../AGENTS.md) in full before proposing or making repository changes. It is the canonical instruction set for this project.
---
...
---
> Source: [sindreslungaard/duel-masters](https://github.com/sindreslungaard/duel-masters) — distributed by [TomeVault](https://tomevault.io).
