---
trigger: always_on
description: Load `docs/` as project memory at session start or when context is needed.
---
...
---
> Source: [posaune0423/use-haptic](https://github.com/posaune0423/use-haptic) — distributed by [TomeVault](https://tomevault.io).
