---
trigger: always_on
description: 在 Claude Code 中引用文件时，使用 markdown 链接语法：
---

# m2w: Markdown to WordPress - Claude Code 项目指令
...
---
> Source: [huangwb8/m2w](https://github.com/huangwb8/m2w) — distributed by [TomeVault](https://tomevault.io).
