---
trigger: always_on
description: Whale is a Go CLI/TUI agent. The entrypoint is `cmd/whale`. Most application code lives under `internal/`:
---
...
---
> Source: [usewhale/DeepSeek-Code-Whale](https://github.com/usewhale/DeepSeek-Code-Whale) — distributed by [TomeVault](https://tomevault.io).
