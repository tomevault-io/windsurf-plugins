---
trigger: always_on
description: An open-source TypeForm clone built with Next.js 16, Supabase, and Tailwind CSS.
---
...
---
> Source: [dabit3/openform](https://github.com/dabit3/openform) — distributed by [TomeVault](https://tomevault.io).
