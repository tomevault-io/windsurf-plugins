---
trigger: always_on
description: -  Refer to the following documentation pages for guidance:
---
...
---
> Source: [rocketseat-education/ai-task-manager](https://github.com/rocketseat-education/ai-task-manager) — distributed by [TomeVault](https://tomevault.io).
