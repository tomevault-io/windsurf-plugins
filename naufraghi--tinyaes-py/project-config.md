---
trigger: always_on
description: `tinyaes` is a Cython wrapper around the [tiny-AES-c](https://github.com/kokke/tiny-AES-c) C library, providing AES-128 encryption/decryption in CTR and CBC modes. It is a single Python package (not a monorepo) with no external services.
---
...
---
> Source: [naufraghi/tinyaes-py](https://github.com/naufraghi/tinyaes-py) — distributed by [TomeVault](https://tomevault.io).
