---
trigger: always_on
description: ./mvnw clean install -Pdocker
---
...
---
> Source: [greenmail-mail-test/greenmail](https://github.com/greenmail-mail-test/greenmail) — distributed by [TomeVault](https://tomevault.io).
