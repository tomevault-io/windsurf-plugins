---
trigger: always_on
description: Kubernetes operator (operator-sdk / controller-runtime) that manages the
---
...
---
> Source: [tigera/operator](https://github.com/tigera/operator) — distributed by [TomeVault](https://tomevault.io).
