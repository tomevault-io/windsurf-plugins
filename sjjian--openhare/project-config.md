---
trigger: always_on
description: This is Microsoft's official Go driver for SQL Server and Azure SQL Database.
---
...
---
> Source: [sjjian/openhare](https://github.com/sjjian/openhare) — distributed by [TomeVault](https://tomevault.io).
