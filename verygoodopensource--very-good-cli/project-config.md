---
trigger: always_on
description: At its core, VGV prefers code that embodies clear, concise mental models. We prefer to think deeply about the problem we are solving and find the solution that best fits.
---
...
---
> Source: [VeryGoodOpenSource/very_good_cli](https://github.com/VeryGoodOpenSource/very_good_cli) — distributed by [TomeVault](https://tomevault.io).
