---
trigger: always_on
description: NeewerLite is a native macOS menu-bar app that gives users full control over Neewer Bluetooth LED lights — something Neewer only provides on iOS/Android. For architecture, build commands, and technical details, see [Docs/Codebase-Guide.md](../Docs/Codebase-Guide.md).
---
...
---
> Source: [keefo/NeewerLite](https://github.com/keefo/NeewerLite) — distributed by [TomeVault](https://tomevault.io).
