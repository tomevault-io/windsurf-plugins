---
trigger: always_on
description: Citty: Elegant, zero-dependency CLI builder for Node.js.
---
...
---
> Source: [unjs/citty](https://github.com/unjs/citty) — distributed by [TomeVault](https://tomevault.io).
