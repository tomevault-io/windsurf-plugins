---
trigger: always_on
description: Event sourcing library for Python with pluggable backends.
---
...
---
> Source: [python-event-sourcery/python-event-sourcery](https://github.com/python-event-sourcery/python-event-sourcery) — distributed by [TomeVault](https://tomevault.io).
