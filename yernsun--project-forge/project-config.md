---
trigger: always_on
description: Project Forge is an independent project generator. Preserve its ability to render every valid
---
...
---
> Source: [yernsun/project-forge](https://github.com/yernsun/project-forge) — distributed by [TomeVault](https://tomevault.io).
