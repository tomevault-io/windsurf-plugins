---
trigger: always_on
description: - `crates/app`: Binary entry point and wiring (config loading, runtime bootstrap).
---
...
---
> Source: [gfhdhytghd/OQQWall_rust](https://github.com/gfhdhytghd/OQQWall_rust) — distributed by [TomeVault](https://tomevault.io).
