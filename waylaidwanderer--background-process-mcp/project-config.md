---
trigger: always_on
description: This extension provides a robust set of tools for managing background processes. It is your primary interface for any long-running or interactive tasks.
---
...
---
> Source: [waylaidwanderer/background-process-mcp](https://github.com/waylaidwanderer/background-process-mcp) — distributed by [TomeVault](https://tomevault.io).
