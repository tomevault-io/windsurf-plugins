---
trigger: always_on
description: Use this guide to make concise, high-signal contributions to the generalized k-means clustering library.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/derrickburns)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/derrickburns)
