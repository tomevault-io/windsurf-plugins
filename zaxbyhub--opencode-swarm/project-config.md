---
trigger: always_on
description: These instructions apply to Copilot coding agents, Copilot custom agents, and any AI agent assigned to a GitHub issue in this repository.
---
...
---
> Source: [ZaxbyHub/opencode-swarm](https://github.com/ZaxbyHub/opencode-swarm) — distributed by [TomeVault](https://tomevault.io).
