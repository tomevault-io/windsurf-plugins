---
trigger: always_on
description: Always-on rules for agents that read `AGENTS.md` (Codex CLI/app, VS Code Codex extension, and
---
...
---
> Source: [vagkaratzas/token-saviour](https://github.com/vagkaratzas/token-saviour) — distributed by [TomeVault](https://tomevault.io).
