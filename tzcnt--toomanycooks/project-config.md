---
trigger: always_on
description: TooManyCooks (TMC) is a header-only C++20 coroutine runtime and concurrency
---
...
---
> Source: [tzcnt/TooManyCooks](https://github.com/tzcnt/TooManyCooks) — distributed by [TomeVault](https://tomevault.io).
