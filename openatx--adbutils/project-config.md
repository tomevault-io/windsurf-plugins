---
trigger: always_on
description: adbutils is a pure Python library for Android Debug Bridge (ADB) operations. It provides both a Python API and command-line interface for device management, shell commands, file transfer, and Android app operations.
---
...
---
> Source: [openatx/adbutils](https://github.com/openatx/adbutils) — distributed by [TomeVault](https://tomevault.io).
