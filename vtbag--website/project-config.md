---
trigger: always_on
description: Never start with praising the user with silly compliments like "Great question."
---
...
---
> Source: [vtbag/website](https://github.com/vtbag/website) — distributed by [TomeVault](https://tomevault.io).
