...
Original source: `GEMINI.md` in [ChiR24/Unreal_mcp](https://github.com/ChiR24/Unreal_mcp).
...
```
npx tomevault install ChiR24/Unreal_mcp
```
Source: [github.com/ChiR24/Unreal_mcp](https://github.com/ChiR24/Unreal_mcp).
