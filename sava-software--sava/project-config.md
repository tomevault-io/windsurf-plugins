---
trigger: always_on
description: Behaviours that recur across this codebase and are not guessable from a
---
...
---
> Source: [sava-software/sava](https://github.com/sava-software/sava) — distributed by [TomeVault](https://tomevault.io).
