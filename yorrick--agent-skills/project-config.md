---
trigger: always_on
description: Agent skills and plugins for **both Claude Code and Codex**.
---
...
---
> Source: [yorrick/agent-skills](https://github.com/yorrick/agent-skills) — distributed by [TomeVault](https://tomevault.io).
