---
trigger: always_on
description: "Ghicește" is a Romanian Wordle clone built to run as a Discord Activity. It is a full-stack web application architected as a monorepo using pnpm workspaces.
---
