...
Original source: `AGENTS.md` in [microsoft/mcp-for-beginners](https://github.com/microsoft/mcp-for-beginners).
...
```
npx tomevault install microsoft/mcp-for-beginners
```
Source: [github.com/microsoft/mcp-for-beginners](https://github.com/microsoft/mcp-for-beginners).
