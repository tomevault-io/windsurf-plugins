---
trigger: always_on
description: 解析几何直接用**数学平面坐标**（x 右、y 上），无需像立体几何那样做 z↔y 换轴。前端引擎把数学
---
...
---
> Source: [wy51ai/edulab](https://github.com/wy51ai/edulab) — distributed by [TomeVault](https://tomevault.io).
