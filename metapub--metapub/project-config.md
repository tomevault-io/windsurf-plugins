---
trigger: always_on
description: This file provides coding guidelines for Claude when working on the metapub project.
---
...
---
> Source: [metapub/metapub](https://github.com/metapub/metapub) — distributed by [TomeVault](https://tomevault.io).
