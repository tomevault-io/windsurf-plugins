---
trigger: always_on
description: Solidity interfaces, libraries, and reference mocks for Base's precompiles: **B20** (ERC-20 superset
---
...
---
> Source: [base/base-std](https://github.com/base/base-std) — distributed by [TomeVault](https://tomevault.io).
