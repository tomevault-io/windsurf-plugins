---
trigger: always_on
description: 你的任务是按照 *.instructions.md 描述的规范完成功能开发任务。
---
...
---
> Source: [zhouda1fu/Ncp.CleanDDD](https://github.com/zhouda1fu/Ncp.CleanDDD) — distributed by [TomeVault](https://tomevault.io).
