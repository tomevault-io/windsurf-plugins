---
trigger: always_on
description: **I2P (Interface-to-Platform)**: Bootgly serves CLI and Web from the same core via two interfaces:
---
...
---
> Source: [bootgly/bootgly](https://github.com/bootgly/bootgly) — distributed by [TomeVault](https://tomevault.io).
