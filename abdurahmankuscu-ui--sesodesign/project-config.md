---
trigger: always_on
description: > **Note:** GitHub Copilot automatically reads this file to set its global behavior. By including this in the `.github` folder, Copilot stops writing generic "slop" code and adheres to the premium Taste Skill standards.
---
...
---
> Source: [abdurahmankuscu-ui/sesodesign](https://github.com/abdurahmankuscu-ui/sesodesign) — distributed by [TomeVault](https://tomevault.io).
