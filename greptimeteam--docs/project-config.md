---
trigger: always_on
description: Guidance for coding agents working in this repository. `CLAUDE.md` imports this
---
...
---
> Source: [GreptimeTeam/docs](https://github.com/GreptimeTeam/docs) — distributed by [TomeVault](https://tomevault.io).
