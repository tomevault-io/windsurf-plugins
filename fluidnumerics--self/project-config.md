---
trigger: always_on
description: The reference for this style is the tree at `f3e1e57c`, the last commit before
---
...
---
> Source: [FluidNumerics/SELF](https://github.com/FluidNumerics/SELF) — distributed by [TomeVault](https://tomevault.io).
