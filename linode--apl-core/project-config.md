---
trigger: always_on
description: APL Core (App Platform for Linode) is a Kubernetes platform that integrates 30+ cloud-native applications (Istio, Argo CD, Keycloak, Tekton, Harbor, etc.) into a cohesive, multi-tenant PaaS. The codebase is a hybrid of TypeScript (CLI/operators), Helm charts, Helmfile manifests, and Go templates.
---
...
---
> Source: [linode/apl-core](https://github.com/linode/apl-core) — distributed by [TomeVault](https://tomevault.io).
