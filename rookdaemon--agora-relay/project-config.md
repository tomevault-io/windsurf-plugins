---
trigger: always_on
description: This repo is a minimal WebSocket relay for Agora peer-to-peer messaging.
---

# Agora Relay
This repo is a minimal WebSocket relay for Agora peer-to-peer messaging.
