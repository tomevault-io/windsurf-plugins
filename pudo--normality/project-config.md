---
trigger: always_on
description: normality is a performance-sensitive text normalisation library. It is a hot
---
...
---
> Source: [pudo/normality](https://github.com/pudo/normality) — distributed by [TomeVault](https://tomevault.io).
