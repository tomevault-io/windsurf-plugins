---
trigger: always_on
description: OpenInCode is a small macOS Finder toolbar utility written in Swift. It reads the selected Finder item, or the front Finder window when nothing is selected, and opens the corresponding folder in Visual Studio Code.
---
...
---
> Source: [sozercan/OpenInCode](https://github.com/sozercan/OpenInCode) — distributed by [TomeVault](https://tomevault.io).
