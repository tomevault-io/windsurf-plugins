---
trigger: always_on
description: Monorepo with three independent packages (JS, Python, and Rust) implementing the same ID generator algorithm. No shared build system — each package is self-contained.
---
...
---
> Source: [youssefm/sparkid](https://github.com/youssefm/sparkid) — distributed by [TomeVault](https://tomevault.io).
