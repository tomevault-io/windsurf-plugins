---
trigger: always_on
description: Snap is an Elasticsearch/OpenSearch client for Elixir.
---
...
---
> Source: [breakroom/snap](https://github.com/breakroom/snap) — distributed by [TomeVault](https://tomevault.io).
