---
trigger: always_on
description: MIDI file parser and player that emits JSON events for each MIDI event. Does not generate audio — consumers handle sound synthesis.
---
...
---
> Source: [grimmdude/MidiPlayerJS](https://github.com/grimmdude/MidiPlayerJS) — distributed by [TomeVault](https://tomevault.io).
