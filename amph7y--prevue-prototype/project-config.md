---
trigger: always_on
description: This project uses the Google Gemini API for the following features:
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/amph7y)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/amph7y)
