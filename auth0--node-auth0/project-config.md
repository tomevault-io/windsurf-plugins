---
trigger: always_on
description: This is the **Auth0 Node.js SDK v5** - a TypeScript SDK providing Auth0 Authentication and Management API clients. The codebase uses **Fern-generated code** for the Management API with custom wrappers.
---
...
---
> Source: [auth0/node-auth0](https://github.com/auth0/node-auth0) — distributed by [TomeVault](https://tomevault.io).
