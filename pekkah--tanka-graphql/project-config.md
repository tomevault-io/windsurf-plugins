---
trigger: always_on
description: Always reference the [CLAUDE.md](mdc:CLAUDE.md) file at the start of conversations for project-specific guidance, development commands, and architectural patterns.
---
...
---
> Source: [pekkah/tanka-graphql](https://github.com/pekkah/tanka-graphql) — distributed by [TomeVault](https://tomevault.io).
