---
trigger: always_on
description: This repository contains Codex Mate, a local companion launcher for the Codex App. It starts Codex with a debug port, runs a helper server, and injects UI enhancements without modifying the installed Codex App bundle.
---
...
---
> Source: [serein431/Codex-Mate](https://github.com/serein431/Codex-Mate) — distributed by [TomeVault](https://tomevault.io).
