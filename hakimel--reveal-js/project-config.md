---
trigger: always_on
description: This directory contains the `@revealjs/react` wrapper. Keep the guidance here high level and update it when the public API, source layout, or Reveal/React synchronization model changes.
---
...
---
> Source: [hakimel/reveal.js](https://github.com/hakimel/reveal.js) — distributed by [TomeVault](https://tomevault.io).
