---
trigger: always_on
description: Example & reference catalog of ready-to-use MTA projects demonstrating deployment
---
...
---
> Source: [SAP-samples/cf-mta-examples](https://github.com/SAP-samples/cf-mta-examples) — distributed by [TomeVault](https://tomevault.io).
