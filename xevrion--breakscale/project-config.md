---
trigger: always_on
description: Breakscale is a discrete-event system design simulator for CS students. `src/sim` is a pure
---
...
---
> Source: [xevrion/breakscale](https://github.com/xevrion/breakscale) — distributed by [TomeVault](https://tomevault.io).
