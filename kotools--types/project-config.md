---
trigger: always_on
description: Supplement to `CLAUDE.md`. Captures rules enforced by `.editorconfig` plus
---
...
---
> Source: [kotools/types](https://github.com/kotools/types) — distributed by [TomeVault](https://tomevault.io).
