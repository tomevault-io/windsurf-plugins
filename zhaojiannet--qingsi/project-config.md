---
trigger: always_on
description: 会员管理 + 收银 + 预约 + 营业报表，覆盖美业 / 美容 / 美发 / 美甲 / 按摩 / 瑜伽 / 培训 / 宠物等行业。品牌名、行业类型、登录背景图在 `frontend/app/src/config/app.js` 切换；不要把行业文案/图片路径硬编码到组件。
---
...
---
> Source: [zhaojiannet/QingSi](https://github.com/zhaojiannet/QingSi) — distributed by [TomeVault](https://tomevault.io).
