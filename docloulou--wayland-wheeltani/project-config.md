...
**Start any session:**
1. `resolve_repo { "path": "{project absolute path}" }` — confirm the project is indexed. If not: `index_folder { "path": "{project absolute path}" }`
...
---
> Source: [docloulou/Wayland-Wheeltani](https://github.com/docloulou/Wayland-Wheeltani) — distributed by [TomeVault](https://tomevault.io).
