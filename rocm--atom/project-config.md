---
trigger: always_on
description: ATOM is a lightweight LLM inference engine built on AITER GPU kernels for the AMD ROCm platform.
---
...
---
> Source: [ROCm/ATOM](https://github.com/ROCm/ATOM) — distributed by [TomeVault](https://tomevault.io).
