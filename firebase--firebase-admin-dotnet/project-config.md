---
trigger: always_on
description: This document provides a detailed guide for AI agents to understand and contribute to the Firebase Admin .NET SDK. Adhering to these guidelines is crucial for maintaining code quality, consistency, and idiomatic C# practices.
---
...
---
> Source: [firebase/firebase-admin-dotnet](https://github.com/firebase/firebase-admin-dotnet) — distributed by [TomeVault](https://tomevault.io).
