---
trigger: always_on
description: Claude (AI) がこのリポジトリで作業するときの起動コンテキスト。**このファイル
---
...
---
> Source: [thawk105/ccbench](https://github.com/thawk105/ccbench) — distributed by [TomeVault](https://tomevault.io).
