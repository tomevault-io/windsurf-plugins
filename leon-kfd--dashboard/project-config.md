---
trigger: always_on
description: Vue 3 + TypeScript + Vite 构建的可自定义浏览器起始页。支持组件拖拽布局、主题切换、壁纸配置、多标签页等功能。
---
...
---
> Source: [leon-kfd/Dashboard](https://github.com/leon-kfd/Dashboard) — distributed by [TomeVault](https://tomevault.io).
