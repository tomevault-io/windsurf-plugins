---
trigger: always_on
description: Read ./README.md for project background.
---
...
---
> Source: [webern/cargo-readme](https://github.com/webern/cargo-readme) — distributed by [TomeVault](https://tomevault.io).
