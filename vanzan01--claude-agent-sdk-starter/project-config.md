---
trigger: always_on
description: npm run dev          # Development mode
---
...
---
> Source: [vanzan01/claude-agent-sdk-starter](https://github.com/vanzan01/claude-agent-sdk-starter) — distributed by [TomeVault](https://tomevault.io).
