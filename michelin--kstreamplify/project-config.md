---
trigger: always_on
description: - `kstreamplify-core`: core Kafka Streams functionality.
---
...
---
> Source: [michelin/kstreamplify](https://github.com/michelin/kstreamplify) — distributed by [TomeVault](https://tomevault.io).
