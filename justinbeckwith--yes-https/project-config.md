---
trigger: always_on
description: - This repository is a small ESM Node.js package that exports a single middleware from `lib/index.js`.
---
...
---
> Source: [JustinBeckwith/yes-https](https://github.com/JustinBeckwith/yes-https) — distributed by [TomeVault](https://tomevault.io).
