---
trigger: always_on
description: Guidance for AI coding agents (Claude Code, Codex, Cursor, Copilot, and others) working in
---
...
---
> Source: [onflow/fcl-js](https://github.com/onflow/fcl-js) — distributed by [TomeVault](https://tomevault.io).
