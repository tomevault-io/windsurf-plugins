---
trigger: always_on
description: 本文档描述模板中的状态机、计数器系统及其依赖关系，供维护和重构参考。
---
...
---
> Source: [pku-typst/pkuthss-typst](https://github.com/pku-typst/pkuthss-typst) — distributed by [TomeVault](https://tomevault.io).
