---
trigger: always_on
description: <!-- ORGANVM:AUTO:START -->
---
...
**Org:** `organvm-vi-koinonia` | **Repo:** `koinonia-db`

### Edges
- **Produces** → `salon-archive, reading-group-curriculum, adaptive-personal-syllabus, community-hub`: package

### Siblings in Community
`community-hub`, `salon-archive`, `reading-group-curriculum`, `adaptive-personal-syllabus`, `.github`
...
Run: `organvm ecosystem show koinonia-db` | `organvm ecosystem validate --organ VI`


## External Mirrors (Network Testament)

- **technical** (2): sqlalchemy/sqlalchemy, sqlalchemy/alembic

Convergences: 20 | Run: `organvm network map --repo koinonia-db` | `organvm network suggest`
...
**UID:** `ent_repo_01KKKX3RVQSMP17RZ8TCD10657` | **Matched by:** primary_name

Resolve: `organvm ontologia resolve koinonia-db` | History: `organvm ontologia history ent_repo_01KKKX3RVQSMP17RZ8TCD10657`
...
**Dialect:** PEDAGOGICAL_DIALECTIC | **Classical Parallel:** Geometry | **Translation Role:** The Dialectic — teaching IS inter-dialect translation

Strongest translations: V (structural), II (analogical), III (analogical)

Scan: `organvm trivium scan VI <OTHER>` | Matrix: `organvm trivium matrix` | Synthesize: `organvm trivium synthesize`
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/organvm-vi-koinonia)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/organvm-vi-koinonia)
