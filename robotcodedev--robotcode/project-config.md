---
trigger: always_on
description: This file is a short orientation layer for automated contributors. For complete contributor details, see [CONTRIBUTING.md](CONTRIBUTING.md).
---
...
---
> Source: [robotcodedev/robotcode](https://github.com/robotcodedev/robotcode) — distributed by [TomeVault](https://tomevault.io).
