---
trigger: always_on
description: **PlanGenerateAgent函数**: 这个类的功能是生成计划。它是BaseAgent的子类。
---
...
---
> Source: [OpenBMB/XAgent](https://github.com/OpenBMB/XAgent) — distributed by [TomeVault](https://tomevault.io).
