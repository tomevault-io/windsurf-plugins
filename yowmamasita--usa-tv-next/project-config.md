---
trigger: always_on
description: Stremio addon serving free IPTV streams for US television channels. Static JSON addon — no server, just files served from GitHub raw URLs.
---
...
---
> Source: [yowmamasita/usa-tv-next](https://github.com/yowmamasita/usa-tv-next) — distributed by [TomeVault](https://tomevault.io).
