---
trigger: always_on
description: Entry point for AI coding agents working on this repository. Read this
---
...
---
> Source: [emp-toolkit/emp-tool](https://github.com/emp-toolkit/emp-tool) — distributed by [TomeVault](https://tomevault.io).
