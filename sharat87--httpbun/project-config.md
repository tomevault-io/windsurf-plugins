---
trigger: always_on
description: **IMPORTANT**: Always use `uv` for Python operations in this project. Never invoke Python directly.
---
...
---
> Source: [sharat87/httpbun](https://github.com/sharat87/httpbun) — distributed by [TomeVault](https://tomevault.io).
