---
trigger: always_on
description: A distributed, stateful computational unit that executes through a directed graph of interconnected nodes. Agents represent autonomous processing entities that can maintain persistent state, communicate between execution steps, and integrate with external systems.
---
...
---
> Source: [redplanetlabs/agent-o-rama](https://github.com/redplanetlabs/agent-o-rama) — distributed by [TomeVault](https://tomevault.io).
