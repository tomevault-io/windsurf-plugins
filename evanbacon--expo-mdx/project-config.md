---
trigger: always_on
description: This is a universal MDX implementation for Expo (React & React Native). It transforms MDX files at build time via Metro and renders them using universal React Native components.
---
...
---
> Source: [EvanBacon/expo-mdx](https://github.com/EvanBacon/expo-mdx) — distributed by [TomeVault](https://tomevault.io).
