---
trigger: always_on
description: Perennial is a system implemented in Rocq for proving Go code correct. It builds on the Iris separation logic framework and uses stdpp (a Rocq standard library for Iris).
---
...
---
> Source: [mit-pdos/perennial](https://github.com/mit-pdos/perennial) — distributed by [TomeVault](https://tomevault.io).
