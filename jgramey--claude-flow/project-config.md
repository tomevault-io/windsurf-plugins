---
trigger: always_on
description: **ABSOLUTE RULE**: ALL operations MUST be concurrent/parallel in ONE message:
---
...
---
> Source: [JGRamey/claude-flow](https://github.com/JGRamey/claude-flow) — distributed by [TomeVault](https://tomevault.io).
