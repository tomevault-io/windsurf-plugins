---
trigger: always_on
description: - **Backend** : Laravel 12 (PHP 8.2+), architecture MVC classique
---
...
---
> Source: [SMEWebify/WebErpMesv2](https://github.com/SMEWebify/WebErpMesv2) — distributed by [TomeVault](https://tomevault.io).
