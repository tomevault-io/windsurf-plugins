---
trigger: always_on
description: MCP server that reads/writes Final Cut Pro XML (FCPXML) files. 53 tools for timeline analysis, batch editing, QC, generation, multi-track support, and NLE export.
---
