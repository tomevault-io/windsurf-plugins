---
trigger: always_on
description: - Full build: `mvn clean package -Pproduction`
---
...
---
> Source: [eschnou/OpenGPA](https://github.com/eschnou/OpenGPA) — distributed by [TomeVault](https://tomevault.io).
