---
trigger: always_on
description: `docs/architecture.md` governs. Two rules break most often, so they are also
---
...
---
> Source: [geograms/aurora](https://github.com/geograms/aurora) — distributed by [TomeVault](https://tomevault.io).
