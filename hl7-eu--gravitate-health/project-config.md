---
trigger: always_on
description: This is a **FHIR R5 Implementation Guide** for the Gravitate Health EU project. It defines how electronic Product Information (ePI) can be personalized/focused based on patient data (IPS - International Patient Summary) using "Lenses".
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/hl7-eu) — claim your Tome and manage your conversions.
