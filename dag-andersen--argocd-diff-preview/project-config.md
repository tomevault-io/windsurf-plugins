---
trigger: always_on
description: ArgoCD Diff Preview is a Go CLI tool that generates diffs between Argo CD application manifests across Git branches.
---
...
---
> Source: [dag-andersen/argocd-diff-preview](https://github.com/dag-andersen/argocd-diff-preview) — distributed by [TomeVault](https://tomevault.io).
