---
trigger: always_on
description: - Route durable multi-session work through `flightdeck/deck.md` and the focused Work page.
---
...
---
> Source: [Yuelioi/keycrash](https://github.com/Yuelioi/keycrash) — distributed by [TomeVault](https://tomevault.io).
