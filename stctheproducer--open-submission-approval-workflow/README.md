...
Workflow-first application submission and approval system for applicants and reviewers
...
From [stctheproducer/open-submission-approval-workflow](https://github.com/stctheproducer/open-submission-approval-workflow) — a repo with 0+ stars on GitHub.
