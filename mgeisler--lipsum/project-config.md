---
trigger: always_on
description: `lipsum` is a Rust library for generating pseudo-Latin "lorem ipsum" placeholder
---
...
---
> Source: [mgeisler/lipsum](https://github.com/mgeisler/lipsum) — distributed by [TomeVault](https://tomevault.io).
