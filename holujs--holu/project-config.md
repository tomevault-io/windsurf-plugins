---
trigger: always_on
description: This file provides rules and context for AI agents working inside the **Holu framework monorepo** (specifically on the framework core and packages).
---
...
---
> Source: [holujs/holu](https://github.com/holujs/holu) — distributed by [TomeVault](https://tomevault.io).
