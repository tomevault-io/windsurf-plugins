---
trigger: always_on
description: This is a production-ready Stable Diffusion server supporting multiple AI models (SDXL, Flux Schnell) with FastAPI backend and Gradio UI. The server handles text-to-image generation, inpainting, style transfer, and cloud storage integration.
---
...
---
> Source: [Netwrck/stable-diffusion-server](https://github.com/Netwrck/stable-diffusion-server) — distributed by [TomeVault](https://tomevault.io).
