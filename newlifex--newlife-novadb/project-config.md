---
trigger: always_on
description: 适用于新生命团队（NewLife）全部 C#/.NET 仓库。存在本文件则必须遵循。**简体中文回复。**
---
...
---
> Source: [NewLifeX/NewLife.NovaDb](https://github.com/NewLifeX/NewLife.NovaDb) — distributed by [TomeVault](https://tomevault.io).
