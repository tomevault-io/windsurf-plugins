---
trigger: always_on
description: Radar Forge is an agent-powered daily digest generator for open-source project intelligence, currently focused on the AI open-source ecosystem. A GitHub Actions cron job runs at 00:00 UTC (08:00 CST) and produces detailed Chinese-language reports plus an integrated daily entrypoint, published as GitHub Issues and committed Markdown files.
---
...
Radar Forge is an agent-powered daily digest generator for open-source project intelligence, currently focused on the AI open-source ecosystem. A GitHub Actions cron job runs at 00:00 UTC (08:00 CST) and produces detailed Chinese-language reports plus an integrated daily entrypoint, published as GitHub Issues and committed Markdown files.
...
| File | Label | Notes |
|------|-------|-------|
| `ai-daily.md` | `daily` | Integrated entrypoint across generated daily reports; preferred input for weekly/monthly rollups |
...
- All LLM prompts are in `src/prompts.ts`. Each report type has its own builder function. Daily prompts should stay factual and avoid forced trend judgments.
...
---
> Source: [borq168/radar-forge](https://github.com/borq168/radar-forge) — distributed by [TomeVault](https://tomevault.io).
