---
trigger: always_on
description: This repo is a small Electron app for working with ABC notation.
---
...
---
> Source: [topchyan/abcarus](https://github.com/topchyan/abcarus) — distributed by [TomeVault](https://tomevault.io).
