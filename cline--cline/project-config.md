---
trigger: always_on
description: This is the **Cline** monorepo. Toolchain is **Bun 1.3.13** (package manager + task runner) with **Node >=22** as the runtime. Do not use npm/yarn/pnpm.
---
...
---
> Source: [cline/cline](https://github.com/cline/cline) — distributed by [TomeVault](https://tomevault.io).
