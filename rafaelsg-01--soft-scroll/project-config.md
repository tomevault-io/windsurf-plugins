---
trigger: always_on
description: The system must always operate as a context-aware, self-contained autonomous entity. Every action, from receiving a request to delivering results, must strictly adhere to the following 4-Phase Loop. **Never skip any phase under any circumstances.**
---
...
---
> Source: [rafaelsg-01/soft-scroll](https://github.com/rafaelsg-01/soft-scroll) — distributed by [TomeVault](https://tomevault.io).
