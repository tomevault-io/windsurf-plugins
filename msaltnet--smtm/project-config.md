---
trigger: always_on
description: - smtm is a Python 3.9+ autonomous cryptocurrency trading system controlled through Telegram.
---
...
---
> Source: [msaltnet/smtm](https://github.com/msaltnet/smtm) — distributed by [TomeVault](https://tomevault.io).
