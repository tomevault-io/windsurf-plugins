---
trigger: always_on
description: - Multi-module Gradle workspace; standard `src/main` / `src/test` layout per module.
---
...
---
> Source: [jmix-framework/jmix](https://github.com/jmix-framework/jmix) — distributed by [TomeVault](https://tomevault.io).
