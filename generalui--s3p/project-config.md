---
trigger: always_on
description: Source is CaffeineScript (`.caf`). Build compiles to `build/`. Tests run from `build/` via Jest.
---
...
---
> Source: [generalui/s3p](https://github.com/generalui/s3p) — distributed by [TomeVault](https://tomevault.io).
