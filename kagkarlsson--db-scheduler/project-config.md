---
trigger: always_on
description: Java library for persistent task scheduling on a relational database. Uses either optimistic locking
---
...
---
> Source: [kagkarlsson/db-scheduler](https://github.com/kagkarlsson/db-scheduler) — distributed by [TomeVault](https://tomevault.io).
