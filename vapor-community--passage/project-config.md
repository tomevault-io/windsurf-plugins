---
trigger: always_on
description: Handles email/phone verification codes. Supports sync delivery or async via Vapor Queues (`SendEmailCodeJob`, `SendPhoneCodeJob`).
---
...
---
> Source: [vapor-community/passage](https://github.com/vapor-community/passage) — distributed by [TomeVault](https://tomevault.io).
