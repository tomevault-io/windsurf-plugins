---
trigger: always_on
description: Each `.mk` snippet starts with a reference header-comment of the
---
...
---
> Source: [emissary-ingress/emissary](https://github.com/emissary-ingress/emissary) — distributed by [TomeVault](https://tomevault.io).
