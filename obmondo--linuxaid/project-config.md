---
trigger: always_on
description: Guidance for agentic coding tools working in this LinuxAid repository.
---
...
---
> Source: [Obmondo/LinuxAid](https://github.com/Obmondo/LinuxAid) — distributed by [TomeVault](https://tomevault.io).
