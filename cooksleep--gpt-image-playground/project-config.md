---
trigger: always_on
description: 本文件定义 AI 编码助手在此仓库中应遵循的工作方式。
---
...
---
> Source: [CookSleep/gpt_image_playground](https://github.com/CookSleep/gpt_image_playground) — distributed by [TomeVault](https://tomevault.io).
