---
trigger: always_on
description: Icon rendering for Django, by [Zostera](https://github.com/zostera). Define icons in settings, render via template tags. Supports Font Awesome, Material, Bootstrap 3, images, and custom renderers.
---
...
---
> Source: [zostera/django-icons](https://github.com/zostera/django-icons) — distributed by [TomeVault](https://tomevault.io).
