---
trigger: always_on
description: This repository contains **GSAP (GreenSock Animation Platform) skills** for AI coding agents. When editing or adding skills, follow these rules.
---
...
---
> Source: [JYP-jjbb/code-intel-analysis-platform](https://github.com/JYP-jjbb/code-intel-analysis-platform) — distributed by [TomeVault](https://tomevault.io).
