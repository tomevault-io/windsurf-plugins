---
trigger: always_on
description: lang-detect is a fast, lightweight language detection library using tiered script detection and
---

lang-detect is a fast, lightweight language detection library using tiered script detection and
neural networks, built with TypeScript.
...
---
> Source: [oomfware/lang-detect](https://github.com/oomfware/lang-detect) — distributed by [TomeVault](https://tomevault.io).
