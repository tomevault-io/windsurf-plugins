---
trigger: always_on
description: Guidance for working in this repo (Angular Spotify — an Nx monorepo Spotify clone).
---
...
---
> Source: [trungvose/angular-spotify](https://github.com/trungvose/angular-spotify) — distributed by [TomeVault](https://tomevault.io).
