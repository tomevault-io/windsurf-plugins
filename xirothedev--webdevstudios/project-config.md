---
trigger: always_on
description: - Use Tailwind utility classes for consistent styling, with custom CSS only for special cases
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/xirothedev)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/xirothedev)
