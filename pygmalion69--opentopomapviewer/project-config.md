---
trigger: always_on
description: OpenTopoMapViewer is an Android application for viewing OpenTopoMap with features like location tracking, GPX import, and hiking/cycling routes. The app is available in two flavors: a Google Play version (with ads) and a FOSS version (no ads).
---
...
---
> Source: [Pygmalion69/OpenTopoMapViewer](https://github.com/Pygmalion69/OpenTopoMapViewer) — distributed by [TomeVault](https://tomevault.io).
