---
trigger: always_on
description: Moltbot runs a single embedded agent runtime derived from **p-mono**.
---
...
---
> Source: [ComposioHQ/openclaw-composio](https://github.com/ComposioHQ/openclaw-composio) — distributed by [TomeVault](https://tomevault.io).
