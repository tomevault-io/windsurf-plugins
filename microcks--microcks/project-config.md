---
trigger: always_on
description: **You MUST run `mvn spotless:apply` from the repository root before every commit that touches Java files.** This is not optional — CI will fail if any file has a formatting violation.
---
...
---
> Source: [microcks/microcks](https://github.com/microcks/microcks) — distributed by [TomeVault](https://tomevault.io).
