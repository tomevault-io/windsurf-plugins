---
trigger: always_on
description: - 必须实现 `IIntegrationEventConverter<TDomainEvent, TIntegrationEvent>` 接口。
---
...
---
> Source: [netcorepal/netcorepal-cloud-template](https://github.com/netcorepal/netcorepal-cloud-template) — distributed by [TomeVault](https://tomevault.io).
