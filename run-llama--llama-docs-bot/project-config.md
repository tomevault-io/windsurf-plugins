---
trigger: always_on
description: An "agent" is an automated reasoning and decision engine. It takes in a user input/query and can make internal decisions for executing
---
...
---
> Source: [run-llama/llama_docs_bot](https://github.com/run-llama/llama_docs_bot) — distributed by [TomeVault](https://tomevault.io).
