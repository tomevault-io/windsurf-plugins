---
trigger: always_on
description: DeepSeek Harness 的插件集 monorepo（npm 分发）。每个插件都是独立的 cordis bundle
---
...
---
> Source: [wingsky-1/dsh-plugin-hub](https://github.com/wingsky-1/dsh-plugin-hub) — distributed by [TomeVault](https://tomevault.io).
