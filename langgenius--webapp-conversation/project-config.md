---
trigger: always_on
description: - **App Router (Next.js 14)**: Entry is `app/layout.tsx` and `app/page.tsx`.
---
...
---
> Source: [langgenius/webapp-conversation](https://github.com/langgenius/webapp-conversation) — distributed by [TomeVault](https://tomevault.io).
