---
trigger: always_on
description: Project-local notes for Claude sessions. Kept short on purpose.
---
...
---
> Source: [valinorintelligence/Gridwolf](https://github.com/valinorintelligence/Gridwolf) — distributed by [TomeVault](https://tomevault.io).
