---
trigger: always_on
description: Unless user explicitly asks do not inspect reference or modify examples
---
...
---
> Source: [mastra-ai/mastra](https://github.com/mastra-ai/mastra) — distributed by [TomeVault](https://tomevault.io).
