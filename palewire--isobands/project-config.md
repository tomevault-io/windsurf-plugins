---
trigger: always_on
description: This repository is a template for an open-source Python package. It provides
---
...
---
> Source: [palewire/isobands](https://github.com/palewire/isobands) — distributed by [TomeVault](https://tomevault.io).
