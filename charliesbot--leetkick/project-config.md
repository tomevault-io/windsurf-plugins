---
trigger: always_on
description: A TypeScript CLI for scaffolding LeetCode exercises with language-specific testing setups. Fetches problems from LeetCode's GraphQL API and generates solution + test files using templates.
---
...
---
> Source: [charliesbot/leetkick](https://github.com/charliesbot/leetkick) — distributed by [TomeVault](https://tomevault.io).
