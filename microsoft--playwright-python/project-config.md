---
trigger: always_on
description: Guidance for Claude when working in this repository.
---
...
---
> Source: [microsoft/playwright-python](https://github.com/microsoft/playwright-python) — distributed by [TomeVault](https://tomevault.io).
