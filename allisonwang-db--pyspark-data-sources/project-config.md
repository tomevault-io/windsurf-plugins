---
trigger: always_on
description: This file provides context and guidelines for AI agents working on the `pyspark-data-sources` repository.
---
...
---
> Source: [allisonwang-db/pyspark-data-sources](https://github.com/allisonwang-db/pyspark-data-sources) — distributed by [TomeVault](https://tomevault.io).
