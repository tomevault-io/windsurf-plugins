---
trigger: always_on
description: > Also read [ARCHITECTURE.md](ARCHITECTURE.md) for design decisions, [CONTRIBUTING.md](CONTRIBUTING.md) for PR workflow, [OWNERS](OWNERS) for reviewers/approvers.
---
...
---
> Source: [openshift/service-ca-operator](https://github.com/openshift/service-ca-operator) — distributed by [TomeVault](https://tomevault.io).
