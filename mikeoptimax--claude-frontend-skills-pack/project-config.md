---
trigger: always_on
description: Drop this file in your project root. Claude Code reads it automatically.
---
...
---
> Source: [mikeoptimax/claude-frontend-skills-pack](https://github.com/mikeoptimax/claude-frontend-skills-pack) — distributed by [TomeVault](https://tomevault.io).
