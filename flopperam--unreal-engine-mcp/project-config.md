...
#### Method 1: Using spawn_physics_blueprint_actor  (Recommended for all shapes)
```python
...
---
> Source: [flopperam/unreal-engine-mcp](https://github.com/flopperam/unreal-engine-mcp) — distributed by [TomeVault](https://tomevault.io).
