---
trigger: always_on
description: MNS v1 官方 Go SDK,封装 smq proxy HTTP 数据面 API(队列收发消息、主题发布订阅等),供外部客户使用。
---
...
8. **发布约束**:修改 `version.go` 的 `Version` 常量时,必须同步在 `CHANGELOG.md` 顶部追加与之一致的版本条目,并更新本文件「项目概览」表格的**版本**单元格。完整发布流程见 [`docs/deployment.md`](docs/deployment.md)
...
---
> Source: [aliyun/aliyun-mns-go-sdk](https://github.com/aliyun/aliyun-mns-go-sdk) — distributed by [TomeVault](https://tomevault.io).
