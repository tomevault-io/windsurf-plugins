---
trigger: always_on
description: - I’m using Aube to manage packages and Node to run scripts.
---
...
---
> Source: [yippee-fun/morphlex](https://github.com/yippee-fun/morphlex) — distributed by [TomeVault](https://tomevault.io).
