---
trigger: always_on
description: - `lib/` holds all production Dart source, including `src/` helpers and the public API surface exported by `flex_seed_scheme.dart`.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/rydmike)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/rydmike)
