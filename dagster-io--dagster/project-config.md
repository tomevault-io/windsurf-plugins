---
trigger: always_on
description: - **Package Locations**: [.claude/python_packages.md](./.claude/python_packages.md) - Comprehensive list of all Python packages and their filesystem paths. **ALWAYS check this file first when looking for package locations.**
---
...
---
> Source: [dagster-io/dagster](https://github.com/dagster-io/dagster) — distributed by [TomeVault](https://tomevault.io).
