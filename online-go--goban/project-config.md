---
trigger: always_on
description: Goban is a TypeScript library for Go (Weiqi/Baduk) game visualization and interaction, used by Online-Go.com. The library provides both browser and Node.js compatibility through separate builds.
---
...
---
> Source: [online-go/goban](https://github.com/online-go/goban) — distributed by [TomeVault](https://tomevault.io).
