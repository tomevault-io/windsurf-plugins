---
trigger: always_on
description: make build              # → build/coraza-waf.so  (buildmode=c-shared)
---
...
---
> Source: [united-security-providers/coraza-envoy-go-filter](https://github.com/united-security-providers/coraza-envoy-go-filter) — distributed by [TomeVault](https://tomevault.io).
