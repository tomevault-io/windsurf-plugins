---
trigger: always_on
description: Before ANY package install, update, or removal in this repo, run the
---
...
---
> Source: [tommulkins/hermes-plugin-session-analyzer](https://github.com/tommulkins/hermes-plugin-session-analyzer) — distributed by [TomeVault](https://tomevault.io).
