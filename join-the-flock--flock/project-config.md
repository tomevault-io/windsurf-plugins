---
trigger: always_on
description: A tool run during ci to collect and verify source code's licenses.
---
...
---
> Source: [join-the-flock/flock](https://github.com/join-the-flock/flock) — distributed by [TomeVault](https://tomevault.io).
