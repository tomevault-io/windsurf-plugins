---
trigger: always_on
description: ESPP (Espressif++) is a C++ component library for ESP32/ESP-IDF. It targets ESP-IDF v5.5.1+ and provides ~120 reusable components published to the [ESP Component Registry](https://components.espressif.com) under the `espp` namespace.
---
...
---
> Source: [esp-cpp/espp](https://github.com/esp-cpp/espp) — distributed by [TomeVault](https://tomevault.io).
