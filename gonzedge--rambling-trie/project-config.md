---
trigger: always_on
description: `rambling-trie` is a Ruby gem implementing a compressed trie data structure. The main entry point
---
...
---
> Source: [gonzedge/rambling-trie](https://github.com/gonzedge/rambling-trie) — distributed by [TomeVault](https://tomevault.io).
