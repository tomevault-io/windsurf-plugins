---
trigger: always_on
description: Microsoft Olive is a Python-based AI model optimization toolkit for the ONNX Runtime. It provides 40+ built-in optimization components for model compression, optimization, fine-tuning, and compilation.
---
...
---
> Source: [microsoft/Olive](https://github.com/microsoft/Olive) — distributed by [TomeVault](https://tomevault.io).
