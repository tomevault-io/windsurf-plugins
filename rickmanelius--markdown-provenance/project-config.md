---
trigger: always_on
description: A Claude Code plugin that provides the `/markdown-provenance` slash command for uploading markdown files to Arweave permanent storage.
---
...
---
> Source: [rickmanelius/markdown-provenance](https://github.com/rickmanelius/markdown-provenance) — distributed by [TomeVault](https://tomevault.io).
