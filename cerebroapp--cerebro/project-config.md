---
trigger: always_on
description: - Do install dependencies with `yarn` (classic Yarn v1) after checkout so postinstall scripts set up Electron and Husky hooks correctly.
---
...
---
> Source: [cerebroapp/cerebro](https://github.com/cerebroapp/cerebro) — distributed by [TomeVault](https://tomevault.io).
