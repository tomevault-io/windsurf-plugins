---
trigger: always_on
description: `openwisp-users` is the OpenWISP Django app that provides user management, organizations, groups, authentication helpers, and multi-tenancy utilities.
---
...
---
> Source: [openwisp/openwisp-users](https://github.com/openwisp/openwisp-users) — distributed by [TomeVault](https://tomevault.io).
