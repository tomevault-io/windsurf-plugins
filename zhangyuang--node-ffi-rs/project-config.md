---
trigger: always_on
description: High-performance FFI module for Node.js, written in Rust + N-API. Allows JS/TS to call C/C++ dynamic libraries (.so/.dylib/.dll) without writing native binding code.
---
...
---
> Source: [zhangyuang/node-ffi-rs](https://github.com/zhangyuang/node-ffi-rs) — distributed by [TomeVault](https://tomevault.io).
