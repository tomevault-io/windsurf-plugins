---
trigger: always_on
description: - 本目录是MarginNote插件开发项目,运行环境与前端/Node不同,不要按浏览器假设做实现。
---
...
---
> Source: [Temsys-Shen/zotero-marginnote](https://github.com/Temsys-Shen/zotero-marginnote) — distributed by [TomeVault](https://tomevault.io).
