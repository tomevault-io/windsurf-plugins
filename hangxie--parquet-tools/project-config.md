---
trigger: always_on
description: This document defines expectations for contributors
---
...
---
> Source: [hangxie/parquet-tools](https://github.com/hangxie/parquet-tools) — distributed by [TomeVault](https://tomevault.io).
