---
trigger: always_on
description: This is a Java 8 Maven multi-module Elasticsearch ORM. The root `pom.xml` coordinates:
---
...
---
> Source: [ymm-tech/ebatis](https://github.com/ymm-tech/ebatis) — distributed by [TomeVault](https://tomevault.io).
