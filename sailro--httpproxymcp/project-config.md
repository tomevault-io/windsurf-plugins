---
trigger: always_on
description: An HTTP/HTTPS MITM proxy with full traffic capture, exposed as an MCP server so LLMs can inspect, filter, and analyze network traffic. Built with .NET 10, C#, SQLite (Dapper), and the Model Context Protocol.
---
