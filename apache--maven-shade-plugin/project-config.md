...
# Agent Guide for maven-shade-plugin
...
---
> Source: [apache/maven-shade-plugin](https://github.com/apache/maven-shade-plugin) — distributed by [TomeVault](https://tomevault.io).
