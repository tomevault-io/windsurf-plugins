---
trigger: always_on
description: This guide is for AI coding agents working in the SvelteKit monorepo.
---
...
---
> Source: [sveltejs/kit](https://github.com/sveltejs/kit) — distributed by [TomeVault](https://tomevault.io).
