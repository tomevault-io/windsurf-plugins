---
trigger: always_on
description: This repository implements the experimental `io.containerd.systemd.v1`
---
...
---
> Source: [cpuguy83/containerd-shim-systemd-v1](https://github.com/cpuguy83/containerd-shim-systemd-v1) — distributed by [TomeVault](https://tomevault.io).
