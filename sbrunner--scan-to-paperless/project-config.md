---
trigger: always_on
description: The project should fully be in async mode.
---
...
---
> Source: [sbrunner/scan-to-paperless](https://github.com/sbrunner/scan-to-paperless) — distributed by [TomeVault](https://tomevault.io).
