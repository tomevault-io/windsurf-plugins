---
trigger: always_on
description: Astro Minimal is an open source blog template designed and developed using **Astro** and the **Bulma CSS framework**. This project was created by DomeT99 (Domenico Tenace) as a standard, reusable foundation for blog websites with a focus on simplicity and minimalism.
---
...
---
> Source: [Domenico-Tenace-Open-Labs/astro-minimal](https://github.com/Domenico-Tenace-Open-Labs/astro-minimal) — distributed by [TomeVault](https://tomevault.io).
