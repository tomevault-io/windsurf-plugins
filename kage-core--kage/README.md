...
Original source: `AGENTS.md` in [kage-core/Kage](https://github.com/kage-core/Kage).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/kage-core/Kage](https://github.com/kage-core/Kage)
