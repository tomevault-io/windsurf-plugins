---
trigger: always_on
description: - Read and follow [`.agents/AGENTS.md`](.agents/AGENTS.md) before reviewing or modifying this repository. Its architecture, code-generation, layout, DTO, and communication rules remain authoritative.
---
...
---
> Source: [unraous/uxuescript](https://github.com/unraous/uxuescript) — distributed by [TomeVault](https://tomevault.io).
