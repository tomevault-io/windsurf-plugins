---
trigger: always_on
description: - Always run `pnpm format` after making code changes, then commit the result. Formatting is Prettier across the repo (`**/*.{ts,tsx,js,mjs,cjs,json,md}`); committing the formatted output keeps CI green.
---
...
---
> Source: [what-works-global/payload-packages](https://github.com/what-works-global/payload-packages) — distributed by [TomeVault](https://tomevault.io).
