---
trigger: always_on
description: - `src/main/java` and `src/main/resources` contain the Jenkins plugin source and resources.
---
...
---
> Source: [jenkinsci/dingtalk-plugin](https://github.com/jenkinsci/dingtalk-plugin) — distributed by [TomeVault](https://tomevault.io).
