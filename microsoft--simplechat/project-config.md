---
trigger: always_on
description: Always maintain relevance to the repository in which you are working. Do not provide generic or unrelated information unless specifically requested by the user.
---
...
---
> Source: [microsoft/simplechat](https://github.com/microsoft/simplechat) — distributed by [TomeVault](https://tomevault.io).
