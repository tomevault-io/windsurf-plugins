---
trigger: always_on
description: QuantEcon.py is a high-performance, open-source Python library for quantitative economics. The library provides tools for economics research including Markov chains, dynamic programming, game theory, quadrature, and optimization algorithms.
---
...
---
> Source: [QuantEcon/QuantEcon.py](https://github.com/QuantEcon/QuantEcon.py) — distributed by [TomeVault](https://tomevault.io).
