---
trigger: always_on
description: **Never add `Co-Authored-By:` trailers crediting any AI tool to a git commit.**
---
...
---
> Source: [sonus21/rqueue](https://github.com/sonus21/rqueue) — distributed by [TomeVault](https://tomevault.io).
