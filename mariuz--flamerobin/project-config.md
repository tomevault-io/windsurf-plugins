---
trigger: always_on
description: FlameRobin is a C++20/wxWidgets GUI administration tool for Firebird DBMS.
---
...
---
> Source: [mariuz/flamerobin](https://github.com/mariuz/flamerobin) — distributed by [TomeVault](https://tomevault.io).
