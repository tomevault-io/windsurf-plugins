---
trigger: always_on
description: **Obsidian S3 Sync + Backup** — An Obsidian community plugin that provides bi-directional vault synchronization and scheduled backups for S3-compatible storage (AWS S3, Cloudflare R2, Backblaze B2, RustFS) with optional end-to-end encryption.
---
