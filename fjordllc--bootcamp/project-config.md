---
trigger: always_on
description: - `app/` Rails app code: `models/`, `controllers/`, `views/`, `jobs/`, `helpers/`, and frontend under `javascript/` (Shakapacker).
---
...
---
> Source: [fjordllc/bootcamp](https://github.com/fjordllc/bootcamp) — distributed by [TomeVault](https://tomevault.io).
