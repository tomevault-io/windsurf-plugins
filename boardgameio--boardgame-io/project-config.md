---
trigger: always_on
description: This file provides guidance to coding agents (e.g. Claude Code) working in this repository.
---
...
---
> Source: [boardgameio/boardgame.io](https://github.com/boardgameio/boardgame.io) — distributed by [TomeVault](https://tomevault.io).
