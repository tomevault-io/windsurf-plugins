---
trigger: always_on
description: Extensão VS Code para desenvolvimento ADVPL/4GL/TLPP (TOTVS Protheus).
---
...
---
> Source: [totvs/advpl-vscode](https://github.com/totvs/advpl-vscode) — distributed by [TomeVault](https://tomevault.io).
