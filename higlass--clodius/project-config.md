---
trigger: always_on
description: A Python library and CLI tool for aggregating large genomic datasets into tile-based formats for display at multiple resolutions (used by [HiGlass](https://higlass.io)).
---
...
---
> Source: [higlass/clodius](https://github.com/higlass/clodius) — distributed by [TomeVault](https://tomevault.io).
