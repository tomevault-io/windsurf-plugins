---
trigger: always_on
description: All `/research-system/*` pages are thin wrappers around
---
...
---
> Source: [zacharymays-cpu/zacharymays-site](https://github.com/zacharymays-cpu/zacharymays-site) — distributed by [TomeVault](https://tomevault.io).
