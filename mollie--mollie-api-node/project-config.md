---
trigger: always_on
description: Official Node.js client (`@mollie/api-client`) for the Mollie Payment API v2.
---
...
---
> Source: [mollie/mollie-api-node](https://github.com/mollie/mollie-api-node) — distributed by [TomeVault](https://tomevault.io).
