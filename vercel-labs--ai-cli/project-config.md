---
trigger: always_on
description: This is a Turborepo monorepo. The CLI application lives in `packages/ai-cli/` and shared configuration packages live in `packages/`.
---
...
---
> Source: [vercel-labs/ai-cli](https://github.com/vercel-labs/ai-cli) — distributed by [TomeVault](https://tomevault.io).
