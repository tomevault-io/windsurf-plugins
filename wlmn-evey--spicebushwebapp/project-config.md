---
trigger: always_on
description: - `app/`: Astro site, with pages in `app/src/pages/`, components in `app/src/components/`, shared utilities under `app/src/lib/`, and tests in `app/tests/` or near code.
---
...
---
> Source: [wlmn-evey/SpicebushWebapp](https://github.com/wlmn-evey/SpicebushWebapp) — distributed by [TomeVault](https://tomevault.io).
