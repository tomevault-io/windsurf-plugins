---
trigger: always_on
description: Cryptographically verifiable code review system for the Rust/Cargo ecosystem.
---
...
---
> Source: [crev-dev/cargo-crev](https://github.com/crev-dev/cargo-crev) — distributed by [TomeVault](https://tomevault.io).
