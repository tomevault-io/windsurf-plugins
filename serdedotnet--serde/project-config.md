---
trigger: always_on
description: Serde.NET is a serialization/deserialization framework for .NET, inspired by Rust's serde.rs. It uses source generators to produce serialize/deserialize implementations at compile time.
---
...
---
> Source: [serdedotnet/serde](https://github.com/serdedotnet/serde) — distributed by [TomeVault](https://tomevault.io).
