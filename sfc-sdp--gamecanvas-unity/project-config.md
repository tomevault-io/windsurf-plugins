---
trigger: always_on
description: 慶應SFC「スマートデバイスプログラミング」講座向け教育用2Dゲームフレームワーク (Unity)
---
...
---
> Source: [sfc-sdp/GameCanvas-Unity](https://github.com/sfc-sdp/GameCanvas-Unity) — distributed by [TomeVault](https://tomevault.io).
