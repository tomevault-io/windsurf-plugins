---
trigger: always_on
description: This is a WordPress plugin being developed within a Lando-based local development environment. The plugin directory (`wp-content/plugins/image-scraper/`) is currently empty and ready for development.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/welbinator)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/welbinator)
