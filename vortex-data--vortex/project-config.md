---
trigger: always_on
description: Guidance for Claude, Codex and other coding agents working in the Vortex repository.
---
...
---
> Source: [vortex-data/vortex](https://github.com/vortex-data/vortex) — distributed by [TomeVault](https://tomevault.io).
