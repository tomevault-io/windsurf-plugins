---
trigger: always_on
description: Welcome to `xalpha`. This document defines the operational rules for AI agents and contributors.
---
...
---
> Source: [refraction-ray/xalpha](https://github.com/refraction-ray/xalpha) — distributed by [TomeVault](https://tomevault.io).
