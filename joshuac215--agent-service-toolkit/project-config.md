---
trigger: always_on
description: - Default to no comments in code you add or edit.
---
...
---
> Source: [JoshuaC215/agent-service-toolkit](https://github.com/JoshuaC215/agent-service-toolkit) — distributed by [TomeVault](https://tomevault.io).
