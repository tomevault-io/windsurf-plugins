---
trigger: always_on
description: A Spring Boot application with 24 intentional memory leak examples for training purposes. Each leak demonstrates a real-world pattern.
---
...
---
> Source: [victorrentea/java-memory](https://github.com/victorrentea/java-memory) — distributed by [TomeVault](https://tomevault.io).
