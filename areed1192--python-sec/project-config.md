---
trigger: always_on
description: Every new feature, model, or public method **must** have unit tests before the work is considered complete.
---
...
---
> Source: [areed1192/python-sec](https://github.com/areed1192/python-sec) — distributed by [TomeVault](https://tomevault.io).
