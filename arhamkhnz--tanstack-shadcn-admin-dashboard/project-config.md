---
trigger: always_on
description: Studio Admin is a responsive admin dashboard built with TanStack Start, React 19, TypeScript, Tailwind CSS v4, and shadcn/ui.
---
...
---
> Source: [arhamkhnz/tanstack-shadcn-admin-dashboard](https://github.com/arhamkhnz/tanstack-shadcn-admin-dashboard) — distributed by [TomeVault](https://tomevault.io).
