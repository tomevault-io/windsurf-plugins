---
trigger: always_on
description: Provides various utilities such as concurrency primitives and JSON serialization. Technically not a library, but a collection of private headers and source files that are compiled with both `libbson` and `libmongoc`.
---
...
---
> Source: [mongodb/mongo-c-driver](https://github.com/mongodb/mongo-c-driver) — distributed by [TomeVault](https://tomevault.io).
