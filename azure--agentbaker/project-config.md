---
trigger: always_on
description: AgentBaker repo has 2 main services discussed below:
---
...
---
> Source: [Azure/AgentBaker](https://github.com/Azure/AgentBaker) — distributed by [TomeVault](https://tomevault.io).
