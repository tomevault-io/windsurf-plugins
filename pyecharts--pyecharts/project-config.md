---
trigger: always_on
description: This file contains guidelines for agents working on the pyecharts project.
---
...
---
> Source: [pyecharts/pyecharts](https://github.com/pyecharts/pyecharts) — distributed by [TomeVault](https://tomevault.io).
