---
trigger: always_on
description: Astro standalone Node server, deployed via `cubo` to Kubernetes on AWS. Three environments: `production`, `staging1`, `staging2`.
---
...
---
> Source: [datocms/astro-website](https://github.com/datocms/astro-website) — distributed by [TomeVault](https://tomevault.io).
