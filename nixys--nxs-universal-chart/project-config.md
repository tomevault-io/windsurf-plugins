---
trigger: always_on
description: This repository is the reference baseline for reusable Helm application charts that keep:
---
...
---
> Source: [nixys/nxs-universal-chart](https://github.com/nixys/nxs-universal-chart) — distributed by [TomeVault](https://tomevault.io).
