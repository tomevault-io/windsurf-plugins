---
trigger: always_on
description: Alfa is an accessibility conformance testing engine (110+ rules, 80+ TypeScript packages in a monorepo). See [docs/development.md](../docs/development.md) for commands, architecture, and conventions. See [agents.md](../agents.md) for behavioral guidelines that apply to all agents.
---
...
---
> Source: [Siteimprove/alfa](https://github.com/Siteimprove/alfa) — distributed by [TomeVault](https://tomevault.io).
