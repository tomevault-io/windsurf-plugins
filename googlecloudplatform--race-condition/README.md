...
> Tome by [GoogleCloudPlatform](https://github.com/GoogleCloudPlatform/race-condition) — distributed by [TomeVault](https://tomevault.io)
...
Original source: `.cursor/rules/*.mdc` in [GoogleCloudPlatform/race-condition](https://github.com/GoogleCloudPlatform/race-condition).
