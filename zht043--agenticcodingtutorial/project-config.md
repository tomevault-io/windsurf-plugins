---
trigger: always_on
description: 本文件定义本仓库内 Agent 的默认工作约束。
---
...
---
> Source: [zht043/AgenticCodingTutorial](https://github.com/zht043/AgenticCodingTutorial) — distributed by [TomeVault](https://tomevault.io).
