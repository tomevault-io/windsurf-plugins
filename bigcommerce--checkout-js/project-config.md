---
trigger: always_on
description: **Always use named exports. Never add new default exports.**
---
...
---
> Source: [bigcommerce/checkout-js](https://github.com/bigcommerce/checkout-js) — distributed by [TomeVault](https://tomevault.io).
