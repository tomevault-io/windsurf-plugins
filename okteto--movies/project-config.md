---
trigger: always_on
description: Microservices-based Movies rental application demonstrating Okteto development on Kubernetes. Deployed via Helm charts. The agent can deploy all services with a single `okteto deploy`, then help the user debug any individual service.
---
...
---
> Source: [okteto/movies](https://github.com/okteto/movies) — distributed by [TomeVault](https://tomevault.io).
