---
trigger: always_on
description: This file is a thin entrypoint for Codex. The authoritative, vendor-neutral protocol lives in `_system/`.
---
...
---
> Source: [yinkalario/Knowledge-Wiki](https://github.com/yinkalario/Knowledge-Wiki) — distributed by [TomeVault](https://tomevault.io).
