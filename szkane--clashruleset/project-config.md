---
trigger: always_on
description: ClashRuleSet is a curated collection of domain/IP filtering rules for **Clash** (network proxy tool). It provides specialized traffic splitting for AI services, ByteDance apps, Web3, education, and developer tools, plus standard streaming/gaming services.
---
...
---
> Source: [szkane/ClashRuleSet](https://github.com/szkane/ClashRuleSet) — distributed by [TomeVault](https://tomevault.io).
