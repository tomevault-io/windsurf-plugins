---
trigger: always_on
description: **项目状态**: Agent系统Phase 0-5已完成 → 进行"动态化视频"增强 (D系列)
---
...
---
> Source: [zhangzhanglaila/offline-short-video-agent](https://github.com/zhangzhanglaila/offline-short-video-agent) — distributed by [TomeVault](https://tomevault.io).
