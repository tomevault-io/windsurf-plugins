---
trigger: always_on
description: > Canonical reference for the **React Native CLI** integration. This sample is what `docs/playbooks/integration/react-native-cli.md` and the iOS CI workflow point at.
---
