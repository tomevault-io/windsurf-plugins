---
trigger: always_on
description: 1.  **Domain Knowledge Capture:** When working on a feature or complex task, capture significant domain knowledge (design decisions, tricky implementation details, rationales, API usage notes, error handling strategies, configuration details) that isn't obvious from the code itself.
---
