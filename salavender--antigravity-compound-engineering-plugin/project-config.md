---
trigger: always_on
description: This project implements the Compound Learning System for {PROJECT_NAME} - a self-improving knowledge system based on the "Compounding Engineering" philosophy.
---
...
---
> Source: [salavender/antigravity-compound-engineering-plugin](https://github.com/salavender/antigravity-compound-engineering-plugin) — distributed by [TomeVault](https://tomevault.io).
