---
trigger: always_on
description: - **Test**: `npm test` or `npm run test`
---
...
---
> Source: [semantic-release/gitlab](https://github.com/semantic-release/gitlab) — distributed by [TomeVault](https://tomevault.io).
