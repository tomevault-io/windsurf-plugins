---
trigger: always_on
description: Read `CLAUDE.md` first. This file defines how you execute, not what the project is.
---
...
---
> Source: [verda-cloud/verda-cli](https://github.com/verda-cloud/verda-cli) — distributed by [TomeVault](https://tomevault.io).
