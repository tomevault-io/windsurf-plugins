---
trigger: always_on
description: This file provides guidance to Claude Code (claude.ai/code) and other AI coding agents when working with code in this repository.
---
...
---
> Source: [rezathepure/claude-code-scenes](https://github.com/rezathepure/claude-code-scenes) — distributed by [TomeVault](https://tomevault.io).
