---
trigger: always_on
description: Read `CONTRIBUTING.md` first. Treat `pyproject.toml` and `tox.ini` as the
---
...
---
> Source: [falconry/falcon](https://github.com/falconry/falcon) — distributed by [TomeVault](https://tomevault.io).
