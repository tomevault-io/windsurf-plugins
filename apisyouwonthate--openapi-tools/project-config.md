---
trigger: always_on
description: PostHog is already integrated into this Astro project. The configuration includes:
---
...
---
> Source: [apisyouwonthate/openapi.tools](https://github.com/apisyouwonthate/openapi.tools) — distributed by [TomeVault](https://tomevault.io).
