---
trigger: always_on
description: Aster is a Tauri (Rust shell) + React desktop application with a Go Kubernetes sidecar.
---
...
---
> Source: [zjy365/aster](https://github.com/zjy365/aster) — distributed by [TomeVault](https://tomevault.io).
