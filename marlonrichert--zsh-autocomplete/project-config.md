---
trigger: always_on
description: This file provides guidance for AI coding agents (GitHub Copilot, Claude, etc.) working on this repository.
---
...
---
> Source: [marlonrichert/zsh-autocomplete](https://github.com/marlonrichert/zsh-autocomplete) — distributed by [TomeVault](https://tomevault.io).
