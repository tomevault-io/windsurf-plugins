---
trigger: always_on
description: This document summarizes the project context and the conventions that language models must follow when helping on this repository.
---
...
---
> Source: [avelino/awesome-go](https://github.com/avelino/awesome-go) — distributed by [TomeVault](https://tomevault.io).
