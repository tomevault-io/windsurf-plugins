---
trigger: always_on
description: > Published npm package (`@willianpinho/large-file-mcp`) providing MCP tools for reading, searching, and navigating large files that exceed LLM context limits.
---
