---
trigger: always_on
description: See [README.md](README.md) for why this repository exists, who or what uses it, and its responsibility boundary.
---
...
---
> Source: [elastic/homebrew-tap](https://github.com/elastic/homebrew-tap) — distributed by [TomeVault](https://tomevault.io).
