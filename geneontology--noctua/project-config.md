---
trigger: always_on
description: Gene Ontology CAM (Causal Activity Model) editor — a web-based curation
---
...
---
> Source: [geneontology/noctua](https://github.com/geneontology/noctua) — distributed by [TomeVault](https://tomevault.io).
