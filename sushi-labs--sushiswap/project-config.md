---
trigger: always_on
description: React + Tailwind. Components are imported from the bundle; you write layout glue with
---
...
---
> Source: [sushi-labs/sushiswap](https://github.com/sushi-labs/sushiswap) — distributed by [TomeVault](https://tomevault.io).
