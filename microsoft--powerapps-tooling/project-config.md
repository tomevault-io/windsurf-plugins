---
trigger: always_on
description: This is a .NET SDK project (SDK 10.0, pinned in `global.json`). The solution is `src/PASopa.sln`.
---
...
---
> Source: [microsoft/PowerApps-Tooling](https://github.com/microsoft/PowerApps-Tooling) — distributed by [TomeVault](https://tomevault.io).
