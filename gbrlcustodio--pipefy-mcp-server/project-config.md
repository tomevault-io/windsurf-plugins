---
trigger: always_on
description: - **`README.md`** — Project pitch, install commands (pre-launch git + post-v1.0 PyPI), repo layout, MCP tools table, skills section, contributing.
---
...
---
> Source: [gbrlcustodio/pipefy-mcp-server](https://github.com/gbrlcustodio/pipefy-mcp-server) — distributed by [TomeVault](https://tomevault.io).
