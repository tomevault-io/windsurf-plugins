---
trigger: always_on
description: Guidance for Claude Code agents working in this repo.
---
...
---
> Source: [linkedin/Hoptimator](https://github.com/linkedin/Hoptimator) — distributed by [TomeVault](https://tomevault.io).
