---
trigger: always_on
description: transforms, algorithms) into the `_core` module defined in `src/module.cpp`.
---
...
---
> Source: [scikit-hep/boost-histogram](https://github.com/scikit-hep/boost-histogram) — distributed by [TomeVault](https://tomevault.io).
