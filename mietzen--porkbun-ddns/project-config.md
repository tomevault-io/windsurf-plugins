---
trigger: always_on
description: porkbun-ddns is an unofficial DDNS client for Porkbun domains. Distributed as both a pip package (`porkbun-ddns` on PyPI) and a Docker image (`porkbun-ddns` on Docker Hub). Sets/updates A (IPv4) and AAAA (IPv6) DNS records, only updating when IPs change.
---
...
---
> Source: [mietzen/porkbun-ddns](https://github.com/mietzen/porkbun-ddns) — distributed by [TomeVault](https://tomevault.io).
