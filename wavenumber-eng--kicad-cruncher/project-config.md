---
trigger: always_on
description: `kicad-cruncher` is the public command-line workflow package built on the
---
...
---
> Source: [wavenumber-eng/kicad_cruncher](https://github.com/wavenumber-eng/kicad_cruncher) — distributed by [TomeVault](https://tomevault.io).
