---
trigger: always_on
description: > General instructions and guidelines for automatic code agents like Github Copilot for interpreting
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/kadijairus)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/kadijairus)
