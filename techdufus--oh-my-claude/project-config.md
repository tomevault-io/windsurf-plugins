---
trigger: always_on
description: Claude Code plugin providing ultrawork mode, context protection, and specialized agent workflows.
---
...
---
> Source: [TechDufus/oh-my-claude](https://github.com/TechDufus/oh-my-claude) — distributed by [TomeVault](https://tomevault.io).
