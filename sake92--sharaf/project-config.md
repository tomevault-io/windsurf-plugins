---
trigger: always_on
description: This project uses **deder**, not sbt or mill. Config lives in `deder.pkl` (Pkl-based DSL).
---
...
---
> Source: [sake92/sharaf](https://github.com/sake92/sharaf) — distributed by [TomeVault](https://tomevault.io).
