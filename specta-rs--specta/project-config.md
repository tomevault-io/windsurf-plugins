---
trigger: always_on
description: Specta is a Rust library for easily exporting Rust types to other languages (TypeScript, Swift, Rust, OpenAPI, etc.). It's a workspace with multiple crates:
---
...
---
> Source: [specta-rs/specta](https://github.com/specta-rs/specta) — distributed by [TomeVault](https://tomevault.io).
