---
trigger: always_on
description: This package is the Edition Ghost theme. In the standalone mirror repository, this tree is pushed from `TryGhost/Themes/packages/edition` by subtree sync; make durable theme-content changes in `TryGhost/Themes` unless the task is explicitly repo-level metadata or GitHub settings.
---
...
---
> Source: [TryGhost/Edition](https://github.com/TryGhost/Edition) — distributed by [TomeVault](https://tomevault.io).
