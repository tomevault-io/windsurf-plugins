---
trigger: always_on
description: The users cookbook manages operating system users and groups with Chef Infra's built-in `user`,
---
...
---
> Source: [sous-chefs/users](https://github.com/sous-chefs/users) — distributed by [TomeVault](https://tomevault.io).
