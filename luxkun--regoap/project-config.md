---
trigger: always_on
description: This file gives AI coding agents guidance for the Godot subtree.
---
...
---
> Source: [luxkun/ReGoap](https://github.com/luxkun/ReGoap) — distributed by [TomeVault](https://tomevault.io).
