...
> Tome by [thepartly](https://github.com/thepartly/gatehouse) — distributed by [TomeVault](https://tomevault.io)
...
From [thepartly/gatehouse](https://github.com/thepartly/gatehouse) — a repo with 339+ stars on GitHub.
