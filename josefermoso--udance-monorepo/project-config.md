---
trigger: always_on
description: > **TL;DR:** This guide outlines the archiving process for a completed Level 3 intermediate feature. The aim is to create a self-contained, easily accessible record of the feature's development lifecycle, including its planning, design decisions, implementation summary, and reflection.
---
...
1.  **Confirm Reflection Complete:** Verify in `memory-bank/active/tasks.md` that the reflection phase for this feature is marked as complete and `memory-bank/archive/reflection-[feature_id].md` exists and is finalized.
2.  **Gather All Feature-Specific Documents:**
    * The feature plan section from `memory-bank/active/tasks.md` (or a copy of it).
* All `memory-bank/creative/[aspect_name].md` documents related to this feature.
* The `memory-bank/archive/reflection-[feature_id].md` document.
* Key diagrams or architectural notes from `memory-bank/active/progress.md` if not captured elsewhere.
...
graph TD
    ...
    CreateArchiveFile["3. Create Feature Archive File<br>e.g., `memory-bank/archive/by-feature/feature-[FeatureNameOrID]_YYYYMMDD.md`"] -->
...
## 📝 Structure for `memory-bank/archive/by-feature/feature-[FeatureNameOrID]_YYYYMMDD.md`
  ...
  * **3. Design Decisions & Creative Outputs:**
      ...
      * Direct links to all relevant `memory-bank/creative/[aspect_name].md` documents.
* Link to `memory-bank/docs/style-guide.md` version used (if applicable).
  ...
  * **6. Reflection & Lessons Learned:**
      * Direct link to `memory-bank/archive/reflection-[feature_id].md`.
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/josefermoso) — claim your Tome and manage your conversions.
