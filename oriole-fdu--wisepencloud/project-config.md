---
trigger: always_on
description: 本文档是 `wisepen-cloud` 仓库的代理入口规则。开始任何代码改动前，先阅读本文件，并按任务类型继续阅读 `docs/agents/` 下的分体文档。
---
...
---
> Source: [Oriole-FDU/WisePenCloud](https://github.com/Oriole-FDU/WisePenCloud) — distributed by [TomeVault](https://tomevault.io).
