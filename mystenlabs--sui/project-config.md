---
trigger: always_on
description: When a sub-crate's CLAUDE.md conflicts with this file, the sub-crate's instructions win.
---
...
---
> Source: [MystenLabs/sui](https://github.com/MystenLabs/sui) — distributed by [TomeVault](https://tomevault.io).
