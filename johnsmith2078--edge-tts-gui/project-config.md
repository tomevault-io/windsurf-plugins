---
trigger: always_on
description: - `src/`: Qt (C++17) application source.
---
...
---
> Source: [johnsmith2078/edge-tts-gui](https://github.com/johnsmith2078/edge-tts-gui) — distributed by [TomeVault](https://tomevault.io).
