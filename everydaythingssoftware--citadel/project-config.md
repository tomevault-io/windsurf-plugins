---
trigger: always_on
description: enables `SQLITE_FCNTL_PERSIST_WAL` by default: `-wal`/`-shm` sidecars survive
---
...
---
> Source: [everydaythingssoftware/citadel](https://github.com/everydaythingssoftware/citadel) — distributed by [TomeVault](https://tomevault.io).
