---
trigger: always_on
description: - Read [CLAUDE.md](../CLAUDE.md) before changing the project. It captures the architecture, ports, and gotchas.
---
...
---
> Source: [xpsony/UmlautAdaptarrEX](https://github.com/xpsony/UmlautAdaptarrEX) — distributed by [TomeVault](https://tomevault.io).
