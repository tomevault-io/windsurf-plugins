---
trigger: always_on
description: - `src/`: Core library (e.g., `processor.js`, `transform.js`, `versions.js`, `v2/`, `v3/`, `calculator/`). Entry point: `src/index.js` (types in `types/`).
---
...
---
> Source: [samvera/node-iiif](https://github.com/samvera/node-iiif) — distributed by [TomeVault](https://tomevault.io).
