---
trigger: always_on
description: SGPT works with Google's Gemini models without any Gemini-specific code. Gemini is reachable over an OpenAI-compatible
---
...
---
> Source: [tbckr/sgpt](https://github.com/tbckr/sgpt) — distributed by [TomeVault](https://tomevault.io).
