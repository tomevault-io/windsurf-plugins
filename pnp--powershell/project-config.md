---
trigger: always_on
description: Repository guidance for this project lives in **[AGENTS.md](AGENTS.md)** — read it first. It is the
---
...
---
> Source: [pnp/powershell](https://github.com/pnp/powershell) — distributed by [TomeVault](https://tomevault.io).
