---
trigger: always_on
description: MatrixOne (MO) 是一个超融合数据库，采用存算分离架构（CN/TN/LogService/Proxy）。
---
...
---
> Source: [matrixorigin/matrixone](https://github.com/matrixorigin/matrixone) — distributed by [TomeVault](https://tomevault.io).
