---
trigger: always_on
description: Rules for AI coding agents (Claude Code, GitHub Copilot, Cursor, Codex, etc.) working on
---
...
---
> Source: [Consensys-Incorporated/doc.linea](https://github.com/Consensys-Incorporated/doc.linea) — distributed by [TomeVault](https://tomevault.io).
