---
trigger: always_on
description: - This branch launches the Tauri desktop shell by default (`apps/desktop-tauri/src-tauri`), while
---
...
---
> Source: [tsouth89/ceiling](https://github.com/tsouth89/ceiling) — distributed by [TomeVault](https://tomevault.io).
