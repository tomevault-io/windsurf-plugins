---
trigger: always_on
description: This repo IS a Claude Code plugin. Plugin users get `skills/genart/SKILL.md`
---
...
---
> Source: [camilleroux/genart-skill](https://github.com/camilleroux/genart-skill) — distributed by [TomeVault](https://tomevault.io).
