---
trigger: always_on
description: This is a TypeScript project that implements a frontend build tooling called Vite. Please follow these guidelines when contributing:
---
...
---
> Source: [vitejs/vite](https://github.com/vitejs/vite) — distributed by [TomeVault](https://tomevault.io).
