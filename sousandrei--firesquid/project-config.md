---
trigger: always_on
description: Firesquid is a Linux microVM manager built around Firecracker. The project is
---
...
---
> Source: [sousandrei/firesquid](https://github.com/sousandrei/firesquid) — distributed by [TomeVault](https://tomevault.io).
