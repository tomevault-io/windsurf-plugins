---
trigger: always_on
description: <!-- This file is automatically applied to all GitHub Copilot Chat requests in this workspace. -->
---
...
---
> Source: [xCDAT/xcdat](https://github.com/xCDAT/xcdat) — distributed by [TomeVault](https://tomevault.io).
