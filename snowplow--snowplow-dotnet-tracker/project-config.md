---
trigger: always_on
description: The Snowplow .NET Tracker is a comprehensive analytics library that enables event tracking in .NET applications. It sends structured and unstructured events to Snowplow collectors for data analytics pipelines. The tracker supports multiple platforms (.NET Standard 1.4/2.0) and provides async/sync event emission, persistent storage, and rich context capabilities.
---
