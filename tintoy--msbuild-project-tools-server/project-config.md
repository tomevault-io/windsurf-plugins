---
trigger: always_on
description: This is a **Language Server Protocol (LSP)** implementation for MSBuild project files, providing IntelliSense, completions, and diagnostics for `.csproj`, `.props`, and `.targets` files.
---
...
---
> Source: [tintoy/msbuild-project-tools-server](https://github.com/tintoy/msbuild-project-tools-server) — distributed by [TomeVault](https://tomevault.io).
