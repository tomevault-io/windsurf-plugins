---
trigger: always_on
description: - `packages/`: Dart/Flutter packages. Core at `packages/core`, public wrapper at `packages/enhanced`, and feature add‑ons under `packages/fwfh_*`.
---
...
---
> Source: [daohoangson/flutter_widget_from_html](https://github.com/daohoangson/flutter_widget_from_html) — distributed by [TomeVault](https://tomevault.io).
