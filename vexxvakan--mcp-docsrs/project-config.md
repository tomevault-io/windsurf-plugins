---
trigger: always_on
description: We are running multiple agents on the same code base so you can expect changes in the active commit not authored by you. Do not reset or otherwise touch them and stay only at your edited files scope for your session.
---
...
- Do not create too many files in one directory. If the directory is larger than 5 .ts files you need to create a new further split sub directory
...
- Remove functions entirely when they are clean to remove.
- Do not keep artifacts for API confirmness or useless type aliases.
- Clean up types after function removal as well.
...
- Coverage for your changes must be at 90% or higher.

---
> Source: [vexxvakan/mcp-docsrs](https://github.com/vexxvakan/mcp-docsrs) — distributed by [TomeVault](https://tomevault.io).
