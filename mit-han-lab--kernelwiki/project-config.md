---
trigger: always_on
description: A structured knowledge base of GPU kernel optimization for NVIDIA Blackwell (SM100) and Hopper (SM90), optimized for LLM agent retrieval.
---
...
---
> Source: [mit-han-lab/KernelWiki](https://github.com/mit-han-lab/KernelWiki) — distributed by [TomeVault](https://tomevault.io).
