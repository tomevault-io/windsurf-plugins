---
trigger: always_on
description: The Packages directory contains the primary UPM package developed in this
---
...
---
> Source: [keijiro/VfxGraphAssets](https://github.com/keijiro/VfxGraphAssets) — distributed by [TomeVault](https://tomevault.io).
