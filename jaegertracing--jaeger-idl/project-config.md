---
trigger: always_on
description: This document summarizes key workflows, build system details, and troubleshooting tips for working with the `jaeger-idl` repository.
---
...
---
> Source: [jaegertracing/jaeger-idl](https://github.com/jaegertracing/jaeger-idl) — distributed by [TomeVault](https://tomevault.io).
