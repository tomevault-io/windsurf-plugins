---
trigger: always_on
description: - `CoreRipperX/`: CLI console app entry point.
---
...
---
> Source: [CXWorld/CoreRipperX](https://github.com/CXWorld/CoreRipperX) — distributed by [TomeVault](https://tomevault.io).
