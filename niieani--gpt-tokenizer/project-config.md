---
trigger: always_on
description: - This repository uses **Yarn 4 (Berry)** in classic `node_modules` mode (Plug'n'Play is disabled). Install dependencies with `yarn install --immutable`.
---
...
---
> Source: [niieani/gpt-tokenizer](https://github.com/niieani/gpt-tokenizer) — distributed by [TomeVault](https://tomevault.io).
