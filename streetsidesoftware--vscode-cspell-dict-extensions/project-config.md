---
trigger: always_on
description: - This is an npm + `lerna-lite` monorepo of many VS Code extensions, mostly under `extensions/*`.
---
...
---
> Source: [streetsidesoftware/vscode-cspell-dict-extensions](https://github.com/streetsidesoftware/vscode-cspell-dict-extensions) — distributed by [TomeVault](https://tomevault.io).
