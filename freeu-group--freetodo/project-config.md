---
trigger: always_on
description: - `lifetrace/`: FastAPI backend (routers, services, repositories, storage, llm, jobs, util).
---
...
---
> Source: [FreeU-group/FreeTodo](https://github.com/FreeU-group/FreeTodo) — distributed by [TomeVault](https://tomevault.io).
