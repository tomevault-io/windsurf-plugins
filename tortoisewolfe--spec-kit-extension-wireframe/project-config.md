---
trigger: always_on
description: Use these slash commands for repo health checks. They're read-only and safe to run any time.
---
...
---
> Source: [TortoiseWolfe/spec-kit-extension-wireframe](https://github.com/TortoiseWolfe/spec-kit-extension-wireframe) — distributed by [TomeVault](https://tomevault.io).
