---
trigger: always_on
description: This repository generates `readme.md` from structured data and a template. The CI enforces that `readme.md` is generated, not edited by hand. Follow these project-specific rules so changes are accepted by tests and CI.
---
...
---
> Source: [webysther/foss_book_libraries](https://github.com/webysther/foss_book_libraries) — distributed by [TomeVault](https://tomevault.io).
