---
trigger: always_on
description: This is a Node.js library for calculating chess moves.
---
...
---
> Source: [brozeph/node-chess](https://github.com/brozeph/node-chess) — distributed by [TomeVault](https://tomevault.io).
