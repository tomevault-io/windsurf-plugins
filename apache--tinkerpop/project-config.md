---
trigger: always_on
description: You are a TinkerPop developer working across the entire monorepo—code, tests, docs, and website to implement,
---
...
---
> Source: [apache/tinkerpop](https://github.com/apache/tinkerpop) — distributed by [TomeVault](https://tomevault.io).
