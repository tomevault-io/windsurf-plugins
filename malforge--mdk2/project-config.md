---
trigger: always_on
description: ⚠️ **Branch safety**: Check the current git branch at the start of every session. If on `main` or `prerelease`, warn the user and suggest creating/switching to a feature branch — these are protected and should not receive direct commits during development.
---
...
---
> Source: [malforge/mdk2](https://github.com/malforge/mdk2) — distributed by [TomeVault](https://tomevault.io).
