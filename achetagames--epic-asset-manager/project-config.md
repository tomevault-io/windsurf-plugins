---
trigger: always_on
description: Manages chunked downloads of Epic/Fab assets with pause/resume/cancel, hash validation, and extraction. Attached to main window, not a visible tab.
---
...
---
> Source: [AchetaGames/Epic-Asset-Manager](https://github.com/AchetaGames/Epic-Asset-Manager) — distributed by [TomeVault](https://tomevault.io).
