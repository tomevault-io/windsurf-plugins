---
trigger: always_on
description: This document lists the automated subagents and guidance for using them when working with this repository. The project is a Maven-based Java project targeting Java 17 with forward compatibility testing on Java 21. The subagents described here are intended to help with planning multi-step tasks and remediating CVEs in project dependencies.
---
...
---
> Source: [goldmansachs/jdmn](https://github.com/goldmansachs/jdmn) — distributed by [TomeVault](https://tomevault.io).
