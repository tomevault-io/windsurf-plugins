---
trigger: always_on
description: This document describes how agentic coding tools should work in this repository. It summarizes how to build, test, and the coding conventions already used across the codebase. Follow these rules unless a change explicitly requires deviation.
---
...
---
> Source: [InCerryGit/Dispose.Scope](https://github.com/InCerryGit/Dispose.Scope) — distributed by [TomeVault](https://tomevault.io).
