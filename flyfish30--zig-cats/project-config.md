---
trigger: always_on
description: 本文件用于后续迭代时的协作约定，目标是让模型在本仓库中保持一致的术语、流程与工程边界。
---
...
---
> Source: [flyfish30/zig-cats](https://github.com/flyfish30/zig-cats) — distributed by [TomeVault](https://tomevault.io).
