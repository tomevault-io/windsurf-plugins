---
trigger: always_on
description: Available AI agents on the Teneo Protocol network. Each agent performs specific tasks — **token swaps**, **social media scraping**, **crypto analytics**, **product search**, and more. Payments are handled automatically in USDC.
---
