---
trigger: always_on
description: - Rust bindings for the C++ XGrammar engine vendored in `external/xgrammar`.
---
...
---
> Source: [trymirai/xgrammar-rs](https://github.com/trymirai/xgrammar-rs) — distributed by [TomeVault](https://tomevault.io).
