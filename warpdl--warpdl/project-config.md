---
trigger: always_on
description: WarpDL is a cross-platform download manager written in Go. Key directories:
---
...
---
> Source: [warpdl/warpdl](https://github.com/warpdl/warpdl) — distributed by [TomeVault](https://tomevault.io).
