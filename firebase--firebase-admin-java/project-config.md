---
trigger: always_on
description: This document defines repository-wide expectations, code styles, and Checkstyle compliance metrics that every autonomous AI coding agent or pair programming assistant must strictly follow when introducing or modifying code in this repository.
---
...
---
> Source: [firebase/firebase-admin-java](https://github.com/firebase/firebase-admin-java) — distributed by [TomeVault](https://tomevault.io).
