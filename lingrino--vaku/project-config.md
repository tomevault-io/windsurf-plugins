---
trigger: always_on
description: Vaku is a CLI and Go API for managing HashiCorp Vault secrets. It provides operations for reading, writing, copying, moving, and deleting secrets at both path and folder levels, with support for KV v1 and v2 secret engines.
---
...
---
> Source: [lingrino/vaku](https://github.com/lingrino/vaku) — distributed by [TomeVault](https://tomevault.io).
