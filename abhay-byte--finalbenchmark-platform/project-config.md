---
trigger: always_on
description: You have context-mode MCP tools available. These rules are NOT optional — they protect your context window from flooding. A single unrouted command can dump 56 KB into context and waste the entire session. Antigravity does NOT have hooks, so these instructions are your ONLY enforcement mechanism. Follow them strictly.
---
...
---
> Source: [abhay-byte/finalbenchmark-platform](https://github.com/abhay-byte/finalbenchmark-platform) — distributed by [TomeVault](https://tomevault.io).
