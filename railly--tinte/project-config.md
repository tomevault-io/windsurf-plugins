---
trigger: always_on
description: Generate, compile, install, and preview design systems from one source of truth. Compatible with shadcn/cli v4 presets and registries.
---
...
---
> Source: [Railly/tinte](https://github.com/Railly/tinte) — distributed by [TomeVault](https://tomevault.io).
