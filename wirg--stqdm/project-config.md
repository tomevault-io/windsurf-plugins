---
trigger: always_on
description: This is the package for STqdm, a library that integrates `tqdm` inside Streamlit using Streamlit's native `.progress` widget.
---
...
---
> Source: [Wirg/stqdm](https://github.com/Wirg/stqdm) — distributed by [TomeVault](https://tomevault.io).
