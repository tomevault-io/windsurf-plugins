---
trigger: always_on
description: This file provides context for the core row-processing architecture of libyuv. Use these guidelines when refactoring, reviewing, or generating code within the `row_*.cc` files.
---
...
---
> Source: [skysilent/libyuv](https://github.com/skysilent/libyuv) — distributed by [TomeVault](https://tomevault.io).
