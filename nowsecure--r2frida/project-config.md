---
trigger: always_on
description: Handles devices, sessions, memory I/O, and JSON message dispatch.
---
...
---
> Source: [nowsecure/r2frida](https://github.com/nowsecure/r2frida) — distributed by [TomeVault](https://tomevault.io).
