---
trigger: always_on
description: Don't infer beyond what the code and repo make explicit—ask when uncertain. Never modify abstractions or architecture without explicit instruction.
---
...
---
> Source: [brownsys/paralegal](https://github.com/brownsys/paralegal) — distributed by [TomeVault](https://tomevault.io).
