---
trigger: always_on
description: Guidance for Claude Code (and the roundhouse Rails specialist agents) working in
---
...
---
> Source: [IcaliaLabs/sepomex](https://github.com/IcaliaLabs/sepomex) — distributed by [TomeVault](https://tomevault.io).
