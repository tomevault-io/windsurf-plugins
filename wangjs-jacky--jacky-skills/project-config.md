---
trigger: always_on
description: 这是一个 Claude Code Skills 管理仓库，用于存放自定义 skill 并使用 j-skills 工具管理。
---
...
---
> Source: [wangjs-jacky/jacky-skills](https://github.com/wangjs-jacky/jacky-skills) — distributed by [TomeVault](https://tomevault.io).
