---
trigger: always_on
description: Guidance for anyone (human or Claude) working in this repo. Non-sensitive; lives in the
---
...
---
> Source: [shmsoft/FreeEed](https://github.com/shmsoft/FreeEed) — distributed by [TomeVault](https://tomevault.io).
