---
trigger: always_on
description: Instructions for Claude when working in this repository.
---
...
---
> Source: [vinzenz/prd-breakdown-execute](https://github.com/vinzenz/prd-breakdown-execute) — distributed by [TomeVault](https://tomevault.io).
