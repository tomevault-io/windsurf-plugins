---
trigger: always_on
description: Football (soccer) dataset built from transfermarkt.com data. Raw data is acquired via scrapers/APIs into `data/raw/`, then transformed with dbt + DuckDB into prepared CSV files in `data/prep/`.
---
...
---
> Source: [dcaribou/transfermarkt-datasets](https://github.com/dcaribou/transfermarkt-datasets) — distributed by [TomeVault](https://tomevault.io).
