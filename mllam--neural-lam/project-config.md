---
trigger: always_on
description: Mandatory rules for AI coding agents. Violations will result in rejected PRs.
---
...
---
> Source: [mllam/neural-lam](https://github.com/mllam/neural-lam) — distributed by [TomeVault](https://tomevault.io).
