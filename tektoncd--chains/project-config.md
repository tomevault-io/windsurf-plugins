---
trigger: always_on
description: Kubernetes controller for supply chain security. Watches TaskRun and
---
...
---
> Source: [tektoncd/chains](https://github.com/tektoncd/chains) — distributed by [TomeVault](https://tomevault.io).
