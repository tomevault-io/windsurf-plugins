---
trigger: always_on
description: pnpm build          # Minified production build (esbuild, src/index.ts → dist/)
---
...
---
> Source: [ony3000/prettier-plugin-brace-style](https://github.com/ony3000/prettier-plugin-brace-style) — distributed by [TomeVault](https://tomevault.io).
