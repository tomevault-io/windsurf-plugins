---
trigger: always_on
description: Swift package providing a `Day` type for date-as-day handling without time/timezone complexity, plus a `DayTypeUI` product for SwiftUI calendar components.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/drekka) — claim your Tome and manage your conversions.
