---
trigger: always_on
description: - Always use the backend Poetry virtualenv (`backend-py3.10`) for Python commands.
---
...
---
> Source: [abi/screenshot-to-code](https://github.com/abi/screenshot-to-code) — distributed by [TomeVault](https://tomevault.io).
