---
trigger: always_on
description: Go language host for Pulumi .NET. Invoked by the Pulumi CLI to build, run, and generate code for .NET Pulumi programs.
---
...
---
> Source: [pulumi/pulumi-dotnet](https://github.com/pulumi/pulumi-dotnet) — distributed by [TomeVault](https://tomevault.io).
