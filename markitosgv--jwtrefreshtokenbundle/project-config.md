---
trigger: always_on
description: When the code or conversation mentions "JWT refresh token", "gesdinet", "JWTRefreshTokenBundle" or files from `Gesdinet\JWTRefreshTokenBundle`, provide suggestions based on **gesdinet/jwt-refresh-token-bundle**:
---
...
---
> Source: [markitosgv/JWTRefreshTokenBundle](https://github.com/markitosgv/JWTRefreshTokenBundle) — distributed by [TomeVault](https://tomevault.io).
