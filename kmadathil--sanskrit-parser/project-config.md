---
trigger: always_on
description: Sanskrit Parser is a Python library for morphological and syntactic analysis of Sanskrit text. It provides three levels of parsing:
---
...
---
> Source: [kmadathil/sanskrit_parser](https://github.com/kmadathil/sanskrit_parser) — distributed by [TomeVault](https://tomevault.io).
