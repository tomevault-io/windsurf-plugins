---
trigger: always_on
description: Vagrant-based VM for safely running and testing **OpenClaw** (the open-source autonomous AI agent, formerly Moltbot/Clawdbot by Peter Steinberger). This is NOT the Captain Claw game reimplementation -- it was originally scaffolded that way but has been fully rewritten.
---
...
---
> Source: [tudoanh/openclaw-vm](https://github.com/tudoanh/openclaw-vm) — distributed by [TomeVault](https://tomevault.io).
