---
trigger: always_on
description: - **Domain**: Crypto token asset registry — logos, metadata (`info.json`), and trading-pair tokenlists for ~188 blockchains maintained by the Trust Wallet community.
---
...
---
> Source: [trustwallet/assets](https://github.com/trustwallet/assets) — distributed by [TomeVault](https://tomevault.io).
