---
trigger: always_on
description: OpenFoodFacts Ruby SDK is a Ruby gem that provides API access to the Open Food Facts database, the open database about food. The gem includes models for Product, Locale, User and many other food-related entities.
---
...
---
> Source: [openfoodfacts/openfoodfacts-ruby](https://github.com/openfoodfacts/openfoodfacts-ruby) — distributed by [TomeVault](https://tomevault.io).
