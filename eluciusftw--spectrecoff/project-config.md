---
trigger: always_on
description: A thin, opinionated F# wrapper around [Spectre.Console](https://spectreconsole.net).
---
...
---
> Source: [EluciusFTW/SpectreCoff](https://github.com/EluciusFTW/SpectreCoff) — distributed by [TomeVault](https://tomevault.io).
