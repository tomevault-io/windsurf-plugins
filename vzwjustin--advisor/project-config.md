---
trigger: always_on
description: The repo on `main` is **Rust-only** (`advisor-rs` / `Cargo.toml`). There is no
---
...
---
> Source: [vzwjustin/advisor](https://github.com/vzwjustin/advisor) — distributed by [TomeVault](https://tomevault.io).
