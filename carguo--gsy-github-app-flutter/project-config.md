---
trigger: always_on
description: 这是一个 Flutter GitHub 客户端，同时也是带有教学展示性质的示例工程。
---
...
---
> Source: [CarGuo/gsy_github_app_flutter](https://github.com/CarGuo/gsy_github_app_flutter) — distributed by [TomeVault](https://tomevault.io).
