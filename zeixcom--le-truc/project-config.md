---
trigger: always_on
description: Focused guidance for AI agents reviewing or writing code in `@zeix/le-truc`.
---
...
---
> Source: [zeixcom/le-truc](https://github.com/zeixcom/le-truc) — distributed by [TomeVault](https://tomevault.io).
