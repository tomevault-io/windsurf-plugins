---
trigger: always_on
description: This repo contains a Claude Code plugin for analyzing FEC (Federal Election Commission) campaign finance filings. It includes an Agent Skill and an MCP server for secure API access.
---
...
---
> Source: [hodgesmr/agent-fecfile](https://github.com/hodgesmr/agent-fecfile) — distributed by [TomeVault](https://tomevault.io).
