---
trigger: always_on
description: Auto-generated C# SDK for [ModerationAPI](https://moderationapi.com/) -- multi-modal content moderation for text, images, video, and audio in 200+ languages.
---
...
---
> Source: [tryAGI/ModerationAPI](https://github.com/tryAGI/ModerationAPI) — distributed by [TomeVault](https://tomevault.io).
