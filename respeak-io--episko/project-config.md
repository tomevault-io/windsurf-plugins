---
trigger: always_on
description: `CLAUDE.md` is the comprehensive project guide despite its historical filename. Read
---
...
---
> Source: [respeak-io/episko](https://github.com/respeak-io/episko) — distributed by [TomeVault](https://tomevault.io).
