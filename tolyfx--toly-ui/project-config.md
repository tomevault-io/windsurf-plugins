---
trigger: always_on
description: - `modules/tolyui` 是纯 Dart/Flutter UI 聚合包，只能依赖和导出不包含原生平台实现的组件包。
---
...
---
> Source: [TolyFx/toly_ui](https://github.com/TolyFx/toly_ui) — distributed by [TomeVault](https://tomevault.io).
