---
trigger: always_on
description: BRender is a 3D rendering engine with multiple renderer backends:
---
...
---
> Source: [BlazingRenderer/BRender](https://github.com/BlazingRenderer/BRender) — distributed by [TomeVault](https://tomevault.io).
