---
trigger: always_on
description: Generate [Agent Skills](https://agentskills.io/home) from project documentation.
---
...
---
> Source: [uni-helper/skills](https://github.com/uni-helper/skills) — distributed by [TomeVault](https://tomevault.io).
