---
trigger: always_on
description: Flow Agent 是 Python 智能体服务，采用 `backend/src` 源码布局：
---
...
---
> Source: [zeyuW/flow-agent](https://github.com/zeyuW/flow-agent) — distributed by [TomeVault](https://tomevault.io).
