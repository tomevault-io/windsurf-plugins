---
trigger: always_on
description: - Windows Forms app targeting `net8.0-windows`
---
...
---
> Source: [brondavies/TrayToolbar](https://github.com/brondavies/TrayToolbar) — distributed by [TomeVault](https://tomevault.io).
