---
trigger: always_on
description: Bare-metal `no_std` Rust HAL for Espressif SoCs. MSRV: **1.95.0** (source: `MSRV` env in `.github/workflows/ci.yml`).
---
...
---
> Source: [esp-rs/esp-hal](https://github.com/esp-rs/esp-hal) — distributed by [TomeVault](https://tomevault.io).
