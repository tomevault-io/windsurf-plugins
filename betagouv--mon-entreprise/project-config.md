---
trigger: always_on
description: Les règles du projet (mission, principes, conventions de code, tests, commits) sont celles de `CONTRIBUTING.md`, la référence de l'équipe, importée ci-dessous. Ce fichier n'ajoute que ce qui est utile à un agent : les commandes, l'ordre des opérations et les pièges connus.
---
...
---
> Source: [betagouv/mon-entreprise](https://github.com/betagouv/mon-entreprise) — distributed by [TomeVault](https://tomevault.io).
