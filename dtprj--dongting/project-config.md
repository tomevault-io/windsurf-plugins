---
trigger: always_on
description: - Before running compile/package/test commands or writing tests, see [build-and-test](.agents/skills/build-and-test/SKILL.md) skill for important details.
---
...
---
> Source: [dtprj/dongting](https://github.com/dtprj/dongting) — distributed by [TomeVault](https://tomevault.io).
