---
trigger: always_on
description: - **Install**: `bun install` (enforced via preinstall hook)
---
...
---
> Source: [laulauland/bluesky-context-server](https://github.com/laulauland/bluesky-context-server) — distributed by [TomeVault](https://tomevault.io).
