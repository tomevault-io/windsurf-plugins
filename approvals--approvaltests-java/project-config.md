---
trigger: always_on
description: - **Full build:** `./build_and_test` (takes 1-2 min; auto-formats code via Maven formatter plugin)
---
...
---
> Source: [approvals/ApprovalTests.Java](https://github.com/approvals/ApprovalTests.Java) — distributed by [TomeVault](https://tomevault.io).
