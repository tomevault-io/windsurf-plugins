---
trigger: always_on
description: 所有 LLM / VLM / T2I 调用都走 `sn-ppt-standard/lib/model_client.py`（自包含、直接 httpx 打 endpoint、自动 `load_dotenv`）。**不再依赖 `sn-image-base`**。
---
...
---
> Source: [OpenSenseNova/SenseNova-Skills](https://github.com/OpenSenseNova/SenseNova-Skills) — distributed by [TomeVault](https://tomevault.io).
