---
trigger: always_on
description: The Trash Toolkit is a collection of .NET tools for working with Antlr4 grammars.
---
...
---
> Source: [antlr/grammars-v4](https://github.com/antlr/grammars-v4) — distributed by [TomeVault](https://tomevault.io).
