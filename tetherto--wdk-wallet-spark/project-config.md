...
- **Domain:** Spark Blockchain (Liquid Bitcoin / LBTC).
- **Key Libraries:** `@buildonspark/spark-sdk`, `@sparkscan/api-node-sdk-client`.
- **Standards:** BIP-44 (m/44'/998').
- **Features:** Zero fees, Lightning Network support (invoices, payments).

---
> Source: [tetherto/wdk-wallet-spark](https://github.com/tetherto/wdk-wallet-spark) — distributed by [TomeVault](https://tomevault.io).
