---
trigger: always_on
description: Before publishing a new version, you **must** update the following files:
---
...
---
> Source: [yen0304/Skill-Dock](https://github.com/yen0304/Skill-Dock) — distributed by [TomeVault](https://tomevault.io).
