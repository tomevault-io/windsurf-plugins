---
trigger: always_on
description: This branch is the foundation for a new platform-based generation of RxJS, with
---
...
---
> Source: [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) — distributed by [TomeVault](https://tomevault.io).
