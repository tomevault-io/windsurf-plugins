---
trigger: always_on
description: This is the Descope .NET SDK, which provides authentication and user management capabilities. The SDK uses Microsoft Kiota to auto-generate API client code from OpenAPI specifications.
---
...
---
> Source: [descope/descope-dotnet](https://github.com/descope/descope-dotnet) — distributed by [TomeVault](https://tomevault.io).
