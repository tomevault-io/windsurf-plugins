---
trigger: always_on
description: - Default working scope is `examples/` unless a task explicitly requires touching root-level CMake or source files.
---
...
---
> Source: [tpn/perfecthash](https://github.com/tpn/perfecthash) — distributed by [TomeVault](https://tomevault.io).
