---
trigger: always_on
description: This is Recharts repository. Recharts is a React-based charting library.
---
...
---
> Source: [recharts/recharts](https://github.com/recharts/recharts) — distributed by [TomeVault](https://tomevault.io).
