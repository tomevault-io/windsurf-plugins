---
trigger: always_on
description: At the start of every conversation, read [`docs/README.md`](docs/README.md) to load the project documentation map. Skills are automatically loaded by Claude Code from `.claude/skills/` — do not manually read them.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/decentraland) — claim your Tome and manage your conversions.
