---
trigger: always_on
description: - Subject line: capitalized, 50 characters or less, imperative mood (e.g., "Fix bug" not "Fixed bug")
---
...
---
> Source: [OpenDevicePartnership/embedded-batteries](https://github.com/OpenDevicePartnership/embedded-batteries) — distributed by [TomeVault](https://tomevault.io).
