---
trigger: always_on
description: This repo is a pnpm workspace and uses Moon as the task runner.
---
...
---
> Source: [shellscape/jsx-email](https://github.com/shellscape/jsx-email) — distributed by [TomeVault](https://tomevault.io).
