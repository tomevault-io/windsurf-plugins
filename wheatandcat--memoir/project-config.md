---
trigger: always_on
description: - issueのリンクが提供されていない場合は、必ずユーザーに「関連するissueのリンクはありますか？」と確認する
---
...
---
> Source: [wheatandcat/memoir](https://github.com/wheatandcat/memoir) — distributed by [TomeVault](https://tomevault.io).
