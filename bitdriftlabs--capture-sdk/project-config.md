---
trigger: always_on
description: Multi-platform telemetry SDK for iOS/Android with a shared Rust core.
---
...
---
> Source: [bitdriftlabs/capture-sdk](https://github.com/bitdriftlabs/capture-sdk) — distributed by [TomeVault](https://tomevault.io).
