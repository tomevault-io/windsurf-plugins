---
trigger: always_on
description: Note: CLAUDE.md is a symlink to this file. Edit AGENTS.md directly.
---
...
---
> Source: [styled-components/styled-components-website](https://github.com/styled-components/styled-components-website) — distributed by [TomeVault](https://tomevault.io).
