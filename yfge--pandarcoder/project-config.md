---
trigger: always_on
description: 这个文件记录了Claude开发过程中需要了解的关键信息和常用命令。
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/yfge) — claim your Tome and manage your conversions.
