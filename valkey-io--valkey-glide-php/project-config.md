---
trigger: always_on
description: This file provides AI agents and developers with the minimum but sufficient context to work productively with the Valkey GLIDE PHP client. It covers build commands, testing, contribution requirements, and essential guardrails specific to the PHP implementation.
---
...
---
> Source: [valkey-io/valkey-glide-php](https://github.com/valkey-io/valkey-glide-php) — distributed by [TomeVault](https://tomevault.io).
