---
trigger: always_on
description: - Native C GTK4/libadwaita NetworkManager sidebar for Wayland; Gtk4LayerShell is required to show it.
---
...
---
> Source: [Relz/network-manager-sidebar](https://github.com/Relz/network-manager-sidebar) — distributed by [TomeVault](https://tomevault.io).
