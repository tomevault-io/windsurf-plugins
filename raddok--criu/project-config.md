---
trigger: always_on
description: CRIU is a tool for saving the state of a running application to a set of files
---
...
---
> Source: [raddok/criu](https://github.com/raddok/criu) — distributed by [TomeVault](https://tomevault.io).
