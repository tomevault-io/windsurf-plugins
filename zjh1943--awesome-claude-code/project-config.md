---
trigger: always_on
description: **Awesome Claude Code** (Claude Code Academy) is a comprehensive, open-source learning resource hub for Claude Code developers, catering specifically to the Chinese-speaking community. It serves as a documentation site built with **Next.js** and **Nextra**.
---
...
---
> Source: [zjh1943/awesome-claude-code](https://github.com/zjh1943/awesome-claude-code) — distributed by [TomeVault](https://tomevault.io).
