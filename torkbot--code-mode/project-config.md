---
trigger: always_on
description: - No artificial optionality. Fallbacks for the sake of optionality are poison. Trust the type-checker for internal contracts. Validate at the boundary of the library and I/O.
---
...
---
> Source: [torkbot/code-mode](https://github.com/torkbot/code-mode) — distributed by [TomeVault](https://tomevault.io).
