---
trigger: always_on
description: - For C API reference pages, use the public header comments in `include/winsparkle.h` as the source text.
---
...
- Use sidebar order numbers in multiples of 10, for example `10`, `20`, `30`, to leave room for future insertions.
- Use italics for user-visible UI labels, not bold.
...
---
> Source: [vslavik/winsparkle](https://github.com/vslavik/winsparkle) — distributed by [TomeVault](https://tomevault.io).
