---
trigger: always_on
description: This repository contains a multilingual Next.js tool gallery. Follow the existing implementation patterns in `src/app/[lang]/tools`, keep edits scoped, and prefer local browser-side processing for user files.
---
...
---
> Source: [selfboot/ai_gallery](https://github.com/selfboot/ai_gallery) — distributed by [TomeVault](https://tomevault.io).
