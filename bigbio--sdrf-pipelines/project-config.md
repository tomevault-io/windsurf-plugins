---
trigger: always_on
description: uv run pre-commit run --all-files
---
...
---
> Source: [bigbio/sdrf-pipelines](https://github.com/bigbio/sdrf-pipelines) — distributed by [TomeVault](https://tomevault.io).
