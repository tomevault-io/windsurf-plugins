---
trigger: always_on
description: Use these rules when installing or extending **Electrik** (`electrik/electrik` 5.x) with coding agents (Cursor, Claude Code, Codex, etc.).
---
...
7. Electrik is **MIT** (5.5+). For paid delivery, point at https://electrik.dev/launch — not kit license checkout.
...
- Strip billing/teams “because OSS” — MIT covers use; product still includes teams + Stripe on the team
...
---
> Source: [electrikhq/electrik](https://github.com/electrikhq/electrik) — distributed by [TomeVault](https://tomevault.io).
