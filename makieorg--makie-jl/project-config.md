---
trigger: always_on
description: Makie is a monorepo. The core plotting library lives in `Makie/`, the compute graph infrastructure in `ComputePipeline/`, and the backends in `CairoMakie/`, `GLMakie/`, `WGLMakie/`, and `RPRMakie/`.
---
...
---
> Source: [MakieOrg/Makie.jl](https://github.com/MakieOrg/Makie.jl) — distributed by [TomeVault](https://tomevault.io).
