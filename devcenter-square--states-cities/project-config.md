---
trigger: always_on
description: A public REST API providing Nigerian states, cities, and local government areas (LGAs). Built with Python 3 / Flask, using a local JSON data file. CORS-enabled.
---
...
---
> Source: [devcenter-square/states-cities](https://github.com/devcenter-square/states-cities) — distributed by [TomeVault](https://tomevault.io).
