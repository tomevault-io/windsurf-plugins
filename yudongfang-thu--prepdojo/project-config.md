---
trigger: always_on
description: 本地优先（local-first）的 AI 刷题工具：本地沙箱判题（AC/WA/TLE/MLE/RE/CE）+ AI 讲题教练（沙箱作为可调用工具）+ 八股 AI 面试官 + 知识目录结构化流水线。前身项目存于 `legacy/`（只读存档，勿改）。macOS/Linux only（判题用 POSIX rlimit），Windows 需 WSL。
---
...
---
> Source: [yudongfang-thu/PrepDojo](https://github.com/yudongfang-thu/PrepDojo) — distributed by [TomeVault](https://tomevault.io).
