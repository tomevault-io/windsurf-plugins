---
trigger: always_on
description: - `src/`: TypeScript sources. Key files: `main.ts` (CLI entry), `anthropic-proxy.ts` (HTTP proxy), `convert-*.ts` (format converters), `detect-mimetype.ts`, `json-schema.ts`.
---
...
---
> Source: [coder/anyclaude](https://github.com/coder/anyclaude) — distributed by [TomeVault](https://tomevault.io).
