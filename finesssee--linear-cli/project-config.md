---
trigger: always_on
description: Use `linear-cli` for all Linear.app operations. Do not use Linear MCP tools.
---
...
---
> Source: [Finesssee/linear-cli](https://github.com/Finesssee/linear-cli) — distributed by [TomeVault](https://tomevault.io).
