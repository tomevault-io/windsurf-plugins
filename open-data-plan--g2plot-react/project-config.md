---
trigger: always_on
description: - `src/components/base/index.tsx` – shared React wrapper managing the G2Plot lifecycle.
---
...
---
> Source: [open-data-plan/g2plot-react](https://github.com/open-data-plan/g2plot-react) — distributed by [TomeVault](https://tomevault.io).
