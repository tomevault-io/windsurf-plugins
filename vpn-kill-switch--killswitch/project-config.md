---
trigger: always_on
description: - `src/bin/killswitch.rs`: CLI entry point (delegates to `killswitch::cli`).
---
...
---
> Source: [vpn-kill-switch/killswitch](https://github.com/vpn-kill-switch/killswitch) — distributed by [TomeVault](https://tomevault.io).
