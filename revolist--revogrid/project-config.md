---
trigger: always_on
description: These rules are for AI coding agents working in the RevoGrid repository.
---
...
---
> Source: [revolist/revogrid](https://github.com/revolist/revogrid) — distributed by [TomeVault](https://tomevault.io).
