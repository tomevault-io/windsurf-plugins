---
trigger: always_on
description: This document provides guidelines for the AI assistant when working on the Zoi project. Please adhere to these instructions to ensure consistency and quality.
---
