---
trigger: always_on
description: These rules apply to all provider Go source files under `github/`. Combine
---
...
---
> Source: [integrations/terraform-provider-github](https://github.com/integrations/terraform-provider-github) — distributed by [TomeVault](https://tomevault.io).
