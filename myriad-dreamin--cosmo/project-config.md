---
trigger: always_on
description: - Prefer flat, linear control flow. Use guard clauses, early returns, small helper functions, and explicit intermediate values instead of deeply nested `if`, `match`, callback, or result-unwrapping pyramids.
---
...
---
> Source: [Myriad-Dreamin/cosmo](https://github.com/Myriad-Dreamin/cosmo) — distributed by [TomeVault](https://tomevault.io).
