---
trigger: always_on
description: Before running tests, linters, builds, or package-manager commands:
---
...
---
> Source: [khashashin/ogi](https://github.com/khashashin/ogi) — distributed by [TomeVault](https://tomevault.io).
