---
trigger: always_on
description: - `src/` holds the SolidJS + TypeScript app code; entry points are `src/index.tsx` and `src/index.css`.
---
...
---
> Source: [khmm12/minimal-chrome-tab](https://github.com/khmm12/minimal-chrome-tab) — distributed by [TomeVault](https://tomevault.io).
