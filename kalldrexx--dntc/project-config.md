---
trigger: always_on
description: You are working on DNTC, a transpiler that converts MSIL (Microsoft Intermediate Language) from compiled .NET
---
...
---
> Source: [KallDrexx/dntc](https://github.com/KallDrexx/dntc) — distributed by [TomeVault](https://tomevault.io).
