---
trigger: always_on
description: This is the Modrinth monorepo — it contains all Modrinth projects, both frontend and backend. When entering a project, either to edit or analyse, you should read it's CLAUDE.md.
---
...
---
> Source: [Mystic-Stars/Axolotl](https://github.com/Mystic-Stars/Axolotl) — distributed by [TomeVault](https://tomevault.io).
