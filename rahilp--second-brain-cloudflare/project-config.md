---
trigger: always_on
description: Always recall at session start and remember important context via Second Brain (MCP or brain CLI)
---
...
- **personal** = private to author; **company** = shared with the team
- **v3.0.0:** one shared team per brain — omit `team` unless `list_teams` returns more than one
- User says "share with the team" → `workspace: company`
- `team` on remember, share, recall, list_recent when multi-team is enabled later; not on id-based tools (get, append, update, etc.)

Full guidance: copy [CURSOR_INSTRUCTIONS.md](https://github.com/rahilp/second-brain-cloudflare/blob/main/AI_Instructions/CURSOR_INSTRUCTIONS.md) into `~/.cursor/CURSOR_INSTRUCTIONS.md`, or open it from a clone of this repository.

---
> Source: [rahilp/second-brain-cloudflare](https://github.com/rahilp/second-brain-cloudflare) — distributed by [TomeVault](https://tomevault.io).
