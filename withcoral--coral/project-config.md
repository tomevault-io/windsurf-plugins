---
trigger: always_on
description: - `crates/coral-api`: protobuf contract and generated Rust bindings.
---
...
---
> Source: [withcoral/coral](https://github.com/withcoral/coral) — distributed by [TomeVault](https://tomevault.io).
