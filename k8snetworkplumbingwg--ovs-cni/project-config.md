---
trigger: always_on
description: Kubernetes CNI plugin that attaches pods to Open vSwitch bridges. Works with Multus and NetworkAttachmentDefinition CRD.
---
...
---
> Source: [k8snetworkplumbingwg/ovs-cni](https://github.com/k8snetworkplumbingwg/ovs-cni) — distributed by [TomeVault](https://tomevault.io).
