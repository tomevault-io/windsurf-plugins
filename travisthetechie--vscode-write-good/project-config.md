---
trigger: always_on
description: - `src/`: TypeScript sources. `extension.ts` wires activation, diagnostics, and settings; `linter.ts` wraps the `write-good` engine.
---
...
---
> Source: [TravisTheTechie/vscode-write-good](https://github.com/TravisTheTechie/vscode-write-good) — distributed by [TomeVault](https://tomevault.io).
