---
trigger: always_on
description: 给 AI 助手（以及人类）在本仓库工作时的指引。**构建、发布、改 UI 之前先读这份。**
---
...
---
> Source: [wavever/ClipTrace](https://github.com/wavever/ClipTrace) — distributed by [TomeVault](https://tomevault.io).
