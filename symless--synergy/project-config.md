---
trigger: always_on
description: - **Never configure or build unless explicitly asked.** No `cmake`, `cmake --build`, `make`, `ninja`, etc. After code changes, stop at the edit and ask the user to build manually.
---
...
---
> Source: [symless/synergy](https://github.com/symless/synergy) — distributed by [TomeVault](https://tomevault.io).
