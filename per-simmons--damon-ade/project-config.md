---
trigger: always_on
description: Guidelines for agents and developers working in this repository.
---
...
---
> Source: [per-simmons/damon-ade](https://github.com/per-simmons/damon-ade) — distributed by [TomeVault](https://tomevault.io).
