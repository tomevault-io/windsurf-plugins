---
trigger: always_on
description: > 本仓库的完整 AI 工程规范见 [AGENTS.md](AGENTS.md)，已通过 `@AGENTS.md` 导入；以下仅说明 Claude Code 环境差异，冲突以 AGENTS.md 为准。
---
...
---
> Source: [xaoxuu/hexo-theme-stellar](https://github.com/xaoxuu/hexo-theme-stellar) — distributed by [TomeVault](https://tomevault.io).
