---
trigger: always_on
description: **ExTester** (`vscode-extension-tester`) is a UI testing framework for Visual Studio Code extensions.
---
...
---
> Source: [redhat-developer/vscode-extension-tester](https://github.com/redhat-developer/vscode-extension-tester) — distributed by [TomeVault](https://tomevault.io).
