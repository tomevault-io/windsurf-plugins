---
trigger: always_on
description: - Follow `rustfmt` defaults; do not add `rustfmt.toml` overrides without
---
...
---
> Source: [strawlab/flo](https://github.com/strawlab/flo) — distributed by [TomeVault](https://tomevault.io).
