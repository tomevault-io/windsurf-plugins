---
trigger: always_on
description: This file captures a lightweight set of contribution notes for people using AI assistants (Codex/ChatGPT/etc.) when working on **pyrainbird**.
---
...
---
> Source: [allenporter/pyrainbird](https://github.com/allenporter/pyrainbird) — distributed by [TomeVault](https://tomevault.io).
