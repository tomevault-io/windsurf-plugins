---
trigger: always_on
description: - **Always use `uv` for python commands and environment management.**
---
...
---
> Source: [talmolab/sleap](https://github.com/talmolab/sleap) — distributed by [TomeVault](https://tomevault.io).
