---
trigger: always_on
description: A reference implementation of a chat application using the Anthropic Managed Agents API.
---
...
---
> Source: [tradermonty/claude-trading-agent](https://github.com/tradermonty/claude-trading-agent) — distributed by [TomeVault](https://tomevault.io).
