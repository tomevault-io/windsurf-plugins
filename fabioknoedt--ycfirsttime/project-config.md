---
trigger: always_on
description: Context for Claude Code sessions working inside this repository.
---
...
---
> Source: [fabioknoedt/YCFirstTime](https://github.com/fabioknoedt/YCFirstTime) — distributed by [TomeVault](https://tomevault.io).
