---
trigger: always_on
description: - Always refer to `home-assistant-js-websocket` library for types and functions to interact with the Home Assistant API.
---
...
---
> Source: [denysdovhan/purifier-card](https://github.com/denysdovhan/purifier-card) — distributed by [TomeVault](https://tomevault.io).
