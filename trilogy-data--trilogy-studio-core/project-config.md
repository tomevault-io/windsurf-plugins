---
trigger: always_on
description: /lib contains core typescript code
---
...
---
> Source: [trilogy-data/trilogy-studio-core](https://github.com/trilogy-data/trilogy-studio-core) — distributed by [TomeVault](https://tomevault.io).
