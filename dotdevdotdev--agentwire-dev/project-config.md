---
trigger: always_on
description: Voice interface for AI coding agents. Push-to-talk from any device to tmux sessions running Claude Code.
---
...
---
> Source: [dotdevdotdev/agentwire-dev](https://github.com/dotdevdotdev/agentwire-dev) — distributed by [TomeVault](https://tomevault.io).
