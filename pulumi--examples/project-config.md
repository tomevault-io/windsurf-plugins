---
trigger: always_on
description: Go test suite that deploys and destroys every Pulumi example as an integration test. Uses `pulumi/pulumi/pkg/v3/testing/integration`.
---
...
---
> Source: [pulumi/examples](https://github.com/pulumi/examples) — distributed by [TomeVault](https://tomevault.io).
