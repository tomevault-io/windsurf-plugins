---
trigger: always_on
description: This project is based on **NeuCharFramework (NCF)**, a modular .NET framework.
---
...
---
> Source: [NeuCharFramework/NcfPackageSources](https://github.com/NeuCharFramework/NcfPackageSources) — distributed by [TomeVault](https://tomevault.io).
