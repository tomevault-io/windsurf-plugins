---
trigger: always_on
description: This package is the Alto Ghost theme. In the standalone mirror repository, this tree is pushed from `TryGhost/Themes/packages/alto` by subtree sync; make durable theme-content changes in `TryGhost/Themes` unless the task is explicitly repo-level metadata or GitHub settings.
---
...
---
> Source: [TryGhost/Alto](https://github.com/TryGhost/Alto) — distributed by [TomeVault](https://tomevault.io).
