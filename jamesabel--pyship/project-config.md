---
trigger: always_on
description: pyship is a Windows application freezer, installer, and updater for Python applications. It creates a CLIP (Complete Location Independent Python) environment, a native launcher executable, and an NSIS installer. It optionally uploads artifacts to AWS S3 for distribution.
---
...
---
> Source: [jamesabel/pyship](https://github.com/jamesabel/pyship) — distributed by [TomeVault](https://tomevault.io).
