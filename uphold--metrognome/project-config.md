---
trigger: always_on
description: This repo **is** the metrognome plugin itself. For development guidance see `CLAUDE.md`; for setting it up across AI agents see `COMPATIBILITY.md`.
---
...
---
> Source: [uphold/metrognome](https://github.com/uphold/metrognome) — distributed by [TomeVault](https://tomevault.io).
