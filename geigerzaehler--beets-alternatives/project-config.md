---
trigger: always_on
description: - `cli_test.py` — the entire suite. Tests drive the plugin through the beets CLI
---
...
---
> Source: [geigerzaehler/beets-alternatives](https://github.com/geigerzaehler/beets-alternatives) — distributed by [TomeVault](https://tomevault.io).
