---
trigger: always_on
description: Java / Spring Boot monorepo for [Activiti Cloud](https://github.com/Activiti/activiti-cloud) — workflow runtime, query, audit, connectors, and Kubernetes deployment charts.
---
