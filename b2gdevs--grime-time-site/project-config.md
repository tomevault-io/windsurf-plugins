---
trigger: always_on
description: This project is managed under the **GAD framework**. Use `gad` CLI for all planning context.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/B2Gdevs)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/B2Gdevs)
