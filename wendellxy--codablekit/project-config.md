---
trigger: always_on
description: This document is for AI agents and contributors working on `CodableKit`. It explains the project structure, how to build and test locally, coding standards, and common workflows. Keep it concise and high-signal.
---
...
---
> Source: [WendellXY/CodableKit](https://github.com/WendellXY/CodableKit) — distributed by [TomeVault](https://tomevault.io).
