---
trigger: always_on
description: - `src/index.ts` is the plugin entry that wires PicGo CLI/GUI commands, config schema, and migration flow.
---
...
---
> Source: [PicGo/picgo-plugin-pic-migrater](https://github.com/PicGo/picgo-plugin-pic-migrater) — distributed by [TomeVault](https://tomevault.io).
