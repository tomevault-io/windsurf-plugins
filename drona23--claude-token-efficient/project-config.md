---
trigger: always_on
description: Reproducible measurement of what `CLAUDE.md` does to model output: token cost
---
...
---
> Source: [drona23/claude-token-efficient](https://github.com/drona23/claude-token-efficient) — distributed by [TomeVault](https://tomevault.io).
