---
trigger: always_on
description: This document provides guidance for AI agents and automated systems working with the RabbitMQ Stream Go Client codebase.
---
...
---
> Source: [rabbitmq/rabbitmq-stream-go-client](https://github.com/rabbitmq/rabbitmq-stream-go-client) — distributed by [TomeVault](https://tomevault.io).
