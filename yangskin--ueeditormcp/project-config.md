---
trigger: always_on
description: Action IDs use **dot notation**: `domain.verb` or `domain.noun_verb`.
---
...
---
> Source: [yangskin/UEEditorMCP](https://github.com/yangskin/UEEditorMCP) — distributed by [TomeVault](https://tomevault.io).
