---
trigger: always_on
description: The project is organized into several crates, and there are some key crates and types:
---
...
---
> Source: [unixzii/little-agent](https://github.com/unixzii/little-agent) — distributed by [TomeVault](https://tomevault.io).
