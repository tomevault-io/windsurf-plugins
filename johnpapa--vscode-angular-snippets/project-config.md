---
trigger: always_on
description: This is a **VS Code snippets extension**. The product is JSON snippet files — not compiled code. There is no build step, no test suite, and no runtime logic.
---
...
---
> Source: [johnpapa/vscode-angular-snippets](https://github.com/johnpapa/vscode-angular-snippets) — distributed by [TomeVault](https://tomevault.io).
