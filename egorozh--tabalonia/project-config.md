---
trigger: always_on
description: Avalonia library: tab control with draggable, detachable and reattachable tabs. Port of [Dragablz](https://github.com/ButchersBoy/Dragablz) (WPF). Published to NuGet as `Tabalonia`.
---
...
---
> Source: [egorozh/Tabalonia](https://github.com/egorozh/Tabalonia) — distributed by [TomeVault](https://tomevault.io).
