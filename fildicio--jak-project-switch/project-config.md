---
trigger: always_on
description: A file for [guiding AI coding agents](https://agents.md/).
---
...
---
> Source: [fildicio/jak-project-switch](https://github.com/fildicio/jak-project-switch) — distributed by [TomeVault](https://tomevault.io).
