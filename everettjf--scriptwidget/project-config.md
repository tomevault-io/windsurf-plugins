---
trigger: always_on
description: - `Shared/ScriptWidgetRuntime/`: core Swift runtime (JavaScriptCore host, JSX → SwiftUI rendering, helper APIs).
---
...
---
> Source: [everettjf/ScriptWidget](https://github.com/everettjf/ScriptWidget) — distributed by [TomeVault](https://tomevault.io).
