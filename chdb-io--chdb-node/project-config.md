---
trigger: always_on
description: Orientation and gotchas for agents (and humans) editing this repo. Pairs with
---
...
---
> Source: [chdb-io/chdb-node](https://github.com/chdb-io/chdb-node) — distributed by [TomeVault](https://tomevault.io).
