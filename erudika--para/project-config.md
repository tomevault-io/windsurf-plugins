---
trigger: always_on
description: - `para/Chart.yaml` defines chart metadata and required Kubernetes version.
---
...
---
> Source: [Erudika/para](https://github.com/Erudika/para) — distributed by [TomeVault](https://tomevault.io).
