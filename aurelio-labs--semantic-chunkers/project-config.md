---
trigger: always_on
description: What an agent needs to work in this repository. Facts about the code and how to test it. The direction lives in `VISION.md`.
---
...
---
> Source: [aurelio-labs/semantic-chunkers](https://github.com/aurelio-labs/semantic-chunkers) — distributed by [TomeVault](https://tomevault.io).
