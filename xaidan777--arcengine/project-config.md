---
trigger: always_on
description: Основа для 3D-игр в браузере, заточенная под работу с Claude Code: ванильный
---
...
---
> Source: [xaidan777/ArcEngine](https://github.com/xaidan777/ArcEngine) — distributed by [TomeVault](https://tomevault.io).
