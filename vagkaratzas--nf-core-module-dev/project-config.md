---
trigger: always_on
description: This file is the source of truth for coding agents working inside this repository. `CLAUDE.md` only points here.
---
...
---
> Source: [vagkaratzas/nf-core-module-dev](https://github.com/vagkaratzas/nf-core-module-dev) — distributed by [TomeVault](https://tomevault.io).
