---
trigger: always_on
description: Equinox is a set of low-dependency F# libraries for event-sourced processing against stream-based stores.
---
...
---
> Source: [jet/equinox](https://github.com/jet/equinox) — distributed by [TomeVault](https://tomevault.io).
