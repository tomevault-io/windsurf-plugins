---
trigger: always_on
description: The basis of the SDK is https://github.com/palantir/foundry-platform-python. Their main
---
...
---
> Source: [anjor/pltr-cli](https://github.com/anjor/pltr-cli) — distributed by [TomeVault](https://tomevault.io).
