...
| [workos/oagen-emitters](https://github.com/workos/oagen-emitters) | The per-language emitters, including the Swift emitter that produces this repo's code |

Regeneration runs from a checkout of `openapi-spec`, never from this repo:

```bash
npm run sdk:generate -- --lang ios --output workos-ios
```
...
| Generated Swift code is broken or un-idiomatic | [workos/oagen-emitters](https://github.com/workos/oagen-emitters) |
...
---
> Source: [workos/workos-ios](https://github.com/workos/workos-ios) — distributed by [TomeVault](https://tomevault.io).
