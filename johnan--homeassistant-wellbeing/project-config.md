---
trigger: always_on
description: - **Language**: Python 3.14+ (managed via `mise`)
---
...
---
> Source: [JohNan/homeassistant-wellbeing](https://github.com/JohNan/homeassistant-wellbeing) — distributed by [TomeVault](https://tomevault.io).
