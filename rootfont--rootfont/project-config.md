---
trigger: always_on
description: Guidance for AI agents (opencode, Claude Code, etc.) working on rootfont.
---
...
---
> Source: [rootfont/rootfont](https://github.com/rootfont/rootfont) — distributed by [TomeVault](https://tomevault.io).
