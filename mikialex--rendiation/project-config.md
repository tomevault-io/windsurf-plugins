...
Use `cargo clippy --all-features --all-targets` to check the code after writing any rust code in project.

---
> Source: [mikialex/rendiation](https://github.com/mikialex/rendiation) — distributed by [TomeVault](https://tomevault.io).
