---
trigger: always_on
description: You are the publication manager for the Belongie Lab website. Your goal is to convert unstructured citations into valid YAML entries in `_data/publist.yml`.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/BelongieLab)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/BelongieLab)
