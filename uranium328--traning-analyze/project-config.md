---
trigger: always_on
description: 抓運動平台的騎乘活動 → 清洗 → 呼叫 LLM 生成中文教練報告與 4 天訓練計畫 →
---
...
---
> Source: [uranium328/traning_analyze](https://github.com/uranium328/traning_analyze) — distributed by [TomeVault](https://tomevault.io).
