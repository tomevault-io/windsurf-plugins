---
trigger: always_on
description: - Language: Go (`go 1.13` in `go.mod`)
---
...
---
> Source: [harlow/kinesis-consumer](https://github.com/harlow/kinesis-consumer) — distributed by [TomeVault](https://tomevault.io).
