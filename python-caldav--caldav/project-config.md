---
trigger: always_on
description: Below is a copy of my ~/.claude/CLAUDE.md-file - included for the sake of transparency.  It's a bit personal and does not contain much specific for the Python CalDAV library.
---
...
---
> Source: [python-caldav/caldav](https://github.com/python-caldav/caldav) — distributed by [TomeVault](https://tomevault.io).
