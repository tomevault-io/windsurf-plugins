---
trigger: always_on
description: This repository is split into two npm projects:
---
...
---
> Source: [xhongc/spark-novel](https://github.com/xhongc/spark-novel) — distributed by [TomeVault](https://tomevault.io).
