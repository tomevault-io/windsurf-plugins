---
trigger: always_on
description: Project context for Claude Code. Read this and `docs/ROADMAP.md` first.
---
...
---
> Source: [perezjuanj/OpenCircuit](https://github.com/perezjuanj/OpenCircuit) — distributed by [TomeVault](https://tomevault.io).
