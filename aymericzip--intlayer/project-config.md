---
trigger: always_on
description: Intlayer: open-source i18n monorepo. Bun + Turborepo. Ships npm packages (React, Next.js, Vue, Svelte, Angular…) + hosted CMS (backend + dashboard).
---
...
---
> Source: [aymericzip/intlayer](https://github.com/aymericzip/intlayer) — distributed by [TomeVault](https://tomevault.io).
