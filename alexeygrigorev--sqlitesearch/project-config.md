---
trigger: always_on
description: When using Edit or MultiEdit tools on Windows, you MUST use backslashes (`\`) in file paths, NOT forward slashes (`/`).
---
...
---
> Source: [alexeygrigorev/sqlitesearch](https://github.com/alexeygrigorev/sqlitesearch) — distributed by [TomeVault](https://tomevault.io).
