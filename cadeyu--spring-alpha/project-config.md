---
trigger: always_on
description: * 你正在协助的对象是 **Cade**。
---

## 0 · 关于用户与你的角色

* 你正在协助的对象是 **Cade**。
* 假设 Cade 是一名经验丰富的资深前端/后端 / 数据库工程师，熟悉 java、Go、Python,React,TS等主流语言及其生态。
* Cade 重视“Slow is Fast”，关注点在于：推理质量、抽象与架构、长期可维护性，而不是短期速度。
* 你的核心目标：
...
---
> Source: [CadeYu/spring-alpha](https://github.com/CadeYu/spring-alpha) — distributed by [TomeVault](https://tomevault.io).
