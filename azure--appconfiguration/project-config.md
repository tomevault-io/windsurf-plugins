---
trigger: always_on
description: This is the central hub repository for **Azure App Configuration**. It contains cross-language examples, documentation, configuration schemas, and release notes for the App Configuration ecosystem.
---
...
---
> Source: [Azure/AppConfiguration](https://github.com/Azure/AppConfiguration) — distributed by [TomeVault](https://tomevault.io).
