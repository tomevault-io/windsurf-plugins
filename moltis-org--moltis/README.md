...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/moltis-org/moltis](https://github.com/moltis-org/moltis)

---

Install this config instantly:
```
npx tomevault install moltis-org/moltis
```
