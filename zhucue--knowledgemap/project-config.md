---
trigger: always_on
description: 面向学生的知识库平台，核心功能：AI 生成树形思维导图、追问对话、知识资源库。
---
...
---
> Source: [zhucue/knowledgeMap](https://github.com/zhucue/knowledgeMap) — distributed by [TomeVault](https://tomevault.io).
