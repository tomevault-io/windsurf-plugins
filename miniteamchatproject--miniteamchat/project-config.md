---
trigger: always_on
description: 该文件为 Claude Code (claude.ai/code) 提供在该仓库中工作的指导。
---
...
---
> Source: [MiniTeamChatProject/MiniTeamChat](https://github.com/MiniTeamChatProject/MiniTeamChat) — distributed by [TomeVault](https://tomevault.io).
