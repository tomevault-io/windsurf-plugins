---
trigger: always_on
description: This is a project that uses Stagehand, which amplifies Playwright with `act`, `extract`, and `observe` added to the Page class.
---
...
---
> Source: [browserbase/stagehand-scaffold](https://github.com/browserbase/stagehand-scaffold) — distributed by [TomeVault](https://tomevault.io).
