...
Multi-agent orchestration system for Codex CLI, providing intelligent delegation, parallel execution, and IDE-like capabilities through LSP/AST integration.

**Version:** 4.0.0
**Purpose:** Transform Codex into a conductor of specialized AI agents
...
| `docs/CODEX.md` | End-user orchestration instructions (installed to user projects) |
...
| Agent tool assignments | `docs/CODEX.md` (Agent Tool Matrix) |
...
---
> Source: [realsigridjin/oh-my-codex](https://github.com/realsigridjin/oh-my-codex) — distributed by [TomeVault](https://tomevault.io).
