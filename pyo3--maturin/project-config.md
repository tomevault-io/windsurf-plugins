---
trigger: always_on
description: maturin builds and publishes Rust crates with pyo3, cffi, and uniffi bindings (and standalone Rust binaries) as Python packages. The core is written in Rust (`src/`) and exposed both as a CLI (`maturin`) and as a PEP 517 build backend through a small Python shim (`maturin/`).
---
...
---
> Source: [PyO3/maturin](https://github.com/PyO3/maturin) — distributed by [TomeVault](https://tomevault.io).
