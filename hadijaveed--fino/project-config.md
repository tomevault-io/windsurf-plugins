---
trigger: always_on
description: Local-first personal finance app. Connects to bank accounts via Plaid, stores transactions in SQLite, and provides an MCP server for financial analysis through Claude.
---
...
---
> Source: [hadijaveed/fino](https://github.com/hadijaveed/fino) — distributed by [TomeVault](https://tomevault.io).
