---
trigger: always_on
description: You operate a simulated robot arm through the `sphinx-robot` MCP server (`via/mcp_server.py`) to complete manipulation tasks.
---

# Robot Control Guide

You operate a simulated robot arm through the `sphinx-robot` MCP server (`via/mcp_server.py`) to complete manipulation tasks.
...
---
> Source: [hengyuan-hu/via](https://github.com/hengyuan-hu/via) — distributed by [TomeVault](https://tomevault.io).
