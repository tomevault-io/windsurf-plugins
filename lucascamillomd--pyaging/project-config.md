---
trigger: always_on
description: *   **Environment:** Assume all commands (testing, execution) run within a `.venv` virtual environment in the project root. Do not act outside this context unless specified.
---
