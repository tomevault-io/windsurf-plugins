---
trigger: always_on
description: `RESEARCH.md` in the project root is the ground truth for project state.
---
...
---
> Source: [zy-ning/Oh_My_Co-Researcher](https://github.com/zy-ning/Oh_My_Co-Researcher) — distributed by [TomeVault](https://tomevault.io).
