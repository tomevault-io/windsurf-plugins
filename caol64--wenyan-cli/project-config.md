---
trigger: always_on
description: - Use `pnpm` for all package management and repo scripts.
---
...
---
> Source: [caol64/wenyan-cli](https://github.com/caol64/wenyan-cli) — distributed by [TomeVault](https://tomevault.io).
