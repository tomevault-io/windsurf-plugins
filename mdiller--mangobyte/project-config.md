---
trigger: always_on
description: MangoByte is a Discord bot built with Python and [disnake](https://github.com/DisnakeDev/disnake). It focuses on:
---
...
---
> Source: [mdiller/MangoByte](https://github.com/mdiller/MangoByte) — distributed by [TomeVault](https://tomevault.io).
