...
# Agent Guide for maven-assembly-plugin
...
---
> Source: [apache/maven-assembly-plugin](https://github.com/apache/maven-assembly-plugin) — distributed by [TomeVault](https://tomevault.io).
