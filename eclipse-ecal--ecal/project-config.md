---
trigger: always_on
description: This file provides **agent-oriented guidance** for working in the eCAL repository.
---
...
---
> Source: [eclipse-ecal/ecal](https://github.com/eclipse-ecal/ecal) — distributed by [TomeVault](https://tomevault.io).
