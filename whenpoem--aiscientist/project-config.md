---
trigger: always_on
description: > 中文版本: [AGENTS.zh-CN.md](AGENTS.zh-CN.md)
---
...
---
> Source: [whenpoem/aiscientist](https://github.com/whenpoem/aiscientist) — distributed by [TomeVault](https://tomevault.io).
