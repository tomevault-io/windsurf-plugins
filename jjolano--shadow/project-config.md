---
trigger: always_on
description: - Inspect the worktree and relevant source before choosing an implementation. Preserve existing user changes.
---
...
---
> Source: [jjolano/shadow](https://github.com/jjolano/shadow) — distributed by [TomeVault](https://tomevault.io).
