---
trigger: always_on
description: It is an IntelliJ plugin for support of R language and RMarkdown.
---
...
---
> Source: [JetBrains/Rplugin](https://github.com/JetBrains/Rplugin) — distributed by [TomeVault](https://tomevault.io).
