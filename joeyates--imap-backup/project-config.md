---
trigger: always_on
description: - Never use `unless` in the codebase.
---
...
---
> Source: [joeyates/imap-backup](https://github.com/joeyates/imap-backup) — distributed by [TomeVault](https://tomevault.io).
