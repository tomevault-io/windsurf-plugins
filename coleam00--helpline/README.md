...
Original source: `CLAUDE.md` in [coleam00/helpline](https://github.com/coleam00/helpline).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/coleam00/helpline](https://github.com/coleam00/helpline)
