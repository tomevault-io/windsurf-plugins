---
trigger: always_on
description: HELICS is a multi-language, cross-platform C++ framework for connecting separate
---
...
---
> Source: [GMLC-TDC/HELICS](https://github.com/GMLC-TDC/HELICS) — distributed by [TomeVault](https://tomevault.io).
