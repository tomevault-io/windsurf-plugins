---
trigger: always_on
description: `deb-get` is a Bash CLI providing apt-get-like functionality for `.deb` packages from 3rd party apt repositories, PPAs, GitHub Releases, and direct downloads. Targets Debian, Ubuntu and derivatives. Single-file script (~65KB) with ~400 package definitions.
---
...
---
> Source: [wimpysworld/deb-get](https://github.com/wimpysworld/deb-get) — distributed by [TomeVault](https://tomevault.io).
