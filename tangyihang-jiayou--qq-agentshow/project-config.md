---
trigger: always_on
description: - `docs/RELEASE-REQUIREMENTS.md` is the release source of truth. Read it before installation, review, versioning, or publication work; update its evidence table for every release candidate.
---

# Repository Guidelines

- `docs/RELEASE-REQUIREMENTS.md` is the release source of truth. Read it before installation, review, versioning, or publication work; update its evidence table for every release candidate.
...
---
> Source: [tangyihang-jiayou/QQ_agentshow](https://github.com/tangyihang-jiayou/QQ_agentshow) — distributed by [TomeVault](https://tomevault.io).
