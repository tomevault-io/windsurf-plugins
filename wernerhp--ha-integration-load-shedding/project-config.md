---
trigger: always_on
description: This repository is a **Home Assistant custom integration** that tracks load
---
...
---
> Source: [wernerhp/ha.integration.load_shedding](https://github.com/wernerhp/ha.integration.load_shedding) — distributed by [TomeVault](https://tomevault.io).
