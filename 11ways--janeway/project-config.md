---
trigger: always_on
description: Janeway is a Node.js console REPL with an interactive TUI (Terminal User Interface). It provides:
---
...
---
> Source: [11ways/janeway](https://github.com/11ways/janeway) — distributed by [TomeVault](https://tomevault.io).
