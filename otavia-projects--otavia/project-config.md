---
trigger: always_on
description: PostgreSQL database driver implementing the sql module's Connection/Driver SPI.
---
...
---
> Source: [otavia-projects/otavia](https://github.com/otavia-projects/otavia) — distributed by [TomeVault](https://tomevault.io).
