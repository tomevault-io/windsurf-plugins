---
trigger: always_on
description: React Native wrapper (`@livekit/react-native`) that makes [`livekit-client`](https://github.com/livekit/client-sdk-js) work on React Native by providing WebRTC via `@livekit/react-native-webrtc`, browser API polyfills, and native audio session management for iOS/Android.
---
...
---
> Source: [livekit/client-sdk-react-native](https://github.com/livekit/client-sdk-react-native) — distributed by [TomeVault](https://tomevault.io).
