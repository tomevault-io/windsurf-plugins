---
trigger: always_on
description: This project is a personal Data Structures and Algorithms (DSA) tracker and roadmap viewer. It consists of a static frontend (`index.html`) that renders a structured curriculum from a JSON data file (`a2z.json`), supported by Python scripts for data maintenance and content archiving.
---
...
---
> Source: [Bugaddr/a2z_old_sheet](https://github.com/Bugaddr/a2z_old_sheet) — distributed by [TomeVault](https://tomevault.io).
