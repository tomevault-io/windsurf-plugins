---
trigger: always_on
description: <!-- BEGIN:api-platform-agent-rules -->
---
...
---
> Source: [api-platform/skillset](https://github.com/api-platform/skillset) — distributed by [TomeVault](https://tomevault.io).
