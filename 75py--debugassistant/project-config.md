---
trigger: always_on
description: Debug Assistant is an Android application designed to help Android developers by providing quick access to development tools through system tiles. The app enables toggling proxy settings and ADB (Android Debug Bridge) directly from the Quick Settings panel.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/75py)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/75py)
