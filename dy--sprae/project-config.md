---
trigger: always_on
description: Reactive HTML templating. Bind state to DOM via `:` attributes. No build step.
---
...
---
> Source: [dy/sprae](https://github.com/dy/sprae) — distributed by [TomeVault](https://tomevault.io).
