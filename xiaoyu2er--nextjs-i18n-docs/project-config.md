---
trigger: always_on
description: Project-level guidance for AI assistants working on this codebase.
---
...
---
> Source: [xiaoyu2er/nextjs-i18n-docs](https://github.com/xiaoyu2er/nextjs-i18n-docs) — distributed by [TomeVault](https://tomevault.io).
