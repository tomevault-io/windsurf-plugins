---
trigger: always_on
description: Firebolt Documentation Writing Style
---

# Adopt Google Style Guide

- Follow the Google style guide when writing documentation
- Follow the Mintlify style guide when writing documentation
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/firebolt-db) — claim your Tome and manage your conversions.
