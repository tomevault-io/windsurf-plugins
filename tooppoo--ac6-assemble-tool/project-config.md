---
trigger: always_on
description: 本ドキュメントは、このリポジトリにおける **ソフトウェア開発上の判断基準・背景・運用ルール**をまとめたものです。
---
...
設計原則の優先度は **可逆性 > 低結合 = 高凝集 = 直交性 > KISS = YAGNI > DRY** とする。
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/tooppoo)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/tooppoo)
