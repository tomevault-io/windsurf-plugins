---
trigger: always_on
description: Instructions in this file apply to the entire repository.
---
...
---
> Source: [edelstone/tints-and-shades](https://github.com/edelstone/tints-and-shades) — distributed by [TomeVault](https://tomevault.io).
