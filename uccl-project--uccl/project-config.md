---
trigger: always_on
description: **UCCL-Lite** is an efficient communication library for low-end, consumer-level
---
...
---
> Source: [uccl-project/uccl](https://github.com/uccl-project/uccl) — distributed by [TomeVault](https://tomevault.io).
