---
trigger: always_on
description: These instructions steer GitHub Copilot's automatic PR reviews. They complement `AGENTS.md` and `CONTRIBUTING.md`.
---
...
---
> Source: [DependencyTrack/dependency-track](https://github.com/DependencyTrack/dependency-track) — distributed by [TomeVault](https://tomevault.io).
