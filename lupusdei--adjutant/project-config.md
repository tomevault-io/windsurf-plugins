---
trigger: always_on
description: **Adjutant is the DASHBOARD for ALL of Gas Town.**
---
...
**Adjutant is the DASHBOARD for ALL of Gas Town.**

When building UI features, remember:
- Beads tab shows `~/gt/.beads/` (town beads, hq-* prefix), NOT adjutant/.beads/
...
---
> Source: [LupusDei/adjutant](https://github.com/LupusDei/adjutant) — distributed by [TomeVault](https://tomevault.io).
