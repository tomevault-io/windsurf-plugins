---
trigger: always_on
description: This repository provides stable data structures for the Internet Computer that persist across canister upgrades. These structures do not require `pre_upgrade` or `post_upgrade` hooks.
---
...
---
> Source: [dfinity/stable-structures](https://github.com/dfinity/stable-structures) — distributed by [TomeVault](https://tomevault.io).
