---
trigger: always_on
description: React 17 SPA deployed on **Azure Static Web Apps** with an Azure Functions API backend.
---
...
---
> Source: [webmaxru/bpm-counter](https://github.com/webmaxru/bpm-counter) — distributed by [TomeVault](https://tomevault.io).
