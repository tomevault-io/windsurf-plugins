---
trigger: always_on
description: - **C11** (`-std=c11`) with no compiler extensions required.
---
...
---
> Source: [yaglo/mynes](https://github.com/yaglo/mynes) — distributed by [TomeVault](https://tomevault.io).
