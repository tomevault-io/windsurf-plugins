---
trigger: always_on
description: Choose the right trait for your use case:
---
...
---
> Source: [thin-edge/thin-edge.io](https://github.com/thin-edge/thin-edge.io) — distributed by [TomeVault](https://tomevault.io).
