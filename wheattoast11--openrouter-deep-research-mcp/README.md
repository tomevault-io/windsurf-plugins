...
Original source: `CLAUDE.md` in [wheattoast11/openrouter-deep-research-mcp](https://github.com/wheattoast11/openrouter-deep-research-mcp).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/wheattoast11/openrouter-deep-research-mcp](https://github.com/wheattoast11/openrouter-deep-research-mcp)
