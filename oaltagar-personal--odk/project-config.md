---
trigger: always_on
description: ODK is an agent skill that orchestrates the full AI-assisted software development lifecycle: brainstorming, task management, execution with proof-based verification, and compound learning. The skill is the primary interface; the CLI exists to support agent automation.
---
...
---
> Source: [oaltagar-personal/odk](https://github.com/oaltagar-personal/odk) — distributed by [TomeVault](https://tomevault.io).
