---
trigger: always_on
description: If you're an agent working in this repo, start here. This file is meant to orient you quickly; it does not replace the project docs or maintainer judgment.
---
...
---
> Source: [tektoncd/pipeline](https://github.com/tektoncd/pipeline) — distributed by [TomeVault](https://tomevault.io).
