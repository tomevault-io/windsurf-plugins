---
trigger: always_on
description: handles a null entry assembly happily; the `netstandard2.0` asset (around 382 KB at 4.5.0) is the
---
...
---
> Source: [apache/logging-log4net](https://github.com/apache/logging-log4net) — distributed by [TomeVault](https://tomevault.io).
