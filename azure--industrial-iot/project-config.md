---
trigger: always_on
description: The repo uses `.slnx` solution files (not legacy `.sln`).
---
...
---
> Source: [Azure/Industrial-IoT](https://github.com/Azure/Industrial-IoT) — distributed by [TomeVault](https://tomevault.io).
