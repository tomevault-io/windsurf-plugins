---
trigger: always_on
description: Command Code (commandcode.ai) 的本地反向代理网关。接收下游 OpenAI 兼容请求（`/v1/chat/completions`），转换为上游 Command Code 专有 wire 协议，再将流式 SSE 响应转回标准 OpenAI 格式返回给客户端（ZCode、Cursor 等）。
---
...
---
> Source: [zmjjcjb/cmdc-hub](https://github.com/zmjjcjb/cmdc-hub) — distributed by [TomeVault](https://tomevault.io).
