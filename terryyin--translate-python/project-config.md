---
trigger: always_on
description: **Important:** Run `nix develop` in every new terminal session to activate the development environment with all required dependencies and correct Python paths.
---
