---
trigger: always_on
description: - PR 合入 main 前需要生成发布说明
---
...
---
> Source: [NEVSTOP-LAB/Communicable-State-Machine](https://github.com/NEVSTOP-LAB/Communicable-State-Machine) — distributed by [TomeVault](https://tomevault.io).
