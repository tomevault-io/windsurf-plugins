---
trigger: always_on
description: This is a PHP library called `sanmai/pipeline` that provides functional programming capabilities for working with data pipelines using lazy evaluation. The library implements streaming pipelines similar to the pipe operator (`|>`) in functional languages.
---
...
---
> Source: [sanmai/pipeline](https://github.com/sanmai/pipeline) — distributed by [TomeVault](https://tomevault.io).
