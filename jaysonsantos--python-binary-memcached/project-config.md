---
trigger: always_on
description: This repository contains the `python-binary-memcached` package, a pure Python client for memcached's binary protocol.
---
...
---
> Source: [jaysonsantos/python-binary-memcached](https://github.com/jaysonsantos/python-binary-memcached) — distributed by [TomeVault](https://tomevault.io).
