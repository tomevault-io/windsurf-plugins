---
trigger: always_on
description: This is the official Mixpanel React Native SDK, a wrapper around native iOS and Android SDKs for analytics tracking. It supports React Native apps, Expo, and React Native for Web (via JavaScript mode).
---
...
---
> Source: [mixpanel/mixpanel-react-native](https://github.com/mixpanel/mixpanel-react-native) — distributed by [TomeVault](https://tomevault.io).
