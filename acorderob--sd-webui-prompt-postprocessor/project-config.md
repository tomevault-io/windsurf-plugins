---
trigger: always_on
description: description: "Use when writing, editing, or reviewing Python code."
---
...
---
> Source: [acorderob/sd-webui-prompt-postprocessor](https://github.com/acorderob/sd-webui-prompt-postprocessor) — distributed by [TomeVault](https://tomevault.io).
