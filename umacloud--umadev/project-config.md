---
trigger: always_on
description: Guidance for any AI coding agent (Codex CLI / Codex Desktop / Antigravity
---
...
---
> Source: [umacloud/umadev](https://github.com/umacloud/umadev) — distributed by [TomeVault](https://tomevault.io).
