---
trigger: always_on
description: Local-only web app for practicing SQL exercises from the BDD (Databases) module. 25 exercises across 5 parts covering DDL and DQL against the DZTelecom telecom database.
---
