...
Key external deps: `starknet` (10.0.2), `@dojoengine/torii-wasm`/`torii-client` (1.8.2), `zustand`, `effect`.
...
---
> Source: [dojoengine/dojo.js](https://github.com/dojoengine/dojo.js) — distributed by [TomeVault](https://tomevault.io).
