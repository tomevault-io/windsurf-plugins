---
trigger: always_on
description: provides explicit-root `find` and `find_async`.
---
...
---
> Source: [remotefs-rs/remotefs-rs](https://github.com/remotefs-rs/remotefs-rs) — distributed by [TomeVault](https://tomevault.io).
