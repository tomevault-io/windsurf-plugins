---
trigger: always_on
description: Use `AGENTS.override.md` file WITH HIGHEST PRECEDENCE if it exists. Do NOT mix
---
...
---
> Source: [knative/func](https://github.com/knative/func) — distributed by [TomeVault](https://tomevault.io).
