---
trigger: always_on
description: - All files with source code are to be kept under approximately 600-700 lines. If some module, file, concept, etc. needs to exceed that, split it up into logical modules/includes
---
...
---
> Source: [HyperionGray/opsechat](https://github.com/HyperionGray/opsechat) — distributed by [TomeVault](https://tomevault.io).
