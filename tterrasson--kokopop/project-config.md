---
trigger: always_on
description: Standalone C++ runtime for neural text-to-speech models in GGUF format. Two
---
...
---
> Source: [tterrasson/kokopop](https://github.com/tterrasson/kokopop) — distributed by [TomeVault](https://tomevault.io).
