---
trigger: always_on
description: Ruby FFI binding for CZMQ/ZMQ. Version 2.0.0.pre1. Requires Ruby >= 3.3.
---
...
---
> Source: [paddor/cztop](https://github.com/paddor/cztop) — distributed by [TomeVault](https://tomevault.io).
