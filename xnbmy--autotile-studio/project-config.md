---
trigger: always_on
description: - 每次修改代码后，必须运行 `pnpm tauri build` 以打包程序。
---
...
---
> Source: [xnbmy/Autotile-Studio](https://github.com/xnbmy/Autotile-Studio) — distributed by [TomeVault](https://tomevault.io).
