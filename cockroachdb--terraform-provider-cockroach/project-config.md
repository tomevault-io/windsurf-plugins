---
trigger: always_on
description: This repository contains `terraform-provider-cockroach`, the
---
...
---
> Source: [cockroachdb/terraform-provider-cockroach](https://github.com/cockroachdb/terraform-provider-cockroach) — distributed by [TomeVault](https://tomevault.io).
