---
trigger: always_on
description: 本文件为 Gemini CLI 在 MANYOYO 项目中工作时提供全面的上下文和指令。
---
...
---
> Source: [xcanwin/manyoyo](https://github.com/xcanwin/manyoyo) — distributed by [TomeVault](https://tomevault.io).
