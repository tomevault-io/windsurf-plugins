---
trigger: always_on
description: Concise always-on reminders live in `.claude/rules/`:
---
...
---
> Source: [shakacode/shakapacker](https://github.com/shakacode/shakapacker) — distributed by [TomeVault](https://tomevault.io).
