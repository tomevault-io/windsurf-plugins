---
trigger: always_on
description: Este projeto é um Simulador e Acompanhamento em tempo real para a Copa do Mundo FIFA 2026 (React + Vite + Tailwind CSS v4 + Supabase).
---
...
---
> Source: [yudinakasato-23/copa-mundo-2026](https://github.com/yudinakasato-23/copa-mundo-2026) — distributed by [TomeVault](https://tomevault.io).
