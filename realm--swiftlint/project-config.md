---
trigger: always_on
description: You are working on SwiftLint, a linter for Swift code that enforces coding style and conventions. It helps maintain a clean and consistent codebase by identifying and reporting issues in Swift files. It can even automatically fix some of these issues.
---
...
---
> Source: [realm/SwiftLint](https://github.com/realm/SwiftLint) — distributed by [TomeVault](https://tomevault.io).
