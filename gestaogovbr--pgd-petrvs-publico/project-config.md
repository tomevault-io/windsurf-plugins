---
trigger: always_on
description: - Monorepo com `back-end/` em Laravel 10/PHP 8.2 e `front-end/` em Angular 21.
---
...
---
> Source: [gestaogovbr/pgd-petrvs-publico](https://github.com/gestaogovbr/pgd-petrvs-publico) — distributed by [TomeVault](https://tomevault.io).
