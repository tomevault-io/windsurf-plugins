---
trigger: always_on
description: A Claude Code plugin providing structured thinking methods as multi-agent sessions. Purely declarative — no code, no build steps, only Markdown files.
---
