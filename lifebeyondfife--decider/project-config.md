---
trigger: always_on
description: - calibration/probe runs are allowed but must always carry a hard per-run timeout and a stated total budget for the sweep; full BenchmarkDotNet runs (multi-iteration, statistical) remain user-triggered, since they're the expensive final measurement, not the exploration tool
---
...
---
> Source: [lifebeyondfife/Decider](https://github.com/lifebeyondfife/Decider) — distributed by [TomeVault](https://tomevault.io).
