...
`AGENTS.md` targets agents writing `.ap` programs. If you're
...
- [`agents/library-dev.md`](./agents/library-dev.md) — adding to
  the stdlib or writing an Aperio library.
...
---
> Source: [aperio-lang/aperio](https://github.com/aperio-lang/aperio) — distributed by [TomeVault](https://tomevault.io).
