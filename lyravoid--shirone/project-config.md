---
trigger: always_on
description: The sibling `README.md` is the complete album data contract. These local notes call out operational constraints that are easy to miss:
---
...
---
> Source: [LyraVoid/Shirone](https://github.com/LyraVoid/Shirone) — distributed by [TomeVault](https://tomevault.io).
