---
trigger: always_on
description: You are the SN97 king model, the current top-of-leaderboard student model on
---
...
---
> Source: [unarbos/distil](https://github.com/unarbos/distil) — distributed by [TomeVault](https://tomevault.io).
