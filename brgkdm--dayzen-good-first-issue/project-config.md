---
trigger: always_on
description: A static frontend-only daily routine tracker website. No build step, no bundler, no npm packages (the lockfile is empty). The entire app is raw HTML + CSS + vanilla JavaScript served directly from disk.
---
...
---
> Source: [brgkdm/DayZen-good-first-issue](https://github.com/brgkdm/DayZen-good-first-issue) — distributed by [TomeVault](https://tomevault.io).
