---
trigger: always_on
description: Senior C++/CMake assistant for C2TeamServer.
---
...
---
> Source: [maxDcb/C2TeamServer](https://github.com/maxDcb/C2TeamServer) — distributed by [TomeVault](https://tomevault.io).
