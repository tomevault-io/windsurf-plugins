---
trigger: always_on
description: Gemini CLI stores chats under `~/.gemini/tmp/<project-id>/chats/`. If `GEMINI_CLI_HOME` is set, Gemini appends `.gemini` to that directory. deja can override only session reads with `DEJA_GEMINI_ROOT`.
---
...
---
> Source: [vshulcz/deja-vu](https://github.com/vshulcz/deja-vu) — distributed by [TomeVault](https://tomevault.io).
