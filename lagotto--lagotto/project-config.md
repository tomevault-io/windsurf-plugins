---
trigger: always_on
description: The Lagotto software includes a number of agents. Most agents require a user account with the service. Agents collect information about works, contributors, publishers, and their relations to each other.
---
...
---
> Source: [lagotto/lagotto](https://github.com/lagotto/lagotto) — distributed by [TomeVault](https://tomevault.io).
