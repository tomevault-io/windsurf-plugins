---
trigger: always_on
description: Keep changes scoped to the requested component. Preserve unrelated working-tree
---
...
---
> Source: [lukaszliniewicz/Pandrator](https://github.com/lukaszliniewicz/Pandrator) — distributed by [TomeVault](https://tomevault.io).
