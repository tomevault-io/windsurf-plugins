---
trigger: always_on
description: You are working in a Decapod-managed repository.
---
...
---
> Source: [DecapodLabs/decapod](https://github.com/DecapodLabs/decapod) — distributed by [TomeVault](https://tomevault.io).
