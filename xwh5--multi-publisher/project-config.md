---
trigger: always_on
description: 一行命令，Markdown 发布到全网。支持微信公众号、知乎、掘金、CSDN 等 20+ 平台。
---
...
---
> Source: [xwh5/multi-publisher](https://github.com/xwh5/multi-publisher) — distributed by [TomeVault](https://tomevault.io).
