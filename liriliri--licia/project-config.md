---
trigger: always_on
description: Licia is a zero-dependency JavaScript utility library containing 455+ individual utility modules. Each module is independent and can be used standalone via the eustia build tool.
---
...
---
> Source: [liriliri/licia](https://github.com/liriliri/licia) — distributed by [TomeVault](https://tomevault.io).
