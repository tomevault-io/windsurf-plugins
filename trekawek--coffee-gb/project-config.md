---
trigger: always_on
description: This project includes a programmatic interface (`Agent`) designed for automated debugging, testing, and AI-assisted troubleshooting of Game Boy ROMs.
---
