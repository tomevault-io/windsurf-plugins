---
trigger: always_on
description: Below are some of the conventions that we are or would like to follow in NDK. This page should be considered incomplete as there are conventions being followed in the codebase which are not described here. We should add to this doc incrementally as part of relevant PRs.
---
...
---
> Source: [agencyenterprise/neurotechdevkit](https://github.com/agencyenterprise/neurotechdevkit) — distributed by [TomeVault](https://tomevault.io).
