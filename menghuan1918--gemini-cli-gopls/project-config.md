---
trigger: always_on
description: These instructions describe how to efficiently work in the Go programming language using the gopls MCP server.
---

# The gopls MCP server

These instructions describe how to efficiently work in the Go programming language using the gopls MCP server.

## Init a Go workspace

If no go.mod is detected at startup, the gopls MCP will not start. After initializing the Go workspace, you need to restart the CLI for the gopls MCP to take effect.
...
---
> Source: [Menghuan1918/gemini-cli-gopls](https://github.com/Menghuan1918/gemini-cli-gopls) — distributed by [TomeVault](https://tomevault.io).
