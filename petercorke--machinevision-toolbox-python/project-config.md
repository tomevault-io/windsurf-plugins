---
trigger: always_on
description: * docstrings are ReST format for use with Sphinx.  Check syntax with ``rstcheck`` and use the Sphinx directives for parameters, return values, etc.  See https://www.sphinx-doc.org/en/master/usage/restructuredtext/basics.html for details.
---
...
---
> Source: [petercorke/machinevision-toolbox-python](https://github.com/petercorke/machinevision-toolbox-python) — distributed by [TomeVault](https://tomevault.io).
