---
trigger: always_on
description: These instructions apply to the entire repository. Keep changes focused on the requested task and preserve unrelated worktree changes.
---
...
---
> Source: [XunMengWinter/PetNote-oss](https://github.com/XunMengWinter/PetNote-oss) — distributed by [TomeVault](https://tomevault.io).
