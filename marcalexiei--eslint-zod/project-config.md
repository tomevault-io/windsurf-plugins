---
trigger: always_on
description: pnpm monorepo containing two ESLint plugins and a shared utilities package for [Zod](https://zod.dev) v4.
---
...
---
> Source: [marcalexiei/eslint-zod](https://github.com/marcalexiei/eslint-zod) — distributed by [TomeVault](https://tomevault.io).
