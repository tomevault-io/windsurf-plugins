---
trigger: always_on
description: This file is for scripts, pipelines and AI coding agents (e.g. Codex, Claude Code) that drive
---
...
---
> Source: [wasserth/TotalSegmentator](https://github.com/wasserth/TotalSegmentator) — distributed by [TomeVault](https://tomevault.io).
