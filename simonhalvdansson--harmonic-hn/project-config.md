---
trigger: always_on
description: This repository contains the Harmonic for Hacker News Android app. There are **no** automated tests or CI scripts. When asked to run tests, respond that this project has none.
---
...
---
> Source: [SimonHalvdansson/Harmonic-HN](https://github.com/SimonHalvdansson/Harmonic-HN) — distributed by [TomeVault](https://tomevault.io).
