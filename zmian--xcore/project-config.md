---
trigger: always_on
description: This repo targets the latest iOS, Xcode, and Swift releases plus an example app.
---
...
---
> Source: [zmian/xcore](https://github.com/zmian/xcore) — distributed by [TomeVault](https://tomevault.io).
