---
trigger: always_on
description: Citizen is a MediaWiki skin (requires MW 1.43+) built on `SkinMustache`. It uses PHP for server-side rendering, Mustache templates, LESS for styles, and vanilla JS/Vue 3 for client-side interactivity via MediaWiki's ResourceLoader.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/StarCitizenTools)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/StarCitizenTools)
