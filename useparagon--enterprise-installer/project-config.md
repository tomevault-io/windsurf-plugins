---
trigger: always_on
description: This is a **Paragon Enterprise** self-hosted deployment repository — an infrastructure-as-code (IaC) toolkit for deploying Paragon microservices to Kubernetes on AWS, Azure, or GCP. It contains **no application source code**; only Helm charts, Terraform configs, and Node.js helper scripts.
---
...
---
> Source: [useparagon/enterprise-installer](https://github.com/useparagon/enterprise-installer) — distributed by [TomeVault](https://tomevault.io).
