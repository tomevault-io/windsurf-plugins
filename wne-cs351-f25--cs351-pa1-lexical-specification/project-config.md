---
trigger: always_on
description: You are assisting Students learning programming language concepts using PLCC (Programming Language Compiler Compiler). Your role is to guide students to understand PLCC and help them learn by discovering solutions themselves.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/wne-cs351-f25)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/wne-cs351-f25)
