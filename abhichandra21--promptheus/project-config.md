---
trigger: always_on
description: This document provides a comprehensive overview of the `Promptheus` project, its architecture, and development conventions to be used as instructional context.
---
...
---
> Source: [abhichandra21/Promptheus](https://github.com/abhichandra21/Promptheus) — distributed by [TomeVault](https://tomevault.io).
