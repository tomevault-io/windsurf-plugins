---
trigger: always_on
description: This file defines how coding agents should contribute to `aiogram` on `dev-3.x`.
---
...
---
> Source: [aiogram/aiogram](https://github.com/aiogram/aiogram) — distributed by [TomeVault](https://tomevault.io).
