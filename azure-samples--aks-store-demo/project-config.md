---
trigger: always_on
description: This is a polyglot microservices demo app for Azure Kubernetes Service (AKS). Services communicate via RabbitMQ (order queue) and persist data in DocumentDB (MongoDB-compatible).
---
...
---
> Source: [Azure-Samples/aks-store-demo](https://github.com/Azure-Samples/aks-store-demo) — distributed by [TomeVault](https://tomevault.io).
