---
trigger: always_on
description: 1) Build: `dotnet build MarketBoardPlugin.sln -c Debug` (Release as needed)
---
...
---
> Source: [fmauNeko/MarketBoardPlugin](https://github.com/fmauNeko/MarketBoardPlugin) — distributed by [TomeVault](https://tomevault.io).
