---
trigger: always_on
description: The GeminiContext uses Google's Gemini models for LaVague's World Model multi-modal LLM, Action Engine LLM and embedding model.
---
...
---
> Source: [lavague-ai/LaVague](https://github.com/lavague-ai/LaVague) — distributed by [TomeVault](https://tomevault.io).
