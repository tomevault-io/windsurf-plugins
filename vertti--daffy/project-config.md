---
trigger: always_on
description: Daffy is a decorator-first runtime DataFrame validation library.
---
...
---
> Source: [vertti/daffy](https://github.com/vertti/daffy) — distributed by [TomeVault](https://tomevault.io).
