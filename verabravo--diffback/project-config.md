---
trigger: always_on
description: `diffback` is a CLI tool that starts a local web server to review uncommitted git changes. It's designed for reviewing AI-generated code changes and producing structured feedback prompts.
---
