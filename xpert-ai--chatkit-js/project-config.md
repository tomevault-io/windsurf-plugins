---
trigger: always_on
description: Guidance for AI agents working in this repository. Keep changes scoped to the target
---
...
---
> Source: [xpert-ai/chatkit-js](https://github.com/xpert-ai/chatkit-js) — distributed by [TomeVault](https://tomevault.io).
