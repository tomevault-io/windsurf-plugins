---
trigger: always_on
description: Read all README files in the project root and in all subdirectories except for `lib/`.
---
...
---
> Source: [OpenCyphal/libcanard](https://github.com/OpenCyphal/libcanard) — distributed by [TomeVault](https://tomevault.io).
