---
trigger: always_on
description: `azure-functions-doctor` is a Python CLI that diagnoses common Azure Functions project issues.
---
...
---
> Source: [yeongseon/azure-functions-doctor-python](https://github.com/yeongseon/azure-functions-doctor-python) — distributed by [TomeVault](https://tomevault.io).
