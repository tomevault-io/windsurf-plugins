---
trigger: always_on
description: SvelteKit + Svelte 5 + TypeScript + TailwindCSS + Holocene design system
---
...
---
> Source: [temporalio/ui](https://github.com/temporalio/ui) — distributed by [TomeVault](https://tomevault.io).
