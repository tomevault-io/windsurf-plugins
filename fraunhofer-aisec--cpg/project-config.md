---
trigger: always_on
description: This file provides guidance to AI coding agents (Claude Code, Cursor, Codex, Gemini CLI, etc.) working in this repository.
---
...
---
> Source: [Fraunhofer-AISEC/cpg](https://github.com/Fraunhofer-AISEC/cpg) — distributed by [TomeVault](https://tomevault.io).
