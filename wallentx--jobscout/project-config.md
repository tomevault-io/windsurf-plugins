---
trigger: always_on
description: Classify a pull request into exactly one release-note label.
---
...
---
> Source: [wallentx/jobscout](https://github.com/wallentx/jobscout) — distributed by [TomeVault](https://tomevault.io).
