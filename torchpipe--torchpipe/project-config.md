---
trigger: always_on
description: 使用 uv 管理 Python 环境和依赖，阿里源已配置在 `~/.config/uv/uv.toml`：
---
...
- **torchpipe >= 0.2.0 要求 torch >= 2.2**；torch 1.x / 2.0~2.1 用户请使用 0.1.x 系列或 `dev-torch1.x` 分支
...
---
> Source: [torchpipe/torchpipe](https://github.com/torchpipe/torchpipe) — distributed by [TomeVault](https://tomevault.io).
