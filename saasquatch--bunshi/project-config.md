---
trigger: always_on
description: Bunshi is a tiny, fast, dependency-free library for creating state stores and other dependencies that lets you lift state up or push state down. It works out of the box with React, Vue, and vanilla JavaScript/TypeScript. The library is extremely lightweight with strict bundle size limits enforced during builds.
---
...
Bunshi is a tiny, fast, dependency-free library for creating state stores and other dependencies that lets you lift state up or push state down. It works out of the box with React, Vue, and vanilla JavaScript/TypeScript. The library is extremely lightweight with strict bundle size limits enforced during builds.
...
---
> Source: [saasquatch/bunshi](https://github.com/saasquatch/bunshi) — distributed by [TomeVault](https://tomevault.io).
