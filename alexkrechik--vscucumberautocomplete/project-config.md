---
trigger: always_on
description: - Behavior lives primarily in `gserver/`; `gclient/` mainly starts the language client.
---
...
---
> Source: [alexkrechik/VSCucumberAutoComplete](https://github.com/alexkrechik/VSCucumberAutoComplete) — distributed by [TomeVault](https://tomevault.io).
