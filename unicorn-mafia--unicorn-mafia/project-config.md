---
trigger: always_on
description: This is a Next.js 15 single-page application (community website). See `CLAUDE.md` for standard dev commands (`pnpm dev`, `pnpm lint`, `pnpm build`). Uses pnpm (version pinned in `packageManager` field).
---
...
---
> Source: [unicorn-mafia/unicorn-mafia](https://github.com/unicorn-mafia/unicorn-mafia) — distributed by [TomeVault](https://tomevault.io).
