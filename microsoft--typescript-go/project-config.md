---
trigger: always_on
description: This is the codebase for a native port of the TypeScript compiler and language server.
---
...
---
> Source: [microsoft/typescript-go](https://github.com/microsoft/typescript-go) — distributed by [TomeVault](https://tomevault.io).
