---
trigger: always_on
description: - Desktop app lives in `cardinal/` (React UI in `src/`, Tauri/native glue in `src-tauri/`, build output in `cardinal/dist/`).
---
...
---
> Source: [cardisoft/cardinal](https://github.com/cardisoft/cardinal) — distributed by [TomeVault](https://tomevault.io).
