---
trigger: always_on
description: Prometheus exporter that collects pricing rates from AWS, GCP, and Azure. Exports rates per instance of a given resource (`$/core/hr`, `$/GiB/hr`) as Prometheus metrics. Rates, not total spend. Go 1.25+.
---
...
---
> Source: [grafana/cloudcost-exporter](https://github.com/grafana/cloudcost-exporter) — distributed by [TomeVault](https://tomevault.io).
