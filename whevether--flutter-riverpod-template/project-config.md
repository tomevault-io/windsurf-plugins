---
trigger: always_on
description: 目的：快速让 AI 编码助手理解本仓库的架构、关键约定和常见改动点，使其在提交补丁或生成代码时更可靠。
---
...
---
> Source: [whevether/flutter_riverpod_template](https://github.com/whevether/flutter_riverpod_template) — distributed by [TomeVault](https://tomevault.io).
