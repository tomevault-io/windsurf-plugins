---
trigger: always_on
description: Single-file Python 3 CLI app (`breathe.py`) that paces resonance breathing for HFrEF vagal training. macOS and Windows 11 supported, stdlib only, no dependencies.
---
...
---
> Source: [VergeWarlord/breathe-cli-656](https://github.com/VergeWarlord/breathe-cli-656) — distributed by [TomeVault](https://tomevault.io).
