---
trigger: always_on
description: Dioxus is a cross-platform UI framework for Rust, similar to React. It compiles to web (WASM), desktop (webview), mobile (iOS/Android), and native (GPU-rendered).
---
...
---
> Source: [DioxusLabs/dioxus](https://github.com/DioxusLabs/dioxus) — distributed by [TomeVault](https://tomevault.io).
