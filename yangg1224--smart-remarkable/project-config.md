---
trigger: always_on
description: This file provides guidance to Claude Code (claude.ai/code) and other similar tools when working with code in this repository.
---
...
---
> Source: [yangg1224/smart_remarkable](https://github.com/yangg1224/smart_remarkable) — distributed by [TomeVault](https://tomevault.io).
