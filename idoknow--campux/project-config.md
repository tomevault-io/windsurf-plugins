---
trigger: always_on
description: Read [DESIGN.md](./DESIGN.md) before changing signed-in product UI. It is the current product design source of truth: Campux should feel like a compact, quiet internal operating tool with pale gray canvas, centered content, white information surfaces, understated navigation, and natural-width tabs.
---
...
---
> Source: [idoknow/Campux](https://github.com/idoknow/Campux) — distributed by [TomeVault](https://tomevault.io).
