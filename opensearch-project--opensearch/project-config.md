---
trigger: always_on
description: - `server` - Core of the OpenSearch server. Includes the distributed system framework as well as most of the search and indexing functionality.
---
...
---
> Source: [opensearch-project/OpenSearch](https://github.com/opensearch-project/OpenSearch) — distributed by [TomeVault](https://tomevault.io).
