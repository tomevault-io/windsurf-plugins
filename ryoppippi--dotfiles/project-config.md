---
trigger: always_on
description: ryoppippi's personal dotfiles managed via **Nix Flake** (nix-darwin + home-manager).
---
...
---
> Source: [ryoppippi/dotfiles](https://github.com/ryoppippi/dotfiles) — distributed by [TomeVault](https://tomevault.io).
