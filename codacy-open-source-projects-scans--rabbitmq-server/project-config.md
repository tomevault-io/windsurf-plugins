---
trigger: always_on
description: This repository contains open source [RabbitMQ](https://www.rabbitmq.com/), a multi-protocol
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/codacy-open-source-projects-scans)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/codacy-open-source-projects-scans)
