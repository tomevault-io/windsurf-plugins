---
trigger: always_on
description: Docker images and docker-compose setup for running CKAN (open data portal) on Alpine Linux. Images are published to Docker Hub (`keitaro/ckan`) and GitHub Container Registry (`ghcr.io/keitaroinc/ckan`).
---
...
---
> Source: [keitaroinc/docker-ckan](https://github.com/keitaroinc/docker-ckan) — distributed by [TomeVault](https://tomevault.io).
