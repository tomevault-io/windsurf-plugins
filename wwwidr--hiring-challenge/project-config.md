---
trigger: always_on
description: - Primary branch is `main` (not `master`). Always branch from `main`, target PRs to `main`.
---
...
---
> Source: [wwwidr/hiring-challenge](https://github.com/wwwidr/hiring-challenge) — distributed by [TomeVault](https://tomevault.io).
