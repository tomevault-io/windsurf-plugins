---
trigger: always_on
description: A DankMaterialShell (DMS) launcher plugin for searching the web with 23+ built-in search engines and support for custom search engines, including integration with 13,000+ DuckDuckGo !bangs.
---
...
---
> Source: [devnullvoid/dms-web-search](https://github.com/devnullvoid/dms-web-search) — distributed by [TomeVault](https://tomevault.io).
