---
trigger: always_on
description: Whenever you find a new rule that applies to this project, add it to this file.
---
...
---
> Source: [serbanghita/Mobile-Detect](https://github.com/serbanghita/Mobile-Detect) — distributed by [TomeVault](https://tomevault.io).
