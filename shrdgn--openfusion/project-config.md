---
trigger: always_on
description: `openfusion` is a single, stateless Python (3.11+) FastAPI service — an OpenAI-compatible
---
...
---
> Source: [shrdgn/openfusion](https://github.com/shrdgn/openfusion) — distributed by [TomeVault](https://tomevault.io).
