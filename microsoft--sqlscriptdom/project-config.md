---
trigger: always_on
description: This repository keeps its canonical Copilot instruction files in the `.github` folder and its reusable agent skills in `.agents/skills`.
---
...
---
> Source: [microsoft/SqlScriptDOM](https://github.com/microsoft/SqlScriptDOM) — distributed by [TomeVault](https://tomevault.io).
