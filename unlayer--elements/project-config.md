---
trigger: always_on
description: A monorepo providing React components that render to email-safe HTML (tables for Outlook/Gmail), responsive web HTML, and print/PDF HTML. The core value: write JSX once, get production-ready HTML for any output target.
---
...
---
> Source: [unlayer/elements](https://github.com/unlayer/elements) — distributed by [TomeVault](https://tomevault.io).
