---
trigger: always_on
description: - `packages/core/`: core TypeScript library (entry at `packages/core/index.ts`, logic in `packages/core/lib/`, aggregators in `packages/core/lib/aggregators/`).
---
...
---
> Source: [withfabricxyz/spandex](https://github.com/withfabricxyz/spandex) — distributed by [TomeVault](https://tomevault.io).
