# AI instruction files for wga

> Sourced from [blackfyre/wga](https://github.com/blackfyre/wga), graded against the public Tome Standard and kept consistent across every major platform by [TomeVault](https://tomevault.io)
