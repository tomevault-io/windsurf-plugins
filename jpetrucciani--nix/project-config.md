---
trigger: always_on
description: - `flake.nix`, `default.nix`, `overlays.nix`, `home.nix`: core entrypoints for the flake, pinned nixpkgs, overlays, and home-manager config.
---
...
---
> Source: [jpetrucciani/nix](https://github.com/jpetrucciani/nix) — distributed by [TomeVault](https://tomevault.io).
