---
trigger: always_on
description: This is a **Modbus TCP Server** written in Python that serves as a mock Modbus slave system for testing Modbus master implementations. It allows predefined register values via JSON configuration files and supports both TCP and UDP protocols, with optional TLS encryption.
---
...
---
> Source: [cybcon/modbus-server](https://github.com/cybcon/modbus-server) — distributed by [TomeVault](https://tomevault.io).
