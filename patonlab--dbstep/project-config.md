---
trigger: always_on
description: DBSTEP (DFT-Based Steric Parameters) is a Python package for computing steric parameters from chemical structures. It calculates Sterimol parameters (L, Bmin, Bmax), percent buried volume, Sterimol2Vec, and Vol2Vec parameters from molecular structure files and quantum chemistry output files.
---
...
---
> Source: [patonlab/DBSTEP](https://github.com/patonlab/DBSTEP) — distributed by [TomeVault](https://tomevault.io).
