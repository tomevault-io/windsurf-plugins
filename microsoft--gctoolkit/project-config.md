---
trigger: always_on
description: GCToolKit is a Java-based toolkit for analyzing Garbage Collection logs from various JVM implementations. The project uses Maven as its build system and is structured as a multi-module project.
---
...
---
> Source: [microsoft/gctoolkit](https://github.com/microsoft/gctoolkit) — distributed by [TomeVault](https://tomevault.io).
