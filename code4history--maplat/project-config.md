---
trigger: always_on
description: These principles govern how an AI coding agent should operate in this repository, regardless of which tool (Claude Code, Codex, or others) is used.
---
...
---
> Source: [code4history/Maplat](https://github.com/code4history/Maplat) — distributed by [TomeVault](https://tomevault.io).
