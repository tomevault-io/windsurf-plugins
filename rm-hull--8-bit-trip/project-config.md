---
trigger: always_on
description: **8-bit Trip** is a React application that generates and visualizes 8-bit style audio (bytebeat). It allows users to input mathematical formulas which are processed in real-time to create audio waveforms. The application state (algorithm and sample rate) is encoded in the URL, allowing for easy sharing of compositions.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/rm-hull)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/rm-hull)
