---
trigger: always_on
description: - 更新中文翻译流水线（glossary/TM/prompt）
---
...
---
> Source: [liyupi/openclaw-guide](https://github.com/liyupi/openclaw-guide) — distributed by [TomeVault](https://tomevault.io).
