---
trigger: always_on
description: 给所有编程智能体（Claude Code、Codex、Copilot 等）的项目工作指南。
---
...
---
> Source: [typex-ink/Typex](https://github.com/typex-ink/Typex) — distributed by [TomeVault](https://tomevault.io).
