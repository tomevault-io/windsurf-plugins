---
trigger: always_on
description: QMCkl (Quantum Monte Carlo kernel library) is a C/Fortran library that implements the main kernels of Quantum Monte Carlo (QMC) methods. The library provides a standard API with implementations optimized for modern hardware.
---
...
---
> Source: [TREX-CoE/qmckl](https://github.com/TREX-CoE/qmckl) — distributed by [TomeVault](https://tomevault.io).
