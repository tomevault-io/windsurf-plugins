# AI instruction files for boffin

> Sourced from [MicSm/boffin](https://github.com/MicSm/boffin), graded against the public Tome Standard and kept consistent across every major platform by [TomeVault](https://tomevault.io)
