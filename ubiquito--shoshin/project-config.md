---
trigger: always_on
description: Static HTML/CSS/JS. No framework. No build step. No tracking.
---
...
---
> Source: [ubiquito/shoshin](https://github.com/ubiquito/shoshin) — distributed by [TomeVault](https://tomevault.io).
