---
trigger: always_on
description: To use the Google Gemini API, create an account on [Google AI Studio](https://ai.google.dev/) and generate your API key from the API keys section.
---
...
---
> Source: [microsoft/UFO](https://github.com/microsoft/UFO) — distributed by [TomeVault](https://tomevault.io).
