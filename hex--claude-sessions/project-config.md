---
trigger: always_on
description: This is a Claude Code session managed by the cs tool. Session metadata lives in the .cs/ directory. The session root is your workspace for project files.
---
...
---
> Source: [hex/claude-sessions](https://github.com/hex/claude-sessions) — distributed by [TomeVault](https://tomevault.io).
