---
trigger: always_on
description: Guidance for coding agents working in `github.com/algolia/cli`.
---
...
---
> Source: [algolia/cli](https://github.com/algolia/cli) — distributed by [TomeVault](https://tomevault.io).
