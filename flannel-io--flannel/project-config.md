---
trigger: always_on
description: Manages forwarding rules and masquerading using either iptables or nftables.
---
...
---
> Source: [flannel-io/flannel](https://github.com/flannel-io/flannel) — distributed by [TomeVault](https://tomevault.io).
