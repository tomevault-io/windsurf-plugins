---
trigger: always_on
description: I have thousands of 3D objects in various formats of meshes, level of detail, formats etc. I want to use pytorch to train a model to convert a high fidelity mesh to a lower level of detail, with minimal loss.
---
...
---
> Source: [martinnormark/neural-mesh-simplification](https://github.com/martinnormark/neural-mesh-simplification) — distributed by [TomeVault](https://tomevault.io).
