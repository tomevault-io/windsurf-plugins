---
trigger: always_on
description: Agent-OS is a **governance-first kernel for AI agents** — a Python framework providing policy enforcement, semantic intent classification, identity management, and execution control for autonomous AI agents.
---
...
---
> Source: [imran-siddique/agent-os](https://github.com/imran-siddique/agent-os) — distributed by [TomeVault](https://tomevault.io).
