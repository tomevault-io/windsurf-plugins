---
trigger: always_on
description: Flutter mobile app for **offline AI pet breed classification** using TensorFlow Lite. Identifies dog and cat breeds via camera/gallery with on-device ML inference. Uses MobileNet quantized model for privacy and speed without internet connectivity.
---
