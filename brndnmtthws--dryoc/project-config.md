---
trigger: always_on
description: `dryoc` is a pure-Rust cryptography crate intended to be mostly compatible with
---
...
---
> Source: [brndnmtthws/dryoc](https://github.com/brndnmtthws/dryoc) — distributed by [TomeVault](https://tomevault.io).
