---
trigger: always_on
description: Use `uv run` to invoke all tools (pytest, ruff, pyright, etc.). For example:
---
...
---
> Source: [yairchu/moops](https://github.com/yairchu/moops) — distributed by [TomeVault](https://tomevault.io).
