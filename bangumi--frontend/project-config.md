---
trigger: always_on
description: 这是 Bangumi 新前端项目，使用 React、TypeScript、Vite 和 pnpm workspace。
---
...
---
> Source: [bangumi/frontend](https://github.com/bangumi/frontend) — distributed by [TomeVault](https://tomevault.io).
