---
trigger: always_on
description: - As requested on 2026-09-05, suspend use of `ponytail` for HUNDUN-FLOW until the user explicitly re-enables it.
---
...
---
> Source: [windcicada/Hundun-Flow](https://github.com/windcicada/Hundun-Flow) — distributed by [TomeVault](https://tomevault.io).
