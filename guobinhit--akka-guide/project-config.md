---
trigger: always_on
description: 为了使用代理（`Agents`），你需要将以下依赖添加到你的项目中：
---
...
---
> Source: [guobinhit/akka-guide](https://github.com/guobinhit/akka-guide) — distributed by [TomeVault](https://tomevault.io).
