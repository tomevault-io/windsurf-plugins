---
trigger: always_on
description: <!-- Part 1 & 2: Portable across repos. Do NOT add repo-specific rules here. -->
---
...
---
> Source: [bpmnkit/monorepo](https://github.com/bpmnkit/monorepo) — distributed by [TomeVault](https://tomevault.io).
