---
trigger: always_on
description: The instructions for this repository are in [`AGENTS.md`](../AGENTS.md) at the repository
---
...
---
> Source: [pyvista/pyvista](https://github.com/pyvista/pyvista) — distributed by [TomeVault](https://tomevault.io).
