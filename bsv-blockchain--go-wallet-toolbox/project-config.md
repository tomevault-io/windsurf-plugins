---
trigger: always_on
description: All contributors must read `.github/AGENTS.md` for complete guidelines. If any rule here conflicts with that file, **AGENTS.md** takes precedence.
---
...
---
> Source: [bsv-blockchain/go-wallet-toolbox](https://github.com/bsv-blockchain/go-wallet-toolbox) — distributed by [TomeVault](https://tomevault.io).
