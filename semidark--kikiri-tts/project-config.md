---
trigger: always_on
description: kikiri-tts (formerly `kokoro-deutsch`; the Python package and published HuggingFace model retain the old name) is a training recipe for fine-tuning [Kokoro TTS](https://github.com/hexgrad/kokoro) (82M parameters, based on StyleTTS 2) for German. The project contains:
---
...
---
> Source: [semidark/kikiri-tts](https://github.com/semidark/kikiri-tts) — distributed by [TomeVault](https://tomevault.io).
