---
trigger: always_on
description: Always use `bundle` and `rake` commands, not any third-party packaging tools.
---
...
---
> Source: [elastic/elasticsearch-ruby](https://github.com/elastic/elasticsearch-ruby) — distributed by [TomeVault](https://tomevault.io).
