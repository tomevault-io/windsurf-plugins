---
trigger: always_on
description: These standards apply to all Copilot interactions including code generation and PR review.
---
...
---
> Source: [zaxbysauce/opencode-swarm](https://github.com/zaxbysauce/opencode-swarm) — distributed by [TomeVault](https://tomevault.io).
