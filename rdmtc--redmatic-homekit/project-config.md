---
trigger: always_on
description: Instructions for AI coding agents (Claude Code, etc.) working in this
---
...
---
> Source: [rdmtc/RedMatic-HomeKit](https://github.com/rdmtc/RedMatic-HomeKit) — distributed by [TomeVault](https://tomevault.io).
