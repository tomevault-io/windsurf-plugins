---
trigger: always_on
description: JavaScript/TypeScript library for drawing, animating, and interacting with shapes, text, plots, and equations in a browser using WebGL. No runtime dependencies.
---
...
| Run specific test | `docker exec figureone_dev npx jest path/to/file.test.ts` |
...
- Test files: `*.test.ts` colocated with source, use Jest with jsdom environment
...
---
> Source: [airladon/FigureOne](https://github.com/airladon/FigureOne) — distributed by [TomeVault](https://tomevault.io).
