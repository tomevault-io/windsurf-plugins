---
trigger: always_on
description: This directory customizes the system prompt for Copilot CLI **agent host**
---
...
---
> Source: [devdotfast/review](https://github.com/devdotfast/review) — distributed by [TomeVault](https://tomevault.io).
