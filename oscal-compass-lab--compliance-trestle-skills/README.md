...
> Tome by [oscal-compass-lab](https://github.com/oscal-compass-lab/compliance-trestle-skills), graded and kept true across every major AI platform by [TomeVault](https://tomevault.io)
...
Original source: `.cursor/rules/*.mdc` in [oscal-compass-lab/compliance-trestle-skills](https://github.com/oscal-compass-lab/compliance-trestle-skills).
