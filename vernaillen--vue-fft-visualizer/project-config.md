---
trigger: always_on
description: **Never commit automatically.** Always let the user create commits themselves. Prepare changes and stage files if needed, but do not run `git commit`.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/vernaillen) — claim your Tome and manage your conversions.
