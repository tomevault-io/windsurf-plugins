---
trigger: always_on
description: When a template value has a component-level override falling back to a global default
---
...
---
> Source: [kedacore/charts](https://github.com/kedacore/charts) — distributed by [TomeVault](https://tomevault.io).
