---
trigger: always_on
description: CLI tool for managing Weaviate vector databases. Built with Python + Click.
---
...
---
> Source: [weaviate/weaviate-cli](https://github.com/weaviate/weaviate-cli) — distributed by [TomeVault](https://tomevault.io).
