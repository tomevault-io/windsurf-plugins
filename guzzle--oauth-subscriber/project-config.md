---
trigger: always_on
description: - All code must remain compatible with PHP 7.4. Run PHPStan and PHP-CS-Fixer
---
...
- To resist, `__serialize()` and `__unserialize()` both throw
  ...
  unserialized counterpart, implemented directly on the guarded class.
...
---
> Source: [guzzle/oauth-subscriber](https://github.com/guzzle/oauth-subscriber) — distributed by [TomeVault](https://tomevault.io).
