---
trigger: always_on
description: This file provides guidance to all coding agents (Claude Code, Codex, Gemini, Cursor, etc.) working in this repository.
---
...
---
> Source: [yfge/agentskill.work](https://github.com/yfge/agentskill.work) — distributed by [TomeVault](https://tomevault.io).
