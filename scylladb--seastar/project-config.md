---
trigger: always_on
description: The project uses CMake with ninja as the build system. Build directories are located in `build/<mode>`.
---
...
---
> Source: [scylladb/seastar](https://github.com/scylladb/seastar) — distributed by [TomeVault](https://tomevault.io).
