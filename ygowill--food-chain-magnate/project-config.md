---
trigger: always_on
description: - `core/`: engine-first, reusable gameplay logic (avoid UI/node dependencies). Key areas include `core/engine/`, `core/state/`, `core/actions/`, `core/rules/`, `core/map/`, and `core/tests/` (pure logic tests).
---
...
---
> Source: [ygowill/food_chain_magnate](https://github.com/ygowill/food_chain_magnate) — distributed by [TomeVault](https://tomevault.io).
