---
trigger: always_on
description: This repository packages the `laborer-companion` skill. When a user asks about workplace conflict, HR/manager language, performance reviews, PIPs, layoffs, severance, overtime, salary negotiation, labor-law orientation, job search, or interview strategy, use `skills/laborer-companion/SKILL.md`.
---
