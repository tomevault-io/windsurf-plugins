---
trigger: always_on
description: - Treat `src/WindowsFormsLifetime` as the published library. Keep its supported target frameworks as `net8.0-windows`, `net9.0-windows`, and `net10.0-windows`.
---
...
---
> Source: [alex-oswald/WindowsFormsLifetime](https://github.com/alex-oswald/WindowsFormsLifetime) — distributed by [TomeVault](https://tomevault.io).
