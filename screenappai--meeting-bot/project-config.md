---
trigger: always_on
description: This is a TypeScript-based meeting bot application that automates joining and recording meetings for Google Meet, Microsoft Teams, and Zoom. The project uses Playwright for browser automation, Redis for message brokering, and follows a modular architecture with abstract bot classes.
---
