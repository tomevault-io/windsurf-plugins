---
trigger: always_on
description: 给 AI agent 的使用与维护指引。人只需要读 [README](README.md)。
---
...
---
> Source: [webkubor/talk-skills](https://github.com/webkubor/talk-skills) — distributed by [TomeVault](https://tomevault.io).
