---
trigger: always_on
description: > **Target toolchain:** Go 1.25.x (latest point-release: **1.25.1**).
---
...
---
> Source: [BrianLeishman/go-imap](https://github.com/BrianLeishman/go-imap) — distributed by [TomeVault](https://tomevault.io).
