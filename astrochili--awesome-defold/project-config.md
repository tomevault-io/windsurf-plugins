---
trigger: always_on
description: When asked to process the resource inbox, use GitHub issue
---
...
---
> Source: [astrochili/awesome-defold](https://github.com/astrochili/awesome-defold) — distributed by [TomeVault](https://tomevault.io).
