---
trigger: always_on
description: - Keep the default pipeline local and deterministic.
---
...
---
> Source: [wangxin6x/AutoVideo-Agent](https://github.com/wangxin6x/AutoVideo-Agent) — distributed by [TomeVault](https://tomevault.io).
