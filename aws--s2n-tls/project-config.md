---
trigger: always_on
description: This guide provides context for bumping the version of the s2n-tls Rust bindings.
---
...
---
> Source: [aws/s2n-tls](https://github.com/aws/s2n-tls) — distributed by [TomeVault](https://tomevault.io).
