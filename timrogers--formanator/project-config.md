---
trigger: always_on
description: - `formanator` is a Rust CLI for working with Forma claims, with optional MCP server support.
---
...
---
> Source: [timrogers/formanator](https://github.com/timrogers/formanator) — distributed by [TomeVault](https://tomevault.io).
