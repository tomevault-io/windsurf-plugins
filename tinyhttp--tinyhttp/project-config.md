---
trigger: always_on
description: Handles route matching and middleware execution. Uses `regexparam` for path-to-regexp style routing.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/tinyhttp)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/tinyhttp)
