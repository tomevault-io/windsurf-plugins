---
trigger: always_on
description: This package is the Dope Ghost theme. In the standalone mirror repository, this tree is pushed from `TryGhost/Themes/packages/dope` by subtree sync; make durable theme-content changes in `TryGhost/Themes` unless the task is explicitly repo-level metadata or GitHub settings.
---
...
---
> Source: [TryGhost/Dope](https://github.com/TryGhost/Dope) — distributed by [TomeVault](https://tomevault.io).
