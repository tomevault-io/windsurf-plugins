---
trigger: always_on
description: Skills are available in `.agents/skills/` directory following Agent Skills specification. Each skill is self-contained with instructions, examples, and constraints.
---
