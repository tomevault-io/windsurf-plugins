---
trigger: always_on
description: - **Never amend commits** - always create new commits for fixes
---
...
---
> Source: [wesm/archived-agent-session-viewer](https://github.com/wesm/archived-agent-session-viewer) — distributed by [TomeVault](https://tomevault.io).
