---
trigger: always_on
description: - `lib/` hosts the analyzer plugin logic, with rule implementations and shared utilities; `bin/flutter_hooks_lint.dart` exposes the CLI entry point.
---
...
---
> Source: [mj-hd/flutter_hooks_lint_plugin](https://github.com/mj-hd/flutter_hooks_lint_plugin) — distributed by [TomeVault](https://tomevault.io).
