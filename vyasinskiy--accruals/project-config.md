---
trigger: always_on
description: - **Обязательно**: Основные сервисы (например, `Accountant`) никогда не должны содержать логику форматирования или доставки для конкретных интерфейсов (таких как HTML-разметка Telegram или отправка боту).
---
...
---
> Source: [vyasinskiy/accruals](https://github.com/vyasinskiy/accruals) — distributed by [TomeVault](https://tomevault.io).
