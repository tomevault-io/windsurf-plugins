---
trigger: always_on
description: Kelvin is a Go daemon that adjusts Philips Hue lights to schedules derived
---
...
---
> Source: [stefanwichmann/kelvin](https://github.com/stefanwichmann/kelvin) — distributed by [TomeVault](https://tomevault.io).
