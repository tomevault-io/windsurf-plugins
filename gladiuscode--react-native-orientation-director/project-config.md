---
trigger: always_on
description: React Native turbo-module library (Kotlin + ObjC, new architecture only). Monorepo with Yarn workspaces.
---
...
---
> Source: [gladiuscode/react-native-orientation-director](https://github.com/gladiuscode/react-native-orientation-director) — distributed by [TomeVault](https://tomevault.io).
