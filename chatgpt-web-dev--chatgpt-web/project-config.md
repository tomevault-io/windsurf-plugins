---
trigger: always_on
description: - `src/`: Vue 3 frontend source (components, store, router, locales, styles).
---
...
---
> Source: [chatgpt-web-dev/chatgpt-web](https://github.com/chatgpt-web-dev/chatgpt-web) — distributed by [TomeVault](https://tomevault.io).
