---
trigger: always_on
description: - Assume command examples are run from the repository root. Prefer paths like `python3 scripts/train.py` and `python3 scripts/play.py` in docs and generated commands.
---
...
---
> Source: [MatPoliquin/stable-retro-scripts](https://github.com/MatPoliquin/stable-retro-scripts) — distributed by [TomeVault](https://tomevault.io).
