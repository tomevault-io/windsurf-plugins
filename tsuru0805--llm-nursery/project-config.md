---
trigger: always_on
description: > 人看版(概念/玩法/快速开始)在 [README.md](README.md)。本文件只放结构化工程事实:
---
...
---
> Source: [tsuru0805/llm-nursery](https://github.com/tsuru0805/llm-nursery) — distributed by [TomeVault](https://tomevault.io).
