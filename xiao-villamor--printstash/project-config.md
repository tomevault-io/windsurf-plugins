---
trigger: always_on
description: Self-hosted 3D print library (models, G-code revisions, printers, filament).
---
...
---
> Source: [xiao-villamor/PrintStash](https://github.com/xiao-villamor/PrintStash) — distributed by [TomeVault](https://tomevault.io).
