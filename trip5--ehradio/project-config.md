---
trigger: always_on
description: - **This file**: If you wish to NOT use this file, feel free to add it to your own private exclusions (`.git/info/exclude`).  Please do not try to sync your own version of this file back in a PR to `ehRadio:dev`.
---
...
---
> Source: [trip5/ehRadio](https://github.com/trip5/ehRadio) — distributed by [TomeVault](https://tomevault.io).
