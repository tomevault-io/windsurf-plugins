---
trigger: always_on
description: - `resto` is a STAC-compliant geospatial search engine and catalog, primarily for Earth Observation data but extensible to any spatiotemporal metadata.
---
...
---
> Source: [jjrom/resto](https://github.com/jjrom/resto) — distributed by [TomeVault](https://tomevault.io).
