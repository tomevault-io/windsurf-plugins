---
trigger: always_on
description: - **Minimize comments.** Code should be self-explanatory. Only add comments when the logic is truly non-obvious.
---
...
---
> Source: [andremichelle/openDAW](https://github.com/andremichelle/openDAW) — distributed by [TomeVault](https://tomevault.io).
