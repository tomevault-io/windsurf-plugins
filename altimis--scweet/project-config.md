---
trigger: always_on
description: The importable package. Every module is flat here, with no sub-package. `pip install Scweet` installs this
---
...
---
> Source: [Altimis/Scweet](https://github.com/Altimis/Scweet) — distributed by [TomeVault](https://tomevault.io).
