---
trigger: always_on
description: Nice3point.Revit.Templates ships as NuGet packages: the set of `dotnet new` project templates for creating Revit add-ins, a custom MSBuild SDK for building them.
---
