---
trigger: always_on
description: Instructions for AI agents working on benchmarks in this project.
---
...
---
> Source: [flipbit/tokenizer](https://github.com/flipbit/tokenizer) — distributed by [TomeVault](https://tomevault.io).
