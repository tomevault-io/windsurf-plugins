...
**Note**: Tool names may appear with prefixes depending on MCP client (e.g., `mcp_sap-docs-remote_search`)
...
## Integration Points
- **Community**: LiQL API (search via MATCHES + post content retrieval)
