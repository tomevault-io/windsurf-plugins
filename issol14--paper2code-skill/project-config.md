---
trigger: always_on
description: > This file is specifically designed for LLM agents (Claude, GPT, etc.) to quickly understand and work with this repository.
---
...
---
> Source: [issol14/paper2code-skill](https://github.com/issol14/paper2code-skill) — distributed by [TomeVault](https://tomevault.io).
