---
trigger: always_on
description: Guide for coding agents working in this repo. Read this before touching code.
---
...
---
> Source: [openvax/mhcflurry](https://github.com/openvax/mhcflurry) — distributed by [TomeVault](https://tomevault.io).
