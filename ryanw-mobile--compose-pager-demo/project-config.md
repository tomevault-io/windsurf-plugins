---
trigger: always_on
description: This is a Jetpack Compose Android application that demonstrates how to implement an **Endless Horizontal Pager** with advanced animations and haptic feedback. It serves as a reference for using the modern Jetpack Compose `HorizontalPager` without the need for traditional XML views or complex adapters.
---
...
---
> Source: [ryanw-mobile/compose-pager-demo](https://github.com/ryanw-mobile/compose-pager-demo) — distributed by [TomeVault](https://tomevault.io).
