---
trigger: always_on
description: make compile [BOARD=<board>]              # Compile firmware
---
...
---
> Source: [yoziru/esphome-tesla-ble](https://github.com/yoziru/esphome-tesla-ble) — distributed by [TomeVault](https://tomevault.io).
