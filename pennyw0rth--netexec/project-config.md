---
trigger: always_on
description: - Do not run active security or functional tests against a host or network unless the user explicitly identifies it as an authorized target.
---
...
---
> Source: [Pennyw0rth/NetExec](https://github.com/Pennyw0rth/NetExec) — distributed by [TomeVault](https://tomevault.io).
