---
trigger: always_on
description: Claude Code Hub 是一个 Claude Code API 代理中转服务平台，用于统一管理多个 CC 服务提供商，提供智能负载均衡、用户权限管理和使用统计功能。
---
...
---
> Source: [zsio/claude-code-hub](https://github.com/zsio/claude-code-hub) — distributed by [TomeVault](https://tomevault.io).
