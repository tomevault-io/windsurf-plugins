---
trigger: always_on
description: NaverPay's Stylelint config for CSS/SCSS. ESM (**consumers must use ESM** — `.mjs` config or
---
...
---
> Source: [NaverPayDev/code-style](https://github.com/NaverPayDev/code-style) — distributed by [TomeVault](https://tomevault.io).
