---
trigger: always_on
description: The `global` section in `charts/datahub/values.yaml` follows a two-tier naming convention:
---
...
---
> Source: [acryldata/datahub-helm](https://github.com/acryldata/datahub-helm) — distributed by [TomeVault](https://tomevault.io).
