---
trigger: always_on
description: - **Run all commands via**: `./script/run <cmd>` (sets up dev environment)
---
...
---
> Source: [oxidize-rb/rb-sys](https://github.com/oxidize-rb/rb-sys) — distributed by [TomeVault](https://tomevault.io).
