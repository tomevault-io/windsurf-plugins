---
trigger: always_on
description: wfmash is a tool for computing whole-genome alignments using mashmap for mapping and WFA (wavefront alignment) for base-level alignment.
---
...
---
> Source: [waveygang/wfmash](https://github.com/waveygang/wfmash) — distributed by [TomeVault](https://tomevault.io).
