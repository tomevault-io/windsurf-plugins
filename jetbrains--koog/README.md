...
Original source: `AGENTS.md` in [JetBrains/koog](https://github.com/JetBrains/koog).
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/JetBrains/koog](https://github.com/JetBrains/koog)
