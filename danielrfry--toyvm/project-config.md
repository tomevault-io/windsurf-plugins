---
trigger: always_on
description: - This repository is an Xcode project for a single macOS command-line target: `toyvm`.
---
...
---
> Source: [danielrfry/toyvm](https://github.com/danielrfry/toyvm) — distributed by [TomeVault](https://tomevault.io).
