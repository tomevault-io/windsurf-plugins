---
trigger: always_on
description: ImPlot3D is a C++ library for 3D plotting, extending Dear ImGui. It is designed to be efficient, flexible, and easy to use for real-time 3D data visualization.
---
...
---
> Source: [brenocq/implot3d](https://github.com/brenocq/implot3d) — distributed by [TomeVault](https://tomevault.io).
