---
trigger: always_on
description: This repo is a Go workspace (`go.work`) containing multiple Go modules, built using make.
---
...
---
> Source: [opentdf/platform](https://github.com/opentdf/platform) — distributed by [TomeVault](https://tomevault.io).
