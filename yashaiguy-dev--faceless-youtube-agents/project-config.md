---
trigger: always_on
description: When the user asks to create YouTube videos, run the video factory, clone a channel, or process scripts into videos:
---
...
---
> Source: [yashaiguy-dev/faceless-youtube-agents](https://github.com/yashaiguy-dev/faceless-youtube-agents) — distributed by [TomeVault](https://tomevault.io).
