---
trigger: always_on
description: - `.agents/AGENTS.md` and `.agents/rules/*.mdc` are source of truth. After editing them, run `bun install` to sync. Never edit `SKILL.md` directly.
---
...
---
> Source: [udecode/plate-playground-template](https://github.com/udecode/plate-playground-template) — distributed by [TomeVault](https://tomevault.io).
