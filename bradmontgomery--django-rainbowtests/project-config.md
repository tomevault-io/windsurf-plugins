---
trigger: always_on
description: This repository is a small Django test-runner package intended to make test output more human-friendly by highlighting the most relevant portions of tracebacks and messages.
---
...
---
> Source: [bradmontgomery/django-rainbowtests](https://github.com/bradmontgomery/django-rainbowtests) — distributed by [TomeVault](https://tomevault.io).
