---
trigger: always_on
description: Start with `.agents/domain.md`, then use `.agents/CONTEXT-MAP.md` to find the context glossaries relevant to the work.
---
...
---
> Source: [vite-hub/vitehub](https://github.com/vite-hub/vitehub) — distributed by [TomeVault](https://tomevault.io).
