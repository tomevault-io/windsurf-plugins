---
trigger: always_on
description: Purpose: AI behavior rules for this repository.
---
...
---
> Source: [jcustenborder/kafka-connect-transform-common](https://github.com/jcustenborder/kafka-connect-transform-common) — distributed by [TomeVault](https://tomevault.io).
