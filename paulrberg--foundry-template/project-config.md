---
trigger: always_on
description: Foundry-based template for developing Solidity smart contracts. Dependencies are managed as Node.js packages (via Bun)
---
...
---
> Source: [PaulRBerg/foundry-template](https://github.com/PaulRBerg/foundry-template) — distributed by [TomeVault](https://tomevault.io).
