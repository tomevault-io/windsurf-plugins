...
Original source: `AGENTS.md` in [nolabs-ai/nono](https://github.com/nolabs-ai/nono).
...
```
npx tomevault install nolabs-ai/nono
```
Source: [github.com/nolabs-ai/nono](https://github.com/nolabs-ai/nono).
