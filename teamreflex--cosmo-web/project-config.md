---
trigger: always_on
description: Effect-TS service that runs Apollo's cron-scheduled background tasks (syncing gravities, members, FX rates, price stats; draining outboxes; clearing stats). Runs on Bun via `BunRuntime`.
---
...
---
> Source: [teamreflex/cosmo-web](https://github.com/teamreflex/cosmo-web) — distributed by [TomeVault](https://tomevault.io).
