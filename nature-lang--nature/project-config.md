---
trigger: always_on
description: - `src/`: C compiler front/mid/back-end (AST, CFG/SSA/LIR, lowering, semantic analysis).
---
...
---
> Source: [nature-lang/nature](https://github.com/nature-lang/nature) — distributed by [TomeVault](https://tomevault.io).
