---
trigger: always_on
description: Dingo: gravitational-wave parameter inference using neural posterior estimation.
---
...
---
> Source: [dingo-gw/dingo](https://github.com/dingo-gw/dingo) — distributed by [TomeVault](https://tomevault.io).
