---
trigger: always_on
description: - https://docs.daft.ai for the user-facing API docs
---
...
---
> Source: [Eventual-Inc/Daft](https://github.com/Eventual-Inc/Daft) — distributed by [TomeVault](https://tomevault.io).
