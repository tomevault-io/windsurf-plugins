---
trigger: always_on
description: Async caching layer for `eth` RPC data (blocks, receipts, headers).
---
...
---
> Source: [vicnaum/shinode](https://github.com/vicnaum/shinode) — distributed by [TomeVault](https://tomevault.io).
