---
trigger: always_on
description: 1. **Think before coding.** State assumptions explicitly. If uncertain, ask rather than guess. When multiple interpretations exist, present them - don't pick silently.
---
...
---
> Source: [platformplatform/PlatformPlatform](https://github.com/platformplatform/PlatformPlatform) — distributed by [TomeVault](https://tomevault.io).
