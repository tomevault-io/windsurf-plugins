---
trigger: always_on
description: - Build/Type check: `pnpm run typecheck`
---
...
---
> Source: [wen-templari/claude-code-base-azure-pipeline-task](https://github.com/wen-templari/claude-code-base-azure-pipeline-task) — distributed by [TomeVault](https://tomevault.io).
