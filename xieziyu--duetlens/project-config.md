---
trigger: always_on
description: Electron 桌面应用:人与 codex agent 协同对话式的 code review。主进程后端 Node/TS,渲染层 React SPA。
---
...
---
> Source: [xieziyu/duetlens](https://github.com/xieziyu/duetlens) — distributed by [TomeVault](https://tomevault.io).
