---
trigger: always_on
description: Rust workspace implementing a deductive prover for programs annotated with Hoare-style contracts (requires/ensures/invariants). Parses Taurus language, generates verification conditions (VCs). Independent from the C++ compiler.
---
...
---
> Source: [Simple-XX/SimpleCompiler](https://github.com/Simple-XX/SimpleCompiler) — distributed by [TomeVault](https://tomevault.io).
