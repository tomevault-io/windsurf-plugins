---
trigger: always_on
description: - `src/index.ts` — Cloudflare Worker entrypoint: HTTP auth gate, REST API (`/api/mails`, `/api/mails/:id`), email handler, AI extraction, D1 writes, promotional filter.
---
...
---
> Source: [TooonyChen/AuthInbox](https://github.com/TooonyChen/AuthInbox) — distributed by [TomeVault](https://tomevault.io).
