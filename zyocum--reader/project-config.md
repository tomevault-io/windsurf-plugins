---
trigger: always_on
description: - This project is managed by **uv**: `pyproject.toml` + `uv.lock` are the
---
...
---
> Source: [zyocum/reader](https://github.com/zyocum/reader) — distributed by [TomeVault](https://tomevault.io).
