---
trigger: always_on
description: - **Test all**: `melos run test` or `dart test` (in root/packages)
---
...
---
> Source: [whynotmake-it/figmage](https://github.com/whynotmake-it/figmage) — distributed by [TomeVault](https://tomevault.io).
