---
trigger: always_on
description: A Java library that provides a simplified wrapper around JDBC for safer, more reliable database access. Supports Oracle, PostgreSQL, SQL Server, HSQLDB, and Derby databases.
---
...
---
> Source: [susom/database](https://github.com/susom/database) — distributed by [TomeVault](https://tomevault.io).
