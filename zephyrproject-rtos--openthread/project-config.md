---
trigger: always_on
description: OpenThread is an open-source implementation of the Thread networking protocol, released by Google. It is designed to be OS and platform-agnostic, with a small memory footprint, making it highly portable. It supports both system-on-chip (SoC) and network co-processor (NCP) designs and is a Thread Certified Component.
---
...
---
> Source: [zephyrproject-rtos/openthread](https://github.com/zephyrproject-rtos/openthread) — distributed by [TomeVault](https://tomevault.io).
