---
trigger: always_on
description: - Don't use xcode directly to develop
---
...
---
> Source: [justinbaduaa/alt-tab-macos-free](https://github.com/justinbaduaa/alt-tab-macos-free) — distributed by [TomeVault](https://tomevault.io).
