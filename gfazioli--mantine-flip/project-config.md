---
trigger: always_on
description: `@gfazioli/mantine-flip` — a Mantine 9 component that renders a two-face container with flip animation between front and back views. Supports controlled/uncontrolled modes, swipe gestures, compound components (`Flip.Front`/`Flip.Back`/`Flip.Target`), and spring easing. Requires React 19 and TypeScript 6.
---
...
---
> Source: [gfazioli/mantine-flip](https://github.com/gfazioli/mantine-flip) — distributed by [TomeVault](https://tomevault.io).
