---
trigger: always_on
description: This document outlines the architectural guidelines for AI agents working with **PowerGrid 7.x**.
---
...
---
> Source: [Power-Components/livewire-powergrid](https://github.com/Power-Components/livewire-powergrid) — distributed by [TomeVault](https://tomevault.io).
