---
trigger: always_on
description: - **Do** align your Node.js runtime with `.nvmrc` via `nvm use` before running repo scripts.
---
...
---
> Source: [ai-shifu/ChatALL](https://github.com/ai-shifu/ChatALL) — distributed by [TomeVault](https://tomevault.io).
