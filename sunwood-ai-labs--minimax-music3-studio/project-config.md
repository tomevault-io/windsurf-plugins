---
trigger: always_on
description: ACE-Step 1.5 is an open-source music foundation model combining a Language Model (LM) as a planner with a Diffusion Transformer (DiT) for audio synthesis. It generates commercial-grade music on consumer hardware (< 4GB VRAM).
---
...
---
> Source: [Sunwood-ai-labs/minimax-music3-studio](https://github.com/Sunwood-ai-labs/minimax-music3-studio) — distributed by [TomeVault](https://tomevault.io).
