---
trigger: always_on
description: hlchunk.nvim 是一个 Neovim（>= 0.10.0）缩进与代码块高亮插件，用 Lua 编写。核心能力：indent line、chunk 高亮（基于 treesitter 或括号匹配）、行号高亮、blank 修饰。所有渲染通过 `nvim_buf_set_extmark` 的 virt_text overlay 实现。
---
...
---
> Source: [shellRaining/hlchunk.nvim](https://github.com/shellRaining/hlchunk.nvim) — distributed by [TomeVault](https://tomevault.io).
