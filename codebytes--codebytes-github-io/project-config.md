---
trigger: always_on
description: - Never commit directly to the `main` branch
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/codebytes)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/codebytes)
