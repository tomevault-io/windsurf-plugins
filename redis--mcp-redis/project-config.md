---
trigger: always_on
description: This extension provides a natural language interface for managing and searching data in Redis through the Model Context Protocol (MCP).
---
...
---
> Source: [redis/mcp-redis](https://github.com/redis/mcp-redis) — distributed by [TomeVault](https://tomevault.io).
