---
trigger: always_on
description: JTAF is a framework that generates custom Junos Terraform providers from YANG models. It converts YANG schemas → JSON → Go resource providers, enabling declarative Junos configuration management via Terraform.
---
