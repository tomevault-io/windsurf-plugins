---
trigger: always_on
description: Please check the following conventions if you would like to modify MMDetection as your own project.
---
...
---
> Source: [hasanirtiza/PedesFormer-Transformer-Networks-For-Pedestrian-Detection](https://github.com/hasanirtiza/PedesFormer-Transformer-Networks-For-Pedestrian-Detection) — distributed by [TomeVault](https://tomevault.io).
