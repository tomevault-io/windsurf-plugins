---
trigger: always_on
description: Most SDK source is generated from the OpenAI API schema. Follow `.github/CONTRIBUTING.md` before
---
...
---
> Source: [openai/openai-node](https://github.com/openai/openai-node) — distributed by [TomeVault](https://tomevault.io).
