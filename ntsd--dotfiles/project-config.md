---
trigger: always_on
description: This is a dotfiles management project that provides automated setup and configuration for macOS and Linux development environments. The project uses Make for orchestration, shell scripts for system configuration, and Homebrew for package management.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/ntsd)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/ntsd)
