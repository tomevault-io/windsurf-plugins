---
trigger: always_on
description: This repository is maintained with automated coding agents. Keep every change reproducible from a clean checkout and make failures visible in local output and GitHub Actions.
---
...
---
> Source: [infeng/react-viewer](https://github.com/infeng/react-viewer) — distributed by [TomeVault](https://tomevault.io).
