---
trigger: always_on
description: OpenCode plugin that intercepts LLM error responses and automatically switches to a fallback model chain. Pure TypeScript, ESM, bundled with tsup — ships compiled JS via `dist/`.
---
...
---
> Source: [HyeokjaeLee/opencode-auto-fallback](https://github.com/HyeokjaeLee/opencode-auto-fallback) — distributed by [TomeVault](https://tomevault.io).
