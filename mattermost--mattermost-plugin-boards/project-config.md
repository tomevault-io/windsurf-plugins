---
trigger: always_on
description: - `make apply` — Propagate plugin manifest into server/ and webapp/
---
...
---
> Source: [mattermost/mattermost-plugin-boards](https://github.com/mattermost/mattermost-plugin-boards) — distributed by [TomeVault](https://tomevault.io).
