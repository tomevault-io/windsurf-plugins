---
trigger: always_on
description: This Agents.md file provides comprehensive guidance for AI agents working with
---
...
---
> Source: [ZeroX-DG/vi-rs](https://github.com/ZeroX-DG/vi-rs) — distributed by [TomeVault](https://tomevault.io).
