---
trigger: always_on
description: - MUST: We use @antfu/ni. Use `ni` to install, `nr SCRIPT_NAME` to run script, `nun` to uninstall package
---
...
---
> Source: [aidenybai/bippy](https://github.com/aidenybai/bippy) — distributed by [TomeVault](https://tomevault.io).
