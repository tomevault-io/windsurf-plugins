---
trigger: always_on
description: - DO NOT use **Unicode hyphen** `‑` (U+2011); Use **ASCII hyphen** `-` (U+002D)
---
...
---
> Source: [archibate/dotfiles-opencode](https://github.com/archibate/dotfiles-opencode) — distributed by [TomeVault](https://tomevault.io).
