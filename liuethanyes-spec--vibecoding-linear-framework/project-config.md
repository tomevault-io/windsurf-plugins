---
trigger: always_on
description: 本文件是默认唯一入口。目标：让 AI 按固定流程推进项目，同时避免每次对话读取全部文档。
---
...
---
> Source: [liuethanyes-spec/vibecoding-linear-framework](https://github.com/liuethanyes-spec/vibecoding-linear-framework) — distributed by [TomeVault](https://tomevault.io).
