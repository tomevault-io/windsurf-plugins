---
trigger: always_on
description: WeWork Meteor is a specialized job board application built for the Meteor.js community. It allows companies to post Meteor-specific job opportunities and was originally designed to include a developer directory feature (currently disabled in the UI but infrastructure remains).
---
...
---
> Source: [nate-strauser/wework](https://github.com/nate-strauser/wework) — distributed by [TomeVault](https://tomevault.io).
