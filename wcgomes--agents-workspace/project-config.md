---
trigger: always_on
description: > **This file is not consumer boot policy.** It guides agents working **in** the agents-workspace distribution repo. For the policy that consumers copy into their projects, see [`templates/AGENTS.md`](templates/AGENTS.md).
---
...
---
> Source: [wcgomes/agents-workspace](https://github.com/wcgomes/agents-workspace) — distributed by [TomeVault](https://tomevault.io).
