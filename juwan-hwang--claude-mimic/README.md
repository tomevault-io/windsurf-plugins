...
> Tome by [Juwan-Hwang](https://github.com/Juwan-Hwang/claude-mimic), graded and kept true across every major AI platform by [TomeVault](https://tomevault.io)
...
Original source: `.cursor/rules/*.mdc` in [Juwan-Hwang/claude-mimic](https://github.com/Juwan-Hwang/claude-mimic).
