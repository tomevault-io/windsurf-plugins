---
trigger: always_on
description: Orientation for AI coding agents (Claude Code, Codex, Cursor) working in this repo. Humans should
---
...
---
> Source: [cyrusbehr/tensorrt-cpp-api](https://github.com/cyrusbehr/tensorrt-cpp-api) — distributed by [TomeVault](https://tomevault.io).
