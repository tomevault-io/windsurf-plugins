---
trigger: always_on
description: This document describes the key directories in the AI Gateway workspace for AI coding agents.
---
...
---
> Source: [Azure-Samples/AI-Gateway](https://github.com/Azure-Samples/AI-Gateway) — distributed by [TomeVault](https://tomevault.io).
