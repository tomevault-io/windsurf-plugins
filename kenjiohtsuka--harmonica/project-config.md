---
trigger: always_on
description: Guidance for AI agents working on the Harmonica codebase.
---
...
---
> Source: [KenjiOhtsuka/harmonica](https://github.com/KenjiOhtsuka/harmonica) — distributed by [TomeVault](https://tomevault.io).
