---
trigger: always_on
description: - **jieba-php** is a PHP port of the Jieba Chinese text segmentation library, supporting simplified/traditional Chinese, Japanese, and Korean (CJK) text.
---
...
---
> Source: [fukuball/jieba-php](https://github.com/fukuball/jieba-php) — distributed by [TomeVault](https://tomevault.io).
