---
trigger: always_on
description: Electron desktop app for managing isolated browser environments powered by [CloakBrowser](https://github.com/CloakHQ/CloakBrowser). Local Express API (`:6788`) backed by SQLite manages profiles; React renderer talks to the API via fetch.
---
...
---
> Source: [yt2399/CloakBrowserDesktop](https://github.com/yt2399/CloakBrowserDesktop) — distributed by [TomeVault](https://tomevault.io).
