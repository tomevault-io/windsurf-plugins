---
trigger: always_on
description: > 这是项目的"约束先行"文档。任何 AI 助手（含 Claude Code）或人类协作者在本仓库工作前，必须先读完本文件。
---
...
---
> Source: [lawflow-boop/LawLink](https://github.com/lawflow-boop/LawLink) — distributed by [TomeVault](https://tomevault.io).
