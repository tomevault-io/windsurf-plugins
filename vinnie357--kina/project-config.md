---
trigger: always_on
description: This project uses [bees](https://github.com/ctxshift/bees) for issue tracking. Issues live in `.bees/` (JSONL synced via git, SQLite db local-only).
---
...
---
> Source: [vinnie357/kina](https://github.com/vinnie357/kina) — distributed by [TomeVault](https://tomevault.io).
