---
trigger: always_on
description: The ngrok-operator is a Kubernetes Operator that reconciles:
---
...
---
> Source: [ngrok/ngrok-operator](https://github.com/ngrok/ngrok-operator) — distributed by [TomeVault](https://tomevault.io).
