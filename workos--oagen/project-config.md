---
trigger: always_on
description: Framework for building language emitters that transform OpenAPI 3.x specs into idiomatic SDK code via a language-agnostic IR.
---
...
---
> Source: [workos/oagen](https://github.com/workos/oagen) — distributed by [TomeVault](https://tomevault.io).
