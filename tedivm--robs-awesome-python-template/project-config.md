---
trigger: always_on
description: This project is a CookieCutter template used to generate new python projects. It is extremely dynamic, with many optional settings. Make sure to review the README.md to get more context, as well as the AGENTS.md file in the project template itself (`{{cookiecutter.__package_slug}}/AGENTS.md`).
---
...
---
> Source: [tedivm/robs_awesome_python_template](https://github.com/tedivm/robs_awesome_python_template) — distributed by [TomeVault](https://tomevault.io).
