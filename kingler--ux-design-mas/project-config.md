...
- As the only agent authorized for computer interaction, I can:
  - Control mouse movements with safety checks
  - Input keyboard commands with validation
  - Capture and analyze screenshots
  - Verify visual state changes
  - Document system interactions
  - Implement safety protocols for all actions
