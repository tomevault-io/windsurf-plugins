---
trigger: always_on
description: Feature-gated (`virtual-device`) Transport implementation backed by local filesystem directories instead of USB. Exercises the full MTP/PTP binary protocol path.
---
...
---
> Source: [vdavid/mtp-rs](https://github.com/vdavid/mtp-rs) — distributed by [TomeVault](https://tomevault.io).
