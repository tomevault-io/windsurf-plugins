---
trigger: always_on
description: OLL Trainer is a web-based tool for practicing OLL algorithms in speedcubing. The application allows users to select specific cases to practice and measures solving times.
---
...
---
> Source: [vdobritski/oll_scrumbler](https://github.com/vdobritski/oll_scrumbler) — distributed by [TomeVault](https://tomevault.io).
