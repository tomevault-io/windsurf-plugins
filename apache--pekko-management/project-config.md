...
# Claude Rules for Apache Pekko Management
...
- Discovery mechanism changes are tested against the target platform.
- Cluster bootstrap changes preserve backward compatibility.
...
---
> Source: [apache/pekko-management](https://github.com/apache/pekko-management) — distributed by [TomeVault](https://tomevault.io).
