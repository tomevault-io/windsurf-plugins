---
trigger: always_on
description: Quickemu is a Bash wrapper around QEMU that automates VM creation for ~1000 operating systems (Linux, macOS, Windows, BSDs). Two main tools: `quickget` downloads ISOs and creates configs; `quickemu` launches VMs with optimised hardware detection.
---
...
---
> Source: [quickemu-project/quickemu](https://github.com/quickemu-project/quickemu) — distributed by [TomeVault](https://tomevault.io).
