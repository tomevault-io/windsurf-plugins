---
trigger: always_on
description: This is the **Dependabot CLI** (`dependabot`), a Go tool that orchestrates Dependabot update jobs via Docker containers. It does **not** perform dependency resolution itself — it coordinates three containers:
---
...
---
> Source: [dependabot/cli](https://github.com/dependabot/cli) — distributed by [TomeVault](https://tomevault.io).
