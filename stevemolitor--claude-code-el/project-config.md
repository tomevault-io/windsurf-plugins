---
trigger: always_on
description: - Install package: `M-x package-install-file RET /path/to/claude-code.el`
---
...
---
> Source: [stevemolitor/claude-code.el](https://github.com/stevemolitor/claude-code.el) — distributed by [TomeVault](https://tomevault.io).
