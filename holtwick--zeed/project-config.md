---
trigger: always_on
description: Project context and architecture: see [AGENTS.md](AGENTS.md). The rules below are Claude-specific overrides for this repository.
---
...
---
> Source: [holtwick/zeed](https://github.com/holtwick/zeed) — distributed by [TomeVault](https://tomevault.io).
