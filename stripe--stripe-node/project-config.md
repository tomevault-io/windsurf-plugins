---
trigger: always_on
description: - Run all tests: `just test` (builds first)
---
...
---
> Source: [stripe/stripe-node](https://github.com/stripe/stripe-node) — distributed by [TomeVault](https://tomevault.io).
