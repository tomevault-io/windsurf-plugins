---
trigger: always_on
description: dotnet cake --target=build
---
...
---
> Source: [mono/SkiaSharp.Extended](https://github.com/mono/SkiaSharp.Extended) — distributed by [TomeVault](https://tomevault.io).
