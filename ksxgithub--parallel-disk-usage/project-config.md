---
trigger: always_on
description: Read and follow the CONTRIBUTING.md file in this repository for all code style conventions, commit message format, and development guidelines.
---
...
---
> Source: [KSXGitHub/parallel-disk-usage](https://github.com/KSXGitHub/parallel-disk-usage) — distributed by [TomeVault](https://tomevault.io).
