---
trigger: always_on
description: This project is a Ruby on Rails application that serves as a content management system (CMS) for the website `www.thape.com`. It appears to be a legacy system, as all non-admin traffic is permanently redirected to the main website.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/thape-cn)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/thape-cn)
