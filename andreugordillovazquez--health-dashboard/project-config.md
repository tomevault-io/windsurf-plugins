---
trigger: always_on
description: Apple Health Dashboard — a React app that parses Apple Health XML exports (1GB+) client-side and renders interactive health visualizations. Everything runs in the browser, no server.
---
...
---
> Source: [andreugordillovazquez/health-dashboard](https://github.com/andreugordillovazquez/health-dashboard) — distributed by [TomeVault](https://tomevault.io).
