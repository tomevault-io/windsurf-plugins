---
trigger: always_on
description: This project, `social-auto-upload`, is a powerful automation tool designed to help content creators and operators efficiently publish video content to multiple domestic and international mainstream social media platforms in one click. The project implements video upload, scheduled release and other functions for platforms such as `Douyin`, `Bilibili`, `Xiaohongshu`, `Kuaishou`, `WeChat Channel`, `Baijiahao` and `TikTok`.
---
...
---
> Source: [funfan0517/MediaPublishPlatform](https://github.com/funfan0517/MediaPublishPlatform) — distributed by [TomeVault](https://tomevault.io).
