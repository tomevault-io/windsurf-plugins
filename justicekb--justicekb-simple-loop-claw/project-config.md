---
trigger: always_on
description: Follow the repository contract in `AGENTS.md` before editing code.
---
...
---
> Source: [JUSTICEKB/JUSTICEKB-Simple-LOOP-CLAW](https://github.com/JUSTICEKB/JUSTICEKB-Simple-LOOP-CLAW) — distributed by [TomeVault](https://tomevault.io).
