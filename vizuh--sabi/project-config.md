---
trigger: always_on
description: Begin every response with `VIZUH`. On Hugo's host, read the HugoOS root `AGENTS.md` first; this file is the project overlay for this repository.
---
...
---
> Source: [vizuh/sabi](https://github.com/vizuh/sabi) — distributed by [TomeVault](https://tomevault.io).
