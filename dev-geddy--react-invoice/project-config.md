---
trigger: always_on
description: This repo uses a **three-level doc system**: L1 Constitution (`/docs/constitution.md`, why/invariants), L2 Contracts (`/docs/contracts/<domain>.md`, what/interfaces), L3 Notes (`/docs/notes/`, how/volatile).
---
