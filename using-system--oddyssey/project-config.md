---
trigger: always_on
description: `marketplace/` is a build artifact: the release workflow regenerates it
---
...
---
> Source: [using-system/oddyssey](https://github.com/using-system/oddyssey) — distributed by [TomeVault](https://tomevault.io).
