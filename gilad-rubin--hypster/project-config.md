---
trigger: always_on
description: - `hypster.__version__` is intentionally defined in `src/hypster/_version.py` instead of using `importlib.metadata` at import time.
---
...
---
> Source: [gilad-rubin/hypster](https://github.com/gilad-rubin/hypster) — distributed by [TomeVault](https://tomevault.io).
