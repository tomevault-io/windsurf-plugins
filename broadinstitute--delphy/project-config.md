---
trigger: always_on
description: **STOP. You MUST read [AGENTS.md](AGENTS.md) in full before doing anything.**
---
...
---
> Source: [broadinstitute/delphy](https://github.com/broadinstitute/delphy) — distributed by [TomeVault](https://tomevault.io).
