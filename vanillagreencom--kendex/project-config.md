---
trigger: always_on
description: VStack is a distribution of agent-stack assets: reusable skills (`skills/`,
---
...
---
> Source: [vanillagreencom/kendex](https://github.com/vanillagreencom/kendex) — distributed by [TomeVault](https://tomevault.io).
