---
trigger: always_on
description: Interactive console application for testing and experimenting with Musoq SQL queries. Not a production project — used by developers to quickly validate queries, test new features, and explore the query engine behavior.
---
