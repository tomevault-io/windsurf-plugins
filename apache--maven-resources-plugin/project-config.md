...
# Agent Guide for maven-resources-plugin
...
---
> Source: [apache/maven-resources-plugin](https://github.com/apache/maven-resources-plugin) — distributed by [TomeVault](https://tomevault.io).
