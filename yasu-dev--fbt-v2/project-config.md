---
trigger: always_on
description: - shadcn/ui をベースとしたコンポーネントの使用
---
...
- 変更が必要な場合は `globals.mdc` の承認フローに従うこと
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/yasu-dev) — claim your Tome and manage your conversions.
