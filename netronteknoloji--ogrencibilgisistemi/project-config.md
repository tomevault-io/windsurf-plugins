---
trigger: always_on
description: Multi-tenant okul yönetim sistemi. Web paneli + REST API + MAUI mobil. Her okul ayrı SQL DB. ZKTeco kart okuyucu entegrasyonu.
---
...
---
> Source: [netronteknoloji/OgrenciBilgiSistemi](https://github.com/netronteknoloji/OgrenciBilgiSistemi) — distributed by [TomeVault](https://tomevault.io).
