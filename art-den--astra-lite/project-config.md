---
trigger: always_on
description: - This is software for deepsky astrophotography and live stacking on low power PCs (like rapsberry Pi or Orange Pi). It also works on PCs. More information is in `README.md`.
---
...
---
> Source: [art-den/astra_lite](https://github.com/art-den/astra_lite) — distributed by [TomeVault](https://tomevault.io).
