---
trigger: always_on
description: 本项目是一个论文全流程辅助工具。当用户询问论文、文献、查重、降AI率等相关问题时，使用 `scripts/papercash.py` CLI 来完成任务。
---
...
---
> Source: [Jesseovo/PaperCash](https://github.com/Jesseovo/PaperCash) — distributed by [TomeVault](https://tomevault.io).
