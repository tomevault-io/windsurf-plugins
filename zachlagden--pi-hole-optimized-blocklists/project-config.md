---
trigger: always_on
description: This file provides context to Claude Code (claude.ai/code) when working with this repository.
---
...
---
> Source: [zachlagden/Pi-hole-Optimized-Blocklists](https://github.com/zachlagden/Pi-hole-Optimized-Blocklists) — distributed by [TomeVault](https://tomevault.io).
