---
trigger: always_on
description: When updating the LibreChat config version (e.g., from v1.2.6 to v1.2.7), follow these steps:
---
...
---
> Source: [LibreChat-AI/librechat.ai](https://github.com/LibreChat-AI/librechat.ai) — distributed by [TomeVault](https://tomevault.io).
