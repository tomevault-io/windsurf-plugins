---
trigger: always_on
description: Guidance for AI coding agents working in the Foundry documentation repository.
---
...
---
> Source: [foundry-rs/book](https://github.com/foundry-rs/book) — distributed by [TomeVault](https://tomevault.io).
