---
trigger: always_on
description: Deedle is an F# library for data manipulation providing efficient frame and series data structures (similar to Python's pandas). It supports missing values, aggregations, grouping, joining, statistics, and time-series alignment.
---
...
---
> Source: [fslaborg/Deedle](https://github.com/fslaborg/Deedle) — distributed by [TomeVault](https://tomevault.io).
