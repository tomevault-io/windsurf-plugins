---
trigger: always_on
description: GitHub Action that backports merged PRs to other branches.
---
...
---
> Source: [korthout/backport-action](https://github.com/korthout/backport-action) — distributed by [TomeVault](https://tomevault.io).
