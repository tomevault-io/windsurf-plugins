---
trigger: always_on
description: - `src/` contains the application code. Use `src/main.py` as the interactive entrypoint.
---
...
---
> Source: [andrepichardo/moneyprinter-pro](https://github.com/andrepichardo/moneyprinter-pro) — distributed by [TomeVault](https://tomevault.io).
