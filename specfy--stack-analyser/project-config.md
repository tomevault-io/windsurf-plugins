---
trigger: always_on
description: A rule should meet the following criteria:
---
...
---
> Source: [specfy/stack-analyser](https://github.com/specfy/stack-analyser) — distributed by [TomeVault](https://tomevault.io).
