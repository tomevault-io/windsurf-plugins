---
trigger: always_on
description: TunaOS builds bootable OCI container images that serve as immutable desktop Linux OSes (bootc/rpm-ostree). This is not traditional software.
---
...
---
> Source: [tuna-os/tunaOS](https://github.com/tuna-os/tunaOS) — distributed by [TomeVault](https://tomevault.io).
