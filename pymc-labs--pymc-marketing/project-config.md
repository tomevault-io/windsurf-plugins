---
trigger: always_on
description: - Activate conda env `pymc-marketing-dev` before running any commands.
---
...
---
> Source: [pymc-labs/pymc-marketing](https://github.com/pymc-labs/pymc-marketing) — distributed by [TomeVault](https://tomevault.io).
