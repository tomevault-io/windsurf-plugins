---
trigger: always_on
description: This file defines how AI agents must behave in this project.
---
...
browser-validator   → reads test-scenarios.md, writes qa-output/browser-validation.md
...
---
> Source: [Anasss/qa-orchestra](https://github.com/Anasss/qa-orchestra) — distributed by [TomeVault](https://tomevault.io).
