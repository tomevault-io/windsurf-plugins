---
trigger: always_on
description: RabbitMQ-focused AMQP low-level library for encoding and decoding AMQP frames.
---
...
---
> Source: [gmr/pamqp](https://github.com/gmr/pamqp) — distributed by [TomeVault](https://tomevault.io).
