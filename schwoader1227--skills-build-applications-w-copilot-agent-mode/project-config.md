---
trigger: always_on
description: This repository contains the MonaFit Tracker app, which includes:
---
...
---
> Source: [schwoader1227/skills-build-applications-w-copilot-agent-mode](https://github.com/schwoader1227/skills-build-applications-w-copilot-agent-mode) — distributed by [TomeVault](https://tomevault.io).
