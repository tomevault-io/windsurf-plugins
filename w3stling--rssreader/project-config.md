---
trigger: always_on
description: RSS Reader is a zero-dependency Java 11+ library for parsing RSS and Atom feeds, published to Maven Central as `com.apptasticsoftware:rssreader`. It uses JPMS (`module com.apptasticsoftware.rssreader`) and StAX for XML parsing.
---
...
---
> Source: [w3stling/rssreader](https://github.com/w3stling/rssreader) — distributed by [TomeVault](https://tomevault.io).
