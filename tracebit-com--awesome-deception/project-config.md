---
trigger: always_on
description: This repository is a curated list (`README.MD`) of deception-related resources. Future Codex runs should prioritize **accuracy over volume** and avoid speculative edits.
---
...
---
> Source: [tracebit-com/awesome-deception](https://github.com/tracebit-com/awesome-deception) — distributed by [TomeVault](https://tomevault.io).
