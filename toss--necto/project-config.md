---
trigger: always_on
description: A macOS debugging tool for iOS apps. The shell is Swift; every feature screen is a
---
...
---
> Source: [toss/necto](https://github.com/toss/necto) — distributed by [TomeVault](https://tomevault.io).
