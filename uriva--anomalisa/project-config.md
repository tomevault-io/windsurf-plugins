---
trigger: always_on
description: Avoid commenting unless necessary. No jsdoc. Typings and variable names should
---
...
---
> Source: [uriva/anomalisa](https://github.com/uriva/anomalisa) — distributed by [TomeVault](https://tomevault.io).
