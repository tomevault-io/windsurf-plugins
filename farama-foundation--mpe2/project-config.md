---
trigger: always_on
description: - `docs/` contains documentation source and scripts for generating environment docs.
---
...
---
> Source: [Farama-Foundation/MPE2](https://github.com/Farama-Foundation/MPE2) — distributed by [TomeVault](https://tomevault.io).
