---
trigger: always_on
description: - All user-facing CLI output, prompts, help text, warnings, and error messages must be written in English only.
---
...
---
> Source: [Loongphy/codex-auth](https://github.com/Loongphy/codex-auth) — distributed by [TomeVault](https://tomevault.io).
