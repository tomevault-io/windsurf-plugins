---
trigger: always_on
description: Guidance for AI coding agents (and their humans) contributing to
---
...
---
> Source: [TheAlgorithms/Python](https://github.com/TheAlgorithms/Python) — distributed by [TomeVault](https://tomevault.io).
