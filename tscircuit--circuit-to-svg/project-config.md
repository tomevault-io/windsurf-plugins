---
trigger: always_on
description: - Build: `npm run build` or `bun run build` (tsup-node ./lib/index.ts --format esm --dts --sourcemap)
---
...
---
> Source: [tscircuit/circuit-to-svg](https://github.com/tscircuit/circuit-to-svg) — distributed by [TomeVault](https://tomevault.io).
