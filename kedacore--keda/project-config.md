---
trigger: always_on
description: This file gives AI coding agents (Claude Code, Codex, Cursor, Copilot, Aider, etc.) the rules they must follow when contributing to this repository. It complements [`CONTRIBUTING.md`](CONTRIBUTING.md), which remains the source of truth for humans. Agents must respect every rule there as well.
---
...
---
> Source: [kedacore/keda](https://github.com/kedacore/keda) — distributed by [TomeVault](https://tomevault.io).
