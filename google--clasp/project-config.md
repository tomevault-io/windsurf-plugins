---
trigger: always_on
description: This document provides a high-level overview of the `@google/clasp` project to guide AI-based development and maintenance.
---
...
---
> Source: [google/clasp](https://github.com/google/clasp) — distributed by [TomeVault](https://tomevault.io).
