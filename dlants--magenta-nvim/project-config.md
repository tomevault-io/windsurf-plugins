---
trigger: always_on
description: Check that the changes leverage the type system to make incorrect usage hard or
---
...
---
> Source: [dlants/magenta.nvim](https://github.com/dlants/magenta.nvim) — distributed by [TomeVault](https://tomevault.io).
