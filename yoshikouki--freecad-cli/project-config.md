---
trigger: always_on
description: - Python 3.12+, managed by uv
---
...
---
> Source: [yoshikouki/freecad-cli](https://github.com/yoshikouki/freecad-cli) — distributed by [TomeVault](https://tomevault.io).
