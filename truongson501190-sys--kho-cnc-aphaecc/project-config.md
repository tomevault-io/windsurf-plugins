---
trigger: always_on
description: This React + Vite + TypeScript app uses shadcn-ui components and Tailwind CSS. Use pnpm (see `package.json: packageManager`).
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/truongson501190-sys)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/truongson501190-sys)
