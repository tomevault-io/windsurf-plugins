---
trigger: always_on
description: This repo is an Astro 5 + MDX site with optional React "islands," Tailwind CSS v4, KaTeX, and a small PDF→image pipeline. It renders a single-page research project site from `src/paper.mdx` using `src/pages/index.astro` as the layout and a curated set of components.
---
...
---
> Source: [WANG-Ruipeng/SPRig](https://github.com/WANG-Ruipeng/SPRig) — distributed by [TomeVault](https://tomevault.io).
