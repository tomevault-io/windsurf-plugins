---
trigger: always_on
description: Monorepo for TON blockchain integration libraries: `@ton/walletkit` (core wallet SDK), `@ton/appkit` (app-level kit), `@ton/appkit-react` (React bindings). Uses pnpm workspaces and Turbo.
---
...
---
> Source: [ton-connect/kit](https://github.com/ton-connect/kit) — distributed by [TomeVault](https://tomevault.io).
