---
trigger: always_on
description: As only formulaic changes to this repo are anticipated in the near to medium
---
...
---
> Source: [google/rust_icu](https://github.com/google/rust_icu) — distributed by [TomeVault](https://tomevault.io).
