---
trigger: always_on
description: - `common/` contains shared Kotlin implementation code.
---
...
---
> Source: [AtomMaterialUI/a-file-icon-idea](https://github.com/AtomMaterialUI/a-file-icon-idea) — distributed by [TomeVault](https://tomevault.io).
