---
trigger: always_on
description: TypeScript **GitHub Action** that sends events and metrics to Datadog (`action.yml` + `src/`).
---
...
---
> Source: [masci/datadog](https://github.com/masci/datadog) — distributed by [TomeVault](https://tomevault.io).
