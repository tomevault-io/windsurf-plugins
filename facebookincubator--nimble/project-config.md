---
trigger: always_on
description: Nimble (formerly "Alpha") is Meta's next-generation columnar file format. It is optimized for wide tables (thousands of columns) common in ML feature engineering and training pipelines.
---
...
---
> Source: [facebookincubator/nimble](https://github.com/facebookincubator/nimble) — distributed by [TomeVault](https://tomevault.io).
