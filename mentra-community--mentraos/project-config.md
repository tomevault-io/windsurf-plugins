---
trigger: always_on
description: - Put glasses subscriptions, `session.*` calls, durable state, and logic that
---
...
---
> Source: [Mentra-Community/MentraOS](https://github.com/Mentra-Community/MentraOS) — distributed by [TomeVault](https://tomevault.io).
