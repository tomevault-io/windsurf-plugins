---
trigger: always_on
description: - Java 17 Maven library; sources live in `src/main/java/berlin/yuna/typemap` with `logic` (converters/encoders), `model` (TypeMap/TypeList + concurrent variants), and `config` (converter registry). Shared resources sit in `src/main/resources`.
---
...
---
> Source: [YunaBraska/type-map](https://github.com/YunaBraska/type-map) — distributed by [TomeVault](https://tomevault.io).
