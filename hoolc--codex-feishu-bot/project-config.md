---
trigger: always_on
description: This repository is designed for a Codex-operated bootstrap flow.
---
...
---
> Source: [HOOLC/codex-feishu-bot](https://github.com/HOOLC/codex-feishu-bot) — distributed by [TomeVault](https://tomevault.io).
