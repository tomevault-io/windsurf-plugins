...
From [mablanco/pricegrab](https://github.com/mablanco/pricegrab) — a repo with 9+ stars on GitHub.

---

Install this config instantly:
```
npx tomevault install mablanco/pricegrab
```
Source: [github.com/mablanco/pricegrab](https://github.com/mablanco/pricegrab).
