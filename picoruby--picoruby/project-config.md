---
trigger: always_on
description: This guideline applies only to implementing libraries (gems): not application code, tests, or CRuby tools.
---
...
---
> Source: [picoruby/picoruby](https://github.com/picoruby/picoruby) — distributed by [TomeVault](https://tomevault.io).
