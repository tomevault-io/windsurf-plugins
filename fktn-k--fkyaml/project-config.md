---
trigger: always_on
description: - This repository contains fkYAML, a header-only C++ YAML library.
---
...
---
> Source: [fktn-k/fkYAML](https://github.com/fktn-k/fkYAML) — distributed by [TomeVault](https://tomevault.io).
