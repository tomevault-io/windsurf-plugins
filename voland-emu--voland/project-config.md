---
trigger: always_on
description: Voland: Nintendo Switch emulator, web-first (WASM/WebGPU), C11 core, thin
---
...
---
> Source: [voland-emu/Voland](https://github.com/voland-emu/Voland) — distributed by [TomeVault](https://tomevault.io).
