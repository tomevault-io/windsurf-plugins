---
trigger: always_on
description: This is the JavaScript client for [EthicalAds](https://www.ethicalads.io/). It is responsible for detecting ad placements on publisher websites, fetching ads from the EthicalAds decision API, and rendering them.
---
...
---
> Source: [readthedocs/ethical-ad-client](https://github.com/readthedocs/ethical-ad-client) — distributed by [TomeVault](https://tomevault.io).
