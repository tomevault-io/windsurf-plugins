---
trigger: always_on
description: This repository contains the Docker tooling and Dockerfiles for OpenResty. It supports multiple Linux distributions (Alpine, Ubuntu, Debian, CentOS, Fedora, etc.) and architectures (amd64, arm64, s390x).
---
...
---
> Source: [openresty/docker-openresty](https://github.com/openresty/docker-openresty) — distributed by [TomeVault](https://tomevault.io).
