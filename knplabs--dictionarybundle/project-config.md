---
trigger: always_on
description: Reusable Symfony bundle for declaring named dictionaries in application configuration and consuming them through DI, forms, validation, Twig, Faker, and the web profiler. Treat `composer.json` and the CI matrix as the sources of truth for supported runtime and framework versions.
---
...
---
> Source: [KnpLabs/DictionaryBundle](https://github.com/KnpLabs/DictionaryBundle) — distributed by [TomeVault](https://tomevault.io).
