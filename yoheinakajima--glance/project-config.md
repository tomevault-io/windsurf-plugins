---
trigger: always_on
description: Glance answers typed questions about images from a frozen open vision-language model running locally. It reads the
---
...
---
> Source: [yoheinakajima/glance](https://github.com/yoheinakajima/glance) — distributed by [TomeVault](https://tomevault.io).
