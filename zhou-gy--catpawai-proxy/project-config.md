---
trigger: always_on
description: 这个仓库只作为 CatPawAI 本地代理的学习、研究和个人集成测试项目维护。默认使用场景是本机 `127.0.0.1` 上的 OpenAI 兼容接口，不把它描述成公开模型服务、生产服务或官方项目。
---
...
---
> Source: [zhou-gy/catpawai-proxy](https://github.com/zhou-gy/catpawai-proxy) — distributed by [TomeVault](https://tomevault.io).
