---
trigger: always_on
description: PCRE4J is a Java binding for the PCRE2 (Perl Compatible Regular Expressions 2) library, providing three API layers:
---
...
---
> Source: [alexey-pelykh/pcre4j](https://github.com/alexey-pelykh/pcre4j) — distributed by [TomeVault](https://tomevault.io).
