---
trigger: always_on
description: This repository is a `pnpm` workspace monorepo that ships WebSpatial SDK packages, a local dev/test server, and an end-to-end (AVP simulator) CI harness.
---
...
---
> Source: [webspatial/webspatial-sdk](https://github.com/webspatial/webspatial-sdk) — distributed by [TomeVault](https://tomevault.io).
