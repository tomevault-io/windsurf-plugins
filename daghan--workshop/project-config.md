---
trigger: always_on
description: Update project context file to document workflows and technical configuration
---
...
<template>
---
description: Project workflow rules and technical configuration
globs:
alwaysApply: true
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/daghan)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/daghan)
