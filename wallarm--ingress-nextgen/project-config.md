---
trigger: always_on
description: NGINX Kubernetes Ingress Controller -- watches Ingress, VirtualServer/VirtualServerRoute, TransportServer, and Policy CRDs, generates NGINX configuration, and reloads NGINX. Uses raw client-go (SharedInformerFactory + work queue), not controller-runtime.
---
...
---
> Source: [wallarm/ingress-nextgen](https://github.com/wallarm/ingress-nextgen) — distributed by [TomeVault](https://tomevault.io).
