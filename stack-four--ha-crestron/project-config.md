---
trigger: always_on
description: - [ ] `action-setup` - Service actions are registered in async_setup
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/stack-four)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/stack-four)
