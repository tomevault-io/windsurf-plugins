---
trigger: always_on
description: This is a Ruby gem that provides a client for the Wikidata API. It wraps
---
...
---
> Source: [wilg/wikidata](https://github.com/wilg/wikidata) — distributed by [TomeVault](https://tomevault.io).
