---
trigger: always_on
description: In general, this project adheres to all the standard Go conventions,
---
...
---
> Source: [streamingfast/firehose-ethereum](https://github.com/streamingfast/firehose-ethereum) — distributed by [TomeVault](https://tomevault.io).
