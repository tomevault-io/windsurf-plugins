---
trigger: always_on
description: 本仓库的协作入口已切换到根目录 `AGENTS.md`，后续规则和项目快照以 `AGENTS.md` 为准。
---
...
---
> Source: [JavaLyHn/wraith](https://github.com/JavaLyHn/wraith) — distributed by [TomeVault](https://tomevault.io).
