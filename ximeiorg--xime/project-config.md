---
trigger: always_on
description: 这是一个基于 rime 框架实现的安卓手机五笔输入法，采用 kotlin + jetpack compose 构建。
---
...
---
> Source: [ximeiorg/Xime](https://github.com/ximeiorg/Xime) — distributed by [TomeVault](https://tomevault.io).
