...
Original source: `.cursor/rules/*.mdc` in [bcorporaal/Toko](https://github.com/bcorporaal/Toko).
...
From [bcorporaal/Toko](https://github.com/bcorporaal/Toko) — a repo with 30+ stars on GitHub.
