---
trigger: always_on
description: - Bun is the package manager/runtime; use `bun install --frozen-lockfile` with the committed `bun.lock`.
---
...
---
> Source: [yuji-hatakeyama/opencode-gpt-imagegen](https://github.com/yuji-hatakeyama/opencode-gpt-imagegen) — distributed by [TomeVault](https://tomevault.io).
