---
trigger: always_on
description: Build the project with:
---
...
---
> Source: [sourcefrog/cargo-mutants](https://github.com/sourcefrog/cargo-mutants) — distributed by [TomeVault](https://tomevault.io).
