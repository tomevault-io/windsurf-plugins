---
trigger: always_on
description: Detect and use the appropriate runner by checking in this order:
---
...
---
> Source: [sonic182/aiosonic](https://github.com/sonic182/aiosonic) — distributed by [TomeVault](https://tomevault.io).
