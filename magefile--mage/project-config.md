---
trigger: always_on
description: Mage is a make-like build tool that uses Go functions as build targets. Users write plain Go functions in "magefiles" and mage makes them runnable from the command line.
---
...
---
> Source: [magefile/mage](https://github.com/magefile/mage) — distributed by [TomeVault](https://tomevault.io).
