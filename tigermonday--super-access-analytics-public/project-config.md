---
trigger: always_on
description: 作業前に `docs/ai-agent-guide.md` と `docs/standard-run-order.md` を読む。個別機能は共通ガイドが示す正本に従う。分析・考察は現在のエージェント自身が行い、Pythonから別のAIを自動起動しない。GA4/GTMデータの外部送信は `docs/data-handling.md` に従う。
---
