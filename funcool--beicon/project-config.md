---
trigger: always_on
description: **beicon** is a ClojureScript library wrapping RxJS for reactive streams. Published to Clojars as `funcool/beicon2`.
---
...
---
> Source: [funcool/beicon](https://github.com/funcool/beicon) — distributed by [TomeVault](https://tomevault.io).
