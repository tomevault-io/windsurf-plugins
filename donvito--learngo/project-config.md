---
trigger: always_on
description: This is a **learning monorepo** of independent Go example projects. There is **no root `go.mod`** — each subdirectory is a standalone program. Seven subdirectories have their own `go.mod`; the rest are legacy GOPATH-style single-file programs.
---
...
---
> Source: [donvito/learngo](https://github.com/donvito/learngo) — distributed by [TomeVault](https://tomevault.io).
