---
trigger: always_on
description: Claude Code plugin that gives AI agents persistent memory via Wire containers.
---
...
---
> Source: [usewire/wire-memory](https://github.com/usewire/wire-memory) — distributed by [TomeVault](https://tomevault.io).
