---
trigger: always_on
description: - MD Preview 是本地优先 Markdown 预览器，核心场景是快速打开 AI 生成文档、README、计划文档和手机收到的 Markdown 文件。
---
...
---
> Source: [vorojar/md-preview](https://github.com/vorojar/md-preview) — distributed by [TomeVault](https://tomevault.io).
