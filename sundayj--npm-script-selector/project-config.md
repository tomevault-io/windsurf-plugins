---
trigger: always_on
description: This is a TypeScript CLI tool that helps users discover and run npm scripts from package.json files interactively. The entire application is a single-class implementation in [app.ts](../app.ts).
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/sundayj)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/sundayj)
