---
trigger: always_on
description: - FVM is a Dart CLI that manages Flutter SDK versions per project.
---
...
---
> Source: [leoafarias/fvm](https://github.com/leoafarias/fvm) — distributed by [TomeVault](https://tomevault.io).
