---
trigger: always_on
description: Use pnpm for everything: workspace scripts and dependency management (`pnpm dev`, `pnpm check`, `pnpm test`, `pnpm add`). The Vite+ `vp` CLI appears inside a few scripts but the pnpm scripts wrap it correctly.
---
...
---
> Source: [turf-tools/turf-tools](https://github.com/turf-tools/turf-tools) — distributed by [TomeVault](https://tomevault.io).
