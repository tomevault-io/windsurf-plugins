---
trigger: always_on
description: Developer notes for this repository. Covers build system, architecture decisions, and conventions that are not obvious from the code alone.
---
...
---
> Source: [franverona/loadgo](https://github.com/franverona/loadgo) — distributed by [TomeVault](https://tomevault.io).
