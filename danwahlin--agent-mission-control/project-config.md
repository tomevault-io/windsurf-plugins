...
# Copilot Instructions — Agent Mission Control
...
---
> Source: [DanWahlin/agent-mission-control](https://github.com/DanWahlin/agent-mission-control) — distributed by [TomeVault](https://tomevault.io).
