---
trigger: always_on
description: When working on this repository, **NEVER** commit the following types of files:
---
...
---
> Source: [microsoft/maker.js](https://github.com/microsoft/maker.js) — distributed by [TomeVault](https://tomevault.io).
