---
trigger: always_on
description: This document provides a guide for AI agents working with the `jrdev` codebase. It outlines the project's architecture, key components, and development conventions.
---
...
---
> Source: [presstab/jrdev](https://github.com/presstab/jrdev) — distributed by [TomeVault](https://tomevault.io).
