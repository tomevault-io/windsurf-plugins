---
trigger: always_on
description: - `src/` TypeScript sources (edit here). Entry: `src/index.ts`; CLI shim: `src/generator.ts`.
---
...
---
> Source: [omar-dulaimi/prisma-valibot-generator](https://github.com/omar-dulaimi/prisma-valibot-generator) — distributed by [TomeVault](https://tomevault.io).
