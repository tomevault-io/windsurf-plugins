---
trigger: always_on
description: Frontend-only SPA for a Chinese-language social Q&A site. The API is a separate service.
---
...
---
> Source: [chafan-dev/chafan-pwa](https://github.com/chafan-dev/chafan-pwa) — distributed by [TomeVault](https://tomevault.io).
