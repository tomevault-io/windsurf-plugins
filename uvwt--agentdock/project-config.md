---
trigger: always_on
description: 本仓库是 AgentDock：一个 Go 编写的本地/远程 Agent 工具运行层，支持命令、文件、Git、原生 Skill、浏览器自动化、实验性 macOS 桌面能力和 RecallDock 长期召回。
---
...
---
> Source: [uvwt/agentdock](https://github.com/uvwt/agentdock) — distributed by [TomeVault](https://tomevault.io).
