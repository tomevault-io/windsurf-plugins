---
trigger: always_on
description: Guidance for coding agents working in this repository. Humans may find it useful too.
---
...
---
> Source: [ipfs/ipfs-webui](https://github.com/ipfs/ipfs-webui) — distributed by [TomeVault](https://tomevault.io).
