---
trigger: always_on
description: Guidance for agents working in the wows-toolkit repository. These rules override default behavior and apply to every crate unless a crate-local AGENTS.md says otherwise.
---
