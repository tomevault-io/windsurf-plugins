---
trigger: always_on
description: A native Node.js (NAPI-RS) binding to [wry](https://github.com/tauri-apps/wry) and [tao](https://github.com/tauri-apps/tao) that lets JavaScript/TypeScript create native desktop windows with embedded webviews. Works with Node.js, Deno, and Bun.
---
...
---
> Source: [webviewjs/webview](https://github.com/webviewjs/webview) — distributed by [TomeVault](https://tomevault.io).
