---
trigger: always_on
description: **Mode**: 🔐 Browser · **Domain**: `gemini.google.com`
---
...
---
> Source: [jackwener/opencli](https://github.com/jackwener/opencli) — distributed by [TomeVault](https://tomevault.io).
