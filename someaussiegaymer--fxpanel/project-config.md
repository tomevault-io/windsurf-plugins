---
trigger: always_on
description: The `!NC` comments in code are tags used by a git pre-commit hook to prevent committing the lines containing it, and are generally used to mark TO-DOs that are required to be done before committing the changes.
---
...
---
> Source: [SomeAussieGaymer/fxPanel](https://github.com/SomeAussieGaymer/fxPanel) — distributed by [TomeVault](https://tomevault.io).
