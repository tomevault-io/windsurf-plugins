---
trigger: always_on
description: - `app/` — core Python modules: `bolt_listeners.py` (Slack Bolt handlers), `openai_ops.py`/`openai_image_ops.py` (OpenAI/Azure APIs), `slack_ui.py`/`slack_ops.py` (Slack UI/actions), `markdown_conversion.py`, `env.py`.
---
...
---
> Source: [seratch/ChatGPT-in-Slack](https://github.com/seratch/ChatGPT-in-Slack) — distributed by [TomeVault](https://tomevault.io).
