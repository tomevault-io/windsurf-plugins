...
- Run the full test suite with `swift test` and only commit if all tests pass.
- Run `bin/format`.

---
> Source: [davbeck/swift-glob](https://github.com/davbeck/swift-glob) — distributed by [TomeVault](https://tomevault.io).
