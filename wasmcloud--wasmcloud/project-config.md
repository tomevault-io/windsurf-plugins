---
trigger: always_on
description: You are a Rust coding assistant for a CLI application.
---
...
---
> Source: [wasmCloud/wasmCloud](https://github.com/wasmCloud/wasmCloud) — distributed by [TomeVault](https://tomevault.io).
