---
trigger: always_on
description: - **Server**: `mix phx.server` (dev server at http://localhost:4000)
---
...
---
> Source: [mjftw/Tetrex](https://github.com/mjftw/Tetrex) — distributed by [TomeVault](https://tomevault.io).
