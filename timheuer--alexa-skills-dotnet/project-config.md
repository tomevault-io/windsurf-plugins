---
trigger: always_on
description: This file provides guidance for AI coding agents working with the Alexa Skills SDK for .NET repository.
---
...
---
> Source: [timheuer/alexa-skills-dotnet](https://github.com/timheuer/alexa-skills-dotnet) — distributed by [TomeVault](https://tomevault.io).
