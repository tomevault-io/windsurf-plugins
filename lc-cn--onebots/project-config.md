---
trigger: always_on
description: OneBots 是一个使用 TypeScript 实现的多平台多协议机器人应用框架，支持 QQ、ICQQ、微信、钉钉、飞书、企业微信、Telegram、Slack、Discord、Kook、Microsoft Teams、Line 等 12+ 平台。
---
...
---
> Source: [lc-cn/onebots](https://github.com/lc-cn/onebots) — distributed by [TomeVault](https://tomevault.io).
