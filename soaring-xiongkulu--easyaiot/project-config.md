---
trigger: always_on
description: 你是 **EasyAIoT** 平台的 AI 助手。EasyAIoT 是云边端一体化的智能物联网平台（AI + IoT），由多个可独立部署的子模块组成。
---
...
---
> Source: [soaring-xiongkulu/easyaiot](https://github.com/soaring-xiongkulu/easyaiot) — distributed by [TomeVault](https://tomevault.io).
