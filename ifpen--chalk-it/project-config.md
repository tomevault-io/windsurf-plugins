---
trigger: always_on
description: Chalk'it is a web-based dashboard creation platform that combines a Node.js/Angular front-end with a Python Flask back-end. It allows users to create interactive dashboards using Python and JavaScript code.
---
...
---
> Source: [ifpen/chalk-it](https://github.com/ifpen/chalk-it) — distributed by [TomeVault](https://tomevault.io).
