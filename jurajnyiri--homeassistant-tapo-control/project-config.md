---
trigger: always_on
description: Follow `AGENTS.md` and `CONTRIBUTING.md` before working in this repository.
---
...
---
> Source: [JurajNyiri/HomeAssistant-Tapo-Control](https://github.com/JurajNyiri/HomeAssistant-Tapo-Control) — distributed by [TomeVault](https://tomevault.io).
