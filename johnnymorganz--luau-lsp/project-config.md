---
trigger: always_on
description: Provides Luau type definitions for the plugin API so that plugins get autocomplete and type checking.
---
...
---
> Source: [JohnnyMorganz/luau-lsp](https://github.com/JohnnyMorganz/luau-lsp) — distributed by [TomeVault](https://tomevault.io).
