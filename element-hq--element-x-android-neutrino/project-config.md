---
trigger: always_on
description: > **Repo:** `element-hq/element-x-android` — Android Matrix client (Compose UI + `matrix-rust-sdk`).
---
...
---
> Source: [element-hq/element-x-android-neutrino](https://github.com/element-hq/element-x-android-neutrino) — distributed by [TomeVault](https://tomevault.io).
