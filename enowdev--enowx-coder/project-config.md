---
trigger: always_on
description: Tauri desktop application built with Rust (backend) + React + TypeScript (frontend).
---
...
---
> Source: [enowdev/enowX-Coder](https://github.com/enowdev/enowX-Coder) — distributed by [TomeVault](https://tomevault.io).
