---
trigger: always_on
description: 本文件定义在 Cortex 工作区内使用 Copilot/AI 助手的团队约定与工作流程。Cortex 是一个基于 BEAM 的信号驱动 agent 平台，采用 Phoenix/LiveView、Elixir 以及多个自研子系统（SignalHub、Skills、Agent 等）。
---
