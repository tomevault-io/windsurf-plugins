---
trigger: always_on
description: This repository is a `pnpm` workspace monorepo. `apps/server` contains the Fastify API gateway, Drizzle migrations, worker entrypoints, and Vitest tests. `apps/web` contains the Next.js 15 App Router frontend for the marketing site, admin area, and user console. `packages/shared/src` holds cross-app TypeScript types and enums. Long-form design, deployment, security, and ADR notes live in `docs/`.
---
...
---
> Source: [xxf66666/xxf-ai-server](https://github.com/xxf66666/xxf-ai-server) — distributed by [TomeVault](https://tomevault.io).
