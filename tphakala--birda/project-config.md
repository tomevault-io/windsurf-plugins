---
trigger: always_on
description: Birda is a Rust CLI tool for analyzing audio files using BirdNET and Google Perch AI models. It uses the `birdnet-onnx` crate as its inference library.
---
...
---
> Source: [tphakala/birda](https://github.com/tphakala/birda) — distributed by [TomeVault](https://tomevault.io).
