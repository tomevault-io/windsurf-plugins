---
trigger: always_on
description: > **Critical**: Read [Known Pitfalls](README.md#-known-pitfalls-for-agents) in README before modifying code.
---
...
---
> Source: [tuanhung303/opencode-agent-context-pruning](https://github.com/tuanhung303/opencode-agent-context-pruning) — distributed by [TomeVault](https://tomevault.io).
