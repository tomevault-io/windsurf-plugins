---
trigger: always_on
description: Always install using `uv add` and not `pip install`.
---
...
---
> Source: [yohanesnuwara/boglodite](https://github.com/yohanesnuwara/boglodite) — distributed by [TomeVault](https://tomevault.io).
