---
trigger: always_on
description: Multi-module Maven project (`library` + `examples`) providing a Java client for the [Kraken REST API](https://docs.kraken.com/rest/). See [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md) for the request flow and component diagrams, and [docs/RELEASE.md](docs/RELEASE.md) for the release process.
---
...
---
> Source: [nyg/kraken-api-java](https://github.com/nyg/kraken-api-java) — distributed by [TomeVault](https://tomevault.io).
