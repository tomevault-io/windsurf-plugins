---
trigger: always_on
description: This file is the operating protocol for Codex, Claude Code, and similar local coding agents. Follow it when a user asks to install, deploy, configure, or verify this repository.
---
...
---
> Source: [realchendahuang/sub-store-cloudflare](https://github.com/realchendahuang/sub-store-cloudflare) — distributed by [TomeVault](https://tomevault.io).
