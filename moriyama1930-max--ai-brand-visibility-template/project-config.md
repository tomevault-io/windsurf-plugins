---
trigger: always_on
description: A Worker template that tests whether AI models (GPT-5.4, Claude Sonnet 4, Gemini 3 Flash, Llama 4, Mistral) mention your brand when answering relevant queries. All models run through Cloudflare AI Gateway — no external API keys needed.
---
...
---
> Source: [moriyama1930-max/ai-brand-visibility-template](https://github.com/moriyama1930-max/ai-brand-visibility-template) — distributed by [TomeVault](https://tomevault.io).
