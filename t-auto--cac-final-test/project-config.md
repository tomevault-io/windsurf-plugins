---
trigger: always_on
description: cd code-fish && pip install -r requirements.txt
---
...
---
> Source: [T-Auto/CAC-final-test](https://github.com/T-Auto/CAC-final-test) — distributed by [TomeVault](https://tomevault.io).
