---
trigger: always_on
description: 本文件适用于 `src/bk-login/pages/` 下的统一登录前端。用户在当前任务中的明确要求优先于本文件；若说明与源码或配置不一致，以当前 `package.json`、构建配置和实际代码为准。
---
...
---
> Source: [TencentBlueKing/bk-user](https://github.com/TencentBlueKing/bk-user) — distributed by [TomeVault](https://tomevault.io).
