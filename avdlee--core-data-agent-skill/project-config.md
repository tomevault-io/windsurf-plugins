...
4. **Core Data Best Practices**
   - Follows iOS 14+ best practices
   - Uses modern Swift patterns (async/await where appropriate)
   - Includes both "good" and "bad" examples for clarity
...
- **Description too vague**: "Helps with persistence" is insufficient; needs specific use cases
...
- **Outdated Core Data patterns**: Ensure iOS 14+ compatibility, mention iOS 17+ features explicitly
- **Missing thread safety guidance**: Always recommend NSManagedObjectID for cross-context communication
...
- **Verify Core Data accuracy**: Check against Apple documentation and WWDC sessions
...
- [Core Data Best Practices Repository](https://github.com/AvdLee/CoreDataBestPractices)
...
---
> Source: [AvdLee/Core-Data-Agent-Skill](https://github.com/AvdLee/Core-Data-Agent-Skill) — distributed by [TomeVault](https://tomevault.io).
