---
trigger: always_on
description: nuqs.dev deploys to production from `next`, so docs for a feature can go live
---
...
---
> Source: [47ng/nuqs](https://github.com/47ng/nuqs) — distributed by [TomeVault](https://tomevault.io).
