---
trigger: always_on
description: Proxy Chain is a Node.js proxy server library published to npm as [`proxy-chain`](https://www.npmjs.com/package/proxy-chain).
---
...
---
> Source: [apify/proxy-chain](https://github.com/apify/proxy-chain) — distributed by [TomeVault](https://tomevault.io).
