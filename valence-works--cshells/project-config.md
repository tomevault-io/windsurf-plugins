---
trigger: always_on
description: CShells is a lightweight, extensible shell and feature system for .NET projects that enables building modular and multi-tenant applications with per-shell DI containers and config-driven features.
---
...
---
> Source: [valence-works/cshells](https://github.com/valence-works/cshells) — distributed by [TomeVault](https://tomevault.io).
