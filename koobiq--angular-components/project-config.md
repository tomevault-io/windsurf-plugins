---
trigger: always_on
description: Use the Node.js version specified in [.nvmrc](.nvmrc).
---
...
---
> Source: [koobiq/angular-components](https://github.com/koobiq/angular-components) — distributed by [TomeVault](https://tomevault.io).
