---
trigger: always_on
description: gopus is a pure-Go, no-cgo implementation of the Opus audio codec (RFC 6716 /
---
...
---
> Source: [thesyncim/gopus](https://github.com/thesyncim/gopus) — distributed by [TomeVault](https://tomevault.io).
