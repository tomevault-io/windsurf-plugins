---
trigger: always_on
description: - **Consistent Project Structure**: Organize files and directories in a predictable, logical structure that team members can navigate easily
---
...
- **Justfile**: Look for a justfile in a project and use commands from that file whenever possible

---
> Source: [nanorepublica/django-prodserver](https://github.com/nanorepublica/django-prodserver) — distributed by [TomeVault](https://tomevault.io).
