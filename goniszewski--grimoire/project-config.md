---
trigger: always_on
description: Local-first bookmark manager. Frontend: React 18 + Vite + TypeScript (`src/`). Daemon: Bun + Hono (`daemon/`) bound to `127.0.0.1:3210`, SQLite storage.
---
...
---
> Source: [goniszewski/grimoire](https://github.com/goniszewski/grimoire) — distributed by [TomeVault](https://tomevault.io).
