---
trigger: always_on
description: * This cookbook uses `Policyfile.rb` for local and CI dependency resolution. Keep
---
...
---
> Source: [sous-chefs/mariadb](https://github.com/sous-chefs/mariadb) — distributed by [TomeVault](https://tomevault.io).
