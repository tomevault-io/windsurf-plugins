---
trigger: always_on
description: dymos is a pytho package for trajectory optimization within OpenMDAO.
---
...
---
> Source: [OpenMDAO/dymos](https://github.com/OpenMDAO/dymos) — distributed by [TomeVault](https://tomevault.io).
