---
trigger: always_on
description: 本文件为 dcloudio/hbuilderx-extension-docs 仓库定制的 Copilot CLI Agents 使用说明。
---
...
---
> Source: [dcloudio/hbuilderx-extension-docs](https://github.com/dcloudio/hbuilderx-extension-docs) — distributed by [TomeVault](https://tomevault.io).
