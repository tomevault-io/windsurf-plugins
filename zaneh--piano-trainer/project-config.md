---
trigger: always_on
description: This file gives future Codex runs project-specific context for `piano-trainer`.
---
...
---
> Source: [ZaneH/piano-trainer](https://github.com/ZaneH/piano-trainer) — distributed by [TomeVault](https://tomevault.io).
