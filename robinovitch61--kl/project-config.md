---
trigger: always_on
description: Run `make` to execute tests, linting, etc. This should be run to validate any change.
---
...
---
> Source: [robinovitch61/kl](https://github.com/robinovitch61/kl) — distributed by [TomeVault](https://tomevault.io).
