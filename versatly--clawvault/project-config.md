---
trigger: always_on
description: ClawVault is a structured persistent memory system for AI agents. It stores memories as Obsidian-compatible markdown files. See `README.md` for full documentation.
---
