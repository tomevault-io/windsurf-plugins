---
trigger: always_on
description: Offline, CPU-only AI toolkit for academic learning and demo on budget/old hardware (≤8 GB RAM, no GPU). Six independent modules each with a driver, tests, and Streamlit UI.
---
...
---
> Source: [yogeshhk/AIOOLL](https://github.com/yogeshhk/AIOOLL) — distributed by [TomeVault](https://tomevault.io).
