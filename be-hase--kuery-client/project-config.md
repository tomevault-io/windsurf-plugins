---
trigger: always_on
description: This file provides guidance to coding agents (Claude Code, Codex, etc.) when working with code in this repository. It is the canonical source; tool-specific entry points such as `CLAUDE.md` point here.
---
...
---
> Source: [be-hase/kuery-client](https://github.com/be-hase/kuery-client) — distributed by [TomeVault](https://tomevault.io).
