---
trigger: always_on
description: ostack is a collection of SKILL.md files that give AI agents structured roles for
---

# ostack — AI Engineering Workflow

ostack is a collection of SKILL.md files that give AI agents structured roles for
...
| `/ostack-upgrade` | Update ostack to the latest version. |
