---
trigger: always_on
description: This file provides guidance to Claude Code (claude.ai/code) when working across all projects.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/kaito-siba)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/kaito-siba)
