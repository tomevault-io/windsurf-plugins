---
trigger: always_on
description: CNCF service mesh (Envoy-based) for K8s/VMs. L4-L7 connectivity, security, observability, multi-zone/multi-mesh.
---
...
---
> Source: [kumahq/kuma](https://github.com/kumahq/kuma) — distributed by [TomeVault](https://tomevault.io).
