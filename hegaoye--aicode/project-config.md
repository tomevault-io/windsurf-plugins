---
trigger: always_on
description: Code generation framework based on Freemarker/MyBatis Plus + Spring Boot.
---
...
---
> Source: [hegaoye/aicode](https://github.com/hegaoye/aicode) — distributed by [TomeVault](https://tomevault.io).
