---
trigger: always_on
description: This file provides guidance to AI coding agents (Claude Code, Cursor, Copilot, Codex, etc.) when working with code in this repository.
---
...
---
> Source: [devconcept/multer-gridfs-storage](https://github.com/devconcept/multer-gridfs-storage) — distributed by [TomeVault](https://tomevault.io).
