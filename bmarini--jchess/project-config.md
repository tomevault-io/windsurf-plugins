---
trigger: always_on
description: Context for Claude Code when working in this repository.
---
...
---
> Source: [bmarini/jchess](https://github.com/bmarini/jchess) — distributed by [TomeVault](https://tomevault.io).
