# AI instruction files for flonat-research
...
```
npx tomevault install flonat/flonat-research
```
Source: [github.com/flonat/flonat-research](https://github.com/flonat/flonat-research).
