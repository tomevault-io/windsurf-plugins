---
trigger: always_on
description: 本文是 `cc-3-8-x-mcp` 的 agent 使用规则。它只支持 Cocos Creator 3.8.x；项目自己的预览参数、业务本地服地址、测试账号和验证步骤写在项目文档里。
---
...
---
> Source: [HappyLifeOk/cc-3-8-x-mcp](https://github.com/HappyLifeOk/cc-3-8-x-mcp) — distributed by [TomeVault](https://tomevault.io).
