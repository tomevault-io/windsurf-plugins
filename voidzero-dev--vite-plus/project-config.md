---
trigger: always_on
description: A monorepo task runner (like nx/turbo) with intelligent caching and dependency resolution.
---
...
---
> Source: [voidzero-dev/vite-plus](https://github.com/voidzero-dev/vite-plus) — distributed by [TomeVault](https://tomevault.io).
