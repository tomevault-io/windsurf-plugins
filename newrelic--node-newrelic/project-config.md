---
trigger: always_on
description: `newrelic` is an observability instrumentation agent. It hooks and traces
---
...
---
> Source: [newrelic/node-newrelic](https://github.com/newrelic/node-newrelic) — distributed by [TomeVault](https://tomevault.io).
