---
trigger: always_on
description: An OpenShift cluster health analysis tool that maps Prometheus alerts to high-level components, groups alerts into incidents, evaluates component health, and exposes results as Prometheus metrics.
---
...
---
> Source: [openshift/cluster-health-analyzer](https://github.com/openshift/cluster-health-analyzer) — distributed by [TomeVault](https://tomevault.io).
