---
trigger: always_on
description: Hello-AI 是面向中文小白的 AI / LLM 入门知识库。仓库即唯一内容源，MkDocs Material 构建为静态站点。
---
...
---
> Source: [Unclecheng-li/Hello-AI](https://github.com/Unclecheng-li/Hello-AI) — distributed by [TomeVault](https://tomevault.io).
