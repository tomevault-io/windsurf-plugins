---
trigger: always_on
description: Pure Rust QOA (Quite OK Audio) encoder/decoder. Single-file crate (`src/lib.rs`, ~1250 lines) that enforces `#![forbid(unsafe_code)]`. The encoder beats the reference C implementation by ~27% while remaining 100% safe.
---
...
---
> Source: [rafaelcaricio/qoaudio](https://github.com/rafaelcaricio/qoaudio) — distributed by [TomeVault](https://tomevault.io).
