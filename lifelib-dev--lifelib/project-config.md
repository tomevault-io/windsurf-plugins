---
trigger: always_on
description: lifelib is a Python package that contains reusable project templates for building actuarial models, particularly in life insurance.
---
...
---
> Source: [lifelib-dev/lifelib](https://github.com/lifelib-dev/lifelib) — distributed by [TomeVault](https://tomevault.io).
