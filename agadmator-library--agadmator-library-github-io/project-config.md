---
trigger: always_on
description: A Vue 3 + TypeScript web application that catalogs chess videos from the agadmator YouTube channel. The project includes automated data collection via YouTube API, chess game analysis using Stockfish, and a searchable/filterable video library interface.
---
...
---
> Source: [agadmator-library/agadmator-library.github.io](https://github.com/agadmator-library/agadmator-library.github.io) — distributed by [TomeVault](https://tomevault.io).
