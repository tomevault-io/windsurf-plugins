---
trigger: always_on
description: - Use the latest versions of npm packages when adding dependencies.
---
...
---
> Source: [vercel-labs/webreel](https://github.com/vercel-labs/webreel) — distributed by [TomeVault](https://tomevault.io).
