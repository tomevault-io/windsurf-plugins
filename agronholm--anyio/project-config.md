---
trigger: always_on
description: AnyIO is a high-level asynchronous concurrency and networking library for Python that works on top of both **asyncio** and **Trio**. Source code lives in `src/`, tests in `tests/`.
---
...
---
> Source: [agronholm/anyio](https://github.com/agronholm/anyio) — distributed by [TomeVault](https://tomevault.io).
