---
trigger: always_on
description: - Component library / design system — publishes `@synerise/ds-*` packages to npm
---
...
- Output: individual ESM files (1:1 src→dist mapping via `preserveModules`), not bundled
- TypeScript declarations generated by `vite-plugin-dts`
- Storybook uses **Vite** via `@storybook/react-vite`
...
---
> Source: [Synerise/synerise-design](https://github.com/Synerise/synerise-design) — distributed by [TomeVault](https://tomevault.io).
