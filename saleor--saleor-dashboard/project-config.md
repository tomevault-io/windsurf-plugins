---
trigger: always_on
description: **📚 For detailed implementation instructions for adding new fields or migrating to WHERE API, see [IMPLEMENTATION_GUIDE.md](./IMPLEMENTATION_GUIDE.md)**
---
