---
trigger: always_on
description: This .NET SDK covers Alpaca trading API surface and provides access for all features of this API. The Broker API should be explictitly excluded from any future analysis and processing.
---
...
---
> Source: [alpacahq/alpaca-trade-api-csharp](https://github.com/alpacahq/alpaca-trade-api-csharp) — distributed by [TomeVault](https://tomevault.io).
