---
trigger: always_on
description: - Keep real task completion primary and preserve the structural distinction between project evidence and user evidence.
---
...
---
> Source: [uczltw6/project-mentor](https://github.com/uczltw6/project-mentor) — distributed by [TomeVault](https://tomevault.io).
