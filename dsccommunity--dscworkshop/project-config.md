---
trigger: always_on
description: These instructions are loaded automatically by GitHub Copilot in any session opened against this repository. They are the **repo-scoped** counterpart to the user-level customization in [CopilotAtelier](https://github.com/raandree/CopilotAtelier).
---
...
---
> Source: [dsccommunity/DscWorkshop](https://github.com/dsccommunity/DscWorkshop) — distributed by [TomeVault](https://tomevault.io).
