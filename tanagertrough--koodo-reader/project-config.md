---
trigger: always_on
description: - Validate all IPC arguments from the renderer before filesystem, DB, or shell operations
---
...
---
> Source: [TanagerTrough/koodo-reader](https://github.com/TanagerTrough/koodo-reader) — distributed by [TomeVault](https://tomevault.io).
