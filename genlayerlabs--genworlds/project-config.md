---
trigger: always_on
description: Agents are the entities that are both active and reactive within the world. They have a set of goals and try to accomplish them by planning a series of actions. Also they can trigger non-determinstic actions named `ThoughtActions`.
---
...
---
> Source: [genlayerlabs/genworlds](https://github.com/genlayerlabs/genworlds) — distributed by [TomeVault](https://tomevault.io).
