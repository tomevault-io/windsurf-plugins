---
trigger: always_on
description: - **Type:** Signum Framework SPA
---
...
---
> Source: [signumsoftware/framework](https://github.com/signumsoftware/framework) — distributed by [TomeVault](https://tomevault.io).
