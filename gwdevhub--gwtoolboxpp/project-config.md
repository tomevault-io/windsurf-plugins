---
trigger: always_on
description: Instructions for any AI agent in this repo. (`CLAUDE.md` just imports this.)
---
...
---
> Source: [gwdevhub/GWToolboxpp](https://github.com/gwdevhub/GWToolboxpp) — distributed by [TomeVault](https://tomevault.io).
