---
trigger: always_on
description: Out-of-tree DeepSeek Harness plugin (host + Web client bundle). Read [dsh-plugin-create](../deepseek-harness/.agents/skills/dsh-plugin-create/SKILL.md) for the recipe this repo follows; the harness checkout sits at `../deepseek-harness`.
---
...
src/client/         browser half, served as the single file /plugins/dsh-at-any/client.js
...
---
> Source: [hatsuyuki0103/dsh-at-any](https://github.com/hatsuyuki0103/dsh-at-any) — distributed by [TomeVault](https://tomevault.io).
