---
trigger: always_on
description: This project interacts with **Cropster** (c-sar.cropster.com), a coffee roastery management platform used by **Good Folks Coffee** (account: zach@goodfolkscoffee.com). Version 26.16.3.
---
