---
trigger: always_on
description: - `README.md`、`skills/marp/SKILL.md`、`assets/examples/md/` はすべて Jest テスト内で自動生成される
---
...
---
> Source: [masaki39/marp-mcp](https://github.com/masaki39/marp-mcp) — distributed by [TomeVault](https://tomevault.io).
