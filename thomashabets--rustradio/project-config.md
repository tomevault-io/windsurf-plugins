---
trigger: always_on
description: When context is getting tight, leave a compact handoff that lets the
---
...
---
> Source: [ThomasHabets/rustradio](https://github.com/ThomasHabets/rustradio) — distributed by [TomeVault](https://tomevault.io).
