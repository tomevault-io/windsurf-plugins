---
trigger: always_on
description: When working in Windows environments or when the shell is PowerShell (indicated by `.exe` in shell path, Windows OS, or PowerShell prompts like `PS C:\>`):
---
