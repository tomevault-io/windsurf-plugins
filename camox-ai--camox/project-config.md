---
trigger: always_on
description: - Run `pnpm check` from the repo root when you're done making a series of code changes.
---
...
---
> Source: [camox-ai/camox](https://github.com/camox-ai/camox) — distributed by [TomeVault](https://tomevault.io).
