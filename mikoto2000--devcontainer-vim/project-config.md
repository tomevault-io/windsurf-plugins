---
trigger: always_on
description: - 現在のプラットフォーム用にビルド: `make build`
---
...
---
> Source: [mikoto2000/devcontainer.vim](https://github.com/mikoto2000/devcontainer.vim) — distributed by [TomeVault](https://tomevault.io).
