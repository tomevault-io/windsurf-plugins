---
trigger: always_on
description: Always format code using Prettier before opening a pull request by running `yarn format`. The project uses Prettier with Tailwind CSS plugin and single attribute per line configuration.
---
...
---
> Source: [langchain-ai/open-agent-platform](https://github.com/langchain-ai/open-agent-platform) — distributed by [TomeVault](https://tomevault.io).
