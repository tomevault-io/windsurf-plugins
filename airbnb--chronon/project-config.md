---
trigger: always_on
description: Chronon is an open-source Feature Platform for ML. It solves training-serving skew by ensuring the same feature logic runs in both batch (training) and online (serving) environments.
---
...
---
> Source: [airbnb/chronon](https://github.com/airbnb/chronon) — distributed by [TomeVault](https://tomevault.io).
