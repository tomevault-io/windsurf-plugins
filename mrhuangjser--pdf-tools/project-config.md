---
trigger: always_on
description: This rule is triggered when the user types `@qa` and activates the QA Specialist agent persona.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/MrHuangJser) — claim your Tome and manage your conversions.
