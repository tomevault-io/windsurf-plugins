---
trigger: always_on
description: This is a modern FastAPI backend with **clean architecture** using **domain-driven design**:
---
...
---
> Source: [bibektimilsina00/FastAPI-PgStarterKit](https://github.com/bibektimilsina00/FastAPI-PgStarterKit) — distributed by [TomeVault](https://tomevault.io).
