---
trigger: always_on
description: unifi2mqtt is an MQTT interface ("bridge"/"adapter") for Ubiquiti UniFi network controllers: client
---
...
---
> Source: [hobbyquaker/unifi2mqtt](https://github.com/hobbyquaker/unifi2mqtt) — distributed by [TomeVault](https://tomevault.io).
