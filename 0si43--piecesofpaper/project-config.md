---
trigger: always_on
description: - Known pitfalls (PencilKit, Xcode, pbxproj): see [docs/GOTCHAS.md](docs/GOTCHAS.md)
---
...
---
> Source: [0si43/PiecesOfPaper](https://github.com/0si43/PiecesOfPaper) — distributed by [TomeVault](https://tomevault.io).
