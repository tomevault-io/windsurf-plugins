---
trigger: always_on
description: oxrl train --model Qwen/Qwen2.5-0.5B-Instruct --task math --epochs 1 --steps 10
---
...
---
> Source: [warlockee/oxRL](https://github.com/warlockee/oxRL) — distributed by [TomeVault](https://tomevault.io).
