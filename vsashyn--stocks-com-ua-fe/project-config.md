...
5.  **Type checking**: after major modifications run `pnpm build` and fix any errors.
...
7. **Installing packages**. We are using a pnpm. For example `pnpm add uuid && pnpm add -D @types/uuid`
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/vsashyn) — claim your Tome and manage your conversions.
