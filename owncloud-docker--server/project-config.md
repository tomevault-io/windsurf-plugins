---
trigger: always_on
description: This repository builds the official **ownCloud Classic** Docker image
---
...
- `v24.04/` — Ubuntu 24.04 based image (ownCloud 11.0.0)
...
---
> Source: [owncloud-docker/server](https://github.com/owncloud-docker/server) — distributed by [TomeVault](https://tomevault.io).
