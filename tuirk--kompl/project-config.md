---
trigger: always_on
description: **For AI agents helping a user install, update, and use Kompl.**
---
...
---
> Source: [tuirk/Kompl](https://github.com/tuirk/Kompl) — distributed by [TomeVault](https://tomevault.io).
