---
trigger: always_on
description: Instructions for AI coding assistants and developers working on the jacky-agent codebase.
---

# Jacky Agent - Development Guide

Instructions for AI coding assistants and developers working on the jacky-agent codebase.

**Never give up on the right solution.**

## What Jacky Is

Jacky is a personal AI agent that runs the same agent core across a CLI, a
...
Read the balance right: Jacky ships a **lot** — most merges are bug fixes to
...
- **Expand reach at the edges.** New platform adapters, channels, providers,
  ...
  (`jacky tools`, `jacky setup`, auto-install) rather than bolting on a raw
  env var.
...
- **E2E validation, not just green unit mocks.** For anything touching
  ...
  against a temp `JACKY_HOME`. Mocks hide integration bugs.
...
---
> Source: [jaswanthsai1/jacky-cli](https://github.com/jaswanthsai1/jacky-cli) — distributed by [TomeVault](https://tomevault.io).
