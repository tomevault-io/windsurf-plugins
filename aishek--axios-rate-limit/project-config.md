---
trigger: always_on
description: - Keep changes small, reviewable, and aligned with existing project patterns.
---
...
---
> Source: [aishek/axios-rate-limit](https://github.com/aishek/axios-rate-limit) — distributed by [TomeVault](https://tomevault.io).
