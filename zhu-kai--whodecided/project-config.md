---
trigger: always_on
description: Guidance for AI agents and contributors working on **whodecided** itself.
---
...
---
> Source: [zhu-kai/whodecided](https://github.com/zhu-kai/whodecided) — distributed by [TomeVault](https://tomevault.io).
