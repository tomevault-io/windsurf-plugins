---
trigger: always_on
description: LLM generation is strictly **forbidden** in the sokol headers, shaders and
---
...
---
> Source: [floooh/sokol](https://github.com/floooh/sokol) — distributed by [TomeVault](https://tomevault.io).
