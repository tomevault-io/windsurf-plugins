---
trigger: always_on
description: Hetzner Server Radar is a web application that tracks prices of Hetzner's Dedicated Server Auction over time. It helps customers identify the best configurations and prices by providing advanced filtering, pricing history, and target price alerts.
---
...
---
> Source: [elsbrock/hetzner-radar](https://github.com/elsbrock/hetzner-radar) — distributed by [TomeVault](https://tomevault.io).
