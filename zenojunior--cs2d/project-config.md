---
trigger: always_on
description: - NEVER run `git commit` or `git push` without explicit permission. All code must
---
...
---
> Source: [zenojunior/cs2d](https://github.com/zenojunior/cs2d) — distributed by [TomeVault](https://tomevault.io).
