---
trigger: always_on
description: Use this file as the default operating guide for this repository. Follow it first, and only search the codebase when this file is incomplete or incorrect.
---
...
---
> Source: [reducedmatrice/BadmintonCoachAgent](https://github.com/reducedmatrice/BadmintonCoachAgent) — distributed by [TomeVault](https://tomevault.io).
