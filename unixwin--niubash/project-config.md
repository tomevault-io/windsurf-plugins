---
trigger: always_on
description: - Do not use PowerShell or pwsh as the project command language.
---
...
---
> Source: [unixwin/niubash](https://github.com/unixwin/niubash) — distributed by [TomeVault](https://tomevault.io).
