---
trigger: always_on
description: - `README.md`: main entry point and **only index** (technique notes + prompt classification with links).
---
...
---
> Source: [voytas75/GPTprompts](https://github.com/voytas75/GPTprompts) — distributed by [TomeVault](https://tomevault.io).
