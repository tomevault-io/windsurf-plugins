---
trigger: always_on
description: - **Build the model checker**: `bazel build //:fizzbee`
---
...
---
> Source: [fizzbee-io/fizzbee](https://github.com/fizzbee-io/fizzbee) — distributed by [TomeVault](https://tomevault.io).
