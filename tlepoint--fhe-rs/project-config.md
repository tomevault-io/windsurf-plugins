---
trigger: always_on
description: This repository contains the `fhe.rs` library, a cryptographic library in Rust for Ring-LWE-based homomorphic encryption. Go read the latest version of the README.md.
---
...
---
> Source: [tlepoint/fhe.rs](https://github.com/tlepoint/fhe.rs) — distributed by [TomeVault](https://tomevault.io).
