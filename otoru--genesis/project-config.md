---
trigger: always_on
description: Guidance for AI assistants working on the Genesis project.
---
...
---
> Source: [Otoru/Genesis](https://github.com/Otoru/Genesis) — distributed by [TomeVault](https://tomevault.io).
