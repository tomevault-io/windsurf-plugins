---
trigger: always_on
description: - Do not commit code to directly 'main' branch.
---
...
---
> Source: [elycruz/rollup-plugin-sass](https://github.com/elycruz/rollup-plugin-sass) — distributed by [TomeVault](https://tomevault.io).
