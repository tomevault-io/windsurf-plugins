---
trigger: always_on
description: - `src/nucleus_apple_mcp/`: Python MCP server (FastMCP). Entry points: `__main__.py`, `mcp_app.py`.
---
...
---
> Source: [zish-rob-crur/nucleus-apple-mcp](https://github.com/zish-rob-crur/nucleus-apple-mcp) — distributed by [TomeVault](https://tomevault.io).
