---
trigger: always_on
description: Lambda-coroutines (`[](...) -> ACoroTerminator { co_await ...; }`) must have an
---
...
---
> Source: [cutelyst/asql](https://github.com/cutelyst/asql) — distributed by [TomeVault](https://tomevault.io).
