---
trigger: always_on
description: 本规范用于约束 AI Agent 在 `NetEngine` 仓库中的分析、修改、验证与协作方式
---
...
---
> Source: [dashiell-zhang/NetEngine](https://github.com/dashiell-zhang/NetEngine) — distributed by [TomeVault](https://tomevault.io).
