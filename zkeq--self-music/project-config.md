---
trigger: always_on
description: - 根目录：`frontend/`（Next.js + TypeScript + Tailwind CSS 4），`backend/`（FastAPI + SQLite）。
---
...
---
> Source: [zkeq/Self-Music](https://github.com/zkeq/Self-Music) — distributed by [TomeVault](https://tomevault.io).
