---
trigger: always_on
description: - The API is `POST /` only. Keep `GET /` returning the existing 400 guidance.
---
...
---
> Source: [phpdocker-io/readability-js-server](https://github.com/phpdocker-io/readability-js-server) — distributed by [TomeVault](https://tomevault.io).
