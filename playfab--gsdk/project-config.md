---
trigger: always_on
description: This is a multi-language SDK (C++, C#, Java, Go) plus game engine plugins (Unity, Unreal) for integrating game servers with PlayFab Multiplayer Servers. Each language lives in its own top-level directory with independent build systems. There is no single top-level build.
---
...
---
> Source: [PlayFab/gsdk](https://github.com/PlayFab/gsdk) — distributed by [TomeVault](https://tomevault.io).
