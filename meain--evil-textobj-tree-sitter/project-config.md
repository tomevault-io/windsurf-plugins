---
trigger: always_on
description: An Emacs package providing tree-sitter powered text objects for `evil-mode` and `thing-at-point`. Works with both `elisp-tree-sitter` and the builtin `treesit` library (Emacs 29+).
---
...
---
> Source: [meain/evil-textobj-tree-sitter](https://github.com/meain/evil-textobj-tree-sitter) — distributed by [TomeVault](https://tomevault.io).
