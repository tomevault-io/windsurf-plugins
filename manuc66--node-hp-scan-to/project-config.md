---
trigger: always_on
description: Guidelines for agent contributors working on this repository.
---
...
---
> Source: [manuc66/node-hp-scan-to](https://github.com/manuc66/node-hp-scan-to) — distributed by [TomeVault](https://tomevault.io).
