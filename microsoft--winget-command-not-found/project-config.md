---
trigger: always_on
description: `Microsoft.WinGet.CommandNotFound` is a PowerShell 7 **feedback provider** module that suggests WinGet packages when a native command isn't found, surfacing them via PowerShell's predictive IntelliSense (command-line predictor).
---
...
---
> Source: [microsoft/winget-command-not-found](https://github.com/microsoft/winget-command-not-found) — distributed by [TomeVault](https://tomevault.io).
