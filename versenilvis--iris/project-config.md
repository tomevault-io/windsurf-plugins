---
trigger: always_on
description: **IRIS** is a lightweight, TTY-native shell auto-completion tool written in Go. No Electron, no GUI, no telemetry-runs on macOS and Linux with terminal emulators supporting ANSI colors.
---
...
---
> Source: [versenilvis/IRIS](https://github.com/versenilvis/IRIS) — distributed by [TomeVault](https://tomevault.io).
