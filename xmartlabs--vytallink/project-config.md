---
trigger: always_on
description: - `mobile/`: Flutter app + MCP server; code in `lib/`, design system in `design_system/`, env samples in `environments/`.
---
...
---
> Source: [xmartlabs/vytalLink](https://github.com/xmartlabs/vytalLink) — distributed by [TomeVault](https://tomevault.io).
