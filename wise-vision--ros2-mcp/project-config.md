---
trigger: always_on
description: This repo is a **Python MCP server for ROS 2** (Humble/Jazzy). The packaged entrypoint is `mcp_ros_2_server` (see `pyproject.toml`).
---
...
---
> Source: [wise-vision/ros2_mcp](https://github.com/wise-vision/ros2_mcp) — distributed by [TomeVault](https://tomevault.io).
