---
trigger: always_on
description: SakuraCord is an interactive native macOS Discord client. User-visible actions
---
...
---
> Source: [SakuraCordApp/SakuraCord](https://github.com/SakuraCordApp/SakuraCord) — distributed by [TomeVault](https://tomevault.io).
