...
older majors are not bundled (see
[Versioning and compatibility](/#versioning-and-compatibility) for the
rationale).
...
---
> Source: [stellar/js-stellar-sdk](https://github.com/stellar/js-stellar-sdk) — distributed by [TomeVault](https://tomevault.io).
