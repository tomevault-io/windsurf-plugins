---
trigger: always_on
description: This is a set of convention extension should follow for consistency.
---
...
---
> Source: [Azure/autorest](https://github.com/Azure/autorest) — distributed by [TomeVault](https://tomevault.io).
