---
trigger: always_on
description: - Do not write code before stating assumptions.
---
...
---
> Source: [webprofusion/soundshed-guitar](https://github.com/webprofusion/soundshed-guitar) — distributed by [TomeVault](https://tomevault.io).
