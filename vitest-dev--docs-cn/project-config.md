---
trigger: always_on
description: Guidance for working on the VitePress site in `docs/`. The root `AGENTS.md` applies here too.
---
...
---
> Source: [vitest-dev/docs-cn](https://github.com/vitest-dev/docs-cn) — distributed by [TomeVault](https://tomevault.io).
