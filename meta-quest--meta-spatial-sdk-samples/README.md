...
Original source: `.cursor/rules/*.mdc` in [meta-quest/Meta-Spatial-SDK-Samples](https://github.com/meta-quest/Meta-Spatial-SDK-Samples).
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/meta-quest/Meta-Spatial-SDK-Samples](https://github.com/meta-quest/Meta-Spatial-SDK-Samples)

---

Install this config instantly:
```
npx tomevault install meta-quest/Meta-Spatial-SDK-Samples
```
Source: [github.com/meta-quest/Meta-Spatial-SDK-Samples](https://github.com/meta-quest/Meta-Spatial-SDK-Samples).
