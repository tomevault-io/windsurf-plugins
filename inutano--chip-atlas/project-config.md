---
trigger: always_on
description: This MCP server provides read-only access to [ChIP-Atlas](https://chip-atlas.org), a comprehensive database of public ChIP-seq, ATAC-seq, DNase-seq, and Bisulfite-seq experiments. Use these tools to help users explore epigenomic data, find experiments, and retrieve analysis results.
---
...
---
> Source: [inutano/chip-atlas](https://github.com/inutano/chip-atlas) — distributed by [TomeVault](https://tomevault.io).
