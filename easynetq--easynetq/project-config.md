---
trigger: always_on
description: EasyNetQ is a .NET client API for RabbitMQ. It provides a high-level abstraction over RabbitMQ.Client with pub/sub, RPC, send/receive, scheduling, and more.
---
...
---
> Source: [EasyNetQ/EasyNetQ](https://github.com/EasyNetQ/EasyNetQ) — distributed by [TomeVault](https://tomevault.io).
