---
trigger: always_on
description: These rules guide AI agents to generate correct, safe Cadence transactions using Scheduled Transactions.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/borngreat-ikwutah)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/borngreat-ikwutah)
