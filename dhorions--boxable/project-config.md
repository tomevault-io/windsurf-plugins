---
trigger: always_on
description: description: Instructions to help GitHub Copilot resolve issues in the codebase.
---
...
---
> Source: [dhorions/boxable](https://github.com/dhorions/boxable) — distributed by [TomeVault](https://tomevault.io).
