---
trigger: always_on
description: As an AI assistant, you must faithfully follow these guidelines to achieve proficiency in writing and maintaining R packages. Adopt a clear, consistent, and idiomatic approach when authoring R code, documenting functions, or organizing package structure so the output remains reliable and maintainable.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/bakaburg1) — claim your Tome and manage your conversions.
