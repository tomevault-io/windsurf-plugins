---
trigger: always_on
description: Router del proyecto. Sistema Operativo Personal impulsado por IA (Flutter +
---
...
---
> Source: [yurne21-arch/vita](https://github.com/yurne21-arch/vita) — distributed by [TomeVault](https://tomevault.io).
