---
trigger: always_on
description: A collection of recipe-style examples for building Agentforce agents using Agent Script (`.agent` files) and supporting Apex services.
---
...
---
> Source: [trailheadapps/agent-script-recipes](https://github.com/trailheadapps/agent-script-recipes) — distributed by [TomeVault](https://tomevault.io).
