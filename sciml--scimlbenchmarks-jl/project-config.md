---
trigger: always_on
description: For changes confined to benchmark sources or their environments under `benchmarks/`, the authoritative test is that every affected benchmark Weaves without error. Run the same entrypoint used by CI:
---
