---
trigger: always_on
description: Owns command implementations selected by `src/main.rs`.
---
...
---
> Source: [cristianoliveira/funzzy](https://github.com/cristianoliveira/funzzy) — distributed by [TomeVault](https://tomevault.io).
