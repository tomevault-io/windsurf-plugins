---
trigger: always_on
description: AI agents built on large language models control the path to solving a complex problem. They can typically act on feedback to refine their plan of action, a capability that can improve performance and help them accomplish more sophisticated tasks.
---
...
---
> Source: [KarthikhRR/Stella-Agent](https://github.com/KarthikhRR/Stella-Agent) — distributed by [TomeVault](https://tomevault.io).
