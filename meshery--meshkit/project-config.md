---
trigger: always_on
description: MeshKit is the shared Go library of the Meshery ecosystem: structured errors, logging, database
---
...
---
> Source: [meshery/meshkit](https://github.com/meshery/meshkit) — distributed by [TomeVault](https://tomevault.io).
