---
trigger: always_on
description: This agent runs in a short‑lived environment. Any uncommitted or unpushed work will be permanently
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/rash-sh)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/rash-sh)
