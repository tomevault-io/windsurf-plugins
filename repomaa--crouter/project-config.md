---
trigger: always_on
description: A standalone HTTP router for Crystal language with route params, optional segments, grouping, and controller support.
---
...
---
> Source: [repomaa/crouter](https://github.com/repomaa/crouter) — distributed by [TomeVault](https://tomevault.io).
