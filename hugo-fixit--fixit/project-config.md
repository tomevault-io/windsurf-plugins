---
trigger: always_on
description: This document defines the detailed coding standards for the FixIt theme project. For project overview, architecture, and development commands, see [CLAUDE.md](../../CLAUDE.md).
---
...
---
> Source: [hugo-fixit/FixIt](https://github.com/hugo-fixit/FixIt) — distributed by [TomeVault](https://tomevault.io).
