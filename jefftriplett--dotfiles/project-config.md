---
trigger: always_on
description: - Format all justfiles: `just fmt`
---
...
---
> Source: [jefftriplett/dotfiles](https://github.com/jefftriplett/dotfiles) — distributed by [TomeVault](https://tomevault.io).
