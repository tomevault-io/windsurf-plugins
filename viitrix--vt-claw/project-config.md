---
trigger: always_on
description: **vt-claw** 是一款面向硬件技能的 Claw 软件，通过微信机器人接口提供 AI Agent 服务。项目的三大核心特性：
---
...
---
> Source: [viitrix/vt-claw](https://github.com/viitrix/vt-claw) — distributed by [TomeVault](https://tomevault.io).
