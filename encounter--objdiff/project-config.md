---
trigger: always_on
description: - `objdiff-core`: core library with diffing logic and shared components
---
...
---
> Source: [encounter/objdiff](https://github.com/encounter/objdiff) — distributed by [TomeVault](https://tomevault.io).
