---
trigger: always_on
description: gjoa is a Firefox 152 fork authored in **beagle** (`.bjs` → JS / `.sys.mjs`). This
---
...
---
> Source: [tompassarelli/gjoa](https://github.com/tompassarelli/gjoa) — distributed by [TomeVault](https://tomevault.io).
