---
trigger: always_on
description: - `main.go` + `app.go` boot Wails; keep shared logic under `pkg/` so the UI layer can stay lean.
---
...
---
> Source: [masahide/OmniSSHAgent](https://github.com/masahide/OmniSSHAgent) — distributed by [TomeVault](https://tomevault.io).
