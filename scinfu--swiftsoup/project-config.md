---
trigger: always_on
description: This repo’s current performance harness is the `BenchmarkProfileTest/testParseBenchmarkProfile` test. It is driven by
---
...
---
> Source: [scinfu/SwiftSoup](https://github.com/scinfu/SwiftSoup) — distributed by [TomeVault](https://tomevault.io).
