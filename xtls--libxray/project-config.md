---
trigger: always_on
description: manages the Core lifecycle only; it does not sample or persist traffic.
---
...
---
> Source: [XTLS/libXray](https://github.com/XTLS/libXray) — distributed by [TomeVault](https://tomevault.io).
