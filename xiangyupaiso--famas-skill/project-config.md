---
trigger: always_on
description: 本项目包含 FAMAS (Fund Analysis Multi-Agent System) 的自定义 Skills，可在 OpenAI Codex CLI 中直接使用。
---
...
---
> Source: [xiangyupaiso/FAMAS-Skill](https://github.com/xiangyupaiso/FAMAS-Skill) — distributed by [TomeVault](https://tomevault.io).
