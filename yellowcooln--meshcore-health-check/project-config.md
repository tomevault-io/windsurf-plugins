---
trigger: always_on
description: - `server.js`: Express API, MQTT client, MeshCore packet parsing, session
---
...
---
> Source: [yellowcooln/meshcore-health-check](https://github.com/yellowcooln/meshcore-health-check) — distributed by [TomeVault](https://tomevault.io).
