---
trigger: always_on
description: python3 -m venv .venv && . .venv/bin/activate
---
...
---
> Source: [trinodb/trino-python-client](https://github.com/trinodb/trino-python-client) — distributed by [TomeVault](https://tomevault.io).
