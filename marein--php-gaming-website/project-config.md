---
trigger: always_on
description: After every code change, run `./project unit`, `./project sniffer`, and `./project analyzer`.
---
...
---
> Source: [marein/php-gaming-website](https://github.com/marein/php-gaming-website) — distributed by [TomeVault](https://tomevault.io).
