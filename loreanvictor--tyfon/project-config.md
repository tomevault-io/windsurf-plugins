---
trigger: always_on
description: TyFON operates on a series of conventions. You need to follow some of them for it to work properly, some others
---
...
---
> Source: [loreanvictor/tyfon](https://github.com/loreanvictor/tyfon) — distributed by [TomeVault](https://tomevault.io).
