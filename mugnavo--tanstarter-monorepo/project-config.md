---
trigger: always_on
description: - Stack: TypeScript + React (TanStack Start) in a pnpm + Vite+ monorepo, with Drizzle ORM, shadcn/ui, and Better Auth.
---
...
---
> Source: [mugnavo/tanstarter-monorepo](https://github.com/mugnavo/tanstarter-monorepo) — distributed by [TomeVault](https://tomevault.io).
