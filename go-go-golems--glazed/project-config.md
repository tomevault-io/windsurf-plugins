---
trigger: always_on
description: - Run a binary in XXX/YYY/FOOO: `go run ./XXX/YYY/FOOO` . Use this instead of build + ./XXX.
---
...
---
> Source: [go-go-golems/glazed](https://github.com/go-go-golems/glazed) — distributed by [TomeVault](https://tomevault.io).
