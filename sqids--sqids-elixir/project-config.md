---
trigger: always_on
description: Sqids is a library for generating short, YouTube-looking IDs from non-negative integers. IDs are reversible (decode back to numbers), collision-free, and profanity-filtered via a blocklist.
---
...
---
> Source: [sqids/sqids-elixir](https://github.com/sqids/sqids-elixir) — distributed by [TomeVault](https://tomevault.io).
