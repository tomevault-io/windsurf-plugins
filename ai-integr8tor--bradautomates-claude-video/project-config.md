---
trigger: always_on
description: Agent Skills package that gives an agent a video input. Installable across Claude Code (most common host), Codex, Cursor, GitHub Copilot, and 50+ other [Agent Skills](https://agentskills.io) hosts. Pure-stdlib Python that orchestrates `yt-dlp` + `ffmpeg` and an optional Whisper API.
---
...
---
> Source: [ai-integr8tor/bradautomates-claude-video](https://github.com/ai-integr8tor/bradautomates-claude-video) — distributed by [TomeVault](https://tomevault.io).
