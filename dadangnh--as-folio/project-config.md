---
trigger: always_on
description: Guidelines for AI agents (Claude Code, Codex, Copilot Workspace, etc.) contributing to as-folio.
---
...
---
> Source: [dadangnh/as-folio](https://github.com/dadangnh/as-folio) — distributed by [TomeVault](https://tomevault.io).
