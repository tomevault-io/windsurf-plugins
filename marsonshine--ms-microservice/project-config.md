---
trigger: always_on
description: When handling a bug, failure, unexpected behavior, or edge case, do not optimize only for the reported example. Treat it as evidence of a potentially broader defect.
---
...
---
> Source: [MarsonShine/MS.Microservice](https://github.com/MarsonShine/MS.Microservice) — distributed by [TomeVault](https://tomevault.io).
