---
trigger: always_on
description: Applies to: `docs/` and its descendants.
---
...
---
> Source: [AndreiDrang/python-rucaptcha](https://github.com/AndreiDrang/python-rucaptcha) — distributed by [TomeVault](https://tomevault.io).
