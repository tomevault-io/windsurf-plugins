---
trigger: always_on
description: OpenID Connect & Discovery client library (`openid` crate), async/await, on top of `reqwest` + `biscuit`.
---
...
---
> Source: [kilork/openid](https://github.com/kilork/openid) — distributed by [TomeVault](https://tomevault.io).
