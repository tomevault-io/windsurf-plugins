---
trigger: always_on
description: - **禁止读取或修改** `src/SARibbon.cpp` 和 `src/SARibbon.h` — 这是 amalgamate 工具生成的合并文件，所有源码改动应在 `src/SARibbonBar/` 下进行
---
...
---
> Source: [czyt1988/SARibbon](https://github.com/czyt1988/SARibbon) — distributed by [TomeVault](https://tomevault.io).
