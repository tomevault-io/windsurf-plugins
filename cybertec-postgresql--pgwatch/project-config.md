---
trigger: always_on
description: `pgwatch` is a PostgreSQL monitoring solution designed to provide insights into database performance and health. The project is structured as a multi-component system with Docker-based deployment for both development and production environments. Key components include:
---
