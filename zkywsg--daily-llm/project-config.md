---
trigger: always_on
description: **不是每件事都走 brainstorm → spec → plan → subagent**。按下面三档决定：
---
...
---
> Source: [zkywsg/Daily-LLM](https://github.com/zkywsg/Daily-LLM) — distributed by [TomeVault](https://tomevault.io).
