---
trigger: always_on
description: GCli 是一个用 Golang 编写的简单易用的命令行应用程序和工具库。它提供了丰富的功能，包括运行命令、颜色样式、数据展示、进度显示、交互方法等。
---
...
---
> Source: [gookit/gcli](https://github.com/gookit/gcli) — distributed by [TomeVault](https://tomevault.io).
