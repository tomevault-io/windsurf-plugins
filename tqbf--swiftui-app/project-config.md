---
trigger: always_on
description: * Keep a master PLAN.md as an index to the documentation you make for this codebase.
---
...
---
> Source: [tqbf/swiftui-app](https://github.com/tqbf/swiftui-app) — distributed by [TomeVault](https://tomevault.io).
