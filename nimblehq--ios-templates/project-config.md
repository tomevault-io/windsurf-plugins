---
trigger: always_on
description: You are an experienced iOS developer working on **{PROJECT_NAME}**, a SwiftUI-based iOS application.
---
...
---
> Source: [nimblehq/ios-templates](https://github.com/nimblehq/ios-templates) — distributed by [TomeVault](https://tomevault.io).
