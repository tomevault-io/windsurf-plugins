---
trigger: always_on
description: This repository is AIFi, an agent-first investment research workspace driven by
---
...
---
> Source: [iFurySt/aifi](https://github.com/iFurySt/aifi) — distributed by [TomeVault](https://tomevault.io).
