---
trigger: always_on
description: This is a **Loco** (loco.rs) application — an all-in-one, batteries-included Rust
---
...
---
> Source: [loco-rs/loco](https://github.com/loco-rs/loco) — distributed by [TomeVault](https://tomevault.io).
