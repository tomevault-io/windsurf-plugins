---
trigger: always_on
description: - Core package is `strgen/`; `__init__.py` exports the generator plus `countries.py` data.
---
...
---
> Source: [paul-wolf/strgen](https://github.com/paul-wolf/strgen) — distributed by [TomeVault](https://tomevault.io).
