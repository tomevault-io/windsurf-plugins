---
trigger: always_on
description: 这个仓库是一个面向 Agent 协作开发的基础模板。
---
...
---
> Source: [iFurySt/open-codex-computer-use](https://github.com/iFurySt/open-codex-computer-use) — distributed by [TomeVault](https://tomevault.io).
