---
trigger: always_on
description: The rules for this repository are in [CONTRIBUTING.md](CONTRIBUTING.md). Read that file before you write code.
---
...
---
> Source: [sanity-io/client](https://github.com/sanity-io/client) — distributed by [TomeVault](https://tomevault.io).
