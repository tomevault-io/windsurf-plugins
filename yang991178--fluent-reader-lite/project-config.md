---
trigger: always_on
description: Fluent Reader Lite is an open-source, cross-platform **RSS feed reader** built with **Flutter** (Dart). It targets **iOS** (13.0+) and **Android** (API 24+). It supports Fever API, Google Reader API, Inoreader, and Feedbin as backend sync services. The codebase is ~40 Dart files with no native platform code beyond the standard Flutter boilerplate.
---
...
---
> Source: [yang991178/fluent-reader-lite](https://github.com/yang991178/fluent-reader-lite) — distributed by [TomeVault](https://tomevault.io).
