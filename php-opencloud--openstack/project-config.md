---
trigger: always_on
description: This repository is the `php-opencloud/openstack` SDK: a PHP client for multiple OpenStack services. The public entry point is `src/OpenStack.php`, which creates versioned service objects through shared builder logic in `src/Common/`.
---
...
---
> Source: [php-opencloud/openstack](https://github.com/php-opencloud/openstack) — distributed by [TomeVault](https://tomevault.io).
