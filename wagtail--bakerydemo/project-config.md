---
trigger: always_on
description: Additional guidance for AI coding agents working on `bakerydemo`.
---
...
---
> Source: [wagtail/bakerydemo](https://github.com/wagtail/bakerydemo) — distributed by [TomeVault](https://tomevault.io).
