---
trigger: always_on
description: 本仓库为企业化定制版本，基于上游 Daymychen/art-design-pro 二次开发。此文档用于约束 AI 代理在本仓库的协作方式（代码变更、验证流程、合并策略）。
---
...
---
> Source: [ChnMig/art-design-pro-edge](https://github.com/ChnMig/art-design-pro-edge) — distributed by [TomeVault](https://tomevault.io).
