---
trigger: always_on
description: MeowHub 是一个 Android 应用，让 AI 通过 ADB 协议控制手机——看屏幕截图、理解上下文、执行点击/滑动/输入等操作。核心能力包括：声明式 Skill 引擎、AI 对话式手机操控（ChatAgent）、内嵌 OpenClaw 运行时。
---
...
---
> Source: [zhaojiaqi/MeowHub](https://github.com/zhaojiaqi/MeowHub) — distributed by [TomeVault](https://tomevault.io).
