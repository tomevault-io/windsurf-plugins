---
trigger: always_on
description: I use jj (jujutsu), not git for versioning. Never use git for file versioning.
---
...
---
> Source: [chaosteil/dotfiles](https://github.com/chaosteil/dotfiles) — distributed by [TomeVault](https://tomevault.io).
