---
trigger: always_on
description: Metallic is a from-scratch C11 standard library for WebAssembly, targeting WASI snapshot_preview1. It compiles to `metallic.a` and provides a full hosted-environment libc for programs built with `--target=wasm32-unknown-unknown-wasm`.
---
...
---
> Source: [jdh8/metallic](https://github.com/jdh8/metallic) — distributed by [TomeVault](https://tomevault.io).
