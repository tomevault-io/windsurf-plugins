---
trigger: always_on
description: `const-str` is a Rust library that provides compile-time string operations. It's designed to perform string manipulations at compile time using const generics and const evaluation.
---
...
---
> Source: [Nugine/const-str](https://github.com/Nugine/const-str) — distributed by [TomeVault](https://tomevault.io).
