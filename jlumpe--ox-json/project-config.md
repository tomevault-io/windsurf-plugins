---
trigger: always_on
description: Notes for AI agents working on `ox-json`, an Org mode JSON export backend.
---
...
---
> Source: [jlumpe/ox-json](https://github.com/jlumpe/ox-json) — distributed by [TomeVault](https://tomevault.io).
