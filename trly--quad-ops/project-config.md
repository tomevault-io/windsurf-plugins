---
trigger: always_on
description: GitOps framework for podman containers on Linux and macOS.
---
...
---
> Source: [trly/quad-ops](https://github.com/trly/quad-ops) — distributed by [TomeVault](https://tomevault.io).
