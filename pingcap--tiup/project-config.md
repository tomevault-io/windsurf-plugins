---
trigger: always_on
description: TiUP Playground NG is used to start a single-node TiDB+TiKV+PD+... cluster locally, making it convenient for users (mainly developers) to try out features and run tests. It supports Linux and macOS.
---
...
---
> Source: [pingcap/tiup](https://github.com/pingcap/tiup) — distributed by [TomeVault](https://tomevault.io).
