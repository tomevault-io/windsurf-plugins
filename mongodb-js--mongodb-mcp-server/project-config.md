---
trigger: always_on
description: This project is a server implementing the MCP (Model Context Protocol) that allows users to interact with their MongoDB clusters
---
...
---
> Source: [mongodb-js/mongodb-mcp-server](https://github.com/mongodb-js/mongodb-mcp-server) — distributed by [TomeVault](https://tomevault.io).
