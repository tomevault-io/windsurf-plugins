---
trigger: always_on
description: This file provides guidance to Claude Code agents (claude.ai/code) when working with code in this repository.
---
...
---
> Source: [grab/cursor-talk-to-figma-mcp](https://github.com/grab/cursor-talk-to-figma-mcp) — distributed by [TomeVault](https://tomevault.io).
