---
trigger: always_on
description: This repository is an out-of-tree plugin for DeepSeek Harness. Before changing plugin packaging, Cordis wiring, the browser client, or host-facing tests, read [`docs/deepseek-harness-integration.md`](docs/deepseek-harness-integration.md).
---
...
---
> Source: [xiehuan123/dsh-deepread](https://github.com/xiehuan123/dsh-deepread) — distributed by [TomeVault](https://tomevault.io).
