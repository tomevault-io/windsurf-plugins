---
trigger: always_on
description: You are working on the llm-cli-gateway MCP server.
---
...
---
> Source: [verivus-oss/llm-cli-gateway](https://github.com/verivus-oss/llm-cli-gateway) — distributed by [TomeVault](https://tomevault.io).
