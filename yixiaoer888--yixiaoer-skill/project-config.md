---
trigger: always_on
description: `yxer` is consumed by both humans and AI agents. Command design, output shape, and error messages must remain stable and machine-readable.
---
...
---
> Source: [yixiaoer888/yixiaoer-skill](https://github.com/yixiaoer888/yixiaoer-skill) — distributed by [TomeVault](https://tomevault.io).
