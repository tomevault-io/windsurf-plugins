# AI instruction files for bnbchain-mcp

> Sourced from [nirholas/bnbchain-mcp](https://github.com/nirholas/bnbchain-mcp) and converted for every major platform by [TomeVault](https://tomevault.io)
...
Original source: `CLAUDE.md` in [nirholas/bnbchain-mcp](https://github.com/nirholas/bnbchain-mcp).
