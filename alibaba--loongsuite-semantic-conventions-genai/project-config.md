---
trigger: always_on
description: These instructions guide AI assistants in reviewing pull requests for the
---
...
---
> Source: [alibaba/loongsuite-semantic-conventions-genai](https://github.com/alibaba/loongsuite-semantic-conventions-genai) — distributed by [TomeVault](https://tomevault.io).
