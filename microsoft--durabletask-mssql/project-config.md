---
trigger: always_on
description: This repository implements the Microsoft SQL Server and Azure SQL storage provider for the Durable Task Framework and Durable Functions. It contains:
---
...
---
> Source: [microsoft/durabletask-mssql](https://github.com/microsoft/durabletask-mssql) — distributed by [TomeVault](https://tomevault.io).
