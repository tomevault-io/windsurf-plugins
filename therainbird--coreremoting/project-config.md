---
trigger: always_on
description: - Build: `dotnet build CoreRemoting.sln`
---
...
---
> Source: [theRainbird/CoreRemoting](https://github.com/theRainbird/CoreRemoting) — distributed by [TomeVault](https://tomevault.io).
