---
trigger: always_on
description: handleSpecificError(error);
---
...
---
> Source: [yavuzyalcintas/cursornew](https://github.com/yavuzyalcintas/cursornew) — distributed by [TomeVault](https://tomevault.io).
