---
trigger: always_on
description: - 本仓库所有插件**禁止修改 DeepSeek Harness (DSH) 源码**（对官方源码 checkout 零写入），
---
...
---
> Source: [ningbainb/deepseek-harness-desktop](https://github.com/ningbainb/deepseek-harness-desktop) — distributed by [TomeVault](https://tomevault.io).
