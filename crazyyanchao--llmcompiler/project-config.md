---
trigger: always_on
description: 本项目使用uv作为包管理器，是一个LLM编译器工具，专注于提供智能的任务规划和执行能力。规则涵盖项目特定的开发流程、编码标准和最佳实践。
---
...
---
> Source: [crazyyanchao/llmcompiler](https://github.com/crazyyanchao/llmcompiler) — distributed by [TomeVault](https://tomevault.io).
