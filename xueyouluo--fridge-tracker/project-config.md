---
trigger: always_on
description: 本仓库是“鲜知贴”食材保鲜提醒器项目，包含服务端、双目标固件和墨水屏外壳 CAD：
---
...
---
> Source: [xueyouluo/fridge_tracker](https://github.com/xueyouluo/fridge_tracker) — distributed by [TomeVault](https://tomevault.io).
