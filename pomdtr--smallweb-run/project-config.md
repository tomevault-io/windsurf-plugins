---
trigger: always_on
description: This repository contains smallweb apps (one per subfolder). This folder is linked with the `smallweb.run` domain, so every subfolder will be served at `https://<subfolder>.smallweb.run`.
---
...
---
> Source: [pomdtr/smallweb.run](https://github.com/pomdtr/smallweb.run) — distributed by [TomeVault](https://tomevault.io).
