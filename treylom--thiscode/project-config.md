---
trigger: always_on
description: This is the Gemini CLI / multi-harness entry context for the `thiscode` plugin.
---
...
---
> Source: [treylom/ThisCode](https://github.com/treylom/ThisCode) — distributed by [TomeVault](https://tomevault.io).
