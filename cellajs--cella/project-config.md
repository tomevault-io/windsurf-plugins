---
trigger: always_on
description: Primary agent guidelines for this repo live in @cella/AGENTS.md — read it.
---
...
---
> Source: [cellajs/cella](https://github.com/cellajs/cella) — distributed by [TomeVault](https://tomevault.io).
