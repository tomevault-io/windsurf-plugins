---
trigger: always_on
description: A PHP composer library (`salla/zatca`) that implements ZATCA (Fatoora) e-invoicing for Saudi Arabia: Phase 1 TLV-encoded QR code generation and Phase 2 CSR/certificate onboarding + XML invoice signing with embedded QR.
---
...
---
> Source: [SallaApp/ZATCA](https://github.com/SallaApp/ZATCA) — distributed by [TomeVault](https://tomevault.io).
