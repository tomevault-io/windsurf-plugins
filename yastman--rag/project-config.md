---
trigger: always_on
description: This file is the repo gateway for agents. Keep it short. Do not duplicate
---
...
---
> Source: [yastman/rag](https://github.com/yastman/rag) — distributed by [TomeVault](https://tomevault.io).
