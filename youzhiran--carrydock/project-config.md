---
trigger: always_on
description: - `lib/` 按职能拆分：`screens/` 承载导航与可视层，建议按业务模块继续分子目录，保持 UI 与逻辑解耦。
---
...
---
> Source: [youzhiran/CarryDock](https://github.com/youzhiran/CarryDock) — distributed by [TomeVault](https://tomevault.io).
