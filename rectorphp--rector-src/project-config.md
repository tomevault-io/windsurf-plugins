---
trigger: always_on
description: Project-specific conventions for `rector/rector-src`. See `CONTRIBUTING.md` for the human-facing version.
---
...
---
> Source: [rectorphp/rector-src](https://github.com/rectorphp/rector-src) — distributed by [TomeVault](https://tomevault.io).
