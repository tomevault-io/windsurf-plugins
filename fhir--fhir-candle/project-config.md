---
trigger: always_on
description: fhir-candle is a small in-memory FHIR server for testing and development. It supports FHIR R4, R4B, and R5 via multi-tenant endpoints. Built with C# / .NET, Blazor Server UI with FluentUI components.
---
...
---
> Source: [FHIR/fhir-candle](https://github.com/FHIR/fhir-candle) — distributed by [TomeVault](https://tomevault.io).
