---
trigger: always_on
description: > 這個檔是寫給 **AI 編碼助理（Codex / Claude Code / 任何能讀檔、開 code 的 agent）** 看的。
---
...
---
> Source: [zaxardery8011-design/line-persona](https://github.com/zaxardery8011-design/line-persona) — distributed by [TomeVault](https://tomevault.io).
