---
trigger: always_on
description: - The primary agent keeps the model selected for the current main task. Do not override or rewrite the primary model configuration.
---
...
---
> Source: [zjy1346/OpenThesis](https://github.com/zjy1346/OpenThesis) — distributed by [TomeVault](https://tomevault.io).
