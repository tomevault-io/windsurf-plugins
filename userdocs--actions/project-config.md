...
- For Bash references, consult: https://mywiki.wooledge.org and https://mywiki.wooledge.org/BashFAQ and include a source link when possible. 
- Do not invent links.
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/userdocs)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/userdocs)
