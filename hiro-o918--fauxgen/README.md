...
Original source: `CLAUDE.md` in [hiro-o918/fauxgen](https://github.com/hiro-o918/fauxgen).
...
From [hiro-o918/fauxgen](https://github.com/hiro-o918/fauxgen) — a repo with 8+ stars on GitHub.
