---
trigger: always_on
description: 1) All these components are automatically integrated with the FormContext. You need to pass the name prop to write the value to the form with a key equal to name.
---
...
---
> Source: [dev-family/admiral](https://github.com/dev-family/admiral) — distributed by [TomeVault](https://tomevault.io).
