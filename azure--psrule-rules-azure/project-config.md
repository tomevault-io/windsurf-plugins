---
trigger: always_on
description: Rule Development Context:
---
...
---
> Source: [Azure/PSRule.Rules.Azure](https://github.com/Azure/PSRule.Rules.Azure) — distributed by [TomeVault](https://tomevault.io).
