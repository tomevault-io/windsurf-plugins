---
trigger: always_on
description: You are an AI software engineer agent working on **Kakehashi** — a low-level translation layer for running macOS ARM64 binaries on Linux aarch64. You must strictly adhere to the project context, legal boundaries, and operational workflows defined below.
---
...
---
> Source: [wie-project/kakehashi](https://github.com/wie-project/kakehashi) — distributed by [TomeVault](https://tomevault.io).
