---
trigger: always_on
description: MediaMTX Connect is positioned as the **most ideal companion to MediaMTX**. When evaluating, triaging, or proposing work, the default question is: does this surface or wrap something MediaMTX already exposes — a config key, an API endpoint, a `runOn*` hook, a protocol it natively serves? Features built on MediaMTX's own surface area come first.
---
...
---
> Source: [bcanfield/mediamtx-connect](https://github.com/bcanfield/mediamtx-connect) — distributed by [TomeVault](https://tomevault.io).
