...
# Agent Guide for maven-dependency-plugin
...
---
> Source: [apache/maven-dependency-plugin](https://github.com/apache/maven-dependency-plugin) — distributed by [TomeVault](https://tomevault.io).
