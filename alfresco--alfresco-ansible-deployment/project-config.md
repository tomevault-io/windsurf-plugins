---
trigger: always_on
description: Ansible playbooks for deploying Alfresco Content Services (ACS) on VM/bare-metal.
---
...
---
> Source: [Alfresco/alfresco-ansible-deployment](https://github.com/Alfresco/alfresco-ansible-deployment) — distributed by [TomeVault](https://tomevault.io).
