---
trigger: always_on
description: Kiali is an open source service mesh observability tool for Istio. This repository contains the Helm charts for deploying Kiali — either via the **Kiali Operator** (which watches `Kiali` custom resources and manages the server lifecycle) or as a **standalone Kiali Server** — along with the tooling to build, test, and publish those charts.
---
...
---
> Source: [kiali/helm-charts](https://github.com/kiali/helm-charts) — distributed by [TomeVault](https://tomevault.io).
