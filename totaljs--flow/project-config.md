---
trigger: always_on
description: Guidance for AI coding agents working on Total.js Flow.
---
...
---
> Source: [totaljs/flow](https://github.com/totaljs/flow) — distributed by [TomeVault](https://tomevault.io).
