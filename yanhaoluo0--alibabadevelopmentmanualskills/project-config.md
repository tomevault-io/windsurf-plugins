---
trigger: always_on
description: 本项目遵循《阿里巴巴Java开发手册（黄山版）》的编码规范。以下规则将指导AI助手在编写、审查和重构Java代码时的行为。
---
...
---
> Source: [yanhaoluo0/AlibabaDevelopmentManualSkills](https://github.com/yanhaoluo0/AlibabaDevelopmentManualSkills) — distributed by [TomeVault](https://tomevault.io).
