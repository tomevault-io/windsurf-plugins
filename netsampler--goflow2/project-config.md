---
trigger: always_on
description: There are various agents that can send samples to a flow collector.
---
...
---
> Source: [netsampler/goflow2](https://github.com/netsampler/goflow2) — distributed by [TomeVault](https://tomevault.io).
