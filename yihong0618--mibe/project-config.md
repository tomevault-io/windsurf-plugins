---
trigger: always_on
description: - `mibe.py`: main CLI and monitoring logic (Codex/Kimi log parsing, XiaoAi notification flow).
---
...
---
> Source: [yihong0618/mibe](https://github.com/yihong0618/mibe) — distributed by [TomeVault](https://tomevault.io).
