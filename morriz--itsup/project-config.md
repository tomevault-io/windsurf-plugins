---
trigger: always_on
description: Read `README.md` first for architecture, components, and workflows.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/Morriz)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/Morriz)
