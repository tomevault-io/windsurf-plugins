---
trigger: always_on
description: - **Backend:** Rust, Tauri 2, SQLite (rusqlite), WAL mode
---
...
---
> Source: [yicheng47/quill](https://github.com/yicheng47/quill) — distributed by [TomeVault](https://tomevault.io).
