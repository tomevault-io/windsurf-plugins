---
trigger: always_on
description: Read and follow the conventions defined in `AGENTS.md` at the repository root.
---
...
---
> Source: [ErkanBarin/playwright-agent-mcp-starter](https://github.com/ErkanBarin/playwright-agent-mcp-starter) — distributed by [TomeVault](https://tomevault.io).
