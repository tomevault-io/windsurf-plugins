---
trigger: always_on
description: 本文件定义 Codex 在 `火花` 仓库内的默认工作规则。
---
...
---
> Source: [zhongrenfei1-hub/huohua](https://github.com/zhongrenfei1-hub/huohua) — distributed by [TomeVault](https://tomevault.io).
