---
trigger: always_on
description: RubySchema is a collection of JSON schemas for common Ruby gem configuration files. These schemas enable auto-complete, validation, and inline documentation in editors via the YAML language server. Schemas are committed directly to the `dist/` folder and deployed to Cloudflare at `https://www.rubyschema.org/`.
---
...
---
> Source: [yippee-fun/rubyschema](https://github.com/yippee-fun/rubyschema) — distributed by [TomeVault](https://tomevault.io).
