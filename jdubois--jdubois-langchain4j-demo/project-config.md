---
trigger: always_on
description: - **Java 25+** required. Uses Maven wrapper (`./mvnw`).
---
...
---
> Source: [jdubois/jdubois-langchain4j-demo](https://github.com/jdubois/jdubois-langchain4j-demo) — distributed by [TomeVault](https://tomevault.io).
