---
trigger: always_on
description: Technology Stack: C#, .NET compiled for netstandard2.0, NET8.0, NET10.0
---
...
---
> Source: [nstoredev/NStore](https://github.com/nstoredev/NStore) — distributed by [TomeVault](https://tomevault.io).
