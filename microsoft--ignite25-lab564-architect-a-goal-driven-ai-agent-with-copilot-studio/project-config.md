...
---
> Source: [microsoft/ignite25-LAB564-architect-a-goal-driven-ai-agent-with-copilot-studio](https://github.com/microsoft/ignite25-LAB564-architect-a-goal-driven-ai-agent-with-copilot-studio) — distributed by [TomeVault](https://tomevault.io).
