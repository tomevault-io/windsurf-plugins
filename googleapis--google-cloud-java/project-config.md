---
trigger: always_on
description: This directory, `sdk-platform-java`, contains the foundational components for building Java client libraries for Google Cloud Platform services. It includes the GAPIC (Generated API Client) generator for Java, the GAX (Google API Extensions) runtime library, and other shared modules.
---
...
---
> Source: [googleapis/google-cloud-java](https://github.com/googleapis/google-cloud-java) — distributed by [TomeVault](https://tomevault.io).
