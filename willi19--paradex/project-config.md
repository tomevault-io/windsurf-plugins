---
trigger: always_on
description: Multi-camera vision + robot control framework for dexterous manipulation research.
---
...
---
> Source: [willi19/paradex](https://github.com/willi19/paradex) — distributed by [TomeVault](https://tomevault.io).
