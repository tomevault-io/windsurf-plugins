...
```
npx tomevault install cvs-health/ios-swiftui-accessibility-techniques
```
Source: [github.com/cvs-health/ios-swiftui-accessibility-techniques](https://github.com/cvs-health/ios-swiftui-accessibility-techniques).
