---
trigger: always_on
description: This file gives AI agents and contributors enough context to work effectively in this repo. For deployment topology (Kubernetes/Docker Compose), Celery task flow (queues, chains, worker roles), and pipeline details, use **ARCHITECTURE.md** in addition to this file.
---
...
---
> Source: [splunk/splunk-connect-for-snmp](https://github.com/splunk/splunk-connect-for-snmp) — distributed by [TomeVault](https://tomevault.io).
