---
trigger: always_on
description: - `src/`: TypeScript API (`index.tsx`, `index.web.tsx`) and Nitro spec in `src/specs/*.nitro.ts`.
---
...
---
> Source: [hyochan/react-native-nitro-sound](https://github.com/hyochan/react-native-nitro-sound) — distributed by [TomeVault](https://tomevault.io).
