...
Original source: `CLAUDE.md` in [jeduden/mdsmith](https://github.com/jeduden/mdsmith).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/jeduden/mdsmith](https://github.com/jeduden/mdsmith)
