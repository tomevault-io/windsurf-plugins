...
Original source: `CLAUDE.md` in [microsoft/semanticworkbench](https://github.com/microsoft/semanticworkbench).
...
```
npx tomevault install microsoft/semanticworkbench
```
Source: [github.com/microsoft/semanticworkbench](https://github.com/microsoft/semanticworkbench).
