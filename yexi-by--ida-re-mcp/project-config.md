---
trigger: always_on
description: - README、配置注释、MCP 工具说明、成功摘要、错误提示、日志提示和代码内开发者文档都要使用自然、直接、含义明确的语言。
---
...
---
> Source: [yexi-by/ida-re-mcp](https://github.com/yexi-by/ida-re-mcp) — distributed by [TomeVault](https://tomevault.io).
