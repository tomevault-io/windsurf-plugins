---
trigger: always_on
description: - **Main API**: `lib/autumn.ex` - Primary public interface with `highlight/2` and `highlight!/2` functions
---
...
---
> Source: [leandrocp/autumn](https://github.com/leandrocp/autumn) — distributed by [TomeVault](https://tomevault.io).
