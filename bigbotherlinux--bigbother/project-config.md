---
trigger: always_on
description: BigBother is an intentionally annoying (but functional) NixOS-based Linux distribution. This repo is the main flake containing the OS configuration, custom packages, and NixOS modules.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/BigBotherLinux)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/BigBotherLinux)
