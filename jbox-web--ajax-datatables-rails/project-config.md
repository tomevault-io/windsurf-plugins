---
trigger: always_on
description: validates the incoming search condition against `VALID_SEARCH_CONDITIONS`, and (via the mixed-in
---
...
---
> Source: [jbox-web/ajax-datatables-rails](https://github.com/jbox-web/ajax-datatables-rails) — distributed by [TomeVault](https://tomevault.io).
