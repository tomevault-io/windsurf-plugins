---
trigger: always_on
description: - Code, documentation and feedback shall be in line with principal level scientific elegance, minimalism, conciseness and precision.
---
...
---
> Source: [kserve/models-web-app](https://github.com/kserve/models-web-app) — distributed by [TomeVault](https://tomevault.io).
