---
trigger: always_on
description: > **Note:** `CLAUDE.md` is a symlink to this file.
---
...
---
> Source: [happycapy-ai/Happycapy-skills](https://github.com/happycapy-ai/Happycapy-skills) — distributed by [TomeVault](https://tomevault.io).
