---
trigger: always_on
description: - Next.js 16 App Router app that aggregates latest YouTube videos from configured channels.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/dhedegaard)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/dhedegaard)
