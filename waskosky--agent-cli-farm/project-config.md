---
trigger: always_on
description: Status classification lives in code and tests, not in notes copied from another project.
---
...
---
> Source: [waskosky/agent-cli-farm](https://github.com/waskosky/agent-cli-farm) — distributed by [TomeVault](https://tomevault.io).
