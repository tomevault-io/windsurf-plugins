---
trigger: always_on
description: Backend implementation of "convert to code" for Positron's data explorer in R, allowing users to generate R code (dplyr syntax) that replicates their UI-based data manipulations (filters, sorting).
---
...
---
> Source: [posit-dev/ark](https://github.com/posit-dev/ark) — distributed by [TomeVault](https://tomevault.io).
