...
# Claude Rules for Apache Pekko HTTP
...
- HTTP/2 changes consider compatibility with HTTP/1.1 fallback paths.
- Marshaller changes (spray-json, xml, jackson) are tested independently.
...
---
> Source: [apache/pekko-http](https://github.com/apache/pekko-http) — distributed by [TomeVault](https://tomevault.io).
