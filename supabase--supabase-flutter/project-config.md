---
trigger: always_on
description: This file provides guidance to the agents when working with code in this repository.
---
...
---
> Source: [supabase/supabase-flutter](https://github.com/supabase/supabase-flutter) — distributed by [TomeVault](https://tomevault.io).
