---
trigger: always_on
description: - `macos/` is the primary product: shell launchers, `scripts/` runtime logic, `assets/` CSS/injection payloads, `menubar/` SwiftBar integration, and `tests/` checks.
---
...
---
> Source: [cyjg1/codex-Arknights-skin](https://github.com/cyjg1/codex-Arknights-skin) — distributed by [TomeVault](https://tomevault.io).
