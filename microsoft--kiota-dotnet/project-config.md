---
trigger: always_on
description: When working on code that consumes the Kiota .NET libraries, or when encountering build errors after a version update, refer to [`docs/upgrade-guide-v1-to-v2.md`](../docs/upgrade-guide-v1-to-v2.md) for breaking changes, migration steps, and compiler error mappings between v1.x and v2.x.
---
...
---
> Source: [microsoft/kiota-dotnet](https://github.com/microsoft/kiota-dotnet) — distributed by [TomeVault](https://tomevault.io).
