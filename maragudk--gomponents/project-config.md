---
trigger: always_on
description: This is gomponents, an HTML component library written in pure Go that renders to HTML5. This guide provides instructions for AI assistants working on this codebase.
---
...
---
> Source: [maragudk/gomponents](https://github.com/maragudk/gomponents) — distributed by [TomeVault](https://tomevault.io).
