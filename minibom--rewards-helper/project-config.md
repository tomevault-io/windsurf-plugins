---
trigger: always_on
description: This file gives concise, actionable guidance for AI coding agents working on the Rewards Helper Chrome extension (Manifest V3).
---
...
---
> Source: [minibom/Rewards_Helper](https://github.com/minibom/Rewards_Helper) — distributed by [TomeVault](https://tomevault.io).
