---
trigger: always_on
description: Strimzi provides a way to run Apache Kafka® clusters on Kubernetes and OpenShift using the Operator pattern.
---
...
---
> Source: [strimzi/strimzi-kafka-operator](https://github.com/strimzi/strimzi-kafka-operator) — distributed by [TomeVault](https://tomevault.io).
