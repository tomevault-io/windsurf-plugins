---
trigger: always_on
description: A Sphinx extension for converting reStructuredText (RST) documents into executable Jupyter notebooks. This extension provides two main builders: `jupyter` (for notebooks) and `jupyterpdf` (for PDF generation via notebooks).
---
...
---
> Source: [QuantEcon/sphinxcontrib-jupyter](https://github.com/QuantEcon/sphinxcontrib-jupyter) — distributed by [TomeVault](https://tomevault.io).
