---
trigger: always_on
description: Guidance for the workflow-builder **flow** feature module. Inherits everything in the repo-root `CLAUDE.md`; this file only adds module-specific notes.
---
...
---
> Source: [erupts/erupt-web](https://github.com/erupts/erupt-web) — distributed by [TomeVault](https://tomevault.io).
