---
trigger: always_on
description: - **Build**: CMake (3.21+), C11 compiler (GCC, Clang, MSVC)
---
...
---
> Source: [koron/cmigemo](https://github.com/koron/cmigemo) — distributed by [TomeVault](https://tomevault.io).
