---
trigger: always_on
description: This project implements Kiro-style Spec-Driven Development for Claude Code using hooks and slash commands.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/oberonlai)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/oberonlai)
