---
trigger: always_on
description: Agent-focused instructions for working on the UI Builder project.
---
...
---
> Source: [olliethedev/ui-builder](https://github.com/olliethedev/ui-builder) — distributed by [TomeVault](https://tomevault.io).
