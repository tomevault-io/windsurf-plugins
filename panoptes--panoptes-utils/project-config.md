---
trigger: always_on
description: This document provides specific instructions for the Gemini CLI agent. For all general project guidelines, development workflows, and technical standards, refer to the primary agent documentation.
---
