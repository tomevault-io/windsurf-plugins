---
trigger: always_on
description: > 이 문서는 AI(Claude)가 델파이 트레이더 프로젝트를 일관성 있게 개발하기 위한 가이드입니다.
---
...
---
> Source: [zamong25/AIS2025](https://github.com/zamong25/AIS2025) — distributed by [TomeVault](https://tomevault.io).
