---
trigger: always_on
description: 本文件是 AI 进入本仓库时的入口说明。开始任何改动前，先按本文读取 `.ai/` 知识库；不要把 `.ai/` 当作可忽略的备注目录。
---
...
---
> Source: [woodyyan/pumpkin-pro](https://github.com/woodyyan/pumpkin-pro) — distributed by [TomeVault](https://tomevault.io).
