---
trigger: always_on
description: - Project: `src/Snippets/Snippets.csproj` — targets `net10.0`, `TreatWarningsAsErrors=true`
---
...
---
> Source: [ServiceComposer/ServiceComposer.AspNetCore](https://github.com/ServiceComposer/ServiceComposer.AspNetCore) — distributed by [TomeVault](https://tomevault.io).
