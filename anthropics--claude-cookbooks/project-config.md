---
trigger: always_on
description: A collection of Jupyter notebooks and Python examples for building with the Claude API.
---
...
---
> Source: [anthropics/claude-cookbooks](https://github.com/anthropics/claude-cookbooks) — distributed by [TomeVault](https://tomevault.io).
