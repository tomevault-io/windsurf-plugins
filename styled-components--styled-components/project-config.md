---
trigger: always_on
description: Expo Router app rendering every registry entry from `src/widgets/`. Used as the visual QA surface for v7 native polyfills across iOS, Android, and rn-web.
---
...
---
> Source: [styled-components/styled-components](https://github.com/styled-components/styled-components) — distributed by [TomeVault](https://tomevault.io).
