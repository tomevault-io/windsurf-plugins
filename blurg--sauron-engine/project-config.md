---
trigger: always_on
description: poetry run pytest tests/engine_tests/test_simple_engine.py
---
...
---
> Source: [blurg/sauron-engine](https://github.com/blurg/sauron-engine) — distributed by [TomeVault](https://tomevault.io).
