---
trigger: always_on
description: - `src/sipnet/frontend.c` is the only production entrypoint (`main`): init context, parse CLI, read `sipnet.in`, validate options, derive file names, then run model.
---
...
---
> Source: [PecanProject/sipnet](https://github.com/PecanProject/sipnet) — distributed by [TomeVault](https://tomevault.io).
