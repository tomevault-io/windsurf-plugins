---
trigger: always_on
description: This repo is intended to be installable by an agent on the target user's own machine. Keep the install boring, local, and explicit.
---
...
---
> Source: [uncmatteth/gbrain-bridgebrain](https://github.com/uncmatteth/gbrain-bridgebrain) — distributed by [TomeVault](https://tomevault.io).
