---
trigger: always_on
description: This repository is a JavaScript GitHub Action that queries organization team membership and exposes action outputs.
---
...
---
> Source: [tspascoal/get-user-teams-membership](https://github.com/tspascoal/get-user-teams-membership) — distributed by [TomeVault](https://tomevault.io).
