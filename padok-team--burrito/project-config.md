---
trigger: always_on
description: Go core engine, built on `controller-runtime` / Kubebuilder. One reconciler package per
---
...
---
> Source: [padok-team/burrito](https://github.com/padok-team/burrito) — distributed by [TomeVault](https://tomevault.io).
