---
trigger: always_on
description: Poku is an innovative zero-dependency, cross-platform test runner for Node.js, Bun, and Deno that brings the JavaScript essence back to testing.
---
...
---
> Source: [wellwelwel/poku](https://github.com/wellwelwel/poku) — distributed by [TomeVault](https://tomevault.io).
