---
trigger: always_on
description: **ha-sankey-chart** is a Home Assistant Lovelace custom card that visualizes energy/power/water flows using Sankey diagrams. It shows connections between entities (sources → consumers) in an interactive chart.
---
...
---
> Source: [MindFreeze/ha-sankey-chart](https://github.com/MindFreeze/ha-sankey-chart) — distributed by [TomeVault](https://tomevault.io).
