---
trigger: always_on
description: This file describes the complete data model of the `optimized` library.
---
...
---
> Source: [slundi/guitarpro](https://github.com/slundi/guitarpro) — distributed by [TomeVault](https://tomevault.io).
