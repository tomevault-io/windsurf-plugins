---
trigger: always_on
description: This is a Python project that provides a unified API to access configuration values from different sources (env vars, dotenv files, local mounted files, etc).
---
...
---
> Source: [douglasmiranda/gconfigs](https://github.com/douglasmiranda/gconfigs) — distributed by [TomeVault](https://tomevault.io).
