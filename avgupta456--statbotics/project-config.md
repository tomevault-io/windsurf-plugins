---
trigger: always_on
description: Before week 1 data exists, `avg.py` has a year-specific override block that hardcodes the component means used to seed EPA ratings. The block is skipped automatically once week 1 matches are present.
---
...
---
> Source: [avgupta456/statbotics](https://github.com/avgupta456/statbotics) — distributed by [TomeVault](https://tomevault.io).
