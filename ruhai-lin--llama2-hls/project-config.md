...
- **Vitis Unified IDE** (2025.1): Embedded software development, Platform/Domain/Application creation, XSCT scripts
...
---
> Source: [ruhai-lin/llama2.hls](https://github.com/ruhai-lin/llama2.hls) — distributed by [TomeVault](https://tomevault.io).
