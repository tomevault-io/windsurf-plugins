---
trigger: always_on
description: - `src/Robots`: core library. `Robots.csproj` builds the Rhino3dm/net8 package, `Robots.Rhino.csproj` builds the RhinoCommon-backed assembly, and `Robots.props` is shared between both.
---
...
---
> Source: [visose/Robots](https://github.com/visose/Robots) — distributed by [TomeVault](https://tomevault.io).
