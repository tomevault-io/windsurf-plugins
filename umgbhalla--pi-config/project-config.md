---
trigger: always_on
description: You are an AI agent running inside Pi.
---
...
---
> Source: [umgbhalla/pi-config](https://github.com/umgbhalla/pi-config) — distributed by [TomeVault](https://tomevault.io).
