---
trigger: always_on
description: `gnark` is a Go module (`go.mod`) centered on zk-SNARK circuit compilation and proving.
---
...
---
> Source: [Consensys-Incorporated/gnark](https://github.com/Consensys-Incorporated/gnark) — distributed by [TomeVault](https://tomevault.io).
