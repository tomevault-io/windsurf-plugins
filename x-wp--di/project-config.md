---
trigger: always_on
description: `x-wp/di`: WordPress DI library for PHP `>=8.0`. Builds PHP-DI containers and registers WP hooks/callbacks via PHP 8 attributes on modules/handlers. Current checkout is the lightweight `master` runtime, not the alpha/parser beta architecture. Preserve public compatibility unless explicitly told otherwise.
---
...
---
> Source: [x-wp/di](https://github.com/x-wp/di) — distributed by [TomeVault](https://tomevault.io).
