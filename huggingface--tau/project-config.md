---
trigger: always_on
description: Tau is a Python implementation of Pi's minimalist coding-agent harness architecture. The goal is to develop it incrementally, with each phase clearly documented and tested.
---
...
---
> Source: [huggingface/tau](https://github.com/huggingface/tau) — distributed by [TomeVault](https://tomevault.io).
