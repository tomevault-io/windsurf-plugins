---
trigger: always_on
description: Solidity library for advanced fixed-point math with signed (SD59x18) and unsigned (UD60x18) 18-decimal types.
---
...
---
> Source: [PaulRBerg/prb-math](https://github.com/PaulRBerg/prb-math) — distributed by [TomeVault](https://tomevault.io).
