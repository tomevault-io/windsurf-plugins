...
# Claude Rules for Apache Pekko gRPC
...
- sbt scripted tests pass for plugin changes (`sbt "sbt-plugin / scripted"`).
...
---
> Source: [apache/pekko-grpc](https://github.com/apache/pekko-grpc) — distributed by [TomeVault](https://tomevault.io).
