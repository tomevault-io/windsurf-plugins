---
trigger: always_on
description: > This section is the authoritative source of truth for how **PRs *and* ADO
---
...
---
> Source: [microsoft/shell-intune-samples](https://github.com/microsoft/shell-intune-samples) — distributed by [TomeVault](https://tomevault.io).
