---
trigger: always_on
description: - **Repository and paths**: This repo implements `@gravity-ui/uikit`. When you see `uikit/src/...`, it refers to this repo’s `src/` directory.
---
...
---
> Source: [gravity-ui/uikit](https://github.com/gravity-ui/uikit) — distributed by [TomeVault](https://tomevault.io).
