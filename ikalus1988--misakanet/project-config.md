---
trigger: always_on
description: Lessons for configuring Claude-based agents (Claude Code, cc-haha) as MisakaNet nodes.
---
...
---
> Source: [Ikalus1988/MisakaNet](https://github.com/Ikalus1988/MisakaNet) — distributed by [TomeVault](https://tomevault.io).
