---
trigger: always_on
description: - 这是 macOS 原生 SwiftUI 桌面工具，用于管理常用命令并在 App 内部终端 tab 中执行。
---
...
---
> Source: [wa3ytsm/CommandGathering](https://github.com/wa3ytsm/CommandGathering) — distributed by [TomeVault](https://tomevault.io).
