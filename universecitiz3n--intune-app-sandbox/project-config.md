---
trigger: always_on
description: PowerShell module for testing Intune Win32 app deployment packages locally using Windows Sandbox before deploying to production. Published to PSGallery as `Intune-App-Sandbox`.
---
...
---
> Source: [UniverseCitiz3n/Intune-App-Sandbox](https://github.com/UniverseCitiz3n/Intune-App-Sandbox) — distributed by [TomeVault](https://tomevault.io).
