---
trigger: always_on
description: Guidelines for AI coding agents working on the `one` framework — a
---
...
---
> Source: [wanweiwei07/wrs2](https://github.com/wanweiwei07/wrs2) — distributed by [TomeVault](https://tomevault.io).
