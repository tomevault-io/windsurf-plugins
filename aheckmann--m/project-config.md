---
trigger: always_on
description: `m` is a MongoDB version management tool written in Bash. It helps users download, install, and manage multiple versions of MongoDB server and command-line tools.
---
...
---
> Source: [aheckmann/m](https://github.com/aheckmann/m) — distributed by [TomeVault](https://tomevault.io).
