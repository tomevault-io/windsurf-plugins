---
trigger: always_on
description: A Chrome extension (Manifest V3) that intercepts and logs Encrypted Media
---
...
---
> Source: [shaka-project/eme_logger](https://github.com/shaka-project/eme_logger) — distributed by [TomeVault](https://tomevault.io).
