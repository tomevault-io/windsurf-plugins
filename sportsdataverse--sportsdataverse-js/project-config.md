---
trigger: always_on
description: A TypeScript, ESM-only Node.js client (Node ≥ 20.18.1) for sports data: a
---
...
---
> Source: [sportsdataverse/sportsdataverse-js](https://github.com/sportsdataverse/sportsdataverse-js) — distributed by [TomeVault](https://tomevault.io).
