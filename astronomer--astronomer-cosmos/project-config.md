---
trigger: always_on
description: This file is read by [Claude Code](https://claude.com/claude-code) (`claude.ai/code`) when working in this repository.
---
...
---
> Source: [astronomer/astronomer-cosmos](https://github.com/astronomer/astronomer-cosmos) — distributed by [TomeVault](https://tomevault.io).
