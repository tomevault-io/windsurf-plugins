---
trigger: always_on
description: A curated awesome list of Unique ID libraries and resources. This is a documentation-only repository with no build system, tests, or executable code.
---
...
---
> Source: [grantcarthew/awesome-unique-id](https://github.com/grantcarthew/awesome-unique-id) — distributed by [TomeVault](https://tomevault.io).
