---
trigger: always_on
description: Multi-package campus-life app: Vue 3 frontend (`front/`), Python FastAPI agent (`tian-agent/`), Spring Cloud backend (`unify-conv/`).
---
...
---
> Source: [Bobchasm/tju-unify](https://github.com/Bobchasm/tju-unify) — distributed by [TomeVault](https://tomevault.io).
