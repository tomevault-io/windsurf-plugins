---
trigger: always_on
description: Loro is a Rust CRDT workspace with JS/WASM packaging and a MoonBit codec.
---
...
---
> Source: [loro-dev/loro](https://github.com/loro-dev/loro) — distributed by [TomeVault](https://tomevault.io).
