---
trigger: always_on
description: Migrating all tests in the monorepo to comply with the conventions defined in `test-conventions.md` (repo root).
---
...
---
> Source: [Crossmint/crossmint-sdk](https://github.com/Crossmint/crossmint-sdk) — distributed by [TomeVault](https://tomevault.io).
