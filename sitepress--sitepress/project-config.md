---
trigger: always_on
description: **Site** → **Node** → **Resource** → **Source** (Page, Image) → **PageModel** (optional)
---
...
---
> Source: [sitepress/sitepress](https://github.com/sitepress/sitepress) — distributed by [TomeVault](https://tomevault.io).
