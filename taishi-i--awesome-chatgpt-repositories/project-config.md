---
trigger: always_on
description: This repository is a curated list of 2500+ open-source GitHub repositories related to ChatGPT and LLMs. It includes a searchable skill for Claude Code.
---
...
---
> Source: [taishi-i/awesome-ChatGPT-repositories](https://github.com/taishi-i/awesome-ChatGPT-repositories) — distributed by [TomeVault](https://tomevault.io).
