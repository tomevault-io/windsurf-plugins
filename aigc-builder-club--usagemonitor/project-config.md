---
trigger: always_on
description: Native macOS menu bar app written in Swift/SwiftUI. The user-facing product name is `用量监控`; the technical package and executable are `UsageMonitor`.
---
...
---
> Source: [AIGC-Builder-Club/UsageMonitor](https://github.com/AIGC-Builder-Club/UsageMonitor) — distributed by [TomeVault](https://tomevault.io).
