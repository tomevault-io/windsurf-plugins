---
trigger: always_on
description: **fylepad** is a Markdown-based rich text editor built as a Nuxt 3 web app with Tauri desktop integration. It's a multi-tab notepad featuring TipTap editor extensions, auto-save, PDF/Markdown export/import, and support for diagrams (Mermaid, PlantUML), math blocks (KaTeX), and code blocks with syntax highlighting.
---
...
---
> Source: [imrofayel/fylepad](https://github.com/imrofayel/fylepad) — distributed by [TomeVault](https://tomevault.io).
