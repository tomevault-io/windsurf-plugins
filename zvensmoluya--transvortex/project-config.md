---
trigger: always_on
description: - 解释或修改产品行为时，区分用户能理解的产品概念与代码实现字段；发现命名或 UI 文案可能误导用户时应明确指出。
---
...
---
> Source: [zvensmoluya/TransVortex](https://github.com/zvensmoluya/TransVortex) — distributed by [TomeVault](https://tomevault.io).
