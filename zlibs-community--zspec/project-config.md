---
trigger: always_on
description: Composable specification pattern for Python 3.14+. Turn business rules into
---
...
---
> Source: [zlibs-community/zspec](https://github.com/zlibs-community/zspec) — distributed by [TomeVault](https://tomevault.io).
