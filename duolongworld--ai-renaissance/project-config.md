---
trigger: always_on
description: This is the project-facing instruction file for coding agents. Keep it short: only stable architecture rules and repo-specific boundaries belong here.
---
...
---
> Source: [duolongworld/AI_Renaissance](https://github.com/duolongworld/AI_Renaissance) — distributed by [TomeVault](https://tomevault.io).
