---
trigger: always_on
description: This is a modern, ESM-only React library that wraps TradingView's Lightweight Charts with idiomatic React components.
---
...
---
> Source: [ukorvl/lightweight-charts-react-components](https://github.com/ukorvl/lightweight-charts-react-components) — distributed by [TomeVault](https://tomevault.io).
