---
trigger: always_on
description: | Branch | Baseline | Purpose |
---
...
- Assess every bug fix merged into `main` for both maintenance branches. Backport it when the bug affects that branch and the fix preserves its public API and supported platforms.
...
---
> Source: [siteline/swiftui-introspect](https://github.com/siteline/swiftui-introspect) — distributed by [TomeVault](https://tomevault.io).
