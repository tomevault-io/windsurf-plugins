---
trigger: always_on
description: Publish workspace dependencies before their consumers. Never publish a generated React package against unpublished `@ant-design/icons-svg` changes.
---
...
---
> Source: [ant-design/ant-design-icons](https://github.com/ant-design/ant-design-icons) — distributed by [TomeVault](https://tomevault.io).
