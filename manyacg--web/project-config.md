---
trigger: always_on
description: - 技术栈：Nuxt 4 + TypeScript，UI 主要使用 Varlet（`@varlet/ui`）+ 虚拟瀑布流（`@lhlyu/vue-virtual-waterfall`），部分细节用 Element Plus（如 `ElImageViewer`）。
---
...
---
> Source: [ManyACG/web](https://github.com/ManyACG/web) — distributed by [TomeVault](https://tomevault.io).
