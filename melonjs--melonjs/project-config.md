---
trigger: always_on
description: > **This is a template for a game that *uses* melonJS, not instructions for
---
...
---
> Source: [melonjs/melonJS](https://github.com/melonjs/melonJS) — distributed by [TomeVault](https://tomevault.io).
