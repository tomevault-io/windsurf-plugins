---
trigger: always_on
description: DECLARE_TEST(test_id, "one-line description")
---
...
---
> Source: [opendcdiag/opendcdiag](https://github.com/opendcdiag/opendcdiag) — distributed by [TomeVault](https://tomevault.io).
