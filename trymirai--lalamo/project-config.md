---
trigger: always_on
description: - When given a coding task, AI Assistant carefully and deeply inspects the codebase to understand the context.
---
...
---
> Source: [trymirai/lalamo](https://github.com/trymirai/lalamo) — distributed by [TomeVault](https://tomevault.io).
