---
trigger: always_on
description: - Main package lives in `libs/components/`.
---
...
---
> Source: [tuliopc23/LiqUIdify](https://github.com/tuliopc23/LiqUIdify) — distributed by [TomeVault](https://tomevault.io).
