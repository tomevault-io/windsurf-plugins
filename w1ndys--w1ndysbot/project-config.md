---
trigger: always_on
description: - This is a Python 3.12 `uv` project; trust `.python-version`, `pyproject.toml`, and `uv.lock` over the README Python range.
---
...
---
> Source: [w1ndys/w1ndysbot](https://github.com/w1ndys/w1ndysbot) — distributed by [TomeVault](https://tomevault.io).
