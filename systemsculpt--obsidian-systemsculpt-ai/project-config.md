---
trigger: always_on
description: Canonical repository guidance for the SystemSculpt Obsidian client. CLAUDE.md
---
...
---
> Source: [SystemSculpt/obsidian-systemsculpt-ai](https://github.com/SystemSculpt/obsidian-systemsculpt-ai) — distributed by [TomeVault](https://tomevault.io).
