---
trigger: always_on
description: This is `@nextcapital/copy-service`, a TypeScript library for UI copy management and i18n. It parses a custom DSL into ASTs and evaluates them into plain text, HTML, or React JSX.
---
...
---
> Source: [NextCapital/copy-service](https://github.com/NextCapital/copy-service) — distributed by [TomeVault](https://tomevault.io).
