---
trigger: always_on
description: Ready-to-run Training API recipes built on the [Fireworks Python SDK](https://github.com/fw-ai-external/python-sdk) (`fireworks.training.sdk`). Only `training/` is relevant -- ignore other top-level directories.
---
...
---
> Source: [fw-ai/cookbook](https://github.com/fw-ai/cookbook) — distributed by [TomeVault](https://tomevault.io).
