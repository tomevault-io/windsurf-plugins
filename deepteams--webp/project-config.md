---
trigger: always_on
description: Pure Go WebP image encoder/decoder (`github.com/deepteams/webp`). No CGo dependencies. Supports VP8 (lossy), VP8L (lossless), VP8X (extended format with metadata), alpha channels, and animation.
---
...
---
> Source: [deepteams/webp](https://github.com/deepteams/webp) — distributed by [TomeVault](https://tomevault.io).
