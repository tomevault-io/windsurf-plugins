---
trigger: always_on
description: **kcptun** is a high-performance network accelerator based on KCP with N:M multiplexing and FEC (Forward Error Correction). It is designed to relay TCP traffic over KCP (UDP), which can significantly improve throughput on lossy networks.
---
...
---
> Source: [dumbybumby/kcptun-archive](https://github.com/dumbybumby/kcptun-archive) — distributed by [TomeVault](https://tomevault.io).
