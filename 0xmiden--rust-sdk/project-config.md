---
trigger: always_on
description: **After making any code changes, always run `make format` before committing.** This ensures consistent formatting across Rust, TypeScript, and other files.
---
...
---
> Source: [0xMiden/rust-sdk](https://github.com/0xMiden/rust-sdk) — distributed by [TomeVault](https://tomevault.io).
