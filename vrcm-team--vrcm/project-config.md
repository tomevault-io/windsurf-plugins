---
trigger: always_on
description: VRCM 是使用 Kotlin Multiplatform 与 Compose Multiplatform 开发的 VRChat 好友及内容管理应用，支持 Android、iOS 与 Desktop（JVM）。
---
...
---
> Source: [vrcm-team/VRCM](https://github.com/vrcm-team/VRCM) — distributed by [TomeVault](https://tomevault.io).
