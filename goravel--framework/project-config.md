---
trigger: always_on
description: This file provides rules for GitHub Copilot when reviewing pull requests in `goravel/framework`.
---
...
---
> Source: [goravel/framework](https://github.com/goravel/framework) — distributed by [TomeVault](https://tomevault.io).
