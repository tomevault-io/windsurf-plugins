---
trigger: always_on
description: Guidelines for AI agents working with this project.
---
...
---
> Source: [amperka/serial-projector](https://github.com/amperka/serial-projector) — distributed by [TomeVault](https://tomevault.io).
