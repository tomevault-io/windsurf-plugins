---
trigger: always_on
description: C# WinForms app that shows **now-playing** text from any media app (Chrome, YouTube, Spotify, Edge, VLC, etc.) directly on the Windows taskbar. Uses Windows built-in `GlobalSystemMediaTransportControlsSessionManager` API — no browser extension needed.
---
...
---
> Source: [yaffalhakim1/nowplaying-windows](https://github.com/yaffalhakim1/nowplaying-windows) — distributed by [TomeVault](https://tomevault.io).
