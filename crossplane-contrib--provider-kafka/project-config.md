---
trigger: always_on
description: Crossplane provider for managing Apache Kafka resources (topics, ACLs) as Kubernetes custom resources.
---
...
---
> Source: [crossplane-contrib/provider-kafka](https://github.com/crossplane-contrib/provider-kafka) — distributed by [TomeVault](https://tomevault.io).
