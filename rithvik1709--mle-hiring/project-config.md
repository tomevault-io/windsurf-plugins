---
trigger: always_on
description: MLE Hiring Challenge — Starter Repository
---

# AGENTS.md

MLE Hiring Challenge — Starter Repository
...
This is a starter repo for the **MLE Hiring Challenge**. The participant must build an AI agent that resolves
...
---
> Source: [Rithvik1709/MLE-hiring](https://github.com/Rithvik1709/MLE-hiring) — distributed by [TomeVault](https://tomevault.io).
