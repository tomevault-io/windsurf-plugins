---
trigger: always_on
description: An Agent represents an Identity capable of interacting with other Agents. It is the core of any service or application built with the SDK.
---
...
---
> Source: [jolocom/jolocom-sdk](https://github.com/jolocom/jolocom-sdk) — distributed by [TomeVault](https://tomevault.io).
