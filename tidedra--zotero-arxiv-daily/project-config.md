---
trigger: always_on
description: Zotero-arXiv-Daily recommends new arXiv/bioRxiv/medRxiv papers based on a user's Zotero library. It computes embedding similarity between new papers and the user's existing library, generates TLDRs via LLM, and delivers results by email. Designed to run as a GitHub Actions workflow at zero cost.
---
...
---
> Source: [TideDra/zotero-arxiv-daily](https://github.com/TideDra/zotero-arxiv-daily) — distributed by [TomeVault](https://tomevault.io).
