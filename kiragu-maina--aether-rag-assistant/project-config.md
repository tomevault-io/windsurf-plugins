...
```
Understand all BEST PRACTICES listed in gemini.md.
...
1. gemini.md checklist Writing Functions Best Practices.
2. gemini.md checklist Writing Tests Best Practices.
3. gemini.md checklist Implementation Best Practices.
```
...
- SHOULD NOT refer to gemini or google in the commit message.
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/Kiragu-Maina)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/Kiragu-Maina)
