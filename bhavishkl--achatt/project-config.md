---
trigger: always_on
description: When users request features beyond the base template, check for available recipes in `.kilocode/recipes/`.
---
...
---
> Source: [bhavishkl/achatt](https://github.com/bhavishkl/achatt) — distributed by [TomeVault](https://tomevault.io).
