---
trigger: always_on
description: This project is a Codename One cross-platform mobile app (Java 17 / Maven /
---
...
---
> Source: [eugenp/tutorials](https://github.com/eugenp/tutorials) — distributed by [TomeVault](https://tomevault.io).
