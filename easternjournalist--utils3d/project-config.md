---
trigger: always_on
description: Project-specific notes for AI coding agents working in `utils3d`. For library
---
...
---
> Source: [EasternJournalist/utils3d](https://github.com/EasternJournalist/utils3d) — distributed by [TomeVault](https://tomevault.io).
