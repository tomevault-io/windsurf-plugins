---
trigger: always_on
description: 本文件负责 Skill 的发现、安装、初始化、选择、路由、项目适配和统一安全原则。它不复制各 Skill 的完整规则，也不建立第二套 Runtime 治理。
---
...
---
> Source: [xinghang-ee-cs/dev-runtime-skill](https://github.com/xinghang-ee-cs/dev-runtime-skill) — distributed by [TomeVault](https://tomevault.io).
