---
trigger: always_on
description: A basis refers to a set of two eigenstates. The transition between
---
...
---
> Source: [pasqal-io/Pulser](https://github.com/pasqal-io/Pulser) — distributed by [TomeVault](https://tomevault.io).
