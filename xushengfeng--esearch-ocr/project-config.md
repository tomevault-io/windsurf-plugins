---
trigger: always_on
description: eSearch-OCR 是一个基于 PaddleOCR 模型的 ONNX 运行时 OCR 库。
---
...
---
> Source: [xushengfeng/eSearch-OCR](https://github.com/xushengfeng/eSearch-OCR) — distributed by [TomeVault](https://tomevault.io).
