---
trigger: always_on
description: - Do not use comments to explain what the code does, use comments to explain why the code does what it does.
---
...
---
> Source: [internalfav/terraform-provider-lambdalabs](https://github.com/internalfav/terraform-provider-lambdalabs) — distributed by [TomeVault](https://tomevault.io).
