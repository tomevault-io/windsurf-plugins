---
trigger: always_on
description: - Prefer simple, readable, flat code with minimal indirection.
---
...
---
> Source: [every-app/open-seo](https://github.com/every-app/open-seo) — distributed by [TomeVault](https://tomevault.io).
