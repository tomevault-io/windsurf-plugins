---
trigger: always_on
description: 本檔是儲存庫層級的持久指引。人類使用說明放在 `README.md`；完整 XScript 工作流以 `.agents/skills/xq-xscript-compiler/SKILL.md` 為準。
---
...
---
> Source: [would2000/XQ-Auto-Writer-Skill](https://github.com/would2000/XQ-Auto-Writer-Skill) — distributed by [TomeVault](https://tomevault.io).
