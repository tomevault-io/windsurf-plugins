---
trigger: always_on
description: - `py_linq/__init__.py` — package entry point, exports `Enumerable`; `__version__ = "1.4.0"`
---
...
---
> Source: [viralogic/py-enumerable](https://github.com/viralogic/py-enumerable) — distributed by [TomeVault](https://tomevault.io).
