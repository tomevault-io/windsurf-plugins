---
trigger: always_on
description: Instructions and context for Claude Code when working in this dotfiles repository.
---
...
---
> Source: [jsatk/dotfiles](https://github.com/jsatk/dotfiles) — distributed by [TomeVault](https://tomevault.io).
