---
trigger: always_on
description: **guidata** is the foundational library of the PlotPyStack, providing automatic GUI generation from Python data structures. It enables declarative definition of parameter sets that automatically generate Qt editing widgets.
---
...
---
> Source: [PlotPyStack/guidata](https://github.com/PlotPyStack/guidata) — distributed by [TomeVault](https://tomevault.io).
