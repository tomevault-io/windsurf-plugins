---
trigger: always_on
description: Haystack-Experimental uses **Hatch** for environment and dependency management.
---

# Haystack-Experimental Guidelines for AI Agents

## Environment

Haystack-Experimental uses **Hatch** for environment and dependency management.
...
---
> Source: [deepset-ai/haystack-experimental](https://github.com/deepset-ai/haystack-experimental) — distributed by [TomeVault](https://tomevault.io).
