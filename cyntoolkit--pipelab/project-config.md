---
trigger: always_on
description: Pipelab is a visual automation tool designed to create task automation workflows and cross-platform desktop applications. It provides a visual interface for building pipelines that can automate repetitive tasks, deploy to various platforms (Steam, Itch.io, etc.), and more.
---
...
---
> Source: [CynToolkit/pipelab](https://github.com/CynToolkit/pipelab) — distributed by [TomeVault](https://tomevault.io).
