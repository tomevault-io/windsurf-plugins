---
trigger: always_on
description: This file is read automatically by Cursor, Claude Code, OpenAI Codex, GitHub Copilot, Aider, and other agents that support the [agents.md](https://agents.md) standard. Follow it.
---
...
---
> Source: [aiven/terraform-provider-aiven](https://github.com/aiven/terraform-provider-aiven) — distributed by [TomeVault](https://tomevault.io).
