---
trigger: always_on
description: `ds4.c` is a DeepSeek V4 Flash specific inference engine. It is not a generic
---
...
---
> Source: [paean-ai/deeptide](https://github.com/paean-ai/deeptide) — distributed by [TomeVault](https://tomevault.io).
