---
trigger: always_on
description: Ruby gem + Docker image + Helm chart. Gem is the core product, Docker wraps it as standalone Rack app, Helm deploys the Docker image to Kubernetes.
---
...
---
> Source: [Strech/sidekiq-prometheus-exporter](https://github.com/Strech/sidekiq-prometheus-exporter) — distributed by [TomeVault](https://tomevault.io).
