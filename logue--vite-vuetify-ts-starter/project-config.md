---
trigger: always_on
description: This is a Vue 3 + TypeScript + Vite starter project. Repository configuration is the source of truth for project rules; this file only documents key points for working in the repository.
---
