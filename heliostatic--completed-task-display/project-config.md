---
trigger: always_on
description: 1. How is Work Managed? (The Source of Truth)
---
...
---
> Source: [heliostatic/completed-task-display](https://github.com/heliostatic/completed-task-display) — distributed by [TomeVault](https://tomevault.io).
