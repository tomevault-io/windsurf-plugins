---
trigger: always_on
description: **Design ground truth:** Every UI worker MUST read [`.impeccable.md`](./.impeccable.md) before touching frontend code.
---
...
---
> Source: [waifufun/waifu.fun](https://github.com/waifufun/waifu.fun) — distributed by [TomeVault](https://tomevault.io).
