---
trigger: always_on
description: nvme-stas (NVMe STorage Appliance Services) provides two cooperating systemd daemons:
---
...
---
> Source: [linux-nvme/nvme-stas](https://github.com/linux-nvme/nvme-stas) — distributed by [TomeVault](https://tomevault.io).
