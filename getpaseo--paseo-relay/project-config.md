---
trigger: always_on
description: Paseo Relay is a distributed, protocol-compatible WebSocket relay for
---
...
---
> Source: [getpaseo/paseo-relay](https://github.com/getpaseo/paseo-relay) — distributed by [TomeVault](https://tomevault.io).
