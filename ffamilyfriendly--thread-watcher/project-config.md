---
trigger: always_on
description: These are the configurations and system prompts for the mistral agents used to facilitate AI summaries, regex generation, and issue narrowing.
---
...
---
> Source: [ffamilyfriendly/Thread-Watcher](https://github.com/ffamilyfriendly/Thread-Watcher) — distributed by [TomeVault](https://tomevault.io).
