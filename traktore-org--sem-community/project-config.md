---
trigger: always_on
description: Solar Energy Management (SEM) is a Home Assistant integration for optimizing solar power, battery storage, and EV charging. It maximizes solar self-consumption while protecting battery levels and managing peak load.
---
...
---
> Source: [traktore-org/sem-community](https://github.com/traktore-org/sem-community) — distributed by [TomeVault](https://tomevault.io).
