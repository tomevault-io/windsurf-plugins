---
trigger: always_on
description: <!-- Repo-owned. Keep it LEAN: a router. Shared rules are imported below and synced from pm-kit —
---
...
---
> Source: [celo-org/celo-composer](https://github.com/celo-org/celo-composer) — distributed by [TomeVault](https://tomevault.io).
