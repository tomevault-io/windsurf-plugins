---
trigger: always_on
description: KubeCodeRun is a secure code interpreter API that executes code in isolated Kubernetes pods. It supports multiple languages (see `src/config/languages.py`) with sub-100ms latency for Python/JS via warm pod pools.
---
...
---
> Source: [aron-muon/KubeCodeRun](https://github.com/aron-muon/KubeCodeRun) — distributed by [TomeVault](https://tomevault.io).
