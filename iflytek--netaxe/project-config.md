---
trigger: always_on
description: validates a single compose file without starting containers.
---
...
---
> Source: [iflytek/NetAxe](https://github.com/iflytek/NetAxe) — distributed by [TomeVault](https://tomevault.io).
