---
trigger: always_on
description: A GitHub Action written in Kotlin/JS and executed by Node. `cache-action-entrypoint` is the entry point,
---
...
---
> Source: [burrunan/gradle-cache-action](https://github.com/burrunan/gradle-cache-action) — distributed by [TomeVault](https://tomevault.io).
