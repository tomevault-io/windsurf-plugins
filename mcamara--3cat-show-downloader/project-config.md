---
trigger: always_on
description: - **SOLID and DRY Principles**: Maintain clean, maintainable code following SOLID and DRY principles
---
...
- Always use Rust 2024 edition with latest stable version. Pin version in `rust-toolchain.toml` or use stable.
...
---
> Source: [mcamara/3cat_show_downloader](https://github.com/mcamara/3cat_show_downloader) — distributed by [TomeVault](https://tomevault.io).
