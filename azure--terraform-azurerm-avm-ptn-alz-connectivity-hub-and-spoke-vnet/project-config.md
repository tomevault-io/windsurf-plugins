...
---
> Source: [Azure/terraform-azurerm-avm-ptn-alz-connectivity-hub-and-spoke-vnet](https://github.com/Azure/terraform-azurerm-avm-ptn-alz-connectivity-hub-and-spoke-vnet) — distributed by [TomeVault](https://tomevault.io).
