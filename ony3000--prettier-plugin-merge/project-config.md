---
trigger: always_on
description: pnpm run build       # Bundle with esbuild (minified, outputs to dist/)
---
...
---
> Source: [ony3000/prettier-plugin-merge](https://github.com/ony3000/prettier-plugin-merge) — distributed by [TomeVault](https://tomevault.io).
