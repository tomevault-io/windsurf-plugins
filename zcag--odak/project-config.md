---
trigger: always_on
description: After any code change, don't stop at commit/push — the binary in use must be updated too:
---
...
---
> Source: [zcag/odak](https://github.com/zcag/odak) — distributed by [TomeVault](https://tomevault.io).
