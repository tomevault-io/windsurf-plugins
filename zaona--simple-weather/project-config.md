---
trigger: always_on
description: - `.ux` 语法类似 Vue，但运行时与能力不完全相同；改动前对照 `VelaDocs/guide/framework/` 与 `VelaDocs/guide/framework/script/`。
---
...
---
> Source: [zaona/simple-weather](https://github.com/zaona/simple-weather) — distributed by [TomeVault](https://tomevault.io).
