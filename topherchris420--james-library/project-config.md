---
trigger: always_on
description: This file defines the default working protocol for Claude agents in this repository.
---

# CLAUDE.md — R.A.I.N. Agent Engineering Protocol
...
R.A.I.N. is a Rust-first autonomous agent runtime optimized for:
...
---
> Source: [topherchris420/james_library](https://github.com/topherchris420/james_library) — distributed by [TomeVault](https://tomevault.io).
