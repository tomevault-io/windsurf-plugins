---
trigger: always_on
description: `@yangxj96/logicflow-plugin-flowable` 是基于 [LogicFlow](https://logicflow.org) 的 **BPMN 2.0 流程建模插件**，无缝对接 [Flowable](https://www.flowable.org) 工作流引擎。
---
...
---
> Source: [yangxj96/logicflow-plugin-flowable](https://github.com/yangxj96/logicflow-plugin-flowable) — distributed by [TomeVault](https://tomevault.io).
