---
trigger: always_on
description: Stable Retro is an actively developed Gymnasium-compatible fork of OpenAI Gym Retro. It combines a Python API, a C++14 extension, and vendored libretro emulator cores.
---
...
---
> Source: [Farama-Foundation/stable-retro](https://github.com/Farama-Foundation/stable-retro) — distributed by [TomeVault](https://tomevault.io).
