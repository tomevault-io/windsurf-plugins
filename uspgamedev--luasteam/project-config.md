---
trigger: always_on
description: luasteam is a LuaJIT binding for the Steamworks API, compiled as a shared library (`.dll`/`.so`). It uses a **hybrid architecture**: most bindings are auto-generated from `steam_api.json` via a Rust generator, while complex cases are implemented manually in C++.
---
...
---
> Source: [uspgamedev/luasteam](https://github.com/uspgamedev/luasteam) — distributed by [TomeVault](https://tomevault.io).
