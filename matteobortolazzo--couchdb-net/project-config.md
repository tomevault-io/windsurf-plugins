---
trigger: always_on
description: .NET 10 backend library (`CouchDB.NET`) — a LINQ-enabled .NET SDK for CouchDB.
---
...
---
> Source: [matteobortolazzo/couchdb-net](https://github.com/matteobortolazzo/couchdb-net) — distributed by [TomeVault](https://tomevault.io).
