---
trigger: always_on
description: This document outlines the architectural context, coding standards, and directives for any AI assistant or agent working within the Slate codebase. Slate is a universal visual scripting language that compiles to a JSON AST, which is then natively rendered in the browser.
---
...
---
> Source: [varshith-dev/slate-language](https://github.com/varshith-dev/slate-language) — distributed by [TomeVault](https://tomevault.io).
