---
trigger: always_on
description: 本文件用于约束 Copilot、Codex、Gemini、Claude 等 AI 工具在当前项目中的执行方式。
---
...
---
> Source: [bing-framework/Bing.NetCore](https://github.com/bing-framework/Bing.NetCore) — distributed by [TomeVault](https://tomevault.io).
