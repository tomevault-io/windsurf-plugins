---
trigger: always_on
description: Rspack is a high-performance JavaScript bundler written in Rust that offers strong compatibility with the webpack ecosystem.
---
...
---
> Source: [web-infra-dev/rspack](https://github.com/web-infra-dev/rspack) — distributed by [TomeVault](https://tomevault.io).
