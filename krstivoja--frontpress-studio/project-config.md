---
trigger: always_on
description: **No source file over 300 lines.** Applies to `.js`, `.jsx`, and `.php` under
---
...
---
> Source: [krstivoja/frontpress-studio](https://github.com/krstivoja/frontpress-studio) — distributed by [TomeVault](https://tomevault.io).
