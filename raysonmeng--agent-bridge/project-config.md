---
trigger: always_on
description: - **永远不要直接推送到 master 分支！** 所有改动必须通过 feature/fix 分支 + PR 合并。
---
...
---
> Source: [raysonmeng/agent-bridge](https://github.com/raysonmeng/agent-bridge) — distributed by [TomeVault](https://tomevault.io).
