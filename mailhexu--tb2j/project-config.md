---
trigger: always_on
description: TB2J uses a specific convention for the Heisenberg Hamiltonian. It is crucial to check this when comparing results with other codes or experiments.
---
...
---
> Source: [mailhexu/TB2J](https://github.com/mailhexu/TB2J) — distributed by [TomeVault](https://tomevault.io).
