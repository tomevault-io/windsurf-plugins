---
trigger: always_on
description: Unconference scheduling app for Minnebar. Rails 7.2, Ruby 3.4.1, PostgreSQL.
---
...
---
> Source: [minnestar/sessionizer](https://github.com/minnestar/sessionizer) — distributed by [TomeVault](https://tomevault.io).
