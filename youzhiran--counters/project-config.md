---
trigger: always_on
description: 代码注释、日志和对话回答使用中文!代码注释、日志和对话回答使用中文!
---
...
---
> Source: [youzhiran/counters](https://github.com/youzhiran/counters) — distributed by [TomeVault](https://tomevault.io).
