---
trigger: always_on
description: > **中心思想（理念与精神）** —— 这是本预设研发的最高纲领，一切决策以它为准。
---
...
---
> Source: [yjh051108/dsh-routing-suite](https://github.com/yjh051108/dsh-routing-suite) — distributed by [TomeVault](https://tomevault.io).
