---
trigger: always_on
description: This repository contains the official .NET install scripts (`dotnet-install.ps1` and `dotnet-install.sh`) used to install the .NET SDK and runtimes on Windows, Linux, and macOS. These scripts are consumed by millions of users and CI systems.
---
...
---
> Source: [dotnet/install-scripts](https://github.com/dotnet/install-scripts) — distributed by [TomeVault](https://tomevault.io).
