---
trigger: always_on
description: This document provides essential information for AI agents and developers working on the `oss-licenses-plugin` and its tests.
---
...
---
> Source: [google/play-services-plugins](https://github.com/google/play-services-plugins) — distributed by [TomeVault](https://tomevault.io).
