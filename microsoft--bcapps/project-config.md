---
trigger: always_on
description: The strategy layer that controls how Shopify returns and refunds are processed in Business Central. This module does not hold the return/refund data model (that lives in `Order Refunds` and `Order Returns`). It holds the processing strategies and the interfaces for document creation.
---
...
---
> Source: [microsoft/BCApps](https://github.com/microsoft/BCApps) — distributed by [TomeVault](https://tomevault.io).
