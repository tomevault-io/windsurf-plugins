---
trigger: always_on
description: This is a Pandoc data directory (installed at `~/.local/share/pandoc/`) containing
---
...
---
> Source: [iandol/dotpandoc](https://github.com/iandol/dotpandoc) — distributed by [TomeVault](https://tomevault.io).
