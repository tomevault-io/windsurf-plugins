---
trigger: always_on
description: - `src/` — Cairo contracts and library (Scarb workspace, `snforge test`)
---
...
---
> Source: [keep-starknet-strange/garaga](https://github.com/keep-starknet-strange/garaga) — distributed by [TomeVault](https://tomevault.io).
