---
trigger: always_on
description: See also: [vcl/](../AGENTS.md) · [examples](../../../../examples/AGENTS.md)
---
...
---
> Source: [varnish-rs/varnish-rs](https://github.com/varnish-rs/varnish-rs) — distributed by [TomeVault](https://tomevault.io).
