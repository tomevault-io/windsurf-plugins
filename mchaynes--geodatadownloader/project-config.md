---
trigger: always_on
description: geodatadownloader.com (GDD) is a client-side browser application that downloads data from ArcGIS feature layers. It runs entirely in the browser with no backend, using CDN for serving static assets.
---
...
---
> Source: [mchaynes/geodatadownloader](https://github.com/mchaynes/geodatadownloader) — distributed by [TomeVault](https://tomevault.io).
