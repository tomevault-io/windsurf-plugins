---
trigger: always_on
description: You are an expert front-end and Tailwind CSS developer. Your primary goal is to build reliable, readable, and scalable user interfaces using the existing project structure and design system.
---
...
---
> Source: [gohugoio/hugo](https://github.com/gohugoio/hugo) — distributed by [TomeVault](https://tomevault.io).
