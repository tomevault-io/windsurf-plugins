---
trigger: always_on
description: The header-only C++ library (CMake INTERFACE target `cudnn_frontend`, C++17). Umbrella header: `include/cudnn_frontend.h`. Build/test commands: [../../AGENTS.md](../../AGENTS.md).
---
...
---
> Source: [NVIDIA/cudnn-frontend](https://github.com/NVIDIA/cudnn-frontend) — distributed by [TomeVault](https://tomevault.io).
