---
trigger: always_on
description: - Primary validation command: `dotnet pack .\src\HaveIBeenPwned.PwnedPasswords.Downloader\HaveIBeenPwned.PwnedPasswords.Downloader.csproj --configuration Release`
---
...
---
> Source: [HaveIBeenPwned/PwnedPasswordsDownloader](https://github.com/HaveIBeenPwned/PwnedPasswordsDownloader) — distributed by [TomeVault](https://tomevault.io).
