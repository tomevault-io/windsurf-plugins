---
trigger: always_on
description: Velero uses per-PR changelog fragments that are assembled into release notes.
---
...
---
> Source: [velero-io/velero](https://github.com/velero-io/velero) — distributed by [TomeVault](https://tomevault.io).
