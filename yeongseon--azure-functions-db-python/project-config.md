---
trigger: always_on
description: `azure-functions-db-python` provides pseudo DB trigger functionality for Azure Functions Python v2 applications using SQLAlchemy.
---
...
- Add a scope qualifier when it narrows the area: `feat(writer):`, `docs(trigger):`, `refactor(bridge):`.
...
---
> Source: [yeongseon/azure-functions-db-python](https://github.com/yeongseon/azure-functions-db-python) — distributed by [TomeVault](https://tomevault.io).
