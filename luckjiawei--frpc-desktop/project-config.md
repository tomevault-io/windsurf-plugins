---
trigger: always_on
description: Frpc-Desktop is a cross-platform Electron application. The renderer uses Vue 3, TypeScript, Vite, Pinia, Vue Router, Element Plus, and vue-i18n. The Electron main process manages frpc processes, local persistence, downloads, system integration, and IPC.
---
...
---
> Source: [luckjiawei/frpc-desktop](https://github.com/luckjiawei/frpc-desktop) — distributed by [TomeVault](https://tomevault.io).
