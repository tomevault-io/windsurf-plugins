---
trigger: always_on
description: An Agent defines who solves a Task and how the solving loop runs. Every Agent receives a started Sandbox, an OpenAI-style message list, and a runtime-injected model endpoint.
---
...
---
> Source: [verl-project/uni-agent](https://github.com/verl-project/uni-agent) — distributed by [TomeVault](https://tomevault.io).
