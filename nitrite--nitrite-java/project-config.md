---
trigger: always_on
description: Nitrite Database is an open source embedded NoSQL database for Java. It's a multi-module Maven project that supports both in-memory and file-based persistent storage.
---
...
---
> Source: [nitrite/nitrite-java](https://github.com/nitrite/nitrite-java) — distributed by [TomeVault](https://tomevault.io).
