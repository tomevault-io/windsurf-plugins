---
trigger: always_on
description: When submitting or reviewing a pull request, ensure the following criteria are met:
---
...
---
> Source: [odoo/paper-muncher](https://github.com/odoo/paper-muncher) — distributed by [TomeVault](https://tomevault.io).
