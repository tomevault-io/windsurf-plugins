---
trigger: always_on
description: > See [`AGENTS.md`](../AGENTS.md) for the full agent contract. The most
---
...
---
> Source: [Voxelum/x-minecraft-launcher](https://github.com/Voxelum/x-minecraft-launcher) — distributed by [TomeVault](https://tomevault.io).
