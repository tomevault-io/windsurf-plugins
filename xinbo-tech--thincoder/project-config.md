---
trigger: always_on
description: Zero-dependency AI coding CLI: pure Node.js >= 24 standard library, no build step, ESM (`.mjs`).
---
...
---
> Source: [xinbo-tech/thincoder](https://github.com/xinbo-tech/thincoder) — distributed by [TomeVault](https://tomevault.io).
