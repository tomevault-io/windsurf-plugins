---
trigger: always_on
description: UniBoard 是个人主页、导航页、笔记、短链接与文件分享服务。
---
...
- **后端**: 于 `./server` 文件夹。Spring Boot, Gradle, Kotlin, JVM 25。
...
---
> Source: [Coooolfan/UniBoard](https://github.com/Coooolfan/UniBoard) — distributed by [TomeVault](https://tomevault.io).
