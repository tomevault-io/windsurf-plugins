---
trigger: always_on
description: Guidance for coding agents working on this repository.
---
...
---
> Source: [badges/poser](https://github.com/badges/poser) — distributed by [TomeVault](https://tomevault.io).
