---
trigger: always_on
description: `datavault4sqlmesh` is a Python library that wraps `datavault4sqlglot` with SQLMesh-native model
---
...
---
> Source: [ScalefreeCOM/datavault4sqlmesh](https://github.com/ScalefreeCOM/datavault4sqlmesh) — distributed by [TomeVault](https://tomevault.io).
