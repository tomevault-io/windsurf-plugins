---
trigger: always_on
description: django-feed-reader is a reusable Django app for subscribing to and storing RSS, Atom, and JSON feeds. It is a library with no UI — it provides models, utilities, admin integration, and a management command. Published on PyPI as `django-feed-reader`.
---
...
---
> Source: [xurble/django-feed-reader](https://github.com/xurble/django-feed-reader) — distributed by [TomeVault](https://tomevault.io).
