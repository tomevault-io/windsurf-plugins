---
trigger: always_on
description: > 本 kit 不绑定 Claude Code。核心 = Markdown 规则书 + Python/ffmpeg 命令行工具，
---
...
---
> Source: [xuanbingbingo/hf-video-kit](https://github.com/xuanbingbingo/hf-video-kit) — distributed by [TomeVault](https://tomevault.io).
