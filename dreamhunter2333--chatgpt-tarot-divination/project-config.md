---
trigger: always_on
description: - `src/`: FastAPI backend (routers, config, divination logic).
---
...
---
> Source: [dreamhunter2333/chatgpt-tarot-divination](https://github.com/dreamhunter2333/chatgpt-tarot-divination) — distributed by [TomeVault](https://tomevault.io).
