---
trigger: always_on
description: ExpressoTS v4 application (opinionated layout) with the type-safe Event Bus wired in.
---
...
---
> Source: [expressots/expressots](https://github.com/expressots/expressots) — distributed by [TomeVault](https://tomevault.io).
