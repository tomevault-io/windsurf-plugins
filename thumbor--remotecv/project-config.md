---
trigger: always_on
description: remotecv is a Python worker service that performs OpenCV-based image
---
...
---
> Source: [thumbor/remotecv](https://github.com/thumbor/remotecv) — distributed by [TomeVault](https://tomevault.io).
