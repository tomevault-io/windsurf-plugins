---
trigger: always_on
description: This repository is a refactor/rewrite of `changshengyu/reader-dev`. Treat upstream behavior as the product contract, not the current rewritten component shape.
---
...
---
> Source: [changshengyu/openreader](https://github.com/changshengyu/openreader) — distributed by [TomeVault](https://tomevault.io).
