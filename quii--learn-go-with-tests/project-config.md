---
trigger: always_on
description: This is Chris James's ("quii") book. When drafting or editing chapter prose, match his voice, not generic technical-writing tone. This file is a distilled style guide; when in doubt, go read a chapter he actually wrote (see exclusions below) rather than guessing.
---
...
---
> Source: [quii/learn-go-with-tests](https://github.com/quii/learn-go-with-tests) — distributed by [TomeVault](https://tomevault.io).
