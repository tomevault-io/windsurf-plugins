---
trigger: always_on
description: MNN is a lightweight deep learning **inference engine** (not a training framework), targeting mobile and server platforms. Supports CNN / Transformer / LLM / Diffusion models. Code must prioritize **performance and binary size**.
---
...
---
> Source: [doulujiyao12/mobiinfer](https://github.com/doulujiyao12/mobiinfer) — distributed by [TomeVault](https://tomevault.io).
