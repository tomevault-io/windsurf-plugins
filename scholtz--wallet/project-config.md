---
trigger: always_on
description: AWallet is a Vue 3-based cryptocurrency wallet for Algorand blockchain, built with TypeScript, Vue CLI, and PrimeVue components. The application is packaged as both a web application and deployed via Docker/Kubernetes.
---
