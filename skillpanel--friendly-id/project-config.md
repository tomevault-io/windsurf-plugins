---
trigger: always_on
description: UUID to Base62 (FriendlyId) conversion library for Java.
---
...
---
> Source: [SkillPanel/friendly-id](https://github.com/SkillPanel/friendly-id) — distributed by [TomeVault](https://tomevault.io).
