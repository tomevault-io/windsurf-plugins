---
trigger: always_on
description: This document provides instructions on how to add a new program to this repository. Following these guidelines ensures consistency, security, and maintainability across all Docker images.
---
...
---
> Source: [jauderho/dockerfiles](https://github.com/jauderho/dockerfiles) — distributed by [TomeVault](https://tomevault.io).
