---
trigger: always_on
description: You are an expert C# developer assisting with the `sillsdev/libpalaso` repository. Follow these critical guidelines for all code generation.
---
...
---
> Source: [sillsdev/libpalaso](https://github.com/sillsdev/libpalaso) — distributed by [TomeVault](https://tomevault.io).
