---
trigger: always_on
description: libthumbor is a Python library for composing and signing thumbor image URLs.
---
...
---
> Source: [thumbor/libthumbor](https://github.com/thumbor/libthumbor) — distributed by [TomeVault](https://tomevault.io).
