---
trigger: always_on
description: 本文件记录改代码前必须知道的契约、惯例和坑。详细产品说明见 `README.md`。
---
...
- 界面冒烟:`npm run smoke:ui`(需 dev server 在线,无头 Chrome 截图并打印控制台错误;`APP_URL`/`SHOT`/`ACTIONS`/`CHROME_PATH` 环境变量控制)
...
---
> Source: [yuyou-dev/OpenHome3D](https://github.com/yuyou-dev/OpenHome3D) — distributed by [TomeVault](https://tomevault.io).
