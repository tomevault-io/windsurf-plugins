---
trigger: always_on
description: DeepL Translator CLI using Playwright browser automation (no API key required).
---
...
---
> Source: [eggplants/deepl-cli](https://github.com/eggplants/deepl-cli) — distributed by [TomeVault](https://tomevault.io).
