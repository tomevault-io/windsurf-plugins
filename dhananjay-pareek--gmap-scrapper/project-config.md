---
trigger: always_on
description: - `make test` - Run all unit tests with race detection
---
...
- Import order: standard library, third-party, local packages (prefix: github.com/dhananjay-pareek/google-maps-scraper)
...
---
> Source: [dhananjay-pareek/GMAP-Scrapper](https://github.com/dhananjay-pareek/GMAP-Scrapper) — distributed by [TomeVault](https://tomevault.io).
