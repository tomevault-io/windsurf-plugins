---
trigger: always_on
description: - 只实现当前明确需求，拒绝过度设计（KISS / YAGNI）。
---
...
---
> Source: [lichengiggs/free-proxy](https://github.com/lichengiggs/free-proxy) — distributed by [TomeVault](https://tomevault.io).
