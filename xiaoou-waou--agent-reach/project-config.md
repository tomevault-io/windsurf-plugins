---
trigger: always_on
description: Agent Reach — Python CLI + library that gives AI agents read/search access to 8 internet platforms.
---

# CLAUDE.md

## Project
Agent Reach — Python CLI + library that gives AI agents read/search access to 8 internet platforms.
Positioning: installer + doctor + config tool. NOT a wrapper — after install, agents call upstream tools directly.
Repo: github.com/xiaoou-waou/Agent-Reach | License: MIT | Version: 1.5.0
...
- `agent_reach/channels/` — One file per platform (youtube.py, bilibili.py, etc.)
...
---
> Source: [xiaoou-waou/agent-reach](https://github.com/xiaoou-waou/agent-reach) — distributed by [TomeVault](https://tomevault.io).
