---
trigger: always_on
description: This skill uses **two foundation libraries** for NotebookLM integration:
---
...
---
> Source: [magicseek/nblm](https://github.com/magicseek/nblm) — distributed by [TomeVault](https://tomevault.io).
