---
trigger: always_on
description: - Prioritize correctness, privacy, security, and user-visible behavior regressions over style-only feedback.
---
...
---
> Source: [yerzhansa/enduragent](https://github.com/yerzhansa/enduragent) — distributed by [TomeVault](https://tomevault.io).
