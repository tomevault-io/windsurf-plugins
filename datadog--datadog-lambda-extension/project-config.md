---
trigger: always_on
description: Flag any logging statements (`log::info!`, `log::debug!`, `log::warn!`, `log::error!`,
---
...
---
> Source: [DataDog/datadog-lambda-extension](https://github.com/DataDog/datadog-lambda-extension) — distributed by [TomeVault](https://tomevault.io).
