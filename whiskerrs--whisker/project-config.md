---
trigger: always_on
description: Authority: [docs/comment-style.md](docs/comment-style.md). Operational
---
...
---
> Source: [whiskerrs/whisker](https://github.com/whiskerrs/whisker) — distributed by [TomeVault](https://tomevault.io).
