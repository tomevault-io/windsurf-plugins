---
trigger: always_on
description: - When making changes, do not modify functionalities that already work/tested; implement only the specific requested change, with the smallest possible impact.
---
