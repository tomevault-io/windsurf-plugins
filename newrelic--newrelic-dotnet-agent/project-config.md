---
trigger: always_on
description: Tools that turn the solutions into shippable artifacts (NuGet, MSI, Linux
---
...
---
> Source: [newrelic/newrelic-dotnet-agent](https://github.com/newrelic/newrelic-dotnet-agent) — distributed by [TomeVault](https://tomevault.io).
