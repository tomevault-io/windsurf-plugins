---
trigger: always_on
description: This repo is a macOS SwiftUI image viewer (MVVM + Combine) with protocol-oriented services and on-device AI analysis (macOS 26+).
---
...
---
> Source: [vscarpenter/SimpleImageViewer](https://github.com/vscarpenter/SimpleImageViewer) — distributed by [TomeVault](https://tomevault.io).
