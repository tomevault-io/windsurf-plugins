---
trigger: always_on
description: All the extensions that are registered to Gardener are deployed to the garden runtime and seed clusters on which they are required (also see [extension registration documentation](/docs/gardener/extensions/registration/)).
---
...
---
> Source: [gardener/documentation](https://github.com/gardener/documentation) — distributed by [TomeVault](https://tomevault.io).
