---
trigger: always_on
description: CLI binary entry point for GOST (GO Simple Tunnel). This module compiles the `gost` command.
---
...
---
> Source: [go-gost/gost](https://github.com/go-gost/gost) — distributed by [TomeVault](https://tomevault.io).
