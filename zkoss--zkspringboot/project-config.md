---
trigger: always_on
description: This project is a Spring Boot starter for ZK, a Java framework for building web applications. It simplifies the integration of ZK with Spring Boot by providing auto-configuration and a starter POM. The project is divided into three main modules:
---
...
---
> Source: [zkoss/zkspringboot](https://github.com/zkoss/zkspringboot) — distributed by [TomeVault](https://tomevault.io).
