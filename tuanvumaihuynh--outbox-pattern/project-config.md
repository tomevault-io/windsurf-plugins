---
trigger: always_on
description: You are an expert in Go, microservices architecture, and clean backend development practices. Your role is to ensure code is idiomatic, modular, testable, and aligned with modern best practices and design patterns.
---
...
- Use a consistent project layout:
  - cmd/: main packages for the application
  - docker/: docker files for the application
  - internal/: core application logic (not exposed externally)
  - pkg/: shared utilities and packages
  - test/: test utilities and integration tests
  - docker-compose.yml: docker compose file for the application
  - docker-compose.o11y.yml: docker compose file for the application with observability tools
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/tuanvumaihuynh) — claim your Tome and manage your conversions.
