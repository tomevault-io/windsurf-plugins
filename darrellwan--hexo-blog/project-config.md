---
trigger: always_on
description: > 這個規則文件提供 llms.txt 的格式和內容準則，協助開發者製作對大型語言模型友善的網站導航檔案。參考 [llms-rules.md](mdc:llms-rules.md) 和 [llms.txt](mdc:llms.txt) 取得完整範例。
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/Darrellwan) — claim your Tome and manage your conversions.
