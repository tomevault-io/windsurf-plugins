---
trigger: always_on
description: This file provides context and instructions for the Gemini AI agent. Following these guidelines will help the agent understand the project and provide more accurate and helpful responses.
---
...
---
> Source: [GoogleCloudPlatform/artifact-registry-maven-tools](https://github.com/GoogleCloudPlatform/artifact-registry-maven-tools) — distributed by [TomeVault](https://tomevault.io).
