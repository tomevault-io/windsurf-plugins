---
trigger: always_on
description: This repository contains a JavaScript GitHub Action that runs `cargo semver-checks` for Rust crates/workspaces. The entrypoint in `dist/index.js`.
---
...
---
> Source: [obi1kenobi/cargo-semver-checks-action](https://github.com/obi1kenobi/cargo-semver-checks-action) — distributed by [TomeVault](https://tomevault.io).
