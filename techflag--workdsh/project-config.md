---
trigger: always_on
description: WorkDSH 是基于 DeepSeek Harness 公开插件接口的 Web 工作平台，参考 WorkBuddy 的应用能力。项目独立于 dsh-ssh-desktop。
---
...
---
> Source: [techflag/workdsh](https://github.com/techflag/workdsh) — distributed by [TomeVault](https://tomevault.io).
