---
trigger: always_on
description: Before answering questions or proposing changes about existing blocks, sub-blocks, components, or architectural patterns, the agent MUST first consult:
---
...
---
> Source: [gravity-ui/page-constructor](https://github.com/gravity-ui/page-constructor) — distributed by [TomeVault](https://tomevault.io).
