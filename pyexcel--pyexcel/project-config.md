---
trigger: always_on
description: I reviewed [changelog.yml](changelog.yml) and understand its structure.
---
...
---
> Source: [pyexcel/pyexcel](https://github.com/pyexcel/pyexcel) — distributed by [TomeVault](https://tomevault.io).
