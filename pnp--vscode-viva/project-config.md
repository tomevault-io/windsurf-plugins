---
trigger: always_on
description: This is a **VS Code extension** that serves as an **abstraction layer** over the SharePoint Framework (SPFx) Yeoman generator and CLI for Microsoft 365. The extension provides a comprehensive toolkit for SPFx development with AI-powered assistance.
---
...
---
> Source: [pnp/vscode-viva](https://github.com/pnp/vscode-viva) — distributed by [TomeVault](https://tomevault.io).
