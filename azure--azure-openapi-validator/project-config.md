---
trigger: always_on
description: This workflow validates Azure OpenAPI validator rule changes by running selected rules against spec files from the
---
...
---
> Source: [Azure/azure-openapi-validator](https://github.com/Azure/azure-openapi-validator) — distributed by [TomeVault](https://tomevault.io).
