---
trigger: always_on
description: 本文件用于记录 AI 助手（如 GitHub Copilot、Cursor 等）在项目中需要遵循的约定和示例。
---
...
---
> Source: [Gridea-Pro/gridea-pro](https://github.com/Gridea-Pro/gridea-pro) — distributed by [TomeVault](https://tomevault.io).
