---
trigger: always_on
description: VS Code 扩展，入口 `src/extension.ts`。运行时代码在 `src/`，编译输出到 `out/`。
---
...
---
> Source: [chaselen/v2ex-playground](https://github.com/chaselen/v2ex-playground) — distributed by [TomeVault](https://tomevault.io).
