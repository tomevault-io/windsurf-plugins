---
trigger: always_on
description: - Use a subagent for tasks that require focused expertise (security audit, performance analysis, test generation).
---
...
---
> Source: [rohitg00/awesome-claude-code-toolkit](https://github.com/rohitg00/awesome-claude-code-toolkit) — distributed by [TomeVault](https://tomevault.io).
