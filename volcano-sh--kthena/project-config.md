---
trigger: always_on
description: Kthena is a Kubernetes-native LLM inference platform (controllers, router, CLI, Helm charts).
---
...
---
> Source: [volcano-sh/kthena](https://github.com/volcano-sh/kthena) — distributed by [TomeVault](https://tomevault.io).
