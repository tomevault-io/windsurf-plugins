---
trigger: always_on
description: このファイルは AI コーディングエージェントおよびすべての開発者が読むべきガイドです。
---
...
---
> Source: [tumf/hermes-manager](https://github.com/tumf/hermes-manager) — distributed by [TomeVault](https://tomevault.io).
