...
Original source: `AGENTS.md` in [modelstudioai/cli](https://github.com/modelstudioai/cli).
...
```
npx tomevault install modelstudioai/cli
```
Source: [github.com/modelstudioai/cli](https://github.com/modelstudioai/cli).
