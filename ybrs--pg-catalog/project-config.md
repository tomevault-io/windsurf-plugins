---
trigger: always_on
description: - Never fail silently. If tests don't pass fix the test. Never skip the tests.
---
...
---
> Source: [ybrs/pg_catalog](https://github.com/ybrs/pg_catalog) — distributed by [TomeVault](https://tomevault.io).
