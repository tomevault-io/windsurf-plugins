---
trigger: always_on
description: provides boilerplate for generating new transforms and passes. After running
---
...
---
> Source: [google/heir](https://github.com/google/heir) — distributed by [TomeVault](https://tomevault.io).
