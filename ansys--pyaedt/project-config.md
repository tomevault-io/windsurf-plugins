---
trigger: always_on
description: Skills are organized as plugins under `.github/plugin/`. Always **read the skill file** (using the file-reading tool) **before** responding.
---
...
---
> Source: [ansys/pyaedt](https://github.com/ansys/pyaedt) — distributed by [TomeVault](https://tomevault.io).
