---
trigger: always_on
description: This file is for AI coding agents working in this repository.
---
...
---
> Source: [NickTsitlakidis/event-nest](https://github.com/NickTsitlakidis/event-nest) — distributed by [TomeVault](https://tomevault.io).
