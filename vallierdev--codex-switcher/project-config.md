---
trigger: always_on
description: Tauri 2 desktop app that proxies codex CLI / Claude Code traffic across
---
...
---
> Source: [VallierDev/codex-switcher](https://github.com/VallierDev/codex-switcher) — distributed by [TomeVault](https://tomevault.io).
