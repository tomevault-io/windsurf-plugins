---
trigger: always_on
description: > Essential guardrails only. Detailed patterns in satellite files under `docs/`, `skills/`, `commands/`.
---
...
---
> Source: [travisjneuman/.claude](https://github.com/travisjneuman/.claude) — distributed by [TomeVault](https://tomevault.io).
