---
trigger: always_on
description: This document outlines how AI agents can be used to assist in the development, review, and maintenance of the `bmclib` repository. The goal is to leverage agents to improve code quality, ensure consistency, and provide clear guidance to contributors.
---
...
---
> Source: [bmc-toolbox/bmclib](https://github.com/bmc-toolbox/bmclib) — distributed by [TomeVault](https://tomevault.io).
