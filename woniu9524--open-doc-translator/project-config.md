---
trigger: always_on
description: - 每个 React 组件 (.tsx/.jsx) 必须有对应的 `.vibe.md` 文档文件
---
...
---
> Source: [woniu9524/open-doc-translator](https://github.com/woniu9524/open-doc-translator) — distributed by [TomeVault](https://tomevault.io).
