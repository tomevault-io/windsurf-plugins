---
trigger: always_on
description: 这份文档面向两类读者：**参与本仓库的开发者 / AI 编码代理**，以及**运行在用户机器上、通过 AIOS 创建和修改应用的 AI**。无论你是谁，改这个仓库之前先读完它——这里写的不是建议，是契约。
---
...
---
> Source: [realuckyang/AIOS](https://github.com/realuckyang/AIOS) — distributed by [TomeVault](https://tomevault.io).
