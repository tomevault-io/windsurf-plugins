---
trigger: always_on
description: 每次完成代码修改后，必须依次执行以下步骤，不要遗漏：
---
...
---
> Source: [zhiwuyazhe-fjr/ChatGPT-Helper](https://github.com/zhiwuyazhe-fjr/ChatGPT-Helper) — distributed by [TomeVault](https://tomevault.io).
