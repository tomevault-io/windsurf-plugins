---
trigger: always_on
description: Generates arginfo headers for extensions — run from extension project directories using `php vendor/swoole/phpx/bin/gen_stub.php <stub_dir>`.
---
...
---
> Source: [swoole/phpx](https://github.com/swoole/phpx) — distributed by [TomeVault](https://tomevault.io).
