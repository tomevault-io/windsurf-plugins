---
trigger: always_on
description: - Core package lives in `src/manim_generator/`; `main.py` orchestrates the workflow that drafts, reviews, and executes Manim scenes, while `utils/` holds config, prompt, LLM, file, rendering, and usage helpers.
---
