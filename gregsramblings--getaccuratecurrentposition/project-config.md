---
trigger: always_on
description: Operating notes for agents working in this repo. See `README.md` for full usage docs
---
...
---
> Source: [gregsramblings/getAccurateCurrentPosition](https://github.com/gregsramblings/getAccurateCurrentPosition) — distributed by [TomeVault](https://tomevault.io).
