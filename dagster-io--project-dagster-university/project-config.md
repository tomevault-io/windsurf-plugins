---
trigger: always_on
description: Every lesson file requires these fields:
---
...
---
> Source: [dagster-io/project-dagster-university](https://github.com/dagster-io/project-dagster-university) — distributed by [TomeVault](https://tomevault.io).
