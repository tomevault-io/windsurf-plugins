---
trigger: always_on
description: **Do not import torch outside of `klongpy/backends/torch_backend.py`.**
---
...
---
> Source: [briangu/klongpy](https://github.com/briangu/klongpy) — distributed by [TomeVault](https://tomevault.io).
