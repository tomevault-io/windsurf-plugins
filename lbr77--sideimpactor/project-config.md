---
trigger: always_on
description: - Use `bun` for all Node.js dependency and script operations.
---
...
---
> Source: [lbr77/SideImpactor](https://github.com/lbr77/SideImpactor) — distributed by [TomeVault](https://tomevault.io).
