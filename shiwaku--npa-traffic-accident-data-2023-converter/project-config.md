---
trigger: always_on
description: 警察庁の交通事故統計情報オープンデータ（2023年本票）をGISデータ（読みやすい形式）に変換するPythonスクリプト群。
---
...
---
> Source: [shiwaku/npa-traffic-accident-data-2023-converter](https://github.com/shiwaku/npa-traffic-accident-data-2023-converter) — distributed by [TomeVault](https://tomevault.io).
