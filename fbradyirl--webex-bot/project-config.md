---
trigger: always_on
description: Instructions for AI coding agents (Claude, Codex, Copilot, etc.) working on this repository.
---
...
---
> Source: [fbradyirl/webex_bot](https://github.com/fbradyirl/webex_bot) — distributed by [TomeVault](https://tomevault.io).
