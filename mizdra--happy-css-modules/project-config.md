---
trigger: always_on
description: `happy-css-modules` (CLI name `hcm`) is a CLI tool that generates type definitions (`.d.ts`) and Declaration Maps (`.d.ts.map`) from CSS Modules `.css`/`.scss`/`.less` files. The `.d.ts.map` enables go-to-definition in tsserver.
---
...
---
> Source: [mizdra/happy-css-modules](https://github.com/mizdra/happy-css-modules) — distributed by [TomeVault](https://tomevault.io).
