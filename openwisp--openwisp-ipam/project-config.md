---
trigger: always_on
description: `openwisp-ipam` is the OpenWISP Django app for IP address and subnet management.
---
...
---
> Source: [openwisp/openwisp-ipam](https://github.com/openwisp/openwisp-ipam) — distributed by [TomeVault](https://tomevault.io).
