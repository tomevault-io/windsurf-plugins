---
trigger: always_on
description: Scoped agent rules for `frontend/`. Loaded automatically on top of the repo-root [`AGENTS.md`](../AGENTS.md).
---
...
---
> Source: [apache/texera](https://github.com/apache/texera) — distributed by [TomeVault](https://tomevault.io).
