---
trigger: always_on
description: Agent is the component that implements the interface to interact with `Chain` by deciding how to
---
...
---
> Source: [Forethought-Technologies/AutoChain](https://github.com/Forethought-Technologies/AutoChain) — distributed by [TomeVault](https://tomevault.io).
