---
trigger: always_on
description: - 遵循 [eslint.config.js](../eslint.config.js) 中现有的 JavaScript 与 Vue 风格：使用 ES modules、分号、单引号，以及按分组排序的 import。
---
...
---
> Source: [kooriookami/yugioh-card](https://github.com/kooriookami/yugioh-card) — distributed by [TomeVault](https://tomevault.io).
