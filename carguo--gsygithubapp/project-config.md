---
trigger: always_on
description: > 该文件是面向 AI 协作（Trae / Cursor / Copilot 等）和团队成员的统一入口。
---
...
---
> Source: [CarGuo/GSYGithubAPP](https://github.com/CarGuo/GSYGithubAPP) — distributed by [TomeVault](https://tomevault.io).
