...
# Pascal Language Agents Instructions
...
- Keeping language configuration, commands, and localization updates consistent.
- Applying minimal, safe changes aligned with repository conventions.

## Typical agent tasks

- Update language contributions, snippets, or command registrations.
