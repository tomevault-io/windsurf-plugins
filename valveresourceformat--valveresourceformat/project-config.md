---
trigger: always_on
description: ValveResourceFormat (VRF) is a C# library and toolset for parsing Valve's Source 2 resource formats. The project folders are:
---
...
---
> Source: [ValveResourceFormat/ValveResourceFormat](https://github.com/ValveResourceFormat/ValveResourceFormat) — distributed by [TomeVault](https://tomevault.io).
