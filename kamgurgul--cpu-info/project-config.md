---
trigger: always_on
description: This is a compose multiplatform project build for Android, iOS, JVM and web. App is focused around
---
...
---
> Source: [kamgurgul/cpu-info](https://github.com/kamgurgul/cpu-info) — distributed by [TomeVault](https://tomevault.io).
