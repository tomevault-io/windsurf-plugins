---
trigger: always_on
description: このリポジトリは、`Electron`、`Babylon.js`、`WebGPU` を使った実験的な MMD エディタ / ビューア `MMD_modoki` です。
---
...
---
> Source: [togechiyo/MMD_modoki](https://github.com/togechiyo/MMD_modoki) — distributed by [TomeVault](https://tomevault.io).
