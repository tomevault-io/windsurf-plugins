---
trigger: always_on
description: This is the CQF Clinical Reasoning on FHIR repository, which provides JVM-based, FHIR-enabled clinical reasoning components. The project implements FHIR Clinical Reasoning operations like Measure evaluation (`$evaluate-measure`), PlanDefinition application (`$apply`), and CQL evaluation capabilities.
---
...
---
> Source: [cqframework/clinical-reasoning](https://github.com/cqframework/clinical-reasoning) — distributed by [TomeVault](https://tomevault.io).
