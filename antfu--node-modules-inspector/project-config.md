---
trigger: always_on
description: Migrate the Node Modules Inspector to use `devframe` as the underlying framework, maintaining complete backward compatibility with the existing user-facing experience (CLI commands, outputs, configuration, and web interface).
---
