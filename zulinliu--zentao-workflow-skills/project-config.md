---
trigger: always_on
description: - 面向用户阅读和审查的文档、注释、提交说明、Agent 交互内容优先使用中文
---
...
---
> Source: [zulinliu/zentao-workflow-skills](https://github.com/zulinliu/zentao-workflow-skills) — distributed by [TomeVault](https://tomevault.io).
