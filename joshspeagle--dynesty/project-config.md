---
trigger: always_on
description: Core package code lives in `py/dynesty/` (samplers, bounds, utilities, plotting, and results APIs).
---
...
---
> Source: [joshspeagle/dynesty](https://github.com/joshspeagle/dynesty) — distributed by [TomeVault](https://tomevault.io).
