---
trigger: always_on
description: Serialize arbitrary JS values (functions, classes, closures) into importable ES modules at build time. Derived from Pulumi's closure serialization engine (Apache 2.0).
---
...
---
> Source: [Fryuni/inox-tools](https://github.com/Fryuni/inox-tools) — distributed by [TomeVault](https://tomevault.io).
