---
trigger: always_on
description: CNC machine controller — Node.js/Express backend + React frontend communicating over Socket.IO.
---
...
---
> Source: [cncjs/cncjs](https://github.com/cncjs/cncjs) — distributed by [TomeVault](https://tomevault.io).
