---
trigger: always_on
description: Every branch must bump all version references. Version is defined in 3 places:
---
...
---
> Source: [exa-labs/exa-py](https://github.com/exa-labs/exa-py) — distributed by [TomeVault](https://tomevault.io).
