---
trigger: always_on
description: ZPass 是一款**零知识架构**的跨平台密码管理器。本仓库为 monorepo，按职责拆分多个子项目，每个子项目都有自己的 `README.md` 或 `AGENTS.md` 作为权威入口；本文件只覆盖**跨项目铁律**与**模块索引**。
---
...
---
> Source: [zerx-lab/zpass](https://github.com/zerx-lab/zpass) — distributed by [TomeVault](https://tomevault.io).
