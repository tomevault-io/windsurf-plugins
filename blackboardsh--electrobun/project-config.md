---
trigger: always_on
description: **NEVER** run electrobun directly from the bin folder or node_modules. The correct way to build and run Electrobun is:
---
...
---
> Source: [blackboardsh/electrobun](https://github.com/blackboardsh/electrobun) — distributed by [TomeVault](https://tomevault.io).
