---
trigger: always_on
description: Agent 作为 Vue 3 组件库的贡献者工作。代码修改仅限于 `components/`、`style/`、`docs/demos/`、`docs/*/component/` 及对应的测试文件。禁止修改 CI/CD 配置（`.github/workflows/*`）、发布脚本（`scripts/publish.ts`、`scripts/release.ts`）和 `@vexip-ui/*` 包内的 lint 配置。
---
...
---
> Source: [vexip-ui/vexip-ui](https://github.com/vexip-ui/vexip-ui) — distributed by [TomeVault](https://tomevault.io).
