---
trigger: always_on
description: This project is a GitHub CLI extension written in Go that provides Git credential authentication using GitHub Apps and Personal Access Tokens (PATs). It implements the Git credential helper protocol.
---
...
---
> Source: [AmadeusITGroup/gh-app-auth](https://github.com/AmadeusITGroup/gh-app-auth) — distributed by [TomeVault](https://tomevault.io).
