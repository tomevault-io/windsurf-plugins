---
trigger: always_on
description: - We use Astral's UV for package management and building.
---
...
- After making code changes, be sure to run `just`, which completes the rough equivalent of a CI pass
...
- Use PEP 695 type syntax improvements whenever appropriate (aka `class Foo[T]:`, `type Foo = t.Literal["baz", "buzz"]`, etc.)
...
---
> Source: [davepeck/game-of-go](https://github.com/davepeck/game-of-go) — distributed by [TomeVault](https://tomevault.io).
