---
trigger: always_on
description: - Applies repo-wide. Keep changes scoped; do not create issues or pull requests, or post comments.
---
...
---
> Source: [sxyazi/yazi](https://github.com/sxyazi/yazi) — distributed by [TomeVault](https://tomevault.io).
