---
trigger: always_on
description: Maputnik is a MapLibre style editor written using React and TypeScript.
---
...
---
> Source: [maplibre/maputnik](https://github.com/maplibre/maputnik) — distributed by [TomeVault](https://tomevault.io).
