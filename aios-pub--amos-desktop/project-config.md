---
trigger: always_on
description: - Moly is an LLM app that allows users to interact with multiple AI providers, both local and remote
---
...
---
> Source: [aios-pub/amos-desktop](https://github.com/aios-pub/amos-desktop) — distributed by [TomeVault](https://tomevault.io).
