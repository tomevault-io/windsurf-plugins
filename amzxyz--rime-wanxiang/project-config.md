---
trigger: always_on
description: 本文件用于指导 AI 编程代理在 `rime-wanxiang` 仓库中进行修改。
---
...
---
> Source: [amzxyz/rime-wanxiang](https://github.com/amzxyz/rime-wanxiang) — distributed by [TomeVault](https://tomevault.io).
