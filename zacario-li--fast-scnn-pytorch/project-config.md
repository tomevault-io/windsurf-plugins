---
trigger: always_on
description: Fast-SCNN is a PyTorch implementation of the Fast Semantic Segmentation Network. See `readme.md` for architecture details.
---
...
---
> Source: [zacario-li/Fast-SCNN_pytorch](https://github.com/zacario-li/Fast-SCNN_pytorch) — distributed by [TomeVault](https://tomevault.io).
