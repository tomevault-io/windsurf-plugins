---
trigger: always_on
description: This package (`projects/orcid-registry-ui`, published as `@orcid/registry-ui`) contains **feature-oriented UI components** for the main orcid-angular application only. It is not intended for reuse outside this project.
---
...
---
> Source: [ORCID/orcid-angular](https://github.com/ORCID/orcid-angular) — distributed by [TomeVault](https://tomevault.io).
