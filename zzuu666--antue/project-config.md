---
trigger: always_on
description: This is an **Antue** Vue 2.x component library (Ant Design for Vue). Node 10 is required (the project uses webpack 3 and babel 6).
---
...
---
> Source: [zzuu666/antue](https://github.com/zzuu666/antue) — distributed by [TomeVault](https://tomevault.io).
