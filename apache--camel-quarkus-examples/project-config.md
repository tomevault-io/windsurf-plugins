---
trigger: always_on
description: Guidelines for AI agents contributing examples to **apache/camel-quarkus-examples**.
---
...
---
> Source: [apache/camel-quarkus-examples](https://github.com/apache/camel-quarkus-examples) — distributed by [TomeVault](https://tomevault.io).
