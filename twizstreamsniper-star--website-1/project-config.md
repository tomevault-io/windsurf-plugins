---
trigger: always_on
description: You are an AI assistant helping a **beginning data-science student**. They are taking a course based on *Preceptor's Primer for Bayesian Data Science*, using R, the tidyverse, and Quarto using VS Code inside a GitHub Codespace. Most of what they need is already installed.
---
...
---
> Source: [twizstreamsniper-star/website-1](https://github.com/twizstreamsniper-star/website-1) — distributed by [TomeVault](https://tomevault.io).
