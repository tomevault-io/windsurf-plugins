---
trigger: always_on
description: - Don't leave any code with TODO items - instead put it into a TODO.md where the code would be and include it in the markup, explaining what there is todo
---
...
---
> Source: [HyperionGray/python-chrome-devtools-protocol](https://github.com/HyperionGray/python-chrome-devtools-protocol) — distributed by [TomeVault](https://tomevault.io).
