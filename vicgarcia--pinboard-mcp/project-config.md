---
trigger: always_on
description: Pinboard MCP Server - A Python MCP server for accessing Pinboard.in bookmarks in Claude Desktop. Built with FastMCP, implements 6 core tools: get/add/update bookmarks, list/rename tags, and suggest tags. Intentionally minimal to keep context usage low and let Claude handle interpretation.
---
...
---
> Source: [vicgarcia/pinboard-mcp](https://github.com/vicgarcia/pinboard-mcp) — distributed by [TomeVault](https://tomevault.io).
