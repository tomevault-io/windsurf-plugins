---
trigger: always_on
description: - `webapp/` hosts language ports (`golang/`, `ruby/`, `php/`, `python/`, `node/`); focus changes on one port and mirror fixes only when needed.
---
...
---
> Source: [catatsuy/private-isu](https://github.com/catatsuy/private-isu) — distributed by [TomeVault](https://tomevault.io).
