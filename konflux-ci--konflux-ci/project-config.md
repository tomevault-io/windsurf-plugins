---
trigger: always_on
description: <!-- Line count is capped; see MAX_AGENTS_MD_LINES in .github/workflows/validate-agents-md.yaml -->
---
...
---
> Source: [konflux-ci/konflux-ci](https://github.com/konflux-ci/konflux-ci) — distributed by [TomeVault](https://tomevault.io).
