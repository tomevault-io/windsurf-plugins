---
trigger: always_on
description: g10k is a high-performance Go implementation of r10k for Puppet environment deployment. It syncs Puppet environments from Git control repositories and resolves Puppetfile dependencies (Forge modules + Git modules) with aggressive caching and parallelism.
---
...
---
> Source: [voxpupuli/g10k](https://github.com/voxpupuli/g10k) — distributed by [TomeVault](https://tomevault.io).
