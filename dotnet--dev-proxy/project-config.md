---
trigger: always_on
description: Dev Proxy is a cross-platform .NET API simulator and proxy for testing how applications handle API failures, rate limits, latency, and more.
---
...
---
> Source: [dotnet/dev-proxy](https://github.com/dotnet/dev-proxy) — distributed by [TomeVault](https://tomevault.io).
