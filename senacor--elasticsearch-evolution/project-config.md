---
trigger: always_on
description: Flyway-inspired library for migrating Elasticsearch/OpenSearch index mappings. Executes versioned HTTP migration scripts and persists their execution state in an internal index (`es_evolution`).
---
...
---
> Source: [senacor/elasticsearch-evolution](https://github.com/senacor/elasticsearch-evolution) — distributed by [TomeVault](https://tomevault.io).
