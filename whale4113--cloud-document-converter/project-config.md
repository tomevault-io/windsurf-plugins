---
trigger: always_on
description: This repo is a pnpm + Turborepo monorepo for **Cloud Document Converter** (a browser extension that converts Lark cloud docs to Markdown).
---
...
---
> Source: [whale4113/cloud-document-converter](https://github.com/whale4113/cloud-document-converter) — distributed by [TomeVault](https://tomevault.io).
