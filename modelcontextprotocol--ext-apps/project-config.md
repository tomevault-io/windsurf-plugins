---
trigger: always_on
description: MCP Apps SDK (`@modelcontextprotocol/ext-apps`) enables MCP servers to display interactive UIs in conversational clients.
---
...
---
> Source: [modelcontextprotocol/ext-apps](https://github.com/modelcontextprotocol/ext-apps) — distributed by [TomeVault](https://tomevault.io).
