---
trigger: always_on
description: NNTile is a C++17/Python framework for distributed neural network training built on the StarPU runtime.
---
...
---
> Source: [nntile/nntile](https://github.com/nntile/nntile) — distributed by [TomeVault](https://tomevault.io).
