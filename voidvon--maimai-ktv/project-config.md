---
trigger: always_on
description: 本仓库是 Flutter KTV 主应用，播放器 package 已迁移到 `https://github.com/voidvon/ktv-player`，本地协作目录约定为 `../ktv-player/`。
---
...
---
> Source: [voidvon/maimai-ktv](https://github.com/voidvon/maimai-ktv) — distributed by [TomeVault](https://tomevault.io).
