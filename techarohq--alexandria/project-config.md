---
trigger: always_on
description: When undertaking a task, take a moment to pause and ask the user what the intent
---
...
---
> Source: [TecharoHQ/alexandria](https://github.com/TecharoHQ/alexandria) — distributed by [TomeVault](https://tomevault.io).
