---
trigger: always_on
description: Dead-simple cross-platform file encryption (AES-256-GCM + Argon2id) with an Electron GUI and a
---
...
---
> Source: [alichtman/deadbolt](https://github.com/alichtman/deadbolt) — distributed by [TomeVault](https://tomevault.io).
