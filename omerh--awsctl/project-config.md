---
trigger: always_on
description: awsctl is a Go-based CLI tool for managing AWS infrastructure across multiple regions with a single command. Here's what it does:
---
...
---
> Source: [omerh/awsctl](https://github.com/omerh/awsctl) — distributed by [TomeVault](https://tomevault.io).
