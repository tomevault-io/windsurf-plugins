---
trigger: always_on
description: ./build.sh    # Clean and build (kills QEMU, cleans, builds, generates IL)
---
...
---
> Source: [ProtonOS/ProtonOS](https://github.com/ProtonOS/ProtonOS) — distributed by [TomeVault](https://tomevault.io).
