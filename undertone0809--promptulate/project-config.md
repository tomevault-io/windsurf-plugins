---
trigger: always_on
description: The Agent is one of the core components of `promptulate`, its core idea is to build a proxy that can handle complex capabilities using components such as llm, Tool, Memory, Provider, and Output Formatter.
---
...
---
> Source: [Undertone0809/promptulate](https://github.com/Undertone0809/promptulate) — distributed by [TomeVault](https://tomevault.io).
