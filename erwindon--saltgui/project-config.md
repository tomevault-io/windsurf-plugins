---
trigger: always_on
description: SaltGUI is a webapplication to manage a Saltstack installation.
---
...
---
> Source: [erwindon/SaltGUI](https://github.com/erwindon/SaltGUI) — distributed by [TomeVault](https://tomevault.io).
