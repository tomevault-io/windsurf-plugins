---
trigger: always_on
description: Project context for AI coding assistants working on this repository.
---
...
---
> Source: [vyrx-dev/toofan](https://github.com/vyrx-dev/toofan) — distributed by [TomeVault](https://tomevault.io).
