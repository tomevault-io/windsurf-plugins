---
trigger: always_on
description: 完整产品与技术方案见 `mac-ssh-client-spec.md`(实施依据,按里程碑推进)。
---
...
- [~] M4 — 二期(部分已并入 main):
  - [x] iTerm2 .itermcolors 主题导入(6 单测覆盖)
...
---
> Source: [xinghelee/Berth](https://github.com/xinghelee/Berth) — distributed by [TomeVault](https://tomevault.io).
