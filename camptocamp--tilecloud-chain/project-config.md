---
trigger: always_on
description: The project must use async-friendly APIs for I/O to don't block the event loop.
---
...
- `tilecloud_chain/configuration.py`, `tilecloud_chain/CONFIG.md` and `tilecloud_chain/host_limit.py` are generated by pre-commit hooks.
- Do not edit those files manually; update the source files and run pre-commit to regenerate them.
...
---
> Source: [camptocamp/tilecloud-chain](https://github.com/camptocamp/tilecloud-chain) — distributed by [TomeVault](https://tomevault.io).
