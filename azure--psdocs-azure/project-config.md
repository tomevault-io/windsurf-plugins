---
trigger: always_on
description: When performing a code review, prioritize CI/CD correctness, build scripts, and monorepo structure changes.
---
...
---
> Source: [Azure/PSDocs.Azure](https://github.com/Azure/PSDocs.Azure) — distributed by [TomeVault](https://tomevault.io).
