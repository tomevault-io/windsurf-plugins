---
trigger: always_on
description: Bulk-register free Grok (xAI) **OAuth** accounts → import into a patched **Sub2API** multi-account reverse proxy → schedule many ~1M-token free accounts.
---
...
---
> Source: [xubin0903/GrokPool](https://github.com/xubin0903/GrokPool) — distributed by [TomeVault](https://tomevault.io).
