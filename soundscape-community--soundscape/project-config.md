---
trigger: always_on
description: - Never add new `Copyright (c) Microsoft Corporation.` notices to files changed in this repository.
---
...
---
> Source: [soundscape-community/soundscape](https://github.com/soundscape-community/soundscape) — distributed by [TomeVault](https://tomevault.io).
