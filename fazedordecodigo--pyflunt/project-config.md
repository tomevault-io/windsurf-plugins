---
trigger: always_on
description: - Biblioteca Python que implementa o Domain Notification Pattern (inspirada no Flunt .NET). Núcleo em `flunt/` com `Notifiable` e contratos de validação fluent.
---
...
---
> Source: [fazedordecodigo/PyFlunt](https://github.com/fazedordecodigo/PyFlunt) — distributed by [TomeVault](https://tomevault.io).
