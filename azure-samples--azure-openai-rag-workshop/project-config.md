---
trigger: always_on
description: Fastify service for document ingestion (PDF upload) and embedding generation into Azure AI Search or Qdrant.
---
...
---
> Source: [Azure-Samples/azure-openai-rag-workshop](https://github.com/Azure-Samples/azure-openai-rag-workshop) — distributed by [TomeVault](https://tomevault.io).
