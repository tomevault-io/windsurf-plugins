---
trigger: always_on
description: `tiangong-lca-data` owns checked-in TianGong LCA dataset content plus bundled reference assets that ship with the dataset package. Start here when the task may change data files, schema assets, or release-note content.
---
...
---
> Source: [linancn/TianGong-LCA-Data](https://github.com/linancn/TianGong-LCA-Data) — distributed by [TomeVault](https://tomevault.io).
