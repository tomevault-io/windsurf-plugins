---
trigger: always_on
description: - One-shot paren balance check (all 11 files):
---
...
---
> Source: [vritser/dsh-emacs](https://github.com/vritser/dsh-emacs) — distributed by [TomeVault](https://tomevault.io).
