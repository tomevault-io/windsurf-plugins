---
trigger: always_on
description: `AmplifyPlugins/` contains all AWS service plugin implementations. Each plugin implements a category behavior protocol from `Amplify/Categories/` and provides the concrete AWS integration.
---
...
---
> Source: [aws-amplify/amplify-swift](https://github.com/aws-amplify/amplify-swift) — distributed by [TomeVault](https://tomevault.io).
