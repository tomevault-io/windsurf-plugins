---
trigger: always_on
description: Flutter SDK with native integrations across all platforms.
---
...
---
> Source: [getsentry/sentry-dart](https://github.com/getsentry/sentry-dart) — distributed by [TomeVault](https://tomevault.io).
