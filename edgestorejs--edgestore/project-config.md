---
trigger: always_on
description: Use the following diff as base to create a new adapter.
---
...
---
> Source: [edgestorejs/edgestore](https://github.com/edgestorejs/edgestore) — distributed by [TomeVault](https://tomevault.io).
