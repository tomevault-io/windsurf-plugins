---
trigger: always_on
description: This is a **professional text-to-image conversion tool** that converts Markdown content into beautifully formatted shareable images. The project emphasizes **privacy protection** (all processing happens locally in the browser) and **user experience** (multiple themes, fonts, and background customization options).
---
...
---
> Source: [nicejade/markdown2png](https://github.com/nicejade/markdown2png) — distributed by [TomeVault](https://tomevault.io).
