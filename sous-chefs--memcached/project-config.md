---
trigger: always_on
description: Memcached does not publish operating-system package repositories for this cookbook to configure.
---
...
---
> Source: [sous-chefs/memcached](https://github.com/sous-chefs/memcached) — distributed by [TomeVault](https://tomevault.io).
