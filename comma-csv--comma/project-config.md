---
trigger: always_on
description: This repository is a Ruby gem. Ruby 3.0+ is required, and the CI matrix exercises Ruby 3.0-3.4 against Rails/ActiveRecord appraisals from 6.0 through 7.1.
---
...
---
> Source: [comma-csv/comma](https://github.com/comma-csv/comma) — distributed by [TomeVault](https://tomevault.io).
