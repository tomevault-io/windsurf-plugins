---
trigger: always_on
description: Use `/build-and-test` to build and run all unit tests. Manual steps:
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/rspamd) — claim your Tome and manage your conversions.
