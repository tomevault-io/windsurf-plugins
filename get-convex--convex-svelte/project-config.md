---
trigger: always_on
description: 1. Preserve and improve the existing architecture, DX, and UX.
---
...
---
> Source: [get-convex/convex-svelte](https://github.com/get-convex/convex-svelte) — distributed by [TomeVault](https://tomevault.io).
