---
trigger: always_on
description: This repository is the `doorkeeper-openid_connect` gem: a Rails engine that adds OpenID Connect behavior on top of the Doorkeeper OAuth 2 provider.
---
...
---
> Source: [doorkeeper-gem/doorkeeper-openid_connect](https://github.com/doorkeeper-gem/doorkeeper-openid_connect) — distributed by [TomeVault](https://tomevault.io).
