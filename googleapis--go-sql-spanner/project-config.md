---
trigger: always_on
description: This repository contains the Google Cloud Spanner driver for Go's `database/sql` package, along with internal packages (`parser`, `connectionstate`, `spannerlib`) and dynamic wrappers for Python, Ruby, .NET, and Java that wrap `spannerlib`.
---
...
---
> Source: [googleapis/go-sql-spanner](https://github.com/googleapis/go-sql-spanner) — distributed by [TomeVault](https://tomevault.io).
