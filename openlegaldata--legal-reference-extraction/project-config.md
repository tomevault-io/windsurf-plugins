---
trigger: always_on
description: - `src/refex/` — source package (src layout, installed via `pip install -e .`)
---
...
---
> Source: [openlegaldata/legal-reference-extraction](https://github.com/openlegaldata/legal-reference-extraction) — distributed by [TomeVault](https://tomevault.io).
