---
trigger: always_on
description: - Build: `pnpm build` (alias: `run-p build:*`)
---
...
---
> Source: [d-kimuson/claude-crew](https://github.com/d-kimuson/claude-crew) — distributed by [TomeVault](https://tomevault.io).
