---
trigger: always_on
description: These instructions apply to `pychron/experiment/` and all subdirectories unless
---
...
---
> Source: [NMGRL/pychron](https://github.com/NMGRL/pychron) — distributed by [TomeVault](https://tomevault.io).
