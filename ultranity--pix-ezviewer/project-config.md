---
trigger: always_on
description: 为 WebView 内的 HTTP(S) 请求提供基于规则的 SNI 绕过能力,与 API 层共用同一套 SNI 原语。
---
...
---
> Source: [ultranity/Pix-EzViewer](https://github.com/ultranity/Pix-EzViewer) — distributed by [TomeVault](https://tomevault.io).
