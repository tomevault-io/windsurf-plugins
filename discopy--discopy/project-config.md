---
trigger: always_on
description: DisCoPy is a Python toolkit for computing with string diagrams.
---
...
---
> Source: [discopy/discopy](https://github.com/discopy/discopy) — distributed by [TomeVault](https://tomevault.io).
