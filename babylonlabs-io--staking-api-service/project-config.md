---
trigger: always_on
description: This is a backend service that provides API for data that is fetched and indexed by another service called `babylon-staking-indexer`.
---
...
---
> Source: [babylonlabs-io/staking-api-service](https://github.com/babylonlabs-io/staking-api-service) — distributed by [TomeVault](https://tomevault.io).
