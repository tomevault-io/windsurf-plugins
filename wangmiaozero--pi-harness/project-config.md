---
trigger: always_on
description: This file is required reading for every AI / coding agent working on this repository (Cursor, Claude, Codex, Copilot, and others).
---
...
---
> Source: [wangmiaozero/pi-harness](https://github.com/wangmiaozero/pi-harness) — distributed by [TomeVault](https://tomevault.io).
