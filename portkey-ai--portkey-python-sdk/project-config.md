---
trigger: always_on
description: Portkey is an AI Gateway that unifies LLM signatures. This SDK wraps the OpenAI Python SDK using a **vendoring approach** to avoid conflicts with user-installed OpenAI packages.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/Portkey-AI)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/Portkey-AI)
