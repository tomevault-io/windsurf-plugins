---
trigger: always_on
description: 基于 **Next.js 16 (App Router)** + **Supabase** 的家族族谱管理应用，TypeScript 开发。
---
...
---
> Source: [yunfengsa/pure-genealogy](https://github.com/yunfengsa/pure-genealogy) — distributed by [TomeVault](https://tomevault.io).
