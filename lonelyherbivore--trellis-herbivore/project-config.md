...
This project is indexed by GitNexus as **Trellis** (13200 symbols, 18027 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
---
> Source: [LonelyHerbivore/Trellis-Herbivore](https://github.com/LonelyHerbivore/Trellis-Herbivore) — distributed by [TomeVault](https://tomevault.io).
