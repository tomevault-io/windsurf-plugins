...
- **Auto-generated**: `docs/api/API.md` generated from TypeScript/JSDoc using TypeDoc
...
---
> Source: [silverbucket/webfinger.js](https://github.com/silverbucket/webfinger.js) — distributed by [TomeVault](https://tomevault.io).
