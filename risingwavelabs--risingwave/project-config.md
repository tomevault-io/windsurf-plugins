---
trigger: always_on
description: RisingWave is a Postgres-compatible streaming database that offers the simplest and most cost-effective way to process, analyze, and manage real-time event data — with built-in support for the Apache Iceberg™ open table format.
---
...
---
> Source: [risingwavelabs/risingwave](https://github.com/risingwavelabs/risingwave) — distributed by [TomeVault](https://tomevault.io).
