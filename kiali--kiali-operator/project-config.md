---
trigger: always_on
description: Ansible-based Kubernetes operator that manages Kiali (service mesh observability UI) and the OpenShift Service Mesh Console plugin via Custom Resource Definitions.
---
...
---
> Source: [kiali/kiali-operator](https://github.com/kiali/kiali-operator) — distributed by [TomeVault](https://tomevault.io).
