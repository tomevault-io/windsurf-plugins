---
trigger: always_on
description: Build a production-ready WebTransport implementation with Bun **v1.3.9+** as the primary runtime (plus Node and Deno via Node-API) on **macOS + Linux + Windows**, implemented as a **Node-API (napi-rs) native addon** powered by **wtransport (Rust)**. Must support:
---
...
---
> Source: [vmeansdev/webtransport-bun](https://github.com/vmeansdev/webtransport-bun) — distributed by [TomeVault](https://tomevault.io).
