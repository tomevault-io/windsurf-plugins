---
trigger: always_on
description: This repository is a .NET solution for NCalc. The main solution is `NCalc.slnx`.
---
...
---
> Source: [ncalc/ncalc](https://github.com/ncalc/ncalc) — distributed by [TomeVault](https://tomevault.io).
