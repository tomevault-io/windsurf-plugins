---
trigger: always_on
description: 开源 SDK 让 LLM 输出驱动 Live2D/3D Avatar + Marketplace（创作者上传→租赁/售卖→平台抽佣）
---
...
---
> Source: [myths-labs/prometheus-avatar](https://github.com/myths-labs/prometheus-avatar) — distributed by [TomeVault](https://tomevault.io).
