...
Original source: `.cursor/rules/*.mdc` in [MasaruFukazawa/designdocs-sample.fukazawasoftwaredevelopment.com](https://github.com/MasaruFukazawa/designdocs-sample.fukazawasoftwaredevelopment.com).
