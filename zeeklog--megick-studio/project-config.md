---
trigger: always_on
description: - When changing Prisma schema or adding database migrations, always run the relevant Prisma follow-up commands before handing the task back: generate the Prisma client, apply/check migrations for the active database, and verify the affected API endpoint or query. Do not treat typecheck alone as sufficient for database shape changes.
---
...
---
> Source: [zeeklog/Megick-Studio](https://github.com/zeeklog/Megick-Studio) — distributed by [TomeVault](https://tomevault.io).
