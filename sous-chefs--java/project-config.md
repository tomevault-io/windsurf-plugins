---
trigger: always_on
description: This file records maintainer and agent decisions for the Java cookbook. Keep it focused on durable
---
...
---
> Source: [sous-chefs/java](https://github.com/sous-chefs/java) — distributed by [TomeVault](https://tomevault.io).
