---
trigger: always_on
description: K8s (Kata Containers) orchestrator for isolated dev environments. Bun monorepo + Rust agent.
---
...
---
> Source: [frak-id/atelier](https://github.com/frak-id/atelier) — distributed by [TomeVault](https://tomevault.io).
