---
trigger: always_on
description: This file applies only to `packages/volto-babel-preset-razzle` and its subdirectories.
---
...
---
> Source: [plone/volto](https://github.com/plone/volto) — distributed by [TomeVault](https://tomevault.io).
