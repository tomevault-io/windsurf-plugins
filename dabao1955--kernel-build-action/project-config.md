---
trigger: always_on
description: - This repo is primarily a single GitHub Action. The shipped entrypoints are `action.yml -> dist/index.js` and `dist/post/index.js`; source lives in `src/index.ts` and `src/post.ts`.
---
...
---
> Source: [dabao1955/kernel_build_action](https://github.com/dabao1955/kernel_build_action) — distributed by [TomeVault](https://tomevault.io).
