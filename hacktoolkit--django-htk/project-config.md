---
trigger: always_on
description: Instructions for AI agents and maintainers working in `django-htk`.
---
...
---
> Source: [hacktoolkit/django-htk](https://github.com/hacktoolkit/django-htk) — distributed by [TomeVault](https://tomevault.io).
