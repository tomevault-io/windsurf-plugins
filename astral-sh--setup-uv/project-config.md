---
trigger: always_on
description: This repository is a TypeScript-based GitHub Action for installing `uv` in GitHub Actions workflows. It also supports restoring/saving the `uv` cache and optional managed-Python caching.
---
...
---
> Source: [astral-sh/setup-uv](https://github.com/astral-sh/setup-uv) — distributed by [TomeVault](https://tomevault.io).
