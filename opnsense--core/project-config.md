---
trigger: always_on
description: Repository-level guidance for coding agents working on the OPNsense core repository.
---
...
---
> Source: [opnsense/core](https://github.com/opnsense/core) — distributed by [TomeVault](https://tomevault.io).
