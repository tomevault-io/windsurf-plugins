---
trigger: always_on
description: - Create virtual environment: `uv venv`
---
...
### Usage
- Run script: `python protocols/<protocol>/main.py`
  - Example: `python protocols/aave/main.py`
...
---
> Source: [yearn/monitoring](https://github.com/yearn/monitoring) — distributed by [TomeVault](https://tomevault.io).
