...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/TianGzlab/OmicsClaw](https://github.com/TianGzlab/OmicsClaw)

---

Install this config instantly:
```
npx tomevault install TianGzlab/OmicsClaw
```
Source: [github.com/TianGzlab/OmicsClaw](https://github.com/TianGzlab/OmicsClaw).
