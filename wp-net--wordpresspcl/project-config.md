---
trigger: always_on
description: - Use the .NET 10 SDK. Restore and build the solution in Release configuration:
---
...
---
> Source: [wp-net/WordPressPCL](https://github.com/wp-net/WordPressPCL) — distributed by [TomeVault](https://tomevault.io).
