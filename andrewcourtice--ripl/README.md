# AI instruction files for ripl

> Sourced from [andrewcourtice/ripl](https://github.com/andrewcourtice/ripl), graded against the public Tome Standard and kept consistent across every major platform by [TomeVault](https://tomevault.io)
