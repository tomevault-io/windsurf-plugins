---
trigger: always_on
description: 给自动化 agent(Claude Code / Cursor / Copilot 等)的项目说明 —— 帮用户**部署**和**改**这个项目时读它。人类请看 [README.md](README.md) 与 [CONTRIBUTING.md](CONTRIBUTING.md)。
---
...
---
> Source: [yanglongyun/one](https://github.com/yanglongyun/one) — distributed by [TomeVault](https://tomevault.io).
