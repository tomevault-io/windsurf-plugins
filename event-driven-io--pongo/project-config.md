---
trigger: always_on
description: Pongo provides a MongoDB-style document API backed by PostgreSQL and SQLite.
---
...
---
> Source: [event-driven-io/Pongo](https://github.com/event-driven-io/Pongo) — distributed by [TomeVault](https://tomevault.io).
