---
trigger: always_on
description: | Java format (Google Java Format) | `yarn fix:android` |
---
...
---
> Source: [getsentry/sentry-react-native](https://github.com/getsentry/sentry-react-native) — distributed by [TomeVault](https://tomevault.io).
