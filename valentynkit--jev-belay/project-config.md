---
trigger: always_on
description: A Claude Code Stop hook that blocks an unverified "done" and fails open on everything
---
...
---
> Source: [valentynkit/jev-belay](https://github.com/valentynkit/jev-belay) — distributed by [TomeVault](https://tomevault.io).
