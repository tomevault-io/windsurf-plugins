---
trigger: always_on
description: This repository contains the CometChat Calls SDK sample apps for Flutter. When working with this codebase, use the agent skills in the `skills/` directory for SDK-specific guidance.
---
