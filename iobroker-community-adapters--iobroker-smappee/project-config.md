...
8. [Smappee-Specific Patterns](#smappee-specific-patterns)
   - [Logging Patterns](#logging-patterns)
   - [MQTT Topic Handling](#mqtt-topic-handling)
   - [Switch Control Implementation](#switch-control-implementation)
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/iobroker-community-adapters)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/iobroker-community-adapters)
