---
trigger: always_on
description: This file contains high-priority rules for the Antigravity agent in this repository.
---
...
---
> Source: [wileverg/wileverg](https://github.com/wileverg/wileverg) — distributed by [TomeVault](https://tomevault.io).
