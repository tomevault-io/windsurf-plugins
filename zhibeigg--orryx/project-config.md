---
trigger: always_on
description: - `src/main/kotlin/org/gitee/orryx`：核心插件代码，按 `api/`、`core/`、`module/`、`compat/` 组织。
---
...
---
> Source: [zhibeigg/Orryx](https://github.com/zhibeigg/Orryx) — distributed by [TomeVault](https://tomevault.io).
