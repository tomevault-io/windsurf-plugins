---
trigger: always_on
description: This repo is a small pnpm-workspace monorepo for **Party**: a TypeScript particle simulation engine with **dual runtimes** (WebGPU + CPU) and a React playground app.
---
