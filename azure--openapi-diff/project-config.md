---
trigger: always_on
description: This repository contains the source code for `openapi-diff` (aka `oad`, aka `@azure/oad`), a breaking-change
---
...
---
> Source: [Azure/openapi-diff](https://github.com/Azure/openapi-diff) — distributed by [TomeVault](https://tomevault.io).
