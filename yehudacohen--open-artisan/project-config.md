---
trigger: always_on
description: - Pure functional state machine in `state-machine.ts` — no side effects, transition table lookup only
---
...
---
> Source: [yehudacohen/open-artisan](https://github.com/yehudacohen/open-artisan) — distributed by [TomeVault](https://tomevault.io).
