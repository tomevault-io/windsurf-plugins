---
trigger: always_on
description: Client → Server (jobs.py) → Worker (cea/worker.py) → Server
---
...
---
> Source: [architecture-building-systems/CityEnergyAnalyst](https://github.com/architecture-building-systems/CityEnergyAnalyst) — distributed by [TomeVault](https://tomevault.io).
