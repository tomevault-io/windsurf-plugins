---
trigger: always_on
description: Instructions for using this repository with Codex while preserving Claude Code plugin compatibility.
---
...
---
> Source: [wfukatsu/nexus-architect](https://github.com/wfukatsu/nexus-architect) — distributed by [TomeVault](https://tomevault.io).
