---
trigger: always_on
description: Kelora is a Rust-based command-line log analysis tool using the Rhai scripting engine. This guide provides essentials for AI agents working on the codebase.
---
...
---
> Source: [dloss/kelora](https://github.com/dloss/kelora) — distributed by [TomeVault](https://tomevault.io).
