---
trigger: always_on
description: This repository is a Bashly-based CLI. Prefer working from the source partials in `src/` and regenerate artifacts as needed.
---
...
---
> Source: [DannyBen/alf](https://github.com/DannyBen/alf) — distributed by [TomeVault](https://tomevault.io).
