---
trigger: always_on
description: - Install `uv` (if not present): `pip install uv` or follow https://astral.sh/uv installation guide.
---
...
---
> Source: [Hoopoes/FastStart](https://github.com/Hoopoes/FastStart) — distributed by [TomeVault](https://tomevault.io).
