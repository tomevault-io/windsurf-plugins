...
Augur OS is a **Tauri 2 desktop application** for B2B lead research and signal scoring. It uses Claude CLI as an AI backend for company/person research, scoring, and conversation generation.
...
Location: `~/.local/share/augur-os/data.db`
...
---
> Source: [DivyamTalwar/Augur](https://github.com/DivyamTalwar/Augur) — distributed by [TomeVault](https://tomevault.io).
