---
trigger: always_on
description: Aplicação web leve, segura e otimizada para registro de treinamentos de funcionários. O sistema foi refatorado para uma arquitetura modular baseada em componentes simples (`index.php` atua como bootstrap).
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/wppslander)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/wppslander)
