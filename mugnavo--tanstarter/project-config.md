---
trigger: always_on
description: - Stack: TypeScript + React (TanStack Start), with Drizzle ORM, shadcn/ui, and Better Auth.
---
...
---
> Source: [mugnavo/tanstarter](https://github.com/mugnavo/tanstarter) — distributed by [TomeVault](https://tomevault.io).
