---
trigger: always_on
description: 这是剑网3（JX3）游戏的 Lua 插件集合，包含多个独立插件模块。插件需要同时兼容**重制版（remake/HD）**和**缘起（classic/origin）**两个游戏版本。
---
...
---
> Source: [tinymins/JX3MY](https://github.com/tinymins/JX3MY) — distributed by [TomeVault](https://tomevault.io).
