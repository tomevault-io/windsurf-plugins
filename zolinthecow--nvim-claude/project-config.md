---
trigger: always_on
description: This guide defines how to work in this repo. Detailed behavior and examples live in colocated doctest docs.
---
...
---
> Source: [zolinthecow/nvim-claude](https://github.com/zolinthecow/nvim-claude) — distributed by [TomeVault](https://tomevault.io).
