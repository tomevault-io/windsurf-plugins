---
trigger: always_on
description: This repository contains Power BI projects (PBIP format) with semantic models and reports.
---
...
---
> Source: [RuiRomano/powerbi-agentic-mcp-cloud-agent](https://github.com/RuiRomano/powerbi-agentic-mcp-cloud-agent) — distributed by [TomeVault](https://tomevault.io).
