---
trigger: always_on
description: This file provides guidance to AI codign agents like Claude Code (claude.ai/code), Cursor AI, Codex,
---
...
---
> Source: [HarperFast/rocksdb-js](https://github.com/HarperFast/rocksdb-js) — distributed by [TomeVault](https://tomevault.io).
