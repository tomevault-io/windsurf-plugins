---
trigger: always_on
description: - Monorepo managed by NX, with apps in `apps/` and shared code in `libraries/`.
---
...
- Test: `pnpm test` (Vitest, per package; `vitest run --root <pkg>` for one)
...
- Docker: `docker compose -f ./docker/docker-compose.dev.yaml up -d`
...
- `docker/docker-compose.dev.yaml` — Local development Docker setup
...
---
> Source: [postmill-ai/postmill-app](https://github.com/postmill-ai/postmill-app) — distributed by [TomeVault](https://tomevault.io).
