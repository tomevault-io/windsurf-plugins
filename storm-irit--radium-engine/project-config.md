---
trigger: always_on
description: \page develCodingConvention Coding conventions for Radium
---
...
---
> Source: [STORM-IRIT/Radium-Engine](https://github.com/STORM-IRIT/Radium-Engine) — distributed by [TomeVault](https://tomevault.io).
