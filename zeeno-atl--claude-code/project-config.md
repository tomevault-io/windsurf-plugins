---
trigger: always_on
description: - Build Docker image: `make all` or `make build`
---
...
---
> Source: [Zeeno-atl/claude-code](https://github.com/Zeeno-atl/claude-code) — distributed by [TomeVault](https://tomevault.io).
