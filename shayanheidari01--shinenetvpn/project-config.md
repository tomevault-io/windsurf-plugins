---
trigger: always_on
description: Async HTTP/3 driver bridging `quiche::h3::Connection` to Tokio tasks via channels. `H3Driver<H: DriverHooks>` is generic over sealed client/server hooks; users interact through `H3Controller` + typed event/command channels.
---
...
---
> Source: [shayanheidari01/ShineNETVPN](https://github.com/shayanheidari01/ShineNETVPN) — distributed by [TomeVault](https://tomevault.io).
