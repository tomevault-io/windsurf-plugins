---
trigger: always_on
description: This document provides instructions for AI agents to set up the development environment and run build processes for the litra-rs project.
---
...
- Rust toolchain is pinned to version 1.92.0 (see `rust-toolchain.toml`)
...
---
> Source: [timrogers/litra-rs](https://github.com/timrogers/litra-rs) — distributed by [TomeVault](https://tomevault.io).
