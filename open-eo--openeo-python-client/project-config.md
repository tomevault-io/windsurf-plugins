---
trigger: always_on
description: This file is for AI coding agents (e.g. Claude Code, GitHub Copilot, Cursor,
---
...
---
> Source: [Open-EO/openeo-python-client](https://github.com/Open-EO/openeo-python-client) — distributed by [TomeVault](https://tomevault.io).
