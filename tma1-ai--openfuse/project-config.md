---
trigger: always_on
description: Langfuse is an open source LLM engineering platform for developing, monitoring,
---
...
---
> Source: [tma1-ai/openfuse](https://github.com/tma1-ai/openfuse) — distributed by [TomeVault](https://tomevault.io).
