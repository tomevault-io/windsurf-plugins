---
trigger: always_on
description: - Root crate: `tui-journal` (binary `tjournal`) with source in `src/`.
---
...
---
> Source: [AmmarAbouZor/tui-journal](https://github.com/AmmarAbouZor/tui-journal) — distributed by [TomeVault](https://tomevault.io).
