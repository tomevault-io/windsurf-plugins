---
trigger: always_on
description: 小红书 (Xiaohongshu) 数据采集框架，基于 Playwright 实现真实浏览器自动化，具备双层反检测能力（playwright-stealth + browserforge）。
---
...
---
> Source: [yangsijie666/xiaohongshu-crawler](https://github.com/yangsijie666/xiaohongshu-crawler) — distributed by [TomeVault](https://tomevault.io).
