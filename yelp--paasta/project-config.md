---
trigger: always_on
description: PaaSTA - container orchestration platform for deploying services on Kubernetes at Yelp.
---
...
---
> Source: [Yelp/paasta](https://github.com/Yelp/paasta) — distributed by [TomeVault](https://tomevault.io).
