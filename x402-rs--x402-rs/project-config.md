---
trigger: always_on
description: This folder contains canonical x402 protocol specifications downloaded from the upstream [coinbase/x402](https://github.com/coinbase/x402) repository.
---
...
---
> Source: [x402-rs/x402-rs](https://github.com/x402-rs/x402-rs) — distributed by [TomeVault](https://tomevault.io).
