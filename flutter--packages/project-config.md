---
trigger: always_on
description: This document provides guidance for AI agents to effectively contribute to the `flutter/packages` repository.
---
...
---
> Source: [flutter/packages](https://github.com/flutter/packages) — distributed by [TomeVault](https://tomevault.io).
