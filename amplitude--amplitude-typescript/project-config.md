---
trigger: always_on
description: This document outlines the commit message standards and pull request guidelines for the Amplitude TypeScript SDK.
---
...
---
> Source: [amplitude/Amplitude-TypeScript](https://github.com/amplitude/Amplitude-TypeScript) — distributed by [TomeVault](https://tomevault.io).
