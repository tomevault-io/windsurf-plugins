---
trigger: always_on
description: Manual de usuário do gnrx (GitBook), organizado em `epi/`, `formularios/`, `auditorias/`, etc., cada um com seu próprio `SUMMARY.md`.
---
...
---
> Source: [victor-gnrx/gnrx-manual](https://github.com/victor-gnrx/gnrx-manual) — distributed by [TomeVault](https://tomevault.io).
