---
trigger: always_on
description: This file contains build commands, code style guidelines, and development practices for agentic coding agents working in this netlab repository.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/ipspace)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/ipspace)
