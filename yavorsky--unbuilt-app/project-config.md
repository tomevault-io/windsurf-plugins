---
trigger: always_on
description: > Tech stack detection for websites via Playwright + pattern matching.
---
...
---
> Source: [yavorsky/unbuilt.app](https://github.com/yavorsky/unbuilt.app) — distributed by [TomeVault](https://tomevault.io).
