---
trigger: always_on
description: See the root [CLAUDE.md](../../CLAUDE.md) for when to use `CqlException<TError>` vs plain .NET exceptions.
---
...
---
> Source: [FirelyTeam/firely-cql-sdk](https://github.com/FirelyTeam/firely-cql-sdk) — distributed by [TomeVault](https://tomevault.io).
