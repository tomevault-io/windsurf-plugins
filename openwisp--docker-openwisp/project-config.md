---
trigger: always_on
description: `docker-openwisp` provides Docker images, compose files, and deployment helpers for running OpenWISP in containers.
---
...
---
> Source: [openwisp/docker-openwisp](https://github.com/openwisp/docker-openwisp) — distributed by [TomeVault](https://tomevault.io).
