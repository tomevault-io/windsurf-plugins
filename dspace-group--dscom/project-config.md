---
trigger: always_on
description: dscom is a .NET library and CLI tool that replaces deprecated Microsoft COM tools (`tlbexp.exe`, `OleView`, `RegAsm.exe`) for .NET 5+. It exports .NET assemblies to COM Type Libraries (TLBs), registers/unregisters COM types, embeds TLBs, and converts TLBs to YAML.
---
...
---
> Source: [dspace-group/dscom](https://github.com/dspace-group/dscom) — distributed by [TomeVault](https://tomevault.io).
