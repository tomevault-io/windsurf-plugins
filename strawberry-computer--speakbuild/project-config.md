---
trigger: always_on
description: - Start: `yarn start` or `expo start`
---
...
---
> Source: [Strawberry-Computer/speakbuild](https://github.com/Strawberry-Computer/speakbuild) — distributed by [TomeVault](https://tomevault.io).
