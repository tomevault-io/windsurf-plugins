---
trigger: always_on
description: Guidelines for code assistants and automation agents working in this repository.
---
...
---
> Source: [VrianCao/Uptimer](https://github.com/VrianCao/Uptimer) — distributed by [TomeVault](https://tomevault.io).
