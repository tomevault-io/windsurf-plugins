---
trigger: always_on
description: - A CLI-based AI agent for deep financial research and Kalshi prediction market trading, built with TypeScript, Ink (React for CLI), and LangChain.
---
...
---
> Source: [OctagonAI/kalshi-trading-bot-cli](https://github.com/OctagonAI/kalshi-trading-bot-cli) — distributed by [TomeVault](https://tomevault.io).
