---
trigger: always_on
description: Standing instructions for Claude (including Claude Code / "CC") working in this
---
...
---
> Source: [erlsci/iso8601](https://github.com/erlsci/iso8601) — distributed by [TomeVault](https://tomevault.io).
