---
trigger: always_on
description: - Extension config: `Config` (`@/core/config/setting.ts`); new keys sync `package.json` + `Config.get()` overload/`defaultValue` + `l10n/`
---
...
---
> Source: [jackiotyu/git-worktree-manager](https://github.com/jackiotyu/git-worktree-manager) — distributed by [TomeVault](https://tomevault.io).
