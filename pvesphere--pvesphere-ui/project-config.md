---
trigger: always_on
description: - 组件名应该始终使用多词组合，避免与HTML元素冲突
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/pvesphere)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/pvesphere)
