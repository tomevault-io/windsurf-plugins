...
- The code most be readable and maintainable especially for new team members
- Simplicity is key.

---
> Source: [madskristensen/LanguagePack](https://github.com/madskristensen/LanguagePack) — distributed by [TomeVault](https://tomevault.io).
