---
trigger: always_on
description: Test app for **Branch SDK v7.0.0-beta.2** compatibility with **React Native New Architecture** via the Interop Layer.
---
...
---
> Source: [BranchMetrics/react-native-branch-deep-linking-attribution](https://github.com/BranchMetrics/react-native-branch-deep-linking-attribution) — distributed by [TomeVault](https://tomevault.io).
