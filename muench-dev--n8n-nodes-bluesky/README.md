...
Original source: `copilot-instructions.md` in [muench-dev/n8n-nodes-bluesky](https://github.com/muench-dev/n8n-nodes-bluesky).
...
```
npx tomevault install muench-dev/n8n-nodes-bluesky
```
Source: [github.com/muench-dev/n8n-nodes-bluesky](https://github.com/muench-dev/n8n-nodes-bluesky).
