---
trigger: always_on
description: A Mantine-inspired component library for [gpui](https://github.com/zed-industries/zed)
---
...
---
> Source: [wess/guise](https://github.com/wess/guise) — distributed by [TomeVault](https://tomevault.io).
