---
trigger: always_on
description: - 检查 Workload 的状态（例如健康状态、网络信息等），并且上报至 Core
---
...
---
> Source: [projecteru2/white-paper](https://github.com/projecteru2/white-paper) — distributed by [TomeVault](https://tomevault.io).
