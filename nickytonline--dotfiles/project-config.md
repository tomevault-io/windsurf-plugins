---
trigger: always_on
description: - `Brewfile` lists Homebrew packages, casks, and Mac App Store apps.
---
...
- `install.sh` bootstraps a new macOS machine (installs tools and creates symlinks).
...
---
> Source: [nickytonline/dotfiles](https://github.com/nickytonline/dotfiles) — distributed by [TomeVault](https://tomevault.io).
