---
trigger: always_on
description: A curated registry of apps and tools that integrate with [OpenRouter](https://openrouter.ai). Each app has a directory in `apps/` with metadata and a logo.
---
...
---
> Source: [OpenRouterTeam/awesome-openrouter](https://github.com/OpenRouterTeam/awesome-openrouter) — distributed by [TomeVault](https://tomevault.io).
