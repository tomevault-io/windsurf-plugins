---
trigger: always_on
description: This repository contains comprehensive skills for AI coding agents, optimized for:
---
...
Skills in `skills/` directory follow the Agent Skills format. Each skill has:
