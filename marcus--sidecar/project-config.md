---
trigger: always_on
description: go install -ldflags "-X main.Version=v0.1.0" ./cmd/sidecar
---
...
---
> Source: [marcus/sidecar](https://github.com/marcus/sidecar) — distributed by [TomeVault](https://tomevault.io).
