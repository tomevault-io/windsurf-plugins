---
trigger: always_on
description: Project-specific notes for working on the Rust core in this repo.
---
...
---
> Source: [yaroslavyaroslav/llm_runner](https://github.com/yaroslavyaroslav/llm_runner) — distributed by [TomeVault](https://tomevault.io).
