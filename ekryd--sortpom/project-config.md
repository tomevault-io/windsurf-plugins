---
trigger: always_on
description: SortPom is a Maven plugin that sorts `pom.xml` files. It is a two-module Maven project:
---
...
---
> Source: [Ekryd/sortpom](https://github.com/Ekryd/sortpom) — distributed by [TomeVault](https://tomevault.io).
