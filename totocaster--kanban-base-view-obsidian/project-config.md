---
trigger: always_on
description: Study these before writing any implementation code for the Bases kanban view:
---
...
- Include human-written release notes with every release; autogenerated notes or a compare link alone are not sufficient.
- Add a concise changelog to the annotated Git tag and publish polished notes with the GitHub release.
- Summarize user-visible changes, important fixes, and any compatibility or migration requirements. Explicitly state when no migration is required.
- Include a full comparison link to the previous release and verify the published notes and required release assets after publishing.

---
> Source: [totocaster/kanban-base-view-obsidian](https://github.com/totocaster/kanban-base-view-obsidian) — distributed by [TomeVault](https://tomevault.io).
