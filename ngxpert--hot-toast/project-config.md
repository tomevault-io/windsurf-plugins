---
trigger: always_on
description: - Ignore reading files mentioned in [.gitignore](mdc:.gitignore)
---
...
---
> Source: [ngxpert/hot-toast](https://github.com/ngxpert/hot-toast) — distributed by [TomeVault](https://tomevault.io).
