---
trigger: always_on
description: You are currently working within the src/Laravel component. This environment differs from the main Symfony-based core.
---
...
---
> Source: [api-platform/laravel](https://github.com/api-platform/laravel) — distributed by [TomeVault](https://tomevault.io).
