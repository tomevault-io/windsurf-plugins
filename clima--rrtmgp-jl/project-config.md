---
trigger: always_on
description: Please refer to the shared CliMA agent index for ecosystem-wide rules regarding architecture, performance, code quality, infrastructure, and workflows:
---
...
---
> Source: [CliMA/RRTMGP.jl](https://github.com/CliMA/RRTMGP.jl) — distributed by [TomeVault](https://tomevault.io).
