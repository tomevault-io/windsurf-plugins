---
trigger: always_on
description: Enables users to select specific data items.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/artibella)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/artibella)
