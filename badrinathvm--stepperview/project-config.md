---
trigger: always_on
description: StepperView is a SwiftUI component library for displaying step indicators in vertical and horizontal orientations. It supports iOS, watchOS, tvOS, and macOS. Published via CocoaPods (v1.6.7), Swift Package Manager, and Carthage.
---
...
---
> Source: [badrinathvm/StepperView](https://github.com/badrinathvm/StepperView) — distributed by [TomeVault](https://tomevault.io).
