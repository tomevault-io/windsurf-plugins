---
trigger: always_on
description: This repository contains a Unity plugin for loading and saving Vorbis `.ogg` audio
---
...
---
> Source: [gindemit/unity-vorbis](https://github.com/gindemit/unity-vorbis) — distributed by [TomeVault](https://tomevault.io).
