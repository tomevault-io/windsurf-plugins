---
trigger: always_on
description: This section provides links to documentation from installed packages. It is automatically generated and may be updated by running `bake agent:context:install`.
---
...
---
> Source: [socketry/io-event](https://github.com/socketry/io-event) — distributed by [TomeVault](https://tomevault.io).
