---
trigger: always_on
description: Public coding rules for AI-assisted work in this repository.
---
...
---
> Source: [tt-a1i/hive](https://github.com/tt-a1i/hive) — distributed by [TomeVault](https://tomevault.io).
