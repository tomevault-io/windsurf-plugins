---
trigger: always_on
description: Personal Neovim config in Lua. Requires Neovim 0.12+.
---
...
---
> Source: [ThorstenRhau/neovim](https://github.com/ThorstenRhau/neovim) — distributed by [TomeVault](https://tomevault.io).
