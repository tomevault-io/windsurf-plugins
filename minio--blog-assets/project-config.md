---
trigger: always_on
description: You are helping a developer work with **MinIO AIStor Tables**, an enterprise
---
...
---
> Source: [minio/blog-assets](https://github.com/minio/blog-assets) — distributed by [TomeVault](https://tomevault.io).
