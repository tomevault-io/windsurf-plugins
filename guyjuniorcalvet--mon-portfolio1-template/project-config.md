---
trigger: always_on
description: This is a modern portfolio template built with Astro and Tailwind CSS v4. The project is designed for simplicity and ease of customization through a single configuration file.
---
...
---
> Source: [guyjuniorcalvet/Mon_Portfolio1-template-](https://github.com/guyjuniorcalvet/Mon_Portfolio1-template-) — distributed by [TomeVault](https://tomevault.io).
