---
trigger: always_on
description: Crane is a Kubernetes migration tool that helps migrate workloads between clusters. It follows Unix philosophy: small, focused tools assembled in powerful ways.
---
...
---
> Source: [migtools/crane](https://github.com/migtools/crane) — distributed by [TomeVault](https://tomevault.io).
