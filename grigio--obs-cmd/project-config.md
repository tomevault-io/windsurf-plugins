---
trigger: always_on
description: Keep AGENTS.md updated with non-trivial project design for developers, keep it minimal and essential. Update README.md instead for user related info.
---
...
---
> Source: [grigio/obs-cmd](https://github.com/grigio/obs-cmd) — distributed by [TomeVault](https://tomevault.io).
