---
trigger: always_on
description: - Python: project venv at `.venv/bin/python` (or system `python3`)
---
...
---
> Source: [zpol/rf-hunter](https://github.com/zpol/rf-hunter) — distributed by [TomeVault](https://tomevault.io).
