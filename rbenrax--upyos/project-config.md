---
trigger: always_on
description: upyOS is a modular flash Operating System for microcontrollers based on **MicroPython**. It provides a POSIX-like environment for microcontrollers (ESP32, ESP8266, RP2040, etc.).
---
...
---
> Source: [rbenrax/upyOS](https://github.com/rbenrax/upyOS) — distributed by [TomeVault](https://tomevault.io).
