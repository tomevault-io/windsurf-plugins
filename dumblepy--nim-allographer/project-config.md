---
trigger: always_on
description: - `.cursor/rules/project.mdc` を必ず読み、プロジェクトルールと達成目標を確認する。
---
...
---
> Source: [dumblepy/nim-allographer](https://github.com/dumblepy/nim-allographer) — distributed by [TomeVault](https://tomevault.io).
