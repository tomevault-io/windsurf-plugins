---
trigger: always_on
description: njs is a JavaScript engine integrated with NGINX. It ships as:
---
...
---
> Source: [nginx/njs](https://github.com/nginx/njs) — distributed by [TomeVault](https://tomevault.io).
