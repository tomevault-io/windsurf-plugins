---
trigger: always_on
description: Instructions for AI agents working in this repository. This file contains stable principles and quality standards. For operational details, commands, and workflows, see the [Agent Documentation Index](./.agent-docs/README.md).
---
...
---
> Source: [aws-amplify/amplify-category-api](https://github.com/aws-amplify/amplify-category-api) — distributed by [TomeVault](https://tomevault.io).
