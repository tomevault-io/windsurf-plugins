---
trigger: always_on
description: - This app uses `gt-react` for inline translations and stores generated locale files in `public/_gt`.
---
...
---
> Source: [jlgrimes/training-court](https://github.com/jlgrimes/training-court) — distributed by [TomeVault](https://tomevault.io).
