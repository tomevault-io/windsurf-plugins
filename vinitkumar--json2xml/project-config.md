---
trigger: always_on
description: - Test: `pytest -vv` (all tests) or `pytest tests/test_<name>.py -vv` (single test file)
---
...
---
> Source: [vinitkumar/json2xml](https://github.com/vinitkumar/json2xml) — distributed by [TomeVault](https://tomevault.io).
