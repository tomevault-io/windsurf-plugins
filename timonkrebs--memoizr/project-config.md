---
trigger: always_on
description: Never replace LINQ expressions with manual loops, manual index tracking, or equivalent imperative code. LINQ is idiomatic C# and is preferred in this codebase. PRs that rewrite LINQ into `for`/`foreach` loops or manual aggregations will be rejected.
---
...
---
> Source: [timonkrebs/MemoizR](https://github.com/timonkrebs/MemoizR) — distributed by [TomeVault](https://tomevault.io).
