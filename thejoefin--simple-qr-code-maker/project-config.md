---
trigger: always_on
description: - This is a WinUI 3 + MSIX-packaged desktop app. Use `dotnet msbuild`, not `dotnet build`.
---
...
---
> Source: [TheJoeFin/Simple-QR-Code-Maker](https://github.com/TheJoeFin/Simple-QR-Code-Maker) — distributed by [TomeVault](https://tomevault.io).
