---
trigger: always_on
description: dotnet build OpenTelemetry.slnx --configuration Release
---
...
---
> Source: [open-telemetry/opentelemetry-dotnet](https://github.com/open-telemetry/opentelemetry-dotnet) — distributed by [TomeVault](https://tomevault.io).
