---
trigger: always_on
description: Gradio UI package that builds every tab in the kohya_ss app and translates form inputs into `sd-scripts` CLI invocations. Owned by the root `AGENTS.md`; see it for submodule and dependency rules.
---
...
---
> Source: [bmaltais/kohya_ss](https://github.com/bmaltais/kohya_ss) — distributed by [TomeVault](https://tomevault.io).
