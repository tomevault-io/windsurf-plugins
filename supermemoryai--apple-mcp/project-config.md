---
trigger: always_on
description: - `bun run dev` - Start the development server
---
...
---
> Source: [supermemoryai/apple-mcp](https://github.com/supermemoryai/apple-mcp) — distributed by [TomeVault](https://tomevault.io).
