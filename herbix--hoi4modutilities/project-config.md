---
trigger: always_on
description: * 源代码：主要代码放在`src`目录下。webview里的代码放在`webviewsrc`目录下。本地化资源放在`i18n`目录下。
---
...
---
> Source: [herbix/hoi4modutilities](https://github.com/herbix/hoi4modutilities) — distributed by [TomeVault](https://tomevault.io).
