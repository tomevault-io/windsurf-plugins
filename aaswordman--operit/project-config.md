---
trigger: always_on
description: - 只有在用户明确要求时，才执行编译/构建/测试（例如 `./gradlew :app:compileDebugKotlin`、`npm run build`、`pnpm run build`）。
---
...
---
> Source: [AAswordman/Operit](https://github.com/AAswordman/Operit) — distributed by [TomeVault](https://tomevault.io).
