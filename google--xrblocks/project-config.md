---
trigger: always_on
description: When working in this repository, follow all guidelines in [AGENTS.md](AGENTS.md).
---
...
---
> Source: [google/xrblocks](https://github.com/google/xrblocks) — distributed by [TomeVault](https://tomevault.io).
