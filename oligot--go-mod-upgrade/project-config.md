---
trigger: always_on
description: Tooling is pinned in `mise.toml`; run tasks through mise (`mise tasks`), not bare `go`/`golangci-lint`.
---
...
---
> Source: [oligot/go-mod-upgrade](https://github.com/oligot/go-mod-upgrade) — distributed by [TomeVault](https://tomevault.io).
