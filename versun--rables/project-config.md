---
trigger: always_on
description: This file provides guidance to coding agents (Codex CLI / Claude Code / etc.) when working in this repository.
---
...
---
> Source: [versun/Rables](https://github.com/versun/Rables) — distributed by [TomeVault](https://tomevault.io).
