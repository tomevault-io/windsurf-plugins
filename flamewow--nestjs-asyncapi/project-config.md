---
trigger: always_on
description: NestJS module that auto-generates [AsyncAPI](https://www.asyncapi.com/) documentation for event-based services (WebSockets, pub/sub, microservices) using decorators — similar to `@nestjs/swagger` but for async/event-driven APIs.
---
...
---
> Source: [flamewow/nestjs-asyncapi](https://github.com/flamewow/nestjs-asyncapi) — distributed by [TomeVault](https://tomevault.io).
