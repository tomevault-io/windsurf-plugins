---
trigger: always_on
description: - owner: [Githubのオーナ名] # Github MCPを使用するのに必要。定義しないと毎回確認するようになります。
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/akzy4)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/akzy4)
