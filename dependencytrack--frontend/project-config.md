---
trigger: always_on
description: Vue 2 SPA (Vue CLI, BootstrapVue, CoreUI). Node >= 22, npm >= 10.
---
...
---
> Source: [DependencyTrack/frontend](https://github.com/DependencyTrack/frontend) — distributed by [TomeVault](https://tomevault.io).
