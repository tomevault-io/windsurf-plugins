---
trigger: always_on
description: This project is a custom node for [ComfyUI](https://github.com/comfyanonymous/ComfyUI) that generates depth maps from input images. It utilizes state-of-the-art monocular depth estimation models, specifically **Depth-Anything** (V1 and V2) and **MiDaS**.
---
...
- **Camera Integration**: Support for extracting camera extrinsics and intrinsics from DA3 models.
- **5-Tuple Output**: Node now returns `(DEPTH, CONFIDENCE, EXTRINSICS, INTRINSICS, JSON)` for maximum flexibility.
- **New Models**: Added support for DA3-Large, DA3-Giant, and DA3Nested-Giant-Large.
...
---
> Source: [Limbicnation/ComfyUIDepthEstimation](https://github.com/Limbicnation/ComfyUIDepthEstimation) — distributed by [TomeVault](https://tomevault.io).
