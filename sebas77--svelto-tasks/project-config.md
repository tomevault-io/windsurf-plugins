---
trigger: always_on
description: Read and follow `AGENTS.md` at the repository root before doing any work in this repo — it explains what Svelto.Tasks is, when to use it, how to use it correctly, and how to build/test your changes.
---
...
---
> Source: [sebas77/Svelto.Tasks](https://github.com/sebas77/Svelto.Tasks) — distributed by [TomeVault](https://tomevault.io).
