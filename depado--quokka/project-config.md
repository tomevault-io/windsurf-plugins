---
trigger: always_on
description: Quokka is a **boilerplate/template engine** CLI written in Go. It fetches a template (from git or local path), interactively prompts the user for variable values, and renders the template to an output directory.
---
...
---
> Source: [depado/quokka](https://github.com/depado/quokka) — distributed by [TomeVault](https://tomevault.io).
