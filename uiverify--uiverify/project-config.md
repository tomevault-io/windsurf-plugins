---
trigger: always_on
description: A pnpm **monorepo** of the public, client-installed packages for **UI Verify** (visual testing),
---
...
---
> Source: [uiverify/uiverify](https://github.com/uiverify/uiverify) — distributed by [TomeVault](https://tomevault.io).
