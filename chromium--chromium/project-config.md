---
trigger: always_on
description: - When modifying `json_view_builder.h` or `json_view_builder.cc` to add, change, or remove supported components, layout managers, or properties:
---
...
---
> Source: [chromium/chromium](https://github.com/chromium/chromium) — distributed by [TomeVault](https://tomevault.io).
