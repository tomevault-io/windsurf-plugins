...
Original source: `CLAUDE.md` in [shuyu-labs/WebCode](https://github.com/shuyu-labs/WebCode).
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/shuyu-labs/WebCode](https://github.com/shuyu-labs/WebCode)
