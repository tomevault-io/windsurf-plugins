---
trigger: always_on
description: OSRE (Open Source Render Engine) is an experimental C++ render engine using CMake, C++17, OpenGL, and SDL2. It includes an editor (OSRE-Ed) and various samples.
---
...
---
> Source: [kimkulling/osre](https://github.com/kimkulling/osre) — distributed by [TomeVault](https://tomevault.io).
