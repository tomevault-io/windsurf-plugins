---
trigger: always_on
description: Keep the project setup similar to [ryasmi/baseroo](https://github.com/ryasmi/baseroo).
---
...
---
> Source: [ryasmi/rulr](https://github.com/ryasmi/rulr) — distributed by [TomeVault](https://tomevault.io).
