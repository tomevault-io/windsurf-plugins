---
trigger: always_on
description: Kubernetes CSI (Container Storage Interface) driver for WekaFS, a high-performance distributed filesystem. Supports native Weka protocol and NFS transport, snapshots, encryption, dynamic/static provisioning, and observability via Prometheus metrics and OpenTelemetry tracing.
---
...
---
> Source: [weka/csi-wekafs](https://github.com/weka/csi-wekafs) — distributed by [TomeVault](https://tomevault.io).
