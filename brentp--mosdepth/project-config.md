---
trigger: always_on
description: mosdepth is a fast BAM/CRAM depth calculation tool for WGS, exome, or targeted sequencing written in Nim. It provides per-base, per-window, and per-region depth calculations about 2x faster than samtools depth.
---
...
---
> Source: [brentp/mosdepth](https://github.com/brentp/mosdepth) — distributed by [TomeVault](https://tomevault.io).
