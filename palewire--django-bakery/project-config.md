---
trigger: always_on
description: django-bakery is a Django package that renders database-backed views, feeds,
---
...
---
> Source: [palewire/django-bakery](https://github.com/palewire/django-bakery) — distributed by [TomeVault](https://tomevault.io).
