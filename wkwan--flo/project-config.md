---
trigger: always_on
description: When running an example which requires a human to visually verify the result or interact with the game, don't run with a timeout. If you can can verify the result from the logs, you can use a timeout.
---
...
---
> Source: [wkwan/flo](https://github.com/wkwan/flo) — distributed by [TomeVault](https://tomevault.io).
