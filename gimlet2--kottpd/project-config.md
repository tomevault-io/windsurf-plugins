---
trigger: always_on
description: kottpd is a REST framework written in pure Kotlin. It provides a simple API for creating HTTP and HTTPS servers with support for routing, static files, filters, and exception handling.
---
...
---
> Source: [gimlet2/kottpd](https://github.com/gimlet2/kottpd) — distributed by [TomeVault](https://tomevault.io).
