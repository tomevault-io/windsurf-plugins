---
trigger: always_on
description: This document provides context, conventions, and instructions for AI agents (and human developers) working on the `animeko-website` repository.
---
...
---
> Source: [open-ani/ani-website](https://github.com/open-ani/ani-website) — distributed by [TomeVault](https://tomevault.io).
