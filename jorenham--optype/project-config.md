---
trigger: always_on
description: This document provides GitHub Copilot with context about the optype project to help
---
...
---
> Source: [jorenham/optype](https://github.com/jorenham/optype) — distributed by [TomeVault](https://tomevault.io).
