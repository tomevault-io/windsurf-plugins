---
trigger: always_on
description: Storefront X is a modern e-commerce framework for building high-performance PWAs with SSR (server-side rendering). It is published as a monorepo of npm packages (`@magexo/*`) that other projects install and use.
---
...
---
> Source: [storefront-x/storefront-x](https://github.com/storefront-x/storefront-x) — distributed by [TomeVault](https://tomevault.io).
