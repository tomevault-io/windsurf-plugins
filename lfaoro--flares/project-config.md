---
trigger: always_on
description: **Module**: `github.com/lfaoro/flares` · **Go**: 1.26.3 · **CLI**: `urfave/cli/v3`
---
...
---
> Source: [lfaoro/flares](https://github.com/lfaoro/flares) — distributed by [TomeVault](https://tomevault.io).
