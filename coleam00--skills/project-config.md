---
trigger: always_on
description: THE CONVENTIONS FILE. `CLAUDE.md`, or `AGENTS.md` - the name follows your agent.
---

<!--
  THE CONVENTIONS FILE. `CLAUDE.md`, or `AGENTS.md` - the name follows your agent.
