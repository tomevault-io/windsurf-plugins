---
trigger: always_on
description: This repository is part of the Tether WDK (Wallet Development Kit) ecosystem. It follows strict coding conventions and tooling standards to ensure consistency, reliability, and cross-platform compatibility (Node.js and Bare runtime).
---
...
- **Domain:** Base Abstract Classes.
- **Role:** Defines the standard interfaces and base classes for all specific blockchain wallet implementations.
- **Key Classes:** `WalletManager`, `WalletAccount`, `WalletAccountReadOnly`, `Protocol`.
- **Usage:** Primarily a dependency for other `@tetherto/wdk-wallet-*` packages.

---
> Source: [tetherto/wdk-wallet](https://github.com/tetherto/wdk-wallet) — distributed by [TomeVault](https://tomevault.io).
