---
trigger: always_on
description: - Create a Python virtual environment: `python -m venv venv`
---
...
---
> Source: [SamYuan1990/i18n-agent-action](https://github.com/SamYuan1990/i18n-agent-action) — distributed by [TomeVault](https://tomevault.io).
