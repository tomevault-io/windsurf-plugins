---
trigger: always_on
description: This package is the Ease Ghost theme. In the standalone mirror repository, this tree is pushed from `TryGhost/Themes/packages/ease` by subtree sync; make durable theme-content changes in `TryGhost/Themes` unless the task is explicitly repo-level metadata or GitHub settings.
---
...
---
> Source: [TryGhost/Ease](https://github.com/TryGhost/Ease) — distributed by [TomeVault](https://tomevault.io).
