---
trigger: always_on
description: This document provides a high-level overview of the `gaio` project structure, architectural decisions, and key components to assist AI agents in understanding and modifying the codebase.
---
