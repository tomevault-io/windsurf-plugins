---
trigger: always_on
description: > Project-wide instructions for GitHub Copilot. Loaded automatically by Copilot Chat and Copilot Workspace when this file is present in `.github/`.
---
...
---
> Source: [vincenzo-afk/Medibook](https://github.com/vincenzo-afk/Medibook) — distributed by [TomeVault](https://tomevault.io).
