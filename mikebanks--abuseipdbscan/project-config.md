---
trigger: always_on
description: - Primary CLI logic lives in `AbuseIPDB.py` at the repo root; the console entrypoint is registered as `abuseipdb-scan`.
---
...
---
> Source: [mikebanks/AbuseIPdbSCAN](https://github.com/mikebanks/AbuseIPdbSCAN) — distributed by [TomeVault](https://tomevault.io).
