---
trigger: always_on
description: We use Python 3.11, so when your responses include Python code, please use Python 3.11 features and syntax.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/OlafHaag)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/OlafHaag)
