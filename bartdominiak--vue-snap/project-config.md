---
trigger: always_on
description: Vue 3 carousel library built on CSS Scroll Snap. ESM-only npm package; the compiled `dist/` is committed to the repo.
---
...
---
> Source: [bartdominiak/vue-snap](https://github.com/bartdominiak/vue-snap) — distributed by [TomeVault](https://tomevault.io).
