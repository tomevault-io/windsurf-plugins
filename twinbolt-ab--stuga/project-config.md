---
trigger: always_on
description: Stuga is a beautiful, opinionated, mobile-first Home Assistant dashboard designed for ease of use without complex configuration. It is built as a cross-platform application using React and Capacitor.
---
...
---
> Source: [twinbolt-ab/stuga](https://github.com/twinbolt-ab/stuga) — distributed by [TomeVault](https://tomevault.io).
