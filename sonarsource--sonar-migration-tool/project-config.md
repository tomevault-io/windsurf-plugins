---
trigger: always_on
description: Always use agent swarms and subagents to parallelize your work. This is a critical best practice for maximizing the efficiency and speed of your work. By leveraging multiple agents, you can significantly reduce the time it takes to complete tasks and increase overall productivity.
---
...
---
> Source: [SonarSource/sonar-migration-tool](https://github.com/SonarSource/sonar-migration-tool) — distributed by [TomeVault](https://tomevault.io).
