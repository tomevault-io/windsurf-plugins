---
trigger: always_on
description: Quick Camera is a macOS utility application that displays output from USB-based cameras on the desktop. It's primarily used for presentations where users need to show external device output to an audience. The app is available on the Mac App Store.
---
...
---
> Source: [simonguest/quick-camera](https://github.com/simonguest/quick-camera) — distributed by [TomeVault](https://tomevault.io).
