---
trigger: always_on
description: `mini_racer` is a Ruby gem with a CRuby C/C++ extension around V8 and a separate
---
...
---
> Source: [rubyjs/mini_racer](https://github.com/rubyjs/mini_racer) — distributed by [TomeVault](https://tomevault.io).
