---
trigger: always_on
description: These rules apply to **every** agent in this configuration. OpenCode loads this
---
...
---
> Source: [znlgis/my-opencode-config](https://github.com/znlgis/my-opencode-config) — distributed by [TomeVault](https://tomevault.io).
