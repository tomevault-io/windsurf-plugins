---
trigger: always_on
description: This is a C++ canister for running llama.cpp on the Internet Computer (ICP), built with icpp-pro.
---
...
---
> Source: [onicai/llama_cpp_canister](https://github.com/onicai/llama_cpp_canister) — distributed by [TomeVault](https://tomevault.io).
