---
trigger: always_on
description: All the extensions that are registered to Gardener are deployed to the garden runtime and seed clusters on which they are required (also see [extension registration documentation](registration.md)).
---
...
---
> Source: [gardener/gardener](https://github.com/gardener/gardener) — distributed by [TomeVault](https://tomevault.io).
