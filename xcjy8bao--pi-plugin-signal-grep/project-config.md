---
trigger: always_on
description: This repository is developed through pull requests, including AI-authored changes. Read this file, `docs/AI_PULL_REQUEST_GUIDE.md`, and `docs/QUALITY_GATES.md` before editing.
---
...
---
> Source: [xcjy8bao/pi-plugin-signal-grep](https://github.com/xcjy8bao/pi-plugin-signal-grep) — distributed by [TomeVault](https://tomevault.io).
