---
trigger: always_on
description: This document provides a guide for AI agents working on `chrono` (chrono-node) to quickly understand the project context, layout, testing commands, and implementation constraints.
---
...
---
> Source: [wanasit/chrono](https://github.com/wanasit/chrono) — distributed by [TomeVault](https://tomevault.io).
