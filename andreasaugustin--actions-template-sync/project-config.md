---
trigger: always_on
description: - This repository contains the `actions-template-sync` GitHub Action.
---
...
---
> Source: [AndreasAugustin/actions-template-sync](https://github.com/AndreasAugustin/actions-template-sync) — distributed by [TomeVault](https://tomevault.io).
