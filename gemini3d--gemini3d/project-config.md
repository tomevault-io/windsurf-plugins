---
trigger: always_on
description: * the `bind(C)` interface is a vital capability that couples to external programs written in C and C++.
---
...
---
> Source: [gemini3d/gemini3d](https://github.com/gemini3d/gemini3d) — distributed by [TomeVault](https://tomevault.io).
