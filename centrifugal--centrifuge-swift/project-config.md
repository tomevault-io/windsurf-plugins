---
trigger: always_on
description: Swift SDK for Centrifugo / Centrifuge. `Sources/SwiftCentrifuge` is the library;
---
...
---
> Source: [centrifugal/centrifuge-swift](https://github.com/centrifugal/centrifuge-swift) — distributed by [TomeVault](https://tomevault.io).
