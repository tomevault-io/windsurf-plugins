---
trigger: always_on
description: ENMARCHA is a modular .NET NuGet package library that accelerates .NET development with enterprise-grade utilities for AI, Semantic Kernel, data, and cloud scenarios. The AI layer is branded **ENGENIA**.
---
...
---
> Source: [Encamina/enmarcha](https://github.com/Encamina/enmarcha) — distributed by [TomeVault](https://tomevault.io).
