---
trigger: always_on
description: Official Python client for [YDB](https://ydb.tech/) — a fault-tolerant distributed SQL DBMS.
---
...
---
> Source: [ydb-platform/ydb-python-sdk](https://github.com/ydb-platform/ydb-python-sdk) — distributed by [TomeVault](https://tomevault.io).
