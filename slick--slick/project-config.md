---
trigger: always_on
description: This is Slick, a functional relational mapping (FRM) library for Scala that provides type-safe, composable database access. It's a multi-module SBT project with comprehensive testing across multiple database platforms.
---
...
---
> Source: [slick/slick](https://github.com/slick/slick) — distributed by [TomeVault](https://tomevault.io).
