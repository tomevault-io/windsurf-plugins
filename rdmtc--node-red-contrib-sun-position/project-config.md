---
trigger: always_on
description: - This repository contains Node-RED contrib nodes for sun/moon position, scheduling, and time-based logic.
---
...
---
> Source: [rdmtc/node-red-contrib-sun-position](https://github.com/rdmtc/node-red-contrib-sun-position) — distributed by [TomeVault](https://tomevault.io).
