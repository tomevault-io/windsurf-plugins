---
trigger: always_on
description: This is a Rust project that uses `xtask` for task automation.
---
...
---
> Source: [yoshuawuyts/wasm.directory](https://github.com/yoshuawuyts/wasm.directory) — distributed by [TomeVault](https://tomevault.io).
