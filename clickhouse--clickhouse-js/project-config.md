---
trigger: always_on
description: > **Audience:** This file contains guidance for AI agents contributing to the `ClickHouse/clickhouse-js` repository itself. It is **not** intended for downstream projects that depend on `@clickhouse/client` or `@clickhouse/client-web`
---
...
---
> Source: [ClickHouse/clickhouse-js](https://github.com/ClickHouse/clickhouse-js) — distributed by [TomeVault](https://tomevault.io).
