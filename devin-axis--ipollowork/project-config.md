---
trigger: always_on
description: iPolloWork helps users run agents, skills, and MCP. It is an open-source alternative to Claude Cowork/Codex as a desktop app.
---
...
---
> Source: [Devin-AXIS/iPolloWork](https://github.com/Devin-AXIS/iPolloWork) — distributed by [TomeVault](https://tomevault.io).
