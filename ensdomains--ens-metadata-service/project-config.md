---
trigger: always_on
description: Documentation intended to be read by automated agents working on this codebase.
---
...
---
> Source: [ensdomains/ens-metadata-service](https://github.com/ensdomains/ens-metadata-service) — distributed by [TomeVault](https://tomevault.io).
