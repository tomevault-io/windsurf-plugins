---
trigger: always_on
description: This repository contains an Emacs Lisp package.
---
...
---
> Source: [xiaoxinghu/doing.el](https://github.com/xiaoxinghu/doing.el) — distributed by [TomeVault](https://tomevault.io).
