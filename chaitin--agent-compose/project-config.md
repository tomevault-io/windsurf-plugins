---
trigger: always_on
description: This repo contains the agent-compose session control plane. It creates, resumes, stops, and proxies isolated notebook runtimes, and exposes agent, loader, LLM, configuration, and workspace APIs.
---
...
---
> Source: [chaitin/agent-compose](https://github.com/chaitin/agent-compose) — distributed by [TomeVault](https://tomevault.io).
