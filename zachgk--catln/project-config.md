---
trigger: always_on
description: Catln is a term-rewriting programming language. The compiler is written in Haskell (GHC 9.6.x, Stack LTS 21.25).
---
...
---
> Source: [zachgk/catln](https://github.com/zachgk/catln) — distributed by [TomeVault](https://tomevault.io).
