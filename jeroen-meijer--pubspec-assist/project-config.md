---
trigger: always_on
description: VS Code extension for adding and updating Dart/Flutter `pubspec.yaml` dependencies via [pub.dev](https://pub.dev/) — fuzzy search, comma-separated multi-package add, auto-sort, and version resolution without leaving the editor.
---
...
---
> Source: [jeroen-meijer/pubspec-assist](https://github.com/jeroen-meijer/pubspec-assist) — distributed by [TomeVault](https://tomevault.io).
