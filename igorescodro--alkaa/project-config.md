---
trigger: always_on
description: provides implementations bound via Koin. Other features depend only on API modules.
---
...
---
> Source: [igorescodro/alkaa](https://github.com/igorescodro/alkaa) — distributed by [TomeVault](https://tomevault.io).
