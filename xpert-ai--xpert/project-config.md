---
trigger: always_on
description: This repo uses NestJS + TypeORM on the server and Angular 17 (standalone, signals, new control flow) on the client. Follow these rules when extending the codebase.
---
...
---
> Source: [xpert-ai/xpert](https://github.com/xpert-ai/xpert) — distributed by [TomeVault](https://tomevault.io).
