---
trigger: always_on
description: Validates EVM smart-contract state against YAML configs. Calls view functions on deployed contracts and diffs returns against expected values.
---
...
---
> Source: [lidofinance/state-mate](https://github.com/lidofinance/state-mate) — distributed by [TomeVault](https://tomevault.io).
