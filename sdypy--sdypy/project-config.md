---
trigger: always_on
description: Guidance for anyone (human or AI) developing the **SDyPy core umbrella**. It is
---
...
---
> Source: [sdypy/sdypy](https://github.com/sdypy/sdypy) — distributed by [TomeVault](https://tomevault.io).
