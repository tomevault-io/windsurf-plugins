---
trigger: always_on
description: Instructions for AI coding agents working in this repository. This file is the source of truth. Tool-specific files (e.g. CLAUDE.md) should only import it.
---
...
---
> Source: [mongodb-js/kerberos](https://github.com/mongodb-js/kerberos) — distributed by [TomeVault](https://tomevault.io).
