---
trigger: always_on
description: These are static SVGs, hand-authored to match GitHub's Primer button styles, served at `https://install.raweb.app/buttons/<name>.svg` and embedded via `<picture>`/`<img>` in PR descriptions and docs.
---
...
---
> Source: [kimmknight/raweb](https://github.com/kimmknight/raweb) — distributed by [TomeVault](https://tomevault.io).
