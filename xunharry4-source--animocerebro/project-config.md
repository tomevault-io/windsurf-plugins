---
trigger: always_on
description: This document is available in two languages:
---
...
- **[中文版 (Chinese)](AGENTS_ZH.md)** - 完整的中文版本
- **[English Version](AGENTS_EN.md)** - Complete English version

请选择您偏好的语言版本阅读。
Please select your preferred language version to read.
...
- [Zentex 红线 / Zentex Red Lines](AGENTS_ZH.md#zentex-红线仓库红线) | [English](AGENTS_EN.md#zentex-red-lines-repository-red-lines)
- [完成判定闸门 / Completion Gate](AGENTS_ZH.md#完成判定闸门) | [English](AGENTS_EN.md#completion-gate)

---

> **Note**: The original bilingual content has been split into two separate documents for better readability and maintenance.
> 
> **注意**: 原始的双语内容已拆分为两个独立的文档，以提高可读性和可维护性。

---
> Source: [xunharry4-source/AnimoCerebro](https://github.com/xunharry4-source/AnimoCerebro) — distributed by [TomeVault](https://tomevault.io).
