---
trigger: always_on
description: This document serves as the "Source of Truth" for AI agents and humans contributing to this repository. It defines the architectural standards and the "Scromfy Way" of building ComfyUI nodes.
---
...
---
> Source: [scruffynerf/scromfyUI_Nodes](https://github.com/scruffynerf/scromfyUI_Nodes) — distributed by [TomeVault](https://tomevault.io).
