---
trigger: always_on
description: 本 SKILL 的小红书发布已从旧的 **CDP-to-真实Chrome** Python 栈（`cdp_publish.py` 等，需桌面
---
...
---
> Source: [ZJU-REAL/Easel](https://github.com/ZJU-REAL/Easel) — distributed by [TomeVault](https://tomevault.io).
