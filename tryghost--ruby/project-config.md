---
trigger: always_on
description: This package is the Ruby Ghost theme. In the standalone mirror repository, this tree is pushed from `TryGhost/Themes/packages/ruby` by subtree sync; make durable theme-content changes in `TryGhost/Themes` unless the task is explicitly repo-level metadata or GitHub settings.
---
...
---
> Source: [TryGhost/Ruby](https://github.com/TryGhost/Ruby) — distributed by [TomeVault](https://tomevault.io).
