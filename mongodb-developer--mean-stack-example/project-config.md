---
trigger: always_on
description: Use these commands from the repository root:
---
...
---
> Source: [mongodb-developer/mean-stack-example](https://github.com/mongodb-developer/mean-stack-example) — distributed by [TomeVault](https://tomevault.io).
