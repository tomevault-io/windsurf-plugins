---
trigger: always_on
description: - Use Effect's type-safe alternatives where possible:
---
...
---
> Source: [unionlabs/union](https://github.com/unionlabs/union) — distributed by [TomeVault](https://tomevault.io).
