---
trigger: always_on
description: These notes capture our lightweight process and guardrails while submitting focused pull requests against `main` for .NET 10 changes.
---
...
---
> Source: [dotnet/docs-maui](https://github.com/dotnet/docs-maui) — distributed by [TomeVault](https://tomevault.io).
