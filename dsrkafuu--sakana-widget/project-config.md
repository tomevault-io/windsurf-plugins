---
trigger: always_on
description: - **Runtime & package manager**: Bun (lockfile is `bun.lock`). Use `bun install`, not npm/yarn.
---
...
---
> Source: [dsrkafuu/sakana-widget](https://github.com/dsrkafuu/sakana-widget) — distributed by [TomeVault](https://tomevault.io).
