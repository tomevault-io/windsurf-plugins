---
trigger: always_on
description: `@adobe/spectrum-wc-core` — abstract base classes, mixins, types, and utilities shared by both 1st-gen and 2nd-gen. No rendering, no CSS, no element registration.
---
...
---
> Source: [adobe/spectrum-web-components](https://github.com/adobe/spectrum-web-components) — distributed by [TomeVault](https://tomevault.io).
