...
Original source: `AGENTS.md` in [MingGH/demo-mock-server](https://github.com/MingGH/demo-mock-server).
...
```
npx tomevault install MingGH/demo-mock-server
```
Source: [github.com/MingGH/demo-mock-server](https://github.com/MingGH/demo-mock-server).
