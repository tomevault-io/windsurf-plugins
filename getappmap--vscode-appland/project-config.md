---
trigger: always_on
description: This project is the official AppMap VS Code extension. It provides developers with runtime-aware AI to help them understand and debug their code more effectively.
---
...
---
> Source: [getappmap/vscode-appland](https://github.com/getappmap/vscode-appland) — distributed by [TomeVault](https://tomevault.io).
