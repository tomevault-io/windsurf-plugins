---
trigger: always_on
description: **ALWAYS use `uv` for Python package management** - Never use pip, pip3, or create venv manually.
---
...
---
> Source: [jbohnslav/opencv_transforms](https://github.com/jbohnslav/opencv_transforms) — distributed by [TomeVault](https://tomevault.io).
