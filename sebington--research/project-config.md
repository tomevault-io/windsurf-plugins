---
trigger: always_on
description: Start by creating a new folder for your work with an appropriate name.
---
...
---
> Source: [sebington/research](https://github.com/sebington/research) — distributed by [TomeVault](https://tomevault.io).
