---
trigger: always_on
description: provides one. Never fabricate numbers.
---

# Project rules for this job-search workspace

Claude Code reads this file automatically at the start of every session.
These rules apply to every command and every generated document.
...
- `job-analysis.md` — output of /analyze
...
- `interview-prep.md` — output of /prep
...
---
> Source: [yapsancode/job-kit](https://github.com/yapsancode/job-kit) — distributed by [TomeVault](https://tomevault.io).
