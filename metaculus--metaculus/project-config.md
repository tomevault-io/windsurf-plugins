---
trigger: always_on
description: This is a Django + Next.js monorepo. Python/Django backend lives in the root directory, Next.js frontend lives in `front_end/`.
---
...
---
> Source: [Metaculus/metaculus](https://github.com/Metaculus/metaculus) — distributed by [TomeVault](https://tomevault.io).
