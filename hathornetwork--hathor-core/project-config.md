---
trigger: always_on
description: A full-node implementation for the Hathor Network — a DAG-based cryptocurrency with nano contracts.
---
...
---
> Source: [HathorNetwork/hathor-core](https://github.com/HathorNetwork/hathor-core) — distributed by [TomeVault](https://tomevault.io).
