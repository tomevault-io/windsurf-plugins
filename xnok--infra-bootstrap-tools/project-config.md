---
trigger: always_on
description: This file tells AI coding assistants how to be productive in the infra-bootstrap-tools monorepo. Keep guidance short, actionable and always reference concrete files or commands in the repo.
---
...
1. **Capture**: Start every task by creating or updating a note in `docs/1-projects/<your-task>.md`. Use this to plan, log findings, and draft changes.
...
4. **Archive**: Once done, move the raw notes to `docs/4-archives/<your-task>.md`.
...
---
> Source: [xNok/infra-bootstrap-tools](https://github.com/xNok/infra-bootstrap-tools) — distributed by [TomeVault](https://tomevault.io).
