---
trigger: always_on
description: PG Back Web is a Go-based PostgreSQL backup management web application with these core layers:
---
...
---
> Source: [eduardolat/pgbackweb](https://github.com/eduardolat/pgbackweb) — distributed by [TomeVault](https://tomevault.io).
