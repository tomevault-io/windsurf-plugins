---
trigger: always_on
description: Airfoil Wings (from now, Wings) is a data ingestion service and framework to ingest data from any source directly into the data lakehouse.
---
...
---
> Source: [useairfoil/wings](https://github.com/useairfoil/wings) — distributed by [TomeVault](https://tomevault.io).
