---
trigger: always_on
description: * ALWAYS use Metals MCP tools to compile and run tests instead of relying on bash commands
---
...
---
> Source: [scalameta/metals](https://github.com/scalameta/metals) — distributed by [TomeVault](https://tomevault.io).
