---
trigger: always_on
description: All Django commands run **inside Docker** (`docker compose exec backend`). Use the `make` shortcuts:
---
...
---
> Source: [wilfredinni/django-starter-template](https://github.com/wilfredinni/django-starter-template) — distributed by [TomeVault](https://tomevault.io).
