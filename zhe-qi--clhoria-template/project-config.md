---
trigger: always_on
description: pnpm install/dev/build/start/typecheck/lint/lint:fix/test
---
...
---
> Source: [zhe-qi/clhoria-template](https://github.com/zhe-qi/clhoria-template) — distributed by [TomeVault](https://tomevault.io).
