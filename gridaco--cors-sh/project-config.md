---
trigger: always_on
description: Guidance for AI coding agents (and humans) working in this repo. `CLAUDE.md` is a symlink to this file.
---
...
---
> Source: [gridaco/cors.sh](https://github.com/gridaco/cors.sh) — distributed by [TomeVault](https://tomevault.io).
