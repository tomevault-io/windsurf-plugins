---
trigger: always_on
description: Bioinformatics automata toolkit for constructing, manipulating, and applying weighted finite-state transducers (WFSTs). Provides both a CLI (`boss`) and C++ library.
---
...
---
> Source: [evoldoers/machineboss](https://github.com/evoldoers/machineboss) — distributed by [TomeVault](https://tomevault.io).
