---
trigger: always_on
description: Pi extension: Codex-style `/goal` command and `get_goal` / `create_goal` / `update_goal` tools. State lives in pi session custom entries.
---
...
---
> Source: [fitchmultz/pi-codex-goal](https://github.com/fitchmultz/pi-codex-goal) — distributed by [TomeVault](https://tomevault.io).
