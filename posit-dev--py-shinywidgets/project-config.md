---
trigger: always_on
description: Handles dynamic loading of 3rd party widget JavaScript:
---
...
---
> Source: [posit-dev/py-shinywidgets](https://github.com/posit-dev/py-shinywidgets) — distributed by [TomeVault](https://tomevault.io).
