---
trigger: always_on
description: `meh` is a personal code editor written in Zig. It uses SDL2 for rendering and SDL2_ttf
---
...
---
> Source: [remeh/meh](https://github.com/remeh/meh) — distributed by [TomeVault](https://tomevault.io).
