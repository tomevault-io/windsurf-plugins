---
trigger: always_on
description: Windows向け日本語IME。MozcのUIフレームワークとAzooKeyのかな漢字変換エンジン（Zenzai AI対応）を組み合わせたハイブリッドIME。
---
...
---
> Source: [unok/myime](https://github.com/unok/myime) — distributed by [TomeVault](https://tomevault.io).
