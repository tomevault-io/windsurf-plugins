---
trigger: always_on
description: Companion to `AGENTS.md`; read that first. This file: Claude-specific facts and workflow rules.
---
...
---
> Source: [blinklabs-io/gouroboros](https://github.com/blinklabs-io/gouroboros) — distributed by [TomeVault](https://tomevault.io).
