---
trigger: always_on
description: AI-powered chat interface for Obsidian, integrating with OpenCode Server for agent orchestration and tool execution.
---
...
---
> Source: [windyboy/opencode-obsidian](https://github.com/windyboy/opencode-obsidian) — distributed by [TomeVault](https://tomevault.io).
