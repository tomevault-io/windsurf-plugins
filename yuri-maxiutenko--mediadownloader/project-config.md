---
trigger: always_on
description: WPF desktop front-end for the yt-dlp CLI (Windows, x64 only). Self-contained .NET 10, per-user WiX MSI installer.
---
...
---
> Source: [yuri-maxiutenko/MediaDownloader](https://github.com/yuri-maxiutenko/MediaDownloader) — distributed by [TomeVault](https://tomevault.io).
