---
trigger: always_on
description: SEO strategy, keywords, and optimization guidelines for gaboesquivel.com
---
...
## Cross-Content Linking Architecture

### Blog to Domain Specialization (Highest Priority)
Link domain concepts to specialization pages:
- Link "DeFi applications" → `/web3`
- Link "AI assistants" → `/ai`
- Max 1-2 domain specialization links per post

### Blog to Projects (Medium Priority)
Link specific named projects to their pages:
...
### Blog to Tech (Lower Priority)
Link specific tech mentions to dedicated tech pages:
...
## External Inbound Link Strategy
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/gaboesquivel) — claim your Tome and manage your conversions.
