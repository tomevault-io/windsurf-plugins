---
trigger: always_on
description: 本仓库的 PR 拒绝率是 94%。被拒的 PR 里几乎每一条都是没读或没遵守本指南的 agent 提交的。维护者会在数小时内关掉劣质 PR，并经常公开评论："This pull request is slop that's made of lies."（这个 PR 是一堆谎言堆出来的劣质内容。）
---
...
---
> Source: [jnMetaCode/superpowers-zh](https://github.com/jnMetaCode/superpowers-zh) — distributed by [TomeVault](https://tomevault.io).
