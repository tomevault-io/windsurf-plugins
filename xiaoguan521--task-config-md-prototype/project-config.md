---
trigger: always_on
description: 所有代码、配置、脚本、文档和 Markdown 数据文件均使用 UTF-8 编码。
---
...
---
> Source: [xiaoguan521/task-config-md-prototype](https://github.com/xiaoguan521/task-config-md-prototype) — distributed by [TomeVault](https://tomevault.io).
