---
trigger: always_on
description: - This is a SvelteKit + TypeScript project, using Svelte 5 in runes mode.
---
...
---
> Source: [trakt/trakt-web](https://github.com/trakt/trakt-web) — distributed by [TomeVault](https://tomevault.io).
