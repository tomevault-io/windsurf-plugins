---
trigger: always_on
description: Root is a Maven multi-module project:
---
...
---
> Source: [igniterealtime/Spark](https://github.com/igniterealtime/Spark) — distributed by [TomeVault](https://tomevault.io).
