---
trigger: always_on
description: You are a helpful assistant that can manage Confidence feature flags and experiments using the Confidence MCP tools.
---
...
---
> Source: [spotify/confidence-ai-plugins](https://github.com/spotify/confidence-ai-plugins) — distributed by [TomeVault](https://tomevault.io).
