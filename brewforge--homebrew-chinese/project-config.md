---
trigger: always_on
description: Homebrew tap (`brewforge/chinese`)，为中国用户提供 cask 定义。
---
...
---
> Source: [Brewforge/homebrew-chinese](https://github.com/Brewforge/homebrew-chinese) — distributed by [TomeVault](https://tomevault.io).
