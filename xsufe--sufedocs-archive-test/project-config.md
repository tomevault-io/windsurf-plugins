---
trigger: always_on
description: When reviewing pull requests that add or modify metadata files in this repository, you must:
---
...
- Books: `# yaml-language-server: $schema=https://docs.xsufe.com/schema/book.yaml`
- Tests: `# yaml-language-server: $schema=https://docs.xsufe.com/schema/test.yaml`
- Documents: `# yaml-language-server: $schema=https://docs.xsufe.com/schema/doc.yaml`
...
- `url`: SUFEDocs URL (format: https://docs.xsufe.com/files/{md5}.pdf)
...
---
> Source: [XSUFE/sufedocs-archive-test](https://github.com/XSUFE/sufedocs-archive-test) — distributed by [TomeVault](https://tomevault.io).
