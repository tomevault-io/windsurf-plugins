---
trigger: always_on
description: - `nbs/` is the source of truth. This is an nbdev project: edit notebooks here before regenerating Python modules.
---
...
---
> Source: [kurianbenoy/whisper_normalizer](https://github.com/kurianbenoy/whisper_normalizer) — distributed by [TomeVault](https://tomevault.io).
