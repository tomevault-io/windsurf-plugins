---
trigger: always_on
description: > **Important:** Use only `yarn` for all dependency and script management. Do not use `npm`.
---
...
---
> Source: [cardano-foundation/cardano-org](https://github.com/cardano-foundation/cardano-org) — distributed by [TomeVault](https://tomevault.io).
