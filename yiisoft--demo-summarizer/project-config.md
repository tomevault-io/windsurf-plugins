---
trigger: always_on
description: - Run project commands through the Makefile so they execute in the configured Docker environment.
---
...
- Do not add Ollama integration. Local LLM integration uses an OpenAI-compatible adapter, with `llama.cpp` as the Docker single-binary option.

---
> Source: [yiisoft/demo-summarizer](https://github.com/yiisoft/demo-summarizer) — distributed by [TomeVault](https://tomevault.io).
