---
trigger: always_on
description: This project is a **Gemini CLI OpenAI Worker** that transforms Google's Gemini models into OpenAI-compatible endpoints using Cloudflare Workers. It provides OAuth2 authentication and real thinking capabilities for Gemini models.
---
