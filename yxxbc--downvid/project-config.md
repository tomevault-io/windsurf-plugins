---
trigger: always_on
description: pnpm download-deps          # 首次运行必须：下载 yt-dlp + ffmpeg 到 bin/<platform>/<arch>/
---
...
---
> Source: [yxxbc/downvid](https://github.com/yxxbc/downvid) — distributed by [TomeVault](https://tomevault.io).
