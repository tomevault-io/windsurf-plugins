---
trigger: always_on
description: To run only the tests for the main NullAway module, run `./gradlew :nullaway:test`. Run _only_ these tests unless you
---
...
---
> Source: [uber/NullAway](https://github.com/uber/NullAway) — distributed by [TomeVault](https://tomevault.io).
