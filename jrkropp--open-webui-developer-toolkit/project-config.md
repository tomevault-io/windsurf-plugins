---
trigger: always_on
description: This Agents.md file provides comprehensive guidance for OpenAI Codex and other AI agents working with this codebase.  This repository provides **extensions (pipes, filters, tools)** for the
---
