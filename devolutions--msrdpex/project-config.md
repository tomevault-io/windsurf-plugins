---
trigger: always_on
description: This file contains repo-specific guidance for *any* AI agent (Copilot, Claude, Cursor, etc.) working in this repository.
---
...
---
> Source: [Devolutions/MsRdpEx](https://github.com/Devolutions/MsRdpEx) — distributed by [TomeVault](https://tomevault.io).
