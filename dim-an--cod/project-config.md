---
trigger: always_on
description: **Cod** is a completion daemon for **bash**, **fish**, and **zsh**. It watches for `--help` usage, parses the output, and generates shell completions. Data: `$XDG_DATA_HOME/cod`, config: `$XDG_CONFIG_HOME/cod/config.toml`.
---
...
---
> Source: [dim-an/cod](https://github.com/dim-an/cod) — distributed by [TomeVault](https://tomevault.io).
