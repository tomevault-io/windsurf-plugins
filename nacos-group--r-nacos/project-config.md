---
trigger: always_on
description: - 测试：`python3 integration_tests/scripts/run_test.py` (运行完整集成测试)
---
...
---
> Source: [nacos-group/r-nacos](https://github.com/nacos-group/r-nacos) — distributed by [TomeVault](https://tomevault.io).
