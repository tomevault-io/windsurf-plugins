---
trigger: always_on
description: Dafthunk is a visual workflow automation platform built on Cloudflare infrastructure (Workers, D1, R2, AI). Users create workflows by connecting 50+ node types in a visual editor (React Flow).
---
...
---
> Source: [dafthunk-com/dafthunk](https://github.com/dafthunk-com/dafthunk) — distributed by [TomeVault](https://tomevault.io).
