---
trigger: always_on
description: Single-binary Go service: HTTP/TLS/QUIC server that returns the client's IP, geolocation, ASN, headers, TCP port scan, and DNS discovery. Uses [gin](https://github.com/gin-gonic/gin) + [httprouter](https://github.com/julienschmidt/httprouter). Requires Go >= 1.25.
---
...
---
> Source: [dcarrillo/whatismyip](https://github.com/dcarrillo/whatismyip) — distributed by [TomeVault](https://tomevault.io).
