---
trigger: always_on
description: - Core: `generate.go`, `types.go`, `inline_refs.go`, `genstate.go`.
---
...
---
> Source: [goadesign/plugins](https://github.com/goadesign/plugins) — distributed by [TomeVault](https://tomevault.io).
