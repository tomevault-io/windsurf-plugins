---
trigger: always_on
description: For full project architecture, commands, and conventions, see [AGENTS.md](../AGENTS.md).
---
...
---
> Source: [ReactiveX/rxdart](https://github.com/ReactiveX/rxdart) — distributed by [TomeVault](https://tomevault.io).
