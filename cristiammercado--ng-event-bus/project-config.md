---
trigger: always_on
description: This repository is an Angular workspace for the public `ng-event-bus` npm
---
...
---
> Source: [cristiammercado/ng-event-bus](https://github.com/cristiammercado/ng-event-bus) — distributed by [TomeVault](https://tomevault.io).
