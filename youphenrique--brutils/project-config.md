---
trigger: always_on
description: `brutils` is a TypeScript monorepo of utilities for Brazilian business rules and data validation. The published package is `@brutils/core` (in `packages/core/`), which currently covers CPF, CNPJ, and Brazilian states (UFs).
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/youphenrique)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/youphenrique)
