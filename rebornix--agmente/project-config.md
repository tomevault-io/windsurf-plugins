---
trigger: always_on
description: This file is the entrypoint for cloud/Claude coding agents. Use it with `Agents.md`.
---
...
---
> Source: [rebornix/Agmente](https://github.com/rebornix/Agmente) — distributed by [TomeVault](https://tomevault.io).
