---
trigger: always_on
description: Logflare is a real-time log aggregation platform built with Elixir/Phoenix. The codebase follows Phoenix context patterns with domain-driven design.
---
...
---
> Source: [Logflare/logflare](https://github.com/Logflare/logflare) — distributed by [TomeVault](https://tomevault.io).
