---
trigger: always_on
description: Development principles for working in this repo. User-facing documentation lives in [`docs/`](../docs/).
---
...
---
> Source: [dfinity/certified-assets](https://github.com/dfinity/certified-assets) — distributed by [TomeVault](https://tomevault.io).
