...
Original source: `CLAUDE.md` in [IJONIS/geo-lint](https://github.com/IJONIS/geo-lint).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/IJONIS/geo-lint](https://github.com/IJONIS/geo-lint)
