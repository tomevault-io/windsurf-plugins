---
trigger: always_on
description: A skill (pure markdown, no runtime) that strips AI-generated patterns from text, code, and academic writing. Works with Claude Code, Codex CLI, Cursor, and 40+ other coding agents via the Skills CLI.
---
...
---
> Source: [gabelul/slopbuster](https://github.com/gabelul/slopbuster) — distributed by [TomeVault](https://tomevault.io).
