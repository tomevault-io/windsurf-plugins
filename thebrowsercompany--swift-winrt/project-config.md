---
trigger: always_on
description: - This project is a code generator which generates swift code, but the codebase is written in C++. The code for the code generator is in the `swiftwinrt` subdirectory
---
...
---
> Source: [thebrowsercompany/swift-winrt](https://github.com/thebrowsercompany/swift-winrt) — distributed by [TomeVault](https://tomevault.io).
