...
---
> Source: [Azure/terraform-azurerm-avm-res-storage-storageaccount](https://github.com/Azure/terraform-azurerm-avm-res-storage-storageaccount) — distributed by [TomeVault](https://tomevault.io).
