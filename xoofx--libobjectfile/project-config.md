---
trigger: always_on
description: LibObjectFile is a .NET library to read, manipulate and write linker and executable object files (e.g ELF, ar, DWARF, PE...).
---

# LibObjectFile — Codex Agent Instructions
...
- Library: `src/LibObjectFile/`
- Benchmarks: `src/LibObjectFile.Bench/`
- CodeGen: `src/LibObjectFile.CodeGen/` (Native header to C# codegen))
- Tests: `src/LibObjectFile.Tests/` (MSTest)
...
---
> Source: [xoofx/LibObjectFile](https://github.com/xoofx/LibObjectFile) — distributed by [TomeVault](https://tomevault.io).
