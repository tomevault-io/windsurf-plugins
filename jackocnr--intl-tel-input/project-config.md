...
When making changes in the component directories (angular/, react/, svelte/ and vue/), note that the "withUtils" files are auto-generated, so do not update them. For example, when making changes to react/src/IntlTelInput.tsx, do not update react/src/IntlTelInputWithUtils.tsx, as it is auto-generated. The same applies to the other component directories.

---
> Source: [jackocnr/intl-tel-input](https://github.com/jackocnr/intl-tel-input) — distributed by [TomeVault](https://tomevault.io).
