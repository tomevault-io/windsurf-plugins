---
trigger: always_on
description: Start with `docs/high_level.md`. It defines shared repo rules and the runtime core vs model executor boundary.
---
...
---
> Source: [wxing1292/psi-dec](https://github.com/wxing1292/psi-dec) — distributed by [TomeVault](https://tomevault.io).
