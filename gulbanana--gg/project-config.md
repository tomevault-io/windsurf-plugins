---
trigger: always_on
description: GG is a GUI for Jujutsu (jj) version control. It's a Tauri desktop app with Svelte/TypeScript frontend (`app/`) and Rust backend (`src/`). Two launch modes: native GUI (`gg gui`) and browser-based web mode (`gg web`).
---
...
---
> Source: [gulbanana/gg](https://github.com/gulbanana/gg) — distributed by [TomeVault](https://tomevault.io).
