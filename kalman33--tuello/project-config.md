---
trigger: always_on
description: Ce fichier fournit des instructions à Claude Code (claude.ai/code) pour travailler avec le code de ce dépôt.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/kalman33)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/kalman33)
