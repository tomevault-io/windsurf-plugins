---
trigger: always_on
description: Compatibility entrypoint for agent tools. The authoritative spec lives under `.spec/`; this file only points, it defines no rules of its own.
---
...
---
> Source: [LumioGames/LumioGame](https://github.com/LumioGames/LumioGame) — distributed by [TomeVault](https://tomevault.io).
