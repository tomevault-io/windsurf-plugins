---
trigger: always_on
description: Eigen is Artsy's mobile app — a bare React Native application that uses the Expo sdk, available on both iOS and Android, that powers the [Artsy](https://www.artsy.net) marketplace for discovering and collecting art.
---
...
---
> Source: [artsy/eigen](https://github.com/artsy/eigen) — distributed by [TomeVault](https://tomevault.io).
