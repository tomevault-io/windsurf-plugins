---
trigger: always_on
description: This file provides guidance to [Gemini CLI](https://github.com/google-gemini/gemini-cli)) when working with code in this repository.
---
...
---
> Source: [centminmod/claude-code-devcontainers](https://github.com/centminmod/claude-code-devcontainers) — distributed by [TomeVault](https://tomevault.io).
