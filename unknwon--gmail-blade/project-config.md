---
trigger: always_on
description: - When you see changes made outside your knowledge, use the current version as your new starting point. Do not blindly overwrite those changes or you sucks. Even if you have to update the code, please god damn respect the pattern, order, whatever!
---
...
---
> Source: [unknwon/gmail-blade](https://github.com/unknwon/gmail-blade) — distributed by [TomeVault](https://tomevault.io).
