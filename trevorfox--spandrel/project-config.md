---
trigger: always_on
description: A spec with a reference implementation. Spandrel turns markdown file trees into governed knowledge graphs served via REST and MCP, with all wire surfaces gated by a single access policy.
---
...
---
> Source: [trevorfox/spandrel](https://github.com/trevorfox/spandrel) — distributed by [TomeVault](https://tomevault.io).
