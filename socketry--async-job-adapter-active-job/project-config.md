---
trigger: always_on
description: When working on this project, consult the `agents.md` file for project-specific guidelines, architecture decisions, and development patterns. This file contains curated information that will help you make better decisions aligned with the project's goals and standards.
---
...
---
> Source: [socketry/async-job-adapter-active_job](https://github.com/socketry/async-job-adapter-active_job) — distributed by [TomeVault](https://tomevault.io).
