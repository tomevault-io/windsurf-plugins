---
trigger: always_on
description: `AGENTS.md` is the canonical repository-wide AI guidance file. `CLAUDE.md` is a symlink to this file so Claude Code and other agents read the same instructions without duplication.
---
