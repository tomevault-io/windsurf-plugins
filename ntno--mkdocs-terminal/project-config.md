---
trigger: always_on
description: You should always follow the best practices outlined in this document.  If there is a valid reason why you cannot follow one of these practices, you should inform the user and document the reason.
---
...
---
> Source: [ntno/mkdocs-terminal](https://github.com/ntno/mkdocs-terminal) — distributed by [TomeVault](https://tomevault.io).
