---
trigger: always_on
description: Coraza is a Web Application Firewall (WAF) engine written in Go that implements Seclang directives and it is compatible with OWASP CRS. It provides protection against common web application attacks.
---
...
---
> Source: [corazawaf/coraza](https://github.com/corazawaf/coraza) — distributed by [TomeVault](https://tomevault.io).
