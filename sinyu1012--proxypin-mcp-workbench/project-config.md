---
trigger: always_on
description: - `proxypin` is a Flutter app with an in-process HTTP(S) proxy core; UI and proxy run in the same app process (`lib/main.dart`, `lib/network/bin/server.dart`).
---
...
---
> Source: [sinyu1012/proxypin-mcp-workbench](https://github.com/sinyu1012/proxypin-mcp-workbench) — distributed by [TomeVault](https://tomevault.io).
