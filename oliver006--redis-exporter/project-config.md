---
trigger: always_on
description: Prometheus exporter for Redis, Sentinel, Cluster, Dragonfly, Valkey, and Tile38. Written in Go using `gomodule/redigo` for Redis and `prometheus/client_golang` for metrics.
---
...
---
> Source: [oliver006/redis_exporter](https://github.com/oliver006/redis_exporter) — distributed by [TomeVault](https://tomevault.io).
