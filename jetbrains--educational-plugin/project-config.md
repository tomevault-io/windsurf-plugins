---
trigger: always_on
description: - `edu-format` — shared module with course format: course/lesson/task classes, YAML/JSON/XML serialization, etc.
---
...
---
> Source: [JetBrains/educational-plugin](https://github.com/JetBrains/educational-plugin) — distributed by [TomeVault](https://tomevault.io).
