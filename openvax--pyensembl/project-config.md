---
trigger: always_on
description: 1. **Never commit to `main`.** Always `git checkout -b <feature-branch>` before editing. Land via PR.
---
...
---
> Source: [openvax/pyensembl](https://github.com/openvax/pyensembl) — distributed by [TomeVault](https://tomevault.io).
