---
trigger: always_on
description: This file provides repo-specific guidance for coding agents working in `OneWare`.
---
...
---
> Source: [one-ware/OneWare](https://github.com/one-ware/OneWare) — distributed by [TomeVault](https://tomevault.io).
