---
trigger: always_on
description: This file provides guidance to code agents when working in this repository.
---
...
---
> Source: [near/mpc](https://github.com/near/mpc) — distributed by [TomeVault](https://tomevault.io).
