---
trigger: always_on
description: Go implementation of Model Context Protocol (MCP) server providing Claude with access to local markdown documentation from multiple sources.
---
...
---
> Source: [umputun/local-docs-mcp](https://github.com/umputun/local-docs-mcp) — distributed by [TomeVault](https://tomevault.io).
