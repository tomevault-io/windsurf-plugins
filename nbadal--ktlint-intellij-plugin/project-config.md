---
trigger: always_on
description: You are an expert AI programmer.
---
...
---
> Source: [nbadal/ktlint-intellij-plugin](https://github.com/nbadal/ktlint-intellij-plugin) — distributed by [TomeVault](https://tomevault.io).
