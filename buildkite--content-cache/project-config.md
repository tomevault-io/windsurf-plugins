---
trigger: always_on
description: ./content-cache -address :8080 -storage ./cache -log-level debug
---
...
---
> Source: [buildkite/content-cache](https://github.com/buildkite/content-cache) — distributed by [TomeVault](https://tomevault.io).
