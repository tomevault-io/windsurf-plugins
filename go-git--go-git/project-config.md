---
trigger: always_on
description: When reviewing pull requests in this repository, focus on correctness, maintainability, test quality, and compatibility with upstream Git behavior.
---
...
---
> Source: [go-git/go-git](https://github.com/go-git/go-git) — distributed by [TomeVault](https://tomevault.io).
