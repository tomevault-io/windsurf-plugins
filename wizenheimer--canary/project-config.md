---
trigger: always_on
description: This file is the entry point for AI agents (and humans new to the repo).
---
...
---
> Source: [wizenheimer/canary](https://github.com/wizenheimer/canary) — distributed by [TomeVault](https://tomevault.io).
