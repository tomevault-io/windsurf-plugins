---
trigger: always_on
description: Guidance for AI coding agents **and** human contributors. The goal: extend the
---
...
---
> Source: [UmmahLibrary/ummah-library](https://github.com/UmmahLibrary/ummah-library) — distributed by [TomeVault](https://tomevault.io).
