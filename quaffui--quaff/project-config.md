---
trigger: always_on
description: - Keep changes small and component-local. Do not stage unrelated work such as experimental components unless the task explicitly asks for it.
---
...
---
> Source: [quaffui/quaff](https://github.com/quaffui/quaff) — distributed by [TomeVault](https://tomevault.io).
