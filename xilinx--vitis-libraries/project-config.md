---
trigger: always_on
description: - This is an AMD/Xilinx DSP library for AIE (AI Engine) architecture
---
...
---
> Source: [Xilinx/Vitis_Libraries](https://github.com/Xilinx/Vitis_Libraries) — distributed by [TomeVault](https://tomevault.io).
