---
trigger: always_on
description: This repository is a monorepo for the Dile Components library. It contains multiple packages under the `packages/` directory, each focused on a different area of the component ecosystem.
---
...
---
> Source: [Polydile/dile-components](https://github.com/Polydile/dile-components) — distributed by [TomeVault](https://tomevault.io).
