---
trigger: always_on
description: - **Build in debug mode:** `make build` or `mush build`
---
...
---
> Source: [javanile/mush](https://github.com/javanile/mush) — distributed by [TomeVault](https://tomevault.io).
