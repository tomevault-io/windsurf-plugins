---
trigger: always_on
description: A wrapper application that automatically upgrades Java applications by polling ConfigService for new versions, downloading updates, and managing the application lifecycle. Supports both Linux and Windows deployments with proxy support and TLS configuration.
---
...
---
> Source: [Cantara/Java-Auto-Update](https://github.com/Cantara/Java-Auto-Update) — distributed by [TomeVault](https://tomevault.io).
