---
trigger: always_on
description: - **mini-signals** is a fast, minimal, type-safe event/messaging system for TypeScript/JavaScript, inspired by [js-signals](https://github.com/millermedeiros/js-signals) and [EventEmitter3](https://github.com/primus/eventemitter3).
---
...
---
> Source: [Hypercubed/mini-signals](https://github.com/Hypercubed/mini-signals) — distributed by [TomeVault](https://tomevault.io).
