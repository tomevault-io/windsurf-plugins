---
trigger: always_on
description: - **Dock/panel changes require a spec trace.** `src/viser/client/src/dock/dock-ux-spec.md` (it lives next to the code it governs) is
---
...
---
> Source: [viser-project/viser](https://github.com/viser-project/viser) — distributed by [TomeVault](https://tomevault.io).
