---
trigger: always_on
description: ***CRITICAL*** **ALWAYS** unset `NODE_ENV` environment variable when working in this project. See https://github.com/github/copilot-cli/issues/151
---
...
---
> Source: [Eps-Acoustic-Revolution-Lab/DUO_TOK](https://github.com/Eps-Acoustic-Revolution-Lab/DUO_TOK) — distributed by [TomeVault](https://tomevault.io).
