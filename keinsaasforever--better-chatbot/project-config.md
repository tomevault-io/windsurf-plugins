---
trigger: always_on
description: - App code lives in `src`.
---
...
---
> Source: [keinsaasforever/better-chatbot](https://github.com/keinsaasforever/better-chatbot) — distributed by [TomeVault](https://tomevault.io).
