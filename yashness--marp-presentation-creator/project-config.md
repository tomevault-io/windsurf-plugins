---
trigger: always_on
description: - `todo.md` must never be deleted; they must be corrected and updated.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/yashness) — claim your Tome and manage your conversions.
