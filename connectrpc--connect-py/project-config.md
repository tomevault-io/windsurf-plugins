---
trigger: always_on
description: This file provides guidance to agentic coding assistants like Claude Code (claude.ai/code) when
---
...
---
> Source: [connectrpc/connect-py](https://github.com/connectrpc/connect-py) — distributed by [TomeVault](https://tomevault.io).
