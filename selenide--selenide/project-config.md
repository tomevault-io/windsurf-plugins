...
Selenide is a Java framework providing a concise fluent API for Selenium WebDriver. It simplifies writing browser-based automated tests. Current version: 7.17.0, requires Java 17+.
...
---
> Source: [selenide/selenide](https://github.com/selenide/selenide) — distributed by [TomeVault](https://tomevault.io).
