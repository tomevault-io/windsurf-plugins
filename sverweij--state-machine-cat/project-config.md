---
trigger: always_on
description: These instructions guide GitHub Copilot on how to generate and modify code for the `state-machine-cat` project.
---
...
---
> Source: [sverweij/state-machine-cat](https://github.com/sverweij/state-machine-cat) — distributed by [TomeVault](https://tomevault.io).
