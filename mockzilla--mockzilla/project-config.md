---
trigger: always_on
description: - Go version is specified in `go.mod`
---
...
---
> Source: [mockzilla/mockzilla](https://github.com/mockzilla/mockzilla) — distributed by [TomeVault](https://tomevault.io).
