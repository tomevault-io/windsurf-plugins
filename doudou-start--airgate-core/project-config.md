---
trigger: always_on
description: > 叠加于根 `../CLAUDE.md`。开发前先读「生态边界」「🚫 红线」。
---
...
---
> Source: [DouDOU-start/airgate-core](https://github.com/DouDOU-start/airgate-core) — distributed by [TomeVault](https://tomevault.io).
