---
trigger: always_on
description: This file documents conventions for AI coding assistants (Claude Code,
---
...
---
> Source: [yfedoseev/browser_oxide](https://github.com/yfedoseev/browser_oxide) — distributed by [TomeVault](https://tomevault.io).
