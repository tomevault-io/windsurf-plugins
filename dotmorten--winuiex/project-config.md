---
trigger: always_on
description: This repo is a Windows-only .NET / WinUI 3 solution. The main solution file is `src\WinUIExtensions.sln`.
---
...
---
> Source: [dotMorten/WinUIEx](https://github.com/dotMorten/WinUIEx) — distributed by [TomeVault](https://tomevault.io).
