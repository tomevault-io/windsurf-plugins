---
trigger: always_on
description: This document outlines the developer contracts, build commands, test instructions, and event schema definitions for **Context-GC**.
---
...
---
> Source: [athishio/context-gc](https://github.com/athishio/context-gc) — distributed by [TomeVault](https://tomevault.io).
