---
trigger: always_on
description: - fetch latest changes: `git fetch origin | cat`
---
...
---
> Source: [rknell/dart_queue](https://github.com/rknell/dart_queue) — distributed by [TomeVault](https://tomevault.io).
