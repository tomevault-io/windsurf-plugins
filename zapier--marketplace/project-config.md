---
trigger: always_on
description: Canonical guide for AI agents (and humans) working in `zapier/marketplace`. `CLAUDE.md` is a one-line shim that points here.
---
...
---
> Source: [zapier/marketplace](https://github.com/zapier/marketplace) — distributed by [TomeVault](https://tomevault.io).
