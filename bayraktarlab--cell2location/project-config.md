---
trigger: always_on
description: cell2location is a Bayesian model for spatial transcriptomics that estimates cell type abundances in spatial data by integrating single-cell RNA-seq reference signatures. It is built on top of scvi-tools and Pyro.
---
...
---
> Source: [BayraktarLab/cell2location](https://github.com/BayraktarLab/cell2location) — distributed by [TomeVault](https://tomevault.io).
