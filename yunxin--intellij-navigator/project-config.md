---
trigger: always_on
description: Requires JDK 17+. Use PyCharm's bundled JDK:
---
...
---
> Source: [yunxin/intellij-navigator](https://github.com/yunxin/intellij-navigator) — distributed by [TomeVault](https://tomevault.io).
