---
trigger: always_on
description: **Always squash and merge pull requests that target `development`.** Never use a
---
...
---
> Source: [dataplat/dbatools](https://github.com/dataplat/dbatools) — distributed by [TomeVault](https://tomevault.io).
