---
trigger: always_on
description: This file provides instructions for contributing to the `goals` repository.  It is intended to be self-contained: everything needed to work effectively in this repository is documented here or cited with a precise path.
---
...
---
> Source: [rust-lang/goals](https://github.com/rust-lang/goals) — distributed by [TomeVault](https://tomevault.io).
