---
trigger: always_on
description: Flutter plugin providing periodic background-fetch callbacks for iOS and Android, including Android headless (post-termination) execution.
---
...
---
> Source: [transistorsoft/flutter_background_fetch](https://github.com/transistorsoft/flutter_background_fetch) — distributed by [TomeVault](https://tomevault.io).
