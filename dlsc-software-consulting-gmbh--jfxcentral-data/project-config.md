---
trigger: always_on
description: Content/data repository for [jfx-central.com](https://www.jfx-central.com), a community hub for the JavaFX ecosystem. It stores structured data (JSON + Markdown + images) for libraries, people, tools, books, news, tutorials, blogs, videos, and more. A Maven-based Java project loads and validates all data via unit tests.
---
...
---
> Source: [dlsc-software-consulting-gmbh/jfxcentral-data](https://github.com/dlsc-software-consulting-gmbh/jfxcentral-data) — distributed by [TomeVault](https://tomevault.io).
