---
trigger: always_on
description: This document provides an overview of the `blackpiratex.com` project for the Gemini agent.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/blackpiratelive)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/blackpiratelive)
