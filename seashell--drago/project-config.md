---
trigger: always_on
description: The `agent` command is likely Drago's most important command. It is used to start client and/or server agent.
---
...
---
> Source: [seashell/drago](https://github.com/seashell/drago) — distributed by [TomeVault](https://tomevault.io).
