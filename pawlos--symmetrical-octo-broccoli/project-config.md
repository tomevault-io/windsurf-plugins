...
| `OCTO_RESOLVE_NATIVE` | `true`/`false` — resolve native frame addresses to function names via DbgHelp (default `false`) |
...
---
> Source: [pawlos/symmetrical-octo-broccoli](https://github.com/pawlos/symmetrical-octo-broccoli) — distributed by [TomeVault](https://tomevault.io).
