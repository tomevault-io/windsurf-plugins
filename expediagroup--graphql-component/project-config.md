---
trigger: always_on
description: - Pass via constructor `dataSources` option
---
...
---
> Source: [ExpediaGroup/graphql-component](https://github.com/ExpediaGroup/graphql-component) — distributed by [TomeVault](https://tomevault.io).
