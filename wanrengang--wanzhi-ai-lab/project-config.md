---
trigger: always_on
description: > 本文档面向 AI 代理和协作者，说明如何在万智创界 AI 实验室知识库中创建和编辑内容。
---
...
---
> Source: [wanrengang/wanzhi-ai-lab](https://github.com/wanrengang/wanzhi-ai-lab) — distributed by [TomeVault](https://tomevault.io).
