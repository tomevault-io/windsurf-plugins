---
trigger: always_on
description: Stick to the prompts and context being provided. Don't jump ahead to doing steps.
---
...
---
> Source: [skills/create-applications-with-the-copilot-cli](https://github.com/skills/create-applications-with-the-copilot-cli) — distributed by [TomeVault](https://tomevault.io).
