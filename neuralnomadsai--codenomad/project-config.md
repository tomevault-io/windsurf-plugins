---
trigger: always_on
description: - Reuse the existing token & utility layers before introducing new CSS variables or custom properties. Extend `src/styles/tokens.css` / `src/styles/utilities.css` if a shared pattern is needed.
---
...
---
> Source: [NeuralNomadsAI/CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad) — distributed by [TomeVault](https://tomevault.io).
