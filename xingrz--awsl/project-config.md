---
trigger: always_on
description: A Tampermonkey userscript that enhances Weibo (weibo.com) with quick-forward buttons, user remark display, auto dark mode, and more.
---
...
---
> Source: [xingrz/awsl](https://github.com/xingrz/awsl) — distributed by [TomeVault](https://tomevault.io).
