---
trigger: always_on
description: Operating notes for coding agents working in `contentful.rb`, the Ruby client for
---
...
---
> Source: [contentful/contentful.rb](https://github.com/contentful/contentful.rb) — distributed by [TomeVault](https://tomevault.io).
