---
trigger: always_on
description: `pax.BlazorChartJs` is a .NET/Blazor Razor class library that wraps Chart.js 4.x through Blazor JavaScript isolation. The package targets `net10.0` and exposes typed C# chart configuration models plus a reusable `ChartComponent` for rendering charts in Blazor applications.
---
...
---
> Source: [ipax77/pax.BlazorChartJs](https://github.com/ipax77/pax.BlazorChartJs) — distributed by [TomeVault](https://tomevault.io).
