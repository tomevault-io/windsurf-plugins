...
Original source: `CLAUDE.md` in [watzon/pindrop](https://github.com/watzon/pindrop).
...
```
npx tomevault install watzon/pindrop
```
Source: [github.com/watzon/pindrop](https://github.com/watzon/pindrop).
