---
trigger: always_on
description: This is the **Lua Neovim client** for the easy-dotnet plugin. It is intentionally dumb. Its only responsibilities are:
---
...
---
> Source: [GustavEikaas/easy-dotnet.nvim](https://github.com/GustavEikaas/easy-dotnet.nvim) — distributed by [TomeVault](https://tomevault.io).
