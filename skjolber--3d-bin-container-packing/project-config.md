---
trigger: always_on
description: Generated Spring server-side interface stubs for the Pack REST API. Provides `PackApi` (and related interfaces) ready to be implemented by a Spring Boot `@RestController`.
---
