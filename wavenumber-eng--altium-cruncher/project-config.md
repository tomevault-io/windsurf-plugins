---
trigger: always_on
description: This repository owns the standalone public `altium-cruncher` Python package and
---
...
---
> Source: [wavenumber-eng/altium_cruncher](https://github.com/wavenumber-eng/altium_cruncher) — distributed by [TomeVault](https://tomevault.io).
