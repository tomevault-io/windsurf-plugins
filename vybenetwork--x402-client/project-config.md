---
trigger: always_on
description: > Machine-readable instructions for AI agents to make pay-per-call requests to Vybe's Solana analytics API via the x402 protocol.
---
...
---
> Source: [vybenetwork/x402-client](https://github.com/vybenetwork/x402-client) — distributed by [TomeVault](https://tomevault.io).
