---
trigger: always_on
description: These instructions guide GitHub Copilot inside **VSCode** when assisting with Flutter and Dart development.
---
...
---
> Source: [TesteurManiak/flutter_manga_reader](https://github.com/TesteurManiak/flutter_manga_reader) — distributed by [TomeVault](https://tomevault.io).
