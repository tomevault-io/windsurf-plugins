---
trigger: always_on
description: Obsidian plugin that searches Quran ayahs/surahs and inserts formatted text into the active editor.
---
...
---
> Source: [AmmarCodes/obsidian-quran-helper-plugin](https://github.com/AmmarCodes/obsidian-quran-helper-plugin) — distributed by [TomeVault](https://tomevault.io).
