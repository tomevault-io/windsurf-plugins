---
trigger: always_on
description: - This repo combines the high-level Python bindings in `python/egglog/`, the Rust extension in `src/`, and the Sphinx docs in `docs/`.
---
...
---
> Source: [egraphs-good/egglog-python](https://github.com/egraphs-good/egglog-python) — distributed by [TomeVault](https://tomevault.io).
