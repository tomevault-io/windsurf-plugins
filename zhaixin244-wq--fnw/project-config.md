---
trigger: always_on
description: > 本项目为芯片架构设计工作区，使用 AI Agent 辅助完成从需求探索到 RTL 实现的全流程。
---
...
---
> Source: [zhaixin244-wq/fnw](https://github.com/zhaixin244-wq/fnw) — distributed by [TomeVault](https://tomevault.io).
