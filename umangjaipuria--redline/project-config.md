---
trigger: always_on
description: Redline is for local review of documents (HTML in this version). It is a reviewing-and-commenting tool, not the document owner: **you author and edit the content directly; Redline only reads content and writes the comment state block.** This app is self-contained in this folder.
---
...
---
> Source: [umangjaipuria/redline](https://github.com/umangjaipuria/redline) — distributed by [TomeVault](https://tomevault.io).
