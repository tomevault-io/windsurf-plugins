---
trigger: always_on
description: Apply these rules to Packer templates and the shell scripts that build and
---
...
---
> Source: [konstruktoid/hardened-images](https://github.com/konstruktoid/hardened-images) — distributed by [TomeVault](https://tomevault.io).
