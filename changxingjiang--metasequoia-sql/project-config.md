---
trigger: always_on
description: 本项目采用模块化的目录结构，各目录的职责如下：
---
...
---
> Source: [ChangxingJiang/metasequoia-sql](https://github.com/ChangxingJiang/metasequoia-sql) — distributed by [TomeVault](https://tomevault.io).
