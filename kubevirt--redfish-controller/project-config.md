---
trigger: always_on
description: You are building a cloud native service for kubernetes and OpenShift
---
...
---
> Source: [kubevirt/redfish-controller](https://github.com/kubevirt/redfish-controller) — distributed by [TomeVault](https://tomevault.io).
