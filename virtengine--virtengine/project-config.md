---
trigger: always_on
description: - Purpose: Describe how AGENTS.md files document modules and how agents should work in this repo.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/virtengine)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/virtengine)
