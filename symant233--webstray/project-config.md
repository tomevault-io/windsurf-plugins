---
trigger: always_on
description: Purpose: help an AI coding agent be immediately productive in this repo — how the app is wired, what to change, where to run it, and project-specific conventions.
---
...
---
> Source: [symant233/WebsTray](https://github.com/symant233/WebsTray) — distributed by [TomeVault](https://tomevault.io).
