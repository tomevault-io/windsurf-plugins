---
trigger: always_on
description: Coding guidelines for AI agents working in this project.
---
...
---
> Source: [extractus/article-extractor](https://github.com/extractus/article-extractor) — distributed by [TomeVault](https://tomevault.io).
