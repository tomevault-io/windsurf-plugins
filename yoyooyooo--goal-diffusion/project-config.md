---
trigger: always_on
description: 本仓库是 AI Coding Project OS 方法套件、agent skills 和 `goal-diffusion` CLI 的源码仓库。
---
...
---
> Source: [yoyooyooo/goal-diffusion](https://github.com/yoyooyooo/goal-diffusion) — distributed by [TomeVault](https://tomevault.io).
