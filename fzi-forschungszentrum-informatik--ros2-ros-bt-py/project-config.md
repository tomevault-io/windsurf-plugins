---
trigger: always_on
description: ROS 2 Behavior Tree library (`ros_bt_py`) with a ReactJS web GUI. Alternative to BehaviorTree.cpp, SMACH, FlexBE.
---
...
---
> Source: [fzi-forschungszentrum-informatik/ros2_ros_bt_py](https://github.com/fzi-forschungszentrum-informatik/ros2_ros_bt_py) — distributed by [TomeVault](https://tomevault.io).
