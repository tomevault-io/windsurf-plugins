---
trigger: always_on
description: - `/src/`: InterSystems Package Manager ObjectScript source code classes.
---
...
---
> Source: [intersystems/ipm](https://github.com/intersystems/ipm) — distributed by [TomeVault](https://tomevault.io).
