---
trigger: always_on
description: - `automem/`: Core package. Notable dirs: `api/` (Flask blueprints), `utils/`, `stores/`, `config.py`.
---
...
---
> Source: [verygoodplugins/automem](https://github.com/verygoodplugins/automem) — distributed by [TomeVault](https://tomevault.io).
