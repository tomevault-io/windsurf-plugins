---
trigger: always_on
description: - This repo powers **React Native Directory**, a Next.js Pages Router app that renders a React Native Web / Expo UI and serves JSON endpoints from `pages/api/`.
---
...
---
> Source: [react-native-community/directory](https://github.com/react-native-community/directory) — distributed by [TomeVault](https://tomevault.io).
