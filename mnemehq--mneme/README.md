...
Original source: `CLAUDE.md` in [MnemeHQ/mneme](https://github.com/MnemeHQ/mneme).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/MnemeHQ/mneme](https://github.com/MnemeHQ/mneme)
