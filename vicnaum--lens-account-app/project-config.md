---
trigger: always_on
description: description: Rules for implementing WalletConnect v2 using @reown/walletkit or @walletconnect/web3wallet, where this app acts AS the wallet for the Lens Account.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/vicnaum)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/vicnaum)
