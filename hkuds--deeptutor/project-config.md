---
trigger: always_on
description: DeepTutor is an **agent-native** intelligent learning companion built around
---
...
---
> Source: [HKUDS/DeepTutor](https://github.com/HKUDS/DeepTutor) — distributed by [TomeVault](https://tomevault.io).
