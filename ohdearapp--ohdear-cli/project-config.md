---
trigger: always_on
description: A standalone CLI tool for [Oh Dear](https://ohdear.app) website monitoring. Built with Laravel Zero 12 and `spatie/laravel-openapi-cli`, which auto-generates all API commands from the Oh Dear OpenAPI spec.
---
