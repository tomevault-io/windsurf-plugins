---
trigger: always_on
description: Claude Video is an AI-powered video production suite for Claude Code. It provides 15 sub-skills covering the full video production pipeline from editing to AI generation.
---
...
---
> Source: [AgriciDaniel/claude-video](https://github.com/AgriciDaniel/claude-video) — distributed by [TomeVault](https://tomevault.io).
