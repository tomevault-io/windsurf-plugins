---
trigger: always_on
description: This repository contains `Edi.Captcha`, an ASP.NET Core captcha library, plus a sample MVC app and NUnit tests. Treat the package project as a public NuGet library: keep changes small, preserve public API compatibility unless the request explicitly calls for a breaking change, and update README/sample usage when behavior or setup changes.
---
