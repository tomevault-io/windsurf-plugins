---
trigger: always_on
description: Execution engine using Apache DataFusion for transform evaluation.
---
...
---
> Source: [vega/vegafusion](https://github.com/vega/vegafusion) — distributed by [TomeVault](https://tomevault.io).
