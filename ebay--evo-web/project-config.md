---
trigger: always_on
description: When reviewing pull requests for the evo-web project, please follow these custom guidelines and check for the items outlined in our PR checklist. This project contains multiple packages with specific requirements for each.
---
...
---
> Source: [eBay/evo-web](https://github.com/eBay/evo-web) — distributed by [TomeVault](https://tomevault.io).
