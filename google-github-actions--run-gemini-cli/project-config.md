---
trigger: always_on
description: This project is a **composite GitHub Action**, designed to be reusable, efficient, and secure for other developers.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/google-github-actions)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/google-github-actions)
