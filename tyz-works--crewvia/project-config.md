---
trigger: always_on
description: カンバン駆動でタスクを管理し、Taskvia（WebUI）と連携して承認フローを実現する。
---
...
---
> Source: [tyz-works/Crewvia](https://github.com/tyz-works/Crewvia) — distributed by [TomeVault](https://tomevault.io).
