---
trigger: always_on
description: This repository is `typescript-retry-decorator`: a small TypeScript library that provides a `@Retryable` decorator (supports both legacy `experimentalDecorators` and TS5 “standard decorators” runtime signature).
---
...
---
> Source: [vcfvct/typescript-retry-decorator](https://github.com/vcfvct/typescript-retry-decorator) — distributed by [TomeVault](https://tomevault.io).
