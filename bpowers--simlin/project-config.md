---
trigger: always_on
description: Pure Rust implementation of a Vensim MDL file parser, replacing the C++ `src/xmutil` dependency.
---
...
---
> Source: [bpowers/simlin](https://github.com/bpowers/simlin) — distributed by [TomeVault](https://tomevault.io).
