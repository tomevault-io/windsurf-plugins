...
## UI Conventions
- Every clickable element (`button`, `a`, or interactive `div`) must have `cursor-pointer` in its Tailwind classes.

---
> Source: [walkersutton/cyclemetry](https://github.com/walkersutton/cyclemetry) — distributed by [TomeVault](https://tomevault.io).
