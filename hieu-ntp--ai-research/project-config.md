---
trigger: always_on
description: Prompts are **automatically logged** via hooks when you use any supported AI tool.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/HIEU-ntp)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/HIEU-ntp)
