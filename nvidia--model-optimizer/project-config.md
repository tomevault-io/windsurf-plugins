---
trigger: always_on
description: These instructions apply to AI-assisted work in this repository.
---
...
---
> Source: [NVIDIA/Model-Optimizer](https://github.com/NVIDIA/Model-Optimizer) — distributed by [TomeVault](https://tomevault.io).
