---
trigger: always_on
description: You may optionally install [orchestrator-agent](https://github.com/openark/orchestrator-agent) on your MySQL hosts.
---
...
---
> Source: [percona/orchestrator](https://github.com/percona/orchestrator) — distributed by [TomeVault](https://tomevault.io).
