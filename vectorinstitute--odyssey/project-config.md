---
trigger: always_on
description: No `GEMINI.yaml` here, unlike `eICU.yaml` in this same directory --
---
...
---
> Source: [VectorInstitute/odyssey](https://github.com/VectorInstitute/odyssey) — distributed by [TomeVault](https://tomevault.io).
