---
trigger: always_on
description: 1. **Nomenclatura de Pacotes**
---
...
---
> Source: [chapzin/parse-efd-fiscal](https://github.com/chapzin/parse-efd-fiscal) — distributed by [TomeVault](https://tomevault.io).
