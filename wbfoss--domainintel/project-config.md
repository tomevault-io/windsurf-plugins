---
trigger: always_on
description: - **Do not add AI attribution to commits.** No `Co-Authored-By: Claude ...` (or
---
...
---
> Source: [wbfoss/domainintel](https://github.com/wbfoss/domainintel) — distributed by [TomeVault](https://tomevault.io).
