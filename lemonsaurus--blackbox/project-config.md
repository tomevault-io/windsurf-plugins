---
trigger: always_on
description: Everything you need to know to work on this repo. The toolchain is self-enforcing: if the local hooks pass, CI passes.
---
...
---
> Source: [lemonsaurus/blackbox](https://github.com/lemonsaurus/blackbox) — distributed by [TomeVault](https://tomevault.io).
