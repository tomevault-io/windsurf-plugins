---
trigger: always_on
description: Headless WordPress MCP server — adds an Astro frontend to any WordPress site, with multi-site support.
---
...
---
> Source: [vapvarun/wp-astro-mcp](https://github.com/vapvarun/wp-astro-mcp) — distributed by [TomeVault](https://tomevault.io).
