---
trigger: always_on
description: This is an MCP (Model Context Protocol) server for MCPize hosting platform.
---
...
---
> Source: [JosieBot26/prospector-mcp-email-finder](https://github.com/JosieBot26/prospector-mcp-email-finder) — distributed by [TomeVault](https://tomevault.io).
