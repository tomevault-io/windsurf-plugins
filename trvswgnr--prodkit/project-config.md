---
trigger: always_on
description: - Treat this file as living memory: update it whenever durable user preferences or stable workspace facts become clear.
---
...
---
> Source: [trvswgnr/prodkit](https://github.com/trvswgnr/prodkit) — distributed by [TomeVault](https://tomevault.io).
