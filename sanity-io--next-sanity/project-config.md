---
trigger: always_on
description: The public `next-sanity/live` export is implemented by three condition-specific entry points:
---
...
---
> Source: [sanity-io/next-sanity](https://github.com/sanity-io/next-sanity) — distributed by [TomeVault](https://tomevault.io).
