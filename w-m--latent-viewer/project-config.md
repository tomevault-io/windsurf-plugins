---
trigger: always_on
description: The project displays 3D Gaussian Splatting scenes in the browser. A React-based
---
...
---
> Source: [w-m/latent-viewer](https://github.com/w-m/latent-viewer) — distributed by [TomeVault](https://tomevault.io).
