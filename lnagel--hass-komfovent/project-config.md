...
uv run pytest --cov=custom_components/komfovent --cov-branch --cov-report=xml
...
---
> Source: [lnagel/hass-komfovent](https://github.com/lnagel/hass-komfovent) — distributed by [TomeVault](https://tomevault.io).
