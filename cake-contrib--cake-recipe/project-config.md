---
trigger: always_on
description: As set out in the introduction [Cake.Recipe is a set of convention based build scripts](../). The conventions are important, as they determine the defaults. But they are not set in stone and they can be changed in several ways
---
...
---
> Source: [cake-contrib/Cake.Recipe](https://github.com/cake-contrib/Cake.Recipe) — distributed by [TomeVault](https://tomevault.io).
