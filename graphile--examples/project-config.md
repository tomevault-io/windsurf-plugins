---
trigger: always_on
description: - snake_case for tables, functions, columns (avoids having to put them in quotes in most cases)
---
...
---
> Source: [graphile/examples](https://github.com/graphile/examples) — distributed by [TomeVault](https://tomevault.io).
