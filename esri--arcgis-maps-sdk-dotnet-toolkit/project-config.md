---
trigger: always_on
description: - CI builds the main toolkit SDK project heads with .NET:
---
...
---
> Source: [Esri/arcgis-maps-sdk-dotnet-toolkit](https://github.com/Esri/arcgis-maps-sdk-dotnet-toolkit) — distributed by [TomeVault](https://tomevault.io).
