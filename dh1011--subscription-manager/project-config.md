---
trigger: always_on
description: This project is a single-page web application built with **Next.js** for managing subscriptions. It allows users to track expenses, set up notifications via NTFY, and visualize their subscription payments on a calendar.
---
...
---
> Source: [dh1011/subscription-manager](https://github.com/dh1011/subscription-manager) — distributed by [TomeVault](https://tomevault.io).
