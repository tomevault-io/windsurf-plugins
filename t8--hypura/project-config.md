---
trigger: always_on
description: Storage-tier-aware LLM inference scheduler for Apple Silicon. Places model
---
...
---
> Source: [t8/hypura](https://github.com/t8/hypura) — distributed by [TomeVault](https://tomevault.io).
