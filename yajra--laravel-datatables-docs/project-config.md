---
trigger: always_on
description: When working with this documentation repository, ALWAYS follow these rules:
---
...
---
> Source: [yajra/laravel-datatables-docs](https://github.com/yajra/laravel-datatables-docs) — distributed by [TomeVault](https://tomevault.io).
