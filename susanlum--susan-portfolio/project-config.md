---
trigger: always_on
description: Susan's AI-powered portfolio app that showcases built projects with live demos, case studies, and skill tags — demoable by recruiters in 30 seconds.
---

# susan-portfolio

Susan's AI-powered portfolio app that showcases built projects with live demos, case studies, and skill tags — demoable by recruiters in 30 seconds.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "105427308+susanlum@users.noreply.github.com"
  git config user.name "susanlum"
  ```
...
---
> Source: [susanlum/susan-portfolio](https://github.com/susanlum/susan-portfolio) — distributed by [TomeVault](https://tomevault.io).
