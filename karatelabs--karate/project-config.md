---
trigger: always_on
description: Start with [docs/DESIGN.md](./docs/DESIGN.md) — the primary architecture reference for the codebase (and the deep-dive docs it links).
---
...
- **Tag non-code commits with `[no ci]`.** Docs-only and other commits that don't touch buildable/testable code should carry `[no ci]` in the subject line to skip the CI run.

---
> Source: [karatelabs/karate](https://github.com/karatelabs/karate) — distributed by [TomeVault](https://tomevault.io).
