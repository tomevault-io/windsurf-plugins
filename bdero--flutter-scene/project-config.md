---
trigger: always_on
description: This repository is the **flutter_scene** realtime 3D engine for Flutter, plus the packages built around it. This file orients coding agents, and the people directing them, toward using these packages correctly. It is about *using* the engine, not developing it.
---
...
---
> Source: [bdero/flutter_scene](https://github.com/bdero/flutter_scene) — distributed by [TomeVault](https://tomevault.io).
