---
trigger: always_on
description: This repository contains the official Docker images for .NET Framework, published to Microsoft Container Registry (mcr.microsoft.com).
---
...
---
> Source: [microsoft/dotnet-framework-docker](https://github.com/microsoft/dotnet-framework-docker) — distributed by [TomeVault](https://tomevault.io).
