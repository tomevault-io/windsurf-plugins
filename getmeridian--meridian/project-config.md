---
trigger: always_on
description: **Two-stage pipeline** — CI validates on every push/PR. Release triggers only on CI success on main via `workflow_run`. Prevents accidental releases from failed builds.
---
...
---
> Source: [getmeridian/meridian](https://github.com/getmeridian/meridian) — distributed by [TomeVault](https://tomevault.io).
