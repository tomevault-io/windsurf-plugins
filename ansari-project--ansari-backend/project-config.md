---
trigger: always_on
description: This project uses **Codev** for AI-assisted development.
---
...
---
> Source: [ansari-project/ansari-backend](https://github.com/ansari-project/ansari-backend) — distributed by [TomeVault](https://tomevault.io).
