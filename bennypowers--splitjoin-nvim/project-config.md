---
trigger: always_on
description: Treesitter-based split/join for Neovim. Split or join list-like syntax
---
...
---
> Source: [bennypowers/splitjoin.nvim](https://github.com/bennypowers/splitjoin.nvim) — distributed by [TomeVault](https://tomevault.io).
