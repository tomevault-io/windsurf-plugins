---
trigger: always_on
description: This is a VS Code extension that provides OpenCode Zen models via the Language Model Chat Provider API. The codebase is TypeScript with strict mode, using the ai-sdk for API communication.
---
...
---
> Source: [wienans/vsc-opencode-zen-chat-provider](https://github.com/wienans/vsc-opencode-zen-chat-provider) — distributed by [TomeVault](https://tomevault.io).
