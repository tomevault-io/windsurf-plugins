# AI instruction files for Wikipedia-API

> Sourced from [martin-majlis/Wikipedia-API](https://github.com/martin-majlis/Wikipedia-API), graded against the public Tome Standard and kept consistent across every major platform by [TomeVault](https://tomevault.io)
