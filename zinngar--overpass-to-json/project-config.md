---
trigger: always_on
description: This project is a single-page application built with Vite and TypeScript. It allows users to fetch traffic light data from the Overpass API and download it as a JSON file.
---
...
---
> Source: [zinngar/Overpass-to-Json-](https://github.com/zinngar/Overpass-to-Json-) — distributed by [TomeVault](https://tomevault.io).
