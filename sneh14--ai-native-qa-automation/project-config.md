---
trigger: always_on
description: EventHub is a full-stack event ticket booking platform built for QA training. Users can browse events, book tickets, manage bookings, and create events. Each user operates in an isolated sandbox.
---
...
---
> Source: [Sneh14/ai-native-qa-automation](https://github.com/Sneh14/ai-native-qa-automation) — distributed by [TomeVault](https://tomevault.io).
