---
trigger: always_on
description: 本文件为 AI 与协作者在本仓库中进行代码生成、变更评审与文档撰写时的统一约束与上下文指引。请严格遵循以下规范，确保改动与项目架构、风格和运行形态保持一致。
---
...
---
> Source: [phuhao00/greatestworks](https://github.com/phuhao00/greatestworks) — distributed by [TomeVault](https://tomevault.io).
