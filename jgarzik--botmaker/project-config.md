---
trigger: always_on
description: validates, then the proxy injects the real API key when forwarding upstream.
---
...
---
> Source: [jgarzik/botmaker](https://github.com/jgarzik/botmaker) — distributed by [TomeVault](https://tomevault.io).
