---
trigger: always_on
description: > 面向开发人员与 AI Agent 的 `dsh-desktop`（DeepSeek Harness 桌面壳）协作指南
---
...
---
> Source: [wang-yi-bit64/dsh-desktop](https://github.com/wang-yi-bit64/dsh-desktop) — distributed by [TomeVault](https://tomevault.io).
