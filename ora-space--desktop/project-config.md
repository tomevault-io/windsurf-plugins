---
trigger: always_on
description: 1. **Code Documentation**: Unless it is a standard, self-explanatory method (e.g., `new()`), every function must include a comment above the signature describing its purpose. Provide inline comments for any complex logic, non-trivial algorithms, or specialized branching within function bodies. Write comments in English.
---
...
---
> Source: [ora-space/desktop](https://github.com/ora-space/desktop) — distributed by [TomeVault](https://tomevault.io).
