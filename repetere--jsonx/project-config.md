---
trigger: always_on
description: - JSONX is a TypeScript and React package. Source files live in `src/`, generated package output lives in `build/` and `dist/`.
---
...
---
> Source: [repetere/jsonx](https://github.com/repetere/jsonx) — distributed by [TomeVault](https://tomevault.io).
