---
trigger: always_on
description: Follow these rules when editing or generating code for the @sasjs/core SAS macro library.
---
...
---
> Source: [sasjs/core](https://github.com/sasjs/core) — distributed by [TomeVault](https://tomevault.io).
