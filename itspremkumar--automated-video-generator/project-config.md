---
trigger: always_on
description: This repo is `automated-video-generator` (TypeScript, Node 18+, Remotion, Edge-TTS).
---
...
---
> Source: [itsPremkumar/Automated-Video-Generator](https://github.com/itsPremkumar/Automated-Video-Generator) — distributed by [TomeVault](https://tomevault.io).
