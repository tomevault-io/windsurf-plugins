---
trigger: always_on
description: - **PLAN.md** — The source of truth for all phases, implementation status, and test plans. When completing work on any phase or sub-task, update the relevant `STATUS:` tags. When adding new features or changing scope, update the plan accordingly.
---
...
---
> Source: [truecourse-ai/truecourse](https://github.com/truecourse-ai/truecourse) — distributed by [TomeVault](https://tomevault.io).
