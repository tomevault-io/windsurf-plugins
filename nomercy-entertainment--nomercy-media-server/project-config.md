---
trigger: always_on
description: NoMercy MediaServer is a self-hosted media streaming platform built with .NET 9.0, featuring automatic media encoding, comprehensive library management, and remote streaming capabilities. The system emphasizes privacy, user ownership, and seamless cross-platform deployment.
---
...
---
> Source: [NoMercy-Entertainment/nomercy-media-server](https://github.com/NoMercy-Entertainment/nomercy-media-server) — distributed by [TomeVault](https://tomevault.io).
