---
trigger: always_on
description: QD 是一个基于 HAR Editor 和 Tornado Server 的 HTTP 请求定时任务自动执行框架，用于自动化 HTTP 请求任务。该项目使用 Python 构建，支持定时任务调度、请求模板管理和会话管理等功能。
---
...
---
> Source: [qd-today/qd](https://github.com/qd-today/qd) — distributed by [TomeVault](https://tomevault.io).
