---
trigger: always_on
description: Browser-side TypeScript library (`@cloudflare/speedtest`) that measures
---
...
---
> Source: [cloudflare/speedtest](https://github.com/cloudflare/speedtest) — distributed by [TomeVault](https://tomevault.io).
