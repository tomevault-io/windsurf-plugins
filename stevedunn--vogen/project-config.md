---
trigger: always_on
description: This document is aimed at AI agents working on the **Vogen** repository.  The
---
...
---
> Source: [SteveDunn/Vogen](https://github.com/SteveDunn/Vogen) — distributed by [TomeVault](https://tomevault.io).
