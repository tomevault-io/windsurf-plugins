---
trigger: always_on
description: - `pyside/stubgen_pyside.py` contains the shared PySide6 generator logic
---
...
---
> Source: [LumaPictures/cg-stubs](https://github.com/LumaPictures/cg-stubs) — distributed by [TomeVault](https://tomevault.io).
