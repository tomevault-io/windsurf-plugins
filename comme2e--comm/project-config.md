---
trigger: always_on
description: All commands must be run inside Nix for this repository.
---
...
---
> Source: [CommE2E/comm](https://github.com/CommE2E/comm) — distributed by [TomeVault](https://tomevault.io).
