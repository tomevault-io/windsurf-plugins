---
trigger: always_on
description: An MCP (Model Context Protocol) server for reading and analyzing VCD/FST waveform files using the wellen library.
---
...
---
> Source: [jiegec/waveform-mcp](https://github.com/jiegec/waveform-mcp) — distributed by [TomeVault](https://tomevault.io).
