---
trigger: always_on
description: - Multi-module Maven repository with root `pom.xml`.
---
...
---
> Source: [apolloconfig/apollo-java](https://github.com/apolloconfig/apollo-java) — distributed by [TomeVault](https://tomevault.io).
