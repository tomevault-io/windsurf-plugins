---
trigger: always_on
description: - **Package manager**: pnpm 10.28.2+ (workspaces in `packages/*`)
---
...
---
> Source: [tyler-technologies-oss/forge](https://github.com/tyler-technologies-oss/forge) — distributed by [TomeVault](https://tomevault.io).
