---
trigger: always_on
description: This is a NixOS flake-based system configuration managing multiple machines with shared modules, Home Manager for user-level config, and agenix for secrets.
---
...
---
> Source: [JRMurr/NixOsConfig](https://github.com/JRMurr/NixOsConfig) — distributed by [TomeVault](https://tomevault.io).
