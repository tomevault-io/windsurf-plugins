---
trigger: always_on
description: Use `pnpm ui:init` after pulling `wenyan-ui` changes; it updates the submodule, installs its dependencies, and runs `svelte-kit sync`.
---
...
---
> Source: [caol64/wenyan](https://github.com/caol64/wenyan) — distributed by [TomeVault](https://tomevault.io).
