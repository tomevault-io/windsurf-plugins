...
- **Main code:** `custom_components/openmotics/`
...
- `service_actions.py` — Service action implementations
- `utils.py` — Integration-wide utilities
...
6. Consult [Ruff rules](https://docs.astral.sh/ruff/rules/) or [Pyrefly docs](https://pyrefly.org/en/docs/) when
   validation fails
...
- Debug level: `custom_components.openmotics: debug` in `config/configuration.yaml`
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/rensongroup)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/rensongroup)
