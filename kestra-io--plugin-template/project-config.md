---
trigger: always_on
description: - Provides plugin components under `io.kestra.plugin.templates`.
---
...
---
> Source: [kestra-io/plugin-template](https://github.com/kestra-io/plugin-template) — distributed by [TomeVault](https://tomevault.io).
