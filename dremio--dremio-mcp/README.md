...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/dremio/dremio-mcp](https://github.com/dremio/dremio-mcp)

---

Install this config instantly:
```
npx tomevault install dremio/dremio-mcp
```
Source: [github.com/dremio/dremio-mcp](https://github.com/dremio/dremio-mcp).
