---
trigger: always_on
description: - Core TypeScript sources live in `src/`; `src/grok-cli.ts` routes CLI flags into the generator logic in `src/grok.ts` and `src/terminal.ts`.
---
...
---
> Source: [ui-js/grok](https://github.com/ui-js/grok) — distributed by [TomeVault](https://tomevault.io).
