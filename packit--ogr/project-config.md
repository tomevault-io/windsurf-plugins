---
trigger: always_on
description: Instructions for anyone — human or agent — contributing to `ogr`. See
---
...
- Tests live in `tests/`, and use [`requre`](https://github.com/packit/requre)
  ...
  `tests/integration/<service>/test_data`.
...
---
> Source: [packit/ogr](https://github.com/packit/ogr) — distributed by [TomeVault](https://tomevault.io).
