---
trigger: always_on
description: 当发现一个 bug 时，**不要**只修复眼前的症状。必须追溯数据流全链路，
---
...
---
> Source: [xianyu-sheng/Xenon](https://github.com/xianyu-sheng/Xenon) — distributed by [TomeVault](https://tomevault.io).
