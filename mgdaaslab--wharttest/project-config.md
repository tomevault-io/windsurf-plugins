---
trigger: always_on
description: WHartTest 是 AI 驱动的智能测试用例生成平台，采用前后端分离的 Monorepo 架构。
---
...
---
> Source: [MGdaasLab/WHartTest](https://github.com/MGdaasLab/WHartTest) — distributed by [TomeVault](https://tomevault.io).
