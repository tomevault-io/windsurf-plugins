---
trigger: always_on
description: Project rules for Claude Code sessions working on this repo.
---
...
---
> Source: [outsmartchad/outsmart-cli](https://github.com/outsmartchad/outsmart-cli) — distributed by [TomeVault](https://tomevault.io).
