---
trigger: always_on
description: 本文件为Claude Code (claude.ai/code)在此代码库中工作时提供指导。
---
...
---
> Source: [HighTorque-Robotics/Panthera-HT_ROS2](https://github.com/HighTorque-Robotics/Panthera-HT_ROS2) — distributed by [TomeVault](https://tomevault.io).
