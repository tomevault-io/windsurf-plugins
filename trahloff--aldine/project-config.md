---
trigger: always_on
description: Guidance for AI agents (and a fast orientation for humans) working in this repo.
---
...
---
> Source: [trahloff/Aldine](https://github.com/trahloff/Aldine) — distributed by [TomeVault](https://tomevault.io).
