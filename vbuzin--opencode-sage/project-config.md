---
trigger: always_on
description: These rules apply to every opencode session, across every agent. Agent files
---
...
---
> Source: [vbuzin/opencode-sage](https://github.com/vbuzin/opencode-sage) — distributed by [TomeVault](https://tomevault.io).
