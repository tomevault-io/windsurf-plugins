---
trigger: always_on
description: - Simba.js is a Node.js CLI that scaffolds TypeScript backend projects (`bin/index.js` → `lib/index.js` → `lib/src/index.js`).
---
...
---
> Source: [AnthonyLzq/Simba.js](https://github.com/AnthonyLzq/Simba.js) — distributed by [TomeVault](https://tomevault.io).
