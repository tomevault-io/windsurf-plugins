---
trigger: always_on
description: > 给 Claude Code / Cursor / Copilot 等 AI 助手看的项目协作规范。
---
...
---
> Source: [yupoet/aurumq-rl](https://github.com/yupoet/aurumq-rl) — distributed by [TomeVault](https://tomevault.io).
