---
trigger: always_on
description: dotnet build dotnet-project-file-analyzers.slnx -c Release
---
...
---
> Source: [dotnet-project-file-analyzers/dotnet-project-file-analyzers](https://github.com/dotnet-project-file-analyzers/dotnet-project-file-analyzers) — distributed by [TomeVault](https://tomevault.io).
