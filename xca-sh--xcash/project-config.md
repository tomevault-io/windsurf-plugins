---
trigger: always_on
description: - Xcash, 基于 Django 的开源企业级加密货币金融网关，支持支付、充币，支持多商户与多项目管理。
---
...
- 永远不要在智能合约（Solidity/TVM 等）里乱加注释：合约源码保持精简、靠清晰命名自解释，不堆砌解释性注释。此条针对智能合约，优先于上一条"核心业务逻辑需有完整的逻辑注释"。
- 保证代码的逻辑清晰，人类可读性高
...
---
> Source: [xca-sh/xcash](https://github.com/xca-sh/xcash) — distributed by [TomeVault](https://tomevault.io).
