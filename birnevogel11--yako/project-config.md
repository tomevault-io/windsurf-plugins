---
trigger: always_on
description: Yako is a mock-based testing framework for Ansible playbooks. It intercepts Ansible task execution via a custom callback plugin to run assertions and inject mocks, enabling unit-style testing of roles and playbooks without real infrastructure.
---
