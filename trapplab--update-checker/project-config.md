---
trigger: always_on
description: Minimal Flutter starter app with i18n support and three build flavors.
---
...
---
> Source: [trapplab/update-checker](https://github.com/trapplab/update-checker) — distributed by [TomeVault](https://tomevault.io).
