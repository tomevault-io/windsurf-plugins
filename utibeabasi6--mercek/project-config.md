---
trigger: always_on
description: A desktop IDE for AWS ECS (Tauri 2 + Rust backend, React 19 + TypeScript frontend). The full build spec is `specs/mercek.md` — **it is the source of truth** for scope, architecture, and conventions.
---
...
---
> Source: [utibeabasi6/mercek](https://github.com/utibeabasi6/mercek) — distributed by [TomeVault](https://tomevault.io).
