---
trigger: always_on
description: The Rust driver for MongoDB.
---
...
---
> Source: [mongodb/mongo-rust-driver](https://github.com/mongodb/mongo-rust-driver) — distributed by [TomeVault](https://tomevault.io).
