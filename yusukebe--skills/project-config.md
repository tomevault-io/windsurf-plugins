---
trigger: always_on
description: Instructions for AI agents working **inside this repository**.
---
...
---
> Source: [yusukebe/skills](https://github.com/yusukebe/skills) — distributed by [TomeVault](https://tomevault.io).
