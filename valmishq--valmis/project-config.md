---
trigger: always_on
description: An agent is a configured AI assistant: a model, a personality, and a set of capabilities. You can create as many agents as you like, each with its own credentials, skills, knowledge, memory, and workflows.
---
