---
trigger: always_on
description: Kiwa UI is a **shadcn-style component library and CLI** specifically built for **Hono-first stacks**. It provides SSR-first UI primitives, paid blocks, and starter kits for developers building applications with Hono (deployed to Bun, Deno, Cloudflare Workers, or Node).
---
...
---
> Source: [kiwa-ui/kiwa-ui](https://github.com/kiwa-ui/kiwa-ui) — distributed by [TomeVault](https://tomevault.io).
