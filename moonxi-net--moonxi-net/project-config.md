...
- Run `moon test --target native` to check tests pass. MoonBit supports snapshot testing; when
  changes affect outputs, run `moon test --native --update` to refresh snapshots.
...
- fix `moon test/build ...` warning immediately

---
> Source: [moonxi-net/moonxi-net](https://github.com/moonxi-net/moonxi-net) — distributed by [TomeVault](https://tomevault.io).
