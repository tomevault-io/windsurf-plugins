---
trigger: always_on
description: As a Gemini agent, you must adhere to the following instructions when making
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/gkapfham)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/gkapfham)
