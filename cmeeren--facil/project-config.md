---
trigger: always_on
description: - For `src/DbTests/DbTests.fsproj`, prefer running the Expecto console app directly instead of `dotnet test`, especially for focused verification. The YoloDev.Expecto.TestSdk/VSTest adapter path can ignore or fail to apply filters and sit in the testhost for minutes.
---
...
---
> Source: [cmeeren/Facil](https://github.com/cmeeren/Facil) — distributed by [TomeVault](https://tomevault.io).
