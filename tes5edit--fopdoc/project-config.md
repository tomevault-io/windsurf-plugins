---
trigger: always_on
description: This page sets out the conventions used within this documentation. They are roughly similar to those used on [UESP.net](http://www.uesp.net/wiki/Tes5Mod:File_Format_Conventions).
---
...
---
> Source: [TES5Edit/fopdoc](https://github.com/TES5Edit/fopdoc) — distributed by [TomeVault](https://tomevault.io).
