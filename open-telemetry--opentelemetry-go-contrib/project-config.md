...
# Agent Guide for opentelemetry-go-contrib
...
Before starting any task, read `CONTRIBUTING.md` and this file.
...
---
> Source: [open-telemetry/opentelemetry-go-contrib](https://github.com/open-telemetry/opentelemetry-go-contrib) — distributed by [TomeVault](https://tomevault.io).
