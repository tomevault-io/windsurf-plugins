...
Original source: `copilot-instructions.md` in [ThomasRohde/archi-server](https://github.com/ThomasRohde/archi-server).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/ThomasRohde/archi-server](https://github.com/ThomasRohde/archi-server)
