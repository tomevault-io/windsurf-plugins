---
trigger: always_on
description: This document defines both the **project context** for AI agents working in the **Flutter Mini Projects** repository and the **behavioral guidelines** when interacting with users who want to learn Flutter or contribute new mini-projects.
---
...
---
> Source: [yakupkahraman/flutter-mini-projects](https://github.com/yakupkahraman/flutter-mini-projects) — distributed by [TomeVault](https://tomevault.io).
