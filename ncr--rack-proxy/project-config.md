---
trigger: always_on
description: `rack-proxy` is a small, security-sensitive Rack middleware/app that proxies HTTP
---
...
---
> Source: [ncr/rack-proxy](https://github.com/ncr/rack-proxy) — distributed by [TomeVault](https://tomevault.io).
