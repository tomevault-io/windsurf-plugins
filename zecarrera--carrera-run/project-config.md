---
trigger: always_on
description: Always check whether tests need to be added or updated:
---
...
---
> Source: [zecarrera/carrera-run](https://github.com/zecarrera/carrera-run) — distributed by [TomeVault](https://tomevault.io).
