---
trigger: always_on
description: Guidelines for AI coding agents contributing to OpenLineage.
---
...
---
> Source: [OpenLineage/OpenLineage](https://github.com/OpenLineage/OpenLineage) — distributed by [TomeVault](https://tomevault.io).
