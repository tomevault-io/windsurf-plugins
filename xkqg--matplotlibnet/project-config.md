---
trigger: always_on
description: Two pre-built knowledge graphs are available via `.mcp.json`:
---
...
---
> Source: [xkqg/MatPlotLibNet](https://github.com/xkqg/MatPlotLibNet) — distributed by [TomeVault](https://tomevault.io).
