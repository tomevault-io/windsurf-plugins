...
- folder "page_visibility" contains the C/C++ part of the extension.
- folder "example" contains the example project written in Lua for the extension.

---
> Source: [indiesoftby/defold-page-visibility](https://github.com/indiesoftby/defold-page-visibility) — distributed by [TomeVault](https://tomevault.io).
