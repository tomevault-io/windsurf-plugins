---
trigger: always_on
description: 本文件为 `easy-resume` 仓库根目录的 AI 协作指引。仓库下有 5 个独立子项目，每个子项目**各自**带有更详细的 `CLAUDE.md`，进入对应目录工作前请先读那份。
---
...
---
> Source: [umlink/easy-resume](https://github.com/umlink/easy-resume) — distributed by [TomeVault](https://tomevault.io).
