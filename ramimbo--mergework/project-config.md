---
trigger: always_on
description: MergeWork rewards accepted open-source work. Humans and AI agents earn MRWK only
---
...
---
> Source: [ramimbo/mergework](https://github.com/ramimbo/mergework) — distributed by [TomeVault](https://tomevault.io).
