---
trigger: always_on
description: - **Test**: `bb test` (all tests), `bb test-lib` (lib only), `bb test-cli` (CLI only)
---
...
---
> Source: [clojure-lsp/clojure-lsp](https://github.com/clojure-lsp/clojure-lsp) — distributed by [TomeVault](https://tomevault.io).
