---
trigger: always_on
description: 1. Run a docker compose in background for the specified feature e.g. `docker compose -f docker-compose.yml up -d`
---
...
---
> Source: [byjg/docker-easy-haproxy](https://github.com/byjg/docker-easy-haproxy) — distributed by [TomeVault](https://tomevault.io).
