---
trigger: always_on
description: **google-researcher-mcp** - An MCP (Model Context Protocol) server providing Google Search, web scraping, and multi-source research tools for AI assistants.
---
...
---
> Source: [zoharbabin/google-researcher-mcp](https://github.com/zoharbabin/google-researcher-mcp) — distributed by [TomeVault](https://tomevault.io).
