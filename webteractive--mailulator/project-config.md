---
trigger: always_on
description: Guidance for AI coding agents when working in this repository.
---
...
---
> Source: [webteractive/mailulator](https://github.com/webteractive/mailulator) — distributed by [TomeVault](https://tomevault.io).
