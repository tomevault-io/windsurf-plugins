---
trigger: always_on
description: Instructions for AI coding agents (Claude Code, etc.) working in this repository.
---
...
---
> Source: [hobbyquaker/node-red-contrib-lgtv](https://github.com/hobbyquaker/node-red-contrib-lgtv) — distributed by [TomeVault](https://tomevault.io).
