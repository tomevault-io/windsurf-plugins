...
Original source: `CLAUDE.md` in [pipeshub-ai/pipeshub-ai](https://github.com/pipeshub-ai/pipeshub-ai).
...
```
npx tomevault install pipeshub-ai/pipeshub-ai
```
Source: [github.com/pipeshub-ai/pipeshub-ai](https://github.com/pipeshub-ai/pipeshub-ai).
