---
trigger: always_on
description: 本文件供代理或維護者在本倉庫新增 Rime 輸入方案時使用。所有操作應以倉庫現有結構爲準，不要臆測路徑、分支或檔案清單。
---
...
---
> Source: [laubonghaudoi/Chinese_Rime](https://github.com/laubonghaudoi/Chinese_Rime) — distributed by [TomeVault](https://tomevault.io).
