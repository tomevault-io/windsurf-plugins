---
trigger: always_on
description: Cross-platform agent skills repo following the [Agent Skills specification](https://agentskills.io/specification).
---
...
---
> Source: [tryopendata/skills](https://github.com/tryopendata/skills) — distributed by [TomeVault](https://tomevault.io).
