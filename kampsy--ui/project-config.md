---
trigger: always_on
description: Svelte 5 UI component library using TypeScript, TailwindCSS v4, and Vite. Components use Svelte 5 runes ($props, $derived, $bindable) and snippets for reusable templates.
---
...
---
> Source: [kampsy/ui](https://github.com/kampsy/ui) — distributed by [TomeVault](https://tomevault.io).
