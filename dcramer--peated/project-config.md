---
trigger: always_on
description: Use `pnpm`: `pnpm --filter @peated/bottle-classifier typecheck`, `pnpm --filter @peated/bottle-classifier test`
---
...
---
> Source: [dcramer/peated](https://github.com/dcramer/peated) — distributed by [TomeVault](https://tomevault.io).
