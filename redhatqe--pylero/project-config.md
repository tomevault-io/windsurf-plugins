---
trigger: always_on
description: Pylero is a Python SDK wrapping the Polarion WSDL/SOAP API. It provides native Python access to Polarion objects (work items, test runs, documents, plans, etc.) via dynamically generated properties from WSDL definitions.
---
...
---
> Source: [RedHatQE/pylero](https://github.com/RedHatQE/pylero) — distributed by [TomeVault](https://tomevault.io).
