---
trigger: always_on
description: - NEVER hardcode user-visible English strings in production code. ALWAYS use an i18n key for visible copy, placeholders, accessible labels, tooltips, menus, dialogs, empty states, and displayed errors.
---
...
---
> Source: [anomalyco/opencode](https://github.com/anomalyco/opencode) — distributed by [TomeVault](https://tomevault.io).
