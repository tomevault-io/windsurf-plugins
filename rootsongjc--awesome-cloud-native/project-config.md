---
trigger: always_on
description: make build     # Generate tmpl/index.html from README.md (go run repo.go)
---
...
---
> Source: [rootsongjc/awesome-cloud-native](https://github.com/rootsongjc/awesome-cloud-native) — distributed by [TomeVault](https://tomevault.io).
