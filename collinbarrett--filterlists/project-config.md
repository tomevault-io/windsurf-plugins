---
trigger: always_on
description: These instructions are for GitHub Copilot cloud agent sessions started from GitHub issue assignment or pull request comments.
---
...
---
> Source: [collinbarrett/FilterLists](https://github.com/collinbarrett/FilterLists) — distributed by [TomeVault](https://tomevault.io).
