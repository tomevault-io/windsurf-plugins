---
trigger: always_on
description: Public monorepo for Sherlo's React Native SDK. Two published packages live in `packages/`: `cli` (`@sherlo/cli`) and `react-native-storybook` (`@sherlo/react-native-storybook`).
---
...
---
> Source: [sherlo-io/sherlo](https://github.com/sherlo-io/sherlo) — distributed by [TomeVault](https://tomevault.io).
