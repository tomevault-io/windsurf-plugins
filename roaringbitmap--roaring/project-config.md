---
trigger: always_on
description: Many AI-generated bug reports claim that deserialization functions (e.g., `ReadFrom`, `FromBuffer`, `FromUnsafeBytes`, `UnmarshalBinary`, and their `roaring64` equivalents) "trigger bugs", "cause crashes", or "panic" when given malformed or untrusted input.
---
...
---
> Source: [RoaringBitmap/roaring](https://github.com/RoaringBitmap/roaring) — distributed by [TomeVault](https://tomevault.io).
