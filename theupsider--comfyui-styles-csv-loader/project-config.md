---
trigger: always_on
description: This is a Python extension/plugin for ComfyUI that loads style prompts from CSV files, primarily for migration from Automatic1111 Stable Diffusion WebUI.
---
...
---
> Source: [theUpsider/ComfyUI-Styles_CSV_Loader](https://github.com/theUpsider/ComfyUI-Styles_CSV_Loader) — distributed by [TomeVault](https://tomevault.io).
