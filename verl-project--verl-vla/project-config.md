---
trigger: always_on
description: This file records model-layer decisions that every verl-vla integration must
---
...
---
> Source: [verl-project/verl-vla](https://github.com/verl-project/verl-vla) — distributed by [TomeVault](https://tomevault.io).
