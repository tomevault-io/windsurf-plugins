---
trigger: always_on
description: This guide applies to `aiavatar/adapter/asterisk/`. Also follow the
---
...
---
> Source: [uezo/aiavatarkit](https://github.com/uezo/aiavatarkit) — distributed by [TomeVault](https://tomevault.io).
