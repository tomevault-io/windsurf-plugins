---
trigger: always_on
description: Use **Go Modules**: `go mod tidy`, `go test ./...`
---
...
---
> Source: [way-platform/vin-go](https://github.com/way-platform/vin-go) — distributed by [TomeVault](https://tomevault.io).
