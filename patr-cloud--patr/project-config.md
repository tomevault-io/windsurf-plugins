---
trigger: always_on
description: Patr is a Rust/TypeScript monorepo for a DevOps platform. The key components are:
---
...
---
> Source: [patr-cloud/patr](https://github.com/patr-cloud/patr) — distributed by [TomeVault](https://tomevault.io).
