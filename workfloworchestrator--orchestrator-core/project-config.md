---
trigger: always_on
description: - **Package**: `orchestrator-core` (SURF), module `orchestrator.core`
---
...
## Code Rules
- Code should be as `pure` as possible with no side effects.
...
---
> Source: [workfloworchestrator/orchestrator-core](https://github.com/workfloworchestrator/orchestrator-core) — distributed by [TomeVault](https://tomevault.io).
