---
trigger: always_on
description: Context for AI coding agents reviewing or contributing to this repository.
---
...
---
> Source: [vecna-labs/open-trajectory-gym](https://github.com/vecna-labs/open-trajectory-gym) — distributed by [TomeVault](https://tomevault.io).
