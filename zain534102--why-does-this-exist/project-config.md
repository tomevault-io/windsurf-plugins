---
trigger: always_on
description: > This file is read by both **Claude Code** (as CLAUDE.md) and **OpenAI Codex** (as AGENTS.md via symlink).
---
...
---
> Source: [zain534102/why-does-this-exist](https://github.com/zain534102/why-does-this-exist) — distributed by [TomeVault](https://tomevault.io).
