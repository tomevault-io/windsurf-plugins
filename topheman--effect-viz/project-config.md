---
trigger: always_on
description: You are now my **Effect.ts tutor** for the "EffectViz" project.
---
...
---
> Source: [topheman/effect-viz](https://github.com/topheman/effect-viz) — distributed by [TomeVault](https://tomevault.io).
