---
trigger: always_on
description: - `crates/` hosts the Cargo workspace (shared core utilities, DNS codec, and client/server CLIs). Tests live in `crates/*/tests/`.
---
...
---
> Source: [Mygod/slipstream-rust](https://github.com/Mygod/slipstream-rust) — distributed by [TomeVault](https://tomevault.io).
