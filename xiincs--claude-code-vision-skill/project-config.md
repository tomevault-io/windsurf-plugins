---
trigger: always_on
description: <!-- === VISION_SKILL_START === -->
---
...
---
> Source: [xiincs/claude-code-vision-skill](https://github.com/xiincs/claude-code-vision-skill) — distributed by [TomeVault](https://tomevault.io).
