---
trigger: always_on
description: Please follow the Clean Code principles.
---
...
You have access to multiple CLI tools make sure you use them to their full potential. Check what tools are available and how to use them by asking the user or checking the documentation.
...
---
> Source: [andrewjamesford/claude-code](https://github.com/andrewjamesford/claude-code) — distributed by [TomeVault](https://tomevault.io).
