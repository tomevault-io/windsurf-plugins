---
trigger: always_on
description: Run `make install` to install esbuild (for bundling JavaScript) and project dependencies.
---
...
---
> Source: [koaning/drawdata](https://github.com/koaning/drawdata) — distributed by [TomeVault](https://tomevault.io).
