---
trigger: always_on
description: py2many transpiles Python code to Rust, C++, Go, Zig, Julia, Nim, Dart, V, D, Kotlin, Mojo, SMT, and Lean.
---
...
---
> Source: [py2many/py2many](https://github.com/py2many/py2many) — distributed by [TomeVault](https://tomevault.io).
