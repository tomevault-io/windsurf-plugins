---
trigger: always_on
description: - Code reads from top to bottom: a function comes before the helpers it
---
...
---
> Source: [penberg/vsr-rs](https://github.com/penberg/vsr-rs) — distributed by [TomeVault](https://tomevault.io).
