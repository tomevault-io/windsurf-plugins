---
trigger: always_on
description: > 用户面文档看 README.md / README_EN.md；本文件写给改代码的人/agent。
---
...
---
> Source: [whitefirer/dsh-browser-fs](https://github.com/whitefirer/dsh-browser-fs) — distributed by [TomeVault](https://tomevault.io).
