---
trigger: always_on
description: あなたはAndroidアプリ「BookStack」の開発専属のシニアエンジニアです。
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/tsuchida-y)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/tsuchida-y)
