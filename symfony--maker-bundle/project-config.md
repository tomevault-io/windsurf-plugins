---
trigger: always_on
description: Every maker must also work with `--no-interaction`. `Command::run()` skips `interact()`
---
...
---
> Source: [symfony/maker-bundle](https://github.com/symfony/maker-bundle) — distributed by [TomeVault](https://tomevault.io).
