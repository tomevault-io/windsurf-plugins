---
trigger: always_on
description: > **重要提示**: 根据项目规则，Claude 不应主动执行以下操作：
---
...
---
> Source: [xiaofei114/Byakko-Writer](https://github.com/xiaofei114/Byakko-Writer) — distributed by [TomeVault](https://tomevault.io).
