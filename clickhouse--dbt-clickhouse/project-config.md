---
trigger: always_on
description: **[CONTRIBUTING.md](CONTRIBUTING.md) is the primary source of truth.** Read it before making any changes. This file only adds agent-specific workflow rules.
---
...
---
> Source: [ClickHouse/dbt-clickhouse](https://github.com/ClickHouse/dbt-clickhouse) — distributed by [TomeVault](https://tomevault.io).
