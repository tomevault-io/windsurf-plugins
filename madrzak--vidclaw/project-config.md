---
trigger: always_on
description: - `src/`: React frontend. Feature UI lives under `src/components/*` (for example `src/components/Kanban/Board.jsx`), shared hooks in `src/hooks/`, and utilities in `src/lib/`.
---
...
---
> Source: [madrzak/vidclaw](https://github.com/madrzak/vidclaw) — distributed by [TomeVault](https://tomevault.io).
