---
trigger: always_on
description: This file helps AI coding agents (Codex, Copilot, Cursor, Claude, etc.) understand the LiteMarkup codebase and its extension conventions. Read this before making changes.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/tuures)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/tuures)
