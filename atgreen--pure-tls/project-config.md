---
trigger: always_on
description: - `src/` contains the TLS implementation, split into focused areas such as `crypto/`, `handshake/`, `record/`, and `x509/`. Core entry points and shared utilities live alongside (`package.lisp`, `streams.lisp`, `utils.lisp`).
---
...
---
> Source: [atgreen/pure-tls](https://github.com/atgreen/pure-tls) — distributed by [TomeVault](https://tomevault.io).
