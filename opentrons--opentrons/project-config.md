---
trigger: always_on
description: Follow the same rules as other Opentrons JS/TS packages. Authoritative detail lives in the Cursor skills below; this file is a checklist for contributors.
---
...
---
> Source: [Opentrons/opentrons](https://github.com/Opentrons/opentrons) — distributed by [TomeVault](https://tomevault.io).
