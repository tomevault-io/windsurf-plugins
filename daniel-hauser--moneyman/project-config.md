---
trigger: always_on
description: Moneyman is a TypeScript/Node.js application that scrapes financial transaction data from Israeli banks and credit card companies, then exports the data to various storage providers like Google Sheets, YNAB, Azure Data Explorer, and others.
---
...
---
> Source: [daniel-hauser/moneyman](https://github.com/daniel-hauser/moneyman) — distributed by [TomeVault](https://tomevault.io).
