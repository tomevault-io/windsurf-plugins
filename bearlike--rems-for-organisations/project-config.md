---
trigger: always_on
description: This document explains the current structure of REMS (Resources and Event Management System) and how to contribute effectively. Keep it up to date whenever new modules or features are introduced.
---
...
---
> Source: [bearlike/REMS-For-Organisations](https://github.com/bearlike/REMS-For-Organisations) — distributed by [TomeVault](https://tomevault.io).
