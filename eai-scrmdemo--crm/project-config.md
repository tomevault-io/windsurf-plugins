---
trigger: always_on
description: Frappe CRM frontend. Vue 3 + frappe-ui. The backend is Frappe Python. Scripts in
---
...
---
> Source: [eai-scrmdemo/crm](https://github.com/eai-scrmdemo/crm) — distributed by [TomeVault](https://tomevault.io).
