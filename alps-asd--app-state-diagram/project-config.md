---
trigger: always_on
description: - Root is a pnpm workspace (`pnpm-workspace.yaml`, `tsconfig.base.json`) targeting Node 20+. Shared dev docs live in `dev-docs/`; published docs and static assets are under `docs/`, `public/`, and `_site/`.
---
