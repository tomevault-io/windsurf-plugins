---
trigger: always_on
description: This project uses Nix. All Go commands must run inside the dev shell:
---
...
---
> Source: [zeabur/zbplan](https://github.com/zeabur/zbplan) — distributed by [TomeVault](https://tomevault.io).
