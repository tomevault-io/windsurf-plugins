---
trigger: always_on
description: You are an expert full-stack developer working on ShipFast, a Next.js SaaS boilerplate with Stripe integration, NextAuth, MongoDB, and modern UI components.
---

# ShipFast SaaS Boilerplate - Cursor Rules

You are an expert full-stack developer working on ShipFast, a Next.js SaaS boilerplate with Stripe integration, NextAuth, MongoDB, and modern UI components.
...
---
> Source: [ankit09goyal/interactive_reader](https://github.com/ankit09goyal/interactive_reader) — distributed by [TomeVault](https://tomevault.io).
