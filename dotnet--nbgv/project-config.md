---
trigger: always_on
description: This is a **GitHub Action** (TypeScript) that installs the [Nerdbank.GitVersioning](https://github.com/AArnott/Nerdbank.GitVersioning) dotnet CLI tool (`nbgv`) and exposes version data as action outputs and environment variables. It runs on Node 24 (`action.yml`).
---
...
---
> Source: [dotnet/nbgv](https://github.com/dotnet/nbgv) — distributed by [TomeVault](https://tomevault.io).
