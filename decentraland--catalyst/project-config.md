---
trigger: always_on
description: This service is being refactored to follow the **Well-Known Components (WKC)** pattern strictly. Apply these rules when adding or modifying code.
---
...
---
> Source: [decentraland/catalyst](https://github.com/decentraland/catalyst) — distributed by [TomeVault](https://tomevault.io).
