---
trigger: always_on
description: Project-specific instructions for AI agents working on this codebase.
---
...
---
> Source: [TryGhost/nodecmsguide](https://github.com/TryGhost/nodecmsguide) — distributed by [TomeVault](https://tomevault.io).
