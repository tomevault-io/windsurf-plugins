---
trigger: always_on
description: These instructions apply to work inside `type-exercise-starter/`.
---
...
- The untouched starter must remain a compiling crate. Published Checkpoint 1–10 ownership lives
  beside the actual implementation location: existing declarations carry checkpoint
  documentation, and future declarations/signatures remain commented until their chapter asks you
  to uncomment them. Checkpoint 10 List and async scaffolds remain commented until the final
  chapter asks you to implement them.
...
---
> Source: [skyzh/type-exercise-in-rust](https://github.com/skyzh/type-exercise-in-rust) — distributed by [TomeVault](https://tomevault.io).
