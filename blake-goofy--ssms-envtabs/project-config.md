---
trigger: always_on
description: SSMS EnvTabs is a Visual Studio Extension (VSIX) for SQL Server Management Studio (SSMS) 2017+ (shell-based). It groups and colors query tabs based on connection properties (Server/Database) defined in user configuration.
---
...
---
> Source: [Blake-goofy/SSMS-EnvTabs](https://github.com/Blake-goofy/SSMS-EnvTabs) — distributed by [TomeVault](https://tomevault.io).
