---
trigger: always_on
description: - Use [conventional commits](https://www.conventionalcommits.org/en/v1.0.0/) message format. Format: `<type>(<scope>): <description>`
---
...
---
> Source: [JaCraig/SQLParser](https://github.com/JaCraig/SQLParser) — distributed by [TomeVault](https://tomevault.io).
