---
trigger: always_on
description: A self-hosted MCP server that gives an MCP client read access to one or more IMAP
---
...
---
> Source: [wildsurfer/your-mail-mcp](https://github.com/wildsurfer/your-mail-mcp) — distributed by [TomeVault](https://tomevault.io).
