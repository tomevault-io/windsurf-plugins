...
Original source: `CLAUDE.md` in [evmts/guillotine](https://github.com/evmts/guillotine).
...
```
npx tomevault install evmts/guillotine
```
Source: [github.com/evmts/guillotine](https://github.com/evmts/guillotine).
