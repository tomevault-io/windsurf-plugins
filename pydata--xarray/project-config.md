---
trigger: always_on
description: xarray has many optional dependencies that may not be available in all testing environments. Always use the standard decorators and patterns when writing tests that require specific dependencies.
---
...
---
> Source: [pydata/xarray](https://github.com/pydata/xarray) — distributed by [TomeVault](https://tomevault.io).
