---
trigger: always_on
description: ODSBox is a lightweight Python wrapper for the [ASAM ODS HTTP API](https://www.asam.net/standards/detail/ods/wiki/).
---
...
---
> Source: [peak-solution/odsbox](https://github.com/peak-solution/odsbox) — distributed by [TomeVault](https://tomevault.io).
