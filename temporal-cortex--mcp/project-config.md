---
trigger: always_on
description: Public documentation repo for the Temporal Cortex MCP server (`@temporal-cortex/cortex-mcp`). Source code is in a private repository — this repo contains user-facing docs, setup guides, integration examples, directory configs, and the Dockerfile.
---
