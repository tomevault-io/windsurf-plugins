...
Original source: `copilot-instructions.md` in [maniaba/asset-connect](https://github.com/maniaba/asset-connect).
...
From [maniaba/asset-connect](https://github.com/maniaba/asset-connect) — a repo with 8+ stars on GitHub.
