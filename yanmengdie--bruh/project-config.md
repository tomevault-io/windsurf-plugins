---
trigger: always_on
description: `bruh/` contains the iOS app. Core models live in `bruh/Models`, networking in `bruh/Networking`, app logic in `bruh/Services`, and SwiftUI screens in `bruh/Views`. Assets and launch resources live under `bruh/Assets.xcassets` and `bruh/LaunchScreen.storyboard`.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/yanmengdie) — claim your Tome and manage your conversions.
