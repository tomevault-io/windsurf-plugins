---
trigger: always_on
description: **swarm** — A Claude Code plugin for multi-agent orchestration. Coordinates teams of agents with shared tasks, inter-agent messaging, and 7 proven patterns including RLM for large-file analysis.
---
...
---
> Source: [zircote-plugins/claude-team-orchestration](https://github.com/zircote-plugins/claude-team-orchestration) — distributed by [TomeVault](https://tomevault.io).
