---
trigger: always_on
description: 面向仓库的 AI 编程桌面工作台。Agent 循环、沙箱、会话在 npm 包 `tether-agent-core`；本仓库只做 Electron 壳和中文工作流界面。
---
...
---
> Source: [tt-11-dd/tether-ai](https://github.com/tt-11-dd/tether-ai) — distributed by [TomeVault](https://tomevault.io).
