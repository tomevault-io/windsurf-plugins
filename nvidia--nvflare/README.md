...
Original source: `AGENTS.md` in [NVIDIA/NVFlare](https://github.com/NVIDIA/NVFlare).
...
```
npx tomevault install NVIDIA/NVFlare
```
Source: [github.com/NVIDIA/NVFlare](https://github.com/NVIDIA/NVFlare).
