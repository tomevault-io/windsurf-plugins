...
Original source: `copilot-instructions.md` in [PointerIDE/Pointer](https://github.com/PointerIDE/Pointer).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/PointerIDE/Pointer](https://github.com/PointerIDE/Pointer)
