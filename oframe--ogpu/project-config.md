---
trigger: always_on
description: Shared agent guidance for this repo. `CLAUDE.md` / `GEMINI.md` / `.cursor/rules/main.mdc` are one-line imports of this file — edit here only.
---
...
---
> Source: [oframe/ogpu](https://github.com/oframe/ogpu) — distributed by [TomeVault](https://tomevault.io).
