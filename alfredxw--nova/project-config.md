---
trigger: always_on
description: 一个面向长篇小说创作的 AI 写作工作台，支持从灵感、设定、大纲、分卷、分章、细纲、正文到一致性检查的完整创作流程。
---
...
---
> Source: [alfredxw/nova](https://github.com/alfredxw/nova) — distributed by [TomeVault](https://tomevault.io).
