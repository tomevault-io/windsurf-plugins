---
trigger: always_on
description: This is bazel managed mono repo, focus on C++ code and Java code.
---
...
---
> Source: [bazelment/trunk](https://github.com/bazelment/trunk) — distributed by [TomeVault](https://tomevault.io).
