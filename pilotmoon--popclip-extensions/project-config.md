---
trigger: always_on
description: - `source/`: Official extensions, each in `Name.popclipext` with
---
...
---
> Source: [pilotmoon/PopClip-Extensions](https://github.com/pilotmoon/PopClip-Extensions) — distributed by [TomeVault](https://tomevault.io).
