---
trigger: always_on
description: > Fast parallel directory deletion for Windows using POSIX semantics
---
...
---
> Source: [zerx-lab/rmx](https://github.com/zerx-lab/rmx) — distributed by [TomeVault](https://tomevault.io).
