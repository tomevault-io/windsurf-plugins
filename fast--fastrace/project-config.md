---
trigger: always_on
description: - Fastrace is a high-performance tracing library focused on low overhead when disabled and fast collection when enabled. The workspace bundles the core tracer, a proc-macro, async/stream helpers, and reporters for Datadog, Jaeger, and OpenTelemetry.
---
...
---
> Source: [fast/fastrace](https://github.com/fast/fastrace) — distributed by [TomeVault](https://tomevault.io).
