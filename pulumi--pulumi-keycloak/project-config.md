---
trigger: always_on
description: The Pulumi keycloak provider is a Go-based Pulumi resource provider that bridges the Terraform provider to Pulumi. It generates SDKs for TypeScript/JavaScript, Python, .NET, Go, and Java. The provider uses the Terraform provider as an upstream source via git submodules.
---

# Pulumi keycloak Provider

The Pulumi keycloak provider is a Go-based Pulumi resource provider that bridges the Terraform provider to Pulumi. It generates SDKs for TypeScript/JavaScript, Python, .NET, Go, and Java. The provider uses the Terraform provider as an upstream source via git submodules.
...
---
> Source: [pulumi/pulumi-keycloak](https://github.com/pulumi/pulumi-keycloak) — distributed by [TomeVault](https://tomevault.io).
