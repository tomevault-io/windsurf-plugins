---
trigger: always_on
description: 1. Before committing changes, always run the tests and ESLint fix:
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/xafron-bv)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/xafron-bv)
