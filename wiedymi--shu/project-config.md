---
trigger: always_on
description: Before changing Shu, keep the implementation narrowly scoped and simplify it
---
...
---
> Source: [wiedymi/shu](https://github.com/wiedymi/shu) — distributed by [TomeVault](https://tomevault.io).
