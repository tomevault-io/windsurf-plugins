---
trigger: always_on
description: - Build debug app: `./gradlew assembleDebug`
---
...
---
> Source: [well-noted/TidWeb](https://github.com/well-noted/TidWeb) — distributed by [TomeVault](https://tomevault.io).
