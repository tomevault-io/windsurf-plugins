---
trigger: always_on
description: Pure-JavaScript X11 protocol client (and rudimentary server) for Node.js.
---
...
---
> Source: [sidorares/node-x11](https://github.com/sidorares/node-x11) — distributed by [TomeVault](https://tomevault.io).
