---
trigger: always_on
description: Ruta - A tiny type-safe client-side router for hono/jsx
---
...
---
> Source: [w3cj/ruta](https://github.com/w3cj/ruta) — distributed by [TomeVault](https://tomevault.io).
