---
trigger: always_on
description: For AI coding agents working in this dotfiles repository.
---
...
---
> Source: [treyhunner/dotfiles](https://github.com/treyhunner/dotfiles) — distributed by [TomeVault](https://tomevault.io).
