---
trigger: always_on
description: - `litecli/`: Core package. Entry point `main.py`, SQL execution in `sqlexecute.py`, completion in `packages/completion_engine.py`, special commands under `packages/special/`.
---
...
---
> Source: [dbcli/litecli](https://github.com/dbcli/litecli) — distributed by [TomeVault](https://tomevault.io).
