---
trigger: always_on
description: **trace.moe-api** is the core backend HTTP API server and data processing service for trace.moe (anime scene search engine).
---
...
- **Image & Media Processing**: `sharp`, `aniep`
...
├── dependency-check.ts          # Service health check script (PostgreSQL, Milvus)
...
---
> Source: [soruly/trace.moe-api](https://github.com/soruly/trace.moe-api) — distributed by [TomeVault](https://tomevault.io).
