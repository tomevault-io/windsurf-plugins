---
trigger: always_on
description: This project is a **Web Intelligence Data Pipeline** developed for the **CS313x – Information Retrieval & Data Analysis** course. It implements a data collection, processing, and analysis pipeline designed to collect, store, and understand web-based textual data.
---
...
---
> Source: [wildkemo/ir-project](https://github.com/wildkemo/ir-project) — distributed by [TomeVault](https://tomevault.io).
