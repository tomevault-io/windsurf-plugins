---
trigger: always_on
description: This is a full-stack TypeScript project that uses React for the frontend and Node.js/Express for the backend. It includes a simple API, frontend routing, and a database connection.
---
