---
trigger: always_on
description: - `cidre/` is the main Rust crate with source in `cidre/src`, examples in `cidre/examples`, benches in `cidre/benches`, and a `build.rs` for platform config.
---
...
---
> Source: [yury/cidre](https://github.com/yury/cidre) — distributed by [TomeVault](https://tomevault.io).
