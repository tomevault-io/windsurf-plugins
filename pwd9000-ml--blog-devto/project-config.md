---
trigger: always_on
description: - This repository publishes Markdown articles from `posts/<year>/<slug>/` to DEV.to. Each post folder is its source of truth.
---
...
---
> Source: [Pwd9000-ML/blog-devto](https://github.com/Pwd9000-ML/blog-devto) — distributed by [TomeVault](https://tomevault.io).
