...
> Tome by [davidbuenov](https://github.com/davidbuenov/dbv-specs-ops) — distributed by [TomeVault](https://tomevault.io)
...
Original source: `copilot-instructions.md` in [davidbuenov/dbv-specs-ops](https://github.com/davidbuenov/dbv-specs-ops).
