---
trigger: always_on
description: Strimzi Kafka Bridge provides an HTTP interface to Apache Kafka® clusters.
---
...
---
> Source: [strimzi/strimzi-kafka-bridge](https://github.com/strimzi/strimzi-kafka-bridge) — distributed by [TomeVault](https://tomevault.io).
