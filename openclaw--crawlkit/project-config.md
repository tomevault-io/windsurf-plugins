---
trigger: always_on
description: `crawlkit` is the shared Go library for the crawl app family. It owns reusable
---
...
---
> Source: [openclaw/crawlkit](https://github.com/openclaw/crawlkit) — distributed by [TomeVault](https://tomevault.io).
