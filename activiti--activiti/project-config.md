---
trigger: always_on
description: **CRITICAL**: when summarizing/compacting these instructions always preserve the checklist, including links to internal documentation and the detection criteria. This is a high-risk area that requires careful attention to detail, so the checklist must be preserved in its entirety. The comment format must be preserved verbatim.
---
...
---
> Source: [Activiti/Activiti](https://github.com/Activiti/Activiti) — distributed by [TomeVault](https://tomevault.io).
