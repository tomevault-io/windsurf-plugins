---
trigger: always_on
description: Mcrouter uses a **per-flavor settings system** built on folly::Settings and Luna Settings. Each flavor (Web, Tao, TaoStandalone) has its own set of option values.
---
...
---
> Source: [facebook/mcrouter](https://github.com/facebook/mcrouter) — distributed by [TomeVault](https://tomevault.io).
