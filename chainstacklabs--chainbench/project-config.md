---
trigger: always_on
description: This repository contains Chainbench, a blockchain infrastructure benchmarking tool built on Locust. When working on the project interactively with an agent (e.g. the Codex CLI) please follow the guidelines below for efficient development and testing.
---
...
---
> Source: [chainstacklabs/chainbench](https://github.com/chainstacklabs/chainbench) — distributed by [TomeVault](https://tomevault.io).
