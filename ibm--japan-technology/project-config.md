---
trigger: always_on
description: - **Environment variables ONLY**: Java apps use [`ClientsUtils.loadConfigFromEnv()`](../../code/payments-app/src/main/java/io/confluent/examples/datacontract/utils/ClientsUtils.java) - do NOT create .properties files, they are ignored
---
...
---
> Source: [IBM/japan-technology](https://github.com/IBM/japan-technology) — distributed by [TomeVault](https://tomevault.io).
