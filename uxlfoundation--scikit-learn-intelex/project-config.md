---
trigger: always_on
description: Build system configuration for Extension for scikit-learn using setup.py, conda, and environment variables.
---
...
---
> Source: [uxlfoundation/scikit-learn-intelex](https://github.com/uxlfoundation/scikit-learn-intelex) — distributed by [TomeVault](https://tomevault.io).
