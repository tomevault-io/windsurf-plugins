---
trigger: always_on
description: thumbor is a smart imaging HTTP service built with Python/Tornado. It resizes,
---
...
---
> Source: [thumbor/thumbor](https://github.com/thumbor/thumbor) — distributed by [TomeVault](https://tomevault.io).
