---
trigger: always_on
description: 如果你想把 MMDetection 修改为自己的项目，请遵循下面的约定。
---
...
---
> Source: [xuarehere/yolo_series_deepsort_pytorch](https://github.com/xuarehere/yolo_series_deepsort_pytorch) — distributed by [TomeVault](https://tomevault.io).
