---
trigger: always_on
description: > **Note**: While this legacy approach works, we strongly recommend using AReaL-lite for
---
...
---
> Source: [EvolvingLMMs-Lab/LLaVA-OneVision-1.5-RL](https://github.com/EvolvingLMMs-Lab/LLaVA-OneVision-1.5-RL) — distributed by [TomeVault](https://tomevault.io).
