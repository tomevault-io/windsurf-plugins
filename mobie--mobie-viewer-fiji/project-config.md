---
trigger: always_on
description: Guidance for coding agents working in `mobie-viewer-fiji`.
---
...
---
> Source: [mobie/mobie-viewer-fiji](https://github.com/mobie/mobie-viewer-fiji) — distributed by [TomeVault](https://tomevault.io).
