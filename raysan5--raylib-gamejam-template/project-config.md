---
trigger: always_on
description: Code element | Convention | Example
---
...
---
> Source: [raysan5/raylib-gamejam-template](https://github.com/raysan5/raylib-gamejam-template) — distributed by [TomeVault](https://tomevault.io).
