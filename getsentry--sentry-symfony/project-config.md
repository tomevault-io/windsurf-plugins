---
trigger: always_on
description: - `sentry/sentry-symfony` is a Composer library and Symfony bundle, not an
---
...
---
> Source: [getsentry/sentry-symfony](https://github.com/getsentry/sentry-symfony) — distributed by [TomeVault](https://tomevault.io).
