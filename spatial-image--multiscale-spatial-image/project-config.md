---
trigger: always_on
description: This library generates multiscale, chunked, multi-dimensional spatial image data
---
...
---
> Source: [spatial-image/multiscale-spatial-image](https://github.com/spatial-image/multiscale-spatial-image) — distributed by [TomeVault](https://tomevault.io).
