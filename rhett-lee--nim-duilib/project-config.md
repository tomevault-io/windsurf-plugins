---
trigger: always_on
description: nim_duilib 是基于 Skia 渲染引擎的跨平台 C++ UI 框架，采用 XML 描述界面布局 + C++ 控制逻辑的开发模式。
---
...
---
> Source: [rhett-lee/nim_duilib](https://github.com/rhett-lee/nim_duilib) — distributed by [TomeVault](https://tomevault.io).
