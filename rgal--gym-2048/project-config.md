---
trigger: always_on
description: - Use `git mv <old> <new>` for all file moves and renames
---
...
---
> Source: [rgal/gym-2048](https://github.com/rgal/gym-2048) — distributed by [TomeVault](https://tomevault.io).
