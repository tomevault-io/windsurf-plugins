---
trigger: always_on
description: Thorium is split into separate Webpack/Electron runtime bundles. Treat each bundle as an isolated runtime island. Runtime code must not import source from another runtime directly. Shared contracts, types, actions, and utilities must be moved to a common/shared area first.
---
...
---
> Source: [edrlab/thorium-reader](https://github.com/edrlab/thorium-reader) — distributed by [TomeVault](https://tomevault.io).
