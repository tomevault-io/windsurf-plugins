---
trigger: always_on
description: Use this extension when the user wants to turn a product brief, mockup, or UI idea into a generated screen, a refined screen edit, or a set of visual variants with local HTML and screenshots.
---
