---
trigger: always_on
description: gtp2ogs is a bridge that allows Go bots using the GTP (Go Text Protocol) to connect to and play games on the OGS (Online-Go.com) platform. The tool spawns and manages bot processes, handles websocket communication with OGS servers, translates between GTP commands and OGS game state, and manages concurrent games.
---
...
---
> Source: [online-go/gtp2ogs](https://github.com/online-go/gtp2ogs) — distributed by [TomeVault](https://tomevault.io).
