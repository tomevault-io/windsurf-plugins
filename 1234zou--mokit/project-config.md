---
trigger: always_on
description: - This guide is only for unit tests under `test/unit/`.
---
...
---
> Source: [1234zou/MOKIT](https://github.com/1234zou/MOKIT) — distributed by [TomeVault](https://tomevault.io).
