---
trigger: always_on
description: This repository is a public, English-language project. Keep all code, comments,
---
...
---
> Source: [yurilopes/Copilot-Tools-Gateway](https://github.com/yurilopes/Copilot-Tools-Gateway) — distributed by [TomeVault](https://tomevault.io).
