---
trigger: always_on
description: - `evalview/`: Python package and CLI (`cli.py`). Modules: `adapters/` (framework integrations), `core/` (types, loader, pricing), `evaluators/` (cost, latency, output, sequence), `reporters/` (console, JSON).
---
