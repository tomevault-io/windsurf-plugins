---
trigger: always_on
description: Qrono is a tiny JavaScript date library with immutable, chainable APIs, UTC-first behavior, local-time support, and strict daylight saving time handling.
---
