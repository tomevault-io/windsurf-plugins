---
trigger: always_on
description: Root-scope guide for AI agents working in `blueprint`.
---
...
---
> Source: [jacob-bytes/komari-theme-blueprint](https://github.com/jacob-bytes/komari-theme-blueprint) — distributed by [TomeVault](https://tomevault.io).
