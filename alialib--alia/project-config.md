---
trigger: always_on
description: The project is undergoing a transition from a pure C++ library to one that has
---
...
---
> Source: [alialib/alia](https://github.com/alialib/alia) — distributed by [TomeVault](https://tomevault.io).
