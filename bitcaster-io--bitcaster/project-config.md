---
trigger: always_on
description: Bitcaster is a system-to-user notification platform. For detailed guidance, refer to the modular instruction files in the `.ai/` directory:
---
...
---
> Source: [bitcaster-io/bitcaster](https://github.com/bitcaster-io/bitcaster) — distributed by [TomeVault](https://tomevault.io).
