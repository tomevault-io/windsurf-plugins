---
trigger: always_on
description: This guide is the primary instruction file for AI coding agents working in this
---
...
---
> Source: [kubernetes-sigs/cluster-api-provider-aws](https://github.com/kubernetes-sigs/cluster-api-provider-aws) — distributed by [TomeVault](https://tomevault.io).
