---
trigger: always_on
description: Guidance for Claude Code (claude.ai/code) when working in this repository (the Better Uptime Terraform provider).
---
...
---
> Source: [BetterStackHQ/terraform-provider-better-uptime](https://github.com/BetterStackHQ/terraform-provider-better-uptime) — distributed by [TomeVault](https://tomevault.io).
