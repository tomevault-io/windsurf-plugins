---
trigger: always_on
description: AI must not be used to generate code for contributions to this project.
---
...
compatible with the MIT license, or may introduce conflicting license terms
...
---
> Source: [CANopenTerm/CANopenTerm](https://github.com/CANopenTerm/CANopenTerm) — distributed by [TomeVault](https://tomevault.io).
