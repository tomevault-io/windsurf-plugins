---
trigger: always_on
description: Context for AI coding assistants (Claude Code, Cursor, etc.) working in this repo. For human contributors, start with the [README](README.md) and [CONTRIBUTING.md](CONTRIBUTING.md).
---
...
---
> Source: [EryouHao/zano](https://github.com/EryouHao/zano) — distributed by [TomeVault](https://tomevault.io).
