---
trigger: always_on
description: - Run `pnpm run fix` before every commit
---
...
---
> Source: [wiebekaai/browser-annotations](https://github.com/wiebekaai/browser-annotations) — distributed by [TomeVault](https://tomevault.io).
