---
trigger: always_on
description: - `main.py`: app entrypoint.
---
...
---
> Source: [BetaStreetOmnis/xhs_ai_publisher](https://github.com/BetaStreetOmnis/xhs_ai_publisher) — distributed by [TomeVault](https://tomevault.io).
