---
trigger: always_on
description: - read all docs (cat docs/-.md) before coding
---
...
---
> Source: [openlibrecommunity/olcrtc](https://github.com/openlibrecommunity/olcrtc) — distributed by [TomeVault](https://tomevault.io).
