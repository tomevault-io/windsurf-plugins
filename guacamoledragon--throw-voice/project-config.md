---
trigger: always_on
description: To bump the version (e.g. `v2.16.0` → `v2.17.0`), update the version number in the following files:
---
...
---
> Source: [guacamoledragon/throw-voice](https://github.com/guacamoledragon/throw-voice) — distributed by [TomeVault](https://tomevault.io).
