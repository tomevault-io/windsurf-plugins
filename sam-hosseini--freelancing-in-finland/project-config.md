---
trigger: always_on
description: - `npm run build` - Generate TOC and contributors list
---
...
---
> Source: [sam-hosseini/freelancing-in-finland](https://github.com/sam-hosseini/freelancing-in-finland) — distributed by [TomeVault](https://tomevault.io).
