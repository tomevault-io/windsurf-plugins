---
trigger: always_on
description: Supplements the repo-root `AGENTS.md`. Run all commands from
---
...
---
> Source: [quasarframework/quasar](https://github.com/quasarframework/quasar) — distributed by [TomeVault](https://tomevault.io).
