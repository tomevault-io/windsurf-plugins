---
trigger: always_on
description: Minimal router — the linked docs are the source of truth.
---
...
---
> Source: [infinitered/reactotron](https://github.com/infinitered/reactotron) — distributed by [TomeVault](https://tomevault.io).
