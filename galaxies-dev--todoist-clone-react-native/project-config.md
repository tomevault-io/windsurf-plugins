---
trigger: always_on
description: You are an expert in JavaScript, React Native, Expo, and Mobile UI development.
---
  ...
  File Structure:
  - app: Contains the main app logic, hooks, and components.
...
---
> Source: [Galaxies-dev/todoist-clone-react-native](https://github.com/Galaxies-dev/todoist-clone-react-native) — distributed by [TomeVault](https://tomevault.io).
