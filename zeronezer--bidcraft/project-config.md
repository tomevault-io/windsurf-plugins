---
trigger: always_on
description: > 本文件面向 AI 编程助手（Claude Code、Codex、Cursor、Trae、Windsurf、Cline、WorkBuddy 等）。
---
...
---
> Source: [zeronezer/bidcraft](https://github.com/zeronezer/bidcraft) — distributed by [TomeVault](https://tomevault.io).
