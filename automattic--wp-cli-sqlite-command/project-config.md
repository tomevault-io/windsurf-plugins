---
trigger: always_on
description: WP-CLI package for importing and exporting SQLite databases, used by WordPress Studio to power the Import, Export, and Sync features.
---
...
---
> Source: [Automattic/wp-cli-sqlite-command](https://github.com/Automattic/wp-cli-sqlite-command) — distributed by [TomeVault](https://tomevault.io).
