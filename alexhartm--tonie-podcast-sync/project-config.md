---
trigger: always_on
description: tonie-podcast-sync is a Python package that syncs podcast episodes to creative tonies (Toniebox). It downloads podcast episodes and uploads them to Tonie Cloud, which then syncs to physical Tonie figurines.
---
...
---
> Source: [alexhartm/tonie-podcast-sync](https://github.com/alexhartm/tonie-podcast-sync) — distributed by [TomeVault](https://tomevault.io).
