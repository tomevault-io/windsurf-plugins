---
trigger: always_on
description: The canonical project context for this repository: what is true only here. Shared guidance arrives through the Cratis AI profiles recorded in `.cratis/ai.json`.
---

# Chronicle — project context

The canonical project context for this repository: what is true only here. Shared guidance arrives through the Cratis AI profiles recorded in `.cratis/ai.json`.
