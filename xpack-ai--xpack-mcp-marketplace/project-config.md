---
trigger: always_on
description: - `admin_service` and `api_service` are independent of each other, both depend on `common`
---
...
---
> Source: [xpack-ai/XPack-MCP-Marketplace](https://github.com/xpack-ai/XPack-MCP-Marketplace) — distributed by [TomeVault](https://tomevault.io).
