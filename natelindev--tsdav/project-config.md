---
trigger: always_on
description: Guidance for AI coding agents working in this repository. The architecture overview lives in `docs/agent-architecture-overview.md`.
---
...
---
> Source: [natelindev/tsdav](https://github.com/natelindev/tsdav) — distributed by [TomeVault](https://tomevault.io).
