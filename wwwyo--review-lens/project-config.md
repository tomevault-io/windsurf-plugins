---
trigger: always_on
description: Devin Review的なAIコードレビュー体験をローカルで実現するデスクトップアプリ。Claude Code CLIをサブスクリプションで利用し、APIコストを回避する。
---
...
---
> Source: [wwwyo/review-lens](https://github.com/wwwyo/review-lens) — distributed by [TomeVault](https://tomevault.io).
