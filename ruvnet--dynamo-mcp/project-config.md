...
- Use the harness's MCP tools (`mcp__dynamo-mcp-agent__*`) for orchestration
...
---
> Source: [ruvnet/dynamo-mcp](https://github.com/ruvnet/dynamo-mcp) — distributed by [TomeVault](https://tomevault.io).
