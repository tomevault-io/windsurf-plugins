---
trigger: always_on
description: - **Never use `panic!()`, `unwrap()`, `todo!()`, or `unimplemented!()` in production code.**
---
...
---
> Source: [input-output-hk/mithril](https://github.com/input-output-hk/mithril) — distributed by [TomeVault](https://tomevault.io).
