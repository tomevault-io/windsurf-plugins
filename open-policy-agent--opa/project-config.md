---
trigger: always_on
description: This file is here to steer AI assisted PRs to Open Policy Agent (OPA) towards
---
...
---
> Source: [open-policy-agent/opa](https://github.com/open-policy-agent/opa) — distributed by [TomeVault](https://tomevault.io).
