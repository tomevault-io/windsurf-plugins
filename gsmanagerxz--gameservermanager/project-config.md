---
trigger: always_on
description: 1. 将服务端所有需要保存的数据统一保存在server\data 目录下
---
...
---
> Source: [GSManagerXZ/GameServerManager](https://github.com/GSManagerXZ/GameServerManager) — distributed by [TomeVault](https://tomevault.io).
