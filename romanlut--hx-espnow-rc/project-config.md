---
trigger: always_on
description: - Never run PlatformIO build, clean, or upload operations concurrently. They share packages, build outputs, and serial ports.
---
...
---
> Source: [RomanLut/hx_espnow_rc](https://github.com/RomanLut/hx_espnow_rc) — distributed by [TomeVault](https://tomevault.io).
