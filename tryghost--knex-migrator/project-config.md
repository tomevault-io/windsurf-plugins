---
trigger: always_on
description: `knex-migrator` is a CommonJS Node package and CLI for Knex-backed database
---
...
---
> Source: [TryGhost/knex-migrator](https://github.com/TryGhost/knex-migrator) — distributed by [TomeVault](https://tomevault.io).
