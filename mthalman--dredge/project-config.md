---
trigger: always_on
description: Dredge is a .NET CLI tool for executing read-only commands against container registry HTTP APIs (OCI Distribution Spec). It's published as both a standalone executable and a .NET global tool (`Valleysoft.Dredge`).
---
...
---
> Source: [mthalman/dredge](https://github.com/mthalman/dredge) — distributed by [TomeVault](https://tomevault.io).
