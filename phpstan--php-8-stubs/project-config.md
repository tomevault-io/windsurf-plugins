---
trigger: always_on
description: This is `phpstan/php-8-stubs` — a repository of PHP stub files automatically extracted from [php-src](https://github.com/php/php-src/). PHPStan uses these stubs to understand the signatures of built-in PHP classes and functions when analysing codebases running PHP 8.0 and later.
---
...
---
> Source: [phpstan/php-8-stubs](https://github.com/phpstan/php-8-stubs) — distributed by [TomeVault](https://tomevault.io).
