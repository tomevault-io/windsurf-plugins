---
trigger: always_on
description: This is a **pnpm monorepo** for a VitePress-based blog ecosystem. There are no automated tests (no vitest/jest). There are no databases or external services required for local development.
---
...
---
> Source: [ATQQ/sugar-blog](https://github.com/ATQQ/sugar-blog) — distributed by [TomeVault](https://tomevault.io).
