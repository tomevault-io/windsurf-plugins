---
trigger: always_on
description: webexec is a terminal server running over WebRTC with support for
---
...
---
> Source: [tuzig/webexec](https://github.com/tuzig/webexec) — distributed by [TomeVault](https://tomevault.io).
