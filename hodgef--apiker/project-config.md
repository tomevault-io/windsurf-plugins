---
trigger: always_on
description: Guidance for AI agents working in the **Apiker** repository. Read this first, then load
---
...
---
> Source: [hodgef/apiker](https://github.com/hodgef/apiker) — distributed by [TomeVault](https://tomevault.io).
