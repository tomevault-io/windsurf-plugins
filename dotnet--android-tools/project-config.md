---
trigger: always_on
description: Shared .NET libraries for Android SDK/JDK discovery and MSBuild task infrastructure, consumed by [dotnet/android](https://github.com/dotnet/android) and IDE extensions.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/dotnet)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/dotnet)
