---
trigger: always_on
description: `go-matter` implements Matter Specification Version 1.5. Code comments cite relevant spec sections (e.g., `// 2.5.2. Vendor Identifier`). The implementation is based on the official C++ reference: https://github.com/project-chip/connectedhomeip.
---
...
---
> Source: [cybergarage/go-matter](https://github.com/cybergarage/go-matter) — distributed by [TomeVault](https://tomevault.io).
