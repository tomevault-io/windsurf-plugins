---
trigger: always_on
description: - 用中文回复；代码注释用英文，注释写 why 不写 how。
---
...
---
> Source: [Compilation-Working-Group/sublink-worker](https://github.com/Compilation-Working-Group/sublink-worker) — distributed by [TomeVault](https://tomevault.io).
