---
trigger: always_on
description: **twampy** is a Python implementation of TWAMP/TWAMP-light (RFC 5357) and STAMP (RFC 8762) for network latency measurement and validation of Nokia SR OS and SR Linux TWAMP/STAMP implementations.
---
...
---
> Source: [nokia/twampy](https://github.com/nokia/twampy) — distributed by [TomeVault](https://tomevault.io).
