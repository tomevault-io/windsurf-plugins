---
trigger: always_on
description: 1. Implement the **step** function in distar/agent/template/agent.py.
---
...
---
> Source: [opendilab/DI-star](https://github.com/opendilab/DI-star) — distributed by [TomeVault](https://tomevault.io).
