---
trigger: always_on
description: IPX — image optimizer (library + `ipx` CLI) powered by [sharp](https://sharp.pixelplumbing.com/) and [svgo](https://github.com/svg/svgo). This branch is **v4 (alpha)**; `v3` lives on its own branch.
---
...
---
> Source: [unjs/ipx](https://github.com/unjs/ipx) — distributed by [TomeVault](https://tomevault.io).
