---
trigger: always_on
description: HTMLを最終成果物にするagent workflow向けの共通plugin。図示つきHTML生成、Preview Runtime、HTML上のレビューコメント、コメント取り込み、agent返信、設計反映を扱う。
---
...
---
> Source: [u-ichi/reviewable-html-workbench](https://github.com/u-ichi/reviewable-html-workbench) — distributed by [TomeVault](https://tomevault.io).
