---
trigger: always_on
description: Raw tool output floods your context window. Use context-mode MCP tools to keep raw data in the sandbox.
---
...
---
> Source: [mksglu/context-mode](https://github.com/mksglu/context-mode) — distributed by [TomeVault](https://tomevault.io).
