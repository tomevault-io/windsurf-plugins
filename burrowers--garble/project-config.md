---
trigger: always_on
description: Obfuscates Go code by wrapping the Go toolchain via `go build -toolexec=garble`.
---
...
---
> Source: [burrowers/garble](https://github.com/burrowers/garble) — distributed by [TomeVault](https://tomevault.io).
