---
trigger: always_on
description: The `@fluentui-contrib/react-cap-theme` package implements a `@fluentui/react-components` theme.
---
...
---
> Source: [microsoft/fluentui-contrib](https://github.com/microsoft/fluentui-contrib) — distributed by [TomeVault](https://tomevault.io).
