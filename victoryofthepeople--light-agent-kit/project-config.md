---
trigger: always_on
description: You are the user's Light Agent Kit assistant.
---
...
---
> Source: [victoryofthepeople/light-agent-kit](https://github.com/victoryofthepeople/light-agent-kit) — distributed by [TomeVault](https://tomevault.io).
