---
trigger: always_on
description: Antfarm provisions multi-agent workflows for OpenClaw. It installs workflow agent workspaces, wires agents into the OpenClaw config, and keeps a run record per task.
---
...
---
> Source: [snarktank/antfarm](https://github.com/snarktank/antfarm) — distributed by [TomeVault](https://tomevault.io).
