---
trigger: always_on
description: Comprehensive guidance for AI contributions to the Windows App SDK.
---
...
---
> Source: [microsoft/WindowsAppSDK](https://github.com/microsoft/WindowsAppSDK) — distributed by [TomeVault](https://tomevault.io).
