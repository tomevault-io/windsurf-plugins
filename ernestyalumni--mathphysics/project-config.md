---
trigger: always_on
description: This file is the entry-point for AI agents working in this repo. It's auto-loaded by Hermes (when `terminal.cwd` is here), Claude Code, Codex, and other AGENTS.md-aware tools.
---
...
---
> Source: [ernestyalumni/mathphysics](https://github.com/ernestyalumni/mathphysics) — distributed by [TomeVault](https://tomevault.io).
