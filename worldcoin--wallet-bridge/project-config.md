---
trigger: always_on
description: Read `README.md` first. It defines the bridge; every change must preserve these invariants:
---
...
---
> Source: [worldcoin/wallet-bridge](https://github.com/worldcoin/wallet-bridge) — distributed by [TomeVault](https://tomevault.io).
