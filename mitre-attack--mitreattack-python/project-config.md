---
trigger: always_on
description: - Core package code lives in `mitreattack/`.
---
...
---
> Source: [mitre-attack/mitreattack-python](https://github.com/mitre-attack/mitreattack-python) — distributed by [TomeVault](https://tomevault.io).
