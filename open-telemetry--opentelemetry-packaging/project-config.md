---
trigger: always_on
description: This repository builds Linux system packages (DEB and RPM) for the OpenTelemetry auto-instrumentation suite.
---
...
---
> Source: [open-telemetry/opentelemetry-packaging](https://github.com/open-telemetry/opentelemetry-packaging) — distributed by [TomeVault](https://tomevault.io).
