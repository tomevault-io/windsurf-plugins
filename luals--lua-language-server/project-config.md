---
trigger: always_on
description: - Windows PowerShell 默认编码为 GBK/UTF-16 LE，**严禁**写入项目文件时不指定编码（会导致 UTF8 文件乱码）
---
...
---
> Source: [LuaLS/lua-language-server](https://github.com/LuaLS/lua-language-server) — distributed by [TomeVault](https://tomevault.io).
