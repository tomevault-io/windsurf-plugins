---
trigger: always_on
description: Microsoft.Diagnostics.Runtime (ClrMD) is a .NET library for inspecting crash dumps and live processes. It provides programmatic access to CLR internals (heap, types, threads, GC roots, exceptions) similar to SOS debugging extensions.
---
...
---
> Source: [microsoft/clrmd](https://github.com/microsoft/clrmd) — distributed by [TomeVault](https://tomevault.io).
