---
trigger: always_on
description: Important context for AI coding agents working on this project.
---
...
---
> Source: [wagtail/guide](https://github.com/wagtail/guide) — distributed by [TomeVault](https://tomevault.io).
