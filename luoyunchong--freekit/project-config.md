---
trigger: always_on
description: dotnet restore FreeKit.sln
---
...
- `IGeekFan.FreeKit.Sample` — main demo app (ASP.NET Core Web, SQLite + multiple DB providers, JWT auth, Swagger)
...
---
> Source: [luoyunchong/FreeKit](https://github.com/luoyunchong/FreeKit) — distributed by [TomeVault](https://tomevault.io).
