---
trigger: always_on
description: - **Primary Tenant Model**: `App\Models\Team` (stored in `team_id` columns)
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/AqibUllah)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/AqibUllah)
