---
trigger: always_on
description: This skill enables **Claude to call `codex exec`** for high-reasoning tasks. It is NOT a comprehensive Codex manual.
---
...
---
> Source: [wywwzjj/cc-skill-codex](https://github.com/wywwzjj/cc-skill-codex) — distributed by [TomeVault](https://tomevault.io).
