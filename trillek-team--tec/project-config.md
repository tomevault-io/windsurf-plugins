---
trigger: always_on
description: **Before doing ANY work, read `AGENTS.md` completely.** It contains:
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/trillek-team)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/trillek-team)
