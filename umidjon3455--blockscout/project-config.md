---
trigger: always_on
description: Blockscout supports running as a single combined application or as separate API and indexer instances via the `APPLICATION_MODE` environment variable.
---
