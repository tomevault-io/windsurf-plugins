---
trigger: always_on
description: Telegram Mini App for two-factor authentication (TOTP). Fully client-side, no backend.
---
...
---
> Source: [yankovichv/authenticator.tg](https://github.com/yankovichv/authenticator.tg) — distributed by [TomeVault](https://tomevault.io).
