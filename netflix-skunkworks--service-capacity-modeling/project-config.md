---
trigger: always_on
description: - Baseline JSON files under `service_capacity_modeling/tools/data/` are generated fixtures.
---
...
---
> Source: [Netflix-Skunkworks/service-capacity-modeling](https://github.com/Netflix-Skunkworks/service-capacity-modeling) — distributed by [TomeVault](https://tomevault.io).
