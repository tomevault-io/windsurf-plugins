---
trigger: always_on
description: Markito is a Go web application for editing and sharing Markdown documents. It uses:
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/paganotoni)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/paganotoni)
