...
```
npx tomevault install dedalus-labs/dedalus-mcp-python
```
Source: [github.com/dedalus-labs/dedalus-mcp-python](https://github.com/dedalus-labs/dedalus-mcp-python).
