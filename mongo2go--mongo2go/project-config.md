---
trigger: always_on
description: Mongo2Go ships **executable MongoDB binaries** (`mongod`, `mongoimport`, `mongoexport`) inside its
---
...
---
> Source: [Mongo2Go/Mongo2Go](https://github.com/Mongo2Go/Mongo2Go) — distributed by [TomeVault](https://tomevault.io).
