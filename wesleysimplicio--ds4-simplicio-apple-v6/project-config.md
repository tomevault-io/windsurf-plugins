---
trigger: always_on
description: > Espelho slim de [../AGENTS.md](../AGENTS.md) pro GitHub Copilot (Chat + Workspace + CLI). Quando GitHub Copilot abre este repositório, lê este arquivo e segue as mesmas regras de [`AGENTS.md`](../AGENTS.md). Para detalhes completos: ler `AGENTS.md`.
---
...
---
> Source: [wesleysimplicio/ds4-simplicio-apple-v6](https://github.com/wesleysimplicio/ds4-simplicio-apple-v6) — distributed by [TomeVault](https://tomevault.io).
