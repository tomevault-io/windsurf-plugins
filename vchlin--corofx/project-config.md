---
trigger: always_on
description: Follow C++ Core Guidelines with an emphasis on consistency,
---
...
---
> Source: [vchlin/corofx](https://github.com/vchlin/corofx) — distributed by [TomeVault](https://tomevault.io).
