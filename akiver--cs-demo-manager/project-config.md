---
trigger: always_on
description: CS Demo Manager is a cross-platform Electron desktop application and CLI for analyzing Counter-Strike (CS2 / CS:GO) demo
---
...
---
> Source: [akiver/cs-demo-manager](https://github.com/akiver/cs-demo-manager) — distributed by [TomeVault](https://tomevault.io).
