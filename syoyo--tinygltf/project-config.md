---
trigger: always_on
description: TinyGLTF v3 C (`tiny_gltf_v3.h` + `tiny_gltf_v3.c` + `tinygltf_json_c.h`) is the
---
...
---
> Source: [syoyo/tinygltf](https://github.com/syoyo/tinygltf) — distributed by [TomeVault](https://tomevault.io).
