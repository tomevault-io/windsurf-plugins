---
trigger: always_on
description: When importing, import classes directly. For functions, import the containing module and call the function using dot notation.
---
...
---
> Source: [lightly-ai/labelformat](https://github.com/lightly-ai/labelformat) — distributed by [TomeVault](https://tomevault.io).
