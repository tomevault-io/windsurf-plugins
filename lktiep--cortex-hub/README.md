...
Original source: `.cursor/rules/*.mdc` in [lktiep/cortex-hub](https://github.com/lktiep/cortex-hub).
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/lktiep/cortex-hub](https://github.com/lktiep/cortex-hub)
