---
trigger: always_on
description: - **Frontend** (`frontend/`): Next.js 16, React 19, Tailwind 4. Pure UI — no server-side auth logic.
---
...
---
> Source: [tinyfish-io/bigset](https://github.com/tinyfish-io/bigset) — distributed by [TomeVault](https://tomevault.io).
