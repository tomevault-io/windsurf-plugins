---
trigger: always_on
description: Primary instruction source: [`AGENTS.md`](../AGENTS.md)
---
...
---
> Source: [Codeneos/vlocode](https://github.com/Codeneos/vlocode) — distributed by [TomeVault](https://tomevault.io).
