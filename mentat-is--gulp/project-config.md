---
trigger: always_on
description: gULP is a Python FastAPI service + workers that stores documents in OpenSearch and keeps collaboration metadata in PostgreSQL; Redis is used for the task queue & pub/sub. (see `docs/architecture.md`).
---
...
---
> Source: [mentat-is/gulp](https://github.com/mentat-is/gulp) — distributed by [TomeVault](https://tomevault.io).
