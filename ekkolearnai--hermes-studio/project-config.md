---
trigger: always_on
description: This file is a short map for coding agents. Keep detailed guidance in `docs/`
---
...
---
> Source: [EKKOLearnAI/hermes-studio](https://github.com/EKKOLearnAI/hermes-studio) — distributed by [TomeVault](https://tomevault.io).
