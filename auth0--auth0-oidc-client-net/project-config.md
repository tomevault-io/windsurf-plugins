---
trigger: always_on
description: src/Auth0.OidcClient.MAUI.Platforms.Windows/
---
...
---
> Source: [auth0/auth0-oidc-client-net](https://github.com/auth0/auth0-oidc-client-net) — distributed by [TomeVault](https://tomevault.io).
