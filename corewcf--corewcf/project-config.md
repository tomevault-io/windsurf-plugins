---
trigger: always_on
description: CoreWCF is a port of the server-side of Windows Communication Foundation (WCF) to .NET Core. It enables existing WCF services to migrate to modern .NET.
---
...
---
> Source: [CoreWCF/CoreWCF](https://github.com/CoreWCF/CoreWCF) — distributed by [TomeVault](https://tomevault.io).
