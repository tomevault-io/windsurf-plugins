---
trigger: always_on
description: Add new resources to `README.md`, under the most relevant existing section. Keep the entry to one Markdown bullet and follow the style of the surrounding examples.
---
...
---
> Source: [satellite-image-deep-learning/software](https://github.com/satellite-image-deep-learning/software) — distributed by [TomeVault](https://tomevault.io).
