---
trigger: always_on
description: This is the **OpenAPI Initiative Courses** repository, which provides educational materials about OpenAPI. It's primarily a documentation and tutorial repository focused on teaching OpenAPI v3.1 fundamentals.
---
...
---
> Source: [OAI/OAI-Courses](https://github.com/OAI/OAI-Courses) — distributed by [TomeVault](https://tomevault.io).
