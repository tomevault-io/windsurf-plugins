---
trigger: always_on
description: Entry document for any AI coding agent reading this repository — Cursor, Codex,
---
...
---
> Source: [vouchdev/vouch](https://github.com/vouchdev/vouch) — distributed by [TomeVault](https://tomevault.io).
