---
trigger: always_on
description: - All new styles must be added to existing CSS files, often in `editor.css` (not in JS files).
---
...
---
> Source: [JuliaPluto/Pluto.jl](https://github.com/JuliaPluto/Pluto.jl) — distributed by [TomeVault](https://tomevault.io).
