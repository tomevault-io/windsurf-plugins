---
trigger: always_on
description: In BALROG, agents are entities that typically wrap an LLM client. They are responsible for receiving observations and selecting actions. As such, agents are internally responsible for:
---
...
---
> Source: [balrog-ai/BALROG](https://github.com/balrog-ai/BALROG) — distributed by [TomeVault](https://tomevault.io).
