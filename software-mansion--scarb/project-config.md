---
trigger: always_on
description: - This project uses stacked PRs managed with `git spr` or `git spice`. Before starting work, check whether the current branch is part of a stacked PR setup, for example with `git log --oneline main..HEAD` and local `spr` or `spice` config.
---
...
---
> Source: [software-mansion/scarb](https://github.com/software-mansion/scarb) — distributed by [TomeVault](https://tomevault.io).
