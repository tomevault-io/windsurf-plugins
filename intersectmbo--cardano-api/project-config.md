---
trigger: always_on
description: Multiple Haskell modules may share the same qualified alias:
---
...
---
> Source: [IntersectMBO/cardano-api](https://github.com/IntersectMBO/cardano-api) — distributed by [TomeVault](https://tomevault.io).
