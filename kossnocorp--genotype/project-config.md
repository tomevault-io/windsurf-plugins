---
trigger: always_on
description: When you try to make a change and it breaks something in unexpected ways, handle it using the following algorithm:
---
...
---
> Source: [kossnocorp/genotype](https://github.com/kossnocorp/genotype) — distributed by [TomeVault](https://tomevault.io).
