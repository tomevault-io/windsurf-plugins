---
trigger: always_on
description: **QLExpress** 是阿里巴巴开源的一个轻量级、高性能的动态语言引擎，基于 Java 8+ 开发，专为业务规则引擎和动态表达式设计。
---
...
---
> Source: [alibaba/QLExpress](https://github.com/alibaba/QLExpress) — distributed by [TomeVault](https://tomevault.io).
