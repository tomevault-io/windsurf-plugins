---
trigger: always_on
description: 브라우저 확장(Manifest V3, Chrome/Edge/Firefox). 마우스오버/드래그 번역 툴팁, 이중 자막, PDF/EPUB 뷰어, OCR, TTS, 음성 인식 번역을 제공한다. 팝업/설정 UI는 **Vue 3 + Vuetify 3**, 번들러는 **webpack**.
---
...
---
> Source: [ttop32/MouseTooltipTranslator](https://github.com/ttop32/MouseTooltipTranslator) — distributed by [TomeVault](https://tomevault.io).
