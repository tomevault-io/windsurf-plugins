---
trigger: always_on
description: Podman Desktop is an Electron desktop app for managing containers and Kubernetes, built with Svelte 5+, TypeScript, and Tailwind CSS 4+. It supports Podman, Docker, Lima, and CRC engines via a plugin-based extension system.
---
...
---
> Source: [podman-desktop/podman-desktop](https://github.com/podman-desktop/podman-desktop) — distributed by [TomeVault](https://tomevault.io).
