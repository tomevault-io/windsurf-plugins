---
trigger: always_on
description: Monorepo for the Marko Language Server and related tooling. Four npm workspaces under `packages/`:
---
...
---
> Source: [marko-js/language-server](https://github.com/marko-js/language-server) — distributed by [TomeVault](https://tomevault.io).
