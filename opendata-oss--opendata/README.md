...
Original source: `AGENTS.md` in [opendata-oss/opendata](https://github.com/opendata-oss/opendata).
...
```
npx tomevault install opendata-oss/opendata
```
Source: [github.com/opendata-oss/opendata](https://github.com/opendata-oss/opendata).
