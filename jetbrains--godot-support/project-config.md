---
trigger: always_on
description: Project-specific development guidelines for gdscript module (JetBrains Godot plugin)
---
...
---
> Source: [JetBrains/godot-support](https://github.com/JetBrains/godot-support) — distributed by [TomeVault](https://tomevault.io).
