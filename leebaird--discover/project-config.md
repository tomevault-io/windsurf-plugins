---
trigger: always_on
description: Conventions agreed with the operator for Discover development. **Read and follow this file.** When we discuss and agree on a durable rule (layout, install order, Update UX, host-scan gating, etc.), **add or update it here** in the same change set when practical—do not leave it only in chat history.
---
...
---
> Source: [leebaird/discover](https://github.com/leebaird/discover) — distributed by [TomeVault](https://tomevault.io).
