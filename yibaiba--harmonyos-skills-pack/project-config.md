---
trigger: always_on
description: 本文件为 Codex/通用 Coding Agent 的仓库入口说明。
---
...
---
> Source: [yibaiba/harmonyos-skills-pack](https://github.com/yibaiba/harmonyos-skills-pack) — distributed by [TomeVault](https://tomevault.io).
