...
- **Action Recommendations**:
  ...
  console.log(boxen(
    ...
    `${chalk.cyan('1.')} Run ${chalk.yellow('hackmindai list')} to view all tasks\n` +
    `${chalk.cyan('2.')} Run ${chalk.yellow('hackmindai show --id=' + newTaskId)} to view details`,
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/Dampipal)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/Dampipal)
