---
trigger: always_on
description: - `main`: [dist/extension.js](mdc:dist/extension.js) built from [src/extension.ts](mdc:src/extension.ts)
---
...
---
> Source: [chouzz/vscode-better-align](https://github.com/chouzz/vscode-better-align) — distributed by [TomeVault](https://tomevault.io).
