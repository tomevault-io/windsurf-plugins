---
trigger: always_on
description: - **zig** 0.17.x (`/Users/cztomsik/.zvm/bin/zig`) — target is 0.17.x; the 0.17 line may be somewhat unstable
---
...
---
> Source: [cztomsik/tokamak](https://github.com/cztomsik/tokamak) — distributed by [TomeVault](https://tomevault.io).
