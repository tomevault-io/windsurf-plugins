---
trigger: always_on
description: Setup tool for OpenSpec + Playwright E2E integration.
---
...
---
> Source: [wxhou/openspec-playwright](https://github.com/wxhou/openspec-playwright) — distributed by [TomeVault](https://tomevault.io).
