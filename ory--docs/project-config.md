---
trigger: always_on
description: Use `jq` instead of `python3` for all JSON operations in code examples:
---
...
---
> Source: [ory/docs](https://github.com/ory/docs) — distributed by [TomeVault](https://tomevault.io).
