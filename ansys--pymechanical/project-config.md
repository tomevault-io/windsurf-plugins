---
trigger: always_on
description: - Line length: 100 characters (ruff enforced).
---
...
---
> Source: [ansys/pymechanical](https://github.com/ansys/pymechanical) — distributed by [TomeVault](https://tomevault.io).
