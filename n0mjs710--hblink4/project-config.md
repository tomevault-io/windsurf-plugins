---
trigger: always_on
description: HBlink4 is a DMR Server implementing the HomeBrew protocol for amateur radio repeater networks. It's a **repeater-centric** architecture focusing on per-repeater control rather than server-level groupings. The system consists of two main components:
---
...
---
> Source: [n0mjs710/HBlink4](https://github.com/n0mjs710/HBlink4) — distributed by [TomeVault](https://tomevault.io).
