---
trigger: always_on
description: Django autocomplete library based on Select2.
---
...
---
> Source: [yourlabs/django-autocomplete-light](https://github.com/yourlabs/django-autocomplete-light) — distributed by [TomeVault](https://tomevault.io).
