---
trigger: always_on
description: > Reference doc for [molar_vis](../CLAUDE.md). Split out of the master `CLAUDE.md` for on-demand reading — see it for the project overview, build quick-start, and the full docs index.
---
...
---
> Source: [yesint/molar_vis](https://github.com/yesint/molar_vis) — distributed by [TomeVault](https://tomevault.io).
