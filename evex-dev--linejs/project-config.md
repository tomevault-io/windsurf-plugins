---
trigger: always_on
description: This repository is a Deno-first monorepo.
---
...
---
> Source: [evex-dev/linejs](https://github.com/evex-dev/linejs) — distributed by [TomeVault](https://tomevault.io).
