---
trigger: always_on
description: VStory 是 VisActor 体系下的数据叙事研发框架，仓库采用 Rush 管理的 monorepo 结构。核心源码位于 `packages/`，文档站点位于 `docs/`，通用工程配置位于 `share/` 和 `common/`。
---
...
---
> Source: [VisActor/VStory](https://github.com/VisActor/VStory) — distributed by [TomeVault](https://tomevault.io).
