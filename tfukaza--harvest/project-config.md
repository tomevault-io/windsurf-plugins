---
trigger: always_on
description: This project is a Python framework for using AI agents to analyze market data and make real time trading decisions.
---
...
---
> Source: [tfukaza/harvest](https://github.com/tfukaza/harvest) — distributed by [TomeVault](https://tomevault.io).
