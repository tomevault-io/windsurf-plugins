---
trigger: always_on
description: Cross-tool agent instructions for any AI coding assistant working on this repository.
---
...
Revka is a Rust-first autonomous agent runtime optimized for performance, efficiency, stability, extensibility, sustainability, and security.
...
- `src/memory/` — in-session `NoneMemory` binding; persistent memory is delegated to Kumiho MCP
...
---
> Source: [KumihoIO/Revka](https://github.com/KumihoIO/Revka) — distributed by [TomeVault](https://tomevault.io).
