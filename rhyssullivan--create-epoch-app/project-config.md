---
trigger: always_on
description: When you need to call a function inside a `useEffect` that accesses props/state but shouldn't trigger the effect to re-run, use `useEffectEvent` instead of adding the function to the dependency array.
---
