---
trigger: always_on
description: When working in this directory, use a product-facing lens first.
---
...
---
> Source: [Fission-AI/OpenSpec](https://github.com/Fission-AI/OpenSpec) — distributed by [TomeVault](https://tomevault.io).
