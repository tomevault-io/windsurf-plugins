---
trigger: always_on
description: This guide clarifies Pester test outcomes and what it means for a test to be "working" - which requires both **passing** AND **actually validating functionality**.
---
...
---
> Source: [PowerShell/PowerShell](https://github.com/PowerShell/PowerShell) — distributed by [TomeVault](https://tomevault.io).
