---
trigger: always_on
description: MatX is a C++20 numerical computing library targeting both CPUs and NVIDIA GPUs. It tries to use syntax familiar to both Python and MATLAB users.
---
...
---
> Source: [NVIDIA/MatX](https://github.com/NVIDIA/MatX) — distributed by [TomeVault](https://tomevault.io).
