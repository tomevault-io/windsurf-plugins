---
trigger: always_on
description: Shared guidance for every adapter in this folder (`adapters/adminforth-*`). It
---
...
---
> Source: [devforth/adminforth](https://github.com/devforth/adminforth) — distributed by [TomeVault](https://tomevault.io).
