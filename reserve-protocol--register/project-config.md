---
trigger: always_on
description: * **Clarity and Readability:** Code must be self-explanatory. Use meaningful and descriptive names for variables, functions, and components.
---
...
---
> Source: [reserve-protocol/register](https://github.com/reserve-protocol/register) — distributed by [TomeVault](https://tomevault.io).
