---
trigger: always_on
description: agmon 是一个 AI 编码 Agent 实时可观测性工具，监控 Claude Code 和 Codex 的 Token 消耗、费用、工具调用、文件变更等。
---
...
---
> Source: [tt-a1i/agmon](https://github.com/tt-a1i/agmon) — distributed by [TomeVault](https://tomevault.io).
