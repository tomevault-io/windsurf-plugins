---
trigger: always_on
description: 本文件定义在本仓库中执行开发、Issue 分析、PR 审查时的统一行为准则。
---
...
---
> Source: [sjkncs/daily_stock_analysis](https://github.com/sjkncs/daily_stock_analysis) — distributed by [TomeVault](https://tomevault.io).
