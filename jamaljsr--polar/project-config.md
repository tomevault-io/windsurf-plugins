---
trigger: always_on
description: Polar is a Bitcoin Lightning Network development tool that creates local regtest networks using Docker containers. This guide helps AI agents understand the architecture and contribute effectively.
---
...
---
> Source: [jamaljsr/polar](https://github.com/jamaljsr/polar) — distributed by [TomeVault](https://tomevault.io).
