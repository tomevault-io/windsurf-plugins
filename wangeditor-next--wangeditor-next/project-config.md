---
trigger: always_on
description: 本文件说明如何在 `wangEditor-next` monorepo 中协作开发。目标是让人类和 AI 助手都能快速定位、正确修改、可验证交付。
---
...
---
> Source: [wangeditor-next/wangEditor-next](https://github.com/wangeditor-next/wangEditor-next) — distributed by [TomeVault](https://tomevault.io).
