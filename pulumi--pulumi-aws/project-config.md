---
trigger: always_on
description: This is a Go-based Pulumi resource provider that bridges the Terraform provider to Pulumi. It generates SDKs for TypeScript/JavaScript, Python, .NET, Go, and Java. The provider uses the Terraform provider as an upstream source via git submodules.
---
...
---
> Source: [pulumi/pulumi-aws](https://github.com/pulumi/pulumi-aws) — distributed by [TomeVault](https://tomevault.io).
