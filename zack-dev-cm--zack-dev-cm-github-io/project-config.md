---
trigger: always_on
description: This repository publishes Zakhar Pashkin's portfolio, project case studies, crawlable AI context files, and resume assets. Use this file as the index, not the full manual.
---
...
---
> Source: [zack-dev-cm/zack-dev-cm.github.io](https://github.com/zack-dev-cm/zack-dev-cm.github.io) — distributed by [TomeVault](https://tomevault.io).
