---
trigger: always_on
description: * When we encounter errors which would be useful for a user of the application, record it in @docs\\TROUBLESHOOTING.md
---
...
---
> Source: [youjunjer/VM-WSL-ui-keepalive](https://github.com/youjunjer/VM-WSL-ui-keepalive) — distributed by [TomeVault](https://tomevault.io).
