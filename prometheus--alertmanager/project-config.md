---
trigger: always_on
description: Guidance for AI coding agents working in this repository. Keep this file concise and current. For end‑user docs, see `README.md` and https://prometheus.io/docs/alerting/alertmanager/.
---
...
---
> Source: [prometheus/alertmanager](https://github.com/prometheus/alertmanager) — distributed by [TomeVault](https://tomevault.io).
