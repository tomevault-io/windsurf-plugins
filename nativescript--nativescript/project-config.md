---
trigger: always_on
description: This is the source code for NativeScript — `@nativescript/core` and related packages. This guide outlines standard practices for AI agents working in this repository.
---
...
---
> Source: [NativeScript/NativeScript](https://github.com/NativeScript/NativeScript) — distributed by [TomeVault](https://tomevault.io).
