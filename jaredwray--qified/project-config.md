---
trigger: always_on
description: Guidelines for AI coding agents (Claude, Gemini, Codex).
---
...
---
> Source: [jaredwray/qified](https://github.com/jaredwray/qified) — distributed by [TomeVault](https://tomevault.io).
