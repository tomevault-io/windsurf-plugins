---
trigger: always_on
description: Each target has its own `templates/` directory consumed by that target's `make.js`.
---
...
---
> Source: [PlayFab/SDKGenerator](https://github.com/PlayFab/SDKGenerator) — distributed by [TomeVault](https://tomevault.io).
