---
trigger: always_on
description: - This is a Rust workspace. Use `cargo test --workspace` for all tests, `cargo test -p proxyapi` for the core crate, and `cargo test -p proxyapi -- scripting` for scripting tests.
---
...
---
> Source: [emanuele-em/proxelar](https://github.com/emanuele-em/proxelar) — distributed by [TomeVault](https://tomevault.io).
