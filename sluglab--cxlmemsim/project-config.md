---
trigger: always_on
description: - Source: `src/` (core C++: controller, server, helpers), headers in `include/`.
---
...
---
> Source: [SlugLab/CXLMemSim](https://github.com/SlugLab/CXLMemSim) — distributed by [TomeVault](https://tomevault.io).
