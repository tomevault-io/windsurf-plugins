---
trigger: always_on
description: BDD (Behaviour-Driven Development) test suite that validates ODA Canvas compliance. Features are written in Gherkin and executed with Cucumber.js against a live Kubernetes cluster.
---
