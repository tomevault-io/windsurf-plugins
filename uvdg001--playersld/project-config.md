---
trigger: always_on
description: **Players LD** is a professional-grade football team management application. The project is currently in a transition phase, refactoring a monolithic "V1" (found in the root directory) into a modular, high-performance "V2" (found in the `/v2` directory) with a premium aesthetic.
---
...
---
> Source: [uvdg001/PlayersLD](https://github.com/uvdg001/PlayersLD) — distributed by [TomeVault](https://tomevault.io).
