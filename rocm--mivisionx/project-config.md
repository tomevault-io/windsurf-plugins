---
trigger: always_on
description: AMD MIVisionX toolkit - version 4.0.0. A streamlined computer vision toolkit built on AMD OpenVX. As of 4.0.0, the project is reduced to its core: the AMD OpenVX engine, the AMD RPP OpenVX extension, and the RunVX graph executor, across `CPU`, `HIP`, and `OpenCL` backends.
---
...
---
> Source: [ROCm/MIVisionX](https://github.com/ROCm/MIVisionX) — distributed by [TomeVault](https://tomevault.io).
