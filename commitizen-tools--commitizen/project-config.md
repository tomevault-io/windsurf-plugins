---
trigger: always_on
description: This file provides **project-specific guidance for AI agents** (and other automated tools) working on the `commitizen` repository.
---
...
---
> Source: [commitizen-tools/commitizen](https://github.com/commitizen-tools/commitizen) — distributed by [TomeVault](https://tomevault.io).
