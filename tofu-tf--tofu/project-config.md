---
trigger: always_on
description: Agent is like cats-effect Ref but it allows effectful updates of referenced value.
---
...
---
> Source: [tofu-tf/tofu](https://github.com/tofu-tf/tofu) — distributed by [TomeVault](https://tomevault.io).
