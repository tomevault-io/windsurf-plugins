---
trigger: always_on
description: The spec defines the JD diff format for any implementation — Go, Rust, JavaScript,
---
...
---
> Source: [josephburnett/jd](https://github.com/josephburnett/jd) — distributed by [TomeVault](https://tomevault.io).
