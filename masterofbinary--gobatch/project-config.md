---
trigger: always_on
description: This file contains instructions and guidelines for Claude when working with this project. [AGENTS.md](./AGENTS.md) mirrors these instructions for all other AI coding agents; keep the two files in sync.
---
...
---
> Source: [MasterOfBinary/gobatch](https://github.com/MasterOfBinary/gobatch) — distributed by [TomeVault](https://tomevault.io).
