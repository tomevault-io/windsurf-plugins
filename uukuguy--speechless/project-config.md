---
trigger: always_on
description: 1. Create an account on [Google AI](https://ai.google.dev/) and get your API key.
---
...
---
> Source: [uukuguy/speechless](https://github.com/uukuguy/speechless) — distributed by [TomeVault](https://tomevault.io).
