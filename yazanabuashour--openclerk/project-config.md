---
trigger: always_on
description: - For all committed docs, reports, and artifact references, use repo-relative paths or neutral repo-relative placeholders. Never use machine-absolute filesystem paths.
---
...
---
> Source: [yazanabuashour/openclerk](https://github.com/yazanabuashour/openclerk) — distributed by [TomeVault](https://tomevault.io).
