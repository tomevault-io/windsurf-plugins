---
trigger: always_on
description: This repository contains `dotnet-exec`, a .NET CLI tool for executing C# code and script files without requiring a project file, plus the `ReferenceResolver` library used for package, file, folder, framework, and project references.
---
...
---
> Source: [WeihanLi/dotnet-exec](https://github.com/WeihanLi/dotnet-exec) — distributed by [TomeVault](https://tomevault.io).
