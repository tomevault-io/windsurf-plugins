---
trigger: always_on
description: Browser synths & sequencers: C++ DSP → Emscripten/wasm → AudioWorklet, with Lit UI.
---
...
---
> Source: [a-cordier/wasm-audio](https://github.com/a-cordier/wasm-audio) — distributed by [TomeVault](https://tomevault.io).
