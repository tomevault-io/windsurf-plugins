---
trigger: always_on
description: This repository is the open-source AutoMQ Kafka fork.
---
...
---
> Source: [AutoMQ/automq](https://github.com/AutoMQ/automq) — distributed by [TomeVault](https://tomevault.io).
