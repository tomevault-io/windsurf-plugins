---
trigger: always_on
description: In the AI era, agents are autonomous programs that can perform tasks on behalf of users by leveraging large language models (LLMs) and other AI technologies. They can interact with various systems, process information, and make decisions to accomplish specific goals.
---
