---
trigger: always_on
description: This is the `phpstan/phpstan-webmozart-assert` extension for [PHPStan](https://phpstan.org/). It provides type-narrowing support for [webmozart/assert](https://github.com/webmozart/assert) assertion methods.
---
...
---
> Source: [phpstan/phpstan-webmozart-assert](https://github.com/phpstan/phpstan-webmozart-assert) — distributed by [TomeVault](https://tomevault.io).
