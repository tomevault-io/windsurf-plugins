---
trigger: always_on
description: - The repo root is the shared agent integration surface. Keep `.claude-plugin/`, `.codex/`, `.cursor-plugin/`, `.cursor/`, `.opencode/`, `hooks/`, `skills/`, `scripts/`, and `package.json` aligned where they represent the same Lumen distribution.
---
...
---
> Source: [ory/lumen](https://github.com/ory/lumen) — distributed by [TomeVault](https://tomevault.io).
