---
trigger: always_on
description: - `just bs` or `nh os switch . -H <host>` - Build and switch NixOS configuration
---
...
---
> Source: [dileep-kishore/nixos-config](https://github.com/dileep-kishore/nixos-config) — distributed by [TomeVault](https://tomevault.io).
