---
trigger: always_on
description: Guidance for coding agents (Claude Code, and other AI assistants) working in this
---
...
- Each resource is one package under `internal/modules`. Add new ones with
  `go run ./cmd/forge add resource <Name>`, then follow the printed steps.
...
---
> Source: [y0f/go-api-scaffolding](https://github.com/y0f/go-api-scaffolding) — distributed by [TomeVault](https://tomevault.io).
