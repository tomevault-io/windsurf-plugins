---
trigger: always_on
description: A Java client library for the Danish Nationalbanken API.
---

# Nationalbanken Client - Copilot Instructions

## Project Overview
A Java client library for the Danish Nationalbanken API.
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/clanie) — claim your Tome and manage your conversions.
