---
trigger: always_on
description: Instructions for AI agents working with the trend_classifier package.
---
...
---
> Source: [izikeros/trend_classifier](https://github.com/izikeros/trend_classifier) — distributed by [TomeVault](https://tomevault.io).
