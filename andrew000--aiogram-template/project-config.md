---
trigger: always_on
description: - This repository is an aiogram 3 Telegram bot template with a workspace layout managed by `uv`.
---
...
---
> Source: [andrew000/aiogram-template](https://github.com/andrew000/aiogram-template) — distributed by [TomeVault](https://tomevault.io).
