---
trigger: always_on
description: After you generate new code or update existing code, run `bun run full-check` to verify the code is correct. If there are any errors, run
---
...
---
> Source: [skilled-chaindev/prb-math](https://github.com/skilled-chaindev/prb-math) — distributed by [TomeVault](https://tomevault.io).
