---
trigger: always_on
description: <!-- THIS FILE IS AUTO-GENERATED. Edit AGENTS-source.adoc instead. -->
---
...
---
> Source: [gesinn-it-pub/mwbot](https://github.com/gesinn-it-pub/mwbot) — distributed by [TomeVault](https://tomevault.io).
