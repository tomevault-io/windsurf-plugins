---
trigger: always_on
description: `ZeroSettleKit` is the native iOS/Swift SDK — the **source framework** that all platform wrappers depend on. It provides the public API for configuration, product catalog, payment sheet presentation, entitlement management, and subscription lifecycle.
---
