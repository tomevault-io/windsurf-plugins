---
trigger: always_on
description: Core engine and CLI for the OpenAgents ecosystem. Handles agent discovery, installation, configuration, daemon-based execution, and workspace integration. Published to npm as `@openagents-org/agent-launcher`.
---
...
---
> Source: [openagents-org/openagents](https://github.com/openagents-org/openagents) — distributed by [TomeVault](https://tomevault.io).
