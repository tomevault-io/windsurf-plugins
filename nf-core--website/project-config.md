---
trigger: always_on
description: This file provides guidance to AI coding agents (Claude Code and others) when working with code in this repository.
---
...
---
> Source: [nf-core/website](https://github.com/nf-core/website) — distributed by [TomeVault](https://tomevault.io).
