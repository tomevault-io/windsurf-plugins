---
trigger: always_on
description: - **Always use `pnpm publish`**, never `npm publish`. This repo uses pnpm's `catalog:` protocol in peerDependencies — `npm publish` ships the raw `catalog:` string, which breaks installs for users.
---
...
---
> Source: [childrentime/pareto](https://github.com/childrentime/pareto) — distributed by [TomeVault](https://tomevault.io).
