---
trigger: always_on
description: This repository is a collection of independently installable Codex skills. The repository root is intentionally not an installable skill and must not contain `SKILL.md`.
---
...
---
> Source: [xiao24bei/xiaobei-skill](https://github.com/xiao24bei/xiaobei-skill) — distributed by [TomeVault](https://tomevault.io).
