---
trigger: always_on
description: This directory contains the implementation of the message compression filter.
---
...
---
> Source: [grpc/grpc](https://github.com/grpc/grpc) — distributed by [TomeVault](https://tomevault.io).
