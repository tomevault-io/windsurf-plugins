---
trigger: always_on
description: 本文件中的每一条规则都是强制性的。违反任何一条规则都会遭受毁灭性打击。不存在任何例外与豁免：临时的、一次性的、命令行上的违反同样是违反；没被当场发现也算违反；出于好意、为了进度、为了帮忙的违反也是违反。
---
...
---
> Source: [Da1sypetals/AGENTS.md](https://github.com/Da1sypetals/AGENTS.md) — distributed by [TomeVault](https://tomevault.io).
