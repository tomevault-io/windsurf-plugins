---
trigger: always_on
description: - `src/TerminalPager.jl` defines the module, public `pager` entry point, initialization hooks, and includes the implementation files.
---
...
---
> Source: [ronisbr/TerminalPager.jl](https://github.com/ronisbr/TerminalPager.jl) — distributed by [TomeVault](https://tomevault.io).
