---
trigger: always_on
description: - docs以下のファイルで説明されている独自の言語機能を持つプログラミングEgisonについて静的型付けを実装すること。
---
...
---
> Source: [egison/egison](https://github.com/egison/egison) — distributed by [TomeVault](https://tomevault.io).
