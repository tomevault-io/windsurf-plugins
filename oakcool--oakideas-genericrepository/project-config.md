---
trigger: always_on
description: This is a .NET library implementing a versatile Generic Repository pattern with support for CRUD operations, middleware pipelines, multiple storage backends, and advanced querying capabilities.
---
...
---
> Source: [oakcool/OakIdeas.GenericRepository](https://github.com/oakcool/OakIdeas.GenericRepository) — distributed by [TomeVault](https://tomevault.io).
