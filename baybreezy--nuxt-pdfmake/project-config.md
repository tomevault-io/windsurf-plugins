---
trigger: always_on
description: This repo is a [Nuxt Module](https://nuxt.com/docs/4.x/guide/modules/getting-started) (v1.0.0) that lets developers use [pdfmake](https://github.com/bpampuch/pdfmake) seamlessly in their Nuxt projects — on both the **client** and the **server (Nitro)**.
---
...
---
> Source: [BayBreezy/nuxt-pdfmake](https://github.com/BayBreezy/nuxt-pdfmake) — distributed by [TomeVault](https://tomevault.io).
