---
trigger: always_on
description: Oxigraph is an RDF and SPARQL database implementation organized as a Rust workspace.
---
...
---
> Source: [oxigraph/oxigraph](https://github.com/oxigraph/oxigraph) — distributed by [TomeVault](https://tomevault.io).
