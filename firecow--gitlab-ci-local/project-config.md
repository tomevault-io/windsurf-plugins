---
trigger: always_on
description: CLI tool to run GitLab CI pipelines locally. Written in TypeScript, built with Bun.
---
...
---
> Source: [firecow/gitlab-ci-local](https://github.com/firecow/gitlab-ci-local) — distributed by [TomeVault](https://tomevault.io).
