---
trigger: always_on
description: > For comprehensive coding standards, see [docs/specs/3-reference/coding-conventions.md](../docs/specs/3-reference/coding-conventions.md)
---
...
---
> Source: [LycheeOrg/Lychee](https://github.com/LycheeOrg/Lychee) — distributed by [TomeVault](https://tomevault.io).
