---
trigger: always_on
description: `agents-flex-image-gemini` 通过 Gemini `generateContent` REST API 支持 Nano Banana 文生图、图片编辑和多图融合。默认使用 Google 推荐的 `gemini-3.1-flash-image`（Nano Banana 2）。
---
...
---
> Source: [agents-flex/agents-flex](https://github.com/agents-flex/agents-flex) — distributed by [TomeVault](https://tomevault.io).
