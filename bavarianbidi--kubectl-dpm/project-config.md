...
`kubectl-dpm` is a kubectl plugin for managing Kubernetes debug profiles. Written in Go 1.26.4.
...
---
> Source: [bavarianbidi/kubectl-dpm](https://github.com/bavarianbidi/kubectl-dpm) — distributed by [TomeVault](https://tomevault.io).
