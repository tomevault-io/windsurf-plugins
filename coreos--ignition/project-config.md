---
trigger: always_on
description: First-boot provisioning utility for immutable Linux (Fedora CoreOS, RHEL CoreOS, Flatcar). Partitions disks, formats filesystems, writes files, configures users during initramfs.
---
...
---
> Source: [coreos/ignition](https://github.com/coreos/ignition) — distributed by [TomeVault](https://tomevault.io).
