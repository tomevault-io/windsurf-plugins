---
trigger: always_on
description: Ansible playbook that provisions a hardened k3s Kubernetes cluster (3-master HA + 3 workers)
---
...
---
> Source: [digitalis-io/k3s-on-prem-production](https://github.com/digitalis-io/k3s-on-prem-production) — distributed by [TomeVault](https://tomevault.io).
