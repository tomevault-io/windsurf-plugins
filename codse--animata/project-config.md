---
trigger: always_on
description: Animata is a free, open-source library of animated React components built with Next.js 16, Tailwind CSS v4, and TypeScript. Components live in `animata/` and are documented via MDX in `content/docs/`. The site itself is the primary showcase — the landing page at `app/(main)/page.tsx` and the docs at `app/(main)/docs/`.
---
...
---
> Source: [codse/animata](https://github.com/codse/animata) — distributed by [TomeVault](https://tomevault.io).
