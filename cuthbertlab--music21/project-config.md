---
trigger: always_on
description: - At the start of every session, run `git fetch` (and pull/rebase as appropriate) from
---
...
---
> Source: [cuthbertLab/music21](https://github.com/cuthbertLab/music21) — distributed by [TomeVault](https://tomevault.io).
