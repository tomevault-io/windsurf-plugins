---
trigger: always_on
description: When suggesting commit messages, always use the Angular Conventional Commits format.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/jolution)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/jolution)
