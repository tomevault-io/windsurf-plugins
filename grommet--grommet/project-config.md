---
trigger: always_on
description: Welcome to the Grommet AI contribution guidelines! The purpose of these instructions is to act as a guardrail for AI tools (like GitHub Copilot) when generating code within the Grommet ecosystem. By adhering to these guidelines, AI-assisted code generation will be more aligned with Grommet's specific architecture, conventions, and semantics.
---
...
---
> Source: [grommet/grommet](https://github.com/grommet/grommet) — distributed by [TomeVault](https://tomevault.io).
