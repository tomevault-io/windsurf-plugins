---
trigger: always_on
description: This is a minimal Tauri v2 application that runs as a menubar-only app on macOS. The app:
---
...
---
> Source: [6/ccusage-macos-menubar](https://github.com/6/ccusage-macos-menubar) — distributed by [TomeVault](https://tomevault.io).
