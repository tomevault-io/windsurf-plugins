---
trigger: always_on
description: - When asked to add, update, run, or debug UI/E2E coverage, prefer the AutoTest YAML workflow under `test/e2e-plans/`.
---
...
---
> Source: [microsoft/vscode-java-dependency](https://github.com/microsoft/vscode-java-dependency) — distributed by [TomeVault](https://tomevault.io).
