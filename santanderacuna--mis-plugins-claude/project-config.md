---
trigger: always_on
description: <!-- gentle-ai:persona -->
---

<!-- gentle-ai:persona -->
## Rules

- **PROHIBIDO lanzar Workflows o agentes múltiples sin autorización explícita del usuario.** Si la tarea requiere multi-agente, preguntar primero y esperar aprobación. Máximo 1-2 agentes si se autoriza. Skills como `deep-research` que lanzan docenas de agentes en paralelo están prohibidas por defecto.
...
## Stack y Convenciones de Proyectos

Lee `/home/sacunpolo/Documentos/mis-skills/stack-dev-jose.md` al inicio de cada proyecto o cuando necesites referencia de stack, arquitectura, convenciones de Laravel/Vue, reglas de autenticación, estructura de carpetas, o cualquier decisión técnica de diseño. Este archivo es la fuente de verdad única para todos los proyectos.
...
---
> Source: [SantanderAcuna/mis-plugins-claude](https://github.com/SantanderAcuna/mis-plugins-claude) — distributed by [TomeVault](https://tomevault.io).
