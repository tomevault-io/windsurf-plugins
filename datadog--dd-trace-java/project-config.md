---
trigger: always_on
description: Datadog Java APM agent (`dd-trace-java`): a Java agent that auto-instruments JVM applications at runtime via bytecode manipulation.
---
...
---
> Source: [DataDog/dd-trace-java](https://github.com/DataDog/dd-trace-java) — distributed by [TomeVault](https://tomevault.io).
