---
trigger: always_on
description: You are contributing to **zoft.MauiExtensions.Controls.AutoCompleteEntry**, a **.NET MAUI custom control library** that provides an `AutoCompleteEntry` (an `Entry`-like control that shows suggestions while the user types). :contentReference[oaicite:3]{index=3}
---
