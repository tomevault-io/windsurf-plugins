---
trigger: always_on
description: Aethon is a **Tauri 2 + React 19 + TypeScript + bun + Rust** desktop app whose
---
...
---
> Source: [utensils/aethon](https://github.com/utensils/aethon) — distributed by [TomeVault](https://tomevault.io).
