---
trigger: always_on
description: GEPA (Genetic-Pareto) is a Python framework for optimizing text components (AI prompts, code, instructions) using LLM-based reflection and Pareto-efficient evolutionary search.
---
...
---
> Source: [gepa-ai/gepa](https://github.com/gepa-ai/gepa) — distributed by [TomeVault](https://tomevault.io).
