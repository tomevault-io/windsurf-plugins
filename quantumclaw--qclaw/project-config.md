---
trigger: always_on
description: This file tells AI coding agents (Claude Code, Copilot, Cursor, etc.) how to work on the QuantumClaw codebase.
---
...
---
> Source: [QuantumClaw/QClaw](https://github.com/QuantumClaw/QClaw) — distributed by [TomeVault](https://tomevault.io).
