---
trigger: always_on
description: 本文件是仓库级工作契约。任何 AI 或自动化代理在修改本仓库前都必须遵守它；与实现、测试和安全边界冲突的临时说明不具有更高优先级。
---
...
---
> Source: [yhan-sun/p2wlan](https://github.com/yhan-sun/p2wlan) — distributed by [TomeVault](https://tomevault.io).
