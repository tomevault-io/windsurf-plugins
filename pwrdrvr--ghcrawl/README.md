...
Original source: `CLAUDE.md` in [pwrdrvr/ghcrawl](https://github.com/pwrdrvr/ghcrawl).
...
From [pwrdrvr/ghcrawl](https://github.com/pwrdrvr/ghcrawl) — a repo with 51+ stars on GitHub.
