---
trigger: always_on
description: Guidance for maintaining this repo. This is the **core monorepo** — many modules ship from `src/`
---
...
---
> Source: [shinyorg/shiny](https://github.com/shinyorg/shiny) — distributed by [TomeVault](https://tomevault.io).
