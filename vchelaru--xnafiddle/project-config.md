---
trigger: always_on
description: XnaFiddle is a standalone KNI game runner with an in-browser C# editor. It is a Blazor WASM app with a WebGL canvas and Monaco code editor that lets users write, compile, and run XNA/KNI game code directly in the browser.
---
...
---
> Source: [vchelaru/XnaFiddle](https://github.com/vchelaru/XnaFiddle) — distributed by [TomeVault](https://tomevault.io).
