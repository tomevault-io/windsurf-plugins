---
trigger: always_on
description: This project is a .NET SDK for the Google Gemini API. It allows developers to integrate generative AI features into their .NET and ASP.NET Core applications. The SDK supports both Google AI Studio and Vertex AI, providing a comprehensive set of functionalities including content generation, model management, embeddings, and more.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/mscraftsman)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/mscraftsman)
