---
trigger: always_on
description: - Use the latest version of the WDL spec from https://github.com/openwdl/wdl/
---
...
---
> Source: [stjudecloud/workflows](https://github.com/stjudecloud/workflows) — distributed by [TomeVault](https://tomevault.io).
