---
trigger: always_on
description: - use uv run for all project tooling commands (pytest, ruff, etc.)
---
...
---
> Source: [21cmfast/21cmFAST](https://github.com/21cmfast/21cmFAST) — distributed by [TomeVault](https://tomevault.io).
