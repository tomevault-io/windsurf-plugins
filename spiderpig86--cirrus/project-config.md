---
trigger: always_on
description: This document complements the human-focused README by giving coding agents precise, actionable instructions: build steps, tests, structure, and conventions. Keep human docs concise; put agent-specific details here for predictable automation.
---
...
---
> Source: [Spiderpig86/Cirrus](https://github.com/Spiderpig86/Cirrus) — distributed by [TomeVault](https://tomevault.io).
