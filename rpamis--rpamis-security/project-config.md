...
**Java Version:** JDK 17+ (for v1.1.4+), JDK 8-17 (for v1.0.7)
...
---
> Source: [rpamis/rpamis-security](https://github.com/rpamis/rpamis-security) — distributed by [TomeVault](https://tomevault.io).
