---
trigger: always_on
description: **ttmp32gme** is a cross-platform tool that converts MP3/audio files into TipToi GME (Game Music Engine) files playable on the TipToi pen. It generates printable control sheets with OID codes for music/audiobook playback control.
---
...
---
> Source: [thawn/ttmp32gme](https://github.com/thawn/ttmp32gme) — distributed by [TomeVault](https://tomevault.io).
