---
trigger: always_on
description: `rocom-capture`：在 Linux 网关上被动抓取手机游戏《洛克王国：世界》(进程 `com.tencent.nrc`)
---
...
---
> Source: [whoisnian/rocom-capture](https://github.com/whoisnian/rocom-capture) — distributed by [TomeVault](https://tomevault.io).
