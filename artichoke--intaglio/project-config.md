---
trigger: always_on
description: You are working in `artichoke/intaglio`, a Rust crate that provides symbol
---
...
---
> Source: [artichoke/intaglio](https://github.com/artichoke/intaglio) — distributed by [TomeVault](https://tomevault.io).
