---
trigger: always_on
description: This project is a Rust library named `textwrap` for wrapping and indenting text.
---
...
---
> Source: [mgeisler/textwrap](https://github.com/mgeisler/textwrap) — distributed by [TomeVault](https://tomevault.io).
