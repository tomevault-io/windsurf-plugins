---
trigger: always_on
description: Always check docs and examples before doing UI work. LLM doesn't have great knowledge of WinUI 3. especially windows-rs.
---
...
---
> Source: [vertopolkaLF/codex-minibar](https://github.com/vertopolkaLF/codex-minibar) — distributed by [TomeVault](https://tomevault.io).
