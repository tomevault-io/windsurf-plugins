---
trigger: always_on
description: Project instructions for AI coding agents (Claude Code, Cursor, Codex, etc.). All agents working in this repo should read this file. For deeper architecture and conventions, see [CLAUDE.md](./CLAUDE.md).
---
...
---
> Source: [homeassistant-extras/toolbar-status-chips](https://github.com/homeassistant-extras/toolbar-status-chips) — distributed by [TomeVault](https://tomevault.io).
