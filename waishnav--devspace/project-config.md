---
trigger: always_on
description: This project exposes a local development workspace over MCP so ChatGPT, Claude,
---
...
---
> Source: [Waishnav/devspace](https://github.com/Waishnav/devspace) — distributed by [TomeVault](https://tomevault.io).
