---
trigger: always_on
description: This is a pure Ruby implementation of a AMQP 0-9-1 protocol parser
---
...
---
> Source: [ruby-amqp/amq-protocol](https://github.com/ruby-amqp/amq-protocol) — distributed by [TomeVault](https://tomevault.io).
