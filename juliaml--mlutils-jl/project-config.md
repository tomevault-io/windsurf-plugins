---
trigger: always_on
description: MLUtils.jl is the data-handling layer of the JuliaML/Flux ecosystem. It defines the
---
...
---
> Source: [JuliaML/MLUtils.jl](https://github.com/JuliaML/MLUtils.jl) — distributed by [TomeVault](https://tomevault.io).
