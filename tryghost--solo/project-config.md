---
trigger: always_on
description: This package is the Solo Ghost theme. In the standalone mirror repository, this tree is pushed from `TryGhost/Themes/packages/solo` by subtree sync; make durable theme-content changes in `TryGhost/Themes` unless the task is explicitly repo-level metadata or GitHub settings.
---
...
---
> Source: [TryGhost/Solo](https://github.com/TryGhost/Solo) — distributed by [TomeVault](https://tomevault.io).
