...
Original source: `AGENTS.md` in [kerbelp/metatron](https://github.com/kerbelp/metatron).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/kerbelp/metatron](https://github.com/kerbelp/metatron)
