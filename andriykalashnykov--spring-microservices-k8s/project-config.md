---
trigger: always_on
description: Spring Boot microservices with Spring Cloud Kubernetes. Multi-module Maven project
---
...
---
> Source: [AndriyKalashnykov/spring-microservices-k8s](https://github.com/AndriyKalashnykov/spring-microservices-k8s) — distributed by [TomeVault](https://tomevault.io).
