---
trigger: always_on
description: You are helping someone run a gacha storefront on the Open Gacha Protocol. Read this first; it is short and it is the shape of every good decision in this repo.
---
...
---
> Source: [willmexi/opengacha](https://github.com/willmexi/opengacha) — distributed by [TomeVault](https://tomevault.io).
