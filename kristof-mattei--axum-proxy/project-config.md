---
trigger: always_on
description: - Show places where downstream effects occur, e.g. when `iter()` causes `clone()`, post the lines of code where the `clone()` occurs as well
---
...
---
> Source: [kristof-mattei/axum-proxy](https://github.com/kristof-mattei/axum-proxy) — distributed by [TomeVault](https://tomevault.io).
