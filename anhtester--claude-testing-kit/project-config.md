---
trigger: always_on
description: > **Scope:** Áp dụng cho mọi tác vụ Test Automation do Claude (Claude Code) hoạt động trong dự án này.
---
...
---
> Source: [anhtester/claude-testing-kit](https://github.com/anhtester/claude-testing-kit) — distributed by [TomeVault](https://tomevault.io).
