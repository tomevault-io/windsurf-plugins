---
trigger: always_on
description: In test code, avoid being too defensive against exceptions. Let them bubble up instead of catching them and logging. The stack trace is more useful than a log with fewer details.
---
