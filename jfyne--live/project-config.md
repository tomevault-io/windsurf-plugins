---
trigger: always_on
description: - Test files: `*_test.go` suffix, same package as source
---
...
---
> Source: [jfyne/live](https://github.com/jfyne/live) — distributed by [TomeVault](https://tomevault.io).
