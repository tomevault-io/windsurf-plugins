---
trigger: always_on
description: This document provides context, architectural insights, and development standards for AI agents working on the Echo Android codebase.
---

# Echo Android - Agent Guide

This document provides context, architectural insights, and development standards for AI agents working on the Echo Android codebase.

## 1. Project Overview
**Echo** is a decentralized, off-grid communication application focused on privacy and censorship resistance. It utilizes mesh networking (primarily Bluetooth LE and Tor/Arti) to enable peer-to-peer messaging without centralized servers.
...
---
> Source: [julyhackathon2026/songket](https://github.com/julyhackathon2026/songket) — distributed by [TomeVault](https://tomevault.io).
