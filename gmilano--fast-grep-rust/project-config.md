---
trigger: always_on
description: A high-performance regex search engine implemented in Rust. The core idea: build a sparse n-gram inverted index over a codebase so that most searches only need to scan a small fraction of files, rather than every file.
---
...
---
> Source: [gmilano/fast-grep-rust](https://github.com/gmilano/fast-grep-rust) — distributed by [TomeVault](https://tomevault.io).
