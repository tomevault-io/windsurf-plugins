---
trigger: always_on
description: AI 小说/漫剧/宣传片/短片生成平台。后端 FastAPI(`backend/`),前端 React+Vite 手写 CSS(`frontend/`),
---
...
---
> Source: [ynnyh/jarvis-write](https://github.com/ynnyh/jarvis-write) — distributed by [TomeVault](https://tomevault.io).
