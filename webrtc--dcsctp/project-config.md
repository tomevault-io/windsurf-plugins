---
trigger: always_on
description: `dcsctp` is a Rust implementation of the Stream Control Transmission Protocol
---
...
---
> Source: [webrtc/dcsctp](https://github.com/webrtc/dcsctp) — distributed by [TomeVault](https://tomevault.io).
