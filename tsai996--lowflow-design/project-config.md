---
trigger: always_on
description: `lowflow-design` is a low-code workflow designer built with Vue 3, TypeScript, and Vite. It uses Element Plus for UI, Pinia for state, UnoCSS and SCSS for styling, and `vite-plugin-mock` for local user and role APIs.
---
...
---
> Source: [tsai996/lowflow-design](https://github.com/tsai996/lowflow-design) — distributed by [TomeVault](https://tomevault.io).
