---
trigger: always_on
description: Read `README.md`, then `AGENT_INTEGRATION.md`. For floating app connections read `docs/FLOATING_ICONS.md` and `docs/app-integrations.json`. `docs/API_CONTRACT.md` is the public runtime contract; source and actual tests govern if documentation disagrees.
---
...
---
> Source: [tosya301/midori-companion-avatar](https://github.com/tosya301/midori-companion-avatar) — distributed by [TomeVault](https://tomevault.io).
