---
trigger: always_on
description: - Use TypeScript. Prefer ES modules.
---
...
---
> Source: [katspaugh/wavesurfer.js](https://github.com/katspaugh/wavesurfer.js) — distributed by [TomeVault](https://tomevault.io).
