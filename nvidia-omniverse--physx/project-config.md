---
trigger: always_on
description: Self-contained Python/C library for USD-based physics simulation — the fastest
---
...
---
> Source: [NVIDIA-Omniverse/PhysX](https://github.com/NVIDIA-Omniverse/PhysX) — distributed by [TomeVault](https://tomevault.io).
