---
trigger: always_on
description: The smartmeter-obis library is a Node.js library for reading and parsing smartmeter data using OBIS (Object Identification System) protocols. It supports SML (Smart Message Language), D0 protocol, and JSON EFR formats with various transport methods including serial, HTTP, TCP, and local file.
---
...
---
> Source: [Apollon77/smartmeter-obis](https://github.com/Apollon77/smartmeter-obis) — distributed by [TomeVault](https://tomevault.io).
