---
trigger: always_on
description: Guidance for AI agents working in this repository (ecnerwala's competitive
---
...
---
> Source: [ecnerwala/cp-book](https://github.com/ecnerwala/cp-book) — distributed by [TomeVault](https://tomevault.io).
