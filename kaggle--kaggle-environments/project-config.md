---
trigger: always_on
description: This document provides guidance for AI coding agents working with the `kaggle-environments` repository. It covers project structure, commands, code style, and architecture.
---
...
---
> Source: [Kaggle/kaggle-environments](https://github.com/Kaggle/kaggle-environments) — distributed by [TomeVault](https://tomevault.io).
