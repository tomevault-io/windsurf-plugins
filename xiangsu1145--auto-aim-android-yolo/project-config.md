---
trigger: always_on
description: Android FPS game AI aim-assist. Single-module Gradle app (`:app`) — Kotlin/Java + C++ NDK. Captures screen via MediaProjection, runs YOLOv8/v11 inference via TFLite with Qualcomm QNN HTP delegate (Hexagon NPU), draws overlays, injects touch via Shizuku + uinput.
---
...
---
> Source: [xiangsu1145/Auto-aim_android-yolo](https://github.com/xiangsu1145/Auto-aim_android-yolo) — distributed by [TomeVault](https://tomevault.io).
