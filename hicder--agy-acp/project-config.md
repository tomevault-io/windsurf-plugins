---
trigger: always_on
description: Single Rust crate. ACP (Agent Client Protocol) stdio adapter for Google Antigravity CLI (`agy`). Bridges `agy` into OpenAB's JSON-RPC protocol.
---
...
---
> Source: [hicder/agy-acp](https://github.com/hicder/agy-acp) — distributed by [TomeVault](https://tomevault.io).
