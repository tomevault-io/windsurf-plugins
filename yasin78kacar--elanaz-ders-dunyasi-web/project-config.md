---
trigger: always_on
description: Bu dosya, Ders Dünyası projesinde çalışan AI agent'ın (Cursor / Claude Code) her oturumda uyması gereken kuralları içerir. Bu kurallar Yasin tarafından belirlenmiştir ve istisnasız uygulanır.
---
...
---
> Source: [yasin78kacar/elanaz-ders-dunyasi-web](https://github.com/yasin78kacar/elanaz-ders-dunyasi-web) — distributed by [TomeVault](https://tomevault.io).
