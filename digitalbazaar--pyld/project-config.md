---
trigger: always_on
description: - Review documentation diffs with the same rigor as code diffs; apply the
---
...
---
> Source: [digitalbazaar/pyld](https://github.com/digitalbazaar/pyld) — distributed by [TomeVault](https://tomevault.io).
