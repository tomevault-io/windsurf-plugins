---
trigger: always_on
description: Das `import` Modul ist das **Kern-Framework** des Pacemaker Import-Systems. Es ist ein **Tier 3 Modul** und integriert alle Infrastructure-Tiers (0-2) mit Core-Logik.
---
...
---
> Source: [techdivision/import](https://github.com/techdivision/import) — distributed by [TomeVault](https://tomevault.io).
