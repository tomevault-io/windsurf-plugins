---
trigger: always_on
description: This project uses **uv** for dependency management. Always use `uv` commands:
---
...
---
> Source: [allenai/reward-bench](https://github.com/allenai/reward-bench) — distributed by [TomeVault](https://tomevault.io).
