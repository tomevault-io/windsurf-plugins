---
trigger: always_on
description: This is a .NET MAUI plugin that provides cross-platform access to device calendars (read/write calendars, events, attendees, reminders). It targets Android, iOS, macOS (Catalyst), and Windows.
---
...
---
> Source: [jfversluis/Plugin.Maui.CalendarStore](https://github.com/jfversluis/Plugin.Maui.CalendarStore) — distributed by [TomeVault](https://tomevault.io).
