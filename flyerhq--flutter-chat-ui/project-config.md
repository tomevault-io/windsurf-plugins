---
trigger: always_on
description: - **Performance** - Always optimize for performance.
---
...
---
> Source: [flyerhq/flutter_chat_ui](https://github.com/flyerhq/flutter_chat_ui) — distributed by [TomeVault](https://tomevault.io).
