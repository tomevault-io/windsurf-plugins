---
trigger: always_on
description: SDL_kitchensink is an FFmpeg and SDL3 based C99 library for audio and video
---
...
---
> Source: [katajakasa/SDL_kitchensink](https://github.com/katajakasa/SDL_kitchensink) — distributed by [TomeVault](https://tomevault.io).
