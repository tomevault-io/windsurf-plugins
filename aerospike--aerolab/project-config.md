...
The [backend package](mdc:pkg/backend/init.go) provides unified multi-cloud management:
...
Refer to [backend README](mdc:pkg/backend/README.md) for comprehensive backend documentation.

---
> Source: [aerospike/aerolab](https://github.com/aerospike/aerolab) — distributed by [TomeVault](https://tomevault.io).
