...
---
> Source: [obi1kenobi/cargo-semver-checks](https://github.com/obi1kenobi/cargo-semver-checks) — distributed by [TomeVault](https://tomevault.io).
