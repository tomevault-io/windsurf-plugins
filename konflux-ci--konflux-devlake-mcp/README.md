# AI instruction files for konflux-devlake-mcp
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/konflux-ci/konflux-devlake-mcp](https://github.com/konflux-ci/konflux-devlake-mcp)
