---
trigger: always_on
description: 0. 如果当前目录不在知识库内，向上遍历父目录直到找到 `.thirdspace/workspace-index.yaml`，该目录即为 vault 根。也可通过 `$THIRDSPACE_VAULT` 环境变量或 `~/.thirdspace/config.yaml` 指定（可选）。
---
...
---
> Source: [zzyong24/thirdspace-vault-template](https://github.com/zzyong24/thirdspace-vault-template) — distributed by [TomeVault](https://tomevault.io).
