---
trigger: always_on
description: openstack-operator is a Kubernetes meta-operator that orchestrates the entire
---
...
---
> Source: [openstack-k8s-operators/openstack-operator](https://github.com/openstack-k8s-operators/openstack-operator) — distributed by [TomeVault](https://tomevault.io).
