---
trigger: always_on
description: 이 파일은 Claude Code가 이 프로젝트에서 코드를 작성하거나 수정할 때 **항상** 준수해야 하는 규칙입니다.
---
...
---
> Source: [zz1231me/myhomepage](https://github.com/zz1231me/myhomepage) — distributed by [TomeVault](https://tomevault.io).
