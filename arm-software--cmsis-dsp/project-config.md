---
trigger: always_on
description: - To build CMSIS-DSP in a cmake project use `add_subdirectory` and use the CMSIS-DSP folder
---
...
---
> Source: [ARM-software/CMSIS-DSP](https://github.com/ARM-software/CMSIS-DSP) — distributed by [TomeVault](https://tomevault.io).
