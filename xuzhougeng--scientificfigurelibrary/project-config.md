---
trigger: always_on
description: 适用于整个仓库。保持本文件简短，只放日常开发约束和按需阅读入口；详细设计、决策依据和任务进度放在对应文档中。
---
...
---
> Source: [xuzhougeng/ScientificFigureLibrary](https://github.com/xuzhougeng/ScientificFigureLibrary) — distributed by [TomeVault](https://tomevault.io).
