---
trigger: always_on
description: Lofi FM is an online lofi music player built as a client-side web application. It allows users to play lofi music from YouTube videos, with features like custom theming, background images, draggable controls, starring songs, and background video scaling options. The app is designed for work, study, and relaxation, particularly during coding sessions.
---
...
---
> Source: [kiran-venugopal/lofi-fm](https://github.com/kiran-venugopal/lofi-fm) — distributed by [TomeVault](https://tomevault.io).
