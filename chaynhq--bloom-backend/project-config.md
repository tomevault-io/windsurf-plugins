---
trigger: always_on
description: NestJS/TypeScript REST API for a trauma-healing support platform. PostgreSQL via TypeORM, deployed on Render.
---
...
---
> Source: [chaynHQ/bloom-backend](https://github.com/chaynHQ/bloom-backend) — distributed by [TomeVault](https://tomevault.io).
