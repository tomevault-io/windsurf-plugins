---
trigger: always_on
description: - Test files should be named in the format `[module-name].spec.ts`
---
...
---
> Source: [coze-dev/coze-js](https://github.com/coze-dev/coze-js) — distributed by [TomeVault](https://tomevault.io).
