---
trigger: always_on
description: 本仓库不再通过 `AGENTS.md` 约束 `.ai/skills/` 的加载与使用；相关能力是否启用、如何启用，改由各自 IDE 或本地 Agent 配置决定。
---
...
---
> Source: [TencentBlueKing/BKFlow](https://github.com/TencentBlueKing/BKFlow) — distributed by [TomeVault](https://tomevault.io).
