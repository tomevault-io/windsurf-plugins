---
trigger: always_on
description: DDD-first operating guide for coding agents in this repository.
---
...
---
> Source: [shortlink-org/shortlink](https://github.com/shortlink-org/shortlink) — distributed by [TomeVault](https://tomevault.io).
