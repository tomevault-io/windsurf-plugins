---
trigger: always_on
description: Info about the actual game can be found in the `docs` folder. `docs/game_info.md` is the entry point.
---
...
---
> Source: [vossenwout/llm-rpg](https://github.com/vossenwout/llm-rpg) — distributed by [TomeVault](https://tomevault.io).
