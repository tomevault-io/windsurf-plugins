---
trigger: always_on
description: - `drs` - Apply Nix configuration with darwin-rebuild
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/tmm)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/tmm)
