---
trigger: always_on
description: This directory is LazyLLM's **module abstraction layer**, defining the base class and core implementations for all executable units.
---
...
---
> Source: [LazyAGI/LazyLLM](https://github.com/LazyAGI/LazyLLM) — distributed by [TomeVault](https://tomevault.io).
