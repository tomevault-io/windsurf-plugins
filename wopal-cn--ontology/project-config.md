---
trigger: always_on
description: > **定位**：WopalSpace 的 Agent 能力源码研发中心。所有修改在此，部署到 `.wopal/`，运行时加载自 `.agents/`。
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/wopal-cn) — claim your Tome and manage your conversions.
