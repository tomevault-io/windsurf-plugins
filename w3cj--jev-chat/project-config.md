---
trigger: always_on
description: pnpm monorepo: `apps/server` (Hono, Jev pipeline, MCP adapters), `apps/web` (React), and
---
...
---
> Source: [w3cj/jev-chat](https://github.com/w3cj/jev-chat) — distributed by [TomeVault](https://tomevault.io).
