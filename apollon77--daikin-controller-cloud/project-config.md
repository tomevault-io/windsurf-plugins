---
trigger: always_on
description: This is a TypeScript library for interacting with Daikin Cloud devices through the Daikin Onecta API. The library provides an abstraction layer over OpenID Connect (OIDC) authentication flows and facilitates device control via the cloud.
---
...
---
> Source: [Apollon77/daikin-controller-cloud](https://github.com/Apollon77/daikin-controller-cloud) — distributed by [TomeVault](https://tomevault.io).
