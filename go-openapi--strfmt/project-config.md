---
trigger: always_on
description: Go library that gives first-class Go types to the `format` keyword from
---
...
---
> Source: [go-openapi/strfmt](https://github.com/go-openapi/strfmt) — distributed by [TomeVault](https://tomevault.io).
