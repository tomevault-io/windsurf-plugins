---
trigger: always_on
description: - Do not restart the PM2 service for changes under `public/`. Static files are served from disk; a browser refresh is enough.
---
...
---
> Source: [ttm43/codex-cc-web-terminal](https://github.com/ttm43/codex-cc-web-terminal) — distributed by [TomeVault](https://tomevault.io).
