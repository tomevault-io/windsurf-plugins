---
trigger: always_on
description: This project follows Vyges conventions for hardware IP development. Context is provided via the **vyges.vycontext** extension:
---
...
---
> Source: [vyges/vyges-ip-template](https://github.com/vyges/vyges-ip-template) — distributed by [TomeVault](https://tomevault.io).
