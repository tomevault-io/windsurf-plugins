---
trigger: always_on
description: - Never pass `-D warnings` to `cargo clippy` or `cargo build`. Run plain
---
...
---
> Source: [questdb/c-questdb-client](https://github.com/questdb/c-questdb-client) — distributed by [TomeVault](https://tomevault.io).
