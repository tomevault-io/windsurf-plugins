...
Original source: `AGENTS.md` in [PrimeIntellect-ai/verifiers](https://github.com/PrimeIntellect-ai/verifiers).
...
```
npx tomevault install PrimeIntellect-ai/verifiers
```
Source: [github.com/PrimeIntellect-ai/verifiers](https://github.com/PrimeIntellect-ai/verifiers).
