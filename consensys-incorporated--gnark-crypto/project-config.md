---
trigger: always_on
description: This is a **heavily code-generated** cryptography library. ~90% of code under `ecc/` and `field/` is generated from Go templates.
---
...
---
> Source: [Consensys-Incorporated/gnark-crypto](https://github.com/Consensys-Incorporated/gnark-crypto) — distributed by [TomeVault](https://tomevault.io).
