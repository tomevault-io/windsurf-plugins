---
trigger: always_on
description: - Treat this AGENTS.md as the single source that distills historical reviewers’ expectations. Use it for every AI review, test run, and documentation update.
---
...
---
> Source: [vocdoni/davinci-node](https://github.com/vocdoni/davinci-node) — distributed by [TomeVault](https://tomevault.io).
