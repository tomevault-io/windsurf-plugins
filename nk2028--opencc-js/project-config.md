---
trigger: always_on
description: `opencc-js` is a pure JavaScript implementation of Open Chinese Convert for browsers and Node.js. Dictionary data is generated from `opencc-data` at build time and bundled into `dist`.
---
...
---
> Source: [nk2028/opencc-js](https://github.com/nk2028/opencc-js) — distributed by [TomeVault](https://tomevault.io).
