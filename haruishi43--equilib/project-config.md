---
trigger: always_on
description: `equilib` (PyPI: `pyequilib`) is a Python library for processing equirectangular
---
...
---
> Source: [haruishi43/equilib](https://github.com/haruishi43/equilib) — distributed by [TomeVault](https://tomevault.io).
