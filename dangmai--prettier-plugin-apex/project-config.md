---
trigger: always_on
description: A Prettier plugin for Salesforce Apex. It is a pnpm monorepo orchestrated with Nx. The plugin delegates parsing to a Java component (`apex-ast-serializer`) that wraps Salesforce's proprietary `jorje` parser, then uses Prettier's doc IR to format the resulting AST.
---
...
---
> Source: [dangmai/prettier-plugin-apex](https://github.com/dangmai/prettier-plugin-apex) — distributed by [TomeVault](https://tomevault.io).
