---
trigger: always_on
description: This document defines the conventions for creating and using benchmarks in `pyapprox_benchmarks`.
---
...
---
> Source: [sandialabs/pyapprox](https://github.com/sandialabs/pyapprox) — distributed by [TomeVault](https://tomevault.io).
