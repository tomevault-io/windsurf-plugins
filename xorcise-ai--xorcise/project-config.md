---
trigger: always_on
description: XORCISE runs cyber-AI agents against real missions inside an isolated per-run environment,
---
...
---
> Source: [xorcise-ai/xorcise](https://github.com/xorcise-ai/xorcise) — distributed by [TomeVault](https://tomevault.io).
