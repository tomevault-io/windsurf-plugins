---
trigger: always_on
description: This file tells AI agents (Claude Code, Codex, Cursor, Copilot, etc.) how to
---
...
---
> Source: [strangeadvancedmarketing/Adam](https://github.com/strangeadvancedmarketing/Adam) — distributed by [TomeVault](https://tomevault.io).
