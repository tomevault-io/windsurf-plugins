---
trigger: always_on
description: Barbara Minto's Pyramid Principle packaged as five composable writing skills. No commands, no agents, no MCP — skills only. Each skill is independently addressable by its skill ID.
---
...
---
> Source: [tyroneross/pyramid-principle](https://github.com/tyroneross/pyramid-principle) — distributed by [TomeVault](https://tomevault.io).
