---
trigger: always_on
description: This is a Node.js application that generates Kindle-compatible screensaver images from Home Assistant Lovelace dashboards using Puppeteer (headless Chrome) and image processing tools.
---
...
---
> Source: [sibbl/hass-lovelace-kindle-screensaver](https://github.com/sibbl/hass-lovelace-kindle-screensaver) — distributed by [TomeVault](https://tomevault.io).
