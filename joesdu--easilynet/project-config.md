---
trigger: always_on
description: RabbitMQ event bus with publisher confirms, Channel<T> retry queue, Polly resilience, dead letter store, consumer
---
...
---
> Source: [joesdu/EasilyNET](https://github.com/joesdu/EasilyNET) — distributed by [TomeVault](https://tomevault.io).
