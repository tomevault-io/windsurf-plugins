---
trigger: always_on
description: ./build.sh --download-driver   # download the Playwright driver
---
...
---
> Source: [microsoft/playwright-dotnet](https://github.com/microsoft/playwright-dotnet) — distributed by [TomeVault](https://tomevault.io).
