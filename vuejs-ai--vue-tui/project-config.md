---
trigger: always_on
description: - AGENTS.md is the source of truth. CLAUDE.md is a symlink to it.
---
...
---
> Source: [vuejs-ai/vue-tui](https://github.com/vuejs-ai/vue-tui) — distributed by [TomeVault](https://tomevault.io).
