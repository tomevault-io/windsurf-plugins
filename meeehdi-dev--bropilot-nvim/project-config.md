---
trigger: always_on
description: This document provides instructions and guidelines for AI agents (like Copilot, Cursor, or other coding assistants) operating within the `bropilot.nvim` repository.
---
...
---
> Source: [meeehdi-dev/bropilot.nvim](https://github.com/meeehdi-dev/bropilot.nvim) — distributed by [TomeVault](https://tomevault.io).
