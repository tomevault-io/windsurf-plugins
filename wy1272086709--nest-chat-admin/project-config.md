---
trigger: always_on
description: 本文档定义 Codex 及其他编码智能体在本仓库中的协作规范，适用于整个仓库。
---
...
---
> Source: [wy1272086709/nest-chat-admin](https://github.com/wy1272086709/nest-chat-admin) — distributed by [TomeVault](https://tomevault.io).
