---
trigger: always_on
description: - Use `uv run` for all script and command execution
---
...
---
> Source: [EuroEval/EuroEval](https://github.com/EuroEval/EuroEval) — distributed by [TomeVault](https://tomevault.io).
