---
trigger: always_on
description: This file provides essential context for AI assistants working with this NixOS homelab configuration repository.
---
...
---
> Source: [truxnell/nix-config](https://github.com/truxnell/nix-config) — distributed by [TomeVault](https://tomevault.io).
