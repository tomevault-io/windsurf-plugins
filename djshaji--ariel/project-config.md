---
trigger: always_on
description: Ariel is a cross-platform LV2 plugin host built with GTK4 and lilv for real-time audio processing. The application provides a modern interface for loading and managing LV2 plugins with JACK audio backend support.
---
