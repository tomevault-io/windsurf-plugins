---
trigger: always_on
description: - **Run all tests**: `make test` or `uv run pytest -v -s`
---
...
---
> Source: [bernatsampera/event-deep-research](https://github.com/bernatsampera/event-deep-research) — distributed by [TomeVault](https://tomevault.io).
