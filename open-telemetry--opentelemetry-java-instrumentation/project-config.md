---
trigger: always_on
description: First-pass PR review rules. A deep review with full knowledge files runs
---
...
---
> Source: [open-telemetry/opentelemetry-java-instrumentation](https://github.com/open-telemetry/opentelemetry-java-instrumentation) — distributed by [TomeVault](https://tomevault.io).
