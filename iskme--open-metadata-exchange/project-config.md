---
trigger: always_on
description: Open Metadata Exchange (OME) is a distributed, decentralized network for sharing metadata
---
...
---
> Source: [ISKME/Open-Metadata-Exchange](https://github.com/ISKME/Open-Metadata-Exchange) — distributed by [TomeVault](https://tomevault.io).
