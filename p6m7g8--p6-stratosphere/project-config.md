---
trigger: always_on
description: This repository, **p6-cirrus**, is a collection of Bash/Zsh helper functions and scripts for AWS CLI operations (CloudTrail, ConfigService, EC2, IAM, etc.) organized under `lib/`, plus a `p6-cirrus.zsh` module. There are ~30 small scripts, no compiled languages.
---
...
---
> Source: [p6m7g8/p6-stratosphere](https://github.com/p6m7g8/p6-stratosphere) — distributed by [TomeVault](https://tomevault.io).
