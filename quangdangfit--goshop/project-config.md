---
trigger: always_on
description: Project-specific rules are in `.claude/rules/`.
---
...
---
> Source: [quangdangfit/goshop](https://github.com/quangdangfit/goshop) — distributed by [TomeVault](https://tomevault.io).
