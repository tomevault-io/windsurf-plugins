---
trigger: always_on
description: - The only runnable installed bundle is `/Applications/SuperDictate.app`.
---
...
---
> Source: [shlgd/SuperDictate](https://github.com/shlgd/SuperDictate) — distributed by [TomeVault](https://tomevault.io).
