---
trigger: always_on
description: This project uses [**mise**](https://mise.jdx.dev) to pin tools, expose tasks, and wire git hooks. `mise.toml` is the source of truth. Don't install tools by hand or add ad-hoc scripts; add a mise tool or task instead.
---
...
---
> Source: [sherifabdlnaby/gpool](https://github.com/sherifabdlnaby/gpool) — distributed by [TomeVault](https://tomevault.io).
