---
trigger: always_on
description: This project is Fray, a Java concurrency testing platform for the JVM. It instruments the JVM and application,
---
...
---
> Source: [cmu-pasta/fray](https://github.com/cmu-pasta/fray) — distributed by [TomeVault](https://tomevault.io).
