---
trigger: always_on
description: 本文件定义基于 Tauri + Rsbuild + React 19 + TailwindCSS 的多代理协作架构，用于指导后续模块化开发与联调。
---
...
---
> Source: [Mario34/tesla-camera](https://github.com/Mario34/tesla-camera) — distributed by [TomeVault](https://tomevault.io).
