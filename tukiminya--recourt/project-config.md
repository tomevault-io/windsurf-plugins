---
trigger: always_on
description: - このリポジトリ内のエージェントは、ユーザーからのあらゆるリクエストに対して日本語で返答してください。
---
...
---
> Source: [tukiminya/recourt](https://github.com/tukiminya/recourt) — distributed by [TomeVault](https://tomevault.io).
