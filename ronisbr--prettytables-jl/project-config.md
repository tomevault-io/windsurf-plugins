---
trigger: always_on
description: - Treat `src/PrettyTables.jl` as the module entrypoint. Preserve its include order: load core types and implementation first, keep each backend grouped, load printing-state files after the backends, and include `src/precompile.jl` last.
---
...
---
> Source: [ronisbr/PrettyTables.jl](https://github.com/ronisbr/PrettyTables.jl) — distributed by [TomeVault](https://tomevault.io).
