---
trigger: always_on
description: - Core SDK code lives in `splunklib/` (client bindings, search commands, modular input helpers). Keep new modules close to their domain peers (e.g., searchcommand utilities under `splunklib/searchcommands`).
---
...
---
> Source: [splunk/splunk-sdk-python](https://github.com/splunk/splunk-sdk-python) — distributed by [TomeVault](https://tomevault.io).
