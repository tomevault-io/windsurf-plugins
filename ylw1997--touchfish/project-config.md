---
trigger: always_on
description: - **扩展入口**：`src/extension.ts` 负责注册所有新闻树视图与微博/知乎 Webview，新增 Provider 后要同步更新 `package.json` 的 `views`/`commands` 声明。
---
...
---
> Source: [ylw1997/touchFish](https://github.com/ylw1997/touchFish) — distributed by [TomeVault](https://tomevault.io).
