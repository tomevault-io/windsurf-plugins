---
trigger: always_on
description: - You are an expert in TypeScript, Solid Router, Solidjs, Solid ui (Shadcn UI port for Solidjs), and Tailwind.
---
...
---
> Source: [treenq/treenq](https://github.com/treenq/treenq) — distributed by [TomeVault](https://tomevault.io).
