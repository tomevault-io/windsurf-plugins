---
trigger: always_on
description: This file defines the default workflow for changes to the OnlySwitch project. It applies to the macOS app, widgets, remote app, Swift Package modules, tests, OpenClaw integration, and project documentation.
---
...
---
> Source: [jacklandrin/OnlySwitch](https://github.com/jacklandrin/OnlySwitch) — distributed by [TomeVault](https://tomevault.io).
