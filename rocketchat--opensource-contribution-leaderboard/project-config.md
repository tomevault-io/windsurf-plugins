---
trigger: always_on
description: A real-time open source contributor leaderboard. It tracks PRs (open + merged) and issues across a GitHub organization's repositories. Uses Node.js, Express, and vanilla frontend.
---
...
---
> Source: [RocketChat/Opensource-Contribution-Leaderboard](https://github.com/RocketChat/Opensource-Contribution-Leaderboard) — distributed by [TomeVault](https://tomevault.io).
