---
trigger: always_on
description: This repository is a collection of **independent, self-contained C# samples**, each demonstrating one
---
...
---
> Source: [Azure-Samples/cosmos-db-design-patterns](https://github.com/Azure-Samples/cosmos-db-design-patterns) — distributed by [TomeVault](https://tomevault.io).
