---
trigger: always_on
description: This repository manages the Korean-authored source and published English variant of the AI-Human cowork framework.
---

# Repository Copilot Instructions

This repository manages the Korean-authored source and published English variant of the AI-Human cowork framework.
This file is the repository maintenance context that GitHub Copilot reads automatically.

> OpenAI Codex and Cursor users: see `AGENTS.md` in the project root.
> Claude Code users: see `CLAUDE.md` in the project root.
...
---
> Source: [lim8603/cowork-context-framework](https://github.com/lim8603/cowork-context-framework) — distributed by [TomeVault](https://tomevault.io).
