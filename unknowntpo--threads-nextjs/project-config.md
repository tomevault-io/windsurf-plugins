---
trigger: always_on
description: - `app/` holds the Next.js route tree, including route handlers and shared layouts; use the `@/` alias for imports.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/unknowntpo)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/unknowntpo)
