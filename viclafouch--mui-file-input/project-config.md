---
trigger: always_on
description: A file input component for MUI (Material UI), published on NPM as `mui-file-input`.
---
...
---
> Source: [viclafouch/mui-file-input](https://github.com/viclafouch/mui-file-input) — distributed by [TomeVault](https://tomevault.io).
