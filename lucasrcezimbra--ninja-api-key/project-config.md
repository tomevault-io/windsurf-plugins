---
trigger: always_on
description: This is a Django package that provides API Key authentication for [Django Ninja](https://django-ninja.dev/). It's a fork of django-ninja-apikey with enhanced security features and better Django integration.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/lucasrcezimbra) — claim your Tome and manage your conversions.
