---
trigger: always_on
description: Top-level entrypoint for agents working in this repository.
---
...
---
> Source: [microsoftgraph/microsoft-graph-docs-contrib](https://github.com/microsoftgraph/microsoft-graph-docs-contrib) — distributed by [TomeVault](https://tomevault.io).
