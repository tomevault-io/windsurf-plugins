---
trigger: always_on
description: 本文档为AI Coding智能体在本代码仓库工作时提供指导。
---
...
---
> Source: [macula-projects/macula-boot](https://github.com/macula-projects/macula-boot) — distributed by [TomeVault](https://tomevault.io).
