---
trigger: always_on
description: This project is a React component library called `tasks-timeline-view`. It provides a timeline view for displaying and managing tasks. The library is built with React, TypeScript, and Vite. It uses Storybook for component development and demonstration, and Zustand for state management.
---
...
---
> Source: [Leonezz/tasks-timeline-view](https://github.com/Leonezz/tasks-timeline-view) — distributed by [TomeVault](https://tomevault.io).
