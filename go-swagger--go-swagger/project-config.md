---
trigger: always_on
description: Generates server, client, CLI, and model code from specs — or specs from annotated Go source.
---
...
---
> Source: [go-swagger/go-swagger](https://github.com/go-swagger/go-swagger) — distributed by [TomeVault](https://tomevault.io).
