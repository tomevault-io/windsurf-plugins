---
trigger: always_on
description: You need to touch **6 files** (2 new, 4 existing):
---
...
---
> Source: [upstash/redis-js](https://github.com/upstash/redis-js) — distributed by [TomeVault](https://tomevault.io).
