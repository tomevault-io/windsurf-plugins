---
trigger: always_on
description: Here is a list with some of the code conventions used by raylib:
---
...
---
> Source: [raysan5/raylib](https://github.com/raysan5/raylib) — distributed by [TomeVault](https://tomevault.io).
