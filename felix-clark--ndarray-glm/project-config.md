...
- Greek letters for model quantities: `\eta` (natural parameter), `\mu` (mean), `\omega` (linear predictor), `\rho` (linear offset/control)
...
---
> Source: [felix-clark/ndarray-glm](https://github.com/felix-clark/ndarray-glm) — distributed by [TomeVault](https://tomevault.io).
