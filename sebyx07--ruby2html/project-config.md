---
trigger: always_on
description: Ruby2html is a Ruby gem that converts pure Ruby code into HTML. It features **C extension optimizations** for high-performance HTML rendering, escaping, and attribute generation. The project is both a standalone gem and a Rails demo application.
---
...
---
> Source: [sebyx07/ruby2html](https://github.com/sebyx07/ruby2html) — distributed by [TomeVault](https://tomevault.io).
