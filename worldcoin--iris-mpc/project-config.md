---
trigger: always_on
description: - Root `Cargo.toml` wires `iris-mpc/` (service entrypoints), `iris-mpc-common/` (shared types), `iris-mpc-cpu/` (HNSW stack), `iris-mpc-gpu/` (CUDA stack), and `iris-mpc-store/` (persistence).
---
...
---
> Source: [worldcoin/iris-mpc](https://github.com/worldcoin/iris-mpc) — distributed by [TomeVault](https://tomevault.io).
