---
trigger: always_on
description: Synthora is an Avalonia UI theme and control styles library component targeting .NET 10.0. The `Synthora` project produces a NuGet package with styling definitions, resources (accents, theme files, strings, density styles), and component setups. `Synthora.Demo` provides a test/demo application.
---
...
---
> Source: [zrt2399/Synthora](https://github.com/zrt2399/Synthora) — distributed by [TomeVault](https://tomevault.io).
