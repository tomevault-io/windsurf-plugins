...
Original source: `AGENTS.md` in [tuist/schlussel](https://github.com/tuist/schlussel).
...
From [tuist/schlussel](https://github.com/tuist/schlussel) — a repo with 16+ stars on GitHub.
