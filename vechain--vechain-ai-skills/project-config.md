---
trigger: always_on
description: marketplace.json            # Plugin marketplace catalog
---
...
---
> Source: [vechain/vechain-ai-skills](https://github.com/vechain/vechain-ai-skills) — distributed by [TomeVault](https://tomevault.io).
