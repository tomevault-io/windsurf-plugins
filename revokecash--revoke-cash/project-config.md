---
trigger: always_on
description: NEVER stage or unstage changes, just leave them in the working directory. The index is user-owned.
---
...
---
> Source: [RevokeCash/revoke.cash](https://github.com/RevokeCash/revoke.cash) — distributed by [TomeVault](https://tomevault.io).
