---
trigger: always_on
description: Este arquivo cobre todo o repositório.
---
...
---
> Source: [SharebookBR/sharebook-backend](https://github.com/SharebookBR/sharebook-backend) — distributed by [TomeVault](https://tomevault.io).
