---
trigger: always_on
description: This is an AI-driven tool for automatically generating book sources for the Legado reading Android app. The system analyzes website HTML structures and creates compliant JSON configurations using a knowledge-driven approach.
---
...
---
> Source: [DandanLLab/legadoSkill](https://github.com/DandanLLab/legadoSkill) — distributed by [TomeVault](https://tomevault.io).
