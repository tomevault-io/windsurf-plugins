---
trigger: always_on
description: - For Frontend documentation use [XtendUI](https://github.com/xtendui/xtendui) and [Tailwindcss](https://github.com/tailwindlabs/tailwindcss).
---
...
---
> Source: [xtendui/xtendui](https://github.com/xtendui/xtendui) — distributed by [TomeVault](https://tomevault.io).
