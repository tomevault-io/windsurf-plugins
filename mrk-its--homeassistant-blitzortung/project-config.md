---
trigger: always_on
description: <!-- CLAUDE.md is a symlink to this file — edit only AGENTS.md -->
---
...
- When adding new functionality, always include unit tests.
- If existing code needs to be modified and is not covered by tests, first implement appropriate tests to verify the current behavior. This ensures that the changes do not introduce regressions.
...
---
> Source: [mrk-its/homeassistant-blitzortung](https://github.com/mrk-its/homeassistant-blitzortung) — distributed by [TomeVault](https://tomevault.io).
