---
trigger: always_on
description: > Use this document as a system prompt or paste directly into any LLM to enable openlore capabilities.
---
...
- Before committing code (pre-commit hook via `openlore drift --install-hook`)
...
---
> Source: [clay-good/OpenLore](https://github.com/clay-good/OpenLore) — distributed by [TomeVault](https://tomevault.io).
