---
trigger: always_on
description: Expo template with pre-built components and patterns.
---
...
---
> Source: [vandamd/light-template](https://github.com/vandamd/light-template) — distributed by [TomeVault](https://tomevault.io).
