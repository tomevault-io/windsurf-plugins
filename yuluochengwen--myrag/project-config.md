---
trigger: always_on
description: - Backend uses Python 3.11 + FastAPI with typed config objects in `Backend/app/core/config.py`; add new config fields via `BaseModel`/`Settings` instead of scattered constants.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/yuluochengwen)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/yuluochengwen)
