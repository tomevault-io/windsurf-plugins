---
trigger: always_on
description: Pivot is a minimal GUI for coding agents. A Node WebSocket server wraps provider CLIs (Codex, Claude Code, Cursor, Grok, OpenCode) and serves web, desktop, and mobile clients.
---
...
---
> Source: [13kparkin/Pivot](https://github.com/13kparkin/Pivot) — distributed by [TomeVault](https://tomevault.io).
