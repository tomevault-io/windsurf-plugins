---
trigger: always_on
description: - **Package Manager**: Use `pnpm` (not npm or yarn).
---
...
---
> Source: [NeteaseCloudMusicApiEnhanced/api-enhanced](https://github.com/NeteaseCloudMusicApiEnhanced/api-enhanced) — distributed by [TomeVault](https://tomevault.io).
