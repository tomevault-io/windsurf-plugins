---
trigger: always_on
description: GPU-accelerated video preview thumbnail (BIF) generation for Plex Media Server. Uses FFmpeg hardware decoding (CUDA, VAAPI, QSV, VideoToolbox) and parallel workers. Docker-only deployment with a web UI as the sole interface (no CLI).
---
...
---
> Source: [stevezau/media_preview_generator](https://github.com/stevezau/media_preview_generator) — distributed by [TomeVault](https://tomevault.io).
