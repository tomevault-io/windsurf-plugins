---
trigger: always_on
description: Tool tests should not load full channel or plugin runtimes for static tool
---
...
---
> Source: [answeryt/Jumping-Agent-platform](https://github.com/answeryt/Jumping-Agent-platform) — distributed by [TomeVault](https://tomevault.io).
