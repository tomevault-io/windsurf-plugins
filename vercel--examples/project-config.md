---
trigger: always_on
description: - **Build**: `npm run build` (uses Next.js with Turbopack)
---
...
---
> Source: [vercel/examples](https://github.com/vercel/examples) — distributed by [TomeVault](https://tomevault.io).
