---
trigger: always_on
description: This extension provides a real-time, bottom-sticky heads-up display (HUD) at the bottom of your terminal during Gemini CLI sessions.
---
...
---
> Source: [yideng-xl/gemini-cli-hud](https://github.com/yideng-xl/gemini-cli-hud) — distributed by [TomeVault](https://tomevault.io).
