---
trigger: always_on
description: Use the `[TYPE](scope): Description` format:
---
...
---
> Source: [chroma-core/chroma](https://github.com/chroma-core/chroma) — distributed by [TomeVault](https://tomevault.io).
