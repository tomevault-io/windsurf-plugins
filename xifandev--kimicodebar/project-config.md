---
trigger: always_on
description: - 完成修改后，尤其是改动较多、涉及关键功能 / UI 重构 / bug 修复时，Agent 应直接执行 `git commit` 并 `git push` 推送到 GitHub，无需询问用户确认。
---
...
---
> Source: [xifandev/KimiCodeBar](https://github.com/xifandev/KimiCodeBar) — distributed by [TomeVault](https://tomevault.io).
