---
trigger: always_on
description: - Preserve the asynchronous `init()` and `parse()` API and token output format.
---
...
---
> Source: [hexenq/kuroshiro-analyzer-kuromoji](https://github.com/hexenq/kuroshiro-analyzer-kuromoji) — distributed by [TomeVault](https://tomevault.io).
