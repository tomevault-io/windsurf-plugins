---
trigger: always_on
description: The pipeline flows: **discover** → **extract** → **index** → **query**
---
...
---
> Source: [unblocked/repo-rules-agent](https://github.com/unblocked/repo-rules-agent) — distributed by [TomeVault](https://tomevault.io).
