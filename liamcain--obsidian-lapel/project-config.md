---
trigger: always_on
description: This repo follows [Conventional Commits](https://www.conventionalcommits.org/). Every commit message must match:
---
...
---
> Source: [liamcain/obsidian-lapel](https://github.com/liamcain/obsidian-lapel) — distributed by [TomeVault](https://tomevault.io).
