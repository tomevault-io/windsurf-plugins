---
trigger: always_on
description: - All folders within the clients follow the kebab-case naming convention. This means folder names are lowercase with words separated by hyphens ("-").
---
...
---
> Source: [LoopscaleLabs/rwa-token](https://github.com/LoopscaleLabs/rwa-token) — distributed by [TomeVault](https://tomevault.io).
