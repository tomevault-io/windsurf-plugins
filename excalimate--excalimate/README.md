...
Original source: `copilot-instructions.md` in [excalimate/excalimate](https://github.com/excalimate/excalimate).
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/excalimate/excalimate](https://github.com/excalimate/excalimate)
