---
trigger: always_on
description: **raygun4node** is the official Raygun.com Node.js SDK, written in TypeScript. It enables Node.js applications to send crash reports and error data to the Raygun error monitoring service.
---
...
---
> Source: [MindscapeHQ/raygun4node](https://github.com/MindscapeHQ/raygun4node) — distributed by [TomeVault](https://tomevault.io).
