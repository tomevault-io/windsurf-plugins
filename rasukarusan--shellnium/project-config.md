---
trigger: always_on
description: Shellnium is a Selenium WebDriver implementation for Bash/Zsh. It enables browser automation directly from the terminal using W3C WebDriver protocol over curl + jq.
---
...
---
> Source: [Rasukarusan/shellnium](https://github.com/Rasukarusan/shellnium) — distributed by [TomeVault](https://tomevault.io).
