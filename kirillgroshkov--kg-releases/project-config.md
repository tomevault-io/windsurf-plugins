---
trigger: always_on
description: **kg-releases** is a Vue 3 web app that tracks GitHub release notifications for starred
---
...
---
> Source: [kirillgroshkov/kg-releases](https://github.com/kirillgroshkov/kg-releases) — distributed by [TomeVault](https://tomevault.io).
