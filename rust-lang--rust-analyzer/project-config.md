---
trigger: always_on
description: Follow `AI_POLICY.md`. In particular:
---
...
---
> Source: [rust-lang/rust-analyzer](https://github.com/rust-lang/rust-analyzer) — distributed by [TomeVault](https://tomevault.io).
