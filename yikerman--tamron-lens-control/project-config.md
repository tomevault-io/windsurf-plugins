---
trigger: always_on
description: This Rust 2024 project builds the `tlc` binary and reusable
---
...
---
> Source: [yikerman/tamron-lens-control](https://github.com/yikerman/tamron-lens-control) — distributed by [TomeVault](https://tomevault.io).
