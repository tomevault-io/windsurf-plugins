---
trigger: always_on
description: This repository is **Binance.Net** — a strongly typed C#/.NET client library for the Binance cryptocurrency exchange API. It is part of the CryptoExchange.Net ecosystem.
---
