---
trigger: always_on
description: When reviewing Pixeltable PRs, apply these project-specific rules. Pixeltable is a Python library (3.10–3.13) for declarative multimodal AI data infrastructure. UDFs (`@pxt.udf`) and query functions (`@pxt.query`) extend the system.
---
...
---
> Source: [pixeltable/pixeltable](https://github.com/pixeltable/pixeltable) — distributed by [TomeVault](https://tomevault.io).
