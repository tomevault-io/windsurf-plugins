---
trigger: always_on
description: This repository uses an agent harness. Treat reviews and code suggestions as part of that harness instead of as isolated code edits.
---
...
---
> Source: [vllm-project/semantic-router](https://github.com/vllm-project/semantic-router) — distributed by [TomeVault](https://tomevault.io).
