---
trigger: always_on
description: This is the **Apache Cassandra Datasource plugin for Grafana** — a Grafana data source plugin that enables visualizing time-series data stored in Apache Cassandra and CQL-compatible databases (DataStax Enterprise, DataStax Astra, AWS Keyspaces, etc.).
---
