---
trigger: always_on
description: We use the [Google C++ style
---
...
---
> Source: [apache/rocketmq-clients](https://github.com/apache/rocketmq-clients) — distributed by [TomeVault](https://tomevault.io).
