---
trigger: always_on
description: IMPORTANT: For any Markdown files generated by AI, always disclose that they were created with the assistance of AI. If missing, add the `ai-usage` frontmatter key/value pair:
---
...
---
> Source: [dotnet/docs](https://github.com/dotnet/docs) — distributed by [TomeVault](https://tomevault.io).
