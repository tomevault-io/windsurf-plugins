---
trigger: always_on
description: This repository is the canonical source for the `img2threejs` skill. Host entrypoints
---
...
---
> Source: [img2threejs/img2threejs](https://github.com/img2threejs/img2threejs) — distributed by [TomeVault](https://tomevault.io).
