---
trigger: always_on
description: This repository contains the content (Integrations, Scripts, Playbooks, Reports, Modeling Rules, Parsing Rules) for the Cortex Platform (XSOAR, XSIAM, etc.).
---
...
---
> Source: [demisto/content](https://github.com/demisto/content) — distributed by [TomeVault](https://tomevault.io).
