---
trigger: always_on
description: > **READ THIS FIRST**: This file serves as the single source of truth for any AI agent (Claude, Gemini, Cursor, etc.) working on the webpg2app repository. It aggregates architectural context, development workflows, and behavioral guidelines.
---

# webpg2app AI Agent Documentation

> **READ THIS FIRST**: This file serves as the single source of truth for any AI agent (Claude, Gemini, Cursor, etc.) working on the webpg2app repository. It aggregates architectural context, development workflows, and behavioral guidelines.
...
---
> Source: [mwakidenis/webpage2app](https://github.com/mwakidenis/webpage2app) — distributed by [TomeVault](https://tomevault.io).
