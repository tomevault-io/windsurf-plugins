---
trigger: always_on
description: CLI tool and library to download historical klines (candlestick data) from the Binance API. Supports JSON/CSV export. Distributed via npm, Homebrew, and standalone binaries.
---
...
---
> Source: [maxgfr/binance-historical](https://github.com/maxgfr/binance-historical) — distributed by [TomeVault](https://tomevault.io).
