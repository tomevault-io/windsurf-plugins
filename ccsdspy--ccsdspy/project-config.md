---
trigger: always_on
description: CCSDSPy is a Python library for reading tightly packed bits in CCSDS (Consultative Committee for Space Data Systems) format, used by NASA and ESA missions. It provides an object-oriented API for decoding fixed-length and variable-length packets from binary files.
---
...
---
> Source: [CCSDSPy/ccsdspy](https://github.com/CCSDSPy/ccsdspy) — distributed by [TomeVault](https://tomevault.io).
