---
trigger: always_on
description: Design tokens for GitHub's Primer design system, built with Style Dictionary.
---
...
---
> Source: [primer/primitives](https://github.com/primer/primitives) — distributed by [TomeVault](https://tomevault.io).
