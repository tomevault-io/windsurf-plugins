---
trigger: always_on
description: SharpPhysics is a 2D physics engine built with C# (.NET 9) and SFML.NET for rendering. It includes:
---
...
---
> Source: [dankelley2/sharpPhysics](https://github.com/dankelley2/sharpPhysics) — distributed by [TomeVault](https://tomevault.io).
