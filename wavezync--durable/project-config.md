---
trigger: always_on
description: Durable workflow engine for Elixir - provides resumable, reliable workflows with automatic retries, sleep/wait primitives, and PostgreSQL-backed persistence.
---
...
---
> Source: [wavezync/durable](https://github.com/wavezync/durable) — distributed by [TomeVault](https://tomevault.io).
