---
trigger: always_on
description: - `newton/_src/` is internal. Examples and docs must not import from `newton._src`. Expose user-facing symbols via public modules (`newton/geometry.py`, `newton/solvers.py`, etc.).
---
...
---
> Source: [newton-physics/newton](https://github.com/newton-physics/newton) — distributed by [TomeVault](https://tomevault.io).
