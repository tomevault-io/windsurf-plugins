---
trigger: always_on
description: A starter Cloudflare Worker using Chanfana (OpenAPI), Hono, D1, and Zod v4. This is a copyable template — users clone it and build on top.
---
...
---
> Source: [Dev-moe-kyawaung/chanfana-template](https://github.com/Dev-moe-kyawaung/chanfana-template) — distributed by [TomeVault](https://tomevault.io).
