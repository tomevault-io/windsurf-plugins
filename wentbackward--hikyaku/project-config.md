---
trigger: always_on
description: Short reference for agents working in this repo. For full docs see `docs/`.
---
...
---
> Source: [wentbackward/hikyaku](https://github.com/wentbackward/hikyaku) — distributed by [TomeVault](https://tomevault.io).
