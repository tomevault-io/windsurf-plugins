---
trigger: always_on
description: Before opening or updating a PR, verify:
---

# Claude Rules for Apache Pekko Connectors
...
- Integration test dependencies (Docker Compose scripts under `scripts/`) are documented and started before running tests.
- PR names are prefixed with the module marker (e.g., "JMS", "AWS S3", "Kafka").
...
---
> Source: [apache/pekko-connectors](https://github.com/apache/pekko-connectors) — distributed by [TomeVault](https://tomevault.io).
