---
trigger: always_on
description: - Never include `codex` in branch names or pull request titles.
---
...
---
> Source: [huggingface/speech-to-speech](https://github.com/huggingface/speech-to-speech) — distributed by [TomeVault](https://tomevault.io).
