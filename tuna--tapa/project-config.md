---
trigger: always_on
description: Binding for every agent and human, whatever the task. Orientation and
---
...
---
> Source: [tuna/tapa](https://github.com/tuna/tapa) — distributed by [TomeVault](https://tomevault.io).
