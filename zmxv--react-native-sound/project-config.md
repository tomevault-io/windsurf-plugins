---
trigger: always_on
description: This is a React Native native module that provides cross-platform audio playback capabilities for iOS, Android, and Windows. The library wraps platform-specific audio APIs (AVAudioPlayer on iOS, MediaPlayer on Android) and exposes them through a unified JavaScript interface.
---
...
---
> Source: [zmxv/react-native-sound](https://github.com/zmxv/react-native-sound) — distributed by [TomeVault](https://tomevault.io).
