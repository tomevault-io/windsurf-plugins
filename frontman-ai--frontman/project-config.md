---
trigger: always_on
description: This is a multi-language project with ReScript, TypeScript, and JavaScript components. The main client library is being converted from TypeScript to ReScript.
---
