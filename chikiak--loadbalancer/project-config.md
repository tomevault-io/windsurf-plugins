---
trigger: always_on
description: This is a general-purpose project configuration. The following guidelines define how Gemini (AI Agent) should interact with this workspace.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/Chikiak)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/Chikiak)
