---
trigger: always_on
description: This project allows users to download web pages, extract their readable content, convert it to Markdown, and save it locally. It's written in Python and uses modern development practices.
---
...
---
> Source: [vladiliescu/clipit](https://github.com/vladiliescu/clipit) — distributed by [TomeVault](https://tomevault.io).
