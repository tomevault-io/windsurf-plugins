---
trigger: always_on
description: **Sentinel** is a Home Assistant custom integration that monitors the health of integrations and physical devices in real time. It fires events and creates binary_sensor entities when something breaks.
---
