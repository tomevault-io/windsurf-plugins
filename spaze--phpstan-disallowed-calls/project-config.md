---
trigger: always_on
description: Runs lint, neon lint, phpcs, phpstan, and phpunit in sequence. PHPStan is at `vendor/phpstan/phpstan/phpstan.phar`.
---
...
---
> Source: [spaze/phpstan-disallowed-calls](https://github.com/spaze/phpstan-disallowed-calls) — distributed by [TomeVault](https://tomevault.io).
