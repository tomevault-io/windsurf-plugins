---
trigger: always_on
description: WebHackersWeapons is a curated collection of web security tools and utilities. It contains 409+ security tools categorized by type (Army-knife, Proxy, Recon, Fuzzer, Scanner, Exploit, Utils, etc.), platform, language, and tags.
---
...
---
> Source: [christophercruz98112/WebHackersWeapons](https://github.com/christophercruz98112/WebHackersWeapons) — distributed by [TomeVault](https://tomevault.io).
