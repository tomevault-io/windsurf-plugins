---
trigger: always_on
description: This file is for students using Google's Gemini CLI instead of (or
---
...
---
> Source: [jamditis/mooc-starter-kit](https://github.com/jamditis/mooc-starter-kit) — distributed by [TomeVault](https://tomevault.io).
