---
trigger: always_on
description: This repository contains a curated list of domains used by various email tracking services. It is primarily intended for use with network-level DNS blockers like Pi-hole to enhance privacy by preventing email trackers from reporting user activity.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/jaybocc2)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/jaybocc2)
