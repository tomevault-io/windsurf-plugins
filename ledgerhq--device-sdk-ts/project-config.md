---
trigger: always_on
description: AI agents contributing to this repository must follow project conventions.
---
...
---
> Source: [LedgerHQ/device-sdk-ts](https://github.com/LedgerHQ/device-sdk-ts) — distributed by [TomeVault](https://tomevault.io).
