---
trigger: always_on
description: This is a proof-of-concept demonstrating OpenTelemetry (OTel) observability with two independent Spring Boot 3.5.9 / Java 21 microservices. Each module is a self-contained Maven project — there is no parent POM.
---
...
---
> Source: [tuxtor/spring-boot-otel-poc](https://github.com/tuxtor/spring-boot-otel-poc) — distributed by [TomeVault](https://tomevault.io).
