---
trigger: always_on
description: See [SECURITY.md](SECURITY.md) for the full threat model, including:
---
...
---
> Source: [apache/axis-axis2-java-core](https://github.com/apache/axis-axis2-java-core) — distributed by [TomeVault](https://tomevault.io).
