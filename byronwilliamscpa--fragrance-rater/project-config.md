---
trigger: always_on
description: > These instructions guide Copilot code reviews to focus on issues that automated checks cannot catch.
---
...
- Are command-line arguments validated appropriately?
- Do error messages guide users to correct usage?
- Is help text accurate and helpful?
- Are exit codes meaningful and consistent?
- Does the CLI handle signals (Ctrl+C) gracefully?
...
- **Package**: `fragrance_rater`
- **Source**: `src/fragrance_rater/`
- **Tests**: `tests/`
- **CLI Entry**: `src/fragrance_rater/cli.py`

---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/ByronWilliamsCPA)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/ByronWilliamsCPA)
