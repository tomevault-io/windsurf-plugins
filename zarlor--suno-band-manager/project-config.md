---
trigger: always_on
description: This file contains standing orders that apply to any LLM agent working in this repository. It is loaded automatically by Gemini CLI, Claude Code (`CLAUDE.md`), and Codex CLI / OpenCode (`AGENTS.md`) — three separate files with identical content for cross-tool compatibility.
---
...
---
> Source: [zarlor/suno-band-manager](https://github.com/zarlor/suno-band-manager) — distributed by [TomeVault](https://tomevault.io).
