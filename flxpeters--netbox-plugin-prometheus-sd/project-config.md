---
trigger: always_on
description: A NetBox plugin that exposes devices, virtual machines, services, and IP addresses
---
...
---
> Source: [FlxPeters/netbox-plugin-prometheus-sd](https://github.com/FlxPeters/netbox-plugin-prometheus-sd) — distributed by [TomeVault](https://tomevault.io).
