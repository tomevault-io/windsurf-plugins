---
trigger: always_on
description: The Pulumi azure provider is a Go-based Pulumi resource provider that bridges the Terraform provider to Pulumi. It generates SDKs for TypeScript/JavaScript, Python, .NET, Go, and Java. The provider uses the Terraform provider as an upstream source via git submodules.
---

# Pulumi azure Provider

The Pulumi azure provider is a Go-based Pulumi resource provider that bridges the Terraform provider to Pulumi. It generates SDKs for TypeScript/JavaScript, Python, .NET, Go, and Java. The provider uses the Terraform provider as an upstream source via git submodules.
...
---
> Source: [pulumi/pulumi-azure](https://github.com/pulumi/pulumi-azure) — distributed by [TomeVault](https://tomevault.io).
