---
trigger: always_on
description: This file provides guidance to coding agents when working with code in this repository. `AGENTS.md` is the source of truth; `CLAUDE.md` is a symlink for compatibility.
---
...
---
> Source: [braintrustdata/autoevals](https://github.com/braintrustdata/autoevals) — distributed by [TomeVault](https://tomevault.io).
