---
trigger: always_on
description: **Before making ANY code changes, ALWAYS add failing test cases first, then fix them.**
---
...
---
> Source: [yazinsai/quran-validator](https://github.com/yazinsai/quran-validator) — distributed by [TomeVault](https://tomevault.io).
