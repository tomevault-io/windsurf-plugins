---
trigger: always_on
description: wayper is a Python 3.12+ wallpaper manager with Wallhaven integration, a Click CLI,
---
...
---
> Source: [yuukidach/wayper](https://github.com/yuukidach/wayper) — distributed by [TomeVault](https://tomevault.io).
