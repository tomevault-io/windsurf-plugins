---
trigger: always_on
description: Instructions for AI coding agents working on the FiftyOne App (this directory).
---
...
---
> Source: [voxel51/fiftyone](https://github.com/voxel51/fiftyone) — distributed by [TomeVault](https://tomevault.io).
