---
trigger: always_on
description: Discord bot (user app) for Hoyoverse games with multi-game/account/language support. Python 3.12+, discord.py, PostgreSQL/Tortoise ORM, Pillow image generation, Flet web auth, uv package manager.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/seriaati) — claim your Tome and manage your conversions.
