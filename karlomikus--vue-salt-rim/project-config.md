---
trigger: always_on
description: Application is run in a docker container with Bun as the runtime. Use the following commands to manage the application:
---
...
---
> Source: [karlomikus/vue-salt-rim](https://github.com/karlomikus/vue-salt-rim) — distributed by [TomeVault](https://tomevault.io).
