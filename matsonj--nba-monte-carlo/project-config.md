---
trigger: always_on
description: - **Full build**: `make build` (sets up venv, installs deps, configures dbt and Evidence)
---
...
---
> Source: [matsonj/nba-monte-carlo](https://github.com/matsonj/nba-monte-carlo) — distributed by [TomeVault](https://tomevault.io).
