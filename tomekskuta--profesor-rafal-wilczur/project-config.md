---
trigger: always_on
description: Slack bot using `@slack/bolt` with Socket Mode. Entry point: `src/index.ts`
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/tomekskuta)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/tomekskuta)
