---
trigger: always_on
description: `django-loci` is a Django app that provides geographic and indoor mapping features used by OpenWISP modules.
---
...
---
> Source: [openwisp/django-loci](https://github.com/openwisp/django-loci) — distributed by [TomeVault](https://tomevault.io).
