---
trigger: always_on
description: - If the `acton` Codex skill is available in this environment, use it for Acton CLI, Tolk, wrappers, tests, scripts, deployment, and `Acton.toml` tasks.
---
...
---
> Source: [ton-blockchain/acton](https://github.com/ton-blockchain/acton) — distributed by [TomeVault](https://tomevault.io).
