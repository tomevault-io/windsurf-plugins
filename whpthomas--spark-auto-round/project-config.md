---
trigger: always_on
description: Fork of [Intel auto-round](https://github.com/intel/auto-round) trimmed to CUDA + `torch.compile` + W4A16 quantization for **DGX Spark GB10 (128 GiB unified memory)**. Not a general-purpose quantization toolkit — most upstream features are stubbed, commented out, or removed.
---
...
---
> Source: [whpthomas/spark-auto-round](https://github.com/whpthomas/spark-auto-round) — distributed by [TomeVault](https://tomevault.io).
