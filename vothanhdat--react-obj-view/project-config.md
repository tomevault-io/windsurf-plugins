---
trigger: always_on
description: `react-obj-view` is a high-performance React component for inspecting deeply nested objects and data structures. It features virtualization, custom resolvers, and a flexible theming system.
---
...
---
> Source: [vothanhdat/react-obj-view](https://github.com/vothanhdat/react-obj-view) — distributed by [TomeVault](https://tomevault.io).
