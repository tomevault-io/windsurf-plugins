---
trigger: always_on
description: 本项目自身就是一个 memory engine，开发时必须使用其 MCP 工具，确保知识积累形成闭环。
---
...
---
> Source: [uudam42/agent-memory-engine](https://github.com/uudam42/agent-memory-engine) — distributed by [TomeVault](https://tomevault.io).
