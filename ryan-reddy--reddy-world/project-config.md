---
trigger: always_on
description: **Tech Stack**: Vite + Lit Element + TypeScript + Vaadin Router (client-side SPA)
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/Ryan-Reddy)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/Ryan-Reddy)
