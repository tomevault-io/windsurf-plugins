---
trigger: always_on
description: These rules apply to the whole repository unless a deeper `AGENTS.md` overrides
---
...
---
> Source: [yswlww/metapi-evolution](https://github.com/yswlww/metapi-evolution) — distributed by [TomeVault](https://tomevault.io).
