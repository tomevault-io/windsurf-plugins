---
trigger: always_on
description: Valibot is a modular, type-safe schema validation library with zero runtime dependencies.
---
...
---
> Source: [open-circle/valibot](https://github.com/open-circle/valibot) — distributed by [TomeVault](https://tomevault.io).
