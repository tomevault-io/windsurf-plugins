---
trigger: always_on
description: Guidance for AI coding agents working on the Lunex codebase. This file supplements README.md and DEVELOPMENT.md by focusing on context needed for automation (build, test, conventions, PR).
---
...
---
> Source: [zen8labs/lunex](https://github.com/zen8labs/lunex) — distributed by [TomeVault](https://tomevault.io).
