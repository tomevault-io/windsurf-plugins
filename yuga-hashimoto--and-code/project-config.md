---
trigger: always_on
description: At the start of every new session, ALWAYS create a git worktree before making any changes.
---
...
---
> Source: [yuga-hashimoto/and-code](https://github.com/yuga-hashimoto/and-code) — distributed by [TomeVault](https://tomevault.io).
