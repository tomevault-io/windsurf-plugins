---
trigger: always_on
description: - `action.yml`: public action contract, inputs, and Docker action wiring.
---
...
---
> Source: [ScaCap/action-ktlint](https://github.com/ScaCap/action-ktlint) — distributed by [TomeVault](https://tomevault.io).
