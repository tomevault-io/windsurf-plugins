---
trigger: always_on
description: This extension contributes two declarative Copilot chat agents defined in `agents/`. They have no runtime TypeScript code — behavior is entirely driven by markdown prompts and skill invocations.
---
...
---
> Source: [Azure/vscode-aks-tools](https://github.com/Azure/vscode-aks-tools) — distributed by [TomeVault](https://tomevault.io).
