---
trigger: always_on
description: このファイルはこのリポジトリでコードを扱う際のClaude Code (claude.ai/code) へのガイダンスを提供します。
---
...
---
> Source: [kenzo0107/terraform-provider-sendgrid](https://github.com/kenzo0107/terraform-provider-sendgrid) — distributed by [TomeVault](https://tomevault.io).
