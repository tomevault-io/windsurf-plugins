...
Original source: `copilot-instructions.md` in [GalacticDynamics/unxt](https://github.com/GalacticDynamics/unxt).
...
```
npx tomevault install GalacticDynamics/unxt
```
Source: [github.com/GalacticDynamics/unxt](https://github.com/GalacticDynamics/unxt).
