---
trigger: always_on
description: Releases are cut **automatically on every merge to `main`** by `.github/workflows/release.yml`:
---
...
---
> Source: [shorepine/amy](https://github.com/shorepine/amy) — distributed by [TomeVault](https://tomevault.io).
