---
trigger: always_on
description: 这是一个基于AI技术的智能专利生成与管理系统的Claude Code配置文档。
---
...
---
> Source: [zhenzhiyang/PatPilot](https://github.com/zhenzhiyang/PatPilot) — distributed by [TomeVault](https://tomevault.io).
