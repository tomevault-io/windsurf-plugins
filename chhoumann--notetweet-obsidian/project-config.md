---
trigger: always_on
description: NoteTweet is an Obsidian community plugin for posting tweets and threads to X
---
...
---
> Source: [chhoumann/notetweet_obsidian](https://github.com/chhoumann/notetweet_obsidian) — distributed by [TomeVault](https://tomevault.io).
