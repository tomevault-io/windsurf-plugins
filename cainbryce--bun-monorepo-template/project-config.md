...
Use bun scripts to manage monorepo

- Use `bun new-module` to create a new monorepo module
- Use `bun get-module` to get metdata about a monorepo module
- Use `bun delete-module` to delete a monorepo module
- Use `bun fmt` to format scripts in repository
- Use `bun run build` to build in the context of the root index.ts as entry
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/cainbryce) — claim your Tome and manage your conversions.
