---
trigger: always_on
description: If the user explicitly asks you to spawn a subagent to answer a question, do this:
---
...
---
> Source: [ttsiodras/utils](https://github.com/ttsiodras/utils) — distributed by [TomeVault](https://tomevault.io).
