---
trigger: always_on
description: This is the community task library for [Mechanic](https://mechanic.dev/), a Liquid-based development and automation platform for Shopify stores.
---
...
---
> Source: [lightward/mechanic-tasks](https://github.com/lightward/mechanic-tasks) — distributed by [TomeVault](https://tomevault.io).
