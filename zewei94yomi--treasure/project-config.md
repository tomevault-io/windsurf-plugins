---
trigger: always_on
description: 网页版本地双人搜打撤游戏（纯 Canvas + 原生 JS，零依赖零构建）。项目已封存（v31），
---
...
---
> Source: [zewei94yomi/Treasure](https://github.com/zewei94yomi/Treasure) — distributed by [TomeVault](https://tomevault.io).
