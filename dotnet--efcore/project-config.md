---
trigger: always_on
description: This document provides guidance for working with code in the Entity Framework Core project.
---
...
---
> Source: [dotnet/efcore](https://github.com/dotnet/efcore) — distributed by [TomeVault](https://tomevault.io).
