---
trigger: always_on
description: Embedded NoSQL database for iOS and macOS. The codebase is an Objective-C core with a Swift wrapper built on LiteCore.
---
...
---
> Source: [couchbase/couchbase-lite-ios](https://github.com/couchbase/couchbase-lite-ios) — distributed by [TomeVault](https://tomevault.io).
