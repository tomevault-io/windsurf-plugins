---
trigger: always_on
description: Kodein-DI is a Kotlin Multiplatform dependency injection framework.
---
...
---
> Source: [kosi-libs/Kodein](https://github.com/kosi-libs/Kodein) — distributed by [TomeVault](https://tomevault.io).
