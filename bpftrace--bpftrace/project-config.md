---
trigger: always_on
description: This file provides context for AI agents when working on the bpftrace codebase.
---
...
---
> Source: [bpftrace/bpftrace](https://github.com/bpftrace/bpftrace) — distributed by [TomeVault](https://tomevault.io).
