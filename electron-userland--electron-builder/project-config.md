---
trigger: always_on
description: Claude can run these directly to build, test, and lint the codebase:
---
...
---
> Source: [electron-userland/electron-builder](https://github.com/electron-userland/electron-builder) — distributed by [TomeVault](https://tomevault.io).
