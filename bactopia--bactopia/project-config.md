---
trigger: always_on
description: This document serves as the AI Context Master Map for the Bactopia pipeline. It provides entry points to modular documentation for understanding the codebase structure, patterns, and conventions.
---
...
---
> Source: [bactopia/bactopia](https://github.com/bactopia/bactopia) — distributed by [TomeVault](https://tomevault.io).
