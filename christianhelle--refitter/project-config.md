---
trigger: always_on
description: OpenAPI-to-Refit code generator. Multi-package solution: CLI tool, MSBuild task, C# Source Generator, and Core library.
---
...
---
> Source: [christianhelle/refitter](https://github.com/christianhelle/refitter) — distributed by [TomeVault](https://tomevault.io).
