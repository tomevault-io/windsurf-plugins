---
trigger: always_on
description: This repository contains the Kubernetes Agentic Harness (`kube-agents`). It is a collection of agent configurations, personas, and skills designed to implement a cooperative multi-agent system for Kubernetes/GKE operations. It separates concerns into a Platform Agent, Operator Agent, and DevTeam Agent to transition from reactive manual management to proactive, intent-driven operations.
---
