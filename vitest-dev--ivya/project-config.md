---
trigger: always_on
description: When you need to reference Playwright source code (e.g. for ARIA snapshot implementation details), clone it locally:
---
...
---
> Source: [vitest-dev/ivya](https://github.com/vitest-dev/ivya) — distributed by [TomeVault](https://tomevault.io).
