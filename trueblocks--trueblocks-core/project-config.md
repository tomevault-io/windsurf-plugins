---
trigger: always_on
description: When I say "We want to go into step-by-step mode" or similar, switch to these rules:
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/TrueBlocks)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/TrueBlocks)
