---
trigger: always_on
description: > AI 驱动的 BOSS 直聘智能求职助手 · Web 控制台 + CLI + Plan-then-Execute Agent + 面试练习
---
...
---
> Source: [zxtshine/boos-ai](https://github.com/zxtshine/boos-ai) — distributed by [TomeVault](https://tomevault.io).
