---
trigger: always_on
description: This repo is the **Terraform provider for Elastic Cloud** (the "cloud provider"), written in Go.
---
...
---
> Source: [elastic/terraform-provider-ec](https://github.com/elastic/terraform-provider-ec) — distributed by [TomeVault](https://tomevault.io).
