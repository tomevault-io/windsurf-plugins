---
trigger: always_on
description: This is a **production-grade, fault-tolerant, zero-copy PHP parser** written in Rust.
---
...
---
> Source: [wudi/php-parser](https://github.com/wudi/php-parser) — distributed by [TomeVault](https://tomevault.io).
