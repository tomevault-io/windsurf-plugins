---
trigger: always_on
description: - Source code lives in `src/honeymcp/` with core middleware in `src/honeymcp/core/` and data models in `src/honeymcp/models/`.
---
...
---
> Source: [barvhaim/HoneyMCP](https://github.com/barvhaim/HoneyMCP) — distributed by [TomeVault](https://tomevault.io).
