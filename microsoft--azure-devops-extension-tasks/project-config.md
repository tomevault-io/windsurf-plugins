---
trigger: always_on
description: Purpose: Help agents quickly contribute to Azure DevOps Extension Tasks (publishing & packaging tasks for Azure/VS Marketplace).
---
...
---
> Source: [microsoft/azure-devops-extension-tasks](https://github.com/microsoft/azure-devops-extension-tasks) — distributed by [TomeVault](https://tomevault.io).
