---
trigger: always_on
description: Entry point for AI/LLM agents working in or with this repository. Pointers below; nothing canonical lives in this file.
---
...
---
> Source: [supabase/supabase-js](https://github.com/supabase/supabase-js) — distributed by [TomeVault](https://tomevault.io).
