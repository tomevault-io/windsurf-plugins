---
trigger: always_on
description: Agent-facing contributor guide. Mirrors [CLAUDE.md](CLAUDE.md) for non-Claude agents.
---
...
---
> Source: [xhulianomalaj/Slot-Game](https://github.com/xhulianomalaj/Slot-Game) — distributed by [TomeVault](https://tomevault.io).
