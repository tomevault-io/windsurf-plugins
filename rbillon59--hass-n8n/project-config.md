---
trigger: always_on
description: This is a Home Assistant addon that packages n8n (workflow automation tool) as a Docker container with nginx reverse proxy for secure access through Home Assistant's ingress system.
---
...
---
> Source: [Rbillon59/hass-n8n](https://github.com/Rbillon59/hass-n8n) — distributed by [TomeVault](https://tomevault.io).
