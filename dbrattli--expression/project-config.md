---
trigger: always_on
description: The `expression/` package contains the library. Core functional types and helpers live
---
...
---
> Source: [dbrattli/Expression](https://github.com/dbrattli/Expression) — distributed by [TomeVault](https://tomevault.io).
