---
trigger: always_on
description: SSP Operator is a Kubernetes operator that deploys and controls additional KubeVirt resources:
---
...
---
> Source: [kubevirt/ssp-operator](https://github.com/kubevirt/ssp-operator) — distributed by [TomeVault](https://tomevault.io).
