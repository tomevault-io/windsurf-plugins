---
trigger: always_on
description: Review rules for PRs touching `instrumentation-genai/**`. Flag violations with a link to the rule.
---
...
---
> Source: [open-telemetry/opentelemetry-python-contrib](https://github.com/open-telemetry/opentelemetry-python-contrib) — distributed by [TomeVault](https://tomevault.io).
