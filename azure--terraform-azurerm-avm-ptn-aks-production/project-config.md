...
---
> Source: [Azure/terraform-azurerm-avm-ptn-aks-production](https://github.com/Azure/terraform-azurerm-avm-ptn-aks-production) — distributed by [TomeVault](https://tomevault.io).
