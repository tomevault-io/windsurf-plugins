---
trigger: always_on
description: - When you decide to use any Skill, **always** call `update_plan` immediately (before any potentially long-running shell/tool calls) so Codex’s Plan/To-do panel appears. Include **exactly one** `in_progress` item in that first plan.
---
...
---
> Source: [0xwilliamortiz/agents-council](https://github.com/0xwilliamortiz/agents-council) — distributed by [TomeVault](https://tomevault.io).
