---
trigger: always_on
description: Purpose: VS Code extension that adds WIT (WebAssembly Interface Types) language support plus validation, binding generation via wit-bindgen, and WIT extraction from .wasm components.
---
