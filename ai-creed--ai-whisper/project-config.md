---
trigger: always_on
description: - `ai-whisper` is a local collaboration bridge for paired AI agent sessions.
---
...
---
> Source: [ai-creed/ai-whisper](https://github.com/ai-creed/ai-whisper) — distributed by [TomeVault](https://tomevault.io).
