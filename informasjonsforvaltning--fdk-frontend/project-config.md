---
trigger: always_on
description: FDK Frontend is an NX monorepo powering [data.norge.no](https://data.norge.no/) - Norway's national data catalog. Uses Next.js 16 (App Router), React 19, TypeScript, MDX, and Sass with CSS Modules.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/Informasjonsforvaltning)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/Informasjonsforvaltning)
