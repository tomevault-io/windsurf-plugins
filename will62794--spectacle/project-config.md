---
trigger: always_on
description: The core implementation of the Javascript TLA+ interpreter lives in `eval.js`, where the `evalExpr` is the main evaluation function, and recursively calls other evaluation functions depending on the type of expression being evaluated.
---
...
---
> Source: [will62794/spectacle](https://github.com/will62794/spectacle) — distributed by [TomeVault](https://tomevault.io).
