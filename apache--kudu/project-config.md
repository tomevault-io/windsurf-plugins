---
trigger: always_on
description: provides and disclaims, the configuration flags whose defaults change the
---
...
---
> Source: [apache/kudu](https://github.com/apache/kudu) — distributed by [TomeVault](https://tomevault.io).
