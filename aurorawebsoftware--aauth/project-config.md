---
trigger: always_on
description: Tool-agnostic guidance for AI coding agents (Claude Code, Cursor, Copilot, …) working
---
...
---
> Source: [AuroraWebSoftware/AAuth](https://github.com/AuroraWebSoftware/AAuth) — distributed by [TomeVault](https://tomevault.io).
