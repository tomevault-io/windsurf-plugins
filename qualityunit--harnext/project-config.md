---
trigger: always_on
description: Harnext is an AI coding agent with harness engineering. Built on the pi-agent-core runtime, it provides an interactive coding agent that can read, write, edit files and run shell commands. Written in TypeScript (ESM), runs on Node.js >= 20.
---
...
---
> Source: [QualityUnit/harnext](https://github.com/QualityUnit/harnext) — distributed by [TomeVault](https://tomevault.io).
