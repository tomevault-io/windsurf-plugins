---
trigger: always_on
description: description: Guide for using Tailwind CSS v4 instead of v3.x
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/agent-tech)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/agent-tech)
