---
trigger: always_on
description: This repo runs a local web UI + API for managing X (Twitter) account connections and scheduling posts.
---
...
---
> Source: [tylerbuilds/x-manager](https://github.com/tylerbuilds/x-manager) — distributed by [TomeVault](https://tomevault.io).
