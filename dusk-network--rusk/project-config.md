---
trigger: always_on
description: Agent-specific guidance. Read `CLAUDE.md` first for repo map and commands.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/dusk-network)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/dusk-network)
