---
trigger: always_on
description: This is the monorepo for `@lazarv/react-server`, an open React Server Components runtime built on the Vite Environment API.
---
...
---
> Source: [lazarv/react-server](https://github.com/lazarv/react-server) — distributed by [TomeVault](https://tomevault.io).
