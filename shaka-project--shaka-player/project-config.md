---
trigger: always_on
description: Shaka Player is an open-source JavaScript library for adaptive media playback
---
...
---
> Source: [shaka-project/shaka-player](https://github.com/shaka-project/shaka-player) — distributed by [TomeVault](https://tomevault.io).
