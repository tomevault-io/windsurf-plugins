---
trigger: always_on
description: - `AgentX` — Spring Boot (Java 17) backend. Source in `AgentX/src/main`, tests in `AgentX/src/test`. Built with Maven Wrapper (`./mvnw`).
---
...
---
> Source: [lucky-aeon/AgentX](https://github.com/lucky-aeon/AgentX) — distributed by [TomeVault](https://tomevault.io).
