---
trigger: always_on
description: When reviewing changes (code, tests, build scripts, documentation, workflows), expand the review beyond correctness and style. Actively look for:
---
...
---
> Source: [ipsilon/evmone](https://github.com/ipsilon/evmone) — distributed by [TomeVault](https://tomevault.io).
