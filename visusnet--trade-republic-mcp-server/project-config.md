---
trigger: always_on
description: - Create a Claude Skill that automatically trades on Trade Republic in order to maximize profits.
---
...
---
> Source: [visusnet/trade-republic-mcp-server](https://github.com/visusnet/trade-republic-mcp-server) — distributed by [TomeVault](https://tomevault.io).
