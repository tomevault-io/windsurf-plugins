---
trigger: always_on
description: `Android/` contains the Gradle APK project, Java IME code, JNI bridge, resources,
---
...
---
> Source: [Ismantic/SimeApp](https://github.com/Ismantic/SimeApp) — distributed by [TomeVault](https://tomevault.io).
