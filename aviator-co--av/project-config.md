---
trigger: always_on
description: Tests use Go's [testscript](https://pkg.go.dev/github.com/rogpeppe/go-internal/testscript) framework. Each `.txtar` file is an independent test with a fresh git repo, bare remote, and mock GitHub GraphQL server.
---
...
---
> Source: [aviator-co/av](https://github.com/aviator-co/av) — distributed by [TomeVault](https://tomevault.io).
