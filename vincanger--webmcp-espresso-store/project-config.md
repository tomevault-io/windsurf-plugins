---
trigger: always_on
description: This project uses the Wasp framework.
---
...
---
> Source: [vincanger/webmcp-espresso-store](https://github.com/vincanger/webmcp-espresso-store) — distributed by [TomeVault](https://tomevault.io).
