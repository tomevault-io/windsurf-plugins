---
trigger: always_on
description: This file provides guidance to LLM when working with code in `<project-root>/.doom.d` in this repository.
---
...
---
> Source: [yqrashawn/yqdotfiles](https://github.com/yqrashawn/yqdotfiles) — distributed by [TomeVault](https://tomevault.io).
