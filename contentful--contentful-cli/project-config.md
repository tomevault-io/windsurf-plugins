---
trigger: always_on
description: Operating notes for coding agents working in `contentful-cli`. Read this before
---
...
---
> Source: [contentful/contentful-cli](https://github.com/contentful/contentful-cli) — distributed by [TomeVault](https://tomevault.io).
