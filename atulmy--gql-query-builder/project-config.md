---
trigger: always_on
description: Zero-runtime-dependency TypeScript library that generates GraphQL query/mutation/subscription **strings** (plus a `variables` object) from plain JavaScript objects. Published to npm as `gql-query-builder`.
---
...
---
> Source: [atulmy/gql-query-builder](https://github.com/atulmy/gql-query-builder) — distributed by [TomeVault](https://tomevault.io).
