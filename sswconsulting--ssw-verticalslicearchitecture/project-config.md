---
trigger: always_on
description: A template for **.NET 10 + Vertical Slice Architecture + Aspire**. Each feature is a self-contained vertical slice under `src/WebApi/Features/`, shared domain types sit in `src/WebApi/Common/Domain/`, and infrastructure (EF Core, middleware, services) lives in `src/WebApi/Common/`.
---
...
---
> Source: [SSWConsulting/SSW.VerticalSliceArchitecture](https://github.com/SSWConsulting/SSW.VerticalSliceArchitecture) — distributed by [TomeVault](https://tomevault.io).
