---
trigger: always_on
description: Board support in this repository is split into:
---
...
---
> Source: [shanteacontrols/OpenDeck](https://github.com/shanteacontrols/OpenDeck) — distributed by [TomeVault](https://tomevault.io).
