---
trigger: always_on
description: Handles GitHub GraphQL API interactions:
---
...
---
> Source: [hectcastro/gh-metrics](https://github.com/hectcastro/gh-metrics) — distributed by [TomeVault](https://tomevault.io).
