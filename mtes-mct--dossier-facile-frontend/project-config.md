---
trigger: always_on
description: DossierFacile.fr (service public, Ministère de la Transition écologique) aide les candidats locataires à constituer un dossier de location numérique vérifié.
---
...
---
> Source: [MTES-MCT/Dossier-Facile-Frontend](https://github.com/MTES-MCT/Dossier-Facile-Frontend) — distributed by [TomeVault](https://tomevault.io).
