---
trigger: always_on
description: This is an MCP (Model Context Protocol) server implementation that provides Outlook integration capabilities for AI assistants. The project enables AI models to interact with Microsoft Outlook for calendar management, email sending, and email searching functionalities.
---
...
---
> Source: [wmoto-ai/mcp-outlook-tools](https://github.com/wmoto-ai/mcp-outlook-tools) — distributed by [TomeVault](https://tomevault.io).
