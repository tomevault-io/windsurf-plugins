---
trigger: always_on
description: This file provides context for AI coding agents working on the `qiskit-ibm-transpiler` project.
---
...
---
> Source: [Qiskit/qiskit-ibm-transpiler](https://github.com/Qiskit/qiskit-ibm-transpiler) — distributed by [TomeVault](https://tomevault.io).
