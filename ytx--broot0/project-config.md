---
trigger: always_on
description: Raspberry Pi Zero Wに接続されたカメラの映像をHDMI出力するだけのシンプルなイメージをBuildRootで作成するプロジェクト。
---
...
---
> Source: [ytx/broot0](https://github.com/ytx/broot0) — distributed by [TomeVault](https://tomevault.io).
