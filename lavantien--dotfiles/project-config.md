---
trigger: always_on
description: 1. Verify first. Check official docs and current syntax/versions before coding -- training data goes stale.
---
...
---
> Source: [lavantien/dotfiles](https://github.com/lavantien/dotfiles) — distributed by [TomeVault](https://tomevault.io).
