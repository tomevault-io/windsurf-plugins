---
trigger: always_on
description: - `src/`: TypeScript library source. Public exports live in `src/index.ts`; core event types/logic are in files like `src/sync-event.ts` and `src/types.ts`.
---
...
---
> Source: [swnb/ocev](https://github.com/swnb/ocev) — distributed by [TomeVault](https://tomevault.io).
