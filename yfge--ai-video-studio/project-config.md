---
trigger: always_on
description: This file is the lightweight entrypoint for every coding agent working in this repository. Treat it as the table of contents, not the encyclopedia. Detailed policy lives in the linked docs under `docs/`.
---
...
---
> Source: [yfge/ai-video-studio](https://github.com/yfge/ai-video-studio) — distributed by [TomeVault](https://tomevault.io).
