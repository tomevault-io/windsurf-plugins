---
trigger: always_on
description: This is a Mac app using Objective-C and AppKit.
---
...
---
> Source: [microdotblog/microblog-mac](https://github.com/microdotblog/microblog-mac) — distributed by [TomeVault](https://tomevault.io).
