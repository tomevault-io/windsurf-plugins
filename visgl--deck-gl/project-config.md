---
trigger: always_on
description: This file applies to the entire `deck.gl` repository. More specific `AGENTS.md` files in
---
...
---
> Source: [visgl/deck.gl](https://github.com/visgl/deck.gl) — distributed by [TomeVault](https://tomevault.io).
