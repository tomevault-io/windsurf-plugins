...
Original source: `AGENTS.md` in [Noveum/orbit](https://github.com/Noveum/orbit).
...
Graded against the Tome Standard, TomeVault's public ruleset for whether AI instructions load, read clearly and stay safe. Source: [github.com/Noveum/orbit](https://github.com/Noveum/orbit)
