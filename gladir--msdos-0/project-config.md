---
trigger: always_on
description: MSDOS-0 est un clone des commandes MS-DOS basé sur Pascal supportant les langues française, allemande et anglaise. Chaque fichier `.PAS` implémente une seule commande DOS comme exécutable autonome, compilé avec Turbo Pascal 7 ou Free Pascal.
---
...
---
> Source: [gladir/MSDOS-0](https://github.com/gladir/MSDOS-0) — distributed by [TomeVault](https://tomevault.io).
