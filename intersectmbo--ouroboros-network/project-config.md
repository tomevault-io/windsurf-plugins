---
trigger: always_on
description: Ouroboros Network implements network protocols and applications for the Cardano blockchain:
---
...
---
> Source: [IntersectMBO/ouroboros-network](https://github.com/IntersectMBO/ouroboros-network) — distributed by [TomeVault](https://tomevault.io).
