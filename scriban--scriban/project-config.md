---
trigger: always_on
description: Scriban is a fast, powerful, safe and lightweight scripting language and engine for .NET.
---
...
---
> Source: [scriban/scriban](https://github.com/scriban/scriban) — distributed by [TomeVault](https://tomevault.io).
