---
trigger: always_on
description: `caddy-security` is a Go module that provides a Caddy v2 `security` app and
---
...
---
> Source: [greenpau/caddy-security](https://github.com/greenpau/caddy-security) — distributed by [TomeVault](https://tomevault.io).
