---
trigger: always_on
description: This file provides instructions for Claude AI when working with the Jumpstarter project.
---
...
---
> Source: [jumpstarter-dev/jumpstarter](https://github.com/jumpstarter-dev/jumpstarter) — distributed by [TomeVault](https://tomevault.io).
