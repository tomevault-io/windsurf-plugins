---
trigger: always_on
description: pip install -e ".[dev,openai,google]"
---
...
---
> Source: [llmsresearch/paperbanana](https://github.com/llmsresearch/paperbanana) — distributed by [TomeVault](https://tomevault.io).
