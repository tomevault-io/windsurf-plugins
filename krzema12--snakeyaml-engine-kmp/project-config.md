---
trigger: always_on
description: * place a new file in the common source set (`commonTest`). If a given test cannot be placed there because of depending
---
...
---
> Source: [krzema12/snakeyaml-engine-kmp](https://github.com/krzema12/snakeyaml-engine-kmp) — distributed by [TomeVault](https://tomevault.io).
