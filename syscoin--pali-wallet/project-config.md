---
trigger: always_on
description: Playwright harness that drives the real Pali extension against the live
---
...
---
> Source: [syscoin/pali-wallet](https://github.com/syscoin/pali-wallet) — distributed by [TomeVault](https://tomevault.io).
