---
trigger: always_on
description: make install              # Install dependencies and development tools
---
...
---
> Source: [mivek/python-metar-taf-parser](https://github.com/mivek/python-metar-taf-parser) — distributed by [TomeVault](https://tomevault.io).
