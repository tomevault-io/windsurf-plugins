---
trigger: always_on
description: - Hippo is a GPU programming library for Nim.
---
...
---
> Source: [monofuel/hippo](https://github.com/monofuel/hippo) — distributed by [TomeVault](https://tomevault.io).
