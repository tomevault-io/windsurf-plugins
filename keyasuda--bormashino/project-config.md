---
trigger: always_on
description: Bormashino is a framework for building Single Page Applications (SPAs) using Ruby. It leverages `ruby.wasm` to run a Ruby runtime directly in the browser, allowing developers to write their application logic in Ruby (using Sinatra) while interacting with the DOM and browser APIs.
---
...
---
> Source: [keyasuda/bormashino](https://github.com/keyasuda/bormashino) — distributed by [TomeVault](https://tomevault.io).
