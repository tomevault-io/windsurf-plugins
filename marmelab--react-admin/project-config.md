---
trigger: always_on
description: React-admin is a comprehensive frontend framework for building B2B and admin applications on top of REST/GraphQL APIs, using TypeScript, React, and Material UI. It's an open-source project maintained by Marmelab that provides a complete solution for B2B applications with data-driven interfaces.
---
...
---
> Source: [marmelab/react-admin](https://github.com/marmelab/react-admin) — distributed by [TomeVault](https://tomevault.io).
