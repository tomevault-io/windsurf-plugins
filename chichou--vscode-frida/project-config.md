---
trigger: always_on
description: from frida 17, `Module.getExportByName` and `Module.findExportByName` are removed,
---
...
---
> Source: [ChiChou/vscode-frida](https://github.com/ChiChou/vscode-frida) — distributed by [TomeVault](https://tomevault.io).
