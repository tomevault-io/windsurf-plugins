---
trigger: always_on
description: This is a collection of tips and conventions to follow when working on the [ownCloud web frontend](https://github.com/owncloud/web).
---
...
---
> Source: [owncloud/ocis](https://github.com/owncloud/ocis) — distributed by [TomeVault](https://tomevault.io).
