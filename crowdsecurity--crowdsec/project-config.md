---
trigger: always_on
description: For anyone opening a pull request against crowdsec: human, or LLM.
---
...
---
> Source: [crowdsecurity/crowdsec](https://github.com/crowdsecurity/crowdsec) — distributed by [TomeVault](https://tomevault.io).
