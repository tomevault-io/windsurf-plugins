---
trigger: always_on
description: **cachetools** provides extensible memoizing collections and decorators, including variants of Python's `@lru_cache`. Pure Python 3.10+, no external runtime dependencies.
---
...
---
> Source: [tkem/cachetools](https://github.com/tkem/cachetools) — distributed by [TomeVault](https://tomevault.io).
