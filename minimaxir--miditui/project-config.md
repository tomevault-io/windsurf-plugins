...
- If using Python to implement Rust code using PyO3/`maturin`:
  ...
  - Use `uv` for Python package management and to create a `.venv` if it is not present. **NEVER** use the base system Python installation.
...
---
> Source: [minimaxir/miditui](https://github.com/minimaxir/miditui) — distributed by [TomeVault](https://tomevault.io).
