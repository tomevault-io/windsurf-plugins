---
trigger: always_on
description: This repository provides a React Native module for offline speech recognition using the [Vosk](https://github.com/alphacep/vosk-api) library. It supports both Android and iOS platforms, with native code in Kotlin (Android) and Swift/Objective-C++ (iOS). The repo is a monorepo managed with Yarn workspaces, containing the main library and an example app.
---
...
---
> Source: [riderodd/react-native-vosk](https://github.com/riderodd/react-native-vosk) — distributed by [TomeVault](https://tomevault.io).
