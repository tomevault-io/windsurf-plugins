---
trigger: always_on
description: 完整发版流程见 `.claude/skills/release/SKILL.md`（发版时必读），机制设计见
---
...
---
> Source: [movieclaw/movieclaw](https://github.com/movieclaw/movieclaw) — distributed by [TomeVault](https://tomevault.io).
