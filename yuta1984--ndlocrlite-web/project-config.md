---
trigger: always_on
description: ONNXモデルを使用するOCRツールNDLOCR-Lite（https://github.com/ndl-lab/ndlocr-lite）を ONNX WebRuntimeを使用してWebアプリケーションにポートしたもの
---
...
---
> Source: [yuta1984/ndlocrlite-web](https://github.com/yuta1984/ndlocrlite-web) — distributed by [TomeVault](https://tomevault.io).
