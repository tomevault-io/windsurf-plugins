---
trigger: always_on
description: * MarkBind is a static site generator optimized for content-heavy instructional websites (e.g., courses, tutorials, documentation). It converts Markdown-like syntax into rich, interactive HTML websites.
---
...
---
> Source: [MarkBind/markbind](https://github.com/MarkBind/markbind) — distributed by [TomeVault](https://tomevault.io).
