---
trigger: always_on
description: - **Dev server:** `npm run dev` (runs on localhost:3000)
---
...
---
> Source: [octokatherine/readme.so](https://github.com/octokatherine/readme.so) — distributed by [TomeVault](https://tomevault.io).
