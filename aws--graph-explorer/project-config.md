---
trigger: always_on
description: - Every commit should have no type errors, lint errors, formatting issues, or failing tests
---
...
---
> Source: [aws/graph-explorer](https://github.com/aws/graph-explorer) — distributed by [TomeVault](https://tomevault.io).
