---
trigger: always_on
description: This file is the project-specific operating guide for AI coding agents working in this repository. Keep changes small, evidence-based, and aligned with the existing PocketNet/Bastyon code style.
---
...
---
> Source: [pocketnetteam/pocketnet.gui](https://github.com/pocketnetteam/pocketnet.gui) — distributed by [TomeVault](https://tomevault.io).
