---
trigger: always_on
description: Context for gemini-cli when it runs inside the himmel repo — as the
---
...
---
> Source: [yotamleo/Himmel](https://github.com/yotamleo/Himmel) — distributed by [TomeVault](https://tomevault.io).
