---
trigger: always_on
description: > **What this is:** A Claude Code project persona that makes a local model (Gemma 4 31B in our setup, but works with any) speak every reply out loud through your speakers — using your own cloned voice if you have one, or macOS `say` as a fallback. Pair it with the `Narrative Gemma.command` launcher.
---
...
---
> Source: [nicedreamzapp/claude-code-local](https://github.com/nicedreamzapp/claude-code-local) — distributed by [TomeVault](https://tomevault.io).
