---
trigger: always_on
description: Veil is a Lean library focusing on specifying, testing and verifying transition systems. Please read [README.md](./README.md) to know the syntax of Veil specifications.
---
...
- Whenever you've finished implementing certain feature, remember to run `lake build VeilTest` to go through all unit tests. 

---
> Source: [verse-lab/veil](https://github.com/verse-lab/veil) — distributed by [TomeVault](https://tomevault.io).
