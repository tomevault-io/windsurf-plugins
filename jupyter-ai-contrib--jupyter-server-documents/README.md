...
Server side document handling with improved output handling and kernel management/status.
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/jupyter-ai-contrib/jupyter-server-documents](https://github.com/jupyter-ai-contrib/jupyter-server-documents)
