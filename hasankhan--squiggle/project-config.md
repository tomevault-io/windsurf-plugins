---
trigger: always_on
description: Peer-to-peer LAN instant messenger. No central server — peers discover each other via multicast and communicate directly.
---
...
---
> Source: [hasankhan/Squiggle](https://github.com/hasankhan/Squiggle) — distributed by [TomeVault](https://tomevault.io).
