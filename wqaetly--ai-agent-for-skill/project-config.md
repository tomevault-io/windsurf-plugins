---
trigger: always_on
description: Unity技能配置智能助手系统，通过RAG（检索增强生成）+ LangGraph工作流实现技能配置的智能分析、自动修复和快速生成。
---
...
---
> Source: [wqaetly/ai_agent_for_skill](https://github.com/wqaetly/ai_agent_for_skill) — distributed by [TomeVault](https://tomevault.io).
