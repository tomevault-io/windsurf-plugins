---
trigger: always_on
description: This file is the single source of truth for AI/agent assistance in this repository. It consolidates build/test commands, repository layout, test runner usage, and the main constraints needed to work safely in `Refit`.
---
...
---
> Source: [reactiveui/refit](https://github.com/reactiveui/refit) — distributed by [TomeVault](https://tomevault.io).
