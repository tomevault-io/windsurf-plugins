---
trigger: always_on
description: > 这份文件是仓库级硬约束，每次 Claude Code 会话会自动读。**改 scaffold / 加 scaffold 时 Claude 必须按本文件 + `.claude/commands/add-scaffold.md` 走流程**。
---
...
---
> Source: [cccyd2003-qwq/pinkbin](https://github.com/cccyd2003-qwq/pinkbin) — distributed by [TomeVault](https://tomevault.io).
