---
trigger: always_on
description: Canonical source: [`AGENTS.md`](../AGENTS.md).
---
...
- Respect directory boundaries:
  ...
  - Web: `apps/octopus-web/`
  - Desktop: `apps/octopus-desktop/`
...
- Web changes: run `cd apps/octopus-web && npm ci && npm run lint && npm run build`.
