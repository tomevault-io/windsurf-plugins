---
trigger: always_on
description: Guidance for contributors (including AI assistants) working on `xarray-sql`. It
---
...
---
> Source: [xqlsystems/xarray-sql](https://github.com/xqlsystems/xarray-sql) — distributed by [TomeVault](https://tomevault.io).
