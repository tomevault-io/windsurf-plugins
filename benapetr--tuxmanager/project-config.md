---
trigger: always_on
description: **Tux Manager** is a Linux system monitor application built with **Qt6** (qmake, `.ui` files).
---
...
---
> Source: [benapetr/TuxManager](https://github.com/benapetr/TuxManager) — distributed by [TomeVault](https://tomevault.io).
