---
trigger: always_on
description: Agent guide for `openapi-schema-validator`.
---
...
---
> Source: [python-openapi/openapi-schema-validator](https://github.com/python-openapi/openapi-schema-validator) — distributed by [TomeVault](https://tomevault.io).
