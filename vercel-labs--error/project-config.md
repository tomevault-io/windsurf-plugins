---
trigger: always_on
description: `@vercel/error` gives errors stable codes, recovery fields, diagnostic context, client-safe HTTP projection, and terminal formatting without a framework or runtime dependency.
---
...
---
> Source: [vercel-labs/error](https://github.com/vercel-labs/error) — distributed by [TomeVault](https://tomevault.io).
