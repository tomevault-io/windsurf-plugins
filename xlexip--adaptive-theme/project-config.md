---
trigger: always_on
description: Hecate is an Android app ("Adaptive Theme") that automatically switches between Light and Dark
---
...
---
> Source: [xLexip/Adaptive-Theme](https://github.com/xLexip/Adaptive-Theme) — distributed by [TomeVault](https://tomevault.io).
