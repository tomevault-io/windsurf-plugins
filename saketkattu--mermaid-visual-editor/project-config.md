---
trigger: always_on
description: - `app/`: route entrypoints, global styles, and layout
---
...
---
> Source: [saketkattu/mermaid-visual-editor](https://github.com/saketkattu/mermaid-visual-editor) — distributed by [TomeVault](https://tomevault.io).
