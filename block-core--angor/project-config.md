---
trigger: always_on
description: **Never call SDK layer services directly from ViewModels or UI components.**
---
...
---
> Source: [block-core/angor](https://github.com/block-core/angor) — distributed by [TomeVault](https://tomevault.io).
