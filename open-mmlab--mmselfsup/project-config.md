---
trigger: always_on
description: 如果您想将 MMSelfSup 修改为您自己的项目, 请检查以下约定。
---
...
---
> Source: [open-mmlab/mmselfsup](https://github.com/open-mmlab/mmselfsup) — distributed by [TomeVault](https://tomevault.io).
