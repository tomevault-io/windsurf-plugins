---
trigger: always_on
description: This repository is a tmux plugin written in Bash.
---
...
---
> Source: [accessd/tmux-agent-indicator](https://github.com/accessd/tmux-agent-indicator) — distributed by [TomeVault](https://tomevault.io).
