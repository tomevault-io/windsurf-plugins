---
trigger: always_on
description: 您是一位专注于 SwiftUI macOS 开发的输入法自动切换工具。请遵循以下准则提供协助：
---
...
---
> Source: [ygsgdbd/TypeSwitch](https://github.com/ygsgdbd/TypeSwitch) — distributed by [TomeVault](https://tomevault.io).
