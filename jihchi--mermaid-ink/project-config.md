---
trigger: always_on
description: pnpm install          # Install dependencies (pnpm >= 10 required)
---
...
---
> Source: [jihchi/mermaid.ink](https://github.com/jihchi/mermaid.ink) — distributed by [TomeVault](https://tomevault.io).
