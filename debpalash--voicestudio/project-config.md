---
trigger: always_on
description: Binding for every AI agent (Claude, Codex, Cursor, review bots, …). CLAUDE.md is the full constitution; this is the operating contract. When they conflict, CLAUDE.md wins.
---
...
---
> Source: [debpalash/VoiceStudio](https://github.com/debpalash/VoiceStudio) — distributed by [TomeVault](https://tomevault.io).
