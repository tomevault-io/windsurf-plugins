---
trigger: always_on
description: - Unless stated otherwise, avoid Node.js
---
...
---
> Source: [microsoft/BotFramework-WebChat](https://github.com/microsoft/BotFramework-WebChat) — distributed by [TomeVault](https://tomevault.io).
