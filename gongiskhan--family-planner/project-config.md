---
trigger: always_on
description: You are building a **Family Task Manager** - a React application that helps couples fairly distribute household and childcare responsibilities through an objective scoring system. This guide provides context for all development sessions.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/gongiskhan)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/gongiskhan)
