---
trigger: always_on
description: RAI is a Python monorepo for an Embodied AI agent framework integrating LLMs with ROS 2. It uses `uv` for dependency management and `colcon` for ROS 2 workspace builds.
---
...
---
> Source: [RobotecAI/rai](https://github.com/RobotecAI/rai) — distributed by [TomeVault](https://tomevault.io).
