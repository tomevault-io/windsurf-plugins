---
trigger: always_on
description: ECMAScript engine in pure Go, used as k6's JavaScript runtime. Fork of goja.
---
...
---
> Source: [grafana/sobek](https://github.com/grafana/sobek) — distributed by [TomeVault](https://tomevault.io).
