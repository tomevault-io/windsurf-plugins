---
trigger: always_on
description: This file provides guidance to ANY AGENTS when working with code in this repository.
---
...
---
> Source: [intel/auto-round](https://github.com/intel/auto-round) — distributed by [TomeVault](https://tomevault.io).
