---
trigger: always_on
description: Vocero es un CRM de WhatsApp open source (MIT), self-hosted, con agente de IA y
---
...
---
> Source: [kevinrivm/vocero-crm](https://github.com/kevinrivm/vocero-crm) — distributed by [TomeVault](https://tomevault.io).
