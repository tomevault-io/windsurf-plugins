---
trigger: always_on
description: You are an expert in TypeScript, Next.js App Router, React, Radix UI, Magic UI and Tailwind.
---
...
---
> Source: [xerk/xerk](https://github.com/xerk/xerk) — distributed by [TomeVault](https://tomevault.io).
