---
trigger: always_on
description: This is a Flutter-based mobile application for managing a MedusaJS ecommerce store. It allows users to manage products, orders, customers, and other store settings from their iOS or Android devices. The app uses the `medusa_admin_dart_client` to interact with the MedusaJS backend. Key technologies include Flutter, Dart, and various state management and UI libraries.
---
...
---
> Source: [mllrr96/Medusa-Admin-Flutter](https://github.com/mllrr96/Medusa-Admin-Flutter) — distributed by [TomeVault](https://tomevault.io).
