---
trigger: always_on
description: This file provides guidance to AI coding agents when working
---
...
- Linting: flint (google-java-format, ktlint, markdownlint,
...
---
> Source: [grafana/grafana-opentelemetry-java](https://github.com/grafana/grafana-opentelemetry-java) — distributed by [TomeVault](https://tomevault.io).
