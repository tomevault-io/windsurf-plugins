---
trigger: always_on
description: This file is for AI coding agents, automated reviewers, and security assistants working in the `dep-scan` repository.
---
...
---
> Source: [owasp-dep-scan/dep-scan](https://github.com/owasp-dep-scan/dep-scan) — distributed by [TomeVault](https://tomevault.io).
