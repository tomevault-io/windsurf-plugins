---
trigger: always_on
description: hwpapi is a Python wrapper library that simplifies automation of Hancom Office (HWP - 한글, Korean word processor) using the win32com interface. It provides a Pythonic API for document manipulation, inspired by xlwings.
---
...
---
> Source: [JunDamin/hwpapi](https://github.com/JunDamin/hwpapi) — distributed by [TomeVault](https://tomevault.io).
