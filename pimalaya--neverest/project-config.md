---
trigger: always_on
description: This repository follows **Cairn**, a language- and tool-agnostic convention for
---
...
---
> Source: [pimalaya/neverest](https://github.com/pimalaya/neverest) — distributed by [TomeVault](https://tomevault.io).
