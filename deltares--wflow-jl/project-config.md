---
trigger: always_on
description: Wflow — Julia hydrological modeling framework (Julia ≥ 1.10). Installation via `pixi.toml`.
---
...
---
> Source: [Deltares/Wflow.jl](https://github.com/Deltares/Wflow.jl) — distributed by [TomeVault](https://tomevault.io).
