---
trigger: always_on
description: - `src/` — TanStack Start app code (routes, components, styles).
---
...
---
> Source: [geekspeng/clawhub](https://github.com/geekspeng/clawhub) — distributed by [TomeVault](https://tomevault.io).
