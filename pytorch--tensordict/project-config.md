---
trigger: always_on
description: House rules for LLM-driven contributions to `tensordict`. Sits on top of
---
...
---
> Source: [pytorch/tensordict](https://github.com/pytorch/tensordict) — distributed by [TomeVault](https://tomevault.io).
