---
trigger: always_on
description: This file provides collaborative guidance and philosophy when using the Codex Sessions system.
---

# Codex.sessions.md

This file provides collaborative guidance and philosophy when using the Codex Sessions system.
...
### Quick State Checks
```bash
cat .Codex/state/current_task.json  # Shows current task
git branch --show-current             # Current branch/task
```

### current_task.json Format

**ALWAYS use this exact format for .Codex/state/current_task.json:**
```json
{
...
5. **service-documentation** - Updates service AGENTS.md files
...
---
> Source: [thedaviddias/ux-patterns-for-developers](https://github.com/thedaviddias/ux-patterns-for-developers) — distributed by [TomeVault](https://tomevault.io).
