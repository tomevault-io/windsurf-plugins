---
trigger: always_on
description: This is a Pebble smartwatch application written in C using the Pebble SDK.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/iginoc)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/iginoc)
