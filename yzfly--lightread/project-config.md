---
trigger: always_on
description: 开源、本地优先的电子书 / 论文阅读器。桌面 (Tauri 2) + 网页 PWA + Android 实验版。
---
...
---
> Source: [yzfly/LightRead](https://github.com/yzfly/LightRead) — distributed by [TomeVault](https://tomevault.io).
