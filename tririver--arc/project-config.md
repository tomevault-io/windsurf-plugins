---
trigger: always_on
description: This repository contains ARC research tooling rebuilt as Python packages plus
---
...
---
> Source: [tririver/arc](https://github.com/tririver/arc) — distributed by [TomeVault](https://tomevault.io).
