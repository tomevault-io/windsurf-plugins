---
trigger: always_on
description: These instructions apply when a user asks Codex to install this repository.
---
...
---
> Source: [duolahypercho/codex-router](https://github.com/duolahypercho/codex-router) — distributed by [TomeVault](https://tomevault.io).
