---
trigger: always_on
description: This file provides guidance to AI coding agents (Claude Code, Cursor, Codex...) when working with code in this repository.
---
...
---
> Source: [batosai/adonis-attachment](https://github.com/batosai/adonis-attachment) — distributed by [TomeVault](https://tomevault.io).
