---
trigger: always_on
description: Iceberg cloud storage upload infrastructure. Used by `SubscopedTokenExternalVolumeManager` for the Iceberg (external volume) upload path. Not used for the non-Iceberg path.
---
...
---
> Source: [snowflakedb/snowflake-ingest-java](https://github.com/snowflakedb/snowflake-ingest-java) — distributed by [TomeVault](https://tomevault.io).
