---
trigger: always_on
description: Public Pi extension for managing background processes.
---
...
---
> Source: [aliou/pi-processes](https://github.com/aliou/pi-processes) — distributed by [TomeVault](https://tomevault.io).
