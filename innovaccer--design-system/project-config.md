---
trigger: always_on
description: This file defines the working conventions for `design-system`.
---
...
---
> Source: [innovaccer/design-system](https://github.com/innovaccer/design-system) — distributed by [TomeVault](https://tomevault.io).
