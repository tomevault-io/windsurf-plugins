---
trigger: always_on
description: BlockPy is a web-based Python environment combining visual blocks (Blockly) and text editing, with Skulpt for client-side Python execution. It's designed for data science education with guided feedback and state exploration tools.
---
...
---
> Source: [blockpy-edu/blockpy](https://github.com/blockpy-edu/blockpy) — distributed by [TomeVault](https://tomevault.io).
