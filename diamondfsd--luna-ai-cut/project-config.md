---
trigger: always_on
description: 本项目使用 `src/ui` 目录下的本地 UI 层，以及 Radix 基元提供可访问的低级行为。
---
...
---
> Source: [diamondfsd/luna-ai-cut](https://github.com/diamondfsd/luna-ai-cut) — distributed by [TomeVault](https://tomevault.io).
