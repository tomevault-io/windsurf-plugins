---
trigger: always_on
description: Build `cocogen`: an `npx`-runnable generator that reads TypeSpec (`.tsp`) and scaffolds runnable Microsoft Copilot connector projects.
---
...
---
> Source: [wictorwilen/cocogen](https://github.com/wictorwilen/cocogen) — distributed by [TomeVault](https://tomevault.io).
