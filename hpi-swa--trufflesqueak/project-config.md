---
trigger: always_on
description: Run these before spending time on build failures:
---
...
---
> Source: [hpi-swa/trufflesqueak](https://github.com/hpi-swa/trufflesqueak) — distributed by [TomeVault](https://tomevault.io).
