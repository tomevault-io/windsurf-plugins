---
trigger: always_on
description: Hermes HUD Web UI — the browser version of hermes-hud (TUI consciousness monitor). FastAPI backend + React frontend. Reads from `~/.hermes/` to display agent state.
---
...
---
> Source: [joeynyc/hermes-hudui](https://github.com/joeynyc/hermes-hudui) — distributed by [TomeVault](https://tomevault.io).
