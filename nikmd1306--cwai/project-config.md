---
trigger: always_on
description: CWAI (Commits with AI) — Go CLI tool that generates conventional commit messages from staged git changes using OpenAI-compatible APIs.
---
...
---
> Source: [nikmd1306/cwai](https://github.com/nikmd1306/cwai) — distributed by [TomeVault](https://tomevault.io).
