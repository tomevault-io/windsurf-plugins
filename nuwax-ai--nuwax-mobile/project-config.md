---
trigger: always_on
description: 这是一个基于 uni-app-x 框架开发的智能体平台前端项目，支持多端部署（H5、小程序、App）。
---
...
---
> Source: [nuwax-ai/nuwax-mobile](https://github.com/nuwax-ai/nuwax-mobile) — distributed by [TomeVault](https://tomevault.io).
