---
trigger: always_on
description: Fantastic-admin 是一个基于 Vue 3 的后台管理框架。
---
...
---
> Source: [fantastic-admin/basic](https://github.com/fantastic-admin/basic) — distributed by [TomeVault](https://tomevault.io).
