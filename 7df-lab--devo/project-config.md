---
trigger: always_on
description: This repository is a Rust-based coding agent, currently called `devo`.
---
...
---
> Source: [7df-lab/devo](https://github.com/7df-lab/devo) — distributed by [TomeVault](https://tomevault.io).
