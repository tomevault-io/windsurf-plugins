---
trigger: always_on
description: 本仓库是 **策略研究流水线**：用户给出思想 → 实现并记录 → 回测验证 → 生成报告 → 人工在 Cursor 中调用 AI 分析。
---
...
---
> Source: [xzcawl/auto_quant](https://github.com/xzcawl/auto_quant) — distributed by [TomeVault](https://tomevault.io).
