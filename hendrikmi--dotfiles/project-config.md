---
trigger: always_on
description: Guidelines for Claude Code across all projects.
---
...
---
> Source: [hendrikmi/dotfiles](https://github.com/hendrikmi/dotfiles) — distributed by [TomeVault](https://tomevault.io).
