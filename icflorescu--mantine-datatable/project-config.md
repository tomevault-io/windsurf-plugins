---
trigger: always_on
description: This is a dual-purpose repository containing both the **Mantine DataTable** component package and its documentation website. Understanding this hybrid architecture is crucial for effective development.
---
...
---
> Source: [icflorescu/mantine-datatable](https://github.com/icflorescu/mantine-datatable) — distributed by [TomeVault](https://tomevault.io).
