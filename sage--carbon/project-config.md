---
trigger: always_on
description: - Repo: Sage React component library; TS + React 18; styled-components v5; Storybook 8; Rollup; Jest; Playwright CT; outputs `lib/` + `esm/`.
---
...
---
> Source: [Sage/carbon](https://github.com/Sage/carbon) — distributed by [TomeVault](https://tomevault.io).
