---
trigger: always_on
description: - TypeScript Pulumi program deploying n8n on Google Cloud Run with Cloud SQL and Secret Manager.
---
...
---
> Source: [VeVarunSharma/n8n-self-host-on-gcp-pulumi](https://github.com/VeVarunSharma/n8n-self-host-on-gcp-pulumi) — distributed by [TomeVault](https://tomevault.io).
