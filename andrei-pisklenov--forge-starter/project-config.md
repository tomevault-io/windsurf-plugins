---
trigger: always_on
description: **Always use separate conditional blocks instead of ternary operators to avoid ESLint indentation conflicts.**
---
...
---
> Source: [andrei-pisklenov/forge-starter](https://github.com/andrei-pisklenov/forge-starter) — distributed by [TomeVault](https://tomevault.io).
