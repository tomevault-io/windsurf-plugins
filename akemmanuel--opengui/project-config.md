...
This project uses Biome for linting and formatting. Always use the bun scripts:
...
---
> Source: [akemmanuel/OpenGUI](https://github.com/akemmanuel/OpenGUI) — distributed by [TomeVault](https://tomevault.io).
