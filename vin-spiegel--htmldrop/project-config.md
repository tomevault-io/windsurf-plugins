---
trigger: always_on
description: This is the htmldrop MCP server (htmldrop.link). It lets an agent publish an HTML artifact and receive a public URL. The MCP tool name is `publish_html`.
---
...
- New HTML artifacts run in a browser sandbox. Inline scripts work, but external
  network requests, external assets, forms, popups, and top-level navigation are blocked.
...
---
> Source: [vin-spiegel/htmldrop](https://github.com/vin-spiegel/htmldrop) — distributed by [TomeVault](https://tomevault.io).
