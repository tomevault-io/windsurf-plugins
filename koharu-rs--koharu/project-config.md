---
trigger: always_on
description: Document only durable, repository-specific constraints here. Do not record current file layouts, temporary paths, model inventories, helper names, or other implementation details that may change during a refactor. Normal Rust, TypeScript, testing, formatting, and Git practices are assumed.
---
...
---
> Source: [koharu-rs/koharu](https://github.com/koharu-rs/koharu) — distributed by [TomeVault](https://tomevault.io).
