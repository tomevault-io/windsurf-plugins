---
trigger: always_on
description: posixutils-rs is a suite of Rust-native core command line utilities (cp, mv, awk, make, vi, etc.) using POSIX.2024 as the baseline specification. The goal is to create clean, race-free userland utilities that are POSIX compliant, maximizing compatibility with existing shell scripts while minimizing bloat.
---
...
---
> Source: [rustcoreutils/posixutils-rs](https://github.com/rustcoreutils/posixutils-rs) — distributed by [TomeVault](https://tomevault.io).
