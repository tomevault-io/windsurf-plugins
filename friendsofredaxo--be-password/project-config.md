---
trigger: always_on
description: The be_password addon is a REDAXO CMS extension that provides password reset functionality for backend users. Users can request password reset emails through a "Forgot Password?" link on the REDAXO login page.
---
...
---
> Source: [FriendsOfREDAXO/be_password](https://github.com/FriendsOfREDAXO/be_password) — distributed by [TomeVault](https://tomevault.io).
