---
trigger: always_on
description: - `main.go` is the CLI entry point; it wires configuration, structured logging, and the HTTP server that exposes `/metrics` and `/healthz`.
---
...
---
> Source: [yuuki/rdma_exporter](https://github.com/yuuki/rdma_exporter) — distributed by [TomeVault](https://tomevault.io).
