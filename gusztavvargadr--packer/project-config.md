---
trigger: always_on
description: This repository uses HashiCorp Packer with Chef provisioning to automate building customizable Windows and Ubuntu VM images and Vagrant boxes across multiple hypervisors (VirtualBox, VMware, Hyper-V, QEMU) and cloud providers (AWS EC2).
---
...
---
> Source: [gusztavvargadr/packer](https://github.com/gusztavvargadr/packer) — distributed by [TomeVault](https://tomevault.io).
