---
trigger: always_on
description: TestBeats is a Node.js tool designed to publish test results from various automation testing frameworks to communication platforms like Slack, Microsoft Teams, and Google Chat.
---
...
---
> Source: [test-results-reporter/testbeats](https://github.com/test-results-reporter/testbeats) — distributed by [TomeVault](https://tomevault.io).
