---
trigger: always_on
description: - **Never abbreviate on-chain addresses**: In both table and JSON output, always display Solana mint / pool / position addresses in full. Never truncate with `...`.
---
...
---
> Source: [byreal-git/byreal-agent-skills](https://github.com/byreal-git/byreal-agent-skills) — distributed by [TomeVault](https://tomevault.io).
