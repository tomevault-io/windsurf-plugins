---
trigger: always_on
description: Rules for AI coding agents (Claude Code, GitHub Copilot, Cursor, etc.) working
---
...
---
> Source: [Consensys/doc.linea](https://github.com/Consensys/doc.linea) — distributed by [TomeVault](https://tomevault.io).
