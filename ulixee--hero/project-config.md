---
trigger: always_on
description: This is the primary class to interact with Unblocked Agent. The following is a simple example:
---
...
---
> Source: [ulixee/hero](https://github.com/ulixee/hero) — distributed by [TomeVault](https://tomevault.io).
