---
trigger: always_on
description: `CodeGlancePro` 是一个基于 Gradle Kotlin DSL 的多模块 IntelliJ Platform 插件项目，目标是为 IntelliJ IDEA 系列 IDE 提供增强版代码缩略图与滚动条体验。仓库采用“根模块负责打包与公共入口，子模块负责平台适配”的结构：
---
