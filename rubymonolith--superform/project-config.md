---
trigger: always_on
description: HTML components follow a strict convention for arguments:
---
...
---
> Source: [rubymonolith/superform](https://github.com/rubymonolith/superform) — distributed by [TomeVault](https://tomevault.io).
