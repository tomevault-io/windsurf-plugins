---
trigger: always_on
description: 本仓库的 AI 协作规范以 `CLAUDE.md` 为唯一配置源（Single Source of Truth）。
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/EmbeddedGUI)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/EmbeddedGUI)
