---
trigger: always_on
description: **spark-history-cli** is a Python CLI for querying the Apache Spark History Server REST API. It also ships two agent skills (`spark-history-cli` and `spark-advisor`) that teach AI coding assistants how to debug and optimize Spark applications.
---
...
---
> Source: [yaooqinn/spark-history-cli](https://github.com/yaooqinn/spark-history-cli) — distributed by [TomeVault](https://tomevault.io).
