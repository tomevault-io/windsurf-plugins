---
trigger: always_on
description: This document contains Claude-specific configuration and guidelines for working with the SUI Components project.
---
...
---
> Source: [SUI-Components/sui-components](https://github.com/SUI-Components/sui-components) — distributed by [TomeVault](https://tomevault.io).
