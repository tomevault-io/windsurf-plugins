---
trigger: always_on
description: ABOUTME: BONJSON specification, formal grammar, conformance tests, and test specification.
---
...
- BigNumber wire format: `0xB2 + zigzag_leb128(exponent) + zigzag_leb128(signed_length) + LE magnitude bytes`.
- Record definition: `0xB9 + string* + 0xB6`. Record instance: `0xBA + LEB128(def_index) + value* + 0xB6`.
...
---
> Source: [kstenerud/bonjson](https://github.com/kstenerud/bonjson) — distributed by [TomeVault](https://tomevault.io).
