---
trigger: always_on
description: puzpy is a Python library for parsing .puz crossword puzzle files. It provides a single module (`puz.py`) that can read, write, and manipulate crossword puzzle files in the standard .puz format used by Across Lite and other crossword applications.
---
...
---
> Source: [alexdej/puzpy](https://github.com/alexdej/puzpy) — distributed by [TomeVault](https://tomevault.io).
