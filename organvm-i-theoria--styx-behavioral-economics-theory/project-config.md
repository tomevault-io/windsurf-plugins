...
**Org:** `organvm-i-theoria` | **Repo:** `styx-behavioral-economics-theory`

### Edges
- **Produces** → `organvm-ii-poiesis/styx-behavioral-art`: theory
- **Produces** → `organvm-iii-ergon/peer-audited--behavioral-blockchain`: research
...
Run: `organvm ecosystem show styx-behavioral-economics-theory` | `organvm ecosystem validate --organ I`


## Entity Identity (Ontologia)

**UID:** `ent_repo_01KKKX3RVJR7R864XGT4YC4MFQ` | **Matched by:** primary_name

Resolve: `organvm ontologia resolve styx-behavioral-economics-theory` | History: `organvm ontologia history ent_repo_01KKKX3RVJR7R864XGT4YC4MFQ`
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/organvm-i-theoria)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/organvm-i-theoria)
