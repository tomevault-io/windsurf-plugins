---
trigger: always_on
description: > **License:** GPL-3.0-or-later. This is the only GPL project in the solution. **MIT code must never link against it.** See [docs/ai-workflow/gpl-mit-boundary.md](../../docs/ai-workflow/gpl-mit-boundary.md).
---
