---
trigger: always_on
description: This repository is the plugin distribution repo for Supabase across Claude Code, Cursor, Codex, and Gemini.
---
...
---
> Source: [supabase-community/supabase-plugin](https://github.com/supabase-community/supabase-plugin) — distributed by [TomeVault](https://tomevault.io).
