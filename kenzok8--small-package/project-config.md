---
trigger: always_on
description: - This is an OpenWrt package repository, not a standalone JS app. There is no npm/test runner config in this repo.
---
...
---
> Source: [kenzok8/small-package](https://github.com/kenzok8/small-package) — distributed by [TomeVault](https://tomevault.io).
