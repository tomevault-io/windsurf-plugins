---
trigger: always_on
description: This document describes the purpose of the key configuration files in this package that relate to MCP server distribution and plugin registries.
---
...
---
> Source: [SAP/open-ux-tools](https://github.com/SAP/open-ux-tools) — distributed by [TomeVault](https://tomevault.io).
