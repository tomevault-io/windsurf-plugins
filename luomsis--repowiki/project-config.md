---
trigger: always_on
description: 1. **同步升版本号**：`pyproject.toml` 与 `.claude-plugin/plugin.json` 保持一致。
---
...
---
> Source: [luomsis/repowiki](https://github.com/luomsis/repowiki) — distributed by [TomeVault](https://tomevault.io).
