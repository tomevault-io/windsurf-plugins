---
trigger: always_on
description: Returns, Records and Reports parser. Unlike the device extractors, RLEAPP parses the
---
...
---
> Source: [abrignoni/RLEAPP](https://github.com/abrignoni/RLEAPP) — distributed by [TomeVault](https://tomevault.io).
