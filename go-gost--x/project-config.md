---
trigger: always_on
description: This file provides guidance to Claude Code (claude.ai/code) when working with code in this directory.
---
...
---
> Source: [go-gost/x](https://github.com/go-gost/x) — distributed by [TomeVault](https://tomevault.io).
