---
trigger: always_on
description: IMA.js is an application development stack for building **isomorphic**
---
...
---
> Source: [seznam/ima](https://github.com/seznam/ima) — distributed by [TomeVault](https://tomevault.io).
