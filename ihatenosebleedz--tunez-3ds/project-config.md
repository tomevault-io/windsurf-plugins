---
trigger: always_on
description: Tunez3DS is a feature-rich homebrew MP3 player for the Nintendo 3DS. It is written in C and utilizes `citro2d`/`citro3d` for graphics and `ndsp` for high-quality audio playback.
---
...
---
> Source: [ihatenosebleedz/Tunez-3DS](https://github.com/ihatenosebleedz/Tunez-3DS) — distributed by [TomeVault](https://tomevault.io).
