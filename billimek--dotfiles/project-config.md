---
trigger: always_on
description: Nix flake managing NixOS hosts, nix-darwin (macOS) hosts, and Home Manager user configurations.
---
...
---
> Source: [billimek/dotfiles](https://github.com/billimek/dotfiles) — distributed by [TomeVault](https://tomevault.io).
