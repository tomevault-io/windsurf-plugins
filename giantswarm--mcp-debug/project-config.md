---
trigger: always_on
description: This document outlines the fundamental architectural principles and patterns for the `mcp-debug` codebase. Adherence to these guidelines is **mandatory** to maintain a clean, decoupled, and testable system.
---
