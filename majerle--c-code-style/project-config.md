---
trigger: always_on
description: This repository defines a C coding style. If you (an AI coding agent) are
---
...
---
> Source: [MaJerle/c-code-style](https://github.com/MaJerle/c-code-style) — distributed by [TomeVault](https://tomevault.io).
