---
trigger: always_on
description: **OpenRelik UI** is the web based frontend for the OpenRelik digital forensic artifact workflow system. It provides a visual interface for managing files, folders, and workflows, allowing users to orchestrate forensic tasks and analyze results.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/openrelik)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/openrelik)
