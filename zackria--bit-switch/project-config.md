---
trigger: always_on
description: - Provide concise, repo-specific guidance for Copilot sessions: build/test/lint commands, high-level architecture, and codebase-specific conventions.
---
...
---
> Source: [zackria/bit-switch](https://github.com/zackria/bit-switch) — distributed by [TomeVault](https://tomevault.io).
