---
trigger: always_on
description: A modern Python interface for VASP (Vienna Ab initio Simulation Package) through ASE (Atomic Simulation Environment).
---
...
---
> Source: [jkitchin/vasp](https://github.com/jkitchin/vasp) — distributed by [TomeVault](https://tomevault.io).
