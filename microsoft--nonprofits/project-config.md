---
trigger: always_on
description: This is a **Microsoft Fabric Workload** (WDK v2) for nonprofit organizations. It deploys a **medallion architecture** (Bronze → Silver → Gold) for fundraising analytics via a package installer UI inside Microsoft Fabric.
---
...
---
> Source: [microsoft/Nonprofits](https://github.com/microsoft/Nonprofits) — distributed by [TomeVault](https://tomevault.io).
