---
trigger: always_on
description: - `cargo build --workspace` - Build all workspace members
---
...
---
> Source: [JanssenProject/jans](https://github.com/JanssenProject/jans) — distributed by [TomeVault](https://tomevault.io).
