---
trigger: always_on
description: > 给 AI 编码工具与新贡献者的约定。**只写"不遵守就会出错"的规则**；技术栈版本以
---
...
---
> Source: [go-admin-team/go-admin](https://github.com/go-admin-team/go-admin) — distributed by [TomeVault](https://tomevault.io).
