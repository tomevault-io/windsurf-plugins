---
trigger: always_on
description: **Full Guide**: See [AI_AGENT_GUIDE.md](AI_AGENT_GUIDE.md) for comprehensive documentation.
---
...
- **Migration**: [MIGRATION_NOTES.md](MIGRATION_NOTES.md) - Old → New workflow

---
Last Updated: 2025-10-16 | Python 3.8+ | Stack: Ruff, pytest, mypy

---
> Source: [aspectumapp/osm2geojson](https://github.com/aspectumapp/osm2geojson) — distributed by [TomeVault](https://tomevault.io).
