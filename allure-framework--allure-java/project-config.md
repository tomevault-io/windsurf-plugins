---
trigger: always_on
description: Never create pull requests or push git branches without explicit confirmation from the user.
---
...
---
> Source: [allure-framework/allure-java](https://github.com/allure-framework/allure-java) — distributed by [TomeVault](https://tomevault.io).
