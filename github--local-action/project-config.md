---
trigger: always_on
description: Install dependencies by running:
---
...
---
> Source: [github/local-action](https://github.com/github/local-action) — distributed by [TomeVault](https://tomevault.io).
