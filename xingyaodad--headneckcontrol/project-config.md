---
trigger: always_on
description: **Project Overview**: Robotic head/neck servo control system using ARKit face tracking and animation playback.
---
...
---
> Source: [xingyaodad/HeadNeckControl](https://github.com/xingyaodad/HeadNeckControl) — distributed by [TomeVault](https://tomevault.io).
