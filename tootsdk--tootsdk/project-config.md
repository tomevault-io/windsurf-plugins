---
trigger: always_on
description: - **Build**: `make build` or `swift build` (use `xcrun swift build` to avoid toolchain conflicts)
---
...
---
> Source: [TootSDK/TootSDK](https://github.com/TootSDK/TootSDK) — distributed by [TomeVault](https://tomevault.io).
