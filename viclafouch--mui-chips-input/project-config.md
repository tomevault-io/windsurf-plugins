---
trigger: always_on
description: A chips input component for MUI (Material UI), published on NPM as `mui-chips-input`.
---

# mui-chips-input

A chips input component for MUI (Material UI), published on NPM as `mui-chips-input`.
...
- No runtime dependencies — only peer dependencies (MUI, Emotion, React)

---
> Source: [viclafouch/mui-chips-input](https://github.com/viclafouch/mui-chips-input) — distributed by [TomeVault](https://tomevault.io).
