---
trigger: always_on
description: faas-cli is a REST client for OpenFaaS - CE, Standard, Enterprise and Edge (faasd)
---
...
---
> Source: [openfaas/faas-cli](https://github.com/openfaas/faas-cli) — distributed by [TomeVault](https://tomevault.io).
