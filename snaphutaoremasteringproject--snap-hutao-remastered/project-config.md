---
trigger: always_on
description: Snap Hutao (胡桃工具箱) is a C# WinUI 3 desktop application (MSIX-packaged) that enhances the Genshin Impact experience on Windows without modifying the game client. This is a **remastered fork**.
---
...
---
> Source: [SnapHutaoRemasteringProject/Snap.Hutao.Remastered](https://github.com/SnapHutaoRemasteringProject/Snap.Hutao.Remastered) — distributed by [TomeVault](https://tomevault.io).
