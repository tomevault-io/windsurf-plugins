---
trigger: always_on
description: **SimpleQuestPlates** is a World of Warcraft addon with a modular Lua architecture:
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/DonnieDice)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/DonnieDice)
