---
trigger: always_on
description: Knip is a tool to find and fix unused dependencies, exports and files in
---
...
---
> Source: [webpro-nl/knip](https://github.com/webpro-nl/knip) — distributed by [TomeVault](https://tomevault.io).
