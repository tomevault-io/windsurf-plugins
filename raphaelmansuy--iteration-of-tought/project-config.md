---
trigger: always_on
description: - **Python Version**: Use 3.11.x
---
...
---
> Source: [raphaelmansuy/iteration_of_tought](https://github.com/raphaelmansuy/iteration_of_tought) — distributed by [TomeVault](https://tomevault.io).
