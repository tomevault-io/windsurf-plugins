---
trigger: always_on
description: This is **ai-code-interface.el**, an Emacs package that provides a uniform interface for AI-assisted software development across different AI backends (Claude Code, Gemini CLI, OpenAI Codex, GitHub Copilot CLI).
---
...
---
> Source: [tninja/ai-code-interface.el](https://github.com/tninja/ai-code-interface.el) — distributed by [TomeVault](https://tomevault.io).
