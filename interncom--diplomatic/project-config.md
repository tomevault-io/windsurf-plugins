---
trigger: always_on
description: This repo has a few related projects in it, implementing the DIPLOMATIC protocol for securely syncing application data via untrusted cloud hosts.
---
...
---
> Source: [interncom/DIPLOMATIC](https://github.com/interncom/DIPLOMATIC) — distributed by [TomeVault](https://tomevault.io).
