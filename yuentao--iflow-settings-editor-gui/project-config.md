---
trigger: always_on
description: **iFlow 设置编辑器** 是一个用于编辑 iFlow CLI 配置文件 (`~/.iflow/settings.json`) 的桌面应用程序，采用 Electron + Vue 3 技术栈构建。
---
...
---
> Source: [yuentao/iFlow-Settings-Editor-GUI](https://github.com/yuentao/iFlow-Settings-Editor-GUI) — distributed by [TomeVault](https://tomevault.io).
