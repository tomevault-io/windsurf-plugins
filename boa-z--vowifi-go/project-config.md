---
trigger: always_on
description: This file gives Codex and other AI coding agents the project context needed to
---
...
---
> Source: [boa-z/vowifi-go](https://github.com/boa-z/vowifi-go) — distributed by [TomeVault](https://tomevault.io).
