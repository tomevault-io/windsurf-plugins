---
trigger: always_on
description: This repository contains the Pulumi AWS Native provider: a Go provider plus generated SDKs (Node.js, Python, .NET, Java, Go).
---
...
---
> Source: [pulumi/pulumi-aws-native](https://github.com/pulumi/pulumi-aws-native) — distributed by [TomeVault](https://tomevault.io).
