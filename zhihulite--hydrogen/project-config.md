---
trigger: always_on
description: AI 代理与贡献者的唯一规范入口。CLAUDE.md 只指向本文件，规则不重复维护。
---
...
---
> Source: [zhihulite/Hydrogen](https://github.com/zhihulite/Hydrogen) — distributed by [TomeVault](https://tomevault.io).
