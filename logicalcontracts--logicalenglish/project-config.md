---
trigger: always_on
description: Logical English (from now on referred as "LE") is a small subset of English, and a syntactic sugar for pure PROLOG. A LE program represents a piece of regulatory text - legislation,  contract, legal opinion - so that it can be queried for logical consequences for particular data scenarios.
---
...
---
> Source: [LogicalContracts/LogicalEnglish](https://github.com/LogicalContracts/LogicalEnglish) — distributed by [TomeVault](https://tomevault.io).
