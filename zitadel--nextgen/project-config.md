---
trigger: always_on
description: Zitadel nextgen is pre-release. Review for correctness and contract stability
---
...
---
> Source: [zitadel/nextgen](https://github.com/zitadel/nextgen) — distributed by [TomeVault](https://tomevault.io).
