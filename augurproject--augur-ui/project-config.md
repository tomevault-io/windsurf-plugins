---
trigger: always_on
description: * Modules with a single export should have that denoted as `default`
---
...
---
> Source: [AugurProject/augur-ui](https://github.com/AugurProject/augur-ui) — distributed by [TomeVault](https://tomevault.io).
