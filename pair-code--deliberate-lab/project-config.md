---
trigger: always_on
description: Firebase Cloud Functions backend (built with **esbuild**): HTTP callable
---
...
---
> Source: [PAIR-code/deliberate-lab](https://github.com/PAIR-code/deliberate-lab) — distributed by [TomeVault](https://tomevault.io).
