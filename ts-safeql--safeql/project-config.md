---
trigger: always_on
description: When running tests in this project, you must follow these steps:
---
...
---
> Source: [ts-safeql/safeql](https://github.com/ts-safeql/safeql) — distributed by [TomeVault](https://tomevault.io).
