---
trigger: always_on
description: Fast conventions for agents working on Stims (browser-native MilkDrop visualizer).
---
...
---
> Source: [zz-plant/stims](https://github.com/zz-plant/stims) — distributed by [TomeVault](https://tomevault.io).
