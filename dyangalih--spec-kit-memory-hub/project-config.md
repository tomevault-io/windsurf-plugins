---
trigger: always_on
description: This repository is built to work with VS Code Copilot agents memory.
---
...
---
> Source: [DyanGalih/spec-kit-memory-hub](https://github.com/DyanGalih/spec-kit-memory-hub) — distributed by [TomeVault](https://tomevault.io).
