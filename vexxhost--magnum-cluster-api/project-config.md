---
trigger: always_on
description: When completing any work, make sure that the following is completed:
---
...
---
> Source: [vexxhost/magnum-cluster-api](https://github.com/vexxhost/magnum-cluster-api) — distributed by [TomeVault](https://tomevault.io).
