---
trigger: always_on
description: - `pages/`: Next.js Pages Router routes and page-level UI (`pages/api/` for API handlers).
---
...
---
> Source: [RickCarlino/KoalaCards](https://github.com/RickCarlino/KoalaCards) — distributed by [TomeVault](https://tomevault.io).
