---
trigger: always_on
description: Every StateAdapt package ships an agent skill containing its full API
---
...
---
> Source: [state-adapt/state-adapt](https://github.com/state-adapt/state-adapt) — distributed by [TomeVault](https://tomevault.io).
