---
trigger: always_on
description: - Always use the C# language version configured by this repository (`LangVersion=Latest`) and its target frameworks, including the latest available language features.
---
