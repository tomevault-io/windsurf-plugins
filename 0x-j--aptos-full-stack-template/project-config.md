---
trigger: always_on
description: This is a full-stack Aptos dApp template featuring a message board application with custom indexers. It serves as an alternative to the official CAD (create-aptos-dapp) template with opinionated architecture choices.
---
...
---
> Source: [0x-j/aptos-full-stack-template](https://github.com/0x-j/aptos-full-stack-template) — distributed by [TomeVault](https://tomevault.io).
