---
trigger: always_on
description: Read this file first. It states the rules that apply to every task in this repository. The `.agents/` folder holds the detail.
---
...
---
> Source: [plotly/plotly.js](https://github.com/plotly/plotly.js) — distributed by [TomeVault](https://tomevault.io).
