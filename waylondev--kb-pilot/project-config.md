---
trigger: always_on
description: > Scripts constrain the skeleton; the LLM fills the content. Trust the LLM's intelligence — it is the second engineer, not a keyword matcher.
---
...
---
> Source: [waylondev/kb-pilot](https://github.com/waylondev/kb-pilot) — distributed by [TomeVault](https://tomevault.io).
