---
trigger: always_on
description: Examples are `.py` files, converted to notebooks, executed, then rendered as Markdown
---
...
---
> Source: [emdgroup/baybe](https://github.com/emdgroup/baybe) — distributed by [TomeVault](https://tomevault.io).
