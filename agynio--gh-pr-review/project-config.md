---
trigger: always_on
description: You have a pre-installed `gh pr-review` extension that simplifies working with Pull Requests. Below are the commands for retrieving PR reviews/comments and replying to review comments in a thread, and open and sumbit a review.
---
...
---
> Source: [agynio/gh-pr-review](https://github.com/agynio/gh-pr-review) — distributed by [TomeVault](https://tomevault.io).
