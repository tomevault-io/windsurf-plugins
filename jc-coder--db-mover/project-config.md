---
trigger: always_on
description: This document outlines the architecture, patterns, and conventions of the DB Mover project to assist AI agents in understanding and contributing to the codebase.
---
...
---
> Source: [JC-Coder/db-mover](https://github.com/JC-Coder/db-mover) — distributed by [TomeVault](https://tomevault.io).
