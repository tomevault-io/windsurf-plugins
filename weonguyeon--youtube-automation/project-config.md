---
trigger: always_on
description: 인포그래픽/애니메이션 기반 페이스리스(Faceless) 유튜브 채널 자동화 시스템
---
...
---
> Source: [weonguyeon/youtube-automation](https://github.com/weonguyeon/youtube-automation) — distributed by [TomeVault](https://tomevault.io).
