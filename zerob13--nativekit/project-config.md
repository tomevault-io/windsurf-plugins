---
trigger: always_on
description: Guide for AI agents (and humans) working on `nativekit`.
---
...
---
> Source: [zerob13/nativekit](https://github.com/zerob13/nativekit) — distributed by [TomeVault](https://tomevault.io).
