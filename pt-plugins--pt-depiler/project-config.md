---
trigger: always_on
description: PT-depiler is a browser extension (Manifest v3) for enhancing Private Tracker (PT) site usability. Built with Vue 3 + TypeScript + Vuetify, it provides multi-site search, torrent management, and downloader integration.
---
...
---
> Source: [pt-plugins/PT-depiler](https://github.com/pt-plugins/PT-depiler) — distributed by [TomeVault](https://tomevault.io).
