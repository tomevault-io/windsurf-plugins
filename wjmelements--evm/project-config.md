---
trigger: always_on
description: Fast assembler, disassembler, and executor for the Ethereum Virtual Machine.
---
...
---
> Source: [wjmelements/evm](https://github.com/wjmelements/evm) — distributed by [TomeVault](https://tomevault.io).
