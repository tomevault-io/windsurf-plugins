...
**Hosted on Netlify** at `https://documentation.bonitasoft.com`. Search is provided by Algolia DocSearch. PR previews deploy to Surge.sh.
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/bonitasoft)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/bonitasoft)
