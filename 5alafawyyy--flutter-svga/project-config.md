---
trigger: always_on
description: This is a Flutter package for parsing and rendering SVGA (Simple Vector Graphics Animation) files. SVGA is a lightweight animation format that supports dynamic content replacement, audio playback, and efficient mobile rendering.
---
...
---
> Source: [5alafawyyy/flutter_svga](https://github.com/5alafawyyy/flutter_svga) — distributed by [TomeVault](https://tomevault.io).
