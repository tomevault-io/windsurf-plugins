...
Original source: `AGENTS.md` in [yiwen65/SkillDock](https://github.com/yiwen65/SkillDock).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/yiwen65/SkillDock](https://github.com/yiwen65/SkillDock)
