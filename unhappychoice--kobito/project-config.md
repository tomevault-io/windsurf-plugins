---
trigger: always_on
description: Conventions for working on `kobito` itself. Both Claude Code and Codex auto-read this file at every invocation, so an agent driven by kobito (or by any other orchestrator) picks them up without further wiring.
---
...
---
> Source: [unhappychoice/kobito](https://github.com/unhappychoice/kobito) — distributed by [TomeVault](https://tomevault.io).
