---
trigger: always_on
description: AgentMesh is a **trust-first communication layer for AI agents** — providing cryptographic identity, multi-dimensional trust scoring, scope chains, and governance enforcement for multi-agent systems.
---
...
---
> Source: [imran-siddique/agent-mesh](https://github.com/imran-siddique/agent-mesh) — distributed by [TomeVault](https://tomevault.io).
