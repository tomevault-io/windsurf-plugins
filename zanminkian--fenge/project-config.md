---
trigger: always_on
description: **Fenge** (风格, meaning "style") is a monorepo CLI tool for JavaScript/TypeScript code quality. It wraps ESLint, Prettier, and TypeScript into a single zero-config tool with built-in strict defaults.
---
...
---
> Source: [zanminkian/fenge](https://github.com/zanminkian/fenge) — distributed by [TomeVault](https://tomevault.io).
