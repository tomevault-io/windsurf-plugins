---
trigger: always_on
description: Operational notes for coding agents working in this repository.
---
...
---
> Source: [ansible/tox-ansible](https://github.com/ansible/tox-ansible) — distributed by [TomeVault](https://tomevault.io).
