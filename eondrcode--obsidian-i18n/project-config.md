---
trigger: always_on
description: 本文件约束任何 AI 代理或自动化脚本在 `docs/` 下修改文档时的行为。
---
...
---
> Source: [eondrcode/obsidian-i18n](https://github.com/eondrcode/obsidian-i18n) — distributed by [TomeVault](https://tomevault.io).
