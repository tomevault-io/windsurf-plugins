---
trigger: always_on
description: - Workspace layout lives under `crates/`:
---
...
---
> Source: [woaihekele/Octovalve](https://github.com/woaihekele/Octovalve) — distributed by [TomeVault](https://tomevault.io).
