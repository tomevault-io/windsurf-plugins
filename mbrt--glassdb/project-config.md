---
trigger: always_on
description: Create an ADR (in `docs/adr/xxx-adr-slug.md`) for every important feature
---
...
---
> Source: [mbrt/glassdb](https://github.com/mbrt/glassdb) — distributed by [TomeVault](https://tomevault.io).
