---
trigger: always_on
description: This repo is a **Zed Editor configuration bundle** — `settings.json`, `keymap.json`, `tasks.json` are the source files. `README.md` embeds them inside comment markers. `cli.ts` reads the source files and rewrites the README.
---
...
---
> Source: [jellydn/zed-101-setup](https://github.com/jellydn/zed-101-setup) — distributed by [TomeVault](https://tomevault.io).
