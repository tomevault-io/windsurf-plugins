---
trigger: always_on
description: GLENS is a GenLayer Intelligent Contract debugger with a Next.js frontend in `frontend/` and Python GenLayer contracts in `contracts/`.
---
...
---
> Source: [ysnkhc/glens](https://github.com/ysnkhc/glens) — distributed by [TomeVault](https://tomevault.io).
