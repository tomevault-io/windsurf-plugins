---
trigger: always_on
description: Instructions for coding agents (and new humans) working in this repository.
---
...
---
> Source: [contentful/vault](https://github.com/contentful/vault) — distributed by [TomeVault](https://tomevault.io).
