---
trigger: always_on
description: > 💡 **For comprehensive AI agent context and detailed guidelines, see [`AGENTS.md`](../AGENTS.md) in the repository root.**
---
...
---
> Source: [SSWConsulting/SSW.Rewards.Mobile](https://github.com/SSWConsulting/SSW.Rewards.Mobile) — distributed by [TomeVault](https://tomevault.io).
