---
trigger: always_on
description: Notes for AI assistants working in `u-attributes`.
---
...
---
> Source: [u-gems/u-attributes](https://github.com/u-gems/u-attributes) — distributed by [TomeVault](https://tomevault.io).
