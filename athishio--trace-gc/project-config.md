---
trigger: always_on
description: This document outlines the developer contracts, build commands, test instructions, and event schema definitions for **TraceGC**.
---
...
---
> Source: [athishio/trace-gc](https://github.com/athishio/trace-gc) — distributed by [TomeVault](https://tomevault.io).
