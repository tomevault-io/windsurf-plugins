---
trigger: always_on
description: Go library for analyzing, diffing, flattening, merging (mixin), and fixing
---
...
---
> Source: [go-openapi/analysis](https://github.com/go-openapi/analysis) — distributed by [TomeVault](https://tomevault.io).
