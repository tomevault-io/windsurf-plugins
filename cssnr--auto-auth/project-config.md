---
trigger: always_on
description: Auto Auth is a Web Extension to allow automatic HTTP Basic Authentication.
---
...
---
> Source: [cssnr/auto-auth](https://github.com/cssnr/auto-auth) — distributed by [TomeVault](https://tomevault.io).
