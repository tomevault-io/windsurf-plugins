---
trigger: always_on
description: 当用户要求“打包插件上传商店”时，默认使用白名单打包，避免把开发文件带入发布包。
---
...
---
> Source: [kubai087/lumno-extension](https://github.com/kubai087/lumno-extension) — distributed by [TomeVault](https://tomevault.io).
