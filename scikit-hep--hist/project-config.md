---
trigger: always_on
description: Single `src/hist/` package, built with `hatchling` + `hatch-vcs`. Version is auto-generated from git tags into `src/hist/version.py`.
---
...
---
> Source: [scikit-hep/hist](https://github.com/scikit-hep/hist) — distributed by [TomeVault](https://tomevault.io).
