---
trigger: always_on
description: Relay is a platform for cryo-EM data processing workflows with these key components:
---
...
---
> Source: [warpem/relay](https://github.com/warpem/relay) — distributed by [TomeVault](https://tomevault.io).
