---
trigger: always_on
description: This repository collects community examples, demos, and scripts built on the [Open Force Field](https://openforcefield.org/) software stack. Contributions are low-friction by design, but a reviewer (human or AI) should be able to understand **what** a contribution does and **why** it exists. Use the checklist below to assess any incoming contribution.
---
...
---
> Source: [openforcefield/anything-goes](https://github.com/openforcefield/anything-goes) — distributed by [TomeVault](https://tomevault.io).
