---
trigger: always_on
description: `analiza.dev` is a simple, privacy-focused website analytics platform. It is designed to be low-cost and GDPR compliant, without using cookies. The project is structured as a monorepo containing multiple services that work together to provide the analytics functionality.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/ecyshor) — claim your Tome and manage your conversions.
