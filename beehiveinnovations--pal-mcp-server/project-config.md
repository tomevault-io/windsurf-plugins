---
trigger: always_on
description: See `requirements.txt` and `requirements-dev.txt`
---
...
---
> Source: [BeehiveInnovations/pal-mcp-server](https://github.com/BeehiveInnovations/pal-mcp-server) — distributed by [TomeVault](https://tomevault.io).
