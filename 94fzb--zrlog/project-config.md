---
trigger: always_on
description: 这份文档是 AI Agent 在 `zrlog` 主工程内工作的入口规则。进入本仓库后，先读本文件，再按任务打开 `doc/`、`pom.xml`、`zrlog-web/` 或 `package/` 下的具体实现。
---
...
---
> Source: [94fzb/zrlog](https://github.com/94fzb/zrlog) — distributed by [TomeVault](https://tomevault.io).
