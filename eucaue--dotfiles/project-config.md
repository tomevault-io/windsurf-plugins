---
trigger: always_on
description: - Don't explore the codebase beyond explicitly mentioned files, unless requested.
---
...
---
> Source: [EuCaue/dotfiles](https://github.com/EuCaue/dotfiles) — distributed by [TomeVault](https://tomevault.io).
