---
trigger: always_on
description: Guidance for AI coding agents working in the Basix repository.
---
...
---
> Source: [FEniCS/basix](https://github.com/FEniCS/basix) — distributed by [TomeVault](https://tomevault.io).
