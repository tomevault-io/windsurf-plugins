---
trigger: always_on
description: When updating to a new Go version or upgrading dependencies, touch all of the following locations:
---
...
---
> Source: [natrontech/openvpn-exporter](https://github.com/natrontech/openvpn-exporter) — distributed by [TomeVault](https://tomevault.io).
