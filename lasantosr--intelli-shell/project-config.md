---
trigger: always_on
description: These rules are non-negotiable. Violating them breaks the CI pipeline.
---
...
---
> Source: [lasantosr/intelli-shell](https://github.com/lasantosr/intelli-shell) — distributed by [TomeVault](https://tomevault.io).
