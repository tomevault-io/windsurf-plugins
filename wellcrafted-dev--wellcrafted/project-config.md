---
trigger: always_on
description: Lightweight TypeScript library for type-safe error handling, Result types, branded types, and TanStack Query integration. Zero dependencies, < 2KB.
---
...
---
> Source: [wellcrafted-dev/wellcrafted](https://github.com/wellcrafted-dev/wellcrafted) — distributed by [TomeVault](https://tomevault.io).
