---
trigger: always_on
description: Guide for AI agents working on the Pop codebase.
---
...
---
> Source: [charmbracelet/pop](https://github.com/charmbracelet/pop) — distributed by [TomeVault](https://tomevault.io).
