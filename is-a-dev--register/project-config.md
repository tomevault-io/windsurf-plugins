---
trigger: always_on
description: This repository handles pull requests that register new `.is-a.dev` subdomains. Every PR adds or modifies **only** JSON files in the `domains/` directory. These files define DNS records.
---
...
---
> Source: [is-a-dev/register](https://github.com/is-a-dev/register) — distributed by [TomeVault](https://tomevault.io).
