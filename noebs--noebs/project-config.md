---
trigger: always_on
description: These rules apply to all agents working in this repo. The intent is to keep layers clean and deterministic. Do **not** “defensively” mutate inputs inside lower layers.
---
...
---
> Source: [noebs/noebs](https://github.com/noebs/noebs) — distributed by [TomeVault](https://tomevault.io).
