...
# Copilot Instructions for vscode-flake8
...
- Always enable auto-merge (squash) on PRs after creating them: `gh pr merge <number> --repo microsoft/vscode-flake8 --squash --auto`
- PRs require approval from someone other than the last pusher before merging.

---
> Source: [microsoft/vscode-flake8](https://github.com/microsoft/vscode-flake8) — distributed by [TomeVault](https://tomevault.io).
