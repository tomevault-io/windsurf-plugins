---
trigger: always_on
description: These instructions guide AI code reviewers (GitHub Copilot, CodeRabbit, Qodo, Cubic, CodeAnt, etc.) when evaluating pull requests in this repository.
---
...
---
> Source: [MFlowCode/MFC](https://github.com/MFlowCode/MFC) — distributed by [TomeVault](https://tomevault.io).
