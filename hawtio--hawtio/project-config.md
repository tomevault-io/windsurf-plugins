---
trigger: always_on
description: Guidelines for AI coding agents working on this repository.
---
...
---
> Source: [hawtio/hawtio](https://github.com/hawtio/hawtio) — distributed by [TomeVault](https://tomevault.io).
