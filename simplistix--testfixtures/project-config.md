---
trigger: always_on
description: - **Done means green**: a change is only complete when `./happy.sh` exits 0; do not commit until it does.
---
...
---
> Source: [simplistix/testfixtures](https://github.com/simplistix/testfixtures) — distributed by [TomeVault](https://tomevault.io).
