---
trigger: always_on
description: <!-- This file contains project-specific instructions for Claude Code -->
---
...
---
> Source: [CyberAgentGameEntertainment/NovaShader](https://github.com/CyberAgentGameEntertainment/NovaShader) — distributed by [TomeVault](https://tomevault.io).
