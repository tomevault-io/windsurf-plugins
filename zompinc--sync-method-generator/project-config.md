---
trigger: always_on
description: See README.md for project overview and consumer API.
---
...
---
> Source: [zompinc/sync-method-generator](https://github.com/zompinc/sync-method-generator) — distributed by [TomeVault](https://tomevault.io).
