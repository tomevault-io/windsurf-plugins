---
trigger: always_on
description: TypeScript OAuth 2.0 authorization server library. Framework-agnostic core with adapters.
---
...
---
> Source: [jasonraimondi/ts-oauth2-server](https://github.com/jasonraimondi/ts-oauth2-server) — distributed by [TomeVault](https://tomevault.io).
