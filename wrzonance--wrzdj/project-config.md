---
trigger: always_on
description: Follows the global `~/.claude/rules` (code · workflow · security · agents). This file holds
---
...
---
> Source: [wrzonance/WrzDJ](https://github.com/wrzonance/WrzDJ) — distributed by [TomeVault](https://tomevault.io).
