---
trigger: always_on
description: This program is a command-line tool designed to automate the process of renewing contracts for services on Xserver, a Japanese hosting provider. It handles logging in, solving CAPTCHAs, and performing the renewal actions automatically.
---
...
---
> Source: [h-sumiya/xserver-auto-renew-rs](https://github.com/h-sumiya/xserver-auto-renew-rs) — distributed by [TomeVault](https://tomevault.io).
