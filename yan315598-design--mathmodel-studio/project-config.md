---
trigger: always_on
description: > 本文件是 **Codex** (以及任何遵循 `AGENTS.md` 约定的 agentic CLI) 的项目级入口。
---
...
3. 局部任务工作台 → 写作 (Stage 8) / 图表 / 终审 (Stage 9 或极速终审)
4. 模型选型建议 → Stage 3 选择卡, 不进入求解
...
---
> Source: [yan315598-design/mathmodel-studio](https://github.com/yan315598-design/mathmodel-studio) — distributed by [TomeVault](https://tomevault.io).
