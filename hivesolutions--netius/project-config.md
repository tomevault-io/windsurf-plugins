---
trigger: always_on
description: This document serves as the main reference for the agent's configuration, usage, and development notes. Please refer to the sections below for detailed instructions and guidelines.
---
...
- Increment (look at `CHANGELOG.md` for semver changes) the `version` value in `setup.py` and the `VERSION` value in `src/netius/base/common.py`.

<!-- Content truncated to meet Windsurf 6KB limit -->

---
> Source: [hivesolutions/netius](https://github.com/hivesolutions/netius) — distributed by [TomeVault](https://tomevault.io).
