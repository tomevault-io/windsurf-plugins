---
trigger: always_on
description: > 完整项目规则见 `CLAUDE.md`，本文件仅补充非 Claude Code 环境的额外要求。
---
...
---
> Source: [zuiho-kai/Greyfield](https://github.com/zuiho-kai/Greyfield) — distributed by [TomeVault](https://tomevault.io).
