---
trigger: always_on
description: Unity networking library (Mirror) located at `Assets/Mirror/`.
---
...
---
> Source: [MirrorNetworking/Mirror](https://github.com/MirrorNetworking/Mirror) — distributed by [TomeVault](https://tomevault.io).
