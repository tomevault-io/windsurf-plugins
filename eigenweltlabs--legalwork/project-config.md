---
trigger: always_on
description: LegalWork helps users run agents, skills, and MCP. It is an open-source alternative to Claude Cowork/Codex as a desktop app.
---
...
---
> Source: [eigenweltlabs/legalwork](https://github.com/eigenweltlabs/legalwork) — distributed by [TomeVault](https://tomevault.io).
