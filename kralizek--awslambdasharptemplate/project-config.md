---
trigger: always_on
description: This repository provides a programming model and `dotnet new` templates for AWS Lambda functions.
---
...
---
> Source: [Kralizek/AWSLambdaSharpTemplate](https://github.com/Kralizek/AWSLambdaSharpTemplate) — distributed by [TomeVault](https://tomevault.io).
