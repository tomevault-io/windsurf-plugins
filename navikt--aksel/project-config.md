---
trigger: always_on
description: - Narrow search space; don't replace reading code.
---
...
---
> Source: [navikt/aksel](https://github.com/navikt/aksel) — distributed by [TomeVault](https://tomevault.io).
