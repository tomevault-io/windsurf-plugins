---
trigger: always_on
description: This is a Go repository containing interfaces that define the contract between a
---
...
---
> Source: [dogmatiq/dogma](https://github.com/dogmatiq/dogma) — distributed by [TomeVault](https://tomevault.io).
