---
trigger: always_on
description: This file contains specific instructions for the `google/gemini-2.5-flash-image` model on OpenRouter when working with the Nano Banana extension for image generation, editing, and restoration.
---

# Nano Banana - OpenRouter Image Generation Instructions
...
---
> Source: [Aeven-AI/mcp-nanobanana](https://github.com/Aeven-AI/mcp-nanobanana) — distributed by [TomeVault](https://tomevault.io).
