---
trigger: always_on
description: When updating a dependency (for example to resolve a security advisory), keep the
---
...
---
> Source: [Azure/oav](https://github.com/Azure/oav) — distributed by [TomeVault](https://tomevault.io).
