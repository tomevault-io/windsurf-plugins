---
trigger: always_on
description: This repository provides release data for the [endoflife.date](https://endoflife.date) website. Scripts scrape release information from various sources and output structured JSON files.
---
...
---
> Source: [endoflife-date/release-data](https://github.com/endoflife-date/release-data) — distributed by [TomeVault](https://tomevault.io).
