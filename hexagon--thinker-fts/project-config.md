---
trigger: always_on
description: Thinker-FTS is a fast, extendable, and standalone pure JavaScript full-text search engine that works across Node.js, Deno, and browsers.
---
...
---
> Source: [Hexagon/thinker-fts](https://github.com/Hexagon/thinker-fts) — distributed by [TomeVault](https://tomevault.io).
