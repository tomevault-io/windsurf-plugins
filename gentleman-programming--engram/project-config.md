---
trigger: always_on
description: When working on this project, load the relevant skill(s) BEFORE writing any code.
---
...
---
> Source: [Gentleman-Programming/engram](https://github.com/Gentleman-Programming/engram) — distributed by [TomeVault](https://tomevault.io).
