---
trigger: always_on
description: This file guides coding agents working in the `nwinfo` repository.
---
...
---
> Source: [a1ive/nwinfo](https://github.com/a1ive/nwinfo) — distributed by [TomeVault](https://tomevault.io).
