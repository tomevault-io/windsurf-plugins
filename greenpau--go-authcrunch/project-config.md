---
trigger: always_on
description: go-authcrunch is a Go library for AuthCrunch Authentication, Authorization, and
---
...
---
> Source: [greenpau/go-authcrunch](https://github.com/greenpau/go-authcrunch) — distributed by [TomeVault](https://tomevault.io).
