---
trigger: always_on
description: 本文件定义 AI Agent 在 yamdc 项目中进行代码修改、测试和审查时必须遵循的规范。
---
...
---
> Source: [xxxsen/yamdc](https://github.com/xxxsen/yamdc) — distributed by [TomeVault](https://tomevault.io).
