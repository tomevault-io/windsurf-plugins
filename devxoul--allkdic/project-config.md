---
trigger: always_on
description: macOS menu-bar dictionary app (올ㅋ사전). Built with Tuist, signed with fastlane match, distributed on the Mac App Store.
---
...
---
> Source: [devxoul/allkdic](https://github.com/devxoul/allkdic) — distributed by [TomeVault](https://tomevault.io).
