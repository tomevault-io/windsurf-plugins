---
trigger: always_on
description: Read this before changing `packages/admin-sdk`.
---
...
---
> Source: [shopware/meteor](https://github.com/shopware/meteor) — distributed by [TomeVault](https://tomevault.io).
