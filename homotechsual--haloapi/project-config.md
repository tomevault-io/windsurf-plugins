---
trigger: always_on
description: This repository is a PowerShell module for the Halo API with helper classes, generated documentation output, and GitHub Actions workflows.
---
...
* Treat `Docs/HaloAPI/development/` as repo-authored development documentation.
...
---
> Source: [homotechsual/HaloAPI](https://github.com/homotechsual/HaloAPI) — distributed by [TomeVault](https://tomevault.io).
