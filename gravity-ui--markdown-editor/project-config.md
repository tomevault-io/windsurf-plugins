---
trigger: always_on
description: **Always run tests in Docker. Never run them locally.**
---
...
---
> Source: [gravity-ui/markdown-editor](https://github.com/gravity-ui/markdown-editor) — distributed by [TomeVault](https://tomevault.io).
