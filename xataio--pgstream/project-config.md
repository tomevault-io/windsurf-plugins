---
trigger: always_on
description: Guidance for Claude Code when working inside `pkg/stream/preflight`. The planned check set lives in `docs/migration_preflight_issue.md`; consult it before designing a new check.
---
...
---
> Source: [xataio/pgstream](https://github.com/xataio/pgstream) — distributed by [TomeVault](https://tomevault.io).
