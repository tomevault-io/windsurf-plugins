---
trigger: always_on
description: pnpm dev                    # Start dev server (auto-fetches network limits)
---
...
---
> Source: [stellar/laboratory](https://github.com/stellar/laboratory) — distributed by [TomeVault](https://tomevault.io).
