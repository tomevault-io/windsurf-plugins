---
trigger: always_on
description: - 后端位于 `src/`，入口 `src/app.py`，API 路由在 `src/api/routes/`，服务层在 `src/services/`，领域模型在 `src/domain/`，基础设施在 `src/infrastructure/`。
---
...
---
> Source: [Usagi-org/ai-goofish-monitor](https://github.com/Usagi-org/ai-goofish-monitor) — distributed by [TomeVault](https://tomevault.io).
