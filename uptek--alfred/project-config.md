---
trigger: always_on
description: This project uses WXT - a modern framework for building browser extensions.
---
...
---
> Source: [uptek/alfred](https://github.com/uptek/alfred) — distributed by [TomeVault](https://tomevault.io).
