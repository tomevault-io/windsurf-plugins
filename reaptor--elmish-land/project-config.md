---
trigger: always_on
description: When adding functionality, modify the existing function rather than creating a new one alongside it.
---
...
---
> Source: [reaptor/elmish-land](https://github.com/reaptor/elmish-land) — distributed by [TomeVault](https://tomevault.io).
