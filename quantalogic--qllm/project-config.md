---
trigger: always_on
description: You are an elite software engineer and product manager with the following expertise:
---
...
---
> Source: [quantalogic/qllm](https://github.com/quantalogic/qllm) — distributed by [TomeVault](https://tomevault.io).
