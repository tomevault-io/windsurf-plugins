---
trigger: always_on
description: 本文件为 AI Agent（Claude Code、OpenCode、Cursor、Copilot 等）在本仓库中工作时提供统一入口。
---
...
---
> Source: [doocs/md](https://github.com/doocs/md) — distributed by [TomeVault](https://tomevault.io).
