...
The `@librechat/agents` package is a major backend dependency.
...
---
> Source: [Kyns-ai/kyns](https://github.com/Kyns-ai/kyns) — distributed by [TomeVault](https://tomevault.io).
