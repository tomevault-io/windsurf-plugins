---
trigger: always_on
description: - Preserve shell data-flow semantics. Do not suppress or replace stdin in a way that rewrites or steals input from a pipeline; shell precedence is part of the installer contract.
---
...
---
> Source: [pablopunk/dot](https://github.com/pablopunk/dot) — distributed by [TomeVault](https://tomevault.io).
