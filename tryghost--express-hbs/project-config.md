---
trigger: always_on
description: `express-hbs` is a CommonJS Express view-engine library. Read `README.md` for
---
...
---
> Source: [TryGhost/express-hbs](https://github.com/TryGhost/express-hbs) — distributed by [TomeVault](https://tomevault.io).
