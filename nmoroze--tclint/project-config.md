---
trigger: always_on
description: - Source in `src/tclint/` with CLI entry points under `src/tclint/cli/` and command definitions in `src/tclint/commands/`.
---
...
---
> Source: [nmoroze/tclint](https://github.com/nmoroze/tclint) — distributed by [TomeVault](https://tomevault.io).
