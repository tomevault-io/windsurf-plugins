---
trigger: always_on
description: This document provides guidance for AI agents and developers working on this project.
---
...
---
> Source: [cloudbees-oss/zendesk-java-client](https://github.com/cloudbees-oss/zendesk-java-client) — distributed by [TomeVault](https://tomevault.io).
