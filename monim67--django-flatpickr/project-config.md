---
trigger: always_on
description: Django form widget library providing `DatePickerInput`, `TimePickerInput`, `DateTimePickerInput`. Wraps the
---
...
---
> Source: [monim67/django-flatpickr](https://github.com/monim67/django-flatpickr) — distributed by [TomeVault](https://tomevault.io).
