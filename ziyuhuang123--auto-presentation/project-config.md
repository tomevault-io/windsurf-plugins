---
trigger: always_on
description: 用来读论文、生成单文件 HTML、导出知乎可直接粘贴的富文本内容。
---
...
---
> Source: [ziyuhuang123/auto_presentation](https://github.com/ziyuhuang123/auto_presentation) — distributed by [TomeVault](https://tomevault.io).
