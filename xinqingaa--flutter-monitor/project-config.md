---
trigger: always_on
description: 这是本仓库面向 agent 的唯一工作规范。后续 agent 应以本文档作为项目方向、文档建设和代码演进的硬约束来源。
---
...
---
> Source: [xinqingaa/flutter_monitor](https://github.com/xinqingaa/flutter_monitor) — distributed by [TomeVault](https://tomevault.io).
