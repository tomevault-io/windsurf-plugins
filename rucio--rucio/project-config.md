---
trigger: always_on
description: Repository-wide instructions for AI coding agents and for humans directing them.
---
...
---
> Source: [rucio/rucio](https://github.com/rucio/rucio) — distributed by [TomeVault](https://tomevault.io).
