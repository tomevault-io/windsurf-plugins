---
trigger: always_on
description: - Owl Admin 是 Laravel 扩展包，业务项目通常通过 `composer require slowlyo/owl-admin` 安装。
---
...
---
> Source: [slowlyo/owl-admin](https://github.com/slowlyo/owl-admin) — distributed by [TomeVault](https://tomevault.io).
