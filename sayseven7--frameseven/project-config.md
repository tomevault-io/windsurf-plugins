---
trigger: always_on
description: Keep changes simple, local, readable, and aligned with the current project.
---
...
---
> Source: [sayseven7/frameseven](https://github.com/sayseven7/frameseven) — distributed by [TomeVault](https://tomevault.io).
