---
trigger: always_on
description: - Build: `pnpm run build` (Typecheck + Bundling)
---
...
---
> Source: [observerw/obsidian-code-link](https://github.com/observerw/obsidian-code-link) — distributed by [TomeVault](https://tomevault.io).
