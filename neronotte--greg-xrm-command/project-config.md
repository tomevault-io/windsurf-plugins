---
trigger: always_on
description: PACX is a plugin-based CLI tool for Microsoft Dataverse / Power Platform, distributed as a .NET global tool (`pacx`). It supports ~100+ built-in commands plus dynamic plugin loading from `%appdata%/PACX/Plugins/`.
---
...
---
> Source: [neronotte/Greg.Xrm.Command](https://github.com/neronotte/Greg.Xrm.Command) — distributed by [TomeVault](https://tomevault.io).
