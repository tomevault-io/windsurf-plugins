...
- Always use `cn` from `@/lib/utils` for class name merging.
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/opencollective)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/opencollective)
