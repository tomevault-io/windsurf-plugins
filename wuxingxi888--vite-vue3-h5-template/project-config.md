---
trigger: always_on
description: 该项目是一个基于 Vue3、TypeScript、Vite 构建的移动端 H5 模板项目，集成了现代化的前端技术栈和工程化配置。
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/wuxingxi888) — claim your Tome and manage your conversions.
