---
trigger: always_on
description: OptiClone is a standalone Windows PC voice cloning application built with Python.
---
...
---
> Source: [ycharfi09/OptiClone](https://github.com/ycharfi09/OptiClone) — distributed by [TomeVault](https://tomevault.io).
