# AI instruction files for guardian-agent

> Sourced from [Threat-Vector-Security/guardian-agent](https://github.com/Threat-Vector-Security/guardian-agent) and converted for every major platform by [TomeVault](https://tomevault.io)
...
Original source: `AGENTS.md` in [Threat-Vector-Security/guardian-agent](https://github.com/Threat-Vector-Security/guardian-agent).
