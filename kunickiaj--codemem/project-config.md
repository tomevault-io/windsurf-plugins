---
trigger: always_on
description: - Public repo: never add secrets, internal hostnames, private identifiers, or local artifact paths. Keep `.tmp/`, `.venv/`, `*.sqlite`, `packages/*/dist/`, `packages/viewer-server/static/`, and `.opencode/package-lock.json` out of git.
---
...
---
> Source: [kunickiaj/codemem](https://github.com/kunickiaj/codemem) — distributed by [TomeVault](https://tomevault.io).
