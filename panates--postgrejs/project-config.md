---
trigger: always_on
description: `postgrejs` is a from-scratch PostgreSQL wire-protocol client for Node.js/TypeScript - no `libpq`, no native
---
...
---
> Source: [panates/postgrejs](https://github.com/panates/postgrejs) — distributed by [TomeVault](https://tomevault.io).
