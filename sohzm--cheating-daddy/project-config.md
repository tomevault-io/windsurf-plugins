---
trigger: always_on
description: This repository is a fork of [`cheating-daddy`](https://github.com/sohzm/cheating-daddy).
---
...
---
> Source: [sohzm/cheating-daddy](https://github.com/sohzm/cheating-daddy) — distributed by [TomeVault](https://tomevault.io).
