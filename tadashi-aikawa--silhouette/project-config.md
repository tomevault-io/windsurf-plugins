---
trigger: always_on
description: - `src/` TypeScript/Svelte sources
---
...
---
> Source: [tadashi-aikawa/silhouette](https://github.com/tadashi-aikawa/silhouette) — distributed by [TomeVault](https://tomevault.io).
