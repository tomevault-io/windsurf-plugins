---
trigger: always_on
description: Use **pnpm**: `pnpm install`, `pnpm dev`, `pnpm build`, `pnpm lint`, `pnpm typecheck`, `pnpm generate`, `pnpm knip`
---
...
---
> Source: [fabe/site](https://github.com/fabe/site) — distributed by [TomeVault](https://tomevault.io).
