---
trigger: always_on
description: Central class for watermark collection and staleness detection.
---
...
---
> Source: [trilogy-data/pytrilogy](https://github.com/trilogy-data/pytrilogy) — distributed by [TomeVault](https://tomevault.io).
