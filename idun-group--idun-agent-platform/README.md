# AI instruction files for idun-agent-platform
...
Original source: `.cursor/rules/*.mdc` in [Idun-Group/idun-agent-platform](https://github.com/Idun-Group/idun-agent-platform).
