---
trigger: always_on
description: <!-- Copilot auto-discovery stub — actual instructions live in the tool-agnostic file -->
---

<!-- Copilot auto-discovery stub — actual instructions live in the tool-agnostic file -->
