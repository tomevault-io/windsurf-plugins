---
trigger: always_on
description: UpscalerJS is shipped and has real users — ~4.2M CDN hits/yr, ~450K model-init sessions/yr (see [`internals/statistics/REPORT.md`](internals/statistics/REPORT.md)).  The bar for breaking things is high, and the maintainer wants to stay in close touch with the codebase. So the usual default is inverted.
---
...
---
> Source: [thekevinscott/UpscalerJS](https://github.com/thekevinscott/UpscalerJS) — distributed by [TomeVault](https://tomevault.io).
