...
Original source: `CLAUDE.md` in [artalis-io/bitnet.c](https://github.com/artalis-io/bitnet.c).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/artalis-io/bitnet.c](https://github.com/artalis-io/bitnet.c)
