---
trigger: always_on
description: Apply these rules to all **new or materially modified code and documentation** in
---
...
---
> Source: [AVSLab/basilisk](https://github.com/AVSLab/basilisk) — distributed by [TomeVault](https://tomevault.io).
