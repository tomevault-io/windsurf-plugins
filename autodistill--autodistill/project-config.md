---
trigger: always_on
description: <span class="cls-button">Classification</span>
---
...
---
> Source: [autodistill/autodistill](https://github.com/autodistill/autodistill) — distributed by [TomeVault](https://tomevault.io).
