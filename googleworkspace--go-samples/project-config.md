---
trigger: always_on
description: This repository contains Go code samples for Google Workspace APIs.
---
...
---
> Source: [googleworkspace/go-samples](https://github.com/googleworkspace/go-samples) — distributed by [TomeVault](https://tomevault.io).
