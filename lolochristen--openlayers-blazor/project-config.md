---
trigger: always_on
description: This is a Blazor component library that wraps OpenLayers for .NET. It provides map components for displaying various map types (OpenStreetMap, Bing, SwissTopo) with support for markers, shapes, and vector layers.
---
...
---
> Source: [lolochristen/OpenLayers.Blazor](https://github.com/lolochristen/OpenLayers.Blazor) — distributed by [TomeVault](https://tomevault.io).
