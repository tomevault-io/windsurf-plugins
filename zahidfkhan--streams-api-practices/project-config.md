---
trigger: always_on
description: A **Java 17 Maven** project by Zahid Khan for learning and practising the **Java Stream API**. All source code lives exclusively in `src/test/java` — there is no `src/main/java` directory.
---
...
---
> Source: [ZahidFKhan/Streams-API-Practices](https://github.com/ZahidFKhan/Streams-API-Practices) — distributed by [TomeVault](https://tomevault.io).
