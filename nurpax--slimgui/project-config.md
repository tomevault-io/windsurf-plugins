---
trigger: always_on
description: - Keep recipe examples idiomatic for Dear ImGui and Slimgui. The preferred patterns should match how similar problems are solved in `src/c/imgui/imgui_demo.cpp`, even when the recipe is simplified for documentation.
---
