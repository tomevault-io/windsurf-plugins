---
trigger: always_on
description: This package is the Journal Ghost theme. In the standalone mirror repository, this tree is pushed from `TryGhost/Themes/packages/journal` by subtree sync; make durable theme-content changes in `TryGhost/Themes` unless the task is explicitly repo-level metadata or GitHub settings.
---
...
---
> Source: [TryGhost/Journal](https://github.com/TryGhost/Journal) — distributed by [TomeVault](https://tomevault.io).
