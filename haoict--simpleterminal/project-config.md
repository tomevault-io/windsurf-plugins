---
trigger: always_on
description: SimpleTerminal is an SDL2-based VT100 terminal emulator for embedded Linux handhelds, migrated from SDL1.2. It runs on devices like RGB30, H700, and Raspberry Pi, as well as generic Linux PCs.
---
...
---
> Source: [haoict/SimpleTerminal](https://github.com/haoict/SimpleTerminal) — distributed by [TomeVault](https://tomevault.io).
