---
trigger: always_on
description: Nx monorepo (pnpm + Nx 22) that publishes **@nxlv/python** (`packages/nx-python`), plus `@nxlv/data-migration` and the `@nxlv/util` library. TypeScript, tested with Vitest.
---
...
---
> Source: [lucasvieirasilva/nx-plugins](https://github.com/lucasvieirasilva/nx-plugins) — distributed by [TomeVault](https://tomevault.io).
