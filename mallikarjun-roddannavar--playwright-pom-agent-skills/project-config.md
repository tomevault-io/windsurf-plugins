---
trigger: always_on
description: This file applies to the entire `playwright-pom-agent-skills` framework.
---
...
---
> Source: [Mallikarjun-Roddannavar/playwright-pom-agent-skills](https://github.com/Mallikarjun-Roddannavar/playwright-pom-agent-skills) — distributed by [TomeVault](https://tomevault.io).
