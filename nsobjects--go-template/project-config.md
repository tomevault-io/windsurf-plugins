---
trigger: always_on
description: This project scaffolds API layers (service, biz, data) from OpenAPI descriptions. When working under the repository, follow the
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/NSObjects)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/NSObjects)
