---
trigger: always_on
description: Java 25 + Spring Boot multi-module Gradle project. All convention plugins live in `buildSrc/`. A separate Cucumber-js/TypeScript BDD suite lives in `e2y/testing/bdd/` (not part of the Gradle build).
---
...
---
> Source: [paypal/mirakl-hyperwallet-connector](https://github.com/paypal/mirakl-hyperwallet-connector) — distributed by [TomeVault](https://tomevault.io).
