---
trigger: always_on
description: Tezgah, Claude Code için yazılmış bir SaaS başlatma skill setidir. Türkiye'deki solopreneur'lerin production-ready SaaS uygulaması kurmasını sağlar.
---
...
---
> Source: [komunite/tezgah](https://github.com/komunite/tezgah) — distributed by [TomeVault](https://tomevault.io).
