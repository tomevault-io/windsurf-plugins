---
trigger: always_on
description: > Project instructions (build, structure, labels): see upstream AGENTS.md (injected from system_files context).
---
...
---
> Source: [projectbluefin/common](https://github.com/projectbluefin/common) — distributed by [TomeVault](https://tomevault.io).
