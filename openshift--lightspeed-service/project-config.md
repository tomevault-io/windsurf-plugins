---
trigger: always_on
description: OpenShift LightSpeed (OLS) is an AI-powered assistant service for OpenShift built with FastAPI, LangChain, and LlamaIndex. It provides AI responses to OpenShift/Kubernetes questions using various LLM backends.
---
...
---
> Source: [openshift/lightspeed-service](https://github.com/openshift/lightspeed-service) — distributed by [TomeVault](https://tomevault.io).
