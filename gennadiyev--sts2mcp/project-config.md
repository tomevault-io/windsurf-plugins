---
trigger: always_on
description: - After `combat_end_turn`, the state may show `is_play_phase: false` or `turn: enemy`. Call `get_game_state` again to advance to the next player turn.
---
...
---
> Source: [Gennadiyev/STS2MCP](https://github.com/Gennadiyev/STS2MCP) — distributed by [TomeVault](https://tomevault.io).
