---
trigger: always_on
description: Multi-language client drivers for TypeDB.
---
...
---
> Source: [typedb/typedb-driver](https://github.com/typedb/typedb-driver) — distributed by [TomeVault](https://tomevault.io).
