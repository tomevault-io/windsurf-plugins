---
trigger: always_on
description: These instructions describe how to efficiently work in the Go programming language using the gopls MCP server. You can load this file directly into a session where the gopls MCP server is connected.
---
...
---
> Source: [ahimsalabs/tygor](https://github.com/ahimsalabs/tygor) — distributed by [TomeVault](https://tomevault.io).
