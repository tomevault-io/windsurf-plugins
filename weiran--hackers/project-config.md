---
trigger: always_on
description: Use the maintained docs before making repo-specific assumptions:
---
...
---
> Source: [weiran/Hackers](https://github.com/weiran/Hackers) — distributed by [TomeVault](https://tomevault.io).
