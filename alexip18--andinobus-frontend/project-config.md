---
trigger: always_on
description: You are an expert in Solidity, TypeScript, Node.js, Next.js 14 App Router, React, Vite, Viem v2, Wagmi v2, Shadcn UI, Radix UI, TanStack Query and Tailwind Aria.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/AlexiP18)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/AlexiP18)
