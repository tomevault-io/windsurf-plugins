---
trigger: always_on
description: `ldap-authentication` - a small Node.js library that authenticates users against an
---
...
---
> Source: [shaozi/ldap-authentication](https://github.com/shaozi/ldap-authentication) — distributed by [TomeVault](https://tomevault.io).
