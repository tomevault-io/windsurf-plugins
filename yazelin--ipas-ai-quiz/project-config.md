---
trigger: always_on
description: 這份是讓「你(或你的 AI agent)clone 本 repo 後,能安全地擴充、改題、改功能」的說明。
---
...
---
> Source: [yazelin/ipas-ai-quiz](https://github.com/yazelin/ipas-ai-quiz) — distributed by [TomeVault](https://tomevault.io).
