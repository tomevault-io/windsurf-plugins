---
trigger: always_on
description: Seed-Farmer traditionally uses the [Environment Parameter](manifests.md)  as a means to get environment parameter at runtime to be declarative about the field requested:
---
...
---
> Source: [awslabs/seed-farmer](https://github.com/awslabs/seed-farmer) — distributed by [TomeVault](https://tomevault.io).
