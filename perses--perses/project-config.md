---
trigger: always_on
description: This is the main Perses product repository. It combines a Go API server and CLI, CUE and Go Dashboard-as-Code tooling,
---
...
---
> Source: [perses/perses](https://github.com/perses/perses) — distributed by [TomeVault](https://tomevault.io).
