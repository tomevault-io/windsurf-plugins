...
Original source: `AGENTS.md` in [luckyyyyy/miu2d](https://github.com/luckyyyyy/miu2d).
...
```
npx tomevault install luckyyyyy/miu2d
```
Source: [github.com/luckyyyyy/miu2d](https://github.com/luckyyyyy/miu2d).
