---
trigger: always_on
description: Rust web service (Rocket 0.5) that converts Markdown to PDF using Pandoc with multiple engines (weasyprint, wkhtmltopdf, pdflatex).
---
...
---
> Source: [spawnia/md-to-pdf](https://github.com/spawnia/md-to-pdf) — distributed by [TomeVault](https://tomevault.io).
