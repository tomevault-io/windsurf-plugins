---
trigger: always_on
description: EliteJournalReader is a .NET library for consuming Elite Dangerous journal events. The game generates journal files (and a `Status.json` file) while playing; this library monitors those files in real time and surfaces each event as a typed .NET event that consuming applications can subscribe to.
---
...
---
> Source: [MagicMau/EliteJournalReader](https://github.com/MagicMau/EliteJournalReader) — distributed by [TomeVault](https://tomevault.io).
