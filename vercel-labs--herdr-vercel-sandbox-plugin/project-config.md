---
trigger: always_on
description: - Treat current Herdr, Vercel Sandbox, and coding-agent documentation plus shipped CLI or SDK behavior as ground truth.
---
...
---
> Source: [vercel-labs/herdr-vercel-sandbox-plugin](https://github.com/vercel-labs/herdr-vercel-sandbox-plugin) — distributed by [TomeVault](https://tomevault.io).
