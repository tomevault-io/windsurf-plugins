---
trigger: always_on
description: - This repository is a Python package for retrieval-augmented generation (RAG) pipelines and TREC RAG workflows.
---
...
---
> Source: [castorini/ragnarok](https://github.com/castorini/ragnarok) — distributed by [TomeVault](https://tomevault.io).
