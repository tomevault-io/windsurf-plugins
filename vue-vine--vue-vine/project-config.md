---
trigger: always_on
description: - 此项目是为了创造一种全新的编写 Vue 组件的方式，和 Vue 官方的 SFC 可以同时使用。
---
...
---
> Source: [vue-vine/vue-vine](https://github.com/vue-vine/vue-vine) — distributed by [TomeVault](https://tomevault.io).
