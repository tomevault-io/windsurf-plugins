...
Original source: `CLAUDE.md` in [consi/flowcus](https://github.com/consi/flowcus).
...
From [consi/flowcus](https://github.com/consi/flowcus) — a repo with 30+ stars on GitHub.
