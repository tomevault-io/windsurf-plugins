---
trigger: always_on
description: These guidelines are automatically applied to Python development tasks within this repository.
---
...
---
> Source: [googleapis/google-cloud-python](https://github.com/googleapis/google-cloud-python) — distributed by [TomeVault](https://tomevault.io).
