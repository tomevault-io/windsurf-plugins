---
trigger: always_on
description: `dotnet-monitor` is a diagnostic tool for capturing diagnostic artifacts from .NET applications in an operator-driven or automated manner. It provides a unified HTTP API for collecting diagnostics regardless of where the application runs (local, Docker, Kubernetes).
---
...
---
> Source: [dotnet/dotnet-monitor](https://github.com/dotnet/dotnet-monitor) — distributed by [TomeVault](https://tomevault.io).
