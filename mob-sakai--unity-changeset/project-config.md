---
trigger: always_on
description: This project is a TypeScript library and CLI tool for retrieving and listing Unity editor changesets. It supports both Deno and Node.js environments, using Deno for development and building npm packages via dnt. The codebase follows Deno's conventions and uses modern TypeScript features.
---
...
---
> Source: [mob-sakai/unity-changeset](https://github.com/mob-sakai/unity-changeset) — distributed by [TomeVault](https://tomevault.io).
