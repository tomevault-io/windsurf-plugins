---
trigger: always_on
description: AlaSQL is an open source SQL database for JavaScript with a focus on query speed and data source flexibility for both relational data and schemaless data. It works in web browsers, Node.js, and mobile apps.
---
...
---
> Source: [AlaSQL/alasql](https://github.com/AlaSQL/alasql) — distributed by [TomeVault](https://tomevault.io).
