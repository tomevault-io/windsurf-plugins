...
Original source: `AGENTS.md` in [sengac/fspec](https://github.com/sengac/fspec).
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/sengac/fspec](https://github.com/sengac/fspec)
