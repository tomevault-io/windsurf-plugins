---
trigger: always_on
description: This endpoint queries the agent for the known peers in the gossip pool. This endpoint is only applicable to servers. Due to the nature of gossip, this is eventually consistent.
---
...
---
> Source: [jrxFive/python-nomad](https://github.com/jrxFive/python-nomad) — distributed by [TomeVault](https://tomevault.io).
