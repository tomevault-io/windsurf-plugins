---
trigger: always_on
description: This is a Systems Without Number (SWN) Foundry VTT system project. The main configuration definitions are located in `module/helpers/config.mjs`.
---
...
---
> Source: [wintersleepAI/swnr](https://github.com/wintersleepAI/swnr) — distributed by [TomeVault](https://tomevault.io).
