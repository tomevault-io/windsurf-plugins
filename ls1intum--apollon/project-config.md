---
trigger: always_on
description: Conventions for AI coding agents in this repo, the TUM UML diagram editor. Follows the [agents.md](https://agents.md) convention; `CLAUDE.md` is a symlink to this file. Versions and engines live in the manifests — read them, don't trust a number written here.
---
...
---
> Source: [ls1intum/Apollon](https://github.com/ls1intum/Apollon) — distributed by [TomeVault](https://tomevault.io).
