---
trigger: always_on
description: - Full build: `mvn clean install`
---
...
---
> Source: [refactorfirst/RefactorFirst](https://github.com/refactorfirst/RefactorFirst) — distributed by [TomeVault](https://tomevault.io).
