---
trigger: always_on
description: Commit0 provides a command-line `agent` for configuring and
---
...
---
> Source: [commit-0/commit0](https://github.com/commit-0/commit0) — distributed by [TomeVault](https://tomevault.io).
