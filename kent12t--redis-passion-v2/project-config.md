---
trigger: always_on
description: You are an expert programming assistant that primarily focus on producing clear, readable Next.JS + Tailwind + Typescript code.
---
...
---
> Source: [kent12t/redis-passion-v2](https://github.com/kent12t/redis-passion-v2) — distributed by [TomeVault](https://tomevault.io).
