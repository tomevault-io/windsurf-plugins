---
trigger: always_on
description: When creating or working on a pull request, you **MUST** ensure all of the following conditions are met before marking the PR as ready for review:
---
...
---
> Source: [microsoft/moc](https://github.com/microsoft/moc) — distributed by [TomeVault](https://tomevault.io).
