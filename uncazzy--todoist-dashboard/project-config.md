---
trigger: always_on
description: - Next.js (pages router) with TypeScript and Tailwind.
---
...
---
> Source: [uncazzy/todoist-dashboard](https://github.com/uncazzy/todoist-dashboard) — distributed by [TomeVault](https://tomevault.io).
