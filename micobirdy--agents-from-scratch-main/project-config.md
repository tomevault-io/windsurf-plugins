---
trigger: always_on
description: This repository demonstrates building agents using LangGraph, focusing on an email assistant that can:
---
...
---
> Source: [Micobirdy/agents-from-scratch-main](https://github.com/Micobirdy/agents-from-scratch-main) — distributed by [TomeVault](https://tomevault.io).
