---
trigger: always_on
description: CopilotAdventures is an educational repository containing adventure-themed coding challenges designed to teach developers GitHub Copilot's different interaction modes (Agent, Ask, and Edit). The core concept is fantasy-themed programming puzzles that demonstrate specific Copilot capabilities.
---
...
---
> Source: [microsoft/CopilotAdventures](https://github.com/microsoft/CopilotAdventures) — distributed by [TomeVault](https://tomevault.io).
