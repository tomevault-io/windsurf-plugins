---
trigger: always_on
description: Guidance for AI coding agents (Claude, Cursor, Copilot, etc.) working with this repo. This is a static
---
...
---
> Source: [itmeo/webgradients](https://github.com/itmeo/webgradients) — distributed by [TomeVault](https://tomevault.io).
