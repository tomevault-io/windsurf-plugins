---
trigger: always_on
description: 跨平台音视频播放器 SDK (C++17)，支持直播/本地播放、硬解/GPU 渲染、Vulkan 图像处理、WebRTC、AI 功能。
---
...
---
> Source: [xxxzhou/avox](https://github.com/xxxzhou/avox) — distributed by [TomeVault](https://tomevault.io).
