---
trigger: always_on
description: Shopware LSP is a Language Server Protocol implementation for Shopware and Symfony development. It provides IDE features (completion, go-to-definition, hover, diagnostics) for PHP, Twig, XML, and YAML files.
---
...
---
> Source: [shopware/shopware-lsp](https://github.com/shopware/shopware-lsp) — distributed by [TomeVault](https://tomevault.io).
