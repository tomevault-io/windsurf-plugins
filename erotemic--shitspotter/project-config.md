---
trigger: always_on
description: - **Project overview**: Computer-vision tooling for the ShitSpotter / ScatSpotter dataset and models (see `README.rst`). The package hosts data acquisition utilities, dataset split management, training / inference entrypoints, and analytic scripts.
---
...
---
> Source: [Erotemic/shitspotter](https://github.com/Erotemic/shitspotter) — distributed by [TomeVault](https://tomevault.io).
