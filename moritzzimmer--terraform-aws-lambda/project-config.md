---
trigger: always_on
description: Terraform module for AWS Lambda with opinionated defaults for IAM, logging, VPC, event sources, and deployments. Published to the [Terraform Registry](https://registry.terraform.io/modules/moritzzimmer/lambda/aws).
---
...
---
> Source: [moritzzimmer/terraform-aws-lambda](https://github.com/moritzzimmer/terraform-aws-lambda) — distributed by [TomeVault](https://tomevault.io).
