---
trigger: always_on
description: This file applies to the entire repository. More specific `AGENTS.md` files in subdirectories take precedence for their subtree. Start here for global rules, then read the nested file nearest to the code you are changing.
---
...
---
> Source: [NotNahid/M3UAndroid](https://github.com/NotNahid/M3UAndroid) — distributed by [TomeVault](https://tomevault.io).
