---
trigger: always_on
description: ├── voice_assistant.py      # 语音助手主控制器
---
...
---
> Source: [1ea95/aemeath_ai_desktop_pet](https://github.com/1ea95/aemeath_ai_desktop_pet) — distributed by [TomeVault](https://tomevault.io).
