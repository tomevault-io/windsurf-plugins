---
trigger: always_on
description: This repository is a framework for creating and managing unofficial "BMAD" (Build-My-Agent-Director) expansion packs. These packs are collections of AI agents, tasks, and workflows designed to accomplish specific goals. The entire system is defined through a series of Markdown and YAML files.
---
...
---
> Source: [tronghieu/BMAD-METHOD-MINIONS](https://github.com/tronghieu/BMAD-METHOD-MINIONS) — distributed by [TomeVault](https://tomevault.io).
