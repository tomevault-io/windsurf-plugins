---
trigger: always_on
description: Code comments, docstrings and commit/PR text in this repo frequently cite a
---
...
---
> Source: [XKNX/xknx](https://github.com/XKNX/xknx) — distributed by [TomeVault](https://tomevault.io).
