---
trigger: always_on
description: After each new commit in this repository, explicitly evaluate whether the change should trigger a new release.
---
...
---
> Source: [yanyiwu/gojieba](https://github.com/yanyiwu/gojieba) — distributed by [TomeVault](https://tomevault.io).
