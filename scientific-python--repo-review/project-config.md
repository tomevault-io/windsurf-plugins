---
trigger: always_on
description: **repo-review**: Python 3.10+ framework for validating repository configuration (not source code).
---
...
---
> Source: [scientific-python/repo-review](https://github.com/scientific-python/repo-review) — distributed by [TomeVault](https://tomevault.io).
