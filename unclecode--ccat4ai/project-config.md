---
trigger: always_on
description: - Run script: `bash ccat.sh <git-repo-url> <output-filename>`
---
...
---
> Source: [unclecode/ccat4ai](https://github.com/unclecode/ccat4ai) — distributed by [TomeVault](https://tomevault.io).
