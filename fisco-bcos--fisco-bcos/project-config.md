---
trigger: always_on
description: 本说明旨在让 AI 编码代理在该单仓多模块项目中立即高效产出。
---
...
---
> Source: [FISCO-BCOS/FISCO-BCOS](https://github.com/FISCO-BCOS/FISCO-BCOS) — distributed by [TomeVault](https://tomevault.io).
