---
trigger: always_on
description: 开始修改前阅读根目录 `AGENTS.md` 与 `docs/development/README.md`；
---
...
---
> Source: [w93139/ai-jubensha-fusion](https://github.com/w93139/ai-jubensha-fusion) — distributed by [TomeVault](https://tomevault.io).
