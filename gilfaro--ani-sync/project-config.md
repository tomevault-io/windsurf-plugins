---
trigger: always_on
description: - ALWAYS attempt to add a test case for changed behavior
---
...
---
> Source: [Gilfaro/ani-sync](https://github.com/Gilfaro/ani-sync) — distributed by [TomeVault](https://tomevault.io).
