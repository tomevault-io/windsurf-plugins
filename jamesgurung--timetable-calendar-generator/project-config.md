---
trigger: always_on
description: - Make the smallest reasonable code change that fully solves the task, keeping the diff to a minimum.
---
...
---
> Source: [jamesgurung/timetable-calendar-generator](https://github.com/jamesgurung/timetable-calendar-generator) — distributed by [TomeVault](https://tomevault.io).
