---
trigger: always_on
description: - Before implementation, produce a complete architecture design covering the domain model, ownership and lifecycle, data flow, persistence, APIs, frontend state, failure recovery, migration, and compatibility with existing Solo behavior.
---
...
---
> Source: [solo-agent/solo](https://github.com/solo-agent/solo) — distributed by [TomeVault](https://tomevault.io).
