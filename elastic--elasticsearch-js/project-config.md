---
trigger: always_on
description: Always use `npm` commands, not `yarn`, `pnpm` or any other third-party packaging tool.
---
...
---
> Source: [elastic/elasticsearch-js](https://github.com/elastic/elasticsearch-js) — distributed by [TomeVault](https://tomevault.io).
