---
trigger: always_on
description: PoshMcp is a Model Context Protocol (MCP) server implementation that exposes PowerShell functions as MCP tools. The server dynamically generates MCP tool schemas from PowerShell functions and handles execution through stdio communication.
---
...
---
> Source: [usepowershell/PoshMcp](https://github.com/usepowershell/PoshMcp) — distributed by [TomeVault](https://tomevault.io).
