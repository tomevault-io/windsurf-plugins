---
trigger: always_on
description: - Cell vectors are given in [ASE](https://wiki.fysik.dtu.dk/ase/) style as the **rows** of the cell matrix
---
...
---
> Source: [mir-group/nequip](https://github.com/mir-group/nequip) — distributed by [TomeVault](https://tomevault.io).
