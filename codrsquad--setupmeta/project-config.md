---
trigger: always_on
description: This file defines repo-specific guidance for coding agents working on `setupmeta`.
---
...
---
> Source: [codrsquad/setupmeta](https://github.com/codrsquad/setupmeta) — distributed by [TomeVault](https://tomevault.io).
