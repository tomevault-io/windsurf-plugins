---
trigger: always_on
description: > **Full Docs**: `technical-docs/02-architecture/03-module-system.md`
---
...
---
> Source: [shopware/administration](https://github.com/shopware/administration) — distributed by [TomeVault](https://tomevault.io).
