---
trigger: always_on
description: MCP server for automating binary diffing via Diaphora + IDA Pro.
---
...
---
> Source: [xTeardx/diaphora-mcp](https://github.com/xTeardx/diaphora-mcp) — distributed by [TomeVault](https://tomevault.io).
