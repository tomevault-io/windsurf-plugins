---
trigger: always_on
description: `@winpath-tools/pathfix-cli` is a Node.js CLI (`pathfix`) that wraps four PowerShell scripts for Windows PATH management:
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/winpath-tools)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/winpath-tools)
