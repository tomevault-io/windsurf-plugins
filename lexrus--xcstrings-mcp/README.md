...
Original source: `CLAUDE.md` in [lexrus/xcstrings_mcp](https://github.com/lexrus/xcstrings_mcp).
...
Quality verified by TomeVault's automated analysis pipeline. Source: [github.com/lexrus/xcstrings_mcp](https://github.com/lexrus/xcstrings_mcp)
