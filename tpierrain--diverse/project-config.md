---
trigger: always_on
description: Diverse is a **zero-dependency .NET fuzzing library** (netstandard2.0) that generates random but contextually coherent test data. It is **not** a business application -- it is a library consumed via NuGet by test projects.
---
...
---
> Source: [tpierrain/Diverse](https://github.com/tpierrain/Diverse) — distributed by [TomeVault](https://tomevault.io).
