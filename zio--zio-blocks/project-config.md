---
trigger: always_on
description: When reviewing a pull request, check whether it introduces a **new feature**, **new public API**, or **changes an existing public API**. If it does, verify that the PR also includes corresponding documentation updates under the `docs/` directory.
---
...
---
> Source: [zio/zio-blocks](https://github.com/zio/zio-blocks) — distributed by [TomeVault](https://tomevault.io).
