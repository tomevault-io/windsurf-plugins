---
trigger: always_on
description: This file gives coding agents a current map of the repository.
---
...
---
> Source: [PleasePrompto/ductor](https://github.com/PleasePrompto/ductor) — distributed by [TomeVault](https://tomevault.io).
