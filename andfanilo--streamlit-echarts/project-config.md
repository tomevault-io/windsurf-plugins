---
trigger: always_on
description: Major-version intent below; exact pins live in `pyproject.toml` and `streamlit_echarts/frontend/package.json` — read those for specifics.
---
...
---
> Source: [andfanilo/streamlit-echarts](https://github.com/andfanilo/streamlit-echarts) — distributed by [TomeVault](https://tomevault.io).
