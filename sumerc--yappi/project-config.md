---
trigger: always_on
description: yappi is a C-extension Python profiler (`yappi/_yappi.c` + `yappi/yappi.py`). The C layer handles all profiling hooks via `sys.setprofile`; the Python layer provides the public API and stat containers.
---
...
---
> Source: [sumerc/yappi](https://github.com/sumerc/yappi) — distributed by [TomeVault](https://tomevault.io).
