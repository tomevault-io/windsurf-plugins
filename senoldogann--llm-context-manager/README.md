# AI instruction files for LLM-Context-Manager
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/senoldogann/LLM-Context-Manager](https://github.com/senoldogann/LLM-Context-Manager)
