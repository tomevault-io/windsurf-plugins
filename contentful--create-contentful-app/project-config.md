---
trigger: always_on
description: Scaffolding toolkit for Contentful apps. Three published packages:
---
...
---
> Source: [contentful/create-contentful-app](https://github.com/contentful/create-contentful-app) — distributed by [TomeVault](https://tomevault.io).
