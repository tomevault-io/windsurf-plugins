---
trigger: always_on
description: - Use MCP if you can work task fast with.
---
...
---
> Source: [devndesigner6/ephera-note](https://github.com/devndesigner6/ephera-note) — distributed by [TomeVault](https://tomevault.io).
