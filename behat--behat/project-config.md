---
trigger: always_on
description: - Core PHP code lives in `src/Behat/...`, grouped by component (Context, Definition, Output, Tester).
---
...
---
> Source: [Behat/Behat](https://github.com/Behat/Behat) — distributed by [TomeVault](https://tomevault.io).
