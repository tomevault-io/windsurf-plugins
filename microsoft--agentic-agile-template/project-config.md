---
trigger: always_on
description: > This file provides GitHub Copilot with project-specific context. For the universal cross-agent entry point used by this project, see [`AGENTS.md`](../../../AGENTS.md).
---
