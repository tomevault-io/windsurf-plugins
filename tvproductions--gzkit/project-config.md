---
trigger: always_on
description: Instructions for GitHub Copilot when working with gzkit.
---
...
---
> Source: [tvproductions/gzkit](https://github.com/tvproductions/gzkit) — distributed by [TomeVault](https://tomevault.io).
