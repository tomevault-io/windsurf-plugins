---
trigger: always_on
description: - Use English for all documentation and code comments.
---
...
---
> Source: [0x2E/fusion](https://github.com/0x2E/fusion) — distributed by [TomeVault](https://tomevault.io).
