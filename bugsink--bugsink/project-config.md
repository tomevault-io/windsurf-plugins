---
trigger: always_on
description: Bugsink is a Django-based error tracker. It's maintained by one developer and favors simple, predictable code over
---
...
---
> Source: [bugsink/bugsink](https://github.com/bugsink/bugsink) — distributed by [TomeVault](https://tomevault.io).
