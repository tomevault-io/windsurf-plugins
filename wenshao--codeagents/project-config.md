---
trigger: always_on
description: > 本文件为所有 AI 编程代理提供项目级上下文。支持 Claude Code（通过符号链接）、Codex CLI、Kimi CLI、Copilot CLI、Qwen Code、OpenCode。
---
...
---
> Source: [wenshao/codeagents](https://github.com/wenshao/codeagents) — distributed by [TomeVault](https://tomevault.io).
