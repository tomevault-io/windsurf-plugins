---
trigger: always_on
description: When a required tool or binary is missing, do not stop and ask me to install it first.
---
...
---
> Source: [tymscar/dotfiles](https://github.com/tymscar/dotfiles) — distributed by [TomeVault](https://tomevault.io).
