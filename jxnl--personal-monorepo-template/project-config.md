---
trigger: always_on
description: Use the strongest available coding model unless the user or task explicitly calls for a different model.
---
...
---
> Source: [jxnl/personal-monorepo-template](https://github.com/jxnl/personal-monorepo-template) — distributed by [TomeVault](https://tomevault.io).
