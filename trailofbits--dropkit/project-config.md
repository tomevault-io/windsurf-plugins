---
trigger: always_on
description: Validates format (ssh-rsa, ssh-ed25519, ecdsa-sha2-*, etc.).
---
...
---
> Source: [trailofbits/dropkit](https://github.com/trailofbits/dropkit) — distributed by [TomeVault](https://tomevault.io).
