---
trigger: always_on
description: **ALWAYS reference the [main README.md](./README.md) first for project setup, architecture, and development guidance. Then move on to the following instructions.**
---
