---
trigger: always_on
description: - Spinnaker is an open-source continuous delivery platform for releasing software with high velocity and confidence.
---
...
---
> Source: [spinnaker/spinnaker](https://github.com/spinnaker/spinnaker) — distributed by [TomeVault](https://tomevault.io).
