---
trigger: always_on
description: This is **zap** — a Rust TUI AI coding agent.
---
...
---
> Source: [zap-coding-agent/zap-coding-agent](https://github.com/zap-coding-agent/zap-coding-agent) — distributed by [TomeVault](https://tomevault.io).
