---
trigger: always_on
description: Read [CONSTITUTION.md](/CONSTITUTION.md) before reviewing. Comment only with >80% confidence. One sentence per comment.
---
...
---
> Source: [TimefoldAI/timefold-solver](https://github.com/TimefoldAI/timefold-solver) — distributed by [TomeVault](https://tomevault.io).
