---
trigger: always_on
description: - This repo is a **MaaFramework** automation script bundle: pipelines/images/models live under `assets/`, and a Python **AgentServer** provides custom actions/recognitions.
---
...
---
> Source: [Ostwind23/MAA-for-Millennium-Tour](https://github.com/Ostwind23/MAA-for-Millennium-Tour) — distributed by [TomeVault](https://tomevault.io).
