---
trigger: always_on
description: 开始处理仓库前，先读 `.ai/rules/` 下 `alwaysApply: true` 的基础规则与维护文档；其他文档按任务结合 `description` / `globs` 按需继续阅读。
---
...
---
> Source: [vibe-forge-ai/vibe-forge.ai](https://github.com/vibe-forge-ai/vibe-forge.ai) — distributed by [TomeVault](https://tomevault.io).
