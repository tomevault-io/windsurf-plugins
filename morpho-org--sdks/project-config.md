---
trigger: always_on
description: - Keep this package framework-free. Source may import `viem` for ABI encoding, typed data, and explicit fetch boundary helpers, but it must not import React, wagmi, Redux, or app code.
---
