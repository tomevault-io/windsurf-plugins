---
trigger: always_on
description: This repo implements Gazette: a low-latency streaming data broker,
---
...
---
> Source: [gazette/core](https://github.com/gazette/core) — distributed by [TomeVault](https://tomevault.io).
