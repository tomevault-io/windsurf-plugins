---
trigger: always_on
description: This project uses **bd** (beads) for issue tracking. Run `bd prime` for full
---
...
---
> Source: [mrVanDalo/nixos-artifacts](https://github.com/mrVanDalo/nixos-artifacts) — distributed by [TomeVault](https://tomevault.io).
