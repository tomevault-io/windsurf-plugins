---
trigger: always_on
description: - **Purpose:** eparse is a Python package and CLI tool for crawling, parsing, and extracting tabular data from Excel spreadsheets, with support for SQLite and PostgreSQL outputs.
---
