---
trigger: always_on
description: Contributor quickstart for the Project Starter Guide. Use this repo to maintain the decision matrix, deep-dive docs, and production-ready templates.
---
...
---
> Source: [buildproven/project-starter-guide](https://github.com/buildproven/project-starter-guide) — distributed by [TomeVault](https://tomevault.io).
