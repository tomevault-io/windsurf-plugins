...
4. **AI callback**: `tclaw_chat.c`'s `__ai_chat_handle_event` receives stream events:
...
- **Agent loop ↔ AI callback**: Binary semaphore `s_turn.sem` (`agent_loop_task` waits, `tclaw_chat` posts)
...
```
TClaw/   (git repo: tuya/TClaw, a.k.a. Ducky)
├── agent/                  # Core agent loop and context builder

<!-- Content truncated to meet Windsurf 6KB limit -->

---
> Source: [tuya/TClaw](https://github.com/tuya/TClaw) — distributed by [TomeVault](https://tomevault.io).
