---
trigger: always_on
description: 1. **Non-trivial change → create an issue first.** Trivial edits (typos, formatting) don't need one. Questions don't need one, but may still trigger a wiki update.
---
