---
trigger: always_on
description: **CRITICAL**: Never read, modify, or expose secret/credential files:
---
...
---
> Source: [starkware-libs/sequencer](https://github.com/starkware-libs/sequencer) — distributed by [TomeVault](https://tomevault.io).
