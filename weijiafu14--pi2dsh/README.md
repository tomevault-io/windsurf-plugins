# AI instruction files for pi2dsh

> Sourced from [weijiafu14/pi2dsh](https://github.com/weijiafu14/pi2dsh), graded against the public Tome Standard and kept consistent across every major platform by [TomeVault](https://tomevault.io)
