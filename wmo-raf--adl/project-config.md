---
trigger: always_on
description: ADL is a Django-based platform that automates periodic observation data collection from Automatic Weather Station (AWS)
---
...
---
> Source: [wmo-raf/adl](https://github.com/wmo-raf/adl) — distributed by [TomeVault](https://tomevault.io).
