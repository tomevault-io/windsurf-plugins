---
trigger: always_on
description: Published npm package (`react-touch-drag-slider`). Single default-exported React component in `src/lib/Slider.tsx`. Vite library build, outputs ESM to `dist/`.
---
...
---
> Source: [bushblade/react-touch-drag-slider](https://github.com/bushblade/react-touch-drag-slider) — distributed by [TomeVault](https://tomevault.io).
