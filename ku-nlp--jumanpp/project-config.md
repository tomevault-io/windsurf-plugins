---
trigger: always_on
description: > **Meta-rule**: Rules in this file include their rationale. Rules with rationales are followed more reliably and transfer better to novel situations.
---
...
---
> Source: [ku-nlp/jumanpp](https://github.com/ku-nlp/jumanpp) — distributed by [TomeVault](https://tomevault.io).
