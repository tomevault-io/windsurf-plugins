---
trigger: always_on
description: To ensure code stability and avoid regressions, AI agents MUST perform the
---
...
---
> Source: [dart-lang/dartdoc](https://github.com/dart-lang/dartdoc) — distributed by [TomeVault](https://tomevault.io).
