---
trigger: always_on
description: Contributor and agent orientation for this repository. Organization policy,
---
...
---
> Source: [z-shell/F-Sy-H](https://github.com/z-shell/F-Sy-H) — distributed by [TomeVault](https://tomevault.io).
