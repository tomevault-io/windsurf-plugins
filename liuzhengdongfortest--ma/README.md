...
Original source: `AGENTS.md` in [liuzhengdongfortest/MA](https://github.com/liuzhengdongfortest/MA).
...
```
npx tomevault install liuzhengdongfortest/MA
```
Source: [github.com/liuzhengdongfortest/MA](https://github.com/liuzhengdongfortest/MA).
