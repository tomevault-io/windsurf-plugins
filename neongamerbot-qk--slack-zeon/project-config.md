---
trigger: always_on
description: - **Start**: `npm start` - Runs the bot with ts-node and increased memory
---
...
---
> Source: [NeonGamerBot-QK/slack-zeon](https://github.com/NeonGamerBot-QK/slack-zeon) — distributed by [TomeVault](https://tomevault.io).
