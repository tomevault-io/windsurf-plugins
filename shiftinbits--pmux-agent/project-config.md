---
trigger: always_on
description: Go agent binary for Pocketmux. `pmux` is a transparent tmux wrapper that proxies all commands to `tmux -L pmux` while running a background WebRTC agent for mobile access.
---
