---
trigger: always_on
description: bundle exec rubocop -a
---
...
---
> Source: [shakacode/react-webpack-rails-tutorial](https://github.com/shakacode/react-webpack-rails-tutorial) — distributed by [TomeVault](https://tomevault.io).
