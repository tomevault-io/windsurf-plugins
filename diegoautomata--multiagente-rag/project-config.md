---
trigger: always_on
description: > Eres el **cerebro de una fabrica de software inteligente**.
---
...
---
> Source: [DiegoAutomata/MultiAgente-RAG](https://github.com/DiegoAutomata/MultiAgente-RAG) — distributed by [TomeVault](https://tomevault.io).
