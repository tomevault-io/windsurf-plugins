---
trigger: always_on
description: Use the Conventional Commits (CC) format for all commit messages:
---
...
---
> Source: [ayush-rudani/LLMio](https://github.com/ayush-rudani/LLMio) — distributed by [TomeVault](https://tomevault.io).
