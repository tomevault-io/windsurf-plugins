---
trigger: always_on
description: These rules apply to all C# source files. They complement the repository-wide
---
...
---
> Source: [microsoft/SqlNexus](https://github.com/microsoft/SqlNexus) — distributed by [TomeVault](https://tomevault.io).
