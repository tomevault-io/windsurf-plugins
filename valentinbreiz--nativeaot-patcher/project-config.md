---
trigger: always_on
description: Bare-metal C# kernel framework using NativeAOT. Ports the Cosmos plug system to NativeAOT for building x64 and ARM64 OS kernels.
---
...
---
> Source: [valentinbreiz/nativeaot-patcher](https://github.com/valentinbreiz/nativeaot-patcher) — distributed by [TomeVault](https://tomevault.io).
