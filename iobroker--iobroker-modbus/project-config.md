---
trigger: always_on
description: ioBroker.modbus is a Node.js adapter that implements ModBus Slave and Master functionality for the ioBroker home automation platform. It includes a React-based admin interface and comprehensive ModBus protocol support.
---
...
---
> Source: [ioBroker/ioBroker.modbus](https://github.com/ioBroker/ioBroker.modbus) — distributed by [TomeVault](https://tomevault.io).
