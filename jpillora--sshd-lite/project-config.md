---
trigger: always_on
description: This document provides guidance for AI assistants working on sshd-lite.
---
...
---
> Source: [jpillora/sshd-lite](https://github.com/jpillora/sshd-lite) — distributed by [TomeVault](https://tomevault.io).
