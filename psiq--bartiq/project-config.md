---
trigger: always_on
description: `bartiq` is a symbolic quantum resource estimation compiler and analysis library with docs, tutorials, and optional interactive extras.
---
...
---
> Source: [PsiQ/bartiq](https://github.com/PsiQ/bartiq) — distributed by [TomeVault](https://tomevault.io).
