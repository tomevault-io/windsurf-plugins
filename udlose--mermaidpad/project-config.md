---
trigger: always_on
description: MermaidPad is a cross-platform Mermaid chart editor built with .NET 9 and Avalonia.
---
...
---
> Source: [udlose/MermaidPad](https://github.com/udlose/MermaidPad) — distributed by [TomeVault](https://tomevault.io).
