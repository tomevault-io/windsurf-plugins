---
trigger: always_on
description: Guidance for coding agents working in `super-linter-workflow`.
---
...
---
> Source: [BretFisher/super-linter-workflow](https://github.com/BretFisher/super-linter-workflow) — distributed by [TomeVault](https://tomevault.io).
