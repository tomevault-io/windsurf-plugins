---
trigger: always_on
description: 本项目使用已安装的 `project-lifecycle` Skill 管理需要持久追踪、多人协作或有明显风险的工作。
---
...
---
> Source: [xiaou61/Code-Nest](https://github.com/xiaou61/Code-Nest) — distributed by [TomeVault](https://tomevault.io).
