---
trigger: always_on
description: C#/.NET auto-instrumentation agent for the .NET ecosystem that reports tracing, metrics, and logs
---
...
---
> Source: [SkyAPM/SkyAPM-dotnet](https://github.com/SkyAPM/SkyAPM-dotnet) — distributed by [TomeVault](https://tomevault.io).
