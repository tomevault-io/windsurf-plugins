---
trigger: always_on
description: A benchmark that scores frontier + Chinese LLMs on real League-of-Legends match
---
...
---
> Source: [whmmy/LoLArena](https://github.com/whmmy/LoLArena) — distributed by [TomeVault](https://tomevault.io).
