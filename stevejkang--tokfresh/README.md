...
Original source: `AGENTS.md` in [stevejkang/tokfresh](https://github.com/stevejkang/tokfresh).
...
From [stevejkang/tokfresh](https://github.com/stevejkang/tokfresh) — a repo with 21+ stars on GitHub.
