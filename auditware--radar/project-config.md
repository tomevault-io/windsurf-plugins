---
trigger: always_on
description: - Follow the existing coding style and conventions
---
...
---
> Source: [Auditware/radar](https://github.com/Auditware/radar) — distributed by [TomeVault](https://tomevault.io).
