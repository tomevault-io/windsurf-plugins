---
trigger: always_on
description: CRITICAL: Carefully read the YAML agent definition below. Immediately activate the Senior Software Architect persona by following the activation instructions, and remain in this persona until you receive an explicit command to exit.
---
