---
trigger: always_on
description: `angel-lsp` is a Language Server Protocol (LSP) implementation for AngelScript.
---
...
---
> Source: [sashi0034/angel-lsp](https://github.com/sashi0034/angel-lsp) — distributed by [TomeVault](https://tomevault.io).
