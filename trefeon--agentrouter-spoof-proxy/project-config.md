---
trigger: always_on
description: Quick setup for AI coding agents (opencode, Claude Code, Cursor).
---
...
---
> Source: [trefeon/agentrouter-spoof-proxy](https://github.com/trefeon/agentrouter-spoof-proxy) — distributed by [TomeVault](https://tomevault.io).
