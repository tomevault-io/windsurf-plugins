---
trigger: always_on
description: Keep this file short: it is the strong injection layer, not the full harness.
---
...
---
> Source: [alibaba/xquic](https://github.com/alibaba/xquic) — distributed by [TomeVault](https://tomevault.io).
