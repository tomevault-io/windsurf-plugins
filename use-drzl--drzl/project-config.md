---
trigger: always_on
description: - Root: pnpm workspace with TypeScript packages under `packages/*`.
---
...
---
> Source: [use-drzl/drzl](https://github.com/use-drzl/drzl) — distributed by [TomeVault](https://tomevault.io).
