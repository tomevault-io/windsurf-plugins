---
trigger: always_on
description: - Node: use `>=18` (v20+ recommended).
---
...
---
> Source: [supercorp-ai/supercompat](https://github.com/supercorp-ai/supercompat) — distributed by [TomeVault](https://tomevault.io).
