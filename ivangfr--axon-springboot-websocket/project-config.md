---
trigger: always_on
description: `axon-event-commons` must be installed first — it is a local JAR dependency for the other three services:
---
...
---
> Source: [ivangfr/axon-springboot-websocket](https://github.com/ivangfr/axon-springboot-websocket) — distributed by [TomeVault](https://tomevault.io).
