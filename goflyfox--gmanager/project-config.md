---
trigger: always_on
description: - 全栈管理后台：**GoFrame v2** 后端 (`server/`) + **Vue 3 / Vite / Element Plus** 前端 (`web/`)。
---
...
---
> Source: [goflyfox/gmanager](https://github.com/goflyfox/gmanager) — distributed by [TomeVault](https://tomevault.io).
