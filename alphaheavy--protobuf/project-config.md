---
trigger: always_on
description: This repository contains an implementation of Google's Protocol Buffers in Haskell. It provides a pure Haskell implementation that uses GHC.Generics and does not require `.proto` files to function.
---
...
---
> Source: [alphaHeavy/protobuf](https://github.com/alphaHeavy/protobuf) — distributed by [TomeVault](https://tomevault.io).
