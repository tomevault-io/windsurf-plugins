---
trigger: always_on
description: - Build/Type check: `bun run typecheck`
---
...
---
> Source: [anthropics/claude-code-base-action](https://github.com/anthropics/claude-code-base-action) — distributed by [TomeVault](https://tomevault.io).
