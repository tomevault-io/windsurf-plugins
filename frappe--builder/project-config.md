---
trigger: always_on
description: Preferences for this codebase. Follow existing patterns first. Apply these unless a specific case has a stronger reason.
---
...
---
> Source: [frappe/builder](https://github.com/frappe/builder) — distributed by [TomeVault](https://tomevault.io).
