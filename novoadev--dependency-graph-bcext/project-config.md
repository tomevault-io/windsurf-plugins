---
trigger: always_on
description: -   All code must be written in **English**.
---
...
---
> Source: [NovoaDev/Dependency-Graph-BCExt](https://github.com/NovoaDev/Dependency-Graph-BCExt) — distributed by [TomeVault](https://tomevault.io).
