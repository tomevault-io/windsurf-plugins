---
trigger: always_on
description: - Use @terminal when answering questions about Git.
---
...
---
> Source: [dasiths/VibeCodingBreadcrumbDemo](https://github.com/dasiths/VibeCodingBreadcrumbDemo) — distributed by [TomeVault](https://tomevault.io).
