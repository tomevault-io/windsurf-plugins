---
trigger: always_on
description: Use `agents` folder files for instructions.
---
...
---
> Source: [InsanusMokrassar/MicroUtils](https://github.com/InsanusMokrassar/MicroUtils) — distributed by [TomeVault](https://tomevault.io).
