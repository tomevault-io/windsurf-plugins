---
trigger: always_on
description: npm run build --workspace=@atlassian-dc-mcp/jira
---
...
---
> Source: [b1ff/atlassian-dc-mcp](https://github.com/b1ff/atlassian-dc-mcp) — distributed by [TomeVault](https://tomevault.io).
