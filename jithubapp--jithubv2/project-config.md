---
trigger: always_on
description: JitHub is a Windows native productivity app, not a website. Page layout must be stable, responsive, and owned by the page/workspace shell rather than by whatever content happens to be visible.
---
...
---
> Source: [JitHubApp/JitHubV2](https://github.com/JitHubApp/JitHubV2) — distributed by [TomeVault](https://tomevault.io).
