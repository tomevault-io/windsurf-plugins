---
trigger: always_on
description: Rust bindings to [libtailscale](https://github.com/tailscale/libtailscale), the C library for embedding Tailscale as a userspace network into your application. This crate lets Rust programs join a tailnet, listen for connections, dial other nodes, and use the LocalAPI.
---
...
---
> Source: [messense/libtailscale-rs](https://github.com/messense/libtailscale-rs) — distributed by [TomeVault](https://tomevault.io).
