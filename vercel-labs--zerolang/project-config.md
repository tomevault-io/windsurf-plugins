---
trigger: always_on
description: Zero is a pre-1 experiment in building an agent-first programming language.
---
...
---
> Source: [vercel-labs/zerolang](https://github.com/vercel-labs/zerolang) — distributed by [TomeVault](https://tomevault.io).
