---
trigger: always_on
description: do not delete my comments
---
...
do not delete comments that start with CL

---
> Source: [clowrey/S3XY-BMS](https://github.com/clowrey/S3XY-BMS) — distributed by [TomeVault](https://tomevault.io).
