---
trigger: always_on
description: Tests are documentation. You can create tests for iteration but they should always be removed when you are done and replaced by minimal tests that document the feature.
---
...
---
> Source: [pmndrs/math](https://github.com/pmndrs/math) — distributed by [TomeVault](https://tomevault.io).
