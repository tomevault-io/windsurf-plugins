---
trigger: always_on
description: **gruvbox.nvim** is a Neovim colorscheme plugin that ports the popular gruvbox community theme to Lua with treesitter and semantic highlighting support. This is a single-module Lua plugin targeting Neovim 0.8.0+ with extensive customization capabilities.
---
...
---
> Source: [ellisonleao/gruvbox.nvim](https://github.com/ellisonleao/gruvbox.nvim) — distributed by [TomeVault](https://tomevault.io).
