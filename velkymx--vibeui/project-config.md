---
trigger: always_on
description: You are generating code that uses **`@velkymx/vibeui`** — a Vue 3 component library wrapping Bootstrap 5.3. Follow this and you'll produce correct code on the first try.
---
...
---
> Source: [velkymx/vibeui](https://github.com/velkymx/vibeui) — distributed by [TomeVault](https://tomevault.io).
