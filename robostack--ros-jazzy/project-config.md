---
trigger: always_on
description: Working notes for future coding agents in a RoboStack repo. Replace $DISTRO with e.g. noetic/humble/jazzy/kilted and so forth; you can check the working directory.
---
...
---
> Source: [RoboStack/ros-jazzy](https://github.com/RoboStack/ros-jazzy) — distributed by [TomeVault](https://tomevault.io).
