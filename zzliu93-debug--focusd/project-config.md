---
trigger: always_on
description: 本文件面向在本仓库中工作的 AI 编程代理和协作者，说明项目背景、常用命令、代码边界与变更约定。请在动手修改前先阅读本文件，并优先遵循仓库现有实现风格。
---
...
---
> Source: [zzliu93-debug/FocuSD](https://github.com/zzliu93-debug/FocuSD) — distributed by [TomeVault](https://tomevault.io).
