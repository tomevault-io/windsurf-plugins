---
trigger: always_on
description: This is a **Roll20 Character Sheet** for the Palladium Rifts tabletop role-playing game system. This is NOT a standalone web application or traditional web development project. All code must be written specifically for the Roll20 platform and its character sheet system.
---
...
---
> Source: [Roll20/roll20-character-sheets](https://github.com/Roll20/roll20-character-sheets) — distributed by [TomeVault](https://tomevault.io).
