---
trigger: always_on
description: This cookbook uses `Policyfile.rb` for dependency resolution. Run `chef install Policyfile.rb`
---
...
---
> Source: [sous-chefs/varnish](https://github.com/sous-chefs/varnish) — distributed by [TomeVault](https://tomevault.io).
