---
trigger: always_on
description: Instructions for coding agents working *on this repository*. Micelio is also a
---
...
---
> Source: [tuist/micelio](https://github.com/tuist/micelio) — distributed by [TomeVault](https://tomevault.io).
