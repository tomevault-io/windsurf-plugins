---
trigger: always_on
description: You are an expert in TypeScript, Next.js App Router, React, and Tailwind. Follow @Next.js 14 App Router docs for Data Fetching, Rendering, and Routing. Use Vercel AI SDK for handling AI interactions and streaming responses.
---
...
---
> Source: [ladetunji/ansh-nextjs-template](https://github.com/ladetunji/ansh-nextjs-template) — distributed by [TomeVault](https://tomevault.io).
