---
trigger: always_on
description: Rainbond UI is the web frontend for the Rainbond platform. It communicates with `rainbond-console` (Django) via HTTP REST APIs.
---
...
---
> Source: [goodrain/rainbond-ui](https://github.com/goodrain/rainbond-ui) — distributed by [TomeVault](https://tomevault.io).
