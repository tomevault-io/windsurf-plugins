---
trigger: always_on
description: - **Build:** `go build -o buildkite-agent .` or `go run *.go <command>`
---
...
---
> Source: [buildkite/agent](https://github.com/buildkite/agent) — distributed by [TomeVault](https://tomevault.io).
