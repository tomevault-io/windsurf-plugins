---
trigger: always_on
description: Renderer-specific guidance for `examples/playcanvas/`. Read the root [`AGENTS.md`](../../AGENTS.md),
---
...
---
> Source: [cx20/webgl-physics-examples](https://github.com/cx20/webgl-physics-examples) — distributed by [TomeVault](https://tomevault.io).
