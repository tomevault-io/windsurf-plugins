---
trigger: always_on
description: > **说明**：本文档与 [CLAUDE.md](./CLAUDE.md) 保持内容完全一致，共同定义了本项目的核心设计原则、严格交互确认协议、Git 提交验收门禁与发布审阅规范。
---
...
---
> Source: [ygq-future/antigravity-priority](https://github.com/ygq-future/antigravity-priority) — distributed by [TomeVault](https://tomevault.io).
