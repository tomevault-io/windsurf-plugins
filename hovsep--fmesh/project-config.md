---
trigger: always_on
description: F-Mesh is a Flow-Based Programming (FBP) framework for Go. Apps are directed graphs of **components** connected by **ports** and **pipes**. Data flows as **signals**. Execution runs in discrete synchronized **cycles**; all eligible components run concurrently per cycle.
---
...
---
> Source: [hovsep/fmesh](https://github.com/hovsep/fmesh) — distributed by [TomeVault](https://tomevault.io).
