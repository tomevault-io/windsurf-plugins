---
trigger: always_on
description: Apache ECharts is a TypeScript-first charting library. Most runtime code lives in `src/`, while build scripts, test utilities, and packaging logic live alongside it in dedicated top-level folders.
---
...
---
> Source: [apache/echarts](https://github.com/apache/echarts) — distributed by [TomeVault](https://tomevault.io).
