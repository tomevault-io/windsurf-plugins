---
trigger: always_on
description: Dynamic DNS client for the netcup CCP DNS API, written in PHP. Updates A/AAAA DNS records with the current public IP address. Designed to run as a cron job.
---
...
---
> Source: [stecklars/dynamic-dns-netcup-api](https://github.com/stecklars/dynamic-dns-netcup-api) — distributed by [TomeVault](https://tomevault.io).
