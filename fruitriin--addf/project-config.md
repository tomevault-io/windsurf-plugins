---
trigger: always_on
description: > This file enables Codex (and other AGENTS.md-compatible tools) to use ADDF.
---
...
---
> Source: [fruitriin/ADDF](https://github.com/fruitriin/ADDF) — distributed by [TomeVault](https://tomevault.io).
