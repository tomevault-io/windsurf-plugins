---
trigger: always_on
description: River is a Python library for online (streaming) machine learning. All estimators implement incremental `learn_one`/`predict_one` methods (or `learn_many`/`predict_many` for mini-batch).
---
...
---
> Source: [online-ml/river](https://github.com/online-ml/river) — distributed by [TomeVault](https://tomevault.io).
