...
---
> Source: [microsoft/ignite25-LAB514-build-and-deploy-ai-agents-with-mcp-and-azure-functions](https://github.com/microsoft/ignite25-LAB514-build-and-deploy-ai-agents-with-mcp-and-azure-functions) — distributed by [TomeVault](https://tomevault.io).
