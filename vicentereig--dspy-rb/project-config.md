---
trigger: always_on
description: - Use `rbenv` with the pinned Ruby in `.ruby-version` (3.4.5). For asdf users, `.tool-versions` lists 3.3.7, but rbenv contributors should honor `.ruby-version`.
---
...
---
> Source: [vicentereig/dspy.rb](https://github.com/vicentereig/dspy.rb) — distributed by [TomeVault](https://tomevault.io).
