---
trigger: always_on
description: - Apply these instructions only within this repository.
---
...
---
> Source: [xnuinside/simple-ddl-parser](https://github.com/xnuinside/simple-ddl-parser) — distributed by [TomeVault](https://tomevault.io).
