---
trigger: always_on
description: Firefly is a CLI orchestrator for automatic semantic versioning, git-cliff changelog generation, and creating release all in one command.
---
...
---
> Source: [yehezkieldio/firefly](https://github.com/yehezkieldio/firefly) — distributed by [TomeVault](https://tomevault.io).
