...
Original source: `CLAUDE.md` in [microclaw/microclaw](https://github.com/microclaw/microclaw).
...
From [microclaw/microclaw](https://github.com/microclaw/microclaw) — a repo with 656+ stars on GitHub.
