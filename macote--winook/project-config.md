---
trigger: always_on
description: Winook is a Windows-only library with a managed .NET package and native C++ support binaries. Changes may need to
---
...
---
> Source: [macote/Winook](https://github.com/macote/Winook) — distributed by [TomeVault](https://tomevault.io).
