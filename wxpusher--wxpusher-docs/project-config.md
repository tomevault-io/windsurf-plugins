---
trigger: always_on
description: - 每次回复的第一句话必须是：`【识别到wxpusher-docs/AGENTS.md】`
---
...
---
> Source: [wxpusher/wxpusher-docs](https://github.com/wxpusher/wxpusher-docs) — distributed by [TomeVault](https://tomevault.io).
