---
trigger: always_on
description: GitHub repository management tool — bulk view, archive, and delete repos. Zero-knowledge, client-side only.
---
...
---
> Source: [moollaza/repo-remover](https://github.com/moollaza/repo-remover) — distributed by [TomeVault](https://tomevault.io).
