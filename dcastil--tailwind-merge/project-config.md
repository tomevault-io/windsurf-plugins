---
trigger: always_on
description: This repository is `tailwind-merge`, a TypeScript library that merges Tailwind class strings by removing style conflicts while preserving non-conflicting and non-Tailwind classes.
---
...
---
> Source: [dcastil/tailwind-merge](https://github.com/dcastil/tailwind-merge) — distributed by [TomeVault](https://tomevault.io).
