---
trigger: always_on
description: A single-file Telegram bot (`main.py`) that uses yt-dlp to download media from YouTube, TikTok, Instagram, Twitter/X, and Bluesky. All application logic lives in one file around 590 lines.
---
...
---
> Source: [ssebastianoo/yt-dlp-telegram](https://github.com/ssebastianoo/yt-dlp-telegram) — distributed by [TomeVault](https://tomevault.io).
