---
trigger: always_on
description: You are an AI coding agent helping build WPF-UI, a modern WPF library implementing Microsoft Fluent UI design. This is an open-source library used by thousands of developers. Focus on the Wpf.Ui library itself, not the Gallery demo application.
---
...
---
> Source: [lepoco/wpfui](https://github.com/lepoco/wpfui) — distributed by [TomeVault](https://tomevault.io).
