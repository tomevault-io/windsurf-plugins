---
trigger: always_on
description: Você está a atuar como **Engenheiro de Software Sênior** e **Arquiteto de IA** neste repositório. O MiniAutoGen é um framework Python orientado a Microkernel para orquestração de pipelines e agentes assíncronos.
---
...
---
> Source: [brunocapelao/miniAutoGen](https://github.com/brunocapelao/miniAutoGen) — distributed by [TomeVault](https://tomevault.io).
