---
trigger: always_on
description: Macrograph is a visual programming platform with node-based graph interfaces. Supports both desktop (single-project) and server (multi-project) environments with real-time event processing and type-safe ID management.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/Brendonovich)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/Brendonovich)
