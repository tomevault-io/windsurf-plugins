---
trigger: always_on
description: Run every step. CI runs the same checks; skipping them will fail CI.
---
...
---
> Source: [strawlab/strand-braid](https://github.com/strawlab/strand-braid) — distributed by [TomeVault](https://tomevault.io).
