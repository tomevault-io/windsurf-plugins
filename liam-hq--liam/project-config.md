---
trigger: always_on
description: - frontend/apps/*: Next.js apps (e.g., `@liam-hq/app`, `@liam-hq/docs`).
---
...
---
> Source: [liam-hq/liam](https://github.com/liam-hq/liam) — distributed by [TomeVault](https://tomevault.io).
