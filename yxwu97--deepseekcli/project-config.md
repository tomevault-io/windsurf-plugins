---
trigger: always_on
description: > **镜像要求**：`AGENTS.md` 与 `CLAUDE.md` 必须保持内容完全一致。修改任一文件时必须同步修改另一份，并在交付前比较两者内容。
---
...
---
> Source: [yxwu97/DeepSeekCLI](https://github.com/yxwu97/DeepSeekCLI) — distributed by [TomeVault](https://tomevault.io).
