---
trigger: always_on
description: This crate exists to make networking deterministic. Anything that
---
...
---
> Source: [tokio-rs/turmoil](https://github.com/tokio-rs/turmoil) — distributed by [TomeVault](https://tomevault.io).
