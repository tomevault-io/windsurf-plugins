---
trigger: always_on
description: This is **seo-agi** -- a Claude Code skill for Generative Engine Optimization. It writes pages that rank on Google AND get cited by LLMs.
---
...
---
> Source: [gbessoni/seobuild-onpage](https://github.com/gbessoni/seobuild-onpage) — distributed by [TomeVault](https://tomevault.io).
