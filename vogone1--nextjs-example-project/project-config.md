---
trigger: always_on
description: - **Framework:** Next.js (TypeScript)
---
...
---
> Source: [vogone1/NextJS-Example-Project](https://github.com/vogone1/NextJS-Example-Project) — distributed by [TomeVault](https://tomevault.io).
