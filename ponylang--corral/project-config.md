---
trigger: always_on
description: The Pony dependency manager. It manages `corral.json` (deps, packages, info) and `lock.json` (locked revisions).
---
...
---
> Source: [ponylang/corral](https://github.com/ponylang/corral) — distributed by [TomeVault](https://tomevault.io).
