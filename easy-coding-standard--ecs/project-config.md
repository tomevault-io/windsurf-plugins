---
trigger: always_on
description: A tiny PHP 8.3+ framework: a reflection-based DI container (`src/Container`) plus a console runner (`src/Console`) that turns `CommandInterface::run()` signatures into CLI arguments and options.
---
...
---
> Source: [easy-coding-standard/ecs](https://github.com/easy-coding-standard/ecs) — distributed by [TomeVault](https://tomevault.io).
