---
trigger: always_on
description: Adobe Commerce integration components for AEM (Sling Models, HTL templates, React storefronts).
---
...
---
> Source: [adobe/aem-core-cif-components](https://github.com/adobe/aem-core-cif-components) — distributed by [TomeVault](https://tomevault.io).
