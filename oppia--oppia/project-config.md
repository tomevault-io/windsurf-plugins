---
trigger: always_on
description: Oppia is a large full‑stack web application built with Python (backend) and
---
...
---
> Source: [oppia/oppia](https://github.com/oppia/oppia) — distributed by [TomeVault](https://tomevault.io).
