---
trigger: always_on
description: Run commands from the repository root (`/skillssss`).
---
...
---
> Source: [wanaig/skillssss](https://github.com/wanaig/skillssss) — distributed by [TomeVault](https://tomevault.io).
