---
trigger: always_on
description: `spn` is a package manager and build tool for C projects in the style of UV or cargo. Key features:
---
...
---
> Source: [tspader/spn](https://github.com/tspader/spn) — distributed by [TomeVault](https://tomevault.io).
