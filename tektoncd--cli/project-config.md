---
trigger: always_on
description: Command-line client for [Tekton Pipelines](https://tekton.dev). Provides
---
...
---
> Source: [tektoncd/cli](https://github.com/tektoncd/cli) — distributed by [TomeVault](https://tomevault.io).
