---
trigger: always_on
description: - RepoBar is a macOS menubar app (SwiftUI + AppKit NSMenu) for GitHub repo status, activity, and local project state.
---
...
---
> Source: [steipete/RepoBar](https://github.com/steipete/RepoBar) — distributed by [TomeVault](https://tomevault.io).
