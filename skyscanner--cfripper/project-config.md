---
trigger: always_on
description: CFRipper is a library and CLI security analyzer for AWS CloudFormation templates.
---
...
---
> Source: [Skyscanner/cfripper](https://github.com/Skyscanner/cfripper) — distributed by [TomeVault](https://tomevault.io).
