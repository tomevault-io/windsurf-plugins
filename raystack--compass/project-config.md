---
trigger: always_on
description: Compass is a context engine that builds temporal knowledge graphs. Written in Go (1.25+), it uses PostgreSQL with pgvector, pg_trgm, and tsvector extensions. Single binary with no external dependencies beyond Postgres.
---
...
---
> Source: [raystack/compass](https://github.com/raystack/compass) — distributed by [TomeVault](https://tomevault.io).
