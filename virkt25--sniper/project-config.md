---
trigger: always_on
description: SNIPER v3 orchestrates Claude Code agent teams through protocol-driven phases. The human declares intent, the framework handles decomposition, delegation, and quality assurance.
---
...
---
> Source: [virkt25/sniper](https://github.com/virkt25/sniper) — distributed by [TomeVault](https://tomevault.io).
