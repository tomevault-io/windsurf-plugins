---
trigger: always_on
description: **IMPORTANT:** After making changes to Rust code in the `zkstack_cli` directory, you must rebuild zkstackup for the
---
...
---
> Source: [matter-labs/zksync-era](https://github.com/matter-labs/zksync-era) — distributed by [TomeVault](https://tomevault.io).
