---
trigger: always_on
description: Jenkins 的最佳实践是让 master 只做调度任务，其他的构建等任务的执行都放在 agent（计算节点）上运行。
---
...
---
> Source: [jenkins-zh/jenkins-cli](https://github.com/jenkins-zh/jenkins-cli) — distributed by [TomeVault](https://tomevault.io).
