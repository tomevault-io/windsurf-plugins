---
trigger: always_on
description: GenAIcode is a provider-neutral TypeScript LLM toolkit (a library), not a running
---
...
---
> Source: [gtanczyk/genaicode](https://github.com/gtanczyk/genaicode) — distributed by [TomeVault](https://tomevault.io).
