---
trigger: always_on
description: Canvas-rendered node-graph library (React Flow's API, Excalidraw's perf ceiling, TipTap's
---
...
---
> Source: [winlp4ever/canvas-harness](https://github.com/winlp4ever/canvas-harness) — distributed by [TomeVault](https://tomevault.io).
