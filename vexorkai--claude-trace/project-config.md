---
trigger: always_on
description: Zero-dependency Node.js CLI for Claude Code session cost analytics and efficiency analysis. Primary use: adding features, fixing output formatting, improving the analysis heuristics. Solo project.
---
...
---
> Source: [vexorkai/claude-trace](https://github.com/vexorkai/claude-trace) — distributed by [TomeVault](https://tomevault.io).
