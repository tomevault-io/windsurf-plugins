---
trigger: always_on
description: This document outlines the protocols, coding conventions, testing rules, and commit message standards for AI agents cooperating on the Amber Framework.
---
...
---
> Source: [amberframework/amber](https://github.com/amberframework/amber) — distributed by [TomeVault](https://tomevault.io).
