---
trigger: always_on
description: This guide covers best practices for contributing to the core Recursive Language Models `rlm` library and the `rlm_graph` extension. It covers developing new environments (in `rlm/environments/`), LM clients (in `rlm/clients/`), and graph tools.
---

This guide covers best practices for contributing to the core Recursive Language Models `rlm` library and the `rlm_graph` extension. It covers developing new environments (in `rlm/environments/`), LM clients (in `rlm/clients/`), and graph tools.
...
---
> Source: [omardimarzio/RLM-Graph](https://github.com/omardimarzio/RLM-Graph) — distributed by [TomeVault](https://tomevault.io).
