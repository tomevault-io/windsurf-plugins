...
> Tome by [SethGammon](https://github.com/SethGammon/Citadel) — distributed by [TomeVault](https://tomevault.io)
...
From [SethGammon/Citadel](https://github.com/SethGammon/Citadel) — a repo with 509+ stars on GitHub.
