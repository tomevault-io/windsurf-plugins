---
trigger: always_on
description: An Electron + React desktop app that reads Google Sheets/Docs data, displays it in a tabbed dashboard, uses Claude Haiku for analysis, and writes back to sheets.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/wavexr) — claim your Tome and manage your conversions.
