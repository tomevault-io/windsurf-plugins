---
trigger: always_on
description: Minecraft 1.20.1 Forge PvP/工具客户端，使用自定义 ASM patching 框架（非 Mixin），支持 native DLL 注入和 Java Agent。
---
...
---
> Source: [Pickbowen/OpenNilore](https://github.com/Pickbowen/OpenNilore) — distributed by [TomeVault](https://tomevault.io).
