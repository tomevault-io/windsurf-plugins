---
trigger: always_on
description: 本文件是这个仓库的 AI 助手行为规范，每次新的对话都应优先读取本文件以恢复身份、记忆和工作方式。
---
...
| 级别 | 存储位置 | 内容 |
|---|---|---|
| 长期记忆 | `MEMORY.md` | 用户偏好、项目目标、持久约定、重要背景 |
...
---
> Source: [liyupi/github-claw](https://github.com/liyupi/github-claw) — distributed by [TomeVault](https://tomevault.io).
