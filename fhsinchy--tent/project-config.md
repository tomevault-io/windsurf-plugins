---
trigger: always_on
description: One file per service. Each file exports a single `types.Service` variable.
---
...
---
> Source: [fhsinchy/tent](https://github.com/fhsinchy/tent) — distributed by [TomeVault](https://tomevault.io).
