---
trigger: always_on
description: - 项目描述：`一个基于flutter的粘贴板跨平台应用，支持 mac、windows、linux`
---
...
---
> Source: [DargonLee/easy_pasta](https://github.com/DargonLee/easy_pasta) — distributed by [TomeVault](https://tomevault.io).
