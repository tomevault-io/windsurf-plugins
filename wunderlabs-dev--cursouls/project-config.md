---
trigger: always_on
description: - Cursor-native rules are defined in `.cursor/rules/*.mdc`
---
...
---
> Source: [wunderlabs-dev/cursouls](https://github.com/wunderlabs-dev/cursouls) — distributed by [TomeVault](https://tomevault.io).
