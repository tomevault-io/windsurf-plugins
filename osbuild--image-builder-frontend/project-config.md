---
trigger: always_on
description: React/TypeScript frontend for Red Hat's Image Builder service, running on console.redhat.com as a federated micro-frontend. Also available as a Cockpit plugin for on-premises use.
---
...
---
> Source: [osbuild/image-builder-frontend](https://github.com/osbuild/image-builder-frontend) — distributed by [TomeVault](https://tomevault.io).
