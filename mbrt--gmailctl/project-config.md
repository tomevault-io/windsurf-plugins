---
trigger: always_on
description: gmailctl is a Go CLI tool for declarative Gmail filter management. It allows users to write filters in Jsonnet, validates them, generates diffs, and applies changes via Gmail API without manual XML imports.
---
...
---
> Source: [mbrt/gmailctl](https://github.com/mbrt/gmailctl) — distributed by [TomeVault](https://tomevault.io).
