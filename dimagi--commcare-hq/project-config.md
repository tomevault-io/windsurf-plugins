---
trigger: always_on
description: - **migrations.lock** — If you wrote a migration instead of generating one,
---
...
---
> Source: [dimagi/commcare-hq](https://github.com/dimagi/commcare-hq) — distributed by [TomeVault](https://tomevault.io).
