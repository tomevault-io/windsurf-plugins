---
trigger: always_on
description: 调度中心，是一款支持分布式定时任务调度，支持几千个任务同时调度。有着高性能、高可用（集群）、低延迟（0ms延迟）、低内存（45mb以内）等特点。
---
...
---
> Source: [farseers/FSchedule](https://github.com/farseers/FSchedule) — distributed by [TomeVault](https://tomevault.io).
