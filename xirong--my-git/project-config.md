---
trigger: always_on
description: 本仓库是面向现代工程团队与 AI 编程时代的双语 Git / GitHub 手册。欢迎用 AI 工具协助维护，约定如下。
---
...
---
> Source: [xirong/my-git](https://github.com/xirong/my-git) — distributed by [TomeVault](https://tomevault.io).
