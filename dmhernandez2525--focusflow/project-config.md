---
trigger: always_on
description: - NEVER run `npm install`, `yarn add`, `pnpm add`, `bun add`, or any package
---
...
---
> Source: [dmhernandez2525/FocusFlow](https://github.com/dmhernandez2525/FocusFlow) — distributed by [TomeVault](https://tomevault.io).
