---
trigger: always_on
description: 本文件记录本仓库的关键架构约定与发布流程，避免在 iOS Safari、缓存与版本化资源上反复踩坑。
---
...
---
> Source: [yym68686/Cerebr](https://github.com/yym68686/Cerebr) — distributed by [TomeVault](https://tomevault.io).
