---
trigger: always_on
description: Variant effect prediction (HGVS, VEP-compatible consequences) for VCF, in Rust. CLI + Rust library + REST server + Python bindings. Org `varfish-org`, license MIT.
---
