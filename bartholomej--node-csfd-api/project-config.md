---
trigger: always_on
description: This file serves as the primary context source for AI agents (Claude, Gemini, GPT) working on this repository.
---
...
---
> Source: [bartholomej/node-csfd-api](https://github.com/bartholomej/node-csfd-api) — distributed by [TomeVault](https://tomevault.io).
