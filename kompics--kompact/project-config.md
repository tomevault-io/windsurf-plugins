---
trigger: always_on
description: - Run repository-wide checks with `./run_checks.sh`.
---
...
---
> Source: [kompics/kompact](https://github.com/kompics/kompact) — distributed by [TomeVault](https://tomevault.io).
