---
trigger: always_on
description: 1. **Arquitectura y Reglas del Proyecto**: Lee `VOKTTY.md` antes de realizar cambios de código o diseño.
---
...
---
> Source: [voktty/voktty](https://github.com/voktty/voktty) — distributed by [TomeVault](https://tomevault.io).
