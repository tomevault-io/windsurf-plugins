---
trigger: always_on
description: Guidance for Claude Code (or any agent) working in this repo.
---
...
---
> Source: [btseee/mongolian-bank-exchange-rate](https://github.com/btseee/mongolian-bank-exchange-rate) — distributed by [TomeVault](https://tomevault.io).
