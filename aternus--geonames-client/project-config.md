---
trigger: always_on
description: 1. Always work from inside Docker for this repository.
---
...
---
> Source: [Aternus/geonames-client](https://github.com/Aternus/geonames-client) — distributed by [TomeVault](https://tomevault.io).
