...
Original source: `CLAUDE.md` in [noho/dayu-agent](https://github.com/noho/dayu-agent).
...
```
npx tomevault install noho/dayu-agent
```
Source: [github.com/noho/dayu-agent](https://github.com/noho/dayu-agent).
