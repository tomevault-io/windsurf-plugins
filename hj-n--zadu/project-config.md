---
trigger: always_on
description: A contributor may provide only a paper link and, when available, a reference
---
...
---
> Source: [hj-n/zadu](https://github.com/hj-n/zadu) — distributed by [TomeVault](https://tomevault.io).
