...
Original source: `.cursor/rules/*.mdc` in [RainbowRain9/HeartChat](https://github.com/RainbowRain9/HeartChat).
...
From [RainbowRain9/HeartChat](https://github.com/RainbowRain9/HeartChat) — a repo with 12+ stars on GitHub.
