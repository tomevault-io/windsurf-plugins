---
trigger: always_on
description: When preparing a release for this plugin:
---
...
---
> Source: [marijnbent/obsidian-print](https://github.com/marijnbent/obsidian-print) — distributed by [TomeVault](https://tomevault.io).
