---
trigger: always_on
description: - When generating new Dart code, strictly follow the style conventions defined in [Effective Dart](https://dart.dev/effective-dart).
---
...
---
> Source: [petitparser/dart-petitparser](https://github.com/petitparser/dart-petitparser) — distributed by [TomeVault](https://tomevault.io).
