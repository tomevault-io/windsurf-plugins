---
trigger: always_on
description: 本文档说明项目中使用的 AI 代理配置和提示词生成服务。
---
...
---
> Source: [yxhpy/comfy-prompt-studio](https://github.com/yxhpy/comfy-prompt-studio) — distributed by [TomeVault](https://tomevault.io).
