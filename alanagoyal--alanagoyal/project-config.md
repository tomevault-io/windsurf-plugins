---
trigger: always_on
description: macos desktop environment on the web. next.js, react, tailwind, supabase.
---
...
---
> Source: [alanagoyal/alanagoyal](https://github.com/alanagoyal/alanagoyal) — distributed by [TomeVault](https://tomevault.io).
