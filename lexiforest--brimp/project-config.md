---
trigger: always_on
description: Do not preserve backward compatibility. Remove obsolete paths instead of adding
---
...
and add each new capability on top of a product that already works. Never trade
...
---
> Source: [lexiforest/brimp](https://github.com/lexiforest/brimp) — distributed by [TomeVault](https://tomevault.io).
