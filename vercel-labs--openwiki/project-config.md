---
trigger: always_on
description: OpenWiki is a single Next.js app with Eve embedded through `withEve`:
---
...
---
> Source: [vercel-labs/openwiki](https://github.com/vercel-labs/openwiki) — distributed by [TomeVault](https://tomevault.io).
