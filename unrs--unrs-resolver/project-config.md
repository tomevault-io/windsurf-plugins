---
trigger: always_on
description: This document provides guidance for AI coding assistants (like GitHub Copilot, Cursor, Claude, etc.) when working with the unrs-resolver codebase.
---

# AI Agent Guidelines for unrs-resolver

This document provides guidance for AI coding assistants (like GitHub Copilot, Cursor, Claude, etc.) when working with the unrs-resolver codebase.

## Project Overview

unrs-resolver is a Rust port of webpack's enhanced-resolve, providing ESM and CommonJS module resolution. It offers both a Rust crate and Node.js bindings via NAPI.
...
```rust
use unrs_resolver::{ResolveOptions, Resolver};
...
use unrs_resolver::{ResolveError, ResolveErrorKind};
...
---
> Source: [unrs/unrs-resolver](https://github.com/unrs/unrs-resolver) — distributed by [TomeVault](https://tomevault.io).
