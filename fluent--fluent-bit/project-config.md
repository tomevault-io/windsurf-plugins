---
trigger: always_on
description: - Configure with tests: `cmake -S . -B build -DCFL_TESTS=On`
---
...
---
> Source: [fluent/fluent-bit](https://github.com/fluent/fluent-bit) — distributed by [TomeVault](https://tomevault.io).
