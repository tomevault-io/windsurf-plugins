---
trigger: always_on
description: Compiler (written in TypeScript) to transform BrighterScript (a superset of Roku's BrightScript) into valid BrightScript code.
---
...
---
> Source: [rokucommunity/brighterscript](https://github.com/rokucommunity/brighterscript) — distributed by [TomeVault](https://tomevault.io).
