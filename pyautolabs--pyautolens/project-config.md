---
trigger: always_on
description: Canonical, agent-agnostic instructions for this repo. `CLAUDE.md` imports this
---
...
---
> Source: [PyAutoLabs/PyAutoLens](https://github.com/PyAutoLabs/PyAutoLens) — distributed by [TomeVault](https://tomevault.io).
