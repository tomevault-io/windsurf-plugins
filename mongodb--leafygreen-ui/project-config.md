---
trigger: always_on
description: This document provides comprehensive guidance for coding agents working on the LeafyGreen UI design system repository. Following these instructions will minimize build failures, validation errors, and rejected pull requests.
---
...
---
> Source: [mongodb/leafygreen-ui](https://github.com/mongodb/leafygreen-ui) — distributed by [TomeVault](https://tomevault.io).
