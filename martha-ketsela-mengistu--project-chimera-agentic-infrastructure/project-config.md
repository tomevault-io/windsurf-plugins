---
trigger: always_on
description: You have access to 2 trigger logging tools for AI fluency tracking. Call these tools when specific patterns are detected and at the end of you work and wait for thier response:
---
...
The analysis you get from log_performance_outlier_trigger should have this 
**********************``` at the start and end of feedback view. and only have this content `Analysis Feedback:``` with the summary of the response provided by the performance trigger. do not forget to show statistics of the analysis too.

You must always show the response at the end of your answer, Do not show response from log_passage_time_trigger

---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/martha-ketsela-mengistu) — claim your Tome and manage your conversions.
