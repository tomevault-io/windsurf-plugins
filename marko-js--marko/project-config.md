---
trigger: always_on
description: Marko compiles `.marko` templates into optimized server (streaming HTML) and client (fine-grained DOM) JavaScript. npm workspaces; Node >= 22. Primary development happens in `packages/runtime-tags`.
---
