---
trigger: always_on
description: Python bindings for WPS Office RPC API (Linux only). Uses SIP to generate C++/Python bindings from `.sip` definition files, wrapping the WPS Office C++ SDK.
---
...
---
> Source: [timxx/pywpsrpc](https://github.com/timxx/pywpsrpc) — distributed by [TomeVault](https://tomevault.io).
