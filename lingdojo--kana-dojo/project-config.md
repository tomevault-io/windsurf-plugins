---
trigger: always_on
description: This file provides comprehensive guidance for AI coding assistants (GitHub Copilot, Claude, Kiro, Cursor, and other AI models) when working with the KanaDojo codebase.
---
...
---
> Source: [lingdojo/kana-dojo](https://github.com/lingdojo/kana-dojo) — distributed by [TomeVault](https://tomevault.io).
