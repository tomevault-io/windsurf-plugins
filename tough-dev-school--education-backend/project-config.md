---
trigger: always_on
description: - Ignore all typing errors if the code is a valid python
---
...
---
> Source: [tough-dev-school/education-backend](https://github.com/tough-dev-school/education-backend) — distributed by [TomeVault](https://tomevault.io).
