---
trigger: always_on
description: **Notable** is an Android note-taking app for **Onyx BOOX e-ink tablets** (Kotlin · Jetpack Compose · Hilt · Room · OpenGL canvas · minSdk 29). Performance and responsiveness are the top priorities.
---
