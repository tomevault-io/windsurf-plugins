---
trigger: always_on
description: Tangram is a build system and package manager that makes builds and tests fast and reliable.
---
...
---
> Source: [tangramdotdev/tangram](https://github.com/tangramdotdev/tangram) — distributed by [TomeVault](https://tomevault.io).
