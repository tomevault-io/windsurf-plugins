---
trigger: always_on
description: Rust port of the Fusion AHRS C library, maintaining algorithm parity while following Rust best practices.
---
...
---
> Source: [wboayue/fusion-ahrs](https://github.com/wboayue/fusion-ahrs) — distributed by [TomeVault](https://tomevault.io).
