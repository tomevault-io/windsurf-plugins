---
trigger: always_on
description: - `src/` hosts the training stack: `data/` loaders, `models/` architectures, `trainer/` implementations, `utils/` helpers, plus the entry point `main.py` for launching runs.
---
