---
trigger: always_on
description: Isolated VM environment for running Claude Code and Codex — Firecracker on
---
...
---
> Source: [trailofbits/coop](https://github.com/trailofbits/coop) — distributed by [TomeVault](https://tomevault.io).
