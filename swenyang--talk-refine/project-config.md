---
trigger: always_on
description: TalkRefine is a Windows desktop speech-to-text tool. It uses FunASR (SenseVoice) for ASR and optionally an LLM for text refinement. The app runs as a system tray icon with an overlay UI, launched via a VBS script at startup.
---
...
---
> Source: [swenyang/talk-refine](https://github.com/swenyang/talk-refine) — distributed by [TomeVault](https://tomevault.io).
