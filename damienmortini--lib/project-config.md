---
trigger: always_on
description: What the server does — [TypeScript served from `src/` behind the `dist/` URL][source]
---
...
---
> Source: [damienmortini/lib](https://github.com/damienmortini/lib) — distributed by [TomeVault](https://tomevault.io).
