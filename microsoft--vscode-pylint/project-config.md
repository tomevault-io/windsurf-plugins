---
trigger: always_on
description: - When introducing new functionality, add basic tests following the existing repo test structure.
---

# Copilot Instructions for vscode-pylint
...
- Always enable auto-merge (squash) on PRs after creating them: `gh pr merge <number> --repo microsoft/vscode-pylint --squash --auto`
- PRs require approval from someone other than the last pusher before merging.

---
> Source: [microsoft/vscode-pylint](https://github.com/microsoft/vscode-pylint) — distributed by [TomeVault](https://tomevault.io).
