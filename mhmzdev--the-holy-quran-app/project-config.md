---
trigger: always_on
description: Flutter app for reading the Qur'an (Uthmani script) fetched from the public [alquran.cloud](https://alquran.cloud/api) API and cached offline in Hive. Live on Google Play (`com.hmz.al_quran`, ~1k users). iOS is kept buildable but not shipped. Web build exists but is broken (out of scope until picked up).
---
...
---
> Source: [mhmzdev/the-holy-quran-app](https://github.com/mhmzdev/the-holy-quran-app) — distributed by [TomeVault](https://tomevault.io).
