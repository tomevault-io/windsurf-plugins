---
trigger: always_on
description: SxDevOps is split into `backend/` and `frontend/`.
---
...
---
> Source: [aiyiyi121/sxdevops](https://github.com/aiyiyi121/sxdevops) — distributed by [TomeVault](https://tomevault.io).
