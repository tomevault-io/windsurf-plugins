---
trigger: always_on
description: Activity Launcher is an Android application that launches hidden activities and creates shortcuts for installed apps. It is an open-source utility tool.
---
...
---
> Source: [ActivityLauncher/ActivityLauncher](https://github.com/ActivityLauncher/ActivityLauncher) — distributed by [TomeVault](https://tomevault.io).
