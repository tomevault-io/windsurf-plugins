---
trigger: always_on
description: This repository requires specific environment configuration to build and run .NET 9.0 projects. **All dependencies must be installed during the setup script phase,** especially in restricted environments (e.g., OpenAI Codex).
---
...
---
> Source: [EduardoPires/EquinoxProject](https://github.com/EduardoPires/EquinoxProject) — distributed by [TomeVault](https://tomevault.io).
