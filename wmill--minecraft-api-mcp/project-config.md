---
trigger: always_on
description: - Run Python commands from the relevant Python project with `uv run` so the correct environment is used.
---
...
---
> Source: [wmill/minecraft-api-mcp](https://github.com/wmill/minecraft-api-mcp) — distributed by [TomeVault](https://tomevault.io).
