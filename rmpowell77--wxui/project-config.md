---
trigger: always_on
description: - wxUI is a C++ header-only library that provides a declarative layer over wxWidgets. The public API is in `include/wxUI/*.hpp` and the INTERFACE target is declared in `CMakeLists.txt`.
---
...
---
> Source: [rmpowell77/wxUI](https://github.com/rmpowell77/wxUI) — distributed by [TomeVault](https://tomevault.io).
