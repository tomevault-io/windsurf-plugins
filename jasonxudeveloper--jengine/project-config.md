---
trigger: always_on
description: @.claude/rules/coding-patterns.md
---
...
---
> Source: [JasonXuDeveloper/JEngine](https://github.com/JasonXuDeveloper/JEngine) — distributed by [TomeVault](https://tomevault.io).
