---
trigger: always_on
description: - For questions, planning, tradeoff analysis, or brainstorming: do not edit files and do not run modifying commands. Read-only commands are allowed.
---
...
---
> Source: [drivendataorg/erdantic](https://github.com/drivendataorg/erdantic) — distributed by [TomeVault](https://tomevault.io).
