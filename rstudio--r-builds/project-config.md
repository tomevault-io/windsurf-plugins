---
trigger: always_on
description: r-builds compiles R from source for Linux distros using Docker. Each platform has a Dockerfile, package script, and test configuration. Portable builds (manylinux/musllinux) add a post-build portability layer via `delocate_r.py` + patchelf.
---
...
---
> Source: [rstudio/r-builds](https://github.com/rstudio/r-builds) — distributed by [TomeVault](https://tomevault.io).
