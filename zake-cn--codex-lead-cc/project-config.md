---
trigger: always_on
description: > Documentation only. The actual supervisor rules Codex loads are written to
---
...
---
> Source: [zake-cn/codex_lead_cc](https://github.com/zake-cn/codex_lead_cc) — distributed by [TomeVault](https://tomevault.io).
