---
trigger: always_on
description: 1.阅读这份pdf文档 将寄存器字段输出为markdown文件 参考格式如下（在这个参考格式的基础上为每个寄存器附带偏移地址和复位值的属性）：
---
...
---
> Source: [Left-Hand/Yumud](https://github.com/Left-Hand/Yumud) — distributed by [TomeVault](https://tomevault.io).
