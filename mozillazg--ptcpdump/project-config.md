---
trigger: always_on
description: ptcpdump is a tcpdump-compatible packet analyzer powered by eBPF that automatically annotates packets with process/container/pod metadata. It's written in Go and uses eBPF (Extended Berkeley Packet Filter) for kernel-space packet capture.
---
