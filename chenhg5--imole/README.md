...
Original source: `CLAUDE.md` in [chenhg5/imole](https://github.com/chenhg5/imole).
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/chenhg5/imole](https://github.com/chenhg5/imole)
