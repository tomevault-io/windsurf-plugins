---
trigger: always_on
description: This file is the single source of agent guidance for the `ai2cm/ace` repository.
---
...
---
> Source: [ai2cm/ace](https://github.com/ai2cm/ace) — distributed by [TomeVault](https://tomevault.io).
