---
trigger: always_on
description: This repository is the Go implementation of OpenTelemetry. Prefer changes that preserve specification compliance, API stability, and idiomatic Go over clever abstractions or broad refactors.
---
...
---
> Source: [open-telemetry/opentelemetry-go](https://github.com/open-telemetry/opentelemetry-go) — distributed by [TomeVault](https://tomevault.io).
