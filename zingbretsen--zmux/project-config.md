---
trigger: always_on
description: if you create/update/delete key bindings, always add them to the readme to keep it up to date
---
...
---
> Source: [zingbretsen/zmux](https://github.com/zingbretsen/zmux) — distributed by [TomeVault](https://tomevault.io).
