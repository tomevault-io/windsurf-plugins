---
trigger: always_on
description: `openapi-tui` is a terminal UI application for browsing and running APIs defined with OpenAPI v3.0/v3.1 specifications. Built with Rust using `ratatui` for the TUI layer and `tokio` for async runtime.
---
...
---
> Source: [zaghaghi/openapi-tui](https://github.com/zaghaghi/openapi-tui) — distributed by [TomeVault](https://tomevault.io).
