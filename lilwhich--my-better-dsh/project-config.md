---
trigger: always_on
description: 本仓库是 DeepSeek Harness（DSH）的插件聚合包。当用户请求「安装 my_better-dsh」、
---
...
---
> Source: [lilwhich/my_better-dsh](https://github.com/lilwhich/my_better-dsh) — distributed by [TomeVault](https://tomevault.io).
