---
trigger: always_on
description: Vitessce is a visual integration tool for exploration of spatial single-cell experiments, built as a React component library with WebGL visualization capabilities. This is a complex monorepo with specific architectural patterns that require understanding to be productive.
---
...
---
> Source: [vitessce/vitessce](https://github.com/vitessce/vitessce) — distributed by [TomeVault](https://tomevault.io).
