---
trigger: always_on
description: This file provides cookbook-specific instructions for Copilot and other AI coding assistants. It supplements, but does not duplicate, the general instructions in `.github/copilot-instructions.md`.
---
...
---
> Source: [sous-chefs/postgresql](https://github.com/sous-chefs/postgresql) — distributed by [TomeVault](https://tomevault.io).
