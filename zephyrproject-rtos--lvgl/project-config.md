---
trigger: always_on
description: - Every `lv_malloc` / `lv_realloc` must have a NULL check immediately after
---
...
---
> Source: [zephyrproject-rtos/lvgl](https://github.com/zephyrproject-rtos/lvgl) — distributed by [TomeVault](https://tomevault.io).
