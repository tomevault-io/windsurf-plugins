---
trigger: always_on
description: This is the Azure App Configuration .NET Provider codebase. The service abides by coding guidelines specified in the `github/code-gen-instructions.md` file.
---
...
---
> Source: [Azure/AppConfiguration-DotnetProvider](https://github.com/Azure/AppConfiguration-DotnetProvider) — distributed by [TomeVault](https://tomevault.io).
