---
trigger: always_on
description: - **`source/`** — development directory. Contains both implementations (`.js`) and tests (`.spec.js`, `-spec.ts`).
---
...
---
> Source: [selfrefactor/rambda](https://github.com/selfrefactor/rambda) — distributed by [TomeVault](https://tomevault.io).
