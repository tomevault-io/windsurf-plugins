---
trigger: always_on
description: Rust crate for working with the BSON format.
---
...
---
> Source: [mongodb/bson-rust](https://github.com/mongodb/bson-rust) — distributed by [TomeVault](https://tomevault.io).
