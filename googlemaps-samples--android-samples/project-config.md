---
trigger: always_on
description: Guidance for AI coding agents working on this repository. For human contribution
---
...
---
> Source: [googlemaps-samples/android-samples](https://github.com/googlemaps-samples/android-samples) — distributed by [TomeVault](https://tomevault.io).
