---
trigger: always_on
description: Healthcare patient census/urology rounding platform. Single-page HTML app with Firebase Firestore real-time sync. Mobile-first adaptive UI, no build system. See compliance roadmap in `.kiro/specs/healthcare-compliance/{requirements,design,tasks}.md`.
---
...
---
> Source: [art1907/Clinical-Roundup-List](https://github.com/art1907/Clinical-Roundup-List) — distributed by [TomeVault](https://tomevault.io).
