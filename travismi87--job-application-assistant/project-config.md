---
trigger: always_on
description: When asked to generate a commit message for staged changes, your goal is to create a message that is clean, logical, and tells the story of the change. Adhere to the following process:
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/travismi87) — claim your Tome and manage your conversions.
