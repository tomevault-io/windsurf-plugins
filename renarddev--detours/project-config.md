---
trigger: always_on
description: Always follow [CODE_STYLE_GUIDE.md](CODE_STYLE_GUIDE.md) when generating, modifying, refactoring, or reviewing code in this repository.
---
...
---
> Source: [RenardDev/Detours](https://github.com/RenardDev/Detours) — distributed by [TomeVault](https://tomevault.io).
