---
trigger: always_on
description: - **Andromeda** = open-source non-Material Jetpack Compose design system library
---
...
---
> Source: [aldefy/Andromeda](https://github.com/aldefy/Andromeda) — distributed by [TomeVault](https://tomevault.io).
