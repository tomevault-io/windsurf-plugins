---
trigger: always_on
description: - Go backend using Chi v5 router, gonertia v2 for Inertia SSR, pgx v5 for PostgreSQL
---
...
---
> Source: [angristan/larafeed](https://github.com/angristan/larafeed) — distributed by [TomeVault](https://tomevault.io).
