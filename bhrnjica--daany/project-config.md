---
trigger: always_on
description: Daany is a .NET 7.0+ data analytics library with DataFrame, time series decomposition, and linear algebra capabilities. The project includes C# components with Rust native libraries for performance-critical operations.
---
...
---
> Source: [bhrnjica/daany](https://github.com/bhrnjica/daany) — distributed by [TomeVault](https://tomevault.io).
