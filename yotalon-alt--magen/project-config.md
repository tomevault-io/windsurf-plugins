---
trigger: always_on
description: <!-- Copilot/AI agent instructions for this Flutter feedback system -->
---
...
---
> Source: [yotalon-alt/magen](https://github.com/yotalon-alt/magen) — distributed by [TomeVault](https://tomevault.io).
