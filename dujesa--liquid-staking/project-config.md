---
trigger: always_on
description: This file provides instructions for AI coding assistants (like Claude Code, GitHub Copilot, etc.) working with students in this course.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/dujesa)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/dujesa)
