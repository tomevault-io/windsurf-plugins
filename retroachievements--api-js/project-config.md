---
trigger: always_on
description: - `pnpm dev` - Watch mode for playground file development
---
...
---
> Source: [RetroAchievements/api-js](https://github.com/RetroAchievements/api-js) — distributed by [TomeVault](https://tomevault.io).
