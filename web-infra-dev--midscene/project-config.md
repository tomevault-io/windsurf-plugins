---
trigger: always_on
description: Canonical instructions for coding agents in this repository. `CLAUDE.md`
---
...
---
> Source: [web-infra-dev/midscene](https://github.com/web-infra-dev/midscene) — distributed by [TomeVault](https://tomevault.io).
