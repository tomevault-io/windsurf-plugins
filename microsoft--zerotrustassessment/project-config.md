---
trigger: always_on
description: The **Zero Trust Assessment** PowerShell module runs tenant assessments and generates
---
...
---
> Source: [microsoft/zerotrustassessment](https://github.com/microsoft/zerotrustassessment) — distributed by [TomeVault](https://tomevault.io).
