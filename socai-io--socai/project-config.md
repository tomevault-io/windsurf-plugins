---
trigger: always_on
description: The repo has a Rust core (`core/`), a Rust CLI (`cli/`), and a Tauri 2 desktop
---
...
---
> Source: [socai-io/socai](https://github.com/socai-io/socai) — distributed by [TomeVault](https://tomevault.io).
