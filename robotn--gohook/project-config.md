---
trigger: always_on
description: Cross-platform global keyboard and mouse hook library for Go. A cgo wrapper around
---
...
---
> Source: [robotn/gohook](https://github.com/robotn/gohook) — distributed by [TomeVault](https://tomevault.io).
