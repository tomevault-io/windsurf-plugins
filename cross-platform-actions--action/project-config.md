---
trigger: always_on
description: This repo is a TypeScript GitHub Action (Node 20 runtime) that boots a VM and
---
...
---
> Source: [cross-platform-actions/action](https://github.com/cross-platform-actions/action) — distributed by [TomeVault](https://tomevault.io).
