---
trigger: always_on
description: Magnolia is a Rust CLI tool that enables developers to run GitLab CI, GitHub Actions, and Forgejo/Gitea Actions pipelines locally. This helps developers test their CI/CD configurations before pushing to remote repositories.
---
