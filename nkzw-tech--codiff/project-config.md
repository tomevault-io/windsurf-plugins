---
trigger: always_on
description: - At the end of every code change, run `vpr build` so the built files are refreshed for local testing.
---
...
---
> Source: [nkzw-tech/codiff](https://github.com/nkzw-tech/codiff) — distributed by [TomeVault](https://tomevault.io).
