---
trigger: always_on
description: - **Build**: `cmake . && make` (CMake >= 3.5.0)
---
...
---
> Source: [neural75/gqrx-scanner](https://github.com/neural75/gqrx-scanner) — distributed by [TomeVault](https://tomevault.io).
