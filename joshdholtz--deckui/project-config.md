---
trigger: always_on
description: DeckUI is a Swift DSL for creating slide decks/presentations entirely in Swift code within Xcode. It uses SwiftUI and supports macOS 12+ and iOS 15+.
---
...
---
> Source: [joshdholtz/DeckUI](https://github.com/joshdholtz/DeckUI) — distributed by [TomeVault](https://tomevault.io).
