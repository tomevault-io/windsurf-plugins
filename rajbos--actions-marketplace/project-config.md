---
trigger: always_on
description: When adding new static HTML pages or JavaScript files to the marketplace:
---
...
---
> Source: [rajbos/actions-marketplace](https://github.com/rajbos/actions-marketplace) — distributed by [TomeVault](https://tomevault.io).
