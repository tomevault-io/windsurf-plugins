---
trigger: always_on
description: This is a Kratos service template. This file owns the layering contract
---
...
---
> Source: [omalloc/probecube-agent](https://github.com/omalloc/probecube-agent) — distributed by [TomeVault](https://tomevault.io).
