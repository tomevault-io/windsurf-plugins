---
trigger: always_on
description: These instructions apply to the entire `pydap` repository.
---
...
---
> Source: [pydap/pydap](https://github.com/pydap/pydap) — distributed by [TomeVault](https://tomevault.io).
