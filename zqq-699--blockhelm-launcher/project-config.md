---
trigger: always_on
description: 本文档是 `launcher` 工作区的开发约定。所有 Codex、自动化代理和后续开发者在修改代码前必须阅读并遵守。
---
...
---
> Source: [zqq-699/BlockHelm-Launcher](https://github.com/zqq-699/BlockHelm-Launcher) — distributed by [TomeVault](https://tomevault.io).
