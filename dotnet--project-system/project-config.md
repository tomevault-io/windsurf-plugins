---
trigger: always_on
description: The .NET Project System for Visual Studio is a Windows-based Visual Studio extension project built with C#, VB.NET, MSBuild, and the Common Project System (CPS) framework. This supports SDK-style .NET (C#, F#, and Visual Basic) and Shared Projects project types.
---
...
---
> Source: [dotnet/project-system](https://github.com/dotnet/project-system) — distributed by [TomeVault](https://tomevault.io).
