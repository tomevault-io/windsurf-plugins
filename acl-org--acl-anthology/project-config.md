---
trigger: always_on
description: - Only use **public API** methods from the `acl_anthology` library. Never call private methods (those starting with `_`).
---
...
---
> Source: [acl-org/acl-anthology](https://github.com/acl-org/acl-anthology) — distributed by [TomeVault](https://tomevault.io).
