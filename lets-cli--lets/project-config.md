---
trigger: always_on
description: Use `lets` task runner for all build/test/lint operations instead of raw commands. Run `lets build` first if binary is missing.
---
...
---
> Source: [lets-cli/lets](https://github.com/lets-cli/lets) — distributed by [TomeVault](https://tomevault.io).
