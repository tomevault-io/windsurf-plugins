---
trigger: always_on
description: YouTube playback engine. Embeds the YouTube IFrame Player API, maps its state to `IframeMediaSurface`, and registers as a `media-engine` plugin with `priority = 100` (overrides HLS and DefaultMediaEngine for YouTube URLs).
---
...
---
> Source: [openplayerjs/openplayerjs](https://github.com/openplayerjs/openplayerjs) — distributed by [TomeVault](https://tomevault.io).
