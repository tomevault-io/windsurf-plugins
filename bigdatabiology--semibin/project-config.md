---
trigger: always_on
description: SemiBin is a metagenomic binning tool that uses siamese neural networks (PyTorch) to cluster contigs from metagenomic assemblies into genome bins. It supports both self-supervised (SemiBin2, default) and semi-supervised learning modes, with pre-trained models for 11 environments.
---
...
---
> Source: [BigDataBiology/SemiBin](https://github.com/BigDataBiology/SemiBin) — distributed by [TomeVault](https://tomevault.io).
