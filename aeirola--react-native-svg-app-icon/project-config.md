---
trigger: always_on
description: The cache enables incremental builds by tracking hashes of input and output files across runs. `CacheSession` is created per generation run with the input file buffers and a `force` flag.
---
