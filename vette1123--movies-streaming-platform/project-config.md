...
- **Two-tier incremental cache** (`open-next.config.ts`): L1 regional cache (Cloudflare Cache API, free, no quota) absorbs most reads; L2 KV (1k writes/day, 100k reads/day) only on L1 miss. All KV errors are swallowed → degrade to stale/live render, never a 5xx.
...
---
> Source: [Vette1123/movies-streaming-platform](https://github.com/Vette1123/movies-streaming-platform) — distributed by [TomeVault](https://tomevault.io).
