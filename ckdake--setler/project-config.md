---
trigger: always_on
description: This file gives coding agents the context they need to work in the Setler repo. Follow every
---
...
---
> Source: [ckdake/setler](https://github.com/ckdake/setler) — distributed by [TomeVault](https://tomevault.io).
