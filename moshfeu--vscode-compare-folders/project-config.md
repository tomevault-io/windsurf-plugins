---
trigger: always_on
description: - **Build**: `yarn compile`
---
...
---
> Source: [moshfeu/vscode-compare-folders](https://github.com/moshfeu/vscode-compare-folders) — distributed by [TomeVault](https://tomevault.io).
