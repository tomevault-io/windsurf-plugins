---
trigger: always_on
description: BoxRun is a local VM execution platform built on BoxLite. This is the Rust rewrite providing a single binary (server + CLI), a Rust SDK crate, and full API compatibility with the Python version.
---
