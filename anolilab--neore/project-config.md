---
trigger: always_on
description: - ALWAYS use the new function syntax for Convex functions. For example:
---
...
---
> Source: [anolilab/neore](https://github.com/anolilab/neore) — distributed by [TomeVault](https://tomevault.io).
