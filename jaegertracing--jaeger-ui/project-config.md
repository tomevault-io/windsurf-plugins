---
trigger: always_on
description: Prefer silence over uncertainty. A review comment has a cost — it demands the author's attention, may trigger another round, and can obscure the comments that actually matter. Only post a comment when you are confident the issue is real and material.
---
...
---
> Source: [jaegertracing/jaeger-ui](https://github.com/jaegertracing/jaeger-ui) — distributed by [TomeVault](https://tomevault.io).
