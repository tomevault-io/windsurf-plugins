---
trigger: always_on
description: This file provides operational guidance to Claude Code when working with the `jsonrepair` package.
---
...
---
> Source: [kaptinlin/jsonrepair](https://github.com/kaptinlin/jsonrepair) — distributed by [TomeVault](https://tomevault.io).
