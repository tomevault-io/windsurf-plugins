...
- This particular project is TypeScript (Node.js) Azure Function using the v4 programming model
...
---
> Source: [Azure-Samples/remote-mcp-functions-typescript](https://github.com/Azure-Samples/remote-mcp-functions-typescript) — distributed by [TomeVault](https://tomevault.io).
