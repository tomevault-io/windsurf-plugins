---
trigger: always_on
description: Modern, secure implementation of JoinMarket components using Python 3.14+, Pydantic v2, and AsyncIO.
---
...
---
> Source: [joinmarket-ng/joinmarket-ng](https://github.com/joinmarket-ng/joinmarket-ng) — distributed by [TomeVault](https://tomevault.io).
