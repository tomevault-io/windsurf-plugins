---
trigger: always_on
description: This file exists so automated contributors (Copilot agents, bots, scripts) follow the same guardrails as human maintainers when working in `hoverkraft-tech/compose-action`. It summarizes what to read, which commands to run, and what is out of scope for agents.
---
...
---
> Source: [hoverkraft-tech/compose-action](https://github.com/hoverkraft-tech/compose-action) — distributed by [TomeVault](https://tomevault.io).
