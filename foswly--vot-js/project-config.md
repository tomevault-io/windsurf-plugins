---
trigger: always_on
description: - Use Bun (`bun.lock` is the root lockfile): `bun install`.
---
...
---
> Source: [FOSWLY/vot.js](https://github.com/FOSWLY/vot.js) — distributed by [TomeVault](https://tomevault.io).
