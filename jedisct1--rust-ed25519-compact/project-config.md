---
trigger: always_on
description: - `src/lib.rs` is the crate root; core modules live in `src/` (e.g., `ed25519.rs`, `x25519.rs`, `field25519.rs`, `edwards25519.rs`, `pem.rs`, `sha512.rs`).
---
...
---
> Source: [jedisct1/rust-ed25519-compact](https://github.com/jedisct1/rust-ed25519-compact) — distributed by [TomeVault](https://tomevault.io).
