...
Original source: `AGENTS.md` in [agent-receipts/ar](https://github.com/agent-receipts/ar).
...
Available for 6 platforms including Claude Code, Cursor, Windsurf, and more. Source: [github.com/agent-receipts/ar](https://github.com/agent-receipts/ar)
