---
trigger: always_on
description: 1. **禁止硬编码颜色值**：所有 UI 组件中的颜色必须使用 `ui.CurrentTheme` 中定义的主题色，不得直接使用 `lipgloss.Color("#XXXXXX")` 硬编码颜色。
---
...
---
> Source: [six-ddc/v2ex-tui](https://github.com/six-ddc/v2ex-tui) — distributed by [TomeVault](https://tomevault.io).
