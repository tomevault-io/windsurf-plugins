...
> Tome by [rmdes](https://github.com/rmdes/rsc), graded and kept true across every major AI platform by [TomeVault](https://tomevault.io)
...
From [rmdes/rsc](https://github.com/rmdes/rsc) — a repo with 7+ stars on GitHub.

---

Install this config instantly:
```
npx tomevault install rmdes/rsc
```
Source: [github.com/rmdes/rsc](https://github.com/rmdes/rsc).
