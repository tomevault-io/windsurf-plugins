---
trigger: always_on
description: CoolQBot 是一个基于 [NoneBot2](https://nonebot.dev/) 的多平台聊天机器人，采用模块化的插件架构。它支持 QQ、Discord、Telegram、DoDo、Kaiheila、OneBot V12、Red 和 Satori 等多个平台。主要功能包括复读、签到、天气查询、游戏信息查询等。
---
...
---
> Source: [he0119/CoolQBot](https://github.com/he0119/CoolQBot) — distributed by [TomeVault](https://tomevault.io).
