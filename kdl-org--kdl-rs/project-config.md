---
trigger: always_on
description: KDL is pronounced "cuddle". You must not pronounce it any other way.
---
...
---
> Source: [kdl-org/kdl-rs](https://github.com/kdl-org/kdl-rs) — distributed by [TomeVault](https://tomevault.io).
