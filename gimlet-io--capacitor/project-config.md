---
trigger: always_on
description: - **Build**: `make build` (frontend + Go backend), `deno task build` (frontend only)
---
...
---
> Source: [gimlet-io/capacitor](https://github.com/gimlet-io/capacitor) — distributed by [TomeVault](https://tomevault.io).
