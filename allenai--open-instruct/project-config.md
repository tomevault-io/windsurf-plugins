---
trigger: always_on
description: - `uv run pytest`: Run the tests.
---
...
---
> Source: [allenai/open-instruct](https://github.com/allenai/open-instruct) — distributed by [TomeVault](https://tomevault.io).
