---
trigger: always_on
description: | Install dependencies | `make setup` |
---
...
---
> Source: [mongodb/mongodb-atlas-cli](https://github.com/mongodb/mongodb-atlas-cli) — distributed by [TomeVault](https://tomevault.io).
