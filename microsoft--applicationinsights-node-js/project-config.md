---
trigger: always_on
description: These instructions help GitHub Copilot generate code that aligns with our team's standards and avoids common issues in JavaScript and TypeScript development.
---
...
---
> Source: [microsoft/ApplicationInsights-node.js](https://github.com/microsoft/ApplicationInsights-node.js) — distributed by [TomeVault](https://tomevault.io).
