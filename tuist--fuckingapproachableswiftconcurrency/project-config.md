---
trigger: always_on
description: **Fucking Approachable Swift Concurrency** is a multilingual static documentation website that teaches Swift concurrency concepts using clear mental models and the "Office Building" analogy. Built with [Eleventy (11ty)](https://www.11ty.dev/).
---
...
---
> Source: [tuist/fuckingapproachableswiftconcurrency](https://github.com/tuist/fuckingapproachableswiftconcurrency) — distributed by [TomeVault](https://tomevault.io).
