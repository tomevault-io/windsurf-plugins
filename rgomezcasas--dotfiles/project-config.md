---
trigger: always_on
description: Refer to the `docs/` folder for detailed guides:
---
...
---
> Source: [rgomezcasas/dotfiles](https://github.com/rgomezcasas/dotfiles) — distributed by [TomeVault](https://tomevault.io).
