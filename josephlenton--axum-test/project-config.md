---
trigger: always_on
description: `axum-test` is a Rust library for easy end-to-end (E2E) testing of Axum web applications. It supports REST APIs, WebSockets, and multiple content types (JSON, YAML, MessagePack, multipart forms).
---
...
---
> Source: [JosephLenton/axum-test](https://github.com/JosephLenton/axum-test) — distributed by [TomeVault](https://tomevault.io).
