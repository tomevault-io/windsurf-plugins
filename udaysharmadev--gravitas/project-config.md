---
trigger: always_on
description: When executing coding tasks, follow the GRAVITAS skill loaded from `skills/gravitas/SKILL.md`.
---
...
---
> Source: [udaysharmadev/Gravitas](https://github.com/udaysharmadev/Gravitas) — distributed by [TomeVault](https://tomevault.io).
