---
trigger: always_on
description: Concise rules for building accessible, fast, delightful UIs
---


## Resource Map

Before building UI, consult these resources:

| Need | Resource |
|------|----------|
| Design context | Run `teach-impeccable` command |
| Aesthetic direction | `frontend-design` skill |
| Master workflow | `workflow` rule |
| Visual techniques | `/docs/` best practices |
| Extension patterns | `/patterns/extension.md` (Enhancement Mode) |
| Elevation guide | `/patterns/elevation.md` |
| DRY principles | `/patterns/composition.md` (Standalone Mode) |
| Theme architecture | `/patterns/theming.md` (Standalone Mode) |
| Design tokens | `/tokens/` directory (Standalone Mode) |
| Quality verification | `ui-checklist.md`, `rams` command |
...
---
> Source: [jshmllr/tokyn](https://github.com/jshmllr/tokyn) — distributed by [TomeVault](https://tomevault.io).
