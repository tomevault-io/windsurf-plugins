---
trigger: always_on
description: - Yarn Classic (`yarn.lock` v1) — use `yarn`, not npm. `yarn install --frozen-lockfile` on CI.
---
...
---
> Source: [gmsgowtham/react-native-marked](https://github.com/gmsgowtham/react-native-marked) — distributed by [TomeVault](https://tomevault.io).
