---
trigger: always_on
description: - Run all tests: `rake test` or `rake`
---
...
---
> Source: [whomwah/rqrcode_core](https://github.com/whomwah/rqrcode_core) — distributed by [TomeVault](https://tomevault.io).
