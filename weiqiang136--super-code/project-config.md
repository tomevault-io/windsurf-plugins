---
trigger: always_on
description: 本文件给 super-code（以及其它 AI 编码助手）在本仓库中工作时提供必要上下文。
---
...
---
> Source: [weiqiang136/super-code](https://github.com/weiqiang136/super-code) — distributed by [TomeVault](https://tomevault.io).
