---
trigger: always_on
description: - Use Python 3.10+ type hints (prefer `x | y` over `Union[x, y]`)
---
...
---
> Source: [siapy/siapy-lib](https://github.com/siapy/siapy-lib) — distributed by [TomeVault](https://tomevault.io).
