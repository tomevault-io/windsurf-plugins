---
trigger: always_on
description: This plugin integrates Slack with Ai tools, providing tools to search, read, and send messages in Slack. It also offers useful skills for users and developers.
---
...
---
> Source: [slackapi/slack-skills-plugin](https://github.com/slackapi/slack-skills-plugin) — distributed by [TomeVault](https://tomevault.io).
