---
trigger: always_on
description: **MailDev 3.0** is a mail server + web UI for viewing and testing email during
---
...
---
> Source: [maildev/maildev](https://github.com/maildev/maildev) — distributed by [TomeVault](https://tomevault.io).
