---
trigger: always_on
description: Pure-JS W3C Web Audio API. 100% WPT (4300/4300). The spec is the soul — never diverge.
---
...
---
> Source: [audiojs/web-audio-api](https://github.com/audiojs/web-audio-api) — distributed by [TomeVault](https://tomevault.io).
