---
trigger: always_on
description: Guidance for AI assistants working in this repo. For full contributor etiquette (issues, PR process, forking), see `CONTRIBUTING.md`; for maintainer-only tasks, see `MAINTAINING.md`.
---
...
---
> Source: [lightly-ai/lightly](https://github.com/lightly-ai/lightly) — distributed by [TomeVault](https://tomevault.io).
