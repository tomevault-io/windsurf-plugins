---
trigger: always_on
description: - Use `make help` to find available development targets
---
...
---
> Source: [go-gitea/gitea](https://github.com/go-gitea/gitea) — distributed by [TomeVault](https://tomevault.io).
