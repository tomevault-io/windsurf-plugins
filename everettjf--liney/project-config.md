---
trigger: always_on
description: Liney is a native macOS terminal workspace app built around `AppKit + SwiftUI + a vendored Ghostty runtime`.
---
...
---
> Source: [everettjf/liney](https://github.com/everettjf/liney) — distributed by [TomeVault](https://tomevault.io).
