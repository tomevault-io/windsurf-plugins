---
trigger: always_on
description: This file provides guidance to AI coding agents when working with code in this repository. `CLAUDE.md` is symlinked to this file.
---

# AGENTS.md

This file provides guidance to AI coding agents when working with code in this repository. `CLAUDE.md` is symlinked to this file.

For local/personal notes, use `AGENTS.local.md` (gitignored). `CLAUDE.local.md` is symlinked to it.
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/hankhsu1996)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/hankhsu1996)
