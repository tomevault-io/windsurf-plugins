---
trigger: always_on
description: Guidance for Claude Code when working in this layer.
---
...
---
> Source: [binbashar/le-tf-infra-aws](https://github.com/binbashar/le-tf-infra-aws) — distributed by [TomeVault](https://tomevault.io).
