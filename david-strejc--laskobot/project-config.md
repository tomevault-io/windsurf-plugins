---
trigger: always_on
description: **ALWAYS USE THIS FOR DEPLOYMENT:** `./scripts/deploy`
---
...
---
> Source: [david-strejc/laskobot](https://github.com/david-strejc/laskobot) — distributed by [TomeVault](https://tomevault.io).
