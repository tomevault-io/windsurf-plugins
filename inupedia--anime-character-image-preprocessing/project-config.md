---
trigger: always_on
description: Python tool for anime character image preprocessing (background removal, cropping, tagging, renaming). Supports both CLI (`python main.py <command>`) and Gradio web UI (`python app.py`).
---
...
---
> Source: [Inupedia/anime-character-image-preprocessing](https://github.com/Inupedia/anime-character-image-preprocessing) — distributed by [TomeVault](https://tomevault.io).
