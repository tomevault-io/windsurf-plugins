...
---
> Source: [JulienKode/pull-request-name-linter-action](https://github.com/JulienKode/pull-request-name-linter-action) — distributed by [TomeVault](https://tomevault.io).
