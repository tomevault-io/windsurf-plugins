---
trigger: always_on
description: Currently Havens can be setup to use with or without agents on child nodes. However, whenever possible, we recommend using the agent image for additional stats to be sent back to the server.
---
...
---
> Source: [codeabovelab/haven-platform](https://github.com/codeabovelab/haven-platform) — distributed by [TomeVault](https://tomevault.io).
