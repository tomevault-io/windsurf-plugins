---
trigger: always_on
description: - **ARCHITECTURE-MAP.md** — living navigation map of the codebase (domain ownership, dependencies, hot spots, anti-regression contracts). Read it before starting any task so you work from the real structure, not assumptions.
---
...
---
> Source: [ltmoerdani/opencode-copilot-chat](https://github.com/ltmoerdani/opencode-copilot-chat) — distributed by [TomeVault](https://tomevault.io).
