...
Original source: `CLAUDE.md` in [eqtylab/cupcake](https://github.com/eqtylab/cupcake).
...
```
npx tomevault install eqtylab/cupcake
```
Source: [github.com/eqtylab/cupcake](https://github.com/eqtylab/cupcake).
