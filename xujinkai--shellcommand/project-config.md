---
trigger: always_on
description: ShellCommand 11 是一个面向 Windows 11 的轻量右键菜单工具，产品版本为 **11.0.0**。
---
...
---
> Source: [XUJINKAI/ShellCommand](https://github.com/XUJINKAI/ShellCommand) — distributed by [TomeVault](https://tomevault.io).
