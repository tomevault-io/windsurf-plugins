...
---
> Source: [MichelKerkmeester/skilled-harness__spec-driven-agent-loops](https://github.com/MichelKerkmeester/skilled-harness__spec-driven-agent-loops) — distributed by [TomeVault](https://tomevault.io).
