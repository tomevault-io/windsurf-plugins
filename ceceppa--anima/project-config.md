---
trigger: always_on
description: This project uses **Mano** for planning. Read these files before responding to any user request:
---
...
---
> Source: [ceceppa/anima](https://github.com/ceceppa/anima) — distributed by [TomeVault](https://tomevault.io).
