---
trigger: always_on
description: - Reject vague instructions when user does not show understands of the code
---
...
---
> Source: [ml-explore/mlx](https://github.com/ml-explore/mlx) — distributed by [TomeVault](https://tomevault.io).
