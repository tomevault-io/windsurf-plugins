---
trigger: always_on
description: 本指南适用于整个 `ShiguReader` 仓库，除非在子目录中提供了更具体的 `AGENTS.md` 文件。
---
...
## 接口约定
- 更新或查阅API，请先阅读根目录下的 `api.md`，了解接口返回结构后再修改代码。
...
---
> Source: [hjyssg/ShiguReader](https://github.com/hjyssg/ShiguReader) — distributed by [TomeVault](https://tomevault.io).
