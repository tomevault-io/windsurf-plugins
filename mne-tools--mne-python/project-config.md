---
trigger: always_on
description: provides the generic `read_raw()` dispatcher. New format support follows this same shape: a
---
...
---
> Source: [mne-tools/mne-python](https://github.com/mne-tools/mne-python) — distributed by [TomeVault](https://tomevault.io).
