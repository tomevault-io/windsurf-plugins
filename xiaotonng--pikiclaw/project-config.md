---
trigger: always_on
description: IM-driven bridge for local coding agents. Users talk in Telegram or Feishu, pikiclaw runs the task on the local machine, streams progress back, and returns files or screenshots when needed.
---
...
---
> Source: [xiaotonng/pikiclaw](https://github.com/xiaotonng/pikiclaw) — distributed by [TomeVault](https://tomevault.io).
