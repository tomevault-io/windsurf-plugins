...
> Tome by [leonardsellem](https://github.com/leonardsellem/readwise-vector-db) — distributed by [TomeVault](https://tomevault.io)
...
Original source: `CLAUDE.md` in [leonardsellem/readwise-vector-db](https://github.com/leonardsellem/readwise-vector-db).
