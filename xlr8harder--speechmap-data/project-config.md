---
trigger: always_on
description: This repository owns canonical SpeechMap response data and production
---
...
---
> Source: [xlr8harder/speechmap-data](https://github.com/xlr8harder/speechmap-data) — distributed by [TomeVault](https://tomevault.io).
