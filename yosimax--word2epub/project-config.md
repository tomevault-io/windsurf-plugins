---
trigger: always_on
description: このファイルは、GitHub CopilotやAIアシスタント、開発者がプロジェクトの構造・コーディング規約・命名規則を理解し、一貫したスタイルでコード生成・修正を行うためのガイドです。
---
...
---
> Source: [yosimax/word2epub](https://github.com/yosimax/word2epub) — distributed by [TomeVault](https://tomevault.io).
