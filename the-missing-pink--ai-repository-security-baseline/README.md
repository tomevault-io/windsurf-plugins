...
Original source: `copilot-instructions.md` in [the-missing-pink/ai-repository-security-baseline](https://github.com/the-missing-pink/ai-repository-security-baseline).
...
From [the-missing-pink/ai-repository-security-baseline](https://github.com/the-missing-pink/ai-repository-security-baseline) — a repo with 8+ stars on GitHub.
