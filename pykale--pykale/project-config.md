---
trigger: always_on
description: This file guides automated reviewers (Codex) and humans reviewing pull requests. Keep feedback low-noise, friendly, and focused on what blocks a merge. Follow the tone of the contributing guide and the pull request template.
---
...
---
> Source: [pykale/pykale](https://github.com/pykale/pykale) — distributed by [TomeVault](https://tomevault.io).
