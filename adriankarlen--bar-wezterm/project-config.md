---
trigger: always_on
description: Guidelines for agentic coding assistants working in this repository.
---
...
---
> Source: [adriankarlen/bar.wezterm](https://github.com/adriankarlen/bar.wezterm) — distributed by [TomeVault](https://tomevault.io).
