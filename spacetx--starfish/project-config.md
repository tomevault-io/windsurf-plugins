---
trigger: always_on
description: **starfish** is a Python library for processing images of image-based spatial transcriptomics. It provides scalable pipelines that localize and quantify RNA transcripts in image data generated by any FISH method, from simple RNA single-molecule FISH to combinatorial barcoded assays.
---
...
---
> Source: [spacetx/starfish](https://github.com/spacetx/starfish) — distributed by [TomeVault](https://tomevault.io).
