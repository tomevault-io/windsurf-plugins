---
trigger: always_on
description: This document describes the file structure of a Files.md knowledge base.
---
...
---
> Source: [zakirullin/files.md](https://github.com/zakirullin/files.md) — distributed by [TomeVault](https://tomevault.io).
