---
trigger: always_on
description: AppleTrace is an iOS/macOS tracing library that records Objective-C and Swift calls and exports Perfetto-compatible traces. Preserve low overhead and binary compatibility in the C/Objective-C++ core.
---
