---
trigger: always_on
description: Instructions for AI coding assistants and developers working on the nastech-agent codebase.
---
...
Nastech is a personal AI agent that runs the same agent core across a CLI, a
...
Read the balance right: Nastech ships a **lot** — most merges are bug fixes to
...
- **Expand reach at the edges.** New platform adapters, channels, providers,
  ...
  (`nastech tools`, `nastech setup`, auto-install) rather than bolting on a raw
  env var.
...
---
> Source: [nastechresearch/nastech-agent](https://github.com/nastechresearch/nastech-agent) — distributed by [TomeVault](https://tomevault.io).
