---
trigger: always_on
description: Use this skill when asked to publish a new version of the Numbast agent from `main`.
---
...
---
> Source: [NVIDIA/numbast](https://github.com/NVIDIA/numbast) — distributed by [TomeVault](https://tomevault.io).
