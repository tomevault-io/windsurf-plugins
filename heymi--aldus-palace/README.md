...
> Source: [heymi/aldus-palace](https://github.com/heymi/aldus-palace). Graded, signed and kept current as the models change by [TomeVault](https://tomevault.io)
...
From [heymi/aldus-palace](https://github.com/heymi/aldus-palace) — a repo with 8+ stars on GitHub.
