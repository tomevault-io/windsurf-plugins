---
trigger: always_on
description: These rules apply for the full session.
---
...
---
> Source: [minghinmatthewlam/pi-gui](https://github.com/minghinmatthewlam/pi-gui) — distributed by [TomeVault](https://tomevault.io).
