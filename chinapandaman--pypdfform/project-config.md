---
trigger: always_on
description: These instructions apply to the entire repository unless a more specific
---
...
---
> Source: [chinapandaman/PyPDFForm](https://github.com/chinapandaman/PyPDFForm) — distributed by [TomeVault](https://tomevault.io).
