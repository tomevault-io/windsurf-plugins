---
trigger: always_on
description: - You can launch `cabal repl <project>` to make quick recompilations in a separate process while working on features
---
...
---
> Source: [cardano-scaling/hydra](https://github.com/cardano-scaling/hydra) — distributed by [TomeVault](https://tomevault.io).
