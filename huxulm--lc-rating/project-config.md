---
trigger: always_on
description: - `apps/web/` is the main Next.js 16 app (App Router) with UI in `components/`, shared hooks in `hooks/`, and utilities in `utils/`.
---
...
---
> Source: [huxulm/lc-rating](https://github.com/huxulm/lc-rating) — distributed by [TomeVault](https://tomevault.io).
