---
trigger: always_on
description: - **Specification benchmark**: Conduct unit testing based on OpenAPI 2.0 (Swagger 2.0) and OpenAPI 3.2 specification benchmarks. Use skills `openapi-specification-v2` and `openapi-specification-v3.2` when writing or validating tests and fixtures.
---
...
---
> Source: [hairyf/genapi](https://github.com/hairyf/genapi) — distributed by [TomeVault](https://tomevault.io).
