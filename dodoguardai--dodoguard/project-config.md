---
trigger: always_on
description: **What this is:** LLM provider integrations that implement a standardized interface to call different AI services (OpenAI, Anthropic, AWS Bedrock, etc.).
---
...
- Transforms DodoGuard prompts → provider-specific API format
