---
trigger: always_on
description: tt-umd (Tenstorrent User Mode Driver) is a C++17 library that provides user-space access to Tenstorrent AI accelerator hardware. It supports Wormhole and Blackhole chip architectures.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/tenstorrent)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/tenstorrent)
