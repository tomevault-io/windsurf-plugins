---
trigger: always_on
description: This is a monorepo using npm workspaces with packages: `lib`, `doc`, `compiler`, `plugins/markdown`, `plugins/img-cropper`.
---
...
---
> Source: [koumoul-dev/vuetify-jsonschema-form](https://github.com/koumoul-dev/vuetify-jsonschema-form) — distributed by [TomeVault](https://tomevault.io).
