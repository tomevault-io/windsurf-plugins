---
trigger: always_on
description: This repository is an Obsidian community plugin named `journal-review`. It renders an "On this day" review of daily notes inside a custom sidebar view.
---
...
---
> Source: [Kageetai/obsidian-plugin-journal-review](https://github.com/Kageetai/obsidian-plugin-journal-review) — distributed by [TomeVault](https://tomevault.io).
