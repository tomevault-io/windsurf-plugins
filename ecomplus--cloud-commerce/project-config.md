---
trigger: always_on
description: **IMPORTANT**: When performing git add and commit operations:
---
...
---
> Source: [ecomplus/cloud-commerce](https://github.com/ecomplus/cloud-commerce) — distributed by [TomeVault](https://tomevault.io).
