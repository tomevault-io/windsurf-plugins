...
Original source: `AGENTS.md` in [ndycode/oc-codex-multi-auth](https://github.com/ndycode/oc-codex-multi-auth).
...
```
npx tomevault install ndycode/oc-codex-multi-auth
```
Source: [github.com/ndycode/oc-codex-multi-auth](https://github.com/ndycode/oc-codex-multi-auth).
