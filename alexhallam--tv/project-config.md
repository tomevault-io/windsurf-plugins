---
trigger: always_on
description: - When suggesting Python package installation commands, always use `uv add` instead of `pip install`
---
...
---
> Source: [alexhallam/tv](https://github.com/alexhallam/tv) — distributed by [TomeVault](https://tomevault.io).
