---
trigger: always_on
description: This file provides guidance to Claude Code when working with the Ruby2JS codebase.
---
...
---
> Source: [ruby2js/ruby2js](https://github.com/ruby2js/ruby2js) — distributed by [TomeVault](https://tomevault.io).
