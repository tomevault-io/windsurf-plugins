---
trigger: always_on
description: `azure-functions-logging` provides structured JSON logging for Azure Functions Python v2 applications.
---
...
---
> Source: [yeongseon/azure-functions-logging-python](https://github.com/yeongseon/azure-functions-logging-python) — distributed by [TomeVault](https://tomevault.io).
