---
trigger: always_on
description: > Guidance for AI agents and automated workflows contributing to **Nutshell**.
---
...
---
> Source: [cashubtc/nutshell](https://github.com/cashubtc/nutshell) — distributed by [TomeVault](https://tomevault.io).
