---
trigger: always_on
description: Talo is a self-hostable game development services platform providing leaderboards, player authentication, peer-to-peer multiplayer, event tracking and more.
---
...
---
> Source: [TaloDev/backend](https://github.com/TaloDev/backend) — distributed by [TomeVault](https://tomevault.io).
