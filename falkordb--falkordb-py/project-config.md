---
trigger: always_on
description: falkordb-py is the official Python client for [FalkorDB](https://github.com/FalkorDB/FalkorDB), a graph database that uses the openCypher query language. It wraps Redis connections (via `redis-py`) and adds graph-specific commands (`GRAPH.QUERY`, `GRAPH.DELETE`, etc.).
---
...
---
> Source: [FalkorDB/falkordb-py](https://github.com/FalkorDB/falkordb-py) — distributed by [TomeVault](https://tomevault.io).
