---
trigger: always_on
description: compose-go is the reference implementation of the [Compose
---
...
---
> Source: [compose-spec/compose-go](https://github.com/compose-spec/compose-go) — distributed by [TomeVault](https://tomevault.io).
