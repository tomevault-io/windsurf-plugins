---
trigger: always_on
description: - CTicker is a pure-C TUI crypto ticker for Binance (ncursesw + libcurl + jansson + pthread).
---
...
---
> Source: [xtaci/cticker](https://github.com/xtaci/cticker) — distributed by [TomeVault](https://tomevault.io).
