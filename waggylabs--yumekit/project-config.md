---
trigger: always_on
description: This file is automatically loaded by Claude Code. It contains project-specific conventions that apply to all AI-assisted work on this repository.
---
