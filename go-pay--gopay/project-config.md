---
trigger: always_on
description: 探索/索引本项目代码时，**默认优先使用 `codebase-memory` MCP**，未安装则降级到默认工具：
---
...
---
> Source: [go-pay/gopay](https://github.com/go-pay/gopay) — distributed by [TomeVault](https://tomevault.io).
