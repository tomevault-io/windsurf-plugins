---
trigger: always_on
description: This document provides essential context for AI assistants working with the amqprs codebase.
---
...
---
> Source: [gftea/amqprs](https://github.com/gftea/amqprs) — distributed by [TomeVault](https://tomevault.io).
