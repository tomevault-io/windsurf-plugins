---
trigger: always_on
description: SpreadGrid is a high-performance JavaScript grid library for data-dense applications. It prioritizes speed over visual waterfalls. The library uses canvas-based rendering with 9 canvas sections for pinned rows/columns support.
---
...
---
> Source: [TomaszRewak/js-spread-grid](https://github.com/TomaszRewak/js-spread-grid) — distributed by [TomeVault](https://tomevault.io).
