---
trigger: always_on
description: MohsinApex-Music is a 3rd party YouTube Music client written in Kotlin. It follows material 3 design guidelines closely.
---

# Working with MohsinApex-Music as an AI agent

MohsinApex-Music is a 3rd party YouTube Music client written in Kotlin. It follows material 3 design guidelines closely.
...
3. All string edits should be made to the `MohsinApex-Music/app/src/main/res/values/MohsinApex-Music_strings.xml` file, NOT `MohsinApex-Music/app/src/main/res/values/strings.xml`. Do not touch other `strings.xml` or `MohsinApex-Music_strings.xml` files in the project. ONLY edit the default (English) `MohsinApex-Music_strings.xml` file, DO NOT EDIT OTHER LANGUAGES.
...
---
> Source: [mohsinapex/ApexTunes](https://github.com/mohsinapex/ApexTunes) — distributed by [TomeVault](https://tomevault.io).
