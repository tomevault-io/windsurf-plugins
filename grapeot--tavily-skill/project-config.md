---
trigger: always_on
description: - `src/tavily_skill/` — Python package (`cli.py` owns argparse + Tavily calls).
---
...
---
> Source: [grapeot/tavily-skill](https://github.com/grapeot/tavily-skill) — distributed by [TomeVault](https://tomevault.io).
