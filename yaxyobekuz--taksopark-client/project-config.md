---
trigger: always_on
description: Vite + React 19 + Redux Toolkit + TanStack Query + shadcn/ui + Tailwind. **Based on FSD**, the `owner/` panel is split internally into `features/`.
---
...
---
> Source: [yaxyobekuz/taksopark-client](https://github.com/yaxyobekuz/taksopark-client) — distributed by [TomeVault](https://tomevault.io).
