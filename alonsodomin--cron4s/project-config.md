---
trigger: always_on
description: - **SBT 1.12.9**, cross-builds to **Scala 2.12.17 / 2.13.18 / 3.3.6** on **JVM, JS, Native**
---
...
---
> Source: [alonsodomin/cron4s](https://github.com/alonsodomin/cron4s) — distributed by [TomeVault](https://tomevault.io).
