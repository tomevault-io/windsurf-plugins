---
trigger: always_on
description: This repository is the Temple Wallet mobile app codebase. Temple Wallet is an open-source wallet for Tezos blockchain, focusing on security and seamless UX.
---
...
---
> Source: [madfish-solutions/templewallet-mobile](https://github.com/madfish-solutions/templewallet-mobile) — distributed by [TomeVault](https://tomevault.io).
