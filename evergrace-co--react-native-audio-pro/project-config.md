---
trigger: always_on
description: - Library source lives in `src/` (TypeScript hooks, Zustand store, platform bridges). Unit tests sit in `src/__tests__/`.
---
...
---
> Source: [evergrace-co/react-native-audio-pro](https://github.com/evergrace-co/react-native-audio-pro) — distributed by [TomeVault](https://tomevault.io).
