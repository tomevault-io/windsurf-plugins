---
trigger: always_on
description: LLM evaluation framework built on Vitest.
---
...
---
> Source: [viteval/viteval](https://github.com/viteval/viteval) — distributed by [TomeVault](https://tomevault.io).
