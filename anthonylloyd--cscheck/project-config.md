---
trigger: always_on
description: Guidance for AI coding agents working in, or generating code that uses, **CsCheck**.
---
...
---
> Source: [AnthonyLloyd/CsCheck](https://github.com/AnthonyLloyd/CsCheck) — distributed by [TomeVault](https://tomevault.io).
