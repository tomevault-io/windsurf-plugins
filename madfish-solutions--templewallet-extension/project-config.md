---
trigger: always_on
description: This repository is the Temple Wallet browser extension codebase. Temple Wallet is an open-source multichain wallet for Tezos & EVM-compatible blockchains, focusing on security and seamless UX.
---
...
- `yarn build:without-zip`: Production build without zipping (faster for perf checks)
...
---
> Source: [madfish-solutions/templewallet-extension](https://github.com/madfish-solutions/templewallet-extension) — distributed by [TomeVault](https://tomevault.io).
