---
trigger: always_on
description: This file contains guidelines for reviewing GitHub pull requests that add new packages to the WakeMeOps debian APT repository.
---
...
---
> Source: [upciti/wakemeops](https://github.com/upciti/wakemeops) — distributed by [TomeVault](https://tomevault.io).
