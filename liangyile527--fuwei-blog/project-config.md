---
trigger: always_on
description: - 技术栈：Astro + TypeScript + Svelte，脚本层为 Node.js（`src/**`、`scripts/*.js`）。
---
...
---
> Source: [liangyile527/fuwei-blog](https://github.com/liangyile527/fuwei-blog) — distributed by [TomeVault](https://tomevault.io).
