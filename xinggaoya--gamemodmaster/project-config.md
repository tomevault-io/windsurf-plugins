---
trigger: always_on
description: - `src/`：Vue 3 + TypeScript 前端，`components/` 放 UI 片段，`views/` 为页面，`stores/` 存放 Pinia 状态，`services/` 封装前端数据/更新逻辑，`assets/` 负责样式与静态资源。
---
...
---
> Source: [xinggaoya/GameModMaster](https://github.com/xinggaoya/GameModMaster) — distributed by [TomeVault](https://tomevault.io).
