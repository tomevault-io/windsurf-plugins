---
trigger: always_on
description: npm test              # Lint (standard) + unit tests
---
...
---
> Source: [tediousjs/node-mssql](https://github.com/tediousjs/node-mssql) — distributed by [TomeVault](https://tomevault.io).
