---
trigger: always_on
description: > 这个 Flutter 项目自己的长期记忆。**动手前先读 [`docs/TECHNICAL.md`](docs/TECHNICAL.md)**：
---
...
---
> Source: [weekitmo/herdr-pocket](https://github.com/weekitmo/herdr-pocket) — distributed by [TomeVault](https://tomevault.io).
