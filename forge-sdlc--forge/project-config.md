---
trigger: always_on
description: Forge is an AI-powered SDLC orchestrator that automates software development workflows using LangGraph, FastAPI, and Claude.
---
...
---
> Source: [forge-sdlc/forge](https://github.com/forge-sdlc/forge) — distributed by [TomeVault](https://tomevault.io).
