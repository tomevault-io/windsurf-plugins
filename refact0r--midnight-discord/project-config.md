---
trigger: always_on
description: A CSS theme for Discord. The maintainer may be running it through desktop Vencord (`npm run dev` + `DEV_OUTPUT_PATH`) or testing in a browser tab (`npm run serve`). Most of the time you can just edit files; only spin up the browser injection flow when told.
---
...
---
> Source: [refact0r/midnight-discord](https://github.com/refact0r/midnight-discord) — distributed by [TomeVault](https://tomevault.io).
