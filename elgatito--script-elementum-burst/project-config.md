---
trigger: always_on
description: `burst.py` is the Kodi entrypoint and forwards work into `burst/`, which contains the core search pipeline (`burst.py`, `provider.py`, `client.py`, `filtering.py`, `normalize.py`, `utils.py`).
---
...
---
> Source: [elgatito/script.elementum.burst](https://github.com/elgatito/script.elementum.burst) — distributed by [TomeVault](https://tomevault.io).
