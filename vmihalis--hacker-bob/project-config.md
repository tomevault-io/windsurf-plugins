---
trigger: always_on
description: This repository is the install source for the Hacker Bob `/bob-hunt` Claude Code framework.
---
...
---
> Source: [vmihalis/hacker-bob](https://github.com/vmihalis/hacker-bob) — distributed by [TomeVault](https://tomevault.io).
