...
# simple-operator - AI Agent Guide
...
---
> Source: [amirhosssein0/k8s-operator-lab](https://github.com/amirhosssein0/k8s-operator-lab) — distributed by [TomeVault](https://tomevault.io).
