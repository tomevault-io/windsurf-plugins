---
trigger: always_on
description: The website content tree `docsy.dev/content/en/project/` ([project][]) is the
---
...
listed at <https://github.com/docsy/docsy/milestones>.
...
- `theme/`: the Docsy theme module (the published Hugo module). Consuming sites
  import `github.com/docsy/docsy/theme`; npm/clone installs use
...
---
> Source: [docsy/docsy](https://github.com/docsy/docsy) — distributed by [TomeVault](https://tomevault.io).
