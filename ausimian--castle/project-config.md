---
trigger: always_on
description: Runtime support for hot-code upgrades in Elixir releases. Castle is the runtime
---
...
---
> Source: [ausimian/castle](https://github.com/ausimian/castle) — distributed by [TomeVault](https://tomevault.io).
