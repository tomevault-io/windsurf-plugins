---
trigger: always_on
description: - Install project dependencies with `composer install` from the repository root.
---
...
---
> Source: [voku/portable-ascii](https://github.com/voku/portable-ascii) — distributed by [TomeVault](https://tomevault.io).
