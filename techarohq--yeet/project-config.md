---
trigger: always_on
description: Source code is primarily Go; JavaScript tooling lives under `node_modules` and the root `package.json`.
---
...
---
> Source: [TecharoHQ/yeet](https://github.com/TecharoHQ/yeet) — distributed by [TomeVault](https://tomevault.io).
