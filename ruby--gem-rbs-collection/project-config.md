---
trigger: always_on
description: gem_rbs_collection is a community-managed collection of [RBS](https://github.com/ruby/rbs) type signature files for gems that ship without their own RBS.
---
...
---
> Source: [ruby/gem_rbs_collection](https://github.com/ruby/gem_rbs_collection) — distributed by [TomeVault](https://tomevault.io).
