---
trigger: always_on
description: Smart LLM router for autonomous agents. 55+ models. Wallet-based auth. USDC micropayments via x402.
---
...
---
> Source: [BlockRunAI/ClawRouter](https://github.com/BlockRunAI/ClawRouter) — distributed by [TomeVault](https://tomevault.io).
