---
trigger: always_on
description: A complete, playable bullet-heaven (survivors-like) built with **Phaser 3.90 + TypeScript (strict) + Vite 7**.
---
...
---
> Source: [wubaijian/ai-evolution-game](https://github.com/wubaijian/ai-evolution-game) — distributed by [TomeVault](https://tomevault.io).
