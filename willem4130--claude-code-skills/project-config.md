---
trigger: always_on
description: Repository for custom Claude Code skills - modular, reusable capabilities that extend Claude's functionality.
---
...
---
> Source: [willem4130/claude-code-skills](https://github.com/willem4130/claude-code-skills) — distributed by [TomeVault](https://tomevault.io).
