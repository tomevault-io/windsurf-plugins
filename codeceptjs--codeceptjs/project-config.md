---
trigger: always_on
description: This project is migrating from 3.x to ESM replacing all require() calls with imports.
---
...
---
> Source: [codeceptjs/CodeceptJS](https://github.com/codeceptjs/CodeceptJS) — distributed by [TomeVault](https://tomevault.io).
