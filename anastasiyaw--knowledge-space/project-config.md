---
trigger: always_on
description: This file is for AI agents that clone this repository. Read this before making any changes.
---
...
A curated technical knowledge base (785+ articles, 26 domains) designed for AI agent consumption. Dense references - code, configs, gotchas - no tutorials, no filler.
...
---
> Source: [AnastasiyaW/knowledge-space](https://github.com/AnastasiyaW/knowledge-space) — distributed by [TomeVault](https://tomevault.io).
