---
trigger: always_on
description: This file is the source of truth for any coding agent (Claude Code, Cursor, Codex, etc.) working in this repo. Read it before touching code.
---
...
---
> Source: [daveebbelaar/document-copilot](https://github.com/daveebbelaar/document-copilot) — distributed by [TomeVault](https://tomevault.io).
