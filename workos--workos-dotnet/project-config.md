---
trigger: always_on
description: Most code in this repository is **auto-generated**. It is emitted by the
---

# WorkOS .NET SDK — Agent Context
...
| [workos/oagen-emitters](https://github.com/workos/oagen-emitters) | The per-language emitters, including the C# emitter that produces this repo's code |

Regeneration runs from a checkout of `openapi-spec`, never from this repo:

```bash
npm run sdk:generate -- --lang dotnet --output workos-dotnet
```
...
| Generated C# code is broken or un-idiomatic | [workos/oagen-emitters](https://github.com/workos/oagen-emitters) |
...
---
> Source: [workos/workos-dotnet](https://github.com/workos/workos-dotnet) — distributed by [TomeVault](https://tomevault.io).
