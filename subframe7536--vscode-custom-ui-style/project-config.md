---
trigger: always_on
description: This repository builds a VS Code extension that patches VS Code runtime assets (CSS/JS/HTML/JSON) to apply custom UI styles.
---
...
---
> Source: [subframe7536/vscode-custom-ui-style](https://github.com/subframe7536/vscode-custom-ui-style) — distributed by [TomeVault](https://tomevault.io).
