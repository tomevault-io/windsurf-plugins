---
trigger: always_on
description: OpenPE (Principle to Endgame) — an autonomous first-principles analysis framework using LLM-driven agents.
---
...
---
> Source: [xinzhuwang-wxz/OpenPE](https://github.com/xinzhuwang-wxz/OpenPE) — distributed by [TomeVault](https://tomevault.io).
