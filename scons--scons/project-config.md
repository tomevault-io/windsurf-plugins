---
trigger: always_on
description: python scripts/scons.py            # build packages (wheels, tarballs, zips → build/)
---
...
---
> Source: [SCons/scons](https://github.com/SCons/scons) — distributed by [TomeVault](https://tomevault.io).
