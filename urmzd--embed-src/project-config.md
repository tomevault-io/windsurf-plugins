---
trigger: always_on
description: You are an agent working on **embed-src** — a Rust CLI tool that embeds source files into any text file using comment markers. It works with markdown, YAML, Python, Rust, shell scripts, and any file that supports comments.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/urmzd)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/urmzd)
