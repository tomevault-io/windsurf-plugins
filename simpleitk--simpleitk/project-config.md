---
trigger: always_on
description: SimpleITK is a layer for the Insight Toolkit (ITK) providing an accessible interface for medical image analysis. It has a core C++ library, and uses SWIG to provide language bindings for Python, Java, R, C# and others.
---
...
---
> Source: [SimpleITK/SimpleITK](https://github.com/SimpleITK/SimpleITK) — distributed by [TomeVault](https://tomevault.io).
