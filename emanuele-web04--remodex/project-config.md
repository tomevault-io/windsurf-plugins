---
trigger: always_on
description: Keep this file and `CLAUDE.md` aligned.
---
...
---
> Source: [Emanuele-web04/remodex](https://github.com/Emanuele-web04/remodex) — distributed by [TomeVault](https://tomevault.io).
