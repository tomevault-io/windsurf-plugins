---
trigger: always_on
description: - 以后准备公开 GitHub Release 时，必须在同一个 Release 草稿中集齐三个桌面系统的正式直发包，不得默认只发布 Linux。
---
...
---
> Source: [web-casa/ImgConvert](https://github.com/web-casa/ImgConvert) — distributed by [TomeVault](https://tomevault.io).
