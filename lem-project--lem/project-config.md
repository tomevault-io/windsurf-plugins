---
trigger: always_on
description: Lem is a text editor written in Common Lisp with multiple frontend support (terminal, GUI, browser).
---
...
---
> Source: [lem-project/lem](https://github.com/lem-project/lem) — distributed by [TomeVault](https://tomevault.io).
