---
trigger: always_on
description: This repo is a multi-targeted .NET library (C#), built with `dotnet` and tested with xUnit.
---
...
---
> Source: [InCerryGit/FasterKvCache](https://github.com/InCerryGit/FasterKvCache) — distributed by [TomeVault](https://tomevault.io).
