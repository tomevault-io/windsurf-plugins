---
trigger: always_on
description: Guidance for coding agents working in this repository. Derived from `CLAUDE.md`.
---
...
- Numeric precision: machine (64-bit) and arbitrary precision (custom `BigDecimal` in `src/big-decimal/`, backed by native `bigint`)
...
- Generated: `src/api.md` (regenerated by `npm run doc`; do not edit manually)
- Architecture overview: `ARCHITECTURE.md` (top level)
...
---
> Source: [cortex-js/compute-engine](https://github.com/cortex-js/compute-engine) — distributed by [TomeVault](https://tomevault.io).
