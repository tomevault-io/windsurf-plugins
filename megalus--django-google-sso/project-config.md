---
trigger: always_on
description: Project runs on a virtualenv inside WSL. Python interpreter can be found using command `poetry env info`.
---
...
---
> Source: [megalus/django-google-sso](https://github.com/megalus/django-google-sso) — distributed by [TomeVault](https://tomevault.io).
