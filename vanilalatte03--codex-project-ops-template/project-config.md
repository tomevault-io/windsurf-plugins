---
trigger: always_on
description: - <이 프로젝트가 해결하는 문제를 한 문장으로 작성>
---
...
---
> Source: [vanilalatte03/codex-project-ops-template](https://github.com/vanilalatte03/codex-project-ops-template) — distributed by [TomeVault](https://tomevault.io).
