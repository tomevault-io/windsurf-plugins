---
trigger: always_on
description: **Baro** is a dual-stack project combining Rust and TypeScript/Node.js. It appears to be a TUI (terminal user interface) application with an accompanying web/app component. The project uses Rust for core functionality and TypeScript for the application layer.
---
