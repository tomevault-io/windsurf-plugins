---
trigger: always_on
description: Do **not** edit code in `sea-orm-sync/src/` or `sea-orm-sync/tests/` directly. All source and test files are generated from the main `src/` and `tests/` directories by running:
---
...
---
> Source: [SeaQL/sea-orm](https://github.com/SeaQL/sea-orm) — distributed by [TomeVault](https://tomevault.io).
