---
trigger: always_on
description: This document instructs AI agents (LLMs, coding assistants, automated reviewers) on behavior, quality expectations, and best practices when generating, modifying, or reviewing code and documentation for the **ngx-otp-input** Angular library.
---
...
---
> Source: [pkovzz/ngx-otp-input](https://github.com/pkovzz/ngx-otp-input) — distributed by [TomeVault](https://tomevault.io).
