---
trigger: always_on
description: Internal hooks for automated assistants working in this repo — **not** part of the human-facing attack-macOS documentation set.
---
...
---
> Source: [darmado/attack-macOS](https://github.com/darmado/attack-macOS) — distributed by [TomeVault](https://tomevault.io).
