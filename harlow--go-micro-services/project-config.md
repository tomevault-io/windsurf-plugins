---
trigger: always_on
description: This repository is a Go microservices demo (`github.com/harlow/go-micro-services`) with a gRPC backend and an HTTP frontend.
---
...
---
> Source: [harlow/go-micro-services](https://github.com/harlow/go-micro-services) — distributed by [TomeVault](https://tomevault.io).
