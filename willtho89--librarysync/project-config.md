---
trigger: always_on
description: librarySync is a self-hosted, Docker-compose-deployable, multi-user hub for watch history and ratings that syncs across Trakt, SIMKL, Letterboxd, and Stremio.
---
...
---
> Source: [willtho89/librarySync](https://github.com/willtho89/librarySync) — distributed by [TomeVault](https://tomevault.io).
