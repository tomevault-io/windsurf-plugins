---
trigger: always_on
description: Rainbow Swap frontend (Vite + React + TypeScript) with smart contracts in FunC.
---
...
---
> Source: [0xblackbot/rainbow-swap](https://github.com/0xblackbot/rainbow-swap) — distributed by [TomeVault](https://tomevault.io).
