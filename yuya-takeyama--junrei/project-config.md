---
trigger: always_on
description: The main session often runs on an expensive orchestrator model. **Before
---
...
---
> Source: [yuya-takeyama/junrei](https://github.com/yuya-takeyama/junrei) — distributed by [TomeVault](https://tomevault.io).
