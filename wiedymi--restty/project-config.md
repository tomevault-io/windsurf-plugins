---
trigger: always_on
description: - `src/` contains the TypeScript library code and package entrypoints (`src/index.ts`, `src/internal.ts`, `src/xterm.ts`).
---
...
---
> Source: [wiedymi/restty](https://github.com/wiedymi/restty) — distributed by [TomeVault](https://tomevault.io).
