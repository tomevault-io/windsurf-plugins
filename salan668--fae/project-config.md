---
trigger: always_on
description: FAE (FeAture Explorer) is a **PySide6 desktop GUI application** for radiomics and medical imaging analysis. It is not a library or web app. There are no automated tests.
---
...
---
> Source: [salan668/FAE](https://github.com/salan668/FAE) — distributed by [TomeVault](https://tomevault.io).
