---
trigger: always_on
description: model-library is an open-source Python library by Vals AI that provides a unified interface for interacting with LLM providers (Anthropic, OpenAI, Google, Mistral, AWS Bedrock, and more).
---
...
---
> Source: [vals-ai/model-library](https://github.com/vals-ai/model-library) — distributed by [TomeVault](https://tomevault.io).
