---
trigger: always_on
description: Generative AI, including large language models (LLMs), should not be used in
---
...
---
> Source: [libsdl-org/SDL_shadercross](https://github.com/libsdl-org/SDL_shadercross) — distributed by [TomeVault](https://tomevault.io).
