---
trigger: always_on
description: Most active development commands live in `app/`, not the repository root.
---
...
---
> Source: [yf-hao/haomd](https://github.com/yf-hao/haomd) — distributed by [TomeVault](https://tomevault.io).
