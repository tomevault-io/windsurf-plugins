---
trigger: always_on
description: Chroma is a syntax highlighting library, tool and web playground for Go. It is based on Pygments and includes importers for it, so most of the same concepts from Pygments apply to Chroma.
---
...
---
> Source: [xyproto/algernon](https://github.com/xyproto/algernon) — distributed by [TomeVault](https://tomevault.io).
