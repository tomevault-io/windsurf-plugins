---
trigger: always_on
description: Guidance for AI agents (Claude Code, Codex, etc.) working in this repo.
---
...
- The crate boundary matters. `folio-core` is the library; `folio-cli`
...
---
> Source: [woosal1337/folio](https://github.com/woosal1337/folio) — distributed by [TomeVault](https://tomevault.io).
