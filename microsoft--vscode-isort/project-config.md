---
trigger: always_on
description: This is a VS Code extension that wraps [isort](https://pycqa.github.io/isort/) for Python import sorting. It's a **dual-language project**: TypeScript for the VS Code client, Python for the LSP server.
---
...
- Always enable auto-merge (squash) on PRs after creating them: `gh pr merge <number> --repo microsoft/vscode-isort --squash --auto`
- PRs require approval from someone other than the last pusher before merging.

---
> Source: [microsoft/vscode-isort](https://github.com/microsoft/vscode-isort) — distributed by [TomeVault](https://tomevault.io).
