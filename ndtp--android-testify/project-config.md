---
trigger: always_on
description: This file provides context for Gemini to understand the `android-testify` project.
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/ndtp)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/ndtp)
