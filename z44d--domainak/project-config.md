---
trigger: always_on
description: Practical guide for agentic coding assistants working in `domainak`.
---
...
---
> Source: [z44d/domainak](https://github.com/z44d/domainak) — distributed by [TomeVault](https://tomevault.io).
