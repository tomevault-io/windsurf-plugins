---
trigger: always_on
description: Shubble is a real-time shuttle tracking application for Rensselaer Polytechnic Institute (RPI).
---
...
---
> Source: [Shubble-LLC/shubble](https://github.com/Shubble-LLC/shubble) — distributed by [TomeVault](https://tomevault.io).
