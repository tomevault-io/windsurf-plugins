---
trigger: always_on
description: Always assume a bug-ticket might be outdated and first try to verify if the described issue is still occurring.
---
...
---
> Source: [Accenture/sfmc-devtools](https://github.com/Accenture/sfmc-devtools) — distributed by [TomeVault](https://tomevault.io).
