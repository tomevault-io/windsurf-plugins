---
trigger: always_on
description: - `cmd/` entrypoints for CNI plugin, controller, daemon, and helpers; binaries land in `dist/images/` via Make targets.
---
...
---
> Source: [kubeovn/kube-ovn](https://github.com/kubeovn/kube-ovn) — distributed by [TomeVault](https://tomevault.io).
