---
trigger: always_on
description: **AGENTS.md is a simple, open format for guiding AI agents that works with your repository.**
---
...
---
> Source: [CiscoDevNet/foundry-security-spec](https://github.com/CiscoDevNet/foundry-security-spec) — distributed by [TomeVault](https://tomevault.io).
