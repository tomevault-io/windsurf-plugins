...
-   **Core Component**: `experimental_PaidMcpAgent` from `@stripe/agent-toolkit/cloudflare` is the base for `BoilerplateMCP`, enabling paid tool functionality.
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/cactusaurelius)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/cactusaurelius)
