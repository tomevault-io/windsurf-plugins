---
trigger: always_on
description: > **For technical details on any system, call `get_project_docs(topic)`.**
---
...
---
> Source: [tullulah/vectrex-studio](https://github.com/tullulah/vectrex-studio) — distributed by [TomeVault](https://tomevault.io).
