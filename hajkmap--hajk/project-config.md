---
trigger: always_on
description: Hajk is an open-source web GIS solution based on React, Material UI, and OpenLayers. This guide outlines key architectural patterns and workflows to help AI agents effectively contribute to the codebase.
---
...
---
> Source: [hajkmap/Hajk](https://github.com/hajkmap/Hajk) — distributed by [TomeVault](https://tomevault.io).
