---
trigger: always_on
description: Guidelines for agentic coding tools working in this repository.
---
...
---
> Source: [rustminded/xtask-wasm](https://github.com/rustminded/xtask-wasm) — distributed by [TomeVault](https://tomevault.io).
