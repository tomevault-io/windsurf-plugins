---
trigger: always_on
description: - `backend/` is a Django 4.2 + DRF API service; entrypoints are `backend/manage.py`, `backend/config/settings.py`, and `backend/config/urls.py`.
---
...
---
> Source: [virtualman333/aiUniTokenHub](https://github.com/virtualman333/aiUniTokenHub) — distributed by [TomeVault](https://tomevault.io).
