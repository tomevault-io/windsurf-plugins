---
trigger: always_on
description: - `water-server/`：Spring Boot 后端，主代码在 `src/main/java/com/water/server`，配置和建表脚本在 `src/main/resources`，测试在 `src/test/java`。
---
...
---
> Source: [wangxpcool/water](https://github.com/wangxpcool/water) — distributed by [TomeVault](https://tomevault.io).
