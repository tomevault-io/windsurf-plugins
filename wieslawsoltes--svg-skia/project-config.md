---
trigger: always_on
description: This repository contains the Svg.Skia library and associated tests. The following rules apply when creating pull requests with the Codex agent.
---
...
---
> Source: [wieslawsoltes/Svg.Skia](https://github.com/wieslawsoltes/Svg.Skia) — distributed by [TomeVault](https://tomevault.io).
