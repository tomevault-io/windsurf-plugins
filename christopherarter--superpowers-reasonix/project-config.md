---
trigger: always_on
description: This project ships skills (playbooks) under `skills/`. They only work if you load them.
---
...
---
> Source: [christopherarter/superpowers-reasonix](https://github.com/christopherarter/superpowers-reasonix) — distributed by [TomeVault](https://tomevault.io).
