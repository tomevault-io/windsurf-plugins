---
trigger: always_on
description: Distill a graduate supervisor/mentor into an AI Skill. Auto-collect papers/research records/supervision logs, generate academic guidance Skill + Mentor Persona, with continuous evolution. | 蒸馏研究生导师/教授成 AI Skill，自动采集论文/项目/指导记录，生成学术指导 Skill + 导师风格 persona，支持持续进化。
---
...
1. **导师姓名/代号**（必填）
2. **基本信息**（一句话：学校、学院、职称、主要研究方向，想到什么写什么）
   - 示例：`华南师大 心理学院 教授 认知神经科学 研究方向`
3. **指导风格**（一句话：指导习惯、性格特点、要求标准、印象）
   - 示例：`温和 放养型 每周开组会 论文要求严格 鼓励学生自主探索`
...
---
> Source: [kongtou-1/mentor-skill](https://github.com/kongtou-1/mentor-skill) — distributed by [TomeVault](https://tomevault.io).
