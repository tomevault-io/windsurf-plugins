---
trigger: always_on
description: Go SDR demodulator. Single-module, single-binary project.
---
...
---
> Source: [racerxdl/segdsp](https://github.com/racerxdl/segdsp) — distributed by [TomeVault](https://tomevault.io).
