---
trigger: always_on
description: - Never force unwrap (`!`) or force cast (`as!`) — use `if let`, `guard let`, or `as?` instead
---
...
---
> Source: [jamf/PPPC-Utility](https://github.com/jamf/PPPC-Utility) — distributed by [TomeVault](https://tomevault.io).
