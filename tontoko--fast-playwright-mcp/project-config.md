---
trigger: always_on
description: This is the Fast Playwright MCP Server project - a TypeScript/JavaScript automation tool using Playwright for browser automation via MCP (Model Context Protocol).
---
...
---
> Source: [tontoko/fast-playwright-mcp](https://github.com/tontoko/fast-playwright-mcp) — distributed by [TomeVault](https://tomevault.io).
