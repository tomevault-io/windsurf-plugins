---
trigger: always_on
description: Root-scope guide for AI agents working in `ink`.
---
...
---
> Source: [jacob-bytes/komari-theme-ink](https://github.com/jacob-bytes/komari-theme-ink) — distributed by [TomeVault](https://tomevault.io).
