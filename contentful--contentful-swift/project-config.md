---
trigger: always_on
description: Orientation for coding agents working in `contentful.swift`, the Swift client
---
...
---
> Source: [contentful/contentful.swift](https://github.com/contentful/contentful.swift) — distributed by [TomeVault](https://tomevault.io).
