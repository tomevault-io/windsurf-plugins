---
trigger: always_on
description: 本项目是把飞书作为ACP的客户端的桥接库，虽然有API SDK调用，但是也不免会涉及到参考飞书官方API文档，必要时候需要参看：https://open.larksuite.com/document/server-docs/getting-started/getting-started
---
...
---
> Source: [4t145/lark-acp](https://github.com/4t145/lark-acp) — distributed by [TomeVault](https://tomevault.io).
