---
trigger: always_on
description: This project is adding V language support to the intellij platform as a plugin.
---
...
---
> Source: [vlang/intellij-v](https://github.com/vlang/intellij-v) — distributed by [TomeVault](https://tomevault.io).
