---
trigger: always_on
description: - ユーザーに新しいタスクを要求されたら、必ずプログレスマネージャーであるavaのスキルをロードすること
---
...
---
> Source: [yutakobayashidev/ava](https://github.com/yutakobayashidev/ava) — distributed by [TomeVault](https://tomevault.io).
