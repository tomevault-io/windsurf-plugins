---
trigger: always_on
description: See @docs/ingestion/README_INGESTS.md for the generialized rules of running ingests and @docs/ingestion/README_NARA.md and @docs/ingestion/README_SMITHSONIAN.md for NARA and Smithsonian ingest documentations
---
