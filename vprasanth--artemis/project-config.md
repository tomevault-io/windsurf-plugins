---
trigger: always_on
description: Real-time terminal dashboard for NASA's Artemis II crewed lunar flyby mission.
---
...
---
> Source: [vprasanth/artemis](https://github.com/vprasanth/artemis) — distributed by [TomeVault](https://tomevault.io).
