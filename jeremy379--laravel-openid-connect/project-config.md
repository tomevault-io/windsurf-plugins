---
trigger: always_on
description: Adds **OpenID Connect (OIDC) `id_token`** support to [Laravel Passport](https://laravel.com/docs/passport), which is built on top of [league/oauth2-server](https://github.com/thephpleague/oauth2-server).
---
...
---
> Source: [jeremy379/laravel-openid-connect](https://github.com/jeremy379/laravel-openid-connect) — distributed by [TomeVault](https://tomevault.io).
