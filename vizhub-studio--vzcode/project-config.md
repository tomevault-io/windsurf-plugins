---
trigger: always_on
description: VZCode is a browser-based multiplayer code editor built for real-time collaborative development. It serves as both a standalone editor and the core component of VizHub. The application supports AI-assisted coding, file management, syntax highlighting, and live collaboration features.
---
...
---
> Source: [vizhub-studio/vzcode](https://github.com/vizhub-studio/vzcode) — distributed by [TomeVault](https://tomevault.io).
