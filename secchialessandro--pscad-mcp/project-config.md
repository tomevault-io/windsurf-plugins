---
trigger: always_on
description: This repository contains a Python MCP server that exposes PSCAD automation tools to GitHub Copilot CLI.
---
...
---
> Source: [SecchiAlessandro/pscad-mcp](https://github.com/SecchiAlessandro/pscad-mcp) — distributed by [TomeVault](https://tomevault.io).
