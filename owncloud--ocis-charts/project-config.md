---
trigger: always_on
description: Kubernetes Helm charts for deploying oCIS. Licensed under Apache-2.0. Uses Helm, Helmfile, and KubeLinter for chart management and validation.
---
...
---
> Source: [owncloud/ocis-charts](https://github.com/owncloud/ocis-charts) — distributed by [TomeVault](https://tomevault.io).
