---
trigger: always_on
description: 本文件与 `AGENTS.md` 保持一致，供支持 `GEMINI.md` 的工具读取。
---

# GEMINI.md

本文件与 `AGENTS.md` 保持一致，供支持 `GEMINI.md` 的工具读取。
...
---
> Source: [wukuiqing49/ApplicationArchitecture](https://github.com/wukuiqing49/ApplicationArchitecture) — distributed by [TomeVault](https://tomevault.io).
