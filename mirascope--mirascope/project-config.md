---
trigger: always_on
description: The `website/` package is the Mirascope marketing website built with React, TanStack Router, and Vite. It serves the docs, blog, landing page, and pricing page.
---
...
---
> Source: [Mirascope/mirascope](https://github.com/Mirascope/mirascope) — distributed by [TomeVault](https://tomevault.io).
