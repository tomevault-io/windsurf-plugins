---
trigger: always_on
description: CMU Maps is a Turborepo monorepo with 4 apps and 3 shared packages. See `README.md` and `.github/CONTRIBUTING.md` for general project info.
---
...
---
> Source: [ScottyLabs/maps](https://github.com/ScottyLabs/maps) — distributed by [TomeVault](https://tomevault.io).
