---
trigger: always_on
description: Rules for AI agents working on this project.
---
...
---
> Source: [zas/mcp-musicbrainz](https://github.com/zas/mcp-musicbrainz) — distributed by [TomeVault](https://tomevault.io).
