---
trigger: always_on
description: Common Media Library (CML) is a collection of TypeScript libraries implementing media specifications (CMCD, CMSD, ID3, ISO BMFF, WebVTT, DASH, and more) for use by web video players such as hls.js, dash.js, and shaka-player.
---
