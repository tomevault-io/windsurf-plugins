---
trigger: always_on
description: Common Media Library is optimized for adoption by web video players — performance, tree-shakeability, developer experience, and documentation quality are the top priorities. General project instructions are in [AGENTS.md](AGENTS.md).
---
