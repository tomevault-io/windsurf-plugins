---
trigger: always_on
description: 该文件为 Claude Code (claude.ai/code) 在此代码库中工作时提供指导。
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/yinzhenyu-su)
> This is a context snippet only. You'll also want the standalone SKILL.md file — [download at TomeVault](https://tomevault.io/claim/yinzhenyu-su)
