---
trigger: always_on
description: This is the curl_cffi project, a python binding to curl-impersonate. The project is based
---
...
---
> Source: [lexiforest/curl_cffi](https://github.com/lexiforest/curl_cffi) — distributed by [TomeVault](https://tomevault.io).
