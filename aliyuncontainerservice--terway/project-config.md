---
trigger: always_on
description: - **Trigger**: When modifying Kubernetes API definitions, struct fields, or deepcopy logic.
---
...
---
> Source: [AliyunContainerService/terway](https://github.com/AliyunContainerService/terway) — distributed by [TomeVault](https://tomevault.io).
