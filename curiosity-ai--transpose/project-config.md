---
trigger: always_on
description: Welcome to the H5 repository. H5 is a modern fork of the Bridge.NET C# to JavaScript compiler, updated for .NET 8.0 and .NET Standard 2.1.
---
...
---
> Source: [curiosity-ai/transpose](https://github.com/curiosity-ai/transpose) — distributed by [TomeVault](https://tomevault.io).
