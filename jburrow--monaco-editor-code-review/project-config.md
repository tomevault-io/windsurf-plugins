---
trigger: always_on
description: Code review extension for the Monaco editor: inline comments, threaded replies, and edit history rendered as editor view zones. Published to npm as `monaco-review`.
---
...
---
> Source: [jburrow/monaco-editor-code-review](https://github.com/jburrow/monaco-editor-code-review) — distributed by [TomeVault](https://tomevault.io).
