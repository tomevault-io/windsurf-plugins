---
trigger: always_on
description: xgo is a Go tool that instruments Go code for testing, mocking, tracing, and intercepting. It acts as a drop-in replacement for `go` commands (build, test, run, etc.).
---
...
---
> Source: [xhd2015/xgo](https://github.com/xhd2015/xgo) — distributed by [TomeVault](https://tomevault.io).
