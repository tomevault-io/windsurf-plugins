---
trigger: always_on
description: Go mono-repo of utility libraries for the `go-openapi` / `go-swagger` ecosystem.
---
...
---
> Source: [go-openapi/swag](https://github.com/go-openapi/swag) — distributed by [TomeVault](https://tomevault.io).
