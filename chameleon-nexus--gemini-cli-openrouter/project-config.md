---
trigger: always_on
description: Before submitting any changes, it is crucial to validate them by running the full preflight check. This command will build the repository, run all tests, check for type errors, and lint the code.
---
...
---
> Source: [chameleon-nexus/gemini-cli-openrouter](https://github.com/chameleon-nexus/gemini-cli-openrouter) — distributed by [TomeVault](https://tomevault.io).
