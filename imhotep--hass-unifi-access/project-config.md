---
trigger: always_on
description: Home Assistant custom integration for UniFi Access. Uses `py-unifi-access` as the API library.
---
...
---
> Source: [imhotep/hass-unifi-access](https://github.com/imhotep/hass-unifi-access) — distributed by [TomeVault](https://tomevault.io).
