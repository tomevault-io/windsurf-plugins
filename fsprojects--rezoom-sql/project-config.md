---
trigger: always_on
description: The Rezoom and Rezoom.SQL library code shall be 100% human-written.
---
...
---
> Source: [fsprojects/Rezoom.SQL](https://github.com/fsprojects/Rezoom.SQL) — distributed by [TomeVault](https://tomevault.io).
